...
1. Klicka på alternativet för **published scopes** (publicerade scopes). Här definierar du behörigheterna (scopes) som kan beviljas till andra program.
...
1. Registrera ett klientprogram ([webbapp](active-directory-b2c-app-registration.md#register-a-web-app) eller [intern klient](active-directory-b2c-app-registration.md#register-a-mobile-or-native-app)) om du inte redan har ett. Om du följer den här guiden som startpunkt kommer du att behöva registrera ett klientprogram.
