---
title: Säkra ett webb-API med Node.js i Azure Active Directory B2C | Microsoft Docs
description: Hur du skapar en Node.js-webb-API som accepterar token från en B2C-klient.
