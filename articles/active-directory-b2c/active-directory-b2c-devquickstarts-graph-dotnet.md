...
>[!NOTE]
>För närvarande måste du använda den [Azure AD Graph API](https://msdn.microsoft.com/Library/Azure/Ad/Graph/howto/azure-ad-graph-api-operations-overview?f=255&MSPPError=-2147217396) att hantera användare i en Azure AD B2C-katalog.
