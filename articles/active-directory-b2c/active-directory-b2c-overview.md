...
| <center>![Webb-API:er](../active-directory/develop/media/active-directory-developers-guide/Web_API.png)<br />Webb-API:er</center> | [ASP.NET](active-directory-b2c-devquickstarts-api-dotnet.md)<br /><br />[NodeJS](https://github.com/Azure-Samples/active-directory-b2c-javascript-nodejs-webapi)<br /><br />[Anropa ett .NET-webb-API](active-directory-b2c-devquickstarts-web-api-dotnet.md) | &nbsp; |
