...
1. Följ dessa steg för att [navigera till inställningarna för Azure AD B2C](active-directory-b2c-app-registration.md#navigate-to-b2c-settings).
...
1. Ändra lösenordskomplexiteten för den här principen ska **enkel**, **starka**, eller **anpassad**.
