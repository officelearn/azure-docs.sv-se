...
Du kan lägga till interaktion med ett RESTful-API till dina [anpassade principer](active-directory-b2c-overview-custom.md) i Azure Active Directory B2C (Azure AD B2C). Den här artikeln visar hur du skapar en Azure AD B2C användar resa som samverkar med RESTful-tjänster.
