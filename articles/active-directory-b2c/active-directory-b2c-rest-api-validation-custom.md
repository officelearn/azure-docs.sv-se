...
Du kan också utforma interaktionen som ett Orchestration-steg. Mer information finns i [genom gång: integrera REST API Claims-utbyten i Azure AD B2C användar resa som ett Dirigerings steg](active-directory-b2c-rest-api-step-custom.md).
