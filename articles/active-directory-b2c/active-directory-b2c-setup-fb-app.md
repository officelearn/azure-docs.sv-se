...
2. Om du inte redan har gjort det så, behöver du registrera som Facebook-utvecklare. Om du vill göra detta, Välj **börjar** acceptera Facebooks principer i det övre högra hörnet på sidan och gör registreringen.
3. Välj **Mina appar** och sedan **Lägg till ny App**.
...
13. Klicka på plustecknet bredvid **produkter**, och välj sedan **konfigurera** under **Facebook-inloggning**.
14. Under **Facebook-inloggning**väljer **inställningar**.
