...
Mer information om hur du använder exempel appen finns [Azure Active Directory B2C: migrering av användare](active-directory-b2c-user-migration.md)
