...
ms.locfileid: "54850339"
---
# <a name="tutorial-enable-single-page-app-authentication-with-accounts-using-azure-active-directory-b2c"></a>Självstudier: Aktivera autentisering för en ensidesapp med konton med hjälp av Azure Active Directory B2C
