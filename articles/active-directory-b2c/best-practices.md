...
## <a name="planning-and-design"></a>Planering och utformning
...
| Migrera befintliga appar till b2clogin.com | Utfasningen av login.microsoftonline.com började gälla för alla Azure AD B2C klienter den 04 december 2020. [Läs mer](b2clogin.md). |
...
| [Microsoft Support](support-options.md) | Skicka en supportbegäran till Azure AD B2C tekniska problem. Support för fakturering och prenumerationshantering ges utan kostnad. |
