...
1. På sidan **Översikt** i Azure AD B2C klient organisationen väljer du länken under **resurs namn**. Du dirigeras till Azure AD B2C resursen i din Azure AD-klient.<br/>
    ![Azure AD B2C resurs länken är markerad i Azure Portal](./media/billing/portal-mau-02-b2c-resource-link.png)
...
1. Välj **Bekräfta** för att slutföra uppgraderingen till Mau-fakturering.<br/>
    ![MAU fakturerings bekräftelse i Azure Portal](./media/billing/portal-mau-04-confirm-change-to-mau.png)
...
Användarna är inte dubbelt räknade under över gångs månaden. Unika aktiva användare som autentiseras innan ändringen debiteras per autentisering under en kalender månad. Samma användare ingår inte i MAU-beräkningen för resten av prenumerationens fakturerings period. Några exempel:
...
1. Välj **Skapa**.
    ![sidan för att skapa Azure AD B2C resurs i Azure Portal](./media/billing/portal-01-create-b2c-resource-page.png)
