...
```
> [!NOTE]
> När du skapar användare via Graph API kan måste programmet innehålla ”openid”, ”offline_access” och ”” profilbehörigheter från Microsoft Graph.
