...
![List Rute kontroll med ett enda val som visar flera alternativ](./media/custom-policy-configure-user-input/dropdown-menu-example.png)
...
![Markera kryss Rute kontroll med flera alternativ](./media/custom-policy-configure-user-input/multiselect-menu-example.png)
