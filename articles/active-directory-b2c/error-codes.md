...
| Felkod | Meddelande |
| ---------- | ------- |
| `AADB2C90002` | Det gick inte att hitta CORS-resursen{0}som returnerade en 404. |
| `AADB2C90006` | Omdirigerings-URI: n{0}som tillhandahölls i begäran har inte registrerats för klient-ID{1}. |
| `AADB2C90007` | Programmet som är associerat med klient-ID: t{0}saknar registrerade omdirigerings-URI: er. |
| `AADB2C90008` | Begäran innehåller inte någon klient-ID-parameter. |
| `AADB2C90010` | Begäran innehåller ingen omfattnings parameter. |
| `AADB2C90011` | Klient-ID: t{0}som anges i begäran matchar inte klient-ID{1}som har registrerats i principen. |
| `AADB2C90012` | Omfånget{0}som tillhandahölls i begäran stöds inte. |
...
| `AADB2C90017` | Den klient kontroll som angavs i begäran är ogiltig: {0} |
...
| `AADB2C90021` | Den tekniska profilen{0}finns inte i principen{1}av klienten{2}. |
| `AADB2C90022` | Det går inte att returnera metadata för principen{0}i klient organisationen{1}. |
| `AADB2C90023` | Profilen{0}innehåller inte den nödvändiga metadata{1}. |
| `AADB2C90025` | Profilen "{0}" i principen "{1}" i klient organisationen "{2}" innehåller inte den nödvändiga kryptografiska nyckeln "{3}". |
| `AADB2C90027` | Grundläggande autentiseringsuppgifter som har angetts för{0}är ogiltiga. Kontrol lera att autentiseringsuppgifterna är korrekta och att åtkomsten har beviljats av resursen. |
...
| `AADB2C90037` | Ett fel inträffade under behandlingen av begäran. Kontakta administratören för den plats som du försöker få åtkomst till. |
| `AADB2C90039` | Begäran innehåller en klient kontroll, men den angivna principen{0}i klient organisationen{1}saknar en client_secret i RelyingPartyPolicy. |
...
| `AADB2C90044` | Anspråk '{0}' stöds inte av anspråks matcharen '{1}'. |
...
| `AADB2C90055` | Omfånget{0}som anges i begäran måste ange en resurs, t. ex. https://example.com/calendar.read. |
...
| `AADB2C90067` | Omutloggning omdirigerings-URI{0}har ett ogiltigt format. Ange en https-baserad URL, till exempel "https://example.com/return" eller för interna klienter använder den inbyggda IETF-klient-URI: n "urn: IETF: WG: OAuth: 2.0: OOB". |
...
| `AADB2C90075` | Anspråks utbytet{0}som anges i steg{1}returnerade HTTP-felsvaret med koden{2}och orsaken{3}. |
| `AADB2C90077` | Användaren har inte någon befintlig session och en begär ande prompt-parameter har värdet{0}. |
| `AADB2C90079` | Klienter måste skicka ett client_secret när de löser in ett konfidentiellt bidrag. |
| `AADB2C90080` | Den tillhandahållna tilldelningen har upphört att gälla. Autentisera igen och försök igen. Aktuell tid: {0}, beviljande tid för utfärdande: {1}, tilldelningens förfallo tid för glidande fönster: {2}. |
...
| `AADB2C90092` | Det angivna programmet med ID{0}har inaktiverats för klient organisationen{1}. Aktivera programmet och försök igen. |
| `AADB2C90107` | Programmet med ID{0}kan inte hämta en ID-token, antingen på grund av att OpenID-omfånget inte tillhandahölls i begäran eller att programmet inte har behörighet för det. |
...
| `AADB2C90122` | InInformationen för{0}som togs emot i begäran misslyckades med verifiering av HTTP-begäran. Se till att indatamängden inte innehåller tecken som < eller &. |
...
| `AADB2C90149` | Det gick inte att läsa in skriptet{0}. |
...
| `AADB2C90158` | En kontrollerad verifierings förfrågan misslyckades med orsaken{0}. |
...
| `AADB2C90165` | Det gick inte att hitta SAML-initierings meddelandet med ID{0}i läget. |
...
| `AADB2C90188` | Den tekniska SAML-profilens "{0}" anger en PartnerEntity-URL för '{1}', men hämtningen av metadata Miss lyckas med orsaken '{2}'. |
| `AADB2C90194` | Anspråk{0}som angetts för Bearer-token finns inte i de tillgängliga anspråken. Tillgängliga anspråk{1}. |
...
| `AADB2C90242` | Den tekniska SAML-profilens{0}anger PartnerEntity CDATA som inte kan läsas in för orsaken{1}. |
...
| `AADB2C90261` | Anspråks utbytet{0}som anges i steg{1}returnerade HTTP-felsvaret som inte kunde parsas. |
...
| `AADB2C90276` | Begäran stämmer inte överens med kontroll inställningen{0}:{1}i technicalProfile{2}för principen{3}klient organisation{4}. |
| `AADB2C90277` | Orchestration-steget{0}av användar resan{1}för principen{2}innehåller inte någon innehålls definitions referens. |
| `AADB2C90279` | Det tillhandahållna klient-ID: t{0}matchar inte det klient-ID som utfärdade tilldelningen. |
| `AADB2C90284` | Programmet med ID{0}har inte beviljats medgivande och kan inte användas för lokala konton. |
| `AADB2C90285` | Det gick inte att hitta programmet med ID: t{0}. |
| `AADB2C90288` | UserJourney med ID '{0}' som refereras i TechnicalProfile '{1}' för uppdateringstoken för uppdaterings-token för klienten '{2}' finns inte i principen '{3}' eller någon av dess bas principer. |
...
| `AADB2C99006` | Azure AD B2C kan inte hitta tillägg-appen med app-ID{0}. Besök https://go.microsoft.com/fwlink/?linkid=851224 om du vill ha mer information. |
| `AADB2C99011` | Värdet för metadata{0}har inte angetts i TechnicalProfile{1}i principen{2}. |
| `AADB2C99013` | Den angivna grant_type [{0}] och token_type [{1}]-kombinationen stöds inte. |
| `AADB2C99015` | Profilen "{0}" i principen "{1}" i klient organisationen "{2}" saknar alla InputClaims som krävs för flödet för autentiseringsuppgifter för resurs ägar lösen ord. |
