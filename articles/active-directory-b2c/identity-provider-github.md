...
1. Ange `https://your-tenant-name.b2clogin.com/your-tenant-name.onmicrosoft.com/oauth2/authresp` i **URL för motringning av åtkomst**. Ersätt `your-tenant-name` med namnet på din Azure AD B2C-klient. Använd gemener när du anger ditt klientnamn även om klienten har definierats med versaler i Azure AD B2C.
1. Klicka på **Registrera program**.
1. Kopiera värdena för **klient-ID** och **klient hemlighet**. Du måste båda för att lägga till identitetsleverantören i din klient.
