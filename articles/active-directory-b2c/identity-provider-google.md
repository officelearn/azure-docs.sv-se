...
Om du vill använda ett Google-konto som [identitets leverantör](authorization-code-flow.md) i Azure Active Directory B2C (Azure AD B2C) måste du skapa ett program i din Google Developer-konsol. Om du inte redan har ett Google-konto kan du registrera dig [https://accounts.google.com/SignUp](https://accounts.google.com/SignUp)på.
