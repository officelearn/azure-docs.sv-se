...
ms.author: mimart
ms.subservice: B2C
ms.openlocfilehash: 5b06c69473336bd6273df340afde711b40dd62fe
ms.sourcegitcommit: 6fd28c1e5cf6872fb28691c7dd307a5e4bc71228
ms.translationtype: MT
ms.contentlocale: sv-SE
ms.lasthandoff: 06/23/2020
ms.locfileid: "85201879"
---
...
4. I **webbplats-URL**anger du `https://your-tenant.b2clogin.com` . Ersätt `your-tenant` med namnet på din klient. Exempelvis `https://contosob2c.b2clogin.com`.
5. Ange för **återanrops-URL: en** `https://your-tenant.b2clogin.com/your-tenant.onmicrosoft.com/your-policy-Id/oauth1/authresp` . Ersätt `your-tenant` med namnet på ditt klient namn och `your-policy-Id` med identifieraren för din princip. Exempelvis `b2c_1A_signup_signin_twitter`. Du måste använda små bokstäver när du anger ditt klient namn även om klienten har definierats med versaler i Azure AD B2C.
...
7. Ange ett **namn** för princip nyckeln. Exempelvis `TwitterSecret`. Prefixet `B2C_1A_` läggs till automatiskt till namnet på din nyckel.
...
5. Byt namn på användar resans ID. Exempelvis `SignUpSignInTwitter`.
...
2. Lägg till följande **ClaimsExchange** -element och kontrol lera att du använder samma värde för det ID som du använde för **TargetClaimsExchangeId**:
    ...
    Uppdatera värdet för **TechnicalProfileReferenceId** till ID: t för den tekniska profil som du skapade tidigare. Exempelvis `Twitter-OAUTH1`.
...
2. Öppna den nya filen och uppdatera värdet för attributet **PolicyId** för **TrustFrameworkPolicy** med ett unikt värde. Exempelvis `SignUpSignInTwitter`.
