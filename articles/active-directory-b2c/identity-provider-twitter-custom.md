...
4. I **webbplats-URL**anger `https://your-tenant.b2clogin.com`du. Ersätt `your-tenant` med namnet på din klient. Till exempel `https://contosob2c.b2clogin.com`.
...
9. För **nyckel användning**väljer `Encryption`du.
10. Klicka på **Skapa**.
