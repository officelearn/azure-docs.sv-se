...
* Välj en [Sidlayout](contentdefinitions.md#select-a-page-layout) för användar gränssnitts elementen i programmet.
    ...
    Om du tänker använda Java Script måste du [definiera en version](contentdefinitions.md#migrating-to-page-layout) av sidlayouten med sid `contract` version för *alla* innehålls definitioner i den anpassade principen. Lär dig hur du [migrerar till](contentdefinitions.md#migrating-to-page-layout) sidlayouten med Page version. 
