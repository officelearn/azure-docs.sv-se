...
| SendTokenResponseBodyWithJsonNumbers | Nej | Ställ alltid in på `true` . För äldre format där numeriska värden anges som strängar i stället för JSON-tal, anges till `false` . Det här attributet krävs för klienter som har tagit ett beroende på en tidigare implementering som returnerade sådana egenskaper som strängar. |
