...
Om du vill redigera princip innehållet lokalt, rör du kommandots utdata till en fil med argumentet `-OutputFilePath` och öppnar sedan filen i din favorit redigerare.
...
Om du utfärdar `Set-AzureADMSTrustFrameworkPolicy`-kommandot med ID för en princip som redan finns i Azure AD B2C klienten, skrivs innehållet i den principen över.
