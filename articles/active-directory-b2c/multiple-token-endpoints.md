...
Ändra `ida:AadInstance` värdet i *Web. config* för TaskWebApp så att det refererar `{your-b2c-tenant-name}.b2clogin.com` till i stället för `login.microsoftonline.com`.
