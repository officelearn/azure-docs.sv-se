...
| IncludeKeyInfo | Inga | Anger om SAML-autentiseringsbegäran innehåller certifikatets offentliga nyckel när bindningen har angetts till `HTTP-POST`. Möjliga värden: `true` eller `false`. |
