...
Avgör om ett sträng-anspråk är lika med en annan. Resultatet är ett nytt booleskt ClaimType booleskt värde med ett värde av `true` eller `false`.
