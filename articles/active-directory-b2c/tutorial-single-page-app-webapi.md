...
En Enkels Ides applikation (SPA) från [föregående självstudie](tutorial-single-page-app.md) i serien använder Azure AD B2C för användarens registrering och inloggning, och anropar det ASP.net Core webb-API som skyddas av *frabrikamb2c* demo-klienten.
...
1. Logga in med e-postadressen och lösen ordet som du använde i [föregående självstudie](tutorial-single-page-app.md). Vid lyckad inloggning bör du se `User 'Your Username' logged-in`-meddelandet.
