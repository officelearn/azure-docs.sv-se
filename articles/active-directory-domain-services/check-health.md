...
| Distribuera | <img src= "./media/active-directory-domain-services-alerts/deploying-icon.png" width = "15"> | Din domän håller på att distribueras. |
