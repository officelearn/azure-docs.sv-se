...
description: Lär dig hur du inaktiverar Azure Active Directory Domain Services att använda Azure Portal
...
1. Välj namnet på din Azure AD DS-hanterade domän, till exempel *contoso.com*.
