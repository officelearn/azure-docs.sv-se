...
4. **Azure AD Domain Services** måste aktiveras för Azure AD-katalog. Om du inte gjort det, följer du alla uppgifter som beskrivs i den [komma igång-guiden](create-instance.md).
...
Använda Resursbaserad KCD som beskrivs i det här [artikeln](deploy-kcd.md).
