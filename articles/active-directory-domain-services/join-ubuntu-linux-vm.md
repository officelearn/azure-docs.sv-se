---
title: 'Azure Active Directory Domain Services: Ansluta en Ubuntu-VM till en hanterad domän | Microsoft Docs'
...
Referera till den [felsökning domänanslutning](join-windows-vm.md#troubleshoot-joining-a-domain) artikeln.
