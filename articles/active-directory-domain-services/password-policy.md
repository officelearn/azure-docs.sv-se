...
1. Logga in på Windows-VM som du använder för att administrera din hanterade domän. Om du inte har något, följ instruktionerna för att [hantera en Azure AD Domain Services-domän](manage-domain.md).
