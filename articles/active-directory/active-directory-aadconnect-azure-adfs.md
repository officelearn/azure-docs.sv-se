...
|Regel|Beskrivning|Flöde|
|:----|:----|:------:|
|AllowHttpsFromVirtualNetwork| Tillåt HTTPS från virtuella nätverk | Inkommande |
|AllowHTTPSInternet| Tillåt HTTPS från Internet till DMZ | Inkommande|
|DenyingressexceptHTTPS| Blockera allt annat än HTTPS från Internet | Inkommande |
|DenyOutToInternet| Allt utom HTTPS till Internet blockeras | Utgående |
...
>[AZURE.NOTE] Om autentisering med klientanvändarcertifikat (clientTLS-autentisering med X509-användarcertifikat) krävs så kräver AD FS att TCP-port 49443 är aktiverad för inkommande åtkomst.
