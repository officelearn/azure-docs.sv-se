...
> [AZURE.IMPORTANT] Das Rückschreiben Preview Feature vorübergehend entfernt wurde in der August-Update von AAD Connect. Wenn Sie diese Funktion aktiviert haben, sollten Sie sie deaktivieren.
...
> [AZURE.IMPORTANT] Diese Funktion sollte nur in einer Umgebung getestet werden und sollte nicht verwendet werden, in Azure AD-Verzeichnis für den produktiven Einsatz verwendet.
...
- Das Adressbuchattribut ist in der Vorschau derzeit nicht aufgefüllt. Verwenden Sie hierzu einfach das Exchange PowerShell-Cmdlet "update-recipient".
...
Weitere Informationen zu Office 365-Gruppen befinden [hier](http://aka.ms/O365g).
...
## Nächste Schritte
Weiterhin Ihre [benutzerdefinierte Installation von Azure AD Connect](active-directory-aadconnect-get-started-custom.md).
