...
![Användarinloggning med MFA](./media/active-directory-aadconnect-get-started-custom/connectaadmfa.png)
...
Granska varje domän som markerats med **Inte tillagd** och **Inte verifierad**. Kontrollera att de som du använder har verifierats i Azure AD. Klicka på symbolen Uppdatera när du har verifierat dina domäner. Mer information finns i [Lägga till och verifiera domänen](active-directory-add-domain.md)
