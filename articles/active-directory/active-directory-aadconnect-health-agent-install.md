...
> [AZURE.NOTE] Detta avsnitt gäller endast för AD FS-federationsservrar.
...
> [AZURE.NOTE] Kom ihåg att användningen av Azure AD Connect Health kräver Azure AD Premium. Om du inte har Azure AD Premium kan du inte slutföra konfigurationen på Azure-portalen. Mer information finns på [kravsidan](active-directory-aadconnect-health-agent-install.md#requirements).
