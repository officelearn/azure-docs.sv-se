...
**F: Ich Verwalten mehrerer Azure AD-Verzeichnissen. Wie wechseln kann ich mit Azure Active Directory Premium?**
...
Nr. Die Installation der Agents erfordert nicht den Server neu starten. Während der Installation einiger vorbereitender Schritte muss der Server jedoch möglicherweise neu gestartet werden.
...
Ja.  Für laufende Vorgänge können Sie den Health-Agent zum Weiterleiten ausgehender HTTP-Anforderungen mithilfe eines HTTP-Proxys konfigurieren. Finden Sie unter [Konfigurieren von Azure AD Connect Health-Agents mithilfe der HTTP-Proxy](active-directory-aadconnect-health-agent-install-adfs.md#configure-azure-ad-connect-health-agent-to-use-http-proxy) Weitere Informationen.
...
Wählen Sie einen Proxyserver für LAN verwenden.<br>
Wählen Sie erweitert, wenn Sie unterschiedliche proxyports für HTTP und HTTPS/Secure verfügen.<br>


**F: Unterstützt der Azure AD Connect Health-Dienst die Standardauthentifizierung bei der Verbindung mit HTTP-Proxys?**

Nr. Ein Mechanismus zum Angeben beliebigen Benutzername/Kennworts für die Standardauthentifizierung wird derzeit nicht unterstützt.
