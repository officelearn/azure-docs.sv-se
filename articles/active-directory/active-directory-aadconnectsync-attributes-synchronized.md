...
In diesem Thema werden die Attribute aufgelistet, die von der Azure AD Connect-Synchronisierung synchronisiert werden.<br>
...
## Windows 10
Bei unter Windows 10 per Domänenbeitritt in die Domäne eingebundenen Computern (Geräten) werden einige Attribute mit Azure AD synchronisiert.  Weitere Informationen zu den einzelnen Szenarien finden Sie unter [mit Domäne Geräte für Windows 10 hat Azure AD verbinden](active-directory-azureadjoin-devices-group-policy.md). Diese Attribute werden immer synchronisiert, und Windows 10 wird nicht als App angezeigt, für die Sie die Auswahl aufheben können. Ein unter Windows 10 in die Domäne eingebundener Computer wird dadurch identifiziert, dass das Attribut „userCertificate“ aufgefüllt ist.
