...
**Um die erweiterte Regel zu erstellen.**
In der Azure-Portal unter der Gruppe **konfigurieren** Registerkarte der **erweiterte Regel** aus, und geben Sie dann in das bereitgestellte Textfeld Ihre erweiterte Regel. Sie können die erweiterte Regel mit den folgenden Informationen erstellen.
...
Zeichenfolgen mit Anführungszeichen (") sollten mit dem Escapezeichen ` maskiert werden, z. B.: user.department -eq "Sa`"les".
...
--------------------------------------------------------------------------------
1. Klicken Sie auf die Administrator-Portal auf der **konfigurieren** Registerkarte, und wählen Sie dann **erweiterte Regel**.
2. Geben Sie die Regel mit der folgenden Syntax:
Direkt unterstellten Mitarbeiter für *direkt unterstellten Mitarbeiter für {UserID_of_manager}*
