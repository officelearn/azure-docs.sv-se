...
---
# <a name="add-your-custom-domain-name-to-azure-active-directory"></a>Lägga till ett eget domännamn i Azure Active Directory
...
## <a name="add-the-dns-entry-at-the-domain-name-registrar-for-the-domain"></a>Lägga till DNS-posten hos domännamnsregistratorn för domänen
