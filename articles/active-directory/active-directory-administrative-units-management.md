...
Weitere Informationen zu den Anforderungen der Clientsoftware und Installieren des Azure AD-Moduls, und Informationen zu den Azure AD-Modul-Cmdlets zum Verwalten administrativer Einheiten, einschließlich Syntax, parameterbeschreibungen und Beispielen finden Sie unter [Verwalten von Azure AD mithilfe von Windows PowerShell](https://msdn.microsoft.com/library/azure/jj151815.aspx).
