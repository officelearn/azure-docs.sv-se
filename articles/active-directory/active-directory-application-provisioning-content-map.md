---
title: "Problem med att konfigurera och etablera användare till ett program ”"
description: "Problem med att konfigurera och etablera användare till ett program ”"
...
## <a name="i-want-to-know-when-provisioning-will-finish"></a>Jag vill veta när etablering slutförs
  Följande dokument kan kanske hjälpa dig att lösa några av de vanligaste problemen i den här kategorin.
  * [Jag vet inte hur man tar reda på när en viss användare kommer att ha åtkomst till ett program](https://docs.microsoft.com/azure/active-directory/application-provisioning-when-will-provisioning-finish-specific-user/?/?WT.mc_id=DMC_AAD_Manage_Apps_Troubleshooting_Nav)
  * [Etablering i mitt Azure AD-galleriprogram fungerar, men etableringsprocessen kan ta flera timmar eller mer](https://docs.microsoft.com/azure/active-directory/application-provisioning-when-will-provisioning-finish/?/?WT.mc_id=DMC_AAD_Manage_Apps_Troubleshooting_Nav)

## <a name="im-having-problems-configuring-user-provisioning-to-an-application"></a>Jag har problem konfigurering av användarförsörjning till ett program
  Följande dokument kan kanske hjälpa dig att lösa några av de vanligaste problemen i den här kategorin.
