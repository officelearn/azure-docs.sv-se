...
## Erste Schritte
Stellen Sie sicher, dass Sie über ein Azure AD Basic- oder Premium-Abonnement und ein Azure AD-Verzeichnis verfügen, für die Sie als globaler Administrator angemeldet sind. Sie benötigen auch Azure AD Basic- oder Premium-Lizenzen für den Verzeichnisadministrator und Benutzer, die auf die Apps zugreifen. Werfen Sie einen Blick [hier](active-directory-editions.md) für Weitere Informationen zu den Azure AD-Editionen.
...
2. [Veröffentlichen von Anwendungen](active-directory-application-proxy-publish.md) -Verwenden Sie den Assistenten schnellen und einfachen Ihre lokalen apps veröffentlichten abrufen, Remote zugegriffen werden kann.
