<properties
    pageTitle="Was bedeuten Anwendungszugriff und einmaliges Anmelden mit Azure Active Directory? | Microsoft Azure"
...
*   **Einmaliges Anmelden für Verbundbenutzer** können Anwendungen in Azure AD für die Benutzerauthentifizierung anstelle von eigenen Kennworts aufzufordern umzuleiten. Diese Methode kann für Anwendungen verwendet werden, die Protokolle wie SAML 2.0, WS-Verbund oder OpenID Connect unterstützen, und ist der umfassendste Modus bei der einmaligen Anmeldung.

*   **Kennwortbasierte einmalige** ermöglicht sichere Speicherung des anwendungskennworts und dessen Wiedergabe mit einer webbrowsererweiterung oder einer mobilen app. Damit wird der von der Anwendung bereitgestellte vorhandene Anmeldevorgang genutzt, die Kennwortverwaltung übernimmt jedoch der Administrator, sodass der Benutzer das Kennwort nicht kennen muss.

*   **Vorhandenes einmaliges Anmelden für** ermöglicht Azure AD, alle vorhandenen einmaliges Anmelden nutzen, die für die Anwendung festgelegt wurde, ermöglicht jedoch die Anwendung, die Office 365 oder Azure AD Access Bereich Portale verknüpft werden soll, und können auch zusätzliche reporting in Azure AD, wenn die Anwendung es gestartet sind.
...
Siehe auch: [Verwalten von Zertifikaten für einmaliges Anmelden für Verbundbenutzer](active-directory-sso-certs.md)
...
- Internet Explorer 8, 9 und 10 – unter Windows 7 oder höher (Siehe auch [Handbuch für die Bereitstellung von Internet Explorer-Erweiterung](active-directory-saas-ie-group-policy.md))
...
**Hinweis:** die kennwortbasierten SSO-Erweiterung zur Verfügung stehen für Edge in Windows 10 bei Browsererweiterungen von Edge unterstützt werden.
...
Weitere Informationen finden Sie unter [Automatisieren der Bereitstellung und Aufhebens der Bereitstellung für SaaS-Anwendungen](active-directory-saas-app-provisioning.md)
...
Die [Azure Active Directory-Anwendungskatalog](http://azure.microsoft.com/marketplace/active-directory/all/) enthält eine Liste der Programme, die bekanntermaßen eine Form von einmaliges Anmelden mit Azure Active Directory zu unterstützen.

![][1]

Nachfolgend finden Sie einige Tipps für die Suche nach Apps unter Berücksichtigung der Funktionen, die sie unterstützen:

*   Azure AD unterstützt die automatische Bereitstellung und Aufhebung der Bereitstellung für alle "Top"-apps in die [Azure Active Directory-Anwendungskatalog](http://azure.microsoft.com/marketplace/active-directory/all/).

*   Eine Liste der verbundanwendungen, die speziell unterstützen Verbund einmaliges Anmelden mithilfe eines Protokolls wie z. B. WS-Verbund, SAML oder OpenID Connect finden Sie [hier](http://social.technet.microsoft.com/wiki/contents/articles/20235.azure-active-directory-application-gallery-federated-saas-apps.aspx).
...
*   **Fügen Sie eine nicht gelistete app Sie verwenden** -die benutzerdefinierten Kategorie im app-Katalog im Azure-Verwaltungsportal verwenden, um eine nicht gelistete Anwendung zu verbinden, Ihrer Organisation verwendet wird. Sie können jede Anwendung hinzufügen, die SAML 2.0 als Verbund-App unterstützt, oder jede Anwendung für die kennwortbasierte einmalige Anmeldung, die über eine HTML-basierte Anmeldeseite verfügt. Weitere Informationen finden Sie in diesem Artikel auf [Hinzufügen Ihrer eigenen Anwendung](active-directory-saas-custom-apps.md).


*   **Fügen Sie Ihre Anwendung, die Sie entwickeln** – Wenn Sie die Anwendung selbst entwickelt haben befolgen Sie die Richtlinien in der Azure AD-Entwicklerdokumentation verbundenen einmaliges Anmelden implementieren oder die Bereitstellung mithilfe der Azure AD graph-API. Weitere Informationen finden Sie in den folgenden Ressourcen:
...
*   **Anfordern einer app-Integration** -Anfordern von Support für die Anwendung, die Sie benötigen, mit der [Feedback-Forum für Azure AD](http://feedback.azure.com/forums/169401-azure-active-directory).
...
Der Zugriffsbereich am https://myapps.microsoft.com ist ein webbasiertes Portal, das ermöglicht einem Endbenutzer mit einem Unternehmenskonto in Azure Active Directory anzeigen und Starten von Cloud-basierten Anwendungen, die sie den Zugriff durch Azure AD-Administrator erteilt wurde. Wenn Sie ein Endbenutzer mit [Azure Active Directory Premium](http://azure.microsoft.com/pricing/details/active-directory/), Sie können auch Self-Service-Management-Funktionen über den Zugriffsbereich verwenden.
