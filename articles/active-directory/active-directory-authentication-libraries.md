...
Ein Codebeispiel, das veranschaulicht dieses Szenario mithilfe von Azure AD-Authentifizierung finden Sie unter [systemeigene WPF-Clientanwendung für Web-API](https://github.com/azureadsamples/nativeclient-dotnet).
