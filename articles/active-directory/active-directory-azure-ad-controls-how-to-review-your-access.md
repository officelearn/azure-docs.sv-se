---
title: Granska din åtkomst | Microsoft Docs
...
När du väljer en åtkomstgranskning i listan, kan du se din åtkomst. Välj raden och välj om du vill godkänna eller neka dina behov för kontinuerlig åtkomst.

Granskaren kan kräva att du ange en motivering för godkännande av fortsatt åtkomst.

## <a name="next-steps"></a>Nästa steg

Nekade åtkomst tas inte bort direkt. Om du vill ändra ditt svar och godkänna, återställa svaret och välj ett nytt svar. Du kan göra det här steget tills åtkomstgranskningen är klar.
