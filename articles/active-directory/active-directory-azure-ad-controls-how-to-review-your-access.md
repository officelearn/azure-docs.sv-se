---
title: Granska åtkomsten | Microsoft Docs
description: Granska din åtkomst med Azure Active Directory
...
Du kan se din åtkomst när du väljer en åtkomst-granskning i listan. Välj raden och välja om du vill godkänna eller neka behovet av fortsatt åtkomst.

Granskaren kan kräva att du kan ange en motivering för att godkänna fortsatt åtkomst.

## <a name="next-steps"></a>Nästa steg

Nekade åtkomst tas inte bort direkt. Om du vill ändra ditt svar och godkänna, återställa svaret och välj ett nytt svar. Du kan göra det här steget tills åtkomst granskningen har slutförts.
