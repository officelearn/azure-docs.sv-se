...
------------------------------------------------------------------------------------------
Außer den oben beschriebenen Szenarien können Sie mit Ihrer Benutzer ihre Geräte mit Azure AD aufgrund Zusammenführen einfacheres, Verwaltung der Geräte in Azure AD automatische MDM-Registrierung, und einzelne Anmeldung bei Azure AD verknüpft profitieren und lokalen Ressourcen.  
