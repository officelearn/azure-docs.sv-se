...
--------------------------------------------------------------------------------------------
1.  Aus der **Start** Klicken Sie im Menü **Einstellungen**. 
2.  Wählen Sie **Konten**, und klicken Sie dann auf **Ihr Konto**.
3.  Klicken Sie auf **Hinzufügen Geschäfts-oder Schulkonto**, und geben Sie in Ihrem Unternehmenskonto an.
4.  Sie werden dann zur Anmeldeseite Ihrer Organisation weitergeleitet. Geben Sie Benutzername und Kennwort ein, und klicken Sie auf **OK**.
