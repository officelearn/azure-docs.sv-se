...
1. **Azure AD Join**, die neu in Windows 10 ein Self-service-Arbeit Bereitstellung Erfahrung, die Ziel der Arbeitskräfte, die in erster Linie auf Ressourcen in der Cloud, z. B. Office 365 zugreifen.
1. **Beitreten zu einer Domäne**, besser in Windows 10 beim Verbinden mit Azure AD für Organisationen mit großen Investitionen in lokale apps und Ressourcen.
1. **Eine neue vereinfachte BYOD Erfahrung** mit dem Benutzer ein Geschäftskontos zu Windows problemlos auf persönlichen Geräten den Zugriff auf Arbeitsressourcen hinzufügen.
...
**Verwenden von Azure AD Join für aus folgenden Gründen**:
...
**Wenn die meisten Zugriff auf Unternehmensressourcen über die Cloud ist, kann eine Organisation zusätzliche Vorteile genießen**:
...
Weitere Informationen zu Azure AD Join finden Sie unter [Erweitern von Cloud-Funktionen, Windows 10-Geräte über Azure Active Directory Join](active-directory-azureadjoin-overview.md).
...
**Verwenden Sie beitreten zu einer Domäne in Ihrem Unternehmen für aus folgenden Gründen**:
...
**Beitreten zu einer Domäne wird Windows 10 bietet Ihnen außerdem die folgenden Vorteile nach Verbindung zum Azure AD**:
...
Weitere Informationen zu Azure AD Join, finden Sie unter [mit Domäne Geräte für Windows 10 hat Azure AD verbinden](active-directory-azureadjoin-devices-group-policy.md).
...
- Weitere Informationen zum Domänenbeitritt in Windows 10 finden Sie < link-to-DJ-in-Win10-deployment-guide >.
...
- Legen Sie die Richtlinie zum Aktivieren von Microsoft Passport im Unternehmen fest.
- Weitere Informationen zu Microsoft Passport und Windows Hello in Windows 10 finden Sie < link-to-MS-Passport-and-Windows-Hello-document >.
