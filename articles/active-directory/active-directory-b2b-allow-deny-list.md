...
För att få principen kan använda den [Get-AzureADPolicy](https://docs.microsoft.com/en-us/powershell/module/azuread/get-azureadpolicy?view=azureadps-2.0-preview) cmdlet. Exempel:
...
- Information om villkorlig åtkomst och B2B-samarbete finns [villkorlig åtkomst för användare för B2B-samarbete](active-directory-b2b-mfa-instructions.md).
