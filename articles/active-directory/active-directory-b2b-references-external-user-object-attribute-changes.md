...
- Die **SignInName** und **AltSecId** Attribute werden aufgefüllt.
- Die **DisplayName** Attribut ändert sich von den Benutzerprinzipalnamen (user_fabrikam.com#EXT#@contoso.com) in der Anmeldename (user@fabrikam.com)
