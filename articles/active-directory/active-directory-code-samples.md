...
Tragen zu unseren Beispielen auf GitHub: [Microsoft Azure Active Directory – Beispiele und Dokumentation](https://github.com/AzureADSamples).
...
Diese Codebeispiele zeigen, wie Sie systemeigene Clientanwendungen erstellen, die von Azure AD gesicherte Web-APIs aufrufen. Verwenden sie [Azure AD Authentication Library (ADAL)](http://go.microsoft.com/fwlink/?LinkID=258232) und [OAuth 2.0 in Azure AD](https://msdn.microsoft.com/library/azure/dn645545.aspx).
...
Diese Codebeispiele zeigen die Verwendung [OAuth 2.0 in Azure AD](https://msdn.microsoft.com/library/azure/dn645545.aspx) Erstellung von ASP.NET-Webanwendungen Web-APIs aufrufen, die von Azure AD gesichert werden.
...
| C#/.NET | [WebApp-WebAPI-OAuth2-UserIdentity-Dotnet](http://github.com/AzureADSamples/WebApp-WebAPI-OAuth2-UserIdentity-Dotnet) | Hinzufügen von Autorisierung mit [OAuth 2.0 in Azure AD](https://msdn.microsoft.com/library/azure/dn645545.aspx) zu einer vorhandenen Webanwendung, damit sie eine Web-API aufrufen kann.
...
Diese Codebeispiele zeigen, wie eine Daemon- oder Serveranwendung zu erstellen, die Ressourcen von einer Web-API mit ruft [Azure AD Authentication Library (ADAL)](http://go.microsoft.com/fwlink/?LinkID=258232) und [OAuth 2.0 in Azure AD](https://msdn.microsoft.com/library/azure/dn645545.aspx).
...
| C#/.NET |  [AAL – Windows Store-App zu REST-Dienst – Authentifizierung](http://go.microsoft.com/fwlink/?LinkId=330605) |  Verwendung [Azure AD Authentication Library (ADAL)](http://go.microsoft.com/fwlink/?LinkID=258232) (ehemals AAL) für Windows Store Beta, Windows Store-app Funktionen für die Benutzerauthentifizierung hinzufügen.
| C#/.NET | [ADAL – systemeigene App zu REST-Dienst – Authentifizierung mit AAD mittels Browserdialogfeld](http://go.microsoft.com/fwlink/?LinkId=259814) |  Verwendung [Azure AD Authentication Library (ADAL)](http://go.microsoft.com/fwlink/?LinkID=258232) einen WPF-Client Funktionen für die Benutzerauthentifizierung hinzu.
| C#/.NET | [ADAL – systemeigene App zu REST-Dienst – Authentifizierung mit ACS mittels Browserdialogfeld](http://code.msdn.microsoft.com/AAL-Native-App-to-REST-de57f2cc) |  Verwendung [Azure AD Authentication Library (ADAL)](http://go.microsoft.com/fwlink/?LinkID=258232) und [Access Control Service 2.0 (ACS)](http://msdn.microsoft.com/library/azure/hh147631.aspx) einen WPF-Client Funktionen für die Benutzerauthentifizierung hinzu.
| C#/.NET | [ADAL – Server-zu-Server-Authentifizierung](http://go.microsoft.com/fwlink/?LinkId=259816) | Verwendung [Azure AD Authentication Library (ADAL)](http://go.microsoft.com/fwlink/?LinkID=258232) zum Sichern von Dienstaufrufen von einem serverseitigen Prozess an einen MVC4 Web-API-REST-Dienst.
