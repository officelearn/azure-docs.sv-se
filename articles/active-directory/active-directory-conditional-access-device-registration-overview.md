...
---
# <a name="get-started-with-azure-active-directory-device-registration"></a>Komma igång med Azure Active Directory Device Registration
...
## <a name="scenarios-enabled-by-azure-active-directory-device-registration"></a>Scenarier som använder Azure Active Directory Device Registration
...
### <a name="enable-azure-active-directory-device-registration-service"></a>Aktivera tjänsten Azure Active Directory Device Registration
...
## <a name="configure-azure-active-directory-device-registration-discovery"></a>Konfigurera identifiering av Azure Active Directory Device Registration
