...
![Skapa princip](./media/active-directory-conditional-access-tou/5555.png)
...
5. På den **Azure Active Directory** sidan den **hantera** klickar du på **villkorlig åtkomst**.
    ...
    ![Villkorlig åtkomst](./media/active-directory-conditional-access-tou/03.png) 

6. I den **hantera** klickar du på **användningsvillkoren**.

    ![Användningsvillkor](./media/active-directory-conditional-access-tou/04.png) 

7. Klicka på menyn längst upp **nya allmänna**.

    ![Användningsvillkor](./media/active-directory-conditional-access-tou/05.png) 

8. På den **nya användningsvillkor** sidan:

    ![Användningsvillkor](./media/active-directory-conditional-access-tou/112.png) 
...
![Skapa princip](./media/active-directory-conditional-access-tou/1234.png)
...
1. På den **New** sidan den **namn** textrutan typ **kräver TOU för Isabella**.
    ...
    ![Namn](./media/active-directory-conditional-access-tou/71.png)

2. I den **tilldelning** klickar du på **användare och grupper**.

    ![Användare och grupper](./media/active-directory-conditional-access-tou/06.png)

3. På den **användare och grupper** sidan:

    ![Användare och grupper](./media/active-directory-conditional-access-tou/24.png)
...
4. Klicka på **Molnappar**.
    ...
    ![Molnappar](./media/active-directory-conditional-access-tou/08.png)

5. På den **Molnappar** sidan:

    ![Välj molnappar](./media/active-directory-conditional-access-tou/26.png)
...
6. I den **åtkomstkontroller** klickar du på **bevilja**.
    ...
    ![Åtkomstkontroller](./media/active-directory-conditional-access-tou/10.png)

7. På den **bevilja** sidan:

    ![Bevilja](./media/active-directory-conditional-access-tou/111.png)
...
8. I den **aktiverar principen** klickar du på **på**.
    ...
    ![Aktivera princip](./media/active-directory-conditional-access-tou/18.png)
...
![Vad händer om principen verktyget](./media/active-directory-conditional-access-tou/79.png)
...
2. Klicka på **användare**väljer **Isabella Simonsen**, och klicka sedan på **Välj**.
    ...
    ![Användare](./media/active-directory-conditional-access-tou/15.png)

2. Att välja en molnapp:

    ![Molnappar](./media/active-directory-conditional-access-tou/16.png)
...
![Användningsvillkor](./media/active-directory-conditional-access-tou/57.png)
...
> [Kräva MFA för specifika appar](./active-directory-conditional-access-app-based-mfa.md)
> [blockera åtkomst när en risk för session har identifierats](./active-directory-conditional-access-app-sign-in-risk.md)
