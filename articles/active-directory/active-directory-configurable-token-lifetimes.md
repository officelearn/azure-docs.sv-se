...
I följande exempel har du skapa, uppdatera, länka och ta bort principer för appar, tjänstens huvudnamn och din organisation. Om du är nybörjare på Azure AD, rekommenderar vi att du lär dig mer om [skaffa en Azure AD-klient](develop/quickstart-create-new-tenant.md) innan du fortsätter med de här exemplen.  
