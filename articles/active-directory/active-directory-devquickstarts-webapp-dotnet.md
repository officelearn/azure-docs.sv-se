...
- Folgen Sie den Assistenten, und erstellen Sie ein neues **Web Application and/or WebAPI**.
    ...
    -   Die **Anmelde-URL** ist die Basis-URL der app.  Der Standardwert des Gerüsts ist `https://localhost:44320/`.
...
-   Projekt eine OWIN-Startklasse hinzufügen `Startup.cs`  rechts auf das Projekt-- **Hinzufügen** --> **Neues Element** aus, und suchen Sie nach "OWIN".  Die OWIN-Middleware ruft beim Starten Ihrer Anwendung die Methode `Configuration(...)` auf.
...
Als Referenz das vollständige Beispiel (ohne Ihre Konfigurationswerte) [finden Sie hier](https://github.com/AzureADQuickStarts/WebApp-OpenIdConnect-DotNet/archive/complete.zip).  
