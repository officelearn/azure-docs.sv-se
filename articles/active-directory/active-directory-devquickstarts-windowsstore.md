...
Das vollständige Beispiel (ohne Ihre Konfigurationswerte) dient als Referenz [hier](https://github.com/AzureADQuickStarts/NativeClient-WindowsStore/archive/complete.zip).  Sie können sich nun weiteren Identitätsszenarien zuwenden.  Sie können beispielsweise Folgendes testen:
