...
> [AZURE.NOTE] Die Preisoptionen für diese Editionen finden Sie unter [Azure Active Directory Preise](https://azure.microsoft.com/pricing/details/active-directory/). <br>Azure Active Directory Premium und Azure Active Directory Basic werden derzeit in China nicht unterstützt. Wenn Sie weitere Informationen benötigen, kontaktieren Sie uns im Azure Active Directory-Forum.


- **Azure Active Directory Basic** -Sachbearbeitern mit Cloud-First-Anforderungen vorgesehen,-diese Edition bietet Cloud zentrierte Anwendung Zugriff und Self-Service Identity Management Solutions. Mit der Basic Edition von Azure Active Directory erhalten Sie Funktionen zur Produktivitätssteigerung und Kostensenkung wie gruppenbasierte Zugriffsverwaltung, Self-Service-Kennwortzurücksetzung für Cloud-Anwendungen und den Azure Active Directory-Anwendungsproxy (zur Veröffentlichung lokaler Webanwendungen mit Azure Active Directory). Diese Features basieren auf einer SLA auf Unternehmensebene mit einer Verfügbarkeitsgarantie von 99,9 Prozent.
 
- **Azure Active Directory Premium** – ermöglicht es Organisationen mit anspruchsvoller entworfene Identitäts- und Zugriffsmanagement benötigt, Azure Active Directory Premium Edition fügt Funktionsumfang auf Unternehmensebene Identity Management-Funktionen und ermöglicht Benutzern die Hybrid zur nahtlosen Zugriff auf lokale und cloud-Funktionen. Diese Edition enthält alles, was Sie für Information-Worker und Identitätsadministratoren in Hybridumgebungen für Anwendungszugriff, Self-Service-Identitäts- und Zugriffsverwaltung (Identity and Access Management, IAM), Identitätsschutz und Sicherheit in der Cloud benötigen. Sie unterstützt erweiterte Verwaltungs- und Delegierungsressourcen wie dynamische Gruppen und Self-Service-Gruppenverwaltung. Die Edition enthält Microsoft Identity Manager (eine lokale Identitäts- und Zugriffsverwaltungs-Suite) und bietet Cloudfunktionen für das Zurückschreiben. Dadurch werden Lösungen wie die Self-Service-Kennwortzurücksetzung für Ihre lokalen Benutzer ermöglicht. 

Zum Registrieren und Starten von Active Directory Premium schon heute verwenden, finden Sie unter [Erste Schritte mit Azure Active Directory Premium](active-directory-get-started-premium.md).
...
>-  Azure Multi-Factor Authentication kann über benutzer- oder authentifizierungsspezifische Anbieter genutzt werden. Weitere Informationen finden Sie unter [Was Multi-Factor Authentication ist?](multi-factor-authentication.md) 
...
|  | [Verwaltung von Benutzern und Gruppen (Hinzufügen / Aktualisieren / löschen), Benutzer-basierte Bereitstellung](active-directory-administer.md), [Registrierung des Geräts](active-directory-conditional-access-device-registration-overview.md)| ![Prüfen][12]| ![Prüfen][12]| ![Prüfen][12]| ![Prüfen][12]|
...
|  | **Vorschau**: bedingten Zugriff|  |  | ![Prüfen][12]|  |
|  | **Vorschau**: privilegierten Identitätsmanagement|  |  | ![Prüfen][12]|  |
...
|  | MDM automatische Registrierung von Benutzerzertifikaten, Self-Service-Bitlocker-Wiederherstellung, zusätzliche lokale Administratoren über Azure AD Join Windows 10-Geräte|  |  | ![Prüfen][12]|  |
