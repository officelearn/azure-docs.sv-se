...
g. När du har gjort ovanstående procedur hålla metoden som **korrigering** och klistra in rollen återstående innehåll i den **brödtext i begäran** och på **Kör fråga**.
