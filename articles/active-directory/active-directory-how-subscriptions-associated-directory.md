<properties
    pageTitle="Hur Azure-prenumerationer är associerade med Azure Active Directory | Microsoft Azure"
...
## Konton som du kan använda för att logga in
...
## Hur en Azure-prenumeration är kopplad till Azure AD
...
## Hantera en prenumeration och en katalog
...
## Varför kan jag inte hantera katalogen med mitt aktuella användarkonto?
...
## Hantera en Azure-prenumeration som skapats med hjälp av ett Microsoft-konto med ditt arbets- eller skolkonto
...
## Logga in när du har använt din e-postadress för arbetet för ditt Microsoft-konto
...
### Jag har ingen prenumeration på Azure
...
### Jag har en Azure-prenumeration genom mitt Microsoft-konto
