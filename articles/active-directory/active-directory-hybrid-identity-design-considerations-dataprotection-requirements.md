...
>[AZURE.NOTE]
Wenn Sie fertig sind, Planen der datensicherheit, überprüfen Sie [bestimmen die Anforderungen für mehrstufige Authentifizierung](active-directory-hybrid-identity-design-considerations-multifactor-auth-requirements.md) um sicherzustellen, dass Ihre Auswahl in Bezug auf die Anforderungen für mehrstufige Authentifizierung nicht die Entscheidungen betroffen waren Sie vorgenommen, in diesem Abschnitt haben.
