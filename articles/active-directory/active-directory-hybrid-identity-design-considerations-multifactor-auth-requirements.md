...
>[AZURE.NOTE]
Wenn Sie nicht vertraut mit MFA und was dies der Fall ist sind, wird dringend empfohlen, dass Sie den Artikel lesen [Was Multi-Factor Authentication ist?](multi-factor-authentication.md) vor dem Lesen dieses Abschnitts fortgesetzt.
