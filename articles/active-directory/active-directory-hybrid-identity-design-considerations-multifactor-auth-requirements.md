...
> [!NOTE]
> Om du inte är bekant med MFA och vad det gör vi rekommenderar starkt att du läst artikeln [vad är Azure Multi-Factor Authentication?](authentication/multi-factor-authentication.md) före fortsätta läsa det här avsnittet.
> 
> 
...
[Definiera en hybrid identity införandestrategi](active-directory-hybrid-identity-design-considerations-identity-adoption-strategy.md)
