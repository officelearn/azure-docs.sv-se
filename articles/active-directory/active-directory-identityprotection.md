...
ms.author: markvi
ms.reviewer: nigu
ms.openlocfilehash: a56c9b7cf69898c05eca3b38c165167b8fc39089
...
Azure Active Directory Identity Protection analyserar din konfiguration och identifierar sårbarheter som kan påverka din användaridentitet. Mer information finns i [sårbarheter som identifieras av Azure Active Directory Identity Protection](identity-protection/vulnerabilities.md).
...
Du kan koppla din undersökning aktiviteter till den [meddelanden](identity-protection/notifications.md) Azure Active Directory Protection skickar per e-postmeddelande.
...
* [Riskfylld inloggning återställning](identity-protection/flows.md#risky-sign-in-recovery)
* [Riskfylld inloggning blockerad](identity-protection/flows.md#risky-sign-in-blocked)  
* [Logga in upplevelser med Azure AD Identity Protection](identity-protection/flows.md)  
...
* [Komprometterat konto recovery flow](identity-protection/flows.md#compromised-account-recovery).  
* [Komprometterade kontot har spärrats flow](identity-protection/flows.md#compromised-account-blocked).  
...
* [Flöde för registrering av multifaktorautentisering](identity-protection/flows.md#multi-factor-authentication-registration).  
* [Logga in som inträffar med Azure AD Identity Protection](identity-protection/flows.md).  
...
* [Sårbarheter som identifieras av Azure Active Directory Identity Protection](identity-protection/vulnerabilities.md)

* [Azure Active Directory-riskhändelser](active-directory-identity-protection-risk-events.md)

* [Azure Active Directory Identity Protection-aviseringar](identity-protection/notifications.md)

* [Azure Active Directory Identity Protection spelbok](identity-protection/playbook.md)

* [Azure Active Directory Identity Protection-ordlistan](identity-protection/glossary.md)

* [Logga in upplevelser med Azure AD Identity Protection](identity-protection/flows.md)

* [Azure Active Directory Identity Protection - så avblockera användare](identity-protection/howto-unblock-user.md)
