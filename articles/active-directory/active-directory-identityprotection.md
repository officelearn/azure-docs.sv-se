...
Azure Active Directory Identity Protection analyserar din konfiguration och identifierar sårbarheter som kan påverka din användaridentitet. Mer information finns i [sårbarheter som identifieras av Azure Active Directory Identity Protection](active-directory-identityprotection-vulnerabilities.md).
...
Du kan koppla din undersökning aktiviteter till den [meddelanden](active-directory-identityprotection-notifications.md) Azure Active Directory Protection skickar per e-postmeddelande.
...
Azure Active Directory identifierar [riskhändelsetyper](active-directory-reporting-risk-events.md#risk-event-types) i realtid och offline. Varje riskhändelsen har upptäckts för en inloggning för en användare bidrar till ett logiskt koncept som kallas riskfyllda inloggningen. En riskfylld inloggning är du en indikator för en inloggningsförsök som inte kanske har utförts av är tillförlitligt ägare för ett användarkonto.
...
![Riskprincip för inloggning](./media/active-directory-identityprotection/1014.png "inloggning riskprincipen")
...
* Ange de användare och grupper som principen gäller för:
    ...
    ![Riskprincip för inloggning](./media/active-directory-identityprotection/1015.png "inloggning riskprincipen")
* Ange inloggningsrisk nivå tröskelvärdet (låg, medel eller hög) som utlöser principen:

    ![Riskprincip för inloggning](./media/active-directory-identityprotection/1016.png "inloggning riskprincipen")
* Ange kontroller som ska tillämpas när principen utlöser:  

    ![Riskprincip för inloggning](./media/active-directory-identityprotection/1017.png "inloggning riskprincipen")
...
* Granska och utvärdera effekten av en ändring innan du aktiverar det:
    ...
    ![Riskprincip för inloggning](./media/active-directory-identityprotection/1018.png "inloggning riskprincipen")
...
* [Riskfylld inloggning återställning](active-directory-identityprotection-flows.md#risky-sign-in-recovery)
* [Riskfylld inloggning blockerad](active-directory-identityprotection-flows.md#risky-sign-in-blocked)  
* [Logga in upplevelser med Azure AD Identity Protection](active-directory-identityprotection-flows.md)  
...
- På den **Azure AD Identity Protection** bladet i den **konfigurera** klickar du på **inloggning riskprincipen**.
    ...
    ![Princip för användarrisk](./media/active-directory-identityprotection/1014.png "riskprincip för användare")



## <a name="users-flagged-for-risk"></a>Användare som har flaggats för risk

Alla aktiva [riskhändelser](active-directory-identity-protection-risk-events.md) som identifierades av Azure Active Directory för en användare bidra till ett logiskt koncept som kallas användarrisk. En användare som flaggats för risk är en indikator för ett användarkonto som kan ha komprometterats.

![Användare som har flaggats för risk](./media/active-directory-identityprotection/1200.png)


### <a name="user-risk-level"></a>Nivå för användarrisk
...
1. På den **Azure AD Identity Protection** bladet under **Undersök**, klickar du på **riskhändelser**.
    ...
    ![Återställning av lösenord för manuell](./media/active-directory-identityprotection/1002.png "manuell för lösenordsåterställning")
2. I den **riskhändelser** klickar du på en risk.

    ![Återställning av lösenord för manuell](./media/active-directory-identityprotection/1003.png "manuell för lösenordsåterställning")
3. Högerklicka på en användare på bladet risk.

    ![Återställning av lösenord för manuell](./media/active-directory-identityprotection/1004.png "manuell för lösenordsåterställning")
...
1. På den **Azure AD Identity Protection** bladet klickar du på **användare som har flaggats för risk**.
    ...
    ![Återställning av lösenord för manuell](./media/active-directory-identityprotection/1006.png "manuell för lösenordsåterställning")
2. Välj en användare med minst en riskhändelser från listan över användare.

    ![Återställning av lösenord för manuell](./media/active-directory-identityprotection/1007.png "manuell för lösenordsåterställning")
3. Klicka på användarbladet **Återställ lösenord**.

    ![Återställning av lösenord för manuell](./media/active-directory-identityprotection/1008.png "manuell för lösenordsåterställning")
...
![Princip för användarrisk](./media/active-directory-identityprotection/1009.png "riskprincip för användare")
...
* Ange de användare och grupper som principen gäller för:
    ...
    ![Princip för användarrisk](./media/active-directory-identityprotection/1010.png "riskprincip för användare")
* Ange användaren risk på tröskelvärdet (låg, medel eller hög) som utlöser principen:

    ![Princip för användarrisk](./media/active-directory-identityprotection/1011.png "riskprincip för användare")
* Ange kontroller som ska tillämpas när principen utlöser:

    ![Princip för användarrisk](./media/active-directory-identityprotection/1012.png "riskprincip för användare")
* Växla tillståndet för din princip:

    ![Princip för användarrisk](./media/active-directory-identityprotection/403.png "MFA-registrering")
* Granska och utvärdera effekten av en ändring innan du aktiverar det:

    ![Princip för användarrisk](./media/active-directory-identityprotection/1013.png "riskprincip för användare")
...
* [Komprometterat konto recovery flow](active-directory-identityprotection-flows.md#compromised-account-recovery).  
* [Komprometterade kontot har spärrats flow](active-directory-identityprotection-flows.md#compromised-account-blocked).  
...
![Princip för användarrisk](./media/active-directory-identityprotection/1019.png "riskprincip för användare")
...
* Ange de användare och grupper som principen gäller för:
    ...
    ![MFA-principen](./media/active-directory-identityprotection/1020.png "MFA-principen")
* Ange kontroller som ska tillämpas när principen utlöser::  

    ![MFA-principen](./media/active-directory-identityprotection/1021.png "MFA-principen")
* Växla tillståndet för din princip:

    ![MFA-principen](./media/active-directory-identityprotection/403.png "MFA-principen")
* Visa den aktuella registreringsstatusen:

    ![MFA-principen](./media/active-directory-identityprotection/1022.png "MFA-principen")

En översikt över relaterade användarupplevelsen finns:

* [Flöde för registrering av multifaktorautentisering](active-directory-identityprotection-flows.md#multi-factor-authentication-registration).  
...
- På den **Azure AD Identity Protection** bladet i den **konfigurera** klickar du på **registrering av multifaktorautentisering**.
    ...
    ![MFA-principen](./media/active-directory-identityprotection/1019.png "MFA-principen")
...
* [Aktivera Azure Active Directory Identity Protection](active-directory-identityprotection-enable.md)
...
* [Azure Active Directory Identity Protection spelbok](active-directory-identityprotection-playbook.md)

* [Azure Active Directory Identity Protection-ordlistan](active-directory-identityprotection-glossary.md)

* [Logga in upplevelser med Azure AD Identity Protection](active-directory-identityprotection-flows.md)

* [Azure Active Directory Identity Protection - så avblockera användare](active-directory-identityprotection-unblock-howto.md)
