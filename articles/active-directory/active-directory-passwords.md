...
# Zurücksetzen des Azure AD-Kennworts für Benutzer und Administratoren
  ...
  >[AZURE.IMPORTANT] Sind Sie hier, da Sie Ihre Azure oder Office 365-Kennwort zurücksetzen möchten?  Wenn dies der Fall ist, nehmen Sie [fahren Sie mit diesem Abschnitt](#users-how-to-manage-your-own-password).
...
**Azure AD-Kennwortverwaltung** ist ein Satz von Funktionen, die den Benutzern ermöglicht, alle Kennwörter verwalten von einem beliebigen Gerät jederzeit von einem beliebigen Standort bei der Einhaltung der Sicherheitsrichtlinien, die Sie definieren.
...
- **Self-service-kennwortänderung** können Endbenutzer oder Administratoren ihre abgelaufenen oder nicht abgelaufenen Kennwörter ändern, ohne einen Administrator oder Helpdesk um Unterstützung.
- **Self-service-kennwortzurücksetzung** können Endbenutzer oder Administratoren ihre Kennwörter automatisch zurücksetzen, ohne einen Administrator oder Helpdesk um Unterstützung. Die Self-Service-Kennwortzurücksetzung erfordert Azure AD Premium oder Basic. Weitere Informationen finden Sie unter "Azure Active Directory-Editionen".
- **Zurücksetzen des Kennworts vom Administrator gestartete** ermöglicht es dem Administrator über innerhalb eines Endbenutzers oder ein anderer Administrator das Kennwort zurücksetzen der [Azure-Verwaltungsportal](https://manage.windowsazure.com).
- **Berichte zu kennwortverwaltungsaktivitäten** bieten Administratoren Einblicke in die kennwortzurücksetzung und-Registrierung Aktivitäten in ihrem Unternehmen ereignen. 
- **Das Rückschreiben von Kennwörtern** ermöglicht die Verwaltung von lokalen Kennwörtern aus der Cloud, sodass alle oben genannten Szenarien von oder im Auftrag von ausgeführt werden können, Verbund- oder kennwortsynchronisierten Benutzern. Für das Rückschreiben von Kennwörtern ist Azure AD Premium erforderlich. Weitere Informationen finden Sie unter "Erste Schritte mit Azure AD Premium".
...
- **Senken** -Support unterstützte Reset ist in der Regel 20 % des Unternehmens IT investieren
- **Verbessern der Benutzerfunktionalität** -Benutzer möchten nicht beim Helpdesk anrufen und eine Stunde am Telefon verbringen, jedes Mal, wenn sie ihre Kennwörter vergessen haben
- **Verringerter helpdeskaufwand** -kennwortverwaltung ist in den größten Helpdesk für die meisten Organisationen
- **Mobilität** -Benutzer können ihre Kennwörter unabhängig vom Standort zurücksetzen

### Preise und Verfügbarkeit
Die Azure AD-Kennwortzurücksetzung steht in drei Tarifen zur Verfügung, abhängig von Ihrem Abonnement:

- **Kostenlosen** -nur-Cloud-Administratoren können ihre eigenen Kennwörter zurücksetzen
- **Azure AD Basic oder beliebige kostenpflichtige Office 365-Abonnements** -nur-Cloud-Benutzer und nur-Cloud-Administratoren können ihre eigenen Kennwörter zurücksetzen
- **Azure AD Premium** – alle Benutzer oder Administrator, darunter nur-Cloud-, Verbund oder Kennwort synchronisiert-Benutzer können ihre eigenen Kennwörter zurücksetzen (erfordert [das Rückschreiben von Kennwörtern aktiviert sein](active-directory-passwords-getting-started.md#enable-users-to-reset-or-change-their-ad-passwords))

Weitere Informationen zu Azure AD Premium oder Basic Preise, finden Sie auf der [Active Directory-Preisdetails](https://azure.microsoft.com/pricing/details/active-directory/) Seite.
...
| Thema |  |
| --------- | --------- |
| Wie setze ich das Kennwort eines Benutzers im Office 365-Verwaltungsportal zurück? | [Zurücksetzen des Kennworts eines Benutzers in Office 365](https://support.office.com/article/Reset-a-user-s-password-7A5D073B-7FAE-4AA5-8F96-9ECD041ABA9C) |
...
| Thema |  |
| --------- | --------- |
| Ich möchte wissen, was das Rückschreiben von Kennwörtern ist. | [Übersicht über die Kennwortrückschreibung](active-directory-passwords-learn-more.md#password-writeback-overview) |
...
| Ich möchte wissen, welche Szenarien von der Funktion zum Kennwortrückschreiben unterstützt werden. | [Unterstützte Szenarien für die Kennwortrückschreibung](active-directory-passwords-learn-more.md#scenarios-supported-for-password-writeback) |
| Ich möchte wissen, wie beim Kennwortrückschreiben die Sicherheit gewährleistet wird. | [Sicherheitsmodell für die Kennwortrückschreibung](active-directory-passwords-learn-more.md#password-writeback-security-model) |
...
| Erfahren Sie mehr darüber, welche Daten von Zurücksetzen des Kennworts verwendet werden soll | [Welche Daten werden bei der Kennwortzurücksetzung verwendet?](active-directory-passwords-learn-more.md#what-data-is-used-by-password-reset) |
...
- Nun können die Daten hinter dem Kennwort zurücksetzen Berichte abgerufen werden, direkt aus der [Azure AD-Berichte und Ereignis-API](https://msdn.microsoft.com/library/azure/mt126081.aspx#BKMK_SsprActivityEvent).
...
- Zusätzlich zum Erzwingen der Registrierung bei der Anmeldung bei myapps.microsoft.com, jetzt die Unterstützung beim Erzwingen Registrierung bei Anmeldungen beim Azure-Verwaltungsportal und keines der Verbund für einmaliges Anmelden Applications
...
**Unterstützung für erinnert Benutzer aktualisieren ihre Daten registriert während anmelden** -In Bearbeitung
