...
ms.locfileid: "37448177"
---
# <a name="using-the-audit-log-in-pim"></a>Använda granskningsloggen i PIM
Du kan använda granskningsloggen Privileged Identity Management (PIM) för att se alla användartilldelningar och aktiveringar inom en viss tidsperiod. Om du vill visa fullständig granskningshistorik för aktiviteten i din klient, inklusive administratören, slutanvändare och synkroniseringsåtgärden, kan du använda den [rapporter för åtkomst och användning av Azure Active Directory.](active-directory-view-access-usage-reports.md)
