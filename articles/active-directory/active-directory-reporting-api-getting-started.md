...
- Klicken Sie auf der unteren Leiste auf "Hinzufügen".
    ...
    - **Namen**: jeder Name ist in Ordnung. Ein Eintrag wie "Reporting-API-Anwendung" wird empfohlen.
    - **Typ**: Wählen Sie "Web Application and/or Web API".
...
- Klicken Sie auf die **konfigurieren** Registerkarte.
- Im Abschnitt "Berechtigungen für andere Anwendungen":
    - In der Microsoft Azure Active Directory > Wählen Sie die Berechtigungen der Anwendung **Lesen der Verzeichnisdaten**.
- Klicken Sie auf **Speichern** in der unteren Leiste.
...
- Navigieren Sie zur Registerkarte "Anwendungen".
- Navigieren Sie zu Ihrer neu erstellten Anwendung.
- Navigieren Sie zu der **konfigurieren** Registerkarte.
- Die Anwendung Client-ID wird aufgelistet, auf die **Client-ID** Feld.
...
- Es gibt keine Beschränkung für die Anzahl der von der Azure AD Reporting-API (mithilfe von OData-Paginierung) zurückgegebenen Ereignisse.
    - Aufbewahrung-Grenzwerte für die Berichtsdaten, sehen Sie sich [Aufbewahrungsrichtlinien Reporting](active-directory-reporting-retention.md).
...
- Finden Sie unter [Azure AD-Überwachungsberichtsereignisse](active-directory-reporting-audit-events.md) ausführliche Informationen zum Überwachungsbericht
- Finden Sie unter [Azure AD-Berichte und-Ereignisse (Vorschau)](https://msdn.microsoft.com/library/azure/mt126081.aspx) ausführliche Informationen zum Graph-API-REST-Dienst
