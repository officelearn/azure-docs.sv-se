...
> [AZURE.TIP] Weitere Dokumentationen zu Azure AD Reporting finden Auschecken [Anzeigen von Zugriffs- und Nutzungsberichten](active-directory-view-access-usage-reports.md).
...
Zunächst müssen Sie sich in der [klassischen Azure-Portal](https://manage.windowsazure.com)  als globaler oder Kompatibilitätsadministrator-Administrator. Sie müssen außerdem ein Azure-Abonnementdienstadministrator oder -Co-Administrator sein, bzw. das Azure-Abonnement "Zugriff auf Azure AD" benutzen.
...
Navigieren Sie zu jedem Bericht, um die gesammelten Daten und die verarbeiteten Anmeldungen zu sehen. Sie finden eine [Liste aller Berichte hier](active-directory-reporting-what-it-is.md).
...
Informationen dazu, welche Ereignisse überwacht werden, im Verzeichnis [Azure Active Directory-Überwachungsberichtsereignisse](active-directory-reporting-audit-events.md).
...
E-Mail-Adresse [aadreportinghelp@microsoft.com](mailto:aadreportinghelp@microsoft.com) für Feedback, Hilfe oder Fragen Sie möglicherweise!
