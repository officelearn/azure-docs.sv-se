...
4. I sökrutan skriver **amplitud**väljer **amplitud** resultatet-panelen klickar **Lägg till** för att lägga till programmet.
    ...
    ![Amplitud i resultatlistan](./media/active-directory-saas-amplitude-tutorial/tutorial_amplitude_addfromgallery.png)
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/active-directory-saas-amplitude-tutorial/tutorial_amplitude_samlbase.png)

3. På den **amplitud domän och URL: er** avsnittet, utför följande steg om du vill konfigurera programmet i **IDP** initierade läge:

    ![URL: er och amplitud domän med enkel inloggning information](./media/active-directory-saas-amplitude-tutorial/tutorial_amplitude_url.png)
...
4. Kontrollera **visa avancerade inställningar för URL: en** och utför följande steg om du vill konfigurera programmet i **SP** initierade läge:
    ...
    ![URL: er och amplitud domän med enkel inloggning information](./media/active-directory-saas-amplitude-tutorial/tutorial_amplitude_url1.png)

    I den **inloggnings-URL** textruta anger du URL: `https://analytics.amplitude.com/sso`

5. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.

    ![Länken hämta certifikatet](./media/active-directory-saas-amplitude-tutorial/tutorial_amplitude_certificate.png) 

6. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/active-directory-saas-amplitude-tutorial/tutorial_general_400.png)
...
8. Klicka på den **planera Admin** från det vänstra navigeringsfältet.
    ...
    ![Konfigurera enkel inloggning](./media/active-directory-saas-amplitude-tutorial/configure1.png)

9. Välj **Microsoft Azure Active Directory Metadata** från den **SSO Integration**.

    ![Konfigurera enkel inloggning](./media/active-directory-saas-amplitude-tutorial/configure2.png)

10. På den **ställa in enkel inloggning** avsnittet, utför följande steg:

    ![Konfigurera enkel inloggning](./media/active-directory-saas-amplitude-tutorial/configure3.png)
...
1. I Azure-portalen i den vänstra rutan klickar du på den **Azure Active Directory** knappen.
    ...
    ![Azure Active Directory-knappen](./media/active-directory-saas-amplitude-tutorial/create_aaduser_01.png)

2. Om du vill visa en lista över användare, gå till **användare och grupper**, och klicka sedan på **alla användare**.

    ![”Användare och grupper” och ”alla användare” länkar](./media/active-directory-saas-amplitude-tutorial/create_aaduser_02.png)

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i den **alla användare** dialogrutan.

    ![Knappen Lägg till](./media/active-directory-saas-amplitude-tutorial/create_aaduser_03.png)

4. I den **användaren** dialogrutan utför följande steg:

    ![Dialogrutan användare](./media/active-directory-saas-amplitude-tutorial/create_aaduser_04.png)
...
2. Välj i listan med program **amplitud**.
    ...
    ![Länken amplitud i listan med program](./media/active-directory-saas-amplitude-tutorial/tutorial_amplitude_app.png)  
