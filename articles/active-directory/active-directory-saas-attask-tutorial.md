...
Dieses Lernprogramm wird gezeigt, wie @Task mit Azure Active Directory (Azure AD) integrieren.<br>Integration von Azure AD @Task bietet Ihnen folgende Vorteile: 
...
6. Geben Sie in das Suchfeld **@Task**.
<br><br>![Clientanwendungen][5] <br>

7. Wählen Sie im Ergebnisbereich **@Task**, und klicken Sie dann auf **abgeschlossen** um die Anwendung hinzuzufügen.
<br><br>![Clientanwendungen][30] <br>
...
Damit einmaliges Anmelden funktioniert, muss Azure AD wissen, welcher Benutzer in @Task als Gegenbenutzer zu einem Benutzer in Azure AD fungiert. Das heißt, muss eine linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in @Task eingerichtet werden.<br>
Diese linkbeziehung wird durch Zuweisen des Werts der hergestellt der **Benutzername** in Azure AD als Wert für die **Benutzername** in @Task.
...
4. **[Erstellen eines Benutzers @Tasktest](#creating-a-halogen-software-test-user)** - haben eine Entsprechung Britta Simon in @Taskthat der Azure AD-Darstellung Ihrer verknüpft ist.
...
Ziel dieses Abschnitts ist Azure AD einmaliges Anmelden in Azure AD-Portal aktivieren und konfigurieren Sie einmaliges Anmelden in Ihrer Anwendung @Task.<br>

**Führen Sie zum Konfigurieren des einmaligen Anmeldens von Azure AD in @Task die folgenden Schritte aus:**

1. In Azure AD-Portal auf der **@Task** AHA klicken Sie auf **einmaliges Anmelden konfigurieren** zum Öffnen der **Konfigurieren Sie einmaliges Anmelden**  Dialogfeld.
<br><br> ![Einmaliges Anmelden konfigurieren][6] <br>

2. Auf der **wie sollen sich Benutzer anmelden @Task** Seite **Azure AD Single Sign-On**, und klicken Sie dann auf **Weiter**.
...
<br><br>![Konfigurieren von App-Einstellungen][8] <br>
     ...
     a. In der **-Anmelde-URL** Textfeld die URL ein, Ihre Benutzer für die Anmeldung bei der @Task-Anwendung (z. B.:*https://<Tenant name>.attask ondemand.com*).

     b. Klicken Sie auf **Weiter**.

4. Auf der **Konfigurieren Sie einmaliges Anmelden, um @Task** auf **Metadaten**, speichern Sie die Metadatendatei lokal auf Ihrem Computer, und klicken Sie dann auf **Weiter**.
...
1. Auf der **Single Sign-On** im Dialogfeld die folgenden Schritte ausführen
<br><br>![Einmaliges Anmelden konfigurieren][23]<br>

    a. Als **Typ**, Option **SAML 2.0**.

    b. Wählen Sie **Dienstanbieter-ID**.

    c. Kopieren Sie auf Azure-Portal die **Remote-Anmelde-URL**, und fügen Sie ihn in die **Portal-Anmelde-URL** Textfeld.

    d. Kopieren Sie auf Azure-Portal die **Dienst-URL für einmalige Abmeldung**, und fügen Sie ihn in die **URL Abmeldung** Textfeld.

    e. Kopieren Sie auf Azure-Portal die **Kennwort-URL ändern**, und fügen Sie ihn in die **Kennwort-URL ändern** Textfeld.
...
![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-attask-tutorial/create_aaduser_02.png) 

2. Aus der **Verzeichnis** wählen Sie das Verzeichnis für die Verzeichnisintegration aktiviert werden sollen.

3. Klicken Sie zum Anzeigen der Liste der Benutzer im Menü am oberen Rand **Benutzer**.<br>![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-attask-tutorial/create_aaduser_03.png) 
 
4. Zum Öffnen der **Add User** Klicken Sie im Dialogfeld in der Symbolleiste am unteren Bildschirmrand auf **Benutzer hinzufügen**. <br>![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-attask-tutorial/create_aaduser_04.png) 

5. Auf der **Erzählen Sie uns dieses Benutzers** Dialogfeld führen die folgenden Schritte aus: <br>![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-attask-tutorial/create_aaduser_05.png) 
...
<br><br>![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-attask-tutorial/create_aaduser_06.png) <br>
...
<br><br> ![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-attask-tutorial/create_aaduser_07.png) <br>
 
8. Auf der **vorübergehendes Kennwort abrufen** Dialogfeld führen die folgenden Schritte aus:
<br><br>![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-attask-tutorial/create_aaduser_08.png) <br>
...
2. Klicken Sie im Menü am oberen Rand **Personen**.

3. Klicken Sie auf **neue Person**. 

4. Führen Sie im Dialogfeld „Neue Person“ die folgenden Schritte aus:
<br><br>![@Task-Testbenutzer erstellen][21] <br>

    a. In der **Vorname** Textbox, geben Sie "Britta".

    b. In der **Nachname** Textbox, geben Sie "Simon".

    c. In der **e-Mail-Adresse** Textfeld Geben Sie die e-Mail-Adresse des Britta Simon in Azure Active Directory.
...
Das Ziel dieses Abschnitts ist das Britta Simon Azure einmaliges Anmelden verwenden, indem gewährt keinen Zugriff auf @Task aktivieren.
