...
4. I sökrutan skriver **BitaBIZ**väljer **BitaBIZ** resultatet-panelen klickar **Lägg till** för att lägga till programmet.
    ...
    ![BitaBIZ i resultatlistan](./media/active-directory-saas-bitabiz-tutorial/tutorial_bitabiz_addfromgallery.png)
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/active-directory-saas-bitabiz-tutorial/tutorial_bitabiz_samlbase.png)
...
5. På den **SAML-signeringscertifikat** klickar du på **Certificate(Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/active-directory-saas-bitabiz-tutorial/tutorial_bitabiz_certificate.png) 

6. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/active-directory-saas-bitabiz-tutorial/tutorial_general_400.png)
...
1. I Azure-portalen i den vänstra rutan klickar du på den **Azure Active Directory** knappen.
    ...
    ![Azure Active Directory-knappen](./media/active-directory-saas-bitabiz-tutorial/create_aaduser_01.png)

2. Om du vill visa en lista över användare, gå till **användare och grupper**, och klicka sedan på **alla användare**.

    ![”Användare och grupper” och ”alla användare” länkar](./media/active-directory-saas-bitabiz-tutorial/create_aaduser_02.png)

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i den **alla användare** dialogrutan.

    ![Knappen Lägg till](./media/active-directory-saas-bitabiz-tutorial/create_aaduser_03.png)

4. I den **användaren** dialogrutan utför följande steg:

    ![Dialogrutan användare](./media/active-directory-saas-bitabiz-tutorial/create_aaduser_04.png)
...
2. Klicka på **installationsprogrammet ADMIN**.
    ...
    ![BitaBIZ lägga till användare](./media/active-directory-saas-bitabiz-tutorial/settings1.png)

3. Klicka på **lägga till användare** under **organisation** avsnitt.

    ![BitaBIZ lägga till användare](./media/active-directory-saas-bitabiz-tutorial/user1.png)

4. Klicka på **Lägg till ny medarbetare**.

    ![BitaBIZ lägga till användare](./media/active-directory-saas-bitabiz-tutorial/user2.png)

5. På den **”Lägg till ny medarbetare”** dialogrutan utför följande steg:

    ![BitaBIZ lägga till användare](./media/active-directory-saas-bitabiz-tutorial/user3.png)
...
2. Välj i listan med program **BitaBIZ**.
    ...
    ![Länken BitaBIZ i listan med program](./media/active-directory-saas-bitabiz-tutorial/tutorial_bitabiz_app.png)  
