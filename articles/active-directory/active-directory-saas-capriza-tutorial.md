...
Dieses Lernprogramm wird gezeigt, wie Capriza mit Azure Active Directory (Azure AD) integrieren.<br>Integration von Azure AD Capriza bietet Ihnen folgende Vorteile:
...
1. Klicken Sie in der klassischen Azure-Portal im linken Navigationsbereich auf **Active Directory**. <br><br>
...
6. Geben Sie in das Suchfeld **Capriza**.<br><br>
![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-capriza-tutorial/tutorial_capriza_01.png)<br>
7. Wählen Sie im Ergebnisbereich **Capriza**, und klicken Sie dann auf **abgeschlossen** um die Anwendung hinzuzufügen.
<br><br>
...
Damit einmaliges Anmelden funktioniert, muss Azure AD wissen, welcher Benutzer in Capriza als Gegenbenutzer zu einem Benutzer in Azure AD fungiert. Das heißt, muss eine linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in Capriza eingerichtet werden.<br>
Diese linkbeziehung wird durch Zuweisen des Werts der hergestellt der **Benutzername** in Azure AD als Wert für die **Benutzername** in Capriza.
...
4. **[Erstellen einen Testbenutzer Capriza](#creating-a-capriza-test-user)** – ein Gegenstück zur Britta Simon Capriza enthalten, die in Azure AD-Darstellung Ihrer verknüpft ist.
...
1. In der klassischen Azure-Portal auf der **Capriza** AHA klicken Sie auf **einmaliges Anmelden konfigurieren** zum Öffnen der **Konfigurieren Sie einmaliges Anmelden**  Dialogfeld.
<br><br> ![Einmaliges Anmelden konfigurieren][6] <br>

2. Auf der **wie sollen sich Benutzer anmelden Capriza** Seite **Azure AD Single Sign-On**, und klicken Sie dann auf **Weiter**.
<br><br> ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-capriza-tutorial/tutorial_capriza_03.png) <br>

3. Auf der **App-Einstellungen konfigurieren** Dialogfeld führen die folgenden Schritte aus:
<br><br>![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-capriza-tutorial/tutorial_capriza_04.png) <br>
...
4. Auf der **Capriza einmaliges Anmelden konfigurieren** führen die folgenden Schritte aus:
<br><br>![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-capriza-tutorial/tutorial_capriza_05.png) <br>
...
5. Um SSO-konfiguriert für Ihre Anwendung zu erhalten, wenden Sie sich an das Supportteam von Capriza über support@capriza.com und fügen Sie die heruntergeladene Datei an Ihre e-Mail-Adresse. Geben Sie außerdem die SAML-SSO-URL, die Abmelde-URL und die Aussteller-URL an, damit diese für die SSO-Integration (Single Sign-On, einmaliges Anmelden) konfiguriert werden können.
...
<br><br>![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-capriza-tutorial/create_aaduser_09.png) <br>

2. Aus der **Verzeichnis** wählen Sie das Verzeichnis für die Verzeichnisintegration aktiviert werden sollen.

3. Klicken Sie zum Anzeigen der Liste der Benutzer im Menü am oberen Rand **Benutzer**.
<br><br> ![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-capriza-tutorial/create_aaduser_03.png) <br>
...
<br><br> ![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-capriza-tutorial/create_aaduser_04.png) <br>

5. Auf der **Erzählen Sie uns dieses Benutzers** Dialogfeld führen die folgenden Schritte aus:
<br><br> ![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-capriza-tutorial/create_aaduser_05.png) <br>
...
<br><br>![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-capriza-tutorial/create_aaduser_06.png) <br>
...
<br><br> ![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-capriza-tutorial/create_aaduser_07.png) <br>

8. Auf der **vorübergehendes Kennwort abrufen** Dialogfeld führen die folgenden Schritte aus:
<br><br>![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-capriza-tutorial/create_aaduser_08.png) <br>
...
Das Ziel dieses Abschnitts ist das Erstellen eines Benutzers namens Britta Simon in Capriza. Capriza unterstützt die Just-in-Time-Bereitstellung, die standardmäßig aktiviert ist. **Stellen Sie sicher, dass Ihren Domänennamen für Benutzer bereitstellen mit Capriza konfiguriert ist. Danach kann nur die just-in-Time-benutzerbereitstellung verwendet werden.**

Für Sie steht in diesem Abschnitt kein Aktionselement zur Verfügung. Wenn noch kein Benutzer vorhanden ist, wird beim Zugreifen auf Capriza ein neuer Benutzer erstellt. [Konfigurieren von Azure AD Single Sign-On](#configuring-azure-ad-single-single-sign-on).

> [AZURE.NOTE] Wenn Sie einen Benutzer manuell erstellen möchten, müssen Sie der Capriza-Supportteam wenden.


### Zuweisen des Azure AD-Testbenutzers

Das Ziel dieses Abschnitts ist das Aktivieren von Britta Simon Azure einmaliges Anmelden zu verwenden, indem Capriza keinen Zugriff erteilen.
...
<br><br>![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-capriza-tutorial/tutorial_capriza_50.png) <br>
...
Wenn Sie im Zugriffsbereich auf die Kachel „Capriza“ klicken, sollten Sie automatisch bei Ihrer Capriza-Anwendung angemeldet werden.
