...
I kursen får lära du att integrera ClearCompany med Azure Active Directory (AD Azure).
...
- En ClearCompany enkel inloggning på aktiverade prenumeration
...
Du måste lägga till ClearCompany från galleriet i listan över hanterade SaaS-appar för att konfigurera integrering av ClearCompany i Azure AD.
...
4. I sökrutan skriver **ClearCompany**väljer **ClearCompany** resultatet-panelen klickar **Lägg till** för att lägga till programmet.
    ...
    ![ClearCompany i resultatlistan](./media/active-directory-saas-clearcompany-tutorial/tutorial_clearcompany_addfromgallery.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurera och testa Azure AD enkel inloggning

I det här avsnittet kan du konfigurera och testa Azure AD enkel inloggning med ClearCompany baserat på en testanvändare som kallas ”Britta Simon”.

Azure AD måste du känna till användaren i ClearCompany motsvarighet till en användare i Azure AD för enkel inloggning ska fungera. Med andra ord måste en länk förhållandet mellan en Azure AD-användare och relaterade användaren i ClearCompany upprättas.

I ClearCompany, tilldela värdet för den **användarnamn** i Azure AD som värde för den **användarnamn** etablera länken relationen.
...
3. **[Skapa en testanvändare ClearCompany](#create-a-clearcompany-test-user)**  – du har en motsvarighet för Britta Simon i ClearCompany som är kopplad till Azure AD-representation av användaren.
...
1. I Azure-portalen på den **ClearCompany** integreringssidan för programmet, klickar du på **enkel inloggning**.

    ![Konfigurera enkel inloggning länk][4]

2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
 
    ![Enkel inloggning dialogrutan](./media/active-directory-saas-clearcompany-tutorial/tutorial_clearcompany_samlbase.png)

3. På den **ClearCompany domän och URL: er** avsnittet, utför följande steg om du vill konfigurera programmet i IDP initierade läge:
...
5. På den **SAML-signeringscertifikat** klickar du på **Certificate(Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/active-directory-saas-clearcompany-tutorial/tutorial_clearcompany_certificate.png) 

6. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/active-directory-saas-clearcompany-tutorial/tutorial_general_400.png)
    
7. På den **ClearCompany Configuration** klickar du på **konfigurera ClearCompany** att öppna **konfigurera inloggning** fönster. Kopiera den **SAML enkel inloggning Tjänstwebbadress** från den **Snabbreferens avsnitt.**

    ![ClearCompany konfiguration](./media/active-directory-saas-clearcompany-tutorial/tutorial_clearcompany_configure.png) 

8. Konfigurera enkel inloggning på **ClearCompany** sida, måste du skicka den hämtade **Certificate(Base64)** och **SAML enkel inloggning Tjänstwebbadress** till [ ClearCompany supportteamet](http://www.clearcompany.com/support). De kan ange den här inställningen att ha SAML SSO anslutningen korrekt på båda sidor.
...
1. I Azure-portalen i den vänstra rutan klickar du på den **Azure Active Directory** knappen.
    ...
    ![Azure Active Directory-knappen](./media/active-directory-saas-clearcompany-tutorial/create_aaduser_01.png)

2. Om du vill visa en lista över användare, gå till **användare och grupper**, och klicka sedan på **alla användare**.

    ![”Användare och grupper” och ”alla användare” länkar](./media/active-directory-saas-clearcompany-tutorial/create_aaduser_02.png)

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i den **alla användare** dialogrutan.

    ![Knappen Lägg till](./media/active-directory-saas-clearcompany-tutorial/create_aaduser_03.png)

4. I den **användaren** dialogrutan utför följande steg:

    ![Dialogrutan användare](./media/active-directory-saas-clearcompany-tutorial/create_aaduser_04.png)
...
### <a name="create-a-clearcompany-test-user"></a>Skapa en testanvändare ClearCompany
...
I det här avsnittet kan du aktivera Britta Simon att använda Azure enkel inloggning genom att bevilja åtkomst till ClearCompany.

![Tilldela rollen][200] 

**Om du vill tilldela ClearCompany Britta Simon utför du följande steg:**

1. Öppna vyn program i Azure-portalen och gå till vyn directory och gå till **företagsprogram** Klicka **alla program**.

    ![Tilldela användare][201] 

2. Välj i listan med program **ClearCompany**.

    ![Länken ClearCompany i listan med program](./media/active-directory-saas-clearcompany-tutorial/tutorial_clearcompany_app.png)  
...
När du klickar på panelen ClearCompany på åtkomstpanelen du bör få automatiskt loggat in på ditt ClearCompany program.
