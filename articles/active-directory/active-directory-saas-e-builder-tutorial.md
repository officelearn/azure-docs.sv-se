...
Nach Abschluss dieses Lernprogramms, E-Builder zugewiesene, Azure AD-Benutzer werden mit einmaligem Anmelden bei der Anwendung auf Ihrer e-Builder-Unternehmenssite (vom Dienstanbieter initiierte Anmeldung) oder über die [Einführung in den Zugriffsbereich](active-directory-saas-access-panel-introduction.md).
...
6.  In der **Suchfeld**, Typ **e-Builder**.

    ![Anwendungskatalog](./media/active-directory-saas-e-builder-tutorial/IC777379.png "Application gallery")

7.  Wählen Sie im Ergebnisbereich **e-Builder**, und klicken Sie dann auf **abgeschlossen** um die Anwendung hinzuzufügen.
...
1.  In Azure AD-Portal auf der **E-Builder** AHA klicken Sie auf **einmaliges Anmelden konfigurieren** zum Öffnen der ** einmaliges Anmelden konfigurieren ** Dialogfeld.

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-e-builder-tutorial/IC777381.png "Configure single sign-on")

2.  Auf der **wie sollen sich Benutzer bei E-Builder anmelden** Seite **Microsoft Azure AD Single Sign-On**, und klicken Sie dann auf **Weiter**.

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-e-builder-tutorial/IC777382.png "Configure single sign-on")

3.  Auf der **App-URL konfigurieren** auf der Seite die **e-Builder-Anmelde-URL** Textfeld Ihre URL nach dem Muster "*https://\<tenant-name\>.e-Builder.com*", und klicken Sie dann auf **Weiter**.

    ![App-URL konfigurieren](./media/active-directory-saas-e-builder-tutorial/IC777383.png "Configure app URL")

4.  Auf der **einmaliges Anmelden für E-Builder konfigurieren** Seite, um Ihre Metadaten herunterzuladen, klicken Sie **Metadaten**, und klicken Sie dann die Datendatei lokal als **c:\\E-BuilderMetaData.xml**.
...
6.  Wählen Sie die Konfiguration von SSO Bestätigung, und klicken Sie dann auf **abgeschlossen** Schließen die **einmaliges Anmelden konfigurieren für** Dialogfeld.
    ...
    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-e-builder-tutorial/IC777385.png "Configure single sign-on")
...
2.  Auf der ** e-Builder ** anwendungsintegrationsseite, klicken Sie auf **Zuweisen von Benutzern**.
