...
I kursen får lära du att integrera EasyTerritory med Azure Active Directory (AD Azure).
...
- En EasyTerritory enkel inloggning på aktiverade prenumeration
...
Du måste lägga till EasyTerritory från galleriet i listan över hanterade SaaS-appar för att konfigurera integrering av EasyTerritory i Azure AD.
...
4. I sökrutan skriver **EasyTerritory**väljer **EasyTerritory** resultatet-panelen klickar **Lägg till** för att lägga till programmet.
...
I det här avsnittet kan du konfigurera och testa Azure AD enkel inloggning med EasyTerritory baserat på en testanvändare som kallas ”Britta Simon”.

Azure AD måste du känna till användaren i EasyTerritory motsvarighet till en användare i Azure AD för enkel inloggning ska fungera. Med andra ord måste en länk förhållandet mellan en Azure AD-användare och relaterade användaren i EasyTerritory upprättas.

I EasyTerritory, tilldela värdet för den **användarnamn** i Azure AD som värde för den **användarnamn** etablera länken relationen.
...
3. **[Skapa en testanvändare EasyTerritory](#create-a-easyterritory-test-user)**  – du har en motsvarighet för Britta Simon i EasyTerritory som är kopplad till Azure AD-representation av användaren.
...
1. I Azure-portalen på den **EasyTerritory** integreringssidan för programmet, klickar du på **enkel inloggning**.
...
3. På den **EasyTerritory domän och URL: er** avsnittet, utför följande steg om du vill konfigurera programmet i IDP initierade läge:
...
7. Konfigurera enkel inloggning på **EasyTerritory** sida, måste du skicka den hämtade **XML-Metadata för** till [EasyTerritory supportteamet](mailto:sales@easyterritory.com). De kan ange den här inställningen att ha SAML SSO anslutningen korrekt på båda sidor.
...
### <a name="create-a-easyterritory-test-user"></a>Skapa en testanvändare EasyTerritory

I det här avsnittet skapar du en användare som kallas Britta Simon i EasyTerritory. Se tillsammans med [EasyTerritory supportteamet](mailto:sales@easyterritory.com) att lägga till användare i EasyTerritory-plattformen.

### <a name="assign-the-azure-ad-test-user"></a>Tilldela Azure AD-testanvändare

I det här avsnittet kan du aktivera Britta Simon att använda Azure enkel inloggning genom att bevilja åtkomst till EasyTerritory.

![Tilldela rollen][200] 

**Om du vill tilldela EasyTerritory Britta Simon utför du följande steg:**

1. Öppna vyn program i Azure-portalen och gå till vyn directory och gå till **företagsprogram** Klicka **alla program**.

    ![Tilldela användare][201] 

2. Välj i listan med program **EasyTerritory**.
...
När du klickar på panelen EasyTerritory på åtkomstpanelen du bör få automatiskt loggat in på ditt EasyTerritory program.
