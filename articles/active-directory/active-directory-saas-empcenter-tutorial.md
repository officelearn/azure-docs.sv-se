...
Nach Abschluss dieses Lernprogramms EmpCenter zugewiesene Azure AD-Benutzer werden mit der Anwendung auf Ihrer EmpCenter-Unternehmenswebsite (vom Dienstanbieter initiierte Anmeldung) anmelden oder über die [Einführung in den Zugriffsbereich](active-directory-saas-access-panel-introduction.md).
...
6.  In der **Suchfeld**, Typ **EmpCenter**.

    ![Anwendungskatalog](./media/active-directory-saas-empcenter-tutorial/IC802917.png "Application Gallery")

7.  Wählen Sie im Ergebnisbereich **EmpCenter**, und klicken Sie dann auf **abgeschlossen** um die Anwendung hinzuzufügen.
...
1.  In Azure AD-Portal auf der **EmpCenter** anwendungsintegrationsseite klicken Sie auf **einmaliges Anmelden konfigurieren** Öffnen der ** einmaliges Anmelden konfigurieren ** Dialogfeld.

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-empcenter-tutorial/IC802919.png "Configure Single Sign-On")

2.  Auf der **wie sollen sich Benutzer anmelden EmpCenter** Seite **Microsoft Azure AD Single Sign-On**, und klicken Sie dann auf **Weiter**.
...
3.  Auf der **App-Einstellungen konfigurieren** führen die folgenden Schritte aus:
    ...
    ![Konfigurieren von App-Einstellungen](./media/active-directory-saas-empcenter-tutorial/IC802921.png "Configure App Settings")

    1.  In der **-Anmelde-URL** Textfeld die URL ein, Ihre Benutzer für die Anmeldung bei der EmpCenter-Anwendung (z. B.: *https://partner-authenticati.empcenter.com/workforce/SSO.do*).
    2.  Klicken Sie auf **Weiter**

4.  Auf der **EmpCenter einmaliges Anmelden konfigurieren** zum Herunterladen Ihrer Metadaten klicken **Metadaten**, und speichern Sie die Metadatendatei auf Ihrem Computer.
...
5.  Senden Sie die heruntergeladene Metadatendatei an das Supportteam von EmpCenter.
    ...
    >[AZURE.NOTE] Ihr EmpCenter-Supportteam muss die tatsächliche SSO-Konfiguration.
...
>[AZURE.NOTE] Können Sie alle anderen EmpCenter Benutzerkonten oder APIs von EmpCenter für die Bereitstellung von Azure Active Directory-Benutzerkonten.
...
2.  Auf der ** EmpCenter ** anwendungsintegrationsseite, klicken Sie auf **Zuweisen von Benutzern**.
