...
4. I sökrutan skriver **Envi MMIS**väljer **Envi MMIS** resultatet-panelen klickar **Lägg till** för att lägga till programmet.
    ...
    ![Envi MMIS i resultatlistan](./media/active-directory-saas-envimmis-tutorial/tutorial_envimmis_addfromgallery.png)
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/active-directory-saas-envimmis-tutorial/tutorial_envimmis_samlbase.png)
...
3. På den **Envi MMIS domän och URL: er** avsnittet, utför följande steg om du vill konfigurera programmet i **IDP** initierade läge:
    ...
    ![URL: er och Envi MMIS domän med enkel inloggning information](./media/active-directory-saas-envimmis-tutorial/tutorial_envimmis_url.png)
...
4. Kontrollera **visa avancerade inställningar för URL: en** och utför följande steg om du vill konfigurera programmet i **SP** initierade läge:
    ...
    ![URL: er och Envi MMIS domän med enkel inloggning information](./media/active-directory-saas-envimmis-tutorial/tutorial_envimmis_url1.png)
...
5. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/active-directory-saas-envimmis-tutorial/tutorial_envimmis_certificate.png) 

6. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/active-directory-saas-envimmis-tutorial/tutorial_general_400.png)

7. Logga in på webbplatsen Envi MMIS som en administratör i en annan webbläsarfönster.

8. Klicka på **min domän** fliken.

    ![Konfigurera enkel inloggning spara](./media/active-directory-saas-envimmis-tutorial/configure1.png)

9. Klicka på **Redigera**.

    ![Konfigurera enkel inloggning spara](./media/active-directory-saas-envimmis-tutorial/configure2.png)

10. Välj **Använd fjärrautentiseringen** kryssrutan och välj sedan **HTTP-omdirigering** från den **autentiseringstyp** listrutan.

    ![Konfigurera enkel inloggning spara](./media/active-directory-saas-envimmis-tutorial/configure3.png)

11. Välj **resurser** och klicka sedan på **överföra Metadata**.

    ![Konfigurera enkel inloggning spara](./media/active-directory-saas-envimmis-tutorial/configure4.png)

12. I den **överföra Metadata** popup, utför följande steg:

    ![Konfigurera enkel inloggning spara](./media/active-directory-saas-envimmis-tutorial/configure5.png)
...
13. Efter överföring av hämtade metadatafil fälten ska hämta fylls i automatiskt. Klicka på **uppdatering**
    ...
    ![Konfigurera enkel inloggning spara](./media/active-directory-saas-envimmis-tutorial/configure6.png)
...
1. I Azure-portalen i den vänstra rutan klickar du på den **Azure Active Directory** knappen.
    ...
    ![Azure Active Directory-knappen](./media/active-directory-saas-envimmis-tutorial/create_aaduser_01.png)

2. Om du vill visa en lista över användare, gå till **användare och grupper**, och klicka sedan på **alla användare**.

    ![”Användare och grupper” och ”alla användare” länkar](./media/active-directory-saas-envimmis-tutorial/create_aaduser_02.png)

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i den **alla användare** dialogrutan.

    ![Knappen Lägg till](./media/active-directory-saas-envimmis-tutorial/create_aaduser_03.png)

4. I den **användaren** dialogrutan utför följande steg:

    ![Dialogrutan användare](./media/active-directory-saas-envimmis-tutorial/create_aaduser_04.png)
...
2. Klicka på **användarlistan** fliken.
    ...
    ![Lägga till medarbetare](./media/active-directory-saas-envimmis-tutorial/user1.png)

3. Klicka på **Lägg till användare** knappen.

    ![Lägga till medarbetare](./media/active-directory-saas-envimmis-tutorial/user2.png)

4. I den **Lägg till användare** avsnittet, utför följande steg:

    ![Lägga till medarbetare](./media/active-directory-saas-envimmis-tutorial/user3.png)
...
2. Välj i listan med program **Envi MMIS**.
    ...
    ![Länken Envi MMIS i listan med program](./media/active-directory-saas-envimmis-tutorial/tutorial_envimmis_app.png)  
