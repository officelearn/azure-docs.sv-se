...
4. I sökrutan skriver **Expensify**väljer **Expensify** resultatet-panelen klickar **Lägg till** för att lägga till programmet.
    ...
    ![Expensify i resultatlistan](./media/active-directory-saas-expensify-tutorial/tutorial_expensify_addfromgallery.png)
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/active-directory-saas-expensify-tutorial/tutorial_expensify_samlbase.png)

3. På den **Expensify domän och URL: er** avsnittet, utför följande steg:

    ![Expensify domän URL: er och enkel inloggning information](./media/active-directory-saas-expensify-tutorial/tutorial_expensify_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/active-directory-saas-expensify-tutorial/tutorial_expensify_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/active-directory-saas-expensify-tutorial/tutorial_general_400.png)
...
1. I Azure-portalen i den vänstra rutan klickar du på den **Azure Active Directory** knappen.
    ...
    ![Azure Active Directory-knappen](./media/active-directory-saas-expensify-tutorial/create_aaduser_01.png)

2. Om du vill visa en lista över användare, gå till **användare och grupper**, och klicka sedan på **alla användare**.

    ![”Användare och grupper” och ”alla användare” länkar](./media/active-directory-saas-expensify-tutorial/create_aaduser_02.png)

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i den **alla användare** dialogrutan.

    ![Knappen Lägg till](./media/active-directory-saas-expensify-tutorial/create_aaduser_03.png)

4. I den **användaren** dialogrutan utför följande steg:

    ![Dialogrutan användare](./media/active-directory-saas-expensify-tutorial/create_aaduser_04.png)
...
2. Välj i listan med program **Expensify**.
    ...
    ![Länken Expensify i listan med program](./media/active-directory-saas-expensify-tutorial/tutorial_expensify_app.png)  
