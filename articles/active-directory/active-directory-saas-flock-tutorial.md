...
4. I sökrutan skriver **Flock**väljer **Flock** resultatet-panelen klickar **Lägg till** för att lägga till programmet.
    ...
    ![Flock i resultatlistan](./media/active-directory-saas-flock-tutorial/tutorial_flock_addfromgallery.png)
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/active-directory-saas-flock-tutorial/tutorial_flock_samlbase.png)

3. På den **Flock domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och flock domän med enkel inloggning information](./media/active-directory-saas-flock-tutorial/tutorial_flock_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **Certificate(Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/active-directory-saas-flock-tutorial/tutorial_flock_certificate.png)

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/active-directory-saas-flock-tutorial/tutorial_general_400.png)
...
6. På den **Flock Configuration** klickar du på **konfigurera Flock** att öppna **konfigurera inloggning** fönster. Kopiera den **SAML enhets-ID och SAML enkel inloggning Tjänstwebbadress** från den **Snabbreferens avsnitt.**
    ...
    ![Flock konfiguration](./media/active-directory-saas-flock-tutorial/tutorial_flock_configure.png) 
...
8. Välj **autentisering** fliken navigeringsrutan till vänster och välj sedan **SAML-autentisering**.
    ...
    ![Flock konfiguration](./media/active-directory-saas-flock-tutorial/configure1.png)

9. I den **SAML-autentisering** avsnittet, utför följande steg:

    ![Flock konfiguration](./media/active-directory-saas-flock-tutorial/configure2.png)
...
1. I Azure-portalen i den vänstra rutan klickar du på den **Azure Active Directory** knappen.
    ...
    ![Azure Active Directory-knappen](./media/active-directory-saas-flock-tutorial/create_aaduser_01.png)

2. Om du vill visa en lista över användare, gå till **användare och grupper**, och klicka sedan på **alla användare**.

    ![”Användare och grupper” och ”alla användare” länkar](./media/active-directory-saas-flock-tutorial/create_aaduser_02.png)

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i den **alla användare** dialogrutan.

    ![Knappen Lägg till](./media/active-directory-saas-flock-tutorial/create_aaduser_03.png)

4. I den **användaren** dialogrutan utför följande steg:

    ![Dialogrutan användare](./media/active-directory-saas-flock-tutorial/create_aaduser_04.png)
...
2. Klicka på **hantera Team** från den vänstra navigeringsfönstret.
    ...
    ![Lägga till medarbetare](./media/active-directory-saas-flock-tutorial/user1.png)

3. Klicka på **Lägg till medlem** och markera sedan **gruppmedlemmar**.

    ![Lägga till medarbetare](./media/active-directory-saas-flock-tutorial/user2.png)

4. Ange e-postadressen för användaren som **Brittasimon@contoso.com** och välj sedan **Lägg till användare**.

    ![Lägga till medarbetare](./media/active-directory-saas-flock-tutorial/user3.png)
...
2. Välj i listan med program **Flock**.
    ...
    ![Länken Flock i listan med program](./media/active-directory-saas-flock-tutorial/tutorial_flock_app.png)
