...
4. I sökrutan skriver **FloQast**väljer **FloQast** resultatet-panelen klickar **Lägg till** för att lägga till programmet.
    ...
    ![FloQast i resultatlistan](./media/active-directory-saas-floqast-tutorial/tutorial_floqast_addfromgallery.png)
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/active-directory-saas-floqast-tutorial/tutorial_floqast_samlbase.png)
...
6. I den **användarattribut** avsnitt på den **enkel inloggning** dialogrutan Konfigurera attribut för SAML-token som visas i bilden och utför följande steg:
    ...
    ![Konfigurera enkel inloggning Lägg till](./media/active-directory-saas-floqast-tutorial/tutorial_attribute_04.png)

    ![Konfigurera enkel inloggning Addattb](./media/active-directory-saas-floqast-tutorial/tutorial_attribute_05.png)
...
7. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara metadatafilen på datorn och utför följande steg:
    ...
    ![Länken hämta certifikatet](./media/active-directory-saas-floqast-tutorial/tutorial_floqast_certificate.png)

    a. Kontrollera **visa avancerade inställningar för signering av certifikat**.

    ![Certifikat-kontrollen](./media/active-directory-saas-floqast-tutorial/tutorial_floqast_certificateassertion.png)

    b. Välj **signering alternativet** som **signera SAML-svar och assertion**.

8. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/active-directory-saas-floqast-tutorial/tutorial_general_400.png)
...
1. I Azure-portalen i den vänstra rutan klickar du på den **Azure Active Directory** knappen.
    ...
    ![Azure Active Directory-knappen](./media/active-directory-saas-floqast-tutorial/create_aaduser_01.png)

2. Om du vill visa en lista över användare, gå till **användare och grupper**, och klicka sedan på **alla användare**.

    ![”Användare och grupper” och ”alla användare” länkar](./media/active-directory-saas-floqast-tutorial/create_aaduser_02.png)

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i den **alla användare** dialogrutan.

    ![Knappen Lägg till](./media/active-directory-saas-floqast-tutorial/create_aaduser_03.png)

4. I den **användaren** dialogrutan utför följande steg:

    ![Dialogrutan användare](./media/active-directory-saas-floqast-tutorial/create_aaduser_04.png)
...
2. Välj i listan med program **FloQast**.
    ...
    ![Länken FloQast i listan med program](./media/active-directory-saas-floqast-tutorial/tutorial_floqast_app.png)  
