...
4. I sökrutan skriver **förutse CX Suite**väljer **förutse CX Suite** resultatet-panelen klickar **Lägg till** för att lägga till programmet.
    ...
    ![Förutse CX Suite i resultatlistan](./media/active-directory-saas-foreseecxsuite-tutorial/tutorial_foreseecxsuite_addfromgallery.png)
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/active-directory-saas-foreseecxsuite-tutorial/tutorial_foreseecxsuite_samlbase.png)

3. På den **förutse CX Suite domän och URL: er** om du har **tjänstleverantör metadatafil**, utför följande steg:

    ![Förutse CX Suite domän URL: er och enkel inloggning information](./media/active-directory-saas-foreseecxsuite-tutorial/upload.png)

    a. Klicka på **överför metadatafil**.

    ![Förutse CX Suite domän URL: er och enkel inloggning information](./media/active-directory-saas-foreseecxsuite-tutorial/tutorial_foreseen_uploadconfig.png)
    ...
    ![Förutse CX Suite domän URL: er och enkel inloggning information](./media/active-directory-saas-foreseecxsuite-tutorial/urlupload.png)

4. Om du inte har **tjänstleverantör metadatafil**, utför följande steg:

    ![Förutse CX Suite domän URL: er och enkel inloggning information](./media/active-directory-saas-foreseecxsuite-tutorial/tutorial_foreseecxsuite_url.png)
...
5. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/active-directory-saas-foreseecxsuite-tutorial/tutorial_foreseecxsuite_certificate.png)

6. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/active-directory-saas-foreseecxsuite-tutorial/tutorial_general_400.png)
...
1. I Azure-portalen i den vänstra rutan klickar du på den **Azure Active Directory** knappen.
    ...
    ![Azure Active Directory-knappen](./media/active-directory-saas-foreseecxsuite-tutorial/create_aaduser_01.png)

2. Om du vill visa en lista över användare, gå till **användare och grupper**, och klicka sedan på **alla användare**.

    ![”Användare och grupper” och ”alla användare” länkar](./media/active-directory-saas-foreseecxsuite-tutorial/create_aaduser_02.png)

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i den **alla användare** dialogrutan.

    ![Knappen Lägg till](./media/active-directory-saas-foreseecxsuite-tutorial/create_aaduser_03.png)

4. I den **användaren** dialogrutan utför följande steg:

    ![Dialogrutan användare](./media/active-directory-saas-foreseecxsuite-tutorial/create_aaduser_04.png)
...
2. Välj i listan med program **förutse CX Suite**.
    ...
    ![Länken förutse CX-paket i listan med program](./media/active-directory-saas-foreseecxsuite-tutorial/tutorial_foreseecxsuite_app.png)
