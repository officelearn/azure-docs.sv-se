...
4. I sökrutan skriver **Form.com**väljer **Form.com** resultatet-panelen klickar **Lägg till** för att lägga till programmet.
    ...
    ![Form.com i resultatlistan](./media/active-directory-saas-formcom-tutorial/tutorial_form.com_addfromgallery.png)
...
1. I Azure-portalen i den vänstra rutan klickar du på den **Azure Active Directory** knappen.
    ...
    ![Azure Active Directory-knappen](./media/active-directory-saas-formcom-tutorial/create_aaduser_01.png)

2. Om du vill visa en lista över användare, gå till **användare och grupper**, och klicka sedan på **alla användare**.

    ![”Användare och grupper” och ”alla användare” länkar](./media/active-directory-saas-formcom-tutorial/create_aaduser_02.png)

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i den **alla användare** dialogrutan.

    ![Knappen Lägg till](./media/active-directory-saas-formcom-tutorial/create_aaduser_03.png)

4. I den **användaren** dialogrutan utför följande steg:

    ![Dialogrutan användare](./media/active-directory-saas-formcom-tutorial/create_aaduser_04.png)
...
2. Välj i listan med program **Form.com**.
    ...
    ![Länken Form.com i listan med program](./media/active-directory-saas-formcom-tutorial/tutorial_form.com_app.png)  
