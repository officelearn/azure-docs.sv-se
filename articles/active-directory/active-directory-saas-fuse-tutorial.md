...
Dieses Lernprogramm wird gezeigt, wie Sicherung in Azure Active Directory (Azure AD) integrieren.<br>Integration der Sicherung in Azure AD bietet Ihnen folgende Vorteile:
...
6. Geben Sie in das Suchfeld **Sicherung**.<br><br>
![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-fuse-tutorial/tutorial_fuse_01.png)<br>
7. Wählen Sie im Ergebnisbereich **Sicherung**, und klicken Sie dann auf **abgeschlossen** um die Anwendung hinzuzufügen.
<br><br>
...
Damit einmaliges Anmelden funktioniert, muss Azure AD wissen, welcher Benutzer in Fuse als Gegenbenutzer zu einem Benutzer in Azure AD fungiert. Das heißt, muss eine linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in Sicherung eingerichtet werden.<br>
Diese linkbeziehung wird durch Zuweisen des Werts der hergestellt der **Benutzername** in Azure AD als Wert für die **Benutzername** in Sicherung.
...
4. **[Erstellen einen Testbenutzer Sicherung](#creating-a-fuse-test-user)** – um eine Entsprechung Britta Simon in Sicherung verfügen, die in Azure AD-Darstellung Ihrer verknüpft ist.
...
1. In der klassischen Azure-Portal auf der **-Sicherung** AHA klicken Sie auf **einmaliges Anmelden konfigurieren** Öffnen die **Konfigurieren Sie einmaliges Anmelden**  Dialogfeld.
<br><br> ![Einmaliges Anmelden konfigurieren][6] <br>

2. Auf der **wie sollen sich Benutzer anmelden Sicherung** Seite **Azure AD Single Sign-On**, und klicken Sie dann auf **Weiter**.
<br><br> ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-fuse-tutorial/tutorial_fuse_03.png) <br>

3. Auf der **App-Einstellungen konfigurieren** Dialogfeld führen die folgenden Schritte aus:
<br><br>![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-fuse-tutorial/tutorial_fuse_04.png) <br>

    a. Geben Sie in das Textfeld Anmelde-URL die URL, die Ihre Benutzer für die Anmeldung bei der Sicherung-Anwendung mithilfe des folgenden Musters: **"https://azuresso.fusion-universal.com/"**.

    > [AZURE.NOTE]Wenden Sie sich an den [Sicherung Support-Team](mailto:support@fusion-universal.com) Ihre Anmelde-URL abrufen, wenn Sie es nicht wissen.
    
    b. Klicken Sie auf **Weiter**.


4. Auf der **Sicherung einmaliges Anmelden konfigurieren** führen die folgenden Schritte aus:
<br><br>![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-fuse-tutorial/tutorial_fuse_05.png) <br>

    a. Klicken Sie auf **Download des Zertifikats**, und klicken Sie dann auf Ihrem Computer speichern.

    b. Kopieren der **Aussteller-URL**,  **Single Sign-On Service URL** und die **einmaliges Abmelden Dienst-URL**.

   
5. Um SSO konfiguriert für Ihre Anwendung zu erhalten, wenden Sie sich an das Supportteam von Sicherung über **support@fusion-universal.com**,  fügen Sie die heruntergeladene Datei, und enthalten die **Aussteller-URL**, die **Single Sign-On-Dienst-URL** und **-Dienst-URL für einmalige Abmeldung**.
...
<br><br>![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-fuse-tutorial/create_aaduser_09.png) <br>

2. Aus der **Verzeichnis** wählen Sie das Verzeichnis für die Verzeichnisintegration aktiviert werden sollen.

3. Klicken Sie zum Anzeigen der Liste der Benutzer im Menü am oberen Rand **Benutzer**.
<br><br> ![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-fuse-tutorial/create_aaduser_03.png) <br>
...
<br><br> ![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-fuse-tutorial/create_aaduser_04.png) <br>

5. Auf der **Erzählen Sie uns dieses Benutzers** Dialogfeld führen die folgenden Schritte aus:
<br><br> ![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-fuse-tutorial/create_aaduser_05.png) <br>
...
<br><br>![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-fuse-tutorial/create_aaduser_06.png) <br>
...
<br><br> ![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-fuse-tutorial/create_aaduser_07.png) <br>

8. Auf der **vorübergehendes Kennwort abrufen** Dialogfeld führen die folgenden Schritte aus:
<br><br>![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-fuse-tutorial/create_aaduser_08.png) <br>
...
Für Sie steht in diesem Abschnitt kein Aktionselement zur Verfügung. Wenn noch kein Benutzer vorhanden ist, wird beim Zugreifen auf Fuse ein neuer Benutzer erstellt. [Konfigurieren von Azure AD Single Sign-On](#configuring-azure-ad-single-single-sign-on).


### Zuweisen des Azure AD-Testbenutzers

Das Ziel dieses Abschnitts ist das Aktivieren von Britta Simon mit Azure einmalige Sicherung keinen Zugriff erteilen.
...
<br><br>![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-fuse-tutorial/tutorial_fuse_50.png) <br>
