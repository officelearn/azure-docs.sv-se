...
Nach Abschluss dieses Lernprogramms Greenhouse zugewiesene Azure AD-Benutzer werden mit der Anwendung auf Ihrer Greenhouse-Unternehmenswebsite (vom Dienstanbieter initiierte Anmeldung) anmelden oder über die [Einführung in den Zugriffsbereich](active-directory-saas-access-panel-introduction.md).
...
6.  In der **Suchfeld**, Typ **Greenhouse**.

    ![Anwendungskatalog](./media/active-directory-saas-greenhouse-tutorial/IC790784.png "Application Gallery")

7.  Wählen Sie im Ergebnisbereich **Greenhouse**, und klicken Sie dann auf **abgeschlossen** um die Anwendung hinzuzufügen.
...
1.  In Azure AD-Portal auf der **Greenhouse** AHA klicken Sie auf **einmaliges Anmelden konfigurieren** zum Öffnen der ** einmaliges Anmelden konfigurieren ** Dialogfeld.

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-greenhouse-tutorial/IC790786.png "Configure single sign-on")

2.  Auf der **wie sollen sich Benutzer bei Greenhouse anmelden** Seite **Microsoft Azure AD Single Sign-On**, und klicken Sie dann auf **Weiter**.

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-greenhouse-tutorial/IC790787.png "Configure single sign-on")

3.  Auf der **App-URL konfigurieren** auf der Seite der **Anmelde-URL** Textfeld Ihre URL nach dem Muster "*https://company.greenhouse.io*", und klicken Sie dann auf **Weiter**.

    ![App-URL konfigurieren](./media/active-directory-saas-greenhouse-tutorial/IC790788.png "Configure App URL")

4.  Auf der **einmaliges Anmelden konfigurieren, um Greenhouse** auf **Metadaten**, und speichern Sie dann die Metadatendatei lokal auf Ihrem Computer.
...
5.  Leiten Sie die Metadatendatei an das Supportteam von  Greenhouse weiter.
    ...
    >[AZURE.NOTE] Einmaliges Anmelden muss durch das Supportteam von Greenhouse aktiviert werden.
...
6.  Auf Azure AD-Portal, wählen Sie die Konfiguration von SSO Bestätigung, und klicken Sie dann auf **abgeschlossen** Schließen die **einmaliges Anmelden konfigurieren für** Dialogfeld.
    ...
    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-greenhouse-tutorial/IC790790.png "Configure single sign-on")
...
1.  Melden Sie sich bei Ihrem **Greenhouse** -Unternehmenswebsite als Administrator.

2.  Klicken Sie im Menü am oberen Rand **konfigurieren**, und klicken Sie dann auf **Benutzer**.
...
4.  In der **Add New User** führen die folgenden Schritte aus:

    ![Neuen Benutzer hinzufügen](./media/active-directory-saas-greenhouse-tutorial/IC790793.png "Add New User")

    1.  In der **Geben Sie die Benutzer-e-Mails** Textfeld Geben Sie die e-Mail-Adresse eines gültigen Azure Active Directory-Kontos, das Sie bereitstellen möchten.
...
>[AZURE.NOTE] Können Sie alle anderen Greenhouse Benutzerkonten oder APIs von Greenhouse Bereitstellung AAD-Benutzerkonten.
...
2.  Auf der ** Greenhouse ** anwendungsintegrationsseite, klicken Sie auf **Zuweisen von Benutzern**.
