...
2. I Server Manager går du till **verktyg** > **Group Policy Management**.
    ...
    ![Gå till Verktyg > Gruppera princip Managment](./media/active-directory-saas-ie-group-policy/tools-gpm.png)
...
5. I den **distribuera programvara** fråga, Välj **tilldelad** för din distributionsmetod. Klicka sedan på **OK**.
    ...
    ![Tilldelad och sedan klicka på OK.](./media/active-directory-saas-ie-group-policy/deployment-method.png)
...
4. I den **Visa innehåll** och utför följande steg:
   ...
   3. Klicka på **OK** att Stäng den **Visa innehåll** fönster.
      ...
      ![Fyll i värden som anges ovan.](./media/active-directory-saas-ie-group-policy/show-contents.png)
...
* [Felsöka Access Panel-tillägg för Internet Explorer](active-directory-saas-ie-troubleshooting.md)
