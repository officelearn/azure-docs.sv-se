...
Om du är administratör kan se även: [hur du distribuerar Access Panel-tillägg för Internet Explorer med hjälp av en Grupprincip](active-directory-saas-ie-group-policy.md)
...
2. Öppna filen, och tryck på **extrahera alla** knappen.
    ...
    ![Tryck på Extrahera alla](./media/active-directory-saas-ie-troubleshooting/extract1.png)
3. Tryck på den **extrahera** för att fortsätta.
   
    ![Tryck på Extract](./media/active-directory-saas-ie-troubleshooting/extract2.png)
...
5. Därefter visas följande diagnostiska fönster som beskriver vad som kan gå fel med installationen.
    ...
    ![Ett sampel från fönstret diagnostik](./media/active-directory-saas-ie-troubleshooting/tool_preview.png)
...
1. I Internet Explorer klickar du på den **kugghjulsikonen** i det övre högra hörnet i fönstret. Välj sedan **Internetalternativ**.<br />(I tidigare versioner av Internet Explorer kan du hitta under **Verktyg > Internetalternativ**.
    ...
    ![Ett sampel från fönstret diagnostik](./media/active-directory-saas-ie-troubleshooting/inprivateoptions.png)
...
* [Så här distribuerar du Access Panel-tillägg för Internet Explorer med hjälp av en Grupprincip](active-directory-saas-ie-group-policy.md)
