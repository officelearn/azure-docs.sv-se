...
Nach Abschluss dieses Lernprogramms können sich innotas zugewiesene Azure AD-Benutzer werden mit einmaligem Anmelden bei der Anwendung auf Ihrer Innotas-Unternehmenssite (vom Dienstanbieter initiierte Anmeldung) oder über die [Einführung in den Zugriffsbereich](active-directory-saas-access-panel-introduction.md).
...
6.  In der **Suchfeld**, Typ **Innotas**.

    ![Anwendungskatalog](./media/active-directory-saas-innotas-tutorial/IC777332.png "Application gallery")

7.  Wählen Sie im Ergebnisbereich **Innotas**, und klicken Sie dann auf **abgeschlossen** um die Anwendung hinzuzufügen.
...
1.  In Azure AD-Portal auf der **Innotas** AHA klicken Sie auf **einmaliges Anmelden konfigurieren** zum Öffnen der ** einmaliges Anmelden konfigurieren ** Dialogfeld.

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-innotas-tutorial/IC777334.png "Configure single sign-on")

2.  Auf der **wie sollen sich Benutzer bei Innotas anmelden** Seite **Microsoft Azure AD Single Sign-On**, und klicken Sie dann auf **Weiter**.

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-innotas-tutorial/IC777335.png "Configure single sign-on")

3.  Auf der **App-URL konfigurieren** auf der Seite der **Innotas-Anmelde-URL** Textfeld Ihre URL nach dem Muster "*https://\<tenant-name\>. Innotas.com*", und klicken Sie dann auf **Weiter**.

    ![App-URL konfigurieren](./media/active-directory-saas-innotas-tutorial/IC777336.png "Configure app URL")

4.  Auf der **einmaliges Anmelden für Innotas konfigurieren** Seite, um Ihre Metadaten herunterzuladen, klicken Sie **Metadaten**, und klicken Sie dann die Datendatei lokal als **c:\\InnotasMetaData.xml**.
...
6.  Wählen Sie die Konfiguration von SSO Bestätigung, und klicken Sie dann auf **abgeschlossen** Schließen die **einmaliges Anmelden konfigurieren für** Dialogfeld.
    ...
    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-innotas-tutorial/IC777338.png "Configure single sign-on")
...
2.  Auf der ** Innotas ** anwendungsintegrationsseite, klicken Sie auf **Zuweisen von Benutzern**.
