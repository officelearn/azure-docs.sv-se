...
I kursen får lära du att integrera sköter Lösenordshanteraren & digitala valvet med Azure Active Directory (AD Azure).

Integrera sköter Lösenordshanteraren & digitala valvet med Azure AD ger dig följande fördelar:

- Du kan styra i Azure AD som har åtkomst till sköter Lösenordshanteraren & digitala valvet
...
1. Att lägga till sköter Lösenordshanteraren & digitala valvet från galleriet
2. Konfigurera och testa Azure AD enkel inloggning

## <a name="adding-keeper-password-manager--digital-vault-from-the-gallery"></a>Att lägga till sköter Lösenordshanteraren & digitala valvet från galleriet
Du måste lägga till sköter Lösenordshanteraren & digitala valvet från galleriet i listan över hanterade SaaS-appar för att konfigurera integrering av sköter Lösenordshanteraren & digitala valvet i Azure AD.
...
4. I sökrutan skriver **sköter Lösenordshanteraren & digitala valvet**.

    ![Skapa en testanvändare i Azure AD](./media/active-directory-saas-keeperpasswordmanager-tutorial/tutorial_keeper_search.png)

5. Välj i resultatpanelen **sköter Lösenordshanteraren & digitala valvet**, och klicka sedan på **Lägg till** för att lägga till programmet.
...
Azure AD måste du känna till motsvarande användaren i sköter Lösenordshanteraren & digitala valvet till en användare i Azure AD för enkel inloggning ska fungera. Med andra ord måste en länk mellan en Azure AD-användare och relaterade användaren i sköter Lösenordshanteraren & digitala valvet upprättas.

I sköter Lösenordshanteraren & digitala valvet, tilldela värdet för den **användarnamn** i Azure AD som värde för den **användarnamn** etablera länken relationen.

Om du vill konfigurera och testa Azure AD enkel inloggning med sköter Lösenordshanteraren & digitala valvet, måste du utföra följande byggblock:

1. **[Konfigurera Azure AD enkel inloggning](#configuring-azure-ad-single-sign-on)**  - om du vill att användarna kan använda den här funktionen.
2. **[Skapa en Azure AD-testanvändare](#creating-an-azure-ad-test-user)**  - om du vill testa Azure AD enkel inloggning med Britta Simon.
3. **[Skapa en testanvändare sköter Lösenordshanteraren & digitala valvet](#creating-a-keeperpasswordmanager-test-user)**  – du har en motsvarighet för Britta Simon i sköter Lösenordshanteraren & digitala valvet som är kopplad till Azure AD-representation av användaren.
4. **[Tilldela Azure AD-testanvändare](#assigning-the-azure-ad-test-user)**  - om du vill aktivera Britta Simon att använda Azure AD enkel inloggning.
5. **[Testa enkel inloggning](#testing-single-sign-on)**  - om du vill kontrollera om konfigurationen fungerar.

### <a name="configuring-azure-ad-single-sign-on"></a>Konfigurera Azure AD enkel inloggning

I det här avsnittet Aktivera Azure AD enkel inloggning i Azure-portalen och konfigurera enkel inloggning i tillämpningsprogrammet sköter Lösenordshanteraren & digitala valvet.

**Utför följande steg för att konfigurera Azure AD enkel inloggning med sköter Lösenordshanteraren & digitala valvet:**

1. I Azure-portalen på den **sköter Lösenordshanteraren & digitala valvet** integreringssidan för programmet, klickar du på **enkel inloggning**.
...
3. På den **sköter Lösenordshanteraren & digitala valvet domän och URL: er** avsnittet, utför följande steg:
...
6. På den **sköter Lösenordshanteraren & digitala valvet Configuration** klickar du på **konfigurera sköter Lösenordshanteraren & digitala valvet** att öppna **konfigurera inloggning** fönstret. Kopiera den **Sign-Out URL, SAML enhets-ID och SAML enkel inloggning Tjänstwebbadress** från den **Snabbreferens avsnitt.**
...
Om du vill aktivera Azure AD-användare kan logga in på sköter Lösenordshanteraren & digitala valvet, måste de etableras i sköter Lösenordshanteraren & digitala valvet. Programmet stöder bara i tid användaretablering och authentication-användare kommer automatiskt att skapas i programmet. Du kan kontakta [sköter stöd](https://keepersecurity.com/contact.html), om du vill installera användare manuellt.

### <a name="assigning-the-azure-ad-test-user"></a>Tilldela Azure AD-testanvändare

I det här avsnittet kan du aktivera Britta Simon att använda Azure enkel inloggning genom att bevilja åtkomst till sköter Lösenordshanteraren & digitala valvet.

![Tilldela användare][200] 

**Om du vill tilldela sköter Lösenordshanteraren & digitala valvet Britta Simon, utför du följande steg:**

1. Öppna vyn program i Azure-portalen och gå till vyn directory och gå till **företagsprogram** Klicka **alla program**.

    ![Tilldela användare][201] 

2. Välj i listan med program **sköter Lösenordshanteraren & digitala valvet**.
...
Du bör få inloggningssidan för sköter Lösenordshanteraren & digitala valvet program när du klickar på panelen sköter Lösenordshanteraren & digitala valvet på åtkomstpanelen. Du bör få till programmet när autentiseringen lyckas. Läs mer om åtkomstpanelen [introduktion till åtkomstpanelen](active-directory-saas-access-panel-introduction.md). 
