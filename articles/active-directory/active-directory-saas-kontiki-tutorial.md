...
Nach Abschluss dieses Lernprogramms Kontiki zugewiesene Azure AD-Benutzer werden mit der Anwendung auf Ihrer Kontiki-Unternehmenswebsite (vom Dienstanbieter initiierte Anmeldung) anmelden oder über die [Einführung in den Zugriffsbereich](active-directory-saas-access-panel-introduction.md).
...
6.  In der **Suchfeld**, Typ **Kontiki**.

    ![Anwendungskatalog](./media/active-directory-saas-kontiki-tutorial/IC790236.png "Application Gallery")

7.  Wählen Sie im Ergebnisbereich **Kontiki**, und klicken Sie dann auf **abgeschlossen** um die Anwendung hinzuzufügen.
...
1.  In Azure AD-Portal auf der **Kontiki** anwendungsintegrationsseite klicken Sie auf **einmaliges Anmelden konfigurieren** Öffnen der ** einmaliges Anmelden konfigurieren ** Dialogfeld.

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-kontiki-tutorial/IC790238.png "Configure Single SignOn")

2.  Auf der **Wie möchten Sie Benutzer zur Anmeldung bei Kontiki** Seite **Microsoft Azure AD Single Sign-On**, und klicken Sie dann auf **Weiter**.

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-kontiki-tutorial/IC790239.png "Configure Single SignOn")

3.  Auf der **App-URL konfigurieren** auf der Seite der **Kontiki URL für Anmeldung** Textfeld die URL ein, von Ihren Benutzern zur Anmeldung bei Kontiki (z. B.: "*https://company.mc.eval.kontiki.com/*"), und klicken Sie dann auf **Weiter**.

    ![App-URL konfigurieren](./media/active-directory-saas-kontiki-tutorial/IC790240.png "Configure App URL")

4.  Auf der **Konfigurieren Sie einmaliges Anmelden, um Kontiki** auf **Metadaten**, und speichern Sie die Metadatendatei auf Ihrem Computer.
...
5.  Senden Sie die Metadatendatei an das Supportteam von Kontiki.
    ...
    >[AZURE.NOTE] Konfiguration die einmaligen Anmeldung muss durch das Supportteam von Kontiki erfolgen. Sie erhalten eine Benachrichtigung, sobald die Konfiguration abgeschlossen ist.
...
2.  Auf der ** Kontiki ** anwendungsintegrationsseite, klicken Sie auf **Zuweisen von Benutzern**.
