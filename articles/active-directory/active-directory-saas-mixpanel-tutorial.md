...
Dieses Lernprogramm wird gezeigt, wie Mixpanel mit Azure Active Directory (Azure AD) integrieren.<br>Integration von Azure AD Mixpanel bietet Ihnen folgende Vorteile:
...
6. Geben Sie in das Suchfeld **Mixpanel**.<br><br>
![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_01.png)<br>
7. Wählen Sie im Ergebnisbereich **Mixpanel**, und klicken Sie dann auf **abgeschlossen** um die Anwendung hinzuzufügen.
<br><br>
...
Damit einmaliges Anmelden funktioniert, muss Azure AD wissen, welcher Benutzer in Mixpanel als Gegenbenutzer zu einem Benutzer in Azure AD fungiert. Das heißt, muss eine linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in Mixpanel eingerichtet werden.<br>
Diese linkbeziehung wird durch Zuweisen des Werts der hergestellt der **Benutzername** in Azure AD als Wert für die **Benutzername** in Mixpanel.
...
4. **[Erstellen einen Testbenutzer Mixpanel](#creating-a-mixpanel-test-user)** – ein Gegenstück zur Britta Simon Mixpanel enthalten, die in Azure AD-Darstellung Ihrer verknüpft ist.
...
1. In der klassischen Azure-Portal auf der **Mixpanel** AHA klicken Sie auf **einmaliges Anmelden konfigurieren** zum Öffnen der **Konfigurieren Sie einmaliges Anmelden**  Dialogfeld.
<br><br> ![Einmaliges Anmelden konfigurieren][6] <br>

2. Auf der **wie sollen sich Benutzer anmelden Mixpanel** Seite **Azure AD Single Sign-On**, und klicken Sie dann auf **Weiter**.
<br><br> ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_03.png) <br>

3. Auf der **App-Einstellungen konfigurieren** Dialogfeld führen die folgenden Schritte aus:
<br><br>![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_04.png) <br>
...
4. Auf der **Mixpanel einmaliges Anmelden konfigurieren** führen die folgenden Schritte aus:
<br><br>![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_05.png) <br>

    a. Klicken Sie auf **Download des Zertifikats**, und speichern Sie die Datei auf Ihrem Computer. 
...
6. Klicken Sie auf den unteren Rand der Seite auf das kleine **Zahnradsymbol** Symbol in der linken Ecke. 
   <br><br>![Mixpanel Single Sign-On](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_06.png) <br>

7. Klicken Sie auf die **-Zugriff** Registerkarte, und klicken Sie dann auf **Ändern**.
   <br><br>![Mixpanel-Einstellungen](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_08.png) <br>
    
8. Auf der **Ändern Sie Ihr Zertifikat** Seite, klicken Sie auf **Choose File** das heruntergeladene Zertifikat, und klicken Sie dann auf **Weiter**.
  <br><br>![Mixpanel-Einstellungen](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_09.png) <br>

9. In der klassischen Azure-Portal auf der **Mixpanel einmaliges Anmelden konfigurieren** Kopieren der **Single Sign-On-Dienst-URL** -Wert, fügen Sie ihn in das Textfeld ein Authentifizierung-URL auf den **Ändern Sie die URL für die Authentifizierung** Seite, und klicken Sie dann auf **Weiter**.
   <br><br>![Mixpanel-Einstellungen](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_10.png) <br>
...
<br><br>![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-mixpanel-tutorial/create_aaduser_09.png) <br>

2. Aus der **Verzeichnis** wählen Sie das Verzeichnis für die Verzeichnisintegration aktiviert werden sollen.

3. Klicken Sie zum Anzeigen der Liste der Benutzer im Menü am oberen Rand **Benutzer**.
<br><br> ![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-mixpanel-tutorial/create_aaduser_03.png) <br>
...
<br><br> ![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-mixpanel-tutorial/create_aaduser_04.png) <br>

5. Auf der **Erzählen Sie uns dieses Benutzers** Dialogfeld führen die folgenden Schritte aus:
<br><br> ![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-mixpanel-tutorial/create_aaduser_05.png) <br>
...
<br><br>![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-mixpanel-tutorial/create_aaduser_06.png) <br>
...
<br><br> ![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-mixpanel-tutorial/create_aaduser_07.png) <br>

8. Auf der **vorübergehendes Kennwort abrufen** Dialogfeld führen die folgenden Schritte aus:
<br><br>![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-mixpanel-tutorial/create_aaduser_08.png) <br>
...
2.  Klicken Sie auf den unteren Rand der Seite, auf die kleine Zahnrad-Schaltfläche auf der linken Ecke zu öffnen der **Einstellungen** Fenster.

3.  Klicken Sie auf der **Team** Registerkarte.

4. In der **Teammitglied** Textfeld Geben Sie Brittas e-Mail-Adresse in Azure.
   <br><br>![Mixpanel-Einstellungen](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_11.png) <br>
...
Das Ziel dieses Abschnitts ist das Aktivieren von Britta Simon Azure einmaliges Anmelden zu verwenden, indem Mixpanel keinen Zugriff erteilen.
...
<br><br>![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_50.png) <br>
