...
4. I sökrutan skriver **moconavi**väljer **moconavi** resultatet-panelen klickar **Lägg till** för att lägga till programmet.
    ...
    ![moconavi i resultatlistan](./media/active-directory-saas-moconavi-tutorial/tutorial_moconavi_addfromgallery.png)
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/active-directory-saas-moconavi-tutorial/tutorial_moconavi_samlbase.png)

3. På den **moconavi domän och URL: er** avsnittet, utför följande steg:

    ![moconavi domän URL: er och enkel inloggning information](./media/active-directory-saas-moconavi-tutorial/tutorial_moconavi_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/active-directory-saas-moconavi-tutorial/tutorial_moconavi_certificate.png)

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/active-directory-saas-moconavi-tutorial/tutorial_general_400.png)
...
1. I Azure-portalen i den vänstra rutan klickar du på den **Azure Active Directory** knappen.
    ...
    ![Azure Active Directory-knappen](./media/active-directory-saas-moconavi-tutorial/create_aaduser_01.png)

2. Om du vill visa en lista över användare, gå till **användare och grupper**, och klicka sedan på **alla användare**.

    ![”Användare och grupper” och ”alla användare” länkar](./media/active-directory-saas-moconavi-tutorial/create_aaduser_02.png)

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i den **alla användare** dialogrutan.

    ![Knappen Lägg till](./media/active-directory-saas-moconavi-tutorial/create_aaduser_03.png)

4. I den **användaren** dialogrutan utför följande steg:

    ![Dialogrutan användare](./media/active-directory-saas-moconavi-tutorial/create_aaduser_04.png)
...
2. Välj i listan med program **moconavi**.
    ...
    ![Länken moconavi i listan med program](./media/active-directory-saas-moconavi-tutorial/tutorial_moconavi_app.png)
...
3. Klicka på **ansluta inställningen** knappen.
    ...
    ![Testa enkel inloggning](./media/active-directory-saas-moconavi-tutorial/testing1.png)

4. Ange `https://mcs-admin.moconavi.biz/gateway` till **Anslut till URL: en** textrutan och klicka sedan på **klar** knappen.

    ![Testa enkel inloggning](./media/active-directory-saas-moconavi-tutorial/testing2.png)

5. Utför följande steg på följande skärmbild:

    ![Testa enkel inloggning](./media/active-directory-saas-moconavi-tutorial/testing3.png)
...
6. Azure AD-lösenord för att ange **lösenord** textrutan och klicka sedan på **inloggning** knappen.
    ...
    ![Testa enkel inloggning](./media/active-directory-saas-moconavi-tutorial/testing4.png)

7. Azure AD-autentiseringen har lyckats när menyn visas.

    ![Testa enkel inloggning](./media/active-directory-saas-moconavi-tutorial/testing5.png)
