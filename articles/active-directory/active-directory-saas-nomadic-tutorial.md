...
ms.date: 07/27/2017
ms.author: jeedes
ms.openlocfilehash: 425bc825b7de5b8048685f0ae65b3fa6f60b383b
ms.sourcegitcommit: b6319f1a87d9316122f96769aab0d92b46a6879a
ms.translationtype: MT
ms.contentlocale: sv-SE
ms.lasthandoff: 05/20/2018
ms.locfileid: "34345946"
---
...
I kursen får lära du att integrera Nomadic med Azure Active Directory (AD Azure).

Integrera Nomadic med Azure AD ger dig följande fördelar:

- Du kan styra i Azure AD som har åtkomst till Nomadic.
- Du kan aktivera användarna att automatiskt hämta loggat in på Nomadic (Single Sign-On) med sina Azure AD-konton.
...
För att konfigurera Azure AD-integrering med Nomadic, behöver du följande:

- En Azure AD-prenumeration
- En Nomadic enkel inloggning aktiverad prenumeration
...
Du måste lägga till Nomadic från galleriet i listan över hanterade SaaS-appar för att konfigurera integrering av Nomadic i Azure AD.
...
4. I sökrutan skriver **Nomadic**väljer **Nomadic** resultatet-panelen klickar **Lägg till** för att lägga till programmet.
...
I det här avsnittet kan du konfigurera och testa Azure AD enkel inloggning med Nomadic baserat på en testanvändare som kallas ”Britta Simon”.

Azure AD måste du känna till användaren i Nomadic motsvarighet till en användare i Azure AD för enkel inloggning ska fungera. Med andra ord måste en länk förhållandet mellan en Azure AD-användare och relaterade användaren i Nomadic upprättas.

I Nomadic, tilldela värdet för den **användarnamn** i Azure AD som värde för den **användarnamn** etablera länken relationen.
...
3. **[Skapa en Nomadic testanvändare](#create-a-nomadic-test-user)**  – du har en motsvarighet för Britta Simon i Nomadic som är kopplad till Azure AD-representation av användaren.
...
1. I Azure-portalen på den **Nomadic** integreringssidan för programmet, klickar du på **enkel inloggning**.
...
3. På den **Nomadic domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textruta Skriv en URL med följande mönster: `https://<company name>.nomadic.fm/signin`

    b. I den **identifierare** textruta Skriv en URL med följande mönster: `https://<company name>.nomadic.fm/auth/saml2/sp`, `https://<company name>.staging.nomadic.fm/auth/saml2/sp`

    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med den faktiska inloggnings-URL och identifierare. Kontakta [Nomadic klienten supportteamet](mailto:help@nomadic.fm) att hämta dessa värden. 
...
6.  För att få SSO konfigurerats för ditt program, kontakta [Nomadic supportteamet](mailto:help@nomadic.fm) och ger dem den hämtade **metadata**.
...
I det här avsnittet skapar du en användare som kallas Britta Simon i Nomadic. Se tillsammans med [Nomadic supportteamet](mailto:help@nomadic.fm) att lägga till användare i Nomadic plattformen.

### <a name="assign-the-azure-ad-test-user"></a>Tilldela Azure AD-testanvändare

I det här avsnittet kan du aktivera Britta Simon att använda Azure enkel inloggning genom att bevilja åtkomst till Nomadic.

![Tilldela rollen][200] 

**Om du vill tilldela Nomadic Britta Simon utför du följande steg:**

1. Öppna vyn program i Azure-portalen och gå till vyn directory och gå till **företagsprogram** Klicka **alla program**.

    ![Tilldela användare][201] 

2. Välj i listan med program **Nomadic**.
...
När du klickar på panelen Nomadic på panelen åtkomst du ska hämta automatiskt loggat in på ditt Nomadic program.
