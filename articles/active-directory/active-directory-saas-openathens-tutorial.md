...
* Mer information om programåtkomst och enkel inloggning med Azure Active Directory finns [vad är programåtkomst och enkel inloggning med Azure Active Directory?](manage-apps/what-is-single-sign-on.md).
