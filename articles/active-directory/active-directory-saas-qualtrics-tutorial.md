...
Nach Abschluss dieses Lernprogramms Qualtrics zugewiesene Azure AD-Benutzer werden mit einmaligem Anmelden bei der Anwendung auf Ihrer Qualtrics-Unternehmenssite (vom Dienstanbieter initiierte Anmeldung) oder über die [Einführung in den Zugriffsbereich](active-directory-saas-access-panel-introduction.md).
...
6.  In der **Suchfeld**, Typ **Qualtrics**.

    ![Anwendungskatalog](./media/active-directory-saas-qualtrics-tutorial/IC789543.png "Application Gallery")

7.  Wählen Sie im Ergebnisbereich **Qualtrics**, und klicken Sie dann auf **abgeschlossen** um die Anwendung hinzuzufügen.
...
1.  In Azure AD-Portal auf der **Qualtrics** anwendungsintegrationsseite klicken Sie auf **einmaliges Anmelden konfigurieren** Öffnen der ** einmaliges Anmelden konfigurieren ** Dialogfeld.

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-qualtrics-tutorial/IC789545.png "Configure Single Sign-On")

2.  Auf der **wie sollen sich Benutzer bei Qualtrics anmelden** Seite **Microsoft Azure AD Single Sign-On**, und klicken Sie dann auf **Weiter**.

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-qualtrics-tutorial/IC789546.png "Configure Single Sign-On")

3.  Auf der **App-URL konfigurieren** auf der Seite der **Qualtrics-Anmelde-URL** Textfeld Geben Sie die URL (z. B.: "*https://ssotest2ut1.qualtrics.com*"), und klicken Sie dann auf **Weiter**.

    ![App-URL konfigurieren](./media/active-directory-saas-qualtrics-tutorial/IC789547.png "Configure App URL")

4.  Auf der **Konfigurieren Sie einmaliges Anmelden, um Qualtrics** auf **Metadaten**, und speichern Sie die Metadatendatei auf Ihrem Computer.
...
5.  Senden Sie die Metadatendatei an das Supportteam von Qualtrics.
    ...
    >[AZURE.NOTE]Konfiguration die einmaligen Anmeldung muss durch das Supportteam von Qualtrics erfolgen. Sie erhalten eine Benachrichtigung, sobald die Konfiguration abgeschlossen ist.
...
2.  Auf der ** Qualtrics ** anwendungsintegrationsseite, klicken Sie auf **Zuweisen von Benutzern**.
