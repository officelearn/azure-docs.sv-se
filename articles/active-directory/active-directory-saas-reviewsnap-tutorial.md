...
4. I sökrutan skriver **Reviewsnap**väljer **Reviewsnap** resultatet-panelen klickar **Lägg till** för att lägga till programmet.
    ...
    ![Reviewsnap i resultatlistan](./media/active-directory-saas-reviewsnap-tutorial/tutorial_reviewsnap_addfromgallery.png)
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/active-directory-saas-reviewsnap-tutorial/tutorial_reviewsnap_samlbase.png)
...
3. På den **Reviewsnap domän och URL: er** avsnittet, utför följande steg om du vill konfigurera programmet i **IDP** initierade läge:
    ...
    ![URL: er och Reviewsnap domän med enkel inloggning information](./media/active-directory-saas-reviewsnap-tutorial/tutorial_reviewsnap_url.png)
...
4. Kontrollera **visa avancerade inställningar för URL: en** och utför följande steg om du vill konfigurera programmet i **SP** initierade läge:
    ...
    ![URL: er och Reviewsnap domän med enkel inloggning information](./media/active-directory-saas-reviewsnap-tutorial/tutorial_reviewsnap_url1.png)
...
5. På den **SAML-signeringscertifikat** klickar du på **certifikat (Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/active-directory-saas-reviewsnap-tutorial/tutorial_reviewsnap_certificate.png) 

6. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/active-directory-saas-reviewsnap-tutorial/tutorial_general_400.png)
...
7. På den **Reviewsnap Configuration** klickar du på **konfigurera Reviewsnap** att öppna **konfigurera inloggning** fönster. Kopiera den **Sign-Out URL, SAML enhets-ID och SAML enkel inloggning Tjänstwebbadress** från den **Snabbreferens avsnitt.**
    ...
    ![Reviewsnap konfiguration](./media/active-directory-saas-reviewsnap-tutorial/tutorial_reviewsnap_configure.png) 
...
1. I Azure-portalen i den vänstra rutan klickar du på den **Azure Active Directory** knappen.
    ...
    ![Azure Active Directory-knappen](./media/active-directory-saas-reviewsnap-tutorial/create_aaduser_01.png)

2. Om du vill visa en lista över användare, gå till **användare och grupper**, och klicka sedan på **alla användare**.

    ![”Användare och grupper” och ”alla användare” länkar](./media/active-directory-saas-reviewsnap-tutorial/create_aaduser_02.png)

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i den **alla användare** dialogrutan.

    ![Knappen Lägg till](./media/active-directory-saas-reviewsnap-tutorial/create_aaduser_03.png)

4. I den **användaren** dialogrutan utför följande steg:

    ![Dialogrutan användare](./media/active-directory-saas-reviewsnap-tutorial/create_aaduser_04.png)
...
2. Välj i listan med program **Reviewsnap**.
    ...
    ![Länken Reviewsnap i listan med program](./media/active-directory-saas-reviewsnap-tutorial/tutorial_reviewsnap_app.png)  
