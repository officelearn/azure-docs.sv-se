...
4. I sökrutan skriver **Riskware**väljer **Riskware** resultatet-panelen klickar **Lägg till** för att lägga till programmet.
    ...
    ![Riskware i resultatlistan](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_addfromgallery.png)
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_samlbase.png)

3. På den **Riskware domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och Riskware domän med enkel inloggning information](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/active-directory-saas-riskware-tutorial/tutorial_general_400.png)
...
6. På den **Riskware Configuration** klickar du på **konfigurera Riskware** att öppna **konfigurera inloggning** fönster. Kopiera den **Sign-Out Webbadressen och SAML enkel inloggning Service** från den **Snabbreferens avsnitt.**
    ...
    ![Riskware konfiguration](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_configure.png) 
...
8. Klicka på upp till höger, **Underhåll** att öppna underhållssidan. 
    ...
    ![Riskware konfigurationer Underhåll](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_maintain.png)
...
1. I Azure-portalen i den vänstra rutan klickar du på den **Azure Active Directory** knappen.
    ...
    ![Azure Active Directory-knappen](./media/active-directory-saas-riskware-tutorial/create_aaduser_01.png)

2. Om du vill visa en lista över användare, gå till **användare och grupper**, och klicka sedan på **alla användare**.

    ![”Användare och grupper” och ”alla användare” länkar](./media/active-directory-saas-riskware-tutorial/create_aaduser_02.png)

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i den **alla användare** dialogrutan.

    ![Knappen Lägg till](./media/active-directory-saas-riskware-tutorial/create_aaduser_03.png)

4. I den **användaren** dialogrutan utför följande steg:

    ![Dialogrutan användare](./media/active-directory-saas-riskware-tutorial/create_aaduser_04.png)
...
2. Klicka på upp till höger, **Underhåll** att öppna underhållssidan. 
    ...
    ![Riskware konfigurationen behåller](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_maintain.png)

3. Klicka på underhållssidan **personer**.

    ![Konfiguration av Riskware personer](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_people.png)

4. På den **information** fliken, utför följande steg:
    
    ![Riskware konfigurationsinformation](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_details.png)
...
5. På den **säkerhet** fliken, utför följande steg:    
    ...
    ![Riskware Configuration säkerhet](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_security.png)
...
2. Välj i listan med program **Riskware**.
    ...
    ![Länken Riskware i listan med program](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_app.png)  
