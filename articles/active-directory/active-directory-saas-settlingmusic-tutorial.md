...
4. I sökrutan skriver **reglera musik**väljer **reglera musik** resultatet-panelen klickar **Lägg till** för att lägga till programmet.
    ...
    ![Reglera musik i resultatlistan](./media/active-directory-saas-settlingmusic-tutorial/tutorial_settlingmusic_addfromgallery.png)
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/active-directory-saas-settlingmusic-tutorial/tutorial_settlingmusic_samlbase.png)

3. På den **reglera URL: er och musik domän** avsnittet, utför följande steg:

    ![Reglera musik domän URL: er och enkel inloggning information](./media/active-directory-saas-settlingmusic-tutorial/tutorial_settlingmusic_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **certifikat (Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/active-directory-saas-settlingmusic-tutorial/tutorial_settlingmusic_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/active-directory-saas-settlingmusic-tutorial/tutorial_general_400.png)
...
6. På den **reglera musik Configuration** klickar du på **konfigurera reglera musik** att öppna **konfigurera inloggning** fönster. Kopiera den **Sign-Out Webbadressen och SAML enkel inloggning Service** från den **Snabbreferens avsnitt.**
    ...
    ![Reglera musik konfiguration](./media/active-directory-saas-settlingmusic-tutorial/tutorial_settlingmusic_configure.png) 
...
8. På sidan, klickar du på **management** fliken.
    ...
    ![Reglera musik steg 1](./media/active-directory-saas-settlingmusic-tutorial/tutorial_settlingmusic_step1.png)

9. Klicka på **systeminställningen** fliken.

    ![Reglera musik steg 2](./media/active-directory-saas-settlingmusic-tutorial/tutorial_settlingmusic_step2.png)

10. Växla till **säkerhet** fliken.

    ![Steg 3 reglera musik](./media/active-directory-saas-settlingmusic-tutorial/tutorial_settlingmusic_step3.png)

11. På den **enkel inloggning inställningen** avsnittet, utför följande steg:

    ![Reglera musik step5](./media/active-directory-saas-settlingmusic-tutorial/tutorial_settlingmusic_step4.png)
...
1. I Azure-portalen i den vänstra rutan klickar du på den **Azure Active Directory** knappen.
    ...
    ![Azure Active Directory-knappen](./media/active-directory-saas-settlingmusic-tutorial/create_aaduser_01.png)

2. Om du vill visa en lista över användare, gå till **användare och grupper**, och klicka sedan på **alla användare**.

    ![”Användare och grupper” och ”alla användare” länkar](./media/active-directory-saas-settlingmusic-tutorial/create_aaduser_02.png)

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i den **alla användare** dialogrutan.

    ![Knappen Lägg till](./media/active-directory-saas-settlingmusic-tutorial/create_aaduser_03.png)

4. I den **användaren** dialogrutan utför följande steg:

    ![Dialogrutan användare](./media/active-directory-saas-settlingmusic-tutorial/create_aaduser_04.png)
...
2. Välj i listan med program **reglera musik**.
    ...
    ![Länken Settling musik i listan med program](./media/active-directory-saas-settlingmusic-tutorial/tutorial_settlingmusic_app.png)  
