...
4. I sökrutan skriver **SharePoint lokala**väljer **SharePoint lokala** resultatet-panelen klickar **Lägg till** för att lägga till programmet.
    ...
    ![SharePoint lokalt i resultatlistan](./media\active-directory-saas-sharepoint-on-premises-tutorial/tutorial_sharepointonpremises_addfromgallery.png)
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media\active-directory-saas-sharepoint-on-premises-tutorial/tutorial_sharepointonpremises_samlbase.png)

3. På den **SharePoint lokalt domän och URL: er** avsnittet, utför följande steg:

    ![SharePoint-lokala domän URL: er och enkel inloggning information](./media\active-directory-saas-sharepoint-on-premises-tutorial/tutorial_sharepointonpremises_url1.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn med filnamnstillägget .cer. Kopiera och klistra in den fullständiga sökvägen till metadatafilen hämtade i anteckningar.
    ...
    ![Länken hämta certifikatet](./media\active-directory-saas-sharepoint-on-premises-tutorial/tutorial_sharepointonpremises_certificate.png)

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media\active-directory-saas-sharepoint-on-premises-tutorial/tutorial_general_400.png)
...
6. På den **SharePoint lokalt Configuration** klickar du på **Konfigurera SharePoint lokala** att öppna **konfigurera inloggning** fönster. Kopiera den **inloggning tjänst-URL för enkel** från den **Snabbreferens avsnitt.**
    ...
    ![Konfiguration av SharePoint lokalt](./media\active-directory-saas-sharepoint-on-premises-tutorial/tutorial_sharepointonpremises_configure.png)
...
8. **Konfigurera en ny betrodd identitetsleverantör i SharePoint Server 2016**
    ...
    ![Konfigurera din autentiseringsprovider](./media\active-directory-saas-sharepoint-on-premises-tutorial/fig10-configauthprovider.png)
...
1. I Azure-portalen i den vänstra rutan klickar du på den **Azure Active Directory** knappen.
    ...
    ![Azure Active Directory-knappen](./media\active-directory-saas-sharepoint-on-premises-tutorial/create_aaduser_01.png)

2. Om du vill visa en lista över användare, gå till **användare och grupper**, och klicka sedan på **alla användare**.

    ![”Användare och grupper” och ”alla användare” länkar](./media\active-directory-saas-sharepoint-on-premises-tutorial/create_aaduser_02.png)

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i den **alla användare** dialogrutan.

    ![Knappen Lägg till](./media\active-directory-saas-sharepoint-on-premises-tutorial/create_aaduser_03.png)

4. I den **användaren** dialogrutan utför följande steg:

    ![Dialogrutan användare](./media\active-directory-saas-sharepoint-on-premises-tutorial/create_aaduser_04.png)
...
4. Klicka på i princip för webbprogram **Lägg till användare**.
    ...
    ![Söka efter en användare med deras namn anspråk](./media\active-directory-saas-sharepoint-on-premises-tutorial/fig11-searchbynameclaim.png)
...
9. I behörigheter, klickar du på **fullständig kontroll**.
    ...
    ![Ge fullständig behörighet till en användare med anspråk](./media\active-directory-saas-sharepoint-on-premises-tutorial/fig12-grantfullcontrol.png)
...
![Anspråk sökresultat](./media\active-directory-saas-sharepoint-on-premises-tutorial/fig16-claimssearchresults.png)
...
2. Välj i listan med program **SharePoint lokala**.
    ...
    ![SharePoint-länken i listan med program](./media\active-directory-saas-sharepoint-on-premises-tutorial/tutorial_sharepointonpremises_app.png)
