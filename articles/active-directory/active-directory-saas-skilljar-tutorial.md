...
Dieses Lernprogramm wird gezeigt, wie Skilljar mit Azure Active Directory (Azure AD) integrieren.<br>Integration von Azure AD Skilljar bietet Ihnen folgende Vorteile:
...
6. Geben Sie in das Suchfeld **Skilljar**.<br><br>
![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-skilljar-tutorial/tutorial_skilljar_01.png)<br>
7. Wählen Sie im Ergebnisbereich **Skilljar**, und klicken Sie dann auf **abgeschlossen** um die Anwendung hinzuzufügen.
<br><br>![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-skilljar-tutorial/tutorial_skilljar_02.png)<br>
...
Damit einmaliges Anmelden funktioniert, muss Azure AD wissen, welcher Benutzer in Skilljar als Gegenbenutzer zu einem Benutzer in Azure AD fungiert. Das heißt, muss eine linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in Skilljar eingerichtet werden.<br>
Diese linkbeziehung wird durch Zuweisen des Werts der hergestellt der **Benutzername** in Azure AD als Wert für die **Benutzername** in Skilljar.
...
4. **[Erstellen einen Testbenutzer Skilljar](#creating-a-skilljar-test-user)** – ein Gegenstück zur Britta Simon Skilljar enthalten, die in Azure AD-Darstellung Ihrer verknüpft ist.
...
1. In der klassischen Azure-Portal auf der **Skilljar** AHA klicken Sie auf **einmaliges Anmelden konfigurieren** zum Öffnen der **Konfigurieren Sie einmaliges Anmelden**  Dialogfeld.
<br><br> ![Einmaliges Anmelden konfigurieren][6] <br>

2. Auf der **wie sollen sich Benutzer anmelden Skilljar** Seite **Azure AD Single Sign-On**, und klicken Sie dann auf **Weiter**.
<br><br> ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-skilljar-tutorial/tutorial_skilljar_03.png) <br>

3. Auf der **App-Einstellungen konfigurieren** Dialogfeld führen die folgenden Schritte aus:.
<br><br>![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-skilljar-tutorial/tutorial_skilljar_04.png) <br>
...
4. Auf der **Skilljar einmaliges Anmelden konfigurieren** führen die folgenden Schritte aus:
<br><br>![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-skilljar-tutorial/tutorial_skilljar_05.png) <br>

    a. Klicken Sie auf **Metadaten**, und speichern Sie die Datei auf Ihrem Computer.

    b. Kopieren der **Namensbezeichnerformat** Wert.

    c. Klicken Sie auf **Weiter**.


5. Um SSO konfiguriert für Ihre Anwendung zu erhalten, wenden Sie sich an das Supportteam von Skilljar per e-Mail, schließen Sie die **Namensbezeichnerformat** -Wert aus dem vorherigen Schritt, und fügen Sie die heruntergeladene Metadatendatei.
...
<br><br>![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-skilljar-tutorial/create_aaduser_09.png) <br>

2. Aus der **Verzeichnis** wählen Sie das Verzeichnis für die Verzeichnisintegration aktiviert werden sollen.

3. Klicken Sie zum Anzeigen der Liste der Benutzer im Menü am oberen Rand **Benutzer**.
<br><br> ![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-skilljar-tutorial/create_aaduser_03.png) <br>
...
<br><br> ![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-skilljar-tutorial/create_aaduser_04.png) <br>

5. Auf der **Erzählen Sie uns dieses Benutzers** Dialogfeld führen die folgenden Schritte aus:
<br><br> ![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-skilljar-tutorial/create_aaduser_05.png) <br>
...
<br><br>![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-skilljar-tutorial/create_aaduser_06.png) <br>
...
<br><br> ![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-skilljar-tutorial/create_aaduser_07.png) <br>

8. Auf der **vorübergehendes Kennwort abrufen** Dialogfeld führen die folgenden Schritte aus:
<br><br>![Ein Azure AD-Testbenutzer erstellen](./media/active-directory-saas-skilljar-tutorial/create_aaduser_08.png) <br>
...
> [AZURE.NOTE] Wenn Sie einen Benutzer manuell erstellen möchten, müssen Sie der Skilljar-Supportteam wenden.


### Zuweisen des Azure AD-Testbenutzers

Das Ziel dieses Abschnitts ist das Aktivieren von Britta Simon Azure einmaliges Anmelden zu verwenden, indem Skilljar keinen Zugriff erteilen.
...
<br><br>![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-skilljar-tutorial/tutorial_skilljar_50.png) <br>
