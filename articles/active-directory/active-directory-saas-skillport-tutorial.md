...
3. På den **Skillport domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textruta Skriv en URL med följande mönster:
      ...
      Europa Datacenter:`https://<subdomain>.skillport.eu`
   
      USA Datacenter:`https://<subdomain>.skillport.com`
   
    b. I den **Reply URL** textruta Skriv en URL med följande mönster:
    
      Europa Datacenter:`https://<subdomain>.skillport.eu/adfs/ls/`
    
      USA Datacenter:`https://<subdomain>.skillport.com/sp/ACS.saml2`

    > [!NOTE] 
    > Dessa värden är inte verkligt. Uppdatera dessa värden med den faktiska Reply URL och inloggnings-URL. Kontakta [Skillport klienten supportteamet](https://www.skillsoft.com/contact.asp) att hämta dessa värden.
