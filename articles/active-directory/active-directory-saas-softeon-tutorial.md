...
4. I sökrutan skriver **Softeon WMS**.
    ...
    ![Skapa en testanvändare i Azure AD](./media/active-directory-saas-softeon-tutorial/tutorial_softeon_search.png)

5. Välj i resultatpanelen **Softeon WMS**, och klicka sedan på **Lägg till** för att lägga till programmet.

    ![Skapa en testanvändare i Azure AD](./media/active-directory-saas-softeon-tutorial/tutorial_softeon_addfromgallery.png)
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Konfigurera enkel inloggning](./media/active-directory-saas-softeon-tutorial/tutorial_softeon_samlbase.png)

3. På den **Softeon WMS domän och URL: er** avsnittet, utför följande steg:

    ![Konfigurera enkel inloggning](./media/active-directory-saas-softeon-tutorial/tutorial_softeon_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **certifikat (Base64)** och spara certifikatfilen på datorn.
    ...
    ![Konfigurera enkel inloggning](./media/active-directory-saas-softeon-tutorial/tutorial_softeon_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning](./media/active-directory-saas-softeon-tutorial/tutorial_general_400.png)
...
6. På den **Softeon WMS Configuration** klickar du på **konfigurera Softeon WMS** att öppna **konfigurera inloggning** fönster. Kopiera den **SAML enhets-ID och SAML enkel inloggning Tjänstwebbadress** från den **Snabbreferens avsnitt.**
    ...
    ![Konfigurera enkel inloggning](./media/active-directory-saas-softeon-tutorial/tutorial_softeon_configure.png) 
...
1. I den **Azure-portalen**, klicka på det vänstra navigeringsfönstret **Azure Active Directory** ikon.
    ...
    ![Skapa en testanvändare i Azure AD](./media/active-directory-saas-softeon-tutorial/create_aaduser_01.png) 

2. Om du vill visa en lista över användare, gå till **användare och grupper** och på **alla användare**.
    
    ![Skapa en testanvändare i Azure AD](./media/active-directory-saas-softeon-tutorial/create_aaduser_02.png) 

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i dialogrutan.
 
    ![Skapa en testanvändare i Azure AD](./media/active-directory-saas-softeon-tutorial/create_aaduser_03.png) 

4. På den **användaren** dialogrutan utför följande steg:
 
    ![Skapa en testanvändare i Azure AD](./media/active-directory-saas-softeon-tutorial/create_aaduser_04.png) 
...
2. Välj i listan med program **Softeon WMS**.
    ...
    ![Konfigurera enkel inloggning](./media/active-directory-saas-softeon-tutorial/tutorial_softeon_app.png) 
