...
4. I sökrutan skriver **Spacio**väljer **Spacio** resultatet-panelen klickar **Lägg till** för att lägga till programmet.
    ...
    ![Spacio i resultatlistan](./media/active-directory-saas-spacio-tutorial/tutorial_spacio_addfromgallery.png)
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/active-directory-saas-spacio-tutorial/tutorial_spacio_samlbase.png)

3. På den **Spacio domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och Spacio domän med enkel inloggning information](./media/active-directory-saas-spacio-tutorial/tutorial_spacio_url.png)
...
1. I Azure-portalen i den vänstra rutan klickar du på den **Azure Active Directory** knappen.
    ...
    ![Azure Active Directory-knappen](./media/active-directory-saas-spacio-tutorial/create_aaduser_01.png)

2. Om du vill visa en lista över användare, gå till **användare och grupper**, och klicka sedan på **alla användare**.

    ![”Användare och grupper” och ”alla användare” länkar](./media/active-directory-saas-spacio-tutorial/create_aaduser_02.png)

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i den **alla användare** dialogrutan.

    ![Knappen Lägg till](./media/active-directory-saas-spacio-tutorial/create_aaduser_03.png)

4. I den **användaren** dialogrutan utför följande steg:

    ![Dialogrutan användare](./media/active-directory-saas-spacio-tutorial/create_aaduser_04.png)
...
2. Välj i listan med program **Spacio**.
    ...
    ![Länken Spacio i listan med program](./media/active-directory-saas-spacio-tutorial/tutorial_spacio_app.png)  
