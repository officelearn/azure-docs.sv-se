...
Nach Abschluss dieses Lernprogramms Azure AD-Benutzer zugewiesene TOPdesk - Public können sich in der Anwendung auf Ihrer TOPdesk – Public-Unternehmenswebsite (vom Dienstanbieter initiierte Anmeldung) oder über die [Einführung in den Zugriffsbereich](active-directory-saas-access-panel-introduction.md).
...
6.  In der **Suchfeld**, Typ **TOPdesk - Public**.

    ![Anwendungskatalog](./media/active-directory-saas-topdesk-public-tutorial/IC790614.png "Application Gallery")

7.  Wählen Sie im Ergebnisbereich **TOPdesk - Public**, und klicken Sie dann auf **abgeschlossen** um die Anwendung hinzuzufügen.
...
1.  Melden Sie sich auf Ihre **TOPdesk - Public** -Unternehmenswebsite als Administrator.
...
5.  In der **öffentlichen** Teil der **SAML Login** Konfiguration führen die folgenden Schritte aus:
    ...
    2.  Öffnen Sie die Metadatendatei, und suchen Sie die **ein** Knoten.
        ![Ein](./media/active-directory-saas-topdesk-public-tutorial/IC790619.png "AssertionConsumerService")
...
7.  Auf der **TOPdesk - Public** AHA klicken Sie auf **einmaliges Anmelden konfigurieren** zum Öffnen der ** einmaliges Anmelden ** Dialogfeld.
...
8.  Auf der **Wie möchten Sie Benutzer zur Anmeldung bei TOPdesk - Public** Seite **Microsoft Azure AD Single Sign-On**, und klicken Sie dann auf **Weiter**.
...
9.  Auf der **App-URL konfigurieren** führen die folgenden Schritte aus:
    ...
    1.  In der **TOPdesk – Public-Anmelde-URL** Textfeld die URL ein, von den Benutzern Ihrer TOPdesk – Public Anwendung anzumelden (z. B.: "*https://qssolutions.topdesk.net*").
    2.  In der **TOPdesk – Public-Antwort-URL** Textfeld einfügen der **TOPdesk – Public-AssertionConsumerService-URL** (z. B.: "*https://qssolutions.topdesk.net/tas/public/login/saml*")
    3.  Klicken Sie auf **Weiter**.

10. Auf der **einmaliges Anmelden konfigurieren, um TOPdesk – Public** Seite zum Herunterladen der Metadatendatei, klicken Sie auf **Metadaten**, und speichern Sie die Datei lokal auf Ihrem Computer.
...
12. Auf der TOPdesk – Public-Unternehmenswebsite in das **TOPdesk** Menü klicken Sie auf **Einstellungen**.
...
2.  Klicken Sie im Menü am oberen Rand **TOPdesk \ > New \ > Unterstützungsdateien \ > Person**.
...
3.  Führen Sie im Dialogfeld „Neue Person“ die folgenden Schritte aus:
    ...
    3.  Wählen Sie eine **Website** für das Konto.
    4.  Klicken Sie auf **Speichern**.

>[AZURE.NOTE] Können Sie alle anderen TOPdesk – Public Benutzerkonten oder APIs vom TOPdesk - Public Bereitstellung AAD-Benutzerkonten.
...
2.  Auf der ** TOPdesk - Public ** anwendungsintegrationsseite, klicken Sie auf **Zuweisen von Benutzern**.
