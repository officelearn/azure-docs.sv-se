...
4. I sökrutan skriver **ån**väljer **ån** resultatet-panelen klickar **Lägg till** för att lägga till programmet.
    ...
    ![Ån i resultatlistan](./media/active-directory-saas-versal-tutorial/tutorial_versal_addfromgallery.png)
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/active-directory-saas-versal-tutorial/tutorial_versal_samlbase.png)

3. På den **ån domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och versal domän med enkel inloggning information](./media/active-directory-saas-versal-tutorial/tutorial_versal_url.png)
...
4. Ditt program förväntar SAML-intyg i ett specifikt format, vilket kräver att du kan lägga till anpassade attributmappning konfigurationen för SAML-token attribut. Följande skärmbild visar ett exempel för det här. Standardvärdet för **användar-ID** är **user.userprincipalname** men **ån** förväntar sig detta mappas med användarens e-postadress. Som du kan använda **user.mail** attribut i listan eller använda rätt attribut-värde baserat på konfigurationen för din organisation.
    ...
    ![Listrutan för användar-ID](./media/active-directory-saas-versal-tutorial/tutorial_versal_attribute.png)

5. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.

    ![Länken hämta certifikatet](./media/active-directory-saas-versal-tutorial/tutorial_versal_certificate.png) 

6. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/active-directory-saas-versal-tutorial/tutorial_general_400.png)
...
1. I Azure-portalen i den vänstra rutan klickar du på den **Azure Active Directory** knappen.
    ...
    ![Azure Active Directory-knappen](./media/active-directory-saas-versal-tutorial/create_aaduser_01.png)

2. Om du vill visa en lista över användare, gå till **användare och grupper**, och klicka sedan på **alla användare**.

    ![”Användare och grupper” och ”alla användare” länkar](./media/active-directory-saas-versal-tutorial/create_aaduser_02.png)

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i den **alla användare** dialogrutan.

    ![Knappen Lägg till](./media/active-directory-saas-versal-tutorial/create_aaduser_03.png)

4. I den **användaren** dialogrutan utför följande steg:

    ![Dialogrutan användare](./media/active-directory-saas-versal-tutorial/create_aaduser_04.png)
...
2. Välj i listan med program **ån**.
    ...
    ![Ån länken i listan med program](./media/active-directory-saas-versal-tutorial/tutorial_versal_app.png)  
