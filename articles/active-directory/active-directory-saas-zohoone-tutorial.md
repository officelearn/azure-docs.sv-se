...
4. I sökrutan skriver **Zoho en**väljer **Zoho en** resultatet-panelen klickar **Lägg till** för att lägga till programmet.
    ...
    ![En Zoho i resultatlistan](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_addfromgallery.png)
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_samlbase.png)

3. På den **Zoho en domän och URL: er** avsnittet, utför följande steg om du vill konfigurera programmet i **IDP** initierade läge:

    ![URL: er och Zoho en domän med enkel inloggning information](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_url.png)
...
5. På den **SAML-signeringscertifikat** klickar du på **certifikat (Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_certificate.png) 

6. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/active-directory-saas-zohoone-tutorial/tutorial_general_400.png)
...
7. På den **Zoho en konfiguration** klickar du på **konfigurera Zoho en** att öppna **konfigurera inloggning** fönster. Kopiera den **Sign-Out Webbadressen och SAML enkel inloggning Service** från den **Snabbreferens avsnitt.**
    ...
    ![Zoho en konfiguration](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_configure.png) 
...
9. På den **organisation** flik, klicka på **installationsprogrammet** under **SAML-autentisering**.
    ...
    ![Zoho en organisations](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_setup.png)

10. Utför följande steg på popup-sidan:

    ![En Zoho sig](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_save.png)
...
11. När du har sparat inställningarna för SAML-autentisering, kopiera den **SAML-Identfier** värde och använda det här värdet i den **Reply URL** i Azure-portalen under **Zoho en domän och URL: er** avsnittet.
    ...
    ![En Zoho saml](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_samlidenti.png)

12. Gå till den **domäner** och klicka sedan på **Lägg till domän**.

    ![Zoho en domän](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_domain.png)

13. På den **Lägg till domän** utför följande steg:

    ![En Zoho Lägg till domän](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_adddomain.png)
...
1. I Azure-portalen i den vänstra rutan klickar du på den **Azure Active Directory** knappen.
    ...
    ![Azure Active Directory-knappen](./media/active-directory-saas-zohoone-tutorial/create_aaduser_01.png)

2. Om du vill visa en lista över användare, gå till **användare och grupper**, och klicka sedan på **alla användare**.

    ![”Användare och grupper” och ”alla användare” länkar](./media/active-directory-saas-zohoone-tutorial/create_aaduser_02.png)

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i den **alla användare** dialogrutan.

    ![Knappen Lägg till](./media/active-directory-saas-zohoone-tutorial/create_aaduser_03.png)

4. I den **användaren** dialogrutan utför följande steg:

    ![Dialogrutan användare](./media/active-directory-saas-zohoone-tutorial/create_aaduser_04.png)
...
2. På den **användare** fliken, klicka på **användaren logotypen**.
    ...
    ![Zoho en användare](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_users.png)

3. På den **Lägg till användare** utför följande steg:

    ![En Zoho lägga till användare](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_adduser.png)
...
2. Välj i listan med program **Zoho en**.
    ...
    ![Zoho en länk i listan med program](./media/active-directory-saas-zohoone-tutorial/tutorial_zohoone_app.png)  
