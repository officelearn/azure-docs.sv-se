...
Nach Abschluss dieses Lernprogramms ZScaler Beta zugewiesene Azure AD-Benutzer werden mit der Anwendung auf Ihrer ZScaler Beta-Unternehmenswebsite (vom Dienstanbieter initiierte Anmeldung) anmelden oder über die [Einführung in den Zugriffsbereich](active-directory-saas-access-panel-introduction.md).
...
6.  In der **Suchfeld**, Typ **ZScaler Beta**.

    ![Anwendungskatalog](./media/active-directory-saas-zscaler-beta-tutorial/IC800224.png "Application Gallery")

7.  Wählen Sie im Ergebnisbereich **ZScaler Beta**, und klicken Sie dann auf **abgeschlossen** um die Anwendung hinzuzufügen.
...
1.  In Azure AD-Portal auf der **ZScaler Beta** AHA klicken Sie auf **einmaliges Anmelden konfigurieren** zum Öffnen der ** einmaliges Anmelden konfigurieren ** Dialogfeld.
...
2.  Auf der **wie sollen sich Benutzer bei ZScaler Beta anmelden** Seite **Microsoft Azure AD Single Sign-On**, und klicken Sie dann auf **Weiter**.
...
3.  Auf der **App-URL konfigurieren** auf der Seite der **ZScaler Beta-Anmelde-URL** Textfeld Geben Sie die URL, die Ihre Benutzer für die Anmeldung bei Ihrem ZScaler Beta-Anwendung, und klicken Sie dann auf **Weiter**.

    ![App-URL konfigurieren](./media/active-directory-saas-zscaler-beta-tutorial/IC800227.png "Configure App URL")

    >[AZURE.NOTE] Sie können den tatsächlichen Wert für Ihre Umgebung von Ihrem ZScaler Beta-Supportteam erhalten, wenn Sie ihn benötigen.

4.  Auf der **einmaliges Anmelden konfigurieren um ZScaler Beta** Seite, um Ihr Zertifikat herunterzuladen, klicken Sie **Zertifikat herunterladen**, und speichern Sie die Datei auf Ihrem Computer.
...
9.  Auf der **SAML einmaliges Anmelden für Parameter konfigurieren** Seite führen die folgenden Schritte aus, und klicken Sie dann auf **Fertig**:
    ...
    1.  In Azure-Portal auf der **einmaliges Anmelden konfigurieren um ZScaler Beta** Kopieren der **Authentifizierungsanforderungs-URL** -Wert aus, und fügen Sie ihn in die **URL des SAML-Portals, an die Benutzer, für die Authentifizierung gesendet werden** Textfeld.
...
11. In Azure-Portal auf der **einmaliges Anmelden konfigurieren um ZScaler Beta** Dialogfeld auf der Seite Wählen Sie die Konfiguration von SSO Bestätigung, und klicken Sie dann auf **vollständig**.
...
>[AZURE.NOTE] Können Sie alle anderen ZScaler Beta Benutzerkonten oder APIs von ZScaler Beta Bereitstellung AAD-Benutzerkonten.
...
2.  Auf der **ZScaler Beta** anwendungsintegrationsseite, klicken Sie auf **Zuweisen von Benutzern**.
