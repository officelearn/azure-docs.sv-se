---
title: Bästa praxis för att skydda administrativ åtkomst i Azure AD | Microsoft Docs
...
![Faser i översikten med tiden rader](./media/admin-roles-best-practices/roadmap-timeline.png)
...
![Steg 1](./media/admin-roles-best-practices/stage-one.png)
...
Azure Active Directory, använder [Azure AD Privileged Identity Management](active-directory-privileged-identity-management-configure.md) kapaciteten. Tidsbegränsad aktivering av Privilegierade roller fungerar genom att:
...
Läs mer om hur Microsoft Office 365 hanterar säkerhetsincidenter [Security Incident Management i Microsoft Office 365](http://aka.ms/Office365SIM).
