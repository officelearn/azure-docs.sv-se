...
Du får ett svar på det sätt som visas nedan. Kopiera "ID-attributet" som finns i svaret. Det här värdet är **ProvisioningJobId** och kommer att användas för att hämta underliggande metadata för schemat.
   ...
   [![etablerings jobb-ID](./media/export-import-provisioning-configuration/wd_export_03.png)](./media/export-import-provisioning-configuration/wd_export_03.png#lightbox)
...
På fliken "begär ande text" kopierar du innehållet i JSON-schemafilen.
   ...
   [![begär ande text](./media/export-import-provisioning-configuration/wd_export_04.png)](./media/export-import-provisioning-configuration/wd_export_04.png#lightbox)
