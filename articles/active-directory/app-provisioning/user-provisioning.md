...
Detaljerad vägledning om hur du använder SCIM för att automatisera etableringen och avetablering av användare och grupper i ett program finns i [bygga en scim-slutpunkt och konfigurera användar etablering](use-scim-to-provision-users-and-groups.md).
