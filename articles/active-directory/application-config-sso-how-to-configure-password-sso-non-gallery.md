...
När du lägger till ett icke-galleriet program måste du konfigurera enkel inloggning metoden programmet använder genom att välja den **enkel inloggning** navigeringsobjektet på en Enterprise-programmet i den [Azure Portal](https://portal.azure.com/).
