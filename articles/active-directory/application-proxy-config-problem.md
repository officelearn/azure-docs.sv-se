...
Mer information om hur du skapar ett programproxy-program via administrationsportalen finns [publicera program med Azure AD Application Proxy](manage-apps/application-proxy-publish-azure-portal.md).
...
[Aktivera Application Proxy i Azure portal](manage-apps/application-proxy-enable.md)
