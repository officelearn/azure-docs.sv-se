...
Följ stegen nedan om du vill kontrollera om du har rätt djuplänken:
...
6.  Öppna den [ **Azure Portal** ](https://portal.azure.com/) och logga in som en **Global administratör** eller **Co-administratör.**

7.  Öppna den **Azure Active Directory-tillägget** genom att klicka på **fler tjänster** längst ned i den huvudsakliga vänstra navigeringsmenyn.

8.  Skriv i **”Azure Active Directory**” i sökrutan för filter och välj den **Azure Active Directory** objekt.

9.  Klicka på **företagsprogram** från Azure Active Directory vänstra navigeringsmenyn.
...
12. Hitta etiketten **användaren åtkomst-URL**. Du djuplänken ska matcha denna URL.
