...
* **F: kan mina användare registrera sina egna lösen ords återställnings data?**
  ...
  > **S:** Ja. Så länge lösen ords återställning är aktiverat och de är licensierade kan användare gå till registrerings portalen för lösen ords återställning (https://aka.ms/ssprsetup) för att registrera sin autentiseringsinformation. Användare kan också registrera sig via åtkomst panelen (https://myapps.microsoft.com). Om du vill registrera dig via åtkomst panelen måste du välja profil bilden, välja **profil**och sedan välja alternativet **Registrera för lösen ords återställning** .
  >
  >
...
* **F: hur lång tid ska jag vänta på att få ett e-postmeddelande, SMS eller telefonsamtal från återställning av lösen ord?**
  ...
  > * Kontrol lera att autentiseringsdata i katalogen är korrekt formaterat, till exempel + 1 4255551234 eller *användar\@contoso.com*. 
