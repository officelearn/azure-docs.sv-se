...
Mer information, gå igenom kraven för anslutningen i den [krav för Azure AD Connect](./../connect/active-directory-aadconnect-prerequisites.md) artikeln.
