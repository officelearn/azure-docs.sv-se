...
| --- | --- |
| Lösenord | MFA and SSPR |
| Säkerhetsfrågor | SSPR Only |
| E-postadress | SSPR Only |
| Microsoft Authenticator-appen | MFA and SSPR |
| OATH Hardware token | Public preview for MFA and SSPR |
| SMS | MFA and SSPR |
| Röstsamtal | MFA and SSPR |
| Applösenord | MFA only in certain cases |
