...
* Om användaren har åtkomst till den anpassade URL:
    * Genom att skicka den *wattimmar* parametern till lösenordet som återställa sidan ”https://login.microsoftonline.com/?whr=contoso.com”
...
[Contact]: ./media/concept-sspr-customization/sspr-contact-admin.png "Kontakta administratören för hjälp om du återställer ditt lösenord e-exempel"
