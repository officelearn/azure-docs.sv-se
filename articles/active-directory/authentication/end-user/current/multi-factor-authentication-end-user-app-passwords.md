...
- Testa den [Microsoft Authenticator-appen](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-how-to.md) att verifiera din inloggningar med app-meddelanden i stället för att ta emot texter eller samtal.
