---
title: Ställ in tvåstegsverifiering - Azure AD | Microsoft Docs
...
5. Om du använder de här apparna kopiera applösenordet tillhandahålls och klistra in den i ditt program i stället för vanliga lösenord. Du kan använda samma applösenord för flera appar. Mer information finns i [vad är Applösenord](../../../../multi-factor-authentication/end-user/multi-factor-authentication-end-user-app-passwords.md).
6. Klicka på **Klar**.
...
* Ställ in [applösenord](../../../../multi-factor-authentication/end-user/multi-factor-authentication-end-user-app-passwords.md) för ursprunglig enhetsappar som inte stöder tvåstegsverifiering.
* Kolla in den [Microsoft Authenticator-appen](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-how-to.md) säker autentisering för snabb, även om du inte har cell service.
