...
**Gå till sidan för ytterligare säkerhet verifiering**

- Gå till https://aka.ms/MFASetup.

    ![Proofup](./media/multi-factor-authentication-end-user-manage-settings/proofup.png)

Om du klickar på länken inte fungerar kan du också få till den **ytterligare säkerhetsverifiering** sidan genom att följa dessa steg:
...
1. På den **ytterligare säkerhetsverifiering** väljer textrutan med ditt aktuella telefonnummer och redigera den med ditt nya telefonnummer.  
2. Välj **Spara**.  
3. Om det här telefonnumret är det tal som du använder för din verifieringsalternativet, måste du kontrollera det nya värdet innan du kan spara den.  
