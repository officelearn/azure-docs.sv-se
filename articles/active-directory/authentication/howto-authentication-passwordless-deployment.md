...
| --- | --- | --- |
| [Kombinerad registrering för Azure Multi-factor autentisering och självbetjäning lösenordsåterställning (SSPR)](howto-registration-mfa-sspr-combined.md) är aktiverat | √ | √ |
