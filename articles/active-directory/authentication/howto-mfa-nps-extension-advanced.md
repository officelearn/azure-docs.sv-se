...
Använd rekommenderade åtgärder för felsökning av problem med alternativt inloggnings-ID: N [alternativa inloggnings-ID fel](howto-mfa-nps-extension-errors.md#alternate-login-id-errors).
