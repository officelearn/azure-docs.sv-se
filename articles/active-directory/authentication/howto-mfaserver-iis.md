...
4. Ange inloggnings-URL (t. ex. `https://localhost/contoso/auth/login.aspx`) i dialog rutan konfigurera formulärbaserad webbplats automatiskt och klicka på **OK**om du vill identifiera användar namn, lösen ord och domänautentiseringsuppgifter automatiskt.
