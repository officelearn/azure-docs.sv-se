...
| OnPremisesAdminActionRequired = 29 | Vi kan tyvärr inte återställa ditt lösen ord just nu på grund av ett problem med konfigurationen av lösen ords återställning i organisationen. Det finns ingen ytterligare åtgärd som du kan vidta för att lösa den här situationen. Kontakta din administratör och be dem att undersöka.<br /><br />Mer information om det potentiella problemet finns i [Felsöka tillbakaskrivning av lösen ord](troubleshoot-sspr-writeback.md). | SSPR_0029: vi kan inte återställa lösen ordet på grund av ett fel i din lokala konfiguration. Kontakta din administratör och be dem att undersöka. |
