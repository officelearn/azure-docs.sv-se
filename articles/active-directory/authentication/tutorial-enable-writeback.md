...
* En befintlig server som konfigurerats för att köra en aktuell version av [Azure AD Connect](../connect/active-directory-aadconnect-get-started-express.md).
