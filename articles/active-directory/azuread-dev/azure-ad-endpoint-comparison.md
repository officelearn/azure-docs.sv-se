...
Om du vill veta mer om OAuth 2,0, `refresh_tokens`och `access_tokens`kan du titta på [referens för Microsoft Identity Platform-protokollet](../develop/active-directory-v2-protocols.md?toc=/azure/active-directory/azuread-dev/toc.json&bc=/azure/active-directory/azuread-dev/breadcrumb/toc.json).
