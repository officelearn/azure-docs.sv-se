...
12. Välj **Microsoft Azure-hantering** på sidan **Välj** och välj sedan **Välj**.
    ...
    ![Skärm bild som visar den valda Microsoft Azure hanterings appen](media/tutorial-mfa/tutorial-mfa-policy-11.png)
...
1.  På sidan **villkorlig åtkomst – principer** väljer du **What If**. 
    ...
    ![Skärm bild som visar var du väljer alternativet vad om](media/tutorial-mfa/tutorial-mfa-whatif-1.png)
...
I den här självstudien har du skapat en princip för villkorlig åtkomst som kräver att gäst användare använder MFA när de loggar in till en av dina molnappar. Läs mer om att lägga till gästanvändare för samarbete i [Lägga till B2B-samarbetsanvändare för Azure Active Directory i Azure-portalen](add-users-administrator.md).
