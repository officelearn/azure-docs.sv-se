...
description: Användartokenreferens för Azure Active Directory B2B-samarbete
...
Om du vill veta hur token ser ut för en B2B-samarbetsanvändare finns här bärare tokeninformation och tokeninnehåll för en Azure Active Directory (Azure AD) gäst och en Microsoft-konto gäst i resursklienten (för tenantid 04dcc6ab-388a-4559-b527-fbec656300ea). Om du vill visa JSON Web Token [https://jwt.io/](https://jwt.io/) (JWT) använder eller [https://jwt.ms/](https://jwt.ms/).

## <a name="azure-ad-guest-token"></a>Azure AD-gästtoken
```
...
## <a name="microsoft-account-guest-token"></a>Gästtoken för Microsoft-konto
```
