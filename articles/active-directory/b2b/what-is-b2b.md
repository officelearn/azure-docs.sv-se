---
title: Vad är Azure Active Directory B2B-samarbete? - Azure Active Directory | Microsoft Docs
...
![Skärm bild som visar post sidan ny gäst användar inbjudan](media/what-is-b2b/adding-b2b-users-admin.png)
