...
1. Om det finns en brand vägg mellan dina servrar och Azure AD konfigurerar du följande objekt:
   ...
   - Om brand väggen eller proxyservern låter dig ange säkra suffix lägger du till anslutningar i \*. msappproxy.net och \*. servicebus.windows.net. Om inte, Tillåt åtkomst till [Azure datacenter IP-intervall](https://www.microsoft.com/download/details.aspx?id=41653)som uppdateras varje vecka.
