...
Den vanligaste topologin är en multipel AD-skog med en eller flera domäner och en enda Azure AD-klient.  
...
![topologin för en enskild skog och en enskild klient](media/plan-cloud-provisioning-topologies/migrate.png) ett pilot scenario innebär att både Azure AD Connect och Azure AD Connect moln etablering i samma skog och omfånget användare och grupper. Obs: ett objekt ska finnas i omfånget i ett av verktygen. 
