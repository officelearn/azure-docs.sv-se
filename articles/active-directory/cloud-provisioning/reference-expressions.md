...
|-----|----|
|[Lägg till](#append)|Tar ett käll sträng värde och lägger till suffixet i slutet av det.|
...
|[Växel](#switch)|Returnerar **värdet** för den **nyckeln**när **källobjektet** matchar en **nyckel**. | 
