...
Ja, du kan använda Exchange ActiveSync i principer för villkorlig åtkomst med några [begränsningar](https://docs.microsoft.com/azure/active-directory/conditional-access/conditional-access-for-exo-and-spo). 
