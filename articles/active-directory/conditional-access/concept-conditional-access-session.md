...
- Övervaka användarsessioner för kompatibilitet: riskfyllda användare övervakas när de loggar in i appar och deras åtgärder loggas in i sessionen. Du kan undersöka och analysera användarbeteende för att förstå där, och under vilka omständigheter sessionsprinciper ska användas i framtiden.
