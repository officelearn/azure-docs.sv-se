...
* **Tjänstkonton** och **tjänstprinciper**, till exempel Azure AD Connect Sync-konto. Tjänstkonton är icke-interaktiva konton som inte är kopplade till en viss användare. De används normalt av backend-tjänster och ger programmatisk åtkomst till program. Tjänstkonton bör uteslutas eftersom MFA inte kan slutföras programmässigt.
