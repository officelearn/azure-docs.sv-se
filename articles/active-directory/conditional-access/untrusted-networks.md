---
title: Så här kräver du Multi-Factor Authentication (MFA) för åtkomst från obetrodda nätverk med Azure Active Directory (Azure AD) villkorlig åtkomst | Microsoft Docs
