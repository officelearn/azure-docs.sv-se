...
Läs mer om Azure AD, [identitet identitetssynkronisering och duplicerad attributåterhämtning](https://aka.ms/dupattributeresdocs).
...
![Diagnostisera synkronisering överblivna felobjektet * finns användare * scenario](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixOrphanedCase.png)
...
![Diagnostisera synkronisering överblivna felobjektet * samma användare * scenario](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixOrphanedCase.png)
