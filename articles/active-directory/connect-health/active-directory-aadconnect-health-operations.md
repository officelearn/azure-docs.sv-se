...
![Skärmbild av Azure AD Connect Health e-postmeddelandeinställningarna](./media/active-directory-aadconnect-health/email_noti_discover.png)
...
1. Från den **konfigurera** klickar du på **användare**.<br>
   ![Skärmbild av Azure AD Connect Health resource sidopanelen](./media/active-directory-aadconnect-health/startRBAC.png)
2. Välj **Lägg till**.
...
6. När rolltilldelningen är klar visas de användare och grupper i listan.<br>
   ![Skärmbild av Azure AD Connect Health RBAC användare fönster, med nya användare som är markerat](./media/active-directory-aadconnect-health/RBAC_user_list.png)
...
2. På bladet kan du fästa bladet eller olika delar av det, på instrumentpanelen. Klicka bara på den **fäst på instrumentpanelen** ikon.<br>
   ![Skärmbild av Azure AD Connect Health RBAC Fäst bladet, med fästikonen markerad](./media/active-directory-aadconnect-health/RBAC_pin_blade.png)
...
![Skärmbild av Azure AD Connect Health RBAC användare fönstret med ta bort markerade](./media/active-directory-aadconnect-health/RBAC_remove.png)
