...
Under analysen (steg 4) om attributet har konfigurerats på ett eller flera objekt i katalogen, slutsatsen guiden attributet som används av ett annat program och returnerar ett fel som visas i diagrammet nedan. Om du är säker på att attributet inte är används av befintliga program, måste du kontakta Support för information om hur du kan ignorera felet.
