...
### <a name="highlevel-steps-for-upgrading-from-dirsync-to-azure-ad-connect"></a>Allmänna steg för att uppgradera från DirSync till Azure AD Connect
...
## <a name="inplace-upgrade"></a>Uppgradering på plats
