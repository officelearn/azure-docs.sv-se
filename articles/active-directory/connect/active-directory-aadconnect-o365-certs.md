...
![Office 365 portal-meddelande](./media/active-directory-aadconnect-o365-certs/notification.png)
...
> [!NOTE]
> Om du behöver stöd för flera toppdomänerna, till exempel contoso.com och fabrikam.com, måste du använda den **SupportMultipleDomain** växel med cmdlets. Mer information finns i [stöd för flera domäner på toppnivå nivå](active-directory-aadconnect-multiple-domains.md).
>
