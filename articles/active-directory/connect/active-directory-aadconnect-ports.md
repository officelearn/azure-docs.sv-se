...
En lista över slutpunkter finns i [avsnittet krav för Azure AD Connect Health-agenten](../connect-health/active-directory-aadconnect-health-agent-install.md#requirements).
