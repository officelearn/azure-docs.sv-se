...
>[!IMPORTANT]
>Vi rekommenderar starkt att som du [förnyar Kerberos-krypteringsnyckel](active-directory-aadconnect-sso-faq.md#how-can-i-roll-over-the-kerberos-decryption-key-of-the-azureadssoacc-computer-account) av den `AZUREADSSOACC` datorkontot minst var 30: e dag.
