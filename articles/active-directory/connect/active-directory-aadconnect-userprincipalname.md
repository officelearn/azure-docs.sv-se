...
Ett UPN består av ett UPN-prefix (användarkontonamnet) och UPN-suffix (ett DNS-domännamn). Prefixet är ansluten med suffixet med hjälp av den ”@” symbol. Till exempel ”someone@example.com”. Ett UPN måste vara unika bland alla säkerhetsobjekt inom en directory-skog. 
...
- Ange Azure AD MailNickName attributet lokala e-attributet prefix.
...
### <a name="scenario-4-non-verified-upn-suffix--update-on-premises-mail-attribute-and-primary-smtp-address"></a>Scenario 4: Icke-verifierad UPN-suffixet – uppdatera lokala e-postattribut och primära SMTP-adress

Lokala användarobjektet:
- mailNickName: us4
- e-post:us6@contoso.com
...
- Efter den första synkroniseringen för användarobjektet, uppdateras till lokal e-attributet och primära SMTP-adress påverkar inte attribut för en Azure AD MailNickName eller UserPrincipalName.
