...
![Start-menyn med Sync Rule Editor](./media/active-directory-aadconnectsync-change-the-configuration/startmenu2.png)
...
Den [scheduler](active-directory-aadconnectsync-feature-scheduler.md) körs var 30: e minut som standard. Kontrollera att den inte startar när du gör ändringar och felsöka din nya regler. För att tillfälligt inaktivera scheduler, starta PowerShell och kör `Set-ADSyncScheduler -SyncCycleEnabled $false`.

![Inaktivera scheduler](./media/active-directory-aadconnectsync-change-the-configuration/schedulerdisable.png)  
...
**Förhandsgranskning och en fullständig synkronisering på ett enda objekt**  
   ...
   ![Genomför förhandsversion](./media/active-directory-aadconnectsync-change-the-configuration/commitpreview.png)  
...
2. Skapa attributflöden med **uttryck** för **ExchangeRate för FlowType** och med **AuthoritativeNull** för **källa**. Literalen **AuthoritativeNull** anger att värdet ska vara tomt i metaversum, även om en lägre prioritet synkroniseringsregel försöker att fylla i värdet.
  ![Transformering för tilläggsattribut](./media/active-directory-aadconnectsync-change-the-configuration/syncruletransformations.png)
...
4. Kontrollera att de avsedda ändringarna är på väg att exporteras genom att söka i Anslutarplatsen.
  ![Mellanlagrad delete](./media/active-directory-aadconnectsync-change-the-configuration/deletetobeexported.png)
...
![Lägg till attribut för datakälla till en lokal AD anslutningsschema](./media/active-directory-aadconnectsync-change-the-configuration/usertype1.png)
...
![Lägga till källattributet schemat för Azure AD-koppling](./media/active-directory-aadconnectsync-change-the-configuration/usertype2.png)
