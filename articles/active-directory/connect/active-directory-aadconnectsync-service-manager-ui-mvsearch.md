...
Markera ett objekt i sökresultaten och **egenskaper** att se den [metaversum objektegenskaper](active-directory-aadconnectsync-troubleshoot-object-not-syncing.md#metaverse-object-properties).
