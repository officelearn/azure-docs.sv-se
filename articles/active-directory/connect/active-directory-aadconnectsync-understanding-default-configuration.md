...
För att förstå vilka konfigurationsmodellen kan läsa [förstå deklarativ etablering](active-directory-aadconnectsync-understanding-declarative-provisioning.md).
...
![Bild med scenariobeskrivning](./media/active-directory-aadconnectsync-understanding-default-configuration/scenario.png)
...
![Synkronisering Regelredigeraren ikon](./media/active-directory-aadconnectsync-understanding-default-configuration/sre.png)
...
![Synkroniseringsregler inkommande](./media/active-directory-aadconnectsync-understanding-default-configuration/syncrulesinbound.png)
...
Eftersom den här regeln är en regel för out-of-box, får du en varning när du öppnar regeln. Du bör inte göra någon [ändringar av out-of-box regler](active-directory-aadconnectsync-best-practices-changing-default-configuration.md), så att du får din avsikt är. I detta fall använder vill du bara visa regeln. Välj **nr**.
...
![Beskrivning av fliken synkroniserade regeln editor ](./media/active-directory-aadconnectsync-understanding-default-configuration/syncruledescription.png)
...
![Konfigurera fliken i synkronisering regeln editor ](./media/active-directory-aadconnectsync-understanding-default-configuration/syncrulescopingfilter.png)
...
![Konfigurera fliken i synkronisering regeln editor ](./media/active-directory-aadconnectsync-understanding-default-configuration/syncrulescopingfilterout.png)
...
![Häng med fliken regler i synkronisering regeln editor ](./media/active-directory-aadconnectsync-understanding-default-configuration/syncrulejoinrules.png)
...
![Transformationer fliken synkroniserade regeln editor ](./media/active-directory-aadconnectsync-understanding-default-configuration/syncruletransformations.png)
...
Se [förstå uttryck för deklarativ etablering](active-directory-aadconnectsync-understanding-declarative-provisioning-expressions.md) mer information om Uttrycksspråk för attributflöden.
...
* Läs mer om konfigurationsmodellen i [förstå deklarativ etablering](active-directory-aadconnectsync-understanding-declarative-provisioning.md).
...
* Fortsätt att läsa hur out-of-box-konfigurationen fungerar i [förstå användare och kontakter](active-directory-aadconnectsync-understanding-users-and-contacts.md)
* Se hur du ändrar något praktiskt med deklarativ etablering i [hur du gör en ändring i standardkonfigurationen](active-directory-aadconnectsync-change-the-configuration.md).
