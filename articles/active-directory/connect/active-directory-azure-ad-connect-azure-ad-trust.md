...
![Azure AD Connect sidan som visar meddelandet om säkerhetskopiering av befintliga Azure AD-förtroende](media/active-directory-azure-ad-connect-azure-ad-trust/backup2.png)
...
![En sanpshot för till exempel som säkerhetskopiering av Azure AD-förtroende](media/active-directory-azure-ad-connect-azure-ad-trust/backup.png)
...
* [Hantera och anpassa Active Directory Federation Services med Azure AD Connect](active-directory-aadconnect-federation-management.md)