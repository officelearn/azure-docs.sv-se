---
title: Azure Active Directory v2 Android komma igång | Microsoft Docs
description: 'Hur en Android-app kan få en åtkomsttoken och anropa Microsoft Graph API eller API: er som kräver åtkomst-token från en Azure Active Directory v2-slutpunkt.'
