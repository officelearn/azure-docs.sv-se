...
description: 'Hur en Android-app kan få en åtkomsttoken och anropa Microsoft Graph API eller API: er som kräver åtkomsttoken från en Azure Active Directory v2-slutpunkt.'
