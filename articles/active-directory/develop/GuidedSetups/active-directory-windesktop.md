...
description: Hur ett Windows Desktop .NET (XAML)-program kan få en åtkomsttoken och anropa ett API som skyddas av en Azure Active Directory v2-slutpunkt.
