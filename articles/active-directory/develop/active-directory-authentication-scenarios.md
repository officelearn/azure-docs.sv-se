...
![Den enda Sidprogram diagram](./media/active-directory-authentication-scenarios/single_page_app.png)
...
![Internt program för att webb-API-Diagram](./media/active-directory-authentication-scenarios/native_app_to_web_api.png)
...
![Webbprogram till webb-API-diagram](./media/active-directory-authentication-scenarios/web_app_to_web_api.png)
...
![Daemon eller ett program till webb-API-diagram](./media/active-directory-authentication-scenarios/daemon_server_app_to_web_api.png)
