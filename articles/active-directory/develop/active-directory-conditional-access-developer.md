...
Kunskap om [enda](quickstart-v1-integrate-apps-with-azure-ad.md) och [flera innehavare](active-directory-devhowto-multi-tenant-overview.md) appar och [vanliga autentiseringsmönster](authentication-scenarios.md) antas.
...
![App fungerar on-behalf-of-flödesdiagram](media/active-directory-conditional-access-developer/app-performing-on-behalf-of-scenario.png)
...
![Appen åtkomst till flera tjänster flödesdiagram](media/active-directory-conditional-access-developer/app-accessing-multiple-services-scenario.png)
...
![Ensidesappen använder ADAL flödesdiagram](media/active-directory-conditional-access-developer/spa-using-adal-scenario.png)
...
* Läs mer om scenarier med flera innehavare i [så här loggar du in användare med flera innehavare mönstret](active-directory-devhowto-multi-tenant-overview.md).
