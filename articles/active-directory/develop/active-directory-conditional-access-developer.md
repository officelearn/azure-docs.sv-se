...
Azure Active Directory (Azure AD) finns flera sätt att skydda din app och skydda en tjänst. En av dessa unika funktioner är villkorlig åtkomst. Villkorlig åtkomst kan utvecklare och enterprise-kunder att skydda tjänster i en mängd olika sätt, inklusive:
