...
description: Läs om fördelarna med att integrera ditt program med Azure Active Directory, och få resurser för funktioner som förenklad inloggning, Identitetshantering, multifaktorautentisering och åtkomstkontroll.
...
ms.locfileid: "59359894"
---
# <a name="integrating-with-azure-active-directory"></a>Integrera med Azure Active Directory

[!INCLUDE [active-directory-devguide](../../../includes/active-directory-devguide.md)]

I den här artikeln du lär dig mer om fördelarna med att integrera ditt program med Azure Active Directory (Azure AD) och hämta resurser för integrering. Azure AD tillhandahåller organisationer med företagsklass Identitetshantering för molnprogram. Azure AD-integrering ger användarna en smidig inloggningsupplevelse och bidrar till att dina program som överensstämmer med IT-princip.
