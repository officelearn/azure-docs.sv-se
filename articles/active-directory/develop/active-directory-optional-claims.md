...
> - Valfria anspråk för Azure AD fungerar bara med Azure AD-tillägget och fungerar inte med Microsoft Graph Directory-tillägget. Båda API: erna kräver `Directory.ReadWriteAll` behörighet, som endast kan skickas av administratörer.
