...
![Kodflöde för OAuth-autentisering](media/active-directory-protocols-oauth-code/active-directory-oauth-code-flow-native-app.png)
...
Mer information om JSON web token finns i den [JWT IETF utkast till en specifikation](http://go.microsoft.com/fwlink/?LinkId=392344). Mer information om typer av token och anspråk [stöds Token och anspråkstyper](active-directory-token-and-claims.md)
