...
Den `profile` omfång kan användas med den `openid` omfång och alla andra. Den ger appen åtkomst till en stor mängd information om användaren. Informationen om den kan komma åt omfattar, men är inte begränsad till användarens förnamn, efternamn, primära användarnamn och objekt-ID. En fullständig lista över anspråk för profilen som är tillgängliga i parametern id_tokens för en viss användare ser den [v2.0 tokens referens](active-directory-v2-tokens.md).
...
![Arbeta konto medgivande](../../media/active-directory-v2-flows/work_account_consent.png)
