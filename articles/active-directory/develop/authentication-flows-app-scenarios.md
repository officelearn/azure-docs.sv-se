...
Många moderna webbappar skapas som program på en enda sida på klient sidan. Dessa program använder Java Script eller ett ramverk som vinkel, Vue.js och React.js. Dessa program körs i en webbläsare.
