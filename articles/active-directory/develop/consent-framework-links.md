---
title: Så här fungerar programtillåtelser | Microsoft Docs
description: Mer information om hur Azure AD-ramverket för medgivande fungerar om du vill se hur du kan använda den när du utvecklar program på Azure AD
...
ms.locfileid: "56185476"
---
# <a name="how-application-consent-works"></a>Hur programmet samtycker fungerar

Den här artikeln är att hjälpa dig att lära dig mer om hur Azure AD-ramverket för medgivande fungerar så att du kan utveckla program mer effektivt.
