...
|`unique_name` |  Sträng | Innehåller en mänsklig läsbara värde som identifierar föremål för token. Det här värdet är inte säkert att vara unika inom en klient och bör endast användas för visning. Endast utfärdats i v1.0 `id_tokens`. |
...
## <a name="validating-idtokens"></a>Verifiera `id_tokens`
