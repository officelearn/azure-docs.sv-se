...
Returnerar `IAuthenticationResult` en åtkomsttoken och ID-token, medan den nya uppdateringstoken lagras i cacheminnet.
Ansökan kommer nu också att innehålla ett IAccount:
