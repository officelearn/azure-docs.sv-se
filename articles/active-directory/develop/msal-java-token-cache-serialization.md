...
ms.locfileid: "73905503"
---
# <a name="custom-token-cache-serialization-in-msal-for-java-msal4j"></a>Anpassad token cache-serialisering i MSAL för Java (MSAL4J)

Om du vill ha ett program med beständig token cache måste du anpassa serialiseringen. Java-klasser och gränssnitt som ingår i cachelagring av token är följande:
