...
MSAL4J är det Java-bibliotek som används för att logga in användare och begära token som används för att få åtkomst till ett API som skyddas av Microsoft Identity Platform.
...
Lägg till en referens till MSAL4J genom att lägga till följande kod överst i filen där du kommer att använda MSAL4J:
