...
> Om du vill att kod exemplet i den här snabb starten ska fungera måste du lägga till en `redirectUri` som `http://localhost:3000/` och aktivera **implicit beviljande**.
