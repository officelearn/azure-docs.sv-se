...
1. Välj den **Azure Active Directory** tjänsten och välj sedan **appregistreringar**.
...
1. Om arbetsflödet kräver att du kan spara i manifesten i centrallagret för senare användning, föreslår vi att rebasing sparade manifesten i databasen med den som du ser i den **appregistreringar** upplevelse.
