...
Klientprogram | Plattform | Flöde/tilldelning | Anrop Microsoft Graph | Anropar ett ASP.NET-eller ASP.NET Core 2. x-webb-API
------------------ | -------- | ---------- | -------------------- | -------------------------
...
Klientprogram | Plattform | Flöde/tilldelning | Anropar en ASP.NET-eller ASP.NET Core 2,0-webb-API
------------------ | -------- | ---------- | -------------------- 
