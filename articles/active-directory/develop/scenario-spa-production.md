...
Djupgående snabb starts exempel, som förklarar koden för att logga in användare och hämta en åtkomsttoken för att anropa Microsoft Graph-API med hjälp av MSAL. js:
