...
| ![MSAL python](media/sample-v2-code/logo_python.png) <br/> MSAL python | Stöd för python-webbprogram |
| ![MSAL Java](media/sample-v2-code/logo_java.png) <br/> MSAL Java | Stöd för Java-webbprogram |
