...
description: Lär dig hur du konfigurerar ett program som program för flera innehavare och hur flera innehavare fungerar
...
Här är en lista över rekommenderade avsnitt för mer information om program för flera innehavare:
...
- Få en förståelse av [så här konfigurerar du ett program är flera innehavare](https://docs.microsoft.com/azure/active-directory/develop/active-directory-integrating-applications#configuring-multi-tenant-applications)
- Få en stegvisa översikt över [hur Azure AD-ramverket för medgivande används för att implementera medgivande](https://docs.microsoft.com/azure/active-directory/develop/active-directory-integrating-applications#overview-of-the-consent-framework), vilket krävs för program för flera innehavare
