---
title: Validerings skillnader enligt de konto typer som stöds (SignInAudience) – Microsoft Identity Platform/Azure Active Directory
...
När du registrerar ett program med Microsoft Identity Platform för utvecklare uppmanas du att välja vilka konto typer som programmet har stöd för. I programobjektet och manifestet är den här egenskapen `signInAudience`.
