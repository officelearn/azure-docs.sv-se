...
1. I listan över sidor för appen väljer du **Autentisering**. Sedan:
   - I avsnittet **Avancerade inställningar** ställer du in **utloggnings-URL** till **https://localhost:44316/Account/EndSession** .
   - I avsnittet **Avancerade inställningar** > **implicita bidrag** väljer du **åtkomsttoken** och **ID-token**. Det här exemplet kräver att det [implicita tilldelnings flödet](v2-oauth2-implicit-grant-flow.md) är aktiverat för att logga in användaren och anropa ett API.
1. Välj **Spara**.
1. På sidan **certifikat & hemligheter** väljer du **ny klient hemlighet**i avsnittet **klient hemligheter** . Sedan:
...
1. I listan över sidor för appen väljer du API- **behörigheter**. Sedan:
...
1. I Visual Studio skapar du ett nytt projekt för  **C# Visual** **ASP.NET-webbprogram (.NET Framework)** . 
...
1. Uppdatera **shared\_layout. cshtml** och **Home\Index.cshtml** för att länka ihop de olika vyerna på rätt sätt.
...
1. Välj **Konfigurera**.
1. På fliken **anslutning** uppdaterar du mål-URL: en så att den använder "https". Använd exempelvis [https://dotnet-web-daemon-v2-contoso.azurewebsites.net](https://dotnet-web-daemon-v2-contoso.azurewebsites.net). Välj **Nästa**.
...
1. På sidan **autentisering** för ditt program uppdaterar du URL-fälten för **utloggning** med adressen för din tjänst. Använd exempelvis [https://dotnet-web-daemon-v2-contoso.azurewebsites.net](https://dotnet-web-daemon-v2-contoso.azurewebsites.net).
1. Från **anpassnings** menyn uppdaterar du **Start sidans URL** till adressen till din tjänst. Använd exempelvis [https://dotnet-web-daemon-v2-contoso.azurewebsites.net](https://dotnet-web-daemon-v2-contoso.azurewebsites.net).
