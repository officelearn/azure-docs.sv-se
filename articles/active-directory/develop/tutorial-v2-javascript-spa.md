---
title: Azure AD v2 JS SPA interaktiva installation | Microsoft Docs
description: Hur JavaScript SPA-program kan anropa ett API som kräver åtkomsttoken genom Azure Active Directory v2-slutpunkten
