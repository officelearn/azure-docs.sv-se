---
title: Kom igång med Azure Active Directory v2.0 Windows desktop | Microsoft Docs
description: Hur ett Windows Desktop .NET (XAML)-program kan få en åtkomsttoken och anropa ett API som skyddas av en Azure Active Directory v2.0-slutpunkten.
