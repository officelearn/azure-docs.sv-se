...
* Lägg till följande nya metod till **MainPage.xaml.cs**. Den här metoden används för att göra en `GET` begäran mot Graph API med hjälp av ett [auktorisera]-huvud:
