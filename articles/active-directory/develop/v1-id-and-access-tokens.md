...
| Autentisering snabbmeddelanden |Innehåller information om datum och tid när autentiseringen gjordes. <br><br> **SAML exempelvärde**: <br> `<AuthnStatement AuthnInstant="2011-12-29T05:35:22.000Z">` | |
...
| `unique_name` |Namn |Innehåller en mänsklig läsbara värde som identifierar föremål för token. Det här värdet är inte säkert att vara unika inom en klient och är avsedd att användas endast för visning. <br><br> **SAML exempelvärde**: <br> `<Attribute Name=”http://schemas.xmlsoap.org/ws/2005/05/identity/claims/name”>`<br>`<AttributeValue>frankm@contoso.com<AttributeValue>` <br><br> **Exempelvärde JWT**: <br> `"unique_name": "frankm@contoso.com"` |
