---
title: Microsoft Identity Platform och SAML Bearer-försäkrat flöde | Azure
...
1. I bröd texten i begäran ersätter du **client_id**, **client_secret**och **Assertion** (Base64-kodad SAML-kontroll som hämtades i föregående steg):
