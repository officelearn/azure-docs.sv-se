...
| Microsoft-konto: säkerhets kopiering/återställning |Nej |Ja |
...
| **Skriv bords anpassning**: Skriv bords tema (bakgrund, system färg, standard system ljud, skärmsläckare) |sync |X |Visst |
| **Skriv bords anpassning**: bild spels tapet |sync |X |Visst |
| **Skriv bords anpassning**: inställningar för aktivitets fältet (position, Auto-Dölj osv.) |sync |X |Visst |
...
| **Högkontrast**: på eller av |sync |X |Enkel åtkomst |
| **Hög kontrast**: Tema inställningar |sync |X |Enkel åtkomst |
...
| **Tangent bord**: användare kan aktivera/inaktivera skärm tangent bordet |sync |X |Enkel åtkomst |
| **Tangent bord**: aktivera Tröga tangenter Ja (inaktiverat som standard) |sync |X |Enkel åtkomst |
| **Tangent bord**: aktivera filter nycklar (av som standard) |sync |X |Enkel åtkomst |
| **Tangent bord**: Aktivera växlings tangenter (inaktiverat som standard) |sync |X |Enkel åtkomst |
...
| **Start skärms anpassning**: accentfärg (endast mobil) |X |sync |Visst |
