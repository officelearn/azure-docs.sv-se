...
* Mer information om roller och administratören rolltilldelning finns i [Tilldela administratörsroller](active-directory-assign-admin-roles-azure-portal.md).
