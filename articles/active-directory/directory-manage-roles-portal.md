...
* Mer information om roller och administratören rolltilldelning finns i [Tilldela administratörsroller](users-groups-roles/directory-assign-admin-roles.md).
