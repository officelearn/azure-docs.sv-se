...
[Get-MsolGroup](/powershell/module/msonline/get-msolgroup) -cmdlet: en kan användas för att hämta gruppobjektet och kontrol lera *licens* egenskapen: den visar alla produkt licenser som är tilldelade till gruppen.
