...
- [Skapa en ny grupp med Azure Active Directory](active-directory-groups-create-azure-portal.md) eller [skapa och hantera en ny grupp med PowerShell-cmdletar](../enterprise-users/groups-settings-v2-cmdlets.md)
