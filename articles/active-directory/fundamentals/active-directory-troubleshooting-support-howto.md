---
title: Hitta hjälp och öppna ett support ärende – Azure Active Directory | Microsoft Docs
description: Anvisningar om hur du får hjälp och öppnar ett support ärende för Azure Active Directory.
...
Om du inte kan hitta svar med hjälp av självhjälps resurser kan du öppna ett support ärende online. Du bör bara öppna varje support ärende för ett enda problem, så att vi kan ansluta dig till de support tekniker som är föremål för experter på ditt problem. Azure Active Directory teknik team prioriterar också sitt arbete baserat på incidenter som genereras, så att du ofta bidrar till service förbättringar.
...
Se sidan [kontakta Microsoft Support för](https://portal.office.com/Support/ContactUs.aspx) att få support telefonnummer.
