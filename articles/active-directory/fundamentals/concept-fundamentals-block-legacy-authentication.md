...
1. Navigera till Azure-portalen > Azure Active Directory > inloggningar.
1. Lägg till kolumnen Klientapp om den inte visas genom att klicka på Kolumner > klientapp.
1. Filtrera efter klientapp > kontrollera alla andra klientalternativ som visas och klicka på Verkställ.
1. Filtrera efter status > lyckad och klicka på Använd. 
