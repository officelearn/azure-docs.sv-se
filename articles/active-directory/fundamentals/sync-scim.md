...
## <a name="components-ofsystem"></a>System komponenter 
...
## <a name="implementscimwith-azure-ad"></a>Implementera SCIM med Azure AD 
...
* [SCIM 2,0 protokoll kompatibilitet för Azure AD Provisioning-tjänsten](https://docs.microsoft.com/azure/active-directory/app-provisioning/use-scim-to-provision-users-and-groupsapplication-provisioning-config-problem-scim-compatibility)
