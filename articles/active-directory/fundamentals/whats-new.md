...
### <a name="app-only-tokens-now-require-the-resource-application-web-api-to-exist-in-the-resource-tenant"></a>Endast app-token kräver att resurs programmet (webb-API) finns i resurs klienten
