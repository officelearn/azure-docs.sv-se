...
3. Följ stegen i [Azure Active Directory-cmdletar för att konfigurera gruppinställningar](users-groups-roles/groups-settings-cmdlets.md) skapa gruppinställningar för den här klienten.
...
Mer information finns i artikeln [Azure Active Directory-cmdletar för att konfigurera gruppinställningar](users-groups-roles/groups-settings-cmdlets.md).
...
* [Princip för Office 365-grupper](users-groups-roles/groups-lifecycle.md)
