...
<em>"**Cloud App Security** hjälper oss att se till att våra personer på rätt sätt använder våra moln-och SaaS-program, på ett sätt som stöder de grundläggande säkerhets principerna som skyddar Accenture."</em> --- [John Blasi, hanterings chef, informations säkerhet, Accenture](https://customers.microsoft.com/story/accenture-professional-services-cloud-app-security)
