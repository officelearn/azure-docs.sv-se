...
![Distributionsdesign](./media/how-to-connect-fed-azure-adfs/deployment.png)
...
![Skapa det virtuella nätverket](./media/how-to-connect-fed-azure-adfs/deploynetwork1.png)
...
![Undernät](./media/how-to-connect-fed-azure-adfs/deploynetwork2.png)

![DMZ-undernät](./media/how-to-connect-fed-azure-adfs/deploynetwork3.png)
...
![Skapa en nätverkssäkerhetsgrupp](./media/how-to-connect-fed-azure-adfs/creatensg1.png)
...
![Initiera nätverkssäkerhetsgruppen](./media/how-to-connect-fed-azure-adfs/nsgint1.png)
...
![Konfigurera nätverkssäkerhetsgruppen](./media/how-to-connect-fed-azure-adfs/nsgconfigure1.png)
...
![Undernät efter NSG](./media/how-to-connect-fed-azure-adfs/nsgconfigure2.png)
...
![Skapa lagringskonton](./media/how-to-connect-fed-azure-adfs/storageaccount1.png)
...
![Tillgänglighetsuppsättningar](./media/how-to-connect-fed-azure-adfs/availabilityset1.png)
...
![Distribuerade virtuella datorer](./media/how-to-connect-fed-azure-adfs/virtualmachinesdeployed_noadfs.png)
...
![Bläddra till lastbalanseraren](./media/how-to-connect-fed-azure-adfs/browseloadbalancer.png)
...
![Intern lastbalanserare](./media/how-to-connect-fed-azure-adfs/ilbdeployment1.png)
...
![Lastbalanserare efter ILB](./media/how-to-connect-fed-azure-adfs/ilbdeployment2.png)
...
![Konfigurera serverdelspoolen för den interna belastningsutjämnaren](./media/how-to-connect-fed-azure-adfs/ilbdeployment3.png)
...
![Konfigurera ILB-avsökning](./media/how-to-connect-fed-azure-adfs/ilbdeployment4.png)
...
![Konfigurera ILB-belastningsutjämningsregler](./media/how-to-connect-fed-azure-adfs/ilbdeployment5.png)
...
![Internetuppkopplad lastbalanserare](./media/how-to-connect-fed-azure-adfs/elbdeployment1.png)

Efter distributionen visas lastbalanseraren i listan över lastbalanserare.

![Lista med lastbalanserare](./media/how-to-connect-fed-azure-adfs/elbdeployment2.png)
...
![Konfigurera en Internetuppkopplad lastbalanserare](./media/how-to-connect-fed-azure-adfs/elbdeployment3.png) 

![Konfigurera en Internetuppkopplad lastbalanserare (DNS)](./media/how-to-connect-fed-azure-adfs/elbdeployment4.png)
...
![Konfigurera serverdelspoolen för den Internetuppkopplade lastbalanseraren](./media/how-to-connect-fed-azure-adfs/elbdeployment5.png)
...
![Konfigurera avsökningen för den Internetuppkopplade lastbalanseraren](./media/how-to-connect-fed-azure-adfs/elbdeployment6.png)
...
![Konfigurera lastbalanseringsregler för den Internetuppkopplade lastbalanseraren](./media/how-to-connect-fed-azure-adfs/elbdeployment7.png)
...
![INT-åtkomstregler (inkommande)](./media/how-to-connect-fed-azure-adfs/nsg_int.png)
...
![EXT-åtkomstregler (inkommande)](./media/how-to-connect-fed-azure-adfs/nsg_dmz.png)
...
![Testa inloggningssidan](./media/how-to-connect-fed-azure-adfs/test1.png)

Om inloggningen lyckas visas ett meddelande som det nedan:

![Lyckat test](./media/how-to-connect-fed-azure-adfs/test2.png)
...
* [Konfigurera och hantera AD FS med Azure AD Connect](how-to-connect-fed-whatis.md)
