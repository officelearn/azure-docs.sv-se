...
Se dokument [metoder för att tilldela användare och grupper till en app](../../active-directory/manage-apps/methods-for-assigning-users-and-groups.md#assign-groups) för information om hur du hanterar grupp tilldelningar till program.
...
[Metoder för att tilldela användare och grupper till en app](../../active-directory/manage-apps/methods-for-assigning-users-and-groups.md#assign-groups)

[Konfigurera roll anspråk](../../active-directory/develop/active-directory-enterprise-app-role-management.md)