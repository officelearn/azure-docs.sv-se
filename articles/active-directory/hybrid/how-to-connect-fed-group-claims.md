...
3. Ange grupp configuration valfria anspråk.
   ...
   Om du vill grupper i token för att innehålla den lokala AD-Gruppattribut i avsnittet valfria anspråk anger vilken typ tokenu valfria anspråk ska tillämpas på, namnet på valfria anspråk som begärs och ytterligare egenskaper som önskas.  Flera typer av token kan visas:
