...
* En Azure AD-klientorganisation. You get one with an [Azure free trial](https://azure.microsoft.com/pricing/free-trial/). You can use one of the following portals to manage Azure AD Connect:
...
* Windows Server 2012R2
  * Microsoft PowerShell is installed by default. Ingen åtgärd krävs.
...
| Number of objects in Active Directory | Processor | Minne | Hard drive size |
| --- | --- | --- | --- |
