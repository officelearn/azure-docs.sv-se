...
1. I listan **kopplingar** ser du till att den koppling som du ändrade i föregående steg är markerad. I **åtgärder**väljer du **Konfigurera körnings profiler**.  
   ![anslutnings körning profil 1](./media/how-to-connect-sync-configure-filtering/connectorrunprofiles1.png)  
...
3. Justera de **tillagda** och **borttagna** domänerna för varje profil.
    1. För var och en av de fem profilerna utför du följande steg för varje **tillagd** domän:
        ...
        ![anslutnings kör profiler 2](./media/how-to-connect-sync-configure-filtering/runprofilesnewstep1.png)  
    ...
    2. Utför följande steg för varje **borttagen** domän för var och en av de fem profilerna:
        ...
        ![Connector kör profiler 4](./media/how-to-connect-sync-configure-filtering/runprofilesdeletestep.png)  
...
5. I **omfångs filter**, klickar du på **Lägg till grupp**och klickar sedan på **Lägg till sats**. I **attribut**väljer du **ExtensionAttribute15**. Kontrol lera att **operatorn** är inställd på **lika**och skriv värdet **nosync** i rutan **värde** . Klicka på **Next**.  
...
5. I **omfångs filter**, klickar du på **Lägg till grupp**och klickar sedan på **Lägg till sats**. I **attribut**väljer du **avdelning**. Kontrol lera att operatorn är inställd på **lika**och skriv värdet **Sales** i rutan **värde** . Klicka på **Next**.  
...
I det här exemplet ändrar du filtreringen så att endast användare som har både e-post och userPrincipalName som slutar i @contoso.com synkroniseras:
...
2. Välj **kopplingar**. I listan **kopplingar** väljer du den koppling där du gjorde en konfigurations ändring tidigare. I **åtgärder**väljer du **Kör**.  
   ![kopplings körning](./media/how-to-connect-sync-configure-filtering/connectorrun.png)  
