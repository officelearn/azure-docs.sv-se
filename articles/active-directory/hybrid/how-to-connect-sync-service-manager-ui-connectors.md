...
### <a name="configure-run-profiles"></a>Konfigurera körning av profiler
...
### <a name="changing-the-ad-ds-account-password"></a>Ändra lösen ordet för AD DS-kontot
...
8. Ange det nya lösen ordet för AD DS-kontot i text rutan för lösen ord ![Azure AD Connect verktyget Sync-krypterings nyckel](./media/how-to-connect-sync-service-manager-ui-connectors/key6.png)
