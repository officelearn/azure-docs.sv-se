...
* Om värdet för sourceAnchor ändras efter att objektet har exporter ATS till Azure AD genererar Azure AD Connect Sync ett fel och tillåter inte fler ändringar av objektet innan problemet har åtgärd ATS och sourceAnchor ändras tillbaka i käll regissören Ja.
