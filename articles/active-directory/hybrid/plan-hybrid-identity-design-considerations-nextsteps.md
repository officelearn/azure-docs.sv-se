...
* [Microsoft System Center](/previous-versions/system-center/developer/cc817313(v=msdn.10)) -lösningar kan hjälpa dig att samla in och samla in information om din infrastruktur, principer, processer och metod tips så att IT-personalen kan skapa hanterbara system och automatisera åtgärder.
* [Microsoft Intune](/mem/intune/) är en molnbaserad enhetshanteringstjänst som hjälper dig att hantera dina datorer och mobila enheter och skyddar ditt företags information.
* Med [MDM för Microsoft 365](https://technet.microsoft.com/library/ms.o365.cc.devicepolicy.aspx) kan du hantera och skydda mobila enheter när de är anslutna till din Microsoft 365 organisation. Du kan använda MDM för Microsoft 365 för att ställa in säkerhets principer och åtkomst regler för enheter och Rensa mobila enheter om de tappas bort eller blir stulna.
