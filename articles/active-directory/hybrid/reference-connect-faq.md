...
**F: Fungerar Azure Active Directory Domain Services (Azure AD DS) health-agenten på server core?**  
...
**F: Stöder Azure AD Connect synkroniserar från två domäner till i Azure AD?**  
...
**F: Enkla domännamn utan toppdomän (SLDs) stöds?**  
...
**F: Går det att ungefärlig matchning en lokal Azure AD-grupp eller kontaktobjekt med en befintlig Azure AD-grupp eller kontakta objekt?**  
...
**F: Där dokumenteras PowerShell-cmdlets för Azure AD Connect?**  
...
**F: Azure-inloggningssidan visar användarnamnen för användare som har tidigare loggat in. Det här beteendet stängas av?**  
...
**F: Jag tror att jag uppgraderat till Azure AD Connect, men Office-portalen fortfarande omnämnanden DirSync. Varför är detta?**  
...
**F: Min status för automatiska uppgraderingar texten ”pausad”. Varför är det pausat? Bör jag aktivera den?**  
...
**F: Mitt företag har strikta ändringshantering krav och jag vill styra när skickas. Kan jag styra när automatisk uppgradering startas?**  
Nej, det finns ingen sådan funktion idag. Funktionen utvärderas i en kommande version.

**F: Jag får ett e-postmeddelande om gick inte att automatiskt uppgradera? Hur vet jag att det lyckades?**  
...
**F: Automatisk uppgradering också uppgradera Azure AD Connect Health?**  
