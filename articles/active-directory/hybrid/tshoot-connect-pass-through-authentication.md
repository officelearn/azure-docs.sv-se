...
![Azure Active Directory Administrationscenter – Azure AD Connect-bladet](./media/tshoot-connect-pass-through-authentication/pta7.png)

![Azure Active Directory Administrationscenter - direktautentisering bladet](./media/tshoot-connect-pass-through-authentication/pta11.png)
...
![Azure Active Directory Administrationscenter - rapporten inloggningar](./media/tshoot-connect-pass-through-authentication/pta4.png)
...
Kontrollera att servern där autentisering-agenten har installerats kan kommunicera med vår tjänst-URL: er och portar visas [här](how-to-connect-pta-quick-start.md#step-1-check-the-prerequisites).
...
Kontrollera att servern där Azure AD Connect är installerad kan kommunicera med vår tjänst-URL: er och portar visas [här](how-to-connect-pta-quick-start.md#step-1-check-the-prerequisites).
...
För detaljerad analys, aktivera ”” sessionsloggen (Högerklicka i Loggboken program att hitta det här alternativet). Kör inte Autentiseringsagenten med den här loggfilen aktiveras under normal drift; Använd enbart för felsökning. Logginnehållet visas bara när loggen är inaktiverad igen.
