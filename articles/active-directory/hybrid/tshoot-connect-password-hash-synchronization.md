...
1. Är Connect-server i [mellanlagringsläge](how-to-connect-sync-operations.md#staging-mode)? En server i mellanlagringsläge synkroniserar inte eventuella lösenord.
