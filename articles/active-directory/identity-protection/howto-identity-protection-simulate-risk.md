...
2. Använd din nya VPN, navigera till [https://myapps.microsoft.com](https://myapps.microsoft.com) och ange autentiseringsuppgifterna för ditt test konto.
...
1. Navigera till [https://myapps.microsoft.com](https://myapps.microsoft.com)i standard webbläsaren.  
...
5. Logga in för att [https://myapps.microsoft.com](https://myapps.microsoft.com) att använda samma autentiseringsuppgifter som tidigare och inom några minuter efter den tidigare inloggningen.
