            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Grunder</h3>
                        <p>
                        <a href="/azure/active-directory/fundamentals/active-directory-whatis">Vad är Azure AD?</a><br/>
                        <a href="/azure/active-directory/fundamentals/understand-azure-identity-solutions">Identitetslösningar</a><br/>
                        <a href="/azure/active-directory/fundamentals/get-started-azure-ad">Komma igång</a><br/>
                        <a href="/azure/active-directory/fundamentals/whats-new">Nyheter</a><br/>
                        <a href="/azure/active-directory/fundamentals/active-directory-deployment-plans">Distributionsscheman för Azure AD</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3><a href="/azure/active-directory/users-groups-roles/index">Företagsanvändare</a></h3>
                        <p>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Autentisering</h3>
                        <p>
                        <a href="/azure/active-directory/authentication/concept-sspr-howitworks">Lösenord</a><br/>
                        ...
                        <a href="/azure/active-directory/authentication/active-directory-certificate-based-authentication-get-started">Certifikatbaserad autentisering</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <a href="/azure/active-directory/conditional-access/index">Villkorlig åtkomst</a><br/>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Enheter</h3>
                        <p>
                        <a href="/azure/active-directory/devices/index">Enhetshantering</a><br/>
                        <a href="/azure/active-directory/user-help/device-management-azuread-registered-devices-windows10-setup">Windows 10-enheter</a><br/>
                        <a href="/azure/active-directory/user-help/device-management-azuread-joined-devices-setup">Anslutna enheter</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <a href="/azure/active-directory/manage-apps/migrate-adfs-apps-to-azure">Appmigrering</a><br/>
