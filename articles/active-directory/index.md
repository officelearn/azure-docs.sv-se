...
ms.locfileid: "66307004"
---
<div id="main" class="v2">
    <div class="container">
        <h1>Dokumentation om Azure Active Directory</h1>
        <p>Azure Active Directory (Azure AD) är en molnbaserad identitets- och åtkomsthanteringstjänst för flera klientorganisationer.</p><p></p>
                                                ...
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <p>
                                                            ...
                                                            <a href="manage-apps/user-provisioning.md">Automatisk användarförsörjning</a><br>
                                            ...
                                            <div class="cardPadding">
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <br><br>
                                                        <h3><a href="governance/index.yml">Identitetshantering</a></h3>
                                                        <p>
                                                            <a href="governance/entitlement-management-overview.md">Vad är berättigandehantering?</a><br>
                                                            <a href="governance/access-reviews-overview.md">Vad är åtkomstgranskningar?</a><br>
                                                            <a href="conditional-access/terms-of-use.md">Kräva användningsvillkor</a><br>
                                                ...
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <p>
                                                            ...
                                                            <a href="privileged-identity-management/pim-how-to-add-role-to-user.md">Tilldela katalogroller</a><br>
                                                            <a href="privileged-identity-management/index.yml"><i>Mer information &gt;</i></a>
                                                        </p>
                                                        <br><br>
                ...
                <div class="cardSize">
                    <div class="cardPadding">
                        <div class="card">
                            ...
                            <div class="cardText">
                                <h3>Microsoft 365</h3>
                                <p>Utforska Microsoft 365, en komplett lösning som omfattar Azure AD.</p>
                            </div>
                        </div>
                    </div>
                </div>
