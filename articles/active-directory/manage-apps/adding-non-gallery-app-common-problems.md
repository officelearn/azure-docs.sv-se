---
title: Problem med att lägga till ett program som inte är Galleri | Microsoft Docs
description: Förstå vanliga problem med folkets ansikte när du lägger till anpassade program som inte är gallerier
...
ms.locfileid: "84760294"
---
# <a name="problem-adding-a-non-gallery-application"></a>Problem med att lägga till ett program som inte är en Galleri

Den här artikeln hjälper dig att förstå vanliga problem när du lägger till **anpassade program som inte är gallerier** och vad du kan göra för att lösa dem. 
...
Ibland, på grund av tillfälliga problem, nätverks problem eller en bugg, kan det hända att det inte går att lägga till ett program. Du kan se att detta inträffar när du klickar på ikonen **meddelanden** (klock ikonen) i det övre högra hörnet av Azure Portal och ser en röd ikon (!) bredvid aviseringen **skapa program** . Detta tyder på ett fel när programmet skapades.
...
Om du behöver hjälp med att lära dig om anpassade program kan du lära dig mer om enkel inloggning med Azure AD och hur det fungerar med hjälp av [dokument biblioteket för Azure AD-program](https://docs.microsoft.com/azure/active-directory/active-directory-apps-index) .
...
1. Klicka på **meddelande** ikonen (klock klock) längst upp till höger i Azure Portal
...
- **Internt transaktions-ID** – det interna ID som vi kan använda för att se felet i våra system
