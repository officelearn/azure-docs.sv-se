...
- **Ett omfångs filter har kon figurer ATS** **det här filtrerar användaren utifrån ett attributvärde**. Mer information om omfångs filter finns i [definitions](define-conditional-rules-for-provisioning-user-accounts.md)områdes filter.
