...
Om du använder programmet Qlik Sense ska du alltid installera den senaste anslutningsappen. Qlik Sense använder WebSockets, som endast stöds på versioner av anslutningsappen 1.5.612.0 eller senare.
...
5. Konfigurera **ytterligare inställningar** om det behövs. De flesta programmen bör behålla dessa inställningarna i standardtillstånden. 
    ...
    | Fält | Beskrivning |
    | :---- | :---------- |
    | **Tidsgränsen gick ut för serverdels-programmet** | Ställ endast in värdet på **Lång** om programmet autentiserar och ansluter långsamt. |
