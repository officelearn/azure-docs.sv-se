...
4. Programproxyn verifierar token och hämtar User Principal Name (UPN) från den och sedan anslutningen hämtar UPN och det namnet SPN (Service Principal) via en autentiserad dually säker kanal.
