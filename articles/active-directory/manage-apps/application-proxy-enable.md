...
Om du inte är medveten om säkerhet och produktivitet fördelarna Application Proxy ger för din organisation, lär du dig mer om [ge säker fjärråtkomst till lokala program](application-proxy.md).
...
3. Gå till **Azure Active Directory** > **programproxy**.
   ...
   ![Navigera till Application Proxy](./media/application-proxy-enable/app_proxy_navigate.png)
