...
![Diagram över trafikflödet från användaren till målprogrammet](./media/application-proxy-network-topology/application-proxy-three-hops.png)
...
![Diagram över anslutning är installerad i ett Azure-datacenter](./media/application-proxy-network-topology/application-proxy-expressroute-private.png)
...
Dessutom kan du överväga att ordna dina kopplingar med [connector grupper](application-proxy-connector-groups.md) till mål-appar som finns i olika platser och nätverk. 
...
![Diagram över användare, proxy, koppling och app finns i USA](./media/application-proxy-network-topology/application-proxy-pattern1.png)
...
![Diagram som visar som användare sprids globalt, men proxy-, anslutnings- och app finns i USA](./media/application-proxy-network-topology/application-proxy-pattern2.png)
...
![Diagram över ExpressRoute mellan proxyservern och connector](./media/application-proxy-network-topology/application-proxy-pattern3.png)
...
![Diagram över kopplingen i ett Azure-datacenter och ExpressRoute mellan koppling och appen](./media/application-proxy-network-topology/application-proxy-pattern4.png)
...
![Diagram över användare och proxy i USA med kopplingen och appen i EU](./media/application-proxy-network-topology/application-proxy-pattern5b.png)
...
![Diagram över användare och proxy connector i USA-app i EU](./media/application-proxy-network-topology/application-proxy-pattern5c.png)
