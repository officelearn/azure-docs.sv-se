...
Läs mer om kopplingar [förstå Azure AD Application Proxy kopplingar](application-proxy-connectors.md).
...
* [Lokal anslutning](application-proxy-connectors.md): komponenten lokalt kopplingen lyssnar efter förfrågningar från Azure AD Application Proxy-tjänsten och hanterar anslutningar till de interna program. 
...
[Topologiöverväganden nätverk när du använder Azure AD Application Proxy](application-proxy-network-topology.md)
