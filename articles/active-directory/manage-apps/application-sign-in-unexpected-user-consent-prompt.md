...
-   [Appar, behörigheter och medgivande i Azure Active Directory (v 1.0-slutpunkt)](https://docs.microsoft.com/azure/active-directory/active-directory-apps-permissions-consent)
