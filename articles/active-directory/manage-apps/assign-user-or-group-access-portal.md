...
> [!NOTE]
> De funktioner som beskrivs i den här artikeln kräver ett Azure Active Directory Premium P1- eller Premium P2-licens. Mer information finns i [sida med priser för Azure Active Directory](https://azure.microsoft.com/pricing/details/active-directory).
...
3. På den **Azure Active Directory - *directoryname***  bladet (det vill säga Azure AD bladet för den katalog som du hanterar), Välj **företagsprogram**.
    ...
    ![Öppna företagsappar](./media/assign-user-or-group-access-portal/open-enterprise-apps.png)
...
8. På den **Lägg uppdrag** bladet väljer **användare och grupper**.
    ...
    ![Tilldela en användare eller grupp i appen](./media/assign-user-or-group-access-portal/assign-users.png)
...
Mer information om hur du tilldelar en användare till en roll för program finns i dokumentationen för [ny AzureADUserAppRoleAssignment](https://docs.microsoft.com/powershell/module/azuread/new-azureaduserapproleassignment?view=azureadps-2.0)

Om du vill tilldela en grupp till en enterprise-app måste du ersätta `Get-AzureADUser` med `Get-AzureADGroup`.

### <a name="example"></a>Exempel

Det här exemplet tilldelas användaren Britta Simon till den [Microsoft arbetsplats Analytics](https://products.office.com/business/workplace-analytics) program med hjälp av PowerShell.
...
3. Kör kommandot `$sp.AppRoles` ska visas rollerna som är tillgängliga för arbetsplats Analytics-programmet. I det här exemplet ska vi tilldelas Britta Simon rollen analytiker (begränsad åtkomst).
    ...
    ![Arbetsplats Analytics roll](./media/assign-user-or-group-access-portal/workplace-analytics-role.png)
