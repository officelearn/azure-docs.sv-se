...
| [Verktyget: Active Directory Federation Services beredskap Migreringsskriptet](https://aka.ms/migrateapps/adfsscript) | Det här är ett skript du kan köra på din lokala Active Directory Federation Services (AD FS) server att fastställa beredskap för migrering till Azure AD-appar.|
