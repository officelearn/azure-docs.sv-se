...
| VANLIGA FRÅGOR OCH SVAR| [Vanliga frågor](user-provisioning.md) om automatisk användar etablering |
...
I det här exemplet skapas användare och grupper i en HR-databas som är ansluten till en lokal katalog. Azure AD Provisioning-tjänsten hanterar automatisk användar etablering för mål SaaS-program.
 ...
 ![användar etablering](media/auto-user-provision-dp/hybridprovisioning.png)
...
![Etablerings skärmen för att hantera inställningar för användar konto etablering](media/auto-user-provision-dp/userprovisioning-admincredentials.png)
