...
description: PowerShell-exempel som visar alla Azure Active Directory (Azure AD) Application Proxy-program som använder anpassade domäner men inte har ett giltigt SSL-certifikat.
...
Det här exemplet på PowerShell-skript visar alla Azure Active Directory (Azure AD) Application Proxy-appar som använder anpassade domäner men inte har ett giltigt SSL-certifikat.
