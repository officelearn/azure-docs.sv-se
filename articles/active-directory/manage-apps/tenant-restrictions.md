...
![Klient begränsningar trafikflöde – diagram](./media/tenant-restrictions/traffic-flow.png)
...
![Åtkomst nekades för användare i ej tillåten klienter](./media/tenant-restrictions/end-user-denied.png)
...
![Använda Azure portal för att visa begränsade inloggningsförsök](./media/tenant-restrictions/portal-report.png)
