...
När den inledande synkroniseringen har startat, kan du använda den **granskningsloggar** att övervaka förloppet som visar alla åtgärder som utförs av tjänsten etablering på din app. Mer information om hur du tolkar Azure AD-etablering loggar finns [rapportering om automatisk konto användaretablering](../active-directory-saas-provisioning-reporting.md).
