...
* [Använd en virtuell Linux-dator som tilldelats hanterad identitet för att få åtkomst till Resource Manager](tutorial-linux-vm-access-arm.md) -hanterade-identiteter-Work-VM
