...
```
I JSON-svaret har `"Microsoft.ManagedIdentity/userAssignedIdentities"` användare tilldelade hanterade identiteter värdet returnerat för nyckel. `type`
