...
1. Logga in på Azure med `Connect-AzAccount` cmdleten. Använd ett konto som är associerat med den Azure-prenumeration under vilken du har konfigurerat den hanterade identiteten:
