...
| Hanterad identitets typ | Alla allmänt tillgängliga<br>Globala Azure-regioner | Azure Government | Azure Tyskland | Azure Kina 21Vianet |
| --- | :-: | :-: | :-: | :-: |
| Systemtilldelad | ![Få][check] | ![Få][check] | Inte tillgängligt | Inte tillgängligt |
| Användartilldelad | ![Få][check] | ![Få][check]  | Inte tillgängligt  | Inte tillgängligt |
...
|Hanterad identitets typ | Alla allmänt tillgängliga<br>Globala Azure-regioner | Azure Government | Azure Tyskland | Azure Kina 21Vianet |
| --- | :-: | :-: | :-: | :-: |
| Systemtilldelad | ![Få][check] | ![Få][check] | Förhandsgranskning | Förhandsgranskning |
| Användartilldelad | ![Få][check] | ![Få][check] | Förhandsgranskning | Förhandsgranskning |
