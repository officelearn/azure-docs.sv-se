...
![Hanterade identiteter för Azure-resurser automationsskript exportfel](../managed-service-identity/media/msi-known-issues/automation-script-export-error.png)
