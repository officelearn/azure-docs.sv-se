---
title: Använda en hanterad tjänstidentitet för virtuell Linux-dator för att komma åt Azure Storage med hjälp av en SAS-autentiseringsuppgift
description: En självstudie som visar hur du använder en hanterad tjänstidentitet för virtuell Linux-dator och kommer åt Azure Storage med hjälp av en SAS-autentiseringsuppgift, istället för en åtkomstnyckel för lagringskonto.
...
Den här självstudien visar hur du aktiverar hanterad tjänstidentitet för en virtuell Linux-dator och sedan hämtar en SAS-autentiseringsuppgift (en signatur för delad åtkomst) för lagring med hjälp av den hanterade tjänstidentiteten. Mer specifikt, en [autentiseringsuppgift för tjänst-SAS](/azure/storage/common/storage-dotnet-shared-access-signature-part-1?toc=%2fazure%2fstorage%2fblobs%2ftoc.json#types-of-shared-access-signatures). 
...
Azure Storage har inte inbyggt stöd för Azure AD-autentisering.  Du kan dock använda en hanterad tjänstidentitet för att hämta en lagrings-SAS från Resource Manager, och sedan få åtkomst till lagring med hjälp av SAS:en.  I det här steget ger du den virtuella datorns hanterade tjänstidentitet åtkomst till lagringskontots SAS.   
...
I den här självstudien har du lärt dig att använda en hanterad tjänstidentitet för en virtuell Linux-dator och kommit åt Azure Storage med hjälp av en SAS-autentiseringsuppgift.  Läs mer om Azure Storage SAS här:
