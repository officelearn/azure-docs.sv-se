...
En virtuell dator MSI-dator kan du hämta åtkomsttoken från Azure AD utan att du behöver att placera autentiseringsuppgifter i din kod. Under försättsbladen, när du aktiverar MSI gör två saker: registrerar den virtuella datorn med Azure Active Directory för att skapa dess hanterad identitet och konfigurerar identiteten på den virtuella datorn.
...
4. Ge behållaren ett namn, Välj en åtkomstnivå och sedan på **OK**. Det namn du angav används senare under kursen. 
    ...
    ![Skapa lagringsbehållare](../media/msi-tutorial-linux-vm-access-storage/create-blob-container.png)
...
I den här självstudien lärde du dig att skapa en hanterad tjänstidentitet för att komma åt Azure Storage med SAS-autentiseringsuppgifter.  Om du vill veta se mer om Azure Storage SAS:
