...
- Appar som använder WIA (Windows Integrated Authentication) direkt med Active Directory. Dessa appar kan integreras med Azure AD via [Azure AD-programproxy](https://docs.microsoft.com/azure/active-directory/application-proxy-publish-azure-portal).
