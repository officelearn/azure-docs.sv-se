...
När du har aktiverat MSI på en Azure-resurs, till exempel en [virtuella Azure-datorn](msi-qs-configure-cli-windows-vm.md) eller [skaluppsättning för virtuell dator i Azure](msi-qs-configure-cli-windows-vmss.md): 
...
- För att aktivera MSI på en virtuell Azure-dator, se [konfigurera en Azure VM hanterade tjänsten identitet (MSI) med hjälp av Azure CLI](msi-qs-configure-cli-windows-vm.md).
- Om du vill aktivera MSI i en skaluppsättning för virtuell dator i Azure finns [konfigurera ett Azure Virtual Machine skala Ange hanterade tjänsten identitet (MSI) med Azure-portalen](msi-qs-configure-portal-windows-vmss.md)
