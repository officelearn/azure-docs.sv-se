...
När du har aktiverat MSI på en Azure-resurs, till exempel en [Azure VM](msi-qs-configure-portal-windows-vm.md) eller [Azure VMSS](msi-qs-configure-portal-windows-vmss.md):
...
- För att aktivera MSI på en virtuell Azure-dator, se [konfigurera en Azure VM hanterade tjänsten identitet (MSI) med hjälp av Azure portal](msi-qs-configure-portal-windows-vm.md).
