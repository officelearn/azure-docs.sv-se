...
- [Skapa en Virtual Machine Scale Set i Azure-portalen](../virtual-machine-scale-sets/virtual-machine-scale-sets-create-portal.md)  
...
- Med Azure-portalen, ge en virtuell dator i Azure skaluppsättning MSI [åtkomst till en annan Azure-resurs](msi-howto-assign-access-portal.md).
