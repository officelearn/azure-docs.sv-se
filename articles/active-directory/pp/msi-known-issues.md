...
Obs: Inbyggda deltagarrollen kan utföra alla åtgärder som beskrivs ovan: 
- CRUD användartilldelade identiteter
- Tilldela en användare som tilldelats en resurs identitet. (d.v.s. tilldela identitet till en virtuell dator)
...
![MSI automation export skriptfel](~/articles/active-directory/media/msi-known-issues/automation-script-export-error.png)
...
När schemat exportfunktionen blir tillgänglig för MSI VM-tillägg, visas det i [exportera resursgrupper som innehåller VM-tillägg](~/articles/virtual-machines/windows/extensions-export-templates.md#supported-virtual-machine-extensions).
...
## <a name="known-issues-with-user-assigned-msi-private-preview-feature"></a>Kända problem med användaren tilldelas MSI *(privat förhandsgranskningsfunktion)*
...
- Tilldelar en roll till en MSI till en resurs för närvarande kräver inte särskilda behörigheter. 
