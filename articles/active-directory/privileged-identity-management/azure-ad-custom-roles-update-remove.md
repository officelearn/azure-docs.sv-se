---
title: Uppdatera eller ta bort en anpassad roll tilldelning för Azure AD i Privileged Identity Management (PIM) | Microsoft Docs
...
> [!NOTE]
> Anpassade Azure AD-roller är inte integrerade med de inbyggda katalog rollerna under för hands versionen. När funktionen är allmänt tillgänglig, sker roll hanterings roll hantering i den inbyggda roll upplevelsen.
