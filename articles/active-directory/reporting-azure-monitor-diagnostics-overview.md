...
* **Spårningsloggar**: [Rapporten om spårningsloggaktivitet](active-directory-reporting-activity-audit-logs.md) ger dig åtkomst till historiken för varje uppgift som utförs i din klientorganisation.
* **Inloggningsloggar**: Med [rapporten om inloggningsaktivitet](active-directory-reporting-activity-sign-ins.md) kan du se vem som har utfört de uppgifter som rapporteras i spårningsloggarna.
...
**S:** Lagringskostnaden beror både på storleken på dina loggar och den kvarhållningsperiod som du väljer. En lista över de uppskattade kostnaderna för klientorganisationer, vilket beror på mängden loggar som genereras, finns i avsnittet [Lagringsstorlek för aktivitetsloggar](https://review.docs.microsoft.com/en-us/azure/active-directory/reporting-azure-monitor-diagnostics-overview?branch=pr-en-us-47660#storage-size-for-activity-logs).
...
**S:** Azure Monitor stöds för närvarande av Splunk, QRadar och Sumo Logic. Splunk är dock det enda SIEM-verktyget som stöds för Azure AD-loggar. Mer information om hur anslutningsapparna fungerar finns på sidan om att [strömma Azure-övervakningsdata till en händelsehubb för användning av ett externt verktyg](../monitoring-and-diagnostics/monitor-stream-monitoring-data-event-hubs.md).
...
* [Dirigera aktivitetsloggar till en händelsehubb](reporting-azure-monitor-diagnostics-azure-event-hub.md)
