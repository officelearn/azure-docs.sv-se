...
Som ett alternativ till Azure-portalen för att komma åt inloggningsdat, kan du också använda [rapport-API](concept-reporting-api.md).
...
Mer information finns i [inloggningsaktivitetsrapporterna i Azure Active Directory-portalen](concept-sign-ins.md).
