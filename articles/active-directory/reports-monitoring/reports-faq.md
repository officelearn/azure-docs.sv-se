...
**S:** används den [API: er för Office 365-Management](https://msdn.microsoft.com/office-365/office-365-managment-apis-overview) åtkomst till Office 365-aktivitetsloggar via ett API.
