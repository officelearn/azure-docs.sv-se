...
Klicken Sie auf den entsprechenden Link, um die **Aktionen** und **nicht-Aktionen** Eigenschaften einer Rollendefinition. Die **Aktionen** -Eigenschaft gibt die zulässigen Aktionen für Azure-Ressourcen. Für Aktionszeichenfolgen dürfen Platzhalter verwendet werden. Die **nicht-Aktionen** -Eigenschaft einer Rollendefinition gibt die Aktionen, die von den zulässigen Aktionen ausgeschlossen werden müssen.
...
| **Aktionen** ||
| ------- | ------ |
| */Lesen | Lesen der Ressourcen aller Typen |
| Microsoft.DevTestLab/labs/labStats/action | Lesen Sie die Lab-Statistiken |
| Microsoft.DevTestLab/Environments/* | Erstellen und Verwalten von Umgebungen |
...
| **Aktionen** ||
| ------- | ------ |
| */Lesen | Lesen der Ressourcen aller Typen, mit Ausnahme geheimer Schlüssel. |
