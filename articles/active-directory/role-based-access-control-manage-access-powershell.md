...
Wenn Sie die folgenden Befehlssequenzen verwenden möchten, müssen Sie zuerst die Objekt-IDs suchen.  Es wird davon ausgegangen, dass Sie bereits wissen, die Abonnement-Id, mit dem Sie arbeiten, die andernfalls finden Sie unter [Get-AzureSubscription](https://msdn.microsoft.com/library/dn495302.aspx) auf MSDN.
...
So erhalten Sie die Objekt-Id für eine Azure AD-Dienstprinzipal verwenden:
...
Im folgenden Beispiel wird die `Microsoft.Insights/diagnosticSettings/*` Vorgang der *Virtual Machine-Operator* benutzerdefinierte Rolle.
