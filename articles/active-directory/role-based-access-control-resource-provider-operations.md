...
| Åtgärd | Beskrivning |
|---|---|
|/ appidentities/Läs|Returnerar resurs (webbplats) registrerat gatewayen.|
|/ appidentities/skrivning|Skapar en ny App-identitet.|
|/ appidentities/ta bort|Tar bort en befintlig App-identitet.|
|/deploymenttemplates/listMetadata/Action|Visar Användargränssnittet Metadata som associeras med API-App-paketet.|
|/deploymenttemplates/Generate/Action|Returnerar en Distributionsmall för att etablera API-App-instanser.|
|/ gateways/Läs|Returnerar Gateway-instans.|
...
|/gateways/tokens/Write|Skapar en ny Zumo Token med det angivna namnet.|
|/gateways/Registrations/Read|Returnerar resurs (webbplats) registrerat gatewayen.|
|/gateways/Registrations/Write|Registrerar en resurs (webbplats) med gatewayen.|
|/gateways/Registrations/delete|Avregistrerar en resurs (webbplats) från Gateway.|
|/ apiapps/Läs|Returnerar den API-App-instansen.|
