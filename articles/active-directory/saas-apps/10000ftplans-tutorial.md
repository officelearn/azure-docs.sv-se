...
2. **[Konfigurera 10000Ft Plans enkel inloggning – om](#configure-10000ft-plans-single-sign-on)** du vill konfigurera enskilda Sign-On inställningar på program sidan.
...
### <a name="configure-10000ft-plans-single-sign-on"></a>Konfigurera 10000ft Plans Single Sign-On
...
När du klickar på panelen 10, 000ft planer i åtkomst panelen, bör du loggas in automatiskt på de 10, 000ft-planer som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
