---
title: 'Självstudie: Azure Active Directory integrering med 123ContactForm | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-integration-with-123contactform"></a>Självstudie: Azure Active Directory integrering med 123ContactForm
...
1. För att konfigurera enkel inloggning på **123ContactForm**-sidan går du till [https://www.123contactform.com/form-2709121/](https://www.123contactform.com/form-2709121/) och utför följande steg:
    ...
    a. Skriv e-postmeddelandet för användaren som **BrittaSimon\@contoso.com**i text rutan **e-post** .
