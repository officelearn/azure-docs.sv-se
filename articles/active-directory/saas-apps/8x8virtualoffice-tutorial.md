...
4. I sökrutan skriver **8 x 8 virtuella Office**.
    ...
    ![Skapa en Azure AD-användare för testning](./media/8x8virtualoffice-tutorial/tutorial_8x8virtualoffice_search.png)

5. I resultatpanelen väljer **8 x 8 virtuella Office**, och klicka sedan på **Lägg till** för att lägga till programmet.

    ![Skapa en Azure AD-användare för testning](./media/8x8virtualoffice-tutorial/tutorial_8x8virtualoffice_addfromgallery.png)
...
8 x 8 virtuella kontoret, tilldela värdet för den **användarnamn** i Azure AD som värde för den **användarnamn** att upprätta länken-relation.
...
3. På den **8 x 8 virtuella Office domän och URL: er** avsnittet, utför följande steg:
    ...
    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska identifierare och svars-URL. Kontakta [8 x 8 virtuella Office-supportteamet](https://www.8x8.com/about-us/contact-us) att hämta dessa värden.
...
6. På den **8 x 8 virtuella Office konfiguration** klickar du på **konfigurera 8 x 8 virtuella Office** att öppna **konfigurera inloggning** fönster. Kopiera den **URL för utloggning, SAML entitets-ID och SAML enkel inloggning för tjänst-URL** från den **Snabbreferens avsnittet.**
...
12. Välj **Single Sign On** under autentiseringsmetod och klicka på **SAML**.
    
    ![Konfigurera på App-sida](./media/8x8virtualoffice-tutorial/tutorial_8x8virtualoffice_005.png)

13. Kopiera **SAML SSO-URL: en**, **enkel rör tjänst-URL: en** och **utfärdar-URL** från Azure AD för att **loggar du In URL: en**, **utloggnings-URL**  och **utfärdar-URL** i 8 x 8 virtuella Office. 
    
    ![Konfigurera på App-sida](./media/8x8virtualoffice-tutorial/tutorial_8x8virtualoffice_006.png)
    
14. Klicka på **webbläsare** för att ladda upp det certifikat som du har hämtat från Azure AD, och klicka sedan på den **spara** knappen.
...
1. I den **Azure-portalen**, i det vänstra navigeringsfönstret klickar du på **Azure Active Directory** ikon.
    ...
    ![Skapa en Azure AD-användare för testning](./media/8x8virtualoffice-tutorial/create_aaduser_01.png) 

2. Om du vill visa en lista över användare, gå till **användare och grupper** och klicka på **alla användare**.
    
    ![Skapa en Azure AD-användare för testning](./media/8x8virtualoffice-tutorial/create_aaduser_02.png) 

3. Öppna den **användaren** dialogrutan klickar du på **Lägg till** överst i dialogrutan.
 
    ![Skapa en Azure AD-användare för testning](./media/8x8virtualoffice-tutorial/create_aaduser_03.png) 

4. På den **användaren** dialogrutan utför följande steg:
 
    ![Skapa en Azure AD-användare för testning](./media/8x8virtualoffice-tutorial/create_aaduser_04.png) 
...
**Om du vill tilldela Britta Simon 8 x 8 virtuella Office, utför du följande steg:**
