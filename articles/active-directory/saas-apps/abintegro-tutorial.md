...
ms.date: 05/22/2017
ms.author: jeedes
ms.openlocfilehash: c219d34f77346e0cfc4e57de8ba3fd52b06aaa91
ms.sourcegitcommit: c851842d113a7078c378d78d94fea8ff5948c337
ms.translationtype: MT
ms.contentlocale: sv-SE
ms.lasthandoff: 06/18/2018
ms.locfileid: "35965800"
---
...
4. I sökrutan skriver **Abintegro**.
    ...
    ![Skapa en testanvändare i Azure AD](./media/abintegro-tutorial/tutorial_abintegro_search.png)

5. Välj i resultatpanelen **Abintegro**, och klicka sedan på **Lägg till** för att lägga till programmet.

    ![Skapa en testanvändare i Azure AD](./media/abintegro-tutorial/tutorial_abintegro_addfromgallery.png)
...
1. I den **Azure-portalen**, klicka på det vänstra navigeringsfönstret **Azure Active Directory** ikon.
    ...
    ![Skapa en testanvändare i Azure AD](./media/abintegro-tutorial/create_aaduser_01.png) 

2. Om du vill visa en lista över användare, gå till **användare och grupper** och på **alla användare**.
    
    ![Skapa en testanvändare i Azure AD](./media/abintegro-tutorial/create_aaduser_02.png) 

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i dialogrutan.
 
    ![Skapa en testanvändare i Azure AD](./media/abintegro-tutorial/create_aaduser_03.png) 

4. På den **användaren** dialogrutan utför följande steg:
 
    ![Skapa en testanvändare i Azure AD](./media/abintegro-tutorial/create_aaduser_04.png) 
