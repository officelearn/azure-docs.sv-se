...
4. I sökrutan skriver **upptar LMS**väljer **upptar LMS** i leda panelen och välj sedan den **Lägg till** knappen.
    ...
    ![Upptar LMS i resultatlistan](./media/absorblms-tutorial/tutorial_absorblms_addfromgallery.png)
...
2. I den **enkel inloggning** i dialogrutan den **läge** väljer **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/absorblms-tutorial/tutorial_absorblms_samlbase.png)

3. I den **upptar LMS domän och URL: er** avsnittet, gör du följande:

    ![Upptar LMS domän URL: er och enkel inloggning information](./media/absorblms-tutorial/tutorial_absorblms_url.png)
...
4. I den **SAML-signeringscertifikat** avsnitt i den **hämta** väljer **XML-Metadata för**, och spara sedan metadatafilen till datorn.
    ...
    ![Länk för hämtning av signering certifikat](./media/absorblms-tutorial/tutorial_absorblms_certificate.png) 

5. Välj **Spara**.

    ![Konfigurera enkel inloggning spara](./media/absorblms-tutorial/tutorial_general_400.png)
...
6. I den **upptar LMS Configuration** väljer **konfigurera upptar LMS** att öppna **konfigurera inloggning** fönster och kopiera sedan de **Sign-Out URL** i den **Snabbreferens avsnitt.**
    ...
    ![Fönstret upptar LMS konfiguration](./media/absorblms-tutorial/tutorial_absorblms_configure.png) 
...
11. Gör följande på konfigurationssidan för enkel inloggning:
    ...
    ![Konfigurationssidan för enkel inloggning](./media/absorblms-tutorial/4.png)
...
12. Växla **Tillåt endast SSO-inloggning** till **på**.
    ...
    ![Endast tillåta SSO-inloggning växla](./media/absorblms-tutorial/5.png)
...
2. I den vänstra rutan, Välj **användare**.
    ...
    ![Länken upptar LMS användare](./media/absorblms-tutorial/absorblms_users.png)
...
4. I den **Lägg till ny** listrutan, Välj **användaren**.
    ...
    ![Lägg till ny listrutan](./media/absorblms-tutorial/absorblms_createuser.png)
...
2. I den **program** väljer **upptar LMS**.
    ...
    ![Länken upptar LMS i listan med program](./media/absorblms-tutorial/tutorial_absorblms_app.png) 
...
I panelen åtkomst att välja den **upptar LMS** panelen automatiskt loggar du in i tillämpningsprogrammet upptar LMS. Läs mer om åtkomstpanelen [introduktion till åtkomstpanelen](../active-directory-saas-access-panel-introduction.md).
