...
4. I avsnittet **Grundläggande SAML-konfiguration**, om du vill konfigurera appen i **IDP**-initierat läge, gör du följande:
    ...
    b. I textrutan **svars-URL** skriver du en URL med följande mönster: `https://<CUSTOMER>.acadia.sysalli.com/Shibboleth.sso/SAML2/POST`
...
När du klickar på Acadia-panelen i åtkomstpanelen bör du automatiskt loggas in på Acadia som du har konfigurerat enkel inloggning för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
