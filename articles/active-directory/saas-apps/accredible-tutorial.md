...
I kursen får lära du att integrera Accredible med Azure Active Directory (AD Azure).
...
- En Accredible enkel inloggning aktiverad prenumeration
...
Du måste lägga till Accredible från galleriet i listan över hanterade SaaS-appar för att konfigurera integrering av Accredible i Azure AD.
...
I det här avsnittet kan du konfigurera och testa Azure AD enkel inloggning med Accredible baserat på en testanvändare som kallas ”Britta Simon”.

Azure AD måste du känna till användaren i Accredible motsvarighet till en användare i Azure AD för enkel inloggning ska fungera. Med andra ord måste en länk förhållandet mellan en Azure AD-användare och relaterade användaren i Accredible upprättas.

I Accredible, tilldela värdet för den **användarnamn** i Azure AD som värde för den **användarnamn** etablera länken relationen.
...
3. **[Skapa en testanvändare Accredible](#create-an-accredible-test-user)**  – du har en motsvarighet för Britta Simon i Accredible som är kopplad till Azure AD-representation av användaren.
...
1. I Azure-portalen på den **Accredible** integreringssidan för programmet, klickar du på **enkel inloggning**.

    ![Konfigurera enkel inloggning länk][4]

2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
 
    ![Enkel inloggning dialogrutan](./media/accredible-tutorial/tutorial_accredible_samlbase.png)

3. På den **Accredible domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och Accredible domän med enkel inloggning information](./media/accredible-tutorial/tutorial_accredible_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/accredible-tutorial/tutorial_accredible_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/accredible-tutorial/tutorial_general_400.png)

6. Konfigurera enkel inloggning på **Accredible** sida, måste du skicka den hämtade **XML-Metadata för** till [Accredible supportteamet](mailto:support@accredible.com). De kan ange den här inställningen att ha SAML SSO anslutningen korrekt på båda sidor.
...
### <a name="create-an-accredible-test-user"></a>Skapa en testanvändare Accredible

I det här avsnittet skapar du en användare som kallas Britta Simon i Accredible. Du måste skicka användarens emailid till [Accredible supportteamet](mailto:support@accredible.com), och sedan de kontrollera e-postmeddelandet och skicka inbjudan e-post så att du kan lägga till användare i accredible plattform.
 
### <a name="assign-the-azure-ad-test-user"></a>Tilldela Azure AD-testanvändare

I det här avsnittet kan du aktivera Britta Simon att använda Azure enkel inloggning genom att bevilja åtkomst till Accredible.

![Tilldela rollen][200] 

**Om du vill tilldela Accredible Britta Simon utför du följande steg:**

1. Öppna vyn program i Azure-portalen och gå till vyn directory och gå till **företagsprogram** Klicka **alla program**.

    ![Tilldela användare][201] 

2. Välj i listan med program **Accredible**.
...
När du klickar på panelen Accredible på åtkomstpanelen du bör få automatiskt loggat in på ditt Accredible program.
