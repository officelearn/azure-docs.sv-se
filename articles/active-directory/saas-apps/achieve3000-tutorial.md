...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/achieve3000-tutorial/tutorial_achieve3000_samlbase.png)

3. På den **Achieve3000 domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och Achieve3000 domän med enkel inloggning information](./media/achieve3000-tutorial/tutorial_achieve3000_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/achieve3000-tutorial/tutorial_achieve3000_certificate.png) 
...
6. I den **användarattribut** avsnitt på den **enkel inloggning** dialogrutan Konfigurera attribut för SAML-token som visas i bilden och utför följande steg:
    ...
    ![Konfigurera enkel inloggning Lägg till](./media/achieve3000-tutorial/tutorial_officespace_04.png)
...
7. Klicka på **spara** knappen.
    ...
    ![Konfigurera enkel inloggning spara](./media/achieve3000-tutorial/tutorial_general_400.png)
