...
4. På sidan **Konfigurera enkel inloggning med SAML** utför du följande steg:
    ...
    a. Skriv en URL i text rutan **identifierare** : `https://captivateprime.adobe.com`

    b. Skriv en URL i textrutan **Svars-URL**: `https://captivateprime.adobe.com/saml/SSO`
...
När du klickar på Adobe Captivate Prime-panelen i åtkomstpanelen bör du automatiskt loggas in på Adobe Captivate Prime som du har konfigurerat enkel inloggning för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
