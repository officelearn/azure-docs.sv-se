---
title: 'Självstudier: Azure Active Directory enkel inloggning (SSO) med ADP | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-adp"></a>Självstudier: Azure Active Directory enkel inloggning (SSO) med ADP
