...
3. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/adpfederatedsso-tutorial/tutorial_adp_samlbase.png)

4. På den **ADP domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och ADP domän med enkel inloggning information](./media/adpfederatedsso-tutorial/tutorial_adp_url.png)
...
7. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/adpfederatedsso-tutorial/tutorial_adp_certificate.png) 
...
7. På den **enkel inloggning** markerar **läge** som **inloggning länkade**. länka ditt program till **ADP**.
    ...
    ![Enkel inloggning länkade](./media/adpfederatedsso-tutorial/tutorial_adp_linked.png)
