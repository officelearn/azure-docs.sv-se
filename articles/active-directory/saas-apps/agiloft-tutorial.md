---
title: 'Självstudiekurs: Azure Active Directory-integrering med Agiloft | Microsoft-dokument'
...
ms.locfileid: "73153960"
---
# <a name="tutorial-azure-active-directory-integration-with-agiloft"></a>Självstudiekurs: Azure Active Directory-integrering med Agiloft
...
4. En guidedialogruta visas. I dialogrutan klickar du på **Identity Provider Details** (Information om identitetsprovider) och fyller i följande fält:  
    ...
    a. I **IdP-entitets-ID/Utfärdare** textruta klistrar du in värdet för **Azure Ad Identifier**, som du har kopierat från Azure-portalen.

    b. I **textrutan IdP-inloggningsadress** klistrar du in värdet **för inloggnings-URL**, som du har kopierat från Azure-portalen.

    c. Klistra in värdet **för url för utloggning i** **IdP Logout,** som du har kopierat från Azure-portalen.

    d. Öppna ditt **bas-64-kodade certifikat** i anteckningar som hämtats från Azure-portalen, kopiera innehållet i det i Urklipp och klistra sedan in det i **textrutan för IdP-certifikatinnehåll.**
