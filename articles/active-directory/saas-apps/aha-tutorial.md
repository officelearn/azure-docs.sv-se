...
---
# <a name="tutorial-integrate-aha-with-azure-active-directory"></a>Självstudier: Integrera Aha! med Azure Active Directory
...
2. **[Konfigurera enkel inloggning för Aha! ](#configure-aha-sso) SSO** – för att konfigurera inställningar för enkel inloggning på program sidan.
...
## <a name="configure-aha-sso"></a>Konfigurera enkel inloggning SSO
