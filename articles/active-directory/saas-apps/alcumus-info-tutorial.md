---
title: 'Självstudiekurs: Azure Active Directory-integrering med Alcumus Info Exchange | Microsoft-dokument'
...
ms.locfileid: "73153781"
---
# <a name="tutorial-azure-active-directory-integration-with-alcumus-info-exchange"></a>Självstudiekurs: Azure Active Directory-integrering med Alcumus Info Exchange
...
4. På sidan **Konfigurera enkel inloggning med SAML** utför du följande steg:
    ...
    a. Skriv en URL med följande mönster i textrutan **Identifierare:**`https://<subdomain>.info-exchange.com`

    b. Skriv en URL med följande mönster i textrutan **Svara URL:**`https://<subdomain>.info-exchange.com/Auth/`
