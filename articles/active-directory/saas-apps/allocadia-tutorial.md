---
title: 'Självstudie: Azure Active Directory integrering med Allocadia | Microsoft Docs'
...
ms.locfileid: "73153336"
---
# <a name="tutorial-azure-active-directory-integration-with-allocadia"></a>Självstudie: Azure Active Directory integrering med Allocadia
...
När du klickar på Allocadia-panelen i åtkomstpanelen bör du automatiskt loggas in på Allocadia som du har konfigurerat enkel inloggning för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
