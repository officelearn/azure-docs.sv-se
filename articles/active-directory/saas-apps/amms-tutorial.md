...
Att konfigurera enkel inloggning på **AMMS** sida, som du behöver skicka den **Appfederationsmetadata** till [AMMS supportteam](mailto:techsupport@microwestsoftware.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
