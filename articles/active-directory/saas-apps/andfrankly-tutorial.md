...
För att konfigurera enkel inloggning på **&frankly**-sidan behöver du skicka nedladdade **XML-federationsmetadata** och lämpliga kopierade URL:er från Azure-portalen till [supportteamet för &frankly](mailto:help@andfrankly.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
