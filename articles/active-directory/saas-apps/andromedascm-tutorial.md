...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/andromedascm-tutorial/tutorial_andromedascm_samlbase.png)
...
3. På den **Andromeda domän och URL: er** avsnittet, utför följande steg om du vill konfigurera programmet i **IDP** initierade läge:
    ...
    ![URL: er och Andromeda domän med enkel inloggning information](./media/andromedascm-tutorial/tutorial_andromedascm_url.png)
...
4. Kontrollera **visa avancerade inställningar för URL: en** och utför följande steg om du vill konfigurera programmet i **SP** initierade läge:
    ...
    ![URL: er och Andromeda domän med enkel inloggning information](./media/andromedascm-tutorial/tutorial_andromedascm_url1.png)
...
6. I den **användarattribut** avsnitt på den **enkel inloggning** dialogrutan Konfigurera attribut för SAML-token som visas i bilden och utför följande steg:
    ...
    ![Konfigurera enkel inloggning Lägg till](./media/andromedascm-tutorial/tutorial_attribute_04.png)
...
7. På den **SAML-signeringscertifikat** klickar du på **certifikat (Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/andromedascm-tutorial/tutorial_andromedascm_certificate.png) 

8. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/andromedascm-tutorial/tutorial_general_400.png)
