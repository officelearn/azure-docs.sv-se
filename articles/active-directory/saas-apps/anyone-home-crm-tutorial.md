...
När du klickar på panelen alla hem CRM på åtkomst panelen, bör du loggas in automatiskt på alla hem-CRM som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
...
- [Så här skyddar du alla hem CRM med avancerad synlighet och kontroller](/cloud-app-security/proxy-intro-aad)