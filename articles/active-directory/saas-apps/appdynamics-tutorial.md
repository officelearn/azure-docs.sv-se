...
4. I sökrutan skriver **AppDynamics**.
    ...
    ![Skapa en testanvändare i Azure AD](./media/appdynamics-tutorial/tutorial_appdynamics_search.png)

5. Välj i resultatpanelen **AppDynamics**, och klicka sedan på **Lägg till** för att lägga till programmet.

    ![Skapa en testanvändare i Azure AD](./media/appdynamics-tutorial/tutorial_appdynamics_addfromgallery.png)
...
10. I den **autentiseringsprovider** avsnittet, utför följande steg:
    ...
    e. Klicka på **Spara**.
     ...
     ![Spara](./media/appdynamics-tutorial/ic777673.png "spara")
...
1. I den **Azure-portalen**, klicka på det vänstra navigeringsfönstret **Azure Active Directory** ikon.
    ...
    ![Skapa en testanvändare i Azure AD](./media/appdynamics-tutorial/create_aaduser_01.png) 

2. Om du vill visa en lista över användare, gå till **användare och grupper** och på **alla användare**.
    
    ![Skapa en testanvändare i Azure AD](./media/appdynamics-tutorial/create_aaduser_02.png) 

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i dialogrutan.
 
    ![Skapa en testanvändare i Azure AD](./media/appdynamics-tutorial/create_aaduser_03.png) 

4. På den **användaren** dialogrutan utför följande steg:
 
    ![Skapa en testanvändare i Azure AD](./media/appdynamics-tutorial/create_aaduser_04.png) 
...
2. Gå till **användare**, och klicka sedan på **+** att öppna den **skapa användare** dialogrutan.
    ...
    ![Användare](./media/appdynamics-tutorial/ic790229.png "användare")

3. I den **skapa användare** avsnittet, utför följande steg:
   
    ![Skapa användare](./media/appdynamics-tutorial/ic790230.png "skapa användare")
