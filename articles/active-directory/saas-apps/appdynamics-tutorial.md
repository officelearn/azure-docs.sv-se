...
1. I verktygsfältet längst upp klickar du på **Inställningar** och sedan på **Administration**.
    ...
    ![Administrationsverktyg](./media/appdynamics-tutorial/ic790216.png "Administration")
...
När du klickar på AppDynamics-panelen i åtkomstpanelen bör du automatiskt loggas in på AppDynamics som du har konfigurerat enkel inloggning för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
