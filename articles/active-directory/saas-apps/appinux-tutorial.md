...
För att konfigurera enkel inloggning på **Appinux**-sidan behöver du skicka nedladdade **XML-federationsmetadata** och lämpliga kopierade URL:er från Azure-portalen till [supportteamet för Appinux](https://support.appinux.com/). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
