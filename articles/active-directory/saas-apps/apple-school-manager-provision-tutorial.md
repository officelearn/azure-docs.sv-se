...
3. Ta reda på vilka data som ska [mappas mellan Azure AD och Apple School Manager](../app-provisioning/customize-application-attributes.md).
...
* När du tilldelar användare till Apple School Manager måste du välja en annan roll än **standard åtkomst**. Användare med rollen Standardåtkomst undantas från etableringen och markeras som icke-berättigade i etableringsloggarna. Om den enda rollen som är tillgänglig i programmet är standardrollen för åtkomst, kan du [uppdatera applikationsmanifest](../develop/howto-add-app-roles-in-azure-ad-apps.md) och lägga till fler roller. 
