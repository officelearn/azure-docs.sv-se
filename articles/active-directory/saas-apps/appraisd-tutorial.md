...
När du väljer den uppfattade panelen i åtkomst panelen, bör du loggas in automatiskt till den som du ställer in SSO. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
