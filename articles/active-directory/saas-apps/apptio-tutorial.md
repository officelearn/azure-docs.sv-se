...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/apptio-tutorial/tutorial_apptio_samlbase.png)

3. På den **Apptio domän och URL: er** avsnittet, utför följande steg om du vill konfigurera programmet i IDP initierade läge:

    ![URL: er och Apptio domän med enkel inloggning information](./media/apptio-tutorial/tutorial_apptio_url.png)

    I den **identifierare** textruta Skriv värdet: `urn:federation:apptio`

4. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.

    ![Länken hämta certifikatet](./media/apptio-tutorial/tutorial_apptio_certificate.png) 
...
8. Klicka på **spara** knappen.
    ...
    ![Konfigurera enkel inloggning spara](./media/apptio-tutorial/tutorial_general_400.png)
