---
title: 'Självstudier: Azure Active Directory enkel inloggning (SSO) med båg funktioner | Microsoft Docs'
...
1. I [Azure Portal](https://portal.azure.com/)på sidan Arc- **funktioner** program integration letar du upp avsnittet **Hantera** och väljer **enkel inloggning**.
...
Om du vill konfigurera enkel inloggning på **båg anläggningar** , måste du skicka det hämtade **certifikatet (base64)** och lämpliga kopierade url: er från Azure Portal till [stödet för Arc-arbetsgrupper](mailto:support@arcfacilities.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
...
När du klickar på panelen för ARC-funktioner på åtkomst panelen, bör du loggas in automatiskt på de båg anläggningar som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Prova båg funktioner med Azure AD](https://aad.portal.azure.com/)
