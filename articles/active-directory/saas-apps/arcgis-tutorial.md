---
title: 'Självstudiekurs: Azure Active Directory-integrering med ArcGIS Online | Microsoft-dokument'
...
---
# <a name="tutorial-azure-active-directory-integration-with-arcgis-online"></a>Självstudiekurs: Azure Active Directory-integrering med ArcGIS Online
...
4. Under **Företagsinloggningar**, klickar du på **SET IDENTITY PROVIDER**.
    ...
    ![Inloggningar för företag](./media/arcgis-tutorial/ic784744.png "Inloggningar för företag")
...
4. I dialogrutan **Medlemmar** utför du följande steg:
     ...
     ![Lägga till och granska](./media/arcgis-tutorial/ic784749.png "Lägga till och granska")
    
     a. Ange **e-post,** **förnamn**och **efternamn för** ett giltigt Azure AD-konto som du vill etablera.
