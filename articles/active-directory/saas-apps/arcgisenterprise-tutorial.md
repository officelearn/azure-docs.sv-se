...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg om du vill konfigurera programmet i **IDP**-initierat läge:
    ...
    b. I textrutan **svars-URL** skriver du en URL med följande mönster: `https://<EXTERNAL_DNS_NAME>/portal/sharing/rest/oauth2/saml/signin2`
...
När du klickar på ArcGIS Enterprise-panelen i åtkomstpanelen bör du automatiskt loggas in på ArcGIS Enterprise som du har konfigurerat enkel inloggning för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
