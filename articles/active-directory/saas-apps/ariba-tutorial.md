---
title: 'Självstudiekurs: Azure Active Directory-integrering med Ariba | Microsoft-dokument'
...
---
# <a name="tutorial-azure-active-directory-integration-with-ariba"></a>Självstudiekurs: Azure Active Directory-integrering med Ariba
