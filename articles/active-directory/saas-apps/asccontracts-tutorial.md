...
1. På den **ASC kontrakt domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I textrutan **Identifierare** anger du en URL med följande mönster: `https://<subdomain>.asccontracts.com/shibboleth`

    b. I textrutan **Svars-URL** skriver du en URL med följande mönster: `https://<subdomain>.asccontracts.com/shibboleth.sso/login`

    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med den faktiska identifieraren och svars-URL. Contact ASC Networks Inc. (ASC)-teamet på **613.599.6178** att hämta dessa värden.
...
Arbeta med ASC nätverk Inc. (ASC) support-teamet på **613.599.6178** att hämta de användare som har lagts till i ASC kontrakt-plattformen.
