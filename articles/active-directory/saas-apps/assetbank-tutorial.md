---
title: 'Självstudiekurs: Azure Active Directory-integrering med Asset Bank | Microsoft-dokument'
...
---
# <a name="tutorial-azure-active-directory-integration-with-asset-bank"></a>Självstudiekurs: Azure Active Directory-integrering med Asset Bank
