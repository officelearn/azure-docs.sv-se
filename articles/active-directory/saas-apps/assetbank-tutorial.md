---
title: 'Självstudier: Azure Active Directory-integration med tillgången Bank | Microsoft Docs'
...
ms.locfileid: "39437285"
---
# <a name="tutorial-azure-active-directory-integration-with-asset-bank"></a>Självstudier: Azure Active Directory-integration med tillgången Bank
...
1. På den **tillgången Bank domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<companyname>.assetbank-server.com`

    b. I den **identifierare** textrutan anger du ett URL med hjälp av följande mönster: `https://<companyname>.assetbank-server.com/shibboleth`

    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska inloggnings-URL och identifierare. Kontakta [tillgången Bank klienten supportteamet](mailto:support@assetbank.co.uk) att hämta dessa värden. 
...
Det finns inga uppgift åt dig i det här avsnittet. En ny användare har skapats under ett försök att komma åt tillgången Bank om det inte finns ännu. 
