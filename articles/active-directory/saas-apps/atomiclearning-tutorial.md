...
1. Att konfigurera enkel inloggning på **atomiska Learning** sida, som du behöver skicka de hämtade **XML-Metadata för** till [atomiska Learning supportteamet](mailto:cs@atomiclearning.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
