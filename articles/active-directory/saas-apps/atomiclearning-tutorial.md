...
5. I resultatpanelen väljer **atomiska Learning**, och klicka sedan på **Lägg till** för att lägga till programmet.
...
3. **[Skapa en testanvändare atomiska Learning](#creating-an-atomic-learning-test-user)**  – du har en motsvarighet för Britta Simon i atomiska utbildning som är länkad till en Azure AD-representation av användaren.
...
3. På den **atomiska Learning domän och URL: er** avsnittet, utför följande steg:
    ...
    ![Konfigurera enkel inloggning](./media/atomiclearning-tutorial/tutorial_atomiclearning_url.png)
     ...
     I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://secure2.atomiclearning.com/sso/shibboleth/<companyname>`
...
6. Att konfigurera enkel inloggning på **atomiska Learning** sida, som du behöver skicka de hämtade **XML-Metadata för** till [atomiska Learning supportteamet](mailto:cs@atomiclearning.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
...
Det finns inga uppgift åt dig i det här avsnittet. En ny användare har skapats under ett försök att komma åt atomiska Learning om det inte finns ännu använder e-postadressen för användaren.
