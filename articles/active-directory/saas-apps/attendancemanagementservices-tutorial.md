...
2. **[Konfigurera enkel inloggning för närvaro hanterings tjänster](#configure-attendance-management-services-single-sign-on)** för att konfigurera de enskilda Sign-On inställningarna på program sidan.
...
### <a name="configure-attendance-management-services-single-sign-on"></a>Konfigurera enskilda Sign-On för närvaro hanterings tjänster
...
När du klickar på panelen närvaro hanterings tjänster på åtkomst panelen, bör du loggas in automatiskt på de närvaro hanterings tjänster som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
