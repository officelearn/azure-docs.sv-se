...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/attendancemanagementservices-tutorial/tutorial_attendancemanagementservices_samlbase.png)

3. På den **närvaro Management Services-domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och närvaro Management Services-domän med enkel inloggning information](./media/attendancemanagementservices-tutorial/tutorial_attendancemanagementservices_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **Certificate(Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/attendancemanagementservices-tutorial/tutorial_attendancemanagementservices_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/attendancemanagementservices-tutorial/tutorial_general_400.png)
...
2. Välj i listan med program **närvaro hanteringstjänster**.
    ...
    ![Länken närvaro Management Services på listan med program](./media/attendancemanagementservices-tutorial/tutorial_attendancemanagementservices_app.png)  
