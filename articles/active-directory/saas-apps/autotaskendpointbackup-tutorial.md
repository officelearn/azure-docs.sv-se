---
title: 'Självstudiekurs: Azure Active Directory-integrering med säkerhetskopiering av autotask-slutpunkt | Microsoft-dokument'
...
---
# <a name="tutorial-azure-active-directory-integration-with-autotask-endpoint-backup"></a>Självstudiekurs: Azure Active Directory-integrering med säkerhetskopiering av autotask-slutpunkt
...
4. På sidan **Konfigurera enkel inloggning med SAML** utför du följande steg:
    ...
    a. Skriv en URL med följande mönster i textrutan **Identifierare:**`https://<subdomain>.backup.autotask.net/singlesignon/saml/metadata`

    b. Skriv en URL med följande mönster i textrutan **Svara URL:**`https://<subdomain>.backup.autotask.net/singlesignon/saml/SSO`
