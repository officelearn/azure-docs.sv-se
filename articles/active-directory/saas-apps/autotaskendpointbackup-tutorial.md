...
När du klickar på panelen för Autotask Endpoint Backup på åtkomstpanelen bör du loggas in automatiskt till det Autotask Endpoint Backup-program som du konfigurerat enkel inloggning för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
