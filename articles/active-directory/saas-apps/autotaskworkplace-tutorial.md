...
När du klickar på Autotask Workplace-panelen i åtkomstpanelen bör du automatiskt loggas in på Autotask Workplace som du har konfigurerat enkel inloggning för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
