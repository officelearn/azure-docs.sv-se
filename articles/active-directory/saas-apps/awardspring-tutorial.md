...
För att konfigurera enkel inloggning på **AwardSpring**-sidan behöver du skicka nedladdad **federationsmetadata-XML** och lämpliga kopierade URL:er från Azure-portalen till [supportteamet för AwardSpring](mailto:support@awardspring.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
