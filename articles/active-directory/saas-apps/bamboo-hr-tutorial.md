...
2. I den **enkel inloggning** fönster i den **läge** listrutan, Välj **SAML-baserade inloggning**.
    ...
    ![Fönster för enkel inloggning](./media/bamboo-hr-tutorial/tutorial_bamboohr_samlbase.png)
...
4. Under **SAML-signeringscertifikat**väljer **certifikat (Base64)**, och sedan spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/bamboo-hr-tutorial/tutorial_bamboohr_certificate.png) 
...
8. På sidan, gör du följande:
    ...
    ![Sidan BambooHR enkel inloggning](./media/bamboo-hr-tutorial/ic796691.png "enkel inloggning")   
