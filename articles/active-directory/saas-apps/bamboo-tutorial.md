...
3. **[Skapa en SAML SSO för bambu av lösning GmbH testanvändare](#create-a-saml-sso-for-bamboo-by-resolution-gmbh-test-user)**  – du har en motsvarighet för Britta Simon i SAML SSO för bambu resolution GmbH som är länkad till en Azure AD-representation av användaren.
...
3. På den **SAML SSO bambu resolution GmbH domän och URL: er** avsnittet, utför följande steg om du vill konfigurera programmet i IDP-initierad läge:
...
7. Inloggning till SAML SSO för bambu av lösning GmbH företagets plats som administratör.

8. Till höger i verktygsfältet klickar du på **inställningar** > **tillägg**.

    ![Inställningarna](./media/bamboo-tutorial/tutorial_bamboo_setings.png)

9. Gå till säkerhets-avsnittet, klickar du på **SAML SingleSignOn** på menyraden.
...
12. På den **identitet providerkonfigurationen** klickar du på **nästa**.
