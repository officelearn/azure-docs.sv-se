...
När du klickar på BC in the Cloud-panelen på åtkomstpanelen bör du automatiskt loggas in i BC in the Cloud som du har konfigurerat enkel inloggning för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
