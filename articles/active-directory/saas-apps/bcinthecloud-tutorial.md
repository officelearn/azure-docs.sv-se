...
3. Lägg till nytt program, klicka på **Lägg till** knappen överst i dialogrutan.
...
5. I resultatpanelen väljer **BC i molnet**, och klicka sedan på **Lägg till** för att lägga till programmet.
...
3. **[Skapa en BC i molnet testanvändare](#creating-a-bc-in-the-cloud-test-user)**  – du har en motsvarighet för Britta Simon i BC i molnet som är länkad till en Azure AD-representation av användaren.
...
3. På den **BC i molnet domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://app.bcinthecloud.com/router/loginSaml/<customerid>`
...
6. Att konfigurera enkel inloggning på **BC i molnet** sida, som du behöver skicka de hämtade **XML-Metadata för** till [BC i molnet supportteam](https://www.bcinthecloud.com/supportcenter/).
...
2. I listan med program väljer **BC i molnet**.
