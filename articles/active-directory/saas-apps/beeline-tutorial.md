...
1. På den **BeeLine domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I textrutan **Identifierare** anger du en URL med följande mönster: `https://projects.beeline.net/<instancename>`
