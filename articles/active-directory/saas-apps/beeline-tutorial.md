...
2. **[Konfigurera Beeline enkel inloggning](#configure-beeline-single-sign-on)** – om du vill konfigurera de enskilda Sign-On inställningarna på program sidan.
...
### <a name="configure-beeline-single-sign-on"></a>Konfigurera Beeline Single Sign-On
...
När du klickar på panelen Beeline på åtkomst panelen, bör du loggas in automatiskt på Beeline-instansen där du ställer in SSO. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
