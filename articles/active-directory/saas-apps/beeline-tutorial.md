---
title: 'Självstudiekurs: Azure Active Directory-integrering med BeeLine | Microsoft-dokument'
...
ms.locfileid: "73157730"
---
# <a name="tutorial-azure-active-directory-integration-with-beeline"></a>Självstudiekurs: Azure Active Directory-integrering med BeeLine
...
4. På sidan **Konfigurera enkel inloggning med SAML** utför du följande steg:
    ...
    a. Skriv en URL med följande mönster i textrutan **Identifierare:**`https://projects.beeline.net/<instancename>`
