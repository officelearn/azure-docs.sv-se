---
title: 'Självstudiekurs: Azure Active Directory-integrering med enkel inloggning (SSO) med BenefitHub | Microsoft-dokument'
...
ms.locfileid: "75638821"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-benefithub"></a>Självstudiekurs: Azure Active Directory-integrering med enkel inloggning (SSO) med BenefitHub
...
* Gör att användarna automatiskt loggas in på BenefitHub med sina Azure AD-konton.
...
* BenefitHub-prenumeration (Single Sign-on) aktiverad prenumeration.
...
1. Skriv **BenefitHub** i sökrutan i avsnittet **Lägg till från galleriet.**
1. Välj **BenefitHub** från resultatpanelen och lägg sedan till appen. Vänta några sekunder medan appen läggs till i din klientorganisation.

## <a name="configure-and-test-azure-ad-single-sign-on-for-benefithub"></a>Konfigurera och testa en azure AD-inloggning för BenefitHub

Konfigurera och testa Azure AD SSO med BenefitHub med en testanvändare som heter **B.Simon**. För att SSO ska fungera måste du upprätta en länkrelation mellan en Azure AD-användare och den relaterade användaren i BenefitHub.

Så här konfigurerar och testar du Azure AD SSO med BenefitHub:

1. **[Konfigurera Azure AD SSO](#configure-azure-ad-sso)** – så att användarna kan använda den här funktionen.
    * **[Skapa en Azure AD-testanvändare](#create-an-azure-ad-test-user)** – för att testa azure AD-enkel inloggning med B.Simon.
    * **[Tilldela Azure AD-testanvändaren](#assign-the-azure-ad-test-user)** - så att B.Simon kan använda azure AD-enkel inloggning.
1. **[Konfigurera BenefitHub SSO](#configure-benefithub-sso)** - för att konfigurera de enskilda inloggningsinställningarna på programsidan.
    * **[Skapa BenefitHub-testanvändare](#create-benefithub-test-user)** – om du vill ha en motsvarighet till B.Simon i BenefitHub som är länkad till Azure AD-representationen av användaren.
...
1. På sidan **Konfigurera enkel inloggning med SAML** anger du värdena för följande fält:
    ...
    a. Skriv värdet i textrutan **Identifierare:**`urn:benefithub:passport`

    b. I textrutan **Svars-URL** skriver du värdet: `https://passport.benefithub.info/saml/post/ac`

1. BenefitHub-programmet förväntar sig SAML-påståenden i ett visst format, vilket kräver att du lägger till anpassade attributmappningar i konfigurationen av SAML-tokenattribut. I följande skärmbild visas listan över standardattribut.

    ![image](common/default-attributes.png)

1. Utöver ovanstående förväntar sig BenefitHub-programmet att få fler attribut skickas tillbaka i SAML-svar som visas nedan. Dessa attribut är också förifyllda men du kan granska dem enligt dina krav.
...
1. Kopiera lämpliga webbadresser i avsnittet **Konfigurera BenefitHub** baserat på dina krav.
...
I det här avsnittet aktiverar du B.Simon att använda Azure enkel inloggning genom att bevilja åtkomst till BenefitHub.
