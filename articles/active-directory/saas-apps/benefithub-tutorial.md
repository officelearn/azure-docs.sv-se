---
title: 'Självstudier: Azure Active Directory-integration med BenefitHub | Microsoft Docs'
...
ms.locfileid: "39054173"
---
# <a name="tutorial-azure-active-directory-integration-with-benefithub"></a>Självstudier: Azure Active Directory-integration med BenefitHub
...
5. I resultatpanelen väljer **BenefitHub**, och klicka sedan på **Lägg till** för att lägga till programmet.
...
3. **[Skapa en testanvändare BenefitHub](#creating-a-benefithub-test-user)**  – du har en motsvarighet för Britta Simon i BenefitHub som är länkad till en Azure AD-representation av användaren.
...
5. I den **användarattribut** avsnittet på den **enkel inloggning** dialogrutan Konfigurera SAML-token attributet som visas i föregående bild och utför följande steg:
    ...
    > [!NOTE] 
    > Innan du kan konfigurera SAML-kontroll, måste du kontakta din [BenefitHub support](https://www.benefithub.com/Home/ContactUs) och begära värdet för attributet för unik identifierare för din klient. Du behöver det här värdet för att konfigurera anpassade anspråk för ditt program.
...
8. Att konfigurera enkel inloggning på **BenefitHub** sida, som du behöver skicka de hämtade **XML-Metadata för** till [BenefitHub supportteamet](https://www.benefithub.com/Home/ContactUs). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
...
2. I listan med program väljer **BenefitHub**.
