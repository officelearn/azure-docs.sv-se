---
title: 'Självstudiekurs: Azure Active Directory-integrering med Benefitsolver | Microsoft-dokument'
...
ms.locfileid: "73158922"
---
# <a name="tutorial-azure-active-directory-integration-with-benefitsolver"></a>Självstudiekurs: Azure Active Directory-integrering med Benefitsolver
...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    a. Skriv en URL med hjälp av följande mönster i textrutan **Sign-on-URL:**`http://<companyname>.benefitsolver.com`

    b. Skriv en URL med följande mönster i rutan **Identifierare:**`https://<companyname>.benefitsolver.com/saml20`
