...
1. Klicka på **redigerings** ikonen för att redigera **namnet på namn identifieraren**.
    ...
    ![mallar](media/benselect-tutorial/mail-prefix1.png)

1. I avsnittet **hantera användar anspråk** utför du följande steg:

    ![mallar](media/benselect-tutorial/mail-prefix2.png)
...
När du klickar på panelen BenSelect på åtkomst panelen, bör du loggas in automatiskt på den BenSelect som du ställer in SSO för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
