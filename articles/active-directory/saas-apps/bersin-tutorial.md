...
4. Om du vill konfigurera appen i **IDP**-initierat läge gör du följande i avsnittet **Grundläggande SAML-konfiguration**:
    ...
    c. I den **Vidarebefordransstatus** text skriver en URL med hjälp av följande mönster: `https://www.bersin.com/secure/`
...
Att konfigurera enkel inloggning på **Bersin** sida, som du behöver skicka de hämtade **XML-Metadata för Federation** och lämpliga kopierade URL: er från Azure portal för att [Bersin supportteamet](mailto:ramansabde@gmail.com). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
