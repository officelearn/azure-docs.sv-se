...
3. **[Skapa en testanvändare Bersin](#create-a-bersin-test-user)**  – du har en motsvarighet för Britta Simon i Bersin som är länkad till en Azure AD-representation av användaren.
...
7. Att konfigurera enkel inloggning på **Bersin** sida, som du behöver skicka de hämtade **XML-Metadata för** till [Bersin supportteamet](mailto:USBersinServiceClient@deloitte.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
