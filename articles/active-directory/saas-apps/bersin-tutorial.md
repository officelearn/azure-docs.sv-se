...
1. Om du vill konfigurera programmet i **SP** initierade läge, utföra följande steg:
    ...
    I rutan **Inloggnings-URL** anger du en URL: `https://www.bersin.com/Login.aspx`
...
1. Klicka på **spara** knappen.
    ...
    ![Konfigurera enkel inloggning – knappen Spara](./media/bersin-tutorial/tutorial_general_400.png)
    
1. Att konfigurera enkel inloggning på **Bersin** sida, som du behöver skicka de hämtade **XML-Metadata för** till [Bersin supportteamet](mailto:USBersinServiceClient@deloitte.com). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
