---
title: 'Självstudier: Azure Active Directory-integration med BetterWorks | Microsoft Docs'
...
ms.locfileid: "39433151"
---
# <a name="tutorial-azure-active-directory-integration-with-betterworks"></a>Självstudier: Azure Active Directory-integration med BetterWorks
...
1. På den **BetterWorks domän och URL: er** om du vill konfigurera programmet i **IDP-initierad läge**:
    ...
    a. I den **identifierare** textrutan anger du ett URL med hjälp av följande mönster: `https://app.betterworks.com/saml2/metadata/`

    b. I den **svars-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://app.betterworks.com/saml2/acs/`
...
1. BetterWorks program som förväntar SAML-intyg i ett visst format. Konfigurera följande anspråk för det här programmet. Du kan hantera värdena för dessa attribut från den ”**attributet**” fliken av programmet. Följande skärmbild visar ett exempel för detta. 
