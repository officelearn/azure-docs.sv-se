---
title: 'Självstudie: Azure Active Directory integrering med BGS online | Microsoft Docs'
...
ms.locfileid: "92457222"
---
# <a name="tutorial-azure-active-directory-integration-with-bgs-online"></a>Självstudie: Azure Active Directory integrering med BGS online
...
För att konfigurera enkel inloggning på **BGS Online**-sidan behöver du skicka nedladdad **federationsmetadata-XML** och lämpliga kopierade URL:er från Azure-portalen till [supportteamet för BGS Online](mailto:bgsdashboardteam@millwardbrown.com). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
...
I det här avsnittet skapar du en användare med namnet Britta Simon i BGS Online. Arbeta med [BGS online support team](mailto:bgsdashboardteam@millwardbrown.com) för att lägga till användarna i BGS online-plattformen. Användare måste skapas och aktiveras innan du använder enkel inloggning.

### <a name="test-single-sign-on"></a>Testa enkel inloggning

I det här avsnittet testar du konfigurationen för enkel inloggning Azure AD med hjälp av åtkomstpanelen.

När du klickar på BGS Online-panelen i åtkomstpanelen bör du automatiskt loggas in på BGS Online som du har konfigurerat enkel inloggning för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
