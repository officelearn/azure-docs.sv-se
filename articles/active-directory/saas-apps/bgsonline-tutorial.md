...
1. På den **PÅSAR Online domän och URL: er** avsnittet, utför följande steg:
    ...
    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska identifierare och svars-URL. Kontakta [PÅSAR Online supportteamet](mailTo:bgsdashboardteam@millwardbrown.com) att hämta dessa värden.
