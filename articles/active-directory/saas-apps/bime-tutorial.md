---
title: 'Självstudier: Azure Active Directory-integration med Bime | Microsoft Docs'
...
ms.locfileid: "39446603"
---
# <a name="tutorial-azure-active-directory-integration-with-bime"></a>Självstudier: Azure Active Directory-integration med Bime
...
1. På den **Bime domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<tenant-name>.Bimeapp.com`

    b. I den **identifierare** textrutan anger du ett URL med hjälp av följande mönster: `https://<tenant-name>.Bimeapp.com`

    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska inloggnings-URL och identifierare. Kontakta [Bime klienten supportteamet](https://bime.zendesk.com/hc/categories/202604307-Support-tech-notes-and-tips-) att hämta dessa värden. 
...
1. I verktygsfältet klickar du på **Admin**, och sedan **konto**.
    ...
    ![Administratören](./media/bime-tutorial/ic775558.png "Admin")
...
1. I verktygsfältet klickar du på **Admin**, och sedan **användare**.
    ...
    ![Administratören](./media/bime-tutorial/ic775561.png "Admin")
