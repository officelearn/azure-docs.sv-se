---
title: 'Självstudier: Azure Active Directory-integrering med Birst Agile Business Analytics | Microsoft Docs'
...
ms.locfileid: "67106233"
---
# <a name="tutorial-azure-active-directory-integration-with-birst-agile-business-analytics"></a>Självstudier: Azure Active Directory-integrering med Birst Agile Business Analytics
...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://login.bws.birst.com/SAMLSSO/Services.aspx?birst.idpid=TENANTIDPID`
...
För att konfigurera enkel inloggning på **Birst Agile Business Analytics**-sidan behöver du skicka det nedladdade **certifikatet (Base64)** och lämpliga kopierade URL:er från Azure-portalen till [supportteamet för Birst Agile Business Analytics](mailto:info@birst.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
