...
ms.locfileid: "39427500"
---
# <a name="tutorial-azure-active-directory-integration-with-birst-agile-business-analytics"></a>Självstudier: Azure Active Directory-integration med Birst flexibel Företagsanalys
...
1. På den **Birst flexibel Business Analytics domän och URL: er** avsnittet, utför följande steg:
    ...
    > [!NOTE] 
    > Det här värdet är inte verkliga. Uppdatera värdet med faktiska inloggnings-URL: en. Kontakta [Birst flexibel Business Analytics Client supportteamet](mailto:info@birst.com) att hämta värdet. 
