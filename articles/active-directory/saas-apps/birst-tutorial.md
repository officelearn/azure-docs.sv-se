---
title: 'Självstudiekurs: Azure Active Directory-integrering med Birst Agile Business Analytics | Microsoft-dokument'
...
ms.locfileid: "73158844"
---
# <a name="tutorial-azure-active-directory-integration-with-birst-agile-business-analytics"></a>Självstudiekurs: Azure Active Directory-integrering med Birst Agile Business Analytics
...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    Skriv en URL i textrutan **Sign-on URL** med följande mönster:`https://login.bws.birst.com/SAMLSSO/Services.aspx?birst.idpid=TENANTIDPID`
