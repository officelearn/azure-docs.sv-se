---
title: 'Självstudiekurs: Azure Active Directory-integrering med BitaBIZ | Microsoft-dokument'
...
---
# <a name="tutorial-azure-active-directory-integration-with-bitabiz"></a>Självstudiekurs: Azure Active Directory-integrering med BitaBIZ
