---
title: 'Självstudiekurs: Azure Active Directory-integrering med Blackboard Learn - Shibboleth | Microsoft-dokument'
...
ms.locfileid: "73158817"
---
# <a name="tutorial-azure-active-directory-integration-with-blackboard-learn---shibboleth"></a>Självstudiekurs: Azure Active Directory-integrering med Blackboard Learn - Shibboleth
...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    a. Skriv en URL med hjälp av följande mönster i textrutan **Sign-on-URL:**`https://<yourblackoardlearnserver>.blackboardlearn.com/Shibboleth.sso/Login`

    b. Skriv en URL med följande mönster i rutan **Identifierare:**`https://<yourblackoardlearnserver>.blackboardlearn.com/shibboleth-sp`

    c. Skriv en URL med följande mönster i textrutan **Svara URL:**`https://<yourblackoardlearnserver>.blackboardlearn.com/Shibboleth.sso/SAML2/POST`
