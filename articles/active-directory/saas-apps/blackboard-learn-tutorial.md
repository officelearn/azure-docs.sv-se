---
title: 'Självstudier: Lär dig mer om Azure Active Directory enkel inloggning (SSO) med svart tavla | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-blackboard-learn"></a>Självstudier: Azure Active Directory enkel inloggning (SSO) med svart – lär dig
