---
title: 'Självstudier: Konfigurera Blink för automatisk användar etablering med Azure Active Directory | Microsoft Docs'
...
ms.locfileid: "71156129"
---
# <a name="tutorial-configure-blink-for-automatic-user-provisioning"></a>Självstudier: Konfigurera Blink för automatisk användar etablering
...
1. Logga ett [support ärende](https://help.joinblink.com/hc/requests/new) eller skicka ett e- support@joinblink.com postmeddelande till **blinkande** för att begära en scim-token. .
