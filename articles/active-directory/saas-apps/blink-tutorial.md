---
title: 'Självstudier: Azure Active Directory enkel inloggning (SSO) med blink | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-blink"></a>Självstudier: Azure Active Directory enkel inloggning (SSO) med blink
...
1. I avsnittet **grundläggande SAML-konfiguration** anger du värden för följande fält:
    ...
    > [!NOTE]
    > Dessa värden är inte verkliga. Uppdatera de här värdena med faktisk inloggnings-URL och identifierare. Kontakta [support teamet](https://help.joinblink.com) för att få dessa värden. Du kan även se mönstren som visas i avsnittet **Grundläggande SAML-konfiguration** i Azure-portalen.
...
1. Förutom ovan förväntar sig ett program för att blinka möten med fler attribut att skickas tillbaka i SAML-svar. I avsnittet användar anspråk i dialog rutan användarattribut, utför följande steg för att lägga till SAML-token-attributet som visas i tabellen nedan:
...
Om du vill konfigurera enkel inloggning på **blinkande** sida måste du skicka den hämtade **XML-metadata för federationsmetadata** och lämpliga kopierade url: er från Azure Portal till [blinkande support team](https://help.joinblink.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
