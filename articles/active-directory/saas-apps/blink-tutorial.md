...
1. **[Konfigurera blinka SSO](#configure-blink-sso)** – för att konfigurera inställningar för enskilda Sign-On på program sidan.
...
När du klickar på panelen blinka i åtkomst panelen, bör du loggas in automatiskt till den Blink som du har konfigurerat SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
