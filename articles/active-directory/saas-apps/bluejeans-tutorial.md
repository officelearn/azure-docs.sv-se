...
5. I resultatpanelen väljer **BlueJeans**, och klicka sedan på **Lägg till** för att lägga till programmet.
...
6. På den **BlueJeans Configuration** klickar du på **konfigurera BlueJeans** att öppna **konfigurera inloggning** fönster. Kopiera den **utloggning URL, ändra lösenord URL och SAML enkel inloggning för tjänst-URL** från den **Snabbreferens avsnittet.**

    ![Konfigurera enkel inloggning](./media/bluejeans-tutorial/tutorial_bluejeans_configure.png) 

7. Logga in på i ett annat webbläsarfönster din **BlueJeans** företagets plats som administratör.

8. Gå till **ADMIN \> gruppinställningar \> Security**.

   ![Administratören](./media/bluejeans-tutorial/IC785868.png "Admin")

9. I den **Security** avsnittet, utför följande steg:
