...
4. I sökrutan skriver **BlueJeans**.
    ...
    ![Skapa en testanvändare i Azure AD](./media/bluejeans-tutorial/tutorial_bluejeans_search.png)

5. Välj i resultatpanelen **BlueJeans**, och klicka sedan på **Lägg till** för att lägga till programmet.

    ![Skapa en testanvändare i Azure AD](./media/bluejeans-tutorial/tutorial_bluejeans_addfromgallery.png)
...
9. I den **säkerhet** avsnittet, utför följande steg:
   ...
   ![SAML för enkel inloggning](./media/bluejeans-tutorial/IC785869.png "SAML för enkel inloggning")
...
10. Gå vidare med följande steg:
    ...
    ![Certifikat sökvägen](./media/bluejeans-tutorial/IC785870.png "certifikat sökväg")
...
11. Gå vidare med följande steg:
    ...
    ![Spara ändringarna](./media/bluejeans-tutorial/IC785874.png "spara ändringar")
...
1. I den **Azure-portalen**, klicka på det vänstra navigeringsfönstret **Azure Active Directory** ikon.
    ...
    ![Skapa en testanvändare i Azure AD](./media/bluejeans-tutorial/create_aaduser_01.png)

2. Om du vill visa en lista över användare, gå till **användare och grupper** och på **alla användare**.

    ![Skapa en testanvändare i Azure AD](./media/bluejeans-tutorial/create_aaduser_02.png)

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i dialogrutan.

    ![Skapa en testanvändare i Azure AD](./media/bluejeans-tutorial/create_aaduser_03.png)

4. På den **användaren** dialogrutan utför följande steg:

    ![Skapa en testanvändare i Azure AD](./media/bluejeans-tutorial/create_aaduser_04.png) 
...
Syftet med det här avsnittet är att skapa en användare som kallas Britta Simon i BlueJeans. BlueJeans stöder automatisk användaretablering, vilket är aktiverat som standard. Du hittar mer information [här](bluejeans-provisioning-tutorial.md) om hur du konfigurerar automatisk användaretablering.
