...
1. På den **Bonusly domän och URL: er** avsnittet, utför följande steg:
    ...
    > [!NOTE] 
    > Värdet är inte verkligt. Uppdatera värdet för med den faktiska svars-URL:en. Kontakta [Bonusly supportteamet](https://bonus.ly/contact) att hämta värdet.
 
1. På den **SAML-signeringscertifikat** avsnittet, kopiera den **TUMAVTRYCK** värdet från certifikatet.

    ![Länk för nedladdning av certifikatet](./media/bonus-tutorial/tutorial_bonusly_certificate.png) 

1. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning – knappen Spara](./media/bonus-tutorial/tutorial_general_400.png)
...
1. Om du vill visa en lista över användare, gå till **användare och grupper** och klicka på **alla användare**.
    ...
    ![Länkarna ”Användare och grupper” och ”Alla grupper”](./media/bonus-tutorial/create_aaduser_02.png) 
