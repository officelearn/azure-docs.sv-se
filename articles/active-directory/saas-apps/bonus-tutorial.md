...
2. **[Konfigurera enkel inloggning med bonus](#configure-bonusly-single-sign-on)** för att konfigurera enskilda Sign-On inställningar på program sidan.
...
När du klickar på den bonus panelen i åtkomst panelen, bör du loggas in automatiskt på den bonus som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
