...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/bonus-tutorial/tutorial_bonusly_samlbase.png)

3. På den **Bonusly domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och bonusly domän med enkel inloggning information](./media/bonus-tutorial/tutorial_bonusly_url.png)
...
4. På den **SAML-signeringscertifikat** avsnittet, kopiera den **TUMAVTRYCKET** värde från certifikatet.
    ...
    ![Länken hämta certifikatet](./media/bonus-tutorial/tutorial_bonusly_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/bonus-tutorial/tutorial_general_400.png)
...
3. Klicka på den **användare och tillägg** fliken.
    ...
    ![Användare och tillägg](./media/bonus-tutorial/ic781042.png "användare och tillägg")
