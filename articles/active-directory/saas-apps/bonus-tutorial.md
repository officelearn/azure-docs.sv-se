...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    > [!NOTE]
    > Värdet är inte verkligt. Uppdatera värdet för med den faktiska svars-URL:en. Kontakta [support teamet för bonus](https://bonus.ly/contact) för att hämta värdet. Du kan även se de mönster som visas i avsnittet **Grundläggande SAML-konfiguration** i Azure-portalen.
...
1. I dialogrutan **Lägg till användare** utför du följande steg:
    ...
    c. I text rutan **e-post** anger du e-postadressen till den användare som `brittasimon\@contoso.com`.
