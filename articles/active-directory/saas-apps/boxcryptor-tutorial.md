...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/boxcryptor-tutorial/tutorial_boxcryptor_samlbase.png)

3. På den **Boxcryptor domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och Boxcryptor domän med enkel inloggning information](./media/boxcryptor-tutorial/tutorial_boxcryptor_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **certifikat (Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/boxcryptor-tutorial/tutorial_boxcryptor_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/boxcryptor-tutorial/tutorial_general_400.png)
