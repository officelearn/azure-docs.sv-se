---
title: 'Självstudiekurs: Azure Active Directory-integrering med Brandfolder | Microsoft-dokument'
...
---
# <a name="tutorial-azure-active-directory-integration-with-brandfolder"></a>Självstudiekurs: Azure Active Directory-integrering med Brandfolder
...
4. På sidan **Konfigurera enkel inloggning med SAML** utför du följande steg:
    ...
    a. Skriv en URL med följande mönster i textrutan **Identifierare:**`https://brandfolder.com/organizations/<ORG_SLUG>/saml/metadata`

    b. Skriv en URL med följande mönster i textrutan **Svara URL:**`https://brandfolder.com/organizations/<ORG_SLUG>/saml`
