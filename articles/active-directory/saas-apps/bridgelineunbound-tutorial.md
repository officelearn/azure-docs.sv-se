---
title: 'Självstudiekurs: Azure Active Directory-integrering med Bridgeline Unbound | Microsoft-dokument'
...
ms.locfileid: "73157590"
---
# <a name="tutorial-azure-active-directory-integration-with-bridgeline-unbound"></a>Självstudiekurs: Azure Active Directory-integrering med Bridgeline Obunden
...
4. Om du vill konfigurera programmet i **IDP-initierat** läge i avsnittet **Grundläggande SAML-konfiguration** gör du följande:
    ...
    a. Skriv en URL med följande mönster i textrutan **Identifierare:**`iApps_UPSTT_<ENVIRONMENTNAME>`

    b. Skriv en URL med följande mönster i textrutan **Svara URL:**`https://<SUBDOMAIN>.iapps.com/SAMLAssertionService.aspx`
...
5. Klicka på **Ange ytterligare URL:er** och gör följande om du vill konfigurera appen i **SP**-initierat läge:
    ...
    Skriv en URL med hjälp av följande mönster i textrutan **Sign-on-URL:**`https://<SUBDOMAIN>.iapps.com/CommonLogin/login?<INSTANCENAME>`
