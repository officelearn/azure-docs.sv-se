---
title: 'Självstudiekurs: Azure Active Directory-integrering med Brightspace av Desire2Learn | Microsoft-dokument'
...
ms.locfileid: "73158779"
---
# <a name="tutorial-azure-active-directory-integration-with-brightspace-by-desire2learn"></a>Självstudiekurs: Azure Active Directory-integrering med Brightspace av Desire2Learn
...
4. På sidan **Konfigurera enkel inloggning med SAML** utför du följande steg:
    ...
    b. Skriv en URL med följande mönster i textrutan **Svara URL:**`https://<companyname>.desire2learn.com/d2l/lp/auth/login/samlLogin.d2l`
