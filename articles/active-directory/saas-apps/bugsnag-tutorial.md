---
title: 'Självstudiekurs: Azure Active Directory-integrering med Bugsnag | Microsoft-dokument'
...
---
# <a name="tutorial-azure-active-directory-integration-with-bugsnag"></a>Självstudiekurs: Azure Active Directory-integrering med Bugsnag
...
4. Om du vill konfigurera appen i **IDP**-initierat läge gör du följande i avsnittet **Grundläggande SAML-konfiguration**:
    ...
    Skriv en URL med följande mönster i textrutan **Svara URL:**`https://app.bugsnag.com/user/sign_in/saml/<org_slug>/acs`
