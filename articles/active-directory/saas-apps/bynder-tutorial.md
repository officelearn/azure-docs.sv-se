...
För att konfigurera enkel inloggning på **Bynder**-sidan behöver du skicka nedladdad **federationsmetadata-XML** och lämpliga kopierade URL:er från Azure-portalen till [supportteamet för Bynder](https://www.bynder.com/en/support/). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
