---
title: 'Självstudier: Azure Active Directory-integration med Bynder | Microsoft Docs'
...
ms.locfileid: "39043456"
---
# <a name="tutorial-azure-active-directory-integration-with-bynder"></a>Självstudier: Azure Active Directory-integration med Bynder
...
3. **[Skapa en testanvändare Bynder](#create-a-bynder-test-user)**  – du har en motsvarighet för Britta Simon i Bynder som är länkad till en Azure AD-representation av användaren.
...
3. På den **Bynder domän och URL: er** avsnittet, utför följande steg om du vill konfigurera programmet i **IDP** initierade läge:
    ...
    a. I den **identifierare** textrutan anger du ett URL med hjälp av följande mönster: `https://<company name>.getbynder.com`
    
    b. I den **svars-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<company name>.getbynder.com/sso/SAML/authenticate/`
...
4. Kontrollera **visa avancerade URL-inställningar** och utföra följande steg om du vill konfigurera programmet i **SP** initierade läge:
    ...
    I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<company name>.getbynder.com/login/`

    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska identifierare, svars-URL och inloggnings-URL. Kontakta [Bynder klienten supportteamet](https://www.bynder.com/en/support/) att hämta dessa värden. 
...
6. Klicka på **spara** knappen.
    ...
    ![Konfigurera enkel inloggning spara-knapp](./media/bynder-tutorial/tutorial_general_400.png)

7. Att konfigurera enkel inloggning på **Bynder** sida, som du behöver skicka de hämtade **XML-Metadata för** till [Bynder supportteamet](https://www.bynder.com/en/support/). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
...
Målet med det här avsnittet är att skapa en användare som kallas Britta Simon i Bynder. Bynder stöder just-in-time-etablering, vilket är som standard aktiverat. Det finns inga uppgift åt dig i det här avsnittet. En ny användare skapas vid ett försök att komma åt Bynder om det inte finns ännu.
...
2. I listan med program väljer **Bynder**.
