---
title: 'Självstudiekurs: Azure Active Directory-integrering med Capriza-plattformen | Microsoft-dokument'
...
ms.locfileid: "73157557"
---
# <a name="tutorial-azure-active-directory-integration-with-capriza-platform"></a>Självstudiekurs: Azure Active Directory-integrering med Capriza-plattformen
...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    Skriv en URL med hjälp av följande mönster i textrutan **Sign-on-URL:**`https://<companyname>.capriza.com/<tenantid>`
...
Målet med det här avsnittet är att skapa användaren Britta Simon i Capriza. Capriza stöder just-in-time-etablering, vilket är aktiverat som standard. **Kontrollera att ditt domännamn är konfigurerat med Capriza för etablering av användare. Därefter fungerar bara just-in-time-användarens etablering.**
