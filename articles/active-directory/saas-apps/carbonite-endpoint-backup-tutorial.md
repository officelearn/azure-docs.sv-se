...
2. **[Konfigurera Carbonite Endpoint backup SSO](#configure-carbonite-endpoint-backup-sso)** – om du vill konfigurera enskilda Sign-On inställningar på program sidan.
