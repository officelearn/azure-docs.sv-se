...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/carlsonwagonlit-tutorial/tutorial_carlsonwagonlittravel_samlbase.png)

3. På den **Carlson Wagonlit resa domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och Carlson Wagonlit resa domän med enkel inloggning information](./media/carlsonwagonlit-tutorial/tutorial_carlsonwagonlittravel_url.png)

    I den **identifierare** textruta Skriv värdet: `cwt-stage`

4. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.

    ![Länken hämta certifikatet](./media/carlsonwagonlit-tutorial/tutorial_carlsonwagonlittravel_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/carlsonwagonlit-tutorial/tutorial_general_400.png)
