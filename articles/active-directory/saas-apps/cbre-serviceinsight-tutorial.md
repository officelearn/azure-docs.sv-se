---
title: 'Självstudier: Azure Active Directory enkel inloggning (SSO) med CBRE ServiceInsight | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-cbre-serviceinsight"></a>Självstudier: Azure Active Directory enkel inloggning (SSO) med CBRE ServiceInsight
...
1. I avsnittet **grundläggande SAML-konfiguration** anger du värden för följande fält:
    ...
    I rutan **Inloggnings-URL** anger du en URL: `https://adfs4.mainstreamsasp.com/adfs/ls/`
...
För att konfigurera enkel inloggning på **CBRE ServiceInsight**-sidan måste du skicka **URL:en för appfederationsmetadata** till [CBRE ServiceInsight-supportteamet](mailto:SISupport@cbre.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
