...
I det här avsnittet skapar du en användare med namnet Britta Simon i Certain Admin SSO. Arbeta med [särskilda support team för administration av SSO](mailto:integrations@certain.com) för att lägga till användare i en viss admin SSO-plattform. Användare måste skapas och aktiveras innan du använder enkel inloggning.

### <a name="test-single-sign-on"></a>Testa enkel inloggning

I det här avsnittet testar du konfigurationen för enkel inloggning Azure AD med hjälp av åtkomstpanelen.

När du klickar på Certain Admin SSO-ikonen i åtkomstpanelen bör du automatiskt loggas in på den Certain Admin SSO som du har konfigurerat enkel inloggning för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
