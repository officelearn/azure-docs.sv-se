...
1. Att konfigurera enkel inloggning på **Certify** sida, som du behöver skicka de hämtade **Certificate(Raw)** och **URL för utloggning, SAML entitets-ID och SAML enkel inloggning för tjänst-URL** att [Certify supportteamet](mailto:support@certify.com). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
...
Det finns inget åtgärdsobjekt för dig i det här avsnittet. En ny användare skapas vid ett försök att komma åt certifiera om det inte finns ännu.
