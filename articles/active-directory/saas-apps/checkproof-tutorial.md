...
1. Du kan använda Microsoft Access-panelen. När du klickar på panelen CheckProof på åtkomst panelen, bör du loggas in automatiskt på den CheckProof som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
