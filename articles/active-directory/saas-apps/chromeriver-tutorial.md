---
title: 'Självstudiekurs: Azure Active Directory-integrering med Chromeriver | Microsoft-dokument'
...
ms.locfileid: "73157470"
---
# <a name="tutorial-azure-active-directory-integration-with-chromeriver"></a>Självstudiekurs: Azure Active Directory-integrering med Chromeriver
...
4. På sidan **Konfigurera enkel inloggning med SAML** utför du följande steg:
    ...
    a. Skriv en URL med följande mönster i textrutan **Identifierare:**`https://<subdomain>.chromeriver.com`

    b. Skriv en URL med följande mönster i textrutan **Svara URL:**`https://<subdomain>.chromeriver.com/login/sso/saml/consume?customerId=<uniqueid>`
...
När du klickar på Chromeriver-panelen i åtkomstpanelen bör du automatiskt loggas in på Chromeriver som du har konfigurerat enkel inloggning för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
