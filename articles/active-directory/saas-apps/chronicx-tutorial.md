...
3. **[Skapa en testanvändare ChronicX®](#create-a-chronicx®-test-user)**  – du har en motsvarighet för Britta Simon i ChronicX® som är länkad till en Azure AD-representation av användaren.
...
6. Att konfigurera enkel inloggning på **ChronicX®** sida, som du behöver skicka de hämtade **XML-Metadata för** till [ChronicX® supportteamet](https://www.casebank.com/contact-us/). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
