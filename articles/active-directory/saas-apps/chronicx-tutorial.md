...
2. **[Konfigurera ChronicX® enkel inloggning](#configure-chronicx-single-sign-on)** för att konfigurera de enskilda Sign-On inställningarna på program sidan.
...
När du klickar på panelen ChronicX® på åtkomst panelen, bör du loggas in automatiskt på den ChronicX® som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
