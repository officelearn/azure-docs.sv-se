---
title: 'Självstudier: Azure Active Directory-integration med Cimpl | Microsoft Docs'
...
ms.locfileid: "39445625"
---
# <a name="tutorial-azure-active-directory-integration-with-cimpl"></a>Självstudier: Azure Active Directory-integration med Cimpl
...
1. På den **Cimpl domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://sso.etelesolv.com/<TENANTNAME>`

    b. I den **identifierare** textrutan anger du ett URL med hjälp av följande mönster: `https://sso.etelesolv.com/<TENANTNAME>`

    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska inloggnings-URL och identifierare. Kontakta Cimpl-teamet på **+1 866-982-8250** att hämta dessa värden. 
