---
title: 'Självstudiekurs: Azure Active Directory-integrering med Cimpl | Microsoft-dokument'
...
---
# <a name="tutorial-azure-active-directory-integration-with-cimpl"></a>Självstudiekurs: Azure Active Directory-integrering med Cimpl
