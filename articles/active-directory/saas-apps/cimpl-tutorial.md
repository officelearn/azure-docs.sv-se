---
title: 'Självstudie: Azure Active Directory integrering med Cimpl | Microsoft Docs'
...
ms.locfileid: "73157445"
---
# <a name="tutorial-azure-active-directory-integration-with-cimpl"></a>Självstudie: Azure Active Directory integrering med Cimpl
...
När du klickar på Cimpl-ikonen i åtkomstpanelen bör du automatiskt loggas in på den Cimpl som du har konfigurerat enkel inloggning för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
