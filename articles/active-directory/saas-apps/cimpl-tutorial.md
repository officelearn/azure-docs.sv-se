...
För att konfigurera enkel inloggning på **Cimpl**-sidan behöver du skicka det nedladdade **certifikatet (Base64)** och lämpliga kopierade URL:er från Azure-portalen till Cimpl-supporten på **+1 866-982-8250**. De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
