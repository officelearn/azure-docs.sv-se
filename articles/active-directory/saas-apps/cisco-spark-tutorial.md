...
8. Gå tillbaka till fliken för **Cisco Cloud Collaboration Management** browser. Om testet lyckades väljer du **det här testet lyckades. Aktivera alternativ för enkel Sign-On** och klicka på **Nästa**.
...
När du väljer panelen Cisco-WebEx på åtkomst panelen, bör du loggas in automatiskt på Cisco-WebEx som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
...
- [Skydda Cisco WebEx med avancerad synlighet och kontroller](/cloud-app-security/protect-webex)