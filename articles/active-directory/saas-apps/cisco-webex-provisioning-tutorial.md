...
6.  I fältet **klient-URL** anger du ett värde i form av `https://api.ciscoweb.com/v1/scim/[OrgId]`. Logga in på ditt [Cisco WebEx-kontroll nav](https://admin.webex.com/login)för att få `[OrgId]`. Klicka på organisationens namn längst ned till vänster och kopiera värdet från **organisations-ID**. 
