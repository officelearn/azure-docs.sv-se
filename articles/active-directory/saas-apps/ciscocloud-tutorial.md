...
ms.date: 04/16/2018
ms.author: jeedes
ms.openlocfilehash: c2d80f374b6e7e7c8d64a4a8940853f61e8bb5d7
...
4. I sökrutan skriver **Cisco molnet**väljer **Cisco molnet** resultatet-panelen klickar **Lägg till** för att lägga till programmet.
    ...
    ![Cisco moln i resultatlistan](./media/ciscocloud-tutorial/tutorial_ciscocloud_addfromgallery.png)
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/ciscocloud-tutorial/tutorial_ciscocloud_samlbase.png)
...
3. På den **Cisco molnet domän och URL: er** avsnittet, utför följande steg om du vill konfigurera programmet i **IDP** initierade läge:
    ...
    ![URL: er och Cisco molnet domän med enkel inloggning information](./media/ciscocloud-tutorial/tutorial_ciscocloud_url.png)
...
4. Kontrollera **visa avancerade inställningar för URL: en** och utför följande steg om du vill konfigurera programmet i **SP** initierade läge:
    ...
    ![URL: er och Cisco molnet domän med enkel inloggning information](./media/ciscocloud-tutorial/tutorial_ciscocloud_url1.png)
...
5. På den **SAML-signeringscertifikat** klickar du på kopieringsknappen för att kopiera **webbadress Federation Metadata** och klistra in den i anteckningar.
    ...
    ![Länken hämta certifikatet](./media/ciscocloud-tutorial/tutorial_ciscocloud_certificate.png)

6. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/ciscocloud-tutorial/tutorial_general_400.png)
...
2. Välj i listan med program **Cisco molnet**.
    ...
    ![Länken Cisco moln i listan med program](./media/ciscocloud-tutorial/tutorial_ciscocloud_app.png)  
