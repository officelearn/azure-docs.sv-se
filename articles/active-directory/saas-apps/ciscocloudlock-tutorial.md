...
4. I sökrutan skriver **The Cloud Security Fabric**väljer **The Cloud Security Fabric** resultatet panelen klickar **Lägg till** för att lägga till programmet.
...
3. **[Skapa en testanvändare The Cloud Security Fabric](#create-a-the-cloud-security-fabric-test-user)**  – du har en motsvarighet för Britta Simon i The Cloud Security-infrastrukturen som är länkad till en Azure AD-representation av användaren.
...
3. På den **The Cloud Security Fabric domän och URL: er** avsnittet, utför följande steg:
...
6. Att konfigurera enkel inloggning på **The Cloud Security Fabric** sida, som du behöver skicka de hämtade **XML-Metadata för** till [The Cloud Security Fabric supportteamet](mailto:support@cloudlock.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
...
2. I listan med program väljer **The Cloud Security Fabric**.
