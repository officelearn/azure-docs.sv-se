...
4. I sökrutan skriver **Cisco Cloudlock**väljer **Cisco Cloudlock** resultatet-panelen klickar **Lägg till** för att lägga till programmet.
    ...
    ![Cisco Cloudlock i resultatlistan](./media/ciscocloudlock-tutorial/tutorial_ciscocloudlock_addfromgallery.png)
...
3. På den **Cisco Cloudlock domän och URL: er** avsnittet, utför följande steg:
    ...
    ![Cisco Cloudlock domän och URL: er med enkel inloggning information](./media/ciscocloudlock-tutorial/tutorial_ciscocloudlock_url.png)
...
2. Välj i listan med program **Cisco Cloudlock**.
    ...
    ![Cisco Cloudlock länken i listan med program](./media/ciscocloudlock-tutorial/tutorial_ciscocloudlock_app.png)  
