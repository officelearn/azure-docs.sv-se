...
2. **[Konfigurera Cloud Security Fabric SSO](#configure-the-cloud-security-fabric-sso)** – för att konfigurera enskilda Sign-On inställningar på program sidan.
...
När du klickar på panelen Cloud Security Fabric i åtkomst panelen, bör du loggas in automatiskt på den moln säkerhets infrastruktur som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
