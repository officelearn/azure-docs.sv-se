...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/citrix-gotomeeting-tutorial/tutorial_gotomeeting_samlbase.png)

3. På den **GoToMeeting domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och GoToMeeting domän med enkel inloggning information](./media/citrix-gotomeeting-tutorial/tutorial_gotomeeting_url.png)
...
5. Klicka på **spara** knappen.
    ...
    ![Konfigurera enkel inloggning spara](./media/citrix-gotomeeting-tutorial/tutorial_general_400.png)
