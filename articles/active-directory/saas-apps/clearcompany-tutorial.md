...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/clearcompany-tutorial/tutorial_clearcompany_samlbase.png)
...
3. På den **ClearCompany domän och URL: er** avsnittet, utför följande steg om du vill konfigurera programmet i IDP initierade läge:
    ...
    ![URL: er och ClearCompany domän med enkel inloggning information](./media/clearcompany-tutorial/tutorial_clearcompany_url1.png)

    I den **identifierare** textruta anger du URL: `https://api.clearcompany.com`

4. Kontrollera **visa avancerade inställningar för URL: en** och utför följande steg om du vill konfigurera programmet i **SP** initierade läge:

    ![URL: er och ClearCompany domän med enkel inloggning information](./media/clearcompany-tutorial/tutorial_clearcompany_url2.png)
...
5. På den **SAML-signeringscertifikat** klickar du på **Certificate(Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/clearcompany-tutorial/tutorial_clearcompany_certificate.png) 

6. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/clearcompany-tutorial/tutorial_general_400.png)
