...
3. **[Skapa en tydlig granska testanvändare](#create-a-clear-review-test-user)**  – du har en motsvarighet för Britta Simon i rensa granskning som är länkad till en Azure AD-representation av användaren.
...
3. På den **Rensa granska domän och URL: er** avsnittet, utför följande steg om du vill konfigurera programmet i **IdP-initierad** läge:
...
5. Rensa granska programmet förväntar dig av det unikt värdet för användaridentifierare namnidentifierare anspråket. Du ska mappa användare ID-värde till **user.mail**.
...
8. På den **Rensa Granska konfigurationen** klickar du på **konfigurera Rensa granska** att öppna **konfigurera inloggning** fönster. Kopiera den **URL för utloggning, SAML entitets-ID och SAML enkel inloggning för tjänst-URL** från den **Snabbreferens avsnittet.**

    ![Rensa Granska konfigurationen](./media/clearreview-tutorial/tutorial_clearreview_configure.png) 

9. Att konfigurera enkel inloggning på **Rensa granska** sida, öppna den **Rensa granska** med administratörsautentiseringsuppgifter.

10. Välj **Admin** i det vänstra navigeringsfönstret.
...
2. I listan med program väljer **Rensa granska**.
