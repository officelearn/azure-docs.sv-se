...
2. **[Konfigurera smarta Nelly SSO](#configure-clever-nelly-sso)** – för att konfigurera enskilda Sign-On inställningar på program sidan.
...
När du klickar på panelen smarta Nelly på åtkomst panelen, bör du loggas in automatiskt på smarta-Nelly som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
