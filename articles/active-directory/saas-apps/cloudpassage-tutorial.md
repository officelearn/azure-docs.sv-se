---
title: 'Självstudie: Azure Active Directory integrering med CloudPassage | Microsoft Docs'
...
ms.locfileid: "73157353"
---
# <a name="tutorial-azure-active-directory-integration-with-cloudpassage"></a>Självstudie: Azure Active Directory integrering med CloudPassage
...
När du klickar på CloudPassage-panelen i åtkomstpanelen bör du automatiskt loggas in på CloudPassage som du har konfigurerat enkel inloggning för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
