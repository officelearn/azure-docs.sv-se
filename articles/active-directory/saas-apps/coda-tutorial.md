...
När du klickar på CODA-panelen i åtkomst panelen, bör du loggas in automatiskt på det CODA som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
...
- [Skydda CODA med avancerad synlighet och kontroller](/cloud-app-security/proxy-intro-aad)