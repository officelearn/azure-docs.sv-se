...
För att konfigurera enkel inloggning på **Collaborative Innovation**-sidan behöver du skicka nedladdad **federationsmetadata-XML** och lämpliga kopierade URL:er från Azure-portalen till [supportteamet för Collaborative Innovation](https://www.unilever.com/contact/). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
