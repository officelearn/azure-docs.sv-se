---
title: 'Självstudie: Azure Active Directory integrering med Comm100 Live Chat | Microsoft Docs'
...
ms.locfileid: "73157344"
---
# <a name="tutorial-azure-active-directory-integration-with-comm100-live-chat"></a>Självstudie: Azure Active Directory integrering med Comm100 Live Chat
...
4. På sidan **Ny agent** utför du följande steg:
    ...
    a. a. I text rutan **e-postadress** anger du e-postmeddelandet som **Brittasimon\@contoso.com**.
...
När du klickar på Comm100 Live Chat-panelen i åtkomstpanelen bör du automatiskt loggas in på Comm100 Live Chat som du har konfigurerat enkel inloggning för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
