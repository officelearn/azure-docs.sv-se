---
title: 'Självstudiekurs: Azure Active Directory-integrering med CompetencyIQ | Microsoft-dokument'
...
---
# <a name="tutorial-azure-active-directory-integration-with-competencyiq"></a>Självstudiekurs: Azure Active Directory-integrering med CompetencyIQ
...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    b. Skriv en URL i textrutan **Identifierare (enhets-ID):**`https://www.competencyiq.com/`
