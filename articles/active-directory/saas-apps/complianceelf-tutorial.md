...
4. I sökrutan skriver **kompatibilitet Tomtenisse**väljer **kompatibilitet Tomtenisse** resultatet-panelen klickar **Lägg till** för att lägga till programmet.
    ...
    ![Efterlevnad Tomtenisse i resultatlistan](./media/complianceelf-tutorial/tutorial_complianceelf_addfromgallery.png)
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/complianceelf-tutorial/tutorial_complianceelf_samlbase.png)
...
3. På den **kompatibilitet Tomtenisse domän och URL: er** avsnittet, utför följande steg om du vill konfigurera programmet i **IDP** initierade läge:
    ...
    ![URL: er och kompatibilitet Tomtenisse domän med enkel inloggning information](./media/complianceelf-tutorial/tutorial_complianceelf_url.png)

    I den **identifierare** textruta Skriv en URL som: `https://sso.cordium.com`

4. Kontrollera **visa avancerade inställningar för URL: en** och utför följande steg om du vill konfigurera programmet i **SP** initierade läge:

    ![URL: er och kompatibilitet Tomtenisse domän enkel inloggning](./media/complianceelf-tutorial/tutorial_complianceelf_url1.png)
...
6. Klicka på **spara** knappen.
    ...
    ![Konfigurera enkel inloggning spara](./media/complianceelf-tutorial/tutorial_general_400.png)
...
2. Välj i listan med program **kompatibilitet Tomtenisse**.
    ...
    ![Länken kompatibilitet Tomtenisse i listan med program](./media/complianceelf-tutorial/tutorial_complianceelf_app.png)  
