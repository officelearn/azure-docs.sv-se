...
När du klickar på Compliance ELF-ikonen i åtkomstpanelen bör du loggas in automatiskt på den Compliance ELF som du har konfigurerat enkel inloggning för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
