---
title: 'Självstudiekurs: Azure Active Directory-integrering med Condeco | Microsoft-dokument'
...
---
# <a name="tutorial-azure-active-directory-integration-with-condeco"></a>Självstudiekurs: Azure Active Directory-integrering med Condeco
...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    Skriv en URL med hjälp av följande mönster i textrutan **Sign-on-URL:**`https://<companyname>.condecosoftware.com`
