...
5. I resultatpanelen väljer **Condeco**, och klicka sedan på **Lägg till** för att lägga till programmet.
...
3. **[Skapa en testanvändare Condeco](#creating-a-condeco-test-user)**  – du har en motsvarighet för Britta Simon i Condeco som är länkad till en Azure AD-representation av användaren.
...
6. Att konfigurera enkel inloggning på **Condeco** sida, som du behöver skicka de hämtade **XML-Metadata för** till [Condeco supportteamet](mailTo:supportna@condecosoftware.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
...
2. I listan med program väljer **Condeco**.
