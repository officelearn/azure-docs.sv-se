...
1. På den **Condeco domän och URL: er** avsnittet, utför följande steg:
    ...
    I textrutan **Inloggnings-URL** anger du en URL med följande mönster: `https://<companyname>.condecosoftware.com`
...
1. Att konfigurera enkel inloggning på **Condeco** sida, som du behöver skicka de hämtade **XML-Metadata för** till [Condeco supportteamet](mailTo:supportna@condecosoftware.com). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
...
Det finns inget åtgärdsobjekt för dig i det här avsnittet. En ny användare har skapats under ett försök att komma åt Condeco om det inte finns ännu.
