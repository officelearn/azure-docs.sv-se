...
När du klickar på Consent2Go-panelen i åtkomstpanelen ska du automatiskt loggas in på det Consent2Go du konfigurerade enkel inloggning för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
