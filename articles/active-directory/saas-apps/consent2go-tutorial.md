---
title: 'Självstudiekurs: Azure Active Directory-integrering med Consent2Go | Microsoft-dokument'
...
---
# <a name="tutorial-azure-active-directory-integration-with-consent2go"></a>Självstudiekurs: Azure Active Directory-integrering med Consent2Go
...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    Skriv en URL i textrutan **Sign-on-URL:**`https://www.mcbschools.com/Login`
