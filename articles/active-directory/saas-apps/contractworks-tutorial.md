...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/contractworks-tutorial/tutorial_contractworks_samlbase.png)
...
3. På den **ContractWorks domän och URL: er** avsnittet, utför följande steg om du vill konfigurera programmet i **IDP** initierade läge:
    ...
    ![URL: er och ContractWorks domän med enkel inloggning information](./media/contractworks-tutorial/tutorial_contractworks_url.png)

    I den **identifierare** textruta, ange ett URL-Adressen: `https://login.securedocs.com/saml/metadata`

4. Kontrollera **visa avancerade inställningar för URL: en** och utför följande steg om du vill konfigurera programmet i **SP** initierade läge:

    ![URL: er och ContractWorks domän med enkel inloggning information](./media/contractworks-tutorial/tutorial_contractworks_url1.png)
...
8. Klicka på **spara** knappen.
    ...
    ![Konfigurera enkel inloggning spara](./media/contractworks-tutorial/tutorial_general_400.png)
