...
2. **[Konfigurera Control SSO](#configure-control-sso)** – om du vill konfigurera enskilda Sign-On inställningar på program sidan.
...
När du väljer kontroll panelen på åtkomst panelen, bör du loggas in automatiskt på den kontroll som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
