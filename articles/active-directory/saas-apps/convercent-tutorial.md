...
I det här avsnittet skapar du en användare med namnet Britta Simon i Convercent. Arbeta med [Convercent support team](http://support.convercent.com/) för att lägga till användare i Convercent-plattformen. Användare måste skapas och aktiveras innan du använder enkel inloggning.

### <a name="test-single-sign-on"></a>Testa enkel inloggning 

I det här avsnittet testar du konfigurationen för enkel inloggning Azure AD med hjälp av åtkomstpanelen.

När du klickar på Convercent-panelen i åtkomstpanelen bör du automatiskt loggas in på Convercent som du har konfigurerat enkel inloggning för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
