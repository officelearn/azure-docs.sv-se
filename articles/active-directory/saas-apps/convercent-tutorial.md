---
title: 'Självstudiekurs: Azure Active Directory-integrering med Convercent | Microsoft-dokument'
...
---
# <a name="tutorial-azure-active-directory-integration-with-convercent"></a>Självstudiekurs: Azure Active Directory-integrering med Convercent
...
5. Klicka på **Ange ytterligare URL:er** och utför följande steg om du vill konfigurera programmet i **SP**-initierat läge:
    ...
    a. Skriv en URL med hjälp av följande mönster i textrutan **Sign-on-URL:**`https://<instancename>.convercent.com/`
