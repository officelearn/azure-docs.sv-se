...
2. **[Konfigurera Corptax enkel inloggning](#configure-corptax-single-sign-on)** – om du vill konfigurera de enskilda Sign-On inställningarna på program sidan.
...
I rutan **miljö** skriver du lämplig miljö, du bör logga in automatiskt på den Corptax som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
