...
1. På den **CS stjärnor domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I textrutan **Inloggnings-URL** anger du en URL med följande mönster: `https://<subdomain>.csstars.com/enterprise/default.cmdx?ssoclient=<uniqueid>`

    b. I textrutan **Identifierare** anger du en URL med följande mönster: `https://<subdomain>.csstars.com/enterprise/`

    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med faktisk inloggnings-URL och identifierare. Kontakta [CS stjärnor klienten supportteamet](https://www.marshclearsight.com/support/) att hämta dessa värden. 
