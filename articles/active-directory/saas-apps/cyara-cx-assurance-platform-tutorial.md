...
När du klickar på panelen cyara CX Assurance Platform på åtkomst panelen, bör du loggas in automatiskt på den cyara CX-plattform som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
...
- [Så här skyddar du cyara CX Assurance-plattformen med avancerad synlighet och kontroller](/cloud-app-security/proxy-intro-aad)