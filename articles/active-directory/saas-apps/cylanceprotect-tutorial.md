---
title: 'Självstudie: Azure Active Directory integrering med CylancePROTECT | Microsoft Docs'
...
ms.locfileid: "73159245"
---
# <a name="tutorial-azure-active-directory-integration-with-cylanceprotect"></a>Självstudie: Azure Active Directory integrering med CylancePROTECT
...
När du klickar på CylancePROTECT-panelen i åtkomstpanelen bör du automatiskt loggas in på CylancePROTECT som du har konfigurerat enkel inloggning för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
