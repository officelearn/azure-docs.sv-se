...
3. **[Skapa en testanvändare DATABASICS](#create-a-databasics-test-user)**  – du har en motsvarighet för Britta Simon i DATABASICS som är länkad till en Azure AD-representation av användaren.
...
2. I listan med program väljer **DATABASICS**.
