...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/dealpath-tutorial/tutorial_dealpath_samlbase.png)

3. På den **Dealpath domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och Dealpath domän med enkel inloggning information](./media/dealpath-tutorial/tutorial_dealpath_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **certifikat (Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/dealpath-tutorial/tutorial_dealpath_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/dealpath-tutorial/tutorial_general_400.png)
