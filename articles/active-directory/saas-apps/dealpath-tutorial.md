---
title: 'Självstudiekurs: Azure Active Directory-integrering med Dealpath | Microsoft-dokument'
...
---
# <a name="tutorial-azure-active-directory-integration-with-dealpath"></a>Självstudiekurs: Azure Active Directory-integrering med Dealpath
...
3. På sidan **Konfigurera SAML 2.0-autentisering** utför du följande steg:
    ...
    b. Klistra in värdet för **Azure Ad Identifier**i textrutan **för identitetsproviderutfärdare** , som du har kopierat från Azure-portalen.
