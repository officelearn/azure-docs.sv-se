...
1. På den **Degreed domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I textrutan **Inloggnings-URL** anger du en URL med följande mönster: `https://degreed.com/?orgsso=<company code>`

    b. I textrutan **Identifierare** anger du en URL med följande mönster: `https://degreed.com/<instancename>`

    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med faktisk inloggnings-URL och identifierare. Kontakta [Degreed klienten supportteamet](mailTo:admin@degreed.com) att hämta dessa värden. 
...
1. Att konfigurera enkel inloggning på **Degreed** sida, som du behöver skicka de hämtade **XML-Metadata för** till [Degreed supportteamet](mailTo:admin@degreed.com). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
...
Det finns inget åtgärdsobjekt för dig i det här avsnittet. En ny användare har skapats under ett försök att komma åt Degreed om det inte finns ännu.
