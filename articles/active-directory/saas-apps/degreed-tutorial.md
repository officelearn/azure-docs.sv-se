...
5. I resultatpanelen väljer **Degreed**, och klicka sedan på **Lägg till** för att lägga till programmet.
...
3. **[Skapa en Degreed testanvändare](#creating-a-degreed-test-user)**  – du har en motsvarighet för Britta Simon i Degreed som är länkad till en Azure AD-representation av användaren.
...
6. Att konfigurera enkel inloggning på **Degreed** sida, som du behöver skicka de hämtade **XML-Metadata för** till [Degreed supportteamet](mailTo:admin@degreed.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
...
2. I listan med program väljer **Degreed**.
