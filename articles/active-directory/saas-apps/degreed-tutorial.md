...
För att konfigurera enkel inloggning på **Degreed**-sidan behöver du skicka nedladdad **federationsmetadata-XML** och lämpliga kopierade URL:er från Azure-portalen till [supportteamet för Degreed](mailto:admin@degreed.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
