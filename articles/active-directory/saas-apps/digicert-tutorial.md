...
1. Att konfigurera enkel inloggning på **DigiCert** sida, som du behöver skicka de hämtade **XML-Metadata för** till [DigiCert-supportteamet](mailto:support@digicert.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
