...
* Du kan aktivera användarna att vara registrerat i automatiskt dirigera (Single Sign-On) med sina Azure AD-konton.
...
* Direct enkel inloggning aktiverat prenumeration

## <a name="scenario-description"></a>Scenariobeskrivning

I den här självstudien konfigurerar och testar du enkel inloggning med Azure AD i en testmiljö.

* dirigera stöder **SP** och **IDP** -initierad SSO
...
4. I sökrutan skriver **direkt**väljer **direkt** resultatet panelen klickar **Lägg till** för att lägga till programmet.

     ![direkt i resultatlistan](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurera och testa enkel inloggning med Azure AD

I det här avsnittet ska du konfigurera och testa Azure AD enkel inloggning med direct baserat på en testanvändare kallas **Britta Simon**.
För enkel inloggning att fungera, en länk-relation mellan en Azure AD-användare och relaterade användaren direkt krävs ska upprättas.
...
2. **[Konfigurera direkt enkel inloggning](#configure-direct-single-sign-on)**  – om du vill konfigurera inställningar för enkel inloggning på programsidan.
3. **[Skapa en Azure AD-testanvändare](#create-an-azure-ad-test-user)** – för att testa enkel inloggning med Azure AD med Britta Simon.
4. **[Tilldela Azure AD-testanvändaren](#assign-the-azure-ad-test-user)** – så att Britta Simon kan använda enkel inloggning med Azure AD.
5. **[Skapa direkt testanvändare](#create-direct-test-user)**  – du har en motsvarighet för Britta Simon i direct som är länkad till en Azure AD-representation av användaren.
...
1. I den [Azure-portalen](https://portal.azure.com/)på den **direkt** application integration markerar **enkel inloggning**.
...
4. På den **SAML grundkonfiguration** om du vill konfigurera programmet i **IDP** initierade läge, utföra följande steg:
    ...
    ![enkel inloggning information direkt domän och URL: er](common/idp-identifier.png)
...
5. Klicka på **Ange ytterligare URL:er** och gör följande om du vill konfigurera appen i **SP**-initierat läge:
    ...
    I rutan **Inloggnings-URL** anger du en URL: `https://direct4b.com/sso`
...
7. På den **konfigurera direct** avsnittet, kopiera den lämpliga URL: er enligt dina behov.
...
Att konfigurera enkel inloggning på **direkt** sida, som du behöver skicka de hämtade **XML-Metadata för Federation** och lämpliga kopierade URL: er från Azure portal för att [direct-support-teamet](https://direct4b.com/ja/support.html#inquiry). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
...
1. I Azure-portalen väljer du **företagsprogram**väljer **alla program**och välj sedan **direkt**.

    ![Bladet Företagsprogram](common/enterprise-applications.png)

2. I listan med program väljer **direkt**.

    ![Direktlänk i programlistan](common/all-applications.png)
...
### <a name="create-direct-test-user"></a>Skapa direkt testanvändare
...
När du klickar på panelen direkt i åtkomstpanelen bör du vara automatiskt inloggad på katalogen som du ställer in enkel inloggning. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
