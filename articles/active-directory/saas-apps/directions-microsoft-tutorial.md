---
title: 'Självstudie: Azure Active Directory integrering med vägbeskrivningar på Microsoft | Microsoft Docs'
...
ms.locfileid: "73158411"
---
# <a name="tutorial-azure-active-directory-integration-with-directions-on-microsoft"></a>Självstudie: Azure Active Directory integrering med vägbeskrivningar på Microsoft
...
När du klickar på Directions on Microsoft-panelen på åtkomstpanelen bör du loggas in automatiskt i Directions on Microsoft som du konfigurerar enkel inloggning för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
