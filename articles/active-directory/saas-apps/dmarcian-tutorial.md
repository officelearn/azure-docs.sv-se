...
2. **[Konfigurera DMARCIAN SSO](#configure-dmarcian-sso)** – om du vill konfigurera inställningar för enskilda Sign-On på program sidan.
...
När du klickar på dmarcian-panelen i åtkomstpanelen bör du automatiskt loggas in på dmarcian som du har konfigurerat enkel inloggning för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
