...
---
# <a name="tutorial-integrate-dmarcian-with-azure-active-directory"></a>Självstudier: Integrera dmarcian med Azure Active Directory
...
* dmarcian stöder **SP-och IDP** -INITIERAd SSO
