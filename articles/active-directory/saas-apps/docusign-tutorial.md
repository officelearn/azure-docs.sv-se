...
10. Följ dessa steg på sidan **Inställningar för identitetsprovider** :
    ...
    i. Välj det fält som du vill mappa till Azure AD-anspråket. I det här exemplet mappas **EmailAddress** -anspråket till värdet för `http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress`. Det är standard anspråks namnet från Azure AD för e-postanspråket. Välj **Spara**.
