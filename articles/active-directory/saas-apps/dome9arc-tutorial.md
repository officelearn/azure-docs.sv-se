...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/dome9arc-tutorial/tutorial_dome9arc_samlbase.png)
...
3. På den **Dome9 båge domän och URL: er** avsnittet, utför följande steg om du vill konfigurera programmet i **IDP** initierade läge:
    ...
    ![URL: er och Dome9 båge domän med enkel inloggning information](./media/dome9arc-tutorial/tutorial_dome9arc_url.png)
...
4. Kontrollera **visa avancerade inställningar för URL: en** och utför följande steg om du vill konfigurera programmet i **SP** initierade läge:
    ...
    ![URL: er och Dome9 båge domän med enkel inloggning information](./media/dome9arc-tutorial/tutorial_dome9arc_url1.png)
...
6. I den **användarattribut** avsnitt på den **enkel inloggning** dialogrutan Konfigurera attribut för SAML-token som visas i bilden ovan och utför följande steg:
    ...
    ![Konfigurera enkel inloggning lägga till attb](./media/dome9arc-tutorial/tutorial_dome9_04.png)
...
7. På den **SAML-signeringscertifikat** klickar du på **Certificate(Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/dome9arc-tutorial/tutorial_dome9arc_certificate.png) 

8. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/dome9arc-tutorial/tutorial_general_400.png)
