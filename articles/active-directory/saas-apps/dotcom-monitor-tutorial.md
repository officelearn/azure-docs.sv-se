...
1. **[Konfigurera Dotcom Monitor SSO](#configure-dotcom-monitor-sso)** – för att konfigurera inställningarna för enkel inloggning på program sidan.
    * **[Skapa Dotcom Monitor test User](#create-dotcom-monitor-test-user)** -om du vill ha en motsvarighet till B. Simon i Dotcom-Monitor som är länkad till Azure AD-representation av användare.
...
1. I [Azure Portal](https://portal.azure.com/)på sidan **Dotcom-Monitor-** program integration letar du upp avsnittet **Hantera** och väljer **enkel inloggning**.
...
1. Utöver ovan förväntar sig Dotcom-Monitor-programmet att fler attribut skickas tillbaka i SAML-svar som visas nedan. Dessa attribut är också förifyllda, men du kan granska dem enligt dina krav.
    ...
    > [!NOTE]
    > Det finns mer vägledning [här](../develop/active-directory-enterprise-app-role-management.md) om hur du skapar anpassade roller i Azure AD.
...
När du klickar på panelen Dotcom-Monitor på åtkomst panelen, bör du loggas in automatiskt på den Dotcom-Monitor som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
