---
title: 'Självstudiekurs: Azure Active Directory single sign-on (SSO) integration med Dovetale | Microsoft-dokument'
...
ms.locfileid: "76260675"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-dovetale"></a>Självstudiekurs: Azure Active Directory-integrering med enkel inloggning (SSO) med Dovetale
...
* Gör att användarna automatiskt loggas in på Dovetale med sina Azure AD-konton.
...
* Dovetale enkel inloggning (SSO) aktiverad prenumeration.
...
1. Skriv **Dovetale** i sökrutan i avsnittet **Lägg till från galleriet.**
1. Välj **Dovetale** från resultatpanelen och lägg sedan till appen. Vänta några sekunder medan appen läggs till i din klientorganisation.


## <a name="configure-and-test-azure-ad-single-sign-on-for-dovetale"></a>Konfigurera och testa en azure AD-inloggning för Dovetale

Konfigurera och testa Azure AD SSO med Dovetale med en testanvändare som heter **B.Simon**. För att SSO ska fungera måste du upprätta en länkrelation mellan en Azure AD-användare och den relaterade användaren i Dovetale.

Så här konfigurerar och testar du Azure AD SSO med Dovetale:

1. **[Konfigurera Azure AD SSO](#configure-azure-ad-sso)** – så att användarna kan använda den här funktionen.
    1. **[Skapa en Azure AD-testanvändare](#create-an-azure-ad-test-user)** – för att testa azure AD-enkel inloggning med B.Simon.
    1. **[Tilldela Azure AD-testanvändaren](#assign-the-azure-ad-test-user)** - så att B.Simon kan använda azure AD-enkel inloggning.
1. **[Konfigurera Dovetale SSO](#configure-dovetale-sso)** - för att konfigurera de enskilda inloggningsinställningarna på programsidan.
    1. **[Skapa Dovetale-testanvändare](#create-dovetale-test-user)** – om du vill ha en motsvarighet till B.Simon i Dovetale som är länkad till Azure AD-representationen av användaren.
...
1. Klicka på **Ange ytterligare URL:er** och gör följande om du vill konfigurera appen i **SP**-initierat läge:
    ...
    Skriv en URL med hjälp av följande mönster i textrutan **Sign-on-URL:**`<COMPANYNAME>.dovetale.com`
...
1. Dovetale-programmet förväntar sig SAML-påståenden i ett visst format, vilket kräver att du lägger till anpassade attributmappningar i konfigurationen av SAML-tokenattribut. I följande skärmbild visas listan över standardattribut.

    ![image](common/edit-attribute.png)

1. Förutom ovan förväntar sig Dovetale ansökan få fler attribut som skall skickas tillbaka i SAML svar som visas nedan. Dessa attribut är också förifyllda men du kan granska dem enligt dina krav.
...
I det här avsnittet aktiverar du B.Simon att använda Azure enkel inloggning genom att bevilja åtkomst till Dovetale.
