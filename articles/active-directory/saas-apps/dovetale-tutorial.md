...
* Dovetale stöder **SP-och IDP** -INITIERAd SSO
...
1. Klicka på **Ange ytterligare URL:er** och gör följande om du vill konfigurera appen i **SP**-initierat läge:
    ...
    I textrutan **Inloggnings-URL** skriver du en URL med följande mönster: `<COMPANYNAME>.dovetale.com`
...
I det här avsnittet skapas en användare som heter Britta Simon i Dovetale. Dovetale stöder just-in-Time-etablering, som är aktiverat som standard. Det finns inget åtgärdsobjekt för dig i det här avsnittet. Om det inte redan finns någon användare i Dovetale skapas en ny efter autentisering.
