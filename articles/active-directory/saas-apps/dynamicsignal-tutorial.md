---
title: 'Självstudiekurs: Azure Active Directory-integrering med dynamisk signal | Microsoft-dokument'
...
ms.locfileid: "73158376"
---
# <a name="tutorial-azure-active-directory-integration-with-dynamic-signal"></a>Självstudiekurs: Azure Active Directory-integrering med dynamisk signal
...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    a. Skriv en URL med hjälp av följande mönster i textrutan **Sign-on-URL:**`https://<subdomain>.voicestorm.com`

    b. Skriv en URL med följande mönster i rutan **Identifierare:**`https://<subdomain>.voicestorm.com`

    c. Skriv en URL med följande mönster i textrutan **Svara URL:**`https://<subdomain>.voicestorm.com/User/SsoResponse`
