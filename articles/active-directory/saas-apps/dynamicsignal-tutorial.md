...
När du klickar på Dynamic Signal-ikonen på åtkomstpanelen bör du automatiskt loggas in i den Dynamic Signal som du har konfigurerat enkel inloggning till. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
