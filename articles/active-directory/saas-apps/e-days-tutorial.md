...
## <a name="configure-and-test-azure-ad-single-sign-on-for-e-days"></a>Konfigurera och testa enkel inloggning i Azure AD för E-dagar
...
Om du vill konfigurera och testa Azure AD SSO med E-dagar slutför du följande Bygg stenar:
...
1. På sidan för **E-dagars** program integration i [Azure Portal](https://portal.azure.com/)går du till sidan **Hantera** och väljer **enkel inloggning**.
...
1. Klicka på **Ange ytterligare URL:er** och gör följande om du vill konfigurera appen i **SP**-initierat läge:
    ...
    > [!NOTE]
    > Dessa värden är inte verkliga. Uppdatera värdena med den faktiska identifieraren, svars-URL och inloggnings-URL. Kontakta [support teamet för E-dagar](https://support.e-days.com) för att hämta dessa värden. Du kan även se de mönster som visas i avsnittet **Grundläggande SAML-konfiguration** i Azure-portalen.
...
När du klickar på panelen E-dagar på åtkomst panelen, bör du loggas in automatiskt på de E-dagar som du ställer in SSO för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
...
- [Försök med E-dagar med Azure AD](https://aad.portal.azure.com/)
