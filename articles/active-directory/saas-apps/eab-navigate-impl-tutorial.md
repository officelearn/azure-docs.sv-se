...
När du klickar på panelen EAB navigera implementering på åtkomst panelen, bör du loggas in automatiskt till EAB navigera implementering som du ställer in SSO för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
