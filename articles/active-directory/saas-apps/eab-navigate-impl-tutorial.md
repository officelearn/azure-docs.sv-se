...
När du klickar på panelen EAB navigera implementering på åtkomst panelen, bör du loggas in automatiskt till EAB navigera implementering som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
