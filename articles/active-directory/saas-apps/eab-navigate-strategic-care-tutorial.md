---
title: 'Självstudier: Azure Active Directory enkel inloggning (SSO) med EAB navigera i strategisk vård | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-eab-navigate-strategic-care"></a>Självstudier: Azure Active Directory enkel inloggning (SSO) med EAB navigera i strategiska vård
...
1. I avsnittet **grundläggande SAML-konfiguration** anger du värden för följande fält:
    ...
    I textrutan **Inloggnings-URL** skriver du in en URL med följande mönster: `https://<CUSTOMERURL>.eab.com`
...
Om du vill konfigurera enkel inloggning på **EAB navigera i strategiska vårds** sidan måste du skicka **URL: en för appens Federations-metadata** till [EAB navigera i strategiska vård support teamet](mailto:tech@gradesfirst.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
