...
1. Klicka på **Ange ytterligare URL:er** och gör följande om du vill konfigurera appen i **SP**-initierat läge:
    ...
    > [!NOTE]
    > Dessa värden är inte verkliga. Uppdatera värdena med den faktiska identifieraren, svars-URL och inloggnings-URL. Kontakta [EasySSO för BitBucket-klientens support team](mailto:support@techtime.co.nz) för att hämta dessa värden. Du kan även se mönstren som visas i avsnittet **Grundläggande SAML-konfiguration** i Azure-portalen.
...
1. Logga in på EasySSO för BitBucket-instansen med administratörs behörighet och gå till avsnittet **Hantera appar** .

    ![Hantera appar](./media/easysso-for-bitbucket-tutorial/jira-admin-1.png)

1. Klicka på **EasySSO**.

    ![Enkel inloggning](./media/easysso-for-bitbucket-tutorial/jira-admin-2.png)
...
1. För bästa test upplevelse går du till fliken **titta & känsla** och markerar knappen för **SAML-inloggning** på. Detta aktiverar separat knapp på JIRA-inloggnings skärmen för att testa att Azure AD SAML-integration slutar till slutet. Du kan lämna den här knappen och konfigurera dess placering, färg och översättning för produktions läget.
    ...
    ![Titta & känsla](./media/easysso-for-bitbucket-tutorial/jira-admin-5.png)
...
I det här avsnittet skapas en användare som heter B. Simon i EasySSO för BitBucket. EasySSO för BitBucket har stöd för just-in-Time User-etablering, som är **inaktive rad** som standard. Om du vill aktivera användar etablering måste du markera kryss rutan **skapa användare på ett lyckat inloggnings** alternativ i avsnittet Allmänt i konfiguration av EasySSO-plugin-programmet. Om en användare inte redan finns i EasySSO för BitBucket skapas en ny efter autentiseringen.

Men om du inte vill aktivera automatisk användar etablering för användaren första inloggningen måste användarna finnas i backend-användargrupper EasySSO för BitBucket-instansen använder, t. ex. LDAP eller Atlassiane full.

![Användaretablering](./media/easysso-for-bitbucket-tutorial/jira-admin-6.png)

## <a name="test-sso"></a>Testa SSO

I det här avsnittet testar du konfigurationen för enkel inloggning Azure AD med hjälp av åtkomstpanelen.

När du klickar på panelen EasySSO för BitBucket på åtkomst panelen, bör du loggas in automatiskt på EasySSO för BitBucket som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
