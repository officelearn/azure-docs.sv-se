...
1. Logga in på Atlassian Confluence-instansen med administratörs behörighet och navigera till avsnittet **Hantera appar** . 
...
När du klickar på panelen EasySSO för confluence på åtkomst panelen, bör du loggas in automatiskt på Confluence-instansen som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
...
- [Så här skyddar du EasySSO för Confluence med avancerad synlighet och kontroller](/cloud-app-security/proxy-intro-aad)