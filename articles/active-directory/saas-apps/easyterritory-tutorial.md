---
title: 'Självstudiekurs: Azure Active Directory-integrering med EasyTerritory | Microsoft-dokument'
...
ms.locfileid: "73158405"
---
# <a name="tutorial-azure-active-directory-integration-with-easyterritory"></a>Självstudiekurs: Azure Active Directory-integrering med EasyTerritory
...
4. Om du vill konfigurera programmet i **IDP-initierat** läge i avsnittet **Grundläggande SAML-konfiguration** gör du följande:
    ...
    a. Skriv en URL med följande mönster i textrutan **Identifierare:**`https://apps.easyterritory.com/<tenant id>/dev/`

    b. Skriv en URL med följande mönster i textrutan **Svara URL:**`https://apps.easyterritory.com/<tenant id>/dev/authservices/acs`
...
5. Klicka på **Ange ytterligare URL:er** och gör följande om du vill konfigurera appen i **SP**-initierat läge:
    ...
    Skriv en URL med hjälp av följande mönster i textrutan **Sign-on-URL:**`https://<company name>.easyterritory.com/`
