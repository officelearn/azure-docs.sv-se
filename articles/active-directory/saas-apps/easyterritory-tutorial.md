...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/easyterritory-tutorial/tutorial_easyterritory_samlbase.png)
...
3. På den **EasyTerritory domän och URL: er** avsnittet, utför följande steg om du vill konfigurera programmet i IDP initierade läge:
    ...
    ![URL: er och EasyTerritory domän med enkel inloggning information](./media/easyterritory-tutorial/tutorial_easyterritory_url.png)
...
4. Kontrollera **visa avancerade inställningar för URL: en** och utför följande steg om du vill konfigurera programmet i **SP** initierade läge:
    ...
    ![URL: er och EasyTerritory domän med enkel inloggning information](./media/easyterritory-tutorial/tutorial_easyterritory_url1.png)
...
5. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/easyterritory-tutorial/tutorial_easyterritory_certificate.png) 

6. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/easyterritory-tutorial/tutorial_general_400.png)
