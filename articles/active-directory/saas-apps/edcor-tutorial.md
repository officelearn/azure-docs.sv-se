...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/edcor-tutorial/tutorial_edcor_samlbase.png)

3. På den **Edcor domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och Edcor domän med enkel inloggning information](./media/edcor-tutorial/tutorial_edcor_url1.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/edcor-tutorial/tutorial_edcor_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/edcor-tutorial/tutorial_general_400.png)
