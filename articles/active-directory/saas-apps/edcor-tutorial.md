...
För att konfigurera enkel inloggning på **Edcor**-sidan behöver du skicka nedladdad **federationsmetadata-XML** och lämpliga kopierade URL:er från Azure-portalen till [supportteamet för Edcor](https://www.edcor.com/contact-us/). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
