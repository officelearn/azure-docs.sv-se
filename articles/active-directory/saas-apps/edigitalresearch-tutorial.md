...
ms.date: 07/20/2017
ms.author: jeedes
ms.openlocfilehash: f838e26fcef6a72b87084212b28b8467a6b64e46
ms.sourcegitcommit: c851842d113a7078c378d78d94fea8ff5948c337
ms.translationtype: MT
ms.contentlocale: sv-SE
ms.lasthandoff: 06/18/2018
ms.locfileid: "35968039"
---
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/edigitalresearch-tutorial/tutorial_edigitalresearch_samlbase.png)

3. På den **eDigitalResearch domän och URL: er** avsnittet, utför följande steg:

    ![eDigitalResearch domän URL: er och enkel inloggning information](./media/edigitalresearch-tutorial/tutorial_edigitalresearch_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **certifikat Base(64)** och spara certifikatfilen på datorn.
    ...
    !![Länken hämta certifikatet](./media/edigitalresearch-tutorial/tutorial_edigitalresearch_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/edigitalresearch-tutorial/tutorial_general_400.png)
