...
* När du har konfigurerat edX för Business SAML-integration kan du framtvinga kontroll av sessioner, vilket skyddar exfiltrering och intrånget för organisationens känsliga data i real tid. Kontroll av sessionen sträcker sig från villkorlig åtkomst. [Lär dig hur du tvingar fram en session med Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-any-app).
...
## <a name="configure-and-test-azure-ad-sso-for-edx-for-business-saml-integration"></a>Konfigurera och testa Azure AD SSO för edX för företag SAML-integration
...
När du klickar på panelen för SAML-integrering i edX i åtkomst panelen, bör du loggas in automatiskt på den edX for Business SAML-integration som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
...
- [Skydda edX för företag SAML-integration med avancerad synlighet och kontroller](/cloud-app-security/proxy-intro-aad)