...
4. I sökrutan skriver **EFI digitala butik**väljer **EFI digitala butik** resultatet panelen klickar **Lägg till** för att lägga till programmet.
...
3. **[Skapa en testanvändare EFI digitala butik](#create-a-efi-digital-storefront-test-user)**  – du har en motsvarighet för Britta Simon i EFI digitala butik som är länkad till en Azure AD-representation av användaren.
...
3. På den **EFI digitala butik domän och URL: er** avsnittet, utför följande steg:
...
6. Att konfigurera enkel inloggning på **EFI digitala butik** sida, som du behöver skicka de hämtade **XML-Metadata för** till [EFI digitala butik supportteamet](http://www.efi.com/products/productivity-software/ecommerce-web-to-print/efi-digital-storefront/support/). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
...
2. I listan med program väljer **EFI digitala butik**.
