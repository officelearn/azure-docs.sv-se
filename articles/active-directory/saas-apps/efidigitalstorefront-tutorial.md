...
4. I sökrutan skriver **EFI digitala StoreFront**väljer **EFI digitala StoreFront** resultatet-panelen klickar **Lägg till** för att lägga till programmet.
    ...
    ![EFI digitala StoreFront i resultatlistan](./media/efidigitalstorefront-tutorial/tutorial_efidigital_addfromgallery.png)
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/efidigitalstorefront-tutorial/tutorial_efidigital_samlbase.png)

3. På den **EFI digitala StoreFront domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och EFI digitala StoreFront domän med enkel inloggning information](./media/efidigitalstorefront-tutorial/tutorial_efidigital_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/efidigitalstorefront-tutorial/tutorial_efidigital_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/efidigitalstorefront-tutorial/tutorial_general_400.png)
...
2. Välj i listan med program **EFI digitala StoreFront**.
    ...
    ![Länken EFI digitala StoreFront i listan med program](./media/efidigitalstorefront-tutorial/tutorial_efidigital_app.png)  
