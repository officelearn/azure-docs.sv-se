...
ms.date: 06/18/2017
ms.author: jeedes
ms.openlocfilehash: 0ea212677872ceba7e7c6d74d3db03ba10346a45
...
4. I sökrutan skriver **Egnyte**.
    ...
    ![Skapa en testanvändare i Azure AD](./media/egnyte-tutorial/tutorial_egnyte_search.png)

5. Välj i resultatpanelen **Egnyte**, och klicka sedan på **Lägg till** för att lägga till programmet.

    ![Skapa en testanvändare i Azure AD](./media/egnyte-tutorial/tutorial_egnyte_addfromgallery.png)
...
11. I den **autentisering för enkel inloggning** avsnittet, utför följande steg:
    ...
    ![Enkel inloggning för autentisering](./media/egnyte-tutorial/ic787822.png "enkel inloggning för autentisering")   
...
1. I den **Azure-portalen**, klicka på det vänstra navigeringsfönstret **Azure Active Directory** ikon.
    ...
    ![Skapa en testanvändare i Azure AD](./media/egnyte-tutorial/create_aaduser_01.png) 

2. Om du vill visa en lista över användare, gå till **användare och grupper** och på **alla användare**.
    
    ![Skapa en testanvändare i Azure AD](./media/egnyte-tutorial/create_aaduser_02.png) 

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i dialogrutan.
 
    ![Skapa en testanvändare i Azure AD](./media/egnyte-tutorial/create_aaduser_03.png) 

4. På den **användaren** dialogrutan utför följande steg:
 
    ![Skapa en testanvändare i Azure AD](./media/egnyte-tutorial/create_aaduser_04.png) 
...
4. I den **nya standardanvändare** avsnittet, utför följande steg:
   ...
   ![Nya standardanvändare](./media/egnyte-tutorial/ic787825.png "ny vanlig användare")   
