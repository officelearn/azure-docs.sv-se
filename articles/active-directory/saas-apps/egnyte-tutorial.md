...
5. I resultatpanelen väljer **Egnyte**, och klicka sedan på **Lägg till** för att lägga till programmet.
...
6. På den **Egnyte Configuration** klickar du på **konfigurera Egnyte** att öppna **konfigurera inloggning** fönster. Kopiera den **SAML entitets-ID och SAML enkel inloggning för tjänst-URL** från den **Snabbreferens avsnittet.**
...
4. I den **ny standardanvändare** avsnittet, utför följande steg:
