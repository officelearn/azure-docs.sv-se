...
1. Klicka på **Bjud in användare** på vänster sida-menyn och klicka på **Bjud in en enskild användare** för att lägga till användaren.
    ...
    ![Skärm bild som visar sidan "Bjud in användare" med knappen Bjud in en enskild användare vald.](./media/egress-tutorial/create-user-1.PNG)
...
När du klickar på panelen utgående på åtkomst panelen, bör du loggas in automatiskt på den utgående filen som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
...
- [Skydda utgångs funktioner med avancerad synlighet och kontroller](/cloud-app-security/proxy-intro-aad)