...
För att konfigurera enkel inloggning på **eKincare**-sidan måste du skicka den nedladdade **XML:en med federationsmetadata** och lämpliga kopierade URL:er från Azure-portalen till [eKincare-supportteamet](mailto:tech@ekincare.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
