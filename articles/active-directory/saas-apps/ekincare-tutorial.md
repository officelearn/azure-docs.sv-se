...
1. Att konfigurera enkel inloggning på **eKincare** sida, som du behöver skicka de hämtade **XML-Metadata för** till [eKincare supportteamet](mailto:tech@ekincare.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
