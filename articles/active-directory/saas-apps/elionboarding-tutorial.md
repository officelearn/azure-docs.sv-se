...
3. **[Skapa en testanvändare Eli Onboarding](#create-an-eli-onboarding-test-user)**  – du har en motsvarighet för Britta Simon i Eli Onboarding som är länkad till en Azure AD-representation av användaren.
...
6. Att konfigurera enkel inloggning på **Eli Onboarding** sida, som du behöver skicka de hämtade **XML-Metadata för** till [Eli Onboarding-supporten](mailto:support@geteli.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
...
2. I listan med program väljer **Eli Onboarding**.
