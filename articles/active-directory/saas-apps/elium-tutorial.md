...
3. **[Skapa en testanvändare Elium](#create-an-elium-test-user)**  – du har en motsvarighet för Britta Simon i Elium som är länkad till en Azure AD-representation av användaren.
...
7. I ett annat webbläsarfönster logga du in på webbplatsen Elium företag som administratör.
...
2. I listan med program väljer **Elium**.
