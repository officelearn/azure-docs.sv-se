...
När du klickar på Elqano SSO-panelen på åtkomst panelen, bör du loggas in automatiskt på Elqano SSO som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
...
- [Skydda Elqano SSO med avancerad synlighet och kontroller](/cloud-app-security/proxy-intro-aad)