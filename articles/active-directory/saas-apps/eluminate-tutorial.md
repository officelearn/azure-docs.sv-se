...
När du klickar på eLuminate-panelen i åtkomstpanelen så borde du automatiskt loggas in på den eLuminate som du har konfigurerat enkel inloggning för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
