...
1. På den **omfattar domän och URL: er** avsnittet, utför följande steg:
    ...
    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska identifierare och svars-URL. Kontakta [Encompass supportteamet](https://www.voxmobile.com/contact/) att hämta dessa värden.
...
1. Att konfigurera enkel inloggning på **Encompass** sida, som du behöver skicka de hämtade **Certificate(Base64), URL: en för utloggning och SAML enkel inloggning för tjänst-URL** till [Encompass supportteamet](https://www.voxmobile.com/contact/). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
