---
title: 'Självstudier: Azure Active Directory-integration med Encompass | Microsoft Docs'
...
ms.locfileid: "39047288"
---
# <a name="tutorial-azure-active-directory-integration-with-encompass"></a>Självstudier: Azure Active Directory-integration med Encompass
...
3. **[Skapa en testanvändare Encompass](#create-a-encompass-test-user)**  – du har en motsvarighet för Britta Simon i Encompass som är länkad till en Azure AD-representation av användaren.
...
3. På den **omfattar domän och URL: er** avsnittet, utför följande steg:
    ...
    b. I den **svars-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<subdomain>.voxmobile.com/voxportal/ws/saml/consume`

    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska identifierare och svars-URL. Kontakta [Encompass supportteamet](http://www.voxmobile.com/contact/) att hämta dessa värden.

4. På den **SAML-signeringscertifikat** klickar du på **Certificate(Base64)** och spara certifikatfilen på datorn.

    ![Länk för hämtning av certifikat](./media/encompass-tutorial/tutorial_encompass_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara-knapp](./media/encompass-tutorial/tutorial_general_400.png)

6. På den **omfattar konfiguration** klickar du på **konfigurera omfattar** att öppna **konfigurera inloggning** fönster. Kopiera den **URL: en för utloggning och SAML enkel inloggning för tjänst-URL** från den **Snabbreferens avsnittet.**

    ![Omfatta konfiguration](./media/encompass-tutorial/tutorial_encompass_configure.png) 

7. Att konfigurera enkel inloggning på **Encompass** sida, som du behöver skicka de hämtade **Certificate(Base64), URL: en för utloggning och SAML enkel inloggning för tjänst-URL** till [Encompass supportteamet](http://www.voxmobile.com/contact/). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
...
2. I listan med program väljer **Encompass**.
