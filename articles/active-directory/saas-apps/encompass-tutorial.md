...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/encompass-tutorial/tutorial_encompass_samlbase.png)

3. På den **omfattar domän och URL: er** avsnittet, utför följande steg:

    ![Omfatta domän URL: er och enkel inloggning information](./media/encompass-tutorial/tutorial_encompass_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **Certificate(Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/encompass-tutorial/tutorial_encompass_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/encompass-tutorial/tutorial_general_400.png)
