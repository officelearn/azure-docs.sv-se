...
1. Att konfigurera enkel inloggning på **Encompass** sida, som du behöver skicka de hämtade **Certificate(Base64), URL: en för utloggning och SAML enkel inloggning för tjänst-URL** till [Encompass supportteamet](http://www.voxmobile.com/contact/). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
