...
4. I avsnittet **Grundläggande SAML-konfiguration**, om du vill konfigurera appen i **IDP**-initierat läge, gör du följande:
    ...
    a. I textrutan **Identifierare** skriver du en URL med följande mönster: `https://www.<CUSTOMER DOMAIN>.com/Account`
...
5. Klicka på **Ange ytterligare URL:er** och gör följande om du vill konfigurera appen i **SP**-initierat läge:
    ...
    I textrutan **Inloggnings-URL** skriver du in en URL med följande mönster: `https://www.<CUSTOMER DOMAIN>.com/Account`
...
4. I avsnittet **Lägg till användare** utför du följande steg:
    ...
    a. I textrutan **Användarnamn** skriver du användarnamnet för kontot Britta Simon: **brittasimon@contoso.com**.
    ...
    e. I textrutan **E-postadress** anger du e-postadressen för Britta Simon-kontot: **brittasimon@contoso.com**.

    f. I textrutan **SSO User Name** (Användarnamn för enkel inloggning) skriver du användarnamnet för Britta Simon-kontot: **brittasimon@contoso.com**.
