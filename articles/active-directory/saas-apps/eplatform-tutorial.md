...
Att konfigurera enkel inloggning på **ePlatform** sida, som du behöver skicka den **tumavtrycksvärde** och lämpliga kopierade URL: er från Azure portal för att [ePlatform supportteamet](https://help.eplatform.co/hc/en-us). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
