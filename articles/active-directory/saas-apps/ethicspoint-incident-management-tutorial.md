---
title: 'Självstudiekurs: Azure Active Directory-integrering med ETHICSPoint Incident Management (EPIM) | Microsoft-dokument'
...
ms.locfileid: "73157154"
---
# <a name="tutorial-azure-active-directory-integration-with-ethicspoint-incident-management-epim"></a>Självstudiekurs: Azure Active Directory-integrering med EthicsPoint Incident Management (EPIM)
...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    b. Skriv en URL med följande mönster i rutan **Identifierare:**`https://<companyname>.navexglobal.com/adfs/services/trust`

    c. Skriv en URL med följande mönster i textrutan **Svara URL:**`https://<servername>.navexglobal.com/adfs/ls/`
