...
När du klickar på EthicsPoint Incident Management (EPIM)-panelen på åtkomstpanelen bör du automatiskt loggas in i EthicsPoint Incident Management (EPIM) som du har konfigurerat enkel inloggning för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
