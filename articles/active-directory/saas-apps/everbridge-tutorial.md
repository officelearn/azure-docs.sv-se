...
- En EverBridge enkel inloggning aktiverad prenumeration
...
1. I sökrutan skriver **EverBridge**.

    ![Skapa en Azure AD-användare för testning](./media/everbridge-tutorial/tutorial_everbridge_search.png)

1. I resultatpanelen väljer **EverBridge**, och klicka sedan på **Lägg till** för att lägga till programmet.

    ![Skapa en Azure AD-användare för testning](./media/everbridge-tutorial/tutorial_everbridge_addfromgallery.png)
...
I EverBridge, tilldela värdet för den **användarnamn** i Azure AD som värde för den **användarnamn** att upprätta länken-relation.
...
1. **[Skapa en testanvändare EverBridge](#creating-an-everbridge-test-user)**  – du har en motsvarighet för Britta Simon i EverBridge som är länkad till en Azure AD-representation av användaren.
...
1. På den **enkel inloggning** dialogrutan **läge** som **SAML-baserad inloggning** att aktivera enkel inloggning.
    ...
    ![Konfigurera enkel inloggning](./media/everbridge-tutorial/tutorial_everbridge_samlbase.png)

1. På den **EverBridge domän och URL: er** avsnittet, utför följande steg:

    ![Konfigurera enkel inloggning](./media/everbridge-tutorial/tutorial_everbridge_url.png)

    a. I den **identifierare** textrutan anger du ett URL med hjälp av följande mönster: `https://sso.everbridge.net/<companyname>`

    b. I den **svars-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://manager.everbridge.net/saml/SSO/<companyname>/alias/defaultAlias`
...
1. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.
    ...
    ![Konfigurera enkel inloggning](./media/everbridge-tutorial/tutorial_everbridge_certificate.png) 

1. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning](./media/everbridge-tutorial/tutorial_general_400.png)

1. På den **EverBridge Configuration** klickar du på **konfigurera EverBridge** att öppna **konfigurera inloggning** fönster. Kopiera den **SAML enkel inloggning för tjänst-URL** från den **Snabbreferens avsnittet.**

    ![Konfigurera enkel inloggning](./media/everbridge-tutorial/tutorial_everbridge_configure.png) 

1. För att få SSO konfigurerats för ditt program kan behöva du inloggning till din Everbridge-klient som administratör.

1. Klicka på menyn längst upp i **inställningar** fliken och markera **enkel inloggning** under **Security**.
    ...
    e. I den **inloggnings-URL för identitetsprovider** textrutan klistra in värdet för SAML SSO-URL från Azure AD.
   
    ![Konfigurera enkel inloggning](./media/everbridge-tutorial/tutorial_everbridge_003.png)
...
1. I den **Azure-portalen**, i det vänstra navigeringsfönstret klickar du på **Azure Active Directory** ikon.
    ...
    ![Skapa en Azure AD-användare för testning](./media/everbridge-tutorial/create_aaduser_01.png) 

1. Om du vill visa en lista över användare, gå till **användare och grupper** och klicka på **alla användare**.
    
    ![Skapa en Azure AD-användare för testning](./media/everbridge-tutorial/create_aaduser_02.png) 

1. Öppna den **användaren** dialogrutan klickar du på **Lägg till** överst i dialogrutan.
 
    ![Skapa en Azure AD-användare för testning](./media/everbridge-tutorial/create_aaduser_03.png) 

1. På den **användaren** dialogrutan utför följande steg:
 
    ![Skapa en Azure AD-användare för testning](./media/everbridge-tutorial/create_aaduser_04.png) 
...
**Om du vill tilldela Britta Simon EverBridge, utför du följande steg:**

1. Öppna vyn program i Azure-portalen och gå till vyn directory och gå till **företagsprogram** klickar **alla program**.

    ![Tilldela användare][201] 

1. I listan med program väljer **EverBridge**.
