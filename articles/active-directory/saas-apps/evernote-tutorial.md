---
title: 'Självstudier: Azure Active Directory-integration med Evernote | Microsoft Docs'
...
ms.locfileid: "39442640"
---
# <a name="tutorial-azure-active-directory-integration-with-evernote"></a>Självstudier: Azure Active Directory-integration med Evernote
...
1. På den **SAML-signeringscertifikat** klickar du på **Certificate(Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länk för hämtning av certifikat](./media/evernote-tutorial/tutorial_evernote_certificate.png) 

1. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara-knapp](./media/evernote-tutorial/tutorial_general_400.png)
