...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/evidence-tutorial/tutorial_evidence.com_samlbase.png)

3. På den **Evidence.com domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och evidence.com domän med enkel inloggning information](./media/evidence-tutorial/tutorial_evidence.com_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **Certificate(Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/evidence-tutorial/tutorial_evidence.com_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/evidence-tutorial/tutorial_general_400.png)
