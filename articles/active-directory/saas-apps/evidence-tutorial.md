...
---
# <a name="tutorial-azure-active-directory-integration-with-evidencecom"></a>Självstudie: Azure Active Directory integrering med Evidence.com
...
När du klickar på Evidence.com-panelen på åtkomstpanelen bör du automatiskt loggas in i Evidence.com som du har konfigurerat enkel inloggning för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
