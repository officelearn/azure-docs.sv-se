---
title: 'Självstudiekurs: Azure Active Directory-integrering med påminnelse om förfallodatum | Microsoft-dokument'
...
ms.locfileid: "73158183"
---
# <a name="tutorial-azure-active-directory-integration-with-expiration-reminder"></a>Självstudiekurs: Azure Active Directory-integrering med påminnelse om förfallodatum
...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    Skriv en URL i textrutan **Sign-on-URL:**`https://app.expirationreminder.net/account/sso`
