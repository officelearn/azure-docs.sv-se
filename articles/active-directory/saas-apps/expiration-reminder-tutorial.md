---
title: 'Självstudie: Azure Active Directory-integrering med Expiration Reminder | Microsoft Docs'
...
För att konfigurera enkel inloggning på **Expiration Reminder**-sidan behöver du skicka det nedladdade **certifikatet (RAW)** och lämpliga kopierade URL:er från Azure-portalen till [Expiration Reminder-supporten](mailto:support@expirationreminder.net). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
