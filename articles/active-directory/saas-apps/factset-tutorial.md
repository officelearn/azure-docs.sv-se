...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/factset-tutorial/tutorial_factset_samlbase.png)

3. På den **FactSet domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och FactSet domän med enkel inloggning information](./media/factset-tutorial/tutorial_factset_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/factset-tutorial/tutorial_factset_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/factset-tutorial/tutorial_general_400.png)
