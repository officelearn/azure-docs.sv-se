...
När du klickar på FactSet-panelen i åtkomstpanelen bör du automatiskt loggas in på FactSet som du har konfigurerat enkel inloggning för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
...
- [Så här skyddar du FactSet med avancerad synlighet och kontroller](/cloud-app-security/proxy-intro-aad)