...
När du klickar på den snabba kant-moln panelen i åtkomst panelen, bör du loggas in automatiskt på det snabba yttre molnet för vilket du ställer in SSO. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
