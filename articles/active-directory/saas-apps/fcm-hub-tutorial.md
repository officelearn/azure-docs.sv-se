...
När du klickar på panelen FCM HUB på åtkomst panelen, bör du loggas in automatiskt till FCM-HUBBen som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
...
- [Så här skyddar du FCM-HUBBen med avancerad synlighet och kontroller](/cloud-app-security/proxy-intro-aad)