...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/fidelitynetbenefits-tutorial/tutorial_fidelitynetbenefits_samlbase.png)

3. På den **återgivning NetBenefits domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och återgivning NetBenefits domän med enkel inloggning information](./media/fidelitynetbenefits-tutorial/tutorial_fidelitynetbenefits_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/fidelitynetbenefits-tutorial/tutorial_fidelitynetbenefits_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/fidelitynetbenefits-tutorial/tutorial_general_400.png)
