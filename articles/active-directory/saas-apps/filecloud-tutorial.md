---
title: 'Självstudiekurs: Azure Active Directory-integrering med FileCloud | Microsoft-dokument'
...
---
# <a name="tutorial-azure-active-directory-integration-with-filecloud"></a>Självstudiekurs: Azure Active Directory-integrering med FileCloud
