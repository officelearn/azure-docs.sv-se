---
title: 'Självstudiekurs: Azure Active Directory-integrering med FilesAnywhere | Microsoft-dokument'
...
ms.locfileid: "73158210"
---
# <a name="tutorial-azure-active-directory-integration-with-filesanywhere"></a>Självstudiekurs: Azure Active Directory-integrering med FilerEntär
...
4. Om du vill konfigurera appen i **IDP**-initierat läge gör du följande i avsnittet **Grundläggande SAML-konfiguration**:
    ...
    Skriv en URL med följande mönster i textrutan **Svara URL:**`https://<company name>.filesanywhere.com/saml20.aspx?c=<Client Id>`

5. Klicka på **Ange ytterligare URL:er** och gör följande om du vill konfigurera appen i **SP**-initierat läge:

    ![FilesAnywhere-domän och information om URL:er för enkel inloggning](common/both-signonurl.png)

    Skriv en URL med hjälp av följande mönster i textrutan **Sign-on-URL:**`https://<sub domain>.filesanywhere.com/`
