---
title: 'Självstudier: Konfigurera flock för automatisk användar etablering med Azure Active Directory | Microsoft Docs'
...
ms.locfileid: "70804709"
---
# <a name="tutorial-configure-flock-for-automatic-user-provisioning"></a>Självstudier: Konfigurera flock för automatisk användar etablering
