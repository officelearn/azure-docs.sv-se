...
Att konfigurera enkel inloggning på **FloQast** sida, som du behöver skicka de hämtade **XML-Metadata för Federation** och lämpliga kopierade URL: er från Azure portal för att [FloQast supportteamet](mailto:support@floqast.com). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
