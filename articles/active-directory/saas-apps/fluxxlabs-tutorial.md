...
När du klickar på panelen Fluxx Labs på åtkomst panelen, bör du loggas in automatiskt på de Fluxx-labb som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
...
- [Så här skyddar du Fluxx Labs med avancerad synlighet och kontroller](/cloud-app-security/proxy-intro-aad)