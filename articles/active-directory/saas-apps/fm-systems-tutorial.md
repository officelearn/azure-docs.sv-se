...
1. Att konfigurera enkel inloggning på **FM:Systems** sida, som du behöver skicka de hämtade **XML-Metadata för** till [FM:Systems supportteamet](https://fmsystems.com/ask-us/). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna. Du får ett meddelande när enkel inloggning har aktiverats för din prenumeration.
