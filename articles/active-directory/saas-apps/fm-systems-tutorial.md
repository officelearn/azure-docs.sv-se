...
2. **[Konfigurera fm: system enkel inloggning](#configure-fmsystems-single-sign-on)** – konfigurera de enskilda Sign-On inställningarna på program sidan.
...
### <a name="configure-fmsystems-single-sign-on"></a>Konfigurera FM: system Single Sign-On
...
När du klickar på panelen FM: system på åtkomst panelen bör du loggas in automatiskt på FM: system som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
