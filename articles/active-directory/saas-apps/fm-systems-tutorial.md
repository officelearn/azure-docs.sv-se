...
2. Gå till **system Administration \> hantera säkerhets \> användare \> användar lista**.
...
När du klickar på panelen FM: system på åtkomst panelen bör du loggas in automatiskt på FM: system som du ställer in SSO för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
