---
title: 'Självstudier: Azure Active Directory-integration med Form.com | Microsoft Docs'
...
ms.locfileid: "39053060"
---
# <a name="tutorial-azure-active-directory-integration-with-formcom"></a>Självstudier: Azure Active Directory-integration med Form.com
...
3. **[Skapa en testanvändare Form.com](#create-a-formcom-test-user)**  – du har en motsvarighet för Britta Simon i Form.com som är länkad till en Azure AD-representation av användaren.
...
3. På den **Form.com domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<subdomain>.wa-form.com`
...
5. Klicka på **spara** knappen.
    ...
    ![Konfigurera enkel inloggning spara-knapp](./media/formcom-tutorial/tutorial_general_400.png)

6. På den **Form.com Configuration** klickar du på **konfigurera Form.com** att öppna **konfigurera inloggning** fönster. Kopiera den **SAML enkel inloggning för tjänst-URL** från den **Snabbreferens avsnittet.**

    ![Form.com konfiguration](./media/formcom-tutorial/tutorial_form.com_configure.png) 

7. Att konfigurera enkel inloggning på **Form.com** sida, som du behöver skicka de hämtade **certifikat (Base64)**, **Appfederationsmetadata**, och **SAML Enkel inloggning för tjänst-URL** till [Form.com supportteamet](https://form.com/about/company/contact-us/). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
...
2. I listan med program väljer **Form.com**.
