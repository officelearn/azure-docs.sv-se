...
I kursen får lära du att integrera Form.com med Azure Active Directory (AD Azure).

Integrera Form.com med Azure AD ger dig följande fördelar:

- Du kan styra i Azure AD som har åtkomst till Form.com.
- Du kan aktivera användarna att automatiskt hämta loggat in på Form.com (Single Sign-On) med sina Azure AD-konton.
...
- En Form.com enkel inloggning aktiverad prenumeration
...
Du måste lägga till Form.com från galleriet i listan över hanterade SaaS-appar för att konfigurera integrering av Form.com i Azure AD.
...
4. I sökrutan skriver **Form.com**väljer **Form.com** resultatet-panelen klickar **Lägg till** för att lägga till programmet.

    ![Form.com i resultatlistan](./media/formcom-tutorial/tutorial_form.com_addfromgallery.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurera och testa Azure AD enkel inloggning

I det här avsnittet kan du konfigurera och testa Azure AD enkel inloggning med Form.com baserat på en testanvändare som kallas ”Britta Simon”.

Azure AD måste du känna till användaren i Form.com motsvarighet till en användare i Azure AD för enkel inloggning ska fungera. Med andra ord måste en länk förhållandet mellan en Azure AD-användare och relaterade användaren i Form.com upprättas.

I Form.com, tilldela värdet för den **användarnamn** i Azure AD som värde för den **användarnamn** etablera länken relationen.
...
3. **[Skapa en testanvändare Form.com](#create-a-formcom-test-user)**  – du har en motsvarighet för Britta Simon i Form.com som är kopplad till Azure AD-representation av användaren.
...
1. I Azure-portalen på den **Form.com** integreringssidan för programmet, klickar du på **enkel inloggning**.

    ![Konfigurera enkel inloggning länk][4]

2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.

    ![Enkel inloggning dialogrutan](./media/formcom-tutorial/tutorial_form.com_samlbase.png)

3. På den **Form.com domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och form.com domän med enkel inloggning information](./media/formcom-tutorial/tutorial_form.com_url.png)
...
5. Klicka på **spara** knappen.
    ...
    ![Konfigurera enkel inloggning spara](./media/formcom-tutorial/tutorial_general_400.png)
...
### <a name="create-a-formcom-test-user"></a>Skapa en testanvändare Form.com

Syftet med det här avsnittet är att skapa en användare som kallas Britta Simon i Form.com. Arbeta med [Form.com supportteamet](https://form.com/about/company/contact-us/) att lägga till användare i Form.com-konto.

### <a name="assign-the-azure-ad-test-user"></a>Tilldela Azure AD-testanvändare

I det här avsnittet kan du aktivera Britta Simon att använda Azure enkel inloggning genom att bevilja åtkomst till Form.com.

![Tilldela rollen][200] 

**Om du vill tilldela Form.com Britta Simon utför du följande steg:**

1. Öppna vyn program i Azure-portalen och gå till vyn directory och gå till **företagsprogram** Klicka **alla program**.

    ![Tilldela användare][201] 

2. Välj i listan med program **Form.com**.
...
När du klickar på panelen Form.com på åtkomstpanelen du bör få automatiskt loggat in på ditt Form.com program.
