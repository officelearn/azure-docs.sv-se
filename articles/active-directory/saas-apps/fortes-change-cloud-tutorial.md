...
* När du har konfigurerat Fortes ändra molnet kan du genomdriva session Control, som skyddar exfiltrering och intrånget för organisationens känsliga data i real tid. Kontroll av sessionen utökas från villkorlig åtkomst. [Lär dig hur du tvingar fram en session med Microsoft Cloud App Security](https://docs.microsoft.com/cloud-app-security/proxy-deployment-any-app).
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-fortes-change-cloud"></a>Konfigurera och testa enkel inloggning med Azure AD för Fortes Change Cloud
...
Om du vill konfigurera och testa Azure AD SSO med Fortes ändra molnet slutför du följande Bygg stenar:
...
1. På sidan för att **ändra Cloud** application integration i [Azure Portal](https://portal.azure.com/), letar du upp avsnittet **Hantera** och väljer **enkel inloggning på**Fortes.
...
1. I avsnittet **grundläggande SAML-konfiguration** , om du vill konfigurera programmet i **IDP** initierat läge, anger du värdena för följande fält:
    ...
    a. I text rutan **identifierare** anger du en URL med hjälp av följande mönster:`https://<identifier>.fortes-online.com`
...
1. Fortes Change Cloud Application förväntar sig SAML-intyg i ett särskilt format, vilket kräver att du lägger till anpassade mappningar av attribut i konfigurationen för SAML-token. Följande skärmbild visar en lista över standardattribut, där **nameidentifier** mappas med **user.userprincipalname**. Fortes Change Cloud Application förväntar sig att **NameIdentifier** mappas med **User. sAMAccountName**, så du måste redigera mappningen av attributet genom att klicka på ikonen **Redigera** och ändra attributet mappning.
...
När du klickar på panelen Fortes ändra moln på åtkomst panelen, bör du loggas in automatiskt på det Fortes ändrings moln som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Skydda Fortes ändra moln med avancerad synlighet och kontroller](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)
