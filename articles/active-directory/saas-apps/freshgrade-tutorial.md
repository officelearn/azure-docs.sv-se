---
title: 'Självstudier: Azure Active Directory-integration med FreshGrade | Microsoft Docs'
...
ms.locfileid: "39047169"
---
# <a name="tutorial-azure-active-directory-integration-with-freshgrade"></a>Självstudier: Azure Active Directory-integration med FreshGrade
...
5. I resultatpanelen väljer **FreshGrade**, och klicka sedan på **Lägg till** för att lägga till programmet.
...
3. **[Skapa en testanvändare FreshGrade](#creating-a-freshgrade-test-user)**  – du har en motsvarighet för Britta Simon i FreshGrade som är länkad till en Azure AD-representation av användaren.
...
3. På den **FreshGrade domän och URL: er** avsnittet, utför följande steg:
    ...
    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska inloggnings-URL och identifierare. Kontakta [FreshGrade klienten supportteamet](mailTo:support@freshgrade.com) att hämta dessa värden.
...
6. På den **FreshGrade Configuration** klickar du på **konfigurera FreshGrade** att öppna **konfigurera inloggning** fönster. Kopiera den **SAML enkel inloggning för tjänst-URL** från den **Snabbreferens avsnittet.**

    ![Konfigurera enkel inloggning](./media/freshgrade-tutorial/tutorial_freshgrade_configure.png)

7. Att konfigurera enkel inloggning på **FreshGrade** sida, som du behöver skicka den **Appfederationsmetadata** och **SAML enkel inloggning för tjänst-URL** till [ FreshGrade supportteamet](mailTo:support@freshgrade.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
...
2. I listan med program väljer **FreshGrade**.
