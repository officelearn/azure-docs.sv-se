...
1. Att konfigurera enkel inloggning på **FreshGrade** sida, som du behöver skicka den **Appfederationsmetadata** och **SAML enkel inloggning för tjänst-URL** till [ FreshGrade supportteamet](mailTo:support@freshgrade.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
