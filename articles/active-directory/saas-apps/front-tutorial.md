...
4. I sökrutan skriver **främre**väljer **främre** resultatet-panelen klickar **Lägg till** för att lägga till programmet.
    ...
    ![Framför i resultatlistan](./media/front-tutorial/tutorial_front_addfromgallery.png)
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/front-tutorial/tutorial_front_samlbase.png)
