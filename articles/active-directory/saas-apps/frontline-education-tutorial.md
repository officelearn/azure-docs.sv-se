...
2. **[Konfigurera Frontline Education SSO](#configure-frontline-education-sso)** – för att konfigurera enskilda Sign-On inställningar på program sidan.
...
När du klickar på panelen Frontline utbildning på åtkomst panelen, bör du loggas in automatiskt på den Frontline-utbildning som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
