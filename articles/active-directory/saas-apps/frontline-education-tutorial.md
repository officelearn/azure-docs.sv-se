---
title: 'Självstudier: Azure Active Directory-integrering med Frontline-utbildning | Microsoft Docs'
...
---
# <a name="tutorial-integrate-frontline-education-with-azure-active-directory"></a>Självstudier: Integrera Frontline-utbildning med Azure Active Directory
...
1. I avsnittet **grundläggande SAML-konfiguration** anger du värden för följande fält:
    ...
    I textrutan **Inloggnings-URL** anger du en URL enligt följande mönster: `https://login.frontlineeducation.com/sso/<CLIENTID>`
...
Om du vill konfigurera enkel inloggning på **Frontline-utbildnings** sidan måste du skicka **URL: en** för appens Federations-metadata till [Frontline Education support team](mailto:support@frontlineed.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
