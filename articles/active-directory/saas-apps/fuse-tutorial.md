---
title: 'Självstudie: Azure Active Directory integration med säkring | Microsoft Docs'
...
ms.locfileid: "92450415"
---
# <a name="tutorial-azure-active-directory-integration-with-fuse"></a>Självstudie: Azure Active Directory integrering med säkring
...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    I text rutan **inloggnings-URL** skriver du en URL med följande mönster:  `https://{tenantname}.fuseuniversal.com/`
...
I det här avsnittet skapar du en användare med namnet Britta Simon i Fuse. Arbeta med [säkrings support teamet](mailto:support@fusion-universal.com) för att lägga till användare på den säkra plattformen. Användare måste skapas och aktiveras innan du använder enkel inloggning.

### <a name="test-single-sign-on"></a>Testa enkel inloggning 

I det här avsnittet testar du konfigurationen för enkel inloggning Azure AD med hjälp av åtkomstpanelen.

När du klickar på Fuse-panelen i åtkomstpanelen bör du automatiskt loggas in på Fuse som du har konfigurerat enkel inloggning för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
