---
title: 'Självstudiekurs: Azure Active Directory-integrering med säkring | Microsoft-dokument'
...
---
# <a name="tutorial-azure-active-directory-integration-with-fuse"></a>Självstudiekurs: Azure Active Directory-integrering med säkring
...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    Skriv en URL med hjälp av följande mönster i textrutan **Sign-on-URL:**`https://{tenantname}.fuseuniversal.com/`
