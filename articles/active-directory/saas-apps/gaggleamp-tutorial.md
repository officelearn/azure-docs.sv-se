---
title: 'Självstudier: Azure Active Directory-integration med GaggleAMP | Microsoft Docs'
...
ms.locfileid: "39436520"
---
# <a name="tutorial-azure-active-directory-integration-with-gaggleamp"></a>Självstudier: Azure Active Directory-integration med GaggleAMP
...
1. Kontrollera **visa avancerade URL-inställningar** och utföra följande steg om du vill konfigurera programmet i **SP** initierade läge:
    ...
    ![Konfigurera enkel inloggning](./media/gaggleamp-tutorial/tutorial_gaggleamp_url1.png)
     ...
     I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://gaggleamp.com/i/<customerid>`

    > [!NOTE]
    > Inloggnings-URL-värdet är inte verkliga. Uppdatera det här värdet med faktiska inloggnings-URL: en. Kontakta [GaggleAMP klienten supportteamet](mailto:sales@gaggleamp.com) att hämta det här värdet.
...
Det finns inga uppgift åt dig i det här avsnittet. En ny användare har skapats under ett försök att komma åt GaggleAMP om det inte finns ännu. 
