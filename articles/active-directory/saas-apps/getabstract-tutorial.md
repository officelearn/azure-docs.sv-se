...
1. Att konfigurera enkel inloggning på **Getabstract** sida, som du behöver skicka de hämtade **XML-Metadata för** till [Getabstract supportteamet](https://www.getabstract.com/en/contact). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
