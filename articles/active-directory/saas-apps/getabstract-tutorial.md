...
4. I avsnittet **grundläggande SAML-konfiguration** , om du vill konfigurera programmet i **IDP** initierat läge, utför följande steg:
    ...
    ![Skärm bild som visar avsnittet "Basic S A M L-konfiguration" med "ID" och "svars-URL" markerat och knappen "Spara" är markerad.](common/idp-intiated.png)
...
När du klickar på Getabstract-panelen i åtkomstpanelen bör du automatiskt loggas in på Getabstract som du har konfigurerat enkel inloggning för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
