---
title: 'Självstudie: Azure Active Directory integrering med GlobalOne | Microsoft Docs'
...
---
# <a name="tutorial-integrate-globalone-with-azure-active-directory"></a>Självstudie: integrera GlobalOne med Azure Active Directory
...
Om du vill konfigurera enkel inloggning på **GlobalOne** sida måste du skicka det hämtade **certifikatet (RAW)** och lämpliga kopierade url: er från Azure Portal till [support teamet för GlobalOne](mailto:globalone.support@ey.com). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
