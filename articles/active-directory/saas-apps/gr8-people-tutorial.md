...
När du klickar på panelen gr8 personer på åtkomst panelen, bör du loggas in automatiskt på de gr8-användare som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
...
- [Så här skyddar du gr8-personer med avancerad synlighet och kontroller](/cloud-app-security/proxy-intro-aad)