...
När du klickar på Gra-Pe-panelen i åtkomstpanelen så borde du automatiskt loggas in på den Gra-Pe som du har konfigurerat enkel inloggning för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
