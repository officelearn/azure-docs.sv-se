---
title: 'Självstudiekurs: Azure Active Directory-integrering med Gra-Pe | Microsoft-dokument'
...
---
# <a name="tutorial-azure-active-directory-integration-with-gra-pe"></a>Självstudiekurs: Azure Active Directory-integrering med Gra-Pe
...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    Skriv en URL i textrutan **Sign-on-URL:**`https://btm.tts.co.jp/portal/apl/SSOLogin.aspx`
