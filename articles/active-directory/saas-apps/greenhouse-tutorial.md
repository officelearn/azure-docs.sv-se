---
title: 'Självstudiekurs: Azure Active Directory-integrering med Greenhouse | Microsoft-dokument'
...
---
# <a name="tutorial-azure-active-directory-integration-with-greenhouse"></a>Självstudiekurs: Azure Active Directory-integrering med Greenhouse
...
>[!NOTE]
>Du kan använda andra verktyg för att skapa växthusanvändarkonton eller API:er som tillhandahålls av Greenhouse för att etablera Azure AD-användarkonton. 
