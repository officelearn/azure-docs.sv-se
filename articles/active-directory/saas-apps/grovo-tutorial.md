...
ms.date: 01/12/2018
ms.author: jeedes
ms.openlocfilehash: 59cb7bedb5873fad57c8e2cd927e549e0ab94550
ms.sourcegitcommit: c851842d113a7078c378d78d94fea8ff5948c337
ms.translationtype: MT
ms.contentlocale: sv-SE
ms.lasthandoff: 06/18/2018
ms.locfileid: "35968144"
---
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/grovo-tutorial/tutorial_grovo_samlbase.png)

3. På den **Grovo domän och URL: er** avsnittet, utför följande steg om du vill konfigurera programmet i **IDP** initierade läge:

    ![URL: er och Grovo domän med enkel inloggning information](./media/grovo-tutorial/tutorial_grovo_url.png)
...
4. Kontrollera **visa avancerade inställningar för URL: en**, utföra följande steg:
    ...
    ![URL: er och Grovo domän med enkel inloggning information](./media/grovo-tutorial/tutorial_grovo_url1.png)
    ...
    ![URL: er och Grovo domän med enkel inloggning information](./media/grovo-tutorial/tutorial_grovo_url2.png)
...
6. I den **användarattribut** avsnitt på den **enkel inloggning** dialogrutan Konfigurera attribut för SAML-token som visas i bilden och utför följande steg:
    ...
    ![Konfigurera enkel inloggning Lägg till](./media/grovo-tutorial/tutorial_attribute_04.png)
...
7. På den **SAML-signeringscertifikat** klickar du på **Certificate(Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/grovo-tutorial/tutorial_grovo_certificate.png) 

8. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/grovo-tutorial/tutorial_general_400.png)
