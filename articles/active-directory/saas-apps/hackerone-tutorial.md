---
title: 'Självstudier: Azure Active Directory-integration med Hackerone | Microsoft Docs'
...
ms.locfileid: "39441841"
---
# <a name="tutorial-azure-active-directory-integration-with-hackerone"></a>Självstudier: Azure Active Directory-integration med HackerOne
...
1. På den **HackerOne Single inloggnings-URL och identifierare** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://hackerone.com/<company name>/authentication`
...
1. På den **SAML-inställningar** dialogrutan utför följande steg:
    ...
    b. I **inloggning på URL för enkel** textrutor, klistra in värdet för **SAML inloggnings-tjänst-URL för enkel** som du har kopierat från Azure-portalen.
...
Det finns inga uppgift åt dig i det här avsnittet. När du har åtkomst till HackerOne skapas en ny användare om den inte finns.
