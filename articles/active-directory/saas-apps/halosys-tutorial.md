...
3. **[Skapa en testanvändare Halosys](#create-a-halosys-test-user)**  – du har en motsvarighet för Britta Simon i Halosys som är länkad till en Azure AD-representation av användaren.
...
3. På den **Halosys domän och URL: er** avsnittet, utför följande steg:
    ...
    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska identifierare och svars-URL. Kontakta [Halosys supportteam](http://halosys.com/halosys#contact) att hämta dessa värden.
...
6. På den **Halosys Configuration** klickar du på **konfigurera Halosys** att öppna **konfigurera inloggning** fönster. Kopiera den **SAML enkel inloggning för tjänst-URL** från den **Snabbreferens avsnittet.**

    ![Halosys konfiguration](./media/halosys-tutorial/tutorial_halosys_configure.png) 

7. Att konfigurera enkel inloggning på **Halosys** sida, som du behöver skicka de hämtade **XML-Metadata för** och **SAML enkel inloggning för tjänst-URL** till [Halosys stöd team](http://halosys.com/halosys#contact). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
...
2. I listan med program väljer **Halosys**.
