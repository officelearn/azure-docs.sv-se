...
När du klickar på panelen hälso stöd system på åtkomst panelen bör du loggas in automatiskt på det hälso tillstånds system som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
...
- [Så här skyddar du hälso support systemet med avancerad synlighet och kontroller](/cloud-app-security/proxy-intro-aad)