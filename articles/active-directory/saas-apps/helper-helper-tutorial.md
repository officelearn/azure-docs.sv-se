...
1. På sidan **Konfigurera en enskild Sign-On med SAML** , i avsnittet **SAML-signeringscertifikat** , klickar du på Kopiera för att kopiera **URL för metadata för app Federation** och sparar den i anteckningar.
...
När du väljer Hjälp panelen för hjälp i åtkomst panelen, bör du loggas in automatiskt till hjälp program hjälp för vilka du ställer in SSO. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
