---
title: 'Självstudiekurs: Azure Active Directory-integrering med HighGear | Microsoft-dokument'
...
---
# <a name="tutorial-azure-active-directory-integration-with-highgear"></a>Självstudiekurs: Azure Active Directory-integrering med HighGear
