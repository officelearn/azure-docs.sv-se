---
title: 'Självstudier: Azure Active Directory-integration med HireVue | Microsoft Docs'
...
ms.locfileid: "39433762"
---
# <a name="tutorial-azure-active-directory-integration-with-hirevue"></a>Självstudier: Azure Active Directory-integration med HireVue
...
1. På den **HireVue domän och URL: er** avsnittet, utför följande steg:
    ...
    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska inloggnings-URL och identifierare. Kontakta [HireVue klienten supportteamet](mailto:samlsupport@hirevue.com) att hämta dessa värden. 
...
1. Att konfigurera enkel inloggning på **HireVue** sida, som du behöver skicka de hämtade **Certificate(Base64)** och **URL för utloggning, SAML entitets-ID och SAML enkel inloggning för tjänst-URL**till [HireVue supportteamet](mailto:samlsupport@hirevue.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
