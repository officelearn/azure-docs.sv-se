---
title: 'Självstudier: Azure Active Directory-integration med Hornbill | Microsoft Docs'
...
ms.locfileid: "39164071"
---
# <a name="tutorial-azure-active-directory-integration-with-hornbill"></a>Självstudier: Azure Active Directory-integration med Hornbill
...
3. På den **Hornbill domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<SUBDOMAIN>.hornbill.com/<INSTANCE_NAME>/`

    b. I den **identifierare** textrutan anger du ett URL med hjälp av följande mönster: `https://<SUBDOMAIN>.hornbill.com/<INSTANCE_NAME>/lib/saml/auth/simplesaml/module.php/saml/sp/metadata.php/saml`

    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska inloggnings-URL och identifierare. Kontakta [Hornbill klienten supportteamet](https://www.hornbill.com/support/?request/) att hämta dessa värden. 
...
4. På den **SAML-signeringscertifikat** klickar du på kopieringsknappen för att kopiera **Appfederationsmetadata** och klistra in den i anteckningar.
    ...
    ![Länk för hämtning av certifikat](./media/hornbill-tutorial/tutorial_hornbill_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara-knapp](./media/hornbill-tutorial/tutorial_general_400.png)
