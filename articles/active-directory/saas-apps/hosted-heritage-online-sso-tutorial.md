---
title: 'Självstudier: Azure Active Directory enkel inloggning (SSO) med värd arvet online SSO | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-hosted-heritage-online-sso"></a>Självstudier: Azure Active Directory enkel inloggning (SSO) med värd arvet online SSO
...
Om du vill konfigurera enkel inloggning på **värd arvet online SSO** -sida måste du skicka **URL: en för appens Federations-metadata** till [värd arvet online SSO support team](mailto:support@isoxford.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
...
När du klickar på den värd arvs panelen online SSO på åtkomst panelen, bör du loggas in automatiskt på det värd arvet online SSO som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
