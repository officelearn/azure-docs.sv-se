---
title: 'Självstudiekurs: Azure Active Directory-integrering med värdad grafit | Microsoft-dokument'
...
---
# <a name="tutorial-azure-active-directory-integration-with-hosted-graphite"></a>Självstudiekurs: Azure Active Directory-integrering med värdad grafit
...
4. Om du vill konfigurera programmet i **IDP-initierat** läge i avsnittet **Grundläggande SAML-konfiguration** gör du följande:
    ...
    a. Skriv en URL med följande mönster i textrutan **Identifierare:**`https://www.hostedgraphite.com/metadata/<user id>`

    b. Skriv en URL med följande mönster i textrutan **Svara URL:**`https://www.hostedgraphite.com/complete/saml/<user id>`
...
5. Klicka på **Ange ytterligare URL:er** och gör följande om du vill konfigurera appen i **SP**-initierat läge:
    ...
    Skriv en URL med hjälp av följande mönster i textrutan **Sign-on-URL:**`https://www.hostedgraphite.com/login/saml/<user id>/`
