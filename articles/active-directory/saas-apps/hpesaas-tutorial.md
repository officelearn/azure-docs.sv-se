...
5. I resultatpanelen väljer **HPE SaaS**, och klicka sedan på **Lägg till** för att lägga till programmet.
...
3. **[Skapa en testanvändare HPE SaaS](#creating-an-hpe-saas-test-user)**  – du har en motsvarighet för Britta Simon i HPE SaaS som är länkad till en Azure AD-representation av användaren.
...
6. Att konfigurera enkel inloggning på **HPE SaaS** sida, som du behöver skicka de hämtade **XML-Metadata för** till [HPE SaaS supportteam](https://saas.hpe.com/en-us/contact). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
...
2. I listan med program väljer **HPE SaaS**.
