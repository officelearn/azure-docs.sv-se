...
1. I avsnittet **grundläggande SAML-konfiguration** anger du värden för följande fält:
    ...
    I textrutan **Inloggnings-URL** skriver du en URL med följande mönster: `https://login.hrworks.de/?companyId=<companyId>&directssologin=true`
...
1. Klicka på **administratör** > **grunderna** > **säkerhet** > **enkel inloggning på** den vänstra sidan av meny raden och utför följande steg:
