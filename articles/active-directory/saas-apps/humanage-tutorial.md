...
När du klickar på panelen för mänskligt i åtkomst panelen, bör du loggas in automatiskt till det humant för vilket du ställer in SSO. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
...
- [Skydda personal med avancerad synlighet och kontroller](/cloud-app-security/proxy-intro-aad)