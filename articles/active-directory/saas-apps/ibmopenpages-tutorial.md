---
title: 'Självstudiekurs: Azure Active Directory-integrering med IBM OpenPages | Microsoft-dokument'
...
---
# <a name="tutorial-azure-active-directory-integration-with-ibm-openpages"></a>Självstudiekurs: Azure Active Directory-integrering med IBM OpenPages
...
4. På sidan **Konfigurera enkel inloggning med SAML** utför du följande steg:
    ...
    a. Skriv en URL med följande mönster i textrutan **Identifierare:**`http://<subdomain>.ibm.com:<ID>/openpages`

    b. Skriv en URL med följande mönster i textrutan **Svara URL:**`https://<subdomain>.ibm.com:<ID>/samlsps/op`
