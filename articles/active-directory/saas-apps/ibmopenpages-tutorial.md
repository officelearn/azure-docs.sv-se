...
1. Att konfigurera enkel inloggning på **IBM OpenPages** sida, som du behöver skicka de hämtade **XML-Metadata för** till [IBM OpenPages supportteamet](https://www.ibm.com/support/home/). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
