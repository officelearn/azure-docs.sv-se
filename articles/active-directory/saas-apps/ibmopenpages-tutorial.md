---
title: 'Självstudier: Azure Active Directory-integration med IBM OpenPages | Microsoft Docs'
...
ms.locfileid: "39052653"
---
# <a name="tutorial-azure-active-directory-integration-with-ibm-openpages"></a>Självstudier: Azure Active Directory-integration med IBM OpenPages
...
3. **[Skapa en testanvändare för IBM OpenPages](#create-an-ibm-openpages-test-user)**  – du har en motsvarighet för Britta Simon i IBM OpenPages som är länkad till en Azure AD-representation av användaren.
...
3. På den **IBM OpenPages domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **identifierare** textrutan anger du ett URL med hjälp av följande mönster: `http://<subdomain>.ibm.com:<ID>/openpages`

    b. I den **svars-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<subdomain>.ibm.com:<ID>/samlsps/op`

    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska identifierare och svars-URL. Kontakta [IBM OpenPages klienten supportteamet](https://www.ibm.com/support/home/) att hämta dessa värden. 
...
5. Klicka på **spara** knappen.
    ...
    ![Konfigurera enkel inloggning spara-knapp](./media/ibmopenpages-tutorial/tutorial_general_400.png)

7. Att konfigurera enkel inloggning på **IBM OpenPages** sida, som du behöver skicka de hämtade **XML-Metadata för** till [IBM OpenPages supportteamet](https://www.ibm.com/support/home/). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
...
2. I listan med program väljer **IBM OpenPages**.
