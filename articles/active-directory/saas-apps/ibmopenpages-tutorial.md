---
title: 'Självstudier: Azure Active Directory-katalogintegrering med IBM OpenPages | Microsoft Docs'
...
För att konfigurera enkel inloggning på **IBM OpenPages**-sidan behöver du skicka nedladdad **federationsmetadata-XML** och lämpliga kopierade URL:er från Azure-portalen till [supportteamet för IBM OpenPages](https://www.ibm.com/support/home/). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
