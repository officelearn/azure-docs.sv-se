...
När du klickar på panelen Ice kontakt Center på åtkomst panelen, bör du loggas in automatiskt på det is-kontakt Center som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
...
- [Så här skyddar du Ice-kontakt Center med avancerad synlighet och kontroller](/cloud-app-security/proxy-intro-aad)