---
title: 'Självstudier: Azure Active Directory-integration med Icertis plattform för hantering av kontrakt | Microsoft Docs'
...
ms.locfileid: "39444992"
---
# <a name="tutorial-azure-active-directory-integration-with-icertis-contract-management-platform"></a>Självstudier: Azure Active Directory-integration med Icertis plattform för hantering av kontrakt
...
1. På den **Icertis kontrakt Hanteringsdomän plattform och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<company name>.icertis.com`

    b. I den **identifierare** textrutan anger du ett URL med hjälp av följande mönster: `https://<company name>.icertis.com`

    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska inloggnings-URL och identifierare. Kontakta [Icertis kontrakt plattform Hanteringsklient supportteamet](https://www.icertis.com/company/contact/) att hämta dessa värden. 
