...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/icims-tutorial/tutorial_icims_samlbase.png)

3. På den **ICIMS domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och ICIMS domän med enkel inloggning information](./media/icims-tutorial/tutorial_icims_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/icims-tutorial/tutorial_icims_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/icims-tutorial/tutorial_general_400.png)
