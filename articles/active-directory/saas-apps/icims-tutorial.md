---
title: 'Självstudier: Azure Active Directory-integration med ICIMS | Microsoft Docs'
...
ms.locfileid: "39431121"
---
# <a name="tutorial-azure-active-directory-integration-with-icims"></a>Självstudier: Azure Active Directory-integration med ICIMS
...
1. På den **ICIMS domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<tenant name>.icims.com`

    b. I den **identifierare** textrutan anger du ett URL med hjälp av följande mönster: `https://<tenant name>.icims.com`

    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska inloggnings-URL och identifierare. Kontakta [ICIMS klienten supportteamet](https://www.icims.com/contact-us) att hämta dessa värden. 
...
1. Klicka på **spara** knappen.
    ...
    ![Konfigurera enkel inloggning spara-knapp](./media/icims-tutorial/tutorial_general_400.png)
...
1. Att konfigurera enkel inloggning på **ICIMS** sida, som du behöver skicka de hämtade **XML-Metadata för**, **URL för utloggning, SAML entitets-ID och SAML enkel inloggning för tjänst-URL** till [ ICIMS supportteam](https://www.icims.com/contact-us). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
...
1. Om du vill visa en lista över användare, gå till **användare och grupper** och klicka på **alla användare**.
    ...
    ![”Användare och grupper” och ”alla användare”-länkar](./media/icims-tutorial/create_aaduser_02.png) 
