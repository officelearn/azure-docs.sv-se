---
title: 'Självstudier: Azure Active Directory-integration med IdeaScale | Microsoft Docs'
...
1. På den **IdeaScale domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<companyname>.ideascale.com`
