---
title: 'Självstudiekurs: Azure Active Directory-integrering med iDiD Manager | Microsoft-dokument'
...
ms.locfileid: "73155213"
---
# <a name="tutorial-azure-active-directory-integration-with-idid-manager"></a>Självstudiekurs: Azure Active Directory-integrering med iDiD Manager
...
5. Klicka på **Ange ytterligare URL:er** och gör följande om du vill konfigurera appen i **SP**-initierat läge:
    ...
    Skriv en URL med hjälp av följande mönster i textrutan **Sign-on-URL:**`https://idid2.fi/saml/login/<domain>`
