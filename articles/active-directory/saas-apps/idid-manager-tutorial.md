---
title: 'Självstudie: Azure Active Directory integrering med iDiD Manager | Microsoft Docs'
...
I det här avsnittet skapar du en användare med namnet Britta Simon i iDiD Manager. Arbeta med [support teamet för IDiD Manager](mailto:support@idid.fi) för att lägga till användarna i iDiD Manager-plattformen. Användare måste skapas och aktiveras innan du använder enkel inloggning.

### <a name="test-single-sign-on"></a>Testa enkel inloggning 

I det här avsnittet testar du konfigurationen för enkel inloggning Azure AD med hjälp av åtkomstpanelen.

När du klickar på iDiD Manager-panelen i åtkomstpanelen bör du automatiskt loggas in på iDiD Manager som du har konfigurerat enkel inloggning för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
