...
1. I sökrutan skriver **AVBILDNINGEN fungerar**väljer **AVBILDNINGEN fungerar** resultatet panelen klickar **Lägg till** för att lägga till programmet.
...
1. På den **AVBILDNINGEN fungerar domän och URL: er** avsnittet, utför följande steg:
...
1. I listan med program väljer **AVBILDNINGEN fungerar**.
