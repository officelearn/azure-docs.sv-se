...
2. **[Konfigurera enkel inloggning med enkel inloggning](#configure-imagineer-webvision-single-sign-on)** för att konfigurera enskilda Sign-On inställningar på program sidan.
...
### <a name="configure-imagineer-webvision-single-sign-on"></a>Konfigurera en enkel Sign-On
...
När du klickar på panelen för att skapa en välordnad skärm i åtkomst panelen, bör du loggas in automatiskt på den visuella vision som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
