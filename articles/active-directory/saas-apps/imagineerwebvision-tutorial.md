...
* Du kan aktivera användarna att vara automatiskt inloggad till Imagineer WebVision (Single Sign-On) med sina Azure AD-konton.
...
* Imagineer WebVision enkel inloggning aktiverat prenumeration

## <a name="scenario-description"></a>Scenariobeskrivning

I den här självstudien konfigurerar och testar du enkel inloggning med Azure AD i en testmiljö.

* Har stöd för Imagineer WebVision **SP** -initierad SSO
...
I det här avsnittet ska du konfigurera och testa Azure AD enkel inloggning med Imagineer WebVision baserat på en testanvändare kallas **Britta Simon**.
För enkel inloggning ska fungera, måste en länk förhållandet mellan en Azure AD-användare och relaterade användaren i Imagineer WebVision upprättas.
...
2. **[Konfigurera enkel inloggning för Imagineer-WebVision](#configure-imagineer-webvision-single-sign-on)**  – om du vill konfigurera inställningar för enkel inloggning på programsidan.
3. **[Skapa en Azure AD-testanvändare](#create-an-azure-ad-test-user)**  – om du vill testa Azure AD enkel inloggning med Britta Simon.
4. **[Tilldela Azure AD-testanvändare](#assign-the-azure-ad-test-user)**  – om du vill aktivera Britta Simon att använda Azure AD enkel inloggning.
5. **[Skapa testanvändare Imagineer WebVision](#create-imagineer-webvision-test-user)**  – du har en motsvarighet för Britta Simon i Imagineer WebVision som är länkad till en Azure AD-representation av användaren.
...
1. I den [Azure-portalen](https://portal.azure.com/)på den **Imagineer WebVision** application integration markerar **enkel inloggning**.
...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    ![Imagineer WebVision domän och URL: er med enkel inloggning för information](common/sp-identifier.png)
    ...
    > [!NOTE]
    > Dessa värden är inte verkliga. Uppdatera de här värdena med faktisk inloggnings-URL och identifierare. Kontakta [Imagineer WebVision klienten supportteamet](mailto:support@itgny.com) att hämta dessa värden. Du kan även se mönstren som visas i avsnittet **Grundläggande SAML-konfiguration** i Azure-portalen.
...
Att konfigurera enkel inloggning på **Imagineer WebVision** sida, som du behöver skicka den **Appfederationsmetadata** till [Imagineer WebVision supportteamet](mailto:support@itgny.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
...
1. I Azure-portalen väljer du **företagsprogram**väljer **alla program**och välj sedan **Imagineer WebVision**.

    ![Bladet Företagsprogram](common/enterprise-applications.png)

2. I listan med program väljer **Imagineer WebVision**.

    ![Länken Imagineer WebVision i listan med program](common/all-applications.png)
...
### <a name="create-imagineer-webvision-test-user"></a>Skapa Imagineer WebVision testanvändare
...
När du klickar på panelen Imagineer WebVision i åtkomstpanelen, bör det vara loggas in automatiskt till den Imagineer WebVision som du ställer in enkel inloggning. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
