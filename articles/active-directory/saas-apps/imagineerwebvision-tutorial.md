...
Att konfigurera enkel inloggning på **Imagineer WebVision** sida, som du behöver skicka den **Appfederationsmetadata** till [Imagineer WebVision supportteamet](mailto:support@itgny.com). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
