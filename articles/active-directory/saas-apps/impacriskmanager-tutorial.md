...
ms.date: 11/01/2017
ms.author: jeedes
ms.openlocfilehash: 1735d859401982e494e0fcbb40f5b7a0ddaddfc7
ms.sourcegitcommit: c851842d113a7078c378d78d94fea8ff5948c337
ms.translationtype: MT
ms.contentlocale: sv-SE
ms.lasthandoff: 06/18/2018
ms.locfileid: "35968049"
---
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/impacriskmanager-tutorial/tutorial_impacriskmanager_samlbase.png)
...
3. På den **IMPAC Risk Manager-domän och URL: er** avsnittet, utför följande steg om du vill konfigurera programmet i IDP initierade läge:
    ...
    ![URL: er och IMPAC Risk Manager-domän med enkel inloggning information](./media/impacriskmanager-tutorial/tutorial_impacriskmanager_url_new.png)
...
4. Kontrollera **visa avancerade inställningar för URL: en** och utför följande steg om du vill konfigurera programmet i **SP** initierade läge:
    ...
    ![URL: er och IMPAC Risk Manager-domän med enkel inloggning information](./media/impacriskmanager-tutorial/tutorial_impacriskmanager_url1_new.png)
...
5. På den **SAML-signeringscertifikat** klickar du på **Certificate(Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/impacriskmanager-tutorial/tutorial_impacriskmanager_certificate.png) 

6. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/impacriskmanager-tutorial/tutorial_general_400.png)
