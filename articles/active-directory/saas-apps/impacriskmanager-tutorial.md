...
Att konfigurera enkel inloggning på **IMPAC Risk Manager** sida, som du behöver skicka de hämtade **certifikat (Base64)** och lämpliga kopierade URL: er från Azure portal för att [IMPAC Risk Manager supportteam](mailto:rmsupport@Impac.co.nz). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
