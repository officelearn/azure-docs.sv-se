...
När du klickar på panelen för kris-online-portalen på åtkomst panelen, bör du loggas in automatiskt till i händelse av kris-online-portalen som du ställer in SSO för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
