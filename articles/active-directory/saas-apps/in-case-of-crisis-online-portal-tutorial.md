...
När du klickar på panelen för kris-online-portalen på åtkomst panelen, bör du loggas in automatiskt till i händelse av kris-online-portalen som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
