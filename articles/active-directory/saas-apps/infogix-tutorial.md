...
3. **[Skapa en testanvändare Infogix Data3Sixty styr](#create-an-infogix-data3sixty-govern-test-user)**  – du har en motsvarighet för Britta Simon i Infogix Data3Sixty styr som är länkad till en Azure AD-representation av användaren.
...
5. Infogix Data3Sixty styra program som förväntar SAML-intyg i ett visst format. Konfigurera följande anspråk för det här programmet. Du kan hantera värdena för dessa attribut från den **användarattribut** avsnitt på sidan för integrering av programmet. Följande skärmbild visar ett exempel för detta.
...
9. På den **Infogix Data3Sixty styr Configuration** klickar du på **konfigurera Infogix Data3Sixty styr** att öppna **konfigurera inloggning** fönster. Kopiera den **URL för utloggning, SAML entitets-ID och SAML enkel inloggning för tjänst-URL** från den **Snabbreferens avsnittet.**

    ![Infogix Data3Sixty styr konfiguration](./media/infogix-tutorial/tutorial_infogix_configure.png) 

10. Att konfigurera enkel inloggning på **Infogix Data3Sixty styr** sida, som du behöver skicka de hämtade **certifikat (Raw), URL: en för utloggning, SAML entitets-ID och SAML enkel inloggning för tjänst-URL** till [ Infogix Data3Sixty styr supportteamet](mailto:data3sixtysupport@infogix.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
