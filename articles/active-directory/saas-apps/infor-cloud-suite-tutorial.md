...
Att konfigurera enkel inloggning på **Infor CloudSuite** sida, som du behöver skicka de hämtade **XML-Metadata för Federation** och lämpliga kopierade URL: er från Azure portal för att [Infor CloudSuite supportteam](mailto:support@infor.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
