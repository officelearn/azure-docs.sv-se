...
4. I sökrutan skriver **Infor Retail – informationshantering**väljer **Infor Retail – informationshantering** resultatet-panelen klickar **Lägg till** för att lägga till den programmet.
    ...
    ![Infor Retail – informationshantering i resultatlistan](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_addfromgallery.png)
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_samlbase.png)
...
3. På den **Infor Retail-URL: er och domänen för hantering av Information** avsnittet, utför följande steg om du vill konfigurera programmet i IDP initierade läge:
    ...
    ![Med enkel inloggning information IDP Infor Retail-URL: er och domänen för hantering av Information](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_url.png)
...
4. Kontrollera **visa avancerade inställningar för URL: en** och utför följande steg om du vill konfigurera programmet i **SP** initierade läge:
    ...
    ![Infor Retail-domänen för hantering av Information och URL: er enkel inloggning information SP](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_url1.png)
...
5. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_certificate.png) 

6. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/inforretailinformationmanagement-tutorial/tutorial_general_400.png)
...
2. Välj i listan med program **Infor Retail – informationshantering**.
    ...
    ![Infor Retail – informationshantering länken i listan med program](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_app.png)  
