---
title: 'Självstudier: Azure Active Directory-integration med Innotas | Microsoft Docs'
...
ms.locfileid: "39437240"
---
# <a name="tutorial-azure-active-directory-integration-with-innotas"></a>Självstudier: Azure Active Directory-integration med Innotas
...
1. På den **Innotas domän och URL: er** avsnittet, utför följande steg:
    ...
    I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<tenant-name>.Innotas.com`
...
1. Att konfigurera enkel inloggning på **Innotas** sida, som du behöver skicka de hämtade **XML-Metadata för** till [Innotas supportteam](https://www.innotas.com/contact). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
