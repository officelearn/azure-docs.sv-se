...
1. På den **Innotas domän och URL: er** avsnittet, utför följande steg:
    ...
    > [!NOTE] 
    > Det här värdet är inte verkligt. Uppdatera värdet med den faktiska inloggnings-URL:en. Kontakta [Innotas klienten supportteamet](https://www.innotas.com/contact) att hämta det här värdet. 
