...
2. **[Konfigurera Insider spåra enkel inloggning](#configure-insider-track-single-sign-on)** – så här konfigurerar du inställningarna för enkel inloggning på program sidan.
...
När du klickar på panelen Insider-spår i åtkomst panelen, bör du loggas in automatiskt på det Insider-spår som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
