---
title: 'Självstudier: Azure Active Directory-integration med Insider spåra | Microsoft Docs'
...
3. På den **Insider spåra domän och URL: er** avsnittet, utför följande steg:
    ...
    I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<companyname>/InsiderTrack.Portal.<companyname>/Sso/`
...
5. Klicka på **spara** knappen.
    ...
    ![Konfigurera enkel inloggning spara-knapp](./media/insidertrack-tutorial/tutorial_general_400.png)
...
7. Att konfigurera enkel inloggning på **Insider spåra** sida, som du behöver skicka de hämtade **XML-Metadata, URL: en för utloggning, SAML entitets-ID,** och **SAML enkel inloggning för tjänst-URL** till [Insider spåra supportteamet](https://cytecsolutions.com/contact/). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
