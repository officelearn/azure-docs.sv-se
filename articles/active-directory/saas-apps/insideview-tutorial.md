---
title: 'Självstudier: Azure Active Directory-integration med InsideView | Microsoft Docs'
...
ms.locfileid: "39436282"
---
# <a name="tutorial-azure-active-directory-integration-with-insideview"></a>Självstudier: Azure Active Directory-integration med InsideView
...
1. På den **InsideView domän och URL: er** avsnittet, utför följande steg:
    ...
    I den **svars-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://my.insideview.com/iv/<STS Name>/login.iv`
