...
1. **[Skapa en testanvändare InsideView](#creating-an-insideview-test-user)**  – du har en motsvarighet för Britta Simon i InsideView som är länkad till en Azure AD-representation av användaren.
