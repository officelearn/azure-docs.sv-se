...
När du klickar på panelen insvit i åtkomst panelen, bör du loggas in automatiskt till den insvit som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
...
- [Så här skyddar du insviten med avancerad synlighet och kontroller](/cloud-app-security/proxy-intro-aad)