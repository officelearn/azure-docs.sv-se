...
## <a name="configure-and-test-azure-ad-single-sign-on-for-sage-intacct"></a>Konfigurera och testa enkel inloggning med Azure AD för Sage-Intacct
...
1. Utöver ovan förväntar sig Sage Intacct-program att fler attribut skickas tillbaka i SAML-svar. I avsnittet **Användaranspråk** i dialogrutan **Användarattribut** utför du följande steg för att lägga till SAML-tokenattributet enligt det som visas i tabellen nedan:
    ...
    | namn | Värdet ska vara detsamma som Sage Intacct **-användar-ID**, som du anger i **avsnittet Create Sage Intacct test User**, som beskrivs senare i självstudien |
...
1. I avsnittet **enkel inloggning (SSO)** utför du följande steg:
    ...
    Enkel ![inloggning vid](./media/intacct-tutorial/ic790039.png "enkel inloggning")
...
1. I avsnittet **användar information** utför du följande steg:
    ...
    Användar(./media/intacct-tutorial/ic790043.png "information för") ![användar information]
...
1. Klicka på fliken **enkel inloggning** och kontrol lera att **användar-ID: t för federerad SSO** i skärm bilden nedan och **källattributet** som är mappat med `http://schemas.xmlsoap.org/ws/2005/05/identity/claims/nameidentifier` i avsnittet **användarattribut** i Azure Portal ska vara detsamma.
    ...
    Användar(./media/intacct-tutorial/ic790044.png "information för") ![användar information]
