...
2. **[Konfigurera ingångs läge för enkel inloggning](#configure-intime-single-sign-on)** för att konfigurera de enskilda Sign-On inställningarna på program sidan.
...
### <a name="configure-intime-single-sign-on"></a>Konfigurera en engångs Sign-On
...
När du klickar på panelen vid inaktivitet i åtkomst panelen, bör du loggas in automatiskt till den tid då du ställer in SSO. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
