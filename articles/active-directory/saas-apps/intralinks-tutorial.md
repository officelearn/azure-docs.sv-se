...
5. I resultatpanelen väljer **Intralinks**, och klicka sedan på **Lägg till** för att lägga till programmet.
...
3. **[Skapa en testanvändare Intralinks](#creating-an-intralinks-test-user)**  – du har en motsvarighet för Britta Simon i Intralinks som är länkad till en Azure AD-representation av användaren.
...
6. Att konfigurera enkel inloggning på **Intralinks** sida, som du behöver skicka de hämtade **XML-Metadata för** [Intralinks supportteam](https://www.intralinks.com/contact-1). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
...
6.  I Azure-portalen på den **Intralinks** program integration-sidan klickar du på **enkel inloggning**.

    ![Konfigurera enkel inloggning][4]

7. På den **enkel inloggning** dialogrutan **läge** som **inloggning länkade**.
 
    ![Konfigurera enkel inloggning](./media/intralinks-tutorial/tutorial_intralinks_linkedsignon.png)

8. Hämta SP initierad SSO URL från [Intralinks team](https://www.intralinks.com/contact-1) för andra Intralinks programmet och ange den i **konfigurera inloggnings-URL** enligt nedan. 
...
10. Tilldela program till användare eller grupper som visas i avsnittet  **[tilldelar Azure AD-testanvändare](#assigning-the-azure-ad-test-user)**.
