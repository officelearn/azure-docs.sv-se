...
1. Utför följande steg på sidan **enkel inloggning** :
    ...
    g. Välj **SHA-256** i list rutan för **hash-algoritmen**.
...
När du klickar på panelen insikt i åtkomst panelen, bör du loggas in automatiskt på den insikt som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
