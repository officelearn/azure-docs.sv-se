...
Att konfigurera enkel inloggning på **iPass SmartConnect** sida, som du behöver skicka de hämtade **XML-Metadata för Federation** och lämpliga kopierade URL: er från Azure portal för att [iPass SmartConnect supportteam](mailto:help@ipass.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
