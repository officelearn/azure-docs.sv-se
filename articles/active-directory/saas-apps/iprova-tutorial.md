...
1. **[Konfigurera IPROVA SSO](#configure-iprova-sso)** – om du vill konfigurera inställningar för enskilda Sign-On på program sidan.
...
När du klickar på iProva-panelen i åtkomstpanelen så bör du automatiskt loggas in på den iProva som du har konfigurerat enkel inloggning för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
...
- [Så här skyddar du iProva med avancerad synlighet och kontroller](/cloud-app-security/proxy-intro-aad)