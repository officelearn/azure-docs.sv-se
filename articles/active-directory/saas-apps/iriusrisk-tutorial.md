...
1. Att konfigurera enkel inloggning på **IriusRisk** sida, som du behöver skicka de hämtade **XML-Metadata för** till [IriusRisk supportteamet](mailto:info@continuumsecurity.net). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
