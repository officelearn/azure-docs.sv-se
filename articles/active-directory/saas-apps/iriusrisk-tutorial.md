---
title: 'Självstudier: Azure Active Directory-integration med IriusRisk | Microsoft Docs'
...
ms.locfileid: "39052592"
---
# <a name="tutorial-azure-active-directory-integration-with-iriusrisk"></a>Självstudier: Azure Active Directory-integration med IriusRisk
...
3. **[Skapa en testanvändare IriusRisk](#create-a-iriusrisk-test-user)**  – du har en motsvarighet för Britta Simon i IriusRisk som är länkad till en Azure AD-representation av användaren.
...
3. På den **IriusRisk domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<companyname>.iriusrisk.com/ui#!login`

    b. I den **identifierare** textrutan angett värde: `iriusrisk-sp`

    > [!NOTE] 
    > Inloggnings-URL-värdet är inte verkliga. Uppdatera det här värdet med faktiska inloggnings-URL: en. Kontakta [IriusRisk klienten supportteamet](mailto:info@continuumsecurity.net) att hämta det här värdet. 
...
5. Klicka på **spara** knappen.
    ...
    ![Konfigurera enkel inloggning spara-knapp](./media/iriusrisk-tutorial/tutorial_general_400.png)

6. Att konfigurera enkel inloggning på **IriusRisk** sida, som du behöver skicka de hämtade **XML-Metadata för** till [IriusRisk supportteamet](mailto:info@continuumsecurity.net). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
...
Målet med det här avsnittet är att skapa en användare som kallas Britta Simon i IriusRisk. IriusRisk stöder just-in-time-etablering, vilket är som standard aktiverat. Det finns inga uppgift åt dig i det här avsnittet. En ny användare har skapats under ett försök att komma åt IriusRisk om det inte finns ännu.
