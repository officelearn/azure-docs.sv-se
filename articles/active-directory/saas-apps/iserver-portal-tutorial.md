---
title: 'Självstudier: Azure Active Directory enkel inloggning (SSO) med iServer-portalen | Microsoft Docs'
...
ms.locfileid: "70143102"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-iserver-portal"></a>Självstudier: Azure Active Directory enkel inloggning (SSO) med iServer-portalen
...
1. I avsnittet **grundläggande SAML-konfiguration** , om du vill konfigurera programmet i **IDP** initierat läge, anger du värdena för följande fält:
    ...
    a. I textrutan **Identifierare** skriver du en URL med följande mönster: `iserver-portal-<myiserverportal>`

    b. I textrutan **Svars-URL** skriver du en URL med följande mönster: `https://<myiserverportal.com>/SAML/login`

1. Klicka på **Ange ytterligare URL:er** och gör följande om du vill konfigurera appen i **SP**-initierat läge:

    I textrutan **Inloggnings-URL** skriver du in en URL med följande mönster: `https://<myiserverportal.com>/SAML/login`
...
Om du vill konfigurera enkel inloggning på **IServer Portal** sida måste du skicka **tumavtrycket** och lämpliga kopierade url: er från Azure Portal till [iserver Portal support team](mailto:support@orbussoftware.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
