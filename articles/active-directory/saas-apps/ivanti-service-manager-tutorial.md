...
När du klickar på panelen Ivanti Service Manager (ISM) i åtkomst panelen, bör du loggas in automatiskt på Ivanti Service Manager (ISM) som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
