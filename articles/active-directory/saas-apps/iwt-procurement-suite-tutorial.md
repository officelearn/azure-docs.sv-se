...
När du klickar på panelen IWT anskaffnings paket på åtkomst panelen, bör du loggas in automatiskt till IWT-inköps paketet som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
...
- [Så här skyddar du IWT tillvaratagande Suite med avancerad synlighet och kontroller](/cloud-app-security/proxy-intro-aad)