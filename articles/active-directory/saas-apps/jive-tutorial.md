...
När du klickar på panelen jives på åtkomst panelen, bör du loggas in automatiskt på den jives som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
...
- [Så här skyddar du jives med avancerad synlighet och kontroller](/cloud-app-security/proxy-intro-aad)