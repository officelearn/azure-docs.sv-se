...
5. I resultatpanelen väljer **Jobbadmin**, och klicka sedan på **Lägg till** för att lägga till programmet.
...
3. **[Skapa en testanvändare Jobbadmin](#creating-a-jobbadmin-test-user)**  – du har en motsvarighet för Britta Simon i Jobbadmin som är länkad till en Azure AD-representation av användaren.
...
6. Att konfigurera enkel inloggning på **Jobbadmin** sida, som du behöver skicka de hämtade **XML-Metadata för** till [Jobbadmin supportteamet](https://www.jobbnorge.no/om-oss/kontakt-oss). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
