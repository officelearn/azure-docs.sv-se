---
title: 'Självstudier: Azure Active Directory-integration med JobScore | Microsoft Docs'
...
ms.locfileid: "39449153"
---
# <a name="tutorial-azure-active-directory-integration-with-jobscore"></a>Självstudier: Azure Active Directory-integration med JobScore
...
1. På den **JobScore domän och URL: er** avsnittet, utför följande steg:
    ...
    I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://hire.jobscore.com/auth/adfs/<company name>`
