...
1. I avsnittet **grundläggande SAML-konfiguration** , om du vill konfigurera programmet i **IDP** initierat läge, anger du värdena för följande fält:
    ...
    d. I text rutan för **Relay-tillstånd** skriver du en URL: `/ctrl_login/saml_login`
...
7. Utför följande steg på **integrations sidan för enkel inloggning** under **konfigurationer**:
    ...
    d. Ange det här värdet `http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress` i rutan **attributnamn för e-post** .

    e. Ange det här värdet `http://schemas.xmlsoap.org/ws/2005/05/identity/claims/givenname` i text rutan **namn för förnamn** .

    f. Ange det här värdet `http://schemas.xmlsoap.org/ws/2005/05/identity/claims/surname` i text rutan **attribut namn för efter namn** .
...
När du klickar på panelen Kanbanize på åtkomst panelen, bör du loggas in automatiskt på den Kanbanize som du ställer in SSO för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
