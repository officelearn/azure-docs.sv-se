...
1. Under avsnittet för användare, klickar du på **Lägg till användare** fliken. På den **”Lägg till en användare”** dialogrutan utför följande steg:
