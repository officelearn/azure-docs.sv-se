---
title: 'Självstudiekurs: Azure Active Directory-integrering med Kantega SSO för JIRA | Microsoft-dokument'
...
---
# <a name="tutorial-azure-active-directory-integration-with-kantega-sso-for-jira"></a>Självstudiekurs: Azure Active Directory-integrering med Kantega SSO för JIRA

I den här självstudien får du lära dig hur du integrerar Kantega SSO för JIRA med Azure Active Directory (Azure AD).
...
* Du kan aktivera dina användare automatiskt inloggade på Kantega SSO för JIRA (Enkel inloggning) med sina Azure AD-konton.
...
* Kantega SSO för JIRA enkel inloggning aktiverad prenumeration

## <a name="scenario-description"></a>Scenariobeskrivning

I den här självstudien konfigurerar och testar du enkel inloggning med Azure AD i en testmiljö.

* Kantega SSO för JIRA stöder **SP och IDP** initierade SSO

## <a name="adding-kantega-sso-for-jira-from-the-gallery"></a>Lägga kantega SSO för JIRA från galleriet

Om du vill konfigurera integreringen av Kantega SSO för JIRA i Azure AD måste du lägga till Kantega SSO för JIRA från galleriet i listan över hanterade SaaS-appar.

**Så här lägger du till Kantega SSO för JIRA från galleriet:**
...
4. Skriv **Kantega SSO för JIRA**i sökrutan och välj **Kantega SSO för JIRA från** resultatpanelen och klicka sedan på **Lägg** till knappen för att lägga till programmet.

    ![Kantega SSO för JIRA i resultatlistan](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurera och testa enkel inloggning med Azure AD

I det här avsnittet konfigurerar och testar du azure AD enkel inloggning med Kantega SSO för JIRA baserat på en testanvändare som heter **Britta Simon**.
För enkel inloggning för att fungera måste en länkrelation mellan en Azure AD-användare och den relaterade användaren i Kantega SSO för JIRA upprättas.

Om du vill konfigurera och testa en enkel Azure AD-inloggning med Kantega SSO för JIRA måste du slutföra följande byggblock:

1. **[Konfigurera enkel inloggning med Azure AD](#configure-azure-ad-single-sign-on)** – så att användarna kan använda den här funktionen.
2. **[Konfigurera Kantega SSO för JIRA Single Sign-On](#configure-kantega-sso-for-jira-single-sign-on)** - för att konfigurera inställningarna för enkel inloggning på programsidan.
3. **[Skapa en Azure AD-testanvändare](#create-an-azure-ad-test-user)** – för att testa enkel inloggning med Azure AD med Britta Simon.
4. **[Tilldela Azure AD-testanvändaren](#assign-the-azure-ad-test-user)** – så att Britta Simon kan använda enkel inloggning med Azure AD.
5. **[Skapa Kantega SSO för JIRA-testanvändare](#create-kantega-sso-for-jira-test-user)** – om du vill ha en motsvarighet till Britta Simon i Kantega SSO för JIRA som är länkad till Azure AD-representationen av användaren.
...
Så här konfigurerar du en enkel Azure AD-inloggning med Kantega SSO för JIRA:

1. I [Azure-portalen](https://portal.azure.com/)väljer du Enkel inloggning på sidan **Kantega SSO för** JIRA-programintegration . **Single sign-on**
...
4. Om du vill konfigurera programmet i **IDP-initierat** läge i avsnittet **Grundläggande SAML-konfiguration** gör du följande:
    ...
    ![Kantega SSO för JIRA-domän och webbadresser med enkel inloggning](common/idp-intiated.png)
...
5. Klicka på **Ange ytterligare URL:er** och gör följande om du vill konfigurera appen i **SP**-initierat läge:
    ...
    ![Kantega SSO för JIRA-domän och webbadresser med enkel inloggning](common/metadata-upload-additional-signon.png)
...
7. Kopiera lämpliga webbadresser enligt dina krav i avsnittet **Konfigurera Kantega SSO för JIRA.**
...
1. I ett annat webbläsarfönster loggar du in på din jira-lokala server som administratör.

1. Hovra över kugghjulet och klicka på **Tillägg**.

    ![Konfigurera enkel inloggning](./media/kantegassoforjira-tutorial/addon1.png)

1. I avsnittet Tillägg klickar du på **Hitta nya tillägg**. Sök **kantega SSO för JIRA (SAML & Kerberos)** och klicka på **Installera** knappen för att installera den nya SAML plugin.
...
1. Ny plugin är listad under **INTEGRATIONS**. Klicka på **Konfigurera** för att konfigurera det nya plugin-programmet.
...
1. Gör följande i avsnittet **JIRA-användarkonton:**

    ![Konfigurera enkel inloggning](./media/kantegassoforjira-tutorial/addon10.png)

    a. Välj **Skapa användare i JIRA:s interna katalog om det behövs** och ange lämpligt namn på gruppen för användare (kan vara flera nej. grupper åtskilda av kommatecken).
...
I det här avsnittet kan du aktivera Britta Simon för att använda Azure enkel inloggning genom att bevilja åtkomst till Kantega SSO för JIRA.

1. I Azure-portalen väljer du **Enterprise Applications**, väljer **Alla program**och väljer sedan **Kantega SSO för JIRA**.

    ![Bladet Företagsprogram](common/enterprise-applications.png)

2. Välj **Kantega SSO för JIRA**i programlistan .

    ![Länken Kantega SSO för JIRA i listan Program](common/all-applications.png)
...
Om du vill att Azure AD-användare ska kunna logga in på JIRA måste de etableras i JIRA. I Kantega SSO för JIRA är etablering en manuell aktivitet.
...
1. Klicka på **Skapa användare**under Avsnittet **Användarhanteringsfliken** .
...
När du klickar på panelen Kantega SSO för JIRA i åtkomstpanelen ska du automatiskt loggas in på Den Kantega SSO för JIRA som du konfigurerar SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
