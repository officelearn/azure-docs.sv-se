...
7. I en annan webbläsarfönster logga du in på ditt JIRA på lokal server som administratör.
...
1. Logga in på din JIRA på lokal server som administratör.
