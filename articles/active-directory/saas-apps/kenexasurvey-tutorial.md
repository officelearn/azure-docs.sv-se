...
När du klickar på panelen IBM Kenexa Survey Enterprise på åtkomst panelen, bör du loggas in automatiskt till IBM Kenexa Survey Enterprise som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
