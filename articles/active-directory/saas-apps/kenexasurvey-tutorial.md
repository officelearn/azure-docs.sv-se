...
Att konfigurera enkel inloggning på **IBM Kenexa undersökningen Enterprise** sida, som du behöver skicka de hämtade **certifikat (Base64)** och lämpliga kopierade URL: er från Azure portal för att [IBM Kenexa Enkät Enterprise support-teamet](https://www.ibm.com/support/home/?lnk=fcw). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
