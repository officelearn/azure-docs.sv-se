---
title: 'Självstudier: Azure Active Directory-integration med Kindling | Microsoft Docs'
...
ms.locfileid: "39428659"
---
# <a name="tutorial-azure-active-directory-integration-with-kindling"></a>Självstudier: Azure Active Directory-integration med Kindling
...
1. På den **Kindling domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<companyname>.kindlingapp.com`

    b.  I den **identifierare** textrutan anger du ett URL med hjälp av följande mönster: `https://<companyname>.kindlingapp.com/saml/module.php/saml/sp/metadata.php/clientIDP`

    > [!NOTE] 
    > Dessa värden är inte verkligt. Uppdatera dessa värden med faktiska inloggnings-URL och identifierare. Kontakta [Kindling supportteamet](mailto:support@kindlingapp.com) att hämta dessa värden.
