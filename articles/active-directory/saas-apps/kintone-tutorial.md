...
4. I sökrutan skriver **Kintone**.
    ...
    ![Skapa en testanvändare i Azure AD](./media/kintone-tutorial/tutorial_kintone_search.png)

5. Välj i resultatpanelen **Kintone**, och klicka sedan på **Lägg till** för att lägga till programmet.

    ![Skapa en testanvändare i Azure AD](./media/kintone-tutorial/tutorial_kintone_addfromgallery.png)
...
10. Under **systemadministration \> säkerhet** klickar du på **inloggning**.
    ...
    ![Inloggningen](./media/kintone-tutorial/ic785881.png "inloggning")
...
1. I den **Azure-portalen**, klicka på det vänstra navigeringsfönstret **Azure Active Directory** ikon.
    ...
    ![Skapa en testanvändare i Azure AD](./media/kintone-tutorial/create_aaduser_01.png) 

2. Om du vill visa en lista över användare, gå till **användare och grupper** och på **alla användare**.
    
    ![Skapa en testanvändare i Azure AD](./media/kintone-tutorial/create_aaduser_02.png) 

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i dialogrutan.
 
    ![Skapa en testanvändare i Azure AD](./media/kintone-tutorial/create_aaduser_03.png) 

4. På den **användaren** dialogrutan utför följande steg:
 
    ![Skapa en testanvändare i Azure AD](./media/kintone-tutorial/create_aaduser_04.png) 
...
3. Klicka på **användare & systemadministration**.
    ...
    ![Användaren & systemadministration](./media/kintone-tutorial/ic785880.png "systemadministration & användare")
