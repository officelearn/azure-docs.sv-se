---
title: 'Självstudier: Azure Active Directory-integration med Kiteworks | Microsoft Docs'
...
1. På den **Kiteworks domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<subdomain>.kiteworks.com`
