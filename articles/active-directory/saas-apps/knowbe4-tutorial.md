...
ms.date: 08/31/2017
ms.author: jeedes
ms.openlocfilehash: d02ee99ec425a5a4cec75f460cfaa4698655a368
ms.sourcegitcommit: c851842d113a7078c378d78d94fea8ff5948c337
ms.translationtype: MT
ms.contentlocale: sv-SE
ms.lasthandoff: 06/18/2018
ms.locfileid: "35978216"
---
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/knowbe4-tutorial/tutorial_knowbe4_samlbase.png)

3. På den **KnowBe4 säkerhetsdomän medvetenhet utbildning och URL: er** avsnittet, utför följande steg:

    ![Enkel inloggning information KnowBe4 säkerhetsdomän medvetenhet utbildning och URL: er](./media/knowbe4-tutorial/tutorial_knowbe4_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **certifikat (Raw)** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/knowbe4-tutorial/tutorial_knowbe4_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/knowbe4-tutorial/tutorial_general_400.png)
