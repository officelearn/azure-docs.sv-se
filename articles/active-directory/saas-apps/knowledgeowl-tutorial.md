---
title: 'Självstudier: Azure Active Directory-integration med KnowledgeOwl | Microsoft Docs'
...
1. På den **KnowledgeOwl domän och URL: er** avsnittet, utför följande steg om du vill konfigurera programmet i **IDP** initierade läge:
    ...
    a. I den **identifierare (entitets-ID)** textrutan anger du ett URL med hjälp av följande mönster:
    |||
    |-|-|
...
Målet med det här avsnittet är att skapa en användare som kallas Britta Simon i KnowledgeOwl. KnowledgeOwl stöder just-in-time-etablering, vilket är som standard aktiverat. Det finns inga uppgift åt dig i det här avsnittet. En ny användare har skapats under ett försök att komma åt KnowledgeOwl om det inte finns ännu.
>[!Note]
