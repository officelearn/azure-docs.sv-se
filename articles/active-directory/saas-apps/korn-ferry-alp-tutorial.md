...
I det här avsnittet ska du skapa en användare med namnet Britta Simon i Korn Ferry ALP. Arbeta med [korn-Alp support team](mailto:noreply@kornferry.com) för att lägga till användarna på korn-Alp-plattformen. Användare måste skapas och aktiveras innan du använder enkel inloggning.

### <a name="test-single-sign-on"></a>Testa enkel inloggning 

I det här avsnittet testar du konfigurationen för enkel inloggning Azure AD med hjälp av åtkomstpanelen.

När du klickar på Korn Ferry ALP-panelen på åtkomstpanelen bör du automatiskt loggas in i Korn Ferry ALP som du har konfigurerat enkel inloggning för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
