...
2. **[Konfigurera Kudos enkel inloggning](#configure-kudos-single-sign-on)** – om du vill konfigurera de enskilda Sign-On inställningarna på program sidan.
...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    I text rutan **inloggnings-URL** skriver du en URL med följande mönster:  `https://<company>.kudosnow.com`

    > [!NOTE]
    > Värdet är inte verkligt. Uppdatera värdet med den faktiska inloggnings-URL:en. Kontakta [Kudos client support team](http://success.kudosnow.com/home) för att hämta värdet. Du kan även se mönstren som visas i avsnittet **Grundläggande SAML-konfiguration** i Azure-portalen.
...
### <a name="configure-kudos-single-sign-on"></a>Konfigurera Kudos Single Sign-On
...
När du klickar på panelen Kudos på åtkomst panelen, bör du loggas in automatiskt på den Kudos som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
