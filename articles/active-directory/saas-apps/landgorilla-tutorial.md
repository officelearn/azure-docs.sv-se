...
2. **[Konfigurera mark GORILLA SSO](#configure-land-gorilla-sso)** – för att konfigurera enskilda Sign-On inställningar på program sidan.
...
När du klickar på panelen land Gorilla på åtkomst panelen, bör du loggas in automatiskt på den land-Gorilla som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
