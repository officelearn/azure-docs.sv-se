...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/launchdarkly-tutorial/tutorial_launchdarkly_samlbase.png)
...
3. På den **LaunchDarkly domän och URL: er** avsnittet, utför följande steg om du vill konfigurera programmet i **IDP** initierade läge:
    ...
    ![URL: er och LaunchDarkly domän med enkel inloggning information](./media/launchdarkly-tutorial/tutorial_launchdarkly_url.png)
...
4. Kontrollera **visa avancerade inställningar för URL: en** och utför följande steg om du vill konfigurera programmet i **SP** initierade läge:
    ...
    ![URL: er och LaunchDarkly domän med enkel inloggning information](./media/launchdarkly-tutorial/tutorial_launchdarkly_url1.png)
...
5. På den **SAML-signeringscertifikat** klickar du på **certifikat (Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/launchdarkly-tutorial/tutorial_launchdarkly_certificate.png) 

6. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/launchdarkly-tutorial/tutorial_general_400.png)
