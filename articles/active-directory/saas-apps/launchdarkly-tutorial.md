---
title: 'Självstudiekurs: Azure Active Directory-integrering med LaunchDarkly | Microsoft-dokument'
...
ms.locfileid: "73159657"
---
# <a name="tutorial-azure-active-directory-integration-with-launchdarkly"></a>Självstudiekurs: Azure Active Directory-integrering med LaunchDarkly
...
4. Om du vill konfigurera programmet i **IDP-initierat** läge i avsnittet **Grundläggande SAML-konfiguration** gör du följande:
    ...
    a. Skriv en URL i textrutan **Identifierare:**`app.launchdarkly.com`

    b. Skriv en URL med följande mönster i textrutan **Svara URL:**`https://app.launchdarkly.com/trust/saml2/acs/<customers-unique-id>`
...
5. Klicka på **Ange ytterligare URL:er** och gör följande om du vill konfigurera appen i **SP**-initierat läge:
    ...
    Skriv en URL med hjälp av följande mönster i textrutan **Sign-on-URL:**`https://app.launchdarkly.com`
