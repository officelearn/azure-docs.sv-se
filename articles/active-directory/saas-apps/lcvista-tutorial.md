---
title: 'Självstudier: Azure Active Directory-integration med LCVista | Microsoft Docs'
...
ms.locfileid: "39046812"
---
# <a name="tutorial-azure-active-directory-integration-with-lcvista"></a>Självstudier: Azure Active Directory-integration med LCVista
...
5. I resultatpanelen väljer **LCVista**, och klicka sedan på **Lägg till** för att lägga till programmet.
...
3. **[Skapa en testanvändare LCVista](#creating-a-lcvista-test-user)**  – du har en motsvarighet för Britta Simon i LCVista som är länkad till en Azure AD-representation av användaren.
...
3. På den **LCVista domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<subdomain>.lcvista.com/rainier/login`

    b. I den **identifierare** textrutan anger du ett URL med hjälp av följande mönster: `https://<subdomain>.lcvista.com` 
     
    > [!NOTE] 
    > Dessa värden är inte verkligt. Uppdatera dessa värden med de faktiska identifierare och inloggnings-URL. Kontakta [LCVista klienten supportteamet](https://lcvista.com/contact) att hämta dessa värden. 
...
6. På den **LCVista Configuration** klickar du på **konfigurera LCVista** att öppna **konfigurera inloggning** fönster. Kopiera den **SAML entitets-ID** och **SAML enkel inloggning för tjänst-URL** från den **Snabbreferens avsnittet.**
...
8. I den **SAML-Config** avsnittet, kontrollera den **aktivera SAML-inloggningen** och ange information som vi nämnde i bilden nedan. 
