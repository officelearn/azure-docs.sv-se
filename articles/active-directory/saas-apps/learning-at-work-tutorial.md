...
2. **[Konfigurera utbildning i arbetet SSO](#configure-learning-at-work-sso)** – för att konfigurera enskilda Sign-On inställningar på program sidan.
...
När du klickar på panelen för att lära dig på arbetet i åtkomst panelen, bör du loggas in automatiskt till den utbildning i arbetet som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
