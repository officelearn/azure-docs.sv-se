---
title: 'Självstudier: Azure Active Directory-integration med Learningpool Act | Microsoft Docs'
...
ms.locfileid: "39439444"
---
# <a name="tutorial-azure-active-directory-integration-with-learningpool-act"></a>Självstudier: Azure Active Directory-integration med Learningpool Act
...
1. På den **Learningpool Act domän och URL: er** avsnittet, utför följande steg:
    ...
    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska inloggnings-URL och identifierare. Kontakta [Learningpool Act klienten supportteamet](https://www.Learningpool.com/support) att hämta dessa värden. 
 
1. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.

    ![Konfigurera enkel inloggning](./media/learningpool-tutorial/tutorial_Learningpoolact_certificate.png) 

1. Learningpool Act program som förväntar SAML-intyg i ett visst format. Konfigurera följande anspråk för det här programmet. Du kan hantera värdena för dessa attribut från den **”Atrribute”** fliken av programmet. Följande skärmbild visar ett exempel för detta. 
...
1. Att konfigurera enkel inloggning på **Learningpool Act** sida, som du behöver skicka de hämtade **XML-Metadata för** till [Learningpool Act supportteamet](https://www.Learningpool.com/support). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
