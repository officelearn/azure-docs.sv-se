...
1. **[Skapa en testanvändare LMS-Learning plats](#creating-a-learnconnect-test-user)**  – du har en motsvarighet för Britta Simon i LMS-Learning plats som är länkad till en Azure AD-representation av användaren.
