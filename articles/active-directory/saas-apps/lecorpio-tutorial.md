---
title: 'Självstudier: Azure Active Directory-integration med Lecorpio | Microsoft Docs'
...
ms.locfileid: "39442504"
---
# <a name="tutorial-azure-active-directory-integration-with-lecorpio"></a>Självstudier: Azure Active Directory-integration med Lecorpio
...
1. På den **Lecorpio domän och URL: er** avsnittet, utför följande steg:
    ...
    b. I den **identifierare** textrutan anger du ett URL med hjälp av följande mönster: `https://<instance name>.lecorpio.com/<customer name>`

    > [!NOTE] 
    > Dessa värden är inte verkligt. Uppdatera dessa värden med faktiska inloggnings-URL och identifierare. Här föreslår vi att du för att använda det unika värdet av strängen i identifierare. Kontakta [Lecorpio klienten supportteamet](mailto:info@lecorpio.com) att hämta dessa värden. 
