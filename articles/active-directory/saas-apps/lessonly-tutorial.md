...
4. I sökrutan skriver **Lesson.ly**.
    ...
    ![Skapa en testanvändare i Azure AD](./media/lessonly-tutorial/tutorial_lesson.ly_search.png)

5. Välj i resultatpanelen **Lesson.ly**, och klicka sedan på **Lägg till** för att lägga till programmet.

    ![Skapa en testanvändare i Azure AD](./media/lessonly-tutorial/tutorial_lesson.ly_addfromgallery.png)
...
1. I den **Azure-portalen**, klicka på det vänstra navigeringsfönstret **Azure Active Directory** ikon.
    ...
    ![Skapa en testanvändare i Azure AD](./media/lessonly-tutorial/create_aaduser_01.png) 

2. Om du vill visa en lista över användare, gå till **användare och grupper** och på **alla användare**.
    
    ![Skapa en testanvändare i Azure AD](./media/lessonly-tutorial/create_aaduser_02.png) 

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i dialogrutan.
 
    ![Skapa en testanvändare i Azure AD](./media/lessonly-tutorial/create_aaduser_03.png) 

4. På den **användaren** dialogrutan utför följande steg:
 
    ![Skapa en testanvändare i Azure AD](./media/lessonly-tutorial/create_aaduser_04.png) 
