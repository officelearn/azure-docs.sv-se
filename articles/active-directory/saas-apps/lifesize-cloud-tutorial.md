---
title: 'Självstudiekurs: Azure Active Directory-integrering med Lifesize Cloud | Microsoft-dokument'
...
ms.locfileid: "73159571"
---
# <a name="tutorial-azure-active-directory-integration-with-lifesize-cloud"></a>Självstudiekurs: Azure Active Directory-integrering med Lifesize Cloud
...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    a. Skriv en URL med hjälp av följande mönster i textrutan **Sign-on-URL:**`https://login.lifesizecloud.com/ls/?acs`

    b. Skriv en URL med följande mönster i textrutan **Identifierare:**`https://login.lifesizecloud.com/<companyname>`
