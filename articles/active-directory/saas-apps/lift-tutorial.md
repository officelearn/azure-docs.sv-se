...
När du klickar på panelen lyft i åtkomst panelen, bör du loggas in automatiskt på den hiss som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
