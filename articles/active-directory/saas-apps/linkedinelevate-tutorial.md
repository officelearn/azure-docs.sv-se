...
När du klickar på panelen LinkedIn-höjning i åtkomst panelen, bör du loggas in automatiskt på den LinkedIn-höjning som du ställer in SSO för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
