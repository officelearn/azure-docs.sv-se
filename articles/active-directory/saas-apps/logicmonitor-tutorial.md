...
5. I resultatpanelen väljer **LogicMonitor**, och klicka sedan på **Lägg till** för att lägga till programmet.
...
3. **[Skapa en testanvändare LogicMonitor](#creating-a-logicmonitor-test-user)**  – du har en motsvarighet för Britta Simon i LogicMonitor som är länkad till en Azure AD-representation av användaren.
...
6. Logga in på din **LogicMonitor** företagets plats som administratör.

7. Klicka på menyn längst upp **inställningar**.
   
   ![Inställningar för](./media/logicmonitor-tutorial/ic790052.png "inställningar")

8. I funka navigeringen till vänster klickar du på **enkel inloggning**
