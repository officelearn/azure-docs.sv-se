...
2. I menyn högst upp klickar du på **team**.
    ...
    ![Dela](./media/lucidchart-tutorial/ic791190.png "Team")
...
När du klickar på panelen Lucidchart på åtkomst panelen, bör du loggas in automatiskt på den Lucidchart som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Så här skyddar du Lucidchart med avancerad synlighet och kontroller](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)
