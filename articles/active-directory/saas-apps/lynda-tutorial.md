---
title: 'Självstudier: Azure Active Directory-integration med Lynda.com | Microsoft Docs'
...
ms.locfileid: "39040189"
---
# <a name="tutorial-azure-active-directory-integration-with-lyndacom"></a>Självstudier: Azure Active Directory-integration med Lynda.com
...
5. I resultatpanelen väljer **Lynda.com**, och klicka sedan på **Lägg till** för att lägga till programmet.
...
3. **[Skapa en testanvändare Lynda.com](#creating-a-lyndacom-test-user)**  – du har en motsvarighet för Britta Simon i Lynda.com som är länkad till en Azure AD-representation av användaren.
...
3. På den **Lynda.com domän och URL: er** avsnittet, utför följande steg:
    ...
    I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<subdomain>.lynda.com/Shibboleth.sso/InCommon?providerId=<url>&target=<url> `
...
6. Att konfigurera enkel inloggning på **Lynda.com** sida, som du behöver skicka de hämtade **XML-Metadata för** [Lynda.com support](https://www.linkedin.com/help/lynda/ask).
