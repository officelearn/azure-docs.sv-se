---
title: 'Självstudiekurs: Azure Active Directory-integrering med M-Files | Microsoft-dokument'
...
---
# <a name="tutorial-azure-active-directory-integration-with-m-files"></a>Självstudiekurs: Azure Active Directory-integrering med M-Filer
