...
3. **[Skapa en testanvändare Manabi Pocket](#create-a-manabi-pocket-test-user)**  – du har en motsvarighet för Britta Simon i Manabi Pocket som är länkad till en Azure AD-representation av användaren.
...
3. På den **Manabi Pocket domän och URL: er** avsnittet, utför följande steg:
...
6. Att konfigurera enkel inloggning på **Manabi Pocket** sida, som du behöver skicka de hämtade **XML-Metadata för** till [Manabi Pocket supportteamet](mailto:info-ed-cl@ntt.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
