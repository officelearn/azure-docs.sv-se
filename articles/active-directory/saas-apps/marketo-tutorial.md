---
title: 'Självstudier: Azure Active Directory-integration med Marketo | Microsoft Docs'
...
ms.locfileid: "39448136"
---
# <a name="tutorial-azure-active-directory-integration-with-marketo"></a>Självstudier: Azure Active Directory-integration med Marketo
...
1. På den **Marketo-domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **identifierare** textrutan anger du ett URL med hjälp av följande mönster: `https://saml.marketo.com/sp`

    b. I den **svars-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://login.marketo.com/saml/assertion/\<munchkinid\>`

    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska identifierare och svars-URL. Kontakta [Marketo-supportteamet](http://investors.marketo.com/contactus.cfm) att hämta dessa värden.
