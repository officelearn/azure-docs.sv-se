---
title: 'Självstudiekurs: Azure Active Directory-integrering med MaxxPoint | Microsoft-dokument'
...
---
# <a name="tutorial-azure-active-directory-integration-with-maxxpoint"></a>Självstudiekurs: Azure Active Directory-integrering med MaxxPoint
...
5. Klicka på **Ange ytterligare URL:er** och gör följande om du vill konfigurera appen i **SP**-initierat läge:
    ...
    Skriv en URL med följande mönster i textrutan **Logga in på WEBBADRESS:**`https://maxxpoint.westipc.com/default/sso/login/entity/<customer-id>-azure`
...
När du klickar på MaxxPoint-panelen i åtkomstpanelen bör du automatiskt loggas in på MaxxPoint som du har konfigurerat enkel inloggning för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
