...
5. Klicka på **Ange ytterligare URL:er** och gör följande om du vill konfigurera appen i **SP**-initierat läge:
    ...
    I text rutan **inloggnings-URL** skriver du en URL med följande mönster:  `https://maxxpoint.westipc.com/default/sso/login/entity/<customer-id>-azure`
...
När du klickar på MaxxPoint-panelen i åtkomstpanelen bör du automatiskt loggas in på MaxxPoint som du har konfigurerat enkel inloggning för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
