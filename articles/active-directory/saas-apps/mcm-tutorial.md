...
- En MCM enkel inloggning aktiverad prenumeration
...
Du måste lägga till MCM från galleriet i listan över hanterade SaaS-appar för att konfigurera integrering av MCM i Azure AD.
...
4. I sökrutan skriver **MCM**.

    ![Skapa en testanvändare i Azure AD](./media/mcm-tutorial/tutorial_mcm_search.png)

5. Välj i resultatpanelen **MCM**, och klicka sedan på **Lägg till** för att lägga till programmet.

    ![Skapa en testanvändare i Azure AD](./media/mcm-tutorial/tutorial_mcm_addfromgallery.png)

##  <a name="configuring-and-testing-azure-ad-single-sign-on"></a>Konfigurera och testa Azure AD enkel inloggning
I det här avsnittet kan du konfigurera och testa Azure AD enkel inloggning med MCM baserat på en testanvändare som kallas ”Britta Simon”.

Azure AD måste du känna till användaren i MCM motsvarighet till en användare i Azure AD för enkel inloggning ska fungera. Med andra ord måste en länk förhållandet mellan en Azure AD-användare och relaterade användaren i MCM upprättas.

I MCM, tilldela värdet för den **användarnamn** i Azure AD som värde för den **användarnamn** etablera länken relationen.
...
3. **[Skapa en MCM testanvändare](#creating-a-mcm-test-user)**  – har en motsvarighet för Britta Simon MCM som är kopplad till Azure AD-representation av användaren.
4. **[Tilldela Azure AD-testanvändare](#assigning-the-azure-ad-test-user)**  - om du vill aktivera Britta Simon att använda Azure AD enkel inloggning.
5. **[Testa enkel inloggning](#testing-single-sign-on)**  - om du vill kontrollera om konfigurationen fungerar.

### <a name="configuring-azure-ad-single-sign-on"></a>Konfigurera Azure AD enkel inloggning

I det här avsnittet Aktivera Azure AD enkel inloggning i Azure-portalen och konfigurera enkel inloggning i tillämpningsprogrammet MCM.

**Utför följande steg för att konfigurera Azure AD enkel inloggning med MCM:**

1. I Azure-portalen på den **MCM** integreringssidan för programmet, klickar du på **enkel inloggning**.
...
3. På den **MCM domän och URL: er** avsnittet, utför följande steg:
...
6. Konfigurera enkel inloggning på **MCM** sida, måste du skicka den hämtade **XML-Metadata för** till [MCM supportteam](http://mcmtechnology.com/support/). De kan ange den här inställningen att ha SAML SSO anslutningen korrekt på båda sidor.
...
1. I den **Azure-portalen**, klicka på det vänstra navigeringsfönstret **Azure Active Directory** ikon.
    ...
    ![Skapa en testanvändare i Azure AD](./media/mcm-tutorial/create_aaduser_01.png) 

2. Om du vill visa en lista över användare, gå till **användare och grupper** och på **alla användare**.
    
    ![Skapa en testanvändare i Azure AD](./media/mcm-tutorial/create_aaduser_02.png) 

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i dialogrutan.
 
    ![Skapa en testanvändare i Azure AD](./media/mcm-tutorial/create_aaduser_03.png) 

4. På den **användaren** dialogrutan utför följande steg:
 
    ![Skapa en testanvändare i Azure AD](./media/mcm-tutorial/create_aaduser_04.png) 
...
### <a name="creating-a-mcm-test-user"></a>Skapa en testanvändare MCM
...
> [!NOTE]
> Du kan använda något annat MCM användarens konto skapas verktyg eller API: er som tillhandahålls av MCM etablera AAD-användarkonton.


### <a name="assigning-the-azure-ad-test-user"></a>Tilldela Azure AD-testanvändare

I det här avsnittet kan du aktivera Britta Simon att använda Azure enkel inloggning genom att bevilja åtkomst till MCM.
...
2. Välj i listan med program **MCM**.
...
När du klickar på panelen MCM på åtkomstpanelen du bör få automatiskt loggat in på ditt MCM-program.
