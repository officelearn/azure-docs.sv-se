...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/mercerhrs-tutorial/tutorial_mercerhrs_samlbase.png)

3. På den **Mercer BenefitsCentral (av MBC)-domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och mercer BenefitsCentral (av MBC)-domän med enkel inloggning information](./media/mercerhrs-tutorial/tutorial_mercerhrs_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/mercerhrs-tutorial/tutorial_mercerhrs_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/mercerhrs-tutorial/tutorial_general_400.png)
...
2. Välj i listan med program **Mercer BenefitsCentral (av MBC)**.
    ...
    ![Länken Mercer av BenefitsCentral (MBC) i listan med program](./media/mercerhrs-tutorial/tutorial_mercerhrs_app.png)  
