...
ms.date: 08/17/2017
ms.author: jeedes
ms.openlocfilehash: 7f939f6dfafd0f4425554353b81f5b1e5c46eb20
ms.sourcegitcommit: c851842d113a7078c378d78d94fea8ff5948c337
ms.translationtype: MT
ms.contentlocale: sv-SE
ms.lasthandoff: 06/18/2018
ms.locfileid: "35966618"
---
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/merchlogix-tutorial/tutorial_merchlogix_samlbase.png)

3. På den **Merchlogix domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och Merchlogix domän med enkel inloggning information](./media/merchlogix-tutorial/tutorial_merchlogix_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **certifikat (Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/merchlogix-tutorial/tutorial_merchlogix_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/merchlogix-tutorial/tutorial_general_400.png)
