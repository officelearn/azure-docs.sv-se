...
När du klickar på panelen Michigan data hubb Single Sign-On på åtkomst panelen, bör du loggas in automatiskt på den Michigan data Sign-On hubb som du ställer in SSO. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Så här skyddar du Michigan data hubb Sign-On med avancerad synlighet och kontroller](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)