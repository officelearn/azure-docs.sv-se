...
4. I sökrutan skriver **Mimecast personliga Portal**väljer **Mimecast personliga Portal** resultatet-panelen klickar **Lägg till** för att lägga till programmet.
    ...
    ![Mimecast personliga portalen i resultatlistan](./media/mimecast-personal-portal-tutorial/tutorial_mimecastpersonalportal_addfromgallery.png)
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/mimecast-personal-portal-tutorial/tutorial_mimecastpersonalportal_samlbase.png)

3. På den **Mimecast personliga Portal domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och Mimecast personliga Portal domän med enkel inloggning information](./media/mimecast-personal-portal-tutorial/tutorial_mimecastpersonalportal_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **Certificate(Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/mimecast-personal-portal-tutorial/tutorial_mimecastpersonalportal_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/mimecast-personal-portal-tutorial/tutorial_general_400.png)
...
6. På den **Mimecast personliga Portal Configuration** klickar du på **konfigurera Mimecast personliga Portal** att öppna **konfigurera inloggning** fönster. Kopiera den **Sign-Out URL, SAML enhets-ID och SAML enkel inloggning Tjänstwebbadress** från den **Snabbreferens avsnitt.**
    ...
    ![Konfiguration av Mimecast Personal](./media/mimecast-personal-portal-tutorial/tutorial_mimecastpersonalportal_configure.png) 
...
9. Klicka på **autentisering profiler**.
    ...
    ![Profiler för autentisering](./media/mimecast-personal-portal-tutorial/ic794999.png "profiler för autentisering")

10. Klicka på **nya autentiseringsprofil**.
   
    ![Nya autentiseringsprofil](./media/mimecast-personal-portal-tutorial/ic795000.png "ny autentiseringsprofil")
...
3. Klicka på **registrera nya domän**.
    ...
    ![Registrera en ny domän](./media/mimecast-personal-portal-tutorial/ic795004.png "registrera ny domän")
...
2. Välj i listan med program **Mimecast personliga Portal**.
    ...
    ![Mimecast personliga Portal-länken i listan med program](./media/mimecast-personal-portal-tutorial/tutorial_mimecastpersonalportal_app.png)  
