---
title: 'Självstudiekurs: Azure Active Directory-integrering med MindTickle | Microsoft-dokument'
...
---
# <a name="tutorial-azure-active-directory-integration-with-mindtickle"></a>Självstudiekurs: Azure Active Directory-integrering med MindTickle
...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg om du har **metadatafilen för tjänstleverantör**:
    ...
    Skriv en URL med hjälp av följande mönster i textrutan **Sign-on-URL:**`https://<subdomain>.mindtickle.com`
