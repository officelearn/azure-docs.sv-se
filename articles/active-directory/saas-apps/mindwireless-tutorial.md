...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/mindwireless-tutorial/tutorial_mindwireless_samlbase.png)

3. På den **mindWireless domän och URL: er** avsnittet, utför följande steg:

    ![mindWireless domän och URL: er med enkel inloggning information](./media/mindwireless-tutorial/tutorial_mindwireless_url.png)
...
7. På den **SAML-signeringscertifikat** klickar du på **Certificate(Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/mindwireless-tutorial/tutorial_mindwireless_certificate.png) 

8. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/mindwireless-tutorial/tutorial_general_400.png)
