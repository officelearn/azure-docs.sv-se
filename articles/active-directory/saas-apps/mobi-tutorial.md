...
1. Att konfigurera enkel inloggning på **MOBI** sida, som du behöver skicka de hämtade **XML-Metadata för** till [MOBI supportteam](mailto:sso@mobiwm.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
