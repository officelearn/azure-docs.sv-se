...
Att konfigurera enkel inloggning på **MobiControl** sida, som du behöver skicka den **Appfederationsmetadata** till [MobiControl supportteamet](https://www.soti.net/about/contact-us/). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
