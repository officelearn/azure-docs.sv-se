...
2. **[Konfigurera enkel inloggning för mobila Xpense – om](#configure-mobile-xpense-single-sign-on)** du vill konfigurera inställningar för enkel inloggning på program sidan.
...
4. I avsnittet **Grundläggande SAML-konfiguration**, om du vill konfigurera appen i **IDP**-initierat läge, gör du följande:
    ...
    ![Information om enkel inloggning för mobila Xpense-domäner och webb adresser](common/idp-intiated.png)
...
5. Klicka på **Ange ytterligare URL:er** och gör följande om du vill konfigurera appen i **SP**-initierat läge:
    ...
    ![Information om enkel inloggning för mobila Xpense-domäner och webb adresser](common/metadata-upload-additional-signon.png)
...
### <a name="configure-mobile-xpense-single-sign-on"></a>Konfigurera enkel inloggning för mobila Xpense
...
När du klickar på panelen mobil Xpense på åtkomst panelen, bör du loggas in automatiskt på den mobila Xpense som du ställer in SSO för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
