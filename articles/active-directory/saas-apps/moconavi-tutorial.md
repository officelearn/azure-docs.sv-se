...
2. **[Konfigurera Moconavi enkel inloggning](#configure-moconavi-single-sign-on)** – om du vill konfigurera de enskilda Sign-On inställningarna på program sidan.
...
### <a name="configure-moconavi-single-sign-on"></a>Konfigurera moconavi Single Sign-On
