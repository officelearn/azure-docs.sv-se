...
När du klickar på panelen kort i åtkomst panelen, bör du loggas in automatiskt till det ögonblick dig för vilket du ställer in SSO. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
...
- [Så här skyddar du dig med avancerad synlighet och kontroller](/cloud-app-security/proxy-intro-aad)