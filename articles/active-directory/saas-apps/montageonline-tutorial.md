...
När du klickar på panelen Montagelayout online på åtkomst panelen, bör du loggas in automatiskt på den Montagelayout online som du har konfigurerat SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
