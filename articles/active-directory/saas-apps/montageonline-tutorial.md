...
3. **[Skapa en Montage Online testanvändare](#create-a-montage-online-test-user)**  – du har en motsvarighet för Britta Simon i Montage Online som är länkad till en Azure AD-representation av användaren.
...
3. På den **Montage Online domän och URL: er** avsnittet, utför följande steg:
    ...
    > [!NOTE] 
    > Inloggnings-URL-värdet är inte verkliga. Uppdatera värdet med faktiska inloggnings-URL: en. Kontakta [Montage Online klienten supportteamet](https://www.montage.co.nz/contact-us/) att hämta värdet. 
 
4. På den **SAML-signeringscertifikat** klickar du på **certifikat (Base64)** och spara certifikatfilen på datorn.

    ![Länk för hämtning av certifikat](./media/montageonline-tutorial/tutorial_montageonline_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara-knapp](./media/montageonline-tutorial/tutorial_general_400.png)

6. På den **Montage Online Configuration** klickar du på **konfigurera Montage Online** att öppna **konfigurera inloggning** fönster. Kopiera den **URL för utloggning, SAML entitets-ID och SAML enkel inloggning för tjänst-URL** från den **Snabbreferens avsnittet.**

    ![Montage Online konfiguration](./media/montageonline-tutorial/tutorial_montageonline_configure.png) 

7. Att konfigurera enkel inloggning på **Montage Online** sida, som du behöver skicka de hämtade **certifikat (Base64), URL: en för utloggning, SAML entitets-ID och SAML enkel inloggning för tjänst-URL** till [Montage Online-supportteamet](https://www.montage.co.nz/contact-us/). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
