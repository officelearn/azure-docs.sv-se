---
title: 'Självstudier: Azure Active Directory-integration med Moxi engagera | Microsoft Docs'
...
ms.locfileid: "39046132"
---
# <a name="tutorial-azure-active-directory-integration-with-moxi-engage"></a>Självstudier: Azure Active Directory-integration med Moxi engagera
...
5. I resultatpanelen väljer **Moxi engagera**, och klicka sedan på **Lägg till** för att lägga till programmet.
...
3. **[Skapa en testanvändare Moxi engagera](#creating-a-moxi-engage-test-user)**  – du har en motsvarighet för Britta Simon i Moxi engagera som är länkad till en Azure AD-representation av användaren.
...
3. På den **Moxi engagera domän och URL: er** avsnittet, utför följande steg:
    ...
    I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://svc.<moxiworks-integration-domain>/service/v1/auth/inbound/saml/aad`

    > [!NOTE] 
    > Det här värdet är inte verkliga. Uppdatera det här värdet med faktiska inloggnings-URL: en. Kontakta [Moxi engagera klienten supportteamet](mailto:support@moxiworks.com) att hämta det här värdet. 
...
6. Att konfigurera enkel inloggning på **Moxi engagera** sida, som du behöver skicka de hämtade **XML-Metadata för** till [Moxi engagera supportteamet](mailto:support@moxiworks.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
