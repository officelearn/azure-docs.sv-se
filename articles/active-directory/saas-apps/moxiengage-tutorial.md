...
1. Att konfigurera enkel inloggning på **Moxi engagera** sida, som du behöver skicka de hämtade **XML-Metadata för** till [Moxi engagera supportteamet](mailto:support@moxiworks.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
