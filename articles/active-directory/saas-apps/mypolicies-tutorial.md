...
4. På sidan **Konfigurera enkel inloggning med SAML** utför du följande steg:
    ...
    b. I textrutan **Svars-URL** skriver du in en URL med följande mönster: `https://<tenantname>.mypolicies.com/users/auth/saml/callback`
...
Att konfigurera enkel inloggning på **myPolicies** sida, som du behöver skicka de hämtade **certifikat (Base64)** och lämpliga kopierade URL: er från Azure portal för att [myPolicies supportteam](mailto:support@mypolicies.com). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
