...
2. **[Konfigurera principer för enkel inloggning](#configure-mypolicies-single-sign-on)** för att konfigurera de enskilda Sign-On inställningar på program sidan.
...
### <a name="configure-mypolicies-single-sign-on"></a>Konfigurera principer för enkel Sign-On
...
När du klickar på panelen för principer i åtkomst panelen, bör du loggas in automatiskt på de principer som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
