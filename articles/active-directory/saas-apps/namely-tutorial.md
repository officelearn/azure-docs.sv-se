...
2. **[Konfigurera enkel inloggning](#configure-namely-single-sign-on)** för att konfigurera enskilda Sign-On inställningar på program sidan.
...
### <a name="configure-namely-single-sign-on"></a>Konfigurera enkla Sign-On
...
När du klickar på panelen ensamt i åtkomst panelen, bör du loggas in automatiskt på den så att du kan konfigurera SSO. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
