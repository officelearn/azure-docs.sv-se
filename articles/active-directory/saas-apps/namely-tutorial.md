---
title: 'Självstudier: Azure Active Directory-integration med nämligen | Microsoft Docs'
...
ms.locfileid: "39445111"
---
# <a name="tutorial-azure-active-directory-integration-with-namely"></a>Självstudier: Azure Active Directory-integration med nämligen
...
1. På den **nämligen domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<subdomain>.namely.com`

    b. I den **identifierare** textrutan anger du ett URL med hjälp av följande mönster: `https://<subdomain>.namely.com/saml/metadata`

    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska inloggnings-URL och identifierare. Kontakta [nämligen klienten supportteamet](https://www.namely.com/contact/) att hämta dessa värden. 
