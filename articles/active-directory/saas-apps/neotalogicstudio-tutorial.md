...
4. I sökrutan skriver **Neota Logic Studio**.

    ![Skapa en Azure AD-användare för testning](./media/neotalogicstudio-tutorial/tutorial_neotalogicstudio_search.png)

5. I resultatpanelen väljer **Neota Logic Studio**, och klicka sedan på **Lägg till** för att lägga till programmet.
...
3. **[Skapa en testanvändare Neota Logic Studio](#creating-a-neota-logic-studio-test-user)**  – du har en motsvarighet för Britta Simon i Neota Logic Studio som är länkad till en Azure AD-representation av användaren.
...
3. På den **Neota Logic Studio domän och URL: er** avsnittet, utför följande steg:

    ![Konfigurera enkel inloggning](./media/neotalogicstudio-tutorial/tutorial_neotalogicstudio_url.png)

    a. I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<sub domain>.neotalogic.com/a/<sub application>`

    b. I den **identifierare** textrutan anger du ett URL med hjälp av följande mönster: `https://<sub domain>.neotalogic.com/wb`

    > [!NOTE] 
    > Dessa värden är inte verkligt. Uppdatera dessa värden med faktiska inloggnings-URL och identifierare. Här föreslår vi att du för att använda det unika värdet av strängen i identifierare. Kontakta [Neota Logic Studia supportteamet](https://www.neotalogic.com/contact-us/) att hämta dessa värden. 
...
6. För att få SSO konfigurerats för ditt program kan kontakta [Neota Logic Studio support](https://www.neotalogic.com/contact-us/) team och ge dem med hämtade **XML-Metadata för** fil.
