...
När du klickar på panelen Neota Logic Studio på åtkomst panelen, bör du loggas in automatiskt på Neota Logic Studio som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
