...
1. När du definierar användarens profil kontrollerar du att användarens **e-postadress (personlig)** matchar användar namnet för Azure AD: username@companydomain.extension . Exempelvis `B.Simon@contoso.com`.
...
1. Få åtkomst till URL: en för **Netvision kompositioner** . Exempelvis `https://tenant.compas.cloud`.
