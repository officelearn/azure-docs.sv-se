...
1. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    `https://rpm.newrelic.com/accounts/{acc_id}/sso/saml/login`– Var noga med att `acc_id` ersätta med ditt eget konto-ID för nya Relic efter konto.
