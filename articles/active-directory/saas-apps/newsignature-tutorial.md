...
4. I sökrutan skriver **Cloud Management Portal för Microsoft Azure**.

    ![Skapa en Azure AD-användare för testning](./media/newsignature-tutorial/tutorial_newsignature_search.png)

5. I resultatpanelen väljer **Cloud Management Portal för Microsoft Azure**, och klicka sedan på **Lägg till** för att lägga till programmet.
...
3. **[Skapa en Cloud Management Portal för Microsoft Azure testanvändare](#creating-a-cloud-management-portal-for-microsoft-azure-test-user)**  – du har en motsvarighet för Britta Simon i Cloud Management Portal för Microsoft Azure som är länkad till en Azure AD-representation av användaren.
...
3. På den **Cloud Management Portal för Microsoft Azure-domänen och URL: er** avsnittet, utför följande steg:
...
6. På den **Cloud Management Portal för Microsoft Azure Configuration** klickar du på **konfigurera Cloud Management Portal för Microsoft Azure** att öppna **konfigurera inloggning** fönstret. Kopiera den **URL för utloggning, SAML entitets-ID och SAML enkel inloggning för tjänst-URL** från den **Snabbreferens avsnittet.**

    ![Konfigurera enkel inloggning](./media/newsignature-tutorial/tutorial_newsignature_configure.png) 

7. Att konfigurera enkel inloggning på **Cloud Management Portal för Microsoft Azure** sida, som du behöver skicka de hämtade **certifikat**, **URL: en för utloggning**,  **Enkel inloggning för tjänsten URL för SAML** och **SAML entitets-ID** till [Cloud Management Portal för Microsoft Azure-supportteamet](mailto:jczernuszka@newsignature.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
...
2. I listan med program väljer **Cloud Management Portal för Microsoft Azure**.
