...
1. På den **Nexonia domän och URL: er** avsnittet, utför följande steg:
    ...
    > [!NOTE] 
    > Värdet för svars-URL:en är inte verkligt. Uppdatera värdet för med den faktiska svars-URL:en. Kontakta [Nexonia supportteamet](https://nexonia.zendesk.com/hc/requests/new) att hämta värdet.
 
1. På den **SAML-signeringscertifikat** klickar du på **certifikat (Base64)** och spara certifikatfilen på datorn.

    ![Länk för nedladdning av certifikatet](./media/nexonia-tutorial/tutorial_nexonia_certificate.png) 

1. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning – knappen Spara](./media/nexonia-tutorial/tutorial_general_400.png)
