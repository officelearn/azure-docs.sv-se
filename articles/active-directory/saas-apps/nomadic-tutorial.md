---
title: 'Självstudier: Azure Active Directory-integration med Nomadic | Microsoft Docs'
...
ms.locfileid: "39046387"
---
# <a name="tutorial-azure-active-directory-integration-with-nomadic"></a>Självstudier: Azure Active Directory-integration med Nomadic
...
3. **[Skapa en Nomadic testanvändare](#create-a-nomadic-test-user)**  – du har en motsvarighet för Britta Simon i Nomadic som är länkad till en Azure AD-representation av användaren.
...
3. På den **Nomadic domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<company name>.nomadic.fm/signin`
    ...
    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska inloggnings-URL och identifierare. Kontakta [Nomadic klienten supportteamet](mailto:help@nomadic.fm) att hämta dessa värden. 
...
5. Klicka på **spara** knappen.
    ...
    ![Konfigurera enkel inloggning spara-knapp](./media/nomadic-tutorial/tutorial_general_400.png)

6.  För att få SSO konfigurerats för ditt program kan kontakta [Nomadic supportteamet](mailto:help@nomadic.fm) och ge dem med de hämtade **metadata**.
