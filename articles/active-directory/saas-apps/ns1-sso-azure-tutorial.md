...
1. Välj **Ange ytterligare URL: er**och utför följande steg om du vill konfigurera programmet i **SP** -initierat läge:
    ...
    > [!NOTE]
    > Svars-URL-värdet är inte verkligt. Uppdatera värdet för svars-URL med den faktiska svars-URL:en. Kontakta [ns1 SSO för Azure client support-teamet](mailto:techops@nsone.net) för att hämta värdet. Du kan även se de mönster som visas i avsnittet **Grundläggande SAML-konfiguration** i Azure-portalen.
