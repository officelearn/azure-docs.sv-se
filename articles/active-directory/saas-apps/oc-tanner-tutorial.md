---
title: 'Självstudier: Azure Active Directory-integration med O.C. Turesson - AppreciateHub | Microsoft Docs'
...
ms.locfileid: "39438713"
---
# <a name="tutorial-azure-active-directory-integration-with-oc-tanner---appreciatehub"></a>Självstudier: Azure Active Directory-integration med O.C. Turesson - AppreciateHub
...
- EN O.C. Turesson - AppreciateHub enkel inloggning aktiverat prenumeration
...
1. På den **O.C. Turesson - AppreciateHub domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **svars-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<companyname>.octanner.net/sp/ACS.saml2`
...
Målet med det här avsnittet är att skapa en användare som kallas Britta Simon i O.C. Turesson - AppreciateHub.
...
I det här avsnittet ska aktivera du Britta Simon att använda Azure enkel inloggning genom att bevilja åtkomst till O.C. Turesson - AppreciateHub.
