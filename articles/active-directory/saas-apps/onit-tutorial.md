...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/onit-tutorial/tutorial_onit_samlbase.png)

3. På den **Onit domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och Onit domän med enkel inloggning information](./media/onit-tutorial/tutorial_onit_url.png)
...
4. På den **SAML-signeringscertifikat** avsnittet, kopiera den **TUMAVTRYCKET** värdet för certifikatet.
    ...
    ![Länken hämta certifikatet](./media/onit-tutorial/tutorial_onit_certificate.png) 
...
7. Klicka på **spara** knappen.
    ...
    ![Konfigurera enkel inloggning spara](./media/onit-tutorial/tutorial_general_400.png)
