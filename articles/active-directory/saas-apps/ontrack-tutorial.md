...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/ontrack-tutorial/tutorial_ontrack_samlbase.png)

3. På den **OnTrack domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och OnTrack domän med enkel inloggning information](./media/ontrack-tutorial/tutorial_ontrack_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/ontrack-tutorial/tutorial_ontrack_certificate.png)
...
7. Klicka på **spara** knappen.
    ...
    ![Konfigurera enkel inloggning spara](./media/ontrack-tutorial/tutorial_general_400.png)
