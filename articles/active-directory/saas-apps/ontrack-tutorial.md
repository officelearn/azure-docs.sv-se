...
1. Att konfigurera enkel inloggning på **OnTrack** sida, som du behöver skicka de hämtade **XML-Metadata för** till [OnTrack supportteamet](mailto:CustomerService@insigniagroup.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
