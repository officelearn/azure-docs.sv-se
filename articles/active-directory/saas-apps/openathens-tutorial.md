---
title: 'Självstudie: Azure Active Directory integrering med openaten | Microsoft Docs'
...
ms.locfileid: "72933987"
---
# <a name="tutorial-azure-active-directory-integration-with-openathens"></a>Självstudie: Azure Active Directory integrering med openaten
...
När du klickar på OpenAthens-panelen i åtkomstpanelen bör du automatiskt loggas in på OpenAthens som du har konfigurerat enkel inloggning för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
