---
title: 'Självstudiekurs: Azure Active Directory single sign-on (SSO) integration med OpenAthens | Microsoft-dokument'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-openathens"></a>Självstudiekurs: Azure Active Directory-integrering med enkel inloggning (SSO) med OpenAs

I den här självstudien får du lära dig hur du integrerar OpenAthens med Azure Active Directory (Azure AD). När du integrerar OpenAss med Azure AD kan du:

* Kontroll i Azure AD som har åtkomst till OpenAthens.
* Gör att användarna automatiskt loggas in på OpenAs med sina Azure AD-konton.
...
* OpenAthens enkel inloggning (SSO) aktiverad prenumeration.
...
1. Skriv **OpenAs** i sökrutan i avsnittet **Lägg till från galleriet.**
1. Välj **OpenAthens** från resultatpanelen och lägg sedan till appen. Vänta några sekunder medan appen läggs till i din klientorganisation.

## <a name="configure-and-test-azure-ad-single-sign-on-for-openathens"></a>Konfigurera och testa en azure AD-inloggning för OpenAs

Konfigurera och testa Azure AD SSO med OpenAthens med en testanvändare som heter **B.Simon**. För att SSO ska fungera måste du upprätta en länkrelation mellan en Azure AD-användare och den relaterade användaren i OpenAthens.

Om du vill konfigurera och testa Azure AD SSO med OpenAthens slutför du följande byggblock:

1. **[Konfigurera Azure AD SSO](#configure-azure-ad-sso)** – så att användarna kan använda den här funktionen.
    * **[Skapa en Azure AD-testanvändare](#create-an-azure-ad-test-user)** – för att testa azure AD-enkel inloggning med B.Simon.
    * **[Tilldela Azure AD-testanvändaren](#assign-the-azure-ad-test-user)** - så att B.Simon kan använda azure AD-enkel inloggning.
1. **[Konfigurera OpenAthens SSO](#configure-openathens-sso)** - för att konfigurera de enskilda inloggningsinställningarna på programsidan.
    * **[Skapa OpenAthens testanvändare](#create-openathens-test-user)** - om du vill ha en motsvarighet till B.Simon i OpenAthens som är länkad till Azure AD-representationen av användaren.
...
1. I [Azure-portalen](https://portal.azure.com/)hittar du avsnittet **Hantera** på sidan **OpenAthens-programintegration** och väljer **enkel inloggning**.
...
1. Kopiera lämpliga webbadresser baserat på dina krav i avsnittet **Konfigurera OpenAthens.**
...
I det här avsnittet aktiverar du B.Simon att använda Azure enkel inloggning genom att bevilja åtkomst till OpenAthens.

1. I Azure-portalen väljer du **Enterprise Applications**och väljer sedan **Alla program**.
1. Välj **OpenAthens**i programlistan .
...
## <a name="configure-openathens-sso"></a>Konfigurera OpenAthens SSO

1. I ett annat webbläsarfönster loggar du in på webbplatsen OpenAthens som administratör.
...
1. Utför följande steg under fliken **Information**.
    ...
    b. I textrutan **Attribut för visningsnamn** fyller du i värdet `http://schema.microsoft.com/identity/claims/displayname`.
...
- [Prova OpenAthens med Azure AD](https://aad.portal.azure.com/)