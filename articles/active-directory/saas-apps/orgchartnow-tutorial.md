...
Att konfigurera enkel inloggning på **Organisationsschema nu** sida, som du behöver skicka de hämtade **XML-Metadata för Federation** och lämpliga kopierade URL: er från Azure portal för att [Organisationsschema nu support-teamet ](mailto:ocnsupport@officeworksoftware.com). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
