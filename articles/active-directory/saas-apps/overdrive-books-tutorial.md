...
1. På den **högre växel för datadrivet domän och URL: er** avsnittet, utför följande steg:
    ...
    I textrutan **Inloggnings-URL** anger du en URL med följande mönster: `http://<subdomain>.libraryreserve.com`

    > [!NOTE] 
    > Värdet är inte verkligt. Uppdatera värdet med den faktiska inloggnings-URL:en. Kontakta [högre växel för datadrivet klienten supportteamet](https://help.overdrive.com/) att hämta värdet. 
...
1. Att konfigurera enkel inloggning på **högre växel för datadrivet** sida, som du behöver skicka de hämtade **XML-Metadata för** till [högre växel för datadrivet supportteamet](https://help.overdrive.com/). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
