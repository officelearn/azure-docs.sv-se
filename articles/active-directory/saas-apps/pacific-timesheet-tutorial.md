---
title: 'Självstudier: Azure Active Directory-integration med Pacific tidrapporter | Microsoft Docs'
...
1. På den **Pacific tidrapporter domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **identifierare** textrutan anger du ett URL med hjälp av följande mönster: `https://<InstanceID>.pacifictimesheet.com/timesheet/home.do`
