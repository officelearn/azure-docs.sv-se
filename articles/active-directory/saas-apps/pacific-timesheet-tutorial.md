...
2. **[Konfigurera enkel inloggning för Pacific-tidrapporten](#configure-pacific-timesheet-single-sign-on)** – konfigurera enskilda Sign-On inställningar på program sidan.
...
### <a name="configure-pacific-timesheet-single-sign-on"></a>Konfigurera en enskild Sign-On Pacific-tidrapport
...
När du klickar på panelen Pacific-tidrapport i åtkomst panelen, bör du loggas in automatiskt på den Pacific-tidrapport som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
