...
4. I sökrutan skriver **PagerDuty**väljer **PagerDuty** resultatet-panelen klickar **Lägg till** för att lägga till programmet.
    ...
    ![Skapa en testanvändare i Azure AD](./media/pagerduty-tutorial/tutorial_pagerduty_addfromgallery.png)
...
3. På den **PagerDuty domän och URL: er** avsnittet, utför följande steg:
    ...
    ![URL: er och PagerDuty domän med enkel inloggning information](./media/pagerduty-tutorial/tutorial_pagerduty_url.png)
...
5. Klicka på **spara** knappen.
    ...
    ![Konfigurera enkel inloggning spara](./media/pagerduty-tutorial/tutorial_general_400.png)
...
3. Klicka på **lägga till användare**.
    ...
    ![Lägg till användare](./media/pagerduty-tutorial/ic778539.png "lägga till användare")
