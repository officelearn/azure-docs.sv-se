...
4. I sökrutan skriver **Palo Alto nätverk - GlobalProtect**väljer **Palo Alto nätverk - GlobalProtect** resultatet-panelen klickar **Lägg till** för att lägga till programmet .
    ...
    ![Palo Alto nätverk - GlobalProtect i resultatlistan](./media/paloaltoglobalprotect-tutorial/tutorial_paloaltoglobal_addfromgallery.png)
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/paloaltoglobalprotect-tutorial/tutorial_paloaltoglobal_samlbase.png)

3. På den **Palo Alto nätverk - URL: er och GlobalProtect domän** avsnittet, utför följande steg:

    ![Palo Alto nätverk - GlobalProtect domän och URL: er enkel inloggning information](./media/paloaltoglobalprotect-tutorial/tutorial_paloaltoglobal_url.png)
...
6. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/paloaltoglobalprotect-tutorial/tutorial_paloaltoglobal_certificate.png) 

7. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/paloaltoglobalprotect-tutorial/tutorial_general_400.png)
...
2. Välj i listan med program **Palo Alto nätverk - GlobalProtect**.
    ...
    ![Palo Alto-nätverk – GlobalProtect länken i listan med program](./media/paloaltoglobalprotect-tutorial/tutorial_paloaltoglobal_app.png)  
