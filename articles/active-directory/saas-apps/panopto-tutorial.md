...
2. **[Konfigurera Panopto enkel inloggning](#configure-panopto-single-sign-on)** – om du vill konfigurera de enskilda Sign-On inställningarna på program sidan.
...
När du klickar på panelen Panopto på åtkomst panelen, bör du loggas in automatiskt på den Panopto som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
