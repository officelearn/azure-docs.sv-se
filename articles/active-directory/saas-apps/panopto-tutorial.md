...
1. På den **Panopto domän och URL: er** avsnittet, utför följande steg:
    ...
    I textrutan **Inloggnings-URL** anger du en URL med följande mönster: `https://<tenant-name>.panopto.com`

    > [!NOTE] 
    > Det här värdet är inte verkligt. Uppdatera värdet med den faktiska inloggnings-URL:en. Kontakta [Panopto klienten supportteamet](mailto:support@panopto.com‎) att hämta det här värdet. 
