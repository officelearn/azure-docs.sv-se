---
title: 'Självstudier: Azure Active Directory-integration med PatentSQUARE | Microsoft Docs'
...
ms.locfileid: "39041213"
---
# <a name="tutorial-azure-active-directory-integration-with-patentsquare"></a>Självstudier: Azure Active Directory-integration med PatentSQUARE
...
3. **[Skapa en testanvändare PatentSQUARE](#create-a-patentsquare-test-user)**  – du har en motsvarighet för Britta Simon i PatentSQUARE som är länkad till en Azure AD-representation av användaren.
...
3. På den **PatentSQUARE domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<companysubdomain>.pat-dss.com:443/patlics/secure/aad`

    b. I den **identifierare** textrutan anger du ett URL med hjälp av följande mönster: `https://<companysubdomain>.pat-dss.com:443/patlics`
...
5. Klicka på **spara** knappen.
    ...
    ![Konfigurera enkel inloggning spara-knapp](./media/patentsquare-tutorial/tutorial_general_400.png)

6. Att konfigurera enkel inloggning på **PatentSQUARE** sida, som du behöver skicka de hämtade **XML-Metadata för** till [PatentSQUARE supportteamet](https://www.panasonic.com/jp/business/its/patentsquare.html). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
