...
1. Att konfigurera enkel inloggning på **PatentSQUARE** sida, som du behöver skicka de hämtade **XML-Metadata för** till [PatentSQUARE supportteamet](https://www.panasonic.com/jp/business/its/patentsquare.html). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
