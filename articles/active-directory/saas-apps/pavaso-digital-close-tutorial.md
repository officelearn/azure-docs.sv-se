---
title: 'Självstudiekurs: Azure Active Directory-integrering med Pavaso Digital Close | Microsoft-dokument'
...
ms.locfileid: "73160230"
---
# <a name="tutorial-azure-active-directory-integration-with-pavaso-digital-close"></a>Självstudiekurs: Azure Active Directory-integrering med Pavaso Digital Close
...
4. Om du vill konfigurera programmet i **IDP-initierat** läge i avsnittet **Grundläggande SAML-konfiguration** gör du följande:
    ...
    a. Skriv en URL med följande mönster i textrutan **Identifierare:**`https://<SUBDOMAIN>.pavaso.com/AuthServices`

    b. Skriv en URL med följande mönster i textrutan **Svara URL:**`https://<SUBDOMAIN>.pavaso.com/AuthServices/Acs`
