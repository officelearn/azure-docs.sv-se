...
4. I sökrutan skriver **personer**.
    ...
    ![Skapa en testanvändare i Azure AD](./media/people-tutorial/tutorial_people_search.png)

5. Välj i resultatpanelen **personer**, och klicka sedan på **Lägg till** för att lägga till programmet.

    ![Skapa en testanvändare i Azure AD](./media/people-tutorial/tutorial_people_addfromgallery.png)
...
3. På den **personer domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textruta Skriv en URL med följande mönster:  `https://<company name>.peoplehr.net`

    b. I den **identifierare** textruta anger du URL: `https://www.peoplehr.com`
    ...
    > [!NOTE]
    > Dessa värden är inte verkliga. Uppdatera dessa värden med den faktiska Reply URL och inloggnings-URL. Kontakta [personer klienten supportteamet](mailto:customerservices@peoplehr.com) att hämta dessa värden. 
...
1. I den **Azure-portalen**, klicka på det vänstra navigeringsfönstret **Azure Active Directory** ikon.
    ...
    ![Skapa en testanvändare i Azure AD](./media/people-tutorial/create_aaduser_01.png) 

2. Om du vill visa en lista över användare, gå till **användare och grupper** och på **alla användare**.
    
    ![Skapa en testanvändare i Azure AD](./media/people-tutorial/create_aaduser_02.png) 

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i dialogrutan.
 
    ![Skapa en testanvändare i Azure AD](./media/people-tutorial/create_aaduser_03.png) 

4. På den **användaren** dialogrutan utför följande steg:
 
    ![Skapa en testanvändare i Azure AD](./media/people-tutorial/create_aaduser_04.png) 
