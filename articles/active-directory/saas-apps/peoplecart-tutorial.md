...
3. På den **Peoplecart domän och URL: er** avsnittet, utför följande steg:
    ...
    ![URL: er och Peoplecart domän med enkel inloggning information](./media/peoplecart-tutorial/tutorial_peoplecart_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/peoplecart-tutorial/tutorial_peoplecart_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/peoplecart-tutorial/tutorial_general_400.png)
