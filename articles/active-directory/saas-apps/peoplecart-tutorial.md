...
1. Att konfigurera enkel inloggning på **Peoplecart** sida, som du behöver skicka de hämtade **XML-Metadata för** och **SAML enkel inloggning för tjänst-URL** till [Peoplecart supportteam](https://peoplecart.com/ContactUs.aspx). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
