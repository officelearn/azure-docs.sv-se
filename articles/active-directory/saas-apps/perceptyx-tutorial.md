...
2. **[Konfigurera PERCEPTYX SSO](#configure-perceptyx-sso)** – om du vill konfigurera inställningar för enskilda Sign-On på program sidan.
...
När du väljer panelen Perceptyx på åtkomst panelen, bör du loggas in automatiskt på den Perceptyx som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
