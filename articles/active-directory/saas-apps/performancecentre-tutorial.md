---
title: 'Självstudier: Azure Active Directory-integration med PerformanceCentre | Microsoft Docs'
...
ms.locfileid: "39428187"
---
# <a name="tutorial-azure-active-directory-integration-with-performancecentre"></a>Självstudier: Azure Active Directory-integration med PerformanceCentre
...
1. På den **PerformanceCentre domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `http://companyname.performancecentre.com/saml/SSO`

    b. I den **identifierare** textrutan anger du ett URL med hjälp av följande mönster: `http://companyname.performancecentre.com`

    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska inloggnings-URL och identifierare. Kontakta [PerformanceCentre klienten supportteamet](https://www.performancecentre.com/contact-us/) att hämta dessa värden. 
