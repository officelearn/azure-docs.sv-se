...
Att konfigurera enkel inloggning på **Phraseanet** sida, som du behöver skicka de hämtade **XML-Metadata för Federation** och lämpliga kopierade URL: er från Azure portal för att [Phraseanet supportteamet](mailto:support@alchemy.fr). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
