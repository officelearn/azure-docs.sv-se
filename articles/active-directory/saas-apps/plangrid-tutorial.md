...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/plangrid-tutorial/tutorial_plangrid_samlbase.png)

3. På den **PlanGrid domän och URL: er** avsnittet, utför följande steg om du vill konfigurera programmet i **IDP** initierade läge:

    ![URL: er och PlanGrid domän med enkel inloggning information](./media/plangrid-tutorial/tutorial_plangrid_url1.png)
...
4. Kontrollera **visa avancerade inställningar för URL: en** och utför följande steg om du vill konfigurera programmet i **SP** initierade läge:
    ...
    ![URL: er och PlanGrid domän med enkel inloggning information](./media/plangrid-tutorial/tutorial_plangrid_url2.png)

    I den **inloggnings-URL** textruta anger du URL: `https://app.plangrid.com/login`

5. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.

    ![Länken hämta certifikatet](./media/plangrid-tutorial/tutorial_plangrid_certificate.png) 

6. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/plangrid-tutorial/tutorial_general_400.png)
