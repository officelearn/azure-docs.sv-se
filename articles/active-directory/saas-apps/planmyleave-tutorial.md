...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/planmyleave-tutorial/tutorial_planmyleave_samlbase.png)

3. På den **PlanMyLeave domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och PlanMyLeave domän med enkel inloggning information](./media/planmyleave-tutorial/tutorial_planmyleave_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/planmyleave-tutorial/tutorial_planmyleave_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/planmyleave-tutorial/tutorial_general_400.png)
