...
När du klickar på panelen Planview Enterprise One på åtkomst panelen, bör du loggas in automatiskt på den Planview Enterprise One som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
