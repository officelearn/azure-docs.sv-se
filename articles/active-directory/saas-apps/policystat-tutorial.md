...
4. I sökrutan skriver **PolicyStat**.
    ...
    ![Skapa en testanvändare i Azure AD](./media/policystat-tutorial/tutorial_policystat_search.png)

5. Välj i resultatpanelen **PolicyStat**, och klicka sedan på **Lägg till** för att lägga till programmet.

    ![Skapa en testanvändare i Azure AD](./media/policystat-tutorial/tutorial_policystat_addfromgallery.png)
...
9. Klicka på den **Admin** fliken och klicka sedan på **konfiguration för enkel inloggning** i vänstra navigeringsfönstret.
    ...
    ![Administratörsmenyn](./media/policystat-tutorial/ic808633.png "administratör-menyn")

10. I den **installationsprogrammet** väljer **aktivera enkel inloggning Integration**.
   
    ![Enkel inloggning Configuration](./media/policystat-tutorial/ic808634.png "enkel inloggning konfiguration")

11. Klicka på **Konfigurera attribut**, och sedan, i den **Konfigurera attribut** avsnittet, utför följande steg:
   
    ![Enkel inloggning Configuration](./media/policystat-tutorial/ic808635.png "enkel inloggning konfiguration")
...
12. Klicka på **din IDP Metadata**, och sedan, i den **din IDP Metadata** avsnittet, utför följande steg:
    ...
    ![Enkel inloggning Configuration](./media/policystat-tutorial/ic808636.png "enkel inloggning konfiguration")
...
1. I den **Azure-portalen**, klicka på det vänstra navigeringsfönstret **Azure Active Directory** ikon.
    ...
    ![Skapa en testanvändare i Azure AD](./media/policystat-tutorial/create_aaduser_01.png) 

2. Om du vill visa en lista över användare, gå till **användare och grupper** och på **alla användare**.
    
    ![Skapa en testanvändare i Azure AD](./media/policystat-tutorial/create_aaduser_02.png) 

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i dialogrutan.
 
    ![Skapa en testanvändare i Azure AD](./media/policystat-tutorial/create_aaduser_03.png) 

4. På den **användaren** dialogrutan utför följande steg:
 
    ![Skapa en testanvändare i Azure AD](./media/policystat-tutorial/create_aaduser_04.png) 
