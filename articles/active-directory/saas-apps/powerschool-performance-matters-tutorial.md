...
Att konfigurera enkel inloggning på **Powerschool prestanda frågor** sida, som du behöver skicka de hämtade **XML-Metadata för Federation** och lämpliga kopieras URL: er från Azure portal för att [ Powerschool prestanda frågor supportteam](mailto:pmsupport@powerschoo.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
