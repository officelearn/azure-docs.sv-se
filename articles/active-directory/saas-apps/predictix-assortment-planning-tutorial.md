...
3. **[Skapa en testanvändare Predictix sortimentet planera](#create-a-predictix-assortment-planning-test-user)**  – du har en motsvarighet för Britta Simon Predictix sortimentet planerar som är länkad till en Azure AD-representation av användaren.
...
3. På den **Predictix sortimentet Planera domän och URL: er** avsnittet, utför följande steg:
...
6. På den **Predictix sortimentet planera konfigurationen** klickar du på **konfigurera Predictix sortimentet planera** att öppna **konfigurera inloggning** fönster. Kopiera den **URL för utloggning, SAML entitets-ID och SAML enkel inloggning för tjänst-URL** från den **Snabbreferens avsnittet.**
