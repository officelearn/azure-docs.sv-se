---
title: 'Självstudier: Azure Active Directory-integration med Predictix ordning | Microsoft Docs'
...
1. På den **Predictix ordning domän och URL: er** avsnittet, utför följande steg:
    ...
    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska inloggnings-URL och identifierare. Kontakta [Predictix ordning klienten supportteamet](https://www.predix.io/support/) att hämta dessa värden. 
 
1. På den **SAML-signeringscertifikat** klickar du på **certifikat (Base64)** och spara certifikatfilen på datorn.

    ![Länk för hämtning av certifikat](./media/predictixordering-tutorial/tutorial_predictixordering_certificate.png) 

1. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara-knapp](./media/predictixordering-tutorial/tutorial_general_400.png)
...
1. Att konfigurera enkel inloggning på **Predictix ordning** sida, som du behöver skicka de hämtade **certifikat (Base64)**, **URL för utloggning, SAML entitets-ID och SAML enkel inloggning för tjänst-URL** till [Predictix ordning supportteamet](https://www.predix.io/support/). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
