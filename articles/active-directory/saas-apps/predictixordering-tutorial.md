...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/predictixordering-tutorial/tutorial_predictixordering_samlbase.png)

3. På den **Predictix beställa domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och Predictix beställa domän med enkel inloggning information](./media/predictixordering-tutorial/tutorial_predictixordering_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **certifikat (Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/predictixordering-tutorial/tutorial_predictixordering_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/predictixordering-tutorial/tutorial_general_400.png)
