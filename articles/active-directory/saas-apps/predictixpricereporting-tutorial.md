...
ms.date: 08/08/2017
ms.author: jeedes
ms.openlocfilehash: 730fc5c67b4284123a7a03d5e7c76452727bb009
...
4. I sökrutan skriver **Predictix pris Reporting**väljer **Predictix pris Reporting** resultatet-panelen klickar **Lägg till** för att lägga till programmet.
    ...
    ![Predictix pris rapportering i resultatlistan](./media/predictixpricereporting-tutorial/tutorial_predictixpricereporting_addfromgallery.png)
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/predictixpricereporting-tutorial/tutorial_predictixpricereporting_samlbase.png)

3. På den **Predictix pris Reporting domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och Predictix pris Reporting domän med enkel inloggning information](./media/predictixpricereporting-tutorial/tutorial_predictixpricereporting_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **certifikat (Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/predictixpricereporting-tutorial/tutorial_predictixpricereporting_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/predictixpricereporting-tutorial/tutorial_general_400.png)
...
2. Välj i listan med program **Predictix pris Reporting**.
    ...
    ![Länken Predictix pris rapportering i listan med program](./media/predictixpricereporting-tutorial/tutorial_predictixpricereporting_app.png)  
