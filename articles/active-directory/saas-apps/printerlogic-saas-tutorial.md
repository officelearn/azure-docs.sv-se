...
## <a name="configure-and-test-azure-ad-single-sign-on-for-printerlogic-saas"></a>Konfigurera och testa enkel inloggning med Azure AD för PrinterLogic-SaaS
...
Om du vill konfigurera och testa Azure AD SSO med PrinterLogic SaaS slutför du följande Bygg stenar:
...
1. I [Azure Portal](https://portal.azure.com/)på sidan **PrinterLogic SaaS** Application Integration letar du upp avsnittet **Hantera** och väljer **enkel inloggning**.
...
1. I avsnittet **grundläggande SAML-konfiguration** , om du vill konfigurera programmet i **IDP** initierat läge, anger du värdena för följande fält:
    ...
    a. I textrutan **Identifierare** skriver du en URL med följande mönster: `https://gw.app.printercloud.com/<my_instance>/authn/idp/azuread/saml2/metadata`

    b. I textrutan **Svars-URL** skriver du en URL med följande mönster: `https://gw.app.printercloud.com/<my_instance>/authn/idp/azuread/saml2/acs`

1. Klicka på **Ange ytterligare URL:er** och gör följande om du vill konfigurera appen i **SP**-initierat läge:

    I textrutan **Inloggnings-URL** skriver du en URL med följande mönster: `https://www.<my_instance>printercloud.com`
...
När du klickar på panelen PrinterLogic SaaS på åtkomst panelen, bör du loggas in automatiskt på PrinterLogic-SaaS som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
