---
title: 'Självstudier: Azure Active Directory-integration med Printix | Microsoft Docs'
...
ms.locfileid: "39437030"
---
# <a name="tutorial-azure-active-directory-integration-with-printix"></a>Självstudier: Azure Active Directory-integration med Printix
...
1. På den **Printix domän och URL: er** avsnittet, utför följande steg:
    ...
    I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<subdomain>.printix.net`

    > [!NOTE] 
    > Värdet är inte verkliga. Uppdatera värdet med faktiska inloggnings-URL: en. Kontakta [Printix klienten supportteamet](mailto:support@printix.net) att hämta värdet. 
...
Det finns inga uppgift åt dig i det här avsnittet. En ny användare har skapats under ett försök att komma åt Printix om det inte finns ännu. 
