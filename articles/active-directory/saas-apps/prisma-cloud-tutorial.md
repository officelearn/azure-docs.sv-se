...
När du klickar på Prisma för molnets SSO-panel på åtkomst panelen, bör du loggas in automatiskt till Prisma-molnets SSO för vilken du ställer in SSO. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
