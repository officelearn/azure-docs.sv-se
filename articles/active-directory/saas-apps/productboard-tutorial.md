---
title: 'Självstudie: Azure Active Directory integrering med productboard | Microsoft Docs'
...
1. I avsnittet **grundläggande SAML-konfiguration** , om du vill konfigurera programmet i **IDP** initierat läge, anger du värdena för följande fält:
    ...
    Skriv en URL i text rutan **svars-URL** med följande mönster:  `https://<projectname>.productboard.com/users/auth/saml/callback`

1. Klicka på **Ange ytterligare URL:er** och gör följande om du vill konfigurera appen i **SP**-initierat läge:

    I text rutan **inloggnings-URL** skriver du en URL med följande mönster:  `https://<projectname>.productboard.com/`
...
1. På sidan **Konfigurera en enskild Sign-On med SAML** , i avsnittet **SAML-signeringscertifikat** , klickar du på Kopiera för att kopiera **URL för metadata för app Federation** och spara den på din dator.
...
1. Om du vill automatisera konfigurationen i productboard måste du installera **Mina appar säker inloggnings webb läsar tillägg** genom att klicka på **installera tillägget**.

    ![Mina Apps-tillägg](common/install-myappssecure-extension.png)

1. När du har lagt till tillägget i webbläsaren klickar du på **Konfigurera productboard**, som leder dig till productboard-programmet. Därifrån anger du administratörsautentiseringsuppgifter för att logga in på productboard. Webb läsar tillägget kommer automatiskt att konfigurera programmet åt dig.

    ![Konfigurera konfiguration](common/setup-sso.png)

1. Om du vill konfigurera enkel inloggning på **productboard**  manuellt måste du skicka **URL: en för appens Federations-metadata** till [support teamet för productboard](mailto:support@productboard.com). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.

### <a name="create-productboard-test-user"></a>Skapa productboard test användare

I det här avsnittet skapas en användare som kallas Britta Simon i productboard. productboard stöder just-in-Time-etablering, som är aktiverat som standard. Det finns inget åtgärdsobjekt för dig i det här avsnittet. Om en användare inte redan finns i productboard skapas en ny efter autentiseringen.

### <a name="test-sso"></a>Testa SSO

I det här avsnittet testar du konfigurationen för enkel inloggning Azure AD med hjälp av åtkomstpanelen.

När du klickar på panelen productboard på åtkomst panelen, bör du loggas in automatiskt på den productboard som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
...
- [Prova productboard med Azure AD](https://aad.portal.azure.com/)