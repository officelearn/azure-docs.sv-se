...
När du väljer panelen Profit.co på åtkomst panelen, bör du loggas in automatiskt på den Profit.co som du ställer in SSO för. Mer information finns i [Introduktion till åtkomst panelen](../user-help/my-apps-portal-end-user-access.md).
...
- [Så här skyddar du Profit.co med avancerad synlighet och kontroller](/cloud-app-security/proxy-intro-aad)