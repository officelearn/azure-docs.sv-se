...
1. Att konfigurera enkel inloggning på **Projectplace** sida, som du behöver skicka de hämtade **XML-Metadata för** till [Projectplace-supportteamet](https://success.planview.com/Projectplace/Support). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
