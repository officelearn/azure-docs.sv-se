...
* Du kan aktivera användarna att vara automatiskt inloggad till Projectplace (Single Sign-On) med sina Azure AD-konton.
...
* Projectplace enkel inloggning aktiverat prenumeration

## <a name="scenario-description"></a>Scenariobeskrivning

I den här självstudien konfigurerar och testar du enkel inloggning med Azure AD i en testmiljö.

* Har stöd för Projectplace **SP** -initierad SSO
...
4. I sökrutan skriver **Projectplace**väljer **Projectplace** resultatet panelen klickar **Lägg till** för att lägga till programmet.

     ![Projectplace i resultatlistan](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurera och testa enkel inloggning med Azure AD

I det här avsnittet ska du konfigurera och testa Azure AD enkel inloggning med Projectplace baserat på en testanvändare kallas **Britta Simon**.
För enkel inloggning ska fungera, måste en länk förhållandet mellan en Azure AD-användare och relaterade användaren i Projectplace upprättas.
...
2. **[Konfigurera Projectplace Single Sign-On](#configure-projectplace-single-sign-on)**  – om du vill konfigurera inställningar för enkel inloggning på programsidan.
3. **[Skapa en Azure AD-testanvändare](#create-an-azure-ad-test-user)** – för att testa enkel inloggning med Azure AD med Britta Simon.
4. **[Tilldela Azure AD-testanvändaren](#assign-the-azure-ad-test-user)** – så att Britta Simon kan använda enkel inloggning med Azure AD.
5. **[Skapa testanvändare Projectplace](#create-projectplace-test-user)**  – du har en motsvarighet för Britta Simon i Projectplace som är länkad till en Azure AD-representation av användaren.
...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    ![Projectplace-domän och URL: er med enkel inloggning för information](common/sp-signonurl.png)

    I textrutan **Inloggnings-URL** skriver du in en URL med följande mönster: `https://<company>.projectplace.com`

    > [!NOTE]
    > Värdet är inte verkligt. Uppdatera värdet med den faktiska inloggnings-URL:en. Kontakta [Projectplace klienten supportteamet](https://success.planview.com/Projectplace/Support) att hämta värdet. Du kan även se mönstren som visas i avsnittet **Grundläggande SAML-konfiguration** i Azure-portalen.

5. På sidan **Set up Single Sign-On with SAML** (Konfigurera enkel inloggning med SAML) går du till avsnittet **SAML Signing Certificate** (SAML-signeringscertifikat), klickar på **Ladda ned** för att ladda ned **Federation Metadata-XML** från de angivna alternativen enligt dina behov och spara den på datorn.

    ![Länk för nedladdning av certifikatet](common/metadataxml.png)

6. På den **konfigurera Projectplace** avsnittet, kopiera den lämpliga URL: er enligt dina behov.
...
### <a name="configure-projectplace-single-sign-on"></a>Konfigurera Projectplace Single Sign-On

Att konfigurera enkel inloggning på **Projectplace** sida, som du behöver skicka de hämtade **XML-Metadata för Federation** och lämpliga kopierade URL: er från Azure portal för att [Projectplace-supportteamet ](https://success.planview.com/Projectplace/Support). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
...
2. I listan med program väljer **Projectplace**.
    ...
    ![Projectplace-länk i listan med program](common/all-applications.png)
