...
ms.date: 06/29/2017
ms.author: jeedes
ms.openlocfilehash: 0709d599dfa862128722a1f66d554ac45d948f3a
ms.sourcegitcommit: c851842d113a7078c378d78d94fea8ff5948c337
ms.translationtype: MT
ms.contentlocale: sv-SE
ms.lasthandoff: 06/18/2018
ms.locfileid: "35968858"
---
...
4. I sökrutan skriver **Projectplace**.
    ...
    ![Skapa en testanvändare i Azure AD](./media/projectplace-tutorial/tutorial_projectplace_search.png)

5. Välj i resultatpanelen **Projectplace**, och klicka sedan på **Lägg till** för att lägga till programmet.

    ![Skapa en testanvändare i Azure AD](./media/projectplace-tutorial/tutorial_projectplace_addfromgallery.png)
...
1. I den **Azure-portalen**, klicka på det vänstra navigeringsfönstret **Azure Active Directory** ikon.
    ...
    ![Skapa en testanvändare i Azure AD](./media/projectplace-tutorial/create_aaduser_01.png) 

2. Om du vill visa en lista över användare, gå till **användare och grupper** och på **alla användare**.
    
    ![Skapa en testanvändare i Azure AD](./media/projectplace-tutorial/create_aaduser_02.png) 

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i dialogrutan.
 
    ![Skapa en testanvändare i Azure AD](./media/projectplace-tutorial/create_aaduser_03.png) 

4. På den **användaren** dialogrutan utför följande steg:
 
    ![Skapa en testanvändare i Azure AD](./media/projectplace-tutorial/create_aaduser_04.png) 
...
3. Klicka på **lägga till medlem**.
    ...
    ![Lägga till medlemmar](./media/projectplace-tutorial/ic790232.png "lägga till medlemmar")
