---
title: 'Självstudie: Azure Active Directory integration med enkel inloggning (SSO) med Prolorus | Microsoft Docs'
description: Lär dig hur du konfigurerar enkel inloggning mellan Azure Active Directory och Prolorus.
...
I den här självstudien får du lära dig hur du integrerar Prolorus med Azure Active Directory (Azure AD). När du integrerar Prolorus med Azure AD kan du:

* Kontroll i Azure AD som har åtkomst till Prolorus.
...
* Prolorus stöder **SP** -INITIERAd SSO

## <a name="adding-prolorus-from-the-gallery"></a>Lägga till Prolorus från galleriet

Om du vill konfigurera integreringen av Prolorus i Azure AD måste du lägga till Prolorus från galleriet i listan över hanterade SaaS-appar.
...
1. **[Konfigurera PROLORUS SSO](#configure-prolorus-sso)** – för att konfigurera inställningarna för enkel inloggning på program sidan.
    1. **[Skapa Prolorus test User](#create-prolorus-test-user)** -om du vill ha en motsvarighet till B. Simon i Prolorus som är länkad till Azure AD-representation av användare.
...
1. I avsnittet **grundläggande SAML-konfiguration** anger du värden för följande fält:
    ...
    a. I text rutan **inloggnings-URL** skriver du en URL med följande mönster: `https://<SUBDOMAIN>.prolorus.app/Login`

    b. I textrutan **Identifierare (entitets-ID)** anger du en URL enligt följande mönster: `https://<SUBDOMAIN>.prolorus.app`
...
1. I avsnittet **Konfigurera Prolorus** kopierar du lämpliga URL: er baserat på ditt krav.
...
I det här avsnittet skapar du en användare som heter Britta Simon i Prolorus. Arbeta med [Prolorus support team](mailto:infrastructure@prolorus.com) för att lägga till användare i Prolorus-plattformen. Användare måste skapas och aktiveras innan du använder enkel inloggning.

## <a name="test-sso"></a>Testa SSO 

I det här avsnittet ska du testa Azure AD-konfigurationen för enkel inloggning med följande alternativ. 

1. Klicka på **testa det här programmet** i Azure Portal. Detta omdirigeras till Prolorus-inloggnings-URL där du kan starta inloggnings flödet. 

2. Gå till Prolorus-inloggnings-URL: en direkt och starta inloggnings flödet därifrån.

3. Du kan använda Microsoft Access-panelen. När du klickar på panelen Prolorus i åtkomst panelen omdirigeras den till Prolorus-inloggnings-URL. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).

## <a name="next-steps"></a>Nästa steg

När du har konfigurerat Prolorus kan du genomdriva session Control, som skyddar exfiltrering och intrånget för organisationens känsliga data i real tid. Kontroll av sessionen sträcker sig från villkorlig åtkomst. [Lär dig hur du tvingar fram en session med Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-any-app).