---
title: 'Självstudier: Självstudier: Azure Active Directory enkel inloggning (SSO) med ProNovos Analytics | Microsoft Docs'
...
1. Klicka på **Ange ytterligare URL:er** och gör följande om du vill konfigurera appen i **SP**-initierat läge:
    ...
    I rutan **Inloggnings-URL** anger du en URL: `https://analytics.pronovos.com/Pronovos/servlet/mstrWeb`
...
Om du vill konfigurera enkel inloggning på **ProNovos Analytics** -sidan måste du skicka det hämtade **certifikatet (RAW)** och lämpliga kopierade url: er från Azure Portal till [support teamet för ProNovos Analytics](mailto:support@pronovos.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
...
När du klickar på panelen ProNovos Analytics på åtkomst panelen, bör du loggas in automatiskt till den ProNovos-analys som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
