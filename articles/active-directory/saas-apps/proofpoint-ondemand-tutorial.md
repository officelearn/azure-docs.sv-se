---
title: 'Självstudiekurs: Azure Active Directory-integrering med Proofpoint on Demand | Microsoft-dokument'
...
---
# <a name="tutorial-azure-active-directory-integration-with-proofpoint-on-demand"></a>Självstudiekurs: Azure Active Directory-integrering med Proofpoint on Demand
...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    a. Skriv en URL med hjälp av följande mönster i textrutan **Sign-on-URL:**`https://<hostname>.pphosted.com/ppssamlsp_hostname`

    b. Skriv en URL med följande mönster i rutan **Identifierare:**`https://<hostname>.pphosted.com/ppssamlsp`

    c. Skriv en URL med följande mönster i textrutan **Svara URL:**`https://<hostname>.pphosted.com:portnumber/v1/samlauth/samlconsumer`
