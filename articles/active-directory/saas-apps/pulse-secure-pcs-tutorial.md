...
1. Utför följande steg på sidan inställningar:
    ...
    e. Välj URL-värde för Azure AD-inloggning i **list rutan URL för enkel inloggning för identitetsprovider**.
...
3. Du kan använda Microsoft Access-panelen. När du klickar på panelen för säkra säkra datorer på åtkomst panelen omdirigeras det till Pulse Secure PCs inloggnings-URL. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
