...
2. Utför följande steg på dialog sidan **Skapa ny användare** .
    ...
    ![Användarvänlig](./media/velpicsaml-tutorial/velpic_8.png)
    ...
    d. Skriv e-postadressen till B.Simon@contoso.com-konto i text rutan för **e-post** .
...
När du klickar på panelen PurelyHR på åtkomst panelen, bör du loggas in automatiskt på den PurelyHR som du ställer in SSO för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
