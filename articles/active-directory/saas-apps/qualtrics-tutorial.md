---
title: 'Självstudier: Azure Active Directory-integration med Qualtrics | Microsoft Docs'
...
3. **[Skapa en testanvändare Qualtrics](#create-a-qualtrics-test-user)**  – du har en motsvarighet för Britta Simon i Qualtrics som är länkad till en Azure AD-representation av användaren.
...
3. På den **Qualtrics domän och URL: er** avsnittet, utför följande steg:
    ...
    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska inloggnings-URL och identifierare. Kontakta [Qualtrics klienten supportteamet](https://www.qualtrics.com/support/) att hämta dessa värden.
...
5. Klicka på **spara** knappen.
    ...
    ![Konfigurera enkel inloggning spara-knapp](./media/qualtrics-tutorial/tutorial_general_400.png)

6. Att konfigurera enkel inloggning på **Qualtrics** sida, som du behöver skicka de hämtade **XML-Metadata för** till [Qualtrics supportteam](https://www.qualtrics.com/support/). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
