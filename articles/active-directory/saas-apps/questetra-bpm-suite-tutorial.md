...
2. **[Konfigurera QUESTETRA BPM Suite Single Sign-on](#configure-questetra-bpm-suite-single-sign-on)** -för att konfigurera de enskilda Sign-On inställningarna på program sidan.
...
### <a name="configure-questetra-bpm-suite-single-sign-on"></a>Konfigurera Questetra BPM Suite Single Sign-On
...
När du klickar på panelen Questetra BPM Suite på åtkomst panelen, bör du loggas in automatiskt till Questetra BPM Suite som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
