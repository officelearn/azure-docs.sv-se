...
När du klickar på panelen Raketa på åtkomst panelen, bör du loggas in automatiskt på den Raketa som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
...
- [Så här skyddar du Raketa med avancerad synlighet och kontroller](/cloud-app-security/proxy-intro-aad)