...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/realtimeboard-tutorial/tutorial_realtimeboard_samlbase.png)

3. På den **RealtimeBoard domän och URL: er** om du vill konfigurera programmet i **IDP** initierade läge:

    ![URL: er och RealtimeBoard domän med enkel inloggning information](./media/realtimeboard-tutorial/tutorial_realtimeboard_url.png)
...
5. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/realtimeboard-tutorial/tutorial_realtimeboard_certificate.png) 

6. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/realtimeboard-tutorial/tutorial_general_400.png)
