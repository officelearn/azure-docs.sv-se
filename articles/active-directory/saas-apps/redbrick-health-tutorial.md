---
title: 'Självstudier: Azure Active Directory-integrering med enkel inloggning (SSO) med RedBrick-hälsa | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-redbrick-health"></a>Självstudier: Azure Active Directory enkel inloggning (SSO) med RedBrick-hälsa
...
För att konfigurera enkel inloggning på **RedBrick Health**-sidan behöver du skicka det nedladdade **certifikatet (Base64)** och lämpliga kopierade URL:er från Azure-portalen till [supportteamet för RedBrick Health](https://home.redbrickhealth.com/contact/). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
