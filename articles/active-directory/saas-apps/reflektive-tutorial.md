...
6. Klicka på **spara** knappen.
    ...
    ![Konfigurera enkel inloggning – knappen Spara](./media/reflektive-tutorial/tutorial_general_400.png)

7. Att konfigurera enkel inloggning på **Reflektive** sida, som du behöver skicka de hämtade **XML-Metadata för** till [Reflektive supportteamet](https://support@reflektive.com). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
