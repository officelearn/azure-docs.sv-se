---
title: 'Självstudier: Azure Active Directory enkel inloggning (SSO) med RENRAKU | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-renraku"></a>Självstudier: Azure Active Directory enkel inloggning (SSO) med RENRAKU
...
1. I avsnittet **grundläggande SAML-konfiguration** anger du värden för följande fält:
    ...
    > [!NOTE]
    > Dessa värden är inte verkliga. Uppdatera de här värdena med faktisk inloggnings-URL och identifierare. Kontakta [RENRAKU client support team](https://phoneappli.net/product/contact/) för att hämta dessa värden. Du kan även se mönstren som visas i avsnittet **Grundläggande SAML-konfiguration** i Azure-portalen.
...
Om du vill konfigurera enkel inloggning på **RENRAKU** sida måste du skicka det hämtade **certifikatet (RAW)** och lämpliga kopierade url: er från Azure Portal till [support teamet för RENRAKU](https://phoneappli.net/product/contact/). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
...
När du klickar på panelen RENRAKU på åtkomst panelen, bör du loggas in automatiskt på den RENRAKU som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
