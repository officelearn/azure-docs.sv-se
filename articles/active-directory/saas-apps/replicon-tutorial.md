...
2. **[Konfigurera REPLICON SSO](#configure-replicon-sso)** – om du vill konfigurera inställningar för enskilda Sign-On på program sidan.
...
När du väljer panelen Replicon på åtkomst panelen, bör du loggas in automatiskt på den Replicon som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
