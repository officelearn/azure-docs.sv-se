...
När du klickar på panelen Skriv ut – artikel galax på åtkomst panelen, bör du loggas in automatiskt på den Skriv bords-artikel Galaxy som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Så här skyddar du utskriften av skriv bord – artikel Galaxy med avancerad synlighet och kontroller](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)
