...
1. Du kan använda Microsoft Mina appar. När du klickar på panelen RetrieverMediaDatabase i Mina appar, bör du loggas in automatiskt på den RetrieverMediaDatabase som du ställer in SSO för. Mer information om Mina appar finns i [Introduktion till Mina appar](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
