...
Att konfigurera enkel inloggning på **Reviewsnap** sida, som du behöver skicka de hämtade **certifikat (Base64)** och lämpliga kopierade URL: er från Azure portal för att [Reviewsnap supportteamet](mailto:support@reviewsnap.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
