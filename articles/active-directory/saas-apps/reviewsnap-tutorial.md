...
3. **[Skapa en testanvändare Reviewsnap](#create-a-reviewsnap-test-user)**  – du har en motsvarighet för Britta Simon i Reviewsnap som är länkad till en Azure AD-representation av användaren.
...
7. På den **Reviewsnap Configuration** klickar du på **konfigurera Reviewsnap** att öppna **konfigurera inloggning** fönster. Kopiera den **URL för utloggning, SAML entitets-ID och SAML enkel inloggning för tjänst-URL** från den **Snabbreferens avsnittet.**

    ![Reviewsnap konfiguration](./media/reviewsnap-tutorial/tutorial_reviewsnap_configure.png) 

8. Att konfigurera enkel inloggning på **Reviewsnap** sida, som du behöver skicka de hämtade **certifikat (Base64), URL: en för utloggning, SAML entitets-ID och SAML enkel inloggning för tjänst-URL** till [Reviewsnap supportteam](mailto:support@reviewsnap.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
