---
title: 'Självstudier: Azure Active Directory-integration med RolePoint | Microsoft Docs'
...
ms.locfileid: "39439704"
---
# <a name="tutorial-azure-active-directory-integration-with-rolepoint"></a>Självstudier: Azure Active Directory-integration med RolePoint
...
1. På den **RolePoint domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<subdomain>.rolepoint.com/login`
    
    b. I den **identifierare** textrutan anger du ett URL med hjälp av följande mönster: `https://app.rolepoint.com/<instancename>`

    > [!NOTE] 
    > Dessa värden är inte verkligt. Uppdatera dessa värden med faktiska inloggnings-URL och identifierare. Här vi föreslår att du för att använda det unika värdet av strängen i Identifier.Contact [RolePoint supportteamet](mailto:info@rolepoint.com) att hämta värdet. 
