...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    a. I textrutan **Inloggnings-URL** skriver du en URL enligt följande mönster: `https://<subdomain>.rolepoint.com/login`
...
Att konfigurera enkel inloggning på **RolePoint** sida, som du behöver skicka de hämtade **XML-Metadata för Federation** och lämpliga kopierade URL: er från Azure portal för att [RolePoint supportteamet](mailto:info@rolepoint.com). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
