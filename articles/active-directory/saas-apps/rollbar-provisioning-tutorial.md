---
title: 'Självstudier: Konfigurera Rollbar för automatisk användar etablering med Azure Active Directory | Microsoft Docs'
...
ms.locfileid: "68707661"
---
# <a name="tutorial-configure-rollbar-for-automatic-user-provisioning"></a>Självstudier: Konfigurera Rollbar för automatisk användar etablering
