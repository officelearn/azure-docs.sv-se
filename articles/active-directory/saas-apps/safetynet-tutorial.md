...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/safetynet-tutorial/tutorial_safetynet_samlbase.png)
...
3. På den **SafetyNet domän och URL: er** avsnittet, utför följande steg om du vill konfigurera programmet i **IDP** initierade läge:
    ...
    ![URL: er och SafetyNet domän med enkel inloggning information](./media/safetynet-tutorial/tutorial_safetynet_url.png)
...
4. Kontrollera **visa avancerade inställningar för URL: en** och utför följande steg om du vill konfigurera programmet i **SP** initierade läge:
    ...
    ![URL: er och SafetyNet domän med enkel inloggning information](./media/safetynet-tutorial/tutorial_safetynet_url1.png)
...
5. På den **SAML-signeringscertifikat** klickar du på kopieringsknappen för att kopiera **webbadress Federation Metadata** och klistra in den i anteckningar.
    ...
    ![Länken hämta certifikatet](./media/safetynet-tutorial/tutorial_safetynet_certificate.png)

6. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/safetynet-tutorial/tutorial_general_400.png)
...
2. Välj i listan med program **SafetyNet**.
    ...
    ![Länken SafetyNet i listan med program](./media/safetynet-tutorial/tutorial_safetynet_app.png)  
