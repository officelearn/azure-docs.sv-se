...
ms.date: 05/16/2018
ms.author: jeedes
ms.openlocfilehash: 337c1cb822b4cf05e4a5581b453befb499099b1a
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/salesforce-tutorial/tutorial_salesforce_samlbase.png)

3. På den **Salesforce-domänen och URL: er** avsnittet, utför följande steg:

    ![URL: er och Salesforce-domän med enkel inloggning information](./media/salesforce-tutorial/tutorial_salesforce_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **certifikat** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/salesforce-tutorial/tutorial_salesforce_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/salesforce-tutorial/tutorial_general_400.png)
...
2. Välj i listan med program **Salesforce**.
    ...
    ![Salesforce-länken i listan med program](./media/salesforce-tutorial/tutorial_salesforce_app.png)
