---
title: 'Självstudiekurs: Azure Active Directory-integrering med SAML 1.1 Token enabled LOB App | Microsoft-dokument'
...
---
# <a name="tutorial-azure-active-directory-integration-with-saml-11-token-enabled-lob-app"></a>Självstudiekurs: Azure Active Directory-integrering med SAML 1.1 Token enabled LOB App
