...
5. I resultatpanelen väljer **SAML SSO för antal samverkande resolution GmbH**, och klicka sedan på **Lägg till** för att lägga till programmet.
...
3. **[Skapa en SAML SSO för växer samman av lösning GmbH testanvändare](#creating-a-saml-sso-for-confluence-by-resolution-gmbh-test-user)**  – du har en motsvarighet för Britta Simon i SAML SSO för antal samverkande resolution GmbH som är länkad till en Azure AD-representation av användaren.
...
7. Logga in på i ett annat webbläsarfönster din **SAML SSO för växer samman av lösning GmbH administrationsportalen** som administratör.
...
9. Du omdirigeras till sidan för administratörsåtkomst. Ange lösenordet och klicka på **Bekräfta** knappen.

    ![Konfigurera enkel inloggning](./media/samlssoconfluence-tutorial/addon2.png)

10. Under **ATLASSIANS MARKETPLACE** fliken **hitta nya tillägg**. 

    ![Konfigurera enkel inloggning](./media/samlssoconfluence-tutorial/addon.png)

11. Sök **SAML enkel inloggning (SSO) för antal samverkande** och klicka på **installera** knappen för att installera den nya SAML-plugin-programmet.

    ![Konfigurera enkel inloggning](./media/samlssoconfluence-tutorial/addon7.png)

12. Installationen av plugin-programmet startas. Klicka på **Stäng**.
...
16. På **SAML SingleSignOn plugin-programmet Configuration** klickar du på **lägga till nya IDP: N** knappen för att konfigurera inställningarna för identitetsprovidern.

    ![Konfigurera enkel inloggning](./media/samlssoconfluence-tutorial/addon4.png)

17. På **väljer SAML-identitetsprovider** utför följande steg:
...
20. På **användar-ID-attribut och omvandling** klickar du på **nästa** knappen.

    ![Konfigurera enkel inloggning](./media/samlssoconfluence-tutorial/addon5d.png)
    
21. På **skapa användare och uppdatera** klickar du på **Spara & nästa** att spara inställningarna.   
    
    ![Konfigurera enkel inloggning](./media/samlssoconfluence-tutorial/addon6a.png)
    
22. På **testa dina inställningar** klickar du på **hoppa över testet och konfigurera manuellt** att hoppa över användare testet just nu. Detta kommer att utföras i nästa avsnitt och kräver en del inställningar i Azure-portalen. 
    
    ![Konfigurera enkel inloggning](./media/samlssoconfluence-tutorial/addon6b.png)
    
23. I dialogrutan-läsning apprearing **hoppar över testning innebär...** , klickar du på **OK**.
...
2. I listan med program väljer **SAML SSO för antal samverkande resolution GmbH**.
