...
10. Att konfigurera enkel inloggning på **Sansan** sida, som du behöver skicka de hämtade **certifikat**, **URL: en för utloggning**, **SAML entitets-ID**, och **SAML enkel inloggning för tjänst-URL** till [Sansan supportteamet](https://www.sansan.com/form/contact). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
