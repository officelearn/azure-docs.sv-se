...
6. Gör följande i avsnittet **Användarattribut** i dialogrutan **Användarattribut och anspråk**:
    ...
    ![mallar](./media/saphana-tutorial/tutorial_usermail.png)

    ![mallar](./media/saphana-tutorial/tutorial_usermailedit.png)
...
När du klickar på SAP HANA-panelen i åtkomstpanelen så bör du automatiskt loggas in på den SAP HANA som du har konfigurerat enkel inloggning för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
