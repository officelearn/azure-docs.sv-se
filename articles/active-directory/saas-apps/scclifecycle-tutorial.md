...
2. **[Konfigurera SCC livs cykel enkel inloggning](#configure-scc-lifecycle-single-sign-on)** – så här konfigurerar du inställningarna för enkel inloggning på program sidan.
...
### <a name="configure-scc-lifecycle-single-sign-on"></a>Konfigurera enkel inloggning för SCC-livscykel
...
När du klickar på panelen SCC livs cykel i åtkomst panelen, bör du loggas in automatiskt på den SCC-livscykel som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
