...
Att konfigurera enkel inloggning på **SCC livscykel** sida, som du behöver skicka de hämtade **XML-Metadata för** och lämpliga kopierade URL: er från Azure portal för att [SCC livscykel supportteamet](mailto:lifecycle.support@scc.com). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
