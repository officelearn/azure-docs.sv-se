...
4. I sökrutan skriver **SciQuest tillbringar Director**väljer **SciQuest tillbringar Director** resultatet-panelen klickar **Lägg till** för att lägga till programmet.
    ...
    ![SciQuest tillbringar Director i resultatlistan](./media/sciquest-spend-director-tutorial/tutorial_sciquestspenddirector_addfromgallery.png)
...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/sciquest-spend-director-tutorial/tutorial_sciquestspenddirector_samlbase.png)

3. På den **SciQuest tillbringar Director domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och SciQuest tillbringar Director domän med enkel inloggning information](./media/sciquest-spend-director-tutorial/tutorial_sciquestspenddirector_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/sciquest-spend-director-tutorial/tutorial_sciquestspenddirector_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/sciquest-spend-director-tutorial/tutorial_general_400.png)
...
2. Välj i listan med program **SciQuest tillbringar Director**.
    ...
    ![Länken SciQuest tillbringar Director i listan med program](./media/sciquest-spend-director-tutorial/tutorial_sciquestspenddirector_app.png)  
