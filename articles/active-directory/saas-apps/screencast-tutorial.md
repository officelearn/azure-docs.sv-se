...
1. I avsnittet **grundläggande SAML-konfiguration** anger du värden för följande fält:
    ...
    I textrutan **Inloggnings-URL** skriver du en URL med följande mönster: `https://screencast-o-matic.com/<InstanceName>`

    > [!NOTE]
    > Värdet är inte verkligt. Uppdatera värdet med den faktiska inloggnings-URL:en. Kontakta skärm bilds fönstret [-O-Matic](mailto:support@screencast-o-matic.com) för att hämta värdet. Du kan även se de mönster som visas i avsnittet **Grundläggande SAML-konfiguration** i Azure-portalen.
