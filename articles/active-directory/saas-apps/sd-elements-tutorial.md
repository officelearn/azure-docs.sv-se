...
1. På den **SD element domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **identifierare** textrutan anger du ett URL med hjälp av följande mönster: `https://<tenantname>.sdelements.com/sso/saml2/metadata`

    b. I den **svars-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<tenantname>.sdelements.com/sso/saml2/acs/`

    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska identifierare och svars-URL. Kontakta [SD element supportteam](mailto:support@sdelements.com) att hämta dessa värden.

1. SD element program som förväntar SAML-intyg i ett visst format. Konfigurera följande anspråk för det här programmet. Du kan hantera värdena för dessa attribut från den **”användarattribut”** fliken av programmet. Följande skärmbild visar ett exempel för detta.
