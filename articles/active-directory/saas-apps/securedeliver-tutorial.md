---
title: 'Självstudier: Azure Active Directory-integration med säkra leverera | Microsoft Docs'
...
ms.locfileid: "39448405"
---
# <a name="tutorial-azure-active-directory-integration-with-secure-deliver"></a>Självstudier: Azure Active Directory-integration med säkra leverera
...
1. På den **säkert leverera domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<companyname>.i-securedeliver.jp/sd/<tenantname>/jsf/login/sso`

    b. I den **identifierare** textrutan anger du ett URL med hjälp av följande mönster: `https://<companyname>.i-securedeliver.jp/sd/<tenantname>/postResponse`

    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska inloggnings-URL och identifierare. Kontakta [säkert leverera klienten supportteamet](mailto:iw-sd-support@fujifilm.com) att hämta dessa värden. 
...
1. Att konfigurera enkel inloggning på **säkert leverera** sida, som du behöver skicka de hämtade **certifikat (Base64)**, **URL för utloggning, SAML entitets-ID och SAML enkel inloggning för tjänst-URL** till [säkert leverera supportteamet](mailto:iw-sd-support@fujifilm.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
