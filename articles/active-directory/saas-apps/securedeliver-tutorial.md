...
Att konfigurera enkel inloggning på **säkert leverera** sida, som du behöver skicka de hämtade **certifikat (Base64)** och lämpliga kopierade URL: er från Azure portal för att [säkert leverera support-teamet ](mailto:iw-sd-support@fujifilm.com). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
