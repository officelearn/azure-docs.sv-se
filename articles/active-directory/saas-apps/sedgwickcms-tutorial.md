...
2. **[Konfigurera SEDGWICK CMS enkel inloggning](#configure-sedgwick-cms-single-sign-on)** – så här konfigurerar du inställningarna för enkel inloggning på program sidan.
...
### <a name="configure-sedgwick-cms-single-sign-on"></a>Konfigurera enkel inloggning för Sedgwick CMS
...
När du klickar på panelen Sedgwick CMS på åtkomst panelen, bör du loggas in automatiskt på den Sedgwick-CMS som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
