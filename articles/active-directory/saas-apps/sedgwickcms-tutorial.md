---
title: 'Självstudier: Azure Active Directory-integration med Sedgwick CMS | Microsoft Docs'
...
3. **[Skapa en testanvändare Sedgwick CMS](#create-a-sedgwick-cms-test-user)**  – du har en motsvarighet för Britta Simon i Sedgwick CMS som är länkad till en Azure AD-representation av användaren.
...
3. På den **Sedgwick CMS domän och URL: er** avsnittet, utför följande steg:
    ...
    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska identifierare och svars-URL. Kontakta [Sedgwick CMS-supportteamet](https://www.sedgwick.com/help) att hämta dessa värden.
...
6. Att konfigurera enkel inloggning på **Sedgwick CMS** sida, som du behöver skicka de hämtade **XML-Metadata för** till [Sedgwick CMS-supportteamet](https://www.sedgwick.com/contact/Pages/contactform.aspx). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
