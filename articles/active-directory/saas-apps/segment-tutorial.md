...
1. Utför följande steg på följande sida:
    ...
    a. Kopiera **URL-värdet för enkel inloggning** och klistra in det i rutan **svars-URL** i dialog rutan **grundläggande SAML-konfiguration** i Azure Portal.
