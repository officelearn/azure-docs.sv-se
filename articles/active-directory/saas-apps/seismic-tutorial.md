...
För att konfigurera enkel inloggning på **Seismic**-sidan behöver du skicka det nedladdade **certifikatet (Base64)** och lämpliga kopierade URL:er från Azure-portalen till [supportteamet för Seismic](mailto:support@seismic.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
