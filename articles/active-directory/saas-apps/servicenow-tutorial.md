...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/servicenow-tutorial/tutorial_servicenow_samlbase.png)

3. På den **ServiceNow domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och ServiceNow-domän med enkel inloggning information](./media/servicenow-tutorial/tutorial_servicenow_url.png)
...
4. På den **SAML-signeringscertifikat** avsnittet, utför följande steg: 
    ...
    ![Länken hämta certifikatet](./media/servicenow-tutorial/tutorial_servicenow_certificate.png)
...
5. Klicka på **spara** knappen.
    ...
    ![Konfigurera enkel inloggning spara](./media/servicenow-tutorial/tutorial_general_400.png)
...
7. Aktivera den **integrering – flera enkel inloggning installationsprogrammet för providern** plugin-programmet genom att följa nästa steg:
    ...
    ![Aktivera plugin-programmet](./media/servicenow-tutorial/tutorial_servicenow_03.png "aktivera plugin-program")

     b. Sök efter **integrering – flera enkel inloggning installationsprogrammet för providern**.

     ![Aktivera plugin-programmet](./media/servicenow-tutorial/tutorial_servicenow_04.png "aktivera plugin-program")
...
Syftet med det här avsnittet är att skapa en användare som kallas Britta Simon i ServiceNow. ServiceNow stöder automatisk användaretablering, vilket är aktiverat som standard. Du hittar mer information [här](servicenow-provisioning-tutorial.md) om hur du konfigurerar automatisk användaretablering.
...
2. Välj i listan med program **ServiceNow**.
    ...
    ![Länken ServiceNow i listan med program](./media/servicenow-tutorial/tutorial_servicenow_app.png)  
