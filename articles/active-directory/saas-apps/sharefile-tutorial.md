...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/sharefile-tutorial/tutorial_sharefile_samlbase.png)

3. På den **Citrix ShareFile domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och Citrix ShareFile domän med enkel inloggning information](./media/sharefile-tutorial/tutorial_sharefile_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **certifikat (Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/sharefile-tutorial/tutorial_sharefile_certificate.png)

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/sharefile-tutorial/tutorial_general_400.png)
...
2. Välj i listan med program **Citrix ShareFile**.
    ...
    ![Länken Citrix ShareFile i listan med program](./media/sharefile-tutorial/tutorial_sharefile_app.png)  
