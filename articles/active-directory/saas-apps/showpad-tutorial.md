...
* Du kan aktivera användarna att vara automatiskt inloggad till Showpad (Single Sign-On) med sina Azure AD-konton.
...
* Showpad enkel inloggning aktiverat prenumeration

## <a name="scenario-description"></a>Scenariobeskrivning

I den här självstudien konfigurerar och testar du enkel inloggning med Azure AD i en testmiljö.

* Har stöd för Showpad **SP** -initierad SSO
* Har stöd för Showpad **Just In Time** etableringen av användare
...
4. I sökrutan skriver **Showpad**väljer **Showpad** resultatet panelen klickar **Lägg till** för att lägga till programmet.

    ![Showpad i resultatlistan](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurera och testa enkel inloggning med Azure AD

I det här avsnittet ska du konfigurera och testa Azure AD enkel inloggning med Showpad baserat på en testanvändare kallas **Britta Simon**.
För enkel inloggning ska fungera, måste en länk förhållandet mellan en Azure AD-användare och relaterade användaren i Showpad upprättas.
...
2. **[Konfigurera Showpad Single Sign-On](#configure-showpad-single-sign-on)**  – om du vill konfigurera inställningar för enkel inloggning på programsidan.
3. **[Skapa en Azure AD-testanvändare](#create-an-azure-ad-test-user)** – för att testa enkel inloggning med Azure AD med Britta Simon.
4. **[Tilldela Azure AD-testanvändaren](#assign-the-azure-ad-test-user)** – så att Britta Simon kan använda enkel inloggning med Azure AD.
5. **[Skapa testanvändare Showpad](#create-showpad-test-user)**  – du har en motsvarighet för Britta Simon i Showpad som är länkad till en Azure AD-representation av användaren.
...
1. I den [Azure-portalen](https://portal.azure.com/)på den **Showpad** application integration markerar **enkel inloggning**.
...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    ![Showpad domän och URL: er med enkel inloggning för information](common/sp-identifier.png)
    ...
    > [!NOTE]
    > Dessa värden är inte verkliga. Uppdatera de här värdena med faktisk inloggnings-URL och identifierare. Kontakta [Showpad klienten supportteamet](https://help.showpad.com/) att hämta dessa värden. Du kan även se mönstren som visas i avsnittet **Grundläggande SAML-konfiguration** i Azure-portalen.

5. På sidan **Set up Single Sign-On with SAML** (Konfigurera enkel inloggning med SAML) går du till avsnittet **SAML Signing Certificate** (SAML-signeringscertifikat), klickar på **Ladda ned** för att ladda ned **Federation Metadata-XML** från de angivna alternativen enligt dina behov och spara den på datorn.

    ![Länk för nedladdning av certifikatet](common/metadataxml.png)

6. På den **konfigurera Showpad** avsnittet, kopiera den lämpliga URL: er enligt dina behov.
...
1. Gå till **enkel inloggning** och klicka på **aktivera**.
...
1. I Azure-portalen väljer du **företagsprogram**väljer **alla program**och välj sedan **Showpad**.

    ![Bladet Företagsprogram](common/enterprise-applications.png)

2. I listan med program väljer **Showpad**.

    ![Länken Showpad i listan med program](common/all-applications.png)
...
### <a name="create-showpad-test-user"></a>Skapa Showpad testanvändare

I det här avsnittet skapas en användare som kallas Britta Simon i Showpad. Showpad stöder etableringen av just-in-time-användare som är aktiverat som standard. Det finns inget åtgärdsobjekt för dig i det här avsnittet. Om en användare inte redan finns i Showpad, skapas en ny efter autentisering.

### <a name="test-single-sign-on"></a>Testa enkel inloggning 

I det här avsnittet ska testa du Azure AD enkel inloggning för konfigurationen med hjälp av åtkomstpanelen.

När du klickar på panelen Showpad i åtkomstpanelen, bör det vara loggas in automatiskt till Showpad som du ställer in enkel inloggning. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
