...
5. I resultatpanelen väljer **Showpad**, och klicka sedan på **Lägg till** för att lägga till programmet.
...
3. **[Skapa en testanvändare Showpad](#creating-a-showpad-test-user)**  – du har en motsvarighet för Britta Simon i Showpad som är länkad till en Azure AD-representation av användaren.
...
6. Inloggning till Showpad-klienten som administratör.

7. Klicka på menyn längst upp i **inställningar**.
   
    ![Konfigurera enkel inloggning på App-sida](./media/showpad-tutorial/tutorial_showpad_001.png) 

8. Navigera till ”**enkel inloggning**” och klicka på ”**aktivera**”.
   
    ![Konfigurera enkel inloggning på App-sida](./media/showpad-tutorial/tutorial_showpad_002.png)

9. På den **lägga till en SAML 2.0-tjänst** dialogrutan utför följande steg:
