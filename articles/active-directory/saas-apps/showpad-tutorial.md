...
1. På den **Showpad domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I textrutan **Inloggnings-URL** anger du en URL med följande mönster: `https://<comapany-name>.showpad.biz/login`

    b. I textrutan **Identifierare** anger du en URL med följande mönster: `https://<company-name>.showpad.biz`

    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med faktisk inloggnings-URL och identifierare. Kontakta [Showpad supportteamet](https://help.showpad.com) att hämta dessa värden. 
