...
Att konfigurera enkel inloggning på **Shuccho Navi** sida, som du behöver skicka de hämtade **XML-Metadata för** och lämpliga kopierade URL: er från Azure portal för att [Shuccho Navi supportteamet](mailto:sys_ntabtm@nta.co.jp). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
