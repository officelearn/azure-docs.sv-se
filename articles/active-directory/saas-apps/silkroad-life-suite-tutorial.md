...
3. **[Skapa en testanvändare SilkRoad liv Suite](#create-a-silkroad-life-suite-test-user)**  – du har en motsvarighet för Britta Simon i SilkRoad liv Suite som är länkad till en Azure AD-representation av användaren.
...
3. På den **SilkRoad liv Suite domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<subdomain>.silkroad-eng.com/Authentication/`
    ...
    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska identifierare, svars-URL och inloggnings-URL. Kontakta [SilkRoad liv Suite klienten supportteamet](https://www.silkroad.com/locations/) att hämta dessa värden. 
...
5. Klicka på **spara** knappen.
    ...
    ![Konfigurera enkel inloggning spara-knapp](./media/silkroad-life-suite-tutorial/tutorial_general_400.png)
    
6. På den **SilkRoad liv Suite Configuration** klickar du på **konfigurera SilkRoad liv Suite** att öppna **konfigurera inloggning** fönster. Kopiera den **URL för utloggning, SAML entitets-ID och SAML enkel inloggning för tjänst-URL** från den **Snabbreferens avsnittet.**

    ![SilkRoad liv Suite-konfiguration](./media/silkroad-life-suite-tutorial/tutorial_silkroadlifesuite_configure.png) 

7. Inloggning till webbplatsen SilkRoad företag som administratör. 
...
11. Klicka på **lägga till autentiseringskälla**. 
   
    ![Azure AD enkel inloggning][13] 

12. I den **lägga till autentiseringskälla** avsnittet, utför följande steg: 
...
15. Inaktivera alla andra källor för autentisering. 
