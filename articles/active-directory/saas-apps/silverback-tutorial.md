...
2. **[Konfigurera Silverback-enkel inloggning](#configure-silverback-single-sign-on)** för att konfigurera inställningarna för enkel inloggning på program sidan.
