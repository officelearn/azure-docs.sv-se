...
I den här självstudien får du lära dig hur du integrerar skillport med Azure Active Directory (Azure AD).
Genom att integrera skillport med Azure AD får du följande fördelar:

* Du kan styra i Azure AD som har åtkomst till skillport.
* Du kan göra det möjligt för användarna att logga in automatiskt till skillport (enkel inloggning) med sina Azure AD-konton.
...
* Skillport-aktiverad prenumeration med enkel inloggning

## <a name="scenario-description"></a>Scenariobeskrivning

I den här självstudien konfigurerar och testar du enkel inloggning med Azure AD i en testmiljö.

* Skillport stöder **SP** -INITIERAd SSO

## <a name="adding-skillport-from-the-gallery"></a>Lägga till skillport från galleriet

Om du vill konfigurera integreringen av skillport i Azure AD måste du lägga till skillport från galleriet i listan över hanterade SaaS-appar.
...
4. I rutan Sök skriver du **skillport**, väljer **skillport** från resultat panelen och klickar sedan på **Lägg till** för att lägga till programmet.

    ![Skillport i resultat listan](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurera och testa enkel inloggning med Azure AD

I det här avsnittet konfigurerar och testar du enkel inloggning med Azure AD med skillport baserat på en test användare som kallas **Britta Simon**.
För att enkel inloggning ska fungera måste en länk relation mellan en Azure AD-användare och den relaterade användaren i skillport upprättas.

Om du vill konfigurera och testa enkel inloggning med skillport i Azure AD måste du slutföra följande Bygg stenar:

1. **[Konfigurera enkel inloggning med Azure AD](#configure-azure-ad-single-sign-on)** – så att användarna kan använda den här funktionen.
2. **[Konfigurera skillport enkel inloggning](#configure-skillport-single-sign-on)** – om du vill konfigurera de enskilda Sign-On inställningarna på program sidan.
3. **[Skapa en Azure AD-testanvändare](#create-an-azure-ad-test-user)** – för att testa enkel inloggning med Azure AD med Britta Simon.
4. **[Tilldela Azure AD-testanvändaren](#assign-the-azure-ad-test-user)** – så att Britta Simon kan använda enkel inloggning med Azure AD.
5. **[Skapa skillport test User](#create-skillport-test-user)** – om du vill ha en motsvarighet till Britta Simon i skillport som är länkad till Azure AD-representation av användare.
...
6. I avsnittet **Konfigurera skillport** kopierar du lämpliga URL: er enligt ditt krav.
...
2. I listan program väljer du **skillport**.

    ![Skillport-länken i program listan](common/all-applications.png)
...
När du klickar på panelen skillport på åtkomst panelen, bör du loggas in automatiskt på den skillport som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
