---
title: 'Självstudier: Azure Active Directory-integration med Skillport | Microsoft Docs'
...
ms.locfileid: "39046006"
---
# <a name="tutorial-azure-active-directory-integration-with-skillport"></a>Självstudier: Azure Active Directory-integration med Skillport
...
5. I resultatpanelen väljer **Skillport**, och klicka sedan på **Lägg till** för att lägga till programmet.
...
3. **[Skapa en testanvändare Skillport](#creating-a-skillport-test-user)**  – du har en motsvarighet för Britta Simon i Skillport som är länkad till en Azure AD-representation av användaren.
...
3. På den **Skillport domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textrutan anger du URL:
...
6. Att konfigurera enkel inloggning på **Skillport** sida, som du behöver skicka de hämtade **XML-Metadata för** till [Skillport supportteamet](https://www.skillsoft.com/contact.asp). De kan konfigurera den för att ha SAML SSO-anslutning som är korrekt inställda på båda sidorna.
