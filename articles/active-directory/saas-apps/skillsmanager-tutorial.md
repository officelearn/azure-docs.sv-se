...
1. Att konfigurera enkel inloggning på **kunskaper Manager** sida, som du behöver skicka de hämtade **Certificate(Base64)**, **URL för utloggning, SAML entitets-ID och SAML enkel inloggning för tjänst-URL** till [kunskaper Manager supportteamet](https://www.ibm.com/support/uk/?lnk=msu_uk). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
