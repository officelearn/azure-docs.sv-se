...
Att konfigurera enkel inloggning på **kunskaper Manager** sida, som du behöver skicka de hämtade **certifikat (Base64)** och lämpliga kopierade URL: er från Azure portal för att [kunskaper Manager support-teamet ](https://www.ibm.com/support/uk/?lnk=msu_uk). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
