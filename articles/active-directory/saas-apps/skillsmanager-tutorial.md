...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/skillsmanager-tutorial/tutorial_skillsmanager_samlbase.png)

3. På den **kunskaper Manager-domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och kunskaper Manager-domän med enkel inloggning information](./media/skillsmanager-tutorial/tutorial_skillsmanager_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **Certificate(Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/skillsmanager-tutorial/tutorial_skillsmanager_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/skillsmanager-tutorial/tutorial_general_400.png)
