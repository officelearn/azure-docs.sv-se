...
2. **[Konfigurera enkel inloggning för kunskaps hanteraren](#configure-skills-manager-single-sign-on)** för att konfigurera inställningarna för enkel inloggning på program sidan.
...
### <a name="configure-skills-manager-single-sign-on"></a>Konfigurera enkel inloggning för kunskaps hanteraren
...
När du klickar på panelen kompetens hanterare i åtkomst panelen, bör du loggas in automatiskt på den kunskaps hanterare som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
