...
2. **[Konfigurera SkyDesk E-mail Single Sign-on](#configure-skydesk-email-single-sign-on)** -för att konfigurera de enskilda Sign-On inställningarna på program sidan.
...
### <a name="configure-skydesk-email-single-sign-on"></a>Konfigurera SkyDesk e-post, enkel Sign-On
...
När du klickar på panelen för SkyDesk e-post på åtkomst panelen, bör du loggas in automatiskt på SkyDesk-e-postmeddelandet som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
