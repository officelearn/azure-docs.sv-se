...
Att konfigurera enkel inloggning på **Skytap** sida, som du behöver skicka de hämtade **XML-Metadata för Federation** och lämpliga kopierade URL: er från Azure portal för att [Skytap supportteamet](mailto:support@skytap.com). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
