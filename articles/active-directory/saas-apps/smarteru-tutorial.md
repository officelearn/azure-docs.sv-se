...
5. I resultatpanelen väljer **SmarterU**, och klicka sedan på **Lägg till** för att lägga till programmet.
...
3. **[Skapa en testanvändare SmarterU](#creating-a-smarteru-test-user)**  – du har en motsvarighet för Britta Simon i SmarterU som är länkad till en Azure AD-representation av användaren.
...
6. I ett annat webbläsarfönster logga du in på webbplatsen SmarterU företag som administratör.
