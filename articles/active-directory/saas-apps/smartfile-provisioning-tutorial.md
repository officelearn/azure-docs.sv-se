---
title: 'Självstudier: Konfigurera SmartFile för automatisk användar etablering med Azure Active Directory | Microsoft Docs'
...
ms.locfileid: "68775453"
---
# <a name="tutorial-configure-smartfile-for-automatic-user-provisioning"></a>Självstudier: Konfigurera SmartFile för automatisk användar etablering
...
5.  Under avsnittet **admin credentials** , inmatat `https://<SmartFile sitename>.smartfile.com/ftp/scim` i klient- **URL**. Ett exempel skulle se `https://demo1test.smartfile.com/ftp/scim`ut. Ange värdet för Bearer-token (ProductKey: ProductPassword) som du hämtade tidigare i **hemlig token**. Klicka på **Testa anslutning** för att se till att Azure AD kan ansluta till SmartFile. Om anslutningen Miss lyckas kontrollerar du att SmartFile-kontot har administratörs behörighet och försöker igen.
