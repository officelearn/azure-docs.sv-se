...
2. **[Konfigurera SOFTEON WMS Single Sign-on](#configure-softeon-wms-single-sign-on)** -för att konfigurera inställningarna för enkel inloggning på program sidan.
...
När du klickar på Softeon WMS-panelen på åtkomst panelen, bör du loggas in automatiskt på det Softeon WMS som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
