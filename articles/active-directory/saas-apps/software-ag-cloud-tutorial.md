...
3. Du kan använda Microsoft Access-panelen. När du klickar på panelen programs AG-moln på åtkomst panelen omdirigeras det till URL: en moln inloggnings-URL för Software AG. Mer information om åtkomst panelen finns i [Introduktion till åtkomst panelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
