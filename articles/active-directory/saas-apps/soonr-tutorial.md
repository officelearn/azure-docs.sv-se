...
2. **[Konfigurera enkel inloggning på arbets platsen](#configure-soonr-workplace-single-sign-on)** för att konfigurera enskilda Sign-On inställningar på program sidan.
...
### <a name="configure-soonr-workplace-single-sign-on"></a>Konfigurera ett Sign-On på arbets platsen i tidigare
...
När du klickar på panelen arbets plats i arbets ytan i åtkomst panelen, bör du loggas in automatiskt till den tidigare arbets ytan där du ställer in SSO. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
