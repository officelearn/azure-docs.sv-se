...
Att konfigurera enkel inloggning på **Soonr arbetsplats** sida, som du behöver skicka de hämtade **XML-Metadata för Federation** och lämpliga kopierade URL: er från Azure portal för att [Soonr arbetsplats support team](https://awp.autotask.net/help/). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
