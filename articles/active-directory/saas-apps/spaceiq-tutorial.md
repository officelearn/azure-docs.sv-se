...
2. **[Konfigurera SpaceIQ enkel inloggning](#configure-spaceiq-single-sign-on)** – om du vill konfigurera de enskilda Sign-On inställningarna på program sidan.
...
När du klickar på panelen SpaceIQ på åtkomst panelen, bör du loggas in automatiskt på den SpaceIQ som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
