...
Att konfigurera enkel inloggning på **Spacio** sida, som du behöver skicka den **Appfederationsmetadata** till [Spacio supportteamet](mailto:support@spac.io). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
