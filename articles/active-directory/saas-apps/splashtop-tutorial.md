...
1. I webb portalen för Splashtop går du till fliken **konto information** / **team** och bläddrar ned till avsnittet om att hitta **en enkel inloggning** . Klicka sedan på **Använd för ny SSO-metod**.
...
1. För certifikat information högerklickar du på den certifikat fil som hämtats från Splashtop-programmet på Azure Portal, redigerar den med anteckningar och kopierar sedan innehållet och klistrar in det i fältet **Hämta certifikat (base64)** .
    ...
    ![avbildning](media/splashtop-tutorial/cert-1.png) ![avbildning](media/splashtop-tutorial/cert-2.png) ![avbildning](media/splashtop-tutorial/azure-sso-2.png)
...
När du klickar på panelen Splashtop på åtkomst panelen, bör du loggas in automatiskt på den Splashtop som du ställer in SSO för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
