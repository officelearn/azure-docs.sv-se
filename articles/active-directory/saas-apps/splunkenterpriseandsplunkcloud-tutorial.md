...
När du klickar på panelen Splunk Enterprise och Splunk Cloud i åtkomstpanelen bör du loggas in automatiskt till Splunk Enterprise och Splunk Cloud som du ställer in enkel inloggning för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
