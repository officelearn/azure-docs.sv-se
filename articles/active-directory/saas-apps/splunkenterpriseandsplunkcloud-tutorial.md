---
title: 'Självstudiekurs: Azure Active Directory-integrering med Splunk Enterprise och Splunk Cloud | Microsoft-dokument'
...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    a. Skriv en URL med hjälp av följande mönster i textrutan **Sign-on-URL:**`https://<splunkserverUrl>/en-US/app/launcher/home`

    b. Skriv en URL med följande mönster i rutan **Identifierare:**`<splunkserverUrl>`
