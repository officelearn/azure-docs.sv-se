...
Om du vill konfigurera integreringen av SSOGEN – Azure AD SSO Gateway för Oracle E-Business Suite-EBS, liboch JDE i Azure AD, måste du lägga till SSOGEN-Azure AD SSO Gateway för Oracle E-Business Suite-EBS, och JDE från galleriet till din lista över hanterade er aaS-appar.
...
1. I avsnittet **grundläggande SAML-konfiguration** , om du vill konfigurera programmet i **IDP** initierat läge, anger du värdena för följande fält:
    ...
    I textrutan **Svars-URL** skriver du en URL med följande mönster: `https://<customer_name>.ssogen.com/ssogen/login?client_name=<customer_name>`

1. Klicka på **Ange ytterligare URL:er** och gör följande om du vill konfigurera appen i **SP**-initierat läge:

    I textrutan **Inloggnings-URL** skriver du en URL med följande mönster: `https://<customer_name>.ssogen.com/ssogen/login?client_name=<customer_name>`
...
När du klickar på SSOGEN-Azure AD SSO Gateway för Oracle E-Business Suite-EBS, JDE och på åtkomst panelen, bör du loggas in automatiskt på SSOGEN-Azure AD SSO-Gateway för Oracle E-Business Suite-EBS, och JDE som du är et upp till SSO. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
