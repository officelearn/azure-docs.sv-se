...
- [Skydda SSOGEN – Azure AD SSO Gateway för Oracle E-Business Suite-EBS, liboch JDE med avancerad synlighet och kontroller](/cloud-app-security/proxy-intro-aad)