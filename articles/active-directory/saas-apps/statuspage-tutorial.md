---
title: 'Självstudier: Azure Active Directory-integration med StatusPage | Microsoft Docs'
...
ms.locfileid: "39445372"
---
# <a name="tutorial-azure-active-directory-integration-with-statuspage"></a>Självstudier: Azure Active Directory-integration med StatusPage
...
1. Skriv den **e-postadress**, **Förnamn**, och **Sur namn** av en giltig användare som du vill etablera till relaterade textrutor. 
