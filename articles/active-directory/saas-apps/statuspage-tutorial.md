...
ms.date: 07/11/2017
ms.author: jeedes
ms.openlocfilehash: 948b55a4a72837c9fb6bdfbc0e45dc0c3ba81feb
ms.sourcegitcommit: 16ddc345abd6e10a7a3714f12780958f60d339b6
ms.translationtype: MT
ms.contentlocale: sv-SE
ms.lasthandoff: 06/19/2018
ms.locfileid: "36224760"
---
...
4. I sökrutan skriver **StatusPage**.
    ...
    ![Skapa en testanvändare i Azure AD](./media/statuspage-tutorial/tutorial_statuspage_search.png)

5. Välj i resultatpanelen **StatusPage**, och klicka sedan på **Lägg till** för att lägga till programmet.

    ![Skapa en testanvändare i Azure AD](./media/statuspage-tutorial/tutorial_statuspage_addfromgallery.png)
...
1. I den **Azure-portalen**, klicka på det vänstra navigeringsfönstret **Azure Active Directory** ikon.
    ...
    ![Skapa en testanvändare i Azure AD](./media/statuspage-tutorial/create_aaduser_01.png) 

2. Om du vill visa en lista över användare, gå till **användare och grupper** och på **alla användare**.
    
    ![Skapa en testanvändare i Azure AD](./media/statuspage-tutorial/create_aaduser_02.png) 

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i dialogrutan.
 
    ![Skapa en testanvändare i Azure AD](./media/statuspage-tutorial/create_aaduser_03.png) 

4. På den **användaren** dialogrutan utför följande steg:
 
    ![Skapa en testanvändare i Azure AD](./media/statuspage-tutorial/create_aaduser_04.png) 
...
3. Klicka på den **gruppmedlemmar** fliken. 
    ...
    ![Skapa en testanvändare i Azure AD](./media/statuspage-tutorial/tutorial_statuspage_10.png) 

4. Klicka på **Lägg till TEAMMEDLEM**. 
   
    ![Skapa en testanvändare i Azure AD](./media/statuspage-tutorial/tutorial_statuspage_11.png) 

5. Typ av **e-postadress**, **Förnamn**, och **Sur namn** av en giltig användare som du vill etablera i relaterade textrutor. 
   
    ![Skapa en testanvändare i Azure AD](./media/statuspage-tutorial/tutorial_statuspage_12.png) 
