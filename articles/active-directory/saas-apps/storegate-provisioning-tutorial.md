...
5. Under avsnittet **admin credentials** , in`https://dialpad.com/scim` i **klient-URL**. Mata in det värde som du hämtade och sparade tidigare från Storegate i **hemlig token**. Klicka på **Testa anslutning** för att se till att Azure AD kan ansluta till Storegate. Om anslutningen Miss lyckas kontrollerar du att Storegate-kontot har administratörs behörighet och försöker igen.
