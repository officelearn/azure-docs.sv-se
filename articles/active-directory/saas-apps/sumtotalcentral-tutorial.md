...
4. I rutan Sök skriver du **SumTotalCentral**, väljer **SumTotalCentral** från resultat panelen och klickar sedan på **Lägg till** för att lägga till programmet.

     ![SumTotalCentral i resultat listan](common/search-new-app.png)
...
2. **[Konfigurera SumTotalCentral-enkel inloggning](#configure-sumtotalcentral-single-sign-on)** för att konfigurera inställningarna för enkel inloggning på program sidan.
3. **[Skapa en Azure AD-testanvändare](#create-an-azure-ad-test-user)** – för att testa enkel inloggning med Azure AD med Britta Simon.
4. **[Tilldela Azure AD-testanvändaren](#assign-the-azure-ad-test-user)** – så att Britta Simon kan använda enkel inloggning med Azure AD.
5. **[Skapa SumTotalCentral test User](#create-sumtotalcentral-test-user)** – om du vill ha en motsvarighet till Britta Simon i SumTotalCentral som är länkad till Azure AD-representation av användare.
...
Utför följande steg för att konfigurera enkel inloggning med SumTotalCentral i Azure AD:

1. Välj **enkel inloggning**på sidan **SumTotalCentral** Application Integration i [Azure Portal](https://portal.azure.com/).
...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    > [!NOTE]
    > Inloggnings-URL-värdet är inte verkligt. Uppdatera värdet med den faktiska inloggnings-URL:en. Kontakta [SumTotalCentral client support team](http://www.sumtotalsystems.com/support/) för att hämta värdet. Du kan även se mönstren som visas i avsnittet **Grundläggande SAML-konfiguration** i Azure-portalen.
...
I det här avsnittet aktiverar du Britta Simon för att använda enkel inloggning med Azure genom att bevilja åtkomst till SumTotalCentral.

1. I Azure Portal väljer du **företags program**, väljer **alla program**och väljer sedan **SumTotalCentral**.

    ![Bladet Företagsprogram](common/enterprise-applications.png)

2. I listan program väljer du **SumTotalCentral**.

    ![SumTotalCentral-länken i program listan](common/all-applications.png)
