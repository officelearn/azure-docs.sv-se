...
Att konfigurera enkel inloggning på **SumTotalCentral** sida, som du behöver skicka de hämtade **XML-Metadata för Federation** och lämpliga kopierade URL: er från Azure portal för att [SumTotalCentral supportteam](http://www.sumtotalsystems.com/support/). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
