...
Att konfigurera enkel inloggning på **SurveyMonkey Enterprise** sida, som du behöver skicka de hämtade **XML-Metadata för Federation** och lämpliga kopierade URL: er från Azure portal för att [SurveyMonkey Enterprise support-teamet](mailto:support@selerix.com). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
