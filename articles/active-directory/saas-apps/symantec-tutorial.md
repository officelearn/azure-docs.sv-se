...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/symantec-tutorial/tutorial_symantecwebsecurityservicewss_samlbase.png)

3. På den **URL: er och Symantec Web Service (WSS) säkerhetsdomän** avsnittet, utför följande steg:

    ![URL: er och Symantec Web Security Service (WSS)-domän med enkel inloggning information](./media/symantec-tutorial/tutorial_symantecwebsecurityservicewss_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/symantec-tutorial/tutorial_symantecwebsecurityservicewss_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/symantec-tutorial/tutorial_general_400.png)
