...
När du klickar på panelen SynchroNet klickar du på panelen på åtkomst panelen. du bör loggas in automatiskt på SynchroNet som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
...
- [Skydda SynchroNet genom att klicka med avancerad synlighet och kontroller](/cloud-app-security/proxy-intro-aad)