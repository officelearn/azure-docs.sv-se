...
15. Om du vill konfigurera Omfångsfilter avser följande instruktionerna i den [Scoping filter självstudien](../active-directory-saas-scoping-filters.md).
