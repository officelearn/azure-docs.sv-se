...
1. I avsnittet **grundläggande SAML-konfiguration** anger du värden för följande fält:
    ...
    a. Skriv en URL med följande mönster i textrutan **Inloggnings-URL**: `https://azure.<domain name>.link`

    b. I rutan **Identifierare** skriver du en URL med följande mönster: `https://azure.<domain name>.link`

    c. I textrutan **Svars-URL** skriver du en URL med följande mönster: `https://azure.<domain name>.link/wg/saml/SSO/index.html`
