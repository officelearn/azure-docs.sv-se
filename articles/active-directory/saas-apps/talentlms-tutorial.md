---
title: 'Självstudier: Azure Active Directory-integration med TalentLMS | Microsoft Docs'
...
ms.locfileid: "39430647"
---
# <a name="tutorial-azure-active-directory-integration-with-talentlms"></a>Självstudier: Azure Active Directory-integration med TalentLMS
...
1. På den **TalentLMS domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<tenant-name>.TalentLMSapp.com`

    b. I den **identifierare** textrutan anger du ett URL med hjälp av följande mönster: `http://<tenant-name>.talentlms.com`

    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska inloggnings-URL och identifierare. Kontakta [TalentLMS klienten supportteamet](https://www.talentlms.com/contact) att hämta dessa värden. 
...
1. På den **Lägg till användare** dialogrutan utför följande steg:
    ...
    ![Lägg till användare](./media/talentlms-tutorial/IC777299.png "lägga till användare")  
