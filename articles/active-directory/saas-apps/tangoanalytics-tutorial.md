...
5. I resultatpanelen väljer **Tango Analytics**, och klicka sedan på **Lägg till** för att lägga till programmet.
...
3. **[Skapa en testanvändare Tango Analytics](#creating-a-tango-analytics-test-user)**  – du har en motsvarighet för Britta Simon i Tango Analytics som är länkad till en Azure AD-representation av användaren.
...
6. Att konfigurera enkel inloggning på **Tango Analytics** sida, som du behöver skicka de hämtade **XML-Metadata för** till [Tango Analytics supportteam](mailto:support@tangoanalytics.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
