...
1. På den **Tango Analytics domän och URL: er** avsnittet, utför följande steg:
    ...
    b. I textrutan **Svars-URL** skriver du en URL med följande mönster: `https://mts.tangoanalytics.com/saml2/sp/acs/post`

    > [!NOTE] 
    > Värdet för svars-URL:en är inte verkligt. Uppdatera det med den faktiska svars-URL. Kontakta [Tango Analytics supportteam](mailto:support@tangoanalytics.com) att hämta det här värdet.
...
1. Att konfigurera enkel inloggning på **Tango Analytics** sida, som du behöver skicka de hämtade **XML-Metadata för** till [Tango Analytics supportteam](mailto:support@tangoanalytics.com). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
