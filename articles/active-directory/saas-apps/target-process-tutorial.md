...
2. **[Konfigurera TargetProcess enkel inloggning](#configure-targetprocess-single-sign-on)** – om du vill konfigurera de enskilda Sign-On inställningarna på program sidan.
