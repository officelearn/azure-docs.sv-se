...
ms.date: 06/09/2017
ms.author: jeedes
ms.openlocfilehash: b9cf7ceb74a8b7d3932be4f94c1701c53781ac0c
...
4. I sökrutan skriver **TeamSeer**.
    ...
    ![Skapa en testanvändare i Azure AD](./media/teamseer-tutorial/tutorial_teamseer_search.png)

5. Välj i resultatpanelen **TeamSeer**, och klicka sedan på **Lägg till** för att lägga till programmet.

    ![Skapa en testanvändare i Azure AD](./media/teamseer-tutorial/tutorial_teamseer_addfromgallery.png)
...
10. Klicka på **ställa in information om SAML provider**.
    ...
    ![Inställningar för SAML](./media/teamseer-tutorial/ic789636.png "SAML-inställningar")

11. Utför följande steg i avsnittet SAML-providern information:
   
    ![Inställningar för SAML](./media/teamseer-tutorial/ic789637.png "SAML-inställningar")   
...
12. Utför följande steg för att slutföra konfigurationen av SAML-providern:
    ...
    ![Inställningar för SAML](./media/teamseer-tutorial/ic789638.png "SAML-inställningar") 
...
1. I den **Azure-portalen**, klicka på det vänstra navigeringsfönstret **Azure Active Directory** ikon.
    ...
    ![Skapa en testanvändare i Azure AD](./media/teamseer-tutorial/create_aaduser_01.png) 

2. Om du vill visa en lista över användare, gå till **användare och grupper** och på **alla användare**.
    
    ![Skapa en testanvändare i Azure AD](./media/teamseer-tutorial/create_aaduser_02.png) 

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i dialogrutan.
 
    ![Skapa en testanvändare i Azure AD](./media/teamseer-tutorial/create_aaduser_03.png) 

4. På den **användaren** dialogrutan utför följande steg:
 
    ![Skapa en testanvändare i Azure AD](./media/teamseer-tutorial/create_aaduser_04.png) 
