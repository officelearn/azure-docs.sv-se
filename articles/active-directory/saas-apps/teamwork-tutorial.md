...
2. **[Konfigurera teamwork.com enkel inloggning](#configure-teamworkcom-single-sign-on)** – om du vill konfigurera de enskilda Sign-On inställningarna på program sidan.
...
När du klickar på panelen Teamwork.com på åtkomst panelen, bör du loggas in automatiskt på den Teamwork.com som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
