---
title: 'Självstudier: Azure Active Directory-integration med Teamwork.com | Microsoft Docs'
...
ms.locfileid: "39049620"
---
# <a name="tutorial-azure-active-directory-integration-with-teamworkcom"></a>Självstudier: Azure Active Directory-integration med Teamwork.com
...
3. **[Skapa en testanvändare Teamwork.com](#create-a-teamworkcom-test-user)**  – du har en motsvarighet för Britta Simon i Teamwork.com som är länkad till en Azure AD-representation av användaren.
...
3. På den **Teamwork.com domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<company name>.teamwork.com`
...
5. Klicka på **spara** knappen.
    ...
    ![Konfigurera enkel inloggning spara-knapp](./media/teamwork-tutorial/tutorial_general_400.png)

6. Att konfigurera enkel inloggning på **Teamwork.com** sida, som du behöver skicka de hämtade **XML-Metadata för** till [Teamwork.com supportteamet](mailto:support@teamwork.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
