---
title: 'Självstudier: Azure Active Directory-integrering med Templafy | Microsoft Docs'
...
I den här självstudien får du lära dig hur du integrerar Templafy med Azure Active Directory (AD Azure).
Integrera Templafy med Azure AD ger dig följande fördelar:
...
Om du vill konfigurera Azure AD-integrering med Templafy, behöver du följande objekt:

* En Azure AD-prenumeration. Om du inte har en Azure AD-miljö kan du få en [kostnadsfritt konto](https://azure.microsoft.com/free/)
* Templafy enkel inloggning aktiverat prenumeration

## <a name="scenario-description"></a>Scenariobeskrivning

I den här självstudien konfigurerar och testar du enkel inloggning med Azure AD i en testmiljö.

* Har stöd för Templafy **SP** -initierad SSO
* Har stöd för Templafy **Just In Time** etableringen av användare

## <a name="adding-templafy-from-the-gallery"></a>Att lägga till Templafy från galleriet

För att konfigurera integrering av Templafy i Azure AD, som du behöver lägga till Templafy från galleriet i din lista över hanterade SaaS-appar.
...
4. I sökrutan skriver **Templafy**väljer **Templafy** resultatet panelen klickar **Lägg till** för att lägga till programmet.
...
Utför följande steg för att konfigurera Azure AD enkel inloggning med Templafy:
...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    ![Templafy domän och URL: er med enkel inloggning för information](common/sp-signonurl.png)

    I textrutan **Inloggnings-URL** skriver du in en URL med följande mönster: `https://<CLIENTSUBDOMAIN>.templafy.com`

    > [!NOTE]
    > Värdet är inte verkligt. Uppdatera värdet med den faktiska inloggnings-URL:en. Kontakta [Templafy klienten supportteamet](mailto:support@templafy.com) att hämta värdet. Du kan även se mönstren som visas i avsnittet **Grundläggande SAML-konfiguration** i Azure-portalen.

5. Templafy program som förväntar SAML-intyg i ett visst format. Konfigurera följande anspråk för det här programmet. Du kan hantera värdena för dessa attribut i avsnittet **Användarattribut** på sidan för programintegrering. På sidan **Konfigurera enkel inloggning med SAML** klickar du på knappen **Redigera** för att öppna dialogrutan **Användarattribut**.
...
6. I avsnittet **Användaranspråk** i dialogrutan **Användarattribut** så redigerar du anspråken genom att använda **Redigera-ikonen** eller lägga till anspråken genom att använda **Lägg till nytt anspråk** för att konfigurera SAML-tokenattribut som det visas i bilden ovan och utföra följande steg:
    ...
    c. I den **Namespace** textrutan anger du namnområdet-värde som visas för den raden.
...
I det här avsnittet ska aktivera du Britta Simon att använda Azure enkel inloggning genom att bevilja åtkomst till Templafy.

1. I Azure-portalen väljer du **företagsprogram**väljer **alla program**och välj sedan **Templafy**.

    ![Bladet Företagsprogram](common/enterprise-applications.png)

2. I listan med program väljer **Templafy**.

    ![Länken Templafy i listan med program](common/all-applications.png)
...
I det här avsnittet skapas en användare som kallas Britta Simon i Templafy. Templafy stöder etableringen av just-in-time-användare som är aktiverat som standard. Det finns inget åtgärdsobjekt för dig i det här avsnittet. Om en användare inte redan finns i Templafy, skapas en ny efter autentisering.

### <a name="test-single-sign-on"></a>Testa enkel inloggning

I det här avsnittet ska testa du Azure AD enkel inloggning för konfigurationen med hjälp av åtkomstpanelen.

När du klickar på panelen Templafy i åtkomstpanelen, bör det vara loggas in automatiskt till Templafy som du ställer in enkel inloggning. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
