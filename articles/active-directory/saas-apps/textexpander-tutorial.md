...
* TextExpander stöder **SP-och IDP** -INITIERAd SSO
...
1. Klicka på **Ange ytterligare URL:er** och gör följande om du vill konfigurera appen i **SP**-initierat läge:
    ...
    I rutan **Inloggnings-URL** anger du följande URL: `https://app.textexpander.com/ssoSignin`
...
När du klickar på panelen TextExpander på åtkomst panelen, bör du loggas in automatiskt på den TextExpander som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Så här skyddar du TextExpander med avancerad synlighet och kontroller](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)