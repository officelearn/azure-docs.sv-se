...
1. Att konfigurera enkel inloggning på **The finansiering Portal** sida, som du behöver skicka de hämtade **XML-Metadata för** till [The finansiering Portal supportteamet](mailto:info@regenteducation.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
