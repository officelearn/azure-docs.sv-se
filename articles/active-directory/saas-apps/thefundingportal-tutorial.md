...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    a. I textrutan **Inloggnings-URL** skriver du en URL enligt följande mönster: `https://<subdomain>.regenteducation.net/`
...
Att konfigurera enkel inloggning på **The finansiering Portal** sida, som du behöver skicka de hämtade **XML-Metadata för Federation** och lämpliga kopierade URL: er från Azure portal för att [The finansiering Portal supportteam](mailto:info@regenteducation.com). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
