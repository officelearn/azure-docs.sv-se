...
1. I sökrutan skriver **The finansiering Portal**.

    ![Skapa en Azure AD-användare för testning](./media/thefundingportal-tutorial/tutorial_thefundingportal_search.png)

1. I resultatpanelen väljer **The finansiering Portal**, och klicka sedan på **Lägg till** för att lägga till programmet.
...
1. **[Skapa The finansiering Portal testanvändare](#creating-the-funding-portal-test-user)**  – du har en motsvarighet för Britta Simon i The finansiering Portal som är länkad till en Azure AD-representation av användaren.
...
1. På den **The finansiering Portal domän och URL: er** avsnittet, utför följande steg:

    ![Konfigurera enkel inloggning](./media/thefundingportal-tutorial/tutorial_thefundingportal_url.png)

    a. I textrutan **Inloggnings-URL** anger du en URL med följande mönster: `https://<subdomain>.regenteducation.net/`

    b. I textrutan **Identifierare** anger du en URL med följande mönster: `https://<subdomain>.regenteducation.net`

    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med faktisk inloggnings-URL och identifierare. Kontakta [finansiering Portal klienten supportteamet](mailto:info@regenteducation.com) att hämta dessa värden. 
...
1. Att konfigurera enkel inloggning på **The finansiering Portal** sida, som du behöver skicka de hämtade **XML-Metadata för** till [The finansiering Portal supportteamet](mailto:info@regenteducation.com). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
...
1. I listan med program väljer **The finansiering Portal**.
