...
* Du kan aktivera användarna att vara automatiskt inloggad till ThirdPartyTrust (Single Sign-On) med sina Azure AD-konton.
...
* ThirdPartyTrust enkel inloggning aktiverat prenumeration

## <a name="scenario-description"></a>Scenariobeskrivning

I den här självstudien konfigurerar och testar du enkel inloggning med Azure AD i en testmiljö.

* Har stöd för ThirdPartyTrust **SP** och **IDP** -initierad SSO
...
4. I sökrutan skriver **ThirdPartyTrust**väljer **ThirdPartyTrust** resultatet panelen klickar **Lägg till** för att lägga till programmet.
     ...
     ![ThirdPartyTrust i resultatlistan](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurera och testa enkel inloggning med Azure AD

I det här avsnittet ska du konfigurera och testa Azure AD enkel inloggning med ThirdPartyTrust baserat på en testanvändare kallas **Britta Simon**.
För enkel inloggning ska fungera, måste en länk förhållandet mellan en Azure AD-användare och relaterade användaren i ThirdPartyTrust upprättas.
...
2. **[Konfigurera ThirdPartyTrust Single Sign-On](#configure-thirdpartytrust-single-sign-on)**  – om du vill konfigurera inställningar för enkel inloggning på programsidan.
3. **[Skapa en Azure AD-testanvändare](#create-an-azure-ad-test-user)** – för att testa enkel inloggning med Azure AD med Britta Simon.
4. **[Tilldela Azure AD-testanvändaren](#assign-the-azure-ad-test-user)** – så att Britta Simon kan använda enkel inloggning med Azure AD.
5. **[Skapa testanvändare ThirdPartyTrust](#create-thirdpartytrust-test-user)**  – du har en motsvarighet för Britta Simon i ThirdPartyTrust som är länkad till en Azure AD-representation av användaren.
...
1. I den [Azure-portalen](https://portal.azure.com/)på den **ThirdPartyTrust** application integration markerar **enkel inloggning**.
...
4. På den **SAML grundkonfiguration** om du vill konfigurera programmet i **IDP** initierade läge, utföra följande steg:
    ...
    ![ThirdPartyTrust domän och URL: er med enkel inloggning för information](common/idp-identifier.png)
...
7. På den **konfigurera ThirdPartyTrust** avsnittet, kopiera den lämpliga URL: er enligt dina behov.
...
Att konfigurera enkel inloggning på **ThirdPartyTrust** sida, som du behöver skicka de hämtade **XML-Metadata för Federation** och lämpliga kopierade URL: er från Azure portal för att [ThirdPartyTrust supportteam](mailto:support@thirdpartytrust.com). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
...
1. I Azure-portalen väljer du **företagsprogram**väljer **alla program**och välj sedan **ThirdPartyTrust**.

    ![Bladet Företagsprogram](common/enterprise-applications.png)

2. I listan med program väljer **ThirdPartyTrust**.

    ![Länken ThirdPartyTrust i listan med program](common/all-applications.png)
...
### <a name="create-thirdpartytrust-test-user"></a>Skapa ThirdPartyTrust testanvändare
...
När du klickar på panelen ThirdPartyTrust i åtkomstpanelen, bör det vara loggas in automatiskt till ThirdPartyTrust som du ställer in enkel inloggning. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
