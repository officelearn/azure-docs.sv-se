...
Att konfigurera enkel inloggning på **ThirdPartyTrust** sida, som du behöver skicka de hämtade **XML-Metadata för Federation** och lämpliga kopierade URL: er från Azure portal för att [ThirdPartyTrust supportteam](mailto:support@thirdpartytrust.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
