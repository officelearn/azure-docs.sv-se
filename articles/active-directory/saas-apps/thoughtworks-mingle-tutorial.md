...
2. **[Konfigurera Thoughtworks Mingle Single Sign-on](#configure-thoughtworks-mingle-single-sign-on)** -för att konfigurera de enskilda Sign-On inställningarna på program sidan.
...
### <a name="configure-thoughtworks-mingle-single-sign-on"></a>Konfigurera Thoughtworks Mingle Single Sign-On
...
När du klickar på panelen Thoughtworks Mingle på åtkomst panelen, bör du loggas in automatiskt på Thoughtworks-Mingle som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
