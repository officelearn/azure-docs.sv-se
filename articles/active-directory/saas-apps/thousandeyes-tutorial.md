...
4. I sökrutan skriver **ThousandEyes**.
    ...
    ![Skapa en testanvändare i Azure AD](./media/thousandeyes-tutorial/tutorial_thousandeyes_search.png)

5. Välj i resultatpanelen **ThousandEyes**, och klicka sedan på **Lägg till** för att lägga till programmet.

    ![Skapa en testanvändare i Azure AD](./media/thousandeyes-tutorial/tutorial_thousandeyes_addfromgallery.png)
...
10. Klicka på den **säkerhets- och** fliken.
    ...
    ![Säkerhets- och](./media/thousandeyes-tutorial/ic790068.png "säkerhets- och autentisering")
...
1. I den **Azure-portalen**, klicka på det vänstra navigeringsfönstret **Azure Active Directory** ikon.
    ...
    ![Skapa en testanvändare i Azure AD](./media/thousandeyes-tutorial/create_aaduser_01.png) 

2. Om du vill visa en lista över användare, gå till **användare och grupper** och på **alla användare**.
    
    ![Skapa en testanvändare i Azure AD](./media/thousandeyes-tutorial/create_aaduser_02.png) 

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i dialogrutan.

    ![Skapa en testanvändare i Azure AD](./media/thousandeyes-tutorial/create_aaduser_03.png)

4. På den **användaren** dialogrutan utför följande steg:

    ![Skapa en testanvändare i Azure AD](./media/thousandeyes-tutorial/create_aaduser_04.png)
...
Syftet med det här avsnittet är att skapa en användare som kallas Britta Simon i ThousandEyes. ThousandEyes stöder automatisk användaretablering, vilket är aktiverat som standard. Du hittar mer information [här](thousandeyes-provisioning-tutorial.md) om hur du konfigurerar automatisk användaretablering.
