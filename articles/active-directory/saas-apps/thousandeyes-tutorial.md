...
* ThousandEyes har stöd för [ **Automatisk** användar etablering](./thousandeyes-provisioning-tutorial.md)
...
5. Utför följande steg i avsnittet **Konfigurera enkel inloggning** :
    ...
    ![Konfigurera enkel inloggning](./media/thousandeyes-tutorial/ic790069.png "Konfigurera enskilda Sign-On")
...
När du klickar på panelen ThousandEyes på åtkomst panelen, bör du loggas in automatiskt på den ThousandEyes som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
...
- [Konfigurera användar etablering](./thousandeyes-provisioning-tutorial.md)