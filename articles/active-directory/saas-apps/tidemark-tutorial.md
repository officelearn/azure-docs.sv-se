...
Att konfigurera enkel inloggning på **Tidemark** sida, som du behöver skicka de hämtade **certifikat (Base64)** och lämpliga kopierade URL: er från Azure portal för att [Tidemark supportteamet](http://www.tidemark.com/contact-us). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
