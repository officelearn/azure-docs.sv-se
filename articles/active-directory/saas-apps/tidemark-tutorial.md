...
2. **[Konfigurera Tidemark-enkel inloggning](#configure-tidemark-single-sign-on)** för att konfigurera inställningarna för enkel inloggning på program sidan.
...
När du klickar på panelen Tidemark på åtkomst panelen, bör du loggas in automatiskt på den Tidemark som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
