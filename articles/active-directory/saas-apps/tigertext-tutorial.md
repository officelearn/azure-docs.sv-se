...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    a. I den **inloggnings-URL** text skriver en URL: `https://home.tigertext.com`
    ...
    > [!NOTE]
    > Identifierarvärdet är inte verkligt. Uppdatera det här värdet med den faktiska identifieraren. Kontakta [TigerText skydda Messenger-klienten supportteamet](mailto:prosupport@tigertext.com) att hämta värdet. Du kan även se mönstren som visas i avsnittet **Grundläggande SAML-konfiguration** i Azure-portalen.
...
Att konfigurera enkel inloggning på **TigerText skydda Messenger** sida, som du behöver skicka de hämtade **XML-Metadata för Federation** och lämpliga kopierade URL: er från Azure portal för att [TigerText Skydda Messenger supportteamet](mailto:prosupport@tigertext.com). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
