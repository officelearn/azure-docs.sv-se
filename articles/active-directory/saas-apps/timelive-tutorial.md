...
1. På den **TimeLive domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I textrutan **Inloggnings-URL** anger du en URL med följande mönster: `https://domainname.livetecs.com/`

    b. I textrutan **Identifierare** anger du en URL med följande mönster: `https://domainname.livetecs.com/`
...
1. På den **SAML-signeringscertifikat** klickar du på **Certificate(Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länk för nedladdning av certifikatet](./media/timelive-tutorial/tutorial_timelive_certificate.png) 

1. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning – knappen Spara](./media/timelive-tutorial/tutorial_general_400.png)
