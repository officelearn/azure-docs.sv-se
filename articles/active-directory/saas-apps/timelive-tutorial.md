...
3. **[Skapa en testanvändare TimeLive](#create-a-timelive-test-user)**  – du har en motsvarighet för Britta Simon i TimeLive som är länkad till en Azure AD-representation av användaren.
...
6. På den **TimeLive Configuration** klickar du på **konfigurera TimeLive** att öppna **konfigurera inloggning** fönster. Kopiera den **URL: en för utloggning och SAML enkel inloggning för tjänst-URL** från den **Snabbreferens avsnittet.**

    ![TimeLive konfiguration](./media/timelive-tutorial/tutorial_timelive_configure.png)

7. I ett annat webbläsarfönster logga du in på webbplatsen TimeLive företag som administratör.

8. Välj **inställningar** under **alternativ**.

    ![TimeLive konfiguration](./media/timelive-tutorial/configure1.png)

9. I den **program inställning** avsnittet, utför följande steg:
