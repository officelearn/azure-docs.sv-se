...
3. I avsnittet **Inställningar för enkel Sign-On** utför du följande steg:
    ...
    ![Skärm bild som visar avsnittet enskilda Sign-On inställningar där du kan ange de värden som beskrivs.](./media/timeoffmanager-tutorial/ic795918.png "Inställningar för enskilda Sign-On")
...
4. På sidan **Inställningar för enkel inloggning** kopierar du värdet för **URL: en för den försäkrans konsument tjänst** och klistrar in den i text rutan **svars-URL** i avsnittet **grundläggande SAML-konfiguration** i Azure Portal. 
      ...
      ![Skärm bild som visar "U R L"-länken för intygs konsumenten.](./media/timeoffmanager-tutorial/ic795915.png "Inställningar för enskilda Sign-On")
...
När du klickar på panelen TimeOffManager på åtkomst panelen, bör du loggas in automatiskt på den TimeOffManager som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
