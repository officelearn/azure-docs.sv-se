...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![SAML-baserade inloggning](./media/tinfoil-security-tutorial/tutorial_tinfoil-security_samlbase.png)
...
4. På den **SAML-signeringscertifikat** avsnittet, kopiera den **TUMAVTRYCKET** värde.
    ...
    ![Signeringscertifikat för SAML-avsnitt](./media/tinfoil-security-tutorial/tutorial_tinfoil-security_certificate.png) 
...
5. Utför följande steg för att lägga till nödvändiga attributmappning:
    ...
    ![Lägg till attributet](./media/tinfoil-security-tutorial/tutorial_tinfoil-security_attribute.png "attribut")
    
    ![Lägg till attributet](./media/tinfoil-security-tutorial/tutorial_tinfoil-security_addatt.png "attribut")
...
9. Klicka på i verktygsfältet högst upp **mitt konto**.
    ...
    ![Instrumentpanelen](./media/tinfoil-security-tutorial/ic798971.png "instrumentpanelen")
...
1. I den **Azure-portalen**, klicka på det vänstra navigeringsfönstret **Azure Active Directory** ikon.
    ...
    ![Skapa en testanvändare i Azure AD](./media/tinfoil-security-tutorial/create_aaduser_01.png) 
...
4. På den **användaren** dialogrutan utför följande steg:
    ...
    ![Skapa en testanvändare i Azure AD](./media/tinfoil-security-tutorial/create_aaduser_04.png) 
