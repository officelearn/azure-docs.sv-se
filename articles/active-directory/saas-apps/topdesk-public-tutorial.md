...
2. **[Konfigurera TOPdesk-offentlig enkel inloggning-om](#configure-topdesk---public-single-sign-on)** du vill konfigurera enskilda Sign-On inställningar på program sidan.
...
När du klickar på panelen TOPdesk-offentlig i åtkomst panelen, bör du loggas in automatiskt på den TOPdesk-offentliga som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
