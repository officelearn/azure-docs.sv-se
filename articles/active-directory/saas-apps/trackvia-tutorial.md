...
3. **[Skapa en testanvändare TrackVia](#create-a-trackvia-test-user)**  – du har en motsvarighet för Britta Simon i TrackVia som är länkad till en Azure AD-representation av användaren.
...
7. På den **TrackVia Configuration** klickar du på **konfigurera TrackVia** att öppna **konfigurera inloggning** fönster. Kopiera den **SAML entitets-ID** från den **Snabbreferens avsnittet.**

    ![TrackVia konfiguration](./media/trackvia-tutorial/tutorial_trackvia_configure.png)
    
8. I annat webbläsarfönster inloggning till webbplatsen TrackVia företag som administratör.

9. Klicka på Trackvia **mitt konto** inställningar och välj sedan **Single Sign On** fliken, utför följande steg:
