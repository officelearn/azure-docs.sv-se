---
title: 'Självstudier: Azure Active Directory-integration med Trakstar | Microsoft Docs'
...
ms.locfileid: "39420794"
---
# <a name="tutorial-azure-active-directory-integration-with-trakstar"></a>Självstudier: Azure Active Directory-integration med Trakstar
...
1. På den **Trakstar domän och URL: er** avsnittet, utför följande steg:
    ...
    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska inloggnings-URL och identifierare. Logga in på Trakstar som administratör för att hämta dessa värden.
