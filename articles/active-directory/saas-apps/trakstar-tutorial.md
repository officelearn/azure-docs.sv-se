...
2. **[Konfigurera Trakstar enkel inloggning](#configure-trakstar-single-sign-on)** – om du vill konfigurera de enskilda Sign-On inställningarna på program sidan.
...
När du klickar på panelen Trakstar på åtkomst panelen, bör du loggas in automatiskt på den Trakstar som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
