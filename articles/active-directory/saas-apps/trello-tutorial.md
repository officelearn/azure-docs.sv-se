...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/trello-tutorial/tutorial_trello_samlbase.png)

3. På den **Trello domän och URL: er** om du vill konfigurera programmet i **IDP initierade läge**, utför följande steg:

    ![URL: er och Trello domän med enkel inloggning information](./media/trello-tutorial/tutorial_trello_url.png)
...
4. Om du vill konfigurera programmet i **SP initierade läge**, utför följande steg:
    ...
    ![URL: er och Trello domän med enkel inloggning information](./media/trello-tutorial/tutorial_trello_url1.png)
...
7. På den **SAML-signeringscertifikat** klickar du på **certifikat (Base64)** och spara sedan metadatafilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/trello-tutorial/tutorial_trello_certificate.png) 

8. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/trello-tutorial/tutorial_general_400.png)
...
2. Välj i listan med program **Trello**.
    ...
    ![Länken Trello i listan med program](./media/trello-tutorial/tutorial_trello_app.png)  
