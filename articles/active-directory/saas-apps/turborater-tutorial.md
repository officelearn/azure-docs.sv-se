---
title: 'Självstudier: Azure Active Directory-integration med TurboRater | Microsoft Docs'
...
ms.locfileid: "39055828"
---
# <a name="tutorial-azure-active-directory-integration-with-turborater"></a>Självstudier: Azure Active Directory-integration med TurboRater
...
3. **[Skapa en testanvändare TurboRater](#create-a-turborater-test-user)**  – du har en motsvarighet för Britta Simon i TurboRater som är länkad till en Azure AD-representation av användaren.
...
5. Klicka på **spara** knappen.
    ...
    ![Konfigurera enkel inloggning spara-knapp](./media/turborater-tutorial/tutorial_general_400.png)

7. Att konfigurera enkel inloggning på **TurboRater** sida, som du behöver skicka de hämtade **XML-Metadata för** till [TurboRater supportteamet](https://www.getitc.com/support). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
