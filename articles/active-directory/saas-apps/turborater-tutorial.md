...
1. Att konfigurera enkel inloggning på **TurboRater** sida, som du behöver skicka de hämtade **XML-Metadata för** till [TurboRater supportteamet](https://www.getitc.com/support). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
