...
| Logotyp | Självstudiekursen för enkel inloggning | Självstudiekursen för etableringen av användare |
| :--- | :--- | :--- |
| ![logo](./media/tutorial-list/active-directory-saas-amazon-web-service-tutorial.png)| [Konsolen för Amazon Web Services (AWS)](amazon-web-service-tutorial.md)| [Amazon Web Services (AWS)-konsolen – rollen etablering](amazon-web-service-tutorial.md#configure-azure-ad-sso) |
