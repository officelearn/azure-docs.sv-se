...
* Du kan aktivera användarna att vara automatiskt inloggad till T & E Express (Single Sign-On) med sina Azure AD-konton.
...
4. I sökrutan skriver **d & E Express**väljer **d & E Express** resultatet panelen klickar **Lägg till** för att lägga till programmet.

    ![T & E Express i resultatlistan](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurera och testa enkel inloggning med Azure AD

I det här avsnittet ska du konfigurera och testa Azure AD enkel inloggning med T & E Express baserat på en testanvändare kallas **Britta Simon**.
För enkel inloggning att fungera, en länk förhållandet mellan en Azure AD-användare och relaterade användaren i T & E Express måste upprättas.
...
2. **[Konfigurera T & E Express enkel inloggning](#configure-te-express-single-sign-on)**  – om du vill konfigurera inställningar för enkel inloggning på programsidan.
3. **[Skapa en Azure AD-testanvändare](#create-an-azure-ad-test-user)** – för att testa enkel inloggning med Azure AD med Britta Simon.
4. **[Tilldela Azure AD-testanvändaren](#assign-the-azure-ad-test-user)** – så att Britta Simon kan använda enkel inloggning med Azure AD.
5. **[Skapa testanvändare d & E Express](#create-te-express-test-user)**  – du har en motsvarighet för Britta Simon i T & E Express som är länkad till en Azure AD-representation av användaren.
...
1. I den [Azure-portalen](https://portal.azure.com/)på den **d & E Express** application integration markerar **enkel inloggning**.
...
4. På sidan **Konfigurera enkel inloggning med SAML** utför du följande steg:
    ...
    ![T & E Express domän och URL: er med enkel inloggning för information](common/idp-intiated.png)
    ...
    > [!NOTE]
    > Dessa värden är inte verkliga. Uppdatera dessa värden med den faktiska identifieraren och svars-URL. Här föreslår vi att du använder det unika värdet för strängen i identifieraren. Kontakta [d & E Express klienten supportteam](https://www.tyeexpress.com/contacto.aspx) att hämta dessa värden. Du kan även se mönstren som visas i avsnittet **Grundläggande SAML-konfiguration** i Azure-portalen.

5. På sidan **Set up Single Sign-On with SAML** (Konfigurera enkel inloggning med SAML) går du till avsnittet **SAML Signing Certificate** (SAML-signeringscertifikat), klickar på **Ladda ned** för att ladda ned **Federation Metadata-XML** från de angivna alternativen enligt dina behov och spara den på datorn.

    ![Länk för nedladdning av certifikatet](common/metadataxml.png)

6. På den **konfigurera d & E Express** avsnittet, kopiera den lämpliga URL: er enligt dina behov.
...
I det här avsnittet ska aktivera du Britta Simon att använda Azure enkel inloggning om du beviljar åtkomst till T & E Express.

1. I Azure-portalen väljer du **företagsprogram**väljer **alla program**och välj sedan **d & E Express**.

    ![Bladet Företagsprogram](common/enterprise-applications.png)

2. I listan med program väljer **d & E Express**.

    ![T & E Express länken i listan med program](common/all-applications.png)
...
### <a name="create-te-express-test-user"></a>Skapa d & E Express testanvändare
...
När du klickar på panelen d & E Express i åtkomstpanelen, bör det vara loggas in automatiskt till T & E Express som du ställer in enkel inloggning. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
