...
4. I sökrutan skriver **T & E Express**.
    ...
    ![Skapa en testanvändare i Azure AD](./media/tyeexpress-tutorial/tutorial_tyeexpress_search.png)

5. Välj i resultatpanelen **T & E Express**, och klicka sedan på **Lägg till** för att lägga till programmet.

    ![Skapa en testanvändare i Azure AD](./media/tyeexpress-tutorial/tutorial_tyeexpress_addfromgallery.png)
...
1. I den **Azure-hanteringsportalen**, klicka på det vänstra navigeringsfönstret **Azure Active Directory** ikon.
    ...
    ![Skapa en testanvändare i Azure AD](./media/tyeexpress-tutorial/create_aaduser_01.png) 

2. Gå till **användare och grupper** och på **alla användare** att visa en lista över användare.
    
    ![Skapa en testanvändare i Azure AD](./media/tyeexpress-tutorial/create_aaduser_02.png) 

3. Klicka på överst i dialogrutan **Lägg till** att öppna den **användaren** dialogrutan.
 
    ![Skapa en testanvändare i Azure AD](./media/tyeexpress-tutorial/create_aaduser_03.png) 

4. På den **användaren** dialogrutan utför följande steg:
 
    ![Skapa en testanvändare i Azure AD](./media/tyeexpress-tutorial/create_aaduser_04.png) 
