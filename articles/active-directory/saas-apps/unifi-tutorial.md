---
title: 'Självstudiekurs: Azure Active Directory-integrering med UNIFI | Microsoft-dokument'
...
---
# <a name="tutorial-azure-active-directory-integration-with-unifi"></a>Självstudiekurs: Azure Active Directory-integrering med UNIFI
...
4. Om du vill konfigurera programmet i **IDP-initierat** läge i avsnittet **Grundläggande SAML-konfiguration** gör du följande:
    ...
    Skriv URL:en i textrutan **Identifierare:**`INVIEWlabs`

5. Klicka på **Ange ytterligare URL:er** och gör följande om du vill konfigurera appen i **SP**-initierat läge:

    Skriv en URL i textrutan **Sign-on-URL:**`https://app.discoverunifi.com/login`
