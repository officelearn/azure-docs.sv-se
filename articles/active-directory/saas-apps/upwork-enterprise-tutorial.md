...
1. Klicka på **Ange ytterligare URL:er** och gör följande om du vill konfigurera appen i **SP**-initierat läge:
    ...
    I textrutan **Inloggnings-URL** skriver du en URL med följande mönster: `https://www.upwork.com/ab/account-security/login`
...
När du klickar på panelen för att arbeta med företaget på åtkomst panelen, bör du loggas in automatiskt på det företag som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
