---
title: 'Självstudier: Azure Active Directory-integration med UserEcho | Microsoft Docs'
...
ms.locfileid: "39443285"
---
# <a name="tutorial-azure-active-directory-integration-with-userecho"></a>Självstudier: Azure Active Directory-integration med UserEcho
...
1. På den **UserEcho domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<companyname>.userecho.com/`

    b. I den **identifierare** textrutan anger du ett URL med hjälp av följande mönster: `https://<companyname>.userecho.com/saml/metadata/`

    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska inloggnings-URL och identifierare. Kontakta [UserEcho klienten supportteamet](https://feedback.userecho.com/) att hämta dessa värden. 
