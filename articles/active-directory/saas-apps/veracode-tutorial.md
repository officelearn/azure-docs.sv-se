...
1. Välj **inställningar** > **administratör**på menyn högst upp.
...
När du väljer **Veracode** i åtkomst panelen bör du loggas in automatiskt på den Veracode som du ställer in SSO för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
