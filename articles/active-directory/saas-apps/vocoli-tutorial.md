---
title: 'Självstudie: Azure Active Directory integration med enkel inloggning (SSO) med Vocoli | Microsoft Docs'
...
ms.locfileid: "92521741"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-vocoli"></a>Självstudie: Azure Active Directory integration med enkel inloggning (SSO) med Vocoli
...
Om du vill konfigurera enkel inloggning på **Vocoli** sida måste du skicka det hämtade **certifikatet (base64)** och lämpliga kopierade url: er från Azure Portal till [support teamet för Vocoli](mailto:inbox@vocoli.com). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
...
När du klickar på panelen Vocoli på åtkomst panelen, bör du loggas in automatiskt på den Vocoli som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
