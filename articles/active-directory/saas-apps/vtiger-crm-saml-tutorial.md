...
2. **[Konfigurera VTIGER CRM (SAML) SSO](#configure-vtiger-crm-saml-sso)** – för att konfigurera enskilda Sign-On inställningar på program sidan.
...
När du väljer vtiger CRM-panelen (SAML) i åtkomst panelen, bör du loggas in automatiskt på vtiger CRM (SAML) som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
