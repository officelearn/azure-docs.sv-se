...
2. **[Konfigurera hur vi gör SSO](#configure-way-we-do-sso)** -för att konfigurera enskilda Sign-On inställningar på program sidan.
...
När du väljer sätt på panelen på åtkomst panelen, bör du loggas in automatiskt på det sätt som du ställer in SSO. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
