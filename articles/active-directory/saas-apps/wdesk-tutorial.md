...
4. I sökrutan skriver **Wdesk**.
    ...
    ![Skapa en testanvändare i Azure AD](./media/wdesk-tutorial/tutorial_wdesk_search.png)

5. Välj i resultatpanelen **Wdesk**, och klicka sedan på **Lägg till** för att lägga till programmet.

    ![Skapa en testanvändare i Azure AD](./media/wdesk-tutorial/tutorial_wdesk_addfromgallery.png)
...
1. I den **Azure-portalen**, klicka på det vänstra navigeringsfönstret **Azure Active Directory** ikon.
    ...
    ![Skapa en testanvändare i Azure AD](./media/wdesk-tutorial/create_aaduser_01.png) 

2. Om du vill visa en lista över användare, gå till **användare och grupper** och på **alla användare**.
    
    ![Skapa en testanvändare i Azure AD](./media/wdesk-tutorial/create_aaduser_02.png) 

3. Öppna den **användare** dialogrutan klickar du på **Lägg till** överst i dialogrutan.
 
    ![Skapa en testanvändare i Azure AD](./media/wdesk-tutorial/create_aaduser_03.png) 

4. På den **användaren** dialogrutan utför följande steg:
 
    ![Skapa en testanvändare i Azure AD](./media/wdesk-tutorial/create_aaduser_04.png) 
...
4. Klicka på **Lägg till medlem** att öppna **Lägg till medlem** dialogrutan. 
    ...
    ![Skapa en testanvändare i Azure AD](./media/wdesk-tutorial/createuser1.png)  

5. I **användare** text Ange användarnamnet för användaren som **brittasimon@contoso.com** och på **Fortsätt** knappen.

    ![Skapa en testanvändare i Azure AD](./media/wdesk-tutorial/createuser3.png)

6.  Ange information som visas nedan:
  
    ![Skapa en testanvändare i Azure AD](./media/wdesk-tutorial/createuser4.png)
...
7. Klicka på **spara medlemmen** knappen.  
    ...
    ![Skapa en testanvändare i Azure AD](./media/wdesk-tutorial/createuser5.png)
