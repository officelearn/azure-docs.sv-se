...
2. **[Konfigurera WHATFIX SSO](#configure-whatfix-sso)** – om du vill konfigurera inställningar för enskilda Sign-On på program sidan.
...
1. På sidan **Konfigurera en enskild Sign-On med SAML** , i avsnittet **SAML-signeringscertifikat** , klickar du på Kopiera för att kopiera **URL för metadata för app Federation**.
...
När du väljer panelen Whatfix på åtkomst panelen, bör du loggas in automatiskt på den Whatfix som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
