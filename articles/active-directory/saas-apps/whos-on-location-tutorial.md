...
När du klickar på panelen WhosOnLocation på åtkomst panelen, bör du loggas in automatiskt på den WhosOnLocation som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Så här skyddar du WhosOnLocation med avancerad synlighet och kontroller](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)
