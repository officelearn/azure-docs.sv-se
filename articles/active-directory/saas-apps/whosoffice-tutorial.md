...
När du klickar på panelen WhosOffice på åtkomst panelen, bör du loggas in automatiskt på den WhosOffice som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
