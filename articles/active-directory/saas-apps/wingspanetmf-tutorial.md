...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    a. I textrutan **Inloggnings-URL** skriver du in en URL med följande mönster: `https://<customer name>.<instance name>.mywingspan.com/saml`

    b. I rutan **Identifierare** skriver du en URL med följande mönster: `http://saml.<instance name>.wingspan.com/shibboleth`

    c. I textrutan **Svars-URL** skriver du in en URL med följande mönster: `https://<customer name>.<instance name>.mywingspan.com/`
