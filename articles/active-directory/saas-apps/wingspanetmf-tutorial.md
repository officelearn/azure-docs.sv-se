...
* Du kan aktivera användarna att vara automatiskt inloggad till Wingspan eTMF (Single Sign-On) med sina Azure AD-konton.
...
* Wingspan eTMF enkel inloggning aktiverat prenumeration

## <a name="scenario-description"></a>Scenariobeskrivning

I den här självstudien konfigurerar och testar du enkel inloggning med Azure AD i en testmiljö.

* Har stöd för wingspan eTMF **SP** -initierad SSO
...
4. I sökrutan skriver **Wingspan eTMF**väljer **Wingspan eTMF** resultatet panelen klickar **Lägg till** för att lägga till programmet.

     ![Wingspan eTMF i resultatlistan](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurera och testa Azure AD enkel inloggning

I det här avsnittet ska du konfigurera och testa Azure AD enkel inloggning med Wingspan eTMF baserat på en testanvändare kallas **Britta Simon**.
För enkel inloggning ska fungera, måste en länk förhållandet mellan en Azure AD-användare och relaterade användaren i Wingspan eTMF upprättas.
...
2. **[Konfigurera Wingspan eTMF enkel inloggning](#configure-wingspan-etmf-single-sign-on)**  – om du vill konfigurera inställningar för enkel inloggning på programsidan.
3. **[Skapa en Azure AD-testanvändare](#create-an-azure-ad-test-user)**  – om du vill testa Azure AD enkel inloggning med Britta Simon.
4. **[Tilldela Azure AD-testanvändare](#assign-the-azure-ad-test-user)**  – om du vill aktivera Britta Simon att använda Azure AD enkel inloggning.
5. **[Skapa testanvändare för Wingspan eTMF](#create-wingspan-etmf-test-user)**  – du har en motsvarighet för Britta Simon i Wingspan eTMF som är länkad till en Azure AD-representation av användaren.
...
1. I den [Azure-portalen](https://portal.azure.com/)på den **Wingspan eTMF** application integration markerar **enkel inloggning**.
...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    ![Wingspan eTMF domän och URL: er enkel inloggning för information](common/sp-identifier-reply.png)
...
6. På den **konfigurera Wingspan eTMF** avsnittet, kopiera den lämpliga URL: er enligt dina behov.
...
Att konfigurera enkel inloggning på **Wingspan eTMF** sida, som du behöver skicka de hämtade **XML-Metadata för Federation** och lämpliga kopierade URL: er från Azure portal för att [Wingspan eTMF support-teamet ](https://www.wingspan.com/contact-us/). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
...
1. I Azure-portalen väljer du **företagsprogram**väljer **alla program**och välj sedan **Wingspan eTMF**.

    ![Bladet Företagsprogram](common/enterprise-applications.png)

2. I listan med program väljer **Wingspan eTMF**.

    ![Länken Wingspan eTMF i listan med program](common/all-applications.png)
...
När du klickar på panelen Wingspan eTMF i åtkomstpanelen bör det vara loggas in automatiskt till den Wingspan eTMF som du ställer in enkel inloggning. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
