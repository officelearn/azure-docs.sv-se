...
2. **[Konfigurera Wizergos produktivitet program vara enkel inloggning](#configure-wizergos-productivity-software-single-sign-on)** -för att konfigurera de enskilda Sign-On inställningarna på program sidan.
...
### <a name="configure-wizergos-productivity-software-single-sign-on"></a>Konfigurera Wizergos Productivity Software Single Sign-On
...
2. Från menyn Hamburger väljer du **admin** .
    ...
    ![Skärm bild som visar den administratörs ikon som valts på menyn.](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_000.png)

3. Välj **autentisering** på sidan administratör på den vänstra menyn och klicka på **Azure AD** .

    ![Skärm bild som visar Azure A D som valts från autentisering.](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_002.png)

4. Utför följande steg i avsnittet **Authentication (autentisering** ).

    ![Skärm bild som visar sidan autentisering där du kan ange de värden som beskrivs.](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_003.png)
    ...
    d. I text rutan **URL för enskild Sign-Out** klistrar du in URL-värdet för **utloggning** som du har kopierat från Azure Portal.
...
När du klickar på Wizergos produktivitets programs panel på åtkomst panelen, bör du loggas in automatiskt på den Wizergos produktivitets program vara som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
