...
1. Utför följande steg på följande sida:
    ...
    a. I text rutan **URL för enkel inloggning för identitetsprovider** klistrar du in värdet för **inloggnings-URL** som du har kopierat från Azure Portal.
...
När du klickar på panelen Wootric på åtkomst panelen, bör du loggas in automatiskt på den Wootric som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Så här skyddar du Wootric med avancerad synlighet och kontroller](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)