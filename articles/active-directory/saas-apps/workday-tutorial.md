...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/workday-tutorial/tutorial_workday_samlbase.png)

3. På den **Workday domän och URL: er** avsnittet, utför följande steg:

    ![Arbetsdagar domän och URL: er med enkel inloggning information](./media/workday-tutorial/tutorial_workday_url.png)
...
4. Kontrollera **visa avancerade inställningar för URL: en** och utföra följande steg:
    ...
    ![Arbetsdagar domän och URL: er med enkel inloggning information](./media/workday-tutorial/tutorial_workday_url1.png)
...
5. På den **SAML-signeringscertifikat** klickar du på **certifikat (Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/workday-tutorial/tutorial_workday_certificate.png) 

6. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/workday-tutorial/tutorial_general_400.png)
...
7. På den **Workday Configuration** klickar du på **konfigurera Workday** att öppna **konfigurera inloggning** fönster. Kopiera den **Sign-Out URL, SAML enhets-ID och SAML enkel inloggning Tjänstwebbadress** från den **Snabbreferens avsnitt.**
    ...
    ![Arbetsdagar konfiguration](./media/workday-tutorial/tutorial_workday_configure.png) 
...
10. I den **omdirigering av URL: er** avsnittet, utför följande steg:
    ...
    ![Omdirigering av URL: er](./media/workday-tutorial/IC7829581.png "omdirigerings-URL: er")
...
11. I den **SAML installationsprogrammet** avsnittet, utför följande steg:
    ...
    ![SAML-installationsprogrammet](./media/workday-tutorial/IC782926.png "SAML-installationen")
...
12. I den **SAML identitetsleverantörer** avsnittet, utför följande steg:
    ...
    ![SAML identitetsleverantörer](./media/workday-tutorial/IC7829271.png "SAML identitetsleverantörer")
    ...
    ![SAML identitetsleverantörer](./media/workday-tutorial/IC7829272.png "SAML identitetsleverantörer")
...
13. I den **visa x509 offentliga nyckel** avsnittet, utför följande steg: 
    ...
    ![Visa x509 offentliga nyckel](./media/workday-tutorial/IC782930.png "visa x509 offentliga nyckel") 
...
2. Välj i listan med program **Workday**.
    ...
    ![Länken Workday i listan med program](./media/workday-tutorial/tutorial_workday_app.png)  
