---
title: 'Självstudier: Azure Active Directory-integration med Workfront | Microsoft Docs'
...
5. I resultatpanelen väljer **Workfront**, och klicka sedan på **Lägg till** för att lägga till programmet.
...
3. **[Skapa en testanvändare Workfront](#creating-a-workfront-test-user)**  – du har en motsvarighet för Britta Simon i Workfront som är länkad till en Azure AD-representation av användaren.
...
3. På den **Workfront domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<companyname>.attask-ondemand.com`
...
6. På den **Workfront Configuration** klickar du på **konfigurera Workfront** att öppna **konfigurera inloggning** fönster. Kopiera den **URL: en för utloggning och SAML enkel inloggning för tjänst-URL** från den **Snabbreferens avsnittet.**

    ![Konfigurera enkel inloggning](./media/workfront-tutorial/tutorial_workfront_configure.png) 

7. Inloggning till webbplatsen Workfront företag som administratör.
