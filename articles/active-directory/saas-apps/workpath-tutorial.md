...
5. I resultatpanelen väljer **Workpath**, och klicka sedan på **Lägg till** för att lägga till programmet.
...
3. **[Skapa en testanvändare Workpath](#creating-a-workpath-test-user)**  – du har en motsvarighet för Britta Simon i Workpath som är länkad till en Azure AD-representation av användaren.
...
3. På den **Workpath domän och URL: er** om du vill konfigurera programmet i **IDP** initierad läge utför följande steg:
...
4. Kontrollera **visa avancerade URL-inställningar**. Om du vill konfigurera programmet i **SP** initierade läge, utför följande steg:
...
5. Workpath program som förväntar SAML-intyg i ett visst format. Konfigurera följande anspråk för det här programmet. Du kan hantera värdena för dessa attribut från den ”**användarattribut**” på sidan för integrering av program. Följande skärmbild visar ett exempel för den här konfigurationen. 
...
9. På den **Workpath Configuration** klickar du på **konfigurera Workpath** att öppna **konfigurera inloggning** fönster. Kopiera den **URL för utloggning, SAML entitets-ID och SAML enkel inloggning för tjänst-URL** från den **Snabbreferens avsnittet.**

    ![Konfigurera enkel inloggning](./media/workpath-tutorial/tutorial_workpath_configure.png) 

10. Att konfigurera enkel inloggning på **Workpath** sida, som du behöver skicka de hämtade **XML-Metadata för**, **URL för utloggning, SAML entitets-ID och SAML enkel inloggning för tjänst-URL** till [Workpath supportteamet](https://help.workpath.com). 
