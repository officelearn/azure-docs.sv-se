---
title: 'Självstudier: Azure Active Directory-integration med Workrite | Microsoft Docs'
...
ms.locfileid: "39437995"
---
# <a name="tutorial-azure-active-directory-integration-with-workrite"></a>Självstudier: Azure Active Directory-integration med Workrite
...
1. På den **Workrite domän och URL: er** avsnittet, utför följande steg:
    ...
    I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://app.workrite.co.uk/securelogin/samlgateway.aspx?id=<uniqueid>`
...
1. På den **SAML-signeringscertifikat** klickar du på **Certificate(Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länk för hämtning av certifikat](./media/workrite-tutorial/tutorial_workrite_certificate.png) 

1. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara-knapp](./media/workrite-tutorial/tutorial_general_400.png)
