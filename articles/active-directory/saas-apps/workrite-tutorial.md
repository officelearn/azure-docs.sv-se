...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/workrite-tutorial/tutorial_workrite_samlbase.png)

3. På den **Workrite domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och Workrite domän med enkel inloggning information](./media/workrite-tutorial/tutorial_workrite_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **Certificate(Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/workrite-tutorial/tutorial_workrite_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/workrite-tutorial/tutorial_general_400.png)
