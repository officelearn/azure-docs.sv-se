...
* Du kan aktivera användarna att vara automatiskt inloggad till rad fungerar (Single Sign-On) med sina Azure AD-konton.
...
* RAD fungerar enkel inloggning aktiverad prenumeration

## <a name="scenario-description"></a>Scenariobeskrivning

I den här självstudien konfigurerar och testar du enkel inloggning med Azure AD i en testmiljö.

* Har stöd för rad fungerar **SP** -initierad SSO
...
4. I sökrutan skriver **rad fungerar**väljer **rad fungerar** resultatet panelen klickar **Lägg till** för att lägga till programmet.
    ...
    ![RAD fungerar i resultatlistan](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurera och testa Azure AD enkel inloggning

I det här avsnittet ska du konfigurera och testa Azure AD enkel inloggning med rad fungerar baserat på en testanvändare kallas **Britta Simon**.
För enkel inloggning ska fungera, måste en länk förhållandet mellan en Azure AD-användare och den relaterade användaren i rad fungerar upprättas.
...
2. **[Konfigurera enkel inloggning för rad-fungerar](#configure-line-works-single-sign-on)**  – om du vill konfigurera inställningar för enkel inloggning på programsidan.
3. **[Skapa en Azure AD-testanvändare](#create-an-azure-ad-test-user)**  – om du vill testa Azure AD enkel inloggning med Britta Simon.
4. **[Tilldela Azure AD-testanvändare](#assign-the-azure-ad-test-user)**  – om du vill aktivera Britta Simon att använda Azure AD enkel inloggning.
5. **[Skapa rad fungerar testanvändare](#create-line-works-test-user)**  – du har en motsvarighet för Britta Simon i rad fungerar som är länkad till en Azure AD-representation av användaren.
...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    ![RAD fungerar domän och URL: er med enkel inloggning för information](common/sp-identifier.png)

    a. I textrutan **Inloggnings-URL** anger du en URL enligt följande mönster: `https://auth.worksmobile.com/d/login/<domain>/`

    b. I textrutan **Identifierare (entitets-ID)** anger du en URL: `worksmobile.com`
...
6. På den **konfigurera rad fungerar** avsnittet, kopiera den lämpliga URL: er enligt dina behov.
...
### <a name="configure-line-works-single-sign-on"></a>Konfigurera rad fungerar enkel inloggning

Att konfigurera enkel inloggning på **rad fungerar** sida, Läs igenom den [rad fungerar SSO dokument](https://developers.worksmobile.com/jp/document/1001080101) och konfigurera en inställning för rad fungerar.
...
1. I Azure-portalen väljer du **företagsprogram**väljer **alla program**och välj sedan **rad fungerar**.

    ![Bladet Företagsprogram](common/enterprise-applications.png)

2. I listan med program väljer **rad fungerar**.

    ![Länken fungerar för rad i listan med program](common/all-applications.png)
...
### <a name="create-line-works-test-user"></a>Skapa rad fungerar testanvändare
...
När du klickar på panelen rad fungerar i åtkomstpanelen, bör det vara loggas in automatiskt till rad-fungerar som du ställer in enkel inloggning. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
