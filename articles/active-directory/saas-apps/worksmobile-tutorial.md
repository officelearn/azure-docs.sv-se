...
3. **[Skapa en rad fungerar testanvändare](#creating-a-line-works-test-user)**  – du har en motsvarighet för Britta Simon i rad fungerar som är länkad till en Azure AD-representation av användaren.
...
6. På den **konfigurera rad fungerar** avsnittet, kopiera den lämpliga URL enligt dina behov.
    ...
    ![RAD fungerar konfiguration](common/configuresection.png)
...
### <a name="creating-a-line-works-test-user"></a>Skapa en rad fungerar testanvändare
...
2. I listan med program väljer **rad fungerar**.
    ...
    ![Konfigurera enkel inloggning](./media/worksmobile-tutorial/tutorial_lineworks_app.png)
