...
6. På den **rad fungerar Configuration** klickar du på **konfigurera rad fungerar** att öppna **konfigurera inloggning** fönster. Kopiera den **URL för utloggning, SAML entitets-ID och SAML enkel inloggning för tjänst-URL** från den **Snabbreferens avsnittet.**

    ![RAD fungerar konfiguration](./media/worksmobile-tutorial/tutorial_lineworks_configure.png) 

7. Att konfigurera enkel inloggning på **rad fungerar** sida, som du behöver skicka de hämtade **certifikat-fil, URL: en för utloggning, SAML entitets-ID och SAML enkel inloggning för tjänst-URL** till [stöd för rad fungerar team](mailto:dl_ssoinfo@worksmobile.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
