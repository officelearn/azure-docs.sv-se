...
6. Utför följande steg på sidan **SAML-inställningar** :
    ...
    b. I text rutan för **SAML-Sign-On tjänstens URL** klistrar du in värdet för **inloggnings-URL: en**som du har kopierat från Azure Portal.
...
När du klickar på panelen Workteam på åtkomst panelen, bör du loggas in automatiskt på den Workteam som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
