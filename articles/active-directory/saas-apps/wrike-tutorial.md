---
title: 'Självstudier: Azure Active Directory-integration med Wrike | Microsoft Docs'
...
ms.locfileid: "51977669"
---
# <a name="tutorial-azure-active-directory-integration-with-wrike"></a>Självstudier: Azure Active Directory-integration med Wrike
...
4. På den **SAML grundkonfiguration** avsnittet användaren behöver inte utföra några steg som appen är redan förintegrerade med Azure.
    ...
    a. Klicka på **ange ytterligare webbadresser** och utföra följande steg om du vill konfigurera programmet i **SP** initierade läge:

    b. I den **inloggnings-URL** textrutan anger du ett URL: `https://www.wrike.com/login/`
...
5. På den **SAML-signeringscertifikat** sidan den **SAML-signeringscertifikat** klickar du på **hämta** att ladda ned **Federation Metadata XML** och spara för metadatafilen på datorn.
    ...
    ![Länk för hämtning av certifikat](./media/wrike-tutorial/tutorial_wrike_certificate.png) 

6. Att konfigurera enkel inloggning på **Wrike** sida, som du behöver skicka de hämtade **XML-Metadata för Federation** till [Wrike supportteamet](mailto:support@team.wrike.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
...
Målet med det här avsnittet är att skapa en användare som kallas Britta Simon i Wrike. Wrike stöder just-in-time-etablering, vilket är som standard aktiverat. Det finns inga uppgift åt dig i det här avsnittet. En ny användare har skapats under ett försök att komma åt Wrike om det inte finns ännu.
>[!Note]
