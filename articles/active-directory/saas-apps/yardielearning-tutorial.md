---
title: 'Självstudier: Azure Active Directory-integration med Yardi e | Microsoft Docs'
...
ms.locfileid: "39437206"
---
# <a name="tutorial-azure-active-directory-integration-with-yardi-elearning"></a>Självstudier: Azure Active Directory-integration med Yardi e
...
1. På den **Yardi e-domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I den **inloggnings-URL** textrutan anger du ett URL med hjälp av följande mönster: `https://<companyname>.yardielearning.com/login`

    b. I den **identifierare** textrutan anger du ett URL med hjälp av följande mönster: `https://<companyname>.yardielearning.com/trust`

    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska inloggnings-URL och identifierare. Kontakta [Yardi e klienten supportteamet](mailto:elearning@yardi.com) att hämta dessa värden. 
...
Det finns inga uppgift åt dig i det här avsnittet. En ny användare har skapats under ett försök att komma åt Yardi e om det inte finns ännu. 
