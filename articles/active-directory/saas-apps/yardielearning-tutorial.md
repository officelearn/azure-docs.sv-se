...
2. **[Konfigurera eLearning-enkel inloggning](#configure-yardi-elearning-single-sign-on)** för att konfigurera inställningar för enkel inloggning på program sidan.
...
### <a name="configure-yardi-elearning-single-sign-on"></a>Konfigurera eLearning enkel inloggning
...
När du klickar på panelen eLearning i åtkomst panelen bör du loggas in automatiskt på den eLearning som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
