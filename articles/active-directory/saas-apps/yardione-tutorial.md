...
2. **[Konfigurera YardiOne-enkel inloggning](#configure-yardione-single-sign-on)** för att konfigurera inställningarna för enkel inloggning på program sidan.
...
### <a name="configure-yardione-single-sign-on"></a>Konfigurera YardiOne enkel inloggning
...
När du klickar på panelen YardiOne på åtkomst panelen, bör du loggas in automatiskt på den YardiOne som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
