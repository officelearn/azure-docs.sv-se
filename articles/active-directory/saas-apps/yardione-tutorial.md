...
1. På den **YardiOne domän och URL: er** avsnittet, utför följande steg:
    ...
    a. I textrutan **Inloggnings-URL** anger du en URL med följande mönster: `https://<y1-subdomain>.yardione.com`

    b. I textrutan **Identifierare** anger du en URL med följande mönster: `http://<y1-subdomain>.yardione.com/yAuth2/trust`

    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med faktisk inloggnings-URL och identifierare. Kontakta [YardiOne klienten supportteamet](https://clientcentral.yardi.com) att hämta dessa värden.
...
1. På den **SAML-signeringscertifikat** klickar du på kopieringsknappen för att kopiera **Appfederationsmetadata** och klistra in den i anteckningar. 
    ...
    ![Länk för nedladdning av certifikatet](./media/yardione-tutorial/tutorial_yardione_certificate.png) 
 
1. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning – knappen Spara](./media/yardione-tutorial/tutorial_general_400.png)

1. Att konfigurera enkel inloggning på **YardiOne** sida, som du behöver skicka den **Appfederationsmetadata** till [YardiOne supportteamet](https://clientcentral.yardi.com). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
...
### <a name="create-a-yardione-test-user"></a>Create a YardiOne test user

Målet med det här avsnittet är att skapa en användare som kallas Britta Simon i YardiOne. YardiOne stöder just-in-time-etablering, vilket är som standard aktiverat. Det finns inget åtgärdsobjekt för dig i det här avsnittet. En ny användare har skapats under ett försök att komma åt YardiOne om det inte finns ännu.
