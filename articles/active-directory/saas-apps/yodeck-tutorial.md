---
title: 'Självstudier: Azure Active Directory-integration med Yodeck | Microsoft Docs'
...
ms.locfileid: "39055715"
---
# <a name="tutorial-azure-active-directory-integration-with-yodeck"></a>Självstudier: Azure Active Directory-integration med Yodeck
...
3. **[Skapa en testanvändare Yodeck](#create-a-yodeck-test-user)**  – du har en motsvarighet för Britta Simon i Yodeck som är länkad till en Azure AD-representation av användaren.
...
5. På den **SAML-signeringscertifikat** klickar du på kopieringsknappen för att kopiera **Appfederationsmetadata** och klistra in den i anteckningar.
    ...
    ![Länk för hämtning av certifikat](./media/yodeck-tutorial/tutorial_yodeck_certificate.png)

6. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara-knapp](./media/yodeck-tutorial/tutorial_general_400.png)
    
7. I ett annat webbläsarfönster logga du in på webbplatsen Yodeck företag som administratör.

8. Klicka på **användarinställningar** alternativet form det övre högra hörnet av sidan och väljer **kontoinställningar**.
...
2. Klicka på **användarinställningar** alternativet form det övre högra hörnet av sidan och väljer **användare**.
    ...
    ![Lägg till medarbetare](./media/yodeck-tutorial/user1.png)

3. Klicka på **+ användare** att öppna den **användarinformation** fliken.

    ![Lägg till medarbetare](./media/yodeck-tutorial/user2.png)

4. På den **användarinformation** dialogrutan utför följande steg:

    ![Lägg till medarbetare](./media/yodeck-tutorial/user3.png)
