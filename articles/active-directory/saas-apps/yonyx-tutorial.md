...
3. **[Skapa en testanvändare Yonyx interaktiva guider](#create-a-yonyx-interactive-guides-test-user)**  – du har en motsvarighet för Britta Simon i Yonyx interaktiva guider som är länkad till en Azure AD-representation av användaren.
