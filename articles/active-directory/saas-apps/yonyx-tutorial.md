...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/yonyx-tutorial/tutorial_yonyxinteractiveguides_samlbase.png)

3. På den **Yonyx interaktiva guider domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och Yonyx interaktiva guider domän med enkel inloggning information](./media/yonyx-tutorial/tutorial_yonyxinteractiveguides_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **Certificate(Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/yonyx-tutorial/tutorial_yonyxinteractiveguides_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/yonyx-tutorial/tutorial_general_400.png)
