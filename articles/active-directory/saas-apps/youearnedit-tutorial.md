...
7. Att konfigurera enkel inloggning på **YouEarnedIt** sida, som du behöver skicka de hämtade **Certificate(Base64)** och **SAML enkel inloggning för tjänst-URL** till [ YouEarnedIt supportteamet](https://youearnedit.freshdesk.com/support/tickets/new). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
