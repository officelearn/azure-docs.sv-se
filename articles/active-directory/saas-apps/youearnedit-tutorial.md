...
1. I sökrutan skriver **YouEarnedt**väljer **YouEarnedt** resultatet panelen klickar **Lägg till** för att lägga till programmet.
...
1. **[Skapa en testanvändare YouEarnedIt](#create-a-youearnedit-test-user)**  – du har en motsvarighet för Britta Simon i YouEarnedIt som är länkad till en Azure AD-representation av användaren.
...
1. På den **YouEarnedIt domän och URL: er** avsnittet, utför följande steg:
    ...
    > [!NOTE] 
    > Dessa värden är inte verkliga. Uppdatera dessa värden med de faktiska inloggnings-URL och identifierare. Kontakta [YouEarnedIt klienten supportteamet](https://youearnedit.freshdesk.com/support/tickets/new) att hämta dessa värden. 
...
1. På den **YouEarnedIt Configuration** klickar du på **konfigurera YouEarnedIt** att öppna **konfigurera inloggning** fönster. Kopiera den **SAML enkel inloggning för tjänst-URL** från den **Snabbreferens avsnittet.**

    ![YouEarnedIt konfiguration](./media/youearnedit-tutorial/tutorial_youearnedit_configure.png) 

1. Att konfigurera enkel inloggning på **YouEarnedIt** sida, som du behöver skicka de hämtade **Certificate(Base64)** och **SAML enkel inloggning för tjänst-URL** till [ YouEarnedIt supportteamet](https://youearnedit.freshdesk.com/support/tickets/new). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
...
I det här avsnittet skapar du en användare som kallas Britta Simon i YouEarnedIt. Kontakta YouEarnedIt supportteamet att lägga till användare i YouEarnedIt-plattformen.
...
1. I listan med program väljer **YouEarnedIt**.
