...
Att konfigurera enkel inloggning på **ZenQMS** sida, som du behöver skicka den **Appfederationsmetadata** till [ZenQMS supportteam](mailto:help@zenqms.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
