...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/ziflow-tutorial/tutorial_ziflow_samlbase.png)

3. På den **Ziflow domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och Ziflow domän med enkel inloggning information](./media/ziflow-tutorial/tutorial_ziflow_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **certifikat (Base64)** och spara certifikatfilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/ziflow-tutorial/tutorial_ziflow_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/ziflow-tutorial/tutorial_general_400.png)
...
2. Gå till **personer** högst upp.
    ...
    ![Konfiguration av Ziflow personer](./media/ziflow-tutorial/tutorial_ziflow_people.png)

3. Klicka på **Lägg till** och klicka sedan på **Lägg till användare**.

    ![Ziflow Configuration att lägga till användaren](./media/ziflow-tutorial/tutorial_ziflow_add.png)

4. På den **lägga till en användare** popup, utför följande steg:

    ![Ziflow Configuration att lägga till användaren](./media/ziflow-tutorial/tutorial_ziflow_adduser.png)
