...
När du klickar på panelen ZIVVER på åtkomst panelen, bör du loggas in automatiskt på den ZIVVER som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
