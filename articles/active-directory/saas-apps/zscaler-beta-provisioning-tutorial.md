...
3. Lägg till Zscaler Beta, klicka på den **nytt program** knappen överst i dialogrutan.

    ![Knappen Nytt program][3]

4. I sökrutan skriver **Zscaler Beta**.

    ![Zscaler Beta etablering](./media/zscaler-beta-provisioning-tutorial/app-search.png)

5. I resultatpanelen väljer **Zscaler Beta**, och klicka sedan på den **Lägg till** för att lägga till Zscaler Beta i listan med SaaS-program.

    ![Zscaler Beta etablering](./media/zscaler-beta-provisioning-tutorial/app-search-results.png)

    ![Zscaler Beta etablering](./media/zscaler-beta-provisioning-tutorial/app-creation.png)
...
2. Välj Zscaler Beta från din lista över SaaS-program.

    ![Zscaler Beta etablering](./media/zscaler-beta-provisioning-tutorial/app-instance-search.png)
