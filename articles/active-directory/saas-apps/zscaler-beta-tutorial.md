...
5. I resultatpanelen väljer **Zscaler Beta**, och klicka sedan på **Lägg till** för att lägga till programmet.
...
4. **[Skapa en testanvändare Zscaler Beta](#creating-a-zscaler-beta-test-user)**  – du har en motsvarighet för Britta Simon i betaversionen av Zscaler som är länkad till en Azure AD-representation av användaren.
...
6. På den **Zscaler Beta Configuration** klickar du på **konfigurera Zscaler Beta** att öppna **konfigurera inloggning** fönster. Kopiera den **SAML enkel inloggning för tjänst-URL** från den **Snabbreferens avsnittet.**

    ![Konfigurera enkel inloggning](./media/zscaler-beta-tutorial/tutorial_zscalerbeta_configure.png) 

7. I ett annat webbläsarfönster logga du in på webbplatsen Zscaler Beta företagets som administratör.
