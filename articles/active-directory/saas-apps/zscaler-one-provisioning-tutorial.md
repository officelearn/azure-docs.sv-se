...
3. Lägg till en Zscaler, klicka på den **nytt program** knappen överst i dialogrutan.

    ![Knappen Nytt program][3]

4. I sökrutan skriver **Zscaler en**.

    ![Zscaler en etablering](./media/zscaler-one-provisioning-tutorial/app-search.png)

5. I resultatpanelen väljer **Zscaler en**, och klicka sedan på den **Lägg till** för att lägga till en Zscaler i listan med SaaS-program.

    ![Zscaler en etablering](./media/zscaler-one-provisioning-tutorial/app-search-results.png)

    ![Zscaler en etablering](./media/zscaler-one-provisioning-tutorial/app-creation.png)
...
2. Välj en Zscaler från din lista över SaaS-program.

    ![Zscaler en etablering](./media/zscaler-one-provisioning-tutorial/app-instance-search.png)
