...
5. I resultatpanelen väljer **Zscaler en**, och klicka sedan på **Lägg till** för att lägga till programmet.
...
6. På den **Zscaler en konfiguration** klickar du på **konfigurera Zscaler en** att öppna **konfigurera inloggning** fönster. Kopiera den **SAML enkel inloggning för tjänst-URL** från den **Snabbreferens avsnittet.**

    ![Konfigurera enkel inloggning](./media/zscaler-one-tutorial/tutorial_zscalerone_configure.png) 

7. I ett annat webbläsarfönster logga du in på webbplatsen Zscaler ett företag som administratör.
