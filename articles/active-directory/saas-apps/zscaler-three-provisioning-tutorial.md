---
title: 'Självstudiekurs: Konfigurera Zscaler Three för automatisk användaretablering med Azure Active Directory | Microsoft-dokument'
description: I den här självstudien får du lära dig hur du konfigurerar Azure Active Directory för att automatiskt etablera och avetablera användarkonton till Zscaler Three.
...
---
# <a name="tutorial-configure-zscaler-three-for-automatic-user-provisioning"></a>Självstudiekurs: Konfigurera Zscaler Tre för automatisk etablering av användare

I den här självstudien får du lära dig hur du konfigurerar Azure Active Directory (Azure AD) för att automatiskt etablera och avetablera användare och/eller grupper till Zscaler Three.
...
* En Zscaler Tre hyresgäst.
* Ett användarkonto i Zscaler Three med administratörsbehörighet.
...
Innan du konfigurerar Zscaler Three för automatisk användaretablering med Azure AD måste du lägga till Zscaler Three från Azure AD-programgalleriet i listan över hanterade SaaS-program.
...
Skriv **Zscaler Three**i sökrutan . Välj **Zscaler Tre** i resultatet och välj sedan **Lägg till**.

![Resultatlista](common/search-new-app.png)

## <a name="assign-users-to-zscaler-three"></a>Tilldela användare till Zscaler Three
...
Innan du konfigurerar och aktiverar automatisk användaretablering bör du bestämma vilka användare och/eller grupper i Azure AD som behöver åtkomst till Zscaler Three. När du har bestämt dig kan du tilldela dessa användare och grupper till Zscaler Three genom att följa instruktionerna i [Tilldela en användare eller grupp till en företagsapp](https://docs.microsoft.com/azure/active-directory/active-directory-coreapps-assign-user-azure-portal).

### <a name="important-tips-for-assigning-users-to-zscaler-three"></a>Viktiga tips för att tilldela användare till Zscaler Three

* Vi rekommenderar att du först tilldelar en enda Azure AD-användare till Zscaler Three för att testa konfigurationen för automatisk användaretablering. Du kan tilldela fler användare och grupper senare.

* När du tilldelar en användare till Zscaler Three måste du välja en giltig programspecifik roll (om sådan finns) i tilldelningsdialogrutan. Användare med rollen **Standardåtkomst** är undantagna från etablering.

## <a name="set-up-automatic-user-provisioning"></a>Ställ in automatisk användaretablering

Det här avsnittet guidar dig genom stegen för att konfigurera Azure AD-etableringstjänsten för att skapa, uppdatera och inaktivera användare och grupper i Zscaler Three baserat på användar- och grupptilldelningar i Azure AD.

> [!TIP]
> Du kanske också vill aktivera SAML-baserad enkel inloggning för Zscaler Three. Om du gör det följer du instruktionerna i [Zscaler Three single sign-on tutorial](zscaler-three-tutorial.md). Enkel inloggning kan konfigureras oberoende av automatisk användaretablering, men de två funktionerna kompletterar varandra.

1. Logga in på [Azure-portalen](https://portal.azure.com) och välj **Enterprise-program** > **Alla program** > **Zscaler Tre:**

    ![Företagsprogram](common/enterprise-applications.png)

2. Välj **Zscaler Three**i programlistan :
...
5. I avsnittet **Administratörsautentiseringsuppgifter** anger du **klient-URL:en** och **hemlig token för** ditt Zscaler Three-konto, enligt beskrivningen i nästa steg.

6. Om du vill hämta **klient-URL:en** och **hemlig token**går du till**Administrationsautentiseringsinställningar** **Administration** > i Zscaler Three-portalen och väljer **SAML** under **Autentiseringstyp:**
...
7. När du har angett värdena i **rutorna Klient-URL** och **Hemlig token** väljer du **Testa anslutning** för att se till att Azure AD kan ansluta till Zscaler Three. Om anslutningen misslyckas kontrollerar du att ditt Zscaler Three-konto har administratörsbehörighet och försöker igen.
...
10. I avsnittet **Mappningar** väljer du **Synkronisera Azure Active Directory-användare till ZscalerTre:**

    ![Synkronisera Azure AD-användare](./media/zscaler-three-provisioning-tutorial/user-mappings.png)

11. Granska användarattributen som synkroniseras från Azure AD till Zscaler Three i avsnittet **Attributmappningar.** De attribut som valts som **matchande** egenskaper används för att matcha användarkontona i Zscaler Three för uppdateringsåtgärder. Välj **Spara** om du vill genomföra eventuella ändringar.

    ![Attributmappningar](./media/zscaler-three-provisioning-tutorial/user-attribute-mappings.png)

12. I avsnittet **Mappningar** väljer du **Synkronisera Azure Active Directory Groups till ZscalerTre:**

    ![Synkronisera Azure AD-grupper](./media/zscaler-three-provisioning-tutorial/group-mappings.png)

13. Granska gruppattributen som synkroniseras från Azure AD till Zscaler Three i avsnittet **Attributmappningar.** De attribut som valts som **matchande** egenskaper används för att matcha grupperna i Zscaler Three för uppdateringsåtgärder. Välj **Spara** om du vill genomföra eventuella ändringar.
...
15. Om du vill aktivera Azure AD-etableringstjänsten för Zscaler Three ändrar **du etableringsstatusen** till **På** i avsnittet **Inställningar:**

    ![Etableringsstatus](./media/zscaler-three-provisioning-tutorial/provisioning-status.png)

16. Definiera de användare och/eller grupper som du vill etablera till Zscaler Tre genom att välja de värden du vill använda under **Scope** i avsnittet **Inställningar:**

    ![Scopevärden](./media/zscaler-three-provisioning-tutorial/scoping.png)
