---
title: 'Självstudier: Konfigurera Zscaler tre för automatisk användar etablering med Azure Active Directory | Microsoft Docs'
...
ms.locfileid: "68515365"
---
# <a name="tutorial-configure-zscaler-three-for-automatic-user-provisioning"></a>Självstudier: Konfigurera Zscaler tre för automatisk användar etablering
...
17. När du är redo att etablera väljer du **Spara**:
    ...
    ![Välj Spara](./media/zscaler-three-provisioning-tutorial/save-provisioning.png)
