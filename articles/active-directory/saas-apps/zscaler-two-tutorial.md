...
2. **[Konfigurera Zscaler två enkla inloggningar](#configure-zscaler-two-single-sign-on)** för att konfigurera enskilda Sign-On inställningar på program sidan.
...
### <a name="configure-zscaler-two-single-sign-on"></a>Konfigurera Zscaler två enkla Sign-On
...
När du klickar på panelen Zscaler två på åtkomst panelen, bör du loggas in automatiskt på de Zscaler två som du ställer in SSO för. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](../user-help/my-apps-portal-end-user-access.md).
