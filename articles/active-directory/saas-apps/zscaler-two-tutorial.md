...
* Du kan aktivera användarna att vara automatiskt inloggad till två Zscaler (Single Sign-On) med sina Azure AD-konton.
...
* Zscaler två enkel inloggning aktiverad prenumeration
...
* Zscaler två stöder **Just In Time** etableringen av användare
...
I det här avsnittet ska du konfigurera och testa Azure AD enkel inloggning med Zscaler två baserat på en testanvändare kallas **Britta Simon**.
För enkel inloggning ska fungera, måste en länk förhållandet mellan en Azure AD-användare och relaterade användaren i två Zscaler upprättas.
...
2. **[Konfigurera Zscaler två enkel inloggning](#configure-zscaler-two-single-sign-on)**  – om du vill konfigurera inställningar för enkel inloggning på programsidan.
3. **[Skapa en Azure AD-testanvändare](#create-an-azure-ad-test-user)** – för att testa enkel inloggning med Azure AD med Britta Simon.
4. **[Tilldela Azure AD-testanvändaren](#assign-the-azure-ad-test-user)** – så att Britta Simon kan använda enkel inloggning med Azure AD.
5. **[Skapa Zscaler två testanvändare](#create-zscaler-two-test-user)**  – du har en motsvarighet för Britta Simon i Zscaler två som är länkad till en Azure AD-representation av användaren.
...
1. I den [Azure-portalen](https://portal.azure.com/)på den **Zscaler två** application integration markerar **enkel inloggning**.
...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    ![Zscaler två domän och URL: er med enkel inloggning för information](common/sp-signonurl.png)

    Skriv den URL som används av användarna logga in till ditt ZScaler två program i inloggnings-URL-textrutan.

    > [!NOTE]
    > Du kan uppdatera värdet med faktiska inloggnings-URL: en. Kontakta [Zscaler två klienten supportteamet](https://www.zscaler.com/company/contact) att hämta värdet. Du kan även se mönstren som visas i avsnittet **Grundläggande SAML-konfiguration** i Azure-portalen.

5. Zscaler två programmet förväntar sig SAML-intyg i ett visst format, vilket kräver att du kan lägga till anpassade attributmappningar i SAML-tokenattribut konfigurationen. I följande skärmbild visas listan över standardattribut. Klicka på ikonen  **Redigera** för att öppna dialogrutan **Användarattribut** .

    ![image](common/edit-attribute.png)

6. Förutom ovanstående Zscaler två program som förväntar få fler attribut som ska skickas tillbaka i SAML-svar. I avsnittet **Användaranspråk** i dialogrutan **Användarattribut** utför du följande steg för att lägga till SAML-tokenattributet enligt det som visas i tabellen nedan:
...
8. På den **ställa in två Zscaler** avsnittet, kopiera den lämpliga URL: er enligt dina behov.
...
1. Om du vill automatisera konfiguration i två Zscaler, måste du installera **Mina appar skyddat inloggning webbläsartillägget** genom att klicka på **installera tillägget**.

    ![Mina appar-tillägg](common/install-myappssecure-extension.png)

2. När du lägger till tillägg till webbläsaren, klickar på **installationsprogrammet Zscaler två** omdirigerar dig till två Zscaler programmet. Ange administratörsautentiseringsuppgifter för att logga in på Zscaler två därifrån. Webbläsartillägget automatiskt att konfigurera program för dig. och automatisera steg 3 – 6.

    ![Konfigurera enkel inloggning](common/setup-sso.png)

3. Om du vill att installationsprogrammet Zscaler två manuellt, öppna ett nytt webbläsarfönster och logga till Zscaler två företagets webbplatsen som administratör och utför följande steg:
...
1. I Azure-portalen väljer du **företagsprogram**väljer **alla program**och välj sedan **Zscaler två**.
...
I det här avsnittet skapas en användare som kallas Britta Simon i Zscaler två. Zscaler två stöder etableringen av just-in-time-användare som är aktiverat som standard. Det finns inget åtgärdsobjekt för dig i det här avsnittet. Om en användare inte redan finns i två Zscaler, skapas en ny efter autentisering.
...
När du klickar på panelen Zscaler två i åtkomstpanelen bör det vara loggas in automatiskt till den Zscaler två som du ställer in enkel inloggning. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
