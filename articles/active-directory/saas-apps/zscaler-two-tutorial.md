...
4. Gå till **Administration > Autentisering > Autentiseringsinställningar** och utför följande steg:
    ...
    ![Administrationsverktyg](./media/zscaler-two-tutorial/ic800206.png "Administration")
...
5. I dialogrutan **Användare och grupper** väljer du användaren **Britta Simon** i listan och klickar sedan på knappen **Välj** längst ned på skärmen.
    ...
    ![mallar](./media/zscaler-two-tutorial/tutorial_zscalertwo_users.png)
...
6. I dialogrutan **Välj roll** väljer du lämplig användarroll i listan och klickar sedan på knappen **Välj** längst ned på skärmen.
    ...
    ![mallar](./media/zscaler-two-tutorial/tutorial_zscalertwo_roles.png)

7. I dialogrutan **Lägg till tilldelning** väljer du knappen **Tilldela**.

    ![mallar](./media/zscaler-two-tutorial/tutorial_zscalertwo_assign.png)
...
När du klickar på panelen Zscaler två på åtkomst panelen, bör du loggas in automatiskt på de Zscaler två som du ställer in SSO för. I [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) får du mer information.
