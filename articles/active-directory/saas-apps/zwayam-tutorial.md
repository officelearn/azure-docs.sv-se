...
2. På den **enkel inloggning** markerar **läge** som **SAML-baserade inloggning** att aktivera enkel inloggning.
    ...
    ![Enkel inloggning dialogrutan](./media/zwayam-tutorial/tutorial_Zwayam_samlbase.png)

3. På den **Zwayam domän och URL: er** avsnittet, utför följande steg:

    ![URL: er och Zwayam domän med enkel inloggning information](./media/zwayam-tutorial/tutorial_Zwayam_url.png)
...
4. På den **SAML-signeringscertifikat** klickar du på **XML-Metadata för** och spara sedan metadatafilen på datorn.
    ...
    ![Länken hämta certifikatet](./media/zwayam-tutorial/tutorial_Zwayam_certificate.png) 

5. Klicka på **spara** knappen.

    ![Konfigurera enkel inloggning spara](./media/zwayam-tutorial/tutorial_general_400.png)
