...
Att konfigurera enkel inloggning på **Zwayam** sida, som du behöver skicka de hämtade **XML-Metadata för Federation** och lämpliga kopierade URL: er från Azure portal för att [Zwayam supportteamet](mailto:opendoors@zwayam.com). De ställer du in SAML SSO ansluta till korrekt inställda på båda sidorna.
