...
* Du kan aktivera användarna att vara automatiskt inloggad till Zwayam (Single Sign-On) med sina Azure AD-konton.
...
* Zwayam enkel inloggning aktiverat prenumeration

## <a name="scenario-description"></a>Scenariobeskrivning

I den här självstudien konfigurerar och testar du enkel inloggning med Azure AD i en testmiljö.

* Har stöd för Zwayam **SP** -initierad SSO
...
I det här avsnittet ska du konfigurera och testa Azure AD enkel inloggning med Zwayam baserat på en testanvändare kallas **Britta Simon**.
För enkel inloggning ska fungera, måste en länk förhållandet mellan en Azure AD-användare och relaterade användaren i Zwayam upprättas.
...
2. **[Konfigurera Zwayam Single Sign-On](#configure-zwayam-single-sign-on)**  – om du vill konfigurera inställningar för enkel inloggning på programsidan.
3. **[Skapa en Azure AD-testanvändare](#create-an-azure-ad-test-user)** – för att testa enkel inloggning med Azure AD med Britta Simon.
4. **[Tilldela Azure AD-testanvändaren](#assign-the-azure-ad-test-user)** – så att Britta Simon kan använda enkel inloggning med Azure AD.
5. **[Skapa testanvändare Zwayam](#create-zwayam-test-user)**  – du har en motsvarighet för Britta Simon i Zwayam som är länkad till en Azure AD-representation av användaren.
...
1. I den [Azure-portalen](https://portal.azure.com/)på den **Zwayam** application integration markerar **enkel inloggning**.
...
4. I avsnittet **Grundläggande SAML-konfiguration** utför du följande steg:
    ...
    ![Zwayam domän och URL: er med enkel inloggning för information](common/sp-identifier.png)
    ...
    b. I textrutan **Identifierare (entitets-ID)** anger du en URL: `https://sso.zwayam.com/zwayam-saml/saml/metadata`

    > [!NOTE]
    > Värdet för **inloggnings-URL** är inte verkligt. Uppdatera värdet med den faktiska inloggnings-URL:en. `<SAML Entity ID>` är Azure AD-ID-värde som beskrivs senare i självstudien.
...
6. På den **konfigurera Zwayam** avsnittet, kopiera den lämpliga URL: er enligt dina behov.
...
Att konfigurera enkel inloggning på **Zwayam** sida, som du behöver skicka de hämtade **XML-Metadata för Federation** och lämpliga kopierade URL: er från Azure portal för att [Zwayam supportteamet](mailto:opendoors@zwayam.com). De anger inställningen så att SAML SSO-anslutningen ställs in korrekt på båda sidorna.
...
1. I Azure-portalen väljer du **företagsprogram**väljer **alla program**och välj sedan **Zwayam**.

    ![Bladet Företagsprogram](common/enterprise-applications.png)

2. I listan med program väljer **Zwayam**.

    ![Länken Zwayam i listan med program](common/all-applications.png)
...
När du klickar på panelen Zwayam i åtkomstpanelen, bör det vara loggas in automatiskt till Zwayam som du ställer in enkel inloggning. Mer information om åtkomstpanelen finns i [introduktionen till åtkomstpanelen](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
