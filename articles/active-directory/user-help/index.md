...
Vi har skapat det här innehållet för att hjälpa dig att konfigurera och använda säkerhetsinformation och tvåstegsverifiering, återställa dina egna lösenord, konfigurera och ansluta dina Azure Active Directory-enheter och konfigurera och använda Microsoft Authenticator-appen samt portalen Mina appar.
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <a href="/azure/active-directory/user-help/security-info-setup-security-key">Konfigurera en säkerhetsnyckel</a><br/>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Hjälp om återställning av lösenord</h3>
                        <p>
                        <a href="/azure/active-directory/user-help/active-directory-passwords-reset-register">Registrera dig för återställning av lösenord</a><br/>
                        <a href="/azure/active-directory/user-help/security-info-setup-email">Konfigurera e-post</a><br/>
                        <a href="/azure/active-directory/user-help/security-info-setup-questions">Konfigurera säkerhetsfrågor</a><br/>
                        <a href="/azure/active-directory/user-help/user-help-reset-password">Återställa lösenordet</a>
                        </p>
                    </div>
                </div>
            </div>
