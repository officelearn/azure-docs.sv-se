...
1. På din dator, Observera de **kod** och **Url** information om den **konfigurera mobilappen** sidan. Behåll den här sidan öppen så att du kan se koden och Webbadressen.
    ...
    ![Skärmen som tillhandahåller QR-kod](./media/microsoft-authenticator-app-add-account-manual/auth-app-barcode.png)
...
3. Välj **eller ange koden MANUELLT**.
    ...
    ![Skärmen för att skanna en QR-kod](./media/microsoft-authenticator-app-add-account-manual/auth-app-manual-code.png)
   
4. Ange den **kod** och **URL** från steg 1 och välj sedan **Slutför**.

    ![Skärmen för att ange koden och Webbadressen](./media/microsoft-authenticator-app-add-account-manual/auth-app-code-url.png)
...
- När du har lagt till dina konton till appen, kan du logga in med Microsoft Authenticator-appen på din enhet. Mer information finns i [logga in med appen](microsoft-authenticator-app-phone-signin-faq.md).
