...
- **Konfiguration av lösenordsfri inloggning metod.** Ange ditt användarnamn i enheten du loggar in för ditt personliga Microsoft-konto och sedan använda din mobila enhet för att kontrollera att det är du med hjälp av ditt fingeravtryck, ett ansikte eller en PIN-kod. Den här metoden behöver du inte ange ditt lösenord.
...
2. Längst ned på den **säkerhetskoncepten** väljer du den **mer säkerhetsalternativ** länk.
    ...
    ![Grunderna säkerhetssidan med ”mer säkerhetsalternativ”-länken markerad](./media/microsoft-authenticator-app-add-personal-account/more-security-options-link.png)
...
2. Välj **Lägg till konto** från den **anpassa och styra** ikonen i det övre högra hörnet.
    ...
    ![På kontosidan, med ikonen anpassa och styra markerat](./media/microsoft-authenticator-app-add-personal-account/customize-and-control-icon.png)
