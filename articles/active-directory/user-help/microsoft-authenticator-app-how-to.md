---
title: Ladda ned och installera Microsoft Authenticator-appen – Azure Active Directory | Microsoft Docs
description: Så här hämtar, installerar och använder Microsoft Authenticator-appen för verifiering av två faktorer.
...
- När du hämtar och installerar appen, måste du lägga till dina olika konton. Mer information finns i [lägga till dina konton](microsoft-authenticator-app-add-accounts-overview.md).
