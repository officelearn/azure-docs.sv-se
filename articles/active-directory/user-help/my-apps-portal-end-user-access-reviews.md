...
## <a name="using-myappsmicrosoftcom"></a>Använda myapps.microsoft.com
...
## <a name="using-myapplicationsmicrosoftcom"></a>Använda myapplications.microsoft.com
...
>[!Note]
>Om du inte ser panelen **åtkomst granskningar** , kan det betyda att du inte har behörighet att utföra åtkomst granskningar, eller att du inte har några väntande granskningar som väntar på ditt godkännande. Om du tror att du borde ha åtkomst till panelen kan du kontakta supportavdelningen om du behöver hjälp.

## <a name="to-perform-access-reviews"></a>Så här utför du åtkomst granskningar
