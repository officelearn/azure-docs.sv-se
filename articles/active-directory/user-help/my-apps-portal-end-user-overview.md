...
description: Lär dig mer om portalen Mina appar och felsöka potentiella problem.
...
När du har granskat innehållet översikt, kan du fortsätta till [komma åt och använda appar på portalen Mina appar](my-apps-portal-end-user-access.md).