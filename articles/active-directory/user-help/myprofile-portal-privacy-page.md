---
title: Visa sekretessrelaterade information från min profil (förhandsgranskning)-portal – Azure Active Directory | Microsoft Docs
description: En översikt om sekretess i min profil-portalen.
...
3. Granska information, inklusive:
    ...
    - **Tjänster.** En lista över onlinetjänster som du är ansluten till ditt arbets- eller skolkonto konto.

    - **Användningsvillkor**. Din organisations användningsvillkor.
