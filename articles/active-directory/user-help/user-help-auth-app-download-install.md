...
- När du hämtar och installerar appen, måste du lägga till dina olika konton. Mer information finns i [lägga till dina konton](user-help-auth-app-add-account-overview.md).
