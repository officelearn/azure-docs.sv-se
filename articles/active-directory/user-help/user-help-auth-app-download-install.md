...
- När du har laddat ned och installerat appen måste du lägga till dina olika konton. Mer information finns i [Lägg till dina konton](user-help-auth-app-add-account-overview.md).
