...
Den här artikeln beskriver hur du skapar en anpassad roll med behörigheter för att hantera tilldelningar av företags program för användare och grupper i Azure Active Directory (Azure AD). För elementen i roll tilldelningarna och innebörden av termer som undertyp, behörighet och egenskaps uppsättning, se [översikten över anpassade roller](roles-custom-overview.md).
...
Mer information finns i [skapa och tilldela en anpassad roll](roles-create-custom.md) och [tilldela anpassade roller med resurs omfång med hjälp av PowerShell](roles-assign-powershell.md).
...
Skapa en anpassad roll med hjälp av det medföljande exemplet i Microsoft Graph-API: et. Mer information finns i [skapa och tilldela en anpassad roll](roles-create-custom.md) och [tilldela anpassade administratörs roller med hjälp av Microsoft Graph API](roles-assign-graph.md).
...
Roll tilldelningen kombinerar ett säkerhets objekt-ID (som kan vara en användare eller tjänstens huvud namn), ett roll Definitions-ID och ett Azure AD-resursprogram. Mer information om elementen i en roll tilldelning finns i [Översikt över anpassade roller](roles-custom-overview.md)
