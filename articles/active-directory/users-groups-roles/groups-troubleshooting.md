...
**Jag har konfigurerat en regel, men nu tas befintliga medlemmar i regeln bort**<br/>Detta är ett förväntat beteende. Befintliga medlemmar i gruppen tas bort när en regel aktive ras eller ändras. De användare som returneras från utvärderingen av regeln läggs till som medlemmar i gruppen.
