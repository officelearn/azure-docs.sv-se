...
- [Så här migrerar du enskilda licensierade användare till grupp licensiering i Azure Active Directory](../users-groups-roles/licensing-groups-migrate-users.md)
- [Ytterligare scenarier för Azure Active Directory grupp licensiering](../users-groups-roles/licensing-group-advanced.md)
- [PowerShell-exempel för grupp licensiering i Azure Active Directory](../users-groups-roles/licensing-ps-examples.md)
