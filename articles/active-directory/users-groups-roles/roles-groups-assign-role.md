...
1. På sidan ***roll namn*** väljer du > **Lägg till tilldelning**.

   ![Lägg till den nya roll tilldelningen](./media/roles-groups-assign-role/add-assignment.png)

1. Välj gruppen. Endast de grupper som kan tilldelas till Azure AD-roller visas.

    [![Endast grupper som kan tilldelas en ny roll tilldelning visas.](media/roles-groups-assign-role/eligible-groups.png "Endast grupper som kan tilldelas en ny roll tilldelning visas.")](media/roles-groups-assign-role/eligible-groups.png#lightbox)
