...
Azure Information Protection | [Administratörs roller för Azure AD](directory-assign-admin-roles.md) | [Graph API](/graph/api/overview?view=graph-rest-1.0)<br>[Hämta roll tilldelningar](/graph/api/directoryrole-list?view=graph-rest-1.0)
...
Privileged Identity Management | [Administratörs roller för Azure AD](directory-assign-admin-roles.md) | [Graph API](/graph/api/overview?view=graph-rest-1.0)<br>[Hämta roll tilldelningar](/graph/api/directoryrole-list?view=graph-rest-1.0)
...
Hanterat skriv bord | [Administratörs roller för Azure AD](directory-assign-admin-roles.md) | [Graph API](/graph/api/overview?view=graph-rest-1.0)<br>[Hämta roll tilldelningar](/graph/api/directoryrole-list?view=graph-rest-1.0)
