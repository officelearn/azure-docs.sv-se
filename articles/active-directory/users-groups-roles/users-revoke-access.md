---
title: Återkalla användar åtkomst för nödfall i Azure Active Directory | Microsoft Docs
...
- [Säkra åtkomst metoder för Azure AD-administratörer](directory-admin-roles-secure.md)
