...
Azure AD har stöd för delade konton för alla Enterprise Mobility Suite-, Premium-eller Basic-licensierade användare, i alla typer av lösen ords program för enkel inloggning. Du kan dela konton för tusentals förintegrerade program i program galleriet och kan lägga till ditt eget program för autentisering av lösen ord med [anpassade SSO-appar](../manage-apps/configure-single-sign-on-portal.md).
...
Du kan också göra ditt delade konto säkrare med Multi-Factor Authentication (MFA) (Lär dig mer om att [skydda program med Azure AD](../authentication/concept-mfa-whichversion.md)) och du kan delegera möjligheten att hantera vem som har åtkomst till programmet med [självbetjäning i Azure AD ](groups-self-service-management.md)grupp hantering.
