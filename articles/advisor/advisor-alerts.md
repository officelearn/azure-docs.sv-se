...
I båda schemana kan du identifiera rekommendationer för Advisor-händelser genom **eventSource** att leta `Recommendation` efter eventSource och `Microsoft.Advisor/recommendations/available/action` **operationName** är.
