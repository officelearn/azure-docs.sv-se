...
Om du migrerar till en nyare version av Kubernetes (t.ex.: 1.7.x till 1.9.x), det finns några ändringar i API: et i k8s som kräver din uppmärksamhet.
