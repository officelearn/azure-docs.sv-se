...
> [!NOTE]
> Om du använder den [virtuella noder tillägg](virtual-nodes-cli.md#enable-virtual-nodes-addon), DaemonSets kommer inte att skapa poddar på virtuell nod.
