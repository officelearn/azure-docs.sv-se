...
I den här artikeln används Helm för att installera NGINX ingress-kontrollanten och en webbapp.
...
I följande exempel dirigeras trafik till *EXTERNAL_IP* till tjänsten med namnet `aks-helloworld`. Trafik till *EXTERNAL_IP/Hello-World-Two* dirigeras till `aks-helloworld-two`s tjänsten. Trafik till *EXTERNAL_IP/static* dirigeras till tjänsten med namnet `aks-helloworld` för statiska till gångar.
