---
title: Bästa praxis för Operator – identitet i Azure Kubernetes Services (AKS)
...
En RoleBinding skapas då som binder Azure AD-användaren *developer1\@contoso.com* till RoleBinding, som du ser i följande yaml-manifest:
