...
Om du arbetar i Windows kan du även använda Visual Studio Code.
...
Följ dessa steg om du vill [tillåta åtkomst via en Kubernetes-hemlighet](https://docs.microsoft.com/en-us/azure/container-registry/container-registry-auth-aks#access-with-kubernetes-secret).
