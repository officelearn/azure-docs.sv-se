---
title: Självstudiekurs - Lägg till en exempelmodell- Azure Analysis Services | Microsoft-dokument
...
2. I **Ny modell** > **Välj en datakälla**kontrollerar du **att exempeldata** är markerade och klickar sedan på **Lägg till**.
