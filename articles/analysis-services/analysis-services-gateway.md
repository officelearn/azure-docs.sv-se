...
**EN**: I Services kallas gatewayen för lokala data gateway-tjänsten.
...
**EN**: Du kan installera en gateway på en annan dator för att skapa ett kluster. Mer information finns i [kluster med hög tillgänglighet för den lokala datagatewayen](https://docs.microsoft.com/power-bi/service-gateway-high-availability-clusters) i Power BI Gateway-dokumenten.
...
**EN**: Se loggar för senare i den här artikeln.
