...
|CleanerCurrentPrice|Minne: Rensningsminne aktuellt pris|Antal|Medel|Aktuellt pris för minne, $/ byte/tid, normaliserat till 1000.|
...
|CommandPoolIdleThreads|Trådar: Kommandot inaktiva trådar i kommandopoolen|Antal|Medel|Antal inaktiva trådar i kommandotrådspoolen.|
|LongParsingBusyThreads|Trådar: Upptagna lång parsningstrådar|Antal|Medel|Antal upptagna trådar i den lång parsningstrådspoolen.|
|LongParsingIdleThreads|Trådar: Inaktiva lång parsningstrådar|Antal|Medel|Antal inaktiva trådar i den lång parsningstrådspoolen.|
...
|ProcessingPoolBusyNonIOThreads|Trådar: Bearbetningspoolen upptagen icke-I/O trådar i kommandopoolen|Antal|Medel|Antal trådar som kör icke-I/O-jobb i bearbetningstrådpoolen.|
...
|ProcessingPoolIdleNonIOThreads|Trådar: Bearbetningspoolen inaktiva icke-I/O trådar i kommandopoolen|Antal|Medel|Antal inaktiva trådar i bearbetningstrådpoolen som är dedikerade till icke-I/O-jobb.|
|QueryPoolIdleThreads|Trådar: Fråga inaktiva trådar i kommandopoolen|Antal|Medel|Antal inaktiva trådar för i/o-jobb i bearbetningstrådpoolen.|
|QueryPoolJobQueueLength|Trådar: Fråga pool jobbkölängd|Antal|Medel|Antal jobb i kön för frågetrådspoolen.|
