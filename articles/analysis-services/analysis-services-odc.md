...
ms.locfileid: "92014774"
---
# <a name="create-an-office-data-connection-file"></a>Skapa en fil för Office-dataanslutning

Informationen i den här artikeln beskriver hur du kan skapa en Office-dataanslutnings fil för att ansluta till en Azure Analysis Services-server från Excel 2016 version Number 16.0.7369.2117 eller tidigare, eller Excel 2013. Du måste också ha en uppdaterad [MSOLAP. 7-Provider](/analysis-services/client-libraries?view=azure-analysis-services-current) .
