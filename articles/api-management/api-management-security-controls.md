...
| Loggning och granskning av data planet| Ja | [Azure Monitor diagnostikloggar](../azure-monitor/platform/resource-logs-overview.md) och (valfritt) [Azure Application](../azure-monitor/app/app-insights-overview.md)insikter.  | |
