...
|HttpLargeRequestMessage|HTTP-begärans innehåll för stor.|  
...
|WebDocumentationTemplatesCurlForBasicAuth|för Basic Authorization använder:--user {username}: {password}|  
...
|OAuth2Flow_ObtainAuthorization_AuthorizationCodeGrant_Description|Auktoriseringskodflödet är optimerat för klienter som klarar att hålla sina autentiseringsuppgifter (t.ex. webbserverprogram som implementeras med hjälp av PHP, Java, Python, Ruby, ASP.NET, osv.).|  
...
|OAuth2Flow_ObtainAuthorization_ClientCredentialsGrant_Name|Klientautentiseringsuppgifter|  
...
|OAuth2Flow_ObtainAuthorization_ResourceOwnerPasswordCredentialsGrant_Name|Resursen lösenordsautentiseringsuppgifter Resursägarens|  
...
|OAuth2Scope_AuthorizationCodeGrant_TokenResponse|VALFRITT om identiskt omfång som begärs av klienten; i annat fall obligatoriskt.|  
|OAuth2Scope_ClientCredentialsGrant_TokenRequest|VALFRITT. Omfånget för förfrågan.|  
|OAuth2Scope_ClientCredentialsGrant_TokenResponse|VALFRITT om identiskt omfång som begärs av klienten; i annat fall obligatoriskt.|  
|OAuth2Scope_ImplicitGrant_AuthorizationRequest|VALFRITT. Omfånget för förfrågan.|  
|OAuth2Scope_ImplicitGrant_AuthorizationResponse|VALFRITT om identiskt omfång som begärs av klienten; i annat fall obligatoriskt.|  
|OAuth2Scope_ResourceOwnerPasswordCredentialsGrant_TokenRequest|VALFRITT. Omfånget för förfrågan.|  
|OAuth2Scope_ResourceOwnerPasswordCredentialsGrant_TokenResponse|VALFRITT om identiskt omfång som begärs av klienten; i annat fall obligatoriskt.|  
...
|OAuth2AuthorizationServerCommunicationException|Det gick inte att upprätta en HTTP-anslutning till auktoriseringsservern eller den har oväntat stängts.|  
|WebDocumentationOAuth2GeneralErrorMessage|Ett oväntat fel uppstod.|  
...
|PageTitleError|Det uppstod tyvärr ett problem som betjänar den begärda sidan|  
|TextblockPotentialCauseIntermittentIssue|Detta kan vara ett tillfälligt Dataåtkomstfel som redan är borta.|  
|TextblockPotentialCauseOldLink|Du har klickat på länken kan vara gammal och pekar inte på rätt plats längre.|  
...
|TitlePotentialSolution|Det kan vara ett tillfälligt fel, några saker du kan prova|  
...
|Namn|Text|  
|----------|----------|  
|TextboxExternalIdentitiesDisabled|Logga in är inaktiverad av administratörerna för tillfället.|  
...
|ErrorSsoAuthenticationFailedDetailed|Ogiltig token har angetts eller signaturen kan inte verifieras.|  
...
|WebAuthenticationEmailChangeNoticeHeader|Din e-post ändringsbegäran har bearbetats|  
...
|ValidationErrorFirstNameRequired|Förnamn är obligatoriskt.|  
...
|ValidationErrorLastNameRequired|Efternamn är obligatoriskt.|  
...
|ValidationMessageNewPasswordRequired|Nytt lösenord måste anges.|  
|TextboxLabelNotificationsSenderEmail|Aviseringsavsändarens e-postadress|  
...
|WebAuthenticationPasswordResetSendNoticeHeader|Din begäran om lösenordsåterställning har bearbetats|  
...
|ValidationMessageSubscriptionNameRequired|Prenumerationsnamnet får inte vara tom.|  
