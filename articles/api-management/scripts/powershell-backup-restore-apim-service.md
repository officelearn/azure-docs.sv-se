---
title: "Azure PowerShell skriptexempel - säkerhetskopia och återställa tjänsten | Microsoft Docs"
description: "Azure PowerShell skriptexempel - säkerhetskopiering och återställning av tjänsten"
...
---
# <a name="backup-and-restore-service"></a>Säkerhetskopiering och återställning av tjänsten

Det här exemplet som visas i den här artikeln visar hur du säkerhetskopierar och återställer API Management service-instans. 
