---
title: "Azure PowerShell-skript Sample - skapa en tjänst för APIM | Microsoft Docs"
description: "Azure PowerShell-skript Sample - skapa en APIM-tjänst"
...
Det här exempelskriptet skapar en utvecklare SKU API Management-tjänsten.
