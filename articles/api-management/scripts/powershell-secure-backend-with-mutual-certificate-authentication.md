---
title: "Azure PowerShell skriptexempel - säker serverdel | Microsoft Docs"
description: "Azure PowerShell skriptexempel - säker serverdel"
...
Det här exempelskriptet säkrar backend med ömsesidig autentisering.
