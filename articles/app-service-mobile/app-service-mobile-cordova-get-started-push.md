...
Öppna config.xml i din Cordova-app. Ersätt sedan `Your_Project_ID` med numeriskt projektet ID för din app från den [Google Developer Console][18].
...
För push-meddelanden i dina standard (debug)-versioner måste du öppna filen build.json. Kopiera sedan ”utgåvan”-konfigurationen i konfigurationen av felsökning.
