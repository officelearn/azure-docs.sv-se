...
---
# <a name="deploy-your-first-net-web-app-to-azure-in-five-minutes"></a>Distribuera din första .NET-webbapp via Azure på fem minuter
...
## <a name="deploy-an-net-web-app"></a>Distribuera en .NET-webbapp
...
4. Ändra till en arbetskatalog (`CD`) och klona exempelappen.
