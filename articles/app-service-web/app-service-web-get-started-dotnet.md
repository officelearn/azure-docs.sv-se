<properties 
    pageTitle="Distribuera din första .NET-webbapp via Azure på fem minuter | Microsoft Azure" 
...
I den här kursen lär du dig hur du distribuerar en enkel webbapp med .NET via [Azure App Service](../app-service/app-service-value-prop-what-is.md).
