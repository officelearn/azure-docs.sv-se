...
[Skapa, konfigurera och distribuera en Laravel-webbapp via Azure](app-service-web-php-get-started.md). I de här självstudierna får du grundläggande kunskaper i hur du kör PHP-webbappar i Azure, till exempel:
