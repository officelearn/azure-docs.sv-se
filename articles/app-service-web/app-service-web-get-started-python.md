<properties 
    pageTitle="Distribuera din första Python-webbapp via Azure på fem minuter | Microsoft Azure" 
...
1. Ändra till en arbetskatalog i din kommandoradsterminal (`CD`) och klona exempelappen så här:
    ...
    ![Klona exempelkoden för din första webbapp i Azure](./media/app-service-web-get-started-languages/python-git-clone.png)
