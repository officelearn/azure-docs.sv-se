---
title: "Distribuera din första Python-webbapp till Azure på fem minuter (CLI 2.0 Preview) | Microsoft Docs"
description: "Distribuera en Python-exempelapp och se hur enkelt det är att köra webbappar i App Service. Börja snabbt utveckla på riktigt och se resultatet direkt."
...
4. Därefter får du Python-exempelkoden som du vill distribuera. Ändra till en arbetskatalog (`CD`) och klona exempelappen så här:
