<properties 
    pageTitle="Sessionstillstånd med Azure Redis-cache i Azure App Service" 
...
Skapa cachen genom att följa [de här anvisningarna](../cache-dotnet-how-to-use-azure-redis-cache.md#create-cache).
...
Mer information finns i [NuGet RedisSessionStateProvider-sidan](http://www.nuget.org/packages/Microsoft.Web.RedisSessionStateProvider/ ) och [Konfigurera cacheklienten](../cache-dotnet-how-to-use-azure-redis-cache.md#NuGet).
