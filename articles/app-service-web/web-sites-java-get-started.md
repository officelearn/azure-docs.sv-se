<properties
    pageTitle="Skapa en Java-webbapp i Azure App Service | Microsoft Azure"
...
> [AZURE.NOTE] För den här kursen behöver du ett Microsoft Azure-konto. Om du inte har ett konto kan du [aktivera Visual Studio-prenumerantförmåner] eller [registrera dig för en kostnadsfri utvärderingsversion].
>
...
6. Välj en **App Service-plan/plats** eller skapa en ny.
