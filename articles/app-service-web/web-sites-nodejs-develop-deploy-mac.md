<properties
    pageTitle="Skapa en Node.js-webbapp i Azure App Service | Microsoft Azure"
...
2. Kopiera in följande kod i **server.js**-filen och spara filen:
...
3. Öppna kommandoraden och använd följande kommando för att starta webbappen lokalt.

        node server.js

4. Öppna webbläsaren och gå till http://localhost:1337. 
...
1. Från kommandoraden ändrar du katalog till katalogen **helloworld** och anger följande kommando för att initiera en lokal Git-lagringsplats.

        git init


2. Använd följande kommandon för att lägga till filer på lagringsplatsen:

        git add .
        git commit -m "initial commit"

3. Använd nedanstående kommando till att lägga till en fjärransluten Git-lagringsplats för att push-överföra uppdateringar till webbappen du skapade tidigare:

        git remote add azure [URL for remote repository]

4. Pusha ändringarna till Azure med hjälp av följande kommando:
...
5. Du visar appen genom att klicka på knappen **Bläddra** i området **Webbapp** i Azure portal.
...
2. Från kommandoraden ändrar du katalog till katalogen **helloworld** och kör följande kommandon.
...
3. Uppdatera webbläsarfönstret som du navigerade till webbappens webbadress i.
