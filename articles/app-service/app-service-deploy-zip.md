...
Den här artikeln visar hur du använder en ZIP-filen eller WAR-filen för att distribuera din webbapp till [Azure App Service](app-service-web-overview.md). 
...
För grundläggande HTTP-autentisering måste du dina autentiseringsuppgifter för distribution av App Service. Om du vill se hur du anger dina autentiseringsuppgifter för distribution, se [ange och Återställ användarnivå autentiseringsuppgifter](app-service-deployment-credentials.md#userscope).
