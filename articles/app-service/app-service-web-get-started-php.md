...
```
> [!NOTE]
> Stop-parsing-symbolen `(--%)`, som introducerades i PowerShell 3.0, ger PowerShell i regel att avstå från att tolka indata som PowerShell-kommandon eller uttryck. 
>
