...
I din *docker-compose.yml* filen, mappa den `volumes` alternativet att `${WEBAPP_STORAGE_HOME}`. `WEBAPP_STORAGE_HOME` är en miljövariabel i App Service som är mappad till beständig lagring för din app. Exempel:
