...
Exempel koden innehåller en *Application.py* -fil som talar om för App Service att koden innehåller en kolv-app. Mer information finns i [Containerns startprocess och anpassningar](how-to-configure-python.md).
