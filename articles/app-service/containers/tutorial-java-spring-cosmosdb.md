...
Öppna `pom.xml`-filen i katalogen `initial/spring-boot-todo` och Lägg till följande [Azure webbapp-plugin-program för maven](https://github.com/Microsoft/azure-maven-plugins/blob/develop/azure-webapp-maven-plugin/README.md) -konfiguration.
