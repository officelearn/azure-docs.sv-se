...
4. Hämta din Azure Cosmos DB-nyckel för att ansluta till appen. Behåll den `primaryMasterKey`, `documentEndpoint` tillhands eftersom du behöver dem i nästa steg.
