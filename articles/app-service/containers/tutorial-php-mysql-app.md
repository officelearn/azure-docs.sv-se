...
description: Lär dig hur du skaffar en Linux Node.js-app som arbetar i Azure App Service, med anslutning till en MySQL-databas i Azure. Laravel används i den här självstudien.
ms.devlang: php
ms.topic: tutorial
ms.date: 11/25/2019
