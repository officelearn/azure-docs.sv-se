...
6. I den **Essentials** listrutan klickar du på länken resource group. Observera också att appen är redan ansluten till GitHub-lagringsplatsen under **externt projekt**. 
   
   ![](./media/app-service-deploy-complex-application-predictably/gettemplate-3-portalresourcegroup.png)
7. I bladet för resursgruppen, Observera att det finns redan två appar och en SQL-databas i resursgruppen.
...
I resursnoden kan du se att 4 översta resurserna definieras, inklusive en SQL Server-instans, en apptjänstplan och två appar. 
...
Nu ska vi gå vidare till de faktiska appar själva, som är mer komplicerad. Klicka på [variables('apiSiteName')]-app i JSON-disposition att markera dess JSON-koden. Lägg märke till att saker får mycket mer intressant. För detta ändamål vi pratar mer om funktioner i taget:

##### <a name="root-resource"></a>Rot-resurs
Appen är beroende av två olika resurser. Det innebär att Azure Resource Manager skapar appen endast när både App Service-planen och SQL Server-instansen har skapats.
...
Om du ökar detaljnivån till en app du ska kunna se app konfigurationsinformation som liknar den skärmbilden nedan:
...
7. Välj **Application Insights för Web Apps**, kontrollera en befintlig App Service-plan och appen är markerad och klicka sedan på **Lägg till**.
   
   ![](./media/app-service-deploy-complex-application-predictably/deploy-4-newappinsight.png)
   
   Du kommer nu att kunna visa flera nya resurser som beroende på resurs så att den inte, har beroenden på App Service-plan eller appen. Dessa resurser är inte aktiverade som deras befintliga definitionen och du kommer att ändra.
...
Lär dig mer om JSON-syntax och egenskaper för resurstyper som distribuerats i den här artikeln, se:
