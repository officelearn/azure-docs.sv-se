...
En App Service-miljön måste alltid skapas i ett undernät eftersom ett undernät tillhandahåller en nätverks gränser som kan användas för att låsa inkommande trafik bakom överordnade enheter och tjänster, så att HTTP-och HTTPS-trafik endast godkänns från vissa överordnade IP-adresser.
...
Exemplet nedan visar en regel som uttryckligen ger åtkomst till de hanterings portar som krävs av Azure-infrastrukturen för att hantera och underhålla en App Service-miljön.  Observera att all hanterings trafik flödar över TLS och skyddas av klient certifikat, så även om portarna öppnas är de inte tillgängliga för andra enheter än Azures hanterings infrastruktur.
