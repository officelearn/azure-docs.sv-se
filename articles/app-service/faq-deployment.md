...
Självstudien [skapa din första ASP.NET-webbapp i Azure på fem minuter](app-service-web-get-started-dotnet.md) visar hur du distribuerar en ASP.NET-webbprogram till en webbapp i App Service med Visual Studio.
...
Snabbstart för Azure är utformat för att distribuera din app med hjälp av distributionsstacken och metod för ditt val. Om du vill använda snabbstarten i Azure-portalen, gå till din app service under **distribution**väljer **snabbstarten**.
...
*   Använd ett Git-projekt. Anslut via App Service med hjälp av Deployment Center.
