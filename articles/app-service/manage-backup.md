...
* Du behöver ett Azure storage-konto och en behållare i samma prenumeration som den app som du vill säkerhetskopiera. Mer information om Azure storage-konton finns i [översikt över Azure storage-konton](https://docs.microsoft.com/azure/storage/common/storage-account-overview).
