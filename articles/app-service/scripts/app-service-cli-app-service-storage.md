---
title: Skriptexempel för Azure CLI – Ansluta en webbapp till ett lagringskonto | Microsoft Docs
description: Skriptexempel för Azure CLI – Ansluta en webbapp till ett lagringskonto
services: appservice
...
Det här exempelskriptet skapar ett Azure-lagringskonto och en Azure-webbapp. Därefter länkar det lagringskontot till webbappen med hjälp av app-inställningar.
...
I det här skriptet används följande kommandon för att skapa en resursgrupp, webbappen, lagringskontot och alla relaterade resurser. Varje kommando i tabellen länkar till kommandospecifik dokumentation.
...
| [`az storage account show-connection-string`](/cli/azure/storage/account?view=azure-cli-latest#az_storage_account_show_connection_string) | Hämta anslutningssträngen för ett lagringskonto. |
