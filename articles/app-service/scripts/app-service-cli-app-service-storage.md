...
Det här exempelskriptet skapar ett Azure storage-konto och ett Azure-webbapp. Därefter länkar storage-konto till det webbprogram som använder app-inställningar.
