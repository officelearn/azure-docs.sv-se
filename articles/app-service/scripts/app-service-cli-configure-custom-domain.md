---
title: Skriptexempel för Azure CLI – Mappa en anpassad domän till en webbapp | Microsoft Docs
description: Skriptexempel för Azure CLI – Mappa en anpassad domän till en webbapp
