---
title: Azure CLI skriptexempel - skapa en webbapp och distribuera filer med FTP | Microsoft Docs
description: Azure CLI skriptexempel - skapa en webbapp och distribuera filer med FTP
...
Det här exempelskriptet skapar en webbapp i App Service med dess relaterade resurser och distribuerar en statiska HTML-sida med FTP. För FTP-överför skriptet som använder [cURL](https://en.wikipedia.org/wiki/CURL) som exempel. Du kan använda valfri FTP-verktyg för att ladda upp dina filer.
...
| [`az webapp deployment list-publishing-profiles`](/cli/azure/webapp/deployment?view=azure-cli-latest#az_webapp_deployment_list_publishing_profiles) | Hämta information om tillgängliga web app distribution profiler. |
