...
| [`az webapp deployment user set`](/cli/azure/webapp/deployment/user?view=azure-cli-latest#az_webapp_deployment_user_set) | Anger autentiseringsuppgifter för kontonivå distribution för Apptjänst. |
| [`az webapp deployment source config-local-git`](/cli/azure/webapp/deployment/source?view=azure-cli-latest#az_webapp_deployment_source_config_local_git) | Skapar en konfiguration för kontroll av källan för en lokal Git-lagringsplats. |
