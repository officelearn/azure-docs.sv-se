---
title: Skriptexempel för Azure CLI – Skapa en ASP.NET Core-webbapp i en Docker-container | Microsoft Docs
description: Skriptexempel för Azure CLI – Skapa en ASP.NET Core-webbapp i en Docker-container
services: appservice
...
ms.locfileid: "46992617"
---
# <a name="create-an-aspnet-core-web-app-in-a-docker-container"></a>Skapa en ASP.NET Core-webbapp i en Docker-container

Det här exempelskriptet skapar en resursgrupp, en Linux App Service-plan och en webbapp. Det distribuerar sedan ett ASP.NET Core-program med en Docker-container.
