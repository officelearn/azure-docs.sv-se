---
title: Skriptexempel för Azure CLI – Skapa en ASP.NET Core-webbapp i en Docker-behållare | Microsoft Docs
description: Skriptexempel för Azure CLI – Skapa en ASP.NET Core-webbapp i en Docker-behållare
services: appservice
...
ms.locfileid: "30281545"
---
# <a name="create-an-aspnet-core-web-app-in-a-docker-container"></a>Skapa en ASP.NET Core-webbapp i en Docker-behållare

Det här exempelskriptet skapar en resursgrupp, en Linux App Service-plan och en webbapp. Det distribuerar sedan ett ASP.NET Core-program med en Docker-behållare.
