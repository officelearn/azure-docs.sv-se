...
Det här exempelskriptet skapar en resursgrupp, en Linux App Service-plan och en webbapp. Den distribuerar sedan ett ASP.NET Core-program med en Docker-behållare.
