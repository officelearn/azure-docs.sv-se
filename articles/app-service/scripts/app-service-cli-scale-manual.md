---
title: Skriptexempel för Azure CLI – Skala en webbapp manuellt med Azure CLI | Microsoft Docs
description: Skriptexempel för Azure CLI – Skala en webbapp manuellt med Azure CLI
services: appservice
