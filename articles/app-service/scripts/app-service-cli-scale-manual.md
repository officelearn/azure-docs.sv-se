...
| [AZ apptjänst plan uppdatering](https://docs.microsoft.com/cli/azure/appservice/plan#az_appservice_plan_update) | Uppdaterar egenskaperna för App Service-plan. |
