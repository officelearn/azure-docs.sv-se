...
[!code-powershell[huvudsakliga](../../../powershell_scripts/app-service/map-custom-domain/map-custom-domain.ps1?highlight=1 "tilldela en anpassad domän till en webbapp")]
