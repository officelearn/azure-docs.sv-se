---
title: Skriptexempel för Azure CLI – Binda ett anpassat SSL-certifikat till en app | Microsoft Docs
description: Skriptexempel för Azure CLI – Binda ett anpassat SSL-certifikat till en app
