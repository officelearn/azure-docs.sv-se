...
ms.locfileid: "53719803"
---
# <a name="connect-an-app-service-app-to-cosmos-db-using-cli"></a>Ansluta en App Service-app till Cosmos DB med hjälp av CLI

Det här exempelskriptet skapar ett Azure Cosmos DB-konto med hjälp av Cosmos DB för MongoDB API och en App Service-app. Det länkar sedan en MongoDB-anslutningssträng till webbappen med hjälp av appinställningar.
