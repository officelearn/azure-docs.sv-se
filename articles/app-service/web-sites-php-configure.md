...
Om du vill använda Azure-kommandoradsgränssnittet måste du [installera Azure CLI 2.0](https://docs.microsoft.com/en-us/cli/azure/install-azure-cli?view=azure-cli-latest) på datorn.
