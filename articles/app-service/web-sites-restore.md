...
1. På den **inställningar** bladet för din app i Azure-portalen klickar du på **säkerhetskopieringar** att visa den **säkerhetskopieringar** bladet. Klicka på **återställa**.
   
    ![Välj Återställ nu][ChooseRestoreNow]
2. I den **återställa** bladet först väljer du den säkerhetskopiering.
...
1. Från huvudsakliga **Bläddra** bladet i Azure portal, Välj **lagringskonton**. En lista över dina befintliga lagringskonton visas.
2. Välj lagringskontot som innehåller säkerhetskopian som du vill hämta eller ta bort. Bladet för storage-konto visas.
3. Markera den behållare som du vill använda i bladet storage-konto
...
Om du vill se information om lyckad eller misslyckad återställningen app, navigerar du till den **aktivitetsloggen** bladet i Azure-portalen.  
 

Rulla ned till den önskade återställningsåtgärden och markera den.

Informationsbladet visas tillgänglig information som rör återställningen.
