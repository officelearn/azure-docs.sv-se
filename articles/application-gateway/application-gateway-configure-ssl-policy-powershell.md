...
Besök [omdirigeringsöversikt för Programgateway](application-gateway-redirect-overview.md) om du vill veta hur du omdirigerar HTTP-trafik till en HTTPS-slutpunkt.
