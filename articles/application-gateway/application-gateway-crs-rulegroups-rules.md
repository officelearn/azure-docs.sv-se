...
Application Gateway brand vägg för webbaserade program (WAF) skyddar webb program mot vanliga sårbarheter och sårbarheter. Detta görs genom regler som definieras baserat på OWASP Core-regeln anger 3,0 eller 2.2.9. De här reglerna kan inaktive ras på en regel efter regel. Den här artikeln innehåller de aktuella reglerna och rulesets som erbjuds.

Följande regel grupper och regler är tillgängliga när du använder Application Gateway med brand vägg för webbaserade program.
...
### <a name="crs911"></a> <p x-ms-format-detection="none">BEGÄRAN-911-METOD-TVÅNG</p>
...
### <a name="crs942"></a> <p x-ms-format-detection="none">BEGÄRAN-942-APPLICATION-ATTACK-SQLI</p>

|ruleId|Beskrivning|
|---|---|
|942100|SQL-injektering-attack identifierad via libinsprutning|
|942110|SQL-inmatnings attack: Vanliga inmatnings test har identifierats|
...
### <a name="crs943"></a> <p x-ms-format-detection="none">BEGÄRAN-943-APPLICATION-ATTACK-SESSION-UPPBINDNING</p>
