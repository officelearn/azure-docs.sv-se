...
Använd `Stop-AzApplicationGateway` för att stoppa programgatewayen. Det här exemplet visar `Stop-AzApplicationGateway` cmdlet på den första raden, följt av utdata.
