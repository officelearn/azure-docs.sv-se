...
Om du vill utföra stegen i den här artikeln, måste du [installera Azure-kommandoradsgränssnittet (Azure CLI) för Mac, Linux och Windows](https://docs.microsoft.com/en-us/cli/azure/install-az-cli2).
