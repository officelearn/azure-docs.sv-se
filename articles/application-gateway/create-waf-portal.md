...
![Exempel på brandväggen ett webbprogram](./media/create-waf-portal/scenario-waf.png)
...
3. Ange värdena för Programgateway:
    ...
    ![Skapa nya Programgateway](./media/create-waf-portal/application-gateway-create.png)
...
5. Klicka på **Välj ett virtuellt nätverk**, klickar du på **Skapa nytt**, och ange sedan värdena för det virtuella nätverket:
    ...
    ![Skapa det virtuella nätverket](./media/create-waf-portal/application-gateway-vnet.png)
...
2. Klicka på **undernät**, och klicka sedan på **undernät**.
    ...
    ![Skapa undernät](./media/create-waf-portal/application-gateway-subnet.png)
...
1. Öppna det interaktiva gränssnittet och se till att den är inställd på **PowerShell**.
    ...
    ![Installera anpassade tillägg](./media/create-waf-portal/application-gateway-extension.png)
...
3. Klicka på **Lägg till mål** att lägga till varje virtuell dator som du skapade i serverdelspoolen.
    ...
    ![Lägg till backend-servrar](./media/create-waf-portal/application-gateway-backend.png)
...
7. Klicka på **Spara**.
    ...
    ![Konfigurera diagnostik](./media/create-waf-portal/application-gateway-diagnostics.png)
...
1. Hitta den offentliga IP-adressen för Programgateway på skärmen Översikt. Klicka på **alla resurser** och klicka sedan på **myAGPublicIPAddress**.
    ...
    ![Registrera programmet gateway offentlig IP-adress](./media/create-waf-portal/application-gateway-record-ag-address.png)

2. Kopiera den offentliga IP-adressen och klistra in den i webbläsarens adressfält.

    ![Testa Programgateway](./media/create-waf-portal/application-gateway-iistest.png)
