...
Du kan använda [az network application-gateway frontend-port skapar](/cli/azure/network/application-gateway/frontend-port#az_network_application_gateway_frontend_port_create) att lägga till HTTP-porten till application gateway.
...
Du kan använda [az network application-gateway http-listener skapa](/cli/azure/network/application-gateway/http-listener#az_network_application_gateway_http_listener_create) att lägga till lyssnaren med namnet *myListener* till application gateway.
...
Lägg till HTTP till HTTPS-omdirigeringskonfiguration i application gateway med hjälp av [az network application-gateway omdirigerings-config skapa](/cli/azure/network/application-gateway/redirect-config#az_network_application_gateway_redirect_config_create).
...
Lägg till en routningsregel med namnet *2* med konfigurationen för omdirigering i application gateway med hjälp av [az network application-gateway rule skapa](/cli/azure/network/application-gateway/rule#az_network_application_gateway_rule_create).
