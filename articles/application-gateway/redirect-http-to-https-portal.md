...
I den här självstudien krävs Azure PowerShell module version 1.0.0 eller senare för att skapa ett certifikat och installera IIS. Kör `Get-Module -ListAvailable Az` för att hitta versionen. Om du behöver uppgradera kan du läsa [Install Azure PowerShell module](/powershell/azure/install-az-ps) (Installera Azure PowerShell-modul). Om du vill köra kommandona i den här självstudien måste `Login-AzAccount` du också köra för att skapa en anslutning till Azure.
