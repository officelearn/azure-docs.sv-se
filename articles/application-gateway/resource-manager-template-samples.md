...
description: Den här artikeln innehåller länkar till Azure Resource Manager Template-exempel så att du snabbt kan distribuera Azure Application Gateway som kon figurer ATS på olika sätt.
