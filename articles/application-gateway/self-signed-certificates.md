...
## <a name="configure-the-certificate-in-your-web-servers-ssl-settings"></a>Konfigurera certifikatet i webb serverns SSL-inställningar
...
Följande konfiguration är ett exempel på [nginx Server block](http://nginx.org/docs/http/configuring_https_servers.html) med SSL-konfiguration:
