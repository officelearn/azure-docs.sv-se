...
En lyssnare krävs för att aktivera Programgateway att dirigera trafik på lämpligt sätt. Skapa lyssnare med [ny AzureRmApplicationGatewayHttpListener](/powershell/module/azurerm.network/new-azurermapplicationgatewayhttplistener) med klientdel konfiguration och klientdelsport som du skapade tidigare. Du omdirigera trafik genom att skapa en omdirigering konfiguration som kan läggas till routningsregel som du skapar.

En regel för vidarebefordran krävs för lyssnaren ska kunna skicka inkommande trafik. Skapa en enkel regel med namnet *redirectRule* med [ny AzureRmApplicationGatewayRequestRoutingRule](/powershell/module/azurerm.network/new-azurermapplicationgatewayrequestroutingrule) med omdirigering av konfigurationen.
