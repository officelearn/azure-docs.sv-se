...
![Säker varning](./media/tutorial-http-redirect-cli/application-gateway-secure.png)
...
![Testa bas-URL i Programgateway](./media/tutorial-http-redirect-cli/application-gateway-nginxtest.png)
