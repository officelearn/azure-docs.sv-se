...
ms.locfileid: "52723456"
---
# <a name="application-insights-export-data-model"></a>Datamodell för Application Insights-Export
Den här tabellen anger egenskaperna för telemetri som skickas från den [Application Insights](app-insights-overview.md) SDK: er till portalen.
Ser du de här egenskaperna i utdata från [löpande Export](app-insights-export-telemetry.md).
De visas också i egenskapsfilter i [Metric Explorer](app-insights-metrics-explorer.md) och [Diagnostiksökning](app-insights-diagnostic-search.md).
...
| Sökväg | Typ | Anteckningar |
| --- | --- | --- |
| händelseantal [0] |heltal |100 / ([sampling](app-insights-sampling.md) pris). Till exempel 4 =&gt; 25%. |
...
| basicException [0] antal |heltal |100 / ([sampling](app-insights-sampling.md) pris). Till exempel 4 =&gt; 25%. |
...
Skickas av [TrackTrace](app-insights-api-custom-events-metrics.md#tracktrace), och av den [loggning kort](app-insights-asp-net-trace-logs.md).
...
Skickas av TrackDependency. Används för att rapportprestanda och användning av [anrop till beroenden](app-insights-asp-net-dependencies.md) på den servern och AJAX-anrop i webbläsaren.
...
| remoteDependency [0] antal |heltal |100 / ([sampling](app-insights-sampling.md) pris). Till exempel 4 =&gt; 25%. |
...
Skickas av [TrackRequest](app-insights-api-custom-events-metrics.md#trackrequest). Moduler som standard används för att rapporter serversvarstid, mätt på servern.

| Sökväg | Typ | Anteckningar |
| --- | --- | --- |
| Antal förfrågningar [0] |heltal |100 / ([sampling](app-insights-sampling.md) pris). Till exempel: 4 =&gt; 25%. |
...
| Sökväg | Typ | Anteckningar |
| --- | --- | --- |
| visningar [0] |heltal |100 / ([sampling](app-insights-sampling.md) pris). Till exempel 4 =&gt; 25%. |
...
Rapporter [webbtester för tillgänglighet](app-insights-monitor-web-app-availability.md).
...
| tillgänglighet [0] antal |heltal |100 / ([sampling](app-insights-sampling.md) pris). Till exempel 4 =&gt; 25%. |
...
I stället förväg sammanställning av mått, kan du använda [sampling](app-insights-sampling.md) om du vill minska mängden telemetri.
