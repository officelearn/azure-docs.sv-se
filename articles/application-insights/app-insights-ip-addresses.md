...
Det här är listan med adresser som [webbtester för tillgänglighet](app-insights-monitor-web-app-availability.md) körs. Om du vill köra webbtester i din app, men din webbserver är begränsad till att betjäna specifika klienter, har att tillåta inkommande trafik från våra tillgänglighet testservrar.
