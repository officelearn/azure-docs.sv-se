...
* [Virtuella datorer och webbappar i Azure](app-insights-azure-web-apps.md)
...
## <a name="a-nameprojectsa-build-your-own-sdk"></a><a name="projects"></a> Skapa ditt eget SDK
