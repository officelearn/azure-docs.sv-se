...
![Stöd för ASP.NET Core](./media/app-insights-release-notes-vsix/NetCoreSupport.png)
...
![Stöd för diagnostikverktyg](./media/app-insights-release-notes-vsix/DiagnosticTools.png)
...
![Snabbmenyn för projektet för universella Windows-appar](./media/app-insights-release-notes-vsix/UniversalContextMenu.png)
...
![Ladda upp dialogrutan för universella Windows-appar](./media/app-insights-release-notes-vsix/UniversalUploadDialog.png)
...
![Ladda upp meddelande om slutförd](./media/app-insights-release-notes-vsix/UploadComplete.png)
...
![Snabbmenyn för projektet för Windows Forms-appar](./media/app-insights-release-notes-vsix/WinFormContextMenu.png)

Då öppnas dialogrutan överför HockeyApp som liknar det i en universell Windows-app.

![Ladda upp dialogrutan för Windows Forms-appar](./media/app-insights-release-notes-vsix/WinFormsUploadDialog.png)
...
![Loggningsaviseringar](./media/app-insights-release-notes-vsix/LoggingToast.png)
...
![Hitta matchning](./media/app-insights-release-notes-vsix/FindMatch.png)
...
![Sökfönster](./media/app-insights-release-notes-vsix/SearchWindow.png)
...
![Klicka på information om undantag](./media/app-insights-release-notes-vsix/jumptocode.png)
...
![Publicera meddelande om slutförd](./media/app-insights-release-notes-vsix/publishtoast.png)
...
![Sökfönster](./media/app-insights-release-notes-vsix/search.png)
...
![Diagnostiska verktyg-sidan](./media/app-insights-release-notes-vsix/diagtools.png)
