<properties
    pageTitle="Övervaka din ASP.NET-app med Application Insights SDK | Microsoft Azure"
...
# Övervaka din ASP.NET-app med Application Insights SDK
...
![Exempel på prestandaövervakningsdiagram](./media/app-insights-start-monitoring-app-health-usage/10-perf.png)
...
![Klicka på Nytt, Application Insights](./media/app-insights-start-monitoring-app-health-usage/01-new-asp.png)
...
![Klicka på Egenskaper, markera nyckeln och tryck på CTRL + C.](./media/app-insights-start-monitoring-app-health-usage/02-props-asp.png)
...
1. Redigera NuGet-paketet för ditt webbapprojekt i Visual Studio.
    ...
    ![Högerklicka på projektet och välj Hantera Nuget-paket.](./media/app-insights-start-monitoring-app-health-usage/03-nuget.png)

2. Installera Application Insights SDK för Web Apps.

    ![Sök efter ”Application Insights”](./media/app-insights-start-monitoring-app-health-usage/04-ai-nuget.png)
...
## <a name="monitor"></a> 4. Visa telemetrin
...
![Klicka dig vidare till mer data](./media/app-insights-start-monitoring-app-health-usage/12-first-perf.png)
...
![Använda Visual Studio för att publicera din app](./media/app-insights-start-monitoring-app-health-usage/15-publish.png)
...
## 5. Lägga till beroendespårning (och IIS-prestandaräknare)
...
![I webbappen går du till Inställningar, Tillägg, Lägg till, Application Insights](./media/app-insights-start-monitoring-app-health-usage/05-extend.png)
...
## 6. Lägga till övervakning på klientsidan
...
![Öppna Snabbstart i din webbapp och klicka på Hämta kod för att övervaka webbplatser.](./media/app-insights-start-monitoring-app-health-usage/02-monitor-web-page.png)
...
![Skapa ett ASP.NET-projekt](./media/app-insights-start-monitoring-app-health-usage/appinsights-01-vsnewp1.png)
...
![Välj Lägg till Application Insights](./media/app-insights-start-monitoring-app-health-usage/appinsights-03-addExisting.png)
...
![Högerklicka på projektet och öppna Azure-portalen](./media/app-insights-start-monitoring-app-health-usage/appinsights-04-openPortal.png)
