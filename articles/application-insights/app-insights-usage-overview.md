...
3. **Koden för mobilappen:** använder Mobile Center SDK för att samla in händelser från din app och skicka kopior av dessa händelser till Application Insights för analys av [efter den här guiden](app-insights-mobile-center-quickstart.md).
