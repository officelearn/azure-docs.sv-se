...
![Skärmbild av navigering till arbetsböcker](./media/app-insights-usage-workbooks/001-workbooks.png)

Detta startar ett arbetsboken galleri med ett antal fördefinierade arbetsböcker hjälper dig att komma igång.

![Skärmbild av arbetsboken galleriet](./media/app-insights-usage-workbooks/002-workbook-gallery.png)

Vi börjar med den **standardmall**, som finns under rubriken **Snabbstart**.

![Skärmbild av arbetsboken galleriet](./media/app-insights-usage-workbooks/003-default-template.png)
...
![Application Insights arbetsböcker avsnittet redigeringskontroller](./media/app-insights-usage-workbooks/editing-controls-new.png)
...
![Frågeavsnitt i arbetsböcker](./media/app-insights-usage-workbooks/analytics-section-new.png)
...
Varje avsnitt har sin egen avancerade inställningar är tillgängliga via ikonen för inställningar ![Application Insights arbetsböcker avsnittet redigeringskontroller](./media/app-insights-usage-workbooks/005-settings.png) finns till höger om den **lägga till parametrar** knappen.

![Application Insights arbetsböcker avsnittet redigeringskontroller](./media/app-insights-usage-workbooks/0006-settings-expanded.png)
...
![Application Insights arbetsböcker avsnittet redigeringskontroller](./media/app-insights-usage-workbooks/003-active-users.png)
...
![Application Insights arbetsböcker avsnittet redigeringskontroller](./media/app-insights-usage-workbooks/004-active-users-trend.png)
...
![Application Insights arbetsböcker avsnittet redigeringskontroller](./media/app-insights-usage-workbooks/007-settings-export.png)
...
![Application Insights arbetsböcker avsnittet redigeringskontroller](./media/app-insights-usage-workbooks/008-metrics-grid.png)
...
![Application Insights arbetsböcker avsnittet redigeringskontroller](./media/app-insights-usage-workbooks/009-time-range.png)

Redigera parameterobjekt startas:

![Application Insights arbetsböcker avsnittet redigeringskontroller](./media/app-insights-usage-workbooks/010-time-range-edit.png)
...
![Application Insights arbetsböcker avsnittet redigeringskontroller](./media/app-insights-usage-workbooks/011-data-table.png)

En lämpligare exempel är att använda en listruta för att välja från en uppsättning länder efter namn:
...
![Land listrutan](./media/app-insights-usage-workbooks/012-country-dropdown.png)
...
![Land listrutan](./media/app-insights-usage-workbooks/013-resource-picker.png)
