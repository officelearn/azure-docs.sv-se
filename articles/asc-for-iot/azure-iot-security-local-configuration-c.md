---
title: Förstå Azure Security Center för lokala Gent konfigurationer för C | Microsoft Docs
...
---
# <a name="understanding-the-localconfigurationjson-file---c-agent"></a>Förstå LocalConfiguration. JSON File-C-agenten
...
| Authentication | JsonObject | Konfiguration av autentisering. Det här objektet innehåller all information som behövs för autentisering mot IoTHub |
