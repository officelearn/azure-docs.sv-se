---
title: Konceptuell förklaring av grunderna i Azure IoT-säkerhetsmodulen – Azure återställnings tider
description: Lär dig grunderna om koncept och arbets flöde för Azure återställnings tider IoT-säkerhetsmodulen.
...
Säkerhetsmodulen för Azure återställnings tider tillhandahålls som kostnads fri nedladdning för dina IoT-enheter. Azure Security Center för IoT Cloud service är tillgänglig med en 30-dagars utvärderings version per Azure-prenumeration. [Hämta säkerhetsmodulen nu](https://github.com/azure-rtos/azure-iot-preview/releases) och kom igång. 
