---
title: Autentiseringsmetoder för Azure Security Center för IoT | Microsoft Docs
...
|fil Sök väg|FilePath|b|Absolut fullständig sökväg för filen som innehåller certifikatet eller den symmetriska nyckeln| |
