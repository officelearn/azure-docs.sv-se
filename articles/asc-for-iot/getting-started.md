...
ms.locfileid: "81311379"
---
# <a name="get-started-with-azure-security-center-for-iot"></a>Komma igång med Azure Security Center for IoT

Den här artikeln innehåller en förklaring av de olika komponenterna i Azure Security Center för IoT-tjänsten och förklarar hur du kommer igång med tjänsten med två möjliga distributions alternativ.
