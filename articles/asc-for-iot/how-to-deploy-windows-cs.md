---
title: Installera C#-agent på Windows-enhet
...
1. Lägga till körbehörigheter i InstallSecurityAgent-skriptet genom att köra:
...
Om du vill ha ytterligare hjälp kan du använda kommandot Hämta hjälp i PowerShell.

Exempel på hjälp:```Get-Help .\InstallSecurityAgent.ps1```
...
1. Läs loggfilen för mer information om felet. Loggfilen skulle finnas i arbetskatalogen där vi kör skriptet. 
