...
Log Analytics inmatning i IoT Hub är inaktiverat som standard Azure Security Center för IoT-lösningen. Gör så här för att aktivera det för att arbeta med säkerhetsmodulen för Azure återställnings tider: 
...
> [Konfigurera säkerhetsmodulen för Azure-återställnings tider](how-to-azure-rtos-security-module.md)
