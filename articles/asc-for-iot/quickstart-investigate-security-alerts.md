...
description: Förstå, öka detalj nivån och undersök Azure Security Center för IoT-säkerhetsaviseringar på dina IoT-enheter.
...
ms.locfileid: "88068574"
---
# <a name="quickstart-investigate-security-alerts"></a>Snabb start: undersöka säkerhets aviseringar

En schemalagd undersökning och reparation av de aviseringar som utfärdats av Azure Security Center för IoT är det bästa sättet att säkerställa efterlevnad och skydd i din IoT-lösning.
...
Fortsätt till nästa artikel om du vill lära dig mer om Azure Security Center aviserings typer och eventuella anpassningar...
