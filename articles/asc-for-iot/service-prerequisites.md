---
title: ASC för IoT-krav förhandsversion | Microsoft Docs
description: Information om allt som behövs för att komma igång med ASC krav för IoT-tjänsten.
services: ascforiot
...
ms.locfileid: "58541834"
---
# <a name="asc-for-iot-prerequisites"></a>ASC för IoT-krav
...
Den här artikeln innehåller en förklaring av de olika byggstenarna för ASC för IoT-tjänsten, vad du behöver att påbörja och grundläggande begrepp för att förstå tjänsten. 
...
ASC för IoT-agenter stöder en växande lista med enheter och plattformar. Se den [stöds plattformslistan](select-deploy-agent.md) att kontrollera biblioteket befintligt eller planerat enheten.  
