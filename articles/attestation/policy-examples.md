...
## <a name="default-policy-for-an-sgx-enclave-with-policyformattext"></a>Standard princip för en SGX-enklaven med PolicyFormat = text
...
## <a name="default-policy-for-vbs-enclave"></a>Standard princip för VBS enklaven

Det finns ingen standard princip för VBS-enklaven
