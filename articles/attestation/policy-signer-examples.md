---
title: Exempel på ett signerings certifikat för Azure attesterings princip
description: Ett exempel på ett signerings certifikat innehåll för Azure attesterings princip.
...
## <a name="policy-signer-certificate-content"></a>Information om principens signerade certifikat
...
## <a name="policy-signer-certificates-file-content"></a>Fil innehåll för princip signerings certifikat
