...
Du kan lära dig hur du signerar nodkonfigurationer på https://msdn.microsoft.com/powershell/wmf/5.1/dsc-improvements#how-to-sign-configuration-and-module.
