...
Du skapar en enkel [DSC-konfigurationen](/powershell/dsc/configurations) som säkerställer förekomsten eller frånvaron av den **Web Server** Windows funktionen (IIS), beroende på hur du tilldelar noder.
...
1. Klicka på vänster, **alla resurser** och sedan namnet på ditt Automation-konto.
...
1. På den **importkonfigurationen** sidan, bläddra till den `TestConfig.ps1` filen på datorn.
...
1. Klicka på vänster, **alla resurser** och sedan namnet på ditt Automation-konto.
1. På den **automatiseringskontot** väljer **DSC-konfigurationer** under **konfigurationshantering**.
1. På den **DSC-konfigurationer** klickar du på **TestConfig** (detta är namnet på den konfiguration som du har importerat i föregående procedur).
...
1. På den **automatiseringskontot** klickar du på **DSC-konfigurationer** under **konfigurationshantering**.
1. På den **DSC-konfigurationer** klickar du på **TestConfig** (namnet på den tidigare importerat konfigurationen).
1. Under **Kompileringsjobb**, Välj kompileringsjobbet som du vill visa. En **Kompileringsjobbet** öppnas, med det datum då kompileringsjobbet startades.

    ![Skärmbild av sidan Kompileringsjobbet](./media/automation-dsc-getting-started/CompilationJob.png)
1. Klicka på panelen i den **Kompileringsjobbet** sidan för att visa ytterligare information om jobbet.
...
1. På den **automatiseringskontot** bladet, klickar du på **DSC-Nodkonfigurationer**.
...
1. Logga in på [Azure Portal](https://portal.azure.com).
1. Klicka på vänster, **alla resurser** och sedan namnet på ditt Automation-konto.
1. På den **automatiseringskontot** klickar du på **DSC-noder** under **konfigurationshantering**.
1. I den **DSC-noder** klickar du på **lägga till Azure VM**.

    ![Skärmbild av sidan DSC-noder Markera knappen Lägg till Azure VM](./media/automation-dsc-getting-started/OnboardVM.png)
1. På sidan för virtuella datorer väljer du den virtuella datorn. **Lägg till virtuella datorer i Azure** klickar du på **Välj virtuella datorer som ska publiceras**.
1. Klicka på **Anslut**.
