...
## <a name="onboarding-physicalvirtual-windows-machines"></a>Introduktion till fysiska/virtuella Windows-datorer
...
1. Med hjälp av Azure-portalen eller cmdlets kontrollerar du att datorerna som ska finnas ombord visas som tillståndskonfigurationsnoder som är registrerade i ditt Azure Automation-konto.

## <a name="onboarding-physicalvirtual-linux-machines"></a>Introduktion till fysiska/virtuella Linux-maskiner
