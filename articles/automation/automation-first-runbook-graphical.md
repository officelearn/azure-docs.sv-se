...
4. **Etiketten** tilldelas som standard samma namn som cmdleten, men du kan ändra den till något mer beskrivande. Ändra den till *Skriv Hello World på skärmen*.
...
6. Välj **InputObject**-parametern. Det här är parametern där du anger vilken text som ska skickas till utdataströmmen.
7. I listrutan **Datakälla** väljer du **PowerShell-uttryck**. Listrutan **Datakälla** innehåller olika källor som du använder för att fylla i ett parametervärde.
   ...
   Du kan använda utdata från sådana källor som en annan aktivitet, en Automation-tillgång eller ett PowerShell-uttryck. I det här fallet är utdata bara *Hello World*. Du kan använda ett PowerShell-uttryck och ange en sträng.
...
4. När runbook-jobbet är klart visas dess utdata. I det här fallet visas *Hello World*.<br> ![Hello World](media/automation-first-runbook-graphical/runbook-test-results.png)
...
4. Starta runbook-jobbet genom att klicka på **Starta** och sedan på **Ja** när du uppmanas att göra det.<br> ![Starta runbook](media/automation-first-runbook-graphical/runbook-controls-start-revised20165.png)
5. Ett jobblad öppnas för det runbook-jobb som du skapade. Kontrollera att **Jobbstatus** är **Slutförd**.
7. När runbookens status visas som *Slutförd* klickar du på **Utdata**. Bladet **Utdata** öppnas och du kan se *Hello World* i fönstret.
8. Stäng utdatabladet.
9. Klicka på **Alla loggar** för att öppna bladet Strömmar för runbook-jobbet. Du bör endast se *Hello World* i utdataströmmen, men även andra dataströmmar kan visas för ett runbook-jobb, till exempel Utförlig och Fel, om runbook-jobbet skriver till dem.
10. Stäng bladet Alla loggar och bladet Jobb för att gå tillbaka till bladet MyFirstRunbook.
11. Om du vill visa alla jobb för runbook-jobbet stänger du bladet **Jobb** och väljer **Jobb** under **RESURSER**. Här visas alla jobb som skapats av det här runbook-jobbet. Nu bör du endast se ett jobb eftersom du bara körde jobbet en gång.
...
1. På bladet Automation-konton väljer du **Variabler** under **DELADE RESURSER**.
2. Klicka på **Lägg till en variabel**.<br>![Automation-variabel](media/automation-first-runbook-graphical/create-new-subscriptionid-variable.png)
...
Nu när du har en variabel som ska innehålla prenumerations-ID:t kan du konfigurera runbook-jobbet för att autentisera med ”kör som”-autentiseringsuppgifterna som avses i [kravavsnittet](#prerequisites). Du gör det genom att lägga till **Add-AzureRMAccount**-cmdleten och **tillgången** för Azures ”kör som”-anslutning på arbetsytan.  

1. Gå tillbaka till din runbook och välj **Redigera** på bladet MyFirstRunbook.<br> ![Redigera runbook](media/automation-first-runbook-graphical/runbook-controls-edit-revised20165.png)
2. Eftersom du inte behöver **Skriv Hello World på skärmen** längre klickar du på ellipsen och väljer **Ta bort**.
3. Expandera **TILLGÅNGAR**, **Anslutningar** i bibliotekskontrollen och lägg till **AzureRunAsConnection** på arbetsytan genom att välja **Lägg till på ytan**.
...
10. **Add-AzureRmAccount** har flera parameteruppsättningar så du måste välja en innan du kan ange parametervärden. Klicka på **Parameteruppsättning** och välj parameteruppsättningen **ServicePrincipalCertificate**.
...
12. På bladet Parametervärde väljer du **Aktivitetsutdata** för **Datakälla** och väljer **Hämta ”kör som”-anslutning** i listan. I textrutan **Fältsökväg** skriver du **ApplicationId** och klickar sedan på **OK**. Du anger namnet på egenskapen för Fältsökväg eftersom aktiviteten matar ut ett objekt med flera egenskaper.
...
20. **Set-AzureRmContext** har flera parameteruppsättningar så du måste välja en innan du kan ange parametervärden. Klicka på **Parameteruppsättning** och välj parameteruppsättningen **SubscriptionId**.  
...
5. Välj **Name**. Välj **PowerShell-uttryck** för **Datakälla** och skriv namnet på den virtuella datorn (omgivet av dubbla citattecken) som du ska starta med det här runbook-jobbet. Klicka på **OK**.<br>![Parametervärde för Name i Start-AzureRmVM](media/automation-first-runbook-graphical/runbook-startvm-nameparameter.png)
...
7. Klicka på Testfönster så att du kan testa runbook-jobbet.
