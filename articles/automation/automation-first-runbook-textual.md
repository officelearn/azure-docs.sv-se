<properties
    pageTitle="Min första PowerShell Workflow-runbook i Azure Automation | Microsoft Azure"
...
# Min första PowerShell Workflow-runbook
...
2.  Öppna listan med runbooks genom att klicka på panelen **Runbooks**.<br> ![Runbook-kontroll](media/automation-first-runbook-textual/runbooks-control.png)
...
5.  Eftersom vi ska skapa en [PowerShell Workflow-runbook](automation-runbook-types.md#powerShell-workflow-runbooks) väljer du **Powershell-arbetsflöde** för **Typ av runbook**.<br> ![Ny runbook](media/automation-first-runbook-textual/new-runbook.png)
...
3.  Spara runbooken genom att klicka på **Spara**.<br> ![Spara runbooken](media/automation-first-runbook-textual/runbook-edit-toolbar-save.png)
...
1.  Öppna testfönstret genom att klicka på **Testfönster**.<br> ![Testfönster](media/automation-first-runbook-textual/runbook-edit-toolbar-test-pane.png)
...
4.  När runbook-jobbet är klart visas dess utdata. I detta fall bör du se *Hello World*.<br> ![Hello World](media/automation-first-runbook-textual/test-output-hello-world.png)
...
1.  Klicka på **Publicera** för att publicera runbooken och sedan på **Ja** när du uppmanas att göra det.<br> ![Publicera](media/automation-first-runbook-textual/runbook-edit-toolbar-publish.png)
...
4.  Eftersom vi bara vill starta runbooken klickar du på **Starta** och sedan på **Ja** när du uppmanas att göra det.<br> ![Starta runbooken](media/automation-first-runbook-textual/runbook-toolbar-start.png)
...
6.  Jobbets status visas i **Jobbsammanfattning** och överensstämmer med de statusar som vi såg när vi testade runbooken.<br> ![Jobbsammanfattning](media/automation-first-runbook-textual/job-pane-summary.png)
7.  När runbookens status visas som *Slutförd* klickar du på **Utdata**. Fönstret Utdata öppnas och *Hello World* visas.<br> ![Jobbsammanfattning](media/automation-first-runbook-textual/job-pane-output.png)  
8.  Stäng utdatafönstret.
9.  Klicka på **Strömmar** för att öppna fönstret Strömmar för runbook-jobbet. Vi bör endast se *Hello World* i utdataströmmen, men även andra dataströmmar kan visas för ett runbook-jobb, till exempel Utförlig och Fel, om runbooken skriver till dem.<br> ![Jobbsammanfattning](media/automation-first-runbook-textual/job-pane-streams.png)
10. Stäng fönstret Strömmar och fönstret Jobb för att återgå till fönstret MyFirstRunbook.
11. Öppna fönstret Jobb för runbooken genom att klicka på **Jobb**. Här visas alla jobb som skapats av den här runbooken. Vi bör endast se ett jobb i listan eftersom vi bara körde jobbet en gång.<br> ![Jobb](media/automation-first-runbook-textual/runbook-control-jobs.png)
...
1.  Öppna textredigeraren genom att klicka på **Redigera** i fönstret MyFirstRunbook-Workflow.<br> ![Redigera runbooken](media/automation-first-runbook-textual/runbook-toolbar-edit.png)
...
6.  Starta testet genom att klicka på **Starta**. När testet är klart visas utdata som liknar de nedan, med grundläggande information från ditt konto. Detta bekräftar att autentiseringsuppgifterna är giltiga.<br> ![Autentisera](media/automation-first-runbook-textual/runbook-auth-output.png)
...
6.  Starta runbooken genom att klicka på **Starta**. Skriv **VMName** och **ResourceGroupName** för den virtuella datorn som du ska starta.<br> ![Starta runbooken](media/automation-first-runbook-textual/automation-pass-params.png)
