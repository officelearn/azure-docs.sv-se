...
2. Välj en runbook direkt.
   ...
   *  OMS-arbetsytan är länkad till ett Automation-konto.  
...
*  Du måste ha koden för att konvertera WebhookData till ett PowerShell-objekt.
    ...
    *$SearchResults* är en matris med objekt, och varje objekt innehåller fälten med värden från ett sökresultat
