...
Den [Write-Progress](https://technet.microsoft.com/library/hh849902.aspx) cmdlet är inte giltig i en runbook, eftersom den är avsedd för användning med en interaktiv användare.
