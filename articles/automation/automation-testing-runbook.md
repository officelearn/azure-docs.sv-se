...
* Mer information om hur du konfigurerar runboks för att returnera statusmeddelanden och fel, inklusive rekommenderade metoder, se [Runbook-utdata och meddelanden i Azure Automation](automation-runbook-output-and-messages.md)
