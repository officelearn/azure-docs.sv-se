...
1. Välj knappen **Redigera inställningar** högst upp i fönstret i **lagervyn.**
...
3. Välj lämplig kategori och klicka på **Lägg till** högst upp i fönstret.
...
Klicka på knappen **+ Klona** om du vill klona maskingruppen. Här måste du ge gruppen ett nytt namn och alias för gruppen. Definitionen kan ändras just nu. När du har ändrat frågan trycker du på **Validera fråga** för att förhandsgranska de datorer som skulle väljas. När du är nöjd med gruppen klickar du på **Skapa** för att skapa maskingruppen

Om du vill skapa en ny maskingrupp väljer du **+ Skapa en maskingrupp**. Med den här knappen öppnas **sidan Skapa en maskingrupp** där du kan definiera den nya gruppen. Skapa gruppen genom att klicka på **Skapa**.
