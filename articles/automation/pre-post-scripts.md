...
För att en runbook ska kunna användas som pre- eller efterskript måste runbooken importeras till ditt Automation-konto och publiceras. Mer information om den här processen finns i [Publicera en runbook](manage-runbooks.md#publishing-a-runbook).
