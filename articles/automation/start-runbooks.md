...
Följande bild illustrerar detaljerade steg i livscykeln för en runbook. Den innehåller olika sätt som en runbook startas i Azure Automation, vilka komponenter som krävs för Hybrid Runbook Worker att köra Azure Automation-runbooks och samverkan mellan olika komponenter. Läs om hur du kör Automation-runbooks i datacentret, [hybrid runbook Worker](automation-hybrid-runbook-worker.md)
