...
Lös problemet genom att ta bort följande registernyckel och starta om den `HealthService` och försök på `Add-HybridRunbookWorker` cmdleten igen:
