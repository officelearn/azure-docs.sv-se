...
Vi rekommenderar att du implementerar en avsöknings logik och använder cmdleten [Get-AzureRmAutomationJobOutput](/powershell/module/azurerm.automation/get-azurermautomationjoboutput) för att hämta utdata. Ett exempel på den här logiken definieras nedan.
