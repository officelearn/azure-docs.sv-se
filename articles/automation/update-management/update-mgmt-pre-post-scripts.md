...
![Välj skript](./media/update-mgmt-pre-post-scripts/select-scripts.png)
...
![Valda objekt](./media/update-mgmt-pre-post-scripts/selected-items.png)
...
![Uppdatera resultat](./media/update-mgmt-pre-post-scripts/update-results.png)
...
![Körnings resultat för distribution](./media/update-mgmt-pre-post-scripts/deployment-run.png)
...
![Galleri lista](./media/update-mgmt-pre-post-scripts/runbook-gallery.png)
...
* Mer information om uppdaterings hantering finns i [Hantera uppdateringar och korrigeringar för dina virtuella datorer](update-mgmt-manage-updates-for-vm.md).
