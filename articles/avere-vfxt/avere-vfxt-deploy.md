...
* **Kluster administrations lösen ord** – skapa lösen ordet för kluster administration. Det här lösen ordet används med användar namnet ```admin``` för att logga in på kluster kontroll panelen, där du kan övervaka klustret och konfigurera kluster inställningar.
