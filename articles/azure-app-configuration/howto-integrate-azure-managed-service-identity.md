...
1. Valfritt: om du vill ge åtkomst till Key Vault också följer du anvisningarna i [tilldela en Key Vault åtkomst princip](/azure/key-vault/assign-access-policy-portal).
