...
|---|---|
| [az appconfig delete](/cli/azure/ext/appconfig/appconfig#ext-appconfig-az-appconfig-delete) | Tar bort en resurs för konfigurations Arkiv för appar. |
