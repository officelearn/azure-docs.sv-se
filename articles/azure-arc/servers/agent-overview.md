...
* Följande installationsfiler skapas under installationen.
    ...
    |%ProgramData%\GuestConfig |Innehåller (tillämpade) filer relaterade till Azure-principer.|
...
* Följande Windows-tjänster skapas på mål datorn under installationen av agenten.
    ...
    |-------------|-------------|-------------|------------|
    |himds |Azure Hybrid-Instance Metadata Service |himds. exe |Den här tjänsten implementerar IMDS (Azure instance metadata service) för att spåra datorn.|
...
* Det finns fyra loggfiler tillgängliga för fel sökning. De beskrivs i följande tabell.
    ...
    |%ProgramData%\GuestConfig\ gc_agent_logs \ gc_agent_telemetry. txt |Registrerar Detaljer om telemetri för DSC-tjänster och utförlig loggning.|
...
* Följande installationsfiler skapas under installationen.
    ...
    |/var/lib/GuestConfig |Innehåller (tillämpade) filer relaterade till Azure-principer.|

* Följande daemonar skapas på mål datorn under installationen av agenten.

    |Tjänstnamn |Visningsnamn |Processnamn |Description |
    |-------------|-------------|-------------|------------|
    |himdsd. service |Azure Hybrid-Instance Metadata Service |/opt/azcmagent/bin/himds |Den här tjänsten implementerar IMDS (Azure instance metadata service) för att spåra datorn.|
