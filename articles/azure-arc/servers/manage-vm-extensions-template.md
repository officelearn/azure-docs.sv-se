...
## <a name="deploy-the-dependency-agent"></a>Distribuera beroende agenten
...
* Du kan distribuera och ta bort ett tillägg med hjälp av Azure CLI eller PowerShell.
