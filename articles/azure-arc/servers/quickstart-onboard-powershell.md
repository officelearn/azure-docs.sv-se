...
* Om du redan har installerat agenten kör du kommandot `/opt/azcmagent/bin/hybridrp_proxy add https://{proxy-url}:{proxy-port}`, som konfigurerar proxyservern och startar om agenten.
