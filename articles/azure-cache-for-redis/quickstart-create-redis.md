---
title: 'Snabb start: skapa en Azure-cache för Redis'
description: I den här snabb starten lär du dig hur du skapar en instans av Azure cache för Redis
author: yegu-ms
ms.author: yegu
ms.service: cache
ms.custom: mvc
...
ms.locfileid: "83204810"
---
# <a name="quickstart-create-an-azure-cache-for-redis-instance"></a>Snabb start: skapa en Azure-cache för Redis-instans
