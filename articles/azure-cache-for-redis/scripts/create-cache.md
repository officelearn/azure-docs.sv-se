---
title: Azure CLI skriptexempel – skapa en Azure Cache för Redis | Microsoft Docs
description: Azure CLI skriptexempel – skapa en Azure Cache för Redis
services: cache
documentationcenter: ''
author: yegu-ms
manager: jhubbard
