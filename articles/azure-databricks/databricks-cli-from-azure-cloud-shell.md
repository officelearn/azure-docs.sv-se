...
---
# <a name="use-databricks-cli-from-azure-cloud-shell"></a>Använda Databricks CLI från Azure-molnet Shell
...
* Om du vill se en lista med kommandon för Azure CLI finns [Azure CLI-referens](https://docs.microsoft.com/cli/azure/?view=azure-cli-latest)
