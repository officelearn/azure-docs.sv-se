...
Om du inte använder [Azure Portal](/azure/databricks/administration-guide/cloud-configurations/azure/vnet-inject#vnet-inject-portal) -eller [Azure Resource Manager mallar](/azure/databricks/administration-guide/cloud-configurations/azure/vnet-inject#vnet-inject-advanced) för att skapa nätverks säkerhets grupper, måste du manuellt vitlista följande trafik i dina undernät.
