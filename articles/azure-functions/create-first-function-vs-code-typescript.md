---
title: Skapa en TypeScript-funktion med Visual Studio Code-Azure Functions
...
Det finns också en [CLI-baserad version](create-first-function-cli-typescript.md) av den här artikeln.
