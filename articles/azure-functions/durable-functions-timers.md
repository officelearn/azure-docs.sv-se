...
Du skapar en beständig timer genom att anropa [CreateTimer](https://azure.github.io/azure-functions-durable-extension/api/Microsoft.Azure.WebJobs.DurableOrchestrationContext.html#Microsoft_Azure_WebJobs_DurableOrchestrationContext_CreateTimer_). Metoden returnerar en uppgift som återupptar på ett angivet datum och tid.
