...
| Parameter        | Parameter Type  | Beskrivning |
|------------------|-----------------|-------------|
...
| Fält              | Parameter type  | Beskrivning |
|--------------------|-----------------|-------------|
...
| **`{content}`**    | Request content | Valfri. The JSON-formatted orchestrator function input. |
...
|-----------------------|-----------|-------------|
| **`runtimeStatus`**   | sträng    | The runtime status of the instance. Values include *Running*, *Pending*, *Failed*, *Canceled*, *Terminated*, *Completed*. |
...
| **`createdTime`**     | sträng    | The time at which the instance was created. Uses ISO 8601 extended notation. |
| **`lastUpdatedTime`** | sträng    | The time at which the instance last persisted. Uses ISO 8601 extended notation. |
...
| Fält                  | Datatyp | Beskrivning |
|------------------------|-----------|-------------|
| **`instancesDeleted`** | heltal   | The number of instances deleted. For the single instance case, this value should always be `1`. |
...
| Fält                   | Datatyp | Beskrivning |
|-------------------------|-----------|-------------|
| **`instancesDeleted`**  | heltal   | The number of instances deleted. |
...
|-------------------|-----------------|-------------|
| **`instanceId`**  | URL             | The ID of the orchestration instance. |
| **`reason`**      | Query string    | Valfri. The reason for terminating the orchestration instance. |
...
|-------------------|-----------------|-------------|
| **`instanceId`**  | URL             | The ID of the orchestration instance. |
| **`reason`**      | Query string    | Valfri. The reason for rewinding the orchestration instance. |
...
| **`op`**          | Query string    | Valfri. The name of the user-defined operation to invoke. |
| **`{content}`**   | Request content | The JSON-formatted event payload. |
