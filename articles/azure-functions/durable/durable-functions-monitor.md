...
Orchestrator kräver flera typer av data, så [delade POCO objekt](../functions-reference-csharp.md#reusing-csx-code) används för starkt typifierade dataöverföring i C# och C#-skript:  
