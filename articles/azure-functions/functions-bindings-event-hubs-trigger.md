...
ms.locfileid: "77589797"
---
# <a name="azure-event-hubs-bindings-for-azure-functions"></a>Azure Event Hubs-bindningar för Azure Functions

Den här artikeln förklarar hur du arbetar med [Azure Event Hubs](../event-hubs/event-hubs-what-is-event-hubs.md) -utlösare för Azure Functions. Azure Functions stöder utlösare och [utgående bindningar](functions-bindings-event-hubs-output.md) för Event Hubs.
...
- [Skriv händelser till en händelse ström (utgående bindning)](./functions-bindings-storage-blob-output.md)
