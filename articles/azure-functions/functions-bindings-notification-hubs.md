...
|---------|---------|----------------------|
|**typ** |Ej tillämpligt| Must be set to `notificationHub`. |
|**riktning** |Ej tillämpligt| Must be set to `out`. | 
|**name** |Ej tillämpligt| Variable name used in function code for the notification hub message. |
