...
Koden i `func.ServiceBusMessage`   *_\_init_.pydeklarerarenparametersomgörattdukanläsameddelandetikönidinfunktion.\_*
...
En bindnings definition för ServiceBue definieras i *Function. JSON* där *Type* har angetts `serviceBus`till.
...
`set` I   *_init\__ .pykanduskrivautettmeddelandetillköngenomattskicka\_* ett värde till-metoden.
