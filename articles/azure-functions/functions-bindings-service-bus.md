---
title: "Azure Functions Service Bus-utlösare och bindningar"
...
Du kan använda den `ServiceBusAccount` -attribut som anger Service Bus-konto som ska användas på klass, metoden eller parametern-nivå.  Mer information finns i [utlösaren - attribut för förkompilerade C#](#trigger---attributes-for-precompiled-c).
