...
Du kan följa stegen nedan på en Mac-, Windows- eller Linux-dator. Det bör bara ta ungefär fem minuter att slutföra alla steg i det här ämnet.
...
+ [Azure CLI installerat](https://docs.microsoft.com/cli/azure/install-azure-cli). 
