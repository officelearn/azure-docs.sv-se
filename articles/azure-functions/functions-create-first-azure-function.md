<properties
   pageTitle="Skapa din första Azure-funktion | Microsoft Azure"
...
Det här ämnet visar hur du använder Azure Functions-snabbstart i Azure Functions-portalen för att skapa en enkel "hello world" Node.js-funktion som anropas av en HTTP-utlösare. Du kan också titta på en kort video om du vill se hur dessa steg utförs i portalen.
...
En funktionsapp är värd för körningen av dina funktioner i Azure. Följ dessa steg om du vill skapa en ny funktionsapp samt den nya funktionen. Innan du kan skapa din första funktion måste du ha ett aktivt Azure-konto. Om du inte redan har ett Azure-konto, [finns kostnadsfria konton tillgängliga](https://azure.microsoft.com/free/).
...
3. I fliken **Snabbstart** klickar du på **WebHook + API** > **Skapa en funktion**. En ny fördefinierad Node.js-funktion skapas. 
