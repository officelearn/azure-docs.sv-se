...
1. Expandera det anslutna lagrings kontot, högerklicka på **BLOB-behållare**, klicka på **skapa BLOB-behållare**, skriv `samples-workitems`och tryck sedan på RETUR.
