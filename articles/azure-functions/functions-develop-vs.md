...
* Ett Azure Storage-konto. Om du vill skapa ett lagringskonto, [skapa ett lagringskonto](../storage/common/storage-create-storage-account.md#create-a-storage-account).
