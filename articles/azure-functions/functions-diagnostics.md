...
Du kan ställa frågor eller ge feedback om Azure Functions diagnostik på [UserVoice](https://feedback.azure.com/forums/355860-azure-functions). Ta `[Diag]` med i rubriken för din feedback.
