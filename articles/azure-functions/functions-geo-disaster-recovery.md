---
title: Azure Functions geo-haveri beredskap | Microsoft Docs
description: Hur du använder geografiska regioner för att redundansväxla och använda haveri beredskap i Azure Functions.
services: functions
