...
Kontroller i [sampling funktion i Application Insights](functions-monitoring.md#configure-sampling). I version 2.x kan den här inställningen är underordnad [loggning](#log).
