...
Den här inställningen är underordnad [loggning](#log).
...
Konfigurationsinställningen kan hittas i [bindningar för varaktiga funktioner](durable-functions-bindings.md#host-json).
