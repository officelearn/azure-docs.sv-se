...
2. **Klicka** på fliken **Rubriker**.
3. Ange **x-functions-key** som den första **nyckeln** och klistra in huvudnyckeln (från Urklipp) till **värderutan**.
4. Skriv **Content-Type** som den andra **nyckeln** och skriv **application/json** som **värdet**.

    ![Inställningar för rubriker i Postman](./media/functions-manually-run-non-http/functions-manually-run-non-http-headers.png)

5. **Klicka** på fliken **Brödtext**.
6. Ange **{”input”: ”test”}** som brödtext för begäran.
