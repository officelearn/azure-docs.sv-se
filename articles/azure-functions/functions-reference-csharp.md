...
Du kan använda metoden returvärdet för en utdatabindning genom att använda namnet `$return` i *function.json*. Exempel finns i [utlösare och bindningar](./functions-bindings-return-value.md).
