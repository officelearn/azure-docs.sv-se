...
@No__t-0-instruktionen beskrivs [längre fram i den här artikeln](#referencing-external-assemblies).
...
@No__t-0-direktivet fungerar endast med *. CSX* -filer, inte med *. cs* -filer.
