...
- From the [Azure-portalen], search for and select **Storage accounts**. 
...
| **`--additional-packages`** | List of packages to install when building native dependencies. Till exempel: `python3-dev libevent-dev`. |
