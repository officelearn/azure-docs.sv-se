...
1. Bläddra till **körmiljö för Azure Functions Portal** som `https://<machinename>.<domain>` till exempel `https://mycomputer.mydomain.com`.
...
1. Du måste skapa en prenumeration för att kunna skapa Function-appar.  I det övre vänstra hörnet i portalen klickar du på alternativet **+** bredvid prenumerationerna.
...
1. Alla dina funktions-appar visas i den vänstra rutan i portalen.  Om du vill skapa en ny Funktionsapp väljer du **funktionen rubrik funktion appar** och klickar på alternativet **+** .
...
1. Välj funktionen timer-utlösare i den högra utfällbara filen och ändra schemat till `*/5 * * * * *` (detta cron-uttryck gör att funktionen timer körs var femte sekund) och klickar på **skapa**
