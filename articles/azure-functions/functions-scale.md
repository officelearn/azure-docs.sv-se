...
| | Förbrukningsplan | Premium-plan | Dedicated plan |
|-|:----------------:|:------------:|:----------------:|
...
* En enskild funktionsapp skalar bara upp till högst 200 instanser. A single instance may process more than one message or request at a time though, so there isn't a set limit on number of concurrent executions.
