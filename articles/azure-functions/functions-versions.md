...
Från och med version 2. x använder körnings modellen en språk utöknings modell och alla funktioner i en Function-app måste dela samma språk. Språket i funktioner i en Function-app väljs när du skapar appen och underhålls i [funktionerna\_worker\_runtime](functions-app-settings.md#functions_worker_runtime) -inställningen. 
