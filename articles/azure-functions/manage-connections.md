...
Här är ett exempel på en C#-funktions kod som skapar en statisk [httpclient](https://msdn.microsoft.com/library/system.net.http.httpclient(v=vs.110).aspx) -instans:
