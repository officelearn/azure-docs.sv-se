...
1. Utför ett av följande steg, beroende på din autentiseringsmetod. 
    ...
    * Om ditt program använder autentisering med användar-token med Azure Maps Web SDK, så aktivera `oauth2AllowImplicitFlow`. Om du vill aktivera det anger du `oauth2AllowImplicitFlow` till sant i avsnittet **manifest** i appens registrering. 
...
1. Gå till ditt **Azure Maps-konto**. Välj **åtkomst kontroll (IAM)**  > **roll tilldelning**.
