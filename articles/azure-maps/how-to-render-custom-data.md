...
1. Öppna Postman-appen och klicka på ny | Skapa en ny och välj begäran. Ange ett namn för rendering kartnålar, Välj en samling eller en mapp att spara den till och klicka på Spara.
    
    ![Ladda upp geofence-områden med hjälp av Postman](./media/tutorial-geofence/postman-new.png)
...
1. Öppna en ny flik i samma samling som du skapade ovan i Postman-appen. Välj efter HTTP-metod på fliken builder och ange följande URL för att göra en POST-begäran:

    ```HTTP
    https://atlas.microsoft.com/mapData/upload?subscription-key={subscription-key}&api-version=1.0&dataFormat=geojson
    ```

2. Klicka på parametrar och ange följande nyckel/värde-par som ska användas för POST-begäran-URL. Ersätt prenumeration-key-värde med din prenumerationsnyckel för Azure Maps.
    
    ![Nyckel / värde-parametrar Postman](./media/how-to-render-custom-data/postman-key-vals.png)

3. Klicka på **brödtext** Välj raw indataformat och välj JSON som Indataformatet från den nedrullningsbara listan. Ange följande JSON som data som ska laddas upp:
...
4. Klicka på Skicka och granska svarshuvudet. Location-huvudet innehåller URI: N för att komma åt eller hämta data för framtida användning. Den innehåller också ett unikt `udId` för överförda data.   
...
Du kan ändra utseendet på en polygon med hjälp av style modifierare med den [sökvägsparameter](https://docs.microsoft.com/rest-staging/api/maps/render/getmapimage#uri-parameters).

1. Öppna en ny flik i samma samling som du skapade ovan i Postman-appen. Välj Hämta HTTP-metod på fliken builder och ange följande URL för att göra en GET-begäran för att återge en polygon med färg och opacitet:
...
1. Öppna en ny flik i samma samling som du skapade ovan i Postman-appen. Välj Hämta HTTP-metod på fliken builder och ange följande URL för att göra en GET-begäran:
