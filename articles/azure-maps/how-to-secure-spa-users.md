...
7. Konfigurera rollbaserad åtkomst kontroll i Azure för användare eller grupper. Se [följande avsnitt för att aktivera RBAC](#grant-role-based-access-for-users-to-azure-maps).
