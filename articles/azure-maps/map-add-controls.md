...
Den här artikeln visar hur du lägger till kontroller till en karta. Du lär dig också hur du skapar en karta med alla kontroller och en [format väljare](./choose-map-style.md).
