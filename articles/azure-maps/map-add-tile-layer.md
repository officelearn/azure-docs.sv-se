...
## <a name="add-a-tile-layer"></a>Lägga till ett panelskikt
 ...
 Det här exemplet visar hur du skapar en bildrutsskikt som pekar på en uppsättning paneler som använder x, y, Zooma sida vid sida-system. Källan för den här bildrutsskikt är ett väder polärdiagram överlägg från den [Iowa miljön Mesonet av Iowa State University](https://mesonet.agron.iastate.edu/ogc/).
