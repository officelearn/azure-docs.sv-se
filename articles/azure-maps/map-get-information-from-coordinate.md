...
## <a name="making-a-reverse-search-request-via-service-module"></a>Gör en begäran för omvänd sökning via tjänstemodulen
...
## <a name="making-a-reverse-search-request-via-xmlhttprequest"></a>Gör en begäran för omvänd sökning via XMLHttpRequest
