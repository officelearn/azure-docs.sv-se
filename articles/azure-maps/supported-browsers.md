---
title: Stöd för webbläsare – Azure Maps | Microsoft Docs
description: Läs mer om webbläsare som stöds för Azure Maps Web SDK
author: rbrundritt
ms.author: richbrun
ms.date: 03/25/2019
ms.topic: conceptual
...
> [!TIP]
> Om du bäddar in en karta i en vy för mobila program en WebView-kontroll, kan du använda den [npm-paket för Azure Maps Web SDK](https://www.npmjs.com/package/azure-maps-control) bättre att referera till CDN som värd-versionen av SDK. Detta minskar inläsningstid eftersom SDK: N ska redan finnas på användarens enhet och inte behöver hämtas vid körning.
