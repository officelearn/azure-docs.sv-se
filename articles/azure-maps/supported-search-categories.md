...
| --- | --- |
| ÅTKOMST- \_ Gateway | flyg åtkomst, säkerhets grind, Stations åtkomst, åtkomst-Gateway |
| ADMINISTRATIV \_ avdelning | provins, fjärde ordning, administrativ avdelning, administrativ avdelning för första ordningen, historisk administrativ avdelning för tredje order, plats för en administrativ avdelning i fjärde ordning, plats för en administrativ avdelning med en andra ordning, en beroende politisk enhet, plats, plats för en administrativ avdelning på tredje ordningen, ifyllda platser, en administrativ avdelning för den andra ordningen, plats för en administrativ avdelning, en administrativ avdelning, en ifylld lokal plats, historisk region, historisk plats, historisk ifylld plats, israeliska kvittning, historisk administrations avdelning på fjärde sidan, administrativ avdelning för femte order, historisk administrativ avdelning för tredje order, historisk politisk entitet, historisk administrativ avdelning, säte för en politisk enhet, historisk administrativ avdelning, en sekundär enhet för en politisk enhet |
| ADVENTURE \_ idrotts \_ platser | Adventure idrotts platser |
...
| AMUSEMENT \_ Park | Amusement Arcade, Amusement Place, Amusement Park |
| BIL \_ handlare | ATV/Snowmobile, båt, buss, motorcykel, Last bil, van, återskapande fordon, bil handlare och fordons handlare |
| BANKEN | Bank, banker, bank (er) |
| BOLLAR | strand, stränder |
| Bygg \_ punkt | byggnad (punkt) |
| AFFÄRS \_ Park | affärs Park, industriella områden |
| CAFE \_ pub | Internet kafé, trietanolamin House, kafé, Internet kafé, kafé, kaffe Shop, mikrobryggeri/öl trädgård, pub, kafé/pub, kafé/pub |
| CAMPING \_ mark | rekreation, hus hus, Camping hus |
| \_biltvätt | biltvätt |
| LIKVIDITETs \_ utgivare | automatisk kassa-dator, likviditets utgivare |
| CASINO | casino |
| BIOGRAF | enhets in-biograf, biograf |
| STADS \_ Center | området, administrations området, stads Center, mitten |
| KLUBB \_ koppling | strand klubb, hockey-klubb, klubb förening |
...
| MILITÄR \_ installation | militär Base, västkust Station, militär-installation, örlogs bas |
