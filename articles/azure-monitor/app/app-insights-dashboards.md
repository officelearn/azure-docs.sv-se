...
Du kan också [fästa Analytics](../../azure-monitor/log-query/get-started-portal.md) diagram för en delad instrumentpanel. På så sätt kan du lägga till diagram av en godtyckligt fråga tillsammans med mått som standard. 
