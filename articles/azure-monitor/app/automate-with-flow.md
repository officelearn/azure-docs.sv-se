...
1. I den **frekvens** väljer **dag**, och i den **intervall** anger **1**.
    ...
    ![Dialogrutan för Microsoft Flow-utlösare](./media/automate-with-flow/flow1.png)
...
1. Klicka på **Azure Application Insights - visualisera Analytics fråga förhandsversion**.
    ...
    ![Kör Analytics frågefönster](./media/automate-with-flow/flow2.png)
...
![Program-ID i Azure portal](./media/automate-with-flow/appid.png) 

- Ange ett namn för anslutningen, tillsammans med den program-ID och API-nyckeln.

    ![Fönstret för Microsoft Flow-anslutning](./media/automate-with-flow/flow3.png)
...
- Lägg till följande Analytics-frågan och välj sedan diagramtypen HTML-tabell. 
    ...
    ![Konfigurationsfönstret i Analytics-fråga](./media/automate-with-flow/flow4.png)
...
1. Klicka på **Office 365 Outlook – skicka ett e-postmeddelande**.
    ...
    ![Office 365 Outlook-urvalsfönstret](./media/automate-with-flow/flow2b.png)
...
1. I den **skicka ett e-postmeddelande** fönstret gör du följande:
   ...
   d. Klicka på **visa avancerade alternativ**.
    ...
    ![Office 365 Outlook-konfiguration](./media/automate-with-flow/flow5.png)
...
1. På menyn om dynamiskt innehåll, gör du följande:
    ...
    ![Konfigurationsfönstret i Office 365 e-post](./media/automate-with-flow/flow7.png)
...
- I den **flödesnamn** , lägga till ett namn för flödet och sedan på **Skapa flöde**.
    ...
    ![Skapa flöde fönster](./media/automate-with-flow/flow8.png)
