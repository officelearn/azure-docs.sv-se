...
- **Inkommande konfiguration**
  ...
  - J2EE-appar, lägger du till följande för att den `<TelemetryModules>` tagg i ApplicationInsights.xml:
...
- Läs mer om [inställningen cloud_RoleName](../../azure-monitor/app/app-map.md#set-cloudrolename) för andra SDK: er.
