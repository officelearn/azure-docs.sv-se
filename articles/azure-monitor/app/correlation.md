...
Lägg till följande konfiguration:
  ...
  ```
> [!IMPORTANT] 
> För att se alla konfigurationer som krävs för att aktivera korrelation, se [JavaScript-korrelationens dokumentation](/app/javascript.md#enable-correlation).
