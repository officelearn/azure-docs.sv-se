...
Lägg till följande konfiguration:
  ...
  ```
> [!IMPORTANT] 
> För att se alla konfigurationer som krävs för att aktivera korrelation, se [JavaScript-korrelationens dokumentation](/azure/azure-monitor/app/javascript#enable-correlation).
