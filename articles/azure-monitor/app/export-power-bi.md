...
* [**Exportera Analytics-frågor**](#export-analytics-queries). Detta är den bästa metoden. Skriv en fråga som du vill ha och exportera den till Power BI. Du kan placera den här frågan på en instrument panel, tillsammans med andra data.
