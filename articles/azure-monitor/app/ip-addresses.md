...
> [!TIP]
> Prenumerera på den här sidan som en RSS-feed genom att lägga till https://github.com/MicrosoftDocs/azure-docs/commits/master/articles/azure-monitor/app/ip-addresses.md.atom i din favorit-RSS/ATOM-läsare för att få meddelanden om de senaste ändringarna.
> 
> 
...
>![under Inställningar väljer du inkommande säkerhets regler och väljer sedan Lägg till överst på fliken ](./media/ip-addresses/add-inbound-security-rule.png)

>[!div class="mx-imgBorder"]
>![Lägg till fliken inkommande säkerhets regel](./media/ip-addresses/add-inbound-security-rule2.png)
