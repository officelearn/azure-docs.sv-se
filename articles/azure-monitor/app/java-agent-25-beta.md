---
title: Prestanda övervakning för Java-webbappar i Azure Application Insights (2.5.0-BETA) | Microsoft Docs
description: Utökad prestanda och användnings övervakning av din Java-webbplats med Application Insights (2.5.0-BETA).
...
2. Redigera start skriptet för program servern och Lägg till följande JVM arg:
...
Knapp `JAVA_OPTS`Värde`-javaagent:D:/home/site/wwwroot/applicationinsights-agent-2.5.0-BETA.jar`
