...
I den [Microsoft Azure-portalen](https://portal.azure.com)öppnar den [Application Insights](../../application-insights/app-insights-overview.md) resurs där du vill att data ska visas. (Eller [skapa en ny resurs](../../application-insights/app-insights-create-new-resource.md).)
