---
title: Java Web App Analytics med Azure Application Insights (2.5.0-BETA) | Microsoft Docs
description: 'Övervakning av program prestanda för Java-webbappar med Application Insights (2.5.0-BETA). '
...
[Installera Java](java-agent-25-beta.md) -agenten för att avbilda utgående HTTP-anrop, JDBC-frågor, program loggning och bättre namngivning av åtgärder.
