...
ms.locfileid: "96600990"
---
# <a name="how-to-use-micrometer-with-azure-application-insights-java-sdk-not-recommended"></a>Använda micrometer med Azure Application Insights Java SDK (rekommenderas inte)
