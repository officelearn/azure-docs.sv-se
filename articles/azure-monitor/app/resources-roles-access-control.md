...
## <a name="access"></a>Kontrol lera åtkomst i resurs gruppen
...
| [Application Insights komponent deltagare](https://docs.microsoft.com/azure/role-based-access-control/built-in-roles#application-insights-component-contributor) |Kan redigera Application Insights-resurser, webbtester och aviseringar. |
...
| [Log Analytics läsare](https://docs.microsoft.com/azure/role-based-access-control/built-in-roles#log-analytics-reader) | Log Analytics läsaren kan visa och söka i alla övervaknings data samt Visa övervaknings inställningar, inklusive Visa konfigurationen av Azure Diagnostics på alla Azure-resurser. |
