---
title: Azure Application insikter Snapshot Debugger för .NET-appar | Microsoft Docs
...
Ögonblicks bilder kan innehålla känslig information och kan som standard inte visas. Du måste ha tilldelats rollen `Application Insights Snapshot Debugger` för att kunna visa ögonblicks bilder.
...
Version 15,2 (eller senare) av Visual Studio 2017 publicerar symboler för versions hantering som standard när den publiceras till App Service. I tidigare versioner måste du lägga till följande rad i publicerings profilen `.pubxml`-filen så att symboler publiceras i versions läge:
