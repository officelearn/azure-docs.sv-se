...
Ta reda på när personer använder din webbapp, vilka sidor som de är mest intresserad av, där användarna befinner sig, och vilka webbläsare och operativsystem som de använder. Analysera företag och användningstelemetri med hjälp av [Azure Application Insights](../../application-insights/app-insights-overview.md).
