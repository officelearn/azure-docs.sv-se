...
Anta till exempel att det finns fem behållar instanser av en behållar avbildning och **Healthy**deras enskilda tillstånd är **kritiska**, **Varning**, felfria, felfria. **Healthy** **Healthy**  Statusen för övervakaren för container processor belastning är **kritisk**, eftersom det sämsta tillståndet på 90% av behållarna är **kritisk** vid sortering i fallande ordning i allvarlighets grad.
...
|**Övervakarens namn** | **Beskrivning** | **Integritetsalgoritm** |
|-----------------|-----------------|---------------|
