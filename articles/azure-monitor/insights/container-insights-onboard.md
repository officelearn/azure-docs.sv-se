...
description: Den här artikeln beskrivs hur du aktiverar och konfigurerar Azure Monitor för behållare så att du kan förstå hur din behållare fungerar och vilka prestanda-relaterade problem har identifierats.
...
ms.locfileid: "67514500"
---
# <a name="how-to-enable-azure-monitor-for-containers"></a>Så här aktiverar du Azure Monitor för behållare
...
* **En Log Analytics-arbetsyta.**
    ...
    Azure Monitor för behållare har stöd för en Log Analytics-arbetsyta i de regioner som anges i Azure [produkter per region](https://azure.microsoft.com/global-infrastructure/services/?regions=all&products=monitor), exklusive regionen **Virginia (USA-förvaltad region)** .

    Du kan skapa en arbetsyta när du aktiverar övervakning av din nya AKS-klustret eller låta publiceringsupplevelsen skapa en standardarbetsyta i standardresursgruppen för prenumerationen för AKS-kluster. Om du väljer att skapa den själv, kan du skapa den via [Azure Resource Manager](../platform/template-workspace-configuration.md), via [PowerShell](../scripts/powershell-sample-create-workspace.md?toc=%2fpowershell%2fmodule%2ftoc.json), eller i den [Azure-portalen](../learn/quick-create-workspace.md). En lista över stöds mappningspar för standardarbetsytan finns i [regionsmappning för Azure Monitor för behållare](container-insights-region-mapping.md).
