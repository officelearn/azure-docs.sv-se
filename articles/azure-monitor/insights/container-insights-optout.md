...
Om du vill återaktivera övervakning för ditt kluster, se [aktivera övervakning med hjälp av Azure CLI](container-insights-onboard.md#enable-monitoring-using-azure-cli).
