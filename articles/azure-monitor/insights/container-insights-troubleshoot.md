...
Azure Monitor for containers agent poddar använder cAdvisor-slutpunkten på Node-agenten för att samla in prestanda måtten. Kontrol lera att den behållar agenten på noden är `cAdvisor port: 10255` konfigurerad att tillåtas att öppnas på alla noder i klustret för att samla in prestanda mått.
