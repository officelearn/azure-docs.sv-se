...
| [Azure Storage-konto](../../log-analytics/log-analytics-azure-storage.md) | Nej | Azure storage används inte av lösningen. |
...
[Söka loggarna](../../log-analytics/log-analytics-queries.md) att visa detaljerad DNS-poster.
