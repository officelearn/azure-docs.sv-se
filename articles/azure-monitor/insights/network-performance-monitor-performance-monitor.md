---
title: Prestanda övervaknings funktion i Övervakare av nätverksprestanda lösning i Azure Log Analytics | Microsoft Docs
...
1. Gå till **nätverks prestanda** > **övervaka** > **Konfigurera** > **Monitor**. Välj sedan **standard regel**. 
