...
- [Söka loggarna](../../log-analytics/log-analytics-queries.md) och lär dig att analysera detaljerad information för System Center Operations Manager hälsokontrollen och rekommendationer.
