...
## <a name="system-center-operations-manager-health-check-data-collection-details"></a>Information om System Center Operations Manager-hälsokontroll data insamling
...
### <a name="sql-script-to-grant-granular-permissions-to-the-run-as-account"></a>SQL-skript för att ge detaljerade behörigheter till kör som-kontot
...
### <a name="configure-the-health-check-rule"></a>Konfigurera hälso kontroll regeln
...
3. Högerklicka på regeln och klicka sedan på **åsidosätter** > **för ett särskilt objekt i klassen: Management Server**.
...
#### <a name="configure-the-run-frequency"></a>Konfigurera körnings frekvensen
...
2. I Sök resultaten väljer du den som innehåller text *typen: Management Server*.
3. Högerklicka på regeln och klicka sedan på **Åsidosätt regel** > **för alla objekt i klassen: Management Server**.
...
## <a name="system-center-operations-manager-health-check-solution-faq"></a>Vanliga frågor om System Center Operations Manager-hälsokontroll-lösning
