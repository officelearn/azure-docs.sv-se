...
| **Övervaknings lösning** | **Plattform** | **Microsoft Monitoring Agent** | **Operations Manager-agent** | **Azure-lagring** | **Operations Manager krävs.** | **Operations Manager agent data som skickas via hanterings gruppen** | **Insamlingsfrekvens** |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| [Uppdateringshantering](../../automation/automation-update-management.md) | Windows |&#8226; |&#8226; | | |&#8226; |minst två gånger per dag och 15 minuter efter installation av en uppdatering |
