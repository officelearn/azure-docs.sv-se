...
Övervaknings lösningar samlar normalt in loggdata och tillhandahåller frågor och vyer för att analysera insamlade data. De kan också använda andra tjänster som Azure Automation för att utföra åtgärder relaterade till programmet eller tjänsten.
...
1. Öppna **alla tjänster** och hitta **övervakaren**.
...
1. Logga in på Azure Portal.
1. Öppna **alla tjänster** och hitta **lösningar**.
4. Lösningar som är installerade på alla dina arbets ytor visas. Namnet på lösningen följs av namnet på arbets ytan som den är installerad i.
...
* För att länkas måste Log Analytics arbets ytan och automation-kontot finnas i samma resurs grupp och region. Undantaget är en arbets yta i regionen USA, östra och ett Automation-konto i USA, östra 2.

### <a name="create-a-link-between-a-log-analytics-workspace-and-automation-account"></a>Skapa en länk mellan en Log Analytics arbets yta och ett Automation-konto
Hur du anger Log Analytics arbets ytan och automation-kontot beror på installations metoden för din lösning.
...
* För lösningar utanför Azure Marketplace måste du länka Log Analytics arbets yta och Automation-konto innan du installerar lösningen. Du kan göra detta genom att välja en lösning på Azure Marketplace och välja Log Analytics arbets yta och Automation-konto. Du behöver inte installera lösningen, eftersom länken skapas så snart Log Analytics arbets yta och Automation-konto har valts. När länken har skapats kan du använda den Log Analytics arbets ytan och automation-kontot för alla lösningar.
