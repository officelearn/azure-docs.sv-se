...
7. I dialog rutan **Dependency agent 9.9.0 Uninstall** visas avinstallations förloppet och när det är klart visas sidan **Slutför Dependency agent avinstallation** . Klicka på **Finish**.
