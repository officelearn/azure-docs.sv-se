...
![Exempelfråga](media/tutorial-viewdata/log-analytics-portal-eventlist-01.png)
...
![Menyn Lägg till i filter](media/tutorial-viewdata/log-analytics-portal-eventlist-03.png)
...
Du kan gruppera resultatet för en enda egenskap genom att välja alternativet **Gruppera efter** på postmenyn.  Då läggs en [sammanfattningsoperator](/azure/kusto/query/summarizeoperator) till för frågan som visar resultatet i ett diagram.  Du kan gruppera efter mer än en egenskap, men då måste du redigera frågan direkt.  Välj postmenyn bredvid egenskapen **Dator** och välj **Gruppera efter ”dator”**.  

![Gruppera efter dator](media/tutorial-viewdata/log-analytics-portal-eventlist-04.png)
...
![Tabellvy](media/tutorial-viewdata/log-search-portal-table-01.png)

Klicka på pilen vid en post för att visa information för den posten.

![Sortera resultat](media/tutorial-viewdata/log-search-portal-table-02.png)

Sortera på ett fält genom att klicka på dess kolumnrubrik.

![Sortera resultat](media/tutorial-viewdata/log-search-portal-table-03.png)
...
![Filtrera resultat](media/tutorial-viewdata/log-search-portal-table-04.png)
...
![Gruppera resultat](media/tutorial-viewdata/log-search-portal-table-05.png)
...
![Prestandadata](media/tutorial-viewdata/log-analytics-portal-perfsearch-01.png)
...
![Processoranvändning](media/tutorial-viewdata/log-analytics-portal-perfsearch-02.png)

Det begränsar data till en särskild räknare, men det placerar dem fortfarande inte i ett formulär som är särskilt användbart.  Du kan visa data i ett linjediagram, men först måste du gruppera dem via Dator och TimeGenerated.  Om du vill gruppera flera fält måste du ändra frågan direkt, så ändra frågan så här.  Funktionen [medel](/azure/kusto/query/avg-aggfunction) för egenskapen **CounterValue** används för att beräkna medelvärdet för varje timme.
...
![Diagram över prestandadata](media/tutorial-viewdata/log-analytics-portal-perfsearch-03.png)

Nu när dina data är lämpligt grupperade kan du visa dem i ett visuellt diagram genom att lägga till operatorn [render](/azure/kusto/query/renderoperator).  
...
![Linjediagram](media/tutorial-viewdata/log-analytics-portal-linechart-01.png)
...
> [Skapa och dela Log Analytics-instrumentpaneler](tutorial-logs-dashboards.md)
