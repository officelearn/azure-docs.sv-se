...
- [Kom igång med Log Analytics i Azure-portalen](get-started-portal.md) är en lektion för att skriva frågor och arbeta med resultat i Azure-portalen.
...
- [Visa och analysera data i Log Analytics](../../azure-monitor/log-query/portals.md) förklarar portalerna där du skapar och kör Log Analytics-frågor.
...
- [Standardegenskaper i Log Analytics-poster](../../azure-monitor/platform/log-standard-properties.md) beskriver egenskaper som är standard för alla Log Analytics-data.
- [Utföra mellan resurser loggsökningar i Log Analytics](../../azure-monitor/log-query/cross-workspace-query.md) beskriver hur du skriver frågor som använder data från flera Log Analytics-arbetsytor och Application Insights-program.
