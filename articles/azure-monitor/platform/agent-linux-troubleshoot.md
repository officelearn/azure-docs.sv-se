...
* Det *finns ingen aktuell konfiguration för DSC-loggar. Kör kommandot start-DscConfiguration med parametern-Path för att ange en konfigurations fil och skapa en aktuell konfiguration först.* i `omsconfig.log` loggfil, men inga loggmeddelande finns om `PerformRequiredConfigurationChecks` åtgärder.
