...
ms.locfileid: "79275040"
---
# <a name="connect-windows-computers-to-azure-monitor"></a>Ansluta Windows-datorer till Azure Monitor

För att kunna övervaka och hantera virtuella datorer eller fysiska datorer i ditt lokala datacenter eller annan molnmiljö med Azure Monitor måste du distribuera Log Analytics-agenten (även kallad Microsoft Monitoring Agent (MMA)) och konfigurera den till rapportera till en eller flera Log Analytics-arbetsytor. Agenten stöder också hybridkörningsarbetsrollen för Azure Automation.  
