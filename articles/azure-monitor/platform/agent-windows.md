...
- Granska [hantering och underhåll av Log Analytics agent för Windows och Linux](agent-manage.md) för att lära dig mer om hur du hanterar agenten under distributions livs cykeln på dina datorer.  
