...
Frågor som börjar med `search` eller `union` kan du söka på flera flera kolumner i en tabell eller även flera tabeller. I följande exempel visas flera metoder för att söka termen _minne_:
