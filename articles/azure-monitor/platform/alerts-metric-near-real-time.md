...
|Microsoft.Compute/virtualMachineScaleSets | Ja | Nej |[Skalningsuppsättningar för virtuella datorer](./metrics-supported.md#microsoftcomputevirtualmachinescalesets) |
...
|Microsoft. Network/expressRouteCircuits | Ej tillämpligt | Nej |[ExpressRoute-kretsar](./metrics-supported.md#microsoftnetworkexpressroutecircuits) |
...
<sup>1</sup> stöds endast för plattforms mått (inte anpassade mått)
