...
|Microsoft. DBforPostgreSQL/flexibel | Inga | Inga | [DB för PostgreSQL (flexiable-servrar)](./metrics-supported.md#microsoftdbforpostgresqlflexibleservers)|
