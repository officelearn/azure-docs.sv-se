...
| Svaren | Beskrivning |
| ----- | ----------- |
| Inaktivera `<Action Group Short name>` | Inaktiverar ytterligare SMS från åtgärds gruppen |
| Aktivera `<Action Group Short name>` | Aktiverar SMS från åtgärds gruppen igen |
