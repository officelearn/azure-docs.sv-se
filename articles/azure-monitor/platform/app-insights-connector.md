...
| [SCOM-hanteringsgrupp](../../azure-monitor/platform/om-agents.md) | Inga | Lösningen samlar inte in information från agenter i en ansluten SCOM-hanteringsgrupp. |
| [Azure Storage-konto](collect-azure-metrics-logs.md) | Inga | Lösningen gör inte samlingsinformation från Azure storage. |
