...
| profile | regler | Automatisk skalning skalar automatiskt mellan de högsta och lägsta kapaciteterna, med hjälp av regler i profilen. Du kan ha flera regler i en profil. Det finns vanligtvis två regler: en för att avgöra om att skala ut och den andra sätt att avgöra om att skala i. |
