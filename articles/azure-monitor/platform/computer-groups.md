...
### <a name="windows-server-update-service"></a>Windows Server Update-tjänsten
...
| `GroupSource` |Källan som gruppen samlades in från. <br><br>ActiveDirectory<br>SERVERKONFIGURATION<br>WSUSClientTargeting |
