---
title: Samla in anpassade loggar i Log Analytics | Microsoft Docs
description: Log Analytics kan samla in händelser från textfiler på både Windows och Linux-datorer.  Den här artikeln beskriver hur du definierar en ny anpassad logg och information om de poster som skapas i Log Analytics.
...
När Log Analytics börjar samla in från den anpassade loggen, är dess poster tillgängliga med en loggfråga.  Använd det namn som du gav den anpassade loggen som den **typ** i frågan.
