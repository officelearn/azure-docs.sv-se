...
Följande resurser stöds med Syslog-insamlaren:
...
För andra anläggning [konfigurerar en datakälla för anpassade loggar](data-sources-custom-logs.md) i Azure Monitor.
