...
![Användning och uppskattade kostnader](media/data-usage/usage-estimated-cost-dashboard-01.png)<br>
...
![Visa loggar](media/data-usage/logs.png)<br>
...
Använd de här frågorna sparsamt eftersom sökningar över data data typres är dyrt att köra. Den här frågan ersätter det gamla sättet att läsa detta med datatypen användning. 
