...
| Linux-hybriddator| [Manuell installation](agent-linux.md)|Installera agenten för Linux som anropar ett omslutnings skript som finns på GitHub eller ladda ned och installera agenten manuellt. | 
