...
2. Klicka på **Alla tjänster** på Azure Portal. I listan över resurser skriver du **Log Analytics**. När du börjar skriva filtreras listan baserat på det du skriver. Välj **Log Analytics**.<br><br> ![Azure Portal](media/manage-cost-storage/azure-portal-01.png)<br><br>  
3. Välj din arbetsyta i fönstret Log Analytics-prenumerationer och klicka sedan på **användning och uppskattade kostnader** från det vänstra fönstret.<br><br> ![Användning och uppskattade kostnader](media/manage-cost-storage/usage-estimated-cost-dashboard-01.png)<br>
