...
|IncomingRequests|Inkommande förfrågningar|Antal|Totalt|Inkommande begär Anden för Microsoft. EventHub.|Ingen|
...
|ExportUtilization|Exportanvändning|Procent|Maximal|Exportera användning|Ingen|
...
|CpuUtilization|CPU-användning|Procent|Medel|Aktuell processor användning för Application Gateway|Ingen|
|CapacityUnits|Aktuella kapacitets enheter|Antal|Medel|Förbrukade kapacitets enheter|Ingen|
|FixedBillableCapacityUnits|Fasta fakturerbara kapacitetsenheter|Antal|Medel|Lägsta kapacitets enhet som ska debiteras|Ingen|
...
|TunnelAverageBandwidth|Tunnelbandbredd|BytesPerSecond|Medel|Genomsnittlig bandbredd för en tunnel i byte per sekund|ConnectionName, RemoteIP|
...
|PortBitsInPerSecond|BitsInPerSecond|CountPerSecond|Medel|Inkommande bitar till Azure per sekund|Länk|
|PortBitsOutPerSecond|BitsOutPerSecond|CountPerSecond|Medel|Utgående bitar till Azure per sekund|Länk|
...
|Mått|Mått visnings namn|Enhet|Sammansättningstyp|Beskrivning|Dimensioner|
|---|---|---|---|---|---|
|BitsInPerSecond|BitsInPerSecond|CountPerSecond|Medel|Inkommande bitar till Azure per sekund|PeeringType|
|BitsOutPerSecond|BitsOutPerSecond|CountPerSecond|Medel|Utgående bitar till Azure per sekund|PeeringType|
|GlobalReachBitsInPerSecond|GlobalReachBitsInPerSecond|CountPerSecond|Medel|Inkommande bitar till Azure per sekund|PeeredCircuitSKey|
|GlobalReachBitsOutPerSecond|GlobalReachBitsOutPerSecond|CountPerSecond|Medel|Utgående bitar till Azure per sekund|PeeredCircuitSKey|
...
|Mått|Mått visnings namn|Enhet|Sammansättningstyp|Beskrivning|Dimensioner|
|---|---|---|---|---|---|
|BitsInPerSecond|BitsInPerSecond|CountPerSecond|Medel|Inkommande bitar till Azure per sekund|Ingen|
|BitsOutPerSecond|BitsOutPerSecond|CountPerSecond|Medel|Utgående bitar till Azure per sekund|Ingen|
...
|Mått|Mått visnings namn|Enhet|Sammansättningstyp|Beskrivning|Dimensioner|
|---|---|---|---|---|---|
|ErGatewayConnectionBitsInPerSecond|BitsInPerSecond|CountPerSecond|Medel|Inkommande bitar till Azure per sekund|ConnectionName|
|ErGatewayConnectionBitsOutPerSecond|BitsOutPerSecond|CountPerSecond|Medel|Utgående bitar till Azure per sekund|ConnectionName|
...
|Meddelanden|Antal meddelanden i kö/ämne.|Antal|Medel|Antal meddelanden i kö/ämne.|Entitetsnamnet|
