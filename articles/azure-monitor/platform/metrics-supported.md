...
|TotalLowPriorityNodeCount|Nej|Antal noder med låg prioritet|Antal|Totalt|Totalt antal noder med låg prioritet i batch-kontot|Inga dimensioner|
...
|Average_Uptime|Ja|Drift tid|Antal|Genomsnitt|Average_Uptime|Dator, ObjectName, InstanceName, CounterPath, SourceSystem|
...
|ListenerConnections – lyckad|Nej|ListenerConnections – lyckad|Antal|Totalt|Lyckade ListenerConnections för Microsoft. Relay.|Entitetsnamnet |
...
|SenderConnections – lyckad|Nej|SenderConnections – lyckad|Antal|Totalt|Lyckade SenderConnections för Microsoft. Relay.|Entitetsnamnet |
...
|xtp_storage_percent|Ja|Minnes intern OLTP-lagring i procent|Procent|Genomsnitt|Minnes intern OLTP-lagring i procent. Ej tillämpligt för data lager.|Inga dimensioner|
...
|xtp_storage_percent|Ja|Minnes intern OLTP-lagring i procent|Procent|Genomsnitt|Minnes intern OLTP-lagring i procent|Inga dimensioner|
...
|SQLOnDemandLoginAttempts|Nej|Inloggnings försök|Antal|Totalt|Antal inloggnings försök som distribuerats eller misslyckats|Resultat|
