...
|SuccessfulCalls|Utförda anrop|Antal|Totalt|Antalet utförda anrop.|ApiName, OperationName, Region|
...
|BlockedCalls|Blockerade anrop|Antal|Totalt|Antal anrop som har överskridits hastighet eller kvot.|ApiName, OperationName, Region|
...
|Data av Datadiskködjup|Data Datadiskködjup (förhandsversion)|Count|Medel|Data Datadiskködjup (eller Kölängd)|LUN|
...
|Inkommande flöden|Inkommande flöden (förhandsversion)|Count|Medel|Inkommande flöden är antalet aktuella flöden i den inkommande riktningen (trafik kommer in till den virtuella datorn)|Inga dimensioner|
|Utgående flöden|Utgående flöden (förhandsversion)|Count|Medel|Utgående flöden är antalet aktuella flöden i den utgående riktningen (trafik som går ut från den virtuella datorn)|Inga dimensioner|
...
|Inkommande flöden|Inkommande flöden (förhandsversion)|Antal|Medel|Inkommande flöden är antalet aktuella flöden i den inkommande riktningen (trafik kommer in till den virtuella datorn)|VMName|
|Utgående flöden|Utgående flöden (förhandsversion)|Antal|Medel|Utgående flöden är antalet aktuella flöden i den utgående riktningen (trafik som går ut från den virtuella datorn)|VMName|
...
|EventGridDeliveries|Event Grid-leveranser (förhandsversion)|Antal|Totalt|Antal begäranden för IoT Hub för att generera händelser till Event Grid. Det här värdet innefattar lyckade och misslyckade begäranden. Använd dimensionen resultat för antal annan typ av svar. Se var begäranden som kommer från, använda dimensionen händelsetyp.|Resultatet, händelsetyp|
...
|IncomingRequests|Inkommande begäranden|Antal|Totalt|Inkommande begäranden för Microsoft.EventHub.|EntityName|
...
|ConnectionsClosed|Stängda anslutningar. (Förhandsversion)|Count|Medel|Stängda Microsoft.eventhub-anslutningar. (Förhandsversion)|Inga dimensioner|
...
|beroenden/antal|Beroendeanrop|Count|Antal|Antal anrop gjorda av programmet till externa resurser.|beroendetyp /, beroende/performanceBucket, beroende/lyckades, åtgärden/syntetiska, molnet/Rollinstans, molnet/roleName|
...
|undantag/antal|Undantag|Antal|Count|Kombinerat antal undantagsfel utan felhantering.|molnet/roleName, molnet/Rollinstans, klient/typ|
...
|Mått|Metrisk visningsnamn|Enhet|Sammansättningstyp:|Beskrivning|Dimensioner|
|---|---|---|---|---|---|
|Användning|Användning|Count|Antal|Antal API-anrop|ApiCategory ApiName|
...
|ActionsSucceeded|Lyckade åtgärder |Antal|Totalt|Antalet arbetsflödesåtgärder lyckades.|Inga dimensioner|
...
|ActionThrottledEvents|Begränsade händelser för åtgärder|Antal|Totalt|Antal arbetsflödesåtgärden begränsade händelser...|Inga dimensioner|
...
|RunSuccessLatency|Svarstid för lyckad körning|Sekunder|Medel|Svarstid för lyckade arbetsflödeskörningar körs.|Inga dimensioner|
|RunThrottledEvents|Kör begränsade händelser|Count|Totalt|Antal arbetsflödesåtgärds- eller begränsade händelser.|Inga dimensioner|
|RunStartThrottledEvents|Kör Start begränsade händelser|Antal|Totalt|Antal körningsstart begränsade händelser.|Inga dimensioner|
|RunFailurePercentage|Kör felprocent|Procent|Totalt|Misslyckade arbetsflödeskörningar arbetsflödeskörningar i procent.|Inga dimensioner|
...
|installation.patch|Patch-installationsåtgärder|Antal|Totalt|Patch-installationsåtgärder|Inga dimensioner|
|installation.delete|Ta bort Installation|Antal|Totalt|Ta bort Installation|Inga dimensioner|
|outgoing.allpns.success|Lyckade meddelanden|Antal|Totalt|Totalt antal levererade meddelanden.|Inga dimensioner|
...
|outgoing.apns.pnserror|APNS-fel|Antal|Totalt|Antal push-meddelanden som misslyckades på grund av kommunikationsproblem med APNS.|Inga dimensioner|
...
|outgoing.mpns.authenticationerror|MPNS-autentiseringsfel|Antal|Totalt|Antal push-meddelanden som misslyckades eftersom PNS inte godkände de angivna autentiseringsuppgifterna eller autentiseringsuppgifterna är blockerade.|Inga dimensioner|
...
|ScheduledMessages|Antal schemalagda meddelanden i kö/ämne. (Förhandsversion)|Count|Medel|Antal schemalagda meddelanden i kö/ämne. (Förhandsversion)|EntityName|
...
|deadlock|Låsningar|Antal|Totalt|Låsningar|Inga dimensioner|
...
|app_cpu_billed|App CPU som faktureras|Antal|Totalt|App CPU som faktureras|Inga dimensioner|
...
|FileShareCount|Filresurs|Count|Medel|Antal filresurser i lagringskontots filtjänst.|Inga dimensioner|
|Transaktioner|Transaktioner|Antal|Totalt|Antalet begäranden som görs till en lagringstjänst eller för den angivna API-åtgärden. Det här värdet innefattar lyckade och misslyckade begäranden samt begäranden som genererat fel. Använd måttet responsetype för antalet annan typ av svar.|ResponseType, GeoType, ApiName, autentisering|
|Ingress|Ingress|Byte|Totalt|Mängden ingående data i byte. Det här värdet innefattar inkommande data från en extern klient till Azure Storage samt inkommande data inom Azure.|GeoType, ApiName, Authentication|
|Egress|Egress|Byte|Totalt|Mängden utgående data i byte. Det här värdet innefattar utgående data från en extern klient till Azure Storage samt utgående data inom Azure. Därför motsvarar inte det här värdet fakturerbara utgående data.|GeoType, ApiName, Authentication|
|SuccessServerLatency|Lyckad serversvarstid|Millisekunder|Medel|Genomsnittlig svarstid för Azure Storage för att bearbeta en lyckad förfrågan, i millisekunder. Det här värdet omfattar inte Nätverksfördröjningen som anges i AverageE2ELatency.|GeoType, ApiName, Authentication|
...
|StorageSyncServerHeartbeat|Onlinestatus för Server|Antal|Maximal|Mått som loggar ett värde på 1 varje gång den registrerade servern har registrerar ett pulsslag med Molnslutpunkten|Servernamn|
...
|HttpQueueLength|Http Queue Length|Count|Medel|Http Queue Length|Instans|
...
|LargeAppServicePlanInstances|Arbetare för stora App Service-Plan|Count|Medel|Arbetare för stora App Service-Plan|Inga dimensioner|
