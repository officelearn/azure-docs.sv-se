...
|Average_% ledigt utrymme|Ledigt utrymme i procent|Antal|Medel|Average_% ledigt utrymme|Dator, ObjectName, InstanceName, CounterPath, SourceSystem|
|Average_% använda noder i procent|% Använda noder i procent|Antal|Medel|Average_% använda noder i procent|Dator, ObjectName, InstanceName, CounterPath, SourceSystem|
|Average_% använt utrymme|Använt utrymme i procent|Antal|Medel|Average_% använt utrymme|Dator, ObjectName, InstanceName, CounterPath, SourceSystem|
...
|Average_% använt växlings utrymme|Använt växlings utrymme i procent|Antal|Medel|Average_% använt växlings utrymme|Dator, ObjectName, InstanceName, CounterPath, SourceSystem|
...
|Average_Available megabyte växling|Tillgängliga megabyte växlings utrymme|Antal|Medel|Average_Available megabyte växling|Dator, ObjectName, InstanceName, CounterPath, SourceSystem|
...
|Average_Total byte som skickats|Totalt antal överförda byte|Antal|Medel|Average_Total byte som skickats|Dator, ObjectName, InstanceName, CounterPath, SourceSystem|
|Average_Total byte mottagna|Totalt antal mottagna byte|Antal|Medel|Average_Total byte mottagna|Dator, ObjectName, InstanceName, CounterPath, SourceSystem|
...
|Överförda Average_Total-paket|Totalt antal överförda paket|Antal|Medel|Överförda Average_Total-paket|Dator, ObjectName, InstanceName, CounterPath, SourceSystem|
|Mottagna Average_Total-paket|Totalt antal mottagna paket|Antal|Medel|Mottagna Average_Total-paket|Dator, ObjectName, InstanceName, CounterPath, SourceSystem|
...
|Privilegie rad tid för Average_Pct|PCT privilegie rad tid|Antal|Medel|Privilegie rad tid för Average_Pct|Dator, ObjectName, InstanceName, CounterPath, SourceSystem|
...
|Average_% avbrotts tid|% Avbrotts tid|Antal|Medel|Average_% avbrotts tid|Dator, ObjectName, InstanceName, CounterPath, SourceSystem|
...
|Average_% fin tid|% Trevligt tid|Antal|Medel|Average_% fin tid|Dator, ObjectName, InstanceName, CounterPath, SourceSystem|
|Average_% privilegie rad tid|Privilegie rad tid i procent|Antal|Medel|Average_% privilegie rad tid|Dator, ObjectName, InstanceName, CounterPath, SourceSystem|
...
|Average_Free megabyte|Lediga megabyte|Antal|Medel|Average_Free megabyte|Dator, ObjectName, InstanceName, CounterPath, SourceSystem|
|Average_% ledigt utrymme|Ledigt utrymme i procent|Antal|Medel|Average_% ledigt utrymme|Dator, ObjectName, InstanceName, CounterPath, SourceSystem|
|Average_Available MB|Tillgängliga megabyte|Antal|Medel|Average_Available MB|Dator, ObjectName, InstanceName, CounterPath, SourceSystem|
...
|Mottagna Average_Bytes per sekund|Mottagna byte/SEK|Antal|Medel|Mottagna Average_Bytes per sekund|Dator, ObjectName, InstanceName, CounterPath, SourceSystem|
...
|Average_% processor tid|% Processor tid|Antal|Medel|Average_% processor tid|Dator, ObjectName, InstanceName, CounterPath, SourceSystem|
|Längd på Average_Processor-kön|Kölängd för processor|Antal|Medel|Längd på Average_Processor-kön|Dator, ObjectName, InstanceName, CounterPath, SourceSystem|
