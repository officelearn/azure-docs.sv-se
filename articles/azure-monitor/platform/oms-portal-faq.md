...
![Översiktssidan](media/oms-portal-faq/new-workspace.png)
...
![Översiktssidan](media/oms-portal-faq/overview.png)
...
![Avancerade inställningar](media/oms-portal-faq/advanced-settings.png)
...
| Office 365        | Se den [dokumentation för Office 365 hanteringslösning](../insights/solution-office-365.md) konfigurationsinformation. |
...
| ITSM-anslutningsprogram    | Se [ansluta ITSM-produkter/tjänster med IT Service Management Connector](itsmc-connections.md) anvisningar om hur du ansluter din ITSM-tjänst med Log Analytics. |
...
![Användning och uppskattade kostnader](media/oms-portal-faq/usage.png)
...
- [Hitta och installera lösningar för hantering av](../insights/solutions.md) med Azure portal.
- Lär dig mer om [Loggsökning i Azure-portalen](../log-query/portals.md).
