...
Följande exempel skript skapar en arbets yta och konfigurerar flera data källor. Dessa data källor krävs endast om du övervakar virtuella datorer med hjälp av [Log Analytics agenten](log-analytics-agent.md).
