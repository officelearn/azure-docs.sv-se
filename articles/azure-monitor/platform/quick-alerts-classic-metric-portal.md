...
Mer information om mått och måttaviseringar finns i [Översikt över mått i Azure Monitor](data-platform.md) och [Översikt över aviseringar i Azure Monitor](alerts-overview.md). 
