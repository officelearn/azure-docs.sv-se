...
* [Läs översikten över Azures aktivitets logg](./platform-logs-overview.md)
* [Konfigurera en avisering baserat på en aktivitets logg händelse](./alerts-log-webhook.md)
