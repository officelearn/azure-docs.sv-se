...
| Upprepa | Beskrivning |
|:--- |:--- |
| [Tal](#number-tile) |Totalt antal poster från en fråga. |
| [Två tal](#two-numbers-tile) |Antalet poster från två olika frågor. |
| [Toroid](#donut-tile) | Ett diagram som baseras på en fråga med ett summary-värde i mitten. |
