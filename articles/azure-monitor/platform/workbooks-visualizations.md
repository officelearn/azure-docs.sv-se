...
| `Query` | Alla KQL-frågor som returnerar data i det format som förväntas av diagrammets visualisering | _begär Anden \| make-seriens begär Anden = Count () standard = 0 på tidsstämpeln från sedan (1d) till Now () steg 1H_ |
...
| `Color palette` | Den färgpalett som ska användas i diagrammet. Ignoreras om parametern `Split by` används | Blått, grönt, rött osv. |
...
8. I **panel fält**ställer du in:
    * Rubrik: `name`
    * Left: `Requests`, renderare: `Big Number`, färgpalett: `Green to Red`, min värde: `0`
    * Nederkant: `appName`
