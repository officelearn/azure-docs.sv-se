---
title: Lista över inbyggda princip definitioner för Azure Monitor
description: Visar Azure Policy inbyggda princip definitioner för Azure Monitor. De här inbyggda programmen ger vanliga metoder för att hantera dina Azure-resurser.
ms.date: 04/30/2020
ms.topic: sample
author: bwren
ms.author: bwren
