...
## <a name="metric-measurement-template-up-to-version-2018-04-16"></a>Mall för mått mått (upp till version 2018-04-16)
I följande exempel skapas en [varnings regel för mått mått](../platform/alerts-unified-log.md#calculation-of-measure-based-on-a-numeric-column-such-as-cpu-counter-value).
...
## <a name="template-for-all-resource-types-from-version-2020-05-01-preview"></a>Mall för alla resurs typer (från version 2020-05-01-för hands version)
Följande exempel skapar en regel som kan riktas mot alla resurser.
