...
Den här artikeln innehåller exempel på hur du använder [Azure Resource Manager mallar](../../azure-resource-manager/templates/template-syntax.md) för att konfigurera [mått varnings regler](../platform/alerts-metric-near-real-time.md) i Azure Monitor. Varje exempel innehåller en mallfil och en parameter fil med exempel värden som du kan använda för mallen.
