---
title: Exempel på Resource Manager-mallar för Application Insights resurser
...
Den här artikeln innehåller exempel [Azure Resource Manager mallar](../../azure-resource-manager/templates/template-syntax.md) för att distribuera och konfigurera [klassiska Application Insights resurser](../app/create-new-resource.md) och den nya för [hands versionen av arbets ytans baserade Application Insights resurser](../app/create-workspace-resource.md). Varje exempel innehåller en mallfil och en parameter fil med exempel värden som du kan använda för mallen.
...
* [Läs mer om arbets ytans baserade Application Insights-resurser](../app/create-workspace-resource.md).
