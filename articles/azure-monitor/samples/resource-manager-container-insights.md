...
## <a name="enable-for-new-azure-red-hat-openshift-v3-cluster"></a>Aktivera för nya Azure Red Hat OpenShift v3-kluster
...
## <a name="enable-for-existing-azure-red-hat-openshift-v3-cluster"></a>Aktivera för befintliga Azure Red Hat OpenShift v3-kluster
