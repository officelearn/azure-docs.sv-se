...
Om du vill skapa en diagnostisk inställning lägger du till en resurs av typen <resource namespace> /providers/diagnosticSettings i mallen. Den här artikeln innehåller exempel för två olika resurs typer, men samma mönster kan användas för andra resurs typer. Samlingen av tillåtna loggar och mått varierar beroende på varje resurs typ.

[!INCLUDE [azure-monitor-samples](../../../includes/azure-monitor-resource-manager-samples.md)]


## <a name="diagnostic-setting-for-azure-key-vault"></a>Diagnostisk inställning för Azure Key Vault 
I följande exempel läggs två logg frågor till i ett Azure Key Vault.
...
Följande exempel lägger till två logg frågor till en Azure SQL-databas.
### <a name="template-file"></a>Mallfil
