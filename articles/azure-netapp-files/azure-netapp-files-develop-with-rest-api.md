...
description: REST API för Azure NetApp Files-tjänsten definierar HTTP-åtgärder för resurser, till exempel NetApp-konto, kapacitets uppsättning, volymer och ögonblicks bilder.
