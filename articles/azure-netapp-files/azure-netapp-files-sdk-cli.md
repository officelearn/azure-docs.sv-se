---
title: 'Azure NetApp filer SDK: er | Microsoft Docs'
description: 'Visar en lista över de SDK: er som stöds av Azure NetApp-filer.'
...
ms.locfileid: "65957887"
---
# <a name="azure-netapp-files-sdks"></a>SDK:er för Azure NetApp Files

Den här artikeln innehåller SDK: er som stöds av Azure NetApp-filer.

## <a name="supported-sdks"></a>Stödda SDK: erna 

I tabellen nedan visas de stödda SDK: erna.  Du hittar information om de stödda SDK: erna på sina publicerade platser i GitHub.  

|    Språk    |    SDK publicerade plats    |
|------------------|--------------------------------------------------------------------------------------------|
