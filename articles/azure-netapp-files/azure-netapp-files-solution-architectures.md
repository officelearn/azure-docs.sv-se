...
## <a name="azure-high-performance-computing-hpc-solutions"></a>Azures lösningar för data behandling med höga prestanda (HPC)
...
## <a name="azure-kubernetes-service-aks-solutions"></a>Lösningar för Azure Kubernetes service (AKS)

* [Azure NetApp Files integrering med AKS](https://github.com/andyzhangx/demo/tree/master/linux/nfs)
...
* [SAP HANA skala ut med noden vänte läge på virtuella Azure-datorer med Azure NetApp Files på RedHat Enterprise Linux](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/sap-hana-scale-out-standby-netapp-files-rhel)
...
## <a name="global-file-caching-solutions"></a>Globala lösningar för fil lagring

* [Globalt distribuerad företags fil delning med Azure NetApp Files och Talon snabb™](https://www.talonstorage.com/products/azure-netapp-files)
