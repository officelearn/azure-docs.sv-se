...
ms.locfileid: "34602619"
---
# <a name="azure-policy-samples"></a>Azure Policy-exempel

Följande tabell innehåller länkar till JSON-exempel för Azure Policy. De här exemplen finns även i [lagringsplatsen för Azure Policy-exempel](https://github.com/Azure/azure-policy).
