---
title: Json-exempel i Azure Policy – Endast tillåta en viss VM-plattformsavbildning  | Microsoft Docs
description: Den här json-exempelprincipen kräver att virtuella datorer använder en specifik version av UbuntuServer.
