---
title: "Azure princip json-exemplet - flera namn mönster | Microsoft Docs"
description: "Den här principen för json-exemplet kräver som resursen matchar ett av de angivna namn mönster."
...
---
# <a name="allow-multiple-name-patterns"></a>Tillåt flera namn mönster

Tillåt en av många namn mönster som ska användas för resurser. Ange de tillåtna mönster i principregeln.
