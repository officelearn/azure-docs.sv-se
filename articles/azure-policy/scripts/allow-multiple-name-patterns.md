---
title: Json-exempel i Azure Policy – flera namnmönster  | Microsoft Docs
description: Den här json-exempelprincipen kräver att resursen matchar något av de angivna namnmönstren.
