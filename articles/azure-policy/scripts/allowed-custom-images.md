...
description: Den här principen kräver att endast godkända anpassade avbildningar distribueras i din miljö.
...
- Granska ytterligare [Azure Policy-exempel](../json-samples.md)
- Granska [Azure Policy-definitionsstruktur](../policy-definition.md)
- Azure Policy-exempel för virtuella datorer finns på [Apply policies to Windows VMs](../../virtual-machines/windows/policy.md) (Tillämpa principer för virtuella Windows-datorer)