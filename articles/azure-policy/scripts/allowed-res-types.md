---
title: Json-exempel i Azure Policy – Tillåtna resurstyper | Microsoft Docs
description: Den här json-exempelprincipen garanterar att bara godkända resurstyper distribueras.
