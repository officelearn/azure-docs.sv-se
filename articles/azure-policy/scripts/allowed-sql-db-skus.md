---
title: "Azure princip json-exemplet - tillåtna SQL DB SKU: er | Microsoft Docs"
description: "Den här principen för json-exemplet kräver SQL-databaser för att använda en godkänd SKU."
...
---
# <a name="allowed-sql-db-skus"></a>Tillåtna SQL DB SKU: er

Den här principen kräver att SQL-databaser för att använda en godkänd SKU. Du anger en matris med tillåtna SKU-ID: N eller en matris med tillåtna SKU namn.
