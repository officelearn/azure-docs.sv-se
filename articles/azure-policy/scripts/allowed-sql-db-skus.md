---
title: Json-exempel i Azure Policy – Tillåtna SKU:er för SQL DB | Microsoft Docs
description: Den här json-exempelprincipen kräver att SQL-databaser använder en godkänd SKU.
