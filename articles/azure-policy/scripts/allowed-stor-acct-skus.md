---
title: "Azure princip json-exemplet - tillåtna lagringskonto SKU: er | Microsoft Docs"
description: "Den här principen för json-exemplet kräver att storage-konton använder en godkänd SKU."
...
---
# <a name="allowed-storage-account-skus"></a>Tillåtna lagringskonto SKU: er

Den här principen kräver att storage-konton använder en godkänd SKU. Du anger en matris med godkända SKU: er.
