---
title: Json-exempel i Azure Policy – Tillåtna SKU:er för virtuell nätverksgateway | Microsoft Docs
description: Den här json-exempelprincipen kräver att virtuella nätverksgatewayer använder en godkänd SKU och gatewaytyp.
