---
title: "Azure princip json-exemplet - Audit DB nivå hotidentifiering inställning | Microsoft Docs"
...
---
# <a name="audit-db-level-threat-detection-setting"></a>Granska DB nivån threat detection inställningen
