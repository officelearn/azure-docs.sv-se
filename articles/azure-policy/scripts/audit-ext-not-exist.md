---
title: "Azure princip json-exemplet - Audit om tillägg inte finns | Microsoft Docs"
description: "Den här principen för json-exemplet granskningar om filnamnstillägget inte har distribuerats till en virtuell dator."
...
---
# <a name="audit-if-extension-does-not-exist"></a>Granska om tillägg inte finns

Den här principen granskningar om filnamnstillägget inte har distribuerats till en virtuell dator. Anger du tillägg utgivaren och typ för att kontrollera om den har distribuerats.
