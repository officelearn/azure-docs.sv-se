---
title: Json-exempel i Azure Policy – Granska om ej tillgängligt tillägg  | Microsoft Docs
description: Den här json-exempelprincipen granskar om ett tillägg inte distribueras med en virtuell dator.
