---
title: "Azure princip-json exempel – gransknings-och inga Azure AD admin | Microsoft Docs"
description: "Den här principen för json-exemplet granskningar när det finns inga Azure Active Directory-administratören som tilldelats till SQLServer."
...
---
# <a name="audit-no-azure-active-directory-administrator"></a>Granska ingen Azure Active Directory-administratör

Granska när det finns inga Azure Active Directory-administratören som tilldelats till SQLServer.
