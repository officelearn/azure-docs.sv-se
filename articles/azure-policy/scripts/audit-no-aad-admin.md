---
title: Json-exempel i Azure Policy – Granska när det saknas Azure AD-administratör | Microsoft Docs
description: Den här json-exempelprincipen granskar när det inte finns någon Azure Active Directory-administratör som tilldelats till SQL-servern.
...
ms.locfileid: "34601062"
---
# <a name="audit-no-azure-active-directory-administrator"></a>Granska när det saknas Azure AD-administratör

Granska när det inte finns någon Azure Active Directory-administratör som tilldelats till SQL-servern.
