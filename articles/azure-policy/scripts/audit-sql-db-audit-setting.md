---
title: "Exempel för Azure princip-json - Granskningsnivå SQL DB granskning | Microsoft Docs"
description: "Den här principen för json-exemplet granskningar granskningsinställningar för SQL-databasen om dessa inställningar inte matchar en angiven nivå."
...
---
# <a name="audit-sql-db-level-audit-setting"></a>Granskning SQL DB nivån granskning

Den här principen granskningar SQL granskningsinställningar för databasen om dessa inställningar inte matchar en angiven nivå. Du kan ange ett värde som anger om granskningsinställningarna ska aktiveras eller inaktiveras.
