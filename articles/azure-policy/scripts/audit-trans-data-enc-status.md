---
title: Azure princip json-exemplet - Audit transparent data krypteringsstatus | Microsoft Docs
description: "Den här principen för json-exemplet granskningar transparent datakryptering för SQL-databasen om den inte är aktiverad."
...
---
# <a name="audit-transparent-data-encryption-status"></a>Granska transparent data krypteringsstatus

Den här principen granskningar transparent datakryptering för SQL-databasen om den inte är aktiverad.
