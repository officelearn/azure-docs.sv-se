---
title: "Azure princip-json exempel – framtvinga taggen matchningsmönster | Microsoft Docs"
description: "Den här principen för json-exemplet kräver att resurser uppfyller matchningsmönster för taggvärde."
...
---
# <a name="enforce-tag-match-pattern-for-tag-values"></a>Framtvinga taggen matchningsmönster för taggvärden

Kräv att ett Taggvärde uppfyller ett matchningsmönster. Ange tillåtna mönster i principregeln.
