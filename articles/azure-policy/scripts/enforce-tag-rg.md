---
title: Json-exempel i Azure Policy – Framtvinga tagg och dess värde i resursgrupper | Microsoft Docs
description: Den här json-exempelprincipen kräver en tagg och ett värde i en resursgrupp.
