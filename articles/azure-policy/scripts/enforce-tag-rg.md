---
title: "Azure princip-json exempel – framtvinga taggen och dess värde på resursgrupper | Microsoft Docs"
description: "Den här principen för json-exemplet kräver en tagg och värde i en resursgrupp."
...
---
# <a name="enforce-tag-and-its-value-on-resource-groups"></a>Framtvinga taggen och dess värde på resursgrupper

Den här principen kräver en tagg och värdet på en resursgrupp. Du kan ange den obligatoriska taggnamn och värde.
