---
title: Json-exempel i Azure Policy – Framtvinga tagg och dess värde | Microsoft Docs
description: Den här json-exempelprincipen kräver ett angivet taggnamn och värde.
