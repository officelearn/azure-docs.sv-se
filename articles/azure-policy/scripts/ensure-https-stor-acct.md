---
title: "Azure princip-json exempel – se till att https-trafik endast för storage-konto | Microsoft Docs"
description: "Den här principen för json-exemplet kräver storage-konton för att använda HTTPS-trafik."
...
---
# <a name="ensure-https-traffic-only-for-storage-account"></a>Se till att https-trafik endast för storage-konto

Den här principen kräver storage-konton för att använda HTTPS-trafik.
