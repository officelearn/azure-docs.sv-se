---
title: "Azure princip-json exempel – se till att filen lagringskryptering | Microsoft Docs"
description: "Den här principen för json-exemplet kräver att filen kryptering har aktiverats för storage-konton."
...
---
# <a name="ensure-storage-file-encryption"></a>Se till att filen lagringskryptering

Den här principen kräver att filen kryptering har aktiverats för storage-konton.
