---
title: Json-exempel i Azure Policy – Garantera kryptering för lagringsfil | Microsoft Docs
description: Den här json-exempelprincipen kräver att filkryptering är aktiverat för lagringskonton.
