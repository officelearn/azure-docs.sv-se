---
title: "Azure princip json-exemplet - inget nätverk peering till ER nätverk | Microsoft Docs"
description: "Den här principen för json-exempel förhindrar att ett nätverk som peering från som hör till ett nätverk i en viss resursgrupp."
...
---
# <a name="no-network-peering-to-er-network"></a>Inget nätverk peering till ER nätverk

Den här principen förhindrar att ett nätverk som peering från som hör till ett nätverk i en viss resursgrupp. Använd för att förhindra anslutning med centralt hanterade nätverksinfrastruktur. Du kan ange namnet på resursgruppen att förhindra att kopplingen.
