---
title: Json-exempel i Azure Policy – Ingen nätverkspeering till ER-nätverk | Microsoft Docs
description: Det här json-principexemplet förbjuder att en nätverkspeering associeras till ett nätverk i en angiven resursgrupp.
...
ms.locfileid: "34602541"
---
# <a name="no-network-peering-to-er-network"></a>Ingen nätverkspeering till ER-nätverk
