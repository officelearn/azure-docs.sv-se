---
title: Json-exempel i Azure Policy – Otillåtna VM-tillägg | Microsoft Docs
description: Den här json-exempelprincipen förbjuder användning av angivna tillägg.
...
ms.locfileid: "34602092"
---
# <a name="not-allowed-vm-extensions"></a>Otillåtna VM-tillägg
