---
title: Json-exempel i Azure Policy – NSG x på varje NIC | Microsoft Docs
description: Den här json-exempelprincipen kräver att en viss nätverkssäkerhetsgrupp används med varje gränssnitt för virtuellt nätverk.
