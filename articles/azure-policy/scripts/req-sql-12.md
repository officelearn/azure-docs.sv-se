---
title: Json-exempel i Azure Policy – Kräver SQL Server version 12.0 | Microsoft Docs
description: Den här json-exempelprincipen kräver att SQL-servrar använder version 12.0.
