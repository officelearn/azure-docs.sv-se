---
title: Json-exempel i Azure Policy – Skapa VM med hanterad disk | Microsoft Docs
description: Den här json-exempelprincipen kräver att virtuella datorer använder hanterade diskar.
...
---
# <a name="create-vm-using-managed-disk"></a>Skapa VM med hanterad disk
