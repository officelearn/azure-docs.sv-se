        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Läs mer om Azure Resource Manager</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Videobibliotek för Azure Resource Manager</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Kom igång med Azure Resource Manager</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Kom igång med att skapa beroenden i Azure Resource Manager-mallar</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Kom igång med flera resursinstanser i Azure Resource Manager</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/azure/templates/">Mallformat</a></p>
                        <p><a href="/azure/resource-group-template-functions">Mallfunktioner</a></p>
                        <p><a href="/azure/azure-resource-manager/managed-application-createuidefinition-functions">Funktioner för användargränssnittsdefinition</a></p>
                        <p><a href="/azure/azure-resource-manager/managed-application-createuidefinition-elements">Definitionselement för användargränssnitt</a></p>
                    </div>
                </div>
            </div>
        </div>
