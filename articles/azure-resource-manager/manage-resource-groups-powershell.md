---
title: Hantera Azure Resource Manager grupper med Azure PowerShell | Microsoft Docs
description: Använd Azure PowerShell för att hantera Azure Resource Manager grupper.
