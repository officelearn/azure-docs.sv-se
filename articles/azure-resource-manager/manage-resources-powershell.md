...
Lär dig hur du använder Azure PowerShell med [Azure Resource Manager](resource-group-overview.md) för att hantera dina Azure-resurser. Information om hur du hanterar resurs grupper finns i [Hantera Azure-resurs grupper med hjälp av Azure PowerShell](./manage-resource-groups-powershell.md).
...
Taggning hjälper till att organisera resurs gruppen och resurserna logiskt. Mer information finns i [använda taggar för att ordna dina Azure-resurser](./resource-group-using-tags.md#powershell).
