...
Om du vill gå igenom en självstudiekurs, se [självstudien: Flytta Azure-resurser till en annan resursgrupp eller prenumeration](./resource-manager-tutorial-move-resources.md). 
