...
I det här dokumentet beskrivs de grundläggande begreppen i **createUiDefinition.jspå** filen som Azure Portal använder för att definiera användar gränssnittet när du skapar ett hanterat program.
