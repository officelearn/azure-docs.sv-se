...
Om du vill skicka en hemlighet från en Key Vault till en mall i det hanterade programmet måste du använda en [länkad mall](../templates/linked-templates.md) och referera till Key Vault i parametrarna för den länkade mallen. Ange resurs-ID för Key Vault och namnet på hemligheten.
