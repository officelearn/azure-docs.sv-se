...
> [!NOTE]
> Tidigare var dokumentationen för Azure-kundleverantörer inkluderad i dokumentationen för hanterade program. Den dokumentationen har flyttats. Nu kan du se [Azure-anpassade providers](../custom-providers/overview.md).
