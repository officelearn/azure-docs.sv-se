...
ms.locfileid: "84234678"
---
# <a name="azure-policy-built-in-policy-definitions-for-azure-managed-applications"></a>Azure Policy inbyggda princip definitioner för Azure Managed Applications

Den här sidan är ett index över [Azure policy](../../governance/policy/overview.md) inbyggda princip definitioner för Azure Managed Applications. Ytterligare Azure Policy inbyggda program för andra tjänster finns i [Azure policy inbyggda definitioner](../../governance/policy/samples/built-in-policies.md).
