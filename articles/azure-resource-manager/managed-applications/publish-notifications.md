...
Aviserings tjänsten för hanterade program förväntar sig ett `200 OK` svar från webhook-slutpunkten till meddelandet. Meddelande tjänsten kommer att försöka igen om webhook-slutpunkten returnerar en HTTP-felkod som är större än eller lika med 500, om den returnerar felkoden 429 eller om slut punkten är tillfälligt otillgänglig. Om webhook-slutpunkten inte blir tillgänglig inom 10 timmar tas aviserings meddelandet bort och Återförsöken stoppas.
