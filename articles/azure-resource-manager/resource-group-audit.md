...
1. På Azure Portal-menyn väljer du **övervaka**eller Sök efter och välj **övervakare** från valfri sida.
    ...
    ![Välj övervakare](./media/resource-group-audit/select-monitor-from-menu.png)
...
1. Filtret är tillgängligt på instrument panelen. På Azure Portal-menyn väljer du **instrument panel**.

    ![Visa filter på instrument panelen](./media/resource-group-audit/activity-log-on-dashboard.png)
