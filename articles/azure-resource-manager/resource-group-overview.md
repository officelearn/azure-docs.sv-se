...
> [!NOTE]
> Om ett SDK inte tillhandahåller de funktioner som du behöver kan du även anropa [Azure REST-API](https://msdn.microsoft.com/library/azure/dn790568.aspx) direkt.
> 
> 
