...
Båda användningarna beskrivs mer ingående i den här artikeln. En själv studie kurs finns i [Självstudier: skapa flera resurs instanser med Resource Manager-mallar](template-tutorial-create-multiple-instances.md).
...
Om du vill skapa fler än en instans av en resurs i en distribution lägger du till ett `copy`-element i resurs typen. I elementet kopiera anger du antalet iterationer och ett namn för den här slingan.
