...
- Om du vill hämta resurs-ID för en tilläggs resurs i en Azure Resource Manager mall använder du [extensionResourceId](template-functions-resource.md#extensionresourceid).
