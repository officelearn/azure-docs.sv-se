...
![Referens för Resource Manager-mall distribuera krypterat lagrings konto](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-tutorial-deploy-encrypted-storage-account.png)
...
1. Från VS Code döljer du mallen till rotnivån. Du får den enklaste strukturen med följande element:
    ...
    ![Enklaste struktur för Resource Manager-mall](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-simplest-structure.png)
...
2. Expandera **resurser**. Det finns en `Microsoft.Storage/storageAccounts`-resurs som definierats. Mallen skapar ett okrypterat lagringskonto.
    ...
    ![Definition av lagringskonto för Resource Manager-mall](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-encrypted-storage-resource.png)
...
3. Välj **referens/mall referens/lagring/&lt;Version >/Storage-konton** som visas på följande skärm bild:
    ...
    ![Resource Manager, mallreferens, lagringskonto](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-resources-reference-storage-accounts.png)
...
4. Hitta den krypteringsrelaterade definitionsinformationen.
    ...
    ![Kryptering av lagringskonto för Resource Manager-mallreferens](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-resources-reference-storage-accounts-encryption.png)
    ...
    ![Krypteringsobjekt för lagringskonto för Resource Manager-mallreferens](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-resources-reference-storage-accounts-encryption-object.png)
...
![Krypterade lagringskontoresurser för Resource Manager-mall](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-encrypted-storage-resources.png)
...
![Krypterat lagringskonto för Azure Resource Manager](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-encrypted-storage-account.png)
