...
Du kan gå till definitionen med **CTRL + klicka**eller genom att använda snabb menyn som visas i skärm bilden: ![Visual Studio Code Resource Manager Tools-tillägg gå till definition](./media/use-vs-code-to-create-template/resource-manager-tools-extension-context-menu.png)
