...
ms.locfileid: "67187712"
---
## <a name="clone-the-sample-application"></a>Klona exempelprogrammet

Medan tjänsten distribueras tar vi och arbetar med koden. Klona [exempelappen från GitHub](https://github.com/Azure-Samples/signalr-service-quickstart-serverless-chat), ange SignalR Service-anslutningssträngen och kör programmet lokalt.
