...
1. Ange följande inställningar.
    ...
    | **prisnivå** | Kostnadsfritt | Prova Azure SignalR Service kostnadsfritt. |
    | **Antal enheter** |  Saknas | Antal enheter anger hur många anslutningar som SignalR Service-instansen kan acceptera. Det kan bara konfigureras på Standard-nivån. |
