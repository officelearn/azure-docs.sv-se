...
Azure SQL Edge stöder för närvarande endast följande Stream-indata och utdata.

**Stream-indata**: Detta definierar anslutningarna till en data källa för att läsa data strömmen från
- Edge Hub
- Kafka (stöd för Kafka-indata är för närvarande bara tillgängligt i Intel/AMD64-versioner av Azure SQL Edge.)

**Strömma utdata**: Detta definierar de anslutningar till en data källa som data strömmen ska skrivas till. 
- Edge Hub
