---
title: 'Självstudie: Distribuera en kluster modell i R'
...
Anta att du vill skicka ett kampanj-e-postmeddelande till kunder i kluster 3, gruppen som har fler aktiva retur beteenden (du kan se hur de fyra klustren beskrevs i [del två](clustering-model-build-tutorial.md#analyze-the-results)). Följande kod markerar e-postadresserna för kunder i kluster 3.
...
När du är klar med den här självstudien kan du ta bort tpcxbb_1gb-databasen från servern.
...
* [Självstudie: förbereda data för att träna en förutsägelse modell i R med Azure SQL Database Machine Learning Services (förhands granskning)](predictive-model-prepare-data-tutorial.md)
