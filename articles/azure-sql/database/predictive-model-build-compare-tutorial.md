...
![Jämföra de två modellerna](./media/predictive-model-build-compare-tutorial/compare-models.png)
...
> [Självstudie: Distribuera en förutsägelse modell i R med Azure SQL Database Machine Learning Services (förhands granskning)](predictive-model-deploy-tutorial.md)
