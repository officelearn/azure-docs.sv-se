...
description: Azure SQL Database ger möjlighet att belastningsutjämna skrivskyddade arbets belastningar med hjälp av kapaciteten hos skrivskyddade repliker, som kallas för Läs-och utskalning.
...
> [!NOTE]
> Vid en specifik tidpunkt är det bara en av AlwaysON-replikerna som kan nås av de skrivskyddade sessionerna.

## <a name="monitor-and-troubleshoot-a-read-only-replica"></a>Övervaka och felsöka en skrivskyddad replik
...
Du kan inaktivera och återaktivera Läs utskalning på enkla databaser och Elastic pool-databaser i Premium-eller Affärskritisk tjänst nivån med hjälp av följande metoder.
