...
* Wingtip SaaS-appen har distribuerats. Information om hur du distribuerar på mindre än fem minuter finns i [distribuera och utforska Wingtip SaaS-programmet](../../sql-database/saas-dbpertenant-get-started-deploy.md).
...
1. Öppna Events Hub ( http://events.wtp.&lt ; User &gt; . trafficmanager.net) och välj **contoso konsert Hall**.
