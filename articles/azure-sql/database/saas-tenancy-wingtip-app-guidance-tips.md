...
- [Distribuera Wingtip Ticket SaaS fristående program](../../sql-database/saas-standaloneapp-get-started-deploy.md)
- [Distribuera Wingtip-biljetterna SaaS-databas per klient program](../../sql-database/saas-dbpertenant-get-started-deploy.md)
- [Distribuera Wingtip Ticket SaaS-program för flera klient databaser](../../sql-database/saas-multitenantdb-get-started-deploy.md)
