---
title: 'PowerShell: kopiera en databas till en ny server'
description: Azure PowerShell exempel skript för att kopiera en databas till en ny server
