...
ms.locfileid: "84049927"
---
# <a name="business-critical-tier---azure-sql-database--sql-managed-instance"></a>Affärskritisk nivå – Azure SQL Database & SQL-hanterad instans 
...
-   **Krav för låg IO-latens** – arbets belastningar som behöver ett snabbt svar från lagrings skiktet (1-2 millisekunder i genomsnitt) bör använda affärskritisk nivån. 
