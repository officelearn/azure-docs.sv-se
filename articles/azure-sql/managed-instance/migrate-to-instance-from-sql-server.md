...
Du kan välja beräknings-och lagrings resurser vid distributions tiden och sedan ändra det efteråt utan att använda [Azure Portal](../database/scale-resources.md):
