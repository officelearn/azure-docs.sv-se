...
Innan du börjar läsa den här artikeln bör du ha kunskap om de grundläggande begreppen i SQL Server och Azure. Mer information finns i [SQL Server Books Online](https://msdn.microsoft.com/library/bb545450.aspx) [SQL Server på Azure Virtual Machines](sql-server-on-azure-vm-iaas-what-is-overview.md) och [Azure.com](https://azure.microsoft.com/).
