...
För att få bästa möjliga prestanda från SQL Server som körs på en virtuell Azure-dator kan du läsa mer i avsnittet [prestanda metod tips för SQL Server i Azure Virtual Machines](performance-guidelines-best-practices.md).
