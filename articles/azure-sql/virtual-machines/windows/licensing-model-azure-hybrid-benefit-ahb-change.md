...
- Själv installera SQL Server på en virtuell Azure-dator, [registrera manuellt med den virtuella SQL VM-providern](sql-vm-resource-provider-register.md)och aktivera Azure Hybrid-förmån.
