...
5. Granska sammanfattningen målplatsen den **redo att extrahera** i Self-Extractor guiden, och klicka sedan på **extrahera** att extrahera CloudBuilder.vhdx (cirka 28 GB) och ThirdPartyLicenses.rtf filer. Den här processen tar lite tid att slutföra.
