...
<!-- TBD - IS ASDK --> 
- Använd inte de nya administrativa prenumeration typerna av *Avläsning av prenumeration*, och *förbrukning prenumeration*. Dessa nya prenumerationstyper introducerades med version 1804 men ännu inte är redo att användas. Du bör fortsätta att använda den *Standard Provider* prenumerationstyp.
...
<!-- TBD - IS. ASDK --> 
- När du kör cmdleten Test-AzureStack på behörighet slutpunkt (program) kan felmeddelande ett Varna för ERCS VM. Du kan fortsätta att använda ASDK. 
