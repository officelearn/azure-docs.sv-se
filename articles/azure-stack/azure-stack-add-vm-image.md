...
3. Öppna PowerShell med en förhöjd behörighet och kör:
  ...
  - **OSUri**  
    ...
    Mer information om cmdlet Add-AzsPlatformimage finns i Microsoft-PowerShell [Azure Stack operatorn dokumentation](https://docs.microsoft.com/powershell/module/).
