...
Användare kan nu använda distribution källor för saker som [kontinuerlig distribution](https://docs.microsoft.com/en-us/azure/app-service-web/app-service-continuous-deployment), [lokal Git-distribution](https://docs.microsoft.com/en-us/azure/app-service-web/app-service-deploy-local-git), och [molnet mappsynkronisering](https://docs.microsoft.com/en-us/azure/app-service-web/app-service-deploy-content-sync).
