...
ms.locfileid: "56160773"
---
# <a name="create-mysql-databases"></a>Skapa MySQL-databaser
En Azure Stack-användare som prenumererar på ett erbjudande som innehåller MySQL-databastjänst kan skapa och hantera självbetjäning MySQL-databaser i användarportalen.
