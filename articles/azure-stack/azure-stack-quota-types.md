...
| --- | --- | --- |
| Maximal kapacitet (GB) |2048 |Total lagringskapacitet (inklusive BLOB-objekt och alla associerade ögonblicksbilder, tabeller, köer) som kan användas av en prenumeration på den här platsen. |
