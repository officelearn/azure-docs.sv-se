...
- **Fast** – när du skapar en virtuell dator meddelandet *det gick inte att visa priserna* visas inte längre när du väljer en storlek för VM-storlek.
...
*Det finns inga kända problem med installationen av uppdateringen 1803.*
