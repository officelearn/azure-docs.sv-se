...
ms.locfileid: "55095570"
---
# <a name="validate-azure-stack-pki-certificates"></a>Verifiera Azure Stack PKI-certifikat

Verktyget Azure Stack-beredskap för installation som beskrivs i den här artikeln är tillgänglig [från PowerShell-galleriet](https://aka.ms/AzsReadinessChecker). Du kan använda verktyget för att kontrollera att den [genereras PKI-certifikat](azure-stack-get-pki-certs.md) är lämpliga för distributionen. Verifiera certifikat genom att lämna tillräckligt med tid för att testa och återutfärda certifikat om det behövs.

Beredskap för installation utförs följande verifieringar för certifikat:

- **Läsa PFX**  
    Söker efter giltiga PFX-fil, rätt lösenord, och om informationen om offentliga inte skyddas av lösenordet. 
- **Signaturalgoritm**  
...
**Upplösning**: Följer du anvisningarna i verktyget i informationsavsnittet under varje uppsättning med tester för varje certifikat.
