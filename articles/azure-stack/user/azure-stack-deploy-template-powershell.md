...
1. Bläddra i [AzureStackGitHub repo](https://aka.ms/AzureStackGitHub) och hitta den **101-enkel-windows-vm** mall. Spara mallen i den här platsen: `C:\templates\azuredeploy-101-simple-windows-vm.json`.
