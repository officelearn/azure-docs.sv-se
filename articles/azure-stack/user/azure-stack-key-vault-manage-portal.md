...
2. Från instrumentpanelen väljer **+ skapa en resurs**, sedan **säkerhet + identitet**, sedan **Key Vault**.
    ...
    ![Key Vault-skärmen](media/azure-stack-key-vault-manage-portal/image1.png)
...
![URI-nyckel](media/azure-stack-key-vault-manage-portal/image4.png)
...
![URI-hemlighet](media/azure-stack-key-vault-manage-portal/image5.png)

## <a name="next-steps"></a>Nästa steg

* [Distribuera en virtuell dator genom att hämta lösenord som lagras i Key Vault](azure-stack-key-vault-deploy-vm-with-secret.md)
* [Distribuera en virtuell dator med certifikat som lagras i Key Vault](azure-stack-key-vault-push-secret-into-vm.md)
