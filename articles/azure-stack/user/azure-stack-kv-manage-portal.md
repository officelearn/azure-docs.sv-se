...
8. Dessutom kan du välja en **avancerade åtkomstprincip** att aktivera åtkomst till funktionerna. Till exempel: virtuella datorer (VM) för distribution, Resource Manager för för malldistribution och åtkomst till Azure Disk Encryption för volymkryptering.
...
När nyckeln har skapats kan du välja den under **nycklar** och visa eller ändra dess egenskaper. Egenskapsavsnittet innehåller den **nyckelidentifierare**, vilket är en identifierare URI (Uniform Resource) med externa program att få åtkomst till den här nyckeln. För att begränsa åtgärder på den här nyckeln, konfigurerar du inställningarna under **tillåtna åtgärder**.
...
När hemligheten som har skapats kan du välja den under **hemligheter** och visa eller ändra dess egenskaper. Den **hemlighet identifierare** är en URI som externa program kan använda för att få åtkomst till den här hemligheten.
