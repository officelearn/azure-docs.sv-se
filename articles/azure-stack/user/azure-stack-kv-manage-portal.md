...
Du kan hantera Nyckelvalv i Azure Stack med hjälp av Azure Stack-portalen. Den här artikeln beskriver hur du skapar och hanterar ett nyckelvalv i Azure Stack.
...
2. Från instrumentpanelen väljer **+ skapa en resurs**, sedan **säkerhet + identitet**, sedan **Key Vault**.
...
6. Välj den **prisnivå**. I den Azure Stack Development Kit (ASDK), stöd för nyckelvalv **Standard** endast SKU: er.
...
När du har skapat ett valv kan du använda följande procedur för att skapa och hantera nycklar och hemligheter i valvet.
...
5. Ange en **namn** för din nyckel. Nyckelnamnet kan innehålla endast alfanumeriska tecken och bindestreck (-).
...
5. Ange en **namn** för hemligheten. Det hemliga namnet kan innehålla endast alfanumeriska tecken och bindestreck (-).
