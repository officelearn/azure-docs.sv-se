...
Processen kräver att din klient autentiseringar mot slutpunkten för Microsoft Azure-inloggning. Slutpunkten returnerar en token. Ange token i rubriken för varje begäran som skickades till API: et för Azure-stacken. Azure använder Oauth2.0.

Den här artikeln innehåller enkla exempel specifika till Azure-stacken med curl-verktyget. Det här avsnittet går igenom processen att hämta en token för att komma åt Azure Stack-API. De flesta språk ange Oauth 2.0-bibliotek som har stabila token hanterings- och hantering av uppgifter sådana uppdatera token.

Titta på hela processen i Azure-stacken REST API med en generisk REST-klient kan som curl hjälpa dig att förstå de underliggande begärandena och vad du kan förvänta dig att ta emot svar nyttolastens.

Den här artikeln utforska inte också alla alternativ som är tillgängliga för hämtning av token som interaktiv inloggning eller skapa dedikerade App-ID: N. Mer information finns i [Azure REST API-referens](https://docs.microsoft.com/rest/api/).
...
För varje värde:
 ...
 > Om du är administratör försöker få åtkomst till klientorganisations-API och sedan måste du se till att använda klient-slutpunkt, till exempel 'https://adminmanagement.{region}.{Azure Stack domän} / metadata/slutpunkter? api-version 2015-01-011 =
  ...
  Till exempel med Azure-stacken Development Kit:
  ```
...
### <a name="example"></a>Exempel
  ...
  **username**
  ...
  Azure stacken AAD kontot, till exempel:
  ```
