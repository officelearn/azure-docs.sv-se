...
I den här artikeln lär du dig hur du ansluter till dina Azure-stacken prenumerationer och storage-konton med Lagringsutforskaren. Azure Lagringsutforskaren är en fristående app som gör det enkelt att arbeta med data i Azure-stacken Storage i Windows, macOS och Linux.

>[!NOTE]
>Det finns flera tillgängliga verktyg för att flytta data till och från Azure Storage i stacken. Mer information finns i [dataöverföring verktyg för Azure-stacken lagring](azure-stack-storage-transfer.md).
...
3. I den dialogrutan Anslut till Azure Storage, under **Azure-miljön**väljer **Azure** eller **Azure Kina**, beroende på Azure Stack-konto som du använder. Välj **inloggning** att logga in på Azure Stack-kontot som är kopplad till minst en aktiv prenumeration i Azure-stacken.
