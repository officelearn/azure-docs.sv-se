...
Azure-stacken Storage är en uppsättning lagring molntjänster som innehåller Blobbar, tabeller och köer som är konsekventa med Azure Storage-tjänster.
