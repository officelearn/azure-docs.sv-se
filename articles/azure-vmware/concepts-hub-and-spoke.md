...
* Automatisk registrering måste vara aktiverat för att Azure DNS ska kunna hantera DNS-postens livs cykel automatiskt för de virtuella datorer som distribueras i ekrar virtuella nätverk.
