...
Mer information om hur du hämtar en lista över fil resurser för ett lagrings konto finns i [den här artikeln](https://docs.microsoft.com/powershell/module/az.storage/get-azstorageshare?view=azps-4.3.0).
