...
Du kan skydda upp till 2000 data källor/objekt över alla arbets belastningar (IaaS VM, SQL, AFS osv.) i ett valv.
...
### <a name="if-a-backup-is-kept-for-a-long-time-does-it-take-more-time-to-recover-an-older-data-point"></a>Tar det längre tid att återställa en äldre data punkt om en säkerhets kopia behålls under en längre tid?
