...
## Fungerar Azure Backup Agent på en server som använder Windows Server 2012-deduplicering? <br/>
...
## Hur många återställningar kan jag göra av data som säkerhetskopierats till Azure?<br/>
