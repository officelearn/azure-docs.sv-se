...
Nej. Du kan använda Azure Backup för att skydda Azure Stack, Azure Backup stöder inte support med hjälp av DPM för säkerhetskopiering av appar i Azure Stack.
