...
>[!NOTE]
> Om du inte hittar de listade verktygen, till exempel *AzureOfflineBackupCertGen. exe*, i din installation av mars-agenten skriver AskAzureBackupTeam@microsoft.com du till för att få åtkomst till dem.
...
1. På fliken **ägda program** letar du reda på ett program med formatet `AzureOfflineBackup _<Azure User Id`visnings namn.
