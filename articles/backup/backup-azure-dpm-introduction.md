...
Alla datorer som backas upp av Azure Backup måste ha Backup-agenten (kallas även Microsoft Azure Recovery Service (MARS)-agent) installerad på den. Installera agenten på DPM-servern enligt följande:
