...
POST-URI: n har `{subscriptionId}`, `{vaultName}`, `{vaultresourceGroupName}`och `{fabricName}` parametrar. I vårt exempel skulle värdet för de olika parametrarna vara följande:
