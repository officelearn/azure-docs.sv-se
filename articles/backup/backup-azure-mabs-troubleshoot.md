...
## <a name="error-setup-could-not-update-registry-metadata"></a>Fel: Det gick inte att uppdatera registret metadata
...
| Säkerhetskopiering | Det går inte att jobb för skapande av onlineåterställningspunkt för VMware-VM. VMware-fel inträffade vid försök att hämta information om ChangeTracking. ErrorCode - FileFaultFault (ID 33621) |  1. Återställa ctk på VMWare, för de virtuella datorerna som påverkas <br/> Kontrollera att oberoende disken inte är på plats i VMWare <br/> Stoppa skydd för de berörda virtuella datorerna och skydda nytt med knappen Uppdatera <br/> Kör en kopia för de virtuella datorerna som påverkas|
