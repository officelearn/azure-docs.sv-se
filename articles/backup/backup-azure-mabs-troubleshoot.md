...
Vi rekommenderar att du utför den under verifieringen, innan du börjar felsöka Microsoft Azure Backup Server (MABS):
...
- Kontrollera att Microsoft Azure Recovery Services körs (i tjänstkonsolen). Om nödvändiga startar om och försök igen
- [Kontrollera att det finns 5–10 % ledigt utrymme i den tillfälliga mappen](https://aka.ms/AB-AA4dwtt)
- Om registreringen misslyckas, ser du till den server där du vill installera Azure Backup Server inte är redan registrerat med ett annat valv
...
| Operation | Felinformation | Lösning: |
| --- | --- | --- |
...
| Operation | Felinformation | Lösning: |
|-----------|---------------|------------|
|Installation | Det gick inte att uppdatera metadata för registret. Den här misslyckade uppdateringen kan leda till overusage av användningen av lagringsutrymme. Om du vill undvika detta uppdatera ReFS Trimming-registerposten. | Justera registernyckeln **SYSTEM\CurrentControlSet\Control\FileSystem\RefsEnableInlineTrim**. Ange värdet för Dword 1. |
