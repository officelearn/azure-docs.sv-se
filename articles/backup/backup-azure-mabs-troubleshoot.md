...
| Backup | Det gick inte att skapa onlineåterställningspunkt | Om ett felmeddelande som säger ”Windows Azure Backup-agenten gick inte att skapa en ögonblicksbild av den valda volymen” prova att öka utrymmet i replik och återställningspunktvolym.
| Backup | Det gick inte att skapa onlineåterställningspunkt | Om felmeddelandet säger ”Windows Azure Backup-agenten inte kan ansluta till tjänsten obengine”, kan du kontrollera att OBEngine finns i listan över tjänster körs på datorn. Om OBEngine-tjänsten inte körs, kan du använda kommandot ”net start OBEngine” för att starta tjänsten obengine.
