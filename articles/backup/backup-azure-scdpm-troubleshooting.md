...
description: Felsök problem i System Center Data Protection Manager.
ms.reviewer: kasinh
author: dcurwin
manager: carmonm
ms.service: backup
...
- Försök att starta om tjänsterna från kommando tolken. Använd kommandot följt av `net start dpmra`. `net stop dpmra`
