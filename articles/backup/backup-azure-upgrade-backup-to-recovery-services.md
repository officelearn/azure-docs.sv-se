...
- **Instansbaserade faktureringsmodellen**: Recovery Service-valv stöder bara-instansbaserade faktureringsmodellen. Om du har ett säkerhetskopieringsvalv som använder äldre Storage-baserade faktureringsmodellen kan du konvertera faktureringsmodellen under uppgraderingen.
- **Inga åtgärder i pågående säkerhetskopieringskonfiguration**: Åtkomst till Hanteringsplanet är begränsad under uppgraderingen. Slutför alla hanteringsåtgärder plan och starta sedan uppgraderingen.
...
### <a name="does-the-upgrade-plan-affect-my-ongoing-backups"></a>Påverkar uppgraderingsplanen min pågående säkerhetskopiering?
Nej. Säkerhetskopiorna pågående fortsätter utan avbrott under och efter uppgraderingen.

### <a name="if-i-dont-plan-on-upgrading-soon-what-happens-to-my-vaults"></a>Om jag inte planerar att uppgradera snart, vad händer med Mina valv?
...
### <a name="what-does-this-upgrade-mean-for-my-existing-tooling"></a>Vad betyder detta uppgradering för Mina befintliga verktyg?
...
### <a name="during-the-upgrade-is-there-much-downtime"></a>Under uppgraderingen, finns det stora driftstopp?
...
### <a name="can-i-roll-back-after-upgrading"></a>Kan jag återställa när du har uppgraderat?
Nej. Återställning stöds inte när resurserna har uppgraderats.

### <a name="can-i-validate-my-subscription-or-resources-to-see-if-theyre-capable-of-upgrade"></a>Kan jag verifiera prenumeration eller resurser för att se om de kan uppgraderingen?
...
### <a name="can-i-upgrade-my-csp-based-backup-vault"></a>Kan jag uppgradera min CSP-baserade Backup-valv?
...
### <a name="can-i-view-my-classic-vault-post-upgrade"></a>Kan jag visa mina klassiska efter uppgradering valv?
...
### <a name="my-upgrade-failed-but-the-machine-that-held-the-agent-requiring-updating-doesnt-exist-anymore-what-do-i-do-in-such-a-case"></a>Min uppgraderingen misslyckades, men den dator som lagras agenten kräver uppdatering är inte finns längre. Vad gör jag i så fall?
...
### <a name="why-cant-i-see-the-jobs-information-for-my-resources-after-upgrade"></a>Varför kan jag inte se informationen om jobb för mina resurser efter uppgraderingen?
