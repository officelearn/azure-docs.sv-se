...
![Steg fyra](./media/backup-azure-vms-first-look/step-four.png) Skapa en princip för att skydda virtuella datorer. <br/>
...
## Steg 1 – Skapa ett säkerhetskopieringsvalv för en virtuell dator
...
## Steg 2 – Identifiera och registrera virtuella datorer i Azure
...
8. På snabbmenyn **Registrera objekt** väljer du de virtuella datorer som du vill registrera.
    ...
    >[AZURE.TIP] Flera virtuella datorer kan registreras samtidigt.
...
## Steg 4 – Skapa säkerhetskopieringspolicyn
...
5. På menyn **Konfigurera skydd** väljer du en befintlig princip eller skapar en ny princip för att skydda de virtuella datorer som du har identifierat.
    ...
    >[AZURE.NOTE] En säkerhetskopieringspolicy innehåller ett kvarhållningsschema för de schemalagda säkerhetskopieringarna. Om du väljer en befintlig säkerhetskopieringspolicy kan du inte ändra kvarhållningsalternativen i nästa steg.
...
## Steg 5 – Den första säkerhetskopieringen
...
2. Klicka på fliken **Jobb** för att visa listan över jobb.
    ...
    >[AZURE.NOTE] Säkerhetskopieringen av virtuella datorer är en lokal process. Du kan inte säkerhetskopiera virtuella datorer från en region till ett säkerhetskopieringsvalv i en annan region. Så, för varje Azure-region som innehåller virtuella datorer som behöver säkerhetskopieras måste minst ett säkerhetskopieringsvalv skapas i den regionen.
