...
1. Under den första säkerhets kopieringen installeras ett säkerhets kopierings tillägg på den virtuella datorn om den virtuella datorn körs.
    ...
    - För virtuella Linux-datorer är [VMSnapshotLinux-tillägget](https://docs.microsoft.com/azure/virtual-machines/extensions/vmsnapshot-linux) installerat.
...
**Ögonblicksbild** | **Information** | **Återställning** | **Övervägande**
--- | --- | --- | ---
