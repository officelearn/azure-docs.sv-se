...
| Vmsnapshot-tillägget misslyckades för managed disks – försök säkerhetskopieringen igen. Om problemet kvarstår, följer du anvisningarna i ”http://go.microsoft.com/fwlink/?LinkId=800034”. Kontakta Microsoft-supporten om problemet fortfarande kvarstår | Det här felet uppstår när Backup-tjänsten inte kan utlösa en ögonblicksbild. [Läs mer](backup-azure-troubleshoot-vm-backup-fails-snapshot-timeout.md#vmsnapshot-extension-operation-failed) ögonblicksbild problem om hur du felsöker VM. |
