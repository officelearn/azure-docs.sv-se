...
> [!WARNING]
> Deduplicering är inte tillgängligt i Azure för någon av Backup-komponenterna. Om System Center DPM och Backup Server distribueras i Azure går det inte att deduplicera lagringsdiskarna som är kopplade till den virtuella datorn.
> 
> 
...
> [!WARNING]
> Nyckeln som används för att kryptera säkerhetskopierade data finns endast hos kunden. Microsoft sparar ingen kopia i Azure och har inte åtkomst till nyckeln. Om du tappar bort nyckeln kan inte Microsoft återställa dina säkerhetskopierade data.
> 
> 
