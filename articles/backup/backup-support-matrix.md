...
| ---------------------- | ------------------------------------------------------------ | ----------------- |
| Azure VM               | Ja. Offentlig begränsad förhandsversion stöds för krypterade virtuella datorer och virtuella datorer med mindre än 4 TB diskar | USA, västra centrala   |
