...
1. I guiden Schemalägg säkerhets kopiering väljer du **komma igång** > **Nästa**.
...
1. På sidan **Välj typ av första säkerhets kopiering** bestämmer du om du vill ta den första säkerhets kopian över nätverket eller använda säkerhets kopiering offline. Om du vill ta den första säkerhets kopieringen över nätverket väljer du **automatiskt över nätverket** > **Nästa**.
