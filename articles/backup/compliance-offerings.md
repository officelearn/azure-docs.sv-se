---
title: Azure Backup erbjudanden för regelefterlevnad
description: Sammanfattning av Compliance-erbjudanden för Azure Backup
ms.topic: conceptual
ms.date: 03/16/2020
...
För att hjälpa organisationer att uppfylla nationella, regionala och branschspecifika krav som reglerar insamling och användning av individers data, Microsoft Azure & Azure Backup erbjuder en omfattande uppsättning certifieringar och attesteringar.

Du kan hitta efterföljande erbjudanden för regelefterlevnad för Azure Backup för att säkerställa att tjänsten regleras när du använder tjänsten Azure Backup.

## <a name="global"></a>Global

* [CSA-STAR-attestering](https://docs.microsoft.com/microsoft-365/compliance/offering-csa-star-attestation)
* [CSA-Star-Certificate](https://docs.microsoft.com/microsoft-365/compliance/offering-csa-star-certification)
...
* [CCSL/IRAP (Australien)](https://docs.microsoft.com/microsoft-365/compliance/offering-ccsl-irap-australia)
* [GDPR (EU)](https://www.microsoft.com/trustcenter/privacy/gdpr)

## <a name="next-steps"></a>Nästa steg

Hitta den senaste täckningen och information om kompatibilitet i [Microsoft TrustCenter](https://www.microsoft.com/TrustCenter/Compliance/default.aspx).
