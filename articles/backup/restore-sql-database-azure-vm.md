...
> [!NOTE]
> Säkerhetskopiering av SQL Server-databaser som körs på en Azure-dator som använder Azure Backup är för närvarande i offentlig förhandsversion.
