...
| [New-AzRecoveryServicesVault](https://docs.microsoft.com/powershell/module/az.recoveryservices/new-azrecoveryservicesvaul) | Skapar ett Recovery Services-valv för lagring av säkerhetskopior. | 
