---
title: Träna en CNTK-modell med Azure Batch AI – Python | Microsoft Docs
description: Träna ett neuralt Microsoft Cognitive Toolkit-nätverk (CNTK) med Azure Batch AI via Python-SDK
services: batch-ai
...
Den här artikeln visar hur du använder Azure Python SDK för att träna en Microsoft Cognitive Toolkit-exempelmodell (CNTK) med Batch AI-tjänsten.
...
* Azure Python SDK – Se [Installationsanvisningar](/python/azure/python-sdk-azure-install). Den här artikeln kräver minst paketversion 2.0.0 av azure-mgmt-batchai.
...
Skapa en filresurs med namnet `batchaiquickstart`.
...
Skapa en katalog i resursen med namnet `mnistcntksample`.

```Python
mnist_dataset_directory = 'mnistcntksample'
service.create_directory(azure_file_share_name, mnist_dataset_directory, fail_on_exist=False)
```
Hämta [exempelpaketet](https://batchaisamples.blob.core.windows.net/samples/BatchAIQuickStart.zip?st=2017-09-29T18%3A29%3A00Z&se=2099-12-31T08%3A00%3A00Z&sp=rl&sv=2016-05-31&sr=b&sig=hrAZfbZC%2BQ%2FKccFQZ7OC4b%2FXSzCF5Myi4Cj%2BW3sVZDo%3D) och packa upp det till den aktuella katalogen. Följande kod laddar upp de filer som krävs i Azure-filresursen:
...
En arbetsyta är en toppnivå-samling med alla typer av Batch AI-resurser. Du skapar ditt Batch AI-klustret och experiment i en arbetsyta.
...
Mer information om hur du använder Batch AI med olika ramverk finns i [träningsrecepten](https://github.com/Azure/BatchAI).