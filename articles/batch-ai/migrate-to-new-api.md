...
I kommande Batch AI REST API version 2018-05-01 och relaterade Batch AI SDK: er och verktyg, som viktiga ändringar och nya funktioner introduceras.

Om du har använt en tidigare version av Batch AI-API, förklarar den här artikeln hur du ändrar kod och skript för att fungera med den nya API. Göra dessa ändringar endast när den nya API är tillgänglig.
