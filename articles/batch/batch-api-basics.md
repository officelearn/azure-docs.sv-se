...
---
# <a name="batch-feature-overview-for-developers"></a>Funktionsöversikt för Batch för utvecklare
...
### <a name="multiinstance-task"></a>Aktivitet med flera instanser
