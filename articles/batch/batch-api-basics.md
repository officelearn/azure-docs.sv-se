...
* Skalningsprincip
* Princip för schemaläggning av uppgifter
...
### <a name="task-dependencies"></a>Aktivitetssamband
...
* **WorkItems**: Den här katalogen innehåller katalogerna för jobb och deras aktiviteter på Compute-noden.
