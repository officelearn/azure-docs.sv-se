...
* **Lagringskonto**: För olika alternativ för lagringskonton, se [Översikt över Batch-funktionen](batch-api-basics.md#azure-storage-account).
...
### <a name="batchlabs-optional"></a>BatchLabs (valfritt)
[BatchLabs][github_batchlabs] är ett kostnadsfritt, fristående klientverktyg med omfattande funktioner för att skapa, felsöka och övervaka Azure Batch-program. Det krävs inte för att slutföra den här kursen men kan vara praktiskt när du skapar och felsöker Batch-lösningar.
...
> [!TIP]
> Ett annat sätt att få programmet till beräkningsnoderna i en pool är att använda funktionen för **programpaket** i Azure Batch. Se [Deploy applications to compute nodes with Batch application packages](batch-application-packages.md) (Distribuera program till beräkningsnoder med Batch-programpaket) för mer information.
>
>
