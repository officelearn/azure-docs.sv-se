...
Jobb lanserings aktiviteter kan köras i högst 15 minuter innan de avslutas av batch-tjänsten. Mer information finns i [referens dokumentationen för REST API](/rest/api/batchservice/job/add#jobreleasetask).
> 
> 
