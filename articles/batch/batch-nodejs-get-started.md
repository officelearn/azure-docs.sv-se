...
* [Node.js-klient](https://github.com/shwetams/azure-batchclient-sample-nodejs/blob/master/storehbaseclient.js)
* [Förberedande aktivitet – kommandoskript](https://github.com/shwetams/azure-batchclient-sample-nodejs/blob/master/startup_prereq.sh)
* [Processor för konvertering från CSV-format (Python) till JSON-format](https://github.com/shwetams/azure-batchclient-sample-nodejs/blob/master/processcsv.py)
