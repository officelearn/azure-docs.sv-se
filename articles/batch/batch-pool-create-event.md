...
|Visningsnamn|Sträng|Visningsnamnet för poolen.|
...
|Elementnamn|Typ|Anteckningar|
|------------------|----------|-----------|
|enableAutomaticUpdates|Booleskt värde|Anger om den virtuella datorn är aktiverat för automatiska uppdateringar. Standardvärdet är true om den här egenskapen inte anges.|
