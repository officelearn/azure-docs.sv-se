...
Följande lista gäller för CentOS 7,6, version 1.1.5 rendering images.
...
Följande lista gäller för Windows Server 2016, version 1.3.4 rendering images.
