...
> [!IMPORTANT]
> Om du vill köra V-Ray med Maya utanför [Azure Batch tilläggsfunktioner](https://github.com/Azure/batch-extension-templates)börjar du `vrayses.exe` innan du kör renderingen. För att starta vrayses. exe utanför mallarna kan du använda följande kommando `%MAYA_2017%\vray\bin\vrayses.exe"`.
>
