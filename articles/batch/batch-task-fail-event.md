...
|Elementnamn|Typ|Anteckningar|
|------------------|----------|-----------|
|startTime|DateTime|Den tid då aktiviteten startades. 'Körs' motsvarar den **kör** tillstånd, så om aktiviteten anger resursfiler eller programpaket, visar starttiden tidpunkten då aktiviteten startades hämtas eller distribution av dessa.  Om aktiviteten har startats om eller ett nytt försök, är det senaste tillfälle då aktiviteten startades.|
|endTime|DateTime|Den tid då aktiviteten är slutförd.|
|exitCode|Int32|Slutkoden för aktiviteten.|
