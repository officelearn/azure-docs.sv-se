        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Videobibliotek för Azure Batch</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Kom igång med Batch med hjälp av .NET</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Kom igång med Batch med hjälp av Python</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Kom igång med Batch med hjälp av Node.js</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Batch</h3>
                        <p><a href="/azure/batch/batch-diagnostics">Batch-diagnostikloggar</a></p>
                        <p><a href="/azure/batch/batch-analytics">Batchanalys</a></p>
                        <p><a href="/azure/batch/batch-compute-node-environment-variables">Miljövariabler för Batch-beräkningsnod</a></p>
                    </div>
                </div>
            </div>
        </div>
