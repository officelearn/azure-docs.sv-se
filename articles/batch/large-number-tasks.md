...
Följande är en exempel jobb mal len för en endimensionell parameter rensnings jobb med ett stort antal uppgifter – i det här fallet 250 000. Kommando raden för aktiviteten är ett enkelt `echo`-kommando.
