...
description: Det här exempelskriptet visar hur du lägger till ett program som kan användas med en Azure Batch-pool eller en uppgift.
services: batch
documentationcenter: ''
author: LauraBrenner
manager: evansma
