...
description: Lär dig hur du skapar tjänster som ingår i det kostnadsfria Azure-kontot.
...
Du kan skapa flera instanser av tjänster kostnadsfritt så länge summan av användningen ligger inom användningsgränsen. Du får till exempel 750 timmar med en virtuell B1S Windows-dator kostnadsfritt varje månad med ditt kostnadsfria Azure-konto. Du kan använda 750 timmar i valfri kombination. Du kan till exempel skapa 5 virtuella B1S Windows-datorer och använda dem i 150 timmar vardera.
