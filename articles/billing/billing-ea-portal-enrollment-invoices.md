...
## <a name="incorrect-overage-invoice"></a>Felaktig överförbrukningsfaktura

Om du tror att du har en felaktig överförbrukningsfaktura kan du läsa [Förstå fakturan för ditt Azure Enterprise-avtal](billing-understand-your-bill-ea.md) för att stämma av dina Azure-användningsavgifter. Om du tror att det finns ett misstag i den överförbrukning som Microsoft har debiterat dig för bör du kontakta supporten.

## <a name="change-a-po-number-for-an-overage-invoice"></a>Ändra ett IO-nummer för en överförbrukningsfaktura

Azure EA-portalen genererar automatiskt ett standardmässigt inköpsordernummer (IO) såvida inte EA-administratören anger ett före fakturadatumet. En EA-administratör kan uppdatera IO-numret i Azure EA-portalen genom att logga in och gå till **Rapporter**. En EA-administratör kan uppdatera IO-numret. I det översta högra avsnittet, där IO-numret visas, klickar du på pennsymbolen och uppdaterar informationen.

En EA-administratör kan uppdatera IO-numret under aktuellt faktureringskvartal innan en faktura skapas. Administratören kan även uppdatera IO-numret upp till sju dagar efter mottagandet av ett automatiskt e-postmeddelande om faktura.

Om EA-administratören inte uppdaterade IO-numret och ett nytt IO-nummer behövs är det enda alternativ som finns att slutföra en kredit och fakturera på nytt. Om en kund måste uppdatera IO-numret kontaktar du din partner för att få hjälp.
...
Alla krediter eller justeringar som tillämpas på din registrering visas på [https://ea.azure.com](https://ea.azure.com) i avsnittet **Rapporter**. Om du har en specifikt fråga om ett faktiskt kreditbelopp kan du kontakta [supporten för Azure EA-portalen](https://support.microsoft.com/supportrequestform/cf791efa-485b-95a3-6fad-3daf9cd4027c).

## <a name="request-an-invoice-copy"></a>Begära en fakturakopia

Kontakta din partner om du vill begära en kopia av din faktura.

## <a name="understand-your-bill"></a>Förstå fakturan
...
_Avgifter som debiteras separat_ och _Azure Marketplace-tjänster_ är tjänster från tredje part som distribueras från Azure Marketplace-plattformen. Den största skillnaden mellan de två tjänsterna är hur de faktureras, baserat på den avtalsstruktur som upprättats med tredjepartsutgivare.

Tredjepartsanvändning visas på din faktura under **Avgifter som debiteras separat**. Användningen förbrukar ditt saldo för ekonomiskt åtagande för Azure. Om du vill se listan över tjänster från tredje part kan du läsa [Azure Marketplace-återförsäljartjänster från tredje part använder du ekonomiskt åtagande för Azure](https://azure.microsoft.com/updates/azure-marketplace-third-party-reseller-services-now-use-azure-monetary-commitment/).

Den användning på din faktura som visas under **Azure Marketplace** debiteras separat. Den omfattas inte av något ekonomiskt åtagande. Alla avgifter, däribland Marketplace, överförbrukning och separat fakturerade avgifter, samlas dock på en enskild faktura.

Du får en enda faktura för överförbrukning för första part i Azure samt Marketplace-köp av Azure-tjänster från tredje part.

När ditt ekonomiska åtagande har förbrukats helt faktureras användning månatligen eller kvartalsvis. Om din registrering startade före maj 2018 tillämpas en tröskelregel för ekonomiskt åtagande på 150 %, och du faktureras för överförbrukning kvartalsvis. Om din registrering startade efter maj 2018 faktureras all överförbrukning månatligen.
