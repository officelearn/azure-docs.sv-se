---
title: Visa priser för Azure för företaget | Microsoft Docs
description: ''
services: ''
documentationcenter: ''
author: adpick
...
ms.locfileid: "52500456"
---
# <a name="view-your-organizations-azure-enterprise-agreement-pricing"></a>Visa priser för din organisations Azure Enterprise-avtal 

Azure-kunder med ett Enterprise Agreement (EA) kan visa och hämta EA priser från Azure-portalen. Du kan också använda din organisations EA-priser för att beräkna kostnader med hjälp av Azures priskalkylator.
...
## <a name="estimate-costs-with-ea-pricing"></a>Beräkna kostnader med EA-priser
...
- [Förstå fakturan för Azure-kunder med ett Enterprise-avtal](billing-understand-your-bill-ea.md)
