...
Mer information hittar du i [Lägga till, uppdatera eller ta bort ett kreditkort för Azure](billing-how-to-change-credit-card.md).
...
3. Granska statuskolumnen i rutnätet **Mina prenumerationer** på sidan **Översikt** under **Kostnadshantering och Fakturering**.
...
- Läs [Lös passerat betalningsdatum för din Azure-prenumeration](billing-azure-subscription-past-due-balance.md) om du behöver betala en Azure-faktura.
