...
1. Sök efter **Kostnadshantering + fakturering**.
    ...
    ![Skärmbild som visar en sökning efter kostnadshantering och fakturering ](./media/billing-payment-features-azure-portal/search-bar.png)

1. I listan **Mina prenumerationer** väljer du den prenumeration som du vill lägga till kreditkortet till.
    ![Skärmbild som visar Mina prenumerationer-rutnätet i översikt](./media/billing-payment-features-azure-portal/cost-management-billing-overview-x.png)

1. Välj **Betalningsmetoder**.

    ![Skärmbild som visar bladet betalningsmetoder markerat.](./media/billing-payment-features-azure-portal/subscription-payment-methods-blade.png)
...
1. Välj ”+” i det övre vänstra hörnet om du vill lägga till ett kreditkort.
    ...
    ![Skärmbild som visar plustecken](./media/billing-payment-features-azure-portal/subscription-payment-methods-plus.png)

1. Ange kreditkortsinformation i formuläret till höger.

    ![Skärmbild som visar formulär för att lägga till kreditkort.](./media/billing-payment-features-azure-portal/subscription-add-payment-method-x.png)
...
1. Om du vill göra det här kortet till din aktiva betalningsmetod markerar du kryssrutan intill **Gör det här till min aktiva betalningsmetod** ovanför formuläret. Det här kortet blir det aktiva betalningsmedlet för alla prenumerationer som använder samma kort som den valda prenumerationen.
    ...
    ![Skärmbild som visar kryssruta för att göra kort till aktiv betalningsmetod.](./media/billing-payment-features-azure-portal/subscription-make-active-payment-method-x.png)
...
1. Markera kryssrutan intill det kort som du vill ange som aktiv betalningsmetod.
    ...
    ![Skärmbild som visar ruta markerad bredvid kreditkort](./media/billing-payment-features-azure-portal/subscription-checked-payment-method-x.png)

1. Klicka på **Ange som aktiv** i kommandofältet.

    ![Skärmbild som visar knappen Ange som aktiv](./media/billing-payment-features-azure-portal/subscription-checked-payment-method-set-active.png)
...
![Skärmbild som visar valt kreditkort](./media/billing-payment-features-azure-portal/subscription-edit-payment-method-x.png)
...
1. Klicka på **Ta bort** i kommandofältet.
    ...
    ![Skärmbild som visar knappen Ta bort](./media/billing-payment-features-azure-portal/subscription-checked-payment-method-delete.png)
...
1. Välj **Betala per faktura** i kommandofältet.
    ...
    ![Skärmbild som visar bladet betalningsmetoder markerat.](./media/billing-payment-features-azure-portal/subscription-payment-methods-pay-by-invoice.png)

1. Ange adressen för fakturabetalningsmetoden.
1. Klicka på **Nästa**.

Om du vill godkänd att betala med faktura kan du [läsa om hur du betalar med faktura](billing-how-to-pay-by-invoice.md).
...
1. I listan **Mina prenumerationer** väljer du din Visual Studio Enterprise-prenumeration.
    ...
    ![Skärmbild som visar Mina prenumerationer-rutnätet i översikt](./media/billing-payment-features-azure-portal/cost-management-overview-msdn-x.png)

1. I prenumerationsöversikten klickar du på den orangefärgade banderollen för att ta bort utgiftsgränsen.
    
    ![Skärmbild som visar banderollen Ta bort utgiftsgräns](./media/billing-payment-features-azure-portal/msdn-remove-spending-limit-banner-x.png)

1. Välj om du vill ta bort utgiftsgränsen på obestämd tid eller bara för den aktuella faktureringsperioden.

   ![Skärmbild som visar bladet Ta bort utgiftsgräns](./media/billing-payment-features-azure-portal/remove-spending-limit-blade-x.png)
...
1. I listan **Mina prenumerationer** väljer du din prenumeration på Azure i Open-licensiering.
    ...
    ![Skärmbild som visar Mina prenumerationer-rutnätet i översikt](./media/billing-payment-features-azure-portal/cost-management-overview-aio-x.png)

1. Välj **Kredithistorik**.
    
    ![Skärmbild som visar kredithistorik](./media/billing-payment-features-azure-portal/aio-credit-history-blade.png)

1. Välj ”+” i det övre vänstra hörnet om du vill lägga till mer kredit.

    ![Skärmbild som visar knappen Lägg till kredit](./media/billing-payment-features-azure-portal/aio-credit-history-plus.png)

1. Välj en betalningsmetod i listrutan. Du kan lägga till en produktnyckel eller köpa krediter med ett kreditkort.
    
    ![Skärmbild som visar listrutan Betalningsmetod på bladet Lägg till kredit](./media/billing-payment-features-azure-portal/add-credits-select-payment-method.png)
...
- Lär dig mer om att [analysera och förhindra oväntade kostnader i Azure-portalen](billing-getting-started.md)
