...
![Exempel som visar val av reservationsköp för virtuell dator](./media/billing-save-compute-costs-reservations/select-product-to-purchase.png)
...
- Läs mer om Azure-reservationer med följande artiklar:
    ...
    - [Förstå reservationsanvändning för din prenumeration med Betala per användning-priser](billing-understand-reserved-instance-usage.md)
