...
Om du redan har både ett Office 365-konto och en Azure-prenumeration kan du läsa [Associera en Office 365-klientorganisation med en Azure-prenumeration](billing-add-office-365-tenant-to-azure-subscription.md).
...
2. Logga in med hjälp av ditt användarnamn och lösenord för Office 365. Det konto som du använder behöver inte ha administratörsbehörighet. Om du har fler än ett Office 365-konto bör du använda autentiseringsuppgifterna för det Office 365-konto som du vill associera med din Azure-prenumeration. 
   ...
   ![Skärmbild som visar inloggningssidan.](./media/billing-use-existing-office-365-account-azure-subscription/billing-sign-in-with-office-365-account.png)
...
3. Ange den information som krävs och slutför registreringsprocessen. Viss information krävs kanske inte om du redan har ett Office 365-konto.
    ...
    ![Skärmbild som visar registreringsformuläret.](./media/billing-use-existing-office-365-account-azure-subscription/billing-azure-sign-up-fill-information.png)
...
![Skärmbild som visar relationen mellan katalogen, användare och prenumerationer.](./media/billing-use-existing-office-365-account-azure-subscription/19-background-information.png)
