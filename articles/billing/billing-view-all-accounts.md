...
## <a name="change-billing-account-view-in-the-azure-portal"></a>Ändra fakturering kontovyn i Azure portal

Ett scope är en nod i ett faktureringskonto som användare använder för att visa och hantera fakturering. Till exempel har fakturering konton för Microsoft onlinetjänster-programmet bara scope - fakturering konto, medan fakturering konton för Enterprise-avtal har faktureringskonto, avdelning och kontoområden. Om du har åtkomst till flera fakturering omfattningar som standard ett omfång visas i Azure kostnadshantering + fakturering sidan. Du kan ändra omfång genom att följa anvisningarna nedan:
...
3. Välj **alla fakturering omfång** från till vänster.
