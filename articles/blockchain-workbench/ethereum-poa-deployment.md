...
![Distributionsarkitektur för](./media/ethereum-poa-deployment-guide/deployment-architecture.png)
...
![styrning dapp](./media/ethereum-poa-deployment-guide/governance-dapp.png)
...
En exempeldistribution visas nedan: ![grundläggande bladet](./media/ethereum-poa-deployment-guide/basic-blade.png)
...
![distribution av e-post](./media/ethereum-poa-deployment-guide/deployment-email.png)
...
![övervaka kategorier](./media/ethereum-poa-deployment-guide/monitor-categories.png)

Att välja **noden översikt** omdirigerar dig till en portal för att visa statistik för per nod-infrastruktur.

![noden stats](./media/ethereum-poa-deployment-guide/node-stats.png)

Att välja **nätverk Stats** ombeds du att visa Ethereum nätverksstatistik.

![statistik för nätverk](./media/ethereum-poa-deployment-guide/network-stats.png)
...
3.  Välj den \"Tillåt-ssh\" regel
    ...
    ![SSH-Tillåt](./media/ethereum-poa-deployment-guide/ssh-allow.png)

4.  Ändra \"åtgärd\" att tillåta

    ![SSH Aktivera Tillåt](./media/ethereum-poa-deployment-guide/ssh-enable-allow.png)
