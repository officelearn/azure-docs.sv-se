...
|**Ethereum RPC-slutpunkt** | HTTP-adressen för Azure blockchain service Transaction-noden. Obligatoriskt. Mer information finns i [Hämta RPC-slutpunkten](#get-the-rpc-endpoint). |
