...
Mer information finns i den [Azure Blockchain Workbench klienten exempelprogram på GitHub](https://github.com/Azure-Samples/blockchain-devkit/tree/master/connect/mobile).
