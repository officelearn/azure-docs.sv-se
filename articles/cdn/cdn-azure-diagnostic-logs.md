...
| RequestCountCacheUncacheable | Antalet förfrågningar till till gångar som förhindras från att cachelagras av till gångens Cache-Control-och Expires-huvuden. Det här antalet anger att den inte ska cachelagras på en POP-eller HTTP-klient. | Ja | Ja | Inga |
