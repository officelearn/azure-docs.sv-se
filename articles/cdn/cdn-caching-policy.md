...
1. Om du vill konfigurera cache-huvuden med hjälp av Azure portal, referera till [hur du hanterar Strömningsslutpunkter](../media-services/media-services-portal-manage-streaming-endpoints.md) avsnittet Konfigurera Strömningsslutpunkten.
