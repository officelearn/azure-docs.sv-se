...
> [!TIP]
> Det är möjligt att ha flera CDN-profiler med samma namn, så länge de är i olika resurs grupper.  Om du utelämnar `ResourceGroupName` parametern returneras alla profiler med ett matchande namn.
> 
> 
