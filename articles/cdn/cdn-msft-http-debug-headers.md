...
Rubriken för fel söknings svar, `X-Cache` innehåller information om vilket lager i CDN-stacken som innehållet betjänades från. Den här rubriken är unik för Azure CDN från Microsoft.
