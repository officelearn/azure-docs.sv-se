...
Namn | Syfte
-----|--------
Parametrar för bandbredd | Anger om bandbreddsbegränsning parametrarna (till exempel ec_rate och ec_prebuf) ska vara aktiv.
...
Disabled|Gör att våra servrar för att ignorera bandbreddsbegränsning parametrar för bandbredd. Det begärda innehållet hanteras normalt (det vill säga utan begränsning av bandbredd).
...
Ett filformat kan anges med hjälp av dess Internet medietyp (till exempel Content-Type). Internet medietyp är plattformsoberoende metadata som gör att våra servrar för att identifiera formatet för en viss tillgång. En lista över vanliga Internet medietyper finns nedan.
...
Värde|Resultat
--|--
Enabled|Gör att vår edge-servern hämtar tillgången från den ursprungliga servern.
