...
1. Använd någon av dessa metoder för att hitta det **. cloudapp.net** domän namn som tilldelats din moln tjänst.
   ...
   * Logga in på [Azure-portalen], välj din moln tjänst, titta på **översikts** avsnittet och leta upp URL-posten för **webbplatsen** .
...
4. Du måste också ange domänen eller under domän Ali Aset för CNAME, till exempel **www** , om du vill skapa ett alias för **www\.customdomain.com**. Om du vill skapa ett alias för rot domänen kan det visas som " **\@** "-symbolen i registratorns DNS-verktyg.
...
> [!NOTE]
> En besökare av **www-\.contoso.com** ser aldrig den sanna värden (contoso.cloudapp.net), så vidarebefordrings processen är osynlig för slutanvändaren.
> 
...
1. Använd någon av följande metoder för att hämta IP-adressen för din moln tjänst.
   ...
   * Logga in på [Azure-portalen], välj din moln tjänst, titta på avsnittet **Översikt** och leta upp posten **offentliga IP-adresser** .
