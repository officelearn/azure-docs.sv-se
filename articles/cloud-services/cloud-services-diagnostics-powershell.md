...
* [Konfigurations schemat för diagnostik](/azure/azure-monitor/platform/diagnostics-extension-schema-1dot2) förklarar olika alternativ för XML-konfigurationer för tillägget för diagnostik.
