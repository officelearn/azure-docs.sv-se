...
Du kan till exempel installera .NET 4.6.2 på gäst-OS-familjen 4, som inte ingår i någon version av .NET 4.6. (Gäst-OS-familjen 5 kommer med .NET 4.6). Den senaste informationen på Azure gäst-OS-versioner finns i [Azure Gästoperativsystem släpper nyheter](cloud-services-guestos-update-matrix.md). 
