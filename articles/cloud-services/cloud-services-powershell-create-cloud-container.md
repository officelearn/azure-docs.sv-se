...
* Information om hur du publicerar ditt moln tjänst projekt till Azure finns i kod exemplet **PublishCloudService. ps1** från [arkived Cloud Services-lagringsplatsen](https://github.com/MicrosoftDocs/azure-cloud-services-files/tree/master/Scripts/cloud-services-continuous-delivery).