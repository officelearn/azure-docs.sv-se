...
Mer information om hur du skapar en Linux-dator i den klassiska distributionsmodellen finns [så här skapar du en virtuell Linux-dator.](../virtual-machines/linux/classic/capture-image-classic.md).

Mer information om hur du skapar en Windows-dator i den klassiska distributionsmodellen finns [så här skapar du en virtuell Windows-dator.](../virtual-machines/windows/classic/capture-image-classic.md).
