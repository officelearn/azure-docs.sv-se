...
8. För fullständiga IIS-webbroller instruerar WaHostBootstrapper IISConfigurator att konfigurera IIS-AppPool och pekar på `E:\Sitesroot\<index>`platsen, `<index>` där är ett 0-baserat `<Sites>` index för antalet element som definierats för tjänsten.
