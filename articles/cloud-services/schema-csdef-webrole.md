...
| --------- | ---- | ----------- |  
|name|string|Krävs. Namnet för webbrollen. Rollens namn måste vara unikt.|  
...
|protocol|string|Krävs. Transportprotokoll för den externa slutpunkten. För en webbroll möjliga värden är `HTTP`, `HTTPS`, `UDP`, eller `TCP`.|  
...
| Attribut | Typ | Beskrivning |  
| --------- | ---- | ----------- |  
|name|string|Krävs. Namnet på webbplatsen eller programmet.|  
...
| Attribut | Typ | Beskrivning |  
| --------- | ---- | ----------- |  
|name|string|Krävs. Anger ett namn som identifierar det virtuella programmet.|  
...
| Attribut | Typ | Beskrivning |  
| --------- | ---- | ----------- |  
|name|string|Krävs. Anger ett namn som identifierar den virtuella katalogen.|  
...
| Attribut | Typ | Beskrivning |  
| --------- | ---- | ----------- |  
|name|string|Krävs. Anger ett namn som identifierar bindningen.|  
