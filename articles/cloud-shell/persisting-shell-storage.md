...
Fil resursen innehåller också en avbildning på 5 GB som skapas för dig och som automatiskt sparar data i din `$Home` katalog. Detta gäller både bash och PowerShell.
