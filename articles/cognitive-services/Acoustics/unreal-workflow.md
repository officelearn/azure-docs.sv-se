...
![Projektet är spärrat kurva](media/wwise-occlusion-curve.png)
...
![Projektet hinder kurva](media/wwise-obstruction-curve.png)
...
![Projektet Akustik mixer-plugin-programmet alternativ](media/mixer-plugin-global-settings.png)
...
![Per ljud Mixer-inställningar](media/per-sound-mixer-settings.png)
...
![Designriktlinjer för röst](media/voice-design-guidelines.png)
...
![Dämpning kurvor](media/atten-curve.png)
...
![Akustik utrymme kontroller](media/acoustics-space-controls.png)
...
![Ljud Component-kontroller](media/audio-component-controls.png)
...
![B-P strömning](media/blueprint-streaming.png)
...
![Strömmande installationen](media/streaming-setup.png)
...
![Avståndet fråga](media/distance-query.png)
