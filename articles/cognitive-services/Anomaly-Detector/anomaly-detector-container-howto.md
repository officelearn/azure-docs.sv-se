...
Avvikelse detektorn har följande funktioner för container funktioner:
...
[Exempel](anomaly-detector-container-configuration.md#example-docker-run-commands) på kommandot `docker run` är tillgängliga.
