...
description: 'I den här snabb starten lär du dig att använda API: t för avvikelse detektor för att identifiera avvikelser i din data serie antingen som en batch eller vid strömmande data.'
