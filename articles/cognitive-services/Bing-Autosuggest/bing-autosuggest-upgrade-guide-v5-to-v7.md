---
title: Uppgradera Bing Autosuggest API v5 till v7
...
---
# <a name="autosuggest-api-upgrade-guide"></a>Uppgraderingsguide för api-kort automatiskt

Den här uppgraderingsguiden identifierar ändringarna mellan version 5 och version 7 av API:et för automatiska förslag på Bing. Använd den här guiden för att uppdatera programmet så att det använder version 7.

## <a name="breaking-changes"></a>Icke-bakåtkompatibla ändringar

### <a name="endpoints"></a>Slutpunkter

- Slutpunktens versionsnummer ändrades från v5 till v7. Https:\//api.cognitive.microsoft.com/bing/\*\*v7.0**/Förslag.
