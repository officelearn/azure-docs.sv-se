...
1. Skapa en funktion som `Autosuggest()` kallas för att skicka en begäran till API: et. Skapa en ny `HttpClient()`och Lägg till din prenumerations nyckel i `Ocp-Apim-Subscription-Key` rubriken.
