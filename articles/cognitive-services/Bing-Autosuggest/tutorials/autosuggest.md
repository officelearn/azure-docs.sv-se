...
Skapa ett HTML-formulär med ett textfält. Hanterar händelsen `oninput` och anropar funktionen `bingAutosuggest()`, och skickar innehållet i textfältet och API för automatiska förslag i Bing nyckeln.
