...
Skapa ett HTML-formulär med ett textfält. Hantera `oninput` händelsen och anropa `bingAutosuggest()` funktionen och skicka innehållet i textfältet och API för automatiska förslag i Bing nyckeln.
