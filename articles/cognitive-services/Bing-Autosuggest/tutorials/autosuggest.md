...
Skapa ett HTML-formulär med ett textfält. Hantera `oninput` händelsen och anropa funktionen och `bingAutosuggest()` Skicka innehållet i textfältet och API för automatiska förslag i Bing nyckeln.
