...
* [NYHETSSÖKNING I Bing SDK för Java Script](https://www.npmjs.com/package/@azure/cognitiveservices-newssearch)
     *  Installera genom att köra `npm install @azure/cognitiveservices-newssearch`
