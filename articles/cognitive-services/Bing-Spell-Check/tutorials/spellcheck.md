...
* [En Stavningskontroll i Bing resurs](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingSpellCheck-v7)
...
Skapa ett HTML-formulär med ett textfält. Hantera `onsubmit` händelsen och anropa funktionen bingSpellCheck, och skicka innehållet i textfältet och API för stavningskontroll i Bing nyckeln.
