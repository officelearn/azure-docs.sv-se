---
title: C# Snabbstartsguide för Azure kognitiva-tjänster, Bing Video Sök API | Microsoft Docs
...
ms.locfileid: "35354558"
---
# <a name="quickstart-for-bing-video-search-api-with-c"></a>Snabbstart för Bing Video sökning API med C#

Den här artikeln visar hur använda Bing Video-Sök-API, en del av Microsoft kognitiva Services på Azure. När den här artikeln använder C#, är en RESTful webbtjänst som är kompatibel med alla programmeringsspråk som kan göra HTTP-begäranden och parsa JSON API: et. 
...
## <a name="bing-video-search"></a>Video för Bing search
