---
title: 'Snabbstart: API för videosökning i Bing, C#'
...
ms.locfileid: "52306989"
---
# <a name="quickstart-bing-video-search-api-with-c"></a>Snabbstart: API för videosökning i Bing med C#

Den här artikeln beskriver hur du använder API:et för videosökning i Bing, som är en del av Azure Cognitive Services. Även om den här artikeln använder C# är API:et en RESTful-webbtjänst som är kompatibel med alla programmeringsspråk som kan göra HTTP-begäranden och parsa JSON. 
...
## <a name="see-also"></a>Se även 
 ...
 [Söka på webben efter videor](search-the-web.md)  
