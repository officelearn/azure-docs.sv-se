---
title: PHP Snabbstartsguide för Azure kognitiva-tjänster, Bing Video Sök API | Microsoft Docs
...
ms.locfileid: "35354528"
---
# <a name="quickstart-for-bing-video-search-api-with-php"></a>Snabbstart för Bing Video sökning API med PHP

Den här artikeln visar hur använda Bing Video-Sök-API, en del av Microsoft kognitiva Services på Azure. Den här artikeln använder PHP, är API: et en RESTful webbtjänst som är kompatibel med alla programmeringsspråk som kan göra HTTP-begäranden och parsa JSON. 

Exempelkoden skrevs till fungerar under PHP 5.6.
...
Den [Bing Video Sök API](https://docs.microsoft.com/rest/api/cognitiveservices/bing-web-api-v7-reference) returnerar video resultat från Bing sökmotor.

1. Se till att säker HTTP-stöd är aktiverat i dina `php.ini` enligt beskrivningen i kod-kommentar.
