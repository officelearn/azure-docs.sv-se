---
title: 'Snabbstart: Videosökning i Bing, PHP'
...
ms.locfileid: "52315502"
---
# <a name="quickstart-bing-video-search-api-with-php"></a>Snabbstart: API för videosökning i Bing med PHP

Den här artikeln beskriver hur du använder API:et för videosökning i Bing, som är en del av Microsoft Cognitive Services i Azure. Även om den här artikeln använder PHP, är API:et en RESTful-webbtjänst som är kompatibel med alla programmeringsspråk som kan göra HTTP-begäranden och parsa JSON. 
...
[API:n för videosökning i Bing](https://docs.microsoft.com/rest/api/cognitiveservices/bing-web-api-v7-reference) returnerar videoresultat från Bings sökmotor.
