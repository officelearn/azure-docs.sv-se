---
title: 'Snabbstart: Sök efter videor med REST API för videosökning i Bing och C#'
...
2. Lägg till variabler för din prenumerationsnyckel, slutpunkt och sökvillkor.
...
3. Definiera en `SearchResult`-struct som ska innehålla bildsökningsresultatet och JSON-rubrikinformation.
