...
Installera SDK för videosökning i Bing med hjälp av Maven eller Gradle eller något annat beroendehanteringssystem. Maven POM-filen kräver deklarationen:
```
  <dependencies>
    <dependency>
