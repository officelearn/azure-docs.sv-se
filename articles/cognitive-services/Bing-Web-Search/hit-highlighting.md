---
title: Hur du använder decoration markörer för att markera text - API för webbsökning i Bing
titleSuffix: Azure Cognitive Services
description: Lär dig hur du använder textutsmyckning och träffmarkering i ditt sökresultat med hjälp av Bing Web Search API.
