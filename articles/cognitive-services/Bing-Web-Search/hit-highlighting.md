...
Som standard innehåller Bing inte markerings markörer i visnings strängar. Om du vill aktivera markörerna lägger `textDecorations` du till frågeparametern i din begäran och anger den `true`.
...
Om begäran inte angav dekorationer skulle `expression` fältet innehålla. `log10(2)` 
