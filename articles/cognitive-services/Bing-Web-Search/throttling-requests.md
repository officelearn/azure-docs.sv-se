...
description: Lär dig mer om begärandebegränsning och när du använder Bing Web Search API.
...
ms.locfileid: "55865292"
---
# <a name="throttling-requests-to-the-bing-web-search-api"></a>Begränsning av förfrågningar till Bing Web Search API
