---
title: Analysera en lokal bild med API:et för visuellt innehåll och C# | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: I den här snabbstarten ska du analysera en lokal bild med Visuellt innehåll och C# i Cognitive Services.
...
ms.locfileid: "43771975"
---
# <a name="quickstart-analyze-a-local-image---rest-c35"></a>Snabbstart: Analysera en lokal bild – REST, C&#35;

I den här snabbstarten analyserar du en lokal bild för att extrahera visuella funktioner med hjälp av Visuellt innehåll.
...
> [Använda Visuellt innehåll med C#](../Tutorials/CSharpTutorial.md)
