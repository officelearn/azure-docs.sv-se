...
---
# <a name="quickstart-analyze-a-local-image-using-the-computer-vision-rest-api-and-c"></a>Snabbstart: Analysera en lokal avbildning med hjälp av den REST API för visuellt innehåll ochC#
