---
title: 'Snabbstart: OCR med API:et för visuellt innehåll och C# | Microsoft Docs'
titleSuffix: Microsoft Cognitive Services
description: I den här snabbstarten ska du extrahera tryckt text från en bild med hjälp av Visuellt innehåll och C# i Cognitive Services.
...
ms.locfileid: "43772336"
---
# <a name="quickstart-extract-printed-text-ocr---rest-c35"></a>Snabbstart: Extrahera tryckt text (OCR) – REST, C&#35;
