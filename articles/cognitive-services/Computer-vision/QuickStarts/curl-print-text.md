...
ms.locfileid: "81405064"
---
# <a name="quickstart-extract-printed-text-ocr-using-the-computer-vision-rest-api-and-curl"></a>Snabbstart: Extrahera tryckt text (OCR) med hjälp av COMPUTER Vision REST API och cURL
