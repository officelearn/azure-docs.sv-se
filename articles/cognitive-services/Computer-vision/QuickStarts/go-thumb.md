---
title: 'Snabbstart: Skapa en miniatyrbild – REST, Go – Visuellt innehåll'
...
ms.locfileid: "45629551"
---
# <a name="quickstart-generate-a-thumbnail-using-the-rest-api-and-go-in-computer-vision"></a>Snabbstart: Generera en miniatyrbild med hjälp av REST-API:t och Go i Visuellt innehåll
...
1. Kompilera paketet från filen genom att köra `go build`-kommandot i kommandotolken. Till exempel `go build get-thumbnail.go`.
...
Ta bort det kompilerade paketet och den fil från vilken paketet kompilerades när du inte längre behöver dem. Stäng sedan kommandotolkens fönster och textredigeraren.
