...
description: I den här snabbstarten ska du extrahera tryckt text från en bild med hjälp av Visuellt innehåll och Java i Cognitive Services.
...
ms.locfileid: "43772129"
---
# <a name="quickstart-extract-printed-text-ocr---rest-java"></a>Snabbstart: Extrahera tryckt text (OCR) – REST, Java
...
Ett svar som anger att åtgärden lyckades returneras i JSON. OCR-resultaten omfattar den identifierade texten och avgränsningsfält för regioner, linjer och ord.
