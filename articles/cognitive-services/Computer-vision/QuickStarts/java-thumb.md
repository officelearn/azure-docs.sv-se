...
description: I den här snabbstarten skapar du en miniatyrbild från en bild med hjälp av Visuellt innehåll med Java i Cognitive Services.
...
ms.locfileid: "43772423"
---
# <a name="quickstart-generate-a-thumbnail---rest-java"></a>Snabbstart: Skapa en miniatyrbild – REST, Java
...
Ett svar för en lyckad åtgärd innehåller binärfilen för miniatyrbilden. Om begäran misslyckas innehåller svaret en felkod och ett meddelande som hjälper dig att avgöra vad som gick fel. Följande text är ett exempel på ett lyckat svar.
