...
description: I den här snabbstarten ska du extrahera tryckt text från en bild med hjälp av Visuellt innehåll och JavaScript i Cognitive Services.
...
ms.locfileid: "43771972"
---
# <a name="quickstart-extract-printed-text-ocr---rest-javascript"></a>Snabbstart: Extrahera tryckt text (OCR) – REST, JavaScript
...
1. Kopiera följande och spara det till en fil såsom `ocr.html`.
...
Ett svar som anger att åtgärden lyckades returneras i JSON. OCR-resultatet returnerade text, en avgränsningsruta för områden, linjer och ord.
