---
title: 'Snabb start: extrahera utskriven text – REST, Node. js'
...
1. Du kan också ersätta värdet för `imageUrl` med webbadressen till en annan bild från vilken du vill extrahera tryckt text.
