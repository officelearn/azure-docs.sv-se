...
1. Spara koden som en fil med tillägget `.js`. Ett exempel är `get-thumbnail.js`.
1. Öppna ett kommandotolksfönster.
1. Kör filen i kommandotolken med kommandot `node`. Ett exempel är `node get-thumbnail.js`.
