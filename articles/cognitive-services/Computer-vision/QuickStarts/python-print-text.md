---
title: 'Snabbstart: OCR med Visuellt innehåll och Python | Microsoft Docs'
titleSuffix: Microsoft Cognitive Services
description: I den här snabbstarten ska du extrahera tryckt text från en bild med hjälp av Visuellt innehåll och Python i Cognitive Services.
...
ms.locfileid: "43771905"
---
# <a name="quickstart-extract-printed-text-ocr---rest-python"></a>Snabbstart: Extrahera tryckt text (OCR) – REST, Python
...
## <a name="extract-printed-text"></a>Extrahera tryckt text
