---
title: 'Exempel: utforska en app för bild bearbetning iC#'
...
---
# <a name="sample-explore-an-image-processing-app-with-c"></a>Exempel: utforska en app för bild bearbetning medC#
