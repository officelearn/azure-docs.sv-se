...
Java Swing-programmet konfigureras med sex flikar. Varje fil visar en annan funktion för API för visuellt innehåll (analysera, OCR, osv). De sex självstudiedelarna har inte beroenden så du kan lägga till ett avsnitt, alla sex delar, eller endast en del eller två. Och du kan lägga till delarna i valfri ordning.
