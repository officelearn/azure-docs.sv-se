...
Välj **Skicka**. Om åtgärden lyckas den **svarsstatus** är `200 OK`, och **svarsinnehåll** rutan visar Kontrollera informationen i JSON-format som liknar följande:
