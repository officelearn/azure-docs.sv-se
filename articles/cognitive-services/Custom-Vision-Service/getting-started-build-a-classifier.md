...
1. Välj sedan en av de tillgängliga domänerna. Varje domän optimerar klassificerare för vissa typer av bilder, enligt beskrivningen i följande tabell. Du kommer att kunna ändra domänen senare om du vill.
    ...
    |__Vuxet__|Optimerad för att definiera en bättre vuxet innehåll och inte är vuxen innehåll. Till exempel om du vill blockera bilder av personer i badning passar kan den här domänen du skapa en anpassad klassificerare för att göra detta.|
...
Tillbaka till början av det här avsnittet för att ladda upp en annan uppsättning bilder och upprepa steg.
