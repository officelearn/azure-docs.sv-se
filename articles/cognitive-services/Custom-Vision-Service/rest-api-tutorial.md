---
title: 'Självstudier: Skapa, träna och exportera en modell med REST-API för anpassad visuellt innehåll'
...
ms.locfileid: "58351107"
---
# <a name="tutorial-create-train-and-export-a-model-with-rest"></a>Självstudier: Skapa, träna och exportera en modell med REST
