...
Modeller som genereras av komprimerade domäner kan exporteras för att köras lokalt. Modell prestanda varierar beroende på vald domän. I tabellen nedan rapporterar vi modell storlek och härlednings tid för Intel Desktop CPU och NVidia GPU-\[1\]. 
...
|---|---|---|---|---|
|Klassificering|Allmän (komprimera)|5 MB|13 MS|5 ms|
|Objektidentifiering|Allmän (komprimera)|45 MB|35 MS|5 ms|
