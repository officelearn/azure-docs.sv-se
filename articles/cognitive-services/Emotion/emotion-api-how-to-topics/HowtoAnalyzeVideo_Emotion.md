---
title: Realtid video analys med Känslo-API | Microsoft Docs
description: Använda Känslo-API i kognitiva Services för att utföra analyser av nära realtid på ramar som hämtats från direktuppspelad video.
