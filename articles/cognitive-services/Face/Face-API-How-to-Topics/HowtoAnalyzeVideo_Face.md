---
title: Realtid video analys med Ansikts-API | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: Använda Ansikts-API i kognitiva Services för att utföra analyser av nära realtid på ramar som hämtats från direktuppspelad video.
