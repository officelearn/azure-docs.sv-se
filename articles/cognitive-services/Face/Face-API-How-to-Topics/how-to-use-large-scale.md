...
När du använder klientbiblioteket Ansikts-API, skickas prenumerationsnyckel och prenumerationens slutpunkt via konstruktor i klassen FaceServiceClient. Exempel:
