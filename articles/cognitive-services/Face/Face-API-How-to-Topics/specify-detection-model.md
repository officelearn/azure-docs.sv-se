...
När du använder API: t för [Identifiera ansikte] kan du tilldela modell versionen med parametern `detectionModel`. De tillgängliga värdena är:
...
Om du använder klient biblioteket kan du tilldela värdet för `detectionModel` genom att skicka i en lämplig sträng. Om du lämnar den otilldelad, använder API: n standard modell version (`detection_01`). Se följande kod exempel för .NET-klient biblioteket.
...
Den här koden skapar en **PersonGroup** med ID `mypersongroupid` och lägger till en **person** till den. Sedan lägger den till en ansikte till den här **personen** med hjälp av `detection_02`s modellen. Om du inte anger parametern *detectionModel* använder API: n standard modell, `detection_01`.
...
Den här koden skapar en **FaceList** med namnet `My face collection` och lägger till en ansikte till den med `detection_02`s modellen. Om du inte anger parametern *detectionModel* använder API: n standard modell, `detection_01`.
