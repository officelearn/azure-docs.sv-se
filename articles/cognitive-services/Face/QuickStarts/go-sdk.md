---
title: 'Snabb start: ansikts klient bibliotek för go | Microsoft Docs'
...
---
# <a name="quickstart-face-client-library-for-go"></a>Snabb start: ansikts klient bibliotek för go
...
[Referens dokumentation](https://godoc.org/github.com/Azure/azure-sdk-for-go/services/cognitiveservices/v1.0/face) | [bibliotekets käll kod](https://github.com/Azure/azure-sdk-for-go/tree/master/services/cognitiveservices/v1.0/face) | [SDK-hämtning](https://github.com/Azure/azure-sdk-for-go)
...
* `FACE_SUBSCRIPTION_KEY`-resurs nyckeln för att autentisera dina begär Anden.
...
* **src** – den här katalogen kommer att innehålla källkod och paket. Alla paket som installeras med kommandot `go get` kommer att finnas i den här mappen.
...
Följande klasser och gränssnitt hanterar några av de viktigaste funktionerna i ansikts service go SDK.
...
> [!NOTE] 
> Den här snabb starten förutsätter att du har [skapat miljövariabler](https://docs.microsoft.com/azure/cognitive-services/cognitive-services-apis-create-account#configure-an-environment-variable-for-authentication) för din ansikts nyckel och slut punkt, med namnet `FACE_SUBSCRIPTION_KEY` respektive `FACE_ENDPOINT`.
...
Kör programmet Go med kommandot `go run [arguments]` från program katalogen.
