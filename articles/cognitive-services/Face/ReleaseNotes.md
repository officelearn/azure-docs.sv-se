...
* Har lagts till ögonblicksbild-funktion för att stödja migrering av data mellan prenumerationer: [Ögonblicksbild](https://docs.microsoft.com/en-us/rest/api/cognitiveservices/face/snapshot).
