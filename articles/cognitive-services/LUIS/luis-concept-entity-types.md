...
|Buy a ticket from New York to London on March 5|Location.Origin<br>Location.Destination<br>Prebuilt datetimeV2|New York<br>London<br>5 mars 2018|
...
|Yttrande|Intent predicted|Entities extracted|Förklaring|
|--|--|--|--|
|Hjälp|help|-|Nothing to extract.|
