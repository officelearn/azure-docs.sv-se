...
Ett uttryck kan innehålla många entiteter eller inga alls. Ett klient program _kan_ behöva entiteten för att utföra sin uppgift. 
...
|Entitetstyp|Syfte|
|--|--|
|[**Datorn – lärt sig**](tutorial-machine-learned-entity.md)|Överordnad gruppering av entiteter, oavsett typ av enhet. Enheter som lärts från enheten lär sig från kontexten i uttryck. På så sätt blir variationen av placering i exemplet yttranden stor. |
