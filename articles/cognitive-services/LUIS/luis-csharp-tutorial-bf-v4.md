...
1. I bot-emulatorn anger `Book a flight from Seattle to Berlin tomorrow` och får samma svar för den grundläggande roboten som du fick i **testet i Web Chat** i ett tidigare avsnitt.
