---
title: Självstudie om att anropa en Language Understanding Intelligent Services-app (LUIS) med hjälp av Node.js | Microsoft Docs
...
ms.locfileid: "36263660"
---
# <a name="tutorial-call-a-luis-endpoint-using-nodejs"></a>Självstudie: anropa en LUIS-slutpunkt med Node.js
...
## <a name="consume-a-luis-result-using-the-endpoint-api-with-nodejs"></a>Förbruka ett LUIS-resultat med hjälp av slutpunkts-API med Node.js
...
2. Ange miljövariabeln `LUIS_APP_ID` enligt beskrivningen i kodkommentarerna. 

3. Ange miljövariabeln `LUIS_SUBSCRIPTION_KEY` till din Cognitive Services-prenumerationsnyckel.

4. Kör koden. Det visar samma värden som du såg tidigare i webbläsarfönstret.
<!-- 
