...
1. I uttryck `place John Jackson in engineering`väljer du `John Jackson`entiteten personName och väljer sedan **Radbryt i sammansatt entitet** i popup-menyn för följande uttryck. 
