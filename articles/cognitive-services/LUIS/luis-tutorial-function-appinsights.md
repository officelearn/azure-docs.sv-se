...
Roboten har byggts med Bot Framework 3.x och Azure Web app-robot. En [Bot Framework 4.x med LUIS självstudiekursen](luis-nodejs-tutorial-bf-v4.md) är också tillgänglig.
