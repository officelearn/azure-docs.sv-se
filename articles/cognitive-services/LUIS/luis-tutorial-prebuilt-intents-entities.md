---
title: 'Självstudie: fördefinierat syfte och entiteter – LUIS'
titleSuffix: Azure Cognitive Services
description: I den här självstudien får du lägga till fördefinierade avsikter och entiteter i för att snabbt få avsiktsförutsägelse och dataextrahering. Du behöver inte märka yttranden med fördefinierade entiteter. Entiteten identifieras automatiskt.
...
1. Gå till slutet av webbadressen i webbläsarens adressfält och ange `I want to cancel my trip to Seattle`. Den sista frågesträngsparametern är `q`, yttrande**frågan**. 
    ...
    Resultatet förutsägde verktygen. avboka avsikten med 80% konfidensgrad och extraherade stads data. 
