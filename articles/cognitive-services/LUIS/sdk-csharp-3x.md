---
title: 'Snabb start: Language Understanding (LUIS) Redigera klient bibliotek 3. x för .NET'
titleSuffix: Azure Cognitive Services
description: Kom igång med LUIS-klient biblioteket 3. x för .NET. Följ de här stegen för att installera paketet och prova exempel koden för grundläggande uppgifter.
...
ms.locfileid: "74807508"
---
# <a name="quickstart-language-understanding-luis-client-library-3x-for-net"></a>Snabb start: Language Understanding (LUIS) klient bibliotek 3. x för .NET

Kom igång med klient biblioteket för Language Understanding (LUIS) 3. x för .NET. Följ de här stegen för att installera paketet och prova exempel koden för grundläggande uppgifter.  Med Language Understanding (LUIS) kan du använda anpassad maskin inlärnings information till en användares svars-och naturligt språk text för att förutsäga den övergripande innebörden och hämta relevant, detaljerad information.

Använd Language Understanding (LUIS) klient biblioteket 3. x för .NET till:

* Fråga en publicerad slut punkt
