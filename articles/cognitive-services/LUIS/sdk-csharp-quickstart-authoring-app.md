...
description: Kom igång med LUIS-klient biblioteket för .NET med den här snabb starten. Följ de här stegen för att installera paketet och prova exempel koden för grundläggande uppgifter.
...
ms.locfileid: "75447752"
---
# <a name="quickstart-language-understanding-luis-authoring-2x-client-library-for-net"></a>Snabb start: Language Understanding (LUIS) redigering av 2. x-klient bibliotek för .NET

Kom igång med Language Understanding (LUIS) redigering 2. x-klient biblioteket för .NET. Följ de här stegen för att installera paketet och prova exempel koden för grundläggande uppgifter.  Med Language Understanding (LUIS) kan du använda anpassad maskin inlärnings information till en användares svars-och naturligt språk text för att förutsäga den övergripande innebörden och hämta relevant, detaljerad information.
