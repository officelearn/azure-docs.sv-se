...
[Läs mer](whats-new.md) om vad som är nytt i language Understanding.
...
### <a name="i-received-an-http-403-error-status-code-how-do-i-fix-it"></a>Jag har fått en HTTP 403-fel status kod. Hur gör jag för att åtgärda det?
...
### <a name="i-received-an-http-429-error-status-code-how-do-i-fix-it"></a>Jag har fått en HTTP 429-fel status kod. Hur gör jag för att åtgärda det?
...
### <a name="my-luis-app-was-working-yesterday-but-today-im-getting-403-errors-i-didnt-change-the-app-how-do-i-fix-it"></a>Min LUIS-app fungerade igår men idag får du 403-fel. Jag ändrade inte appen. Hur gör jag för att åtgärda det?
...
### <a name="when-an-app-is-exported-then-reimported-into-a-new-app-with-a-new-app-id-the-luis-prediction-scores-are-different-why-does-this-happen"></a>När en app exporteras och sedan importeras om till en ny app (med ett nytt app-ID), är LUIS förutsägelse poängen annorlunda. Varför sker detta?
...
### <a name="some-utterances-go-to-the-wrong-intent-after-i-made-changes-to-my-app-the-issue-seems-to-disappear-at-random-how-do-i-fix-it"></a>Vissa yttranden går till fel avsikt när jag har gjort ändringar i min app. Problemet verkar försvinna slumpmässigt. Hur gör jag för att åtgärda det? 
...
### <a name="i-got-an-error-about-being-out-of-quota-how-do-i-fix-it"></a>Jag har fått ett fel meddelande om att kvoten är felaktig. Hur gör jag för att åtgärda det? 
...
## <a name="app-management"></a>Hantering av appar
