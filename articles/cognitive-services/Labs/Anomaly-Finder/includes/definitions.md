...
|**WarningText**  <br>*optional*|Om de inkommande datapunkter som tillhandahålls inte följer den regel som kräver att API: et och data fortfarande kan identifieras genom API: et, API: et analyserar data och lägga till varningsinformation i det här fältet.|string|
