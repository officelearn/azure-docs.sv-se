...
Batch-testning ingår i batch-testverktyget. Det här verktyget är tillgängligt som en [zippad körbar fil](https://qnamakerstore.blob.core.windows.net/qnamakerdata/batchtesting/bt.zip) för hämtning eller som [ C# käll kod](https://github.com/Azure-Samples/cognitive-services-qnamaker-csharp/tree/master/documentation-samples/batchtesting). 
