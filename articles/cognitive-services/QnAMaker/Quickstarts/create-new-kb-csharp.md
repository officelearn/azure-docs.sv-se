...
> [!NOTE] 
> Kompletta lösningsfiler är tillgängliga från [**Azure-Samples/cognitive-services-qnamaker-csharp** Github-lagringsplatsen](https://github.com/Azure-Samples/cognitive-services-qnamaker-csharp).
