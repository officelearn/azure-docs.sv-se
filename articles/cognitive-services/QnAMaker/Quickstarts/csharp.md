---
title: C# Snabbstart för Microsoft frågor och svar om Maker API (V4) - kognitiva Azure-tjänster | Microsoft Docs
...
ms.locfileid: "36301350"
---
# <a name="quickstart-for-microsoft-qna-maker-api-with-c"></a>Snabbstart för Microsoft frågor och svar om Maker API med C# 
<a name="HOLTop"></a>

Den här artikeln visar hur du använder den [Microsoft frågor och svar om Maker API](../Overview/overview.md) med C# för att göra följande.
