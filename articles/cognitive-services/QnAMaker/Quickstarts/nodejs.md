---
title: Node.js Snabbstart för Microsoft frågor och svar om Maker API (V4) - kognitiva Azure-tjänster | Microsoft Docs
...
ms.locfileid: "36301544"
---
# <a name="quickstart-for-microsoft-qna-maker-api-with-nodejs"></a>Snabbstart för Microsoft frågor och svar om Maker API med Node.js 
<a name="HOLTop"></a>

Den här artikeln visar hur du använder den [Microsoft frågor och svar om Maker API](../Overview/overview.md) med Node.js att göra följande.
