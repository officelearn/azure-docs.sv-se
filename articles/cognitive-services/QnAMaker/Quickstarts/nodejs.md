...
description: Hämta information om Node.js REST-baserad och kodexempel som hjälper dig att snabbt komma igång med Microsoft Translator Text API i Microsoft Cognitive Services på Azure.
