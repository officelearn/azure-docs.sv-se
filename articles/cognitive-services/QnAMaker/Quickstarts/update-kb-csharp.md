...
## <a name="add-the-kb-update-definition"></a>Lägga till definition för KB-uppdateringen
...
Följande kod gör en HTTPS-begäran för API för QnA Maker för att uppdatera frågor och svar-grupper i en kunskapsbas och tar emot svaret:
...
Uppdateringen av ett KB lägger till, uppdaterar och tar bort frågor och svar-par. 
...
## <a name="add-updatekb-method"></a>Lägga till UpdateKB-metod
Följande metod uppdaterar KB och upprepar statuskontroller. Eftersom det kan ta lite tid att skapa KB måste du upprepa anrop för att kontrollera status tills statusen antingen lyckas eller misslyckas.
...
## <a name="add-the-updatekb-method-to-main"></a>Lägga till metoden UpdateKB till Main

Ändra Main-metoden för att anropa metoden UpdateKB:
...
Skapa och kör programmet. Begäran skickas automatiskt till API:et för QnA Maker för att uppdatera KB, och sedan söker den efter resultaten med 30 sekunders mellanrum. Varje svar skrivs ut till konsolfönstret.
