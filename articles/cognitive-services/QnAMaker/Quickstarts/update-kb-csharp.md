---
title: 'Uppdatera kunskapsbas: Snabbstart för C# – Azure Cognitive Services | Microsoft Docs'
description: Uppdatera en kunskapsbas i C# för QnA Maker.
...
ms.locfileid: "43771418"
---
# <a name="update-a-knowledge-base-in-c"></a>Uppdatera en kunskapsbas i C#
...
1. Skapa ett nytt .NET Framework C#-konsolprogram i valfri IDE.
...
När kunskapsbasen har uppdaterats kan du visa den i QnA Maker-portalen, på sidan [My knowledge bases](https://www.qnamaker.ai/Home/MyServices) (Mina kunskapsbaser). Obs! Namnet på kunskapsbasen har ändrats, till exempel QnA Maker Vanliga frågor och svar (eller namnet på din befintliga kunskapsbas) är nu ”New KB Name”.

Om du vill ändra andra element i kunskapsbasen refererar du till [JSON-schemat](https://westus.dev.cognitive.microsoft.com/docs/services/5a93fcf85b4ccd136866eb37/operations/5ac266295b4ccd1554da7600) i QnA Maker och ändrar strängen `new_kb`.
