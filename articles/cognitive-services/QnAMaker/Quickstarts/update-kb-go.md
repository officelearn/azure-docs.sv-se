---
title: 'Uppdatera kunskapsbas: Snabbstart för Go – Azure Cognitive Services | Microsoft Docs'
...
## <a name="the-update-knowledge-base-response"></a>Svar från kunskapsbasuppdateringen
