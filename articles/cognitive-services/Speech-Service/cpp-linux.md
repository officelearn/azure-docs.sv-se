...
> [!NOTE]
> Om du letar efter en Snabbstart för C++ och Windows, gå [här](cpp-windows.md).
...
* På en x64 datorn som kör:

  ```sh
  export LD_LIBRARY_PATH="$LD_LIBRARY_PATH:$SPEECHSDK_ROOT/lib/x64"
  ```

* På en x86 datorn som kör:
...
Om allt går bra bör du se utdata som liknar följande:
