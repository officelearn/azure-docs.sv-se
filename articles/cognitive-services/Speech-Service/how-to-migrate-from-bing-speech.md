...
description: Lär dig skillnaderna mellan Bing-taligenkänning och Speech-tjänsten från utvecklare synpunkt och migrera ditt program att använda Speech-tjänsten.
...
Med Taltjänsten liknar huvudsakligen Bing-taligenkänning med följande skillnader.
...
1. Gå igenom Taltjänsten [snabbstartguider](quickstart-csharp-dotnet-windows.md) och [självstudier](how-to-recognize-intents-from-speech-csharp.md). Också titta på den [kodexempel](samples.md) att få med de nya API: er.
1. Uppdatera programmet för användning med Speech Service och API: er.
