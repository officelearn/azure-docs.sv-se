...
description: Lär dig att känna igen tal (från en fil från en mikrofon, med en anpassad modell, kontinuerligt eller one-shot) med hjälp av tal-SDK för Java.
