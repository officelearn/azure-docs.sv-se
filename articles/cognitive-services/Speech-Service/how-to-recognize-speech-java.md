...
description: >
  Visar olika sätt att känna igen tal (från fil från mikrofon, med en anpassad modell, kontinuerligt eller one-shot) med hjälp av tal-SDK för Java.
