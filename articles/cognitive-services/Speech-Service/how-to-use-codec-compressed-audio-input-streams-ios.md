---
title: Stream codec komprimerat ljud med talet SDK i iOS-tal-tjänsten
...
Hantering av komprimerat ljud implementeras med [gstreamer](https://gstreamer.freedesktop.org).
Av licens skäl kan dessa funktioner inte levereras med SDK, men ett omslutnings bibliotek som innehåller dessa funktioner måste skapas av programutvecklare och levereras med apparna med hjälp av SDK.
