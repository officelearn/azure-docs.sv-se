...
ms.locfileid: "80656650"
---
:::row:::
    :::column span="3":::
        Speech SDK stöder endast **Ubuntu 16.04/18.04**, **Debian 9**, **Red Hat Enterprise Linux (RHEL) 8**och **CentOS 7/8** på följande målarkitekturer när de används med Linux:
        - x86
        - x64
        - ARM32
        - ARM64
...
# <a name="rhel-8-and-centos-78"></a>[RHEL 8 och CentOS 7/8](#tab/rhel-centos)
