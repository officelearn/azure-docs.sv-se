...
Låt oss ta en titt [`SpeechConfig`](https://docs.microsoft.com/cpp/cognitive-services/speech/speechconfig) på hur en skapas med hjälp av en nyckel och region.
