...
Låt oss ta en titt på hur en [`SpeechConfig`](https://docs.microsoft.com/cpp/cognitive-services/speech/speechconfig) skapas med hjälp av en nyckel och region.
...
Om du känner igen tal med enhetens standard mikrofon, så är det här [`SpeechRecognizer`](https://docs.microsoft.com/cpp/cognitive-services/speech/speechrecognizer) bör se ut så här:

```cpp
auto recognizer = SpeechRecognizer::FromConfig(config);
```

Om du vill ange enheten för ljud inspelning måste du skapa en [`AudioConfig`](https://docs.microsoft.com/cpp/cognitive-services/speech/audio-audioconfig) och ange parametern `audioConfig` när du initierar [`SpeechRecognizer`](https://docs.microsoft.com/cpp/cognitive-services/speech/speechrecognizer).

> [!TIP]
> [Lär dig hur du hämtar enhets-ID: t för din enhet för ljud inspelning](../../../how-to-select-audio-input-devices.md).

Lägg först till följande `using namespace`-instruktion efter `#include`-definitionerna.
...
[Igenkännings klassen](https://docs.microsoft.com/cpp/cognitive-services/speech/speechrecognizer) för tal-SDK: n C++ för visar några metoder som du kan använda för tal igenkänning.
...
Nu ska vi skapa en variabel för att hantera läget för tal igenkänning. För att kunna starta deklarerar vi en `promise<void>`, eftersom vi i början av igenkänningen kan anta att det inte är klart.

```cpp
promise<void> recognitionEnd;
```

Vi prenumererar på de händelser som skickas från [`SpeechRecognizer`](https://docs.microsoft.com/cpp/cognitive-services/speech/speechrecognizer).
...
Om du vill aktivera dikteringsläget använder du metoden [`EnableDictation`](https://docs.microsoft.com/cpp/cognitive-services/speech/speechconfig#enabledictation) på [`SpeechConfig`](https://docs.microsoft.com/cpp/cognitive-services/speech/speechconfig).
...
En vanlig uppgift för tal igenkänning anger språk för indata (eller källa). Låt oss ta en titt på hur du ändrar indatamängds språk till tyska. Leta upp [`SpeechConfig`](https://docs.microsoft.com/cpp/cognitive-services/speech/speechconfig)i koden och Lägg sedan till den här raden direkt under den.
...
Eventuella ändringar i [`PhraseListGrammar`](https://docs.microsoft.com/cpp/cognitive-services/speech/phraselistgrammar) börjar gälla nästa igenkänning eller efter en åter anslutning till tal-tjänsten.
