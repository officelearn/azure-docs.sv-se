...
ms.locfileid: "75660534"
---
## <a name="prerequisites"></a>Krav

Innan du börjar:

* Om det här är ditt första python-projekt använder du den här guiden för att <a href="../quickstarts/create-project.md" target="_blank">skapa ett tomt exempel projekt</a>.
* <a href="../quickstarts/setup-platform.md" target="_blank">Installera Speech SDK för din utvecklings miljö</a>.
