---
title: 'Snabb start: tal-SDK för C# .NET Core Platform-konfiguration – tal tjänst'
titleSuffix: Azure Cognitive Services
description: Använd den här guiden för att konfigurera din plattform för C# under .NET Core på Windows eller macOS med tjänsten Speech service SDK.
