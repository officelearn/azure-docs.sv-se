---
title: 'Snabb start: Översätt tal-till-text, C# (.NET Core Windows) – tal service'
...
1. Ersätt strängen `YourServiceRegion` med [regionen](~/articles/cognitive-services/Speech-Service/regions.md).
