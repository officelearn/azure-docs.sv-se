...
ms.locfileid: "73503362"
---
## <a name="prerequisites"></a>Förutsättningar

* En Azure-prenumerations nyckel för tal tjänsterna. [Skaffa en kostnadsfritt](~/articles/cognitive-services/Speech-Service/get-started.md).
