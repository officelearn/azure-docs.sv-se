...
| `speechToText.verification.enabled` | Om funktionen för **tal-till-text** -tjänsten är aktive rad. `helm test` | `true` |
...
| `textToSpeech.verification.enabled` | Om funktionen för **tal-till-text** -tjänsten är aktive rad. `helm test` | `true` |
