...
description: 'Tal tjänsterna är arbetskonton av tal-till-text, text till tal och tal översättning till en enda Azure-prenumeration. Lägg till tal till program, verktyg och enheter med tal-SDK, tal enheter SDK eller REST API: er.'
...
> [!IMPORTANT]
> Tal tjänster har ersatt API för Bing-taligenkänning, Translator Speech och Custom Speech. Se _instruktions guider > migrering_ för instruktioner om migrering.
