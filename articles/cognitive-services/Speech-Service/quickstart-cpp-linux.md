---
title: 'Snabbstart: Känna igen tal i C++ på Linux med hjälp av Speech Service SDK'
titleSuffix: Azure Cognitive Services
description: Lär dig hur du känner igen tal i C++ på Linux med hjälp av Speech Service SDK
