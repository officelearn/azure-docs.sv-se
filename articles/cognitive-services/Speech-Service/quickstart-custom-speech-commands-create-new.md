...
Nu kan du skapa ett kommando. Vi använder ett exempel som tar en enskild uttryck, `turn on the tv`och svarar på meddelandet. `Ok, turning on the TV`
...
1. Skapa en ny regel för slut för ande `+` genom att välja ikonen bredvid regler för slut för ande
1. Ange regel namnet
