...
Programmet baseras på tal SDK Maven-paketet, version 1.5.0 och Android Studio 3.3.
...
1. I fönstret som visas anger du namnet och versionen av vårt Speech SDK för Android, `com.microsoft.cognitiveservices.speech:client-sdk:1.5.0`. Välj sedan **OK**.
