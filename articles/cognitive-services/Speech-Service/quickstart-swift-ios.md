---
title: 'Snabb start: identifiera tal, Swift-tal-tjänst'
...
1. Lägg till den relativa sökvägen `helloworld/MicrosoftCognitiveServicesSpeech-Bridging-Header.h` till interimskontot för överbryggning till SWIFT-projekt inställningarna för målet HelloWorld i **huvud fältet mål-C-bryggning** .

   ![Rubrik egenskaper](media/sdk/qs-swift-ios-bridging-header.png)
