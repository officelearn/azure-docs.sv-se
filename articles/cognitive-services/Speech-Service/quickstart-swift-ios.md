...
ms.locfileid: "67467434"
---
# <a name="quickstart-recognize-speech-in-swift-on-ios-using-the-speech-sdk"></a>Snabbstart: Känna igen tal i Swift på iOS med hjälp av tal-SDK

[!INCLUDE [Selector](../../../includes/cognitive-services-speech-service-quickstart-selector.md)]

I den här artikeln får du lära dig hur du skapar en app för iOS i Swift med hjälp av Cognitive Services tal SDK för att transkribera tal som registrerats från en mikrofon till text.
...
Cognitive Services tal SDK för iOS distribueras som ett framework-paket.
