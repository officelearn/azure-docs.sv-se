...
ms.locfileid: "71803959"
---
# <a name="quickstart-synthesize-speech-in-swift-on-ios-using-the-speech-sdk"></a>Snabbstart: Syntetisera tal i SWIFT på iOS med hjälp av tal-SDK

Snabb Starter är också tillgängliga för [tal igenkänning](quickstart-swift-ios.md).
