...
description: 'I den här snabb starten ska du använda tal-SDK: n för att identifiera tal från ljuddata som fångats från en mikrofon.'
...
---
# <a name="quickstart-recognize-speech-intents-and-entities-with-language-understanding-luis"></a>Snabb start: identifiera tal, avsikter och entiteter med Language Understanding (LUIS)
