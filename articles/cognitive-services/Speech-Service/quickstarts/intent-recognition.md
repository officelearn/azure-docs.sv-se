---
title: Snabb start för avsikts igenkänning – tal tjänst
titleSuffix: Azure Cognitive Services
description: I den här snabb starten använder du avsikts igenkänning för att interaktivt identifiera insikter från ljud data som fångats från en mikrofon.
...
ms.locfileid: "91283078"
---
# <a name="get-started-with-intent-recognition"></a>Kom igång med avsikts igenkänning
