---
title: 'Snabbstart: Känna igen tal, avsikter och entiteter - Taltjänst'
titleSuffix: Azure Cognitive Services
description: I den här snabbstarten ska du använda Speech SDK för att interaktivt känna igen tal från ljuddata som hämtats från en mikrofon.
...
ms.locfileid: "76900542"
---
# <a name="quickstart-recognize-speech-intents-and-entities-with-language-understanding-luis"></a>Snabbstart: Känna igen tal, avsikter och entiteter med språkförståelse (LUIS)
