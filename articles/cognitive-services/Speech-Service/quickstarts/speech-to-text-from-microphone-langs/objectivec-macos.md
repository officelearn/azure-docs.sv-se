---
title: 'Snabb start: identifiera tal, mål-C-Speech service (macOS)'
titleSuffix: Azure Cognitive Services
description: Lär dig hur du skapar en app för att identifiera tal i mål-C för en macOS-dator med hjälp av Cognitive Services Speech SDK.
