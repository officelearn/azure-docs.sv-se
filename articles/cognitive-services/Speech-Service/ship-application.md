---
title: Azure Cognitive Services och Cognitive Services SDK API för taligenkänning dokumentation – självstudier, API-referens | Microsoft Docs
