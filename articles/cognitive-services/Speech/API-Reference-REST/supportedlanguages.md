...
|Kod | Språk | Kod | Språk |
|-----|-----|-----|-----|
| ar-t.ex. | Arabiska (Egypten), moderna standard | Hej Indien | Hindi (Indien) |
| CA-ES | Katalanska (Spanien) | IT-IT | Italienska (Italien)  |
| da-DK | Danska (Danmark) | ja-JP | Japanska (Japan) |
| de-DE | Tyska (Tyskland) |ko-KR | Koreanska (Korea) |
