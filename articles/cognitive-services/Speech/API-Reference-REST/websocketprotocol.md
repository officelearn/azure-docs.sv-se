...
Klienter *måste* stöd för omdirigering av standard-mekanismer som anges av den [HTTP-protokollspecifikation](https://www.w3.org/Protocols/rfc2616/rfc2616.html).
