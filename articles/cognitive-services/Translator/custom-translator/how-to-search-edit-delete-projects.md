...
1.  Du kan filtrera efter alla (eller alla) av följande fält: projekt namn, status, käll språk, mål språk och kategori.

2.  Klicka på Använd.

    ![Sök efter projekt filter alternativ](media/how-to/how-to-search-project-filters.png)

3.  Ta bort filtret om du vill visa alla dina projekt genom att trycka på "Rensa".
...
2.  I dialog rutan kan du ändra projekt namnet eller projekt beskrivningen, men inte ändra projekt etiketten, kategorin eller språk paret.

    ![Dialog rutan Redigera projekt](media/how-to/how-to-edit-project-dialog.png)

3.  Klicka på filter knappen.

## <a name="delete-a-project"></a>Ta bort ett projekt

Du kan ta bort ett projekt när du inte längre behöver det. Stegen nedan beskriver hur du tar bort ett projekt.
