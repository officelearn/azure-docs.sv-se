...
I- `DetectTextRequest()`klassen skapar du en funktion som heter. `Program` Den här klassen kapslar in den kod som används för att anropa Detect-resursen och skriver ut resultatet till konsolen.
