...
Den globala slut punkten för översättare har angetts som `endpoint` . `path` anger `detect`-vägen och identifierar att vi vill nå version 3 av API:et.
