...
Skapa ett nytt projekt med din favorit-IDE eller redigerare eller skapa en ny mapp på skrivbordet. Kopiera kodavsnittet till projektet/mappen till en `alt-translations.js`fil med namnet .
