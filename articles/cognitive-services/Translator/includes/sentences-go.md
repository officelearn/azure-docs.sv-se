...
>[!NOTE]
> Mer information om slutpunkter, vägar och parametrar för begäran finns i [Translator Text API 3.0: BreakSentence](https://docs.microsoft.com/azure/cognitive-services/translator/reference/v3-0-break-sentence).
