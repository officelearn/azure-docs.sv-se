...
Lägg till följande rader i klassen `BreakSentence`. Först läs-tangenten och slutpunkten från miljövariabler. Sedan kommer du att märka `api-version`att tillsammans med , du kan definiera inmatningsspråket. I det här exemplet är det engelska.
