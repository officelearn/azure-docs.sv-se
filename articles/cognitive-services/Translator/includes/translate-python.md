...
Skapa ett nytt Python-projekt med valfri IDE eller redigeringsprogram. Kopiera sedan det här kodavsnittet till projektet i en fil med namnet `translate-text.py`. Se till att din IDE:s tolk refererar till rätt version av Python för att undvika att bibliotek inte känns igen.
