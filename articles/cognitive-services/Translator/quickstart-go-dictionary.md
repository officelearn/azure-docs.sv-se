...
Skapa ett nytt Go-projekt med hjälp av din favorit-IDE / redigerare eller ny mapp på skrivbordet. Kopiera det här kodfragmentet till ditt projekt/mapp i en fil med namnet `alt-translations.go`.
