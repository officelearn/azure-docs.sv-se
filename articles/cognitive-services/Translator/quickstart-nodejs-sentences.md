...
ms.locfileid: "49644929"
---
# <a name="quickstart-get-sentence-lengths-with-the-translator-text-rest-api-nodejs"></a>Snabbstart: Hämta meningslängder med Translator Text REST API (Node.js)
