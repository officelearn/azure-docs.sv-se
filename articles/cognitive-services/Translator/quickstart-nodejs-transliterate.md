---
title: Konvertera text från skript med hjälp av Translator Text och Node.js | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: I den här snabbstarten ska du konvertera text i ett språk från ett skript till ett annat med hjälp av Translator Text-API:et med Node.js i Cognitive Services.
...
ms.locfileid: "43770831"
---
# <a name="quickstart-transliterate-text-with-nodejs"></a>Snabbstart: Transkribera text med Node.js
