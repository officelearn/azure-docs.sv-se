---
title: 'Snabbstart: Hämta meningslängder, PHP – Translator Text API'
titleSuffix: Azure Cognitive Services
description: I den här snabbstarten ska du hämta längden på meningar i text med hjälp av Translator Text-API:et med PHP.
...
ms.locfileid: "57542734"
---
# <a name="quickstart-get-sentence-lengths-with-the-translator-text-rest-api-php"></a>Snabbstart: Hämta meningslängder med Translator Text REST API (PHP)
