---
title: 'Snabbstart: Översätta text, Python – Translator Text API'
...
I den här snabbstarten lär du dig att översätta en textsträng från engelska till italienska och tyska med hjälp av Python och Translator Text REST API.
...
>[!TIP]
> Om du vill att all kod på samma gång källkoden för det här exemplet är tillgänglig i [GitHub](https://github.com/MicrosoftTranslator/Text-Translation-API-V3-Python).
...
Skapa ett nytt Python-projekt med valfri IDE eller redigeringsprogram. Kopiera sedan det här kodavsnittet till projektet i en fil med namnet `translate-text.py`. Var noga med att din IDE-tolk refererar till rätt version av Python för att undvika bibliotek som inte tolkats.
