---
title: 'Snabbstart: Konvertera textskript, Python – Translator Text API'
...
ms.locfileid: "49647457"
---
# <a name="quickstart-transliterate-text-with-the-translator-text-rest-api-python"></a>Snabbstart: Translitterera text med Translator Text REST API (Python)
