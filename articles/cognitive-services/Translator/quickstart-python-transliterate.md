...
description: I den här snabbstarten lär du dig hur du transkriberar (konverterar) text från ett skript till ett annat med hjälp av Python och Translator Text REST API. I det här exemplet translittereras japanska med det latinska alfabetet.
...
ms.locfileid: "50247886"
---
# <a name="quickstart-use-the-translator-text-api-to-transliterate-text-using-python"></a>Snabbstart: Använda Translator Text API för att transkribera en sträng med hjälp av Python

I den här snabbstarten lär du dig hur du transkriberar (konverterar) text från ett skript till ett annat med hjälp av Python och Translator Text REST API. I det angivna exemplet translittereras japanska med det latinska alfabetet.
...
Skapa ett nytt Python-projekt med valfri IDE eller redigeringsprogram. Kopiera sedan det här kodavsnittet till projektet i en fil med namnet `transliterate-text.py`.
...
>[!NOTE]
> Mer information om slutpunkter, vägar och begärandeparametrar finns i [Translator Text API 3.0: Transkribera](https://docs.microsoft.com/azure/cognitive-services/translator/reference/v3-0-transliterate).
