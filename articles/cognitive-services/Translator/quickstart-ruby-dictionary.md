---
title: 'Snabbstart: Hitta alternativa översättningar, Ruby – Translator Text-API'
...
ms.locfileid: "49649626"
---
# <a name="quickstart-find-alternate-translations-with-the-translator-text-rest-api-ruby"></a>Snabbstart: Hitta alternativa översättningar med Translator Text REST API (Ruby)
