...
description: Beskriver programmerings elementen i Bing-API för lokal affärs sökning.
...
|<a name="offset"/>redovisningsmotkonto|Indexet att starta resultat som anges av `count` parametern.|Integer|Nej|  
|<a name="query" />c|Användarens sökterm.|Sträng|Nej|  
