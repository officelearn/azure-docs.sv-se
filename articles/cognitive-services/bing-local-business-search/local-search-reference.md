...
|<a name="error-subcode" />under kod|Felkoden som identifierar felet. Om `code` till exempel är InvalidRequest, `subCode` kan vara ParameterInvalid eller ParameterInvalidValue. |Sträng|  
