...
ms.locfileid: "35354132"
---
# <a name="tutorial-visual-search-single-page-web-app"></a>Självstudier: Visual Sök Single-page-Webbapp

Detta är klar källkoden som beskrivs i den [Visual Sök Single-page webbprogrammet](tutorial-bing-visual-search-single-page-app.md) självstudiekurs för Bing Visual sökning. Kör appen genom att kopiera källkoden i anteckningar eller något annat textredigeringsprogram och spara den som `bing-visual-search.html`. Öppna sedan den sparade filen i Microsoft Edge eller en annan populära webbläsare.
