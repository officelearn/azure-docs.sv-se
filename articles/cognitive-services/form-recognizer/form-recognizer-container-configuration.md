...
Använd bind-monteringar för att läsa och skriva data till och från behållaren. Du kan ange en inmatnings montering eller en utmatnings montering genom att ange alternativet `--mount` i [`docker run` kommandot](https://docs.docker.com/engine/reference/commandline/run/).
