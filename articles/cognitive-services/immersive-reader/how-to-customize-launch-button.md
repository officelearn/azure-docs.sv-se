...
SDK för avancerad läsare tillhandahåller standardformat för knappen som startar den fördjupade läsaren. Använd attributet `immersive-reader-button` Class för att aktivera den här formateringen.
