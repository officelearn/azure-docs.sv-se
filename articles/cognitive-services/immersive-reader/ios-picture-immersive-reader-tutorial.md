...
I den här självstudien skapar du en iOS-app från grunden och integrerar Read API och den fördjupade läsaren med hjälp av SDK för avancerad läsare. Ett komplett fungerande exempel på den här själv studie kursen finns [här](https://github.com/microsoft/immersive-reader-sdk/iOS/samples/picture-to-immersive-reader-swift).
...
3.  Lägg till CocoaPod till din Podfile genom att `pod 'immersive-reader-sdk', :path => 'https://github.com/microsoft/immersive-reader-sdk/iOS/immersive-reader-sdk'`lägga till. Din Podfile bör se ut så här, med målets namn, vilket ersätter Picture-to-intensivare-Reader-Swift:
 ```ruby
  platform :ios, '9.0'
