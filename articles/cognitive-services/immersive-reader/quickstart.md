---
title: 'Snabb start: skapa en webbapp som startar den fördjupade läsaren med C #'
...
---
# <a name="quickstart-create-a-web-app-that-launches-the-immersive-reader-c"></a>Snabb start: skapa en webbapp som startar den fördjupade läsaren (C#)
...
Nu ska vi konfigurera kontrollanten för att hämta Azure AD-värden från _hemligheter. JSON_. Lägg till följande kod högst upp i _HomeController_ - ```public class HomeController : Controller {```klassen.
...
Börja med att öppna _Views\Shared\Layout.cshtml_. Lägg till följande ```</head>```kod innan raden:
