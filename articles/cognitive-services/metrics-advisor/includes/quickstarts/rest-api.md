...
> [!TIP]
> * Du kan hitta ett python-exempel som använder REST API på [GitHub](https://github.com/Azure-Samples/cognitive-services-rest-api-samples/).
...
> * Efter distributionen kan du börja använda Metrics Advisor-instansen med webb portalen och REST API. Du hittar båda URL: erna i den resurs som du har skapat.
> * Du behöver nyckeln och slut punkten från den resurs som du skapar för att börja använda tjänsten, som finns i **nycklar och slut punkt**, i din resurs. Du klistrar in nyckeln och slut punkten i koden nedan i snabb starten.
