...
Följande kod går igenom en cykel som ber användaren att ange sina inställningar på kommando raden, vilket innebär att informationen skickas till Personanpassare för att välja den bästa åtgärden, vilket visar valet för kunden att välja bland listan och sedan skicka en belönings poäng till En personanpassa signalering av hur bra tjänsten gjorde i valet.
