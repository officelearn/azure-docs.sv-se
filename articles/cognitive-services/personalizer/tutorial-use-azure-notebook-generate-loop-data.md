...
Antecknings boken väljer en slumpmässig användare, tid på dag och typ av väder från data uppsättningen. En sammanfattning av användar informationen är:
...
I början av det operativ system som körs, lyckas förslagen från Personanpassan bara mellan 20% och 30% (anges av belönings poängen på 1). Efter vissa begär Anden förbättras systemet.

Efter de första 10 000-begärandena kör du en offline-utvärdering. Detta gör att en Personanpassare kan granska data och föreslå en bättre inlärnings princip. Tillämpa den nya inlärnings principen och kör antecknings boken igen med 2 000-begäranden. Slingan fungerar bättre.
...
* Sammanhang – ett slumpmässigt val av användare, väder och tid på dagen – simulera en användare på en webbplats eller mobil enhet
* Funktioner – _alla_ kaffe data – från vilka personligare gör ett förslag

Systemet tar emot rankningen av kaffe valen och jämför sedan förutsägelsen med användarens kända val för samma tid på dag och väder. Om det kända valet är samma som det förväntade valet, skickas **belöningen** 1 tillbaka till personanpassaren. Annars är belöningen 0. 
