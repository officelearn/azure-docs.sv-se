...
| Funktion                                                         | NER v 3.0 | NER v 3.1 – för hands version. 1 |
|-----------------------------------------------------------------|--------|----------|
...
Namngiven entitets igenkänning v 3.1 – för hands version. 1 innehåller identifierings funktionerna i v 3.0 och möjligheten att identifiera personlig information ( `PII` ) med `v3.1-preview.1/entities/recognition/pii` slut punkten. Du kan använda den valfria `domain=phi` parametern för att identifiera konfidentiell hälso information ( `PHI` ). Mer information finns i avsnittet [enhets kategorier](../named-entity-types.md) artikeln och avsnittet om att [begära slut punkter](#request-endpoints) nedan.
...
#### <a name="version-31-preview1"></a>[Version 3,1 – för hands version. 1](#tab/version-3-preview)

Igenkänning av namngivna enheter `v3.1-preview.1` använder separata slut punkter för ner och begär Anden om enhets länkning. Använd ett URL-format nedan baserat på din begäran:

Länkning av entitet
* `https://<your-custom-subdomain>.cognitiveservices.azure.com/text/analytics/v3.1-preview.1/entities/linking`

NER
* Allmänna entiteter –`https://<your-custom-subdomain>.cognitiveservices.azure.com/text/analytics/v3.1-preview.1/entities/recognition/general`

* Personlig ( `PII` ) information –`https://<your-custom-subdomain>.cognitiveservices.azure.com/text/analytics/v3.1-preview.1/entities/recognition/pii`
