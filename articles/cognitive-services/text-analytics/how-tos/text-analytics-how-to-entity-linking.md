...
Nästa version av namngiven enhets igenkänning är nu tillgänglig för offentlig för hands version. Den ger uppdateringar för både entitets-och enhets identifiering. Prova att använda [API-test konsolen](https://westus.dev.cognitive.microsoft.com/docs/services/TextAnalytics-v3-0-Preview-1/operations/EntitiesRecognitionGeneral).
