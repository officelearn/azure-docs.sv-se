...
Etiketterna är `positive` , `negative` och `neutral` . På dokument nivå `mixed` kan du också returnera sentiment-etiketten. Sentiment för dokumentet fastställs nedan:
