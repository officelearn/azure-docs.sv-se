---
title: Språkidentifiering Kubernetes config och distribuera steg
titleSuffix: Azure Cognitive Services
description: Språkidentifiering Kubernetes config och distribuera steg
...
ms.locfileid: "78262268"
---
### <a name="deploy-the-language-detection-container-to-an-aks-cluster"></a>Distribuera behållaren för språkidentifiering till ett AKS-kluster
...
1. Skapa en ny fil med namnet *language.yaml*i textredigeraren och klistra in följande YAML i den. Var noga `billing/value` med `apikey/value` att ersätta och med din egen information.
...
1. Kör kommandot Kubernetes `apply` med filen *language.yaml* som mål:
...
1. Kontrollera att tjänsten är tillgänglig och hämta IP-adressen.
    ...
    Utdata för *språktjänstens* körstatus i podden:
