...
[Referens dokumentation](https://docs.microsoft.com/javascript/api/overview/azure/cognitiveservices/textanalytics?view=azure-node-latest) | [bibliotek käll kods](https://github.com/Azure/azure-sdk-for-node/tree/master/lib/services/cognitiveServicesTextAnalytics) | [paket (NPM)](https://www.npmjs.com/package/azure-cognitiveservices-textanalytics) | [exempel](https://github.com/Azure-Samples/cognitive-services-node-sdk-samples/)
...
`ms-rest-azure` Installera och `azure-cognitiveservices-textanalytics` NPM-paketen:
