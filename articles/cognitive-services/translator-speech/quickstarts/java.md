---
title: Java Snabbstartsguide för Azure kognitiva Services, Microsoft Translator tal API | Microsoft Docs
...
ms.locfileid: "35352200"
---
# <a name="quickstart-for-microsoft-translator-speech-api-with-java"></a>Snabbstart för Microsoft Translator tal API med Java 
<a name="HOLTop"></a>
...
Du behöver den [javax.websocket-api-1.1.jar](http://central.maven.org/maven2/javax/websocket/javax.websocket-api/1.1/) och [tyrus-fristående-klient-1.9.jar](http://repo1.maven.org/maven2/org/glassfish/tyrus/bundles/tyrus-standalone-client/1.9/) filer.
