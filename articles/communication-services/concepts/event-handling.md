---
title: Händelsehantering
titleSuffix: An Azure Communication Services concept document
description: Använd Azure Event Grid för att utlösa processer baserat på åtgärder som inträffar i en kommunikations tjänst.
author: mikben
manager: jken
...
| Rubrik | Beskrivning |
| --- | --- |
| [Hur hanterar SMS-händelser i kommunikations tjänster](../quickstarts/telephony-sms/handle-sms-events.md) | Hantering av alla SMS-händelser som tagits emot av kommunikations tjänsten med webhook. |
