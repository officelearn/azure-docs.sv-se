...
Du måste först välja den `Country/region` plats där du vill etablera telefonnumret. När du har valt land/region måste du välja den `use case` som bäst motsvarar dina behov. 
...
### <a name="customizing-phone-number-plans"></a>Anpassa telefon nummer planer
