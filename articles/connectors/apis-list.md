...
| --- | --- | --- | --- |
| [![API Icon][xmlvalidateicon]<br/>**XML-<br/>verifiering**][xmlvalidatedoc] |[![API Icon][xmltransformicon]<br/>**XML-<br/>transformering**][xmltransformdoc] |[![API Icon][flatfileicon]<br/>**Flatfils</br>kodning**][flatfiledoc] |[![API Icon][flatfiledecodeicon]<br/>**Flatfils</br>avkodning**][flatfiledecodedoc] |
