...
> [!NOTE]
> Logic Apps tillämpar TLS (Transport Layer Security) 1.2 när du tar emot samtalet tillbaka till HTTP webhook-utlösaren eller åtgärden. Om du ser TLS handskakningsfel kontrollerar du att du använder TLS 1.2. För inkommande samtal, här är de chiffersviter som stöds:
>
