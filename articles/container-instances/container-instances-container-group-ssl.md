...
Ange innehållet i base64-kodade filer som anges under `secret`. Till exempel `cat` var och en av de base64-kodade filerna för att se dess innehåll. Under distributionen läggs de här filerna till i en [hemlig volym](container-instances-volume-secret.md) i behållar gruppen. I det här exemplet monteras den hemliga volymen till behållaren nginx.
