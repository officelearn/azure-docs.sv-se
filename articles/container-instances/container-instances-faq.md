---
title: Vanliga frågor och svar om Azure Container Instances
...
Du bör också kontrol lera listan över cachelagrade avbildningar i Azure Container images, som är [](/rest/api/container-instances/listcachedimages) tillgängliga via API: et för cachelagrade avbildningar. Du kanske kan byta ut ett bild lager för en av de förcachelagrade bilderna. 
...
Du kan distribuera behållar grupper i ett virtuellt Azure-nätverk och delegera privata IP-adresser till behållar grupper för att dirigera trafik i VNet över dina Azure-resurser. Distribution av en behållar grupp i ett virtuellt nätverk är för närvarande en för hands version och vissa aspekter av den här funktionen kan ändras före allmän tillgänglighet (GA). Se [begränsningar](container-instances-vnet.md#preview-limitations) för förhands granskning för uppdaterad information.
