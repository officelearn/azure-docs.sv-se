...
Windows-behållare kan tillkomma ingen inkommande eller utgående anslutning för upp till 5 sekunder på Skapa. Efter den första konfigurationen återupptas nätverk för behållare på rätt sätt.
