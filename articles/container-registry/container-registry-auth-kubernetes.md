...
Den här artikeln förutsätter att du redan har skapat ett privat Azure Container Registry. Du måste också ha ett Kubernetes-kluster som kör och är tillgängligt via kommando rads verktyget `kubectl`.
...
När du har skapat bildens pull-hemlighet kan du använda den för att skapa Kubernetes-poddar och-distributioner. Ange namnet på hemligheten under `imagePullSecrets` i distributions filen. Några exempel:
