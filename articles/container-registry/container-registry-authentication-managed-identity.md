...
Om du inte redan har ett Azure Container Registry kan du skapa ett register och skicka en exempel behållar avbildning till den. Anvisningar finns i [snabb start: Skapa ett privat behållar register med hjälp](container-registry-get-started-azure-cli.md)av Azure CLI.
