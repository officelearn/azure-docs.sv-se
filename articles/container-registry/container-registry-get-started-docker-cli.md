...
Use [docker tag](https://docs.docker.com/engine/reference/commandline/tag/) to create an alias of the image with the fully qualified path to your registry. I det här exemplet anges `samples`-namnområdet för att undvika oreda i registrets rot.
