...
Båda kommandona returnerar `Login Succeeded` när de har slutförts.
...
Kör följande [Docker-körnings](https://docs.docker.com/engine/reference/run/) kommando för att starta en lokal instans av nginx-behållaren interaktivt (`-it`) på Port 8080. Argumentet `--rm` anger att behållaren ska tas bort när du avbryter den.
