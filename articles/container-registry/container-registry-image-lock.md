...
Om du vill låsa en avbildning av *myrepo/bild* som identifieras av manifest sammandrag (SHA-256-hash, som visas `sha256:...`), kör du följande kommando. (Om du vill hitta manifest sammandrag som är associerad med en eller flera bildtaggar kör du kommandot [AZ ACR-lagringsplats show-Manifests][az-acr-repository-show-manifests] .)
