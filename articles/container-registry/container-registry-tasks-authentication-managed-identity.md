...
Om du vill lägga till autentiseringsuppgifter för en användardefinierad identitet för att autentisera med registret *targetregistry*, skickar du `use-identity` ett värde för IDENTITETENS *klient-ID* . Exempel:
