...
Använd [AZ AD SP Create-for-RBAC][az-ad-sp-create-for-rbac] command to create the service principal, and [az keyvault secret set][az-keyvault-secret-set] för att lagra tjänstens huvud namn **i** valvet:
