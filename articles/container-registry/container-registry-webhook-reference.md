...
|-------------|----------|-----------|
|`id`|Sträng|The ID of the webhook event.|
|`timestamp`|DateTime|The time at which the webhook event was triggered.|
|`action`|Sträng|The action that triggered the webhook event.|
...
|Element|Typ|Beskrivning|
|------------------|----------|-----------|
|`mediaType`|Sträng|The MIME type of the referenced object.|
|`size`|Int32|The number of bytes of the content. Same as Length field.|
|`digest`|Sträng|The digest of the content, as defined by the Registry V2 HTTP API Specification.|
|`length`|Int32|The number of bytes of the content. Same as Size field.|
|`repository`|Sträng|The repository name.|
|`tag`|Sträng|The image tag name.|

### <a name="request"></a>request

|Element|Typ|Beskrivning|
|------------------|----------|-----------|
|`id`|Sträng|The ID of the request that initiated the event.|
|`host`|Sträng|The externally accessible hostname of the registry instance, as specified by the HTTP host header on incoming requests.|
|`method`|Sträng|The request method that generated the event.|
|`useragent`|Sträng|The user agent header of the request.|
...
|`digest`|Sträng|The digest of the content, as defined by the Registry V2 HTTP API Specification.|
|`repository`|Sträng|The repository name.|
|`tag`|Sträng|The chart tag name.|
|`name`|Sträng|The chart name.|
|`version`|Sträng|The chart version.|
