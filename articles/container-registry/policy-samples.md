...
ms.locfileid: "84235664"
---
# <a name="azure-policy-built-in-policy-definitions-for-azure-container-registry"></a>Azure Policy inbyggda princip definitioner för Azure Container Registry

Den här sidan är ett index över [Azure policy](../governance/policy/overview.md) inbyggda princip definitioner för Azure Container Registry. Ytterligare Azure Policy inbyggda program för andra tjänster finns i [Azure policy inbyggda definitioner](../governance/policy/samples/built-in-policies.md).
