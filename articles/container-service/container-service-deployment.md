...
10. Klicka på **Köp** för att starta distributionsprocessen.
...
1. Om du vill distribuera ett DC/OS-, Docker Swarm- eller Kubernetes-kluster väljer du någon av nedanstående mallar från GitHub. 
...
2. Kontrollera därefter att Azure CLI har anslutits till en Azure-prenumeration. Det kan du göra med hjälp av följande kommando:
...
3. Konfigurera Azure CLI-verktygen för att använda Azure Resource Manager.

    ```bash
    azure config mode arm
    ```

4. Skapa en Azure-resursgrupp och ett Container Service-kluster med följande kommando, där:
...
1. För att distribuera ett DC/OS-, Docker Swarm- eller Kubernetes-kluster, väljer du en av följande mallar. Observera att båda de här mallarna är likadana, med undantag för standardvalet av orchestrator.
...
4. Om du distribuerar till en ny resursgrupp måste du först skapa resursgruppen. Skapa en ny resursgrupp genom att använda kommandot `New-AzureRmResourceGroup` och ange ett resursgruppnamn och en målregion:
