<properties
   pageTitle="Azure Container Service-hantering av behållare via REST API | Microsoft Azure"
...
## Samla in information från DC/OS och Marathon
...
## Använd PowerShell för den här övningen: Marathon REST API-interaktion med PowerShell
