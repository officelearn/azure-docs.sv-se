...
1. På sidan Sava/sava_cluster/webport- **gatewayer** klickar ![ du på vamp UI-Edit ](./media/container-service-dcos-vamp-canary-release/vamp_ui_edit.png) för att lägga till ett **villkor** i Route Sava/sava_cluster/Sava: 1.0.0/webport. 

2. Ange villkoret **User-Agent = = Firefox** och klicka på ![ vamp UI-Save ](./media/container-service-dcos-vamp-canary-release/vamp_ui_save.png) .
...
3. Klicka på ![ vamp UI-Edit ](./media/container-service-dcos-vamp-canary-release/vamp_ui_edit.png) för att ändra **styrkan** som tillämpas på villkoret.
