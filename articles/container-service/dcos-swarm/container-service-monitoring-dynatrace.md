...
1. Få åtkomst till ditt DC/OS-gränssnitt via `http://localhost:80/` . I användar gränssnittet för DC/OS går du till fliken **universum** och söker efter **dynaTrace**.
