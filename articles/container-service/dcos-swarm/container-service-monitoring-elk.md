...
Kom åt ditt DC/OS-gränssnitt via `http://localhost:80/` en gång i DC/OS-gränssnittet navigera till **universum**. Sök efter och installera ElasticSearch, Logstash och Kibana från DC/OS-universum och i den aktuella ordningen. Du kan läsa mer om konfigurationen om du går till den **avancerade installations** länken.
