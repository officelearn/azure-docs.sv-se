...
Kom åt ditt DC/OS-gränssnitt via `http://localhost:80/` en gång i DC/OS-gränssnittet navigera till "universum", som finns längst ned till vänster och Sök sedan efter "Sysdig".
