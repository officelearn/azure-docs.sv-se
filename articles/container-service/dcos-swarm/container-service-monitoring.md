...
Få åtkomst till ditt DC/OS-gränssnitt via `http://localhost:80/` . När du har aktiverat DC/OS-gränssnittet navigerar du till "universum" som finns längst ned till vänster och sedan söker efter "Datadog" och klickar på "installera".
