...
[Distribuera](container-service-deployment.md) och [anslut](../container-service-connect.md) ett kluster som konfigurerats av Azure Container Service. Utforska [Marathon-gränssnittet](container-service-mesos-marathon-ui.md). Gå till [https://datadoghq.com](https://datadoghq.com) om du vill konfigurera ett Datadog-konto. 
...
Få åtkomst till ditt DC/OS-gränssnitt via [http://localhost:80/](http://localhost:80/). När du har aktiverat DC/OS-gränssnittet navigerar du till "universum" som finns längst ned till vänster och sedan söker efter "Datadog" och klickar på "installera".
