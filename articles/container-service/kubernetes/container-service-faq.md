...
Det finns stöd för lösningar som är baserade på öppen källkod, som DC/OS, Docker Swarm och Kubernetes. Mer information finns i [Översikt](container-service-intro-kubernetes.md).
 
...
Beroende på ditt scenario kan du också skapa och hantera anpassade containerlösningar med andra Azure-tjänster. Till exempel med [Virtual Machines](../../virtual-machines/linux/overview.md), [Service Fabric](../../service-fabric/service-fabric-overview.md), [Web Apps](../../app-service/overview.md) och [Batch](../../batch/batch-technical-overview.md).  
...
Du kan skala antalet agenter i klustret med hjälp av Azure Portal eller kommandoradsverktygen. Se [Skala ett Azure Container Service-kluster](../../container-service/kubernetes/container-service-scale.md).
...
* [Läs mer](../../container-service/kubernetes/container-service-intro-kubernetes.md) om Azure Container Service.
* Distribuera ett containertjänstkluster med hjälp av [portalen](../../container-service/dcos-swarm/container-service-deployment.md) eller [Azure CLI](../../container-service/dcos-swarm/container-service-create-acs-cluster-cli.md).
