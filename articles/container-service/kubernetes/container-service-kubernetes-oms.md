...
Du kan också använda [Azure Cloud Shell](https://docs.microsoft.com/en-us/azure/cloud-shell/overview), som har den `az` Azure cli och `kubectl` verktyg som redan har installerat för du.  
