...
Om du kör [`az acs create`](/cli/azure/acs#az-acs-create) kommandot för att skapa Kubernetes-klustret kan du välja att generera ett huvud namn för tjänsten automatiskt.
...
Om dina autentiseringsuppgifter har upphört att gälla använder du kommandot [az ad sp reset-credentials](/cli/azure/ad/sp) för att uppdatera autentiseringsuppgifterna:
