---
title: Vanliga frågor om autoskalning-läge i Azure Cosmos DB
...
Med ett insamlat data flöde i autoskalning läge, kan Azure Cosmos DB automatiskt hantera och skala ru/s för din behållare eller databas baserat på användning. Den här artikeln besvarar vanliga frågor om autoskalning.

## <a name="frequently-asked-questions"></a>Vanliga frågor och svar

### <a name="is-autoscale-mode-supported-for-all-apis"></a>Stöds autoskalning läge för alla API: er?
Ja, autoskalning-läget stöds för alla API: er: Core (SQL), Gremlin, Table, Cassandra och API för MongoDB.

### <a name="is-autoscale-mode-supported-for-multi-master-accounts"></a>Stöds autoskalning läge för flera huvud konton?
Ja, autoskalning-läget stöds för flera huvud konton. Det högsta antalet RU/s är tillgängliga i varje region som läggs till i Cosmos-kontot. 
...
Autoskalning-läget kan aktive ras på nya behållare och databaser som skapats med hjälp av Azure Portal. 

### <a name="is-there-cli-or-sdk-support-to-create-containers-or-databases-with-autoscale-mode"></a>Finns det CLI-eller SDK-stöd för att skapa behållare eller databaser med autoskalning-läge?
För närvarande kan du bara skapa resurser med autoskalning-läget från Azure Portal. Stöd för CLI och SDK är inte tillgängligt ännu.
...
För närvarande kan du aktivera autoskalning på nya behållare och databaser när du skapar dem. Stöd för att aktivera autoskalning i befintliga behållare och databaser är ännu inte tillgängligt. Du kan migrera befintliga behållare till en ny behållare med [Azure Data Factory](../data-factory/connector-azure-cosmos-db.md) eller [ändra feed](change-feed.md). 

### <a name="can-i-turn-off-autoscale-mode-on-a-container-or-database"></a>Kan jag inaktivera autoskalning på en behållare eller databas?
Ja, du kan inaktivera autoskalning genom att växla till alternativet Manuell för det etablerade data flödet. I den aktuella versionen, efter växling från autoskalning till manuellt läge, kan du inte aktivera autoskalning igen för samma resurs. 

### <a name="is-autoscale-mode-supported-for-shared-throughput-databases"></a>Stöds autoskalning läge för delade data flödes databaser?
Ja, autoskalning-läget stöds för delade data flödes databaser. Om du vill aktivera den här funktionen väljer du autoskalning-läge och alternativet **etablera data flöde** när du skapar databasen. 
...
I autoskalning-läge kan du omedelbart skala upp eller ned RU/s inom det lägsta och högsta intervallet RU/s, baserat på inkommande trafik. Faktureringen görs med en precision på 1 timme, där du debiteras för flest RU/s inom en viss timme.

### <a name="can-i-specify-a-custom-max-throughput-rus-value-for-autoscale-mode"></a>Kan jag ange ett anpassat Max data flöde (RU/s)-värde för autoskalning-läge?
...
Ja. Från alternativet **skala & inställningar** för din behållare eller **skalnings** alternativ för din databas, kan du välja en högre max ru/s för autoskalning-läge. Det här är en asynkron skalnings åtgärd som kan ta en stund att slutföra (vanligt vis 4-6 timmar, beroende på vilka RU/s som valts) som tjänsten tillhandahåller fler resurser för att stödja större skala. 
...
* Lär dig mer om [fördelarna med ett allokerat data flöde i autoskalning-läge](provision-throughput-autoscale.md#autoscale-benefits).
