---
title: Med hjälp av Java-bibliotek för bulk-executor för att utföra massåtgärder i Azure Cosmos DB | Microsoft Docs
description: Använda Azure Cosmos DB bulk executor Java-bibliotek för att massregistrera importera och uppdatera dokument till Azure Cosmos DB-behållare.
