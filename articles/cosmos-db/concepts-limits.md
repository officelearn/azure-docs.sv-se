...
| Maximum number of distinct (logical) partition keys | Obegränsat |
| Maximum storage per container | Obegränsat |
| Maximum storage per database | Obegränsat |
...
| Resurs | Standardgräns |
| --- | --- |
| Maximum number of databases | Obegränsat |
| Maximum number of containers per database (or account) | Obegränsat |
