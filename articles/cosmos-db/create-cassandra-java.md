...
description: Den här snabb starten visar hur du använder Azure Cosmos DB API för Cassandra för att skapa ett profil program med Azure Portal och Java 3,0 SDK.
