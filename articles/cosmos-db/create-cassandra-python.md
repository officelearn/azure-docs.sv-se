...
- [Python Driver för Apache Cassandra](https://github.com/datastax/python-driver).
...
Det här steget är valfritt. Om du vill lära dig hur databasresurserna skapas i koden kan du granska följande kodavsnitt. Kodavsnitten hämtas alla från *pyquickstart.py* filen. Annars kan du gå vidare till [Uppdatera din anslutningssträng](#update-your-connection-string). 
...
1. Ladda ner Baltimore CyberTrust Root-certifikatet lokalt från [https://cacert.omniroot.com/bc2025.crt](https://cacert.omniroot.com/bc2025.crt). Byt namn på filen med filändelsen *.cer*.

   Certifikatet har serienummer `02:00:00:b9` och SHA1-fingeravtryck `d4🇩🇪20:d0:5e:66:fc:53:fe:1a:50:88:2c:78:db:28:52:ca:e4:74`.

2. Öppna *pyquickstart.py* och ändra `path\to\cert` för att peka på det nya certifikatet.
...
I den här snabbstarten lärde du dig hur du skapar ett Azure Cosmos DB-konto med Cassandra API och kör en Cassandra Python-app som skapar en Cassandra-databas och behållare. Du kan nu importera ytterligare data till ditt Azure Cosmos DB-konto. 
