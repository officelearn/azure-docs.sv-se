...
I den här snabbstarten visas hur du skapar ett Azure Cosmos DB-konto, en dokumentdatabas och en samling med hjälp av Azure Portal. Sedan skapar du och kör en konsolapp som är byggd med [DocumentDB Python API](../documentdb/documentdb-sdk-python.md).
...
> [Importera data till Azure Cosmos DB för DocumentDB-API](../documentdb/documentdb-import-data.md)
