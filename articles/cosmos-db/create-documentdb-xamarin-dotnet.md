...
Auktoriseringen och dataflödet visas i diagrammet nedan.
...
1. I [Azure Portal](http://portal.azure.com/) går du till ditt Azure Cosmos DB-konto. Klicka på **Nycklar** i det västra navigeringsfönstret och sedan på **läs- och skrivnycklar**. Du använder kopiera-knapparna till höger på skärmen för att kopiera URI:n och primärnyckeln i Web.config-filen i nästa steg.
    ...
    ![Visa och kopiera åtkomstnyckeln i Azure Portal, bladet Nycklar](./media/create-documentdb-xamarin-dotnet/keys.png)
...
5. Slutför självstudien [Så här konfigurerar du App Service-programmet för att använda Facebook-inloggning](../app-service-mobile/app-service-mobile-how-to-configure-facebook-authentication.md) för att konfigurera Facebook-autentisering och konfigurera ResourceTokenBroker-webbplatsen.
