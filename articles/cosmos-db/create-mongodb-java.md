...
ms.locfileid: "53793161"
---
# <a name="build-a-web-app-using-azure-cosmos-dbs-api-for-mongodb-and-java-sdk"></a>Skapa en webbapp med Azure Cosmos DB:s API för MongoDB och Java SDK
