...
![Azure Cosmos Account-entiteter](./media/databases-containers-items/cosmos-entities.png)
...
| --- | --- | --- | --- | --- | --- | --- |
|Räkna upp alla databaser| Ja | Ja | Ja (databasen är mappad till ett tecken utrymme) | Ja | Ej tillämpligt | Ej tillämpligt |
|Läs databas| Ja | Ja | Ja (databasen är mappad till ett tecken utrymme) | Ja | Ej tillämpligt | Ej tillämpligt |
|Skapa ny databas| Ja | Ja | Ja (databasen är mappad till ett tecken utrymme) | Ja | Ej tillämpligt | Ej tillämpligt |
|Uppdatera databas| Ja | Ja | Ja (databasen är mappad till ett tecken utrymme) | Ja | Ej tillämpligt | Ej tillämpligt |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
|\_id | Systemgenererad | Unikt ID för behållare | Ja | Nej | Nej | Nej | Nej |
...
|\_self | Systemgenererad | Adresser bara URI för behållaren | Ja | Nej | Nej | Nej | Nej |
...
| Systemdefinierad egenskap | Systemgenererad eller användare kan konfigureras| Syfte | API för SQL | API för Cassandra | API för Azure Cosmos DB för MongoDB | Gremlin-API | Tabell-API |
| --- | --- | --- | --- | --- | --- | --- | --- |
|\_id | Systemgenererad | Unikt ID för objektet | Ja | Nej | Nej | Nej | Nej |
|\_etag | Systemgenererad | Entity-taggen används för optimistisk concurrency-kontroll | Ja | Nej | Nej | Nej | Nej |
|\_ts | Systemgenererad | Tidsstämpel för den senaste uppdateringen av objektet | Ja | Nej | Nej | Nej | Nej |
|\_self | Systemgenererad | Adresser bara URI för objektet | Ja | Nej | Nej | Nej | Nej |
