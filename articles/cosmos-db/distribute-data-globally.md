...
Cosmos DB är en grundläggande Azure-tjänst och den är tillgänglig i alla [Azure-regioner](https://azure.microsoft.com/global-infrastructure/regions/) som standard. Microsoft fungerar Azure-datacenter i mer än 50 regioner över hela världen och fortsätter att för att möta de växande behov av kunderna. När du skapar en Cosmos DB-konto kan bestämma du vilken region som den ska distribueras i. Microsoft Driver Cosmos-DB-tjänsten 24/7, så du kan fokusera på dina program.
