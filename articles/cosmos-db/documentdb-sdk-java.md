...
description: "Lär dig mer om Java API och SDK inklusive frisläppningsdatum, tillbakadragning datum och ändringar mellan varje version av Azure Cosmos DB DocumentDB Java SDK."
services: cosmos-db
...
<tr><td>**Kom igång**</td><td>[Kom igång med Java SDK](documentdb-java-get-started.md)</td></tr>
...
> [!WARNING]
> Alla versioner av DocumentDB SDK för Java före version **1.0.0** ska tas bort på **29 februari 2016**.
> 
> 
