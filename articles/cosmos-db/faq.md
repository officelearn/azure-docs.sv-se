...
Du kan använda ett tilläggsbibliotek för att använda funktionerna i Graph API. Det här biblioteket kallas Microsoft Azure-diagram och den är tillgänglig på NuGet. 
