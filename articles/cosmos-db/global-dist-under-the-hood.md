...
Cosmos DB: s global distribution förlitar sig på två viktiga abstraktioner – --replikuppsättningar och partition uppsättningar. En replikuppsättning är en modulbaserad Lego-block för samordning och en partitionsuppsättning är ett dynamiskt överlägg på en eller flera geografiskt distribuerade resurspartitioner. Att förstå hur globala distributionen fungerar finns det viktigt att förstå dessa två viktiga abstraktioner. 
