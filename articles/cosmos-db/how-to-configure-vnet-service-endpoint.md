---
title: Konfigurera Virtual Network och Subnet-based Access för ditt Azure Cosmos DB-konto
...
Du kan konfigurera Azure Cosmos DB konton för att tillåta åtkomst från ett speciellt undernät i ett virtuellt Azure-nätverk. Så här begränsar du åtkomsten till ett Azure Cosmos DB konto med anslutningar från ett undernät i ett virtuellt nätverk:
