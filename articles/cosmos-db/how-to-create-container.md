...
### <a id="dotnet-mongodb">MongoDB-API</a>
...
> [!Note]
> MongoDB har inget koncept för begäransenheter. Använd Azure-portalen eller SQL API för att skapa en ny samling med dataflöde, som visas i föregående exempel.
