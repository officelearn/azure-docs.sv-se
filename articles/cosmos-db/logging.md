...
Azure Cosmos DB-loggarna för den **DataPlaneRequests** kategori lagras i den **insights-logs-dataplanerequests** behållare i lagringskontot som du angav. 
