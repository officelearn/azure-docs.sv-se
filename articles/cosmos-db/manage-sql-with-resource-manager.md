...
ms.locfileid: "65077762"
---
# <a name="create-azure-cosmos-db-core-sql-api-resources-from-a-resource-manager-template"></a>Skapa Azure Cosmos DB Core (SQL) API-resurser från en Resource Manager-mall

Lär dig hur du skapar ett Azure Cosmos DB-resurser med hjälp av en Azure Resource Manager-mall. I följande exempel skapas ett Azure Cosmos DB-konto från en [Azure-snabbstartsmall](https://aka.ms/sql-arm-qs). Den här mallen skapar ett Azure Cosmos-konto med två behållare som delar 400 RU/s genomströmning på databasnivå.
