...
description: Hämta Azure PowerShell exempel för att utföra olika vanliga uppgifter i Azure Cosmos DB API för Cassandra konton
author: markjbrown
...
Följande tabell innehåller länkar till exempel Azure PowerShell skript för Azure Cosmos DB för API för Cassandra.
...
|[Hämta RU/s](scripts/powershell/cassandra/ps-cassandra-ru-get.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Hämta RU/s för ett tecken utrymme eller en tabell. |
|[Uppdatera RU/s](scripts/powershell/cassandra/ps-cassandra-ru-update.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Uppdatera RU/s för ett tecken utrymme eller en tabell. |
...
|[Lås resurser från borttagning](scripts/powershell/cassandra/powershell-cassandra-lock.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Förhindra att resurser tas bort med resurs lås. |
|||
