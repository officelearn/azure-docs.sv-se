---
title: Skapa ett Cassandra-nyckel utrymme och en tabell med autoskalning för Azure Cosmos DB
description: Skapa ett Cassandra-nyckel utrymme och en tabell med autoskalning för Azure Cosmos DB
author: markjbrown
ms.author: mjbrown
...
ms.locfileid: "94566443"
---
# <a name="create-an-azure-cosmos-cassandra-api-account-keyspace-and-table-with-autoscale-using-azure-cli"></a>Skapa ett Azure-Cosmos API för Cassandra konto, nyckel utrymme och tabell med autoskalning med hjälp av Azure CLI
