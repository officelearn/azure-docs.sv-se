---
title: Skapa en SQL-API-databas och -behållare (Core) för Azure Cosmos DB
description: Skapa en SQL-API-databas och -behållare (Core) för Azure Cosmos DB
author: markjbrown
ms.author: mjbrown
...
---
# <a name="create-an-azure-cosmos-sql-core-api-account-database-and-container-using-azure-cli"></a>Skapa ett Azure Cosmos SQL-API-konto, databas och behållare med Azure CLI
