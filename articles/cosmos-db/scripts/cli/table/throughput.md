...
Det här skriptet skapar en tabell-API-tabell och uppdaterar sedan dataflödet i tabellen.
...
| [az cosmosdb tabell genomströmning uppdatering](/cli/azure/cosmosdb/table/throughput#az-cosmosdb-table-throughput-update) | Uppdatera RU/s för en AZURE Cosmos Table API-tabell. |
