---
title: Azure PowerShell Script-skapa ett Azure SQL DB-API Cosmos-konto | Microsoft Docs
description: "Azure PowerShell-skript exempel – skapa ett Azure SQL DB-API Cosmos-konto"
services: cosmos-db
