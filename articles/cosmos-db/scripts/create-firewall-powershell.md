...
[!code-powershell[huvudsakliga](../../../powershell_scripts/cosmosdb/create-firewall/create-firewall.ps1?highlight=35-36,39-43 "skapa en brandvägg för Azure Cosmos DB")]
