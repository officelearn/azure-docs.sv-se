---
title: Azure CLI-skript – Skapa ett konto, en databas och en samling för Gremlin API i Azure Cosmos DB | Microsoft Docs
description: Exempel på Azure CLI-skript – Skapa ett konto, en databas och en samling för Gremlin API i Azure Cosmos DB
services: cosmos-db
...
Koden i det här CLI-skriptexemplet skapar ett konto, en databas och en samling för Gremlin API i Azure Cosmos DB. 
