---
title: Azure PowerShell-skript – Skapa ett Table API-konto i Azure Cosmos DB | Microsoft Docs
...
ms.locfileid: "41921072"
---
# <a name="azure-cosmos-db-create-a-table-api-account-using-powershell"></a>Azure Cosmos DB: Skapa ett Table API-konto med hjälp av PowerShell
