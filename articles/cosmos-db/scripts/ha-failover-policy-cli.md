---
title: Azure CLI-skript – Skapa en princip för redundansväxling för hög tillgänglighet
...
| [az cosmosdb create](/cli/azure/sql/server#az-sql-server-create) | Skapar ett Azure Cosmos DB-konto. |
