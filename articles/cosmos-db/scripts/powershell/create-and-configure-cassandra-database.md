---
title: Azure PowerShell-skript – skapa ett Cassandra-API för Azure Cosmos DB-konto
description: Azure PowerShell-skriptexempel – skapa ett Cassandra-API för Azure Cosmos DB-konto
author: markjbrown
ms.author: mjbrown
