---
title: Azure PowerShell-skript – Azure Cosmos DB lista och hämta åtgärder för MongoDB-API
...
ms.locfileid: "67603902"
---
# <a name="list-and-get-databases-and-graphs-for-azure-cosmos-db---mongodb-api"></a>Lista och få databaser och diagram för Azure Cosmos DB - MongoDB API
