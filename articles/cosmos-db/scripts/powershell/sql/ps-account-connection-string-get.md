---
title: Azure PowerShell-skript – Get-anslutningssträngar för ett Azure Cosmos-konto
description: Azure PowerShell-skriptexempel – Get-anslutningssträngar för ett Azure Cosmos-konto
author: markjbrown
...
---
# <a name="get-connection-strings-for-an-azure-cosmos-account-using-powershell"></a>Hämta anslutningssträngar för ett Azure Cosmos-konto med hjälp av PowerShell
