---
title: Azure PowerShell-skript – hämta nycklar för ett Azure Cosmos-konto
description: Azure PowerShell-skriptexempel – Get-nycklar för ett Azure Cosmos-konto
author: markjbrown
...
ms.locfileid: "65078407"
---
# <a name="get-keys-for-an-azure-cosmos-account-using-powershell"></a>Hämta nycklar för ett Azure Cosmos-konto med hjälp av PowerShell
