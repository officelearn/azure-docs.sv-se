---
title: Azure PowerShell-skript – ta bort en behållare i ett Azure Cosmos-konto
description: Azure PowerShell-skriptexempel – ta bort en behållare i ett Azure Cosmos-konto
author: markjbrown
...
---
# <a name="delete-a-container-in-an-azure-cosmos-account-using-powershell"></a>Ta bort en behållare i ett Azure Cosmos-konto med hjälp av PowerShell
