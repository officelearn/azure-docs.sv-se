---
title: Azure PowerShell-skript – Azure Cosmos DB Update RU/s för tabell-API
description: Azure PowerShell-skript – Azure Cosmos DB Update RU/s för tabell-API
author: markjbrown
