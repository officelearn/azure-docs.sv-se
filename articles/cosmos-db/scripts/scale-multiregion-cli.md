---
title: "Azure CLI skript-Multiregion replikering för Azure Cosmos DB | Microsoft Docs"
...
---
# <a name="replicate-an-azure-cosmos-db-database-account-in-multiple-regions-and-configure-failover-priorities-using-the-azure-cli"></a>Replikera en Azure Cosmos DB databaskonto i flera områden och konfigurera redundans prioriteringar med hjälp av Azure CLI

Det här exemplet replikerar alla slags Azure Cosmos DB databaskonto i flera områden, och konfigurerar redundans prioriteringar med hjälp av Azure CLI.
