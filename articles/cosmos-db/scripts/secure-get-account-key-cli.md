...
| [az cosmosdb list-keys](https://docs.microsoft.com/cli/azure/cosmosdb#az_cosmosdb_list_keys) | Skapar en logisk server som är värd för SQL-databasen. |
