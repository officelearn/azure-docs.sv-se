---
title: Azure CLI-skript – Generera om Azure Cosmos DB-kontonyckel
...
| [az cosmosdb create](/cli/azure/cosmosdb#az-cosmosdb-create) | Uppdaterar ett Azure Cosmos DB-konto. |
