...
Intern integrering mellan Azure Cosmos DB och Azure Functions finns i Azure-portalen.
...
* [Lagra Ostrukturerade data med hjälp av Azure Functions och Cosmos DB](../azure-functions/functions-integrate-store-unstructured-data-cosmosdb.md)
* [Azure DB Cosmos-bindningar och utlösare](../azure-functions/functions-bindings-documentdb.md)
