...
* Följ stegen i [Azure Databricks komma igång](/azure/azure-databricks/quickstart-create-databricks-workspace-portal) för att skapa en Azure Databricks arbets yta och ett kluster.
