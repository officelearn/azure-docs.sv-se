...
Den [Program.py](https://github.com/Azure/azure-documentdb-python/blob/master/samples/CollectionManagement/Program.py) filen i [CollectionManagement-projektet](https://github.com/Azure/azure-documentdb-python/blob/master/samples/CollectionManagement) visar hur du utför följande aktiviteter. Mer information om Azure Cosmos-samlingarna innan du kör följande exempel finns i [Artikeln Arbeta med databaser, behållare och objekt.](databases-containers-items.md) 
...
Den [Program.py](https://github.com/Azure/azure-documentdb-python/blob/master/samples/DocumentManagement/Program.py) filen i [DocumentManagement-projektet](https://github.com/Azure/azure-documentdb-python/blob/master/samples/DocumentManagement) visar hur du utför följande aktiviteter. Mer information om Azure Cosmos-dokumenten innan du kör följande exempel finns i [Artikeln Arbeta med databaser, behållare och objekt.](databases-containers-items.md) 
...
| [Läsa ett dokument efter ID](https://github.com/Azure/azure-documentdb-python/blob/master/samples/DocumentManagement/Program.py#L69-L78) |[CosmosClient.ReadItem](/python/api/azure-cosmos/azure.cosmos.cosmos_client.cosmosclient?view=azure-python#readitem-document-link--options-none-) |
...
Exempelprojekten visar också hur du utför följande frågeaktiviteter. Mer information om SQL-frågereferensen i Azure Cosmos DB innan du kör följande exempel finns i begreppsartikeln [för SQL-frågeexempel.](how-to-sql-query.md) Mer information om SQL-frågereferensen i Azure Cosmos DB innan du kör följande exempel finns i begreppsartikeln [för SQL-frågeexempel.](how-to-sql-query.md) 
