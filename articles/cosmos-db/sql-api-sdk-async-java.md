...
| |  |
|---|---|
| **SDK-hämtning** | [Maven 3.](https://mvnrepository.com/artifact/com.microsoft.azure/azure-cosmosdb) |
...
|**Kod exempel** | [GitHub](https://github.com/Azure/azure-cosmosdb-java#usage-code-sample)| 
| **Prestandatips**| [GitHub – viktigt](https://github.com/Azure/azure-cosmosdb-java#guide-for-prod)| 
| **Lägsta körnings tid som stöds**|[JDK 8](https://aka.ms/azure-jdks) | 
