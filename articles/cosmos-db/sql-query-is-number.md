...
description: Lär dig mer om SQL system Function IS_NUMBER i Azure Cosmos DB.
author: ginamr
...
## <a name="examples"></a>Exempel
  ...
  I följande exempel kontrol leras objekt av JSON Boolean, Number, String, null, Object, array och odefinierade typer med hjälp av funktionen `IS_NUMBER`.  
