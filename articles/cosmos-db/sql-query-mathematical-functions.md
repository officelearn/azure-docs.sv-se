...
description: Lär dig mer om matematiska SQL system-funktioner i Azure Cosmos DB.
author: ginamr
...
|[RADIANER](sql-query-radians.md)|[SLUMP](sql-query-rand.md)|[AVRUNDA](sql-query-round.md)|
