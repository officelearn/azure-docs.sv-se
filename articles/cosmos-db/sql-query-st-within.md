...
description: Lär dig mer om SQL system Function ST_WITHIN i Azure Cosmos DB.
author: ginamr
...
## <a name="examples"></a>Exempel
  ...
  I följande exempel visas hur du hittar alla familje dokument i en polygon med `ST_WITHIN`.  
