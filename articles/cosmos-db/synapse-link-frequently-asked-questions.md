---
title: Vanliga frågor och svar om Azure Synapse-länken för Azure Cosmos DB
...
ms.locfileid: "83598684"
---
# <a name="frequently-asked-questions-about-azure-synapse-link-for-azure-cosmos-db"></a>Vanliga frågor och svar om Azure Synapse-länken för Azure Cosmos DB
...
I den offentliga för hands versionen stöds endast Synapse-länken för API: et för Azure Cosmos DB SQL (Core). Stöd för Cosmos DB s API för mongo DB & API för Cassandra är för närvarande en för hands version av gated Preview.  Kontakta [Azure Cosmos DB-teamet](mailto:cosmosdbsynapselink@microsoft.com)om du vill begära åtkomst till gated Preview.
...
För närvarande kan du inte inaktivera funktionen när Synapse-länken är aktive rad på konto nivå.  Om du vill inaktivera funktionen måste du ta bort och återskapa ett nytt Azure Cosmos-konto.
...
Du kan bara komma åt och köra frågor mot analys lagret med de olika körnings tider som tillhandahålls av Azure Synapse Analytics. Analys lagret kan frågas och analyseras med:

* Synapse Spark med fullständigt stöd för Scala, python, SparkSQL och C#. Synapse Spark är central för data teknik och vetenskaps scenarier
* SQL Server utan språk i T-SQL och stöd för välbekanta BI-verktyg (till exempel Power BI Premium osv.)
...
Data i analys arkivet är partitionerade baserat på den horisontella partitionering av Shards i transaktions arkivet. För närvarande kan du inte välja en annan partitionerings strategi för analys lagret.
...
![Azure Cosmos DB behållare aktive rad med analys lager – ikon](./media/synapse-link-frequently-asked-questions/analytical-store-icon.png)

En transaktions Arkiv behållare visas med följande ikon:

![Azure Cosmos DB behållare aktive rad med transaktions lager – ikon](./media/synapse-link-frequently-asked-questions/transactional-store-icon.png)
