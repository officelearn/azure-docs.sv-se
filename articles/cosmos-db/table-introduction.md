...
## Tabell-API:er för premium och standard
...
| Konsekvens | Stark inom primär region, eventuell med sekundär region | [fem väldefinierade konsekvensnivåer](consistency-levels.md) för att balansera tillgänglighet, latens, dataflöde och konsekvens baserat på dina programbehov |
