...
|   |   |
|---|---|
|**Hämta SDK**|[Hämta alternativ](https://github.com/azure/azure-storage-java#download)|
|**API-dokumentation**|[Java API-referensdokumentation](https://azure.github.io/azure-storage-java/)|
