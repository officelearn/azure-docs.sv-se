...
|   |   |
|---|---|
|**SDK-hämtningen**|[Alternativ för hämtning](https://github.com/azure/azure-storage-java#download)|
|**API-dokumentationen**|[Java API-referensdokumentation](http://azure.github.io/azure-storage-java/)|
