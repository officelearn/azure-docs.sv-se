...
ms.locfileid: "51621284"
---
# <a name="time-to-live-for-azure-cosmos-db-data"></a>Time to Live för Azure Cosmos DB-data
...
2. **Time to Live-värde på ett objekt** (anges med `TimeToLive`):
...
Lär dig hur du konfigurerar panel-livstid i följande artiklar:
