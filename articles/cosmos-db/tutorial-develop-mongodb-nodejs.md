---
title: Node. js, vinkel-app med Azure Cosmos DB s API för MongoB (part1)
...
> * [Lägg till post-, placerings-och borttagnings funktioner i appen](tutorial-develop-mongodb-nodejs-part6.md)
