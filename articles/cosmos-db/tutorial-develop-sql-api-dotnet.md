...
Den här metoden gör ett REST API-anrop till Azure Cosmos DB och tjänsten etablerar ett antal partitioner baserat på det begärda genomströmningen. Du kan ändra genomströmningen i en samling eller i en uppsättning samlingar allteftersom dina prestandabehov utvecklas med hjälp av SDK:n eller [Azure Portal](set-throughput.md).
