...
Den här artikeln visar hur du konfigurerar en CI-pipeline i Azure DevOps för en ASP.NET-app som använder Cosmos DB-emulatorns build-uppgift för att köra tester. 
