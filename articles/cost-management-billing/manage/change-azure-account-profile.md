---
title: Ändra profilinformationen för ditt Azure-konto
...
1. Välj knappen **Redigera information** och uppdatera information i **profilen**.
   ...
   ![Exempel på Azure-profilinformation](./media/change-azure-account-profile/profile.png)
...
Information om hur du uppdaterar din faktureringsinformation finns i [Change the credit card used to pay for an Azure subscription](change-credit-card.md) (Ändra det kreditkort som används för att betala för en Azure-prenumeration).
