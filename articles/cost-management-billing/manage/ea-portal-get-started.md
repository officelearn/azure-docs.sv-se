...
Du kan även komma åt användningsdata via rapporterings-API:et. Detaljerad information och exempelkod finns i [dokumentationen för rapporterings-API](https://ea.azure.com/helpdocs/reportingAPI).
...
Du kan även komma åt användning via API. Detaljerad information och exempelkod finns i [Rapporterings-API](https://ea.azure.com/helpdocs/reportingAPI) i dokumentationen för Azure Enterprise-portalen.
