---
title: Azure EA-priser
description: Beskriver prisöversikt för Azure EA
author: bandersmsft
...
ms.locfileid: "88686997"
---
# <a name="azure-ea-pricing"></a>Azure EA-priser

Den här artikeln innehåller en prisöversikt för Azure Enterprise-kunder.
...
- Mer information finns i [fakturor för Enterprise-registrering](ea-portal-enrollment-invoices.md).