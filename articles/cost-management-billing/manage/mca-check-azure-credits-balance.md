...
Du kan använda API:erna [Azure Billing](/rest/api/billing/) och [Consumption](/rest/api/consumption/) till att kontrollera kreditsaldot för ditt faktureringskonto programmatiskt.
