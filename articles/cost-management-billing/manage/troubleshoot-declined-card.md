...
ms.locfileid: "77200477"
---
# <a name="troubleshoot-a-declined-card-at-azure-sign-up"></a>Felsöka ett nekat kort vid Azure-registreringen

Du kan stöta på ett problem eller fel där kreditkortet nekas vid Azure-registreringen i antingen Microsoft Azure-portalen eller Azure-kontocentret.
...
[Du kan inte registrera dig för Azure i Azure-portalen eller Azure-kontocentret](troubleshoot-azure-sign-up.md)
...
Mer information om att betala via faktura finns i [Skicka en förfrågan om att betala Azure-prenumerationen via faktura](pay-by-invoice.md).

## <a name="your-credit-card-information-is-outdated"></a>Kreditkortsinformationen är inaktuell

Information om hur du hanterar din kortinformation, som att ändra eller ta bort ett kort, finns i [Lägg till, uppdatera eller ta bort ett kreditkort för Azure](change-credit-card.md).
...
- [Registreringsproblem](troubleshoot-azure-sign-up.md)
