...
- Du kan läsa mer om Azure-reservationer i följande artiklar:
  ...
  - [Förstå hur en reservationsrabatt för en isolerad stämpel för Azure App Service tillämpas](reservation-discount-app-service-isolated-stamp.md)
