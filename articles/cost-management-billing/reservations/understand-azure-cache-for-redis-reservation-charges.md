...
När du har köpt en reserverad kapacitet för Azure Cache for Redis tillämpas reservationsrabatten automatiskt på cacheinstanser som matchar reservationsattributen och reservationskvantiteten. En reservation täcker endast beräkningskostnaderna för Azure Cache for Redis. Du debiteras för lagring och nätverk enligt de vanliga priserna. Reserverad kapacitet är endast tillgängligt för cacheinstanser på [premiumnivå](//azure/azure-cache-for-redis/quickstart-create-redis).
