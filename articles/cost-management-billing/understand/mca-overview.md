...
description: Lär dig mer om ditt faktureringskonto för Microsoft-kundavtal, till exempel faktureringsprofiler och fakturabetalningsmetoder.
author: bandersmsft
...
I Azure-portalen kan du visa fakturan, ladda ned dokument och ändra inställningen för att få framtida fakturor via e-post. Du kan läsa mer i [Ladda ned fakturor för ett Microsoft-kundavtal](../manage/download-azure-invoice-daily-usage-date.md#download-invoices-for-a-microsoft-customer-agreement).
...
| Typ             | Definition  |
|------------------|-------------|
|Azure-krediter    |  Krediterna tillämpas automatiskt på de berättigade avgifterna på din faktura, vilket minskar beloppet du måste betala. Mer information finns i [Spåra Azure-kreditsaldot för din faktureringsprofil](../manage/mca-check-azure-credits-balance.md). |
...
- [Skapa ytterligare en Azure-prenumeration för Microsoft-kundavtal](../manage/create-subscription.md)
