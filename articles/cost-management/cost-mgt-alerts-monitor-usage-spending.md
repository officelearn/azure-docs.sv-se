...
| Alert type | Enterprise Agreement | Microsofts kundavtal | Web direct/Pay-As-You-Go |
|---|---|---|---|
| Budget | ✔ | ✔ | ✔ |
| Kredit | ✔ |✘ | ✘ |
...
When you view the details of a dismissed alert, you can reactivate it if manual action is needed. I följande bild visas ett exempel.
