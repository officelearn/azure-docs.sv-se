...
Om du vill skapa eller uppdatera åtgärds grupper väljer du **Hantera åtgärds grupper** när du skapar eller redigerar en budget.
...
Välj sedan **Lägg till åtgärds grupp** och skapa åtgärds gruppen.
...
## <a name="edit-an-existing-budget"></a>Redigera en befintlig budget
Om du vill göra ändringar i en befintlig budget går du till fönstret huvud budget och väljer den budget som du vill redigera. I fönstret budget Detaljer väljer du **Redigera budget** och gör nödvändiga ändringar och väljer sedan **Spara**.

![Exempel som visar redigera budget](./media/tutorial-acm-create-budgets/edit-budget.png)
