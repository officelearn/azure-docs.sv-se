---
title: Skapa ett Azure Data Explorer-kluster & DB med Powershell
description: Lär dig hur du skapar ett Azure Data Explorer-kluster och -databas med hjälp av PowerShell
...
---
# <a name="create-an-azure-data-explorer-cluster-and-database-by-using-powershell"></a>Skapa ett Azure Data Explorer-kluster och -databas med hjälp av PowerShell
...
Följande steg krävs inte om du kör kommandon i Azure Cloud Shell. Om du kör CLI lokalt följer du steg 1 & 2 för att logga in på Azure och ange din nuvarande prenumeration:
...
1. Ange den prenumeration där du vill att klustret ska skapas:
    ...
    ```
1. När du kör Azure CLI lokalt eller i Azure Cloud Shell måste du installera Az.Kusto-modulen på din enhet:
...
1. Skapa klustret med hjälp av följande kommando:
   ...
   |---|---|---|
   | Namn | *mykustocluster (en)* | Önskat namn på klustret.|
...
1. Skapa databasen med hjälp av följande kommando:
   ...
   | Namn | *mykustodatabas* | Namn på databasen.|
   | ResourceGroupName | *testrg* | Namnet på resursgruppen där klustret kommer att skapas. |
   | MjukdeletePeriod | *3650:00:00:00* | Hur lång tid data ska behållas för att vara tillgängliga för frågor. |
...
* [Ytterligare Kommandon från Az.Kusto](/powershell/module/az.kusto/?view=azps-1.7.0#kusto)
