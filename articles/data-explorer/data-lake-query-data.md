...
> [!TIP]
> Bästa prestanda för frågor kräver data inmatning i Azure Datautforskaren. Möjligheten att fråga data i Azure Data Lake Storage Gen2 utan föregående inmatning bör endast användas för historiska data eller data som sällan efter frågas. [Optimera dina fråge prestanda i sjön](#optimize-your-query-performance) för bästa resultat.
