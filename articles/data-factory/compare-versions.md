...
- **PowerShell**: PowerShell-cmdletarna har uppdaterats för den aktuella versionen. Cmdlets för den aktuella versionen har **DataFactoryV2** i namnet, till exempel: Get-AzDataFactoryV2. 
