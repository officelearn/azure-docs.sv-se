...
typ | Typ av den länkade tjänsten. Till exempel: Azure Storage (datalagring) eller AzureBatch (beräkning). Se beskrivningen för typeProperties. | Ja |
...
Följande länkade tjänst är en Azure Storage-länkad tjänst. Observera att typen är inställd på Azure Storage. Typegenskaperna för azure storage-länkade tjänsten inkluderar en anslutningssträng. Tjänsten Data Factory använder den här anslutningssträngen för att ansluta till datalagret vid körning.
