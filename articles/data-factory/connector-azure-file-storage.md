...
Följande egenskaper stöds för att kopiera data till och från Azure File Storage i **Orc/Avro/JSON-format**:
...
Om du vill kopiera data från Azure File Storage i **Orc/Avro/JSON-format**, stöds följande egenskaper i avsnittet Kopiera aktivitets **källa** :
...
Följande egenskaper stöds i avsnittet **mottagare** för att kopiera data till Azure File Storage i **Orc/Avro/JSON-format**:
