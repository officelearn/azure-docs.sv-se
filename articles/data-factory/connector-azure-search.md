...
En fullständig lista över avsnitt och egenskaper som är tillgängliga för att definiera datauppsättningar finns i den [datauppsättningar](concepts-datasets-linked-services.md) artikeln. Det här avsnittet innehåller en lista över egenskaper som stöds av Azure Search Data uppsättning.
...
För närvarande stöds inte andra data typer, t. ex. ComplexType. En fullständig lista över data typer som stöds av Azure sökning finns i [data typer som stöds (Azure Search)](https://docs.microsoft.com/rest/api/searchservice/supported-data-types).
