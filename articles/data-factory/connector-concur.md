...
Om du vill kopiera data från Concur, ange typ av datakälla i kopieringsaktiviteten till **ConcurSource**. Följande egenskaper stöds i kopieringsaktiviteten **source** avsnittet:
