---
title: Kopiera data från Concur med hjälp av Azure Data Factory (förhandsversion) | Microsoft Docs
...
---
# <a name="copy-data-from-concur-using-azure-data-factory-preview"></a>Kopiera data från Concur med hjälp av Azure Data Factory (förhandsgranskning)
