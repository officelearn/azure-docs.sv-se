...
Kopiera data från Google AdWords genom att ange typegenskapen på datauppsättningen till **GoogleAdWordsObject**. Det finns ingen ytterligare typspecifika-egenskap i den här typen av datauppsättning.
