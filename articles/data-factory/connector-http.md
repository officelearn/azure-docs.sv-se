...
Följande egenskaper stöds för att kopiera data från HTTP i **Orc-format**:
...
För att kopiera data från HTTP i **Orc-format**, stöds följande egenskaper i avsnittet Kopiera aktivitets **källa** :
