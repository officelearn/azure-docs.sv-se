...
Om du vill kopiera data från HubSpot, ange typ av datakälla i kopieringsaktiviteten till **HubspotSource**. Följande egenskaper stöds i kopieringsaktiviteten **source** avsnittet:
