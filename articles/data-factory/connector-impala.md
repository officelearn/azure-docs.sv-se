...
Om du vill kopiera data från Impala, ange typegenskapen på datauppsättningen till **ImpalaObject**. Det finns ingen ytterligare typspecifika-egenskap i den här typen av datauppsättning.
