...
| port | TCP-porten som JIRA-servern använder för att lyssna efter klient anslutningar. Standardvärdet är 443 om du ansluter via HTTPS eller 8080 om du ansluter via HTTP.  | Inga |
