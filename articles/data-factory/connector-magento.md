...
| query | Använd den anpassade SQL-frågan för att läsa data. Till exempel: `"SELECT * FROM Customers"`. | Nej (om "tableName" i data uppsättningen har angetts) |
