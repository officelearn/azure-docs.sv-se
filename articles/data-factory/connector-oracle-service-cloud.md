...
För att kopiera data från molnet för Oracle-tjänsten, ange typ av datakälla i kopieringsaktiviteten till **OracleServiceCloudSource**. Följande egenskaper stöds i kopieringsaktiviteten **source** avsnittet:
