...
| query | Använd den anpassade SQL-frågan för att läsa data. Till exempel: `"SELECT * FROM Payment_Experience"`. | Nej (om "tableName" i data uppsättningen har angetts) |
