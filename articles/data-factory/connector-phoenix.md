...
Om du vill kopiera data från Phoenix, ange typ av datakälla i kopieringsaktiviteten till **PhoenixSource**. Följande egenskaper stöds i kopieringsaktiviteten **source** avsnittet:
