---
title: Kopiera data från SAP HANA med Azure Data Factory
...
| Användar | Ange användar namn när du använder Windows-autentisering. Exempel: `user@domain.com` | Nej |
...
| partitionstabell | Namnet på tabellen i SAP HANA databasen. | Nej (om "fråga" i aktivitets källan har angetts) |
