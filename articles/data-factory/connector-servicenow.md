...
Kopiera data från ServiceNow genom att ange typegenskapen på datauppsättningen till **ServiceNowObject**. Det finns ingen ytterligare typspecifika-egenskap i den här typen av datauppsättning.
