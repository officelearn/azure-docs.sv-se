...
Den här artikeln beskriver hur du kopierar data från och till SFTP-servern. Läs om Azure Data Factory den [introduktionsartikeln](introduction.md).
...
| port | Porten som SFTP-servern lyssnar på.<br/>Tillåtna värden är: heltal, standardvärdet är **22**. |Inga |
| skipHostKeyValidation | Ange om du vill hoppa över validering av värd nycklar.<br/>Tillåtna värden är: **Sant**, **falskt** (standard).  | Inga |
...
| Egenskap                 | Beskrivning                                                  | Krävs |
| ------------------------ | ------------------------------------------------------------ | -------- |
| typ                     | Egenskapen Type under `storeSettings` måste anges till **SftpWriteSetting**. | Ja      |
