---
title: Kopiera data från Shopify med Azure Data Factory (för hands version)
...
| query | Använd den anpassade SQL-frågan för att läsa data. Till exempel: `"SELECT * FROM "Products" WHERE Product_Id = '123'"`. | Nej (om "tableName" i data uppsättningen har angetts) |
