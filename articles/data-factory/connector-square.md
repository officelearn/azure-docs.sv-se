...
| redirectUri | Omdirigerings-URL som tilldelats i instrumentpanelen för kvadratisk program. (t. ex. http:\//localhost: 2 500)  | Ja |
...
För att kopiera data från ruta, ange typ av datakälla i kopieringsaktiviteten till **SquareSource**. Följande egenskaper stöds i kopieringsaktiviteten **source** avsnittet:
