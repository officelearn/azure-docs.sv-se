...
childItems | Kontrollerar om mappen har underordnade objekt. Kan anges till true: Kontrollera att mappen finns och att det finns objekt. Blockerar tills det finns minst ett objekt i mappen eller tidsgränsen har nåtts.-false: Kontrollera att mappen finns och att den är tom. Värde att block tills mappen är tom eller tills tidsgränsen uppnås. Om inget värde har angetts, blockeras aktiviteten tills mappen finns eller tidsgränsen har nåtts. | Boolesk | Nej |
