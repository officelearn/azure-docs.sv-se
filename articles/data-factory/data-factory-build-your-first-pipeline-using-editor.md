...
I den här artikeln får du lära dig hur du använder [Azure Portal](https://portal.azure.com/) till att skapa din första Azure-datafabrik. 
...
2.  På bladet **Ny datafabrik** anger du **GetStartedDF** som namn.
    ...
    > [AZURE.IMPORTANT] Namnet på Azure Data Factory måste vara globalt unikt. Om du får felet: **Datafabriksnamnet "GetStartedDF" är inte tillgängligt**, ändrar du namnet på datafabriken (till exempel yournameGetStartedDF) och försöker skapa igen. Se artikeln [Data Factory – namnregler](data-factory-naming-rules.md) för namnregler för Data Factory-artefakter.
    > 
...
4.  Välj befintlig **resursgrupp** eller skapa en ny resursgrupp. Skapa en resursgrupp för självstudien med namnet: **ADFGetStartedRG**.    
...
I det här steget kommer du länka ett HDInsight-kluster på begäran till din datafabrik. HDInsight-klustret skapas automatiskt vid körning och tas bort när bearbetningen är klar. Det är inaktivt under en angiven tidsrymd. 
