<properties 
    pageTitle="Självstudiekurs: Skapa en pipeline med en kopieringsaktivitet med hjälp av .NET-API:et | Microsoft Azure" 
...
3. Kör följande kommando för att välja den prenumeration som du vill arbeta med. Ersätt **&lt;NameOfAzureSubscription**&gt; med namnet på din Azure-prenumeration. 
    ...
    > [AZURE.IMPORTANT] Anteckna **ID** och **TenantId** i kommandots utdata. 
...
5. Skapa ett Azure Active Directory-program. 
...
6. Skapa AD-tjänstobjektet. 

        New-AzureRmADServicePrincipal -ApplicationId $azureAdApplication.ApplicationId

7. Lägg till tjänstobjektet till rollen som **Data Factory-deltagare**. 

        New-AzureRmRoleAssignment -RoleDefinitionName "Data Factory Contributor" -ServicePrincipalName $azureAdApplication.ApplicationId.Guid

8. Hämta program-ID:t.
...
6. Lägg till följande **appSetttings**-avsnitt i filen **App.config**. De här inställningarna används av helper-metoden: **GetAuthorizationHeader**. 
...
6. Lägg till följande **genom att använda** instruktioner till källfilen (Program.cs) i projektet.
...
8. Lägg till följande kod som skapar en **länkad Azure Storage-tjänst** till **Main**-metoden. 
    ...
    > [AZURE.IMPORTANT] Ersätt **storageaccountname** och **accountkey** med namnet och nyckeln för ditt Azure Storage-konto. 
...
9. Lägg till följande kod som skapar en **länkad Azure SQL-tjänst** till **Main**-metoden.
    ...
    > [AZURE.IMPORTANT] Ersätt **servername**, **databasename**, **username** och **password** med namnen för Azure SQL-servern, databasen, användaren och lösenordet.  
...
14. Lägg till följande kod för att hämta körningsinformation för en datasektor till **Main**-metoden.
...
13. Lägg till följande helper-metod som används av **Main**-metoden i **Program**-klassen.  
...
16. Kontrollera att det finns minst en fil i **adftutorial**-behållaren i Azure-blobblagringen. Om inte skapar du **Emp.txt**-filen i Anteckningar med följande innehåll och laddar upp den till adftutorial-behållaren.
...
18. Kontrollera att en utdatafil har skapats i mappen ”**apifactoryoutput**” i **adftutorial**-behållaren.
