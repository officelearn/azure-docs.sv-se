...
Beräknar ett inverterat värde* ``acos(1) -> 0.0``
---
### <code>add</code>
...
Vänster fyller strängen med den angivna utfyllnaden tills den har en viss längd. Om strängen är lika med eller större än längden, betraktas den som * ``lpad('great', 10, '-') -> '-----great'`` en no-op 
* ``lpad('great', 4, '-') -> 'great'`` 
* -lpad ("Great", 8, "< >)->" < ><great'``
---
### <code>LTRIM</code>
...
Höger pad strängen med den angivna utfyllnaden tills den har en viss längd. Om strängen är lika med eller större än längden, betraktas den som * ``rpad('great', 10, '-') -> 'great-----'``en no-op 
* ``rpad('great', 4, '-') -> 'great'`` 
* ``rpad('great', 8, '<>') -> 'great<><'`` 
---
