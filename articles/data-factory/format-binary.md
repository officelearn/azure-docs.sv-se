---
title: Binärt format i Azure Data Factory | Microsoft Docs
...
| ---------------- | ------------------------------------------------------------ | -------- |
| type             | Data uppsättningens typ-egenskap måste anges till **Binary**. | Ja      |
...
| type | Komprimerings-codec som används för att läsa/skriva binära filer. <br>Tillåtna värden är **bzip2**, **gzip**,DEFLATE, **ZipDeflate**. att använda när du sparar filen. | Nej       |
| level | Komprimerings förhållandet. Använd när dataset används i kopierings aktiviteten Sink.<br>Tillåtna värden är **optimalt** eller **snabbast**.<br>- **Snabbaste** Komprimerings åtgärden bör utföras så snabbt som möjligt, även om den resulterande filen inte komprimeras optimalt.<br>- **Optimal**: Komprimerings åtgärden bör komprimeras optimalt, även om åtgärden tar längre tid att slutföra. Mer information finns i [komprimeringsnivå](https://msdn.microsoft.com/library/system.io.compression.compressionlevel.aspx) avsnittet. | Nej       |
...
| Egenskap      | Beskrivning                                                  | Krävs |
| ------------- | ------------------------------------------------------------ | -------- |
| type          | Typ egenskapen för kopierings aktivitets källan måste anges till **BinarySource**. | Ja      |
...
| Egenskap      | Beskrivning                                                  | Krävs |
| ------------- | ------------------------------------------------------------ | -------- |
| type          | Typ egenskapen för kopierings aktivitets källan måste anges till **BinarySink**. | Ja      |
