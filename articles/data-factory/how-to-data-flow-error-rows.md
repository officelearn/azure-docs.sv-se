...
Ett vanligt scenario i Data Factory när du använder mappnings data flöden är att skriva transformerade data till en databas i Azure SQL Database. I det här scenariot, ett vanligt fel tillstånd som du måste förhindra mot är möjlig kolumn trunkering. Följ de här stegen för att tillhandahålla loggning av kolumner som inte ryms i en mål Strängs kolumn, så att ditt data flöde fortsätter i dessa scenarier.
