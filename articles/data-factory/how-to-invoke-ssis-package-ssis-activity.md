...
Installera de senaste Azure PowerShell-modulerna genom att följa de stegvisa anvisningarna i [hur du installerar och konfigurerar du Azure PowerShell](/powershell/azure/azurerm/install-azurerm-ps).
