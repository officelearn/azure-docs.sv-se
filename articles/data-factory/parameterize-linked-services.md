...
När du redigerar en länkad tjänst i användar gränssnittet tillhandahåller Data Factory inbyggd Parameterisering-upplevelse för följande typer av anslutningar. I bladet skapa/redigera länkade tjänster kan du hitta alternativ för nya parametrar och lägga till dynamiskt innehåll.
...
För andra typer kan du Parameterisera den länkade tjänsten genom att redigera JSON på användar gränssnittet:
