...
Det här exemplet på PowerShell-skriptet kopierar data från flera tabeller i Azure SQL Database till Azure Synapse Analytics (tidigare SQL Data Warehouse).
