...
På sidan **Avancerade inställningar** markerar du kryss rutan **konfiguration av egen värd integration runtime som en proxy för din Azure-SSIS integration runtime** . Välj den lokala IR-och Azure-Blob Storage länkade tjänsten för mellanlagring och ange ett namn på en BLOB-behållare för **mellanlagringsplatsen** om du vill.
