...
Den här funktionen delar upp alla SSIS Data Flow-aktiviteter som har en lokal data källa i två mellanlagrings uppgifter: 
...
- För närvarande stöds endast data flödes aktiviteter med Open Database Connectivity (ODBC)/OLEDB/Flat-filkällor eller OLEDB-mål. 
