...
Du kan skapa en Azure Repos eller Git-lagringsplats i en annan Azure Active Directory-klientorganisation. To specify a different Azure AD tenant, you have to have administrator permissions for the Azure subscription that you're using.
...
| **GitHub Enterprise URL** | The GitHub Enterprise root URL. Till exempel: https://github.mydomain.com. Required only if **Use GitHub Enterprise** is selected | `<your GitHub enterprise url>` |                                                           
