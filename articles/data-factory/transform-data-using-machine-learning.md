...
| globalParameters  | Nyckel, värde-par som ska skickas till den Azure ML Batch Execution Service-slutpunkten. Nycklar måste matcha namnen på webbtjänstparametrar som definierats i den publicerade Azure Machine Learning-webbtjänsten. Värden angavs i egenskapen GlobalParameters i Körningsbegäran för Azure ML-batch | Nej       |
...
Ett annat vanligt scenario när du skapar Azure ML-experiment är att använda modulerna importera Data och utdata. Modulen importera Data som används för att läsa in data i ett experiment och utdata-modulen är att spara data från dina experiment. Mer information om importera Data och utdata finns i [importdata](https://msdn.microsoft.com/library/azure/dn905997.aspx) och [utdata](https://msdn.microsoft.com/library/azure/dn905984.aspx) ämnen i MSDN Library.     
...
> [!NOTE]
> Skiljer sig från webbtjänstparametrar Web service indata och utdata. I det första scenariot har du sett hur indata och utdata kan anges för en Azure ML-webbtjänst. I det här scenariot kan skicka du parametrar för en webbtjänst som motsvarar till egenskaperna för Import Data-och utdata-moduler.
>
> 
