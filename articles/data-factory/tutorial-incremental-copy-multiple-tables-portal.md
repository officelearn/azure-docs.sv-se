...
1. Kör följande SQL-kommando mot din Azure SQL-databas för att skapa tabeller med namnet `customer_table` och `project_table`:  
...
1. Gör så här:
    ...
    1. Ange `@{item().TABLE_NAME}` för **tabell typ parameter namn**.
