...
* För närvarande kan du endast skapa datafabriker i Data Factory i regionerna USA, östra; USA; östra 2 och Europa, västra. Datalagren ( Storage, Azure SQL Database osv.) och beräkningarna (Azure HDInsight osv.) som används i datafabriken kan finnas i andra regioner.
