...
2. Kontrollera att du ger minst ”**läsare**” roll till användaren eller tjänstens huvudnamn på data lake-konto. Nedan visas hur du gör det:
    ...
    3. Klicka på ”Lägg till” på bladet för ”åtkomstkontroll (IAM)”
    4. Ange ”roll” som ”läsare” och väljer användaren eller tjänstens huvudnamn som du använder för Kopiera för att bevilja åtkomst

3. Om du inte vill tilldela rollen ”läsare” till användaren eller tjänstens huvudnamn, alernative är att [uttryckligen ange en plats för körning](data-factory-data-movement-activities.md#global) i kopia activitywith platsen för ditt Data Lake Store. Exempel:
