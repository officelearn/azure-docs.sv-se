...
| minimumRows |Verifierar att data i en **Azure SQL-databas** eller en **Azure-tabell** innehåller det lägsta antalet rader. |<ul><li>Azure SQL-databas</li><li>Azure-tabell</li></ul> |Inga |Ej tillämpligt |
