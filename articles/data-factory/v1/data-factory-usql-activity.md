...
> [!NOTE]
> Den här artikeln gäller för version 1 av Data Factory. Om du använder den aktuella versionen av Data Factory-tjänsten finns [U-SQL-aktivitet i V2](../transform-data-using-data-lake-analytics.md).
