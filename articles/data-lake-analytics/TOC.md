...
### U-SQL-språk
#### [Grundläggande inställningar](data-lake-analytics-u-sql-get-started.md)
#### [Språkreferens](https://msdn.microsoft.com/library/azure/mt591959)
#### [Katalog](data-lake-analytics-u-sql-catalog.md)
#### [Användardefinierade operatörer](data-lake-analytics-u-sql-develop-user-defined-operators.md)
#### [Python-tillägg](data-lake-analytics-u-sql-python-extensions.md)
#### [R-tillägg](data-lake-analytics-u-sql-r-extensions.md)
...
## [Resource Manager-mall](/azure/templates/microsoft.datalakeanalytics/allversions)
