...
Aktivera den **datalagring och bearbetning av** arbetsbelastning som visas: ![Aktivera datalagring och bearbetning av arbetsbelastning](./media/data-lake-analytics-data-lake-tools-get-started/data-lake-tools-for-vs-2017-install-01.png)

Aktivera den **Azure development** arbetsbelastning som visas: ![Aktivera arbetsbelastningen Azure development](./media/data-lake-analytics-data-lake-tools-get-started/data-lake-tools-for-vs-2017-install-02.png)
