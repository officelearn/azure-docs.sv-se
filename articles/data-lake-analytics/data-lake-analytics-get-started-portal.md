...
4. Välj **Fäst på Startsidan**. Detta krävs för att följa de här självstudierna.
5. Klicka på **Skapa**. Det tar dig till Startsidan i portalen. En ny panel har lagts till på Startsidan med etiketten "Distribuera Azure Data Lake Analytics". Det tar en stund att skapa ett Data Lake Analytics-konto. När kontot skapas öppnar portalen kontot på ett nytt blad i portalen.
...
6. Klicka på **Data Explorer** högst upp på Data Lake Analytics-kontobladet. 
...
7. I bladet Data Lake Store-standardkonto klickar du på **Exempel** för att expandera mappen och klickar sedan på **Data** för att expandera mappen. Du bör se följande filer och mappar:
...
1. Klicka på **Skicka jobbet** längst upp. Ett nytt jobbdetaljfönster öppnas. I namnlisten visas jobbets status.   
2. Vänta tills jobbstatusen har ändrats till **Lyckades**. När jobbet är slutfört, öppnar portalen jobbdetaljerna i ett nytt blad:
...
3. Längst ned på bladet **Jobbdetaljer** klickar du på jobbnamnet i **SearchLog-from-Data-Lake.csv**. Du kan förhandsgranska, hämta, byta namn på och ta bort utdatafilen.
...
4. Klicka på **Förhandsgranska** för att se utdatafilen.
