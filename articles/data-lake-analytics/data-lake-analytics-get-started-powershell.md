<properties 
   pageTitle="Kom igång med Azure Data Lake Analytics med hjälp av Azure PowerShell | Azure" 
   description="Lär dig att skapa ett Data Lake Store-konto med hjälp av Azure PowerShell samt skapa ett Data Lake Analytics-jobb med hjälp av U-SQL och skicka jobbet. " 
...
- **En arbetsstation med Azure PowerShell**. Se [Så här installerar och konfigurerar du Azure PowerShell](../powershell-install-configure.md).
