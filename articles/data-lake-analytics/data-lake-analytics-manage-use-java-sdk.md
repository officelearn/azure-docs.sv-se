...
Gå till **fil > Inställningar > Skapa > körning > distribution**. Välj **Byggverktygen > Maven > Importera**. Kontrollera sedan **importera Maven-projekt automatiskt**.

Öppna `Main.java` och Ersätt det befintliga kodblocket med följande kodavsnitt:
...
Ange värden för parametrarna som påpekas i kodfragmentet:
* `localFolderPath`
* `_adlaAccountName`
* `_adlsAccountName`
* `_resourceGroupName`
...
### <a name="setup-clients"></a>Konfigurera klienter
...
### <a name="wait-for-input"></a>Vänta tills indata
