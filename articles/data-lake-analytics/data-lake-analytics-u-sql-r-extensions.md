...
* U-SQL-strängar kan konverteras till faktorer i R-kod, när U-SQL skapa R-dataframe eller genom att ange parametern `stringsAsFactors: true`för minskning.
