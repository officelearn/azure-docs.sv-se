...
Första gången användaren, använda **ADL: Hämta lokala kör paketet** att hämta lokala kör paket, om du inte har [konfigurera U-SQL lokalt körningsmiljön](#set-up-the-u-sql-local-run-environment).
...
3. Installera C# för Visual Studio Code enligt förslaget i meddelanderutan om inte är installerad. Klicka på **installera** att fortsätta och starta sedan om VSCode.
