...
### [Använda MapReduce på HDInsight](data-lake-store-performance-tuning-mapreduce.md)
...
## [Python (filsystemshantering)](https://azure-datalake-store.readthedocs.io/en/latest)
## [REST](/rest/api/datalakestore)
## [Resource Manager-mall](/azure/templates/microsoft.datalakestore/allversions)
