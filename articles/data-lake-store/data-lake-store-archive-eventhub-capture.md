---
title: Samla in data från Event Hubs i Azure Data Lake Storage Gen1 | Microsoft Docs
description: Använd Azure Data Lake Storage Gen1 för att avbilda data från Event Hubs
...
1. I fönstret **Översikt** i Event Hubs namn området klickar du på **+ händelsehubben**.
    ...
    ![Skapa Händelsehubben](./media/data-lake-store-archive-eventhub-capture/data-lake-store-create-event-hub.png "Skapa händelsehubb")

1. Ange följande värden för att konfigurera Event Hubs att avbilda data till Data Lake Storage Gen1.

    ![Skapa Händelsehubben](./media/data-lake-store-archive-eventhub-capture/data-lake-store-configure-eventhub.png "Skapa händelsehubb")
