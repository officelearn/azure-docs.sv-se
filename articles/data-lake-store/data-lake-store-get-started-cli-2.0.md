...
---
# <a name="get-started-with-azure-data-lake-store-using-azure-cli-20-preview"></a>Komma igång med Azure Data Lake Store med hjälp av Azure CLI 2.0 (förhandsversion)
...
## <a name="enable-data-lake-store-preview-in-azure-cli-20"></a>Aktivera Data Lake Store (förhandsversion) i Azure CLI 2.0

Data Lake Store CLI 2.0 är för närvarande tillgängligt som en förhandsversion och aktiveras inte som standard när du installerar Azure CLI 2.0. Kör följande kommando om du vill aktivera Data Lake Store CLI 2.0.
