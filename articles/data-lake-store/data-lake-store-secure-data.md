...
5. Klicka på **Save** (Spara). Du bör se säkerhets gruppen som lagts till enligt nedan.
...
## <a name="filepermissions"></a>Tilldela användare eller säkerhets grupper som ACL: er till Data Lake Storage Gen1 fil systemet
