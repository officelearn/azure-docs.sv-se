...
Utdata för begäran innehåller en autentiseringstoken (anges av `access-token` i utdata nedan) som du sedan skickar med dina REST API-anrop. Spara autentiseringstoken i en textfil. du behöver den när du gör REST-anrop till Data Lake Storage Gen1.
