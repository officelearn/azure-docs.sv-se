...
ms.locfileid: "86512494"
---
# <a name="use-powershell-to-set-azure-data-share-sychronization-settings"></a>Använd PowerShell för att ställa in synkroniseringsaktivitet-inställningar för Azure Data resurs
