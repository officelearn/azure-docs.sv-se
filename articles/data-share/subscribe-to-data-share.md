...
1. Kontrol lera Inkorgen för en inbjudan från din data leverantör. Inbjudan är från Microsoft Azure, med titeln **Azure Data Share-inbjudan från <yourdataprovider@domain.com>** . Anteckna resurs namnet så att du vet att du accepterar rätt resurs om det finns flera inbjudningar. 

1. Välj på **Visa inbjudan** för att se din inbjudan i Azure. Då går du till vyn mottagna resurser.
