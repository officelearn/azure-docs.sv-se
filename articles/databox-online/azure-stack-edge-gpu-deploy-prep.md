...
|  | |
|**Distributions självstudier** |De här självstudierna krävs för att distribuera Azure Stack Edge-enheten i produktionen. |
|**[1. Förbered Azure Portal för Azure Stack Edge](azure-stack-edge-gpu-deploy-prep.md)** |Skapa och konfigurera din Azure Stack Edge-resurs innan du installerar en fysisk enhet i Azure Stack Box Edge. |
|**[2. Installera Azure Stack Edge](azure-stack-edge-gpu-deploy-install.md)**|Packa upp, racka och kablar Azure Stack Edge-fysiska enheten.  |
|**[3. Anslut till Azure Stack Edge](azure-stack-edge-gpu-deploy-connect.md)** |När enheten har installerats ansluter du till enhetens lokala webb gränssnitt.  |
|**[4. Konfigurera nätverks inställningar för Azure Stack Edge](azure-stack-edge-gpu-deploy-configure-network-compute-web-proxy.md)** |Konfigurera nätverket inklusive inställningar för beräknings nätverk och webbproxy för enheten.   |
...
4. Välj enhets typ. Under **Azure Stack Edge Commercial**väljer du **Azure Stack Edge med GPU** och väljer **Registrera dig**. 

    ![Skapa en resurs 2](media/azure-stack-edge-gpu-deploy-prep/create-resource-2.png)

5. Ett kort formulär visas. Fyll i formuläret och välj **Skicka**. Microsoft kommer att aktivera din prenumeration.
...
> [Installera Azure Stack Edge](./azure-stack-edge-gpu-deploy-install.md)
