---
title: Fel sökning av certifikat med Azure Stack Edge | Microsoft Docs
description: Beskriver fel sökning av certifikat fel med Azure Stack Edge-enhet.
