---
title: Azure Data Box Edge hantera bandbredds scheman | Microsoft Docs
description: Beskriver hur du använder Azure Portal för att hantera bandbredds scheman på din Azure Data Box Edge.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
---
# <a name="use-the-azure-portal-to-manage-bandwidth-schedules-on-your-azure-data-box-edge"></a>Använd Azure Portal för att hantera bandbredds scheman på din Azure Data Box Edge  
...
Du kan lägga till, ändra eller ta bort bandbredds scheman för Data Box Edge via Azure Portal.
...
1. I Azure Portal för din Data Box Edge-resurs går du till **bandbredd**.
...
3. Ett schema skapas med de angivna parametrarna. Schemat visas sedan i listan över bandbreddsscheman i portalen.
    ...
    ![Uppdaterad lista över bandbredds scheman](media/data-box-edge-manage-bandwidth-schedules/add-schedule-3.png)

## <a name="edit-schedule"></a>Redigera schema

Gör följande om du vill redigera ett bandbreddsschema.

1. Gå till Data Box Edge-resursen i Azure Portal och gå sedan till **bandbredd**. 
2. Välj i listan över bandbredds scheman och välj ett schema som du vill ändra.
    ![Välj schema för bandbredd](media/data-box-edge-manage-bandwidth-schedules/modify-schedule-1.png)
...
Utför följande steg för att ta bort ett schema för bandbredd som är kopplat till din Data Box Edge-enhet.
