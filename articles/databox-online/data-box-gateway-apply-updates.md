...
1. När uppdateringarna är tillgängliga för din enhet visas ett meddelande. Välj meddelandet eller från det övre kommando fältet, **Uppdatera enhet**. Detta gör att du kan tillämpa enhets program uppdateringar.
    ...
    ![Skärm bild av Azure Stack Edge Data Box Gateway start sidan med alternativen översikt och uppdatera enhet som kallas för.](./media/data-box-gateway-apply-updates/portal-apply-update-01a.png)
...
3. Hämtningen av uppdateringar startar. Du ser ett meddelande om att nedladdningen pågår.
    ...
    ![Skärm bild av Azure Stack Edge Data Box Gateway start sidan med alternativet översikt och meddelande banderollen Ladda ned uppdateringar som kallas för.](./media/data-box-gateway-apply-updates/portal-apply-update-08a.png)
...
5. Du ser ett meddelande om att installationen pågår.
    ...
    ![Skärm bild av Azure Stack Edge Data Box Gateway start sidan med alternativet översikt och meddelandet nedladdnings-och installations förlopp som kallas.](./media/data-box-gateway-apply-updates/portal-apply-update-12a.png)
...
6. Eftersom det här är en enhet med 1 nod startar enheten om när uppdateringarna har installerats. Den kritiska varningen under omstarten indikerar att enhetens pulsslag förloras.
    ...
    ![Skärm bild av Azure Stack Edge Data Box Gateway start sidan med översikts alternativet och den kritiska varnings banderollen som anropas.](./media/data-box-gateway-apply-updates/portal-apply-update-19a.png)
...
7. Enhets statusen uppdateras till **online** efter att uppdateringarna har installerats.
    ...
    ![Skärm bild av Azure Stack Edge Data Box Gateway start sidan med alternativet översikt och online-statusen som kallas.](./media/data-box-gateway-apply-updates/portal-apply-update-23a.png)
