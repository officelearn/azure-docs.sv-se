...
description: Beskriver användningsfallen för Azure Data Box-Gateway, en virtuell installation lagringslösning som gör det möjligt att överföra data till Azure
services: databox
author: alkohli
ms.service: databox
ms.topic: article
