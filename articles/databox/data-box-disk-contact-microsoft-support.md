---
title: Loggsupportbiljett eller öppna ärende för Azure Data Box | Microsoft-dokument
description: Lär dig hur du loggar supportbegäran för problem som rör dina databox- eller databoxdiskorder.
services: databox
author: alkohli
ms.service: databox
ms.subservice: disk
...
Läs om hur du [felsöker problem relaterade till Data Box](data-box-troubleshoot.md).
Läs om hur du [felsöker problem relaterade till dataruteblobar lagring](data-box-troubleshoot-rest.md).
