...
När diskarna är anslutna och olåsta kan du kopiera data från käll data servern till diskarna. När data kopieringen är klar bör du validera data för att säkerställa att de överförs till Azure.
