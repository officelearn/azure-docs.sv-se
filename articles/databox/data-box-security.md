...
- Autentiseringsuppgifter för åtkomst till att kopiera data till och från enheten.
...
- Data raderas från enheten när uppladdningen till Azure är klar. Dataraderingen följer NIST 800-88r1-standarder.
