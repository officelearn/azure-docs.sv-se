---
title: Visa och konfigurera DDoS Protection-telemetri
...
ms.locfileid: "92905689"
---
# <a name="view-and-configure-ddos-protection-telemetry"></a>Visa och konfigurera DDoS Protection-telemetri
...
Information om hur du simulerar en DDoS-attack för att validera telemetri finns i [validera DDoS-identifiering](test-through-simulations.md).
...
> [Konfigurera DDoS-attackens minsknings rapporter och flödes loggar](reports-and-flow-logs.md)