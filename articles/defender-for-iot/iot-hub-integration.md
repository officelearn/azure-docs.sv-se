---
title: Defender för IoT-tjänsten utan säkerhets agenter
description: Kom igång med det inbyggda arbets flödet för tjänsten Defender for IoT.
...
ms.locfileid: "90941701"
---
# <a name="get-started-with-built-in-iot-hub-integration"></a>Kom igång med inbyggd IoT Hub-integrering

Med det här alternativet kan du använda tjänsten utan att använda Defender för IoT-säkerhetsagenter.
...
Grattis! Du har slutfört aktiveringen av tjänsten Defender för IoT på din IoT Hub.
