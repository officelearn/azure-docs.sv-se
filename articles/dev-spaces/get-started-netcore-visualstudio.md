...
![Dialog rutan nytt projekt visar hur du skapar ett C-skarpt webb program med namnet "webfrontend" i plats C:\Source\Repos. List rutan "lösning" visar "Skapa ny lösning" och kryss rutan "Skapa katalog för lösning" är markerad.](media/get-started-netcore-visualstudio/NewProjectDialog1.png)
...
![I dialog rutan "ny S P dot NET Core Web Application", visar två List rutor "dot NET Core" och "A S P dot NET Core 2 punkt 0". I en matris med knappar för projekt mal len nedanför List rutorna är mallen "webb program (modell-Visa-kontrollant)" vald. Kryss rutan Aktivera Docker support är inte markerad.](media/get-started-netcore-visualstudio/NewProjectDialog2.png)
...
![Den nedrullningsbara List rutan visas överst i ett fönster med namnet Microsoft Visual Studio int Preview. "Azure dev Spaces" är markerat.](media/get-started-netcore-visualstudio/LaunchSettings.png)
...
![Dialog rutan Azure dev Spaces innehåller följande rutor: "prenumeration", "Azure Kubernetes service Cluster" och "Space".](media/get-started-netcore-visualstudio/Azure-Dev-Spaces-Dialog.PNG)
...
![Kryss rutan allmänt tillgänglig är markerad.](media/get-started-netcore-visualstudio/Azure-Dev-Spaces-Dialog2.png)
...
![Meddelandet läser: Lägg till Azure dev Spaces-resurs? Det valda ett K S-kluster måste konfigureras för att använda Azure dev-utrymmen innan det kan användas. Vill du göra det? " Det finns knapparna "O K" och "Avbryt".](media/get-started-netcore-visualstudio/Add-Azure-Dev-Spaces-Resource.png)
...
![Popup-fönstret som visas vid hovring visar "skapa" My A K S "i resurs gruppen."](media/get-started-netcore-visualstudio/BackgroundTasks.PNG)
...
![Filen "a z d s dot-yaml" visas i lösningen "webfrontend" i fönstret Solution Explorer.](media/get-started-netcore-visualstudio/ProjectFiles.png)
