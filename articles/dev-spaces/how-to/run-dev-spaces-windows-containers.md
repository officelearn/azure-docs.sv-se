...
Exempel programmet använder [Helm 3][helm-installed] för att köra Windows-tjänsten på klustret. Navigera till `charts` Directory och Använd Helm kör Windows-tjänsten:
