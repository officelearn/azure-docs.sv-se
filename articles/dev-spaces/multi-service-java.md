...
1. Tryck på F5 och vänta tills tjänsten har skapats och distribuerats. You'll know it's ready when a message similar to the below appears in the debug console:
