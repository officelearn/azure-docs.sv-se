...
Generera Docker-och Helm-diagrammets till gångar för att köra programmet i Kubernetes med hjälp av `azds prep` kommandot:
...
Du kan se den tjänst som körs genom att öppna den offentliga URL: en, som visas i utdata från `azds up` kommandot. I det här exemplet är den offentliga URL: en *`http://webfrontend.1234567890abcdef1234.eus.azds.io/`* .
