...
- Ett Kubernetes-kluster som kör Kubernetes 1.9.6 eller senare i området USAÖstra, USACentrala, USAVästra2, EuropaVästra, KanadaCentrala eller KanadaÖstra med HTTP-programroutning aktiverat.
