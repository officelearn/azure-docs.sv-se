...
* Av detta följer att all slags integreringstestning blir komplicerad. Realistiskt sett kan integrationstestning endast ske när koden checkats in, vilket kan medföra problem senare i utvecklingscykeln.
    ...
    ![Diagram som illustrerar de utmaningar som du möter när du utvecklar mikrotjänster.](media/common/microservices-challenges.png)
...
![Ett diagram som visar en enkel C I C D Spaces-installation.](media/common/ci-cd-space-setup.png)
...
Gå till VS Code-fönstret `mywebapi` och gör en kod redigering till `String index()` -metoden i `src/main/java/com/ms/sample/mywebapi/Application.java` , till exempel:
