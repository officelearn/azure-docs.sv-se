---
title: Grupp utveckling med Azure dev Spaces med hjälp av .NET Core och VS Code
...
ms.locfileid: "74279530"
---
# <a name="team-development-with-azure-dev-spaces-using-net-core-and-vs-code"></a>Grupp utveckling med Azure dev Spaces med hjälp av .NET Core och VS Code
...
Gå till VS Code-fönstret för `mywebapi` och gör en kod redigering till metoden `string Get(int id)` i `Controllers/ValuesController.cs`, till exempel:
