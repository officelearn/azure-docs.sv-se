...
Konfigurera kontinuerlig integrering (CI) och kontinuerlig leverans (CD) för ditt .NET Core- eller ASP.NET-program med **Azure DevOps-projektet**.  Azure DevOps-projektet förenklar den initiala konfigurationen av en VSTS-version och lanseringspipeline.
...
1. Skapa ett **nytt** kostnadsfritt VSTS-konto eller välj ett **befintligt** konto.  Välj ett **namn** för ditt VSTS-projekt.  Välj din **Azure-prenumeration**, **plats** och välj ett **namn** för ditt program.  När du är klar väljer du **Klar**.
    ...
    ![Ange VSTS-information](_img/azure-devops-project-aspnet-core/vstsazureinfo.png)
