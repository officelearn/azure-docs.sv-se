---
title: 'Snabbstart: Skapa en CI/CD-pipeline för Java - Azure DevOps-projekt'
...
---
# <a name="quickstart-set-up-a-cicd-pipeline-for-a-java-app-with-azure-devops-projects"></a>Snabbstart: Konfigurera en CI/CD-pipeline för en Java-app med Azure DevOps-projekt

I den här snabbstarten använder du den förenklade Azure DevOps-projektupplevelsen för att konfigurera en pipeline för kontinuerlig integrering (CI) och cd-pipeline (continuous delivery) för java-appen i Azure Pipelines. Du kan använda Azure DevOps-projekt för att konfigurera allt du behöver för att utveckla, distribuera och övervaka din app. 
...
1. Logga in på [Azure-portalen](https://portal.azure.com)och välj **Skapa en resurs**i den vänstra rutan . 
   ...
   ![Skapa en Azure-resurs i Azure-portalen](_img/azure-devops-project-java/continuous-delivery-configuration-full-browser.png)
...
2. Visa ditt körande program genom att välja **Bläddra**.
   ...
   ![Visa instrumentpanelen för program i Azure-portalen](_img/azure-devops-project-java/azure-devops-application-dashboard.png) 
...
1. Peka på fältet **Status** och välj sedan ellipsen (...).  
