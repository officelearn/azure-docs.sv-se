...
Azure DevOps-projektet ger ett förenklat sätt att skapa Azure-resurser och konfigurerar en pipeline för kontinuerlig integrering (CI) och kontinuerlig leverans (CD) för din Python-app i Visual Studio Team Services (VSTS), som är Microsofts DevOps-lösning för Azure.  
...
1. Skapa ett **nytt** VSTS-konto eller välj ett **befintligt** konto.  Välj ett **namn** för ditt VSTS-projekt.  Välj din **Azure-prenumeration**, **plats** och välj ett **namn** för ditt program.  När du är klar väljer du **Klar**.
    ...
    ![Ange VSTS-information](_img/azure-devops-project-python/vstsazureinfo.png)
