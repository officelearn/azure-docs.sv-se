...
Konfigurera kontinuerlig integrering (CI) och kontinuerlig leverans (CD) för ditt Ruby on Rails-program med **Azure DevOps-projektet**.  Azure DevOps-projektet förenklar den initiala konfigureringen av en Azure DevOps Services-version och lanseringspipeline.
