...
8. Spara den genererade token. Senare ska du använda token.
9. Stäng GitHub.   
...
1. Gå till startsidan för team samlingen (till exempel https://contoso-web-team.visualstudio.com) och välj sedan projektet.
2. På startsidan projektet väljer **kod**.
3. Visa klon-URL på projektet **kod** väljer **klona**.
4. Spara URL: en. Du kommer att använda Webbadressen senare.
