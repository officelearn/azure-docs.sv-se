...
- Med `01` deras port
- Som tillhör enheter med **tillverkaren** av den utökade egenskaps nyckeln har angetts till det Escape-sträng svärdet`\"Contoso\"`
...
[GitHub-lagrings platsen för det digitala flätade C#-exemplet](https://github.com/Azure-Samples/digital-twins-samples-csharp/) innehåller några exempel på användardefinierade funktioner:
