...
4. Skapa en digital Azure Digital- [slutpunkt](concepts-route-events.md#create-an-endpoint) som länkar ditt event Grid-ämne till din Azure Digital-instansen.
