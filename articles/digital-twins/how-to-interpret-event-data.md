...
Texten är nytto lasten i en relation, även i JSON-format. Den använder samma format som en `GET` begäran om en relation via DigitalTwins- [API: et](/rest/api/digital-twins/dataplane/twins). 
