...
Kör slutligen och konfigurera ADT Explorer för att ansluta till den ursprungliga Azure Digital-instansen. Följ stegen i avsnittet [*köra och konfigurera ADT Explorer*](quickstart-adt-explorer.md#run-and-configure-adt-explorer) i snabb starten.
...
* Du **behöver inte** återskapa registreringen av appen. Din nya instans kan återanvända samma app-registrering som du redan har.
    - Om du använder den [skriptbaserade](how-to-set-up-instance-scripted.md) installations artikeln kan du ange information om din befintliga App-registrering i stället för att ange ett nytt namn när du uppmanas att göra det.
    - Om du använder den manuella [Portal](how-to-set-up-instance-portal.md) -eller [CLI](how-to-set-up-instance-cli.md) -installationen kan du stoppa efter steget *Skapa Azure Digital-instansen* och *Konfigurera användar åtkomst behörighet* . Du behöver inte fortsätta med *att konfigurera åtkomst behörigheter för klient program*.
