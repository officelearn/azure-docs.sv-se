...
* Du kan för närvarande komma åt SDK: er för kontroll-API: er i...
  ...
  - [**Java**](https://search.maven.org/artifact/com.microsoft.azure.digitaltwins.v2020_10_31/azure-mgmt-digitaltwins/1.0.0/jar) ([referens [automatiskt genererad]](/java/api/overview/azure/digitaltwins?view=azure-java-stable)) ([källa](https://github.com/Azure/azure-sdk-for-java/tree/master/sdk/digitaltwins/mgmt-v2020_10_31))
...
* Du kan använda **Java SDK**. För att använda Java SDK...
   ...
   - Du kan visa [SDK Reference-dokumentationen](/java/api/overview/azure/digitaltwins/client?preserve-view=true&view=azure-java-stable)
...
* Du kan använda **Java Script SDK**. För att använda JavaScript SDK...
   ...
   - Du kan visa [SDK Reference-dokumentationen](/javascript/api/@azure/digital-twins-core/?branch=master&view=azure-node-latest&preserve-view=true).
...
* Du kan använda **python SDK**. Använda python SDK...
   ...
   - Du kan visa [SDK Reference-dokumentationen](/python/api/azure-digitaltwins-core/azure.digitaltwins.core?view=azure-python&preserve-view=true).
