...
1. Konfigurera UDF-filen så att den inkluderar temperatur matchning genom att lägga till eller ta bort kommentar till följande `matcherNames` rad i noden i filen *provisionSample. yaml* :
