...
- *TaskType*. Typ av migreringen för att skapa för SQL Server till Azure SQL-databasinstans Managaged Migreringstyp *MigrateSqlServerSqlDbMi* förväntas. 
