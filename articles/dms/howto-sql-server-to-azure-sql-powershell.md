...
I följande exempel skapas `AzureRmDataMigrationDatabaseInfo` projektet för databasen AdventureWorks2016 och läggs till i listan anges som parameter för att skapa projekt.
