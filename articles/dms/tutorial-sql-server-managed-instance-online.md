---
title: 'Självstudier: Använda Azure Database Migration Service för att utföra en online-migrering av SQL Server till en Azure SQL Database managed instance | Microsoft Docs'
...
1. På sidan **Konfigurera migreringsinställningar** anger du följande information:
    ...
    |**Prenumeration på Azure Storage-konto** | Välj den prenumeration som innehåller Azure Storage-kontot. |
