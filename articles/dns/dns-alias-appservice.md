...
Till exempel contoso.com och www\.contoso.com kan peka på samma Traffic Manager-profilen. Detta är fallet så länge Traffic Manager-profilen har endast externa slutpunkter som har konfigurerats.
...
5. Acceptera standardinställningarna och använda tabellen nedan för att konfigurera två web apps:
   ...
   |---------|---------|---------|
   |App-01|Använd befintlig<br>Välj din resursgrupp|ASP-01(East US)|
   |App-02|Använd befintlig<br>Välj din resursgrupp|ASP-02(Central US)|
...
Information om hur du skapar en Traffic Manager-profilen finns i [snabbstarten: Skapa en Traffic Manager-profil för en högtillgänglig webbprogram](../traffic-manager/quickstart-create-traffic-manager-profile.md).
