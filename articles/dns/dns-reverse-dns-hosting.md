...
Den här artikeln vägleder dig igenom stegen för att skapa din första DNS-zon för omvänd sökning och -post med hjälp av Azure portal, Azure PowerShell, Azure CLI 1.0 eller Azure CLI 2.0.
