...
description: "En självstudiekurs som beskriver hur du skapar en onlinedatabas och ett C#-konsolprogram med hjälp av .NET Core SDK för Azure Cosmos DB DocumentDB-API:et."
services: cosmosdb
...
---
# <a name="azure-cosmos-db-getting-started-with-the-documentdb-api-and-net-core"></a>Azure Cosmos DB: Komma igång med DocumentDB-API:et och .NET Core
...
Välkommen till självstudiekursen som hjälper dig att komma igång med Azure Cosmos DB! När du har genomfört den här självstudiekursen har du en konsolapp som skapar och skickar frågor till DocumentDB-resurser.
...
* Ett aktivt Azure-konto. Om du inte har ett kan du registrera dig för ett [kostnadsfritt konto](https://azure.microsoft.com/free/).
* Ett [Azure Cosmos DB-konto][documentdb-create-account].
...
* Behöver du en mer komplex ASP.NET MVC-självstudiekurs? Se [Skapa en webbapp med ASP.NET MVC via DocumentDB](documentdb-dotnet-application.md).
...
* Vill du testa skalning och prestanda med Azure Cosmos DB? Mer information finns i avsnittet om hur du [testar prestanda och skalning med Azure Cosmos DB](documentdb-performance-testing.md)
...
* Mer information om programmeringsmodellen finns i avsnittet Utveckla på [dokumentationssidan för DocumentDB](https://azure.microsoft.com/documentation/services/documentdb/).
