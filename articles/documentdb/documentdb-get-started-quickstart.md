...
* **[QuickStart](#quickstart)**: Hämta exempelprojektet, lägg till anslutningsinformation och få igång en DocumentDB-app på färre än 10 minuter.
...
1. Ladda ned exempelprojektet .zip från [GitHub](https://github.com/Azure-Samples/documentdb-dotnet-getting-started-quickstart/archive/master.zip) eller klona [documentdb-dotnet-getting-started-quickstart](https://github.com/Azure-Samples/documentdb-dotnet-getting-started-quickstart) repo.
...
## <a name="a-idtutorialatutorial"></a><a id="tutorial"></a>Självstudier
