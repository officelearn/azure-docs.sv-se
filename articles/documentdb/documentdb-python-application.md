...
> [AZURE.IMPORTANT] Om du installerar Python 2.7 för första gången ska du vara noga med att välja **Lägg till python.exe i sökväg**på skärmen Anpassa Python 2.7.11.
> 
