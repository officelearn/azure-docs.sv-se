---
title: 'Självstudiekurs: Skicka anpassade händelser till hybridanslutning - Event Grid'
description: 'Självstudiekurs: Använd Azure Event Grid och Azure CLI för att publicera ett ämne och prenumerera på den händelsen. En hybridanslutning används för slutpunkten.'
services: event-grid
keywords: ''
author: spelluru
ms.author: spelluru
...
ms.locfileid: "73720697"
---
# <a name="tutorial-route-custom-events-to-azure-relay-hybrid-connections-with-azure-cli-and-event-grid"></a>Självstudiekurs: Dirigera anpassade händelser till Azure Relay Hybrid-anslutningar med Azure CLI och Event Grid
...
Du prenumererar på ett ämne för händelserutnät för att tala om för Event Grid vilka händelser du vill spåra. I följande exempel prenumererar du på det anpassade ämne som du skapade och skickar resurs-ID:t för hybridanslutningen för slutpunkten. Hybridanslutnings-ID är i formatet:
...
1. Se till att du har Visual Studio 2019 eller senare.
