...
> [!NOTE]
> Om du använder DFS-slutpunkten *`(abfss://URI) `* för konton som inte är hierarkiskt bevarade, genereras inte händelser. För sådana konton kommer endast BLOB-slutpunkten *`(wasb:// URI)`* att generera händelser.
