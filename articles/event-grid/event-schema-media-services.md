---
title: Azure Media Services som källa för händelserutnät
...
---
# <a name="azure-media-services-as-an-event-grid-source"></a>Azure Media Services som källa för händelserutnät
...
Du hittar felresultatkoderna i [felkoder för livehändelse](../media-services/latest/live-event-error-codes.md).
...
[Registrera dig för jobbtillståndsändringshändelser](../media-services/latest/job-state-events-cli-how-to.md)
