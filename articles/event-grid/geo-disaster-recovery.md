...
- **Data RPO**: Om datorn är felfri och uppdateringar på befintliga trafiken vid tidpunkten för regional redundans, Återställningspunktmålet för händelser är cirka 5 minuter.
