...
> [!NOTE]
> Om du vill veta mer om meddelande leverans, nya försök och obeställbara meddelanden, se den konceptuella artikeln: [Event Grid meddelande leverans och försök igen](delivery-and-retry.md).
