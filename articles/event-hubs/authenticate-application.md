...
- [Azure Event Hubs data](../role-based-access-control/built-in-roles.md#azure-event-hubs-data-sender)avsändare: Använd den här rollen för att ge sändnings åtkomst till Event Hubs-resurser.
