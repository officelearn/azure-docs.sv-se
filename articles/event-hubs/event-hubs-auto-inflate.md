...
Du kan aktivera automatisk ökning under en Azure Resource Manager mall-distribution. Ange till exempel egenskapen `isAutoInflateEnabled` till **True** och ange `maximumThroughputUnits` till 10. Exempel:
