---
title: Skicka händelser med Java – Azure Event Hubs | Microsoft Docs
description: Den här artikeln innehåller en genomgång om hur du skapar ett Java-program som skickar händelser till Azure Event Hubs.
services: event-hubs
