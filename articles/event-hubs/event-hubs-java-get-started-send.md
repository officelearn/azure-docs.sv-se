...
I den här snabbstarten har du skickat meddelanden till en event hub med Java. Läs hur du tar emot händelser från en händelsehubb med hjälp av .NET Framework i [ta emot händelser från event hub - Java](event-hubs-java-get-started-receive-eph.md).
