---
title: 'Azure ExpressRoute: Anslutningsmodeller'
description: I den här artikeln beskrivs de olika anslutningssätten mellan kundens nätverk och Microsoft Azure och Office 365-tjänster. Kunder kan använda MPLS-leverantörer, molnutbyten och Ethernet-leverantörer.
...
## <a name="co-located-at-a-cloud-exchange"></a><a name="CloudExchange"></a>Samlokalt vid ett molnutbyte
...
## <a name="point-to-point-ethernet-connections"></a><a name="Ethernet"></a>Ethernet-anslutningar från punkt till punkt
...
## <a name="any-to-any-ipvpn-networks"></a><a name="IPVPN"></a>Alla IPVPN-nätverk (Any-to-any)
