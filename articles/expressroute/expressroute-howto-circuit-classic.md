...
Du kan hämta den här informationen när som helst genom att `Get-AzureCircuit` använda cmdleten. Om du gör anropet utan några parametrar visas alla kretsar.
