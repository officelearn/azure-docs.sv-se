...
Om du bara kör *$ckt _1* i PowerShell visas *CircuitConnectionStatus* i utdata. Det visar om anslutningen har upprättats, "ansluten" eller "frånkopplad". 
