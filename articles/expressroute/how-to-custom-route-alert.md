...
* Du är van att använda Azure PowerShell. Azure PowerShell krävs för att samla in nätverks prefix i ExpressRoute-gatewayen. Mer information om Azure PowerShell i allmänhet finns i Azure PowerShell- [dokumentationen](/powershell/azure/?view=azps-4.1.0).
