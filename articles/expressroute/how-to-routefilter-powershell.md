---
title: 'Konfigurera väg filter för Microsoft-peering-ExpressRoute: PowerShell: Azure | Microsoft Docs'
...
### <a name="about"></a>Om flödes filter
...
### <a name="getproperties"></a>Hämta egenskaperna för ett flödes filter
...
### <a name="updateproperties"></a>Så här uppdaterar du egenskaperna för ett flödes filter
...
### <a name="detach"></a>Koppla bort ett flödes filter från en ExpressRoute-krets
...
### <a name="delete"></a>Ta bort ett flödes filter
