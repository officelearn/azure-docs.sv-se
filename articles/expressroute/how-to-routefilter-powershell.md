...
Innan du börjar konfigurera måste du kontrollera att du uppfyller följande kriterier:
 ...
 - Installera den senaste versionen av Azure Resource Managers PowerShell-cmdletar. Mer information finns i [installera och konfigurera Azure PowerShelll](/powershell/azure/install-azurerm-ps).
