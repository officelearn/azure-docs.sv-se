...
|  |**Hubb virtuellt nätverk**|**Skyddad virtuell hubb**  |
|---------|---------|---------|
...
|**Brand vägg för webbaserade program på Application Gateway** |Stöds i Virtual Network|Stöds för närvarande i eker-nätverk|
