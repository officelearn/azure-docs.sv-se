...
ms.locfileid: "47048140"
---
# Ny AzureRmFrontDoor

Skapa en ny ytterdörren för Azure load balancer
...
## BESKRIVNING
Den **New AzureRmFrontDoor** cmdlet skapar en ny Azure ytterdörren belastningsutjämnare i den angivna resursgruppen under den aktuella prenumerationen

## EXEMPEL

### Exempel 1: Skapa en åtkomsten baserat på de angivna parametrarna.
```powershell
...
Skapa en åtkomsten baserat på de angivna parametrarna.
...
### -EnabledState
EnabledState för belastningsutjämnaren ytterdörren.
...
### -ResourceGroupName
Resursgruppens namn som ytterdörren kommer att skapas i.
