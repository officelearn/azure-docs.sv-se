...
ms.locfileid: "47048008"
---
# Ny AzureRmFrontDoorBackendObject
...
## BESKRIVNING
Skapa ett PSBackend-objekt för att skapa en ytterdörren
...
### -Adress
Platsen för serverdelen (IP-adress eller FQDN)
...
### -BackendHostHeader
Värdet som ska användas som värdrubrik som skickas till serverdelen. Standardvärdet är serverdelsadressen.
...
### -EnabledState
Om du vill aktivera användningen av serverdelen. Standardvärdet är aktiverat
...
### -Vikt
Vikten för den här slutpunkten för belastningsutjämning syften.
