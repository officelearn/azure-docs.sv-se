...
ms.locfileid: "47047755"
---
# Ny AzureRmFrontDoorBackendPoolObject

Skapa ett PSBackendPool-objekt för att skapa en ytterdörren
...
Namnet på health avsökningen inställningarna för den här serverdelspoolen
...
Namnet på de inställningar för den här serverdelspoolen för belastningsutjämning
