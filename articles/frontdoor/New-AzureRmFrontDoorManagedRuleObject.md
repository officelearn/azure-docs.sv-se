...
ms.locfileid: "47047768"
---
# Ny AzureRmFrontDoorManagedRuleObject
Skapa ManagedRule objekt för att skapa för WAF-princip
...
### -RuleGroupOverride
Listan över azure managed Providerkonfiguration för åsidosättning
...
### -Version
Versionen av den RuleSet-metod
