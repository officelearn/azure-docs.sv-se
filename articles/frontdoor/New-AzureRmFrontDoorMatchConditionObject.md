...
ms.locfileid: "47047774"
---
# Ny AzureRmFrontDoorMatchConditionObject
Skapa MatchCondition objekt för att skapa för WAF-princip
...
### -MatchVariable
Matcha variabeln.
Några möjliga värden är: ”RemoteAddr', 'RequestMethod', 'QueryString', 'PostArgs', 'RequestUri', 'RequestHeader', 'RequestBody'
...
### -NegateCondition
Beskriver om detta är negera villkor eller inte standardvärdet är FALSKT
...
Några möjliga värden är: 'Valfritt', 'IPMatch', 'GeoMatch', 'Equal', ”innehåller”, ”LessThan', 'GreaterThan', 'LessThanOrEqual', 'GreaterThanOrEqual', BeginsWith”, EndsWith''
...
### -Väljare
Namnet på väljare i RequestHeader eller RequestBody som ska matchas
