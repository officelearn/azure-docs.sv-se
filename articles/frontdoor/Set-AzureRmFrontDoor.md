...
ms.locfileid: "47048453"
---
# Set-AzureRmFrontDoor
Uppdatera en ytterdörren belastningsutjämnare
...
## BESKRIVNING
Den **Set-AzureRmFrontDoor** cmdlet: en uppdaterar ytterdörren belastningsutjämning. Om indataparametrar inte har angetts, används gamla parametrar från befintliga åtkomsten.

## EXEMPEL

### Exempel 1: uppdatera en befintlig ytterdörren med FrontDoorName och ResourceGroupName.
```powershell
...
Uppdatera en befintlig FrontDoor.

### Exempel 2: uppdatera en befintlig ytterdörren med PSFrontDoor objekt.
```powershell
...
### Exempel 3: uppdatera en befintlig ytterdörren med resurs-ID
```powershell
...
### -BackendPool
Backendpools som är tillgängliga för regel för vidarebefordran.
...
### -EnabledState
Driftstatus för belastningsutjämnaren ytterdörren.
...
### -FrontendEndpoint
Frontend-slutpunkter är tillgängliga för regel för vidarebefordran.
...
### -HealthProbeSetting
Avsökningen hälsomiljöer som är associerade med den här åtkomsten-instansen.
...
### -InputObject
Ytterdörren objektet uppdateras.
...
Inställningar som är associerade med den här åtkomsten-instansen för belastningsutjämning.
...
### -Namn
Namnet på åtkomsten att uppdatera.
...
### -Resurs-ID
Resurs-Id för åtkomsten att uppdatera
...
### -RoutingRule
Regler för routning som är associerade med den här FrontDoor
...
### -Tagg
Taggarna associera med FrontDoor.
