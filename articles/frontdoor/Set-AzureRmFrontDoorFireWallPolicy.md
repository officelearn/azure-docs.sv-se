...
ms.locfileid: "47047929"
---
# Set-AzureRmFrontDoorFireWallPolicy
WAF-uppdateringsprincip
...
## BESKRIVNING
Den **Set-AzureRmFrontDoor** cmdlet: en uppdaterar en befintlig WAF-princip. Om indataparametrar inte har angetts, används gamla parametrar från den befintliga WAF-principen.

## EXEMPEL

### Exempel 1: uppdatera en befintlig WAF
```powershell
...
Uppdatera en befintlig WAF

### Exempel 2: uppdatera en befintlig WAF
```powershell
...
### Exempel 3: uppdatera en befintlig WAF
```powershell
...
### Exempel 4: uppdatera alla principer för WAF i $resourceGroup
```powershell
...
Uppdatera alla principer för WAF i $resourceGroup
...
### -EnabledState
Om principen har aktiverade tillstånd eller inaktiverats.
Några möjliga värden är: ”inaktiverad”, ”Enabled”
...
### -InputObject
FireWallPolicy objektet uppdateras.
...
### -ManagedRule
Hanterade regler inom principen
...
### -Läge
Beskriver om den är i identifieringsläge eller förhindringsläge på principnivån för.
Några möjliga värden är: ”skydd”, ”identifiering”
...
### -Namn
Namnet på FireWallPolicy att uppdatera.
...
### -ResourceGroupName
Den resursgrupp som FireWallPolicy tillhör.
...
### -Resurs-ID
Resurs-Id för FireWallPolicy att uppdatera
