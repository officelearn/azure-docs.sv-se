...
Skapa en regel som blockerar ”PLACERA” metod använda [New AzFrontDoorCustomRuleObject](/powershell/module/az.frontdoor/new-azfrontdoorwafcustomruleobject) på följande sätt:
