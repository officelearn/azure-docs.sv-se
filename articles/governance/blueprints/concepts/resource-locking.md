...
|Läge|Artifact Resource Type|Status|Beskrivning|
|-|-|-|-|
...
|Skrivskyddad|Resursgrupp|Cannot Edit / Delete|The resource group is read only and tags on the resource group can't be modified. **Not Locked** resources can be added, moved, changed, or deleted from this resource group.|
|Skrivskyddad|Non-resource group|Skrivskyddad|The resource can't be altered in any way -- no changes and it can't be deleted.|
...
|-|-|-|-|-|-|
|Skrivskyddad |**\*** |**\*/read** |SystemDefined (Everyone) |blueprint assignment and user-defined in **excludedPrincipals** |Resource group - _true_; Resource - _false_ |
