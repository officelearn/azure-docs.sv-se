---
title: Distribuera HIPAA HITRUST skiss-exempel
...
ms.locfileid: "88211529"
---
# <a name="deploy-the-hipaa-hitrust-blueprint-sample"></a>Distribuera HIPAA HITRUST skiss-exemplet

För att distribuera HIPAA HITRUST skiss-exemplet måste följande steg vidtas:
...
|\[För hands version \] : distribuera Log Analytics agent för Windows VM Scale Sets (VMSS) |Principtilldelning |Log Analytics arbets yta för Linux VM Scale Sets (VMSS) |Om den här arbets ytan ligger utanför tilldelnings omfånget måste du manuellt bevilja behörigheten Log Analytics deltagare (eller liknande) till princip tilldelningens huvud-ID. |
