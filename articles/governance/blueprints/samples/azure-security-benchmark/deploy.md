---
title: Distribuera exempel på Azure Security benchmark-skiss
description: Distribuera steg för Azure Security benchmark-exemplet inklusive information om skiss artefakt parameter.
ms.date: 05/01/2020
ms.topic: sample
...
ms.locfileid: "82725968"
---
# <a name="deploy-the-azure-security-benchmark-blueprint-sample"></a>Distribuera skiss exemplet för Azure Security-mått
...
|-|-|-|-|
|Granska Azures säkerhets benchmark-rekommendationer och distribuera vissa stödda VM-tillägg|Principtilldelning|
Lista över användare som uteslutits från administratörs gruppen för Windows-datorer|En semikolonavgränsad lista med medlemmar som ska uteslutas i den lokala gruppen Administratörer. T. ex. administratör; Mina Användare1; myUser2|
...
Nu när du har granskat stegen för att distribuera utkastet för Azure Security benchmark kan du gå till följande artiklar om du vill veta mer om skiss-och kontroll mappning:

> [!div class="nextstepaction"]
> [Azure-säkerhet benchmark-skiss – översikt](./index.md)
> [Azure Security benchmark skiss-kontroll mappning](./control-mapping.md)
