---
title: Kanada Federal PBMM skiss prov kontroller
description: Kontroll kartläggning av Kanada Federal PBMM skiss prover. Varje kontroll mappas till en eller flera Azure-principer som hjälper till med utvärdering.
ms.date: 09/04/2019
ms.topic: sample
...
---
# <a name="control-mapping-of-the-canada-federal-pbmm-blueprint-sample"></a>Kontroll kartläggning av Kanada Federal PBMM ritning prov

I följande artikel beskrivs hur exempelmappningen azure blueprint-mappningsmappningar för Azure Blueprints Canada Federal Protected B, Medium Integrity, Medium Availability (PBMM) mappas till Kanadas federala PBMM-kontroller. Mer information om kontrollerna finns i [Canada Federal PBMM](https://www.canada.ca/en/government/system/digital-government/modern-emerging-technologies/cloud-services/government-canada-security-control-profile-cloud-based-it-services.html#toc4).

Följande mappningar är till **Kanada Federal PBMM** kontroller. Använd navigeringen till höger för att hoppa direkt till en specifik kontrollmappning. Många av de mappade kontrollerna implementeras med ett [Azure Policy-initiativ.](../../../policy/overview.md) Om du vill granska hela initiativet öppnar du **Princip** i Azure-portalen och väljer sidan **Definitioner.** Leta sedan reda ** \[på\]och välj förhandsversionen: Audit Canada Federal PBMM kontrollerar** inbyggt principinitiativ.
...
## <a name="location-constraints"></a>Platsbegränsningar

Den här skissen hjälper dig att begränsa platsen för distributionen av alla resurser och resursgrupper till "Canada Central" och "Canada East" genom att tilldela följande Azure Policy-definitioner:

- Tillåtna platser (har varit hårdkodade till "Canada Central" och "Canada East")
- Tillåtna platser för resursgrupper (har varit hårdkodade för "Canada Central" och "Canada East")
...
## <a name="ac-6-least-privilege"></a>Minst privilegium för AC-6
...
## <a name="au-3-2-content-of-audit-records"></a>AU-3 (2) Innehållet i revisionshandlingar
...
## <a name="ia-8-100-identification-and-authentication-non-organizational-users--identity-and-credential-assurance-levels"></a>IA-8 (100) Identifiering och autentisering (icke-organisatoriska användare) | Identitets- och autentiseringsuppgifter
...
Du har granskat kontrollen kartläggning av Kanada Federal PBMM skiss prov. Gå sedan till följande artiklar om du vill veta mer om översikten och hur du distribuerar det här exemplet:

> [!div class="nextstepaction"]
> [Kanada Federal PBMM plan - Översikt](./control-mapping.md)
> [Kanada Federal PBMM plan - Distribuera steg](./deploy.md)
