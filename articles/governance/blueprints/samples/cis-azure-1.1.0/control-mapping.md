---
title: CIS Microsoft Azure grunderna – rekommendations mappning
...
- \[Preview @ no__t-1: rollbaserad Access Control (RBAC) ska användas på Kubernetes-tjänster
