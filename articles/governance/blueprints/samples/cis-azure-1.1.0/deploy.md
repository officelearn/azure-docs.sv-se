---
title: Exempel på benchmark-Microsoft Azure grunder – distribuera steg
...
Nu när du har granskat stegen för att distribuera Microsoft Azure grunderna för benchmark-utkast kan du gå till följande artiklar om du vill veta mer om skiss-och kontroll mappning:

> [!div class="nextstepaction"]
> [CIS-Microsoft Azure grunderna benchmark-skiss – översikt](./index.md)
> [CIS Microsoft Azure grunderna benchmark-kontroll mappning](./control-mapping.md)
