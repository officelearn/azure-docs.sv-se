...
|\[för hands version\]: DoD-effekt nivå 4|Principtilldelning|Webbprogram bör enbart vara åtkomliga via HTTPS|Information om princip effekter finns i [förstå Azure policys effekter](../../../policy/concepts/effects.md).|
|\[för hands version\]: DoD-effekt nivå 4|Principtilldelning|Funktionen App bör enbart vara åtkomliga via HTTPS|Information om princip effekter finns i [förstå Azure policys effekter](../../../policy/concepts/effects.md).|
