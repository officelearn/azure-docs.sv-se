...
Den här skissen säkerställer att granskning och avancerad data säkerhet konfigureras på SQL-servrar.
...
- Granska diagnostikinställning
- Sårbarhets bedömning ska vara aktiverat på SQL-hanterad instans
...
Adaptiva program kontroller i Azure Security Center är en intelligent, automatiserad slut punkt till slut punkt som ger en lista över lösningar som kan blockera eller förhindra att specifik program vara körs på dina virtuella datorer. Med program kontroll kan du skapa godkända program listor för dina virtuella datorer. Den här skissen tilldelar en [Azure policy](../../../policy/overview.md) -definition som hjälper dig att övervaka virtuella datorer där en Application wallow-lista rekommenderas men inte har kon figurer ATS än.
...
Nu när du har granskat kontroll mappningen av DoD-effekten på nivå 5 kan du gå till följande artiklar för att lära dig om skissen och hur du distribuerar det här exemplet:

> [!div class="nextstepaction"]
> [DoD effekt nivå 5 skiss – översikt](./index.md) 
>  [DoD effekt nivå 5 skiss – distribuera steg](./deploy.md)
