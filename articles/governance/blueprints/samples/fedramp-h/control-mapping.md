---
title: FedRAMP Höga skissprovkontroller
description: Kontrollkartläggning av FedRAMP High-skissprovet. Varje kontroll mappas till en eller flera Azure-principer som hjälper till med utvärdering.
ms.date: 01/31/2020
ms.topic: sample
...
---
# <a name="control-mapping-of-the-fedramp-high-blueprint-sample"></a>Kontroll kartläggning av FedRAMP Hög skiss prov

I följande artikel beskrivs hur Azure Blueprints FedRAMP High-skissens exempelmappningar till FedRAMP High-kontrollerna. Mer information om kontrollerna finns i [FedRAMP Security Controls Baseline](https://www.fedramp.gov/).

Följande mappningar är till **FedRAMP Höga** kontroller. Använd navigeringen till höger för att hoppa direkt till en specifik kontrollmappning. Många av de mappade kontrollerna implementeras med ett [Azure Policy-initiativ.](../../../policy/overview.md) Om du vill granska hela initiativet öppnar du **Princip** i Azure-portalen och väljer sidan **Definitioner.** Leta sedan reda på och välj ** \[förhandsversionen:\]Granska FedRAMP-höga kontroller och distribuera specifika VM-tillägg för att stödja inbyggda** principinitiativ för granskningskrav.
...
> Om du vill visa ändringshistoriken läser du [GitHub Commit-historiken](https://github.com/MicrosoftDocs/azure-docs/commits/master/articles/governance/blueprints/samples/fedramp-h/control-mapping.md).
...
- \[Förhandsversion:\]Aktivera Azure Monitor för virtuella datorer
- \[Förhandsversion:\]Aktivera Azure Monitor för VMSS (VMSS)
...
Nu när du har granskat kontrollmappningen av FedRAMP High-skissen kan du besöka följande artiklar om hur du vill veta mer om skissen och hur du distribuerar det här exemplet:

> [!div class="nextstepaction"]
> [FedRAMP Hög plan - Översikt](./index.md)
> [FedRAMP Hög plan - Distribuera steg](./deploy.md)
