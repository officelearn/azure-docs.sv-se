---
title: Översikt över skissexempel på den australiska regeringens ISM PROTECTED-kontroller
...
Avsnittet om kontrollmappning innehåller information om de principer som ingår i den här skissen och hur dessa principer täcker olika kontroller i ISM PROTECTED. Resurser som tilldelats till en arkitektur utvärderas för icke-kompabilitet med tilldelade principer av Azure Policy. Mer information finns i [Azure Policy](../../../policy/overview.md).

## <a name="next-steps"></a>Nästa steg

Du har granskat översikten och skissexemplet för ISM PROTECTED. Nu kan du gå vidare till följande artiklar och lära dig om kontrollmappning och hur du distribuerar det här exemplet:

> [!div class="nextstepaction"]
> [Skiss för ISM PROTECTED – Kontrollmappning](./control-mapping.md)
> [Skiss för ISM PROTECTED – Distributionssteg](./deploy.md)
