---
title: EXEMPELkontroller för ISO 27001 ASE/SQL-arbetsbelastningsritning
description: Styra mappningen av arbetsbelastningskopempelet ISO 27001 App Service Environment/SQL Database till Azure Policy och RBAC.
ms.date: 01/13/2020
ms.topic: sample
...
---
# <a name="control-mapping-of-the-iso-27001-asesql-workload-blueprint-sample"></a>Styra mappning av skissexemplet ISO 27001 ASE/SQL-arbetsbelastning

I följande artikel beskrivs hur azure blueprints ISO 27001 ASE/SQL Workload-skissen mappas till ISO 27001-kontrollerna. Mer information om kontrollerna finns i [ISO 27001](https://www.iso.org/isoiec-27001-information-security.html).
...
- \[Preview\]: Granska minsta antal ägare för prenumeration
...
Nu när du har granskat kontrollmappningen av arbetsbelastningskopempelet ISO 27001 App Service Environment/SQL Database kan du läsa följande artiklar om arkitekturen och hur du distribuerar det här exemplet:

> [!div class="nextstepaction"]
> [Iso 27001 App Service Environment/SQL Database arbetsbelastning skiss - Översikt](./index.md)
> [ISO 27001 App Service Miljö / SQL Database arbetsbelastning skiss - Distribuera steg](./deploy.md)
