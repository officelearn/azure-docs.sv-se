---
title: Exempel – ISO 27001 delade tjänster skiss-kontroll mappning
description: Kontrol lera mappningen av skiss exemplet ISO 27001 Shared Services till Azure Policy och RBAC.
author: DCtheGeek
ms.author: dacoulte
ms.date: 03/14/2019
ms.topic: sample
...
Följande artikel beskriver hur Azure-ritningar ISO 27001 Shared Services skiss-exemplet mappar till ISO 27001-kontrollerna. Mer information om kontrollerna finns i [ISO 27001](https://www.iso.org/isoiec-27001-information-security.html).

Följande mappningar är till **ISO 27001:2013** -kontrollerna. Använd navigeringen till höger om du vill gå direkt till en bestämd kontroll mappning. Många av de mappade kontrollerna implementeras med ett [Azure policy](../../../policy/overview.md) initiativ. Om du vill granska hela initiativet öppnar du **princip** i Azure Portal och väljer sidan **definitioner** . Leta sedan reda på och välj **\[Preview @ no__t-2-kontrollen ISO 27001:2013-kontroller och distribuera särskilda VM-tillägg för att ge stöd för det inbyggda princip initiativet för gransknings krav** .
...
- \[Preview @ no__t-1: Granska det lägsta antalet ägare för en prenumeration
- \[Preview @ no__t-1: Granska det högsta antalet ägare för en prenumeration
...
- \[Preview @ no__t-1: Övervaka resultat av SQL sårbarhets bedömning i Azure Security Center
...
- \[Preview @ no__t-1: Distribuera VM-tillägget för att granska Linux VM-konton utan lösen ord
- \[Preview @ no__t-1: Distribuera VM-tillägget för att granska virtuella Linux-datorer som tillåter fjärr anslutningar från konton utan lösen ord
- \[Preview @ no__t-1: Granska Linux VM-konton utan lösen ord
- \[Preview @ no__t-1: Granska Linux VM som tillåter fjärr anslutningar från konton utan lösen ord
...
- \[Preview @ no__t-1: Granska konton med ägar behörigheter som inte är MFA-aktiverade för en prenumeration
- \[Preview @ no__t-1: Granska konton med Skriv behörighet som inte är MFA-aktiverade för en prenumeration
- \[Preview @ no__t-1: Granska externa konton med ägar behörigheter för en prenumeration
- \[Preview @ no__t-1: Granska externa konton med skrivbehörigheter för en prenumeration
...
- \[Preview @ no__t-1: Granska konton med ägar behörigheter som inte är MFA-aktiverade för en prenumeration
- \[Preview @ no__t-1: Granska konton med Läs behörighet som inte är MFA-aktiverade för en prenumeration
- \[Preview @ no__t-1: Granska konton med Skriv behörighet som inte är MFA-aktiverade för en prenumeration
- \[Preview @ no__t-1: Distribuera VM-tillägg för att granska virtuella Linux-filer passwd-filbehörighet
...
- \[Preview @ no__t-1: Granska föråldrade konton på en prenumeration
- \[Preview @ no__t-1: Granska föråldrade konton med ägar behörigheter för en prenumeration
- \[Preview @ no__t-1: Granska externa konton med ägar behörigheter för en prenumeration
- \[Preview @ no__t-1: Granska externa konton med skrivbehörigheter för en prenumeration
...
- \[Preview @ no__t-1: Distribuera VM-tillägg för att kontrol lera att den virtuella Windows-datorn använder krav för lösen ords komplexitet
- \[Preview @ no__t-1: Distribuera VM-tillägg till granska Windows VM högsta lösen ord ålder 70 dagar
- \[Preview @ no__t-1: Distribuera VM-tillägg till granska Windows VM lägsta lösen ord ålder 1 dag
- \[Preview @ no__t-1: Distribuera VM-tillägg för att granska Windows-lösenord för virtuella datorer måste vara minst 14 tecken
- \[Preview @ no__t-1: Distribuera VM-tillägg för granskning av Windows VM bör inte tillåta tidigare 24 lösen ord
- \[Preview @ no__t-1: Granska virtuell Windows-dator Kräv krav på lösen ords komplexitet
- \[Preview @ no__t-1: Granska den virtuella Windows-datorns högsta ålder för lösen ord 70 dagar
- \[Preview @ no__t-1: Granska virtuell Windows-dator lägsta lösen ord ålder 1 dag
- \[Preview @ no__t-1: Granska Windows-lösenord för virtuella datorer måste innehålla minst 14 tecken
- \[Preview @ no__t-1: Granska virtuell Windows-dator ska inte tillåta tidigare 24 lösen ord
...
- \[Preview @ no__t-1: Granska HTTPS endast åtkomst för en Funktionsapp
- \[Preview @ no__t-1: Granska HTTPS endast åtkomst för ett webb program
- \[Preview @ no__t-1: Granska HTTPS endast åtkomst för en API-app
- \[Preview @ no__t-1: Granska saknad BLOB-kryptering för lagrings konton
- \[Preview @ no__t-1: Distribuera VM-tillägg för granskning av Windows VM ska inte lagra lösen ord med omvänd kryptering
- \[Preview @ no__t-1: Granska virtuell Windows-dator ska inte lagra lösen ord med omvänd kryptering
- \[Preview @ no__t-1: Övervaka okrypterade VM-diskar i Azure Security Center
...
- \[Preview @ no__t-1: Granska Dependency Agent distribution – VM-avbildning (OS) har inte listats
- \[Preview @ no__t-1: Granska Dependency Agent distribution i VMSS – VM-avbildningen (OS) har inte listats
...
- \[Preview @ no__t-1: Övervaka möjlig app-vit listning i Azure Security Center
...
- \[Preview @ no__t-1: Övervaka saknade Endpoint Protection i Azure Security Center
- \[Preview @ no__t-1: Övervaka system uppdateringar som saknas i Azure Security Center
- \[Preview @ no__t-1: Övervaka OS-sårbarheter i Azure Security Center
- \[Preview @ no__t-1: Övervaka resultat av SQL sårbarhets bedömning i Azure Security Center
- \[Preview @ no__t-1: Övervaka säkerhets risker i virtuella datorer i Azure Security Center
...
- \[Preview @ no__t-1: Övervaka tillåtad nätverks åtkomst i Azure Security Center
- \[Preview @ no__t-1: Övervaka oskyddade nätverks slut punkter i Azure Security Center
- \[Preview @ no__t-1: Övervaka oskyddat webb program i Azure Security Center
...
Nu när du har granskat kontroll mappningen av ritningen ISO 27001 Shared Services kan du gå till följande artiklar om du vill lära dig mer om arkitekturen och hur du distribuerar det här exemplet:
