...
- \[Preview @ no__t-1: övervaka resultaten av SQL sårbarhets bedömning i Azure Security Center
...
- \[Preview @ no__t-1: Distribuera VM-tillägget för att granska virtuella Linux-användarkonton utan lösen ord
- \[Preview @ no__t-1: Distribuera VM-tillägget till granska virtuella Linux-datorer som tillåter fjärr anslutningar från konton utan lösen ord
...
- \[Preview @ no__t-1: granska externa konton med ägar behörighet för en prenumeration
- \[Preview @ no__t-1: granska externa konton med Skriv behörighet för en prenumeration
...
- \[Preview @ no__t-1: granska föråldrade konton med ägar behörighet för en prenumeration
- \[Preview @ no__t-1: granska externa konton med ägar behörighet för en prenumeration
- \[Preview @ no__t-1: granska externa konton med Skriv behörighet för en prenumeration
...
- \[Preview @ no__t-1: Distribuera VM-tillägget för att kontrol lera att den virtuella Windows-datorn kräver lösen ords komplexitets krav
- \[Preview @ no__t-1: Distribuera VM-tillägg för att granska den högsta tillåtna lösen ordets ålder för Windows VM 70 dagar
- \[Preview @ no__t-1: Distribuera VM-tillägget till granska Windows VM lägsta lösen ord ålder 1 dag
- \[Preview @ no__t-1: Distribuera VM-tillägg för att granska Windows VM-lösenord måste vara minst 14 tecken
- \[Preview @ no__t-1: Distribuera VM-tillägg för granskning av virtuella Windows-datorer ska inte tillåta tidigare 24 lösen ord
- \[Preview @ no__t-1: granska den virtuella Windows-datorn tillämpar krav på lösen ords komplexitet
- \[Preview @ no__t-1: granska den högsta tillåtna lösen ordets ålder för Windows VM 70 dagar
- \[Preview @ no__t-1: granska Windows VM lägsta lösen ord ålder 1 dag
- \[Preview @ no__t-1: granska Windows-lösenord för virtuella datorer måste vara minst 14 tecken
...
- \[Preview @ no__t-1: Distribuera VM-tillägg för att granska virtuell Windows-dator ska inte lagra lösen ord med omvänd kryptering
- \[Preview @ no__t-1: granska virtuell Windows-dator ska inte lagra lösen ord med omvänd kryptering
- \[Preview @ no__t-1: övervaka okrypterade virtuella dator diskar i Azure Security Center
...
- \[Preview @ no__t-1: gransknings Dependency Agent distribution-VM-avbildning (OS) har inte listats
- \[Preview @ no__t-1: granska Dependency Agent distribution i VMSS-VM-avbildningen (OS) visas inte
...
- \[Preview @ no__t-1: övervaka möjliga app-vit listning i Azure Security Center
...
- \[Preview @ no__t-1: övervaka saknade system uppdateringar i Azure Security Center
