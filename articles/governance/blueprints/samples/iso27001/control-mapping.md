---
title: ISO 27001 skiss prov kontroller
description: Kontrollkartläggning av skissprovet ISO 27001. Varje kontroll mappas till en eller flera Azure-principer som hjälper till med utvärdering.
ms.date: 01/13/2020
ms.topic: sample
...
---
# <a name="control-mapping-of-the-iso-27001-blueprint-sample"></a>Kontrollkartläggning av skissprovet i ISO 27001

I följande artikel beskrivs hur azure blueprints ISO 27001-skissen mappas till ISO 27001-kontrollerna. Mer information om kontrollerna finns i [ISO 27001](https://www.iso.org/isoiec-27001-information-security.html).
...
Nu när du har granskat kontrollmappningen av ISO 27001-skissen kan du läsa följande artiklar om arkitekturen och hur du distribuerar det här exemplet:

> [!div class="nextstepaction"]
> [ISO 27001 blueprint - Översikt](./index.md)
