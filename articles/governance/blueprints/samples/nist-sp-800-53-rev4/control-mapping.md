---
title: NIST SP 800-53 R4 skiss prov kontroller
description: Kontrollkartläggning av NIST SP 800-53 R4-skissprovet. Varje kontroll mappas till en eller flera Azure-principer som hjälper till med utvärdering.
ms.date: 11/18/2019
ms.topic: sample
...
ms.locfileid: "74546616"
---
# <a name="control-mapping-of-the-nist-sp-800-53-r4-blueprint-sample"></a>Kontrollkartläggning av NIST SP 800-53 R4-ritningsprovet

I följande artikel beskrivs hur Azure Blueprints NIST SP 800-53 R4-skissen mappar till NIST SP 800-53 R4-kontrollerna. Mer information om kontrollerna finns i [NIST SP 800-53](https://nvd.nist.gov/800-53).

Följande mappningar är till **NIST SP 800-53 (Rev. 4)** kontroller. Använd navigeringen till höger för att hoppa direkt till en specifik kontrollmappning. Många av de mappade kontrollerna implementeras med ett [Azure Policy-initiativ.](../../../policy/overview.md) Om du vill granska hela initiativet öppnar du **Princip** i Azure-portalen och väljer sidan **Definitioner.** Leta sedan reda på och välj ** \[förhandsversionen:\]Granska NIST SP 800-53 R4-kontroller och distribuera specifika VM-tillägg för att stödja inbyggda** principinitiativ för granskningskrav.
...
## <a name="ac-16-security-attributes"></a>AC-16-säkerhetsattribut
...
Nu när du har granskat kontrollmappningen av NIST SP 800-53 R4-skissen kan du besöka följande artiklar om skissen och hur du distribuerar det här exemplet:

> [!div class="nextstepaction"]
> [NIST SP 800-53 R4-ritning - Översikt](./index.md)
> [NIST SP 800-53 R4-ritning - Driftsättningssteg](./deploy.md)
