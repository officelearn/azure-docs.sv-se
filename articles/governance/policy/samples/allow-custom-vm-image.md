...
description: Den här exempel princip definitionen kräver att anpassade avbildningar kommer från en godkänd resurs grupp som definierats i en parameter.
ms.date: 01/23/2019
ms.topic: sample
...
Den här exempelprincipen kräver att anpassade avbildningar kommer från en godkänd resursgrupp. Du anger namnet på den godkända resursgruppen.
