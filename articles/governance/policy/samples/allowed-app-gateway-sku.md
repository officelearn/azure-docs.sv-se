...
description: Den här exempelprincipen kräver att programgatewayer använder en godkänd SKU.
...
ms.locfileid: "54854997"
---
# <a name="allowed-application-gateway-skus"></a>Tillåtna SKU:er för programgateway
