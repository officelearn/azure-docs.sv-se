...
description: Den här exempel princip definitionen kräver att ExpressRoute använder en angiven mängd bandbredd som definierats i en parameter.
ms.date: 01/23/2019
ms.topic: sample
