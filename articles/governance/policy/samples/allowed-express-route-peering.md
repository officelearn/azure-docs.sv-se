...
description: Den här exempel princip definitionen kräver att ExpressRoute använder angivna peering-platser definierade i en parameter.
ms.date: 01/23/2019
ms.topic: sample
