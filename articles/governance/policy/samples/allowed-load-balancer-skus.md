...
description: Den här exempel princip definitionen kräver att belastningsutjämnare använder en godkänd SKU som definierats i en parameter.
ms.date: 01/23/2019
ms.topic: sample
