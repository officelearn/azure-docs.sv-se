---
title: Exempel – Tillåtna SKU:er för lastbalanserare
description: Den här exempelprincipen kräver att lastbalanserare använder en godkänd SKU.
...
ms.locfileid: "56241962"
---
# <a name="allowed-load-balancer-skus"></a>Tillåtna SKU:er för lastbalanserare

Den här principen kräver att lastbalanserare använder en godkänd SKU. Du anger en matris med tillåtna SKU: er.
