...
description: Den här exempel granskningen av princip definitionen gäller om ett tillägg som definierats i en parameter inte distribueras till en virtuell dator.
ms.date: 01/23/2019
ms.topic: sample
