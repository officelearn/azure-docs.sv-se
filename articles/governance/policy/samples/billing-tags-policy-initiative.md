...
description: Det här exemplet på policy initiativ (princip uppsättning) kräver att angivna taggattribut definieras i parametrarna för kostnads ställe och produkt namn.
ms.date: 01/23/2019
ms.topic: sample
