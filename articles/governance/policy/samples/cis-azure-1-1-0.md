...
I följande artikel finns information om hur den inbyggda definitionen av den Azure Policy reglerande kraven mappar till **domäner** och **kontroller för att kontrol lera** att CIS-Microsoft Azure är benchmark.
...
Leta sedan reda på och välj **gransknings CIS Microsoft Azure lär dig 1.1.0-rekommendationer och distribuera vissa stödda VM-tillägg** gällande kontroll av efterlevnad av de inbyggda initiativ definitionerna.
...
### <a name="ensure-that-net-framework-version-is-the-latest-if-used-as-a-part-of-the-web-app"></a>Se till att .NET Framework-versionen är den senaste, om den används som en del av webbappen
...
|Name<br /><sub>(Azure Portal)</sup> |Description |Påverkan (ar) |Version<br /><sub>GitHub</sub> |
|---|---|---|---|---|
|[Kontrol lera att register med Azure Active Directory är aktiverat i API-appen](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F86d97760-d216-4d81-a3ad-163087b2b6c3) |Hanterad tjänst identitet i App Service gör appen säkrare genom att ta bort hemligheter från appen, t. ex. autentiseringsuppgifter i anslutnings strängarna. När du registrerar med Azure Active Directory i App Service kommer appen att ansluta till andra Azure-tjänster på ett säkert sätt utan att användar namn och lösen ord behövs |AuditIfNotExists, inaktiverat |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/App%20Service/AppService_ApiApp_Audit_AD_Enabled.json) |
|[Kontrol lera att register med Azure Active Directory är aktiverat på Funktionsapp](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Ff0473e7a-a1ba-4e86-afb2-e829e11b01d8) |Hanterad tjänst identitet i App Service gör appen säkrare genom att ta bort hemligheter från appen, t. ex. autentiseringsuppgifter i anslutnings strängarna. När du registrerar med Azure Active Directory i App Service kommer appen att ansluta till andra Azure-tjänster på ett säkert sätt utan att användar namn och lösen ord behövs |AuditIfNotExists, inaktiverat |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/App%20Service/AppService_FunctionApp_Audit_AD_Enabled.json) |
|[Kontrol lera att register med Azure Active Directory är aktiverat i webbappen](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Faa81768c-cb87-4ce2-bfaa-00baa10d760c) |Hanterad tjänst identitet i App Service gör appen säkrare genom att ta bort hemligheter från appen, t. ex. autentiseringsuppgifter i anslutnings strängarna. När du registrerar med Azure Active Directory i App Service kommer appen att ansluta till andra Azure-tjänster på ett säkert sätt utan att användar namn och lösen ord behövs |AuditIfNotExists, inaktiverat |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/App%20Service/AppService_Webapp_Audit_AD_Enabled.json) |
...
### <a name="ensure-server-parameter-log_duration-is-set-to-on-for-postgresql-database-server"></a>Se till att Server parametern "log_duration" är inställd på "ON" för PostgreSQL-databasserver

**ID**: CIS Azure 4,16- **ägarskap**: kund
...
### <a name="ensure-that-email-service-and-co-administrators-is-enabled"></a>Se till att "e-posttjänst och medadministratörer" är aktiverat "

**ID**: CIS Azure 4,7- **ägarskap**: kund

|Name<br /><sub>(Azure Portal)</sup> |Description |Påverkan (ar) |Version<br /><sub>GitHub</sub> |
|---|---|---|---|---|
|[E-postaviseringar till administratörer och prenumerations ägare måste vara aktiverade i avancerade data säkerhets inställningar för SQL-hanterad instans](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Faeb23562-188d-47cb-80b8-551f16ef9fff) |Granska att "e-postmeddelande till administratörer och prenumerations ägare" är aktiverat i inställningarna för avancerat skydd för SQL-instansen. Detta säkerställer att alla identifieringar av avvikande aktiviteter på SQL-hanterad instans rapporteras så snart som möjligt till administratörerna. |AuditIfNotExists, inaktiverat |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/SQL/SqlManagedInstance_AdvancedDataSecurityEmailAdmins_Audit.json) |
...
### <a name="ensure-that-threat-detection-types-is-set-to-all"></a>Se till att hot identifierings typerna är inställt på all
...
|Name<br /><sub>(Azure Portal)</sup> |Description |Påverkan (ar) |Version<br /><sub>GitHub</sub> |
|---|---|---|---|---|
|[Virtuella datorer som är riktade mot Internet bör skyddas med nätverks säkerhets grupper](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Ff6de0be7-9a8a-4b8a-b349-43cf02d22f7c) |Skydda din virtuella dator mot potentiella hot genom att begränsa åtkomsten till den med en nätverks säkerhets grupp (NSG). Om du vill veta mer om hur du styr trafik med NSG: er går du till[https://aka.ms/nsg-doc](https://aka.ms/nsg-doc) |AuditIfNotExists, inaktiverat |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Security%20Center/ASC_NetworkSecurityGroupsOnVirtualMachines_Audit.json) |
...
### <a name="ensure-that-standard-pricing-tier-is-selected"></a>Se till att standard pris nivån är vald
