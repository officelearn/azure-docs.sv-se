---
title: Exempel – ingen låg frekvent åtkomst nivå på lagrings kontot
description: Den här exempel princip definitionen förhindrar användning av låg frekvent åtkomst nivå för alla Blob Storage-konton.
ms.date: 01/23/2019
ms.topic: sample
