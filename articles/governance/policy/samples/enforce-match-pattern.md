...
description: Den här exempelprincipdefinitionen kräver att resurserna uppfyller matchningsmönstret för namngivningskonventioner.
author: DCtheGeek
manager: carmonm
...
ms.locfileid: "59266638"
---
# <a name="sample---enforce-match-pattern-for-naming-conventions"></a>Exempel – Framtvinga matchningsmönster för namngivningskonventioner
