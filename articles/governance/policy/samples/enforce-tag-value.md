...
description: Den här exempel princip definitionen kräver ett taggnamn och ett värde som definierats i en parameter på varje Azure-resurs.
ms.date: 01/23/2019
ms.topic: sample
