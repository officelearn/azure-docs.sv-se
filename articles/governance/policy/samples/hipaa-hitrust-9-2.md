...
### <a name="passwords-are-not-displayed-when-entered"></a>Lösen ord visas inte när de anges.

**ID**: 1002.01 d1system. 1-01. d **ägande**: kund
...
### <a name="electronic-signatures-based-upon-biometrics-are-designed-to-ensure-that-they-cannot-be-used-by-any-individual-other-than-their-genuine-owners"></a>Elektroniska signaturer baserade på biometrik är utformade för att säkerställa att de inte kan användas av andra personer än deras äkta ägare.

**ID**: 11209.01 q2organizational. 9-01. q **ägarskap**: ej tillämpligt
...
### <a name="unique-ids-that-can-be-used-to-trace-activities-to-the-responsible-individual-are-required-for-all-types-of-organizational-and-non-organizational-users"></a>Unika ID: n som kan användas för att spåra aktiviteter till den ansvariga enskilda krävs för alla typer av organisations och icke-organisatoriska användare.

**ID**: 1122.01 q1system. 1 – 01. f **ägarskap**: kund
...
### <a name="sharedgroup-and-generic-user-ids-are-only-used-in-exceptional-circumstances-where-there-is-a-clear-business-benefit-when-user-functions-do-not-need-to-be-traced-additional-accountability-controls-are-implemented-and-after-approval-by-management"></a>Delade/Group-och allmänna användar-ID: n används endast i undantagsfall där det finns en tydlig affärs förmån, när användar funktioner inte behöver spåras, om ytterligare ansvars kontroller implementeras och efter godkännande av hantering.

**ID**: 1124.01 q1system. 34-01. f **ägarskap**: kund
...
### <a name="help-desk-support-requires-user-identification-for-any-transaction-that-has-information-security-implications"></a>Support för supportavdelningen kräver användar identifiering för alla transaktioner som har problem med informations säkerhet.

**ID**: 1128.01 q2system. 5-01. f **ägarskap**: kund
...
### <a name="information-collected-from-multiple-sources-shall-be-aggregated-for-review"></a>Information som samlas in från flera källor sammanställs för granskning.

**ID**: 12103.09 ab1organizational. 5-09. AB **ägande**: kund
...
### <a name="automated-systems-support-near-real-time-analysis-and-alerting-of-events-eg-malicious-code-potential-intrusions-and-integrate-intrusion-detection-into-access-and-flow-control-mechanisms"></a>Automatiserade system stöd för real tids analys och avisering av händelser (t. ex. skadlig kod, potentiella intrång) och integrera intrångs identifiering i åtkomst-och flödes styrnings metoder.

**ID**: 1218.09 ab3system. 47-09. AB **ägande**: kund
...
### <a name="security-is-maintained-through-all-aspects-of-the-transaction"></a>Säkerheten upprätthålls genom alla aspekter av transaktionen.

**ID**: 0944.09 y1organizational. 2-09. y- **ägande**: ej tillämpligt
