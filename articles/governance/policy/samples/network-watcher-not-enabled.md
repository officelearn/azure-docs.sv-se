---
title: Exempel – Granska om Network Watcher inte är aktiverat för regionen
description: Den här exempelprincipdefinitionen granskar om nätverksövervakaren inte har aktiverats för en angiven region
author: DCtheGeek
manager: carmonm
