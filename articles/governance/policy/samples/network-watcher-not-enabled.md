---
title: Exempel – granskning för regioner utan Network Watcher
description: Den här exempel granskningen av princip definitionen gäller om Network Watcher inte är aktiverat för en angiven region som definierats i en parameter.
ms.date: 01/23/2019
ms.topic: sample
...
ms.locfileid: "74463287"
---
# <a name="sample---audit-if-network-watcher-is-not-enabled-for-region"></a>Exempel – Granska om Network Watcher inte är aktiverat för regionen
