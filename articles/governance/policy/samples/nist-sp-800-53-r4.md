...
I följande artikel beskrivs hur den inbyggda definitionen av den Azure Policy reglerande kraven mappar till **efterlevnad av domäner** och **kontroller** till NIST SP 800-53 R4.
...
Leta sedan reda på och välj **[för hands version]: granska NIST SP 800-53 R4-kontroller och distribuera särskilda VM-tillägg för att ge stöd för gransknings krav** gällande definition av den inbyggda initiativet.
...
|Name<br /><sub>(Azure Portal)</sup> |Description |Påverkan (ar) |Version<br /><sub>GitHub</sub> |
|---|---|---|---|---|
...
|[Distribuera krav för att granska virtuella Windows-datorer där gruppen administratörer innehåller någon av de angivna medlemmarna](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F144f1397-32f9-4598-8c88-118decc3ccba) |Den här principen skapar en gäst konfigurations tilldelning för att granska virtuella Windows-datorer där gruppen administratörer innehåller någon av de angivna medlemmarna. Det skapar också en systemtilldelad hanterad identitet och distribuerar VM-tillägget för gäst konfiguration. Den här principen bör endast användas tillsammans med motsvarande gransknings princip i ett initiativ. Mer information om principer för gäst konfiguration finns på[https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_AdministratorsGroupMembersToExclude_Deploy.json) |
|[Distribuera krav för att granska virtuella Windows-datorer där gruppen administratörer inte innehåller alla angivna medlemmar](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F93507a81-10a4-4af0-9ee2-34cf25a96e98) |Den här principen skapar en gäst konfigurations tilldelning för att granska virtuella Windows-datorer där gruppen administratörer inte innehåller alla angivna medlemmar. Det skapar också en systemtilldelad hanterad identitet och distribuerar VM-tillägget för gäst konfiguration. Den här principen bör endast användas tillsammans med motsvarande gransknings princip i ett initiativ. Mer information om principer för gäst konfiguration finns på[https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_AdministratorsGroupMembersToInclude_Deploy.json) |
...
|Name<br /><sub>(Azure Portal)</sup> |Description |Påverkan (ar) |Version<br /><sub>GitHub</sub> |
|---|---|---|---|---|
|[Avancerad data säkerhet ska vara aktiverat på SQL-hanterade instanser](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fabfb7388-5bf4-4ad7-ba99-2cd2f41cebb9) |Granska SQL-hanterade instanser utan avancerad data säkerhet |AuditIfNotExists, inaktiverat |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/SQL/SqlManagedInstance_AdvancedDataSecurity_Audit.json) |
...
|Name<br /><sub>(Azure Portal)</sup> |Description |Påverkan (ar) |Version<br /><sub>GitHub</sub> |
|---|---|---|---|---|
|[Distribuera förutsättningar för att granska virtuella Linux-datorer som tillåter fjärr anslutningar från konton utan lösen ord](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fec49586f-4939-402d-a29e-6ff502b20592) |Den här principen skapar en gäst konfigurations tilldelning för att granska virtuella Linux-datorer som tillåter fjärr anslutningar från konton utan lösen ord. Det skapar också en systemtilldelad hanterad identitet och distribuerar VM-tillägget för gäst konfiguration. Den här principen bör endast användas tillsammans med motsvarande gransknings princip i ett initiativ. Mer information om principer för gäst konfiguration finns på[https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.2.0 – för hands version](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword110_Deploy.json) |
...
|[Visa gransknings resultat från virtuella Linux-datorer som tillåter fjärr anslutningar från konton utan lösen ord](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F2d67222d-05fd-4526-a171-2ee132ad9e83) |Den här principen bör endast användas tillsammans med motsvarande distributions princip i ett initiativ. Den här definitionen gör det möjligt för Azure Policy att bearbeta resultatet av virtuella Linux-datorer i granskning som tillåter fjärr anslutningar från konton utan lösen ord. Mer information om principer för gäst konfiguration finns på[https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.1.0 – för hands version](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword110_Audit.json) |
...
### <a name="non-repudiation"></a>Oavvislig het
...
|Name<br /><sub>(Azure Portal)</sup> |Description |Påverkan (ar) |Version<br /><sub>GitHub</sub> |
|---|---|---|---|---|
|[Distribuera krav för att granska virtuella Linux-datorer som inte har passwd-filbehörigheterna inställt på 0644](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Ff19aa1c1-6b91-4c27-ae6a-970279f03db9) |Den här principen skapar en gäst konfigurations tilldelning för att granska virtuella Linux-datorer som inte har behörigheterna passwd-fil inställd på 0644. Det skapar också en systemtilldelad hanterad identitet och distribuerar VM-tillägget för gäst konfiguration. Den här principen bör endast användas tillsammans med motsvarande gransknings princip i ett initiativ. Mer information om principer för gäst konfiguration finns på[https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.2.0 – för hands version](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword121_Deploy.json) |
|[Distribuera förutsättningar för att granska virtuella Linux-datorer som har konton utan lösen ord](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F3470477a-b35a-49db-aca5-1073d04524fe) |Den här principen skapar en gäst konfigurations tilldelning för att granska virtuella Linux-datorer som har konton utan lösen ord. Det skapar också en systemtilldelad hanterad identitet och distribuerar VM-tillägget för gäst konfiguration. Den här principen bör endast användas tillsammans med motsvarande gransknings princip i ett initiativ. Mer information om principer för gäst konfiguration finns på[https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.2.0 – för hands version](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword232_Deploy.json) |
|[Distribuera krav för att granska virtuella Windows-datorer som inte lagrar lösen ord med omvänd kryptering](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F8ff0b18b-262e-4512-857a-48ad0aeb9a78) |Den här principen skapar en gäst konfigurations tilldelning för att granska virtuella Windows-datorer som inte lagrar lösen ord med omvänd kryptering. Det skapar också en systemtilldelad hanterad identitet och distribuerar VM-tillägget för gäst konfiguration. Den här principen bör endast användas tillsammans med motsvarande gransknings princip i ett initiativ. Mer information om principer för gäst konfiguration finns på[https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0 – för hands version](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEncryption_Deploy.json) |
...
|[Visa gransknings resultat från virtuella Linux-datorer som inte har passwd-filbehörigheterna inställt på 0644](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fb18175dd-c599-4c64-83ba-bb018a06d35b) |Den här principen bör endast användas tillsammans med motsvarande distributions princip i ett initiativ. Den här definitionen gör det möjligt för Azure Policy att bearbeta resultatet av virtuella datorer i gransknings-Linux som inte har passwd-filbehörigheterna inställt på 0644. Mer information om principer för gäst konfiguration finns på[https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.1.0 – för hands version](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword121_Audit.json) |
|[Visa gransknings resultat från virtuella Linux-datorer som har konton utan lösen ord](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fc40c9087-1981-4e73-9f53-39743eda9d05) |Den här principen bör endast användas tillsammans med motsvarande distributions princip i ett initiativ. Den här definitionen gör det möjligt för Azure Policy att bearbeta resultatet av virtuella Linux-datorer som har konton utan lösen ord. Mer information om principer för gäst konfiguration finns på[https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.1.0 – för hands version](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword232_Audit.json) |
|[Visa gransknings resultat från virtuella Windows-datorer som inte lagrar lösen ord med omvänd kryptering](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F2d60d3b7-aa10-454c-88a8-de39d99d17c6) |Den här principen bör endast användas tillsammans med motsvarande distributions princip i ett initiativ. Med den här definitionen kan Azure Policy bearbeta resultatet av granskning av virtuella Windows-datorer som inte lagrar lösen ord med omvänd kryptering. Mer information om principer för gäst konfiguration finns på[https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 – för hands version](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEncryption_Audit.json) |
...
|Name<br /><sub>(Azure Portal)</sup> |Description |Påverkan (ar) |Version<br /><sub>GitHub</sub> |
|---|---|---|---|---|
|[Distribuera krav för att granska virtuella Windows-datorer som tillåter åter användning av de tidigare 24 lösen orden](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F726671ac-c4de-4908-8c7d-6043ae62e3b6) |Den här principen skapar en gäst konfigurations tilldelning för att granska virtuella Windows-datorer som tillåter åter användning av de tidigare 24 lösen orden. Det skapar också en systemtilldelad hanterad identitet och distribuerar VM-tillägget för gäst konfiguration. Den här principen bör endast användas tillsammans med motsvarande gransknings princip i ett initiativ. Mer information om principer för gäst konfiguration finns på[https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0 – för hands version](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEnforce_Deploy.json) |
|[Distribuera krav för att granska virtuella Windows-datorer som inte har en högsta ålder för lösen ord på 70 dagar](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F356a906e-05e5-4625-8729-90771e0ee934) |Den här principen skapar en gäst konfigurations tilldelning för att granska virtuella Windows-datorer som inte har en högsta ålder för lösen ord på 70 dagar. Det skapar också en systemtilldelad hanterad identitet och distribuerar VM-tillägget för gäst konfiguration. Den här principen bör endast användas tillsammans med motsvarande gransknings princip i ett initiativ. Mer information om principer för gäst konfiguration finns på[https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0 – för hands version](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsMaximumPassword_Deploy.json) |
|[Distribuera krav för att granska virtuella Windows-datorer som inte har en minsta ålder på lösen ord på 1 dag](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F16390df4-2f73-4b42-af13-c801066763df) |Den här principen skapar en gäst konfigurations tilldelning för att granska virtuella Windows-datorer som inte har en minsta ålder på lösen ord på 1 dag. Det skapar också en systemtilldelad hanterad identitet och distribuerar VM-tillägget för gäst konfiguration. Den här principen bör endast användas tillsammans med motsvarande gransknings princip i ett initiativ. Mer information om principer för gäst konfiguration finns på[https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0 – för hands version](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsMinimumPassword_Deploy.json) |
|[Distribuera krav för att granska virtuella Windows-datorer som inte har inställningen för lösen ords komplexitet aktiverat](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F7ed40801-8a0f-4ceb-85c0-9fd25c1d61a8) |Den här principen skapar en gäst konfigurations tilldelning för att granska virtuella Windows-datorer där inställningen för lösen ords komplexitet är aktive rad. Det skapar också en systemtilldelad hanterad identitet och distribuerar VM-tillägget för gäst konfiguration. Den här principen bör endast användas tillsammans med motsvarande gransknings princip i ett initiativ. Mer information om principer för gäst konfiguration finns på[https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0 – för hands version](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordComplexity_Deploy.json) |
|[Distribuera krav för att granska virtuella Windows-datorer som inte begränsar minsta längd på lösen ord till 14 tecken](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F23020aa6-1135-4be2-bae2-149982b06eca) |Den här principen skapar en gäst konfigurations tilldelning för att granska virtuella Windows-datorer som inte begränsar minsta längd på lösen ord till 14 tecken. Det skapar också en systemtilldelad hanterad identitet och distribuerar VM-tillägget för gäst konfiguration. Den här principen bör endast användas tillsammans med motsvarande gransknings princip i ett initiativ. Mer information om principer för gäst konfiguration finns på[https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0 – för hands version](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordLength_Deploy.json) |
|[Distribuera krav för att granska virtuella Windows-datorer som inte lagrar lösen ord med omvänd kryptering](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F8ff0b18b-262e-4512-857a-48ad0aeb9a78) |Den här principen skapar en gäst konfigurations tilldelning för att granska virtuella Windows-datorer som inte lagrar lösen ord med omvänd kryptering. Det skapar också en systemtilldelad hanterad identitet och distribuerar VM-tillägget för gäst konfiguration. Den här principen bör endast användas tillsammans med motsvarande gransknings princip i ett initiativ. Mer information om principer för gäst konfiguration finns på[https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0 – för hands version](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEncryption_Deploy.json) |
...
|[Visa gransknings resultat från virtuella Windows-datorer som tillåter åter användning av de tidigare 24 lösen orden](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fcdbf72d9-ac9c-4026-8a3a-491a5ac59293) |Den här principen bör endast användas tillsammans med motsvarande distributions princip i ett initiativ. Med den här definitionen kan Azure Policy bearbeta resultatet av granskning av virtuella Windows-datorer som tillåter åter användning av de tidigare 24 lösen orden. Mer information om principer för gäst konfiguration finns på[https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 – för hands version](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEnforce_Audit.json) |
|[Visa gransknings resultat från virtuella Windows-datorer som inte har en högsta ålder för lösen ord på 70 dagar](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F24dde96d-f0b1-425e-884f-4a1421e2dcdc) |Den här principen bör endast användas tillsammans med motsvarande distributions princip i ett initiativ. Med den här definitionen kan Azure Policy bearbeta resultatet av granskningar av virtuella Windows-datorer som inte har en högsta ålder för lösen ord på 70 dagar. Mer information om principer för gäst konfiguration finns på[https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 – för hands version](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsMaximumPassword_Audit.json) |
|[Visa gransknings resultat från virtuella Windows-datorer som inte har minsta ålder på lösen ord på 1 dag](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F5aa11bbc-5c76-4302-80e5-aba46a4282e7) |Den här principen bör endast användas tillsammans med motsvarande distributions princip i ett initiativ. Med den här definitionen kan Azure Policy bearbeta resultaten av granskning av virtuella Windows-datorer som inte har en minsta ålder på lösen ord på 1 dag. Mer information om principer för gäst konfiguration finns på[https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 – för hands version](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsMinimumPassword_Audit.json) |
|[Visa gransknings resultat från virtuella Windows-datorer där inställningen för lösen ords komplexitet är aktive rad](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Ff48b2913-1dc5-4834-8c72-ccc1dfd819bb) |Den här principen bör endast användas tillsammans med motsvarande distributions princip i ett initiativ. Med den här definitionen kan Azure Policy bearbeta resultaten av granskning av virtuella Windows-datorer som inte har inställningen för lösen ords komplexitet aktive rad. Mer information om principer för gäst konfiguration finns på[https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 – för hands version](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordComplexity_Audit.json) |
|[Visa gransknings resultat från virtuella Windows-datorer som inte begränsar minsta längd på lösen ord till 14 tecken](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F5aebc8d1-020d-4037-89a0-02043a7524ec) |Den här principen bör endast användas tillsammans med motsvarande distributions princip i ett initiativ. Med den här definitionen kan Azure Policy bearbeta resultatet av granskning av virtuella Windows-datorer som inte begränsar minsta längd på lösen ord till 14 tecken. Mer information om principer för gäst konfiguration finns på[https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 – för hands version](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordLength_Audit.json) |
|[Visa gransknings resultat från virtuella Windows-datorer som inte lagrar lösen ord med omvänd kryptering](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F2d60d3b7-aa10-454c-88a8-de39d99d17c6) |Den här principen bör endast användas tillsammans med motsvarande distributions princip i ett initiativ. Med den här definitionen kan Azure Policy bearbeta resultatet av granskning av virtuella Windows-datorer som inte lagrar lösen ord med omvänd kryptering. Mer information om principer för gäst konfiguration finns på[https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 – för hands version](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEncryption_Audit.json) |
...
|Name<br /><sub>(Azure Portal)</sup> |Description |Påverkan (ar) |Version<br /><sub>GitHub</sub> |
|---|---|---|---|---|
|[DDoS Protection standard ska vara aktive rad](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fa7aca53f-2ed4-4466-a25e-0b45ade68efd) |DDoS Protection standard måste vara aktiverat för alla virtuella nätverk med ett undernät som ingår i en Programgateway med en offentlig IP-adress. |AuditIfNotExists, inaktiverat |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Security%20Center/ASC_EnableDDoSProtection_Audit.json) |
...
|[Distribuera förutsättningar för att granska Windows-webbservrar som inte använder säkra kommunikations protokoll](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fb2fc8f91-866d-4434-9089-5ebfe38d6fd8) |Den här principen skapar en gäst konfigurations tilldelning för att granska Windows-webbservrar som inte använder säkra kommunikations protokoll (TLS 1,1 eller TLS 1,2). Det skapar också en systemtilldelad hanterad identitet och distribuerar VM-tillägget för gäst konfiguration. Den här principen bör endast användas tillsammans med motsvarande gransknings princip i ett initiativ. Mer information om principer för gäst konfiguration finns på[https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsTLS_Deploy.json) |
