...
Parametern används sedan i **policyRule. if** -block. Som en _mat ris_ parameter måste en _matris_
[villkoret](../concepts/definition-structure.md#conditions) **i** eller **notIn** användas.
