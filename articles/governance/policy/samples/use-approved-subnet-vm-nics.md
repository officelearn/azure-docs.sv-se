...
description: Den här exempel princip definitionen kräver att nätverks gränssnitt använder ett godkänt undernät som definierats i en parameter.
ms.date: 01/23/2019
ms.topic: sample
