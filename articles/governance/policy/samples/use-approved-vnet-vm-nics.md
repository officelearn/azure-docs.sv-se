...
description: Den här exempelprincipen kräver att nätverksgränssnitt använder ett godkänt virtuellt nätverk.
...
ms.locfileid: "56243169"
---
# <a name="use-approved-vnet-for-vm-network-interfaces"></a>Använda godkända vNet för VM-nätverksgränssnitt
