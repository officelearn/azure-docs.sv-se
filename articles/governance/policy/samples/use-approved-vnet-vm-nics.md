---
title: Exempel – Använd virtuellt nätverk för gränssnitt för virtuella dator nätverk
description: Den här exempel princip definitionen kräver att nätverks gränssnitt använder ett godkänt virtuellt nätverk som definierats i en parameter.
ms.date: 01/23/2019
ms.topic: sample
...
ms.locfileid: "74463104"
---
# <a name="sample---use-approved-vnet-for-vm-network-interfaces"></a>Exempel – använda godkända vNet för VM-nätverksgränssnitt

Den här principen kräver att nätverksgränssnitt använder ett godkänt virtuellt nätverk. Du anger ID för det godkända virtuella nätverket.
