...
description: Den här exempel princip definitionen kräver att virtuella datorer och skalnings uppsättningar för virtuella datorer använder hanterade diskar.
ms.date: 01/23/2019
ms.topic: sample
