...
## [Börja med interaktiv fråga](hdinsight-hadoop-use-interactive-hive.md)
...
#### [Använda Azure PowerShell](hdinsight-hadoop-use-hive-powershell.md)
...
#### [Använda Azure PowerShell](hdinsight-hadoop-use-mapreduce-powershell.md)
#### [Använda Fjärrskrivbord](hdinsight-hadoop-use-mapreduce-remote-desktop.md)
#### [Använda .NET SDK](hdinsight-hadoop-use-mapreduce-dotnet-sdk.md)
...
#### [Använda Azure PowerShell](hdinsight-hadoop-use-pig-powershell.md)
...
## Använda interaktiv fråga
### [Använda Zeppelin för att köra Hive-frågor](hdinsight-connect-hive-zeppelin.md)
## Utveckla
...
### [Använda verktyget för HDInsight VSCode](hdinsight-for-vscode.md)
## Analysera stordata
### [Analysera med Power Query](hdinsight-connect-excel-power-query.md)
### [Ansluta Power BI till Hadoop](hdinsight-connect-hive-power-bi.md)
...
#### [Köra med Azure PowerShell](hdinsight-hadoop-use-sqoop-powershell.md)
