...
> [!NOTE]  
> ESP är allmänt tillgängligt i HDI 3.6 för klustertyper: Apache Spark, interaktiv och Apache Hadoop. ESP för Apache HBase- och Apache Kafka-kluster finns i förhandsversion.
