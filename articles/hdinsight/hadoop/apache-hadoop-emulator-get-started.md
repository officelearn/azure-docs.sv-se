...
1. Öppna en webbläsare och navigera till den URL som visas (vanligt vis `http://127.0.0.1:8888`).
...
2. När gränssnittet har startats använder du följande för att visa de tabeller som ingår i sand boxen:
        ...
        show tables;
3. Använd följande för att hämta 10 rader från `sample_07`s tabellen:
