...
* **[Förhandsgranskning av domänanslutna kluster](../domain-joined/apache-domain-joined-introduction.md)**: Ett kluster kopplat till en Active Directory-domän, så att du kan kontrollera åtkomsten till och tillhandahålla styrning av data.
...
* [Komma igång med Hadoop i HDInsight](apache-hadoop-linux-tutorial-get-started.md): En snabbkurs i hur du etablerar HDInsight Hadoop-kluster och kör Hive-exempelfrågor.
* [Komma igång med Spark i HDInsight](../spark/apache-spark-jupyter-spark-sql.md): En snabbkurs i hur du skapar ett Spark-kluster och kör interaktiva Spark SQL-frågor.
* [Använda R Server på HDInsight](../r-server/r-server-get-started.md): Börja använda R Server i HDInsight Premium.
