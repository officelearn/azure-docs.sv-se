...
Anpassad karta/minska komponenter är vanligen skrivna i Java. Hadoop är en strömmande gränssnitt som gör också att komponenter som ska användas som har utvecklats på andra språk som C#, F #, Visual Basic, Python och JavaScript.
