...
* Så här visar `hivesampletable` du schemat:

    Expandera **hivesampletable**. `hivesampletable` Kolumnernas namn och data typer visas.

* Så här visar `hivesampletable` du data:
