---
title: Använda Hive med Apache Hadoop för webbplatslogganalys - Azure HDInsight
description: Lär dig hur du använder Apache Hive med HDInsight för att analysera webbplatsloggar. Du använder en loggfil som indata till ett HDInsight-tabell och Använd HiveQL för att fråga efter data.
services: hdinsight
