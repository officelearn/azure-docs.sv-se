...
2. Välj __anpassad__och ange den __interna IP-adressen__ för den anpassade DNS-servern. Välj slutligen __Spara__.
...
### <a name="replication-scenarios"></a>Scenarier för replikering
