...
Lär dig hur du hanterar HDInsight-kluster med [HDInsight.NET SDK](/dotnet/api/overview/azure/hdinsight).
...
* [Dokumentation om HDInsight .NET SDK-referens](/dotnet/api/overview/azure/hdinsight)
