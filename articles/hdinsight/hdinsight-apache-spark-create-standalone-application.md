...
10. Skapa .jar-fil. IntelliJ IDEA gör det möjligt för skapa JAR som ett resultat av ett projekt. Utför följande steg.
    ...
    3. I den **skapa JAR från moduler** dialogrutan klickar du på ellipsknappen (![tre punkter](./media/hdinsight-apache-spark-create-standalone-application/ellipsis.png) ) mot den **Main klassen**.
