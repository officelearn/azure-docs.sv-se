<properties 
    pageTitle="En översikt över Apache Spark i HDInsight | Microsoft Azure" 
...
>[AZURE.NOTE] En lista med kända problem och begränsningar med den aktuella versionen finns i [kända problem i Apache Spark på Azure HDInsight (Linux)](hdinsight-apache-spark-jupyter-spark-sql.md).
