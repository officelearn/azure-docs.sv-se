...
* [Hue-binärfiler-14-04.tgz](https://hdiconfigactions.blob.core.windows.net/linuxhueconfigactionv01/hue-binaries-14-04.tgz): Hue binära filen som anropas från hui-install_v0.sh.
