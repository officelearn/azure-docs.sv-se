...
> [!NOTE]
> Standardversionen för HDInsight-tjänsten kan ändras utan föregående meddelande. Om du har ett beroende som version, ange HDInsight version när du skapar ditt kluster med .NET SDK med Azure PowerShell och Azure CLI.
...
| Apache Spark |2.3.0, 2.2.0, 2.1.0 |1.6.2, 2.0 |1.6.0 eller senare |1.5.2 |1.3.1 (endast Windows) |-|-|
...
| HDInsight 3.3 |HDP 2.3 |Windows Server 2012 R2 |Den 2 december 2015 |27 juni 2016 |Den 31 juli 2018 |Ja |Nej |
...
* Alla regioner utom södra Brasilien och västra Japan:
  ...
  | --- | --- | --- | --- | --- | --- | --- |
  | Huvud: standardstorleken för virtuella datorer |D3 v2 |D3 v2 | D13, D14 |A3 |D12 v2 |D12 v2 |
  | Huvud: rekommenderade storlekar för Virtuella datorer |D3 v2, D4 v2, D12 v2 |D3 v2, D4 v2, D12 v2  | D13, D14 |A3, A4, A5 |D12 v2, D13 v2, D14 v2 |D12 v2, D13 v2, D14 v2 |
  ...
  | ZooKeeper: standardstorleken för virtuella datorer | |A3 | |A2 | | |
  | ZooKeeper: rekommenderade storlekar för Virtuella datorer | |A3, A4, A5 | | A2, A3, A4 | | |
