...
4. Skapa ett HDInsight-kluster och välj det virtuella Azure-nätverk under konfigurationen. Använd stegen i följande dokument för att förstå klusterskapningsprocessen:
    ...
    * [Skapa HDInsight med Azure CLI 1.0](hdinsight-hadoop-create-linux-clusters-azure-cli.md)
...
3. Om du använder en anpassad DNS-server med ditt virtuella nätverk kan du även tillåta åtkomst från __168.63.129.16__. Den här adressen är Azures rekursiva matchare. Mer information finns i den [namnmatchning för virtuella datorer och rollen instanser](../virtual-network/virtual-networks-name-resolution-for-vms-and-role-instances.md) dokumentet.
