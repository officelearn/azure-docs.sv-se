...
Metod 2   
Skicka en fil och Lägg märke till att mappen. VSCode automatiskt läggs till i arbetsmappen. Du kan se livy-konfigurationen genom att välja **. vscode\settings.JSON**.
