...
1. I Ambari-ANVÄNDARGRÄNSSNITTET navigerar du till **MapReduce2** > **config** > **Advanced** > **anpassad mapred-site**.
...
1. Ladda ned garn behållare loggar för alla program hanterare med kommandot nedan. Då skapas logg filen som heter `amlogs.txt` i text format.
