...
To use the YARN CLI tools, you must first connect to the HDInsight cluster using SSH. Mer information finns i [Use SSH with HDInsight](hdinsight-hadoop-linux-use-ssh-unix.md) (Använda SSH med HDInsight).
