...
För PowerShell-cmdleten [New-AzStorageAccount](https://docs.microsoft.com/powershell/module/az.storage/new-azstorageaccount)kontrollerar du att parametern `-EnableHttpsTrafficOnly` är inställd på `1`.
