...
* Connect-AzureRmAccount eller [Select-AzureRmProfile](https://msdn.microsoft.com/library/mt619310.aspx). Se [autentisera tjänstens huvudnamn med Azure Resource Manager](../azure-resource-manager/resource-group-authenticate-service-principal.md)
