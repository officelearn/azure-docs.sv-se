...
1. På bladet **valfri konfiguration** väljer du **skript åtgärder**och anger den information som visas nedan:
...
1. Klicka på knappen **Välj** i slutet av **skript åtgärderna**för att spara konfigurationen. Använd slutligen knappen **Välj** längst ned i det **valfria konfigurations** bladet för att spara den valfria konfigurations informationen.
