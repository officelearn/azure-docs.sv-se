...
* Effektiv och ekonomisk datalagring med Azure Storage eller Azure Data Lake Store, som båda är Hadoop-kompatibla lagringsalternativ. Mer information finns i [Använda Azure Storage med Hadoop i HDInsight](hdinsight-hadoop-use-blob-storage.md) eller [Använda Data Lake Store med ett HDInsight-kluster](https://docs.microsoft.com/en-us/azure/data-lake-store/data-lake-store-hdinsight-hadoop-use-portal).
...
## <a id="resources"></a>Resurser för att läsa mer om stordata-analys, Hadoop och HDInsight
