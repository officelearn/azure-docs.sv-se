...
> [!NOTE]
> Stegen i den här artikeln förutsätter att du använder en Windows-baserad klient. Om du använder en Linux-, Unix- eller OS X-klient hittar du mer information i [Använda SSH med Linux-baserat Hadoop i HDInsight från Linux, Unix eller OS X](hdinsight-hadoop-linux-use-ssh-unix.md).
> 
