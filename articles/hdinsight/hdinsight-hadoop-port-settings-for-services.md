...
| Spark Thrift-servern |443 |HTTPS |Spark |Spark Thrift-servern som används för att skicka Hive-frågor. Se [använder Beeline med Hive i HDInsight](hadoop/apache-hadoop-use-hive-beeline.md) |
