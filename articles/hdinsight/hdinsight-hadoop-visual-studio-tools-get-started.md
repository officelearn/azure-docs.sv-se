...
Det tar tid att testa Hive-skript mot ett HDInsight-kluster. Det kan ta flera minuter eller ännu längre tid. HDInsight-verktyg för Visual Studio kan validera Hive-skript lokalt utan att ansluta till ett aktivt kluster.

Med HDInsight-verktyg för Visual Studio kan användarna också se vad som finns i Hive-jobbet genom att samla in och visa YARN-loggarna för specifika Hive-jobb.
...
![hdinsight visual studio tools, kör via hiveserver2](./media/hdinsight-hadoop-visual-studio-tools-get-started/hdinsight.visual.studio.tools.execute.via.hiveserver2.png)

Dessutom kan du se loggar strömmas tillbaka i realtid och visa jobbdiagram om Hive-frågan körs i Tez.

![hdinsight visual studio tools för snabb sökväg för hive-körning](./media/hdinsight-hadoop-visual-studio-tools-get-started/hdinsight.fast.path.hive.execution.png)
