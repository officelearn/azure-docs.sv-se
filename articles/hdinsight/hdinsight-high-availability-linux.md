...
| Status för WebHCat-Server                    | Den här aviseringen om värd nivå utlöses om `templeton` Server status inte är felfri.                                                                                                            |
