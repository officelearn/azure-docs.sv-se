...
Lär dig hur du använder den [Apache Mahout](https://mahout.apache.org) machine learning-biblioteket med Azure HDInsight för att generera filmrekommendationer. I exemplet i det här dokumentet används Azure PowerShell för att köra Mahout jobb.
