...
description: En introduktion till HDInsight och Apache Hadoop- och Apache Spark-teknikstacken och komponenter, inklusive Kafka, Hive, Storm och HBase för stordataanalys.
...
Azure HDInsight är en hanterad analystjänst med öppen källkod med full spektrum i molnet för företag. Du kan använda ramverk baserade på öppen källkod, till exempel Hadoop, Apache Spark, Apache Hive, LLAP, Apache Kafka, Apache Storm, R med flera.
...
![HDInsight-arkitektur: Datalagerhantering](./hadoop/media/apache-hadoop-introduction/hdinsight-architecture-data-warehouse.png "Arkitektur för HDInsight-datalagring")
...
![HDInsight-arkitektur: Data science](./hadoop/media/apache-hadoop-introduction/hdinsight-architecture-data-science.png "ARKITEKTUR för HDInsight-datavetenskap")
...
* [Azure verktygslåda för IntelliJ](./spark/apache-spark-intellij-tool-plugin.md)

* [Azure-verktygslåda för Eclipse](./spark/apache-spark-eclipse-tool-plugin.md)
