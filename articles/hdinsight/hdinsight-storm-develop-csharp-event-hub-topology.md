...
* Den [HDInsight tools för Visual Studio](hdinsight-hadoop-visual-studio-tools-get-started.md).
...
Händelsehubbar är datakällan för det här exemplet. Använd informationen i avsnittet ”Skapa en händelsehubb” i [Kom igång med Händelsehubbar](../event-hubs/event-hubs-csharp-ephcs-getstarted.md).
...
1. Om du inte redan har installerat den senaste versionen av HDInsight tools för Visual Studio finns [komma igång med HDInsight tools för Visual Studio](hdinsight-hadoop-visual-studio-tools-get-started.md).
