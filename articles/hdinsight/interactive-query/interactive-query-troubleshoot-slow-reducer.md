...
När du kör en fråga som `insert into table1 partition(a,b) select a,b,c from table2` en frågeplan startar en mängd olika Defiler, men data från varje partition går till en enda minsknings punkt. Detta gör att frågan blir så låg som den tid det tar för den största partitionens minskning.
