...
Som standard kontrollerar `yarn.scheduler.capacity.maximum-applications` det maximala antalet program som körs eller väntar, och den är som standard `10000`.
