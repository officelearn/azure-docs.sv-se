...
Vi går igenom följande steg för att skapa ett BYOK-aktiverat Kafka-kluster:
...
1. Skapa nycklar.
    ...
    ![Apache Kafka genererar nyckel namn](./media/apache-kafka-byok/apache-kafka-create-key.png "Generera nyckel namn")
