...
Dessutom kan du installera en Desktop IDE och använda den för att få åtkomst till klustret genom att använda en fjärran sluten MapReduce eller Spark Compute context. Alternativen omfattar Microsofts [R-verktyg för Visual Studio](https://marketplace.visualstudio.com/items?itemName=MikhailArkhipov007.RTVS2019) (RTVS), RStudio och Walwares Sol förmörkelse-baserade [tillstånd](http://www.walware.de/goto/statet).
