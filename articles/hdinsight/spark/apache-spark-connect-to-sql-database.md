...
1. Klistra in följande kodutdrag i en ny Jupyter-anteckningsbok i en cell i koden, och ersätta platshållarvärdena med värden för din Azure SQL-databas.
    ...
    Tryck på **SKIFT + RETUR** att köra kodcellen.  
...
6. Kontrollera att data som strömmas till den **hvactable** genom att köra följande fråga. Varje gång du kör frågan, den visar antalet rader i tabellen stigande.
