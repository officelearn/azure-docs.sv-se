...
Installationsinstruktioner finns i [Installera Azure Toolkit för Eclipse](https://docs.microsoft.com/azure/java/eclipse/azure-toolkit-for-eclipse-installation).
