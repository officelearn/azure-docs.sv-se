---
title: 'Snabbstart: Skapa Apache Spark-kluster på Azure HDInsight med Azure PowerShell'
...
---
# <a name="quickstart-create-apache-spark-cluster-in-azure-hdinsight-using-powershell"></a>Snabbstart: Skapa Apache Spark-kluster i Azure HDInsight med PowerShell

I den här snabbstarten använder du Azure PowerShell för att skapa ett Apache Spark-kluster i Azure HDInsight. Du skapar sedan en Jupyter-anteckningsbok och använder den för att köra Spark SQL-frågor mot Apache Hive-tabeller. Azure HDInsight är en hanterad analystjänst med fullständigt spektrum med öppen källkod för företag. Apache Spark-ramverket för Azure HDInsight möjliggör snabb dataanalys och klusterdatorer med hjälp av minnesbearbetning. Jupyter notebook kan du interagera med dina data, kombinera kod med markdown text, och göra enkla visualiseringar.
...
- [PowerShell Az-modulen](https://docs.microsoft.com/powershell/azure/install-az-ps).
...
- Ett Azure Storage-konto eller Azure Data Lake Storage.  Varje HDInsight-kluster kräver en beroende datalagring. I den här snabbstarten skapar du ett kluster som använder Azure Storage Blobbar som klusterlagring. Mer information om att använda Data Lake Storage Gen2 finns i [Snabbstart: Konfigurera kluster i HDInsight](../../storage/data-lake-storage/quickstart-create-connect-hdi-cluster.md).
- Ett kluster av olika klustertyper på HDInsight.  I den här snabbstarten skapar du ett Spark 2.3-kluster.
...
|Location| Ange Azure-regionen, t.ex. USA, centrala. |
...
|SSH-användaruppgifter | SSH-klienterna kan användas för att skapa en fjärrkommandoradssession med kluster i HDInsight.|

1. Välj **Prova** det i det övre högra hörnet för följande kodblock för att öppna [Azure Cloud Shell](../../cloud-shell/overview.md)och följ sedan instruktionerna för att ansluta till Azure.
...
[Jupyter Notebook](https://jupyter.org/) är en interaktiv anteckningsbok miljö som stöder olika programmeringsspråk. Du kan använda anteckningsboken för att interagera med dina data, kombinera kod med markdown-text och utföra enkla visualiseringar.

1. Sök efter och välj **HDInsight-kluster**i [Azure-portalen](https://portal.azure.com).
   
   ![Öppna HDInsight-kluster i Azure-portalen](./media/apache-spark-jupyter-spark-sql-use-powershell/azure-portal-search-hdinsight-cluster.png)
   
1. Välj det kluster som du skapade i listan.
   
   ![Öppna HDInsight-kluster i Azure-portalen](./media/apache-spark-jupyter-spark-sql-use-powershell/azure-portal-open-hdinsight-cluster.png)
   
1. På sidan Översikt **över** klustret väljer du **Klusterinstrumentpaneler**och väljer sedan **Jupyter Notebook**. Ange autentiseringsuppgifterna för klustret om du uppmanas att göra det.
...
1. Välj **Ny** > **PySpark** om du vill skapa en anteckningsbok.
   ...
   ![Skapa en Jupyter-anteckningsbok för att köra interaktiv Spark SQL-fråga](./media/apache-spark-jupyter-spark-sql-use-powershell/hdinsight-spark-create-jupyter-interactive-spark-sql-query.png "Skapa en Jupyter-anteckningsbok för att köra interaktiv Spark SQL-fråga")
...
1. Kör ytterligare en fråga för att visa data i `hivesampletable`.
    ...
    ![Hive-frågeutdata i HDInsight](./media/apache-spark-jupyter-spark-sql-use-powershell/hdinsight-spark-get-started-hive-query-output.png "Hive-frågeutdata i HDInsight")
...
![Azure-portalen tar bort ett HDInsight-kluster](./media/apache-spark-jupyter-spark-sql-use-powershell/hdinsight-azure-portal-delete-cluster.png "Ta bort HDInsight-kluster")
...
### <a name="piecemeal-clean-up-with-powershell-az-module"></a>Bit för bitrensning med PowerShell Az-modul
