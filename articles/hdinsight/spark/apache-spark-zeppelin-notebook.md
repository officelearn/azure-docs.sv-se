...
4. Om du vill lära dig att komma till värdet för nyckeln som anges ovan, här är hur.
    ...
    a. Leta upp paketet i Maven-centrallagret. Den här artikeln har vi använt [spark-csv](https://search.maven.org/#artifactdetails%7Ccom.databricks%7Cspark-csv_2.10%7C1.4.0%7Cjar).
