...
Om du till exempel vill skugga `com.google.guava`kan du lägga till nedanstående kommando i `build.sbt`-filen:
...
Sedan kan du köra `sbt clean` och `sbt assembly` för att skapa den skuggade jar-filen. 
