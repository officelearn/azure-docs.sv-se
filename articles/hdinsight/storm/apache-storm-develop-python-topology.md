...
> [!NOTE]
> Kommandot kräver en lokal Storm-utvecklingsmiljö. Mer information finns i [ställa in en utvecklingsmiljö](http://storm.apache.org/releases/current/Setting-up-development-environment.html)
