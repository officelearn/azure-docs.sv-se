...
> [!div class="mx-imgBorder"]
> ![strömning och bearbetning av Micro batch](./media/migrate-storm-to-spark/streaming-and-micro-batch-processing.png)
...
|Överordnad|Lyssnar efter arbete som har tilldelats till datorn och startar och stoppar arbets processer baserade på direktiv från Nimbus. Varje arbets process kör en delmängd av en topologi. Användarens program logik (kanaler och bult) kör här.|

> [!div class="mx-imgBorder"]
> ![Nimbus-, Zookeeper-och övervaknings-daemon](./media/migrate-storm-to-spark/nimbus-zookeeper-supervisor.png)
...
* De data som bearbetas av storm skrivs till en data mottagare, till exempel Azure Storage eller Azure Data Lake Storage Gen2.
    ...
    > [!div class="mx-imgBorder"]
    > ![diagram över den förmodade aktuella miljön](./media/migrate-storm-to-spark/presumed-current-environment.png)
