...
| kedjad sökning                 | No        | Yes       | No        |                                           |
| omvänd länkad sökning         | Inga        | Inga        | Inga        |                                            |
| funktioner eller behörigheter                   | Ja       | Ja       | Ja       |                                                     |
| batch                          | Ja       | Ja       | Ja       |                                                     |
| transaktionen                    | No        | Yes       | No        |                                                     |
| historik                        | Ja       | Ja       | Ja       |                                                     |
...
| `_include`              | No        | Yes       | Inga        |         |
| `_revinclude`           | Inga        | Inga        | Inga        |         |
