...
description: I den här snabb starten får du lära dig hur du distribuerar Azure API för snabba hälso-och sjukvårds resurser (FHIR®) genom att använda en Azure Resource Manager-mall.
author: mgblythe
...
Fler mall-exempel för Azure API för FHIR finns i [galleriet snabb starts mal len](https://azure.microsoft.com/resources/templates/?resourceType=Microsoft.Healthcareapis&pageNumber=1&sort=Popular).
