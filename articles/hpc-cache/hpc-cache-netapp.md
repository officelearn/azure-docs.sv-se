---
title: Använd Azure HPC cache (för hands version) och Azure NetApp Files
...
ms.locfileid: "72954947"
---
# <a name="use-azure-hpc-cache-preview-with-azure-netapp-files"></a>Använd Azure HPC cache (för hands version) med Azure NetApp Files
...
Om det delegerade under nätet är för stort, är det möjligt för Azure NetApp Files volymer att använda fler IP-adresser än en enda Azure HPC cache-instans kan hantera. En enda cache får ha högst tio lagrings mål.
...
Export namn på Azure NetApp Files systemet har en enda Sök vägs komponent. Försök inte att skapa ett lagrings mål för rot export ``/`` i Azure NetApp Files eftersom exporten inte ger åtkomst till filen.
