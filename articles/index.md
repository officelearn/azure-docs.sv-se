...
<div id="main" class="v2">
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Utvecklarens startguide för Azure</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Cloud Adoption Framework för Azure</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Kostnadsfria Azure-kurser från Pluralsight</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        ...
        <ul class="pivots">
            <li>
                <a href="#get-started">Kom igång</a>
                <ul id="get-started">
                    <li>
                        ...
                        <ul id="get-started1" class="cardsL">
                            <li>
                                <div class="container intro">
                                    <h2 class="likeAnH1">Kom igång med Azure</h2>
                                    <p>Utforska våra populäraste tjänster med snabbstarter, exempel och självstudiekurser.</p>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Distribuera infrastruktur</h3>
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="/azure/virtual-machines/linux/">Virtuella Linux-datorer</a></li>
                                                    <li><a class="barLink" href="/azure/virtual-machines/windows/">Virtuella Windows-datorer</a></li>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Skydda och hantera resurser</h3>
                                                <ul class="noBullet">
                            ...
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Hantera data och artificiell intelligens</h3>
                                                <h4>Relationsdatabaser</h4>
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="/azure/sql-database/">SQL Database som en tjänst</a></li>
                                                    <li><a class="barLink" href="/azure/sql-database-edge/">SQL Database för kanten</a></li>
                                                    <li><a class="barLink" href="/azure/virtual-machines/windows/sql/">SQL Server på virtuella Azure-datorer</a></li>
                                                    <li><a class="barLink" href="/azure/sql-data-warehouse/">Synapse Analytics (tidigare SQL DW)</a></li>
                                                ...
                                                <h4>Artificiell intelligens och Cognitive Services</h4>
                                                <ul class="noBullet">
                                                ...
                                                <ul class="noBullet">
                                                    ...
                                                    <li>
                                                        <a class="barLink" href="/azure/azure-portal/">
                                                            <img src="https://docs.microsoft.com/media/logos/logo_azure.svg" alt=""> Azure-portalen </a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="https://azure.microsoft.com/features/azure-portal/mobile-app/">
                                                            <img src="https://docs.microsoft.com/media/common/i_mobile-app-developement.svg" alt=""> Azure-mobilapp </a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Utveckla dina färdigheter med Microsoft Learn</h3>
                                                <ul class="noBullet">
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/tour-azure-portal/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/tour-azure-services-and-features.svg" alt=""> Titta närmare på Azure-tjänster och -funktioner </a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/principles-cloud-computing/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/principles-cloud-computing.svg" alt=""> Principer för molnbaserad databehandling </a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/control-azure-services-with-cli/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/control-azure-services-with-cli.svg" alt=""> Kontrollera Azure-tjänster med CLI </a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/automate-azure-tasks-with-powershell/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/automate-azure-tasks-with-powershell.svg" alt=""> Automatisera Azure-uppgifter med hjälp av skript med PowerShell </a>
                                                    </li>
                                                    <li>
                            ...
                            <li class="bottomRightItem">
                                <a href="https://docs.microsoft.com/azure/index#pivot=products&panel=all">
                                    <button style="cursor: pointer;position: relative; background: #0050C5; border:none; padding:8px 16px; padding-right:30px;color: white; font-size:14px;">Visa alla Azure-tjänster<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 10 14" style="fill:white;height: 14px;position: absolute;bottom: 13px;right: 12px;width: 1em;"><path d="M7.4 7L1 .6l.6-.6 7 7-7 7-.6-.7L7.4 7z" /></svg></button>
                                </a>
                            </li>
                        </ul>
                    </li>
            ...
            <li>
                ...
                <ul id="products">
                    <li>
                        <a data-default="true" href="#all">Alla</a>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/cognitive-services/bing-spell-check/">
                                                ...
                                                <p>Stavningskontrolls-API i Bing</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/sql-data-warehouse/">
                                                ...
                                                <p>Azure Synapse Analytics (tidigare SQL DW)</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/virtual-machines/linux/">
                                                ...
                                                <p>Virtuella Linux-datorer</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/virtual-machines/windows/">
                                                <img src="media/index/VirtualMachine.svg" alt="" />
                                                <p>Virtuella Windows-datorer</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/virtual-machines/windows/sql/virtual-machines-windows-sql-server-iaas-overview?toc=%2Fazure%2Fvirtual-machines%2Fwindows%2Ftoc.json">
                                                <img src="media/index/VirtualMachine.svg" alt="" />
                                                <p>SQL Server på Virtual Machines</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/virtual-machines/workloads/sap/hana-overview-architecture">
                                                <img src="media/index/VirtualMachine.svg" alt="" />
                                                <p>SAP HANA på stora Azure-instanser</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/integrations">
                                                ...
                                                <p>Integrering av utvecklarverktyg</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/cli">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/active-directory-domain-services">
                                                <img src="media/index/ActiveDirectory.svg" alt="" />
                                                <p>Azure Active Directory för Domain Services</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/media-services/media-services-manage-channels-overview">
                                                ...
                                                <p>Direktuppspelning live och på begäran</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                          <a href="/azure/web-application-firewall/">
                                                ...
                                                <p>Brandvägg för webbaserade program</p>
                                          </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/role-based-access-control/">
                                                ...
                                                <p>Rollbaserad åtkomstkontroll</p>
                                            </a>
                                        </li>
                                        <li>
                    ...
                    <li>
                        ...
                        <ul id="ai" class="cardsA">
                            <li class="fullSpan">
                                <h2>Artificiell intelligens + maskininlärning</h2>
                            </li>
                            <li>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Stärk dina appar, webbplatser och robotar med intelligens för att se, höra, tala och förstå</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Skapa, distribuera och hantera maskininlärning och AI-modeller</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Intelligent, serverfri bot-tjänst som kan byggas ut på begäran</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Fullständigt hanterad sökning som en tjänst</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Skapa en arbetsyta för Azure Databricks med Spark-kluster</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Open Datasets</h3>
                                                    <p>Granskade offentliga datauppsättningar för att förbättra maskininlärningsmodeller</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Synapse Analytics (tidigare SQL DW)</h3>
                                                    <p>Gränslös analystjänst som ger snabbare insikter</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>HDInsight</h3>
                                                    <p>Tillhandahåll Hadoop, Spark, R Server, Hbase och Storm-kluster i molnet</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Data Factory</h3>
                                                    <p>Dirigera och hantera dataomvandling och rörelse</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure-datautforskaren</h3>
                                                    <p>Snabb och mycket skalbar datautforskningstjänst för logg- och telemetridata</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Realtidsanalys för dataströmmar som rör sig snabbt från program och enheter</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Distribuerad analystjänst som förenklar stordata</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Bädda in fantastiska, helt interaktiva datavisualiseringar i dina appar</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Apache Spark för Azure HDInsight</h3>
                                                    <p>Apache Spark i molnet för verksamhetskritiska distributioner</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Apache Storm för Azure HDInsight</h3>
                                                    <p>Enklare strömbearbetning i realtid för stordata</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>R Server för Azure HDInsight</h3>
                                                    <p>Förutsägelseanalyser, maskininlärning och statistisk modellering för stordata</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Extremt skalbar och säker Data Lake-lagring som bygger på Blob Storage</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Lagringsplats i hyperskala för resurskrävande stordataanalyser</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>NFS-filtjänster på företagsnivå som drivs av NetApp</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>En enkel och säker tjänst för att dela stordata med externa organisationer</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#blockchain">Blockkedja</a>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Skapa, styra och expandera blockkedjenätverk i konsortium</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Ansluta blockkedjan till molnet utan tunga lyft</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Blockchain-token</h3>
                                                    <p>Definiera, skapa och hantera enkelt token som baseras på transaktionsregister</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Virtuella Linux-datorer</h3>
                                                    <p>Etablera virtuella datorer med Ubuntu, Red Hat med flera</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Virtuella Windows-datorer</h3>
                                                    <p>Etablera virtuella datorer för SQL Server, SharePoint med flera</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Batch</h3>
                                                    <p>Jobbschemaläggning och beräkningshantering i molnskala</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Skapa högtillgängliga, oändligt skalbara molnprogram och API:er</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SQL Server på Virtual Machines</h3>
                                                    <p>Var värd för SQL Server-företagsappar i molnet</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SAP HANA på stora Azure-instanser</h3>
                                                    <p>Kör de senaste SAP HANA-arbetsbelastningarna hos alla molnprovidrar i hyperskala</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>CycleCloud</h3>
                                                    <p>Skapa, hantera, använda och optimera HPC och stora beräkningskluster i valfri skala</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Köra VMware-plattformen i Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Fullständigt hanterad OpenShift-tjänst som drivs i samarbete med Red Hat</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Cognitive Services</h3>
                                                    <p>Använda Azure Cognitive Services-containrar med Docker, Kubernetes, AKS och Container Instances</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Snabb Kubernetes-utveckling med containrar och mikrotjänster</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Relationsdatabasmotor optimerad för IoT-och Edge-distributioner.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Hanterad PostgreSQL-databastjänst för apputvecklare</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Hanterad MySQL-databastjänst för apputvecklare</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure-databas för MariaDB</h3>
                                                    <p>Hanterad MariaDB-databastjänst för apputvecklare</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Minska komplexiteten för din molnmigrering</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#devtools">Utvecklarverktyg</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Visual Studio</h3>
                                                    <p>Integrerad utvecklingsmiljö (IDE) med alla funktioner för Android, iOS, Windows, webb och molntjänster</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Visual Studio-koden</h3>
                                                    <p>Visual Studio Code är en enkel men kraftfull källkodsredigerare som körs på skrivbordet och är tillgänglig för Windows, macOS och Linux.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SDK:er</h3>
                                                    <p>Skapa molnappar med de programmeringsspråk du redan känner till</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Integrering av utvecklarverktyg</h3>
                                                    <p>Verktyg från tredje part som hjälper dig med din Azure-utveckling</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>CLI</h3>
                                                    <p>Åtkomst till molnet direkt från kommandoradsverktyg</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Snabb och skalbar parameterlagring för App Configuration</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Identifiera, sortera och diagnostisera problem i dina webbappar och tjänster</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Skapa labb i molnet för klassrum, utveckling och testning och andra scenarier (tidigare DevTest Labs)</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Leverera appar snabbare genom att automatisera programlivscykler</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Integrering av utvecklarverktyg</h3>
                                                    <p>Utöka Azure med populära tillägg</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>HockeyApp</h3>
                                                    <p>Distribuera mobilappar, samla in feedback och kraschrapporter, och hantera användning</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Distribuera snabbt valfritt språk på valfri plattform till Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Synkronisera lokala kataloger och aktivera enkel inloggning</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Skapa och distribuera organisationens principer för att kontrollera känslig information</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Active Directory för Domain Services</h3>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Läs mer om hur du skyddar dina molnlösningar på Azure med våra metodtips och riktlinjer</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#integration">Integrering</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Service Bus</h3>
                                                    <p>Anslut via privata och offentliga moln</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Event Grid</h3>
                                                    <p>Få tillförlitlig händelseleverans i omfattande skala</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<li>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Skapar snabbt digitala jordbrukslösningar i molnet.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Ekonomiska tjänster</h3>
                                                    <p>Lösningar och användningsfall för finansbranschen.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Sjukvårdsvetenskap</h3>
                                                    <p>Lösningar och användningsfall för sjukvårdsbranschen.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Tillverkning</h3>
                                                    <p>Lösningar och användningsfall för tillverkningsindustrin.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Detaljhandeln</h3>
                                                    <p>Lösningar och användningsfall för detaljhandelsindustrin.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Är Azure IoT nytt för dig?</h3>
                                                    <p>Börja här och upptäck vilka tjänster som passar dina behov</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>IoT Central</h3>
                                                    <p>Påskynda skapandet av IoT-lösningar</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>IoT Hub</h3>
                                                    <p>Anslut, övervaka och styr flera miljarder IoT-tillgångar</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Ansluta enheter till din IoT-lösning utan att skriva någon enhetskod</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>IoT-lösningsacceleratorer</h3>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Skapa digitala repliker av blanksteg och infrastruktur</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Utforska och analysera Time Series-data direkt</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Stream Analytics</h3>
                                                    <p>Dataströmningsbearbetning i realtid från miljontals IoT-enheter</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Sphere</h3>
                                                    <p>Skapa mycket säkra, anslutna MCU-drivna enheter</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#mgmt">Hantering och styrning</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Scheduler</h3>
                                                    <p>Kör jobb enligt enkla eller komplexa återkommande scheman</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Automation</h3>
                                                    <p>Förenkla molnhantering med processautomatisering</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Vidarebefordra inkommande trafik för hög prestanda och tillgänglighet</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Monitor</h3>
                                                    <p>Mycket detaljerad dataövervakning i realtid för alla Azure-resurser</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Säkerhet &amp; efterlevnad</h3>
                                                    <p>Aktivera hotidentifiering och skydd via avancerad molnsäkerhet</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Portal</h3>
                                                    <p>Skapa, hantera och övervaka alla Azure-produkter i en enda enhetlig konsol</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Förenkla hanteringen av appresurser</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Cloud Shell</h3>
                                                    <p>Effektivisera Azure-administrationen med ett webbläsarbaserat skal</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure-mobilapp</h3>
                                                    <p>Håll dig ansluten till dina Azure-resurser – när som helst och var som helst</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Distribuera och uppdatera molnmiljöer på upprepningsbara sätt med hjälp av sammansättningsbara artefakter</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Utforska resurser i stor skala med ett funktionsrikt frågespråk</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Migrate</h3>
                                                    <p>Upptäck, utvärdera, ange storlek för och migrera dina lokala virtuella datorer till Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Hantera kundresurser i stor skala</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Koda, lagra och strömma video och ljud i olika skalor</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Kodning</h3>
                                                    <p>Kodning i studioklass och i molnskala</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Direktuppspelning, live och på begäran</h3>
                                                    <p>Leverera innehåll till i stort sett alla enheter med en skala som uppfyller företagets krav</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>En spelare för alla uppspelningsbehov</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Leverera innehåll säkert med AES, PlayReady, Widevine och Fairplay</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Medieanalys</h3>
                                                    <p>Skaffa insikter från videofiler med taltjänster och visuella tjänster</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Video Indexer</h3>
                                                    <p>Gör ditt multimedieinnehåll lättare att upptäcka och komma åt</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Stack</h3>
                                                    <p>Utöka tjänster och funktioner i Azure lokalt för att skapa och distribuera hybridmoln och gränsprogram mellan molngränser</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Lär dig hur du hanterar den Azure Stack-integrerade systeminfrastrukturen och hur du gör för att erbjuda tjänster</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <a href="/azure/azure-stack/user">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Azure Stack-användare</h3>
                                                <p>Använd tjänster och skapa program för Azure Stack</p>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>En icke-produktionsmiljö för utvärdering och testning</p>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Digital Twins</h3>
                                                    <p>Skapa nästa generation IoT-lösningar för rumslig intelligens</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Skapa rumsligt medvetna Mixed Reality-upplevelser för flera användare</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Bygg din lösning med en mångsidig sensorenhet</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>API Apps</h3>
                                                    <p>Bygg och använd enkelt API:er i molnet</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Xamarin</h3>
                                                    <p>Snabbare framtagning av fantastiska mobilappar med molnstöd</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure DNS</h3>
                                                    <p>Använd Azure som värd för din DNS-domän</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>VPN Gateway</h3>
                                                    <p>Etablera säker anslutning mellan olika platser</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Brandvägg för webbaserade program</h3>
                                                    <p>Tillhandahålla ett centraliserat skydd för dina webbprogram mot vanliga sårbarheter och hot</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Få optimal Internetanslutning för att få åtkomst till Microsoft-nätverket</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Utvärdera hur ändringar i nätverksinfrastrukturen påverkar dina kunders prestanda</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Privat åtkomst till tjänster på Azure-plattformen, och dina data stannar på Microsofts nätverk</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>En globalt distribuerad tjänst för säkerhetshantering</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Dedikerad HSM</h3>
                                                    <p>Använda lagring av kryptografiska nycklar i Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Skydda företaget från hot i molnet och lokalt</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Rollbaserad åtkomstkontroll</h3>
                                                    <p>Hantera åtkomst till Azure-resurser</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Lär dig hur du använder Microsofts program för säkerhetsinformation och händelsehantering som tillhandahåller intelligenta säkerhetsanalyser för hela din organisation på molnskala</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Managed Disks</h3>
                                                    <p>Beständiga och säkra disklagringsalternativ för virtuella Azure-datorer</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Data Box-serien</h3>
                                                    <p>En serie lagringsenheter som möjliggör offline- eller nätverksbaserad dataöverföring</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Kör flexibla och filbaserade arbetsbelastningar i Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Avere vFXT</h3>
                                                    <p>Kör högpresterande och filbaserade arbetsbelastningar i Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Optimeringslösning för hybridlagring i HPC-miljöer</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Hantera lagring enkelt var som helst på Windows, macOS och Linux</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Arkivlagring</h3>
                                                    <p>Säker molnlagring med låg kostnad för data som används sällan</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure NetApp Files</h3>
                                                    <p>Nätverksfiltjänster på företagsnivå som drivs av NetApp</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Skapa och distribuera affärskritiska webbappar snabbt och efter behov</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Lägg enkelt till webbfunktioner i realtid</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Windows Virtual Desktop</h3>
                                                    <p>Leverera en virtuell datorupplevelse till valfri enhet i molnskala</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
Azure för .NET-utvecklare </h3>
                                                ...
                                                <p>
                                                    <a href="/dotnet/api/overview/azure/?view=azure-dotnet">API-referens</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
...
Azure för Python-utvecklare </h3>
                                                <p>
                                                    <a href="/azure/python">Kom igång</a>
                                                </p>
                                                <p>
                                                    <a href="/python/api/?view=azure-python">API-referens</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
...
Azure för Node.js-utvecklare </h3>
                                                <p>
                                                    <a href="/azure/javascript/">Kom igång</a>
                                                </p>
                                                <p>
                                                    <a href="/javascript/api/overview/azure/">API-referens</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
...
Azure för Java-utvecklare </h3>
                                                ...
                                                <p>
                                                    <a href="/java/api">API-referens</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Azure Portal</h3>
                                                <p>
                                                    <a href="/azure/azure-portal/">Kom igång</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Azure-mobilapp</h3>
                                                <p>
                                                    <a href="https://azure.microsoft.com/features/azure-portal/mobile-app/">Kom igång</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="https://visualstudio.microsoft.com/downloads/?utm_medium=microsoft&utm_source=docs.microsoft.com&utm_campaign=navigation+cta&utm_content=download+vs2017">Ladda ned till Windows</a>
                                                </p>
                                                 <p>
                                                    <a href="https://visualstudio.microsoft.com/vs/mac/">Ladda ned till Mac</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
...
Docker </h3>
                                                ...
                                                <p>
                                                    <a href="https://www.visualstudio.com/downloads/?utm_medium=microsoft&utm_source=docs.microsoft.com&utm_campaign=button+cta&utm_content=download+vs2017">Ladda ned till Visual Studio</a>
                                                </p>
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=780681">Ladda ned till Visual Studio Code</a>
                                                </p>
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=780682">Ladda ned till Azure DevOps</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
...
Azure Resource Manager </h3>
                                                ...
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/templates/">Referens</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="/azure/vs-azure-tools-storage-manage-with-storage-explorer">Kom igång</a>
                                                </p>
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=722418">Ladda ned till Linux</a>
                                                </p>
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=708342">Ladda ned till Mac</a>
                                                </p>
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=708343">Ladda ned till Windows</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Service Fabric SDK och verktyg </h3>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/service-fabric/service-fabric-get-started">Ladda ned till Windows</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/service-fabric/service-fabric-get-started-linux">Ladda ned till Linux</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/service-fabric/service-fabric-get-started-mac">Ladda ned Mac OS X</a>
                                                </p>
                                                <p>
...
SQL-verktyg </h3>
                                                <p>
                                                    <a href="/sql/azure-data-studio/download">Azure Data Studio <sup>FÖRHANDSVERSION</sup></a>
                                                </p>
                                                <p>
...
Azure Dev Spaces </h3>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/dev-spaces/azure-dev-spaces">Kom igång</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/dev-spaces/quickstart-netcore">Nedladdning för .NET Core och VS Code</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/dev-spaces/quickstart-netcore-visualstudio">Nedladdning för .NET Core och Visual Studio</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/dev-spaces/quickstart-nodejs">Nedladdning för Node.js</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
