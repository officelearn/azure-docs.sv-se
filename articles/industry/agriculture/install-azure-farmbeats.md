...
Azure FarmBeats kräver skapande och registrering av program för Azure Active Directory. För att kunna köra skriptet för att skapa AAD, krävs följande behörigheter –
