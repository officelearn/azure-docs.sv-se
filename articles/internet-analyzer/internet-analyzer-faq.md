...
## <a name="how-do-i-participate-in-the-preview"></a>Hur gör jag för att delta i förhandsversionen?

Förhandsversionen är tillgänglig för vissa kunder. Om du är intresse rad av att delta i förhands granskningen gör du följande:
...
## <a name="do-i-get-billed-for-participating-in-the-preview"></a>Debiteras jag för att delta i förhandsversionen?
