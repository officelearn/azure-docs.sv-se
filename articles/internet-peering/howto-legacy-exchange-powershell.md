...
I den här artikeln beskrivs hur du konverterar en befintlig äldre Exchange-peering till en Azure-resurs med hjälp av PowerShell-cmdletar.

Om du vill kan du slutföra den här guiden med hjälp av [Azure-portalen](howto-legacy-exchange-portal.md).
...
Det här exemplet visar hur du får äldre Exchange-peering på Seattle-peering-platsen:
