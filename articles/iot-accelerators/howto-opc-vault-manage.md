...
8. Välj följande **nyckel behörigheter**: **Hämta**, **lista**och **signera**.
9. Välj följande **hemliga behörigheter**: **Hämta**, **lista**, **Ange**och **ta bort**.
10. Välj följande **certifikat behörigheter**: **Hämta** och **lista**.
...
8. Välj följande **nyckel behörigheter**: **Hämta**, **lista**och **signera**.
9. Välj följande **hemliga behörigheter**: **Hämta**, **lista**, **Ange**och **ta bort**.
10. Välj följande **certifikat behörigheter**: **Hämta**, **Visa**, **Uppdatera**, **skapa**och **Importera**.
11. Välj **OK**och välj **Spara**.
