...
ms.locfileid: "34725589"
---
# <a name="compare-azure-iot-options"></a>Jämför Azure IoT-alternativ

Artikeln [Azure och Sakernas Internet](iot-accelerators-what-is-azure-iot.md) beskriver en typisk IoT-lösningsarkitektur med följande nivåer:
...
* [Azure IoT-lösningsacceleratorer](../active-directory-domain-services/index.yml) är en samling [lösningsacceleratorer](iot-accelerators-what-are-solution-accelerators.md) i företagsklass som bygger på Azure PaaS (Platform as a Service), som gör det möjligt att påskynda utvecklingen av anpassade IoT-lösningar.
...
* **Azure IoT-lösningsacceleratorer**: [Vad är Azure IoT-lösningsacceleratorer för något?](iot-accelerators-what-are-solution-accelerators.md)
