...
Artikeln [förstå modellschemat enheten](iot-accelerators-remote-monitoring-device-schema.md) beskrivs det schema som definierar en simulerad enhetsmodell. Den artikeln som avses två typer av JavaScript-fil som implementerar beteendet för en simulerad enhet:
...
Den [simuleringen](iot-accelerators-remote-monitoring-device-schema.md#simulation) avsnitt i enheten modellschemat definierar det interna tillståndet för en simulerad enhet:
...
Den [CloudToDeviceMethods](iot-accelerators-remote-monitoring-device-schema.md#cloudtodevicemethods) avsnitt i enheten modellschemat definierar metoder som en simulerad enhet svarar.
...
Den [skapa en simulerad enhet](iot-accelerators-remote-monitoring-test.md) artikeln visar hur du kör tjänsten enhet simuleringen lokalt. Kör tjänsten lokalt gör det enklare att felsöka din simulerade enheter innan du distribuerar dem till molnet.
