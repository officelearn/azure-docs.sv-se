...
Läs mer om JavaScript-fil som uppdaterar tillstånd enhetsobjekt i [förstå beteendet enheten modellen](iot-accelerators-remote-monitoring-device-behavior.md).
