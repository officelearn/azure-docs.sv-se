...
Du kan alltid börja skapa ett arbets flöde med hjälp av IoT Central Connector i Logic Apps i Azure-portalen. Du kan sedan välja vilken IoT Central app och vilken regel som ska anslutas till, och den fungerar fortfarande på samma sätt. Du behöver inte starta från sidan IoT Central regler varje tillfälle.
