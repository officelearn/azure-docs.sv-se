...
1. Välj **+ nytt** från mallar ![enhets mal len](media/howto-connect-raspberry-pi-csharp/adddevicetemplate.png)
   

2. Välj **Raspberry Pi** och skapa Raspberry Pi-enhet mal len ![lägga till enhets mal len](media/howto-connect-raspberry-pi-csharp/newdevicetemplate.png)
