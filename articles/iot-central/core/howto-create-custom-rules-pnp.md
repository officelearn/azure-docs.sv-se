...
1. Välj **+** för att skapa en ny funktion.
...
Om du vill implementera din funktion lägger C# du till koden för att analysera inkommande HTTP-begäran och skicka e-postmeddelanden enligt följande:
...
Nu när du vet hur du skapar anpassade regler och meddelanden är det föreslagna nästa steg att lära dig hur du [utökar Azure-IoT Central med anpassad analys](howto-create-custom-analytics-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json).
