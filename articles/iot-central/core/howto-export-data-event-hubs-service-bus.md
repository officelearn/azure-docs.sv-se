...
2. Välj en prenumeration. 
    ...
    > [!Note] 
    > Nu kan du exportera data till andra prenumerationer som inte är samma som för ditt standard IoT Central-program. Du kommer att ansluta med hjälp av en anslutnings sträng i det här fallet.
