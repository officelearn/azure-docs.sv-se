...
![Välj åtgärd](media/howto-use-action-groups-pnp/chooseaction.png)

Välj en åtgärds grupp från din Azure-prenumeration:

![Välj åtgärds grupp](media/howto-use-action-groups-pnp/chooseactiongroup.png)

Välj **Spara**. Åtgärds gruppen visas nu i listan med åtgärder som ska köras när regeln utlöses:

![Sparad åtgärds grupp](media/howto-use-action-groups-pnp/savedactiongroup.png)
...
| Webhook     | {"schemaId": "AzureIoTCentralRuleWebhook", "data": {[Normal webhook-nyttolast](howto-create-webhooks-pnp.md#payload)}} |
...
Nu när du har lärt dig hur du använder åtgärds grupper med regler, är det föreslagna nästa steg att lära dig hur du [hanterar dina enheter](howto-manage-devices-pnp.md).
