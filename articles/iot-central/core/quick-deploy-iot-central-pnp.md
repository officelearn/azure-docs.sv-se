...
![Sidan skapa en program-Azure IoT Central](media/quick-deploy-iot-central-pnp/iotcentralcreate-templates-pnp.png)
...
1. Azure IoT Central genererar också ett unikt **program-URL** -prefix åt dig, baserat på program namnet. Du använder den här URL: en för att få åtkomst till ditt program. Du är kostnads fri att ändra detta URL-prefix till något mer minnes värt om du vill.
    ...
    ![Sidan skapa en program-Azure IoT Central](media/quick-deploy-iot-central-pnp/iotcentralcreate-industry-pnp.png)
...
> [Lägg till en simulerad enhet till ditt IoT Central program](./quick-create-pnp-device-pnp.md)
