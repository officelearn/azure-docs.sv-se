...
Innan du börjar bör du slutföra de tre föregående snabb starterna [skapa ett Azure IoT Central-program](./quick-deploy-iot-central-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json), [lägga till en simulerad enhet i IoT Central programmet](./quick-create-pnp-device-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) och [Konfigurera regler och åtgärder för enheten](quick-configure-rules-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json).
...
Öppna e-postmeddelandet som du fick i slutet av [Konfigurera reglerna och åtgärderna för](quick-configure-rules-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) snabb starten av enheten. I e-postmeddelandet väljer du länken till enheten:

![E-postavisering](media/quick-monitor-devices-pnp/email.png)

Vyn **instrument panel** för den simulerade enheten som du skapade i föregående snabb starts fönster öppnas i webbläsaren:

![Enheten som utlöste e-postmeddelandet](media/quick-monitor-devices-pnp/dashboard.png)
...
![Uppdatera inställningar](media/quick-monitor-devices-pnp/change-settings.png)
...
> [Bygg och hantera en enhets mall](howto-set-up-template-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json).
