...
1. Logga in på IoT Central programmet som du skapade med hjälp av den **anpassade appen > för hands version av appen** [skapa ett Azure IoT Central-program (förhands gransknings funktioner)](./quick-deploy-iot-central-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) snabb start.
...
1. Anteckna **ID-omfånget** och den **primära nyckeln** som visas när du väljer **Visa nycklar**. Du använder dessa värden senare i den här självstudien.
    ...
    ![Enhets anslutning](./media/tutorial-connect-pnp-device-pnp/device-connection.png)
...
![Modell lagring och DCM](./media/tutorial-connect-pnp-device-pnp/public-repository.png)
...
![Genererad enhets kod](./media/tutorial-connect-pnp-device-pnp/generated-code.png)
...
1. I ditt IoT Central-program går du till sidan **enheter** och väljer **mxchip-01-** enheten. Enheten lades automatiskt till när enhets koden anslöt:
    ...
    ![Översikts sida](./media/tutorial-connect-pnp-device-pnp/overview-page.png)
...
1. Gå till sidan **enhetsspecifika mallar** om du vill se mallen som IoT Central skapade från DCM i den offentliga lagrings platsen:
    ...
    ![Sidan enhets mallar](./media/tutorial-connect-pnp-device-pnp/device-template.png)
