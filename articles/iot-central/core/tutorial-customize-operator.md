---
title: 'Självstudie: anpassa operatörens vyer i Azure IoT Central'
description: 'Självstudie: som ett verktyg kan du anpassa operatörens vyer i ditt Azure IoT Central-program.'
author: sandeeppujar
ms.author: sandeepu
ms.date: 11/13/2019
ms.topic: tutorial
...
1. Om du vill redigera enhets mal len för den **anslutna luftkonditionerings** enheten väljer du **enhets mallar** i den vänstra rutan:
