...
I den här självstudien får du, som ett verktyg, hur du använder en gateway-enhets mall för att definiera en gateway-enhet i IoT Central-programmet. Sedan kan du konfigurera flera underordnade enheter som ansluter till ditt IoT Central-program via gateway-enheten. 
...
1. Välj **+** för att lägga till ett gränssnitt.  Välj standard gränssnittet för **enhets information** .
...
1. Välj **+** för att börja lägga till en ny enhet.
...
> [Anslut en enhet](tutorial-connect-device.md)
