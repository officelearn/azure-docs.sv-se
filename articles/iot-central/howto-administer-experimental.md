...
![Inställningssidan för program](media/howto-administer-experimental/image0-a.png)
...
Om du vill ändra programavbildningen [Förbered och ladda upp bilder till Azure IoT Central programmet](howto-prepare-images-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json).
...
Klicka på den **kopia** knappen. I dialogrutan, ange information för det nya programmet betala per användning. Klicka sedan på den **kopiera** för att bekräfta att du vill fortsätta. Mer information om fälten i det här formuläret i [skapar ett program](quick-deploy-iot-central-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json) Snabbstart.

![Inställningssidan för program](media/howto-administer-experimental/appCopy2.png)
...
![Inställningssidan för program](media/howto-administer-experimental/appCopy3.png)
...
1. Om du vill lägga till en användare i ett IoT Central-program går du till den **användare** sidan i den **Administration** avsnittet.
    ...
    ![Lista över användare](media/howto-administer-experimental/image1.png)
...
1. Välj en roll för användaren från den **rollen** nedrullningsbara menyn. Mer information om roller i den [hantera roller](#manage-roles) i den här artikeln.
    ...
    ![Systemroll](media/howto-administer-experimental/image3.png)
...
1. Gå till den **fakturering** sidan i den **Administration** avsnittet.
    ...
    ![Utvärderingsversion tillstånd](media/howto-administer-experimental/freetrialbilling.png)

1. Klicka på **konvertera till betala per användning**.

    ![Konvertera utvärderingsversionen](media/howto-administer-experimental/convert.png)
...
> [Konfigurera enheten-mall](howto-set-up-template-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)
