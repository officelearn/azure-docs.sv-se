...
> [!NOTE]
> För **uppdatera en enhet** och **ta bort en enhet**, du behöver ett ID för den befintliga enheten som du vill uppdatera eller ta bort. ID för IoT Central-enhet får du i webbläsarens URL-Adressen. Det här är **inte** densamma som enhets-ID som finns på sidan explorer.
