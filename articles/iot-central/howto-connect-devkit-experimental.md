...
1. Ett Azure IoT Central program som skapats från den **exempel Devkits** mall för program. Mer information finns i [snabbstarten om att skapa ett program](quick-deploy-iot-central-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json).
...
1. Lägg till en **riktig enhet** från Device Explorer klickar du på **+ Ny > verkliga** att lägga till en riktig enhet.
    ...
    * Ange namnet på enheten eller använda det föreslagna namnet
    ...
    ![Lägg till enhet](media/howto-connect-devkit-experimental/add-device.png)
...
1. Hämta anslutningsinformationen som **Scope-ID, enhets-ID och primära nyckel** för tillagd enhet genom att klicka på **Connect** på enhetssidan.
    ...
    ![Anslutningsinformation](media/howto-connect-devkit-experimental/device-connect.png)
...
1. Öppna webbläsaren och navigera till [ http://192.168.0.1/start ](http://192.168.0.1/start). I följande sida visas:
    ...
    ![Konfigurationssidan för enhet](media/howto-connect-devkit-experimental/configpage.png)
...
1. När du har valt **– konfigurera enhet**, visas den här sidan:
    ...
    ![Enheter som har konfigurerats](media/howto-connect-devkit-experimental/deviceconfigured.png)
...
1. Använd **Device Explorer** att navigera till den **mätningar av** för verkliga MXChip enheten som du har lagt till:
    ...
    ![Gå till riktig enhet](media/howto-connect-devkit-experimental/realdevicenew.png)

1. På den **mätningar av** kan du se telemetri som kommer från MXChip-enhet:

    ![Visa telemetri från riktig enhet](media/howto-connect-devkit-experimental/devicetelemetrynew.png)

1. På den **egenskaper** kan du visa den senaste nummer och enhetens plats som rapporteras av enheten:

    ![Visa egenskaper för enhet](media/howto-connect-devkit-experimental/devicepropertynew.png)

1. På den **inställningar** kan du uppdatera inställningarna på enheten MXChip:

    ![Visa Enhetsinställningar](media/howto-connect-devkit-experimental/devicesettingsnew.png)

1. På den **instrumentpanelen** kan du se platsen mappa

    ![Visa instrumentpanelen](media/howto-connect-devkit-experimental/devicedashboardnew.png)
...
![Visual Studio-koden](media/howto-connect-devkit-experimental/vscodeview.png)
