...
* Som enhets utvecklare kan du använda Visual Studio Code för att skapa en [IoT plug and Play](https://aka.ms/iot-pnp-docs) -enhet som ansluter till ditt IoT Central-program.
