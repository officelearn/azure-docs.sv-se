...
2. På den vänstra menyn väljer du **data export**.
    ...
    ![Skapa ny CDE-Händelsehubben](media/howto-export-data-pnp/export-menu1.png)
...
3. Välj knappen **+ ny** längst upp till höger. Välj **Azure Blob Storage** som mål för exporten. 
    ...
    ![Skapa ny kontinuerlig data export](media/howto-export-data-pnp/export-new1.png)
...
4. I list rutan väljer du ditt **lagrings konto namn område**. Du kan också välja det sista alternativet i listan som **anger en anslutnings sträng**. 
    ...
    ![Skapa ny CDE-Händelsehubben](media/howto-export-data-pnp/export-create-blob.png)
...
6. Om du vill aktivera kontinuerlig data export kontrollerar du att **data exporten** är **på**. Välj **Spara**.
   ...
   ![Konfigurera kontinuerlig data export](media/howto-export-data-pnp/export-list-blob.png)
...
> [Visualisera dina data i Power BI](howto-connect-powerbi-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
