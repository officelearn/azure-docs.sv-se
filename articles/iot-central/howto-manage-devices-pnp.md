...
1. Välj **enheter** i den vänstra navigerings menyn. Här visas en lista över alla enheter och dina enhets mallar.
...
1. Välj **enheter** i den vänstra navigerings menyn.
...
1. Välj **migrera**:
    ...
    ![Koppla enheter](./media/howto-manage-devices-pnp/unassociateddevices2a.png)
...
1. Välj **enheter** på navigerings menyn.
