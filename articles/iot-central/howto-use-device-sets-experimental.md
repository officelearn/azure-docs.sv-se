...
1. Välj **+ ny**.
    ...
    ![Ny enhetsuppsättning](media/howto-use-device-sets-experimental/image1.png)
...
1. Skapa fråga för att identifiera enheterna som för enheten genom att välja en egenskap, jämförelseoperator och ett värde. Du kan lägga till flera frågor och enheter som uppfyller **alla** kriterierna är placerade i enhetsuppsättningen. Enhetsuppsättning som du skapar är tillgängliga för alla som har åtkomst till programmet, så att någon kan visa, ändra eller ta bort enhetsuppsättning av.
    ...
    ![Enheten inställd fråga](media/howto-use-device-sets-experimental/image2.png)
...
1. Välj **Redigera**.
    ...
    ![Designläge på](media/howto-use-device-sets-experimental/image3.png)

1. Läs om hur du lägger till en bild [Förbered och ladda upp bilder till Azure IoT Central programmet](howto-prepare-images-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json).
...
1. Lägg till en panel på länken:
    ...
    1. Välj **Spara**.
        ...
        ![Spara länk](media/howto-use-device-sets-experimental/image7.png)
...
1. Lägg till ett rutnät. Ett rutnät är en tabell med enheter i enheten med de kolumner som du väljer.
    ...
    1. Välj **Spara**.
        ...
        ![Spara rutnät](media/howto-use-device-sets-experimental/image9.png)
...
För att lägga till en platskarta till enheten som anger instrumentpanelen som du måste ha konfigurerade Platsegenskapen i mallen för enhet, se [skapa en plats-egenskap som drivs av Azure Maps](howto-set-up-template-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json).
...
1. Välj **kolumnalternativ**.
    ...
    ![Kolumnalternativ för](media/howto-use-device-sets-experimental/image11.png)
...
1. Välj kolumnerna som ska visas genom att markera den kolumn som du vill visa och välja pilen till höger för att välja den.
    ...
    ![Välj kolumn](media/howto-use-device-sets-experimental/image12.png)

1. Välj **OK**.

## <a name="analytics"></a>Analytics

Analys i enhetsuppsättningar är samma som den huvudsakliga analytics-fliken i den vänstra navigeringsmenyn. Du kan lära dig mer om analytics i artikeln på [så här skapar du analytics](howto-use-device-sets-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json).
...
> [Hur du skapar regler för telemetri](howto-create-telemetry-rules-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)
