...
1. Välj **enhets uppsättningar** på den vänstra navigerings menyn.
...
Analys i enhets uppsättningar är samma som fliken Main Analytics i den vänstra navigerings menyn. Du kan lära dig mer om analys i artikeln om [hur du skapar analyser](howto-use-device-sets.md).
