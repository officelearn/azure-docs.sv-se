---
title: Anslut en Azure IoT Plug and Play-förhands gransknings enhet till IoT Central | Microsoft Docs
...
1. Logga in på IoT Central programmet som du skapade i föregående snabb start.
...
Så här lägger du till anslutnings informationen till den genererade enhets koden:

1. I VS Code-fönstret som innehåller den genererade C-koden. Öppna filen `main.c`.

1. Ersätt `[DPS Id Scope]` med det **omfångs-ID** som du antecknade tidigare.

1. Ersätt `[DPS symmetric key]` med enhets nyckeln som du skapade i föregående steg.

1. Ersätt `[device registration Id]` med `mxchip-01`.
...
1. När versionen har slutförts kör du ditt program i samma kommando tolk:
...
1. I ditt IoT Central-program går du till sidan **enheter** och väljer **mxchip-01-** enheten. Enheten lades automatiskt till när enhets koden anslöt:
    ...
    ![Översikts sida](./media/quick-create-pnp-device-pnp/overview-page.png)
...
1. Gå till sidan **enhetsspecifika mallar** om du vill se mallen som IoT Central skapade från DCM i den offentliga lagrings platsen:
    ...
    ![Sidan enhets mallar](./media/quick-create-pnp-device-pnp/device-template.png)

## <a name="next-steps"></a>Nästa steg

I den här snabb starten har du lärt dig hur du ansluter en IoT Plug and Play-enhet som genererades från ett DCM i den offentliga modellens lagrings plats.

Om du vill veta mer om DCMs och hur du skapar egna modeller kan du fortsätta till instruktions guiden:

> [!div class="nextstepaction"]
> [Konfigurera och hantera en enhets mall](./howto-set-up-template-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
