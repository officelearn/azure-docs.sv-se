...
![Sidan Skapa program i Azure IoT Central](media/quick-deploy-iot-central-experimental/iotcentralcreate.png)
...
> [Ta en rundtur om IoT Central](https://docs.microsoft.com/azure/iot-central/overview-iot-central-tour)
