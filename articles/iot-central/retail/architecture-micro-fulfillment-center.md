...
IoT-data kan användas för att driva olika typer av affärsprogram som distribueras i en butiksmiljö. En uppfyllelse center manager eller anställd kan använda dessa program för att visualisera affärsinsikter och vidta meningsfulla åtgärder i realtid. Om du vill veta hur du skapar en Power BI-instrumentpanel i realtid för ditt detaljhandelsteam följer du [självstudien](./tutorial-in-store-analytics-create-app.md).
