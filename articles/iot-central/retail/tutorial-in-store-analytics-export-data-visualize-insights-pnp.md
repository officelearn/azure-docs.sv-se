---
title: Exportera data och visualisera insikter i Azure IoT Central | Microsoft Docs
...
![Konfiguration av kontinuerlig data export](./media/tutorial-in-store-analytics-visualize-insights-pnp/export-configuration.png)
...
![Zon data uppsättningar](./media/tutorial-in-store-analytics-visualize-insights-pnp/dataset-1.png)
...
![Användnings data uppsättning](./media/tutorial-in-store-analytics-visualize-insights-pnp/dataset-2.png)
...
1. Anteckna **enhets-ID: n**. I följande skärm bild är ID: na **f5dcf4ac32e8** och **e29ffc8d5326**:
    ...
    ![Enhets-ID](./media/tutorial-in-store-analytics-visualize-insights-pnp/device-ids.png)
...
![Kort inställningar](./media/tutorial-in-store-analytics-visualize-insights-pnp/card-settings.png)
...
| Axelvärdena    | Tidsstämpel | Tidsstämpel | Saknas | Saknas |
...
> * [Bygg energi lösningar med IoT Central](../energy/overview-iot-central-energy.md)
> * [Bygg myndighets lösningar med IoT Central](../government/overview-iot-central-government.md)
> * [Bygg sjukvårds lösningar med IoT Central](../healthcare/overview-iot-central-healthcare.md)
