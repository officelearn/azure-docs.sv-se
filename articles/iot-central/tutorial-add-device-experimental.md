...
* [Definiera en ny enhetstyp](tutorial-define-device-type-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json) (obligatoriskt)
* [Konfigurera regler och åtgärder för din enhet](tutorial-configure-rules-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json) (valfritt)
* [Anpassa operatörsvyer](tutorial-customize-operator-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json) (valfritt)

## <a name="add-a-real-device"></a>Lägga till en riktig enhet

För att lägga till en riktig enhet i ditt program använder du enhetsmallen **Ansluten luftkonditioneringsenhet** som du skapade i självstudien [Definiera en ny enhetstyp](tutorial-define-device-type-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json).

1. Om du vill lägga till en ny enhet som operatör väljer du **Device Explorer** i den vänstra navigeringsmenyn:

   ![Sidan Device Explorer visar ansluten luftkonditioneringsenhet](media/tutorial-add-device-experimental/explorer.png)
...
2. För att börja ansluta en riktig, ansluten luftkonditioneringsenhet väljer du **Ny** och sedan **Riktig**:
   ...
   ![Börja lägga till en ny, riktig, ansluten luftkonditioneringsenhet](media/tutorial-add-device-experimental/newreal.png)
...
3. Ange enhets-Id (**ska vara gemener**) eller använd det föreslagna enhets-Id:t. Du kan även ange namnet på den nya enheten och välja **Skapa**.  
   ...
   ![Byt namn på enheten](media/tutorial-add-device-experimental/rename.png)
...
1. På sidan **Inställningar** är statusen för inställningen **Ange temperatur** **ingen uppdatering**. Den behåller det här tillståndet tills den riktiga enheten ansluter till programmet och bekräftar att den har agerat på inställningen. 
    ...
    ![Inställningar visar synkronisering](media/tutorial-add-device-experimental/settingssyncing.png)
...
2. På sidan **Egenskaper** för din nya, nätverksanslutna riktiga luftkonditioneringsenhet är både platsen för tjänsten och det senaste servicedatumet redigerbara egenskaper för enheten. Fälten serienummer och version av inbyggd programvara är tomma tills enheten ansluts till programmet. Dessa är skrivskyddade värden som skickas från enheten och kan inte redigeras.
    ...
    ![Enhetsegenskaper för den riktiga enheten](media/tutorial-add-device-experimental/setproperties1.png)
...
1. Anslutningssträngen för en enhetsinstans i ditt program genereras från enhetsinformation som tillhandahålls av IoT Central.
   ...
   ![Enhetssidan visar informationslänk för att visa anslutning](media/tutorial-add-device-experimental/connectionlink.png)
...
1. På sidan Enhetsanslutning kopierar och klistrar du in omfångs-ID, enhets-ID och primärnyckeln i en textredigerare och sparar. Du använder dessa värden i nästa steg.
   ...
   ![Anslutningsinformation](media/tutorial-add-device-experimental/device-connect.png)
...
1. Programmet skriver utdata till konsolen:
   ...
   ![Utdata för klientprogram](media/tutorial-add-device-experimental/output.png)

1. Efter ca 30 sekunder visas telemetrin på sidan **Mått** för enheten:

   ![Riktig telemetri](media/tutorial-add-device-experimental/realtelemetry.png)
...
1. På sidan **Inställningar** ser du att inställningen nu är synkroniserad. När enheten först anslöt fick den inställningsvärdet och bekräftade ändringen:
   ...
   ![Inställningen har synkroniserats](media/tutorial-add-device-experimental/settingsynced.png)
...
1. På sidan **Inställningar** anger du enhetens temperatur till **95** och väljer **Uppdatera enhet**. Exempelprogrammet tar emot och bearbetar den här ändringen:
   ...
   ![Ta emot och bearbeta inställning](media/tutorial-add-device-experimental/receivesetting.png)
...
1. På sidan **Mått** ser du att enheten skickar högre temperaturvärden:
    ...
    ![Temperaturtelemetri är nu högre](media/tutorial-add-device-experimental/highertemperature.png)
...
* [Skapa anpassade analyser](howto-use-device-sets-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)

Som enhetsutvecklare lär du dig att:

* [Förbereda och ansluta ett DevKit](howto-connect-devkit-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)
