...
När enheten skickar ett [Registrera enhets anrop](https://docs.microsoft.com/rest/api/iot-dps/runtimeregistration/registerdevice) till DPS. Du kan förbättra registreringen genom att ta andra fält i bröd texten. Texten ser ut ungefär så här: 
   ```
   { 
