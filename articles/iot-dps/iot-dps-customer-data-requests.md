...
Fullständig dokumentation för API: er för enhets etablerings tjänsten finns på [https://docs.microsoft.com/rest/api/iot-dps](https://docs.microsoft.com/rest/api/iot-dps).
