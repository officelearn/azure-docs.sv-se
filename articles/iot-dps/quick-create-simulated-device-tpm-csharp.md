...
description: Snabb start – skapa och etablera en simulerad TPM- C# enhet med hjälp av enhets-SDK för Azure IoT Hub Device Provisioning service. Den här snabbstarten använder enskilda registreringar.
author: wesmc7777
ms.author: wesmc
ms.date: 11/08/2018
ms.topic: quickstart
