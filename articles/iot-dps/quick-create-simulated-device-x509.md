...
---
# <a name="create-and-provision-an-x509-simulated-device-using-iot-hub-device-provisioning-service-preview"></a>Skapa och etablera en simulerad X.509-enhet med IoT Hub Device Provisioning-tjänsten (förhandsgranskning)
