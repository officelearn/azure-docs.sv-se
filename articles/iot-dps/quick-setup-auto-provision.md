...
3. Väl den aktuella prenumerationen eller ange namnet på och anslutningssträngen för en annan prenumeration på bladet **Add link to IoT hub or pool** (Lägg till länk till IoT-hubb eller pool). Välj *IoT-hubb* som **Resurstyp** och välj namnet på hubben i listrutan. Klicka på **Spara** när du är klar. 
