...
| Java | <ul><li>[Java SE Development Kit 10](https://aka.ms/azure-jdks) <li> [Ange JAVA_HOME miljö variabel](https://docs.oracle.com/cd/E19182-01/820-7851/inst_cli_jdk_javahome_t/) <li> [Maven 3.](https://maven.apache.org/)</ul> |
...
| Verktyg | Kallas även | Plattformar som stöds | Passar bäst för |
| ---- | ------------- | ------------------- | --------- |
