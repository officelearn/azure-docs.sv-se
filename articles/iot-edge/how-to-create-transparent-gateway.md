...
5. In the **Specify routes** page, you should have a default route that sends all messages from all modules to IoT Hub. Om du inte har det lägger du till följande kod och väljer sedan **Nästa**.
