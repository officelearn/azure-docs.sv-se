...
Om du är redo att sätta igång, hitta installationen och använda informationen för den [Azure IoT Edge-plugin för Jenkinx](https://plugins.jenkins.io/azure-iot-edge).