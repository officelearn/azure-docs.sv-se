...
description: Azure DevOps-projekt gör det enkelt att komma igång med Azure. Det hjälper dig att starta en Azure IoT Edge app som du väljer i några enkla steg.
author: shizn
manager: ''
ms.author: xshi
ms.date: 10/09/2019
