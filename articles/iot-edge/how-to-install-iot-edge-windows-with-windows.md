---
title: Installera Azure IoT Edge på Windows med Windows-behållare | Microsoft Docs
description: Installationsinstruktioner för Azure IoT Edge på Windows-enheter som konfigurerats för Windows-behållare
author: kgremban
manager: philmea
ms.reviewer: veyalla
ms.service: iot-edge
