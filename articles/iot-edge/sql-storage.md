...
>[!TIP]
>Varje gång som du skapar en SQL Server-behållare i en produktionsmiljö bör du [ändra standardlösenord](https://docs.microsoft.com/sql/linux/quickstart-install-connect-docker.md#change-the-sa-password).
