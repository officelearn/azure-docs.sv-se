...
Azure IoT Edge körs på de flesta operativ system som kan köra behållare. alla dessa system stöds dock inte. Operativsystem är grupperade i nivåer som representerar supportnivå de kan förvänta sig.
