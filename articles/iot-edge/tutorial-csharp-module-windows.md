...
Du kan använda Azure IoT Edge-moduler för att distribuera kod som implementerar din affärslogik direkt på dina IoT Edge-enheter. Den här självstudien vägleder dig genom att skapa och distribuera en IoT Edge-modul som filtrerar sensordata. I den här självstudiekursen får du lära du dig att:
...
Den här självstudien visar hur du utvecklar **C#** en modul i använda **Visual Studio 2019** och distribuerar den till en **Windows-enhet**. Om du utvecklar moduler för Linux-enheter går du till [utveckla en C# IoT Edge modul för Linux-enheter](tutorial-csharp-module.md) i stället.
...
2. Sök efter **IoT Edge** och välj **Azure IoT Edge-projektet (Windows amd64)** . Klicka på **Next**.
