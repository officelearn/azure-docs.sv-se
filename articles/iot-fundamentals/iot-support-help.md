---
title: Azure IoT-support och hjälp alternativ | Microsoft Docs
description: Få hjälp och support för frågor eller problem när du skapar lösningar med hjälp av Azure IoT-tjänster.
author: philmea
ms.author: phil
...
---
# <a name="azure-iot-support-and-help-options"></a>Azure IoT-support och hjälp alternativ

Här är några förslag på var du kan få hjälp när du utvecklar dina Azure IoT-lösningar.
...
För omedelbara svar från communityn, se Stack Overflow. Stack Overflow är den föredragna kanalen för **utvecklings frågor**. Det är där medlemmar i communityn och Microsoft team-medlemmar är direkt inblandade i att hjälpa dig att lösa dina problem.
...
Om du inte kan hitta ett svar på ditt problem via sökning skickar du en ny fråga till Stack Overflow. Använd någon av följande Taggar när du formulerar frågan:
 ...
 - [Azure IoT SDK:er](https://stackoverflow.com/questions/tagged/azure-iot-sdk)
 - [Azure Time Series Insights](https://stackoverflow.com/questions/tagged/azure-timeseries-insights)

## <a name="start-a-conversation-on-the-msdn-forums"></a>Starta en konversation i MSDN-forumen

För att diskutera Azure-teknik och-tjänster för att skapa IoT-lösningar. MSDN är den föredragna kanalen för **lösnings-relaterade frågor**. Det är där medlemmar i communityn och Microsoft team-medlemmar är direkt inblandade i att hjälpa dig att välja rätt lösning för ditt projekt.
...
Om du vill begära nya funktioner kan du publicera dem på Azure feedback. Dela med dig av dina idéer för att göra Azure IoT-tjänster bättre för de program du utvecklar:

| Tjänst                       | Feedback-URL för Azure |
|-------------------------------|---------------|
| Azure IoT Hub                    | https://feedback.azure.com/forums/321918-azure-iot |
| Utforska IoT Central             | https://feedback.azure.com/forums/911455-azure-iot-central |
...
| Azure IoT-lösningsacceleratorer | https://feedback.azure.com/forums/916438-azure-iot-solution-accelerators |
...
Lär dig mer om viktiga produkt uppdateringar, översikt och meddelanden i [Azure-uppdateringar](https://azure.microsoft.com/updates/?category=iot).

Nyheter och information om Azure IoT delas på Azure- [bloggen](https://azure.microsoft.com/blog/topics/internet-of-things/) och på [Sakernas Internet Visa på Channel 9](https://channel9.msdn.com/Shows/Internet-of-Things-Show).

Du kan också dela dina upplevelser, engagera och lära sig från experter i [Sakernas Internet Tech-communityn](https://techcommunity.microsoft.com/t5/Internet-of-Things-IoT/ct-p/IoT).

## <a name="next-steps"></a>Nästa steg

> [!div class="nextstepaction"]
> [Vad är Azure IoT?](iot-introduction.md)
