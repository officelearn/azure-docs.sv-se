...
description: Använda rörelse sensor att identifiera skaka och använda Azure Functions för att hitta en slumpmässig tweet med en hashtaggar som du anger
author: liydu
manager: jeffya
ms.service: iot-hub
services: iot-hub
