...
* En Azure IoT-hubb. Om du inte har en IoT-hubb kan du använda [kommandot`az iot hub create`](https://docs.microsoft.com/cli/azure/iot/hub#az-iot-hub-create) för att skapa en eller [skapa en IoT-hubb med portalen](iot-hub-create-through-portal.md).
...
1. I kommando tolken kör du [inloggnings kommandot](https://docs.microsoft.com/cli/azure/get-started-with-azure-cli?view=azure-cli-latest):
...
2. Om du har flera Azure-prenumerationer får du åtkomst till alla Azure-konton som är associerade med dina autentiseringsuppgifter när du loggar in på Azure. Använd följande [kommando för att visa en lista över de Azure-konton](https://docs.microsoft.com/cli/azure/account) som du kan använda:
