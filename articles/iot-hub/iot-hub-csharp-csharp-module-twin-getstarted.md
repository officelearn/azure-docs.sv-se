...
ms.locfileid: "68404563"
---
# <a name="get-started-with-iot-hub-module-identity-and-module-twin-using-net-back-end-and-net-device"></a>Kom igång med IoT Hub modulens identitet och modul dubbla med .NET-Server delen och .NET-enheten
