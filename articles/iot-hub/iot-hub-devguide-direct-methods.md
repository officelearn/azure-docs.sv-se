...
* *URI-begäran* som är unik för enheten tillsammans med [API-versionen](https://docs.aws.amazon.com/cli/latest/reference/iot1click-devices/invoke-device-method.html):
