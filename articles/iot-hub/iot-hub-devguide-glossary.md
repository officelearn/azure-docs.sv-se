...
## <a name="device-app"></a>Enhets app
...
[Device Explorer](https://github.com/Azure/azure-iot-sdk-csharp/tree/master/tools/DeviceExplorer) är ett verktyg som körs på Windows och gör att du kan hantera dina enheter i [identitets registret](#identity-registry). Verktyget kan också skicka och ta emot meddelanden till dina enheter.
