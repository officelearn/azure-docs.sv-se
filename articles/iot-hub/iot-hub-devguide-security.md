...
HTTP implementerar autentisering genom att inkludera en giltig token i den **auktorisering** huvudet i begäran.
...
* Direkt användning av de MQTT, AMQP och HTTP.
...
Nu du har lärt dig hur du styr åtkomst IoT-hubb, kan du är intresserad av i följande avsnitt för IoT-hubb developer-guide:
