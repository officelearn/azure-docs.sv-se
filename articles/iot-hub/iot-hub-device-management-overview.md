...
* **Planera**: Operatörer kan skapa ett schema med enhetens metadata schemat som innebär att de enkelt och korrekt fråga efter och rikta en enhetsgrupp för massåtgärder. Du kan använda enhetstvillingen för att lagra dessa enhetsmetadata i form av taggar och egenskaper.
...
* **Konfigurera**: Underlätta massinläsning av konfigurationsändringar och uppdateringar av inbyggd programvara till enheter samtidigt som både hälsotillstånd och säkerhet. Utför dessa åtgärder för enhetshantering gruppvis genom att använda önskade egenskaper eller med direkta metoder och sändningsjobb.
...
* **Övervaka**: Övervaka enhetssamlingens, status för pågående åtgärder och operatörerna problem som kräver deras uppmärksamhet.  Använd enhetstvillingen för att tillåta att enheterna rapporterar driftsförhållanden och status för uppdateringsåtgärder i realtid. Skapa kraftfulla instrumentpanelsrapporter som lyfter fram de mest omedelbara problemen genom att använda enhetstvillingsfrågor.
...
* **Rapportering av förlopp och status**: Lösningen tillbaka enhetstvillingfrågor för end körs, över en uppsättning enheter för att rapportera status och förlopp på enheterna.
