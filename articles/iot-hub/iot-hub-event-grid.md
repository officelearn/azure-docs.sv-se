...
* [Lär dig hur du använder IoT-telemetri för att implementera IoT spatial Analytics med hjälp av Azure Maps](../azure-maps/tutorial-iot-hub-maps.md)