...
>
> - Inte hämta återställs meddelanden från moln till enhet och överordnade jobb som en del av manuell växling vid fel i i preview-versionen av den här funktionen.
...
Om dina affärsmål drifttid inte är uppfyllt av RTO Microsoft initierade redundans eller manuell växling vid fel alternativ ger, bör du överväga att implementera en mekanism för varje enhet automatiskt mellan regioner redundans.
...
* [Kom igång med IoT-hubbar (självstudier)](quickstart-send-telemetry-dotnet.md)
