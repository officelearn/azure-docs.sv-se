...
* Ladda ned käll koden för C SDK och bygg för iOS-plattformen enligt [build](https://github.com/Azure/azure-iot-sdk-c/blob/master/doc/devbox_setup.md) -instruktionen för MacOS.  
