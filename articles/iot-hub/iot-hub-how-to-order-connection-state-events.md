...
3. Välj **fäst på instrumentpanelen**, välj sedan **skapa**.
   ...
   > [!NOTE] 
   > När du väljer **fäst på instrumentpanelen**, din logikapp öppnas automatiskt i Logic Apps Designer. Om inte kan du leta upp och öppna logikappen manuellt.
...
2. På den **översikt** bladet väljer **ta bort**. 
