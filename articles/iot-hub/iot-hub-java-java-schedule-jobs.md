...
Du kan också använda den [IoT-tillägg för Azure CLI 2.0](https://github.com/Azure/azure-iot-cli-extension) verktyg för att lägga till en enhet till IoT-hubben.
