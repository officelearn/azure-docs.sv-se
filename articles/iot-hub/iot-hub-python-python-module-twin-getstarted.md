...
## <a name="update-the-module-twin-using-python-device-sdk"></a>Uppdatera modultvillingen med Python-enheten SDK

I det här avsnittet skapar du en Python-app på din simulerade enhet som uppdaterar modultvillingens rapporterade egenskaper.

1. **Hämta din modulanslutningssträng** – nu om du loggar in på [Azure-portalen](https://portal.azure.com/). Gå till din IoT Hub och klicka på IoT-enheter. Hitta myFirstDevice, öppna den och du ser myFirstModule skapades framgångsrikt. Kopiera modulens anslutningssträng. Den behövs i nästa steg.
...
2. **Skapa appen UpdateModuleTwinReportedProperties**
   ...
   Lägg till `using` följande satser högst upp i **Program.cs-filen:**
