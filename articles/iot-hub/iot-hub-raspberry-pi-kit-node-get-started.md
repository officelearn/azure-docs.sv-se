...
Aktivera PI med mikrousb-kabeln och strömförsörjningen. Använd Ethernet-kabeln för att ansluta Pi till det kabelanslutna nätverket eller följ [anvisningarna från Raspberry Pi-stiftelsen](https://www.raspberrypi.org/learning/software-guide/wifi/) för att ansluta Pi till det trådlösa nätverket. När din PI har lyckats ansluta till nätverket måste du anteckna [IP-adressen för din PI](https://learn.adafruit.com/adafruits-raspberry-pi-lesson-3-network-setup/finding-your-pis-ip-address).
...
2. Installera Node. js och NPM till din PI.
   ...
   Om versionen är lägre än 11. x, eller om det inte finns någon Node. js-version på din PI, installerar du den senaste versionen.
