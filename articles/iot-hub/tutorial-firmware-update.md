...
> [!TIP]
> Om du kör dessa kommandon i en Windows-kommandotolk eller Powershell-prompt, se sidan om [tips för azure-iot-cli-utökning](https://github.com/Azure/azure-iot-cli-extension/wiki/Tips
) för information om hur du citerar JSON-strängar.
