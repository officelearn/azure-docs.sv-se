...
description: Använda C# (.net), skapa och kör IoT plug and Play Device Code som ansluter till en IoT-hubb. Använd Azure IoT Explorer-verktyget för att visa informationen som skickas av enheten till hubben.
author: baanders
ms.author: baanders
ms.date: 12/27/2019
ms.topic: quickstart
...
Den här snabb starten visar hur du skapar ett exempel på IoT Plug and Play Device-program, ansluter det till din IoT-hubb och använder Azure IoT Explorer-verktyget för att visa den information som skickas till hubben. Exempel programmet är skrivet i C# (med .net) och tillhandahålls som en del av Azure IoT-exemplen för C# (.net)-samlingen. En lösnings utvecklare kan använda Azure IoT Explorer-verktyget för att förstå funktionerna i en IoT Plug and Play-enhet utan att behöva visa någon enhets kod.
...
I den här snabb starten förbereder du en utvecklings miljö som du kan använda för att klona och skapa Azure C# IoT-exempel för (.net).

Öppna en kommando tolk i valfri katalog. Kör följande kommando för att klona [Azure IoT-exempel C# för (.net) GitHub-](https://github.com/Azure-Samples/azure-iot-samples-csharp) lagringsplatsen till den här platsen:
