...
I den här snabb starten använder du ett exempel på en miljö sensor som är skriven i C# som IoT Plug and Play-enhet. Följande instruktioner visar hur du installerar och kör enheten:

1. Öppna ett terminalfönster i valfri katalog. Kör följande kommando för att klona [Azure IoT-exemplen för C# (.net)](https://github.com/Azure-Samples/azure-iot-samples-csharp) GitHub-lagringsplatsen till den här platsen:
...
I den här snabb starten använder du en exempel-IoT-lösning i C# för att interagera med exempel enheten.
