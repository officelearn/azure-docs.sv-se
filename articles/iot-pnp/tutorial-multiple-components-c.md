...
Om du har slutfört [snabb starten: Anslut ett exempel på IoT plug and Play Device-program som körs på Linux eller Windows till IoT Hub (C)](quickstart-connect-device-c.md) du redan har laddat ned koden.
