...
---
# <a name="how-to-configure-the-connected-factory-preconfigured-solution"></a>Så här konfigurerar du anslutna fabriken förkonfigurerade lösningen
...
Servrarna OPC UA har OPC UA noder och [OPC Publisher](https://github.com/Azure/iot-edge-opc-publisher) skickar värdena för dessa noder till anslutna fabriken. Detta omfattar:
