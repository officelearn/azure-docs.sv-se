---
title: Vanliga frågor och svar om Azure IoT Suite | Microsoft Docs
...
1. Hämta Bing Maps-API:et för Enterprise QueryKey från [Azure-portalen][lnk-azure-portal]: 
   ...
   3. Som du ser finns det två nycklar: MasterKey och QueryKey. Kopiera värdet för QueryKey.
      ...
      > [!NOTE]
      > Har du inget Bing Maps-API för Enterprise-konto? Skapa ett på [Azure-portalen][lnk-azure-portal] genom att klicka på + Nytt, leta upp Bing Maps-API för företag och följ sedan anvisningarna för att skapa kontot.
      > 
      > 
