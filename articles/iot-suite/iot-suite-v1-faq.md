...
* Om du tar bort resursgrupp i den [Azure-portalen][lnk-azure-portal], bara ta bort resurserna i resursgruppen. Du måste också ta bort Azure Active Directory-programmet som är associerade med förkonfigurerade lösningen i den [klassiska Azure-portalen][lnk-classic-portal].
