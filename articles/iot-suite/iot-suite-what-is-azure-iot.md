<properties
 ...
 description="En översikt över IoT i Azure, inklusive en exempellösningsarkitektur och hur den relaterar till Azure IoT Suite och förkonfigurerade lösningar"
 services=""
 suite="iot-suite"
 documentationCenter=""
...
Du kanske också är intresserad av tjänsten [Azure IoT Hub][] som används i många av de förkonfigurerade lösningarna. [Azure IoT Hub][] tillhandahåller den säkra och tillförlitliga dubbelriktade kommunikationen mellan enheter och molnet som används i arkitekturen för de förkonfigurerade lösningarna.
