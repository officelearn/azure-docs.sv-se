...
- [Krypterings modell och nyckel hanterings tabell](https://docs.microsoft.com/azure/security/fundamentals/encryption-atrest#encryption-model-and-key-management-table)
...
Vad är Azure rollbaserad åtkomst kontroll (Azure RBAC)?
