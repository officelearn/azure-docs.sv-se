...
- Hantera Key Vault-certifikat. Mer information finns i [Om nycklar, hemligheter och certifikat](about-keys-secrets-and-certificates.md).

Mer allmän information om Azure Key Vault finns i [Vad är Nyckelvalv](key-vault-overview.md).
...
- [Skapa och hantera nyckelvalv med CLI](quick-create-cli.md)
- [Skapa och hantera nyckelvalv med PowerShell](quick-create-powershell.md)
- [Skapa och hantera nyckelvalv med Azure-porten](quick-create-portal.md)
- [Skapa och hantera nyckelvalv med Python](quick-create-python.md)
- [Skapa och hantera nyckelvalv med Java](quick-create-java.md)
- [Skapa och hantera nyckelvalv med Node.js](quick-create-node.md)
- [Skapa och hantera nyckelvalv med .NET (v4 SDK)](quick-create-net.md)
- [Skapa ett nyckelvalv och lägg till en hemlighet via en Azure Resource Manager-mall](quick-create-template.md)
...
Mer information om 2.x-versionen av .NET SDK finns i [viktig information](key-vault-dotnet2api-release-notes.md).
...
- [Använd Azure Key Vault från ett webbprogram](quick-create-net.md) – självstudiekurs för att lära dig hur du använder Azure Key Vault från ett webbprogram i Azure. 
...
- [Ändra klient-ID för nyckelvalv efter prenumerationsflyttning](key-vault-subscription-move-fix.md) – När du flyttar din Azure-prenumeration från klient A till klient ab.a till klientnyckeln är dina befintliga nyckelvalv otillgängliga för huvudmännen (användare och program) i klient B. Åtgärda detta med den här guiden.
- [Åtkomst till Key Vault bakom brandvägg](key-vault-access-behind-firewall.md) - För att komma åt ett nyckelvalv måste ditt nyckelvalvklientprogram kunna komma åt flera slutpunkter för olika funktioner.
- [Så här genererar och överför HSM-skyddade nycklar för Azure Key Vault](key-vault-hsm-protected-keys.md) – Det här hjälper dig att planera, generera och sedan överföra dina egna HSM-skyddade nycklar som ska användas med Azure Key Vault.
...
- [Konfigurera Key Vault med end to end-tangentrotation och granskning](key-vault-key-rotation-log-monitoring.md) – Det här går igenom hur du konfigurerar nyckelrotation och granskning med Azure Key Vault.
...
- [Så här använder du Soft-delete för Key Vault med CLI-guider](key-vault-soft-delete-cli.md) som du använder och livscykeln för ett nyckelvalv och olika nyckelvalvsobjekt med mjuk borttagning aktiverat.
- [Så här använder du soft-delete för Key Vault med PowerShell-guider](key-vault-soft-delete-powershell.md) som du använder och livscykeln för ett nyckelvalv och olika nyckelvalvsobjekt med mjuk borttagning aktiverat.
...
- [Funktionen Soft Delete för Key Vault](key-vault-ovw-soft-delete.md) beskriver en funktion som gör det möjligt att återställa borttagna objekt, oavsett om borttagningen var oavsiktlig eller avsiktlig.
- [Key Vault-klientbegränsningen](key-vault-ovw-throttling.md) orienterar dig till de grundläggande begreppen begränsning och erbjuder en metod för din app.
- [Översikt över key vault-lagringskonton](key-vault-ovw-storage-keys.md) beskriver nyckeln till Azure Storage-konton för Key Vault-integrering.
- [Key Vault-säkerhetsvärldar](key-vault-ovw-security-worlds.md) beskriver relationerna mellan regioner och säkerhetsområden.
