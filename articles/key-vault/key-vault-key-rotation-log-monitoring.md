...
Först måste du aktivera loggning i nyckelvalvet. Använd följande PowerShell-kommandon. (Du kan se fullständig information i den [här artikeln om nyckelvalv-loggning](key-vault-logging.md).)
