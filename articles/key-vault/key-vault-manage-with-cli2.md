...
En översikt över Azure Key Vault finns i [Vad är Azure Key Vault?](key-vault-overview.md)
...
Mer detaljerade instruktioner om hur du genererar det här BYOK-paketet finns i [Så här använder du HSM-skyddade nycklar med Azure Key Vault](key-vault-hsm-protected-keys.md).
...
- Information om programmeringsreferenser finns [i utvecklarhandboken för Azure Key Vault](key-vault-developers-guide.md)

- Information om Azure Key Vault och HSM finns i [Så här använder du HSM-skyddade nycklar med Azure Key Vault](key-vault-hsm-protected-keys.md).
