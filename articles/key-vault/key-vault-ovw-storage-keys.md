...
Hämta motsvarande SAS-token och göra anrop till lagring. `-SecretName` med information från den `AccountName` och `Name` parametrar när du körde [Set AzureKeyVaultManagedStorageSasDefinition](https://docs.microsoft.com/en-us/powershell/module/AzureRM.KeyVault/Set-AzureKeyVaultManagedStorageSasDefinition).
