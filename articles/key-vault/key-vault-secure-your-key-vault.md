...
* **användare + appåtkomst**: användas med program som får åtkomst till Nyckelvalvet åt en inloggad användare. Azure PowerShell och Azure portal är exempel på den här typen av åtkomst. Det finns två sätt att bevilja åtkomst till användare: 
...
* **endast appen**: användas med program som körs som daemon-tjänster eller bakgrundsjobb. Programmets identitet beviljas åtkomst till nyckelvalvet.
...
* **Bootstrap-certifikatet**: används för att autentisera med Azure AD. När åtkomst beviljas kan du hämta lagringsnyckeln och använda RSA-nyckel för signering.
