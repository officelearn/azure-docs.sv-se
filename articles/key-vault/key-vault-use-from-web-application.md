...
## <a id="portalsettings"></a>Lägga till appinställningar i Azure-portalen
...
### <a name="add-a-certificate-to-your-web-app-through-the-azure-portal"></a>Lägga till ett certifikat i en webbapp via Azure-portalen
