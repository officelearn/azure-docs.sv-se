...
description: Snabb start visar hur du skapar Azure Key Vault och lägger till nyckel till valven med hjälp av Azure Resource Manager mall.
services: key-vault
author: sebansal
