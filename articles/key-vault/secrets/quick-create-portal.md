...
Mer information om hemligheter finns i [om hemligheter](about-secrets.md).
...
Du kan också skapa Key Vault med Azure CLI och PowerShell:
- [Skapa Key Vault med PowerShell](../general/quick-create-powershell.md)
