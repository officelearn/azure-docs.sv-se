...
Det bästa sättet att autentisera till Azure-tjänster är att använda en [hanterad identitet](../general/managed-identity.md), men det finns vissa scenarier där det inte är ett alternativ. I sådana fall används åtkomstnycklar eller hemligheter. Du bör regelbundet rotera åtkomstnycklar eller hemligheter.
...
Information om hur du skapar en funktionsapp och använder hanterad identitet för att komma åt Key Vault finns i [Skapa en funktionsapp från Azure-portalen](../../azure-functions/functions-create-function-app-portal.md) och [Ange autentisering med nyckelvalv med en hanterad identitet](../general/managed-identity.md).
...
- Översikt: [Övervaka nyckelvalv med Azure Event Grid (förhandsversion)](../general/event-grid-overview.md)
- Så här får du [e-post när en nyckelvalvshemlighet ändras](../general/event-grid-logicapps.md)
