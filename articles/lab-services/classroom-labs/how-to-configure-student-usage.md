...
1. I fönstret **Skicka inbjudan per e-post** anger du ett valfritt meddelande och väljer sedan **Skicka**. 
    ...
    Kolumnen **inbjudan** i listan **användare** visar status för inbjudan för varje tillagd användare. Statusen bör ändras till att **skickas** och sedan **skickas till det \<datum>**. 
...
1. I fönstret **användare** väljer du **kvot per användare: \<antal> timmar** i verktygsfältet. 
1. I fönstret **kvot per användare** anger du antalet timmar som du vill ge varje student utanför den schemalagda klass tiden och väljer sedan **Spara**.
    ...
    De ändrade värdena visas nu på sidan **kvot per användare: \<antal timmar>** i verktygsfältet och i listan användare, som du ser här:
...
1. I den **Justera kvoten \<för den valda användaren eller användarnas e-postadress>** anger du det antal ytterligare labb timmar som du vill bevilja den valda eleven eller eleverna. Välj sedan **Använd**. 
