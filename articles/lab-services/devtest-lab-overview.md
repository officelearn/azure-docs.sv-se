...
Använd färdiga plugin-program eller API för att etablera utvecklings-och testnings miljöer direkt från ditt prioriterade [verktyg för kontinuerlig integrering (CI)](devtest-lab-integrate-ci-cd-vsts.md), Integrated Development Environment (IDE) eller automatisk versions pipeline. Du kan också använda det omfattande kommando rads verktyget.
