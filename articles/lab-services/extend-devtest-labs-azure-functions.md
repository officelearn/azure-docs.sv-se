...
---
# <a name="use-azure-functions-to-extend-devtest-labs"></a>Använd Azure Functions för att utöka DevTest Labs
...
- [Konfigurera ett labb för att använda en Fjärrskrivbordsgateway](configure-lab-remote-desktop-gateway.md)
...
**Exempel krav/scenario**: Användare kan se information om alla virtuella datorer i ett labb, inklusive operativ system, ägare och eventuella artefakter som använts.  Dessutom är det ett enkelt sätt att tillämpa en artefakt för att **tillämpa Windows-uppdateringar** som inte har tillämpats nyligen.
...
Käll koden för de här exempel funktionerna finns i [DevTest Labs GitHub](https://github.com/Azure/azure-devtestlab/tree/master/samples/DevTestLabs/AzureFunctions) -lagringsplatsen (både C# och PowerShell-implementeringarna är tillgängliga).
...
- **ApplyWindowsUpdateArtifact**: För en virtuell dator i ett labb tillämpar den här funktionen **Windows Update** -artefakten.
