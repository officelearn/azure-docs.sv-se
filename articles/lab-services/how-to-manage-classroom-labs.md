...
En mall i ett labb är en grundläggande virtuell datoravbildning som alla användare virtuella datorer skapas. Konfigurera mallen för virtuella datorer så att den är konfigurerad med exakt det som du vill förse labbanvändarna med. Du kan ange ett namn och en beskrivning av mallen som visas för användarna för labbet. Ställa in synlighet för mallen offentlig tillgängliggöra instanser av VM-mallen till lab-användare.  
...
När du har angett synligheten för en mall till **Offentlig**, skapar Azure Lab Services virtuella datorer i labbet med hjälp av mallen. Antal virtuella datorer skapas i den här processen är samma som det maximala antalet användare som tillåts i labbet, där du kan ange i användningsprincipen labbet. Alla virtuella datorer har samma konfiguration som mallen.  
