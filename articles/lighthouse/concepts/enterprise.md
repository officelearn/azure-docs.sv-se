...
Prenumerationer (eller resurs grupper inom en prenumeration) kan registreras i Azure delegerad resurs hantering, antingen genom att distribuera Azure Resource Manager mallar eller genom hanterade tjänster, som publiceras på Azure Marketplace, antingen privat eller offentligt.
