---
title: Skapa en intern Azure-Load Balancer med hjälp av PowerShell
...
Mer information om komponenter för belastnings utjämning finns i [Azure Load Balancer-komponenter](components.md).
...
Stegvisa anvisningar för att skapa en virtuell dator och tilldela den till ett nätverkskort finns i [Skapa en virtuell Azure-dator med PowerShell](../virtual-machines/scripts/virtual-machines-windows-powershell-sample-create-vm.md?toc=%2fazure%2fload-balancer%2ftoc.json).
