---
title: "Skapa en Internetaktiverad belastningsutjämnare – Azure-portalen | Microsoft Docs"
...
Den här artikeln beskriver Resource Manager-distributionsmodellen.

[!INCLUDE [load-balancer-get-started-internet-scenario-include.md](../../includes/load-balancer-get-started-internet-scenario-include.md)]

Artikeln beskriver de enskilda åtgärder som krävs för att det ska gå att skapa en belastningsutjämnare och förklarar i detalj hur detta mål ska uppnås.

## <a name="what-is-required-to-create-an-internet-facing-load-balancer"></a>Vad krävs för att skapa en Internetuppkopplad belastningsutjämnare?
...
1. Skapa en hälsoavsökning.
    ...
    Hovra över ”i”-ikonen om du vill läsa mer om de enskilda konfigurationerna och hur de kan ändras för att uppfylla dina behov.
