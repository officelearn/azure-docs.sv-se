...
- Lär dig hur du kan använda olika typer av loggar för att hantera och felsöka belastningsutjämnare i [logganalys för Azure Load Balancer](../load-balancer/load-balancer-monitor-log.md).
