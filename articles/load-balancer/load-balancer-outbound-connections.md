...
| Period | Tillämpligt protokoll | Information|
| ---------|---------| -------|
...
#### <a name="dynamic-snat-ports-allocated"></a><a name="snatporttable"></a> Tilldelade dynamiska SNAT-portar
