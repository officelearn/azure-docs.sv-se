...
- Lär dig mer om den [Azure Monitor REST API](https://docs.microsoft.com/rest/api/monitor/) och [hur du hämtar måtten via REST API](https://docs.microsoft.com/rest/api/monitor/metrics/metrics_list).
