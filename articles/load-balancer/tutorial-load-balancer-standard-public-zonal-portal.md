...
2. Välj **Inkommande säkerhetsregel** under **Inställningar**. Välj sedan **Lägg till**.
...
1. Välj **Skapa en resurs** > **Compute** > **Windows Server 2016 Datacenter** längst upp till vänster på skärmen. Ange följande värden för den virtuella datorn:
