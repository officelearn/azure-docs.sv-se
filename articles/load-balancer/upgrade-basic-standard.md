...
3. Skapa en utgående regel på belastningsutjämnaren för utgående anslutning
...
* Skript stöder endast offentlig Load Balancer uppgradering. För intern Basic Load Balancer-uppgradering skapar du en intern standard Load Balancer om den utgående anslutningen inte är önskad och skapar en intern standard-Load Balancer och standard-Load Balancer om utgående anslutning krävs.
