...
Du kan hantera dina Azure plats Services-konto och nycklar via Azure-portalen. När du har ett konto och en prenumeration kan implementera du API: er i din webbplats eller mobila program.
