...
![AD-hälsokontroll symbol](./media/log-analytics-ad-assessment/ad-assessment-symbol.png)
...
![Bild av AD-hälsokontroll panel](./media/log-analytics-ad-assessment/ad-healthcheck-summary-tile.png)

![Bild av AD-hälsokontroll instrumentpanelen](./media/log-analytics-ad-assessment/ad-healthcheck-dashboard-01.png)
...
2. Använd följande fråga för att lista över rekommendationer som har misslyckats för datorer i din miljö.
    ...
    ```
    Här är en skärmbild som visar loggsökningsfrågan:<br><br> ![misslyckade rekommendationer](./media/log-analytics-ad-assessment/ad-failed-recommendations.png)
