...
![Exempel enkel schema](./media/log-analytics-create-pipeline-datacollector-api/example-simple-schema-01.png)
...
![Data collection pipeline-arkitektur](./media/log-analytics-create-pipeline-datacollector-api/data-pipeline-dataflow-architecture.png)
...
![Exempel på Logic apps arbetsflöde](./media/log-analytics-create-pipeline-datacollector-api/logic-apps-workflow-example-01.png)
...
2.  Från den **visa filer** fliken i den högra rutan, skapa en ny fil med namnet **project.json** och klistra in följande kod från NuGet-paket som vi använder:
    ...
    ![Azure Functions-exempelprojekt](./media/log-analytics-create-pipeline-datacollector-api/functions-example-project-01.png)
...
5. Testa funktionen för att kontrollera koden fungerar som den ska. Växla till den **testa** fliken i den högra rutan, konfigurera testet på följande sätt. Placera en länk till en blob med exempeldata i den **Begärandetext** textrutan. När du klickar på **kör**, du bör se JSON-utdata i den **utdata** box:
    ...
    ![Funktionsappar testa kod](./media/log-analytics-create-pipeline-datacollector-api/functions-test-01.png)
...
![Logic Apps arbetsflöde komplett exempel](./media/log-analytics-create-pipeline-datacollector-api/logic-apps-workflow-example-02.png)
...
![Korrelera kopplas från data i ett exempel för search-resultat](./media/log-analytics-create-pipeline-datacollector-api/correlating-disjoined-data-example-01.png)
...
Läs mer om den [Data Collector API](log-analytics-data-collector-api.md) att skriva data till Log Analytics från en REST API-klient.