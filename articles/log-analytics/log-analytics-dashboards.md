...
* Skapa [aviseringar](../monitoring-and-diagnostics/monitoring-overview-unified-alerts.md) i Log Analytics för att generera meddelanden och åtgärda problem.
