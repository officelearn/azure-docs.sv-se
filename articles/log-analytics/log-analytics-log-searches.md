...
>[!NOTE]
> Den här artikeln beskriver loggen sökningar med aktuella frågespråket i logganalys.  Om ditt arbetsområde har uppgraderats till den [nya Log Analytics-frågespråket](log-analytics-log-search-upgrade.md), läser du bör [förstå loggen söker i logganalys (nya)](log-analytics-log-search-new.md).
