...
Se [Lägg till Log Analytics-lösningar från lösningsgalleriet](../monitoring/monitoring-solutions.md) för att lägga till funktioner och samla in data.
