...
Information om nätverks- och systemkraven för att distribuera Linux-agenten finns i [kraven för Windows-operativsystem](log-analytics-concept-hybrid.md#prerequisites).
...
2. Klicka på **Skapa** och välj sedan alternativ för följande objekt:
  ...
  * Under **Resursgrupp** väljer du en befintlig resursgrupp eller skapar en ny genom att skriva namnet i textfältet.  
