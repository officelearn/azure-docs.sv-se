...
![Symbol för System Center Operations Manager-hälsokontroll](./media/log-analytics-scom-assessment/scom-assessment-symbol.png)
...
![Panel för System Center Operations Manager-lösning](./media/log-analytics-scom-assessment/log-analytics-scom-healthcheck-tile.png)

![Instrumentpanel för System Center Operations Manager-hälsokontroll](./media/log-analytics-scom-assessment/log-analytics-scom-healthcheck-dashboard-01.png)
...
Använd följande information för att installera och konfigurera lösningen.
 ...
 ![Instrumentpanel för System Center Operations Manager](./media/log-analytics-scom-assessment/scom-configrequired-tile.png)
...
5.  Se till att du ändrar åsidosättningsvärde till **SANT** för den **aktiverad** parametervärde.<br><br> ![åsidosätt parametern](./media/log-analytics-scom-assessment/rule.png)
...
4. Ändra den **intervall** din önskade intervallvärdet parametervärde. I exemplet nedan anges värdet till 1 440 minuter (en dag).<br><br> ![intervall för parametern](./media/log-analytics-scom-assessment/interval.png)<br>  
...
6. På någon av sidorna fokus området, kan du visa prioriterade rekommendationer för din miljö. Klicka på en rekommendation under **påverkade objekt** att visa information om varför rekommendationen görs.<br><br> ![Fokusområde](./media/log-analytics-scom-assessment/log-analytics-scom-healthcheck-dashboard-02.png)<br>
...
2. Använd följande fråga för att lista över rekommendationer som har misslyckats för datorer i din miljö.
    ...
    Här är en skärmbild som visar loggsökningsfrågan:<br><br> ![loggsökning](./media/log-analytics-scom-assessment/scom-log-search.png)<br>
...
- [Söka loggarna](log-analytics-log-searches.md) och lär dig att analysera detaljerad information för System Center Operations Manager hälsokontrollen och rekommendationer.
