...
Lär dig hur du konfigurerar Log Analytics för att hämta Service Fabric-loggar i det här avsnittet. Loggarna kan du visa, analysera och felsöka problem i ditt kluster eller i program och tjänster som körs i klustret, med hjälp av OMS-portalen.
