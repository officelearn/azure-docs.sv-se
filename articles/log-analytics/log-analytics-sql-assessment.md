...
![SQL-hälsokontroll symbol](./media/log-analytics-sql-assessment/sql-assessment-symbol.png)
...
![Bild av SQL-hälsokontroll panel](./media/log-analytics-sql-assessment/sql-healthcheck-summary-tile.png)

![Bild av SQL-hälsokontroll instrumentpanelen](./media/log-analytics-sql-assessment/sql-healthcheck-dashboard-01.png)
...
2. Under **kör som-konfiguration**, klickar du på **profiler**, och öppna **OMS SQL utvärdering av kör som-profil**.
...
2. Använd följande fråga för att lista över rekommendationer som har misslyckats för datorer i din miljö.
    ...
    Här är en skärmbild som visar loggsökningsfrågan:<br><br> ![misslyckade rekommendationer](./media/log-analytics-sql-assessment/sql-assess-failed-recommendations.png)<br>
