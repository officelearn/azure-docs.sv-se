...
![Sifferpanel](media/log-analytics-view-designer-tiles/tile-number.png)
...
![Två tal panelen](media/log-analytics-view-designer-tiles/tile-two-numbers.png)
...
![Ringdiagram panel](media/log-analytics-view-designer-tiles/tile-donut.png)
...
![Rad linjediagram och bildtext panel](media/log-analytics-view-designer-tiles/tile-line-chart.png)
...
![Rad linjediagram och bildtext panel](media/log-analytics-view-designer-tiles/tile-line-chart-callout.png)
...
![Två tidslinjer panel](media/log-analytics-view-designer-tiles/tile-two-timelines.png)
...
* Lär dig mer om [loggsökningar](log-analytics-log-search.md) för frågorna i paneler.
