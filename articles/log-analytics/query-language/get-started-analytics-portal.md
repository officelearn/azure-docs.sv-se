...
![Välja kolumner](media/get-started-analytics-portal/select-columns.png)
...
![Fäst vid instrumentpanelen](media/get-started-analytics-portal/pin-dashboard.png)
