...
1. Gå till [listan med Logic Apps-kopplingar](https://docs.microsoft.com/connectors/connector-reference/connector-reference-logicapps-connectors).

1. Hitta referens sidan för den koppling som du vill blockera.

   Om du till exempel vill blockera Instagram-anslutningsprogrammet går du till den här sidan: 
...
1. Under **princip definition**anger du informationen för princip definitionen, baserat på de egenskaper som beskrivs i exemplet:
   ...
   | **Policyframtvingande** | Yes | **Aktiverad** | Den här inställningen anger om du vill aktivera eller inaktivera princip definitionen när du sparar ditt arbete. |
   ||||
...
1. Under **grunderna**anger du den här informationen för princip tilldelningen:
   ...
   | **Policyframtvingande** | Yes | Inställningen som aktiverar eller inaktiverar princip tilldelningen |
