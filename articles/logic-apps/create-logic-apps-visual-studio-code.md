...
description: Skapa och hantera logic apps i Visual Studio Code (VS-kod)
services: logic-apps
...
* Grundläggande kunskaper om logikapp [arbetsflödesdefinitioner](../logic-apps/logic-apps-workflow-definition-language.md) och deras struktur som använder JavaScript Object Notation (JSON)
