...
1. Börja med en tom fråga eller en tillgänglig befintlig fråga.
   ...
   * Om du vill kontrol lera om det finns några befintliga frågor i verktygsfältet fråga väljer du antingen **exempel frågor** > **Historik**, som visar frågor från föregående fråga körs, eller väljer **query Explorer**, som visar fördefinierade frågor.
