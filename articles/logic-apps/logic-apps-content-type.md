...
* `json()`: Konverterar data till `application/json`
* `xml()`: Konverterar data till `application/xml`
* `binary()`: Konverterar data till `application/octet-stream`
* `string()`: Konverterar data till `text/plain`
* `base64()`: Om du konverterar innehållet till en base64-sträng
