...
1. Om du vill hantera de fall där god kännaren väljer `Approve` eller `Reject`lägger du till ett annat ärende mellan **SKIFT läge** och **standard**. 
...
1. Lägg till följande åtgärder i motsvarande fall:
   ...
   |--------|--------------------|--------|
   | Fall 1 | **Godkänts** | Lägg till Outlook **skicka en e-** poståtgärd för att skicka information om RSS-objektet endast när god kännaren valt **Godkänn**. |
   | Fall 2 | **Tackar** | Lägg till Outlook **skicka en e-** poståtgärd för att meddela andra god kännare om att RSS-objektet avvisades. |
   | Standard | Inget | Ingen åtgärd krävs. I det här exemplet är **standard** fallet tomt eftersom **SelectedOption** bara har två alternativ. |
   |||
...
| `"cases"` | Definierar ett valfritt antal fall. För varje fall är `"Case_*"` standard namnet för det fallet, som du kan byta namn på för läsbarhet |
