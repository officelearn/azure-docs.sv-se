...
Du kan distribuera mallen med hjälp av alla verktyg som PowerShell, REST API, [Visual Studio Team Services Release Management](#team-services), och för malldistribution via Azure portal.
...
## <a name="visual-studio-team-services-release-management"></a>Versionshantering för Visual Studio Team Services

Ett vanligt scenario för att distribuera och hantera en miljö är att använda ett verktyg som versionshantering i Visual Studio Team Services, med en logic app-Distributionsmall. Visual Studio Team Services innehåller en [distribuera Azure-resursgrupp](https://github.com/Microsoft/vsts-tasks/tree/master/Tasks/DeployAzureResourceGroup) uppgift att du kan lägga till någon version eller frigöra pipeline. Du måste ha en [tjänstens huvudnamn](https://blogs.msdn.microsoft.com/visualstudioalm/2015/10/04/automating-azure-resource-group-deployment-using-a-service-principal-in-visual-studio-online-buildrelease-management/) för auktorisering för att distribuera, och du kan generera versionsdefinitionen.

1. Välj i Release Management **tom** så att du skapar en tom definition.
