---
title: Kod exempel för att använda data åtgärder
description: Testa dessa kod exempel som visar hur du kan använda data åtgärder i automatiserade arbets flöden som skapats med Azure Logic Apps
services: logic-apps
