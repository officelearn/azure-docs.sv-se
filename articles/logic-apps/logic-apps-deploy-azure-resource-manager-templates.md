...
* [Självstudie: kontinuerlig integrering för Azure Resource Manager mallar med Azure-pipeline](../azure-resource-manager/templates/template-tutorial-use-azure-pipelines.md)
