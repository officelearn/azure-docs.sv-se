...
För [Azure Government](/azure-government/documentation-government-welcome) och [Azure Kina 21Vianet](/azure/china/china-welcome), reserverade IP-adresser för kopplingar är inte tillgänglig för tillfället.
