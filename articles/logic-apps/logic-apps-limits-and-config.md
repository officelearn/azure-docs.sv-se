...
1. Öppna [Azure-portalen](https://portal.azure.com). I rutan Portal söker du efter **och väljer Logi**Kap par.
...
Här följer gränserna för en Logic app som börjar med en begär ande utlösare och aktiverar [Azure Active Directory öppna autentisering](/azure/active-directory/develop/) (Azure AD OAuth) för att auktorisera inkommande anrop till begär ande utlösare:
...
> Den här taggen fungerar i de regioner där Logic Appss tjänsten är tillgänglig.
> För hanterade anslutningar måste du fortsätta att använda IP-adresserna.
