...
| isMessageFailed |Booleskt värde | Om AS2-meddelandet misslyckades. (Obligatoriskt) |
| isMessageSigned | Booleskt värde | Om AS2-meddelandet signerades. (Obligatoriskt) |
| isMessageEncrypted | Booleskt värde | Anger om meddelandet AS2 krypterades. (Obligatoriskt) |
| isMessageCompressed |Booleskt värde | Om AS2-meddelandet har komprimerats. (Obligatoriskt) |
...
| isNrrEnabled | Booleskt värde | Använd standardvärdet om värdet inte är känd. (Obligatoriskt) |
| isMdnExpected | Booleskt värde | Använd standardvärdet om värdet inte är känd. (Obligatoriskt) |
