...
| Värde | Type | Beskrivning |
|-------|------|-------------|
| <*retry-behavior*> | JSON-objekt | Anpassar återförsöksbeteendet för tillfälliga fel, som har 408, 429, och 5XX-statuskoden och eventuella undantag. Mer information finns i [Återförsöksprinciper](#retry-policies). |
...
| Åtgärdsvärdet | Type | Beskrivning | Utlösare eller åtgärd |
|------------------|------|-------------|-------------------|
...
| **pfx** | Ja | <*base64-encoded-pfx-file*> | Base64-kodad innehållet från en Personal Information Exchange (PFX)-fil |
...
| **pfx** | Ja, endast under ”certifikat” typ av autentiseringsuppgift | <*base64-encoded-pfx-file*> | Base64-kodad innehållet från en Personal Information Exchange (PFX)-fil |
| **secret** | Ja, endast för ”hemligheten” autentiseringstyp | <*secret-for-authentication*> | Base64-kodad hemligheten som klienten använder för begär auktorisering |
|||||
