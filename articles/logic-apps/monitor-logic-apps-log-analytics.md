...
1. Skriv `log analytics workspaces`i sökrutan [Azure Portal](https://portal.azure.com)och välj sedan **Log Analytics arbets ytor**.
...
1. På arbets ytans meny väljer du **arbets ytans sammanfattning** > **Logic Apps hantering**.
...
I det här exemplet visas hur `ActionCompleted`-händelsen inkluderar attributen `clientTrackingId` och `trackedProperties`:
...
* [Skapa övervaknings-och spårnings frågor](../logic-apps/create-monitoring-tracking-queries.md)
