...
| Python-och R-moduler | Skriv kod och bädda in den i en modul för att integrera python och R med din pipeline. | [Skapa python-modell](create-python-model.md) <br/> [Kör Python-skript](execute-python-script.md)   <br/>  [Kör R-skript](execute-r-script.md)
...
| Träna   | Kör data via algoritmen. | [Kors validerings modell](cross-validate-model.md) <br/> [Träna modell](train-model.md)  <br/> [Träna kluster modell](train-clustering-model.md) <br/>  [Finjustera modellens egenskaper](tune-model-hyperparameters.md) |
