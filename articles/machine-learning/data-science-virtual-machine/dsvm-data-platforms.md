...
> [!NOTE]
> SQL Server 2016 Developer Edition kan endast användas i utvecklings-och test syfte. Du behöver en licens eller en av SQL Server-datorer att köras i produktion.
...
| DSVM-versioner som stöds      | Linux <br /> Windows (experimentell)      |
...
> [!NOTE]
> Att köra Microsoft Machine Learning Server i Spark-kontexten för DSVM stöds endast på Ubuntu Linux DSVM-versionen.
