---
title: 'Snabb start: skapa en CentOS-Data Science Virtual Machine'
...
---
# <a name="quickstart-set-up-a-centos-linux-data-science-virtual-machine-in-azure"></a>Snabb start: Konfigurera en CentOS (Linux) Data Science Virtual Machine i Azure
...
* Utforska de olika data vetenskaps verktygen på DSVM genom att prova de verktyg som beskrivs i den här artikeln. Du kan också köra `dsvm-more-info` i gränssnittet i den virtuella datorn för en grundläggande introduktion och för att visa mer information om de verktyg som är installerade på DSVM.  
