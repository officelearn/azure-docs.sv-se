...
I den här artikeln beskrivs vad du kan göra med Data Science VM. Det beskriver några av de viktigaste scenarierna för att använda den virtuella datorn och specificerar de viktiga funktioner som finns tillgängliga i Windows-och Linux-versionerna. Artikeln innehåller också anvisningar om hur du kommer igång med dem.
...
| &nbsp;&nbsp;&nbsp;&nbsp;* Lokal [Spark](https://spark.apache.org/) fristående | J | J |
| &nbsp;&nbsp;&nbsp;&nbsp;* Lokal [Hadoop](https://hadoop.apache.org/) (HDFS, YARN) | N | J |
