...
Mer information om omvandlingen sträng med exempel teknik finns i [publikationen](https://www.microsoft.com/research/publication/automating-string-processing-spreadsheets-using-input-output-examples/).
