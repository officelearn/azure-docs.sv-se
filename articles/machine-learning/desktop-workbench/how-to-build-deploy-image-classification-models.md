...
I den här artikeln lär du dig hur du använder Azure Machine Learning-paket för datorn Vision (AMLPCV) för att träna, testa och distribuera en modell för klassificering av avbildning. En översikt över det här paketet och dess detaljerad referensdokumentation [visas här](https://aka.ms/aml-packages/vision).
