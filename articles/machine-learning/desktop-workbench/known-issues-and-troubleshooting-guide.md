...
Vi har en MSDN-Forum som att du kan ställa frågor. Forumet övervakas aktivt produktteamet. Forumet URL: en är [ https://aka.ms/azureml-forum ](https://aka.ms/azureml-forum). 
