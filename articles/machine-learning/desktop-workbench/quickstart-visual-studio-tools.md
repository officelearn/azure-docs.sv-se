...
När Visual Studio har lästs in på nytt är tillägget aktivt. [Läs mer om hur du söker efter tillägg](https://docs.microsoft.com/visualstudio/ide/finding-and-using-visual-studio-extensions).
