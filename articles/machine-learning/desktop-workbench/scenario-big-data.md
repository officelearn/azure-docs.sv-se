...
* En installerad kopia av [Azure Machine Learning arbetsstationen](../service/overview-what-is-azure-ml.md). Om du vill installera programmet och skapa en arbetsyta, finns det [quickstart installationsguiden](../service/quickstart-installation.md). Om du har flera prenumerationer, kan du [ange den önskade prenumerationen ska den aktuella aktiva prenumerationen](https://docs.microsoft.com/cli/azure/account?view=azure-cli-latest#az_account_set).
