...
Använd `pip install azureml-interpret` och `pip install azureml-interpret-contrib` för allmän användning och `pip install azureml-interpret-contrib` för AutoML använder du för att hämta tolknings paketen.
