...
När du har bekräftat arbets ytans funktion går du till [Start sidan för Studio](https://ml.azure.com) och väljer fliken **data uppsättningar** till vänster. Välj **data uppsättnings övervakare**.
