...
- Åtkomst till ditt AKS-kluster med kommandot `kubectl`. Mer information finns i [ansluta till klustret](https://docs.microsoft.com/azure/aks/kubernetes-walkthrough#connect-to-the-cluster)
...
Om du har fått Läs behörighet för Azure Identity till en hemlighet i en **Key Vault**kan `score.py` komma åt den med följande kod.
...
Om du har fått Läs åtkomst till data i en **lagrings-BLOB**för Azure Identity kan `score.py` komma åt den med följande kod.
