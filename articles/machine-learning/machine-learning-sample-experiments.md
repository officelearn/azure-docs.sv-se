<properties
    pageTitle="Kopiera Machine Learning-provexperiment | Microsoft Azure"
...
# Kopiera provexperiment för att skapa nya Machine Learning-experiment
...
## Hitta ett experiment att kopiera i Cortana Intelligence-galleriet
...
### Hitta de senaste eller mest populära experimenten
...
### Leta efter ett experiment som uppfyller specifika krav
...
3. Du kan hitta experiment som uppfyller kraven på ett par olika sätt:
    ...
    *  **Använd sökrutan.** Om du till exempel vill hitta experiment från Microsoft som rör sifferigenkänning som använder en algoritm för stödvektormaskin med två klasser anger du ”digit recognition” i sökrutan. Välj sedan filtren **Experiment**, **Endast Microsoft innehåll** och **Stödvektormaskin med två klasser**:
