...
Om du inte redan har ett projekt, kan du skapa en från den [skapar och installerar Quickstart](quickstart-installation.md) från den **instrumentpanelen för projektet**, kan du öppna den **iris_sklearn.py** skript () som visas.)
