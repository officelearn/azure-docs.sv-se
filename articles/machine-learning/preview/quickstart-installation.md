...
>[!NOTE]
> Även om du har skapat modellhanteringskontot är din miljö inte konfigurerad för att distribuera webbtjänster än. Lär dig hur du konfigurerar din [distributionsmiljö](deployment-setup-configuration.md).
