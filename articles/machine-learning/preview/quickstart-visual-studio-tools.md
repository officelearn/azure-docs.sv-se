...
När Visual Studio Code har lästs in på nytt är tillägget aktiverat. [Läs mer om hur du installerar tillägg](https://code.visualstudio.com/docs/editor/extension-gallery).
...
4. Välj plattformen ”Azure Machine Learning”.
