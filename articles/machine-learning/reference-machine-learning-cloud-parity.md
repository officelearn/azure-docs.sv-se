...
| Skapa, köra, visualisera och publicera pipeliner i Azure ML designer          | Offentlig för hands version       | JA                | JA         |
| Azure Databricks integrering med ML pipeline                             | Allmän tillgänglighet (GA)                   | NO                 | NO          |
| Skapa pipeline-slutpunkter i Azure ML-designer                             | Offentlig för hands version       | JA                | JA         |
...
| Rollbaserad Access Control (RBAC) – skapa anpassade roller                           | JA | JA |  |
...
* Modell profilering stöder inte 4 processorer i regionen USA-Arizona.   
* Exempel på bärbara datorer kanske inte fungerar i Azure Government om de behöver åtkomst till offentliga data.
* IP-adresser: CLI-kommandot som används i instruktionerna för [VNet och Tvingad tunnel trafik](how-to-enable-virtual-network.md#forced-tunneling) returnerar inte IP-intervall. Använd [Azure IP-intervall och service märken för Azure Government](https://www.microsoft.com/download/details.aspx?id=57063) i stället.
...
| Skapa, köra, visualisera och publicera pipeliner i Azure ML designer          | Offentlig för hands version   | JA       | Saknas        |
| Azure Databricks integrering med ML pipeline                             | Allmän tillgänglighet (GA)               | NO        | Saknas        |
| Skapa pipeline-slutpunkter i Azure ML-designer                             | Offentlig för hands version   | JA       | Saknas        |
| **Integrerade antecknings böcker** |   | | |
...
| WhiteNoise Toolkit för differentiell sekretess                                    | OSS              | NO        | Saknas        |
...
* REST API slut punkter skiljer sig från globala Azure. Använd följande tabell för att hitta REST API slut punkten för regionerna i Azure Kina:
    ...
    | REST-slutpunkt                 | Global Azure                                 | Kina-myndigheter                           |
    |------------------|--------------------------------------------|--------------------------------------------|
...
* IP-adressintervall: CLI-kommandot som används i instruktionerna för [VNet-Tvingad tunnel](how-to-enable-virtual-network.md#forced-tunneling) returnerar inte IP-intervall. Använd [Azures IP-adressintervall och service märken för Azure Kina](https://www.microsoft.com//download/details.aspx?id=57062) i stället.
