---
title: Exempel data för designer
titleSuffix: Azure Machine Learning
description: Läs mer om exempel data uppsättningar som är tillgängliga med Azure Machine Learning designer.
...
ms.locfileid: "81256985"
---
# <a name="sample-datasets-in-azure-machine-learning-designer-preview"></a>Exempel data uppsättningar i Azure Machine Learning designer (för hands version)
