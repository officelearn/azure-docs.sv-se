...
+ **Fel korrigeringar och förbättringar**
  ...
  + **azureml-automl-Core**
    ...
    + Tillåt att mellanliggande data i Azure Machine Learning pPipeline konverteras till data uppsättning i tabell format och används i `AutoMLStep`.
