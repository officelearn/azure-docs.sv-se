...
4. Skapa data uppsättnings Övervakare för dina indata och data uppsättningar för utdata för att identifiera data drift. 
5. Om data påträffas kan du uppdatera din data uppsättning och träna modellen på lämpligt sätt.
...
För att få åtkomst till dina data i ditt lagrings konto erbjuder Azure Machine Learning data lager och data uppsättningar. Data lager ger ett lager av abstraktion över lagrings tjänsten. Detta hjälper till att skydda och förenkla åtkomst till din lagring, eftersom anslutnings informationen lagras i data lagret och inte visas i skript. Data uppsättningar pekar på den eller de filer i din underliggande lagring som du vill använda för ditt dator inlärnings experiment. Tillsammans erbjuder data lager och data uppsättningar ett säkert, skalbart och reproducerat data leverans arbets flöde för dina Machine Learning-uppgifter.
