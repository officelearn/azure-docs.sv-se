...
> [!NOTE]
> När du skapar en avbildning som använder GPU-acceleration måste GPU-basavbildningen användas på Microsoft Azure-tjänster endast.
...
> [!IMPORTANT]
> Endast AKS version 1.11.3 stöds.
