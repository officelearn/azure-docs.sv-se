...
Data uppsättningen innehåller 14 funktioner och en etikett kolumn. Det finns flera typer av funktioner, inklusive numeriska och kategoriska. Följande diagram visar ett utdrag från data uppsättningen: ![data](media/how-to-designer-sample-classification-predict-income/data.png)
...
![Utvärdera resultaten](media/how-to-designer-sample-classification-predict-income/evaluate-result.png)
