...
![Diagram över pipelinen](media/how-to-designer-sample-regression-predict-automobile-price-basic/overall-graph.png)
...
![För bearbetning av data](./media/how-to-designer-sample-regression-predict-automobile-price-basic/data-processing.png)
...
![Resultat resultat](./media/how-to-designer-sample-regression-predict-automobile-price-basic/score-result.png)
...
![Utvärdera resultat](./media/how-to-designer-sample-regression-predict-automobile-price-basic/evaluate-result.png)
