...
1. Om du inte har en Azure-prenumeration kan du skapa ett kostnadsfritt konto innan du börjar. Prova den [kostnads fria eller betalda versionen av Azure Machine learnings tjänsten](https://aka.ms/AMLFree).
...
![Designer-start sida](media/how-to-run-batch-predictions-ui/ui-batch-scoring-1.png)
...
![Skapa ett enkelt experiment](media/how-to-run-batch-predictions-ui/ui-batch-scoring-2.png)
...
![Skapa en pipeline för batch-härledning](media/how-to-run-batch-predictions-ui/ui-batch-scoring-5.png)
...
![Standard pipeline för batch-härledning](media/how-to-run-batch-predictions-ui/ui-batch-scoring-6.png)
...
![Ny nod](media/how-to-run-batch-predictions-ui/ui-batch-scoring-7.png)
...
![Exempel inställningar](media/how-to-run-batch-predictions-ui/ui-batch-scoring-8.png)
...
![Pipeline-distribution](media/how-to-run-batch-predictions-ui/ui-batch-scoring-10.png)
...
![Installations slut punkt](media/how-to-run-batch-predictions-ui/ui-batch-scoring-11.png)
...
![Slut punkts länk](media/how-to-run-batch-predictions-ui/ui-batch-scoring-12.png)

Den här skärmen visar alla publicerade pipeliner under den angivna slut punkten. Klicka på din inferencing-pipeline.

![Härlednings pipeline](media/how-to-run-batch-predictions-ui/ui-batch-scoring-13.png)
...
![Pipeline-information](media/how-to-run-batch-predictions-ui/ui-batch-scoring-14.png)
...
![Pipeline-körning](media/how-to-run-batch-predictions-ui/ui-batch-scoring-15.png)
