...
Eftersom du försöker besvara frågan "vilket är en?" Detta kallas klassificerings problem, men du kan använda samma logik i det här projektet för att ta itu med alla typer av maskin inlärnings problem, oavsett om det är regression, klassificering, klustring och så vidare.

Här är det färdiga diagrammet för det här experimentet:

![Experiment diagram](./media/how-to-ui-sample-classification-predict-churn/experiment-graph.png)
...
4. Välj knappen **Öppna** för exempel 5-experimentet.
    ...
    ![Öppna experimentet](media/how-to-ui-sample-classification-predict-churn/open-sample5.png)

## <a name="data"></a>Data

Data för det här experimentet är från KDD-bägaren 2009. Den har 50 000 rader och 230 funktions kolumner. Uppgiften är att förutse omsättning, begär och försäljning för kunder som använder dessa funktioner. Mer information om data och aktiviteter finns på [KDD-webbplatsen](https://www.kdd.org/kdd-cup/view/kdd-cup-2009).
...
Börja med att göra lite enkel data bearbetning.

- RAW-datauppsättningen innehåller massor av saknade värden. Använd modulen **Rensa data som saknas** för att ersätta de saknade värdena med 0.
