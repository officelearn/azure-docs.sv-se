---
title: 'Exempel på visuella gränssnitt #7: klassificera bok granskningar'
...
ms.locfileid: "72694667"
---
# <a name="sample-7---text-classification-predict-company-category"></a>Exempel 7 – text klassificering: förutse företags kategori 

Det här exemplet visar hur du använder text analys moduler för att bygga en text klassificerings pipeline i Azure Machine Learning Visual Interface.
...
[experimentets ![Graph](./media/how-to-ui-sample-text-classification/nlp-modules-overall.png)](./media/how-to-ui-sample-text-classification/nlp-modules-overall.png#lightbox)

## <a name="data"></a>Data

I det här experimentet använder vi **Wikipedia SP 500** -datauppsättningen. Data uppsättningen härleds från Wikipedia (https://www.wikipedia.org/) baserat på artiklarna i varje S & P 500-företag. Innan du överför till Azure Machine Learning visuellt gränssnitt bearbetades data uppsättningen på följande sätt:
...
Valet av algoritm beror ofta på kraven i användnings fallet. Eftersom syftet med det här experimentet är att förutse företags kategorin är en klassificerings modell med flera klasser ett bra val. Med tanke på att antalet funktioner är stort och dessa funktioner är glesa använder vi **multiklass logistik Regressions** modell för det här experimentet.
...
[![Graph av n-gram-Poäng](./media/how-to-ui-sample-text-classification/n-gram.png)](./media/how-to-ui-sample-text-classification/n-gram.png)
