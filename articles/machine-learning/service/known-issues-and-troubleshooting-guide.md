...
- Högsta tillåtna projekt mappstorleken: 25 MB.
    >[!NOTE]
    >Den här gränsen gäller inte för `.git`, `docs` och `outputs` mappar. Dessa mappnamn är skiftlägeskänsliga. Om du arbetar med stora filer, se [spara ändringar och behandlar stora filer](../desktop-workbench/how-to-read-write-files.md).
...
- Maxstorlek på spårade filen i `outputs` mapp när du har en körning: 512 MB
  - Det innebär att om skriptet genererar en fil som är större än 512 MB i mappen utdata, den inte har samlats in det. Om du arbetar med stora filer, se [spara ändringar och behandlar stora filer](../desktop-workbench/how-to-read-write-files.md).
