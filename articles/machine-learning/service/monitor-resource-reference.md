...
### <a name="amlcomputerclusterevents-table"></a>AmlComputerClusterEvents-tabell
...
I följande tabeller visas de plattforms mått som samlas in för Azure Machine Learning alla mått lagras i namn området **Azure Machine Learning tjänst**.
