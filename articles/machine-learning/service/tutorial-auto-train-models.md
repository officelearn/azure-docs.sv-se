---
title: 'Självstudie nr 2: Träna en regressionsmodell med automatiserad maskininlärning – Azure Machine Learning-tjänsten'
...
ms.locfileid: "52879539"
---
# <a name="tutorial-2-train-a-regression-model-with-automated-machine-learning"></a>Självstudie nr 2: Träna en regressionsmodell med automatiserad maskininlärning
...
### <a name="option-1-add-a-jupyter-widget-to-see-results"></a>Alternativ 1: Lägg till en Jupyter-widget för att se resultat
...
![Körningsinformation för Jupyter-widget](./media/tutorial-auto-train-models/jup-widget-auto.png)
...
Jämför de förutsagda kostnadsvärdena med de faktiska kostnadsvärdena. Använd dataramen `y_test` och konvertera den till en lista som ska jämföras med de förutsagda värdena. Funktionen `mean_absolute_error` tar emot två matriser med värden och beräknar det genomsnittliga absolutvärdefelet mellan dem. I det här exemplet skulle ett medelabsolutfel på 3,5 innebära att modellen i genomsnitt förutsäger kostnaden inom plus eller minus 3,5 av det faktiska värdet.
