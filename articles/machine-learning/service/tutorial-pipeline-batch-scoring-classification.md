...
1. Ange resursgruppsnamnet. Then, select **Delete**.

Du kan också behålla resursgruppen men ta bort en enstaka arbetsyta. Display the workspace properties, and then select **Delete**.
