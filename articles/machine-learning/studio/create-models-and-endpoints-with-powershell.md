...
Det kan vara den bästa metoden, men du vill inte skapa 1 000-tränings experiment i den klassiska versionen av Azure Machine Learning Studio med var och en som representerar en unik plats. Förutom att vara en överbelastad aktivitet verkar den också ineffektiv eftersom varje experiment skulle ha samma komponenter, förutom inlärnings data uppsättningen.
