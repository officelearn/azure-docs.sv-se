...
En **anpassad modul** är en användardefinierad modul som kan överföras till din arbets yta och köras som en del av den Azure Machine Learning Studio (klassiska) experimentet. En **anpassad R-modul** är en anpassad modul som utför en användardefinierad R-funktion. **R** är ett programmeringsspråk för statistiska beräkningar och grafik som används av statistiker och dataexperter för att implementera algoritmer. R är för närvarande det enda språk som stöds i anpassade moduler, men stöd för ytterligare språk är schemalagd för framtida versioner.
...
**Standard utgångsportar:** utgångsportar som är mappade till returvärden från din R-funktion som kan sedan användas av efterföljande moduler. *DataTable* är endast standardutdata porttyp som stöds för närvarande. (Support för *Lär* och *transformeringar* är kommande.) *DataTable* -utdata definieras som:
...
**ColumnPicker**: parametern för val av en kolumn. Den här typen renderas i UX-Gränssnittet som en kolumnväljare. **Egenskaps** elementet används här för att ange ID: t för den port från vilken kolumner väljs, där mål Port typen måste vara *DataTable*. Resultatet av kolumnen skickas till funktionen R som en lista med strängar som innehåller namn på valda kolumnerna. 
