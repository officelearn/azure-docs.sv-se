...
description: Översikt över Azure Batch-tjänster för Machine Learning Studio (klassiska) jobb. Batchbearbetning för IP-Pool kan du skapa pooler där du kan skicka batch-jobb.
