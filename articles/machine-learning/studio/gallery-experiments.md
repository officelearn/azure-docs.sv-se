---
Rubrik: Azure AI-galleriet experimenten titleSuffix: Beskrivning av Azure Machine Learning Studio: Upptäcka och dela experiment i Azure AI-galleriet. Ett experiment är en arbetsyta i Machine Learning Studio som du kan använda för att skapa en modell-tjänster för förutsägande analys: machine learning ms.service: machine learning ms.component: studio ms.topic: artikel
