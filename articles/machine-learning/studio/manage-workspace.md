...
> 
>Mer information om inställningen åtkomstbehörighet finns [visa åtkomst-tilldelningar för användare och grupper i Azure portal](../../role-based-access-control/role-assignments-users.md).
