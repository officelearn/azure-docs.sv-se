---
title: PowerShell-moduler för Machine Learning Studio (klassisk)
...
Du kan interagera med den klassiska versionen av Studio-resurser med hjälp av tre PowerShell-moduler:
