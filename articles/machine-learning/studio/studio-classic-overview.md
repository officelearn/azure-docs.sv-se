...
Information om hur du navigerar genom det stora biblioteket med Machine Learning-algoritmer finns i [så här väljer du algoritmer för Microsoft Machine Learning Studio (klassisk)](algorithm-choice.md).
