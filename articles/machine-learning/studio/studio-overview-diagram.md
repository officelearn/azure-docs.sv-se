...
Det här diagrammet visar hur alla dessa delar hänger ihop.

> [!NOTE]
> [Snabböversikt över Machine Learning-algoritmer för Microsoft Azure Machine Learning Studio](algorithm-cheat-sheet.md) innehåller mer hjälp för att navigera genom och välja de Machine Learning-algoritmer som finns i Machine Learning Studio.
> 
> 
...
**Här kan du ladda ned diagrammet: [Översikt över funktioner i Microsoft Azure Machine Learning Studio](https://download.microsoft.com/download/C/4/6/C4606116-522F-428A-BE04-B6D3213E9E52/ml_studio_overview_v1.1.pdf)**
