---
title: Utforska data i SQL Server-dator på Azure | Microsoft Docs
description: Så här att utforska data som lagras i en SQL Server-VM på Azure.
