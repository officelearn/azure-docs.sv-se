---
title: Använd Azure HDInsight Hadoop kluster 1 TB data uppsättning – team data science process
...
ms.locfileid: "73492349"
---
# <a name="the-team-data-science-process-in-action---using-an-azure-hdinsight-hadoop-cluster-on-a-1-tb-dataset"></a>Team data science-processen i praktiken-använda ett Azure HDInsight Hadoop-kluster på 1 TB data uppsättning
...
## <a name="dataset"></a>Beskrivning av Criteo-datauppsättning
Criteo-data är en data uppsättning för förutsägelse som är cirka 370GB av gzip-komprimerade TSV filer (~ 1.3 TB okomprimerad), som består av mer än 4 300 000 000 poster. Det tas från 24 dagar från klicknings data som gjorts tillgängliga av [Criteo](https://labs.criteo.com/downloads/download-terabyte-click-logs/). För att få till gång till data experter är de data som är tillgängliga för oss att experimentera med vara zippade.
...
**Definition:** *klicknings frekvens (/maskin):* det här är procent andelen av klickningar i data. I den här Criteo-datauppsättningen är/maskin cirka 3,3% eller 0,033.
...
## <a name="setup"></a>Konfigurera ett HDInsight Hadoop-kluster för data vetenskap
**Obs:** Detta är vanligt vis en **Administratörs** uppgift.

Konfigurera din Azure Data Science-miljö för att skapa förutsägelse analys lösningar med HDInsight-kluster i tre steg:

1. [Skapa ett lagrings konto](../../storage/common/storage-quickstart-create-account.md): det här lagrings kontot används för att lagra data i Azure Blob Storage. Data som används i HDInsight-kluster lagras här.
2. [Anpassa Azure HDInsight Hadoop kluster för data vetenskap](customize-hadoop-cluster.md): det här steget skapar ett Azure HDInsight Hadoop-kluster med 64-bitars Anaconda python 2,7 installerat på alla noder. Det finns två viktiga steg (beskrivs i det här avsnittet) att slutföra när du anpassar HDInsight-klustret.

   * Du måste länka lagrings kontot som skapades i steg 1 med ditt HDInsight-kluster när det skapas. Det här lagrings kontot används för att komma åt data som kan bearbetas i klustret.
   * Du måste aktivera fjärråtkomst till Head-noden i klustret när den har skapats. Kom ihåg de autentiseringsuppgifter för fjärråtkomst som du anger här (skiljer sig från de som anges för klustret när de skapas): du behöver dem för att utföra följande procedurer.
...
[Criteo](https://labs.criteo.com/downloads/download-terabyte-click-logs/) -datauppsättningen kan nås genom att klicka på länken, godkänna användnings villkoren och ange ett namn. En ögonblicks bild av vad som ser ut som visas här:
...
Data finns på en offentlig [Azure Blob Storage](../../storage/blobs/storage-dotnet-how-to-use-blobs.md) -plats: wasb://criteo@azuremlsampleexperiments.blob.core.windows.net/raw/. "Wasb" syftar på Azure Blob Storage-platsen.

1. Data i denna offentliga blob-lagring består av tre undermappar med zippade data.

   1. Undermappen *RAW/Count/* innehåller de första 21 dagarna data – från dag\_00 till dag\_20
...
2. För de som vill börja med rå gzip-data är de också tillgängliga i huvudmappen *RAW/* as day_NN. gz, där NN går från 00 till 23.
...
## <a name="login"></a>Logga in på klustrets huvudnoden
Logga in på huvudnoden i klustret genom att använda [Azure Portal](https://ms.portal.azure.com) för att hitta klustret. Klicka på HDInsight elefant-ikonen till vänster och dubbelklicka sedan på namnet på klustret. Gå till fliken **konfiguration** , dubbelklicka på ikonen Anslut längst ned på sidan och ange autentiseringsuppgifter för fjärråtkomst när du uppmanas till det. Då går du till huvudnoden i klustret.

Så här ser en typisk första inloggning i kluster huvudnoden ut:
...
## <a name="hive-db-tables"></a>Skapa Hive-databas och tabeller
...
Följande kod skapar en databas "Criteo" och genererar sedan 4 tabeller:

* en *tabell för generering av antal* som bygger på dagar per dag\_00 till dag\_20,
* en *tabell för användning som tåg data uppsättningen* bygger på dag\_21 och
* två *tabeller som ska användas som test data uppsättningar* byggda dag\_22 och dag\_23.
...
Skript [&#95;exempel registrerings data&#95;filen&#95;skapa&#95;Criteo&#95;Database&#95;och tables. HQL](https://github.com/Azure/Azure-MachineLearning-DataScience/blob/master/Misc/DataScienceProcess/DataScienceScripts/sample_hive_create_criteo_database_and_tables.hql) visas här för att under lätta:
...
Alla dessa tabeller är externa så att du enkelt kan peka på deras Azure Blob Storage-platser (wasb).

**Det finns två sätt att köra en Hive-fråga:**

1. **Med hjälp av kommando raden för Hive-repl**: det första är att utfärda ett Hive-kommando och kopiera och klistra in en fråga på HIVE-repl kommando rad. Gör så här:

        cd %hive_home%\bin
        hive

     Nu körs den här frågan på kommando raden för REPL och inklistringen klistras in.
2. **Spara frågor till en fil och köra kommandot**: det andra är att spara frågorna i en. HQL-fil ([exempel&#95;registrerings data&#95;fil för&#95;att&#95;skapa&#95;Criteo&#95;Database och tables. HQL](https://github.com/Azure/Azure-MachineLearning-DataScience/blob/master/Misc/DataScienceProcess/DataScienceScripts/sample_hive_create_criteo_database_and_tables.hql)) och sedan utfärda följande kommando för att köra frågan:
...
## <a name="exploration"></a>Data utforskning i Hive
...
Innehållet i [exempel&#95;på Hive&#95;-&#95;antal&#95;är&#95;träna tabell exempel. HQL](https://github.com/Azure/Azure-MachineLearning-DataScience/blob/master/Misc/DataScienceProcess/DataScienceScripts/sample_hive_count_train_table_examples.hql) visas här:
...
Räkna nu antalet exempel i de två test data uppsättningarna. Innehållet i [&#95;exempel på Hive&#95;-&#95;Criteo&#95;test&#95;dag&#95;22&#95;tabell&#95;exempel. HQL](https://github.com/Azure/Azure-MachineLearning-DataScience/blob/master/Misc/DataScienceProcess/DataScienceScripts/sample_hive_count_criteo_test_day_22_table_examples.hql) finns här:
...
Kommandot för att göra detta liknar det som visas precis (se [&#95;exempel på Hive&#95;-antal&#95;Criteo&#95;test&#95;dag&#95;23&#95;exempel. HQL](https://github.com/Azure/Azure-MachineLearning-DataScience/blob/master/Misc/DataScienceProcess/DataScienceScripts/sample_hive_count_criteo_test_day_23_examples.hql)):
...
Etikett fördelningen i tågets data uppsättning är av intresse. För att se detta, Visa innehåll [i&#95;Hive&#95;Criteo&#95;etikett&#95;distribution&#95;träna&#95;bord. HQL](https://github.com/Azure/Azure-MachineLearning-DataScience/blob/master/Misc/DataScienceProcess/DataScienceScripts/sample_hive_criteo_label_distribution_train_table.hql):
...
Observera att den procentuella andelen positiva etiketter är cirka 3,3% (konsekvent med den ursprungliga data uppsättningen).
...
Du kan använda Hive: s inbyggda "histogram\_numeric"-funktion för att ta reda på vad fördelningen av de numeriska variablerna ser ut. Här följer innehållet i [&#95;Hive&#95;Criteo&#95;histogram&#95;numeric. HQL](https://github.com/Azure/Azure-MachineLearning-DataScience/blob/master/Misc/DataScienceProcess/DataScienceScripts/sample_hive_criteo_histogram_numeric.hql):
...
Kombinationen av LATERAL vy-explodera i Hive används för att skapa en SQL-liknande utdata i stället för den vanliga listan. Observera att den första kolumnen i den här tabellen motsvarar lager plats Center och den andra till lager plats frekvensen.
...
Även om det är intressant med numeriska variabler är beräkningen av ungefärliga percentiler. Hive: s interna "percentil\_som uppskattar" gör detta för oss. Innehållet i [&#95;Hive&#95;-Criteo&#95;uppskattar&#95;percentiler. HQL](https://github.com/Azure/Azure-MachineLearning-DataScience/blob/master/Misc/DataScienceProcess/DataScienceScripts/sample_hive_criteo_approximate_percentiles.hql) :
...
Du kan fortsätta med data utforskningen, hitta, för vissa kategoriska-kolumner, antalet unika värden som de tar. Det gör du genom att visa innehåll [i&#95;Hive&#95;Criteo&#95;unika&#95;värden&#95;categoricals. HQL](https://github.com/Azure/Azure-MachineLearning-DataScience/blob/master/Misc/DataScienceProcess/DataScienceScripts/sample_hive_criteo_unique_values_categoricals.hql):
...
Observera att Col15 har 19M unika värden! Det är inte möjligt att använda naïve-tekniker som "en-frekvent kodning" för att koda sådana avancerade kategoriska-variabler. I synnerhet förklaras och visas en kraftfull, robust teknik som kallas [inlärning](https://blogs.technet.com/b/machinelearning/archive/2015/02/17/big-learning-made-easy-with-counts.aspx) för att lösa problemet effektivt.

Titta slutligen på antalet unika värden för några andra kategoriska-kolumner. Innehållet i [&#95;&#95;Hive Criteo&#95;unika&#95;värden&#95;flera&#95;categoricals. HQL](https://github.com/Azure/Azure-MachineLearning-DataScience/blob/master/Misc/DataScienceProcess/DataScienceScripts/sample_hive_criteo_unique_values_multiple_categoricals.hql) är:
...
Antalet samförekomster av par av kategoriska variabler är också av intresse. Detta kan fastställas med hjälp av koden [i&#95;Hive&#95;Criteo&#95;parad&#95;kategoriska&#95;Counts. HQL](https://github.com/Azure/Azure-MachineLearning-DataScience/blob/master/Misc/DataScienceProcess/DataScienceScripts/sample_hive_criteo_paired_categorical_counts.hql):
...
## <a name="downsample"></a>Exempel på data uppsättningar för Azure Machine Learning
...
Skript [exemplet&#95;Hive&#95;Criteo&#95;-nedsampling&#95;test&#95;dag&#95;22&#95;DataSet. HQL](https://github.com/Azure/Azure-MachineLearning-DataScience/blob/master/Misc/DataScienceProcess/DataScienceScripts/sample_hive_criteo_downsample_test_day_22_dataset.hql) gör det till test data, dag\_22:
...
Slutligen, skript [exemplet&#95;Hive&#95;Criteo&#95;nedsampling&#95;test&#95;dag&#95;23&#95;DataSet. HQL](https://github.com/Azure/Azure-MachineLearning-DataScience/blob/master/Misc/DataScienceProcess/DataScienceScripts/sample_hive_criteo_downsample_test_day_23_dataset.hql) gör det till test data, dag\_23:
...
Det finns en slutlig viktig komponent innan du går vidare till Azure Machine Learning, vilket avser Count-tabellen. I nästa del avsnitt beskrivs tabellen Count i viss detalj.

## <a name="count"></a>En kort diskussion om Count-tabellen
Som du såg har flera kategoriska-variabler en mycket hög dimensionalitet. I genom gången är en kraftfull teknik som kallas [inlärning med antal](https://blogs.technet.com/b/machinelearning/archive/2015/02/17/big-learning-made-easy-with-counts.aspx) för att koda dessa variabler på ett effektivt och robust sätt presenteras. Mer information om den här tekniken finns i den angivna länken.
...
## <a name="aml"></a>Bygg en modell med Azure Machine Learning
...
### <a name="step1"></a>Steg 1: Hämta data från Hive-tabeller till Azure Machine Learning använda modulen importera data och välj den för ett Machine Learning-experiment
...
2. I rutan **Hive-databasfrågor** , ett enkelt Select * från <\_-databasens\_namn.\_tabellen\_namn >-räcker inte.
...
7. **Namn på Azure Storage-konto**: det lagrings konto som är kopplat till klustret
8. **Lagrings konto nyckel för Azure**: nyckeln för det lagrings konto som är kopplat till klustret.
...
### <a name="step2"></a>Steg 2: skapa ett enkelt experiment i Azure Machine Learning för att förutse klickningar/inga klick
...
Här väljer du att ersätta alla saknade värden med 0. Det finns även andra alternativ, som du kan se genom att titta på list rutorna i modulen.

#### <a name="feature-engineering-on-the-data"></a>Funktions teknik för data
Det kan finnas miljon tals unika värden för vissa kategoriska-funktioner i stora data mängder. Det är helt omöjligt att använda naïve-metoder som enkel kodning för att representera sådana avancerade kategoriska-funktioner. Den här genom gången visar hur du använder funktionen Count med inbyggda Azure Machine Learning moduler för att generera kompakta representationer av dessa kategoriska variabler. Slut resultatet är en mindre modell storlek, snabbare inlärnings tider och prestanda mått som är relativt jämförbara med andra tekniker.
...
![bygga en beräknings modul för Transformations egenskaper](./media/hive-criteo-walkthrough/e0eqKtZ.png)
![bygga modulen för att beräkna en transformering](./media/hive-criteo-walkthrough/OdDN0vw.png)
...
Nu är fokus på en viktig punkt om att transformera våra träna-och test data innan de faktiskt genererar funktioner. Observera att det finns två **köra R-skript** moduler som används innan Count-transformeringen tillämpas på våra data.
...
### <a name="step3"></a>Steg 3: skapa, träna och Poäng modellen
...
För experimentet väljer du standardvärdena. Observera att standardvärdena är vanligt vis meningsfulla och ett bra sätt att få snabba bas linjer om prestanda. Du kan förbättra prestanda genom att svepa parametrarna om du väljer att använda en bas linje.
...
Slutligen bör du analysera modell prestanda. För två klassificerings problem för klass (Binary) är vanligt vis ett lyckat mått AUC. För att visualisera detta kan du ansluta modulen **Poäng modell** till en **modell för utvärderings** modell för detta. Att klicka på **visualisera** i modulen **utvärdera modell** ger en bild som liknar följande:

![Utvärdera modulen BDT modell](./media/hive-criteo-walkthrough/0Tl0cdg.png)

I binära (eller två klass-) klassificerings problem är ett utmärkt mått på förutsägelse noggrannhet den yta under kurvan (AUC). I följande avsnitt visas våra resultat med den här modellen i vår test data uppsättning. För att få detta, högerklickar du på utdataporten för modulen **utvärdera modell** och **visualiserar**sedan.

![Visualisera modell modul för bedömning](./media/hive-criteo-walkthrough/IRfc7fH.png)

### <a name="step5"></a>Steg 5: publicera modellen som en webb tjänst
...
Det gör du genom att först spara vår utbildade modell som ett tränat modell objekt. Det gör du genom att högerklicka på modulen **träna modell** och använda alternativet **Spara som tränad modell** .
...
Som ett Zeroth-steg, eftersom Count-tabellen är stor, tar några rader med test data och genererar utdata från den med Count-funktioner. Detta kan fungera som indata-format för vår WebService. Detta visas här:
...
Först ser det ut så här. Den grundläggande strukturen är en **modell för Poäng modell** som godkänner vårt tränade modell objekt och några rader med indata som genererades i föregående steg med upplärda-modulen **Count** . Använd "Välj kolumner i data uppsättning" för att projicera ut de resultat etiketter och poängen som är trolig.
...
Om du klickar på länken **förfrågan/svar** tas vi till en sida som ger oss före konserverad kod C#i, python och R. Den här koden kan enkelt användas för att ringa till webbtjänsten. Observera att API-nyckeln på den här sidan måste användas för autentisering.
...
Observera att standard-API-nyckeln har ersatts med våra WebServices API-nyckel. Om du klickar på **Kör** på den här cellen i en IPython Notebook får du följande svar:

![IPython-svar](./media/hive-criteo-walkthrough/KSxmia2.png)

I de två test exemplen som frågas om (i JSON-ramverket för python-skriptet) får du tillbaka svar i formatet "beskrivna etiketter, betyget antal sannolikheter". I det här fallet har standardvärdena valts som den före konserverande koden innehåller (0 gäller för alla numeriska kolumner och strängen "värde" för alla kategoriska-kolumner).

Detta avslutar vår genom gång som visar hur du hanterar storskalig data uppsättning med Azure Machine Learning. Du började med en terabyte data, konstruerat en förutsägelse modell och distribuerat den som en webb tjänst i molnet.
