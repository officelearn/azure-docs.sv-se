---
title: Kopiera Blob storage-data med AzCopy - Team Data Science Process
description: Kopieringsdata till och från Azure Blob Storage med AzCopy
...
ms.locfileid: "56209582"
---
# <a name="copy-data-to-and-from-azure-blob-storage-using-azcopy"></a>Kopieringsdata till och från Azure Blob Storage med AzCopy
...
## <a name="copy-blobs-between-azure-containers"></a>Kopiera blobar mellan Azure-behållare
Om du vill kopiera blobar mellan Azure-behållare, använder du följande kommando:
