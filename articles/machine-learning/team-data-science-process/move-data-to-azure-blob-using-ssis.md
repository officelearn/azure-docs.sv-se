...
När kunderna har flyttat lokala data till molnet kan de komma åt dem från valfri Azure-tjänst för att utnyttja den fulla kraften i serien med Azure-tekniker. Den kan användas, till exempel i Azure Machine Learning eller i ett HDInsight-kluster.

Detta är vanligt vis det första steget för genom gången av [SQL](sql-walkthrough.md) och [HDInsight](hive-walkthrough.md) .
...
För att utföra de uppgifter som beskrivs i den här artikeln måste du ha en Azure-prenumeration och ett Azure Storage-konto. Du måste känna till namnet på ditt Azure Storage-konto och din konto nyckel för att ladda upp eller hämta data.
...
* **Microsoft SQL Server 2014-eller 2016 Integration Services Feature Pack för Azure**: dessa kan hämtas från [SQL Server 2014-integrerings tjänster](https://www.microsoft.com/download/details.aspx?id=47366) och [SQL Server 2016 Integration Services](https://www.microsoft.com/download/details.aspx?id=49492) -sidor.
...
| **Sökväg** |Anger ett namn filter för att välja filer med angivet namn mönster. T. ex.\*. xls\* innehåller filer som MySheet001. xls och MySheetABC. xlsx |
