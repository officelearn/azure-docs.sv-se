...
3. **Hur ska du flytta data?** I följande avsnitt beskrivs metoderna och tillgängliga resurser för att mata in eller läsa in data i en mängd olika lagringsplatser och standardmiljöer för bearbetning.
...
1. **Vad kan du om dina data?** Utforska data när du vill få en förstå de grundläggande egenskaperna. Vad mönster eller trender den bevisföremål, vad avvikare har eller hur många värden som saknas. Det här steget är viktigt för att fastställa omfattningen av föregående bearbetning som krävs för utformningen av hypoteser som kan föreslå lämpligaste funktioner eller typ av analys och utforma planer för ytterligare data samlas. Beräkna beskrivande statistik och rita visualiseringar är värdefulla metoder för kontroll av data. Mer information om hur du utforskar en datamängd i olika Azure-miljöer finns [utforska data i Team av vetenskapliga data](explore-data.md).
