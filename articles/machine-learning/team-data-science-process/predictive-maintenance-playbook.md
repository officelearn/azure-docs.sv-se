...
![Bild 1. Löpande aggregerade funktioner](./media/predictive-maintenance-playbook/rolling-aggregate-features.png)
...
![Figur 2. Rullande aggregerade funktioner](./media/predictive-maintenance-playbook/tumbling-aggregate-features.png)
...
Det rekommenderade sättet är att dela upp exemplen i utbildning och validerings uppsättning i ett _tidsberoende_ sätt, där alla verifierings exempel är senare i tid än alla inlärnings exempel. För varje uppsättning finjustering värden, träna algoritmen utifrån datauppsättningar för utbildning. Mät modellens prestanda över samma validerings uppsättning. Välj finjustering värden som visar bästa möjliga prestanda. Finjustering värdena som väljs av träna/verifiering dela resulterar i bättre framtida modellens prestanda än med de värden som väljs slumpmässigt av korsvalidering.
...
![Bild 7. Tidsberoende dela upp för binär klassificering](./media/predictive-maintenance-playbook/time-dependent-split-for-binary-classification.png)
...
| [LinkedIn-utbildning](https://www.linkedin.com/learning) | Offentlig |
