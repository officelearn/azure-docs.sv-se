...
En självstudiekurs visar hur skapar ett TDSP projekt i Azure Machine Learning arbetsstationen finns [Team datavetenskap processen Självstudier: klassificera UCI inkomster i Azure Machine Learning arbetsstationen](../preview/scenario-tdsp-classifying-us-incomes.md) 
...
Ett exempel som använder ett TDSP instansierad projekt i Azure Machine Learning arbetsstationen finns [biomedicinska entitet bokföring med hjälp av naturligt språk bearbetning med djup Learning](../preview/scenario-tdsp-biomedical-recognition.md)
