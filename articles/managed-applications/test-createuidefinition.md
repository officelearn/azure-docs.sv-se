---
title: Testa användar gränssnitts definitionen för Azure Managed Applications | Microsoft Docs
...
Ange värden för fälten. När du är klar visas de värden som skickas till mallen.
