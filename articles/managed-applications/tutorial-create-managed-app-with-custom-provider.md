...
> * Skapa distributions mal len med Azure anpassad Provider, Azure Storage konto och Azure Function
...
2. I **Center för hanterade program**väljer du **tjänst katalog program definition** och klickar på **Lägg till**. 
    ...
    ![Lägg till tjänst katalog](./media/managed-application-with-custom-providers/service-catalog-managed-application.png)
...
3. Ange värden för att skapa en tjänst katalog definition:
    ...
    * För en **paket fil-URI**anger du sökvägen till zip-filen som du skapade i föregående steg.
    ...
    ![Ange värden](./media/managed-application-with-custom-providers/add-service-catalog-managed-application.png)

4. När du kommer till avsnittet autentisering och lås nivå väljer du **Lägg till auktorisering**.

    ![Lägg till auktorisering](./media/managed-application-with-custom-providers/add-authorization.png)

5. Välj en Azure Active Directory grupp för att hantera resurserna och välj **OK**.

   ![Lägg till auktoriseringsregel](./media/managed-application-with-custom-providers/add-auth-group.png)

6. När du har angett alla värden väljer du **skapa**.

   ![Skapa definition av hanterade program](./media/managed-application-with-custom-providers/create-service-catalog-definition.png)
...
2. I den **hanterade program Center**väljer du **tjänst katalog program** och klickar på **Lägg till**. 
    ...
    ![Lägg till hanterat program](./media/managed-application-with-custom-providers/add-managed-application.png)
...
3. På sidan **tjänst katalog program** anger du visnings namn för tjänst katalog definition i sökrutan. Välj den definition som skapades i föregående steg och klicka på **skapa**.
    ...
    ![Välj tjänstkatalog](./media/managed-application-with-custom-providers/select-service-catalog-definition.png)
...
4. Ange värden för att skapa en hanterad program instans från tjänst katalog definitionen:
    ...
    * Ange ett unikt namn på Azure-Function och Azure Storage konto namn.
    ...
    ![Programinställningar](./media/managed-application-with-custom-providers/application-settings.png)

5. När verifieringen är klar klickar du på **OK** för att distribuera en instans av ett hanterat program. 
    
    ![Distribuera hanterat program](./media/managed-application-with-custom-providers/deploy-managed-application.png)
...
![Utför anpassad åtgärd](./media/managed-application-with-custom-providers/perform-custom-action.png)

* Gå till sidan användare och klicka på knappen Lägg till. Ange indata för att skapa en resurs och skicka formuläret:

![Skapa anpassad resurs](./media/managed-application-with-custom-providers/create-custom-resource.png)

* Gå till sidan användare, Välj en "användare"-resurs och klicka på "anpassad kontext åtgärd":

![Skapa anpassad resurs](./media/managed-application-with-custom-providers/perform-custom-resource-action.png)
