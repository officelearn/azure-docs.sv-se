...
**Drivrutinsspecifika** | **Länkar** | **Kompatibla versioner** | **Inkompatibla versioner** | **Anteckningar**
---|---|---|---|---
...
Node.js |  [MySQLjs på GitHub](https://github.com/mysqljs/mysql/) <br> Installations paket från NPM:<br> Köra `npm install mysql` från NPM | 2,15 | 2.14.1 och före
GO | https://github.com/go-sql-driver/mysql/releases | 1,3, 1,4 | 1,2 och före | Använd `allowNativePasswords=true` i anslutnings strängen för version 1,3. Version 1,4 innehåller en korrigering och `allowNativePasswords=true` inte längre krävs.
