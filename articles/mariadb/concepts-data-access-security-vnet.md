...
- Att aktivera på virtuella nätverksslutpunkter till Azure-databas för MariaDB med hjälp av den **Microsoft.Sql** tjänsttagg gör det också möjligt för slutpunkterna för alla Azure-databastjänster: Azure Database for MariaDB, Azure Database för MySQL, Azure Database för PostgreSQL, Azure SQL Database och Azure SQL Data Warehouse.
