...
> [!NOTE]
> Replikering mellan regioner är i för hands version.
...
Det här måttet beräknas med `seconds_behind_master` måttet som är tillgängligt i MariaDB `SHOW SLAVE STATUS` kommandot.
