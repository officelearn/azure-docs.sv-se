---
title: Konfigurera måttaviseringar - Azure portal - Azure Database för MariaDB
description: I den här artikeln beskrivs hur du konfigurerar och får tillgång till måttaviseringar för Azure Database för MariaDB från Azure-portalen.
author: ajlam
ms.author: andrela
ms.service: mariadb
ms.topic: conceptual
...
ms.locfileid: "79529025"
---
# <a name="use-the-azure-portal-to-set-up-alerts-on-metrics-for-azure-database-for-mariadb"></a>Använd Azure-portalen för att ställa in aviseringar om mått för Azure Database för MariaDB

Den här artikeln visar hur du konfigurerar Azure Database för MariaDB-aviseringar med Azure-portalen. Du kan få en avisering baserat på övervakningsmått för dina Azure-tjänster.
...
1. I [Azure-portalen](https://portal.azure.com/)väljer du den Azure-databas för MariaDB-server som du vill övervaka.

2. Under **avsnittet Övervakning** i sidofältet väljer du **Aviseringar** som visas:

   ![Välj varningsregler](./media/howto-alert-metric/2-alert-rules.png)

3. Välj **Lägg till måttvarning** (+ ikon).

4. Sidan **Skapa regel** öppnas enligt nedan. Fyll i den information som krävs:

   ![Lägg till måttaviseringsformulär](./media/howto-alert-metric/4-add-rule-form.png)
