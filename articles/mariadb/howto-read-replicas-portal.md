...
2. Välj den befintliga Azure Database for MariaDB-server som du vill använda som huvud server. Den här åtgärden öppnar den **översikt** sidan.
...
6. Välj plats för replik servern. Standard platsen är samma som för huvud servern.
   ...
   > [!NOTE]
   > Replikering mellan regioner är i för hands version. Om du vill veta mer om vilka regioner du kan skapa en replik i går du till [artikeln Läs replik begrepp](concepts-read-replicas.md). 
