---
title: Skapa och hantera skrivskyddade repliker i Azure Database for MariaDB
description: Den här artikeln beskriver hur du konfigurerar och hanterar skrivskyddade repliker i Azure Database for MariaDB med hjälp av portalen
author: ajlam
ms.author: andrela
ms.service: mariadb
ms.topic: conceptual
...
ms.locfileid: "67079033"
---
# <a name="how-to-create-and-manage-read-replicas-in-azure-database-for-mariadb-using-the-azure-portal"></a>Hur du skapar och hanterar läsa repliker i Azure Database for MariaDB med Azure portal

I den här artikeln får lära du dig att skapa och hantera skrivskyddade repliker i tjänsten Azure Database for MariaDB med Azure portal.
...
- En [Azure Database for MariaDB server](quickstart-create-mariadb-server-database-using-azure-portal.md) som ska användas som huvudserver.

> [!IMPORTANT]
> Läs replica-funktionen är endast tillgänglig för Azure-databas för MariaDB-servrar i generell användning eller Minnesoptimerade prisnivåer. Kontrollera huvudservern är i något av dessa prisnivåer.
...
2. Välj befintlig Azure Database for MariaDB-server som du vill använda som en. Den här åtgärden öppnar den **översikt** sidan.
...
5. Ange ett namn för replikservern.
    ...
    ![Azure Database for MariaDB - namn](./media/howto-read-replica-portal/replica-name.png)

6. Välj **OK** att bekräfta att skapa en replik.
...
När du har skapat replikservern, den kan visas från den **replikering** bladet.
   ...
   ![Azure Database for MariaDB - listan repliker](./media/howto-read-replica-portal/list-replica.png)
...
1. Välj master Azure Database for MariaDB-server i Azure-portalen. 
...
4. Välj **replikeringen stoppas**.
   ...
   ![Azure Database for MariaDB - replikeringen stoppas](./media/howto-read-replica-portal/stop-replication.png)

5. Bekräfta att du vill stoppa replikering genom att klicka på **OK**.

   ![Azure Database for MariaDB - replikeringen stoppas bekräfta](./media/howto-read-replica-portal/stop-replication-confirm.png)
...
3. Välj replikservern som du vill ta bort.
   ...
   ![Azure Database for MariaDB - ta bort repliken väljer server](./media/howto-read-replica-portal/delete-replica-select.png)
...
5. Skriv namnet på den repliken och klicka på **ta bort** att bekräfta borttagningen av repliken.  
   ...
   ![Azure Database for MariaDB - ta bort replik bekräfta](./media/howto-read-replica-portal/delete-replica-confirm.png)
...
2. Från den **översikt**väljer **ta bort**.
   ...
   ![Azure Database for MariaDB - ta bort master](./media/howto-read-replica-portal/delete-master-overview.png)

3. Skriv namnet på huvudservern och klicka på **ta bort** att bekräfta borttagningen av huvudservern.  

   ![Azure Database for MariaDB - ta bort master](./media/howto-read-replica-portal/delete-master-confirm.png)

## <a name="monitor-replication"></a>Övervakare för replikering

1. I den [Azure-portalen](https://portal.azure.com/), väljer du repliken Azure Database for MariaDB-server som du vill övervaka.
...
5. Visa replikeringsfördröjning för det valda tidsintervallet. Bilden nedan visar de senaste 30 minuterna för en stor arbetsbelastning.
