...
Den här artikeln beskriver hur du kan konfigurera en Azure Database for MariaDB-Server för att genomdriva anslutningar för en lägsta TLS-version för att gå igenom och neka alla anslutningar med lägre TLS-version och därmed förbättra nätverks säkerheten.
