---
title: Skapa en Azure-databas för MariaDB med en ARM-mall
description: I den här artikeln lär du dig hur du skapar en Azure Database for MariaDB-server med hjälp av en Azure Resource Manager mall.
author: mgblythe
ms.service: mariadb
ms.topic: quickstart
