---
title: CLI-skript - Skala server - Azure Database för MariaDB
...
Det här exemplet CLI-skriptet skalar beräkning och lagring för en enda Azure-databas för MariaDB-server efter att ha frågat måtten. Beräkning kan skala upp eller ned. Lagring kan bara skalas upp.
...
| [az mariadb server uppdatering](/cli/azure/mariadb/server#az-mariadb-server-update) | Uppdaterar egenskaperna för MariaDB-servern. |
...
- Läs mer om [Azure Database för MariaDB-beräkning och lagring](../concepts-pricing-tiers.md)
