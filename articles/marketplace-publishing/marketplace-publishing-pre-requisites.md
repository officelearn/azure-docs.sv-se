...
Det här är den prenumeration som du använder för att skapa VM-avbildningar och bilder att överlämna den [Azure Marketplace](https://azure.microsoft.com/marketplace/). Om du inte har en befintlig prenumeration sedan logga på https://account.windowsazure.com/signup?offer=ms-azr-0003p.
