...
### <a name="orders"></a>Order
#### <a name="monthly-view-panel-a"></a>Varje månad: panelen A
...
#### <a name="monthly-view-panel-b"></a>Varje månad: panelen B
...
* Order av Azure licenstypen)
* Order per Marketplace licenstyp


![Order Visa månadsvis panelen B][15]

#### <a name="trend-view-panel-c"></a>Trend vyn: panelen C
...
#### <a name="detailed-orders-data-panel-d"></a>Detaljerade order data: panelen D
...
#### <a name="detailed-usage-data-panel-d"></a>Detaljerad användningsdata: panelen D
  ...
  ![månatliga Resursanvändning panelen D hämta resultat][25]
...
* [Arbets- eller skolkonto](https://passwordreset.microsoftonline.com/)
