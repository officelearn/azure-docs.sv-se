...
Därefter kan du skapa en behållare i det lagringskontot med hjälp av den [NewAzureStorageContainer](http://msdn.microsoft.com/library/dn495291.aspx) cmdlet.
