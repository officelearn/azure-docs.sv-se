---
title: Företag processen bibliotek | Azure Marketplace
description: Förklaring av företag processen bibliotek och metoder.
...
En metod består av faser, uppgifter och milstolpar. Varje fas kan ha valfritt antal aktiviteter, vilket är obligatoriska. När alla aktiviteter i en fas har slutförts kan fasen markeras som slutförda. Du kan också skapa en milstolpe för när du planerar en fas ska slutföras. Följande metoder som ingår i ett projekt med LCS:

- Implementering
- Att steg
- Lär dig utveckling
- Migrera och skapa lösningar
- Använda lösningar

Se [LCS metodik](https://docs.microsoft.com/dynamics365/operations/dev-itpro/lifecycle-services/create-methodology) för mer information.
