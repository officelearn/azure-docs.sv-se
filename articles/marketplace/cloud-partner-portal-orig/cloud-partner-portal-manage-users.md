---
title: Hantera användare på partnerportalen i molnet
...
Cloud Partner Portal kan du lägga till användare med rollbaserad åtkomst till virtuell dator-erbjudanden. Det hjälper dig för att hantera åtkomst och behörighet när flera personer arbetar med erbjudanden.

Att **lägga till användare och tilldela roller** för publicering av erbjudande, Följ stegen nedan:

<a name="step-1-to-add-users-and-assign-roles-click-the-users-tab-on-the-left-side-navigation-pane"></a>Steg 1. Klicka på fliken användare i navigeringsfönstret till vänster om du vill lägga till användare och tilldela roller.
--------------------------------------------------------------------------------------------

![Fliken användare](./media/cloud-partner-portal-how-to-manage-users/userstab.png)
...
För närvarande kan endast ägare kan komma åt Azure Payouts och Azure-kund flikarna i insikter.
...
Om du vill ta bort en användare som har lagts till är allt du behöver göra Sök efter sin e-post på fliken användare och tryck sedan på Ta bort-knappen på höger sida.
