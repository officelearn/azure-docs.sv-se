---
title: Vanliga frågor om migrering till Partner Center | Azure Marketplace
description: Den här artikeln behandlar vanliga frågor om migrering av erbjudanden från Cloud Partner Portal till Partner Center.
author: anbene
...
---
# <a name="frequently-asked-questions-for-migrating-from-the-cloud-partner-portal-to-partner-center"></a>Vanliga frågor och svar om migrering från Cloud Partner Portal till Partner Center
...
Erbjudanden kommer att migreras till Partner Center från och med 13 april under månaden av maj. Under den här tids perioden kommer du att kunna komma åt Cloud Partner Portal som vanligt, förutom för den tid som du erbjuder för migrering.
När dina erbjudanden migreras har de statusen "låst – flytta till Partner Center", som visas i följande skärm bild. Den här migrerings perioden ska vara mindre än 24 timmar. Under den här tiden kan du inte göra några uppdateringar av dina erbjudanden. Du får ett e-postmeddelande när vi har slutfört migreringen av dina erbjudanden.

:::image type="content" source="media/migration-faq/all-offers-1.png" alt-text="Visar statusen för migrerade erbjudanden.":::
