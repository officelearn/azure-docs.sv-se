---
title: Publicera en mall för Azure-lösning | Microsoft Docs
...
- Azure Quickstart-mallar:
 ...
 - Aktivera [kundens användning attribution](./../azure-partner-customer-usage-attribution.md) för att spåra Azure-användning av kunders distributioner av programvara på Azure.
...
- Ange innehåll som uppfyller villkoren för ditt erbjudande ska visas på Azure Marketplace och i Azure-portalen.
...
1. Konfigurera följande **erbjuder identitet** fält i erbjuder inställningar.
    ...
    **Erbjudande-ID**
     ...
     En unik identifierare för erbjudandet i en utgivarprofil för. Detta ID visas i produkten URL: er, Azure Resource Manager-mallar och fakturering rapporter. Du kan endast använda gemena alfanumeriska tecken eller bindestreck (-). ID: T får inte sluta med ett bindestreck och kan ha högst 50 tecken. 
    >[!Note]
...
1. Välj **SKU: er**. 
    ...
    SKU-ID är en unik identifierare för SKU: N i ett erbjudande. ID:t visas i produktens webbadresser, Resource Manager-mallar och faktureringsrapporter. SKU-ID:
...
-   Undvik att placera texten på logotypen. Dessa riktlinjer innehåller ditt företag eller varumärke. Utseendet och känslan av din logotyp måste vara *fast* och du bör undvika att toningar.
