...
Lägg till de principer som hanterad App uppfyller. Läs mer om Azure resursprinciper, se [vad är Azure Policy?](https://docs.microsoft.com/azure/azure-policy/azure-policy-introduction) 
