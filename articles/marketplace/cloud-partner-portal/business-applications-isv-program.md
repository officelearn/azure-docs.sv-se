...
> [!IMPORTANT]
> Befintliga ISV-partner med *Dynamics 365 kundens engagemang*, *Dynamics 365 för finansiering och drift*, och *PowerApps* -program bör slutföra alla registrerings steg nedan före den **15 oktober 2019** för att undvika att befintliga erbjudanden tas bort från [Microsoft AppSource](https://appsource.microsoft.com).

För att kunna registrera och dra nytta av alla [möjligheter till teknik, marknadsföring och försäljning](https://partner.microsoft.com/solutions/business-applications/isv-overview) av Business Applications ISV Connect, ber vi befintliga ISV-partner (med *Dynamics CE* och *Ops* -erbjudanden) att utföra följande steg:

- [Konfigurera ditt Microsoft Partner Center-konto](#set-up-your-microsoft-partner-center-account).
- [Godkänn Business Applications-tillägget](#accept-the-business-applications-isv-program-addendum).
- [Konfigurera din fakturerings information](#set-up-your-billing-information).
- [Certifiera ditt program](#recertify-your-application)igen.

> [!IMPORTANT]
> Du måste slutföra alla stegen ovan innan du publicerar ändringarna i ett befintligt erbjudande.

## <a name="set-up-your-microsoft-partner-center-account"></a>Konfigurera ditt Microsoft Partner Center-konto

[Partner Center](https://partner.microsoft.com) är den plats där du kan hantera dina konto inställningar för programmet ISV Connect.

> [!NOTE]
> Det här steget kräver en *ägar* roll i Cloud Partner Portal för ditt konto och rollen *ägare* eller *chef* i Partner Center.

Om du redan har publicerat Dynamics CE eller Dynamics Ops-erbjudanden har troligen ditt Cloud Partner Portal (CPP)-konto redan migrerats och Aktiver ATS på Partner Center. Om inte kan du aktivera ditt partner Center-konto manuellt från din CPP Publisher-profil.
...
1. Gå till [instrument panelen för partner Center](https://partner.microsoft.com/dashboard/account/agreements) och logga in på Partner Center enligt uppmaning.
...
När du har slutfört stegen ovan är dina befintliga Dynamics CE-och Dynamics Ops-erbjudanden tillgängliga för redigering i Partner Center. Du kan också skapa nya erbjudanden via partner Center.
