...
| **Täcka\***                  | PNG-format för 255x115-bild                                                   |
| **Hjälte**                  | PNG-format för 815x290-bild.  Valfritt, men när du har laddat upp hjälte ikonen kan du inte ta bort den. |
| *Skärmbilder*  | Skärm dum par visas på produkt informations sidan. De är ett bra sätt att visuellt förmedla vad IoT Edge-modulen gör och hur det fungerar. Du kan visa arkitektur diagram eller användnings Falls illustrationer för en instans. Valfritt, men högst fem skärm bilder per SKU. |
| **Namn**                  | Namn eller rubrik. Maximal längd på 100 tecken.                             |
| **Bild**                 | Skärmdump-bild, 533x324 pixel PNG-format                               |
| *Videor*  | Videor visas på produkt informations sidan. De är ett bra sätt att visuellt förmedla vad IoT Edge-modulen gör och hur det fungerar. |
| **Namn**                  | Namn eller rubrik. Maximal längd på 100 tecken.                             |
