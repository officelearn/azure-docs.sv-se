---
title: Azure SaaS-erbjudande storefront programkonfiguration | Microsoft Docs
...
I följande tabell beskriver vad butik som du kan ange för erbjudandet.
...
Använd formuläret marknadsföring artefakter för att identifiera Azure Marketplace marknadsföring tillgångar som till exempel logotyper, videor, skärmbilder och dokument.

![Storefront marknadsföring artefakter formulär](./media/saas-storefront-artifacts.png)

I följande tabell beskrivs fälten för marknadsföring artefakter.
...
- URL till sekretess – ange en länk till din Apps sekretesspolicy.
- Villkor för användning – ange villkor för användning av din app. Kunder måste acceptera villkoren innan de kan testa din app.
