...
Logga in [på Partner Center](https://partner.microsoft.com/dashboard/account/v3/enrollment/introduction/partnership) eller Cloud Partner [Portal](https://cloudpartner.azure.com/) för att skapa och konfigurera ditt erbjudande.
