...
2.  Slutför `Help us protect your account` guiden som verifierar din identitet med hjälp av ditt telefonnummer eller din e-postadress.  
...
-->
3.  I `Registration - Account Info` avsnittet väljer du ditt konto land eller din region i den nedrullningsbara menyn *konto land/region* .  
<!--
...
-->
8.  I `Registration - Payment` avsnittet måste du ange din betalnings information för att betala för ditt dev Center-konto.  
...
-->
9.  I `Registration - Review` avsnittet granskar du konto informationen och kontrollerar att allt är korrekt.  
...
3.  Välj `Choose payment method` `Bank account` eller `PayPal`på sidan.  
    >[!IMPORTANT]
...
3.  På `Set up your tax form` sidan väljer du det land eller den region där du har permanent placering.  
