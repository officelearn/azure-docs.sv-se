...
Betala per användning Transact publicering alternativet används, din användningsbaserad programvarulicenser intäkter delas 80% / 20% mellan dig och Microsoft respektive. Ett erbjudande kan kostar betala per användning och ta med din egen licens fakturering modeller och kan nu finnas på nivån erbjudande som separata SKU: er. Detta kan konfigureras i erbjudandet i partnerportalen molnet.
...
Microsofts kunder använda ibland en Enterprise-avtal (EA) för Microsoft-produkter, inklusive Azure användning. Den här betalningsalternativ är utformad för organisationer som vill licens programvara och molntjänster under minst tre år. Kunder har du möjlighet att sprida betalningar i stället för en direkta betalning. När en kund med EA använder betala per användning Transact lista, följer fakturering för utgivarens programvarukostnader licens kvartalsvis EA överförbrukning faktureringsperioden.

### <a name="monetary-commitment"></a>Åtagandebelopp 

Samtliga Enterprise Agreement-kunder kan nu lägga till Azure i avtalet genom att betala ett åtagandebelopp till Azure. Åtagandebeloppet förbrukas sedan under året genom användningen av olika kombinationer av det breda utbud av molntjänster som Azure erbjuder via sina globala datacenter.

## <a name="prerequisites-for-marketplace-publishing"></a>Krav för Marketplace-publicering

### <a name="for-all-marketplace-publishing-options"></a>För alla Marketplace publiceringsalternativ
...
### <a name="prerequisites-specific-to-trial-publishing"></a>Krav för specifika att utvärderingsversion Publishing

|**Krav**  | **Detaljer**  |**Publiceringsalternativ**  |
|---------|---------|---------|
|**Utvärderingsperioden och utvärderingsversionen**     |  En kund måste kunna använda appen kostnadsfritt under en begränsad tid.<br>Det innebär att kunden inte krävas licens eller prenumeration avgifter för produkten eller kostnaden för den underliggande Microsoft från första part produkt eller tjänst. Eftersom alla alternativ för testversionen distribueras till utgivarens Microsoft-produkt prenumeration utvärderingsversion kostnad optimering och hantering kontrolleras endast av utgivaren.<br>Du kan välja en kostnadsfri utvärderingsversion, interaktiva demo eller testversionen. Oavsett vad du väljer erbjuda den kostnadsfria utvärderingsversionen kunden kortaste tid för att testa appen för utan extra kostnad.<br> Nå ut till cloudmarketplace@microsoft.com att starta processen med att skapa en Test-enhet. Obs: Azure Marketplace SaaS utvärderingsversion upplevelser måste tillåta användare att logga in med sina Active Directory fungerar autentiseringsuppgifter. [Läs mer.](https://docs.microsoft.com/en-us/azure/active-directory/develop/active-directory-devhowto-appsource-certified#appsource-trial-experiences) |   Utvärdering      | 
...
|**Azure Active Directory**    |    Erbjudandet måste tillåta Azure Active Directory federerad enkel inloggning (AAD federerad enkel inloggning) med samtycke aktiverad.      |  Utvärdering|

### <a name="prerequisites-specific-to-transact-publishing"></a>Krav som är specifika för Transact publicering
...
I det här avsnittet förklarar vi hur: ska bli en utgivare i Azure Marketplace och AppSource; och för att få åtkomst till partnerportalen moln som ska användas för att skapa, publicera och underhålla erbjudandet. 
...
Under processen kommer samla in adressen företagsinformation, bank kontoinformation och skatt information. Denna information kan du vanligtvis få från finans- eller affärsavdelningen. Dessutom måste du utföra följande Publisher profil komponenter för att utföra olika faser i erbjudandet skapa och distribuera:
...
**Stöd för Azure Marketplace Portal:**
