...
## <a name="azure-marketplace-and-appsource-storefronts"></a>Azure Marketplace och AppSource skyltfönster
...
Marketplace-skyltfönster justeras till målgrupper och Microsoft cloud-produkter som hjälper kunder att söka efter de behöver. Varje storefront erbjuder specialiserade publiceringsalternativ som hjälper dig att maximera investeringen publishing. I följande tabell sammanfattas dessa alternativ:
...
## <a name="using-the-storefronts"></a>Med skyltfönster
...
Engagera IT-proffs och utvecklare molnet via Azure Marketplace för att upptäcka, försök och köpa IaaS, SaaS och PaaS-lösningar:
...
Engagera företagsanvändare på AppSource att hitta, försök och hämta line-of-business SaaS-program och implementeringstjänster för att enheten verksamhetsresultat och minska tiden för värden: 
...
Om du väljer en storefront börjar med att identifiera målgrupp för ditt erbjudande. Azure Marketplace justeras efter behoven för IT-proffs och utvecklare. AppSource justeras efter behoven för användare i verksamheten. Om din lösning riktar sig till båda målgrupper, måste du publicera bara en gång i listan i båda skyltfönster.
...
## <a name="publishing-options"></a>Publiceringsalternativ
...
#### <a name="pay-as-you-go-and-bring-your-own-license-billing-options"></a>Betala per användning och Bring Your Own License fakturering alternativ
...
### <a name="single-billing-and-payment-methods"></a>Metoderna Single fakturering och betalning
...
### <a name="monetary-commitment"></a>Summa 
...
### <a name="prerequisites-for-all-marketplace-publishing-options"></a>Krav för alla Marketplace publiceringsalternativ
...
### <a name="certify-your-azure-ad-integration-for-the-marketplace-multitenant-applications"></a>Certifiera din Azure AD-integrering för Marketplace: flera program
...
## <a name="cloud-partner-portal-pre-publishing-checklist-for-the-azure-marketplace"></a>Molnet partnerportalen före publishing checklista för Azure Marketplace
...
I det här avsnittet förklarar vi hur du:

- Bli en utgivare i Azure Marketplace och AppSource.
- Få åtkomst till partnerportalen molnet. Den portalen ska du använda för att skapa, publicera och underhålla erbjudandet. 
...
Via publiceringsprocessen hela marketplace, kan du använda en e-postadress som identifierar Marketplace-konto. E-postadressen måste vara registrerad som ett Microsoft-ID och används för både den [Microsoft Developer Center](https://developer.microsoft.com/) och [moln partnerportalen](https://cloudpartner.azure.com/). 
...
- [Azure Marketplace kandidat formulär](http://aka.ms/listonazuremarketplace)   
- [AppSource kandidat formulär](http://aka.ms/listonappsource)

När du har skickat formuläret granska programmet Marketplace-teamet och verifiera begäran. När begäran har granskat meddelas via e-post med nästa steg för att bli en godkända partner i partnerportalen molnet.
...
Under processen kan vi samla in adressen företagsinformation, bank kontoinformation och skatt information. Denna information kan du vanligtvis få från finans- eller affärsavdelningen. Dessutom måste du utföra följande publisher profil komponenter för att slutföra de olika faserna i erbjudandet skapa och distribuera:
...
### <a name="guidelines-for-creating-a-microsoft-id-to-manage-an-azure-marketplace-account"></a>Riktlinjer för att skapa ett Microsoft-ID för att hantera ett konto i Azure Marketplace
