...
Det här talet representerar knappen för **att** Klicka på slutförd på sidan erbjudande på sidan erbjudande (produkt informations sida). **Anrop till åtgärden** räknas när knapparna **Hämta nu**, **kontakta mig**och **testa enhet** är markerade.
