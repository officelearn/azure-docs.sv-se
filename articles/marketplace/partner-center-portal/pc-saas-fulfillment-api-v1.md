...
Dokumentationen för den här versionen av API: t är inte längre tillgänglig. Kontakta om du tycker att du behöver åtkomst till den saas-api-v1@microsoft.com .

För all ny utveckling flyttar du till [v2-versionen av API: et](./pc-saas-fulfillment-api-v2.md) även om du redan använder v1. Den här versionen kommer att vara helt inaktuell i framtiden.
