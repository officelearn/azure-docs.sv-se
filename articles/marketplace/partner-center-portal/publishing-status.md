...
Läs mer om content verifieringsvillkoren genom att läsa den [Allmän lista principer](https://docs.microsoft.com/legal/marketplace/certification-policies#100-general-policies).
