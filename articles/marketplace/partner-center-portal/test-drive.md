---
title: Konfigurera test enheter på Microsofts kommersiella marknads platser
...
ms.locfileid: "82786554"
---
# <a name="learn-about-test-drive-for-your-offer"></a>Lär dig mer om test enheten för ditt erbjudande

Med alternativet **testa enhet** på Microsofts kommersiella marknads plats kan du konfigurera en praktisk guidad visning av produktens viktiga funktioner. Med en testen het kan nya kunder prova ditt erbjudande innan de genomför köpet. Mer information finns i [Vad är Test Drive?](../cloud-partner-portal/test-drive/what-is-test-drive.md).

Om du inte längre vill ange en testen het för ditt erbjudande går du tillbaka till sidan **erbjudande konfiguration** och avmarkerar **Aktivera test enhet**.
...
Det finns en distributions mal len som innehåller alla Azure-resurser som utgör din lösning. Detta passar produkter som bara använder Azure-resurser. Läs mer om hur du konfigurerar en [Azure Resource Manager test-enhet](../cloud-partner-portal/test-drive/azure-resource-manager-test-drive.md).
...
- **Videor: Lägg till videor** (valfritt): videor kan laddas upp till YouTube eller Vimeo och refereras till med en länk och miniatyr bild (533 x 324 bild punkter) så att en kund kan visa en genom gång av information för att hjälpa dem att bättre förstå test enheten, inklusive hur du kan använda funktionerna i ditt erbjudande och förstå scenarier som fokuserar på deras fördelar.
  ...
  - **Miniatyr bild (533 x 324 BPT)** – bild filen måste vara i PNG-format.
