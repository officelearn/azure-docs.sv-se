...
## <a name="listing-options"></a>List alternativ
...
Alternativet _Hämta nu (kostnads fri)_, _kostnads fri utvärderings version_och _försäljning via Microsoft_ List Options har följande tekniska krav:
