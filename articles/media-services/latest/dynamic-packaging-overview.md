...
I Media Services används dynamisk paketering om direktuppspelning på begäran eller Live.
...
4. Skapa URL: er som är riktade till olika format (HLS, Dash och Smooth Streaming). Slutpunkt för direktuppspelning skulle ta hand om betjänar rätt manifestet och begäranden för dessa olika format.
