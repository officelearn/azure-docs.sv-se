...
ms.locfileid: "54912654"
---
# <a name="azure-media-services-entities-overview"></a>Översikt över entiteter i Azure Media Services

Den här artikeln ger en kort översikt över Azure Media Services entiteter och punkter till artiklar för mer information om hur varje entitet används i Media Services-arbetsflöden. 
