...
- Kunder måste hämta manifestet manuellt och analysera den exakta start tids stämplingen och tids skalan.
    ...
    - Formeln för att ange tids stämplings egenskaper för till gångs filter är: <br/>startTimestamp = &lt;start tid i manifestet&gt; +  &lt;förväntad filter start tid i sekunder&gt; * tids skala
