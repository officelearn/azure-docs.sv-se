...
Om du vill visa alla REST API transformeringar som är tillgängliga, se [Transforms-Create eller Update](/rest/api/media/transforms/createorupdate#definitions).
