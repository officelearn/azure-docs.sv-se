...
Detaljerad översikt finns i [Azure Monitor Metrics](../../azure-monitor/platform/data-collection.md) och [Azure Monitor diagnostiska loggar](../../azure-monitor/platform/diagnostic-logs-overview.md).
