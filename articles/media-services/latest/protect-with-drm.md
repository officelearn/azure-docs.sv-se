...
Det tar lite tid att slutföra jobbet. När du gör det, vill du bli meddelad. Kodexemplet nedan visar hur du kontrollerar **jobbets** status i tjänsten. Avsökningen är inte en rekommenderad metod för produktion av appar på grund av potentiell latens. Avsökningen kan begränsas om den överanvänds på ett konto. Utvecklare bör i stället använda Event Grid. Se [Dirigera händelser till en anpassad webbslutpunkt](job-state-events-cli-how-to.md).
