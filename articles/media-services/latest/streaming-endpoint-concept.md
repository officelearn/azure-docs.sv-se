...
|`cdnProvider`|När CDN är aktiverat kan du även skicka `cdnProvider` värden. `cdnProvider` styr vilken provider som ska användas. För närvarande stöds tre värden: ”StandardVerizon”, ”PremiumVerizon” och ”StandardAkamai”. Om inget värde anges och `cdnEnabled` är true, ”StandardVerizon” används (som är standardvärdet.)|
