...
![Direktsända video analyser baserade på en extern inferencing-modul](./media/analyze-live-video/external-inferencing-module.png)
...
![Direktsända video analyser baserat på rörelse identifierade ramar via extern inferencing-modul](./media/analyze-live-video/motion-detected-frames.png)
