---
title: gRPC-tilläggs data kontrakt – Azure
...
I den här artikeln får du lära dig att använda gRPC-protokollet för att skicka meddelanden mellan Live Video Analytics-modulen och ditt AI-eller CV-tillägg.
...
![Protokoll meddelanden](./media/data-contracts/grpc2.png)
