...
Ditt medie tjänst konto är länkat till ett Azure Storage konto och när du spelar in video i molnet skrivs innehållet till en medie tjänst [till gång](../latest/assets-concept.md). Varje till gång mappas till en behållare i lagrings kontot. med livs cykel hantering kan du definiera en [princip](https://docs.microsoft.com/azure/storage/blobs/storage-lifecycle-management-concepts?tabs=azure-portal#policy) för ett lagrings konto, där du kan ange en [regel](https://docs.microsoft.com/azure/storage/blobs/storage-lifecycle-management-concepts?tabs=azure-portal#rules) som följande.
...
* Anger att när blobar åldras efter 30 dagar flyttas de från frekvent [åtkomst nivå till](https://docs.microsoft.com/azure/storage/blobs/storage-blob-storage-tiers?tabs=azure-portal)låg frekvent.
...
* Princip uppdateringar för livs cykel hantering är inte omedelbart. Mer information finns i [avsnittet Vanliga frågor och svar](https://docs.microsoft.com/azure/storage/blobs/storage-lifecycle-management-concepts?tabs=azure-portal#faq) .
