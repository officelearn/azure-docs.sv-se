...
Det här avsnittet innehåller information om **Azure Media rörelsedetektor** och visar hur du använder det med Media Services SDK för .NET
...
| --- | --- | --- | --- |
| sensitivityLevel |Sträng: låg, 'medium', 'hög' |Anger Känslighetsnivån på vilka rörelser rapporteras. Justera det här för att justera mängden falska positiva identifieringar. |-medium' |
...
Rörelse detektor API innehåller indikatorer när det finns objekt i rörelse i en fast bakgrund video (t.ex. övervakning av video). Den rörelsedetektor utbildade att minska falsklarm, till exempel ljus och shadow ändringar. Aktuella begränsningar av algoritmerna är natt vision videor, delvis transparenta objekt och små objekt.
...
| Regioner |Refererar till området i videon där du är intresserad rörelse. <br/><br/>-”id” representerar region – i den här versionen finns bara en, ID 0. <br/>-”typ” representerar formen för den region som intresserar dig för rörelse. För närvarande stöds ”rektangel” och ”polygon”.<br/> Om du har angett ”rektangel”, har regionen dimensioner i X, Y, bredd och höjd. X och Y-koordinaterna representerar Xyserver övre vänstra koordinaterna för region i intervallet 0,0 till 1,0 normaliserade skalan. Visar storleken på regionen i en normaliserade skala med 0,0 till 1,0 bredd och höjd. I den aktuella versionen korrigeras alltid X, Y, bredd och höjd på 0, 0 och 1, 1. <br/>Om du har angett ”polygon”, har regionen dimensioner i punkter. <br/> |
...
* Vissa rörelse kanske inte identifieras på grund av tekniska utmaningar; t.ex. natt vision videor, delvis transparenta objekt och små objekt.
...
2. Skapa ett jobb med en aktivitet för identifiering av video rörelse baserat på en konfigurationsfil som innehåller följande json-förinställning. 
