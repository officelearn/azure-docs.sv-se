...
[PlayReadyLicenseResponseTemplate](https://msdn.microsoft.com/library/azure/microsoft.windowsazure.mediaservices.client.contentkeyauthorization.playreadylicenseresponsetemplate.aspx) -den här klassen representerar mallen för svar som skickas tillbaka till användaren. Den innehåller ett fält för en anpassad sträng mellan licensservern och programmet (kan vara användbart för anpassad app logik) samt en lista över mallar för en eller flera licens.

Det här är klassen ”toppnivå” i hierarkin för mallen. Vilket innebär att svar-mallen innehåller en lista över licens mallar och licens-mallar innehåller (direkt eller indirekt) alla andra klasser som utgör mallens data för att kunna serialiseras.
...
Ett exempel på vilka skydd nivåer har stöd för Silverlight finns: [Silverlight stöd för skydd av utdata](http://go.microsoft.com/fwlink/?LinkId=617318).
