...
Det här avsnittet visar hur du använder Azure-portalen för att hantera strömningsslutpunkter. 

>[!NOTE]
>Se till att granska den [översikt](media-services-streaming-endpoints-overview.md) avsnittet. 

Information om hur du skalar den strömmande slutpunkten finns [detta](media-services-portal-scale-streaming-endpoints.md) avsnittet.
...
>[!NOTE]
>När CDN är aktiverat kan du inte använda IP-åtkomst. IP-åtkomst kan bara användas när du inte har CDN.
...
CDN-integrering har aktiverats i Azure data Datacenter execpt Kina och Federal Government regioner.

När den har aktiverats på **åtkomstkontroll**, **anpassad hostname** och **autentisering med Akamai signatur** konfigurationen hämtar inaktiverad.
