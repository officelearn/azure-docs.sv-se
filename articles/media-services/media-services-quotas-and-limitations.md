...
description: "Det här avsnittet beskrivs kvoter och begränsningar som är associerade med Microsoft Azure Media Services."
...
## <a name="open-a-support-ticket-to-request-changes-to-the-default-quotas"></a>Öppna ett supportärende för att begära ändringar i standard kvoterna
