...
RowKey|{sekunder till midnatt} _ {slumpmässigt värde}|01688_00199<br/><br/>Radnyckeln börjar med antalet sekunder som midnatt till att tillåta övre n format frågor inom en partition. Mer information finns i [detta](../cosmos-db/table-storage-design-guide.md#log-tail-pattern) artikel. 
