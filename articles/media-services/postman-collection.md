 ---
Rubrik: importera Postman samlingen med strömning på begäran med Azure operations beskrivning: den här artikeln innehåller en definition av samlingen Postman för Azure Media Services REST-anrop.
