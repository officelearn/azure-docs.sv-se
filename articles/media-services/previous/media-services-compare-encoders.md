...
|[Loudness-korrigering för Dolby® Professional](https://www.dolby.com/us/en/technologies/dolby-professional-loudness-solutions.pdf)<br/> med dialog intelligens™|Nej|Ja|
...
## <a id="billing"></a>Fakturerings mätare som används av varje kodare
...
| Indatafil/fil format | Media Encoder Standard | Arbetsflöde för Media Encoder Premium |
| --- | --- | --- |
...
| Codec för inspelning av video | Media Encoder Standard | Arbetsflöde för Media Encoder Premium |
| --- | --- | --- |
| AVC 8-bitar/10-bit, upp till 4:2:2, inklusive AVCIntra |8-bitars 4:2:0 och 4:2:2 |Ja |
...
| Inmatade ljud-codec | Media Encoder Standard | Arbetsflöde för Media Encoder Premium |
| --- | --- | --- |
...
| MPEG-2 (upp till 422 profil och hög nivå, inklusive varianter som XDCAM, XDCAM HD, XDCAM IMX, CableLabs® och D10) |Nej |Ja |
| MPEG-1 |Nej |Ja |
