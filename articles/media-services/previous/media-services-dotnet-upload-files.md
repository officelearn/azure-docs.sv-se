...
ms.locfileid: "55984230"
---
# <a name="upload-files-into-a-media-services-account-using-net-legacy"></a>Överföra filer till ett Media Services-konto med hjälp av .NET (äldre)
