...
Den här artikeln visar hur du skapar indexering jobb till **Index för en tillgång** och **flera indexfiler**.
...
Manifestfilen med tillägget ”.lst” har skapats och ladda upp till tillgången. Manifestfilen innehåller listan över alla tillgångsfiler som. Mer information finns i [aktivitet förinställningen Azure Media indexer](https://msdn.microsoft.com/library/dn783454.aspx).
