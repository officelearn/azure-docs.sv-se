...
Information om hur du konfigurerar [TriCaster](https://newtek.com/products/tricaster-40.html) -kodare för att skicka en enda bit Ströms bit ström till en AMS-kanal finns i [Konfigurera TriCaster](media-services-configure-tricaster-live-encoder.md).

## <a name="elemental-live"></a>Elemental Live
Mer information finns i [grundämne Live](https://www.elementaltechnologies.com/products/elemental-live).
