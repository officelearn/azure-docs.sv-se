...
description: Det här avsnittet ger en översikt över Media Encoder Standard format och codecs.
...
| HEVC/H. 265| Main-och main-&#42;profiler ()<br/>Huvud support för 10 profiler är avsett för 8bit 4:2:0-innehåll. |
