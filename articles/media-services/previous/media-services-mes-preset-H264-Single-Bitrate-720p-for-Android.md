---
title: H264, Enkel bithastighet, 720p för Android | Microsoft Docs
description: Avsnittet ger en översikt över den **H264, enkel bithastighet, 720p för Android** uppgiften förinställd.
author: Juliako
manager: femila
editor: ''
...
ms.date: 02/10/2019
ms.author: juliako
ms.openlocfilehash: 5146559fc72508ed6cc620fe37d6cba9d357effe
ms.sourcegitcommit: 5fbca3354f47d936e46582e76ff49b77a989f299
ms.translationtype: MT
ms.contentlocale: sv-SE
ms.lasthandoff: 03/12/2019
ms.locfileid: "57768969"
---
...
Det här avsnittet beskrivs de `H264 Single Bitrate 720p for Android` förinställda i XML- och JSON-format.  
  
Den här förinställda ger en enda MP4-filen med en bithastighet 2000 kbit/s och stereo AAC. Detaljerad information om profilen med flera bithastigheter, sampling hastighet och så vidare på detta förinställda ska undersöka XML eller JSON som definieras nedan. Förklaringar av vad varje element i dessa förinställningar innebär och de giltiga värdena för varje element finns i den [Media Encoder Standard schemat](media-services-mes-schema.md) avsnittet.  
