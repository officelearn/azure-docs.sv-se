...
|---|---|---|
| **S1**|Enkel bithastighet kodning. <br/>Filer på SD eller under lösningar, tid inte känsliga, låg kostnad.|Koda till en enda bithastighet MP4-fil med samma upplösning tar cirka 5 minuter.|
