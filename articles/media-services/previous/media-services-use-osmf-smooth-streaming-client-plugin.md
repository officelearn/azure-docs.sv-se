...
2. Spara HTML-sidan och publicera på en webb server. Bläddra till den publicerade webb sidan med din favorit&reg; Player-aktiverad webbläsare (Internet Explorer, Chrome, Firefox, så vidare).
