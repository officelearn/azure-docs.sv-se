...
Den här artikeln beskriver stegen för att migrera från den äldre Windows Azure Media Encoder-processorn (WAME), som dras tillbaka den 1 mars 2020, till Media Encoder Standard medie processor.
