...
|---|---|---|
|Medie insikter|[Optimerad](video-indexer-output-json-v2.md) |[Grunderna](../latest/intelligence-concept.md)|
...
|Efterlevnad|De mest aktuella uppdateringarna finns i [Azure Compliance-erbjudanden. pdf](https://gallery.technet.microsoft.com/Overview-of-Azure-c1be3942/file/178110/23/Microsoft%20Azure%20Compliance%20Offerings.pdf) och Sök efter "video Indexer" för att se om det överensstämmer med ett intresse bevis.|De mest aktuella uppdateringarna finns i [Azure Compliance-erbjudanden. pdf](https://gallery.technet.microsoft.com/Overview-of-Azure-c1be3942/file/178110/23/Microsoft%20Azure%20Compliance%20Offerings.pdf) och Sök efter "Media Services" för att se om det överensstämmer med ett intresse bevis.|
