...
[Artikel 7: Rehost en Linux-app på virtuella Azure-datorer](contoso-migration-rehost-linux-vm.md) | Visar hur Contoso migrerar app virtuella datorer till Azure med Site Recovery. | Planerad
[Artikel 8: Rehost en Linux-app till Azure virtuella datorer och Azure MySQL-Server](contoso-migration-rehost-linux-vm-mysql.md) | Visar hur Contoso migrerar app virtuella datorn med Site Recovery och använder MySQL-arbetsstationen för att migrera till en Azure MySQL Server-instans. | Planerad
...
- **osTicket**: en öppen källkod helpdesk biljetter app som körs på Linux. Du kan ladda ned det från [GitHub](https://github.com/osTicket/osTicket). Aktuella appen är på två virtuella VMware-datorer kör Ubuntu 16.04LTS, som använder Apache 2, PHP 7.0 och MySQL 5.7
