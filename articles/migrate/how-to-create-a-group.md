...
1. Klicka på **utvärdera och migrera servrar**i > **Översikt**för Azure Migrate projekt. I **Azure Migrate: Server utvärdering**, klicka på **grupper**
    - Om du ännu inte har lagt till Azure Migrate: Server utvärderings verktyg, klicka för att lägga till det. [Läs mer](how-to-assess.md).
...
1. På fliken **servrar** i **Azure Migrate: Panelen Server** utvärdering, klicka på **grupper**.
