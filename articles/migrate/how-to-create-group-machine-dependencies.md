...
- [Lär dig mer](https://docs.microsoft.com/azure/azure-monitor/platform/log-analytics-agent#install-and-configure-agent) om att använda dessa metoder för att installera MMA-agenten.
