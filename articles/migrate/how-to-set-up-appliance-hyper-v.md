...
3.  För version 2.19.11.12 ska den genererade hashen matcha de här [inställningarna](https://docs.microsoft.com/azure/migrate/tutorial-assess-hyper-v#verify-security).
