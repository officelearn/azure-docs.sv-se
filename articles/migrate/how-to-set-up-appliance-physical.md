---
title: Konfigurera en installation för utvärdering av fysiska servrar med Azure Migrate Server-utvärdering
description: Beskriver hur du konfigurerar en installation för att utvärdera fysiska servrar med Azure Migrate Server bedömning.
