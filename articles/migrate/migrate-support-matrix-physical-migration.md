...
**UEFI-start** | Den migrerade datorn i Azure kommer automatiskt att konverteras till en BIOS-startvm.<br/><br/> OS-disken bör ha upp till fyra partitioner och volymer ska formateras med NTFS.
