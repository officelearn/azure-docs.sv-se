---
title: Stöd för VMware i Azure Migrate
description: Lär dig mer om VMware Assessment/migration support i Azure Migrate.
ms.topic: conceptual
ms.date: 01/02/2020
...
**Aktivitet** | **Behörigheter som krävs**
--- | ---
Endast utvärdering | vCenter Server skrivskyddat konto.
Utvärdering med [app-Discovery](how-to-discover-applications.md) eller [agent utan agent för beroende visualisering](how-to-create-group-machine-dependencies-agentless.md) | vCenter Server konto med skrivskyddad åtkomst och behörigheter som har Aktiver ATS för **virtuella datorer** > **gäst åtgärder**.
