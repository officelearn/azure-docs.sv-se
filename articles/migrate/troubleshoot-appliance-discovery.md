...
- Azure Migrate kan inte identifiera virtuella VMware-datorer om vCenter-kontot har åtkomst beviljad på nivån vCenter VM Folder. [Läs mer](tutorial-assess-vmware.md#set-the-scope-of-discovery) om omfattnings identifiering.
