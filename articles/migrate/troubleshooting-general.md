...
| 752       | InvalidvCenterEndpoint         | Servern %Name; är inte en vCenter Server.                                  | Ange vCenter-serverinformationen.                                                                       | Försök åtgärden igen med korrekt vCenter Server-information.                                                                                   | 
| 753       | InvalidLoginCredentials        | Det gick inte att ansluta till vCenter-servern % Name; på grund av felet: % ErrorMessage; | Anslutning till vCenter-servern misslyckades på grund av ogiltiga inloggningsuppgifter.                             | Kontrollera att de angivna autentiseringsuppgifterna för inloggning är korrekta.                                                                                    | 
| 754       | NoPerfDataAvaialable           | Prestandadata är inte tillgängliga.                                               | Kontrollera statistik nivå i vCenter Server. Det bör anges till 3 för prestandadata som ska vara tillgängliga. | Ändra statistik nivå 3 (till 5 minuter, 30 minuter och 2 timmar varaktighet) och försök vänta minst en dag.                   | 
...
| 757       | VMNotFound                     | Det gick inte att hitta virtuell dator                                                  | Virtuell dator kan tas bort: % VMID;                                                                | Se till att de virtuella datorerna som är markerade när målgrupp vCenter lager finns under identifieringen                                      | 
| 758       | GetPerfDataTimeout             | VCenter begäran överskreds. Meddelande % Message;                                  | vCenter är-servern felaktigt                                                              | Kontrollera vCenter serverautentiseringsuppgifter och se till att vCenter-servern kan nås. Försök igen. Kontakta supporten om problemet kvarstår. | 
| 759       | VmwareDllNotFound              | VMWare.Vim DLL-filen hittades inte.                                                     | PowerCLI har inte installerats korrekt.                                                                   | Kontrollera om PowerCLI är korrekt installerad. Försök igen. Kontakta supporten om problemet kvarstår.                               | 
| 800       | ServiceError                   | Tjänsten Azure Migrate Collector körs inte.                               | Tjänsten Azure Migrate Collector körs inte.                                                       | Använd services.msc för att starta tjänsten och försök igen.                                                                             | 
...
| 802       | TimeSyncError                  | Tiden har inte synkroniserats med Internet-tidsservern.                            | Tiden har inte synkroniserats med Internet-tidsservern.                                                    | Kontrollera att tiden på datorn är korrekt inställd för den datorns tidszon och försök igen.                                 | 
