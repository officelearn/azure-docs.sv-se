...
3. Verifiera skript integriteten med hjälp av antingen MD5-eller SHA256-hash-filer. Kör det här kommandot för att generera hashen för skriptet:
    ```
