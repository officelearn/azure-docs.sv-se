---
title: Använd artificiell intelligens för att lösa affärs problem med Azure Cognitive Services
description: Lär dig om tjänsten för att bygga smarta mobil program som drivs av artificiell intelligens.
author: codemillmatt
...
- **Visuellt innehåll**
    - Bild markering, miniatyrer
    - OCR (hand SKRIFTS igenkänning)
    - Ansiktsspårning
    - Känslo-identifiering
    - Video insikter
    - Bild-och video moderator
    - Anpassad bild igenkänning

- **Speech**
    - Tal till text (tal avskrifter)
    - Anpassad avskrift för tal (komplexa ord, brus miljö)
    - Text till tal
    - Högtalar-ID och autentisering
    - Tal översättning i real tid
...
- **Beslut** 
    - Content moderator
    - Anpassad innehålls leverans
    - Avvikelse detektor

- **Sök**
    - Automatiska Sök förslag 
    - Förstärkt enhets information
...
- Stöd för behållare för Cognitive Services
 ...
 ## <a name="references"></a>Referenser
   ...
   - [Stöd för containrar](/azure/cognitive-services/cognitive-services-container-support)
