...
- **Valfritt språk, plattform och moln:** Bygg, testa och distribuera Node. js-, python-, Java-, php-, ruby-,C++go C#-, C/,-, Android-och iOS-appar. Kör parallellt på Linux, macOS och Windows. Distribuera till moln leverantörer som Azure, AWS och Google Cloud Platform. Distribuera mobila program via beta kanaler och app-butiker.
