<properties 
    pageTitle="Azure Mobile Engagement – Komma igång med bästa praxis"
...
## Steg 1: Definiera KPI:er så att de passar BET-modellen
...
#### KPI:er för användarinteraktion
...
#### Strategibok – övning 1: Skapa en KPI-instrumentpanel
...
## Steg 2: Ett program för användarinteraktion
...
###### Sekvens med push-meddelanden vid en viss tidpunkt i livscykeln
...
###### Sekvens med beteendebaserade push-meddelanden
...
###### Sekvens med push-meddelanden i form av aviseringar eller meddelanden
...
###### Sekvens med push-meddelanden för ökad kvarhållning
...
###### Vem? Användarsegmentet som kommer att få meddelandena
...
###### Vad? Meddelandet som ska skickas
...
>[AZURE.NOTE] Se till att det innehåll som du skickar som push-meddelanden följer respektive plattforms (iOS, Android, Windows) riktlinjer för apputveckling och sändning av push-meddelanden.

 


###### När? Tidpunkten för kampanjen
...
#### Strategibok, övning 2: Skapa ett program för användarinteraktion
...
#### Acceptanstest för användare (UAT)
