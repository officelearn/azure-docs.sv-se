...
Ovan drar slutsatsen Unity grundläggande vägledningen. Nu ska vi ändra spelet så att den mobila enheten eget. Observera att vi tangentbordsinmatning för spelet hittills för testning. Nu ska vi ändra den så att vi kan styra Windows Media player genom att använda d.v.s. rörelse telefon med accelerationsmätare som indata. 
