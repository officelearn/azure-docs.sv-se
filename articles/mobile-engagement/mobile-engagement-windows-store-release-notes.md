...
* Fast krascher formatering för UWP-appar som körs i versionsläge.
* Fast 1px marginal på meddelanden för universella 8.1-appar.
* MS-appx och ms-appdata är tillgänglig på åtgärd-URL: er.
* Stabilitetsförbättringar.
