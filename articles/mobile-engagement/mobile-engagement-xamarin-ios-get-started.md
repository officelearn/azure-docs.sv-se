...
3. Fyll i **appens namn** och **organisations-ID:t**, och klicka sedan på **Next** (Nästa). 
   ...
   > [!IMPORTANT]
   > Kontrollera att publiceringsprofilen som du så småningom ska använda för att distribuera iOS-appen använder ett app-ID som exakt matchar det paket-ID som du har här. 
   > 
   > 
