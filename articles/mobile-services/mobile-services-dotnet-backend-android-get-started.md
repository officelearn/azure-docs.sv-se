...
---
title: Komma igång med Azure Mobile Services för Android-appar
...
För den här kursen krävs [Android Developer Tools](utvecklingsverktyg för Android.md) med [Android Studio] som omfattar Android Studio Integrated Development Environment och den senaste Android-plattformen. Android 4.2 eller senare krävs.
