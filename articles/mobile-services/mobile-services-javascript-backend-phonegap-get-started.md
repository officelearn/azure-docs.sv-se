<properties
    pageTitle="Komma igång med Azure Mobile Services för PhoneGap/cordova-appar| Microsoft Azure"
...
Den här kursen visar hur du lägger till en molnbaserad serverdelstjänst för en app med Azure Mobile Services. I kursen får du skapa både en ny mobiltjänst och en enkel _To do list_-app (att göra-lista) som lagrar appdata i den nya mobiltjänsten.
...
5. Under **Download and run your app** (Ladda ned och kör appen) klickar du på **Download** (Ladda ned).
    ...
    Projektet för _To do list_-appen som är ansluten till mobiltjänsten laddas ned tillsammans med Mobile Services JavaScript SDK. Spara den komprimerade projektfilen lokalt på datorn och notera var du sparar den.
...
3. När du har startat appen i någon av emulatorerna ovan skriver du lite text i textrutan och klickar sedan på **Lägg till**.
    ...
    > [AZURE.IMPORTANT] Observera att ändringarna i det här plattformsprojektet skrivs över om huvudprojektet återskapas med PhoneGap-verktygen. Gör i stället ändringar i projektets www-rotkatalog (se nedan).
...
2. Öppna en kommandotolk i projektets rotkatalog och kör något av följande plattformsspecifika kommandon:
...
>[AZURE.NOTE]Du kan granska koden som ansluter till mobiltjänsten för att fråga efter och infoga data i filen js/index.js.
