...
### <a name="create-a-metric-alert-classic-rule"></a>Skapa ett mått (klassiskt) varningsregel
...
### <a name="delete-an-alert-classic-rule"></a>Ta bort en varningsregel (klassiskt)
