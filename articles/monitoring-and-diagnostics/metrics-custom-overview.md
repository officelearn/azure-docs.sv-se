...
- Installera tillägget Windows Azure Diagnostics SÄKERHETSSPECIFIKA på din [Azure VM](metrics-store-custom-guestos-resource-manager-vm.md), [virtual machine scale Sets](metrics-store-custom-guestos-resource-manager-vmss.md), [klassisk virtuell dator](metrics-store-custom-guestos-classic-vm.md), eller [klassiska molntjänster](metrics-store-custom-guestos-classic-cloud-service.md) och skicka prestandaräknare till Azure Monitor. 
- Installera den [InfluxData Telegraf agenten](metrics-store-custom-linux-telegraf.md) på virtuell Linux-dator och skicka mått med hjälp av Azure Monitor utdata plugin-programmet.
...
* **Min**: minst observerade värdet från alla exemplen och mätning av faktisk användning under minuten.
* **Max**: max observerade värdet från alla exemplen och mätning av faktisk användning under minuten.
* **Summa**: summering av de observerade värdena från alla exemplen och mätning av faktisk användning under minuten.
* **Antal**: antal exempel och mätningar som görs under minuten.
...
Använda anpassade mått från olika tjänster: 
 ...
 - [Azure-datorer (klassisk)](metrics-store-custom-guestos-classic-vm.md)
 - [Linux-dator med hjälp av Telegraf-agent](metrics-store-custom-linux-telegraf.md)
 - [REST-API](metrics-store-custom-rest-api.md)
 - [Klassiska molntjänster](metrics-store-custom-guestos-classic-cloud-service.md)
