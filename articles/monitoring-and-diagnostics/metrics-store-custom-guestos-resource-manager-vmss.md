...
- Prenumerationen måste vara registrerad med [Microsoft.Insights](https://docs.microsoft.com/en-us/azure/azure-resource-manager/resource-manager-supported-services#portal). 
...
1. På den **övervakaren** väljer **mått**. 
   ...
   ![Övervaka – mått sidan](media/metrics-store-custom-guestos-resource-manager-vmss/metrics.png) 
