---
title: Initiera utöka aviseringar från OMS i Azure | Microsoft Docs
...
Följ stegen nedan om du vill initiera frivilligt utöka av aviseringar från OMS i Azure.

1. Gå till inställningar och aviseringar avsnitt i översiktssidan för Operations Management Suite (OMS). Klicka på knappen med etiketten ”utöka i Azure”, som markerade i bilden nedan.

    ![OMS aviseringsinställningar sida med utöka alternativet](./media/monitor-alerts-extend/ExtendInto.png)
...
2. När du klickar på knappen visas en 3-steg-guiden med det första steget att tillhandahålla information om den här processen. Tryck på Nästa om du vill fortsätta.
    ...
    ![Utöka aviseringar från OMS till Azure - steg 1](./media/monitor-alerts-extend/ExtendStep1.png)
...
För kunder som vill styra programmässigt eller automatisera processen med att utöka aviseringar i OMS till Azure; Microsoft tillhandahåller nya AlertsVersion API under logganalys.
...
> [!NOTE]
> Hämta anrop till API: et resulterar inte i aviseringar i OMS komma utökats till Azure. Det ger endast som svar på Översikt över föreslagna ändringar. För att bekräfta ändringarna göras för att utöka aviseringar i Azure, anropa en POST som behöver göras-API: et.
...
> [!NOTE]
> Resultat för att utöka OMS aviseringar i Azure, kan variera från sammanfattning som tillhandahålls av GET - på kontot för alla ändringar som gjorts i systemet. När schemat, blir aviseringar i OMS tillfälligt otillgänglig för redigering eller ändrar - när nya aviseringar kan skapas. 
