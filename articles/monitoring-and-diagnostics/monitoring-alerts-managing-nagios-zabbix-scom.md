...
1. För **Nagios** och **Zabbix** aviseringar, [Konfigurera servrarna](https://docs.microsoft.com/en-us/azure/log-analytics/log-analytics-linux-agents) att skicka aviseringar till Log Analytics.
1. För **System Center Operations Manager** aviseringar, [ansluta din Operations Manager-hanteringsgrupp till Log Analytics-arbetsytan](https://docs.microsoft.com/en-us/azure/log-analytics/log-analytics-om-agents). Alla varningar som skapats i System Center Operations Manager importeras till Log Analytics.
