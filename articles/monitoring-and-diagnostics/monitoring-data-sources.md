...
| OMS loggen sökfråga aviseringar | Meddelanden | OMS logganalys | <ul><li>**Webhook:** [logganalys aviseringar](../log-analytics/log-analytics-alerts-actions.md#webhook-actions)</li></ul> |
