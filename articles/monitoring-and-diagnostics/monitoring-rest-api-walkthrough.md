...
![ALT ”resurs-ID visas i bladet egenskaper i Azure portal”](./media/monitoring-rest-api-walkthrough/resourceid_azure_portal.png)
...
* Granska den [översikt över övervakning](monitoring-overview.md).
