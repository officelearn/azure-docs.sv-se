...
Hämta en [översikt över aktivitetsloggaviseringar](monitoring-overview-alerts.md) och lär dig att få varningar om  
Läs mer om [SMS hastighetsbegränsning](monitoring-alerts-rate-limiting.md)  
