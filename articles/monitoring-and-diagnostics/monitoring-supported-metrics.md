...
|AttestationAttempts|Attesteringen försök|Antal|Totalt|Antalet enheter intyg försökte|ProvisioningServiceName, Status, Protocol|
...
|MongoRequestCharge|Mongo begäran kostnad|Antal|Totalt|Mongo Frågeenheter används|GlobalDatabaseAccountName, DatabaseName, CollectionName, Region, CommandName, ErrorCode|
...
|ByteCount|Antal byte|Antal|Totalt|Totalt antal byte som överförs inom tidsperiod|VipAddress, VipPort, Direction|
|PacketCount|Antal|Antal|Totalt|Totalt antal paket som skickas inom tidsperiod|VipAddress, VipPort, Direction|
|SYNCount|SYN antal|Antal|Totalt|Totalt antal SYN-paket som skickas inom tidsperiod|VipAddress, VipPort, Direction|
...
|UnhealthyHostCount|Felaktiga värden antal|Antal|Medel|Antalet felaktiga backend-värdar|BackendSettingsPool|
|healthyHostCount|Felfri värden antal|Antal|Medel|Antalet felfri backend-värdar|BackendSettingsPool|
...
|ResponseStatus|Response-Status|Antal|Totalt|HTTP-svarsstatusen som returneras av Programgateway|HttpStatusGroup|
