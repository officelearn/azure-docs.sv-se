...
Du kan också skicka dessa mått och loggar Azure Log Analytics för populära och detaljerad analys eller skapa ytterligare aviseringsregler för att informera dig om kritiska problem till följd av den här analysen.  
...
[Övervakare av nätverksprestanda](https://blogs.msdn.microsoft.com/azuregov/2017/09/05/network-performance-monitor-general-availability/) är en molnbaserad nätverksövervakningslösning som övervakar anslutningen för offentliga moln, datacentra och lokala miljöer.

[ExpressRoute-övervakning](https://azure.microsoft.com/blog/monitoring-of-azure-expressroute-in-preview/) är en NPM-funktion som övervakar slutpunkt-till-slutpunktsanslutningar och prestanda för Azure ExpressRoute-kretsar.
