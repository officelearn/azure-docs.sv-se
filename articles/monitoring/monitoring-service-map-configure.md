...
Den här artikeln innehåller information om att konfigurera agenter för Tjänstkarta och registrering. Information om hur du använder Service Map finns i [använder lösningen Tjänstkarta i Azure]( monitoring-service-map.md).
...
- Lär dig hur du [använda Tjänstkartan]( monitoring-service-map.md) när den har distribuerats och konfigurerats.
