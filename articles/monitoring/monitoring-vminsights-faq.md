...
Mer information på vilka räknare aktiveras finns i vår [onboarding](monitoring-vminsights-onboard.md) artikeln.
...
Om du väljer att använda metoden skriptbaserade stegen beskrivs i den [onboarding](monitoring-vminsights-onboard.md) artikeln. 
...
* Prestandaräknarna har konfigurerats för den valda arbetsytan. Om det här steget misslyckas kan du se att inte några av de prestandadiagram och tabeller som visar data för den virtuella datorn du publicerat. Du kan åtgärda detta genom att köra PowerShell-skriptet som beskrivs [här](monitoring-vminsights-onboard.md#enable-with-powershell).
...
Om du inte ser prestandadata i tabellen disk eller en del av prestandadiagram kan dina prestandaräknare inte konfigureras på arbetsytan. För att lösa, kör du följande [PowerShell-skript](monitoring-vminsights-onboard.md#enable-with-powershell).
