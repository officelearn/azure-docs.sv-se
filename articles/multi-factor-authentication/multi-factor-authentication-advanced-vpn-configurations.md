...
- [Utöka din befintliga infrastruktur för autentisering med NPS-tillägget för Azure Multi-Factor Authentication](multi-factor-authentication-nps-extension.md)
