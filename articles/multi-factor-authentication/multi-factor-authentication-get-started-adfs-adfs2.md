...
1. När dialogrutan Lägg till tillförlitlig IP-adress visas väljer du alternativknappen Enkel IP, IP-intervall eller Undernät.
1. Ange IP-adressen, IP-adressintervallet eller undernätet som ska vitlistas. Om du anger ett undernät väljer du lämplig nätmask och klickar på OK. Nu har den tillförlitliga IP-adressen lagts till.
