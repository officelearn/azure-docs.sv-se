---
title: Skydda molnresurser med Azure Multi-Factor Authentication och AD FS
...
1. Följ anvisningarna i [Aktivera Multi-Factor-Authentication](multi-factor-authentication-get-started-cloud.md#turn-on-multi-factor-authentication-for-users) för användare för att aktivera ett konto.
