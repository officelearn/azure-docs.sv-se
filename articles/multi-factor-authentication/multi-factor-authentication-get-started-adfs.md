---
title: Komma igång med Azure Multi-Factor Authentication och Active Directory Federation Services
...
|:--- |:--- |:--- |
| Skydda Azure AD-resurser med hjälp av Azure Multi-Factor Authentication |<li>Den första  faktorn för autentisering utförs lokalt med hjälp av AD FS.</li> <li>Den andra faktorn är en telefonbaserad metod som utförs med hjälp av molnautentisering.</li> |
| Skydda Azure AD-resurser med hjälp av Active Directory Federation Services |<li>Den första  faktorn för autentisering utförs lokalt med hjälp av AD FS.</li><li>Den andra faktorn utförs lokalt genom att anspråket tillämpas.</li> |
