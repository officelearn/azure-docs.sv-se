---
title: Översikt över verksamhetskontinuitet med Azure-databas för MySQL
description: Översikt över verksamhetskontinuitet med Azure-databas för MySQL.
services: mysql
author: kamathsun
ms.author: sukamat
manager: kfile
...
ms.locfileid: "35263583"
---
# <a name="overview-of-business-continuity-with-azure-database-for-mysql"></a>Översikt över verksamhetskontinuitet med Azure-databas för MySQL

Den här översikten beskriver funktionerna som Azure-databas för MySQL ger för affärskontinuitet och haveriberedskap. Läs mer om alternativ för att återställa från avbrott som kan leda till dataförlust eller leda till databasen och programmet ska bli tillgänglig. Lär dig vad du gör om en användare eller ett program fel påverkar dataintegritet, en Azure-region har ett avbrott eller programmet kräver underhåll.
...
- Mer information om automatisk säkerhetskopiering finns [säkerhetskopieringar i Azure-databas för MySQL](concepts-backup.md).
