---
title: Prestandarekommendationer - Azure Database för MySQL
description: I den här artikeln beskrivs funktionen Prestandarekommendation i Azure Database for MySQL
author: ajlam
ms.author: andrela
ms.service: mysql
ms.topic: conceptual
...
Öppna **prestandarekommendationer** från avsnittet **Intelligent prestanda** i menyraden på Azure-portalsidan för MySQL-servern.
