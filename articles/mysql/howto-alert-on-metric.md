---
title: Konfigurera måttaviseringar - Azure portal - Azure Database för MySQL
description: I den här artikeln beskrivs hur du konfigurerar och kommer åt måttaviseringar för Azure Database för MySQL från Azure-portalen.
author: rachel-msft
ms.author: raagyema
ms.service: mysql
ms.topic: conceptual
...
ms.locfileid: "80067885"
---
# <a name="use-the-azure-portal-to-set-up-alerts-on-metrics-for-azure-database-for-mysql"></a>Använd Azure-portalen för att ställa in aviseringar om mått för Azure Database för MySQL 

Den här artikeln visar hur du konfigurerar Azure Database för MySQL-aviseringar med Azure-portalen. Du kan få en avisering baserat på övervakningsmått för dina Azure-tjänster.
...
1. I [Azure-portalen](https://portal.azure.com/)väljer du den Azure Database för MySQL-server som du vill övervaka.
