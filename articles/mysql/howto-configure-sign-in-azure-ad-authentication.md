...
MySQL-h mydb.mysql.database.azure.com \--User user@tenant.onmicrosoft.com@mydb \---Enable-klartext-plugin \--Password =`az account get-access-token --resource-type oss-rdbms --output tsv --query accessToken`  
