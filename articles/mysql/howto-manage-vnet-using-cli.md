---
title: Skapa och hantera Azure-databas för MySQL VNet slutpunkter och regler som använder Azure CLI | Microsoft Docs
description: Den här artikeln beskriver hur du skapar och hanterar Azure-databas för MySQL VNet slutpunkter och regler som använder Azure CLI-kommandoraden.
services: mysql
author: mbolz
ms.author: mbolz
manager: jhubbard
...
ms.locfileid: "34736600"
---
# <a name="create-and-manage-azure-database-for-mysql-vnet-service-endpoints-using-azure-cli"></a>Skapa och hantera Azure-databas för MySQL VNet slutpunkter med hjälp av Azure CLI
Virtuella nätverk (VNet) services-slutpunkter och regler kan du utöka det privata adressutrymmet i ett virtuellt nätverk till din Azure-databas för MySQL-servern. Med lämplig Azure-kommandoradsgränssnittet (CLI)-kommandon du skapa, uppdatera, ta bort, lista och visa VNet slutpunkter och regler för att hantera servern. En översikt över Azure-databas för MySQL VNet slutpunkter, inklusive begränsningar, finns i [Azure-databas för MySQL Server VNet Tjänsteslutpunkter](concepts-data-access-and-security-vnet.md). Slutpunkter för virtuella nätverk är tillgänglig som förhandsversion i alla regioner som stöds för Azure-databas för MySQL.
...
## <a name="configure-vnet-service-endpoints-for-azure-database-for-mysql"></a>Konfigurera slutpunkter för virtuella nätverk för Azure-databas för MySQL
...
Installera CLI-tillägget för Azure-databas för MySQL VNet slutpunkter med hjälp av den `az extension add --name rdbms-vnet` kommando. 
```azurecli-interactive
...
az extension list
```
Utdata från kommandot visar alla installerade tillägg. Azure-databasen för MySQL CLI tillägg är:
...
### <a name="sample-script-to-create-an-azure-database-for-mysql-database-create-a-vnet-vnet-service-endpoint-and-secure-the-server-to-the-subnet-with-a-vnet-rule"></a>Exempel på skript för att skapa en Azure-databas för MySQL-databas, skapa ett VNet VNet tjänstslutpunkten och skydda servern till undernät med en VNet-regel
