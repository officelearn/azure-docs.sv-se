...
Installera CLI-tillägg för Azure Database för MySQL-VNet-tjänstslutpunkter med hjälp av den `az extension add --name rdbms-vnet` kommando. 
```azurecli-interactive
...
az extension list
```
Utdata från kommandot visar alla installerade tillägg. Azure Database for MySQL-CLI-tillägg är:
