...
description: Den här artikeln beskriver hur du konfigurerar och hanterar Läs repliker i Azure Database for MySQL med hjälp av portalen.
author: ajlam
ms.author: andrela
ms.service: mysql
ms.topic: conceptual
