...
Mer information om hur du anger dessa värden när du skapar en server finns i [skapa en Azure Database for MySQL server med PowerShell](quickstart-create-mysql-server-database-using-azure-powershell.md).
...
> [Så här genererar du en Azure Database for MySQL anslutnings sträng med PowerShell](howto-connection-string-powershell.md)
