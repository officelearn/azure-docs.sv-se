---
title: Azure Database for MySQL-Migreringspartner | Microsoft Docs
description: Listor med tredje parts migreringspartner med lösningar som stöder Azure Database for MySQL.
services: mysql
author: HJToland3
ms.author: jtoland
manager: craigg
...
ms.locfileid: "39116028"
---
# <a name="azure-database-for-mysql-migration-partners"></a>Azure Database for MySQL-migreringspartner
Brett stöd din Azure Database för MySQL-lösning genom att välja från ett brett utbud av branschledande partners och verktyg. Den här artikeln visar Microsoft partnerföretag med lösningar för migrering stöder Azure Database för MySQL.
