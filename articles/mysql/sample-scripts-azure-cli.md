---
title: Azure CLI-exempel för Azure Database for MySQL
...
| [Återställa en server](./scripts/sample-point-in-time-restore.md?toc=%2fcli%2fazure%2ftoc.json) | Azure CLI-skript som återställer en enda Azure Database for MySQL-server till en tidigare tidpunkt. |
