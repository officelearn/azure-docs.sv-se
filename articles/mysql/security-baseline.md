...
- [Skapa och hantera VNet-tjänstens slut punkter och VNet-regler i Azure Database for MySQL](../azure-sql/database/vnet-service-endpoint-rule-overview.md)
