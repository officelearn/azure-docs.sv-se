...
* Slutpunkter
    ...
    * resourceId – för Azure-slutpunkter refererar resurs-ID till resurs-ID: t för Azure Resource Manager (ARM) för virtuella datorer. För icke-Azure-slutpunkter refererar resurs-ID till ARM-resurs-ID: t för den Log Analytics arbets ytan som är länkad till icke-Azure-agenter.
