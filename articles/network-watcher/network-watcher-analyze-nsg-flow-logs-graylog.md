...
4. När de här konfigurationerna har gjorts kan du starta Logstash för att börja läsa i Flow-loggar med följande kommando: `sudo systemctl start logstash.service`.
