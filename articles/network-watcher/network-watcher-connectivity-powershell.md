...
Anslutningen är för närvarande i förhandsversion att använda den här funktionen måste vara registrerad. Gör detta genom att köra följande PowerShell-exempel:
