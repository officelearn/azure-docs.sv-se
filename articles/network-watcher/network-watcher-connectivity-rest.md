...
Hitta om vissa trafik tillåts i eller utanför den virtuella datorn genom att besöka [Kontrollera IP-flöde Kontrollera](diagnose-vm-network-traffic-filtering-problem.md).
