...
| [Azure Edge Zones](#edge-zones)| Distribuera virtuella datorer, behållare och andra tjänster till gräns zoner för att hantera krav på låg latens och högt data flöde.| <p>[Gräns zoner med bärvåg](edge-zones-overview.md#carrier)<p> <p>[Privata gräns zoner](edge-zones-overview.md#private-edge-zones)</p>|
| [Azure-orbital](#orbital)| Kommunicera med din rymder eller satellit Constellations, Downlink och överordnad information, bearbeta dina data i molnet, kedja tjänster med Azure-tjänster i unika scenarier och skapa produkter för dina kunder.  | <p>[Global kommunikation](azure-orbital-overview.md#global-communication)</p>  <p>[Partner underlag](azure-orbital-overview.md#digital-transformation)</p>|
||||
