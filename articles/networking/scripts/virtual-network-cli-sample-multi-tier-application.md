...
[!code-azurecli-interactive[huvudsakliga](../../../cli_scripts/virtual-network/virtual-network-multi-tier-application/virtual-network-multi-tier-application.sh  "för flera nivåer program för virtuella nätverk")]
