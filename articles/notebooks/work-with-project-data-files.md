...
Du kan ta med filer i ett projekt från instrument panelen i projektet eller i en aktiv antecknings bok med antingen **data** -menyn eller `curl`ett kommando som.
...
När du använder kod som skapar en fil, t. ex `write_csv` . Pandas-funktionen, är Sök vägar alltid relativa i mappen Project. Använder *.. /* skapar en sessionsfil som ignoreras när antecknings boken stoppas och stängs.
