...
10. Öppna din Project **AppDelegate. h** -fil och ersätt innehållet med följande kod:
...
11. Lägg till följande-instruktioner i filen Project **AppDelegate. m** `import` :
