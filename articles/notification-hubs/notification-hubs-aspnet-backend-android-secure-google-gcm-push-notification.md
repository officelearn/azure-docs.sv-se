...
Stöd för push-meddelande i Microsoft Azure kan du komma åt en enkel att använda, multiplatform, infrastruktur för utskalad push-meddelande, vilket förenklar implementeringen av push-meddelanden för konsument- och enterprise-program för mobila plattformar.
...
Du måste se till att din Android-app vet hur du autentiserar sig själv med din serverdel när den tar emot push-meddelanden för att åstadkomma detta.
