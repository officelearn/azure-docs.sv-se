...
3. I den **meddelanden** styrenhet, ersätter den **sendNotification** metod med följande kod:
    ...
    Den här koden skickar ett meddelande till alla plattformar på samma gång, utan att behöva ange en inbyggd nyttolast. Notification Hubs bygger och ger korrekt nyttolasten till alla enheter med de angivna *taggen* värdet som anges i de registrerade mallarna.
