...
1. **EnterprisePushBackendSystem**
    ...
    c. `CreateTopic` används för att skapa Service Buss avsnittet.
...
2. **ReceiveAndSendNotification**
    ...
    d. `ReceiveMessageAndSendNotification` används för att läsa meddelandet från avsnittet med hjälp av prenumerationen och om läsningen lyckas kan ett meddelande (i exempel scenariot ett Windows-inbyggt popup-meddelande) skickas till det mobila programmet med Azure Notification Hubs.
    ...
    g. Konfigurera jobbet så att det körs kontinuerligt, så när du loggar in på [Azure-portalen] bör du se något som liknar följande:
...
3. **EnterprisePushMobileApp**
    ...
    c. Se till att följande Notification Hubs registrerings kod anropas vid appens start (när du har ersatt `HubName` och `DefaultListenSharedAccessSignature` värden:
