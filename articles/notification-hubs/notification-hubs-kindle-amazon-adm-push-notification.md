...
2. Högerklicka på projektet i Eclipse och klicka sedan på **Egenskaper**. Välj **Java Build Path** till vänster och sedan fliken **Bibliotek** längst upp. Klicka på **Lägg till extern Jar** och välj filen `\SDK\Android\DeviceMessaging\lib\amazon-device-messaging-*.jar` i den katalog där du extraherade Amazon SDK.
