...
### <a name="should-i-do-registrations-from-the-app-back-end-or-directly-through-client-devices"></a>Ska jag göra registreringar från serverdel för appen eller direkt via klienten enheter?
Registreringar från serverdel för appen är användbara när du har att autentisera klienter innan du skapar registreringen. De är också användbart om du har taggar som måste skapas eller ändras av app-serverdel baserat på applogik. Mer information går du till den [Vägledning för backend-registrering] och [Registrering av backend-vägledning 2] sidor.
...
* Använd en app-serverdel som underhåller en given uppsättning registreringar på dess slut. Den kan sedan utföra en massinfogning till sekundära meddelandehubben.

* Använd en app-serverdel som hämtar en vanlig dump registreringar från den primära meddelandehubben som en säkerhetskopia. Den kan sedan utföra en massinfogning till sekundära meddelandehubben.
