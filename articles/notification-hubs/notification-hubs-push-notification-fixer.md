...
Om du vill använda egenskapen `EnableTestSend` med REST-anropet lägger du till en frågesträngparametern med namnet *test* i slutet av ditt sändnings anrop. Några exempel:
