...
5. Lägg till följande kod högst upp i metoden **Application_Launching** i App.xaml.cs:
   ...
   > 
    ...
    Infoga namnet på din hubb och anslutningssträngen med namnet **DefaultListenSharedAccessSignature** som du noterade i förra avsnittet.
