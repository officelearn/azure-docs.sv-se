...
1. Samla in följande information för Android-appen och meddelandehubben:
    ...
    - **Lyssna anslutningssträng**: På instrumentpanelen på den [klassiska Azure-portalen] klickar du på **Visa anslutningssträngar**. Kopiera anslutningssträngen *DefaultListenSharedAccessSignature* för det här värdet.
    - **Hubbnamn**: Det här är namnet på hubben från den [klassiska Azure-portalen]. Till exempel *mynotificationhub2*.
...
- Azure Notification Hubs Java SDK: Se [Använda Notification Hubs från Java](notification-hubs-java-backend-how-to.md) för att skicka meddelanden från Java. Det här har testats i Eclipse för Android-utveckling.
- PHP: Se [Använda Notification Hubs från PHP](notification-hubs-php-backend-how-to.md).
...
2. I Visual Studio klickar du på **Verktyg**, **Pakethanteraren NuGet** och sedan på **Pakethanterarkonsolen**.
    ...
    Då visas pakethanterarkonsolen i Visual Studio.

3. I fönstret Pakethanterarkonsolen ställer du in **standardprojektet** till det nya projektet för konsolprogrammet. Sedan kör du följande kommando i konsolfönstret:
...
5. Lägg till följande metod i `Program`-klassen. Uppdatera platshållartexten med anslutningssträngen *DefaultFullSharedAccessSignature* och hubbens namn från den [klassiska Azure-portalen].
...
5. Infoga följande skript i schemaläggarfunktionen. Se till att ersätta platshållarna med namnet på din meddelandehubb och anslutningssträngen för *DefaultFullSharedAccessSignature* som du fick tidigare. Klicka på **Spara**.
