...
<ol start="7">
<li>
<p>Eftersom du vill konfigurera APN-anslutningen i Azure-portalen öppnar du inställningarna för Notification Hubs och klickar på <b>Notification Services</b> och sedan på objektet <b>Apple (APNS)</b> i listan. När du har gjort det klickar du på <b>Ladda upp certifikat</b> och väljer <b>.p12</b>-certifikatet som du exporterade tidigare, samt lösenordet för certifikatet.</p>
...
* **Java/PHP**: Ett exempel på hur du skickar push-meddelanden med hjälp av REST-API:er finns i avsnittet Använda Notification Hubs från Java/PHP ([Java](notification-hubs-java-backend-how-to.md) | [PHP](notification-hubs-php-backend-how-to.md)).
...
1. Logga in på den [klassiska Azure-portalen] och välj mobiltjänst.

2. Välj fliken **Schemaläggaren** högst upp.

    ![Den klassiska Azure-portalen – Schemaläggaren][215]

3. Skapa ett nytt schemalagt jobb, infoga ett namn och välj **På begäran**.

    ![Den klassiska Azure-portalen – Skapa nytt jobb][216]
