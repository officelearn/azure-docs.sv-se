<properties
   pageTitle="Datasäkerhet i säkerhets- och granskningslösningen i Operations Management Suite | Microsoft Azure"
...
# Datasäkerhet i säkerhets- och granskningslösningen i Operations Management Suite
...
> [AZURE.NOTE] Platsen för data konfigureras på arbetsytenivå i OMS när arbetsytan skapas, vilket är ett av stegen i den ursprungliga konfigurationsprocessen för säkerhets- och granskningslösningen i OMS.
