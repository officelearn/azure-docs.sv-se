...
* [PowerShell-Cmdlets för automatisering](http://msdn.microsoft.com/library/dn690262.aspx)
...
* [Logga Sök REST-API](../log-analytics/log-analytics-log-search-api.md)
* [Aviseringen REST-API](../log-analytics/log-analytics-api-alerts.md)
...
* [Dokumentation för Tjänstmappning](operations-management-suite-service-map.md)
* [Tjänstkarta REST-API](https://docs.microsoft.com/rest/api/servicemap/)
