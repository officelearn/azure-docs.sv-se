...
Om du vill skapa nya användare som kan autentiseras med Azure AD måste du ha rollen `azure_ad_admin` i-databasen. Den här rollen tilldelas genom att konfigurera Azure AD-administratörskontot för en särskild Azure Database for PostgreSQL Server.
