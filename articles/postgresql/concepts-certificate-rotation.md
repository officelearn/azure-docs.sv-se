...
Om du inte uppdaterar rot certifikatet före den 30 november 2020 kommer dina program som ansluter via SSL/TLS och verifiering för rot certifikatet inte att kunna kommunicera med PostgreSQL-databas servern och programmet kommer att uppleva anslutnings problem till PostgreSQL-databasservern.
