...
---
# <a name="handling-transient-connectivity-errors-for-azure-database-for-postgresql---single-server"></a>Hantering av tillfälliga anslutnings fel för Azure Database for PostgreSQL-enskild server
