---
title: "Övervakning i Azure-databas för PostgreSQL | Microsoft Docs"
description: "Den här artikeln beskriver mätvärden för övervakning och avisering för Azure-databas för PostgreSQL, inklusive CPU, gränser, lagring och anslutningsstatistik."
services: postgresql
author: rachel-msft
ms.author: raagyema
manager: jhubbard
