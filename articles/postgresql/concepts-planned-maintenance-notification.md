...
- Om du har frågor eller förslag kan du behöva arbeta med Azure Database for PostgreSQL, skicka ett e-postmeddelande till Azure Database for PostgreSQL-teamet på *AskAzureDBforMySQL@service.microsoft.com* .
