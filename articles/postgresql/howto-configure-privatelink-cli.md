...
Observera att PostgreSQL Server-ID liknar ```/subscriptions/subscriptionId/resourceGroups/myResourceGroup/providers/Microsoft.DBforPostgreSQL/servers/servername.``` du kommer att använda PostgreSQL-serverns ID i nästa steg. 
...
2. Ange  `nslookup mydemopostgresserver.postgres.privatelink.database.azure.com`. 
