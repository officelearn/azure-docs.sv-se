---
title: Hantera Azure Database för PostgreSQL - Azure-portal
description: Lär dig hur du hanterar en Azure-databas för PostgreSQL-server från Azure-portalen.
author: rachel-msft
ms.author: raagyema
...
---
# <a name="manage-an-azure-database-for-postgresql-server-using-the-azure-portal"></a>Hantera en Azure-databas för PostgreSQL-server med Azure-portalen
Den här artikeln visar hur du hanterar din Azure-databas för PostgreSQL-servrar. Hanteringsuppgifter omfattar beräknings- och lagringsskalning, återställning av administratörslösenord och visning av serverinformation.

## <a name="sign-in"></a>Logga in
Logga in på [Azure-portalen](https://portal.azure.com).

## <a name="create-a-server"></a>Skapa en server
Besök [snabbstarten](quickstart-create-server-database-portal.md) för att lära dig hur du skapar och kommer igång med en Azure-databas för PostgreSQL-server.
...
- Lär dig mer om [justerings- och övervakningsalternativ i Azure Database för PostgreSQL](concepts-monitoring.md)
