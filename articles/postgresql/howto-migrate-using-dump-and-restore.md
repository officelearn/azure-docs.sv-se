...
```
Inklusive--ingen ägare parametern orsakerna alla objekt som skapas under återställningen som ägs av den användare som angetts med--användarnamn. Mer information finns i officiella PostgreSQL-dokumentationen på [pg_restore](https://www.postgresql.org/docs/9.6/static/app-pgrestore.html).
