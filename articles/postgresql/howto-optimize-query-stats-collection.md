...
Så här `pg_stat_statements.track = NONE`anger du:
...
Överväg att `pg_stat_statements.track = NONE` ange i [Azure Portal](howto-configure-server-parameters-using-portal.md) eller med hjälp av [Azure CLI](howto-configure-server-parameters-using-cli.md).
