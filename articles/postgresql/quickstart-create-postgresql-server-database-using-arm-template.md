...
description: I den här snabb starten får du lära dig hur du skapar en Azure Database for PostgreSQL enskild server med hjälp av en Azure Resource Manager mall.
author: lfittl-msft
ms.author: lufittl
