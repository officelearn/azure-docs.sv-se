...
|**Återställ en server**||
| [Återställ en server](./scripts/sample-point-in-time-restore.md?toc=%2fcli%2fazure%2ftoc.json) | Azure CLI-skript som återställer en Azure Database for PostgreSQL-server till en tidigare tidpunkt. |
