...
[!code-azurecli-interactive[huvudsakliga](../../../cli_scripts/postgresql/create-postgresql-server-and-firewall-rule/create-postgresql-server-and-firewall-rule.sh?highlight=15-16 "skapa en Azure-databas för PostgreSQL och brandväggsregel på servernivå.")]
...
[!code-azurecli-interactive[huvudsakliga](../../../cli_scripts/postgresql/create-postgresql-server-and-firewall-rule/delete-postgresql.sh "ta bort resursgruppen.")]
