---
title: Kodfragment för att migrera innehåll från Power BI arbetsytan samlingar | Microsoft Docs
description: Här följer några kodstycken med grundläggande åtgärder som krävs för migrering av innehåll.
...
ms.locfileid: "31407722"
---
# <a name="code-snippets-for-migrating-content-from-power-bi-workspace-collections"></a>Kodfragment för att migrera innehåll från Power BI arbetsytan samlingar

Den här artikeln får du några kodstycken med grundläggande åtgärder som krävs för migrering av innehåll. Relaterade flöden för vissa rapporttyper finns [hur du migrerar Power BI Embedded arbetsytan samling innehåll till Power BI](migrate-from-power-bi-workspace-collections.md#content-migration).

En **Migreringsverktyget** är tillgänglig som du kan använda för att kopiera innehållet från Power BI arbetsytan samlingar till Power BI Embedded. Särskilt om du har mycket innehåll. Mer information finns i [Power BI Embedded Migreringsverktyget](migrate-tool.md).

Koden nedan är exempel med hjälp av C# och [Power BI .NET SDK](https://www.nuget.org/profiles/powerbi).

Kontrollera att du använder följande namnrymder för att köra kodavsnitten nedan.
...
## <a name="export-report-from-a-power-bi-workspace-collection-workspace"></a>Exportera rapporten från en Power BI-Arbetsytesamling-arbetsyta
...
## <a name="import-report-to-power-bi-embedded"></a>Importera rapporten till Power BI Embedded
...
## <a name="extract-directquery-connection-string-from-power-bi-workspace-collections"></a>Extrahera DirectQuery anslutningssträngen från Power BI arbetsytan samlingar

Detta är att uppdatera PBIX efter migrering till Power BI Embedded.
...
## <a name="update-directquery-connection-string-in-power-bi-embedded"></a>Uppdatera DirectQuery anslutningssträngen i Power BI Embedded
...
## <a name="set-directquery-credentials-in-power-bi-embedded"></a>Ange autentiseringsuppgifterna för DirectQuery i Power BI Embedded

I den här fragment använder okrypterad autentiseringsuppgifter för enkelhetens skull skicka krypterade autentiseringsuppgifter stöds också.
...
Du måste återskapa rapporten för den skapade dataset.

I det här kodstycket förutsätter att pushable dataset redan är i en app arbetsytan i Power BI. Information om push-API finns [skicka data till en Power BI-dataset](https://powerbi.microsoft.com/documentation/powerbi-developer-walkthrough-push-data/).
...
Mer information om migreringsprocessen finns [hur du migrerar Power BI-Arbetsytesamling innehåll till Power BI Embedded](migrate-from-power-bi-workspace-collections.md).
