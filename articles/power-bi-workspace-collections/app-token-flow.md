...
Efter **Power BI-Arbetsytesamlingar** skickar en rapport till användaren, användaren kan visa rapporten i din egna app. Exempel: Om du har importerat den [analysera försäljning Data PBIX exempel](https://download.microsoft.com/download/1/4/E/14EDED28-6C58-4055-A65C-23B4DA81C4DE/Analyzing_Sales_Data.pbix), exempelwebbappen skulle se ut:
