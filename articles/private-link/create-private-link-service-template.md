...
description: I den här snabb starten använder du en Azure Resource Manager-mall för att skapa en privat länk-tjänst.
...
ms.locfileid: "84817625"
---
# <a name="quickstart-create-a-private-link-service-by-using-an-azure-resource-manager-template"></a>Snabb start: skapa en privat länk-tjänst med hjälp av en Azure Resource Manager mall

I den här snabb starten använder du en Azure Resource Manager-mall för att skapa en privat länk-tjänst.
...
> [!NOTE]
> Azure Resource Manager mallen genererar ett unikt namn för den virtuella datorns myConsumerVm<b>{UniqueID}</b> -resurs. Ersätt ditt genererade värde för **{UniqueID}**.
