...
description: Kom igång med en privat Azure-slutpunkt för att ansluta till ett Azure Cosmos-konto privat.
author: asudbring
ms.author: allensu
...
12. I Storage Explorer högerklickar du på **Cosmos DB konton** och väljer **Anslut till Cosmos DB**.
