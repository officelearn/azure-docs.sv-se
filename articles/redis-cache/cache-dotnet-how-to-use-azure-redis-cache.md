...
> [!NOTE]
> Observera att icke-SSL-porten är inaktiverad som standard för nya cacheminnen. Anvisningar om hur du aktiverar icke-SSL-porten finns i [Åtkomstportar](cache-configure.md#access-ports)...
> 
> 
