...
* [C#-klass](https://docs.microsoft.com/dotnet/api/microsoft.azure.remoterendering.material)
...
* [C++-klass](https://docs.microsoft.com/cpp/api/remote-rendering/material)
