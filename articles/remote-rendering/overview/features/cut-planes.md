...
* [C# CutPlaneComponent-klass](/dotnet/api/microsoft.azure.remoterendering.cutplanecomponent)
* [C++ CutPlaneComponent-klass](/cpp/api/remote-rendering/cutplanecomponent)
