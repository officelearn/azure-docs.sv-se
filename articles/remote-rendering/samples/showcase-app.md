...
Käll koden för det här programmet tillsammans med instruktioner för att bygga/distribuera finns i [databasen arr samples](https://github.com/Azure/azure-remote-rendering/tree/master/Unity/AzureRemoteRenderingShowcase).
