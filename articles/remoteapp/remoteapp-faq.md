<properties 
    pageTitle="Vanliga frågor och svar om Azure RemoteApp | Microsoft Azure" 
...
## Snabba tips om att använda Azure RemoteApp ##
...
## Information om Azure RemoteApp-prenumerationen ##
...
>[AZURE.NOTE]Azure Active Directory-användare måste komma från den klient som är associerad med din prenumeration. (Du kan visa och ändra din prenumeration på **inställningsfliken** i portalen. Mer info finns i artikeln om att [ändra Azure Active Directory-klienten som används av RemoteApp](remoteapp-changetenant.md).)
...
## Klienter – vilka enheter kan jag använda för att få åtkomst till Azure RemoteApp?
...
- **Finns det någon RemoteApp-dokumentation?** Bra att du frågade. Förutom hjälpinnehållet i portalen (klicka bara på **?** på valfri sida i portalen) kan du läsa följande artiklar för att lära dig mer om RemoteApp:
    - **Kom igång:**
        ...
        - [Hur fungerar det med licensiering?](remoteapp-licensing.md)
...
### Vi vill bli bättre på att hjälpa dig 
