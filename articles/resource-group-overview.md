...
7. En resurs kan interagera med resurser i andra resursgrupper. Denna interaktion är vanlig när de två resurserna är relaterade men inte delar samma livscykel (till exempel webbappar anslutna till en databas).
...
> [!NOTE]
> Om ett SDK inte tillhandahåller de funktioner som du behöver kan du även anropa [Azure REST-API:et](https://msdn.microsoft.com/library/azure/dn790568.aspx) direkt.
> 
> 
