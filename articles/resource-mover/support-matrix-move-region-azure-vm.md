...
RBAC-principer | Stöds inte | Principer för rollbaserad åtkomst kontroll (RBAC) på virtuella datorer kopieras inte över till den virtuella datorn i mål regionen.
