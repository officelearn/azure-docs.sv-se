...
![PowerShell Get-AzureRMAuthorizationChangeLog – skärmbild](./media/change-history-report/access-change-history.png)
...
![Changelog visas som kalkylblad – skärmbild](./media/change-history-report/change-history-spreadsheet.png)

## <a name="next-steps"></a>Nästa steg
* Arbeta med [anpassade roller i Azure RBAC](custom-roles.md)
* Lär dig att hantera [Azure RBAC med powershell](role-assignments-powershell.md)
