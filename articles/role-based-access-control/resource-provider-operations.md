...
> | Åtgärd | Microsoft.ClassicStorage/storageAccounts/images/delete | Tar bort en viss lagringskontoavbildning. |
> | Åtgärd | Microsoft.ClassicStorage/storageAccounts/images/read | Returnerar lagringskontoavbildning. |
...
> | Åtgärd | Microsoft.Consumption/budgets/write | Skapar, uppdatera och ta bort budgetar genom en prenumeration eller en hanteringsgrupp. |
...
> | Åtgärd | Microsoft.ContainerService/managedClusters/providers/Microsoft.Insights/diagnosticSettings/read | Hämta diagnostikinställning för en hanterad klusterresurs |
...
> | Åtgärdstyp | Åtgärd | Beskrivning |
> | --- | --- | --- |
> | Åtgärd | Microsoft.Devices/canaryoperationresults/Read | Hämta Åtgärdsresultat för Kanarieöarna |
> | Åtgärd | Microsoft.Devices/checkNameAvailability/Action | Kontrollera om IotHub-namn är tillgänglig |
> | Åtgärd | Microsoft.Devices/checkProvisioningServiceNameAvailability/Action | Kontrollera om IotHub-namn är tillgänglig |
...
> | Åtgärd | Microsoft.Devices/iotHubs/canaryoperationresults/Read | Hämta Åtgärdsresultat för Kanarieöarna (föråldrade API) |
...
> | Åtgärd | Microsoft.DevTestLab/labs/virtualMachines/TransferDisks/action | Överföra ägarskap för virtuella datordiskar data till dig själv |
...
> | Åtgärdstyp | Åtgärd | Beskrivning |
> | --- | --- | --- |
> | Åtgärd | Microsoft.DynamicsLcs/lcsprojects/clouddeployments/read | Visa Microsoft Dynamics AX 2012 R3 utvärdering distributioner i ett Microsoft Dynamics Lifecycle Services-projekt som hör till en användare |
> | Åtgärd | Microsoft.DynamicsLcs/lcsprojects/clouddeployments/write | Skapa utvärdering för Microsoft Dynamics AX 2012 R3-distribution i ett Microsoft Dynamics Lifecycle Services-projekt som hör till en användare. Distributioner kan hanteras från Azure-hanteringsportalen |
> | Åtgärd | Microsoft.DynamicsLcs/lcsprojects/connectors/read | Läsa kopplingar som hör till ett Microsoft Dynamics Lifecycle Services-projekt |
> | Åtgärd | Microsoft.DynamicsLcs/lcsprojects/connectors/write | Skapa och uppdatera kopplingar som hör till ett Microsoft Dynamics Lifecycle Services-projekt |
> | Åtgärd | Microsoft.DynamicsLcs/lcsprojects/delete | Ta bort Microsoft Dynamics Lifecycle Services-projekt som hör till användaren |
> | Åtgärd | Microsoft.DynamicsLcs/lcsprojects/read | Visa Microsoft Dynamics Lifecycle Services-projekt som hör till en användare |
> | Åtgärd | Microsoft.DynamicsLcs/lcsprojects/write | Skapa och uppdatera Microsoft Dynamics Lifecycle Services-projekt som tillhör användaren. Endast namn och beskrivning egenskaper kan uppdateras. Prenumeration och plats som är kopplade till projektet kan inte uppdateras när du har skapat |
...
> | Åtgärd | Microsoft.EventGrid/register/action | Registrerar eventSubscription för EventGrid-resursprovidern och gör det möjligt att skapa Event Grid-prenumerationer. |
> | Åtgärd | Microsoft.EventGrid/topics/delete | Ta bort ett ämne |
> | Åtgärd | Microsoft.EventGrid/topics/listKeys/action | Lista över nycklar för ämnet |
...
> | Åtgärd | Microsoft.EventGrid/topics/regenerateKey/action | Återskapa nyckel för ämnet |
...
> | Åtgärd | Microsoft.LabServices/labAccounts/sizes/ListAvailableSkus/action | Lista tillgängliga SKU: er för varje storlekstyp av i ett labbkonto |
...
> | Åtgärd | Microsoft.Network/applicationSecurityGroups/joinIpConfiguration/action | Ansluter till en IP-konfiguration till Programsäkerhetsgrupper. |
> | Åtgärd | Microsoft.Network/applicationSecurityGroups/joinNetworkSecurityRule/action | Ansluter till en säkerhetsregel till Programsäkerhetsgrupper. |
...
> | Åtgärd | Microsoft.Network/expressRouteCircuits/join/action | Ansluter till en Expressroute-krets |
...
> | Åtgärd | Microsoft.Network/loadBalancers/inboundNatRules/join/action | Ansluter till en belastningsutjämningsregel för ingående nat |
...
> | Åtgärd | Microsoft.Network/routeFilters/join/action | Ansluter till ett flödesfilter |
...
> | Åtgärd | Microsoft.Network/serviceEndpointPolicies/join/action | Ansluter till en Tjänstslutpunktsprincip |
...
> | Åtgärd | Microsoft.RecoveryServices/Vaults/backupJobsExport/operationResults/read | Returnerar resultatet från Jobbexportåtgärd. |
...
> | Åtgärd | Microsoft.RecoveryServices/Vaults/tokenInfo/read | Returnerar tokeninformation för Recovery Services-valv. |
...
> | Åtgärd | Microsoft.RecoveryServices/Vaults/validateOperation/action | Validera åtgärden på skyddat objekt |
...
> | Åtgärd | Microsoft.Sql/locations/networkInterfaceAzureAsyncOperation/read | Returnerar information om ett visst nätverksgränssnitt Azure en asynkron åtgärd |
> | Åtgärd | Microsoft.Sql/locations/networkInterfaceOperationResults/read | Returnerar information om angivna network interface-åtgärd |
...
> | Åtgärd | Microsoft.Sql/servers/networkInterfaces/read | Returnerar egenskaper för det angivna nätverksgränssnittet |
...
> | Åtgärd | Microsoft.StorSimple/managers/devices/listFailoverSets/action | Lista redundansen anger för en befintlig enhet. |
...
> | Åtgärd | Microsoft.StorSimple/managers/devices/publishSupportPackage/action | Publicera supportpaket för en enhet för felsökning av Microsoft Support. |
...
> | Åtgärd | Microsoft.StorSimple/managers/devices/volumeContainers/listEncryptionKeys/action | Krypteringsnycklar i listan över Volymbehållare |
...
> | Åtgärd | Microsoft.StorSimple/managers/devices/volumeContainers/rolloverEncryptionKey/action | Förnya nycklar för kryptering av Volymbehållare |
...
> | Åtgärd | Microsoft.StorSimple/managers/listPrivateEncryptionKey/action | Hämtar privata krypteringsnyckel för en StorSimple-enhetshanterare. |
...
> | Åtgärd | Microsoft.StorSimple/managers/storageAccountCredentials/listAccessKey/action | Lista åtkomstnycklar autentiseringsuppgifter för Lagringskonto |
