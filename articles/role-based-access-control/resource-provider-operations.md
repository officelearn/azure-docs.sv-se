...
> | Åtgärd | Microsoft. Kusto/kluster/DiagnoseVirtualNetwork/åtgärd | Diagnostiserar nätverks anslutnings status för externa resurser där tjänsten är depedent. |
