...
### <a name="list-all-role-assignments-in-a-subscription"></a>Visa en lista över alla roll tilldelningar i en prenumeration
...
Om du vill visa, lägga till eller ta bort roll tilldelningar kan du behöva ange ett objekts unika ID. ID: t har formatet: `11111111-1111-1111-1111-111111111111`. Du kan hämta ID: t med hjälp av Azure Portal eller Azure PowerShell.
...
Om du vill bevilja åtkomst till en grupp vid ett resurs omfång använder du [New-AzRoleAssignment](/powershell/module/az.resources/new-azroleassignment). Information om hur du hämtar objekt-ID för gruppen finns i [Hämta objekt](#get-object-ids)-ID: n.
...
Om du vill bevilja åtkomst till ett program i ett prenumerations omfång använder du [New-AzRoleAssignment](/powershell/module/az.resources/new-azroleassignment). Information om hur du hämtar objekt-ID för programmet finns i [Hämta objekt](#get-object-ids)-ID: n.
