...
Med rollbaserad åtkomstkontroll (RBAC), definiera åtkomst för användare, grupper och tjänstens huvudnamn genom att tilldela roller för ett visst område. Den här artikeln beskriver hur du hanterar åtkomst med hjälp av Azure PowerShell.
...
![RBAC PowerShell-Get AzureRmRoleDefinition – skärmbild](./media/role-assignments-powershell/1-get-azure-rm-role-definition1.png)
...
![RBAC PowerShell-Get AzureRmRoleDefinition för en viss roll – skärmbild](./media/role-assignments-powershell/1-get-azure-rm-role-definition2.png)
...
![RBAC PowerShell-Get AzureRmRoleAssignment för en resursgrupp – skärmbild](./media/role-assignments-powershell/4-get-azure-rm-role-assignment1.png)
...
![RBAC PowerShell-Get AzureRmRoleAssignment för en användare – skärmbild](./media/role-assignments-powershell/4-get-azure-rm-role-assignment2.png)
...
![RBAC PowerShell nya AzureRmRoleAssignment – skärmbild](./media/role-assignments-powershell/2-new-azure-rm-role-assignment2.png)
...
![RBAC PowerShell nya AzureRmRoleAssignment – skärmbild](./media/role-assignments-powershell/2-new-azure-rm-role-assignment3.png)
...
![RBAC PowerShell nya AzureRmRoleAssignment – skärmbild](./media/role-assignments-powershell/2-new-azure-rm-role-assignment4.png)
...
![RBAC PowerShell ta bort AzureRmRoleAssignment – skärmbild](./media/role-assignments-powershell/3-remove-azure-rm-role-assignment.png)
...
När du använder PowerShell för att skapa en anpassad roll kan du börja om från början eller Använd en av de [inbyggda roller](built-in-roles.md) som utgångspunkt. I exemplet i det här avsnittet börjar med en inbyggd roll och anpassar den med mer behörigheter. Redigera de attribut du vill lägga till den *åtgärder*, *notActions*, eller *scope* som du vill använda och sedan spara ändringarna som en ny roll.
...
![RBAC PowerShell-Get AzureRmRoleDefinition – skärmbild](./media/role-assignments-powershell/2-new-azurermroledefinition.png)
...
![RBAC PowerShell-Set AzureRmRoleDefinition – skärmbild](./media/role-assignments-powershell/3-set-azurermroledefinition-1.png)
...
![RBAC PowerShell-Set AzureRmRoleDefinition – skärmbild](./media/role-assignments-powershell/3-set-azurermroledefinition-2.png)
...
![RBAC PowerShell ta bort AzureRmRoleDefinition – skärmbild](./media/role-assignments-powershell/4-remove-azurermroledefinition.png)
...
![RBAC PowerShell-Get AzureRmRoleDefinition – skärmbild](./media/role-assignments-powershell/5-get-azurermroledefinition-1.png)
...
![RBAC PowerShell-Get AzureRmRoleDefinition – skärmbild](./media/role-assignments-powershell/5-get-azurermroledefinition2.png)
