...
| --- | --- | --- |
| Gruppera<br>(RBAC-kursgrupp) | [Läsare](built-in-roles.md#reader) | Prenumeration |
| Gruppera<br>(RBAC-kursgrupp)| [Deltagare](built-in-roles.md#contributor) | Resursgrupp<br>(rbac-tutorial-resource-user) |
