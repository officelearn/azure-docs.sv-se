...
### <a name="could-not-execute-skill"></a>Det gick inte att köra kompetensen
...
### <a name="could-not-execute-skill-because-the-web-api-request-failed"></a>Det gick inte att köra kompetensen eftersom webb-API-begäran misslyckades
...
### <a name="could-not-execute-skill-because-web-api-skill-response-is-invalid"></a>Det gick inte att köra kompetensen eftersom kunskaps svaret för webb-API är ogiltigt
