...
Kognitiva kunskaper i Azure Kognitiv sökning baseras på maskin inlärnings modeller i API:er för Cognitive Services: [visuellt innehåll](https://docs.microsoft.com/azure/cognitive-services/computer-vision/) och [text analys](https://docs.microsoft.com/azure/cognitive-services/text-analytics/overview). 
...
| Bearbetning av naturligt språk | Text bearbetning för insikter och information om text inmatningar. Språk identifiering, sentiment analys och extrahering av nyckel fraser är kunskaper som omfattas av bearbetning av naturligt språk.  | Se [extrahering av diskussionsämne kunskaper](cognitive-search-skill-keyphrases.md), [Språkidentifiering kunskaper](cognitive-search-skill-language-detection.md), [Attitydanalys kunskaper](cognitive-search-skill-sentiment.md) |
