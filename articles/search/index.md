---
title: "Dokumentation om Azure Search – Självstudier, API-referens | Microsoft Docs"
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Videobibliotek för Azure Search</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Kom igång med Azure Search med hjälp av Azure Portal</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Skapa ett Azure Search-index</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/searchservice">REST API-referens</a></p>
                        <p><a href="/rest/api/searchmanagement">API-referens för REST (hantering)</a></p>
                        <p><a href="search-api-2016-09-01-preview.md">Tjänst-REST (förhandsversion)</a></p>
                    </div>
                </div>
            </div>
        </div>
