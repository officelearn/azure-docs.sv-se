...
Ladda ned [käll koden för Postman-samlingen](https://github.com/Azure-Samples/azure-search-postman-searches/Tutorial/Knowledge_Store/KnowledgeStore.postman_collection.json) och importera den till Postman med hjälp av **fil, importera.** .. Växla till fliken **samlingar** och klicka på knappen **...** och välj **Redigera**. 
