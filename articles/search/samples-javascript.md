...
| [Frågor](https://github.com/Azure/azure-sdk-for-js/blob/master/sdk/search/search-documents/samples/javascript/src/readonlyQuery.js) | Frågorna är skrivskyddade. Den här exempel frågan körs mot ett offentligt index som Microsoft är värd för.  |
...
| [Frågor](https://github.com/Azure/azure-sdk-for-js/blob/master/sdk/search/search-documents/samples/typescript/src/readonlyQuery.js) | Visar frågekörningen mot ett skrivskyddat offentligt index som Microsoft är värd för.  |
...
| Exempel | Beskrivning | 
|---------|-------------|
| [Start](https://github.com/Azure-Samples/azure-search-javascript-samples/tree/master/Quickstart) | Källkod för [snabb start: skapa ett Sök index i Java Script](search-get-started-javascript.md).  |
