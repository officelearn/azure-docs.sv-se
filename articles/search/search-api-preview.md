...
+ För Sök åtgärder är [ **`2019-05-06-Preview`** ](https://docs.microsoft.com/rest/api/searchservice/index-2019-05-06-preview) den aktuella för hands versionen.
+ För hanterings åtgärder är [ **`2019-10-01-Preview`** ](https://docs.microsoft.com/rest/api/searchmanagement/index-2019-10-01-preview) den aktuella för hands versionen.
...
|||
|-|-|
| [Cosmos DB indexerare](search-howto-index-cosmosdb.md) | Stöd för MongoDB-API (för hands version), Gremlin API (Preview) och API för Cassandra (för hands version) API-typer. | 
...
| Begränsning av IP-åtkomst | Med [`api-version=2019-10-01-Preview`](https://docs.microsoft.com/rest/api/searchmanagement/index-2019-10-01-preview) av hanterings REST API kan du skapa en tjänst som har begränsningar för vilka IP-adresser som tillåts åtkomst. |
