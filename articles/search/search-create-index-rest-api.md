---
title: "Skapa ett Azure Search-index med hjälp av REST API | Microsoft Docs"
...
## <a name="ii-define-your-azure-search-index-using-well-formed-json"></a>II. Definiera ditt Azure Search-index med välstrukturerad JSON
