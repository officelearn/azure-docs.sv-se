...
- Om du använder `ScoringParameter.Value` egenskapen `ScoringParameter.Values` använder du egenskapen eller `ToString` metoden i stället.
- Om du använder `SearchRequestOptions.RequestId` egenskapen `ClientRequestId` använder du egenskapen i stället.
