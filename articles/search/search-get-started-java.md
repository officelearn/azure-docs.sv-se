<properties
    pageTitle="Komma igång med Azure Search i Java | Microsoft Azure | Värdbaserad söktjänst i molnet"
...
7. Välj **Window** > **Preferences** > **Java** > **Installed JREs** > **Add**.

8. Välj **Standard VM**i **Add JRE**.
...
8. I Goals i Edit Configuration skriver du ”clean install” och klickar på **Run**.
