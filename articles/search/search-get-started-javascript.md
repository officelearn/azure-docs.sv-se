...
Använd [Java Script/TYPSCRIPT SDK för Azure kognitiv sökning](https://docs.microsoft.com/javascript/api/overview/azure/search-documents-readme?view=azure-node-latest) för att skapa ett Node.js-program i Java Script som skapar, läser in och skickar frågor till ett sökindex.
...
3. Installera `@azure/search-documents` , [Java Script/Typscript SDK för Azure kognitiv sökning](https://docs.microsoft.com/javascript/api/overview/azure/search-documents-readme?view=azure-node-latest).
