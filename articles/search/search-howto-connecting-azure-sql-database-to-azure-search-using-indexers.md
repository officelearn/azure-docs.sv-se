...
Du kan behöva tillåta Azure-tjänster att ansluta till din databas. Se [ansluta från Azure](https://docs.microsoft.com/azure/sql-database/sql-database-firewall-configure) för instruktioner om hur du gör det.
