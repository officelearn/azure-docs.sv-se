---
title: Felsökning av vanliga problem med indexerare i Azure Search | Microsoft Docs
description: Åtgärda vanliga problem med indexerare i Azure Search
author: mgottein
manager: cgronlun
services: search
ms.service: search
