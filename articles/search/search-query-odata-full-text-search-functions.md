...
Följande EBNF ([Extended backable-Naur form](https://en.wikipedia.org/wiki/Extended_Backus–Naur_form)) definierar grammatiken för och- `search.ismatch` `search.ismatchscoring` funktionerna:
