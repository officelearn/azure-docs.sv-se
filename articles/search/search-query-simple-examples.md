...
I den här artikeln använder vi exempel för att illustrera den enkla syntaxen, fylla `search=` i parametern för en [Sök dokument](https://docs.microsoft.com/rest/api/searchservice/search-documents) åtgärd.
