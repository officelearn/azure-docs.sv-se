...
+ [Snabbstart: Ställ in och hämta en hemlighet från Azure Key Vault med hjälp av PowerShell](https://docs.microsoft.com/azure/key-vault/secrets/quick-create-powershell)
