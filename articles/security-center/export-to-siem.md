...
- **Power BI**  -  [Anslut till Microsoft Graph Security API i Power BI Desktop](https://docs.microsoft.com/power-bi/connect-data/desktop-connect-graph-security)
