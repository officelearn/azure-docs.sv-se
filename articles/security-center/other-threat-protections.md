...
En lista över Azure Defender för Resource Manager-aviseringar finns i [referens tabellen för aviseringar](alerts-reference.md#alerts-resourcemanager).
