<properties
   pageTitle="Säkerhetsaviseringar per typ i Azure Security Center | Microsoft Azure"
...
# Säkerhetsaviseringar per typ i Azure Security Center
...
## Vilka typer av aviseringar finns?
...
## Beteendeanalys av virtuell dator
...
### Möjlig utgående Denial of Service-attack upptäcktes
...
### Onormal åtkomst från en okänd plats
