...
Den här artikeln hjälper dig att konfigurera Azure Security Center-säkerhetsprinciper som tillhandahålls av [Azure Policy](../azure-policy/azure-policy-introduction.md).
