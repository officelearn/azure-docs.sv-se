<properties
   pageTitle="Identifieringsfunktioner i Azure Security Center | Microsoft Azure"
...
## Så här identifierar och svarar Azure Security Center på hot
