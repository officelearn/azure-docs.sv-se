---
title: Kryptering för Azure storage-konto i Azure Security Center | Microsoft Docs
...
ms.locfileid: "60703936"
---
# <a name="encryption-for-azure-storage-account-in-azure-security-center"></a>Kryptering för Azure storage-konto i Azure Security Center

Azure Storage-kryptering av vilande data är aktiverat som standard för alla Azure storage-konton. Azure Storage krypterar data skrivs till Azure Storage och dekrypterar dem före hämtning. Mer information finns i [Azure Storage kryptering för vilande data](../storage/common/storage-service-encryption.md).
