...
Azure-säkerhetsövervakningsagenten (ASM) har följande fotavtryck för baslinjen:

* 3MB minnesfotavtryck för det mesta, med eventuella toppar på 10 MB när ett scenario körs var 12:e timma.  
* Försumbart CPU från både beständig process och skannrar. 
* Försumbar diskanvändning.

ASM-agenten har en processkedja som kan nå totalt cirka 30 MB minne.  Varje övervakningsagent kan använda upp till 3 GB disk. Varje instans är högst 20 procent CPU, även om det i praktiken är mycket mindre. 

När datainsamlingsfunktionen är aktiverad i säkerhetsprincipen installeras övervakningsagenten och tilläggen automatiskt på alla befintliga och nya kompatibla virtuella datorer som skapas i  Azure.  Agentens process är avsedd att vara icke-inkräktande och har mycket minimal påverkan på den virtuella datorns prestanda.
...
Kostnaderna för den här lagringen ingår inte i priset för Security Center-tjänsten och debiteras separat enligt [Azures vanliga priser för lagring](https://azure.microsoft.com/pricing/details/storage/). Ur planeringsperspektiv bör du vara medveten om att Säkerhetscenter lägger till data till din Azure-lagring som kan öka kostnaden med mellan 1 till 3 dollar per år.
