<properties
   pageTitle="Felsökningsguide för Azure Security Center | Microsoft Azure"
...
> [AZURE.NOTE] Om Azure Security Center-agenten beter sig felaktigt måste du starta om den virtuella måldatorn eftersom det inte finns något kommando för att stoppa och starta agenten.
