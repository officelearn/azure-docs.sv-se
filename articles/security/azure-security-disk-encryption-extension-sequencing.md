...
* Tillämpa Azure Disk Encryption-tillägget när du har en anpassad kommandoskript som formaterar skrivbordet (Linux): [deploy-extseq-linux-ADE-after-customscript.json](https://github.com/Azure-Samples/compute-automation-configurations/blob/master/ade-vmss/deploy-extseq-linux-ADE-after-customscript.json)
