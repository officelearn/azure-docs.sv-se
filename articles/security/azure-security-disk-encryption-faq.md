...
I artikeln [Azure Disk Encryption förutsättningar](azure-security-disk-encryption-prerequisites.md) visas de VM- [storlekar](azure-security-disk-encryption-prerequisites.md#supported-vm-sizes) och [virtuella dator operativ system](azure-security-disk-encryption-prerequisites.md#supported-operating-systems) som stöder Azure Disk Encryption.
...
Ja, du kan utföra en yum uppdatering på en Red Hat Linux-dator.  Mer information finns i [hantering av Linux-paket bakom en brand vägg](azure-security-disk-encryption-tsg.md#linux-package-management-behind-a-firewall).
...
I Windows använder ADE BitLocker-AES256 krypterings metod (AES256WithDiffuser på tidigare versioner än Windows Server 2012). I Linux använder ADE standardvärdet AES-XTS-plain64 med en huvud nyckel på 256-bitars volym.
...
XFS-volymer stöds endast för datadisk-kryptering med EncryptFormatAll. Då formateras volymen och eventuella data raderas tidigare. Mer information finns i den [EncryptFormatAll kriterier](azure-security-disk-encryption-linux.md#bkmk_EFACriteria).
