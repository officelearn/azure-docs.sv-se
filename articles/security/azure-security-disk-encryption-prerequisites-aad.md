...
3. Kontrollera de installerade versionerna av moduler.
      ...
      ```
4. Logga in på Azure med hjälp av den [Connect AzAccount](/powershell/module/az.profile/connect-azaccount) cmdlet.
