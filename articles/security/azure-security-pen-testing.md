...
En av fördelarna med att använda Microsoft Azure för att testa program och distribution är att du inte behöver skapa en lokal infrastruktur för att utveckla, testa och distribuera ditt program. Hela infrastrukturen har åtgärdat av Microsoft Azure-plattformstjänster. Du behöver inte bry dig om rekvisition, hämta, och ”förflyttning och stapling” lokal maskinvara.
...
När du är redo att penna testa ditt program för Azure som värd, har du möjlighet att [berätta för oss](https://portal.msrc.microsoft.com/en-us/engage/pentest). När vi vet att du ska att utföra specifika test, vi stängs inte av misstag du (till exempel blockerar IP-adressen som du testar från), så länge som dina tester motsvarar Azure pennan testa villkor och villkor som beskrivs i [Microsoft Cloud Unified intrång testning regler för Engagement](https://technet.microsoft.com/en-us/mt784683).
...
Är du redo att sätta igång med penna testa dina program finns i Microsoft Azure? Om så är fallet och sedan öppna på över den [intrång Test översikt](https://technet.microsoft.com/library/mt784683.aspx) (och klicka på knappen Skapa ett testning begära längst ned på sidan. Du hittar också mer information om pennan testa villkor och användbara länkar på hur du kan rapportera säkerhetsbrister relaterade till Azure eller andra Microsoft-tjänster.
