...
MSRC har publicerat ett antal [faktablad](https://technet.microsoft.com/library/bb969102.aspx) som hjälper dig att förstå vad de gör och hur de gör. Vissa ger insikter om hur vi kan skydda Microsoft-molnet och innehåller användbar information om hur du kan använda samma säkerhetskonfigurationer.
...
Mer information om MSRC finns i [MSRC startsidan](https://technet.microsoft.com/library/dn440717.aspx).
