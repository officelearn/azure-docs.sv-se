...
- **CIS-ID: t**: den CIS-benchmark-rekommendation som motsvarar den här rekommendationen.  
...
- **Information**: motiveringen till rekommendationen och länkar till vägledning om hur du implementerar rekommendationen. Om rekommendationen stöds av Azure Security Center visas den här informationen här.  
