...
description: Säkerhets kontroll identitet och Access Control
author: msmbaldwin
manager: rkarlin
ms.service: security
ms.topic: conceptual
...
Läs mer: https://docs.microsoft.com/azure/active-directory/privileged-identity-management/
...
Azure AD repor ting- https://docs.microsoft.com/azure/active-directory/reports-monitoring/
