...
description: Identitets- och åtkomstkontroll för säkerhetskontroll
author: msmbaldwin
manager: rkarlin
ms.service: security
ms.topic: conceptual
...
Lära sig mer:https://docs.microsoft.com/azure/active-directory/privileged-identity-management/
...
Så här visar du riska 2-inloggningar för Azure AD:
