...
Om du använder anpassade definitioner för Azure-principer använder du Azure Azure DevOps eller Azure databaser för att lagra och hantera din kod på ett säkert sätt.
