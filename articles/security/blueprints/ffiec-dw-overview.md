---
title: Azure-säkerhet och efterlevnad skissen - datalagret för FFIEC
description: Azure-säkerhet och efterlevnad skissen - datalagret för FFIEC
services: security
author: meladie
...
ms.locfileid: "57241433"
---
# <a name="azure-security-and-compliance-blueprint-data-warehouse-for-ffiec-financial-services"></a>Azure Blueprint för säkerhet och efterlevnad: Data Warehouse för FFIEC ekonomiska tjänster

## <a name="overview"></a>Översikt

Den här Azure Blueprint för säkerhet och efterlevnad ger vägledning för distribution av ett data warehouse-arkitektur i Azure som är lämplig för insamling, lagring och hämtning av finansiella data regleras av finansiella Institution undersökning (FFIEC).
...
![Data Warehouse för FFIEC referens för Arkitekturdiagram](images/ffiec-dw-architecture.png "Data Warehouse för Arkitekturdiagram för FFIEC referens")
...
Dataflödesdiagram för denna Referensarkitektur är tillgängligt för [hämta](https://aka.ms/ffiec-dw-tm/) eller finns nedan. Den här modellen kan hjälpa kunderna att förstå punkterna i risken i system-infrastruktur när du gör ändringar.

![Data Warehouse för FFIEC hotmodell](images/ffiec-dw-threat-model.png "Data Warehouse för FFIEC hotmodell")
...
Den [Azure säkerhet och efterlevnad skissen – FFIEC Data Warehouse implementering matrisen](https://aka.ms/ffiec-dw-cim) innehåller information som på vilka FFIEC mål med hjälp av data warehouse-arkitektur, inklusive detaljerade beskrivningar av hur implementeringen uppfyller kraven för varje skyddad mål.
