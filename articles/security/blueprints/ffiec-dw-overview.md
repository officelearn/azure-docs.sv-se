---
title: Handlingsplan för säkerhet och efterlevnad i Azure-informations lager för FFIEC
description: Handlingsplan för säkerhet och efterlevnad i Azure-informations lager för FFIEC
services: security
author: meladie
...
ms.locfileid: "68781074"
---
# <a name="azure-security-and-compliance-blueprint-data-warehouse-for-ffiec-financial-services"></a>Azure Security and Compliance Blueprint (Handlingsplan för säkerhet och efterlevnad i Azure): Informations lager för FFIEC Financial Services

## <a name="overview"></a>Översikt

Den här Handlingsplan för säkerhet och efterlevnad i Azure ger vägledning för distribution av en data lager arkitektur i Azure som lämpar sig för insamling, lagring och hämtning av finansiella data som regleras av Federal Financial institution reprövnings rådets (FFIEC).
...
![Data lager för FFIEC referens arkitektur diagram](images/ffiec-dw-architecture.png "Data lager för FFIEC referens arkitektur diagram")
...
Data flödes diagrammet för den här referens arkitekturen är tillgängligt för [hämtning](https://aka.ms/ffiec-dw-tm/) eller finns nedan. Den här modellen kan hjälpa kunder att förstå punkter av potentiell risk i system infrastrukturen när de gör ändringar.

![Data lager för FFIEC hot modell](images/ffiec-dw-threat-model.png "Data lager för FFIEC hot modell")
...
Den [handlingsplan för säkerhet och efterlevnad i Azure – FFIEC för data lager implementering](https://aka.ms/ffiec-dw-cim) innehåller information om vilka FFIEC-mål som hanteras av data lager arkitekturen, inklusive detaljerade beskrivningar av hur implementeringen uppfyller kraven för varje täckt mål.
...
[Azure Active Directory](https://docs.microsoft.com/azure/active-directory/active-directory-whatis) är viktigt för att hantera distributionen och tillhandahålla åtkomst till personal som interagerar med miljön. En befintlig Windows Server-Active Directory kan integreras med Azure Active Directory i [fyra klick](https://docs.microsoft.com/azure/active-directory/connect/active-directory-aadconnect-get-started-express). Kunder kan också knyta samman den distribuerade Active Directory infrastrukturen (domänkontrollanter) till en befintlig Azure Active Directory genom att göra den distribuerade Active Directory-infrastrukturen till en under domän till en Azure Active Directory skog.
