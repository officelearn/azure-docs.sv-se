...
![IaaS-webbprogram för GDPR-referens för Arkitekturdiagram](images/gdpr-iaaswa-architecture.png?raw=true "IaaS-webbprogram för Arkitekturdiagram för GDPR-referens")
...
![IaaS-webbprogram för GDPR hotmodell](images/gdpr-iaaswa-threat-model.png?raw=true "IaaS-webbprogram för GDPR hotmodell")
