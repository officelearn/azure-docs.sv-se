...
| [Azure DevOps (tidigare VSTS)](https://azure.microsoft.com/services/devops/) | |  |  | :heavy_check_mark: |
...
| [Network Watcher-trafikanalys](https://docs.microsoft.com/azure/network-watcher/traffic-analytics) |  |  |  | :heavy_check_mark: |
...
&ast;&ast; Azure Databricks SOC attestering innehåller SOC 2 typ 2-rapport
