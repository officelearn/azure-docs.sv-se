...
- Distribuera Azure-webbappen med App Service miljö som är en dedikerad isolerad med brand Väggs aEcess på klient sidan.
...
- Konfigurera Azure policy och blå utskrifter för att utvärdera efterlevnaden
...
- [Azure Web App](https://docs.microsoft.com/azure/app-service/overview/).  Tillhandahåller en HTTP-baserad tjänst för att vara värd för webb program.
