...
| **Attribut**              | Ej tillämpligt  |
| **Referenser**              | Ej tillämpligt  |
| **Sätt** | Symmetriska Stream-chiffer, till exempel RC4, får inte användas. I stället för symmetriska Stream-chiffer bör produkter använda ett block chiffer, särskilt AES med en nyckel längd på minst 128 bitar. |
...
| **Attribut**              | Ej tillämpligt  |
| **Referenser**              | Ej tillämpligt  |
| **Sätt** | Se till att en princip för enhets hantering är på plats som kräver en PIN-kod för användning och tillåter fjärrrensning |
...
| **Attribut**              | Ej tillämpligt  |
| **Referenser**              | Ej tillämpligt  |
| **Sätt** | Se till att en princip för enhets hantering är på plats som kräver PIN/Password/Auto Lock och krypterar alla data (t. ex. BitLocker) |
...
| **Sätt** | Se till att signerings nycklarna överförs när du använder identitets servern. Länken i avsnittet referenser förklarar hur detta bör planeras utan att orsaka avbrott i program som förlitar sig på identitets servern. |
...
| **Attribut**              | Ej tillämpligt  |
| **Referenser**              | Ej tillämpligt  |
| **Sätt** | <p>Se till att ett kryptografiskt starkt klient-ID, klient hemlighet, används i identitets servern. Följande rikt linjer bör användas när du genererar ett klient-ID och en hemlighet:</p><ul><li>Generera ett slumpmässigt GUID som klient-ID</li><li>Generera en kryptografiskt slumpmässig 256-bitars nyckel som hemlighet</li></ul>|
