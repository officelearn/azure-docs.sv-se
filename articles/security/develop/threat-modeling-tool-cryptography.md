...
## <a id="cipher-length"></a>Använd endast godkända symmetriska block chiffer och nyckel längder
...
## <a id="padding"></a>Använda godkända asymmetriska algoritmer, nyckel längder och utfyllnad
...
| **Dokumentattribut**              | Gäller inte  |
| **Reference**              | Gäller inte  |
| **Steg** | <p>Produkterna måste använda godkända slumpmässiga nummer generatorer. Pseudorandom-funktioner som C runtime-funktionen rand, .NET Framework Class system. Random eller system functions, t. ex. GetTickCount, får därför aldrig användas i sådan kod. Användning av DUAL_EC_DRBG-algoritmen (Elliptic Curve slump tals Generator) är förbjuden</p><ul><li>**CNG-** BCryptGenRandom (Använd BCRYPT_USE_SYSTEM_PREFERRED_RNG-flaggan rekommenderas om inte anroparen kan köras på en IRQL som är större än 0 [PASSIVE_LEVEL])</li><li>**Capi-** cryptGenRandom</li><li>**Win32/64-** RtlGenRandom (nya implementeringar bör använda BCryptGenRandom eller CryptGenRandom) * rand_s * SystemPrng (för kernelläge)</li><li>**. NET-** RNGCryptoServiceProvider eller RNGCng</li><li>**Windows Store-appar –** Windows. Security. Cryptography. CryptographicBuffer. GenerateRandom eller. GenerateRandomNumber</li><li>**Apples OS X (10.7 +)/iOS (2.0 +)-** int SecRandomCopyBytes (SecRandomRef slump, size_t Count, uint8_t \*byte)</li><li>**Apples OS X (< 10.7) –** Använd/dev/Random för att hämta slumpmässiga siffror</li><li>**Java (inklusive Google Android Java-kod)-** Java. Security. SecureRandom-klass. Observera att för Android 4,3 (Gelée bönor) måste utvecklare följa den rekommenderade Android-lösningen och uppdatera sina program för att explicit initiera PRNG med entropi från/dev/urandom eller/dev/Random</li></ul>|
...
## <a id="mac-hash"></a>Använd godkända MAC-/HMAC-/HMAC-hash-algoritmer
...
## <a id="strong-db"></a>Använd starka krypteringsalgoritmer för att kryptera data i databasen
...
| **Tillämpliga tekniker** | Generisk |
| **Dokumentattribut**              | Gäller inte  |
| **Reference**              | [Välja en krypteringsalgoritm](https://technet.microsoft.com/library/ms345262(v=sql.130).aspx) |
...
## <a id="ssis-signed"></a>SSIS-paket ska vara krypterade och digitalt signerade
...
| **Tillämpliga tekniker** | Generisk |
| **Dokumentattribut**              | Gäller inte  |
| **Reference**              | [Identifiera källan till paket med digitala signaturer](https://msdn.microsoft.com/library/ms141174.aspx), [hot och sårbarhets minskning (integrerings tjänster)](https://msdn.microsoft.com/library/bb522559.aspx) |
...
## <a id="securables-db"></a>Lägg till digital signatur till en kritisk databas skydd bara objekt
...
| **Tillämpliga tekniker** | Generisk |
| **Dokumentattribut**              | Gäller inte  |
| **Reference**              | [SQL Server utöknings bar nyckel hantering (EKM)](https://msdn.microsoft.com/library/bb895340), utöknings [bar nyckel hantering med Azure Key Vault (SQL Server)](https://msdn.microsoft.com/library/dn198405) |
...
## <a id="keys-engine"></a>Använd funktionen AlwaysEncrypted om krypterings nycklar inte ska visas för databas motorn
...
| **Dokumentattribut**              | SQL-version – V12, MsSQL2016 |
| **Reference**              | [Always Encrypted (databas motor)](https://msdn.microsoft.com/library/mt163865) |
...
## <a id="keys-iot"></a>Lagra kryptografiska nycklar säkert på IoT-enheter
...
| **SDL-fas**               | Utveckla |  
| **Tillämpliga tekniker** | Generisk |
| **Dokumentattribut**              | Enhetens operativ system – Windows IoT Core, enhets anslutning – Azure IoT-enhets-SDK: er |
| **Reference**              | [TPM på Windows IoT Core](https://developer.microsoft.com/windows/iot/docs/tpm), [Konfigurera TPM på Windows IoT Core](https://docs.microsoft.com/windows/iot-core/secure-your-device/setuptpm), [Azure IoT Device SDK TPM](https://github.com/Azure/azure-iot-hub-vs-cs/wiki/Device-Provisioning-with-TPM) |
...
## <a id="random-hub"></a>Generera en slumpmässig symmetrisk nyckel med tillräcklig längd för autentisering till IoT Hub
...
## <a id="pin-remote"></a>Se till att en princip för enhets hantering är på plats som kräver en PIN-kod för användning och tillåter fjärrrensning
...
## <a id="bitlocker"></a>Se till att en princip för enhets hantering är på plats som kräver PIN/Password/Auto Lock och krypterar alla data (t. ex. BitLocker)
...
## <a id="rolled-server"></a>Se till att signerings nycklar överförs när du använder en identitets Server
...
| **Tillämpliga tekniker** | Generisk |
| **Dokumentattribut**              | Gäller inte  |
| **Reference**              | [Identitets Server – nycklar, signaturer och kryptografi](https://identityserver.github.io/Documentation/docsv2/configuration/crypto.html) |
...
## <a id="client-server"></a>Se till att det kryptografiskt starka klient-ID: t, klient hemligheten används i identitets servern
