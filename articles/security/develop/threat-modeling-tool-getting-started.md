...
| **Komma igång guide**                   | Öppnar **[Microsoft Threat Modeling Tool](threat-modeling-tool.md)** huvud sida                                                                                                                                                                                                                                                                                                                                                                                            |
...
> Cristina: Är det enkelt att se på ett enkelt, men det kan du hjälpa mig genom det?
> Ricardo: Att! Här är en uppdelning:
...
När han klickar på vyn analysvy från menyn ikon (fil med förstorings glas), tas han eller hon till en lista med de genererade hoten som Threat Modeling Tool som finns baserat på standard mal len, som använder SDL-metoden för att använda SDL **[(förfalskning, manipulation, Avslöjande av information, oavvislig het, Denial of service och höjning av privilegier](https://en.wikipedia.org/wiki/STRIDE_(security))** . Idén är att program varan finns under en förutsägbar uppsättning hot som kan hittas med dessa 6 kategorier.
