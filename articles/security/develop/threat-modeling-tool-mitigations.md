...
| **[Auktoriseringsregeln](threat-modeling-tool-authorization.md)** | Vad kan du göra? Auktorisering är hur ditt program ger åtkomst kontroller för resurser och åtgärder |
