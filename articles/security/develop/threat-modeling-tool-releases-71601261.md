...
titleSuffix: Azure
description: Läs viktig information om de Microsoft Threat Modeling Tool som lanserades den 1/29/2019. Anteckningarna innehåller funktions ändringar och kända problem.
author: jegeib
ms.author: jegeib
ms.service: security
