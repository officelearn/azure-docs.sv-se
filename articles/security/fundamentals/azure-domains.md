---
title: Referens lista för Azure-domäner
description: Referens lista för Azure-domäner (inte omfattande)
services: security
author: memildin
manager: rkarlin
ms.assetid: ''
...
ms.locfileid: "87433211"
---
# <a name="reference-list-of-azure-domains-not-comprehensive"></a>Referens lista för Azure-domäner (inte omfattande)

Den här sidan är en del av listan över Azure-domäner som används. En del av dem är REST API slut punkter.


|Tjänst  |Underdomän  |
|---------|---------|
|[Azure-Access Control Service](https://azure.microsoft.com/blog/one-month-retirement-notice-access-control-service/) (dras tillbaka)|*.accesscontrol.windows.net|
...
|[Azure-BizTalk Services](https://azure.microsoft.com/pricing/details/biztalk-services/) (dras tillbaka)|*. biztalk.windows.net|
|[Azure Blob Storage](https://docs.microsoft.com/azure/storage/blobs/)|*.blob.core.windows.net|
|[Azure Cloud Services](https://docs.microsoft.com/azure/cloud-services/cloud-services-choose-me) och [Azure Virtual Machines](https://docs.microsoft.com/azure/virtual-machines/)|*. cloudapp.net|
...
|Azure Container Service (ACS) (inaktuell)|*. azurecontainer.io|
...
|Hanterings tjänster för Azure|*. management.core.windows.net|
...
|[Azure Stack kant](https://azure.microsoft.com/products/azure-stack/edge/) och [Azure IoT Edge](https://azure.microsoft.com/services/iot-edge/)|*.azureedge.net|
