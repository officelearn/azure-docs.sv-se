...
- [Förstå behörigheter i Azure DDoS Protection](../../virtual-network/manage-ddos-protection.md#permissions)
...
**Vägledning**: Använd en säker, Azure-hanterad arbets station med Azure Multi-Factor Authentication (MFA) aktiverat för att logga in på och konfigurera Azure Customer lockbox-begäranden.
...
- [Visa Azure AD-riskfylld inloggning](/azure/active-directory/reports-monitoring/concept-risky-sign-ins)
