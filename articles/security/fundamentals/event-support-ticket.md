...
ms.locfileid: "68727344"
---
# <a name="how-to-log-a-security-event-support-ticket"></a>Så här loggar du ett support ärende för en säkerhets händelse
...
3. När du har valt problem typ och kategori klickar du på knappen**Starta förfrågan**. Ange följande information för att hjälpa oss att bättre förstå problemet.
    ...
    IV. Har du ett meddelande som du vill skicka till kunderna? Vi kommer att samar beta med dig för att skapa ett lämpligt meddelande om det är tillämpligt.
