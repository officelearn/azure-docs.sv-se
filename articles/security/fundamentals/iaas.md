...
Använd [Azure Security Center](../../security-center/security-center-intro.md)för att övervaka säkerhets position för dina [virtuella](../../security-center/security-center-linux-virtual-machine.md) [Windows](../../security-center/security-center-virtual-machine.md) -och Linux-datorer. I Security Center kan du skydda dina virtuella datorer genom att dra nytta av följande funktioner:
