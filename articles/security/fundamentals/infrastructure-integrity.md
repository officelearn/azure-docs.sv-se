...
description: Lär dig mer om Azures infrastruktur integritet och de steg som Microsoft vidtar för att skydda den, till exempel virus genomsökningar på program varu komponent versioner.
services: security
