...
-   [Kabel kryptering](../../storage/common/storage-security-guide.md), till exempel [SMB 3,0-kryptering](../../storage/common/storage-security-guide.md) för [Azure](../../storage/files/storage-dotnet-how-to-use-files.md)-filresurser.
