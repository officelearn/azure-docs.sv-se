...
I den här artikeln diskuterar vi en samling [Azure SQL Database](../../sql-database/sql-database-technical-overview.md) och [SQL Data Warehouse](../../synapse-analytics/sql-data-warehouse/sql-data-warehouse-overview-what-is.md) säkerhets metoder för att skydda din PaaS-webb (Platform-as-a-Service) och mobila program. Dessa bästa metoder härleds från vår erfarenhet av Azure och våra kunders upplevelser som du själv har.
