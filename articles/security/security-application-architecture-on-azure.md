---
title: Integrera säkerhet i din Azure arkitekturritningar | Microsoft Docs
description: " Den här artikeln hjälper dig att förstå arkitekturen för program och tjänster på Azure för att göra det enklare att integrera säkerhet i design och implementering. "
services: security
...
Varje skissen inkluderar följande:

* Fast 2D Visio 2003-baserad fil som du kan hämta och ändra
* Färgad 3D-perspektiv PDF-fil att introducera skissen till mindre teknisk målgrupper
* Videon går igenom 3D-version

## <a name="cloud-and-enterprise-symbol-set"></a>Molnet och företagets symbol set
