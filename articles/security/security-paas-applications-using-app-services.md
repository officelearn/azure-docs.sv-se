...
För App Service i Windows kan du också begränsa IP-adresser dynamiskt genom att konfigurera Web. config. Mer information finns i [dynamisk IP-säkerhet](https://docs.microsoft.com/iis/configuration/system.webServer/security/dynamicIpSecurity/).
