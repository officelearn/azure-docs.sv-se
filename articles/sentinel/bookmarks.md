...
3. Välj **Visa frågeresultat**. Några exempel:
...
5. Välj **Lägg till bok märke**:
    ...
    > [!div class="mx-imgBorder"]
    > fråga](./media/bookmarks/add-hunting-bookmark.png) för ![lägga till jakt bok märken
...
7. I avsnittet **information om frågor** använder du List rutorna för att extrahera information från frågeresultaten för entitetstyper för **konto**, **värd**och **IP-adress** . Den här åtgärden mappar den valda entitetstypen till en viss kolumn från frågeresultatet. Några exempel:
...
1. I Azure Portal navigerar du till **kontroll** > **Threat Management** > **jakt**. 
...
1. I Azure Portal går du till **kontroll** > **Threat management** > **jakt** > **bok märken** och väljer det bok märke eller bok märken som du vill undersöka.
...
1. I Azure Portal går du till **kontroll** > **Threat management** > **jakt** > **bok märken** och väljer det bok märke eller bok märken som du vill lägga till i en incident.

2. Välj **incident åtgärder (förhands granskning)** från kommando fältet:
    
    > [!div class="mx-imgBorder"]
    > ![lägga till bok märken i incident](./media/bookmarks/incident-actions.png)
...
Om du vill visa frågor, resultat eller historik för bok märken väljer du bok märket från fliken **jakt** > **bok märken** och använder länkarna i informations fönstret: 
...
1.  I Azure Portal går du till **kontroll** > **Threat management** > **jakt** > **bok märken** och väljer det bok märke eller bok märken som du vill ta bort. 
