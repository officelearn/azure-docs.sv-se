...
1. Om du vill se poster i tabellen frågar du tabellen med hjälp av tabell namnet som schema.
   ...
   :::image type="content" source="./media/connect-logstash/logstash-custom-logs-query.png" alt-text="Skärm bild av anpassade loggar token-loggar.":::
