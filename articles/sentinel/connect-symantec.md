...
description: Lär dig hur du använder Symantec ICDx Connector för att enkelt ansluta alla dina Symantec-säkerhetslösnings loggar med Azure Sentinel.
services: sentinel
