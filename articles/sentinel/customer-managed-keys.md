...
1.  [Skapa Azure Key Vault resurs](https://docs.microsoft.com/azure-stack/user/azure-stack-key-vault-manage-portal?view=azs-1910)och generera eller importera sedan en nyckel som ska användas för data kryptering.
    > [!NOTE]
    >  Azure Key Vault måste konfigureras som återställnings Bart för att skydda nyckeln och åtkomsten.

1.  [Aktivera återställnings alternativ:](../key-vault/key-vault-best-practices.md#turn-on-recovery-options)

    -   Se till att [mjuk borttagning](../key-vault/key-vault-ovw-soft-delete.md) är aktiverat.

    -   Aktivera [rensnings skyddet](../key-vault/key-vault-ovw-soft-delete.md#purge-protection) för att skydda mot framtvingad borttagning av hemligheten/valvet även efter mjuk borttagning.
