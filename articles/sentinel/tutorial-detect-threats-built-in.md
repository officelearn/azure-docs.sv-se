...
- **Fusion** -baserad på fusions teknik, avancerad attack identifiering i flera steg i Azure Sentinel använder skalbara algoritmer för maskin inlärning som kan korrelera många varningar och händelser över flera produkter till hög åter givning och åtgärder incidenter. Fusion är aktiverat som standard. Eftersom logiken är dold kan du inte använda den som en mall för att skapa mer än en regel.
