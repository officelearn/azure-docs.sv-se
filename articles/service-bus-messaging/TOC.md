# Översikt
## [Vad är Service Bus-meddelanden?](service-bus-queues-topics-subscriptions.md)
...
## [Skapa signaturer för delad åtkomst (SAS)](service-bus-sas-overview.md)
...
### [Använda AMQP med .NET API](service-bus-dotnet-advanced-message-queuing.md)
### [Använda AMQP med partitionerade köer och ämnen](service-bus-partitioned-queues-and-topics-amqp-overview.md)
