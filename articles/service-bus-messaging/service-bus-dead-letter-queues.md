...
Den här artikeln beskrivs köer i Azure Service Bus. Mycket av diskussionen visas den [förlorade köer exempel](https://github.com/Azure/azure-service-bus/tree/master/samples/DotNet/Microsoft.ServiceBus.Messaging/DeadletterQueue) på GitHub.
