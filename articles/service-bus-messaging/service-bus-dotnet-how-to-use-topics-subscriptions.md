...
2. I det vänstra navigeringsfönstret i portalen klickar du på **Service Bus** (om du inte ser **Service Bus** klickar du på **Fler tjänster** eller på **Alla resurser**). Klicka på det namnområde där du vill skapa ämnet. 
