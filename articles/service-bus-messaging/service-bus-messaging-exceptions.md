---
title: Azure Service Bus – undantag för meddelanden | Microsoft-dokument
...
I den här artikeln visas .NET-undantag som genereras av .NET Framework API:er. 
...
Felsökningstips finns i [felsökningsguiden](service-bus-troubleshooting-guide.md)
