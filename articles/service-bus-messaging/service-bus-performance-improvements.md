...
När du ställer in receive-läge [ReceiveAndDelete][ReceiveAndDelete], båda stegen kombineras i en enskild begäran. De här stegen minska det totala antalet åtgärder och kan förbättra den övergripande genomströmningen. Den här prestandafördelar kommer dess risk att förlora meddelanden.
...
* Ange batching intervall till 50 ms att minska antalet överföringar för Service Bus-klient-protokollet. Om du använder flera avsändare, öka batching intervallet 100 MS.
* Lämna gruppbaserad store-åtkomst aktiverat. Denna åtkomst ökar den övergripande hastighet som meddelanden kan skrivas i kön.
* Ange antalet prefetch till 20 gånger de högsta hastighetsprestanda av alla mottagare av ett fabriken. Det här antalet minskar antalet överföringar för Service Bus-klient-protokollet.
...
* Om du använder flera klienter, anger du antalet prefetch till 0. Genom att ange antalet får andra klienten det andra meddelandet när den första klienten fortfarande bearbetar det första meddelandet.
* Använda en partitionerad kö för bättre prestanda och tillgänglighet.
...
* Lämna gruppbaserad store-åtkomst aktiverat. Denna åtkomst ökar den övergripande hastighet som meddelanden kan skrivas till den kö eller ett ämne.
* Ange antalet prefetch till 20 gånger de högsta hastighetsprestanda av alla mottagare av ett fabriken. Det här antalet minskar antalet överföringar för Service Bus-klient-protokollet.
* Använda en partitionerad kö för bättre prestanda och tillgänglighet.
...
Service Bus kan upp till 1 000 samtidiga anslutningar till en entitet. Om en kö kräver mer än 1000 mottagare, Ersätt kön med ett ämne och flera prenumerationer. Varje prenumeration kan stöda upp till 1000 samtidiga anslutningar. Mottagare kan också komma åt kön via HTTP-protokollet.
...
* Ange antalet prefetch till ett mindre värde (till exempel PrefetchCount = 10). Det här antalet förhindra mottagare inaktiv medan andra mottagare har stora mängder meddelanden som cachelagras.
* Använda en partitionerad kö för bättre prestanda och tillgänglighet.
...
* Använd asynkrona åtgärder för att dra nytta av klientsidan batchbearbetning.
* Använd standard batchbearbetning intervall på 20 ms för att minska antalet överföringar för Service Bus-klient-protokollet.
* Lämna gruppbaserad store-åtkomst aktiverat. Denna åtkomst ökar den övergripande hastighet som meddelanden kan skrivas i avsnittet.
* Ange antalet prefetch till 20 gånger de högsta hastighetsprestanda av alla mottagare av ett fabriken. Det här antalet minskar antalet överföringar för Service Bus-klient-protokollet.
...
Avsnitt med ett stort antal prenumerationer exponera en låg totala genomflödet vanligtvis om alla meddelanden dirigeras till alla prenumerationer. Den här låg genomströmning beror på att varje meddelande tas emot många gånger, och alla meddelanden som finns i ett ämne och alla prenumerationer lagras i samma Arkiv. Det antas att antalet avsändare och mottagare per prenumeration antal är litet. Service Bus stöder upp till 2 000 prenumerationer per avsnitt.

Prova följande steg för att maximera genomströmningen:

* Använd asynkrona åtgärder för att dra nytta av klientsidan batchbearbetning.
* Använd standard batchbearbetning intervall på 20 ms för att minska antalet överföringar för Service Bus-klient-protokollet.
* Lämna gruppbaserad store-åtkomst aktiverat. Denna åtkomst ökar den övergripande hastighet som meddelanden kan skrivas i avsnittet.
* Ange antalet prefetch till 20 gånger den förväntade receive frekvensen i sekunder. Det här antalet minskar antalet överföringar för Service Bus-klient-protokollet.
* Använd en partitionerad avsnittet för bättre prestanda och tillgänglighet.
