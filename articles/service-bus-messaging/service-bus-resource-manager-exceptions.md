...
| 429 | inga | Begäran om enhets *enhets namn* står i konflikt med en annan begäran | En annan motstridig åtgärd pågår på samma resurs/entitet | Vänta tills den föregående åtgärden har slutförts innan du försöker igen |
| 429 | inga | En annan uppdateringsbegäran pågår för entitetens *enhets namn*. | En annan motstridig åtgärd pågår på samma resurs/entitet | Vänta tills den föregående åtgärden har slutförts innan du försöker igen |


## <a name="error-code-not-found"></a>Felkod: Kunde inte hittas

Den här fel klassen anger att resursen inte hittades.

| Felkod | Fel under kod | Felmeddelande | Beskrivning | Rekommendation |
| ---------- | ------------- | ------------- | ----------- | -------------- |
| Kunde inte hittas | inga | Det gick inte att hitta entitetens *enhets namn* . | Den entitet som åtgärden inte hittades mot. | Kontrol lera att entiteten finns och försök igen. |
| Kunde inte hittas | inga | Hittades inte. Åtgärden finns inte. | Åtgärden som du försöker utföra finns inte. | Kontrol lera åtgärden och försök igen. |
| Kunde inte hittas | inga | Den inkommande begäran identifieras inte som en begäran om att lagra en namn områdes princip. | Den inkommande begär ande texten är null och kan därför inte köras som en begäran. | Kontrol lera begär ande texten och se till att den inte är null. | 
| Kunde inte hittas | inga | Det gick inte att hitta *enhets namnet* för meddelande enheten. | Det gick inte att hitta den entitet som du försöker köra åtgärden mot. | Kontrol lera om entiteten finns och försök sedan igen. |
