...
Nästa steg är att koppla ihop funktionen och Service Bus-namnområdet. I det här exemplet använder du Azure-portalen. Se sidan [concepts](service-bus-to-event-grid-integration-concept.md för en beskrivning av hur du använder PowerShell eller Azure CLI till att göra samma sak.
