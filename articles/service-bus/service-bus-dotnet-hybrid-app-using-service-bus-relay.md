...
-   Hur du använder Azure Service Bus Relay för att dela data mellan ett Azure-program och en webbtjänst som är värdbaserad någon annanstans.
...
3.  Programmet startas och ska köras i en webbläsare.
...
1.  Om programmet inte redan är öppet öppnar du det **ProductsPortal**-projekt som du skapade i avsnittet "Skapa ett ASP.NET-program” igen i Visual Studio.
...
7.  Högerklicka på lösningen **ProductsPortal** i Solution Explorer och klicka sedan på **Lägg till** och **Befintligt objekt**.
