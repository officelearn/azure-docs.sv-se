...
* Service Fabric nät (för hands version) tillgänglighet i Azure-regionen (`westus`, `eastus`eller `westeurope`)
...
* [Åtgärds stöd för flytt av resurser](../azure-resource-manager/management/move-support-resources.md
)
