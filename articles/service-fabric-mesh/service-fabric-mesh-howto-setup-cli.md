...
| Maven CLI | Lokala kluster och Azure Service Fabric Mesh | `az mesh` EnomslutningsomgörattJava-utvecklarekananvändaenvälbekantkommandoradsupplevelseförlokalochAzure`sfctl` -utvecklings miljö.  
