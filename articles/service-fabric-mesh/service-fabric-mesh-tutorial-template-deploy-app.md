...
|serviceImage|Containeravbildning för serverdelstjänsten.  For example, "<myregistry>.azurecr.io/seabreeze/azure-mesh-todo-service:1.0-nanoserver-1709".|
...
Du bör se följande efter ett par minuter:
