...
- För **hands** version: nyckel [ **valvs referens för Service Fabric program har endast stöd för **versions hemligheter** . Hemligheter utan versioner stöds inte.**](https://docs.microsoft.com/azure/service-fabric/service-fabric-keyvault-references)
...
- [**Resurs styrnings stödet har förbättrats**](https://docs.microsoft.com/azure/service-fabric/service-fabric-resource-governance): tillåter förfrågningar och begränsar specifikationer för processor-och minnes resurser.

### <a name="service-fabric-72-releases"></a>Service Fabric 7,2-versioner
| Utgivningsdatum | Frisläpp | Mer information |
|---|---|---|
| 21 oktober 2020 | [Azure Service Fabric 7,2](https://techcommunity.microsoft.com/t5/azure-service-fabric/azure-service-fabric-7-2-release/ba-p/1805653)  | [Versionsanmärkningar](https://github.com/microsoft/service-fabric/blob/master/release_notes/Service-Fabric-72-releasenotes.md)|
