...
|---|---|
| [Skapa AZ SA kluster](https://docs.microsoft.com/en-us/cli/azure/sf/cluster?view=azure-cli-latest#az_sf_cluster_create) | Skapar ett nytt Service Fabric-kluster.  |
