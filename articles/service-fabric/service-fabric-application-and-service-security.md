...
Reliable Services Application Framework innehåller några inbyggda kommunikations stackar och verktyg som du kan använda för att förbättra säkerheten. Lär dig hur du kan förbättra säkerheten när du använder tjänstens fjärr [C#](service-fabric-reliable-services-secure-communication.md) kommunikation (i eller [Java](service-fabric-reliable-services-secure-communication-java.md)) eller med [WCF](service-fabric-reliable-services-secure-communication-wcf.md).
