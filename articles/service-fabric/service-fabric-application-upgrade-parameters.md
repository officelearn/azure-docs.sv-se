---
title: 'Program uppgradering: uppgraderings parametrar | Microsoft Docs'
...
Använd den vågräta rullnings listen längst ned i tabellen för att visa fältet fullständig beskrivning.
...
| WhatIf | PS | Tillåtna värden är **True** och **false**. Visar vad som händer om cmdleten körs. Cmdleten körs inte. |
...
Offline | Tillåtna värden **övervakas**, **UpgradeMode**, **UnmonitoredAuto**, **UnmonitoredManual**. Standardvärdet är **UnmonitoredAuto**. Se avsnittet *obligatoriska parametrar* i Visual Studio och PowerShell för beskrivningar av dessa värden.|
