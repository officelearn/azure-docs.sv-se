...
> [!NOTE]
> Om du bestämmer dig för att distribuera Service Fabric på Windows Server 1709, Observera att (1) det är inte en långsiktig service gren, så du kan behöva flytta versioner i framtiden och (2) om du distribuerar behållare fungerar inte behållare som bygger på Windows Server 2016 på Windows Server  1709 och vice versa (du måste återskapa dem för att distribuera dem).
>
