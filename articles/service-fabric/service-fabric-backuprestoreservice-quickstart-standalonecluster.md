...
* Service Fabric-kluster med Fabric version 6.4 eller senare. Referera till denna [artikeln](service-fabric-cluster-creation-for-windows-server.md) steg att ladda ned paket som krävs.
