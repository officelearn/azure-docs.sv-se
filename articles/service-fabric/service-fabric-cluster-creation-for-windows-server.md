...
#### <a name="scenario-a-create-an-unsecured-local-development-cluster"></a>Scenario A: Skapa ett oskyddat lokalt utvecklingskluster
...
#### <a name="scenario-c-create-an-offline-internet-disconnected-cluster"></a>Scenario C: Skapa ett offline (internet frånkopplad)-kluster
