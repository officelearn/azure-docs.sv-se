...
* **TimeToRun**: Totalt antal tiden som Chaos kör innan den är klar med framgång. Du kan stoppa Chaos innan den har körts under TimeToRun via StopChaos API.
