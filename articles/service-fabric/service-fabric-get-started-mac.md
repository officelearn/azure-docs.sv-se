...
1. Klona `Vagrantfile`-databasen
    ...
    ```
    Det här steget hämtar filen `Vagrantfile` som innehåller VM-konfigurationen tillsammans med den plats som den virtuella datorn laddas ned från.  Filen pekar på en Ubuntu-avbildning.
...
## <a name="install-the-necessary-java-artifacts-on-vagrant-optional-if-you-want-to-use-the-java-programming-models"></a>Installera nödvändiga Java-artefakter på Vagrant (valfritt om du vill använda Java-programmeringsmodeller)
