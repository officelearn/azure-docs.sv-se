...
5. Det tar en liten stund för klustret att starta. Du kan visa loggar med följande kommando eller gå till instrumentpanelen och visa klusterhälsotillståndet [http://localhost:19080](http://localhost:19080):
