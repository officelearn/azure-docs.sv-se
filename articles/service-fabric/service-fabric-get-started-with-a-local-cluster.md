<properties
   pageTitle="Komma igång med att distribuera och uppgradera appar i det lokala klustret | Microsoft Azure"
...
3. Ta också en titt på listan över partitioner för WordCountService:
    ...
    > [AZURE.NOTE] Mer information om Service Fabric Explorer finns i [Visualisera klustret med Service Fabric Explorer](service-fabric-visualizing-your-cluster.md).
