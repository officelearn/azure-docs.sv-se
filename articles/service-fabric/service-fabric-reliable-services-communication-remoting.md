...
2. Använd [FabricTransportServiceRemotingListener](https://docs.microsoft.com/dotnet/api/microsoft.servicefabric.services.remoting.v2.fabrictransport.runtime.fabrictransportserviceremotingListener?view=azure-dotnet) från namn området `Microsoft.ServiceFabric.Services.Remoting.V2.FabricTransport.Runtime`.
...
3. Använd [FabricTransportServiceRemotingClientFactory](https://docs.microsoft.com/dotnet/api/microsoft.servicefabric.services.remoting.v2.fabrictransport.client.fabrictransportserviceremotingclientfactory?view=azure-dotnet) från namn området `Microsoft.ServiceFabric.Services.Remoting.V2.FabricTransport.Client` för att skapa klienter.
...
2. Åsidosätt standardprovidern för serialisering med `JsonSerializationProvider` för en lyssnare för fjärr kommunikation.
