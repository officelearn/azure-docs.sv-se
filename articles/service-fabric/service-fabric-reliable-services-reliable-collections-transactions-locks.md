...
En tillförlitlig kö använder lås på åtgärds nivå som tillåter en transaktion med `TryPeekAsync` och/eller `TryDequeueAsync` och en transaktion med `EnqueueAsync` i taget.
...
| --- |:--- |:--- |:--- |:--- |
| Delad |Ingen konflikt |Ingen konflikt |uppstod |uppstod |
| Uppdatering |Ingen konflikt |Ingen konflikt |uppstod |uppstod |
| Öppna |Ingen konflikt |uppstod |uppstod |uppstod |
