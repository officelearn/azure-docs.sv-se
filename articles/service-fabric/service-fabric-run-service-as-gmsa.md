...
3. Konfigurera användarens huvud namn och konfigurera `RunAsPolicy` för att referera till [användaren](https://docs.microsoft.com/azure/service-fabric/service-fabric-cluster-fabric-settings#runas).
