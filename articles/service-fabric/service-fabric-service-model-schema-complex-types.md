...
#### <a name="servicegroup"></a>Tjänst grupp
...
Driv rutins alternativ som ska skickas till driv rutinen. Azure Files volym-plugin-programmet har stöd för följande driv rutins alternativ: resurs namn (Azure Files fil resurs som tillhandahåller volymen för behållaren), storageAccountName (det Azure Storage-konto som innehåller Azure Files fil resurs), storageAccountKey (åtkomst nyckel för Azure Storage-kontot som innehåller Azure Files-filresursen).
...
Det här värdet definierar skyddet av värdet för attributet. Det kan vara SecretsStoreRef/krypterat/klartext.
Om värdet är inställt på SecretsStoreRef, refererar värdet till en hemlighet som lagras krypterad i klustrets SecureStore, som är inloggad och dekrypterad vid aktivering.
...
Typ av miljö variabel. Den kan vara klar text/krypterad/SecretsStoreRef.
...
#### <a name="faultdomain"></a>Faulydomain
...
Det här värdet definierar den typ av lösen ord som du har angett i attributet "Password". Det kan vara SecretsStoreRef/krypterat/klartext.
Om värdet är SecretsStoreRef hämtar vi referensvärdet från SecretStore.
Om är inställt på krypterad är programutvecklaren ansvarig för att skapa ett certifikat och använda cmdleten Invoke-ServiceFabricEncryptSecret för att kryptera känslig information.
...
Användardefinierad typ identifierare för en tjänst grupp, till exempel "ActorQueueSGType". Det här värdet används i ApplicationManifest.xml-filen för att identifiera tjänst gruppen.
...
#### <a name="servicetypename"></a>ServiceTypeName
Användardefinierad typ identifierare för en tjänst. Till exempel "QueueType" eller "CalculatorType". Det här värdet används i ApplicationManifest.xml-filen för att identifiera tjänsten.
