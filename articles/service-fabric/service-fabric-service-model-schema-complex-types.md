---
title: XML-schema för Azure Service Fabric service Model, komplexa typer | Microsoft Docs
...
PFX-filen och-lösen ordet är tillgängliga i behållaren med hjälp av Certificates_ServicePackageName_CodePackageName_CertName_PFX-och Certificates_ServicePackageName_CodePackageName_CertName_Password-miljövariablerna. PEM-filen är tillgänglig i behållaren med hjälp av variablerna Certificates_ServicePackageName_CodePackageName_CertName_PEM och Certificates_ServicePackageName_CodePackageName_CertName_PrivateKey-miljövariabeln.
...
Om behållaren har HEALTHCHECK aktive rad och Docker Reports health_status event för den här behållaren kommer Service Fabric att inkludera detta som en del av systemets rapporterade hälsa. När health_status är felfritt Service Fabric rapportera en hälso varning. Som standard är den inställd på True.
...
Om behållaren har HEALTHCHECK aktive rad och Docker Reports health_status event för den här behållaren startar Service Fabric om behållaren när health_status som rapporteras av Docker inte är felfri.
...
Rättigheter att bevilja: Läs, ändra eller fullständig. Standardvärdet är Read.
...
Anger den maximala procent andelen av felaktiga tjänster innan programmet betraktas som ohälsosamt. Standard procents ATS: 0.
...
Anger den maximala procent andelen av felaktiga partitioner innan en tjänst betraktas som ohälsosam. Standard procents ATS: 0.
...
Anger den maximala procent andelen av felaktiga repliker innan en partition anses vara ohälsosam. Standard procents ATS: 0.
