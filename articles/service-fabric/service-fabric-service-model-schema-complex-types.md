...
Ange en standardanvändarkontot för alla kodpaket för tjänsten att don t har en specifik RunAsPolicy som definierats i avsnittet ServiceManifestImport.
|Attribut|Värde|
|---|---|
...
|Attribut|Värde|
|---|---|
|innehåll|3-element, attribut som 1|
|definierats|globalt|
...
|Attribut|Värde|
|---|---|
|innehåll|9-element, attribut som 5|
|definierats|globalt|
...
Isoleringsläget för behållaren. Giltiga värden är standard, process eller Hyper-v (stöds endast för Windows-behållare) på Windows 10-värddatorer, endast Hyper-V-isoleringsläget stöds, så att behållaren körs i Hyper-V-isoleringsläget oavsett inställningen för domänläge dess isolering.
|Attribut|Värde|
|---|---|
|namn|Isolering|
|Använd|valfri|
...
|Attribut|Värde|
|---|---|
|innehåll|3-element, attribut som 10|
|definierats|globalt|
...
Protokoll för slutpunkten. HTTPS-slutpunkter måste också ha en EndpointCertificate och en EndpointBindingPolicy deklarerats i manifestet. Protokollet kan inte ändras senare i en uppgradering av programmet. 
|Attribut|Värde|
|---|---|
|namn|Protokoll|
|typ|Xs:String|
...
|Attribut|Värde|
|---|---|
|innehåll|18-element, attribut som 0|
|definierats|globalt|
...
Behörighet att bevilja, standard läses.
|Attribut|Värde|
|---|---|
|namn|GrantRights|
|standard|Läsa|
...
Typ av resurs, som definierats i tjänstmanifestet slutpunkten eller certifikat.
|Attribut|Värde|
|---|---|
|namn|ResourceType|
|Använd|valfri|
...
|Attribut|Värde|
|---|---|
|innehåll|7-element, attribut som 0|
|definierats|globalt|
...
Anger maximalt tillåten procentandel tjänster som är felaktiga innan programmet betraktas som defekt. Procent som standard: 0.
|Attribut|Värde|
|---|---|
...
Anger maximalt tillåten procentandel partitioner som är felaktiga innan en tjänst betraktas som defekt. Procent som standard: 0.
|Attribut|Värde|
|---|---|
...
Anger maximalt tillåten procentandel skadade repliker innan en partition betraktas som defekt. Procent som standard: 0.
|Attribut|Värde|
|---|---|
