...
Om värdet är true krypteras värdet för den här parametern. Programutvecklaren ansvarar för att skapa ett certifikat och använda cmdleten Invoke-ServiceFabricEncryptSecret för att kryptera känslig information. Den certifikat information som ska användas för att kryptera värdet anges i avsnittet certifikat. Det här attributet är föråldrat. Använd Type-attribut.
...
Om är inställt på krypterad är programutvecklaren ansvarig för att skapa ett certifikat och använda cmdleten Invoke-ServiceFabricEncryptSecret för att kryptera känslig information.
