...
Deklarerar ett certifikat som används för att kryptera känslig information i applikations manifestet. Program författaren använder cmdleten Invoke-ServiceFabricEncryptSecret för att kryptera känslig information, som kopieras till en parameter i avsnittet ConfigOverrides.
...
Beskriver åsidosättningar av konfigurationen för det importerade tjänst manifestet. Med konfigurations åsidosättningar kan du använda samma tjänst manifest på nytt över flera program typer genom att åsidosätta tjänst Manifestets konfiguration endast när den används med en viss program typ. Åsidosättningar av konfigurationen kan ändra standard konfigurationen i ett tjänst manifest så länge standard konfigurationen definieras med Settings. xml i mappen ConfigPackage. 
