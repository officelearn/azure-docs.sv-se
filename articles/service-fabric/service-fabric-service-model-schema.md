...
# <a name="service-model-xml-schema-documentation"></a>Dokumentation för tjänsten modellen XML-schema
Den här artikeln dokumenteras ServiceFabricServiceModel.xsd schemafilen som installerats med Service Fabric-SDK.  Som standard installeras schemafilen till *C:\Program Files\Microsoft SDKs\Service Fabric\schemas\ServiceFabricServiceModel.xsd*.

## <a name="namespace-bindings"></a>Namespace-bindningar
|Prefix|Namespace-URI|
|---|---|
|Xs|http://www.w3.org/2001/XMLSchema|
|Ingen|http://schemas.microsoft.com/2011/01/fabric|

## <a name="component-summary"></a>Sammanfattning 
Följande komponenter har definierats i den http://schemas.microsoft.com/2011/01/fabric namnområde i ServiceFabricServiceModel.xsd:
- [293 element](service-fabric-service-model-schema-elements.md)
...
- [3 elementet grupper](service-fabric-service-model-schema-element-groups.md)
