---
title: Beskrivningar av XML-scheman för Azure Service Fabric service Model
description: En beskrivning av XML-schemat för Service Fabric tjänst modellen, inklusive plats och en sammanfattning av komponenter.
ms.topic: reference
ms.date: 12/10/2018
...
# <a name="service-model-xml-schema-documentation"></a>Dokumentation om XML-scheman för service modell
I den här artikeln dokumenteras ServiceFabricServiceModel. xsd-schemafilen som installeras med Service Fabric SDK.  Som standard installeras schema filen på *C:\Program\Microsoft SDKs\Service Fabric\schemas\ServiceFabricServiceModel.xsd*.

## <a name="namespace-bindings"></a>Bindningar för namnrymd

|Prefix|Namnområdes-URI|
|---|---|
|x|`https://www.w3.org/2001/XMLSchema`|
...
- [3 element grupper](service-fabric-service-model-schema-element-groups.md)
