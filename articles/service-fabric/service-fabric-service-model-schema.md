---
title: XML-schemabeskrivningar för Azure Service Fabric-tjänstmodell
description: En beskrivning av XML-schemat för tjänstmodellen Service Fabric, inklusive plats och en sammanfattning av komponenter.
ms.topic: reference
ms.date: 12/10/2018
...
ms.locfileid: "75639198"
---
<!-- The schema reference articles were generated by the Python script found in the end of this file -->

# <a name="service-model-xml-schema-documentation"></a>Xml-schemadokumentation för tjänstmodell
Den här artikeln dokumenterar schemafilen ServiceFabricServiceModel.xsd som installerats med Service Fabric SDK.  Som standard installeras schemafilen på *C:\Program Files\Microsoft SDK\Service Fabric\schemas\ServiceFabricServiceModel.xsd*.

## <a name="namespace-bindings"></a>Namnområdesbindningar

|Prefix|Namnområde URI|
|---|---|
|Xs|`https://www.w3.org/2001/XMLSchema`|

## <a name="component-summary"></a>Sammanfattning av komponent 
Följande komponenter definieras i ServiceFabricServiceModel.xsd:
- [257 element](service-fabric-service-model-schema-elements.md)
- [112 complexTyper](service-fabric-service-model-schema-complex-types.md)
- [1 simpleTypes](service-fabric-service-model-schema-simple-types.md)
- [3 elementgrupper](service-fabric-service-model-schema-element-groups.md)
- [16 attributgrupper](service-fabric-service-model-schema-attribute-groups.md)
