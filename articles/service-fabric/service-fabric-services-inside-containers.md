...
9. Konfigurera isoleringsläge för behållare kan se [konfigurera isoleringsläge]( https://docs.microsoft.com/en-us/azure/service-fabric/service-fabric-get-started-containers#configure-isolation-mode). Windows stöder två isoleringslägen för containrar: process och Hyper-V. Följande kodfragment visar hur isoleringsläget har angetts i applikationsmanifestfilen.
