...
description: Beskriver program kommandona Service Fabric för programsfctl CLI-.
...
| statusinformation | Hämtar information om ett Service Fabric-program. |
...
| Uppenbarligen | Hämtar manifestet som beskriver en program typ. |
...
| Uppdatering | Startar uppgraderingen av ett program i Service Fabric klustret. |
...
| --hälso kontroll-vänte tid | Vänte tiden när en uppgraderings domän har slutförts innan hälso kontrollerna påbörjas.  Standard\: 0. |
