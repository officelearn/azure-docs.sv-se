...
| health | Hämtar hälsan för en Service Fabric tillstånds känslig tjänst-replikering eller tillstånds lös tjänst instans. |
| info | Hämtar information om en replik av en Service Fabric partition. |
| list | Hämtar information om repliker av en Service Fabric-tjänstepartition. |
