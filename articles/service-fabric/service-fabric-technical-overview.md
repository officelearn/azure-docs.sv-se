...
Begreppen i det här avsnittet beskrivs i följande Microsoft Virtual Academy-videor: <a target="_blank" href="https://mva.microsoft.com/en-US/training-courses/building-microservices-applications-on-azure-service-fabric-16747?l=tbuZM46yC_5206218965">viktiga begrepp</a>, <a target="_blank" href="https://mva.microsoft.com/en-US/training-courses/building-microservices-applications-on-azure-service-fabric-16747?l=tlkI046yC_2906218965">designfasen begrepp</a>, och <a target="_blank" href="https://mva.microsoft.com/en-US/training-courses/building-microservices-applications-on-azure-service-fabric-16747?l=x7CVH56yC_1406218965">Runtime-koncept</a>.
...
**Service Fabric-nät program**: nät program för Service Fabric som beskrivs i resurs-modellen (resursfiler YAML och JSON) och kan distribueras till alla miljöer där Service Fabric kan köras.

**Service Fabric-interna program**: interna program för Service Fabric beskrivs av interna program-modellen (XML-baserade program och tjänstmanifest).  Interna program för Service Fabric kan inte köras i Service Fabric-nät.
...
**Nätverk**: en nätverksresurs som skapar ett privat nätverk för dina program och är oberoende av program eller tjänster som kan referera till den. Flera tjänster från olika program kan inte ingå i samma nätverk. Nätverk är distribuerbar resurser som refereras av program.
...
**Redundanshanteraren service**: varje Service Fabric-kluster har en Redundanshanteraren-tjänst som ansvarar för följande åtgärder:
...
**Reparera Manager-tjänsten**: det här är en valfri systemtjänst som gör att repareringsåtgärder kan utföras på ett kluster i ett sätt som är säkra, vägkarta och transparent. Reparera manager används på:
