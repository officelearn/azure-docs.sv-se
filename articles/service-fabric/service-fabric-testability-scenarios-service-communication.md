...
I det här exemplet anger vi `QuorumLossMode` till `QuorumReplicas` för att indikera att vi vill inducera kvorum utan att ta bort alla repliker. På så sätt är Läs åtgärder fortfarande möjliga. Om du vill testa ett scenario där en hel partition inte är tillgänglig kan du ange den här växeln till `AllReplicas`.
