...
1. Kör containeravbildningen med platsen för certifikaten på den lokala datorn monterad
...
1. Skapa ett **nytt objekt** på Jenkins-instrumentpanelen.
