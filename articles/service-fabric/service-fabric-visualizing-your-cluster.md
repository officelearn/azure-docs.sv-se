...
Service Fabric Explorer finns också i ett Service Fabric-kluster hanteringsslutpunkten för HTTP. Om du vill starta SFX i en webbläsare, bläddra till klustrets HTTP-hanteringsslutpunkt från valfri webbläsare – till exempel https:\//clusterFQDN:19080.
...
Visningsprogrammet för store är en funktion som erbjuds om med inbyggd avbildning Store som gör det möjligt att visa det aktuella innehållet i avbildningen lagra och få fil- och information, tillsammans med filer/mappar tas bort.

![Service Fabric Explorer klusterkarta][sfx-imagestore]
