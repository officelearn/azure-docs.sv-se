...
Icke-plattformshändelser utlöses av användarnas åtgärder. Exempel stoppa en virtuell dator eller når det maximala antalet anslutningar till en Redis-cache.
