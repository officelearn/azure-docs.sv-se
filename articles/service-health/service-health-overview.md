...
description: Lär dig hur Service Health ger dig en anpassningsbar instrument panel som spårar hälso tillståndet för dina Azure-tjänster i de regioner där du använder dem.
ms.topic: conceptual
ms.date: 05/10/2019
