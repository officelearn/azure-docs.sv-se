...
### [Arkitektur för VMware till Azure](site-recovery-architecture-vmware-to-azure.md)
...
#### [Steg 2: Kontrollera krav och begränsningar](vmware-walkthrough-prerequisites.md)
...
#### [Steg 9: Konfigurera en replikeringsprincip](vmware-walkthrough-replication.md)
