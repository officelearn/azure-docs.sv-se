...
**Position** | **Komponent** |**Information**
--- | --- | ---
...
**Krav** | **Information**
--- | ---
**Azure-prenumerations konto** | Om du inte har en Azure-prenumeration kan du skapa ett [kostnads fritt konto](https://azure.microsoft.com/pricing/free-trial/).
