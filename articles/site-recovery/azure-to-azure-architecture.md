---
title: Azure till Azure-replikerings arkitektur i Azure Site Recovery | Microsoft Docs
description: Den här artikeln innehåller en översikt över komponenter och arkitektur som används när du konfigurerar haveri beredskap mellan Azure-regioner för virtuella Azure-datorer med hjälp av tjänsten Azure Site Recovery.
...
**Mål resurs** | **Standardinställning**
--- | ---
...
Läs mer om [utgående anslutning](azure-to-azure-about-networking.md#outbound-connectivity-for-ip-address-ranges) för Site Recovery och att [kontrol lera anslutningen till NSG: er](concepts-network-security-group-with-site-recovery.md).
