...
- Site Recovery stöder Azure Disk Encryption version 0,1, som har ett schema som kräver Azure Active Directory (Azure AD). Site Recovery stöder också version 1,1, som inte kräver Azure AD. [Läs mer om tillägget scheman för Azure Disk Encryption](../virtual-machines/extensions/azure-disk-enc-windows.md#extension-schemata).
...
Nej, Site Recovery kräver ingen Internet anslutning. Men det krävs åtkomst till Site Recovery URL: er och IP-intervall, som du ser i [nätverk i haveri beredskap för virtuella Azure-datorer](https://docs.microsoft.com/azure/site-recovery/azure-to-azure-about-networking#outbound-connectivity-for-ip-address-ranges).
