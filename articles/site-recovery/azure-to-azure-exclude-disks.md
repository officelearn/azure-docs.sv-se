...
- Den virtuella datorn har nått [Azure Site Recovery-gränserna för att replikera data ändras priser](https://docs.microsoft.com/azure/site-recovery/azure-to-azure-support-matrix#azure-site-recovery-limits-to-replicate-data-change-rates)
