...
1. Anpassa mål inställningarna som sammanfattas i tabellen.
   ...
   | **Tillgänglighets uppsättningar för mål** | Som standard skapar Azure Site Recovery en ny tillgänglighets uppsättning i mål regionen med namnet `asr` suffix för den virtuella dator delen av en tillgänglighets uppsättning i käll regionen. Om tillgänglighets uppsättningen som skapats av Azure Site Recovery redan finns används den igen. |
...
1. Spåra förlopp och status på följande sätt:
   ...
   1. I **inställningar** > **Replikerade objekt** visas status för virtuella datorer och den inledande replikeringsprocessen. Välj den virtuella datorn för att öka detalj nivån i inställningarna.
