...
Om du inte ser ditt Azure-VM för val när du aktiverar replikering, kanske detta på grund av inaktuella Site Recovery-konfiguration lämnas på Azure VM. Inaktuell konfiguration kan lämnas på en Azure VM i följande fall:
