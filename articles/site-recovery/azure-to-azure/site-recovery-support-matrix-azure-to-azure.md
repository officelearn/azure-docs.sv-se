...
>[!NOTE]
>
> - Replikera virtuella Azure-datorer från en prenumeration till en annan för för katastrofåterställning stöds inte.
> - Migrera Azure virtuella datorer över prenumerationer stöds inte.
> - Migrera Azure virtuella datorer i samma region stöds inte.
> - Migrera virtuella Azure-datorer från klassiska distributionsmodellen till Resource manager-distributionsmodellen inte stöds.
...
- Börja skydda dina arbetsbelastningar av [replikering av virtuella Azure-datorer](azure-to-azure-quickstart.md)
