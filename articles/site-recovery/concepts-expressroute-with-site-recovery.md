...
Site Recovery replikerar data till ett Azure Storage konto eller en replik hanterad disk på Azure-målets Azure-region via en offentlig slut punkt. Om du vill använda ExpressRoute för Site Recovery replikeringstrafik kan du använda [Microsoft](../expressroute/expressroute-circuit-peerings.md#microsoftpeering) -peering eller en befintlig [offentlig peering](../expressroute/expressroute-circuit-peerings.md#publicpeering) (inaktuell för nya skapelser). Microsoft-peering är den rekommenderade routningsdomänen för replikering. Observera att replikering inte stöds via privat peering.
...
- Hämta PsExec-verktyget [härifrån för att](https://aka.ms/PsExec) få åtkomst till användar kontexten för systemet.
...
Det kombinerade scenariot visas i följande diagram: ![Lokal-till-Azure med ExpressRoute](./media/concepts-expressroute-with-site-recovery/site-recovery-with-expressroute.png)
...
För haveri beredskap för virtuella Azure-datorer krävs som standard inte ExpressRoute för replikering. När de virtuella datorerna redundansväxlas till Azure-regionen kan du komma åt dem via [privat peering](../expressroute/expressroute-circuit-peerings.md#privatepeering).
