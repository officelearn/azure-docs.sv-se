...
![Komponenter](./media/concepts-physical-to-azure-architecture/arch-enhanced.png)
...
![Replikeringsprocessen](./media/concepts-physical-to-azure-architecture/v2a-architecture-henry.png)
...
![Återställning efter fel](./media/concepts-physical-to-azure-architecture/enhanced-failback.png)
