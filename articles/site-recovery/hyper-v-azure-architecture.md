...
4. Du kan övervaka jobbet på fliken **jobb** .      ![Lista över](media/hyper-v-azure-architecture/image1.png) ![jobb Aktivera skydd öka](media/hyper-v-azure-architecture/image2.png)
