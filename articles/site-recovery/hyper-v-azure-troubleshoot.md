---
title: Felsök haveri beredskap för Hyper-V till Azure med Azure Site Recovery | Microsoft Docs
...
1. Kontrol lera händelse loggarna för VSS-fel och rekommendationer:
    ...
    - Ett vanligt fel är: "Hyper-V kunde inte skapa VSS-ögonblicksbilden för den virtuella datorn XYZ: Ett icke-tillfälligt fel uppstod i skrivaren. Att starta om VSS-tjänsten kan lösa problem om tjänsten inte svarar. "
