---
title: Om Distributionshanteraren för Azure Site Recovery för haveri beredskap för virtuella Hyper-V-datorer till Azure | Microsoft Docs
...
Den rekommenderade konfigurationen av den virtuella datorn: 8 virtuella processorer, 16 GB RAM, 300 GB HDD.
...
Exempel: Kopiera .zip-filen till enhet E:\ och packa upp den. E:\ASR Deployment Planner_v 2.3. zip
