...
![Exkludera diskar från replikering och aktivera replikering för Hyper-V till Azure-återställning efter fel](./media/hyper-v-exclude-disk/enable-replication6-with-exclude-disk.png)
...
![Inställningar för växlingsfiler på den virtuella källdatorn](./media/hyper-v-exclude-disk/pagefile-on-d-drive-sourceVM.png)
...
![Inställningar för växlingsfiler på den lokala virtuella datorn](./media/hyper-v-exclude-disk/pagefile-on-g-drive-sourceVM.png)
...
![Inställningar för växlingsfiler på den virtuella Azure-datorn](./media/hyper-v-exclude-disk/pagefile-on-Azure-vm-after-failover-2.png)
