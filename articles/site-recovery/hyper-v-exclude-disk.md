...
1. Om du vill exkludera diskar när du [aktiverar replikering](site-recovery-hyper-v-site-to-azure.md) för en virtuell Hyper-V-dator, när du har valt de virtuella datorer som du vill replikera, går du till sidan för att **Aktivera replikering** > **Egenskaper** > **Konfigurera egenskaper** , granskar kolumnen **diskar som ska replikeras** . Som standard är alla diskar markerade för replikering.
