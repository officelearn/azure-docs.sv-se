---
title: "Planera kapacitet och skalning för replikering av Hyper-V-dator (utan VMM) till Azure med Azure Site Recovery | Microsoft Docs"
description: "Använd den här artikeln för att planera kapaciteten och skala vid replikering av Hyper-V virtuella datorer till Azure med Azure Site Recovery"
...
---
# <a name="step-3-plan-capacity-and-scaling-for-hyper-v-to-azure-replication"></a>Steg 3: Planera kapacitet och skalning för Hyper-V till Azure-replikering

Använd den här artikeln för att ta reda planera för kapacitet och skala vid replikering av lokala Hyper-V virtuella datorer (utan System Center VMM) till Azure med [Azure Site Recovery](site-recovery-overview.md).
...
Du samla in information om replikeringsmiljön och planera kapacitet med den här informationen, tillsammans med överväganden markerat i den här artikeln.
...
Gå till [steg 4: Planera nätverk](hyper-v-site-walkthrough-network.md).
