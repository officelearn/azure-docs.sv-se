...
1. I valvet > **inställningar** > **replikerade objekt**högerklickar du på den dator som har redundansväxlats > **skyddet igen**.
...
1. I valvet > **inställningar** >**replikerade objekt**väljer du de återställda virtuella datorer som har misslyckats igen och klickar på **skydda igen**.
