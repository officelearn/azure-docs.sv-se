...
Azure Site Recovery publicerar uppdateringar av tjänsten med jämna mellanrum – inklusive tillägg av nya funktioner, förbättringar i stödmatris och felkorrigeringar eventuellt. För att behålla den aktuella gör adavantage av alla senaste funktioner och förbättringar och felkorrigeringar om någon bör användare alltid uppdatera till de senaste versionerna av Azure SIte Recovery-komponenter. 
