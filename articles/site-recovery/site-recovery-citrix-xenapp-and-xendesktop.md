...
Ändra namnet så att det uppfyller kraven för Azure om du behöver. Du kan också visa och lägga till information om mål nätverket, under nätet och IP-adressen som ska tilldelas den virtuella Azure-datorn.
...
![Återställnings plan](./media/site-recovery-citrix-xenapp-and-xendesktop/citrix-tfo.png)
