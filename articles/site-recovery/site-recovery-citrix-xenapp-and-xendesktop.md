...
![Återställningsplan för XenApp-komponenter](./media/site-recovery-citrix-xenapp-and-xendesktop/citrix-recoveryplan.png)
   ...
   >[!NOTE]
   >Du kan använda skript på [plats](https://github.com/Azure/azure-quickstart-templates/blob/>master/asr-automation-recovery/scripts) att uppdatera DNS med den nya IP-adresser för den över > virtuella datorer eller för att koppla en belastningsutjämnare på den redundansväxlade virtuella datorn, om det behövs.
