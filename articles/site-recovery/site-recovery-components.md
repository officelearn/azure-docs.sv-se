...
**Primär plats** | **Processerver**: Konfigurera processserverkomponenten på din primära plats så att den hanterar cachelagring, komprimering och dataoptimering. Den hanterar också push-installationen av Unified Agent till de datorer som du vill skydda.<br/><br/> **VMware ESX/ESXi och vCenter**: Du behöver en VMware EXS/ESXi-hypervisor och eventuellt en VMware vCenter-server.<br/><br/> **Virtuella datorer** | Under distributionen installeras Unified Agent på de datorer du vill skydda. Agenten fungerar som en kommunikationsprovider mellan alla komponenter.
