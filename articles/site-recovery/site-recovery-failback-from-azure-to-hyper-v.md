...
Den här artikeln beskriver hur återställa Hyper-V-datorer skyddas av Site Recovery.

## <a name="prerequisites"></a>Förutsättningar
1. Se till att du har läst informationen om den [olika typer av återställning](concepts-types-of-failback.md) och motsvarande varningar.
...
## <a name="failback-to-an-alternate-location-in-hyper-v-environment"></a>Återställning till en annan plats i Hyper-V-miljö
...
9. Du kan logga in på den lokala virtuella datorn att kontrollera att allt fungerar som förväntat. Klicka på **genomför** att slutföra växling vid fel. Commit tar bort den virtuella Azure-datorn och dess diskar och förbereder den virtuella datorn som ska skyddas igen.
...
Det finns ingen uttrycklig gest kallas återställning efter fel på portalen. Återställning är ett steg där du kommer tillbaka till den primära platsen. Per definition är återställning när du redundans de virtuella datorerna från recovery tillbaka till primär.

När du påbörja en växling informerar bladet om den riktning som de virtuella datorerna är flyttas, om riktningen är från Azure till lokala, är det en återställning efter fel.
