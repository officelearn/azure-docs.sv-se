---
title: "Automatisera installation av Mobilitetstjänsten för Azure Site Recovery med hjälp av programdistribueringsverktyg | Microsoft Docs"
...
Den här artikeln innehåller ett exempel på hur du kan använda System Center Configuration Manager för att distribuera tjänsten Azure Site Recovery Mobility i ditt datacenter. Med ett verktyg för distribution av programvara som Configuration Manager har följande fördelar:
...
* Skalning distribution till hundratals servrar samtidigt


> [!NOTE]
> Den här artikeln använder System Center Configuration Manager 2012 R2 för att demonstrera aktiviteten distribution. Du kan också automatisera installation av Mobilitetstjänsten med hjälp av [Azure Automation och Desired State Configuration](site-recovery-automate-mobility-service-install.md).

## <a name="prerequisites"></a>Krav
1. Ett program distributionsverktyg, som Configuration Manager som redan har distribuerats i din miljö.
  Skapa två [enhetssamlingar](https://technet.microsoft.com/library/gg682169.aspx), en för alla **Windows-servrar**, och en annan för alla **Linux-servrar**, som du vill skydda med Site Recovery.
3. Konfigurationsservern som redan har registrerats med Site Recovery.
4. En säker nätverksfilresurs (Server Message Block-resurs) som kan användas av Configuration Manager-servern.
...
### <a name="step-3-deploy-the-package"></a>Steg 3: Distribuera paketet
...
Du kan övervaka förloppet för distributionen med hjälp av Configuration Manager-konsolen. Gå till **övervakning** > **distributioner** > *[package name]*.
  ...
  ![Skärmbild av Configuration Manager kan övervaka distributioner](./media/site-recovery-install-mobility-service-using-sccm/report.PNG)
...
## <a name="other-methods-to-install-mobility-service"></a>Andra metoder för att installera Mobilitetstjänsten
...
Du är nu redo att [Aktivera skydd](https://docs.microsoft.com/en-us/azure/site-recovery/site-recovery-vmware-to-azure#step-6-replicate-applications) för dina virtuella datorer.
