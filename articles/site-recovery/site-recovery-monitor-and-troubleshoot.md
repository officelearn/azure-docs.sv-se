...
2. Gå nedåt i instrument panelen i olika områden. 
    ...
    ![Site Recovery instrument panel](./media/site-recovery-monitor-and-troubleshoot/site-recovery-overview-page.png).
...
**Låst** | **Detaljer**
--- | ---
Test som rekommenderas | Datorer som inte har haft en redundanstest sedan skyddet aktiverades.
Genomfördes | Datorer med eller flera lyckade redundanstest.
...
Program uppdateringar | Tillgängligheten för nya program uppdateringar och information om upphör ande av program varu versioner.
...
- Om du vill använda vyn infrastruktur väljer du lämpligt scenario för replikering i din miljö. Du kan öka detalj nivån i vyn om du vill ha mer information. I följande tabell visas vilka scenarier som visas.
    ...
    **Scenario** | **Låst**  | **Vyn är tillgänglig?**
    --- |--- | ---
    ...
    **Azure VM-replikering mellan Azure-regioner** | Misslyckad/misslyckad återställning | Nej   
    **VMware-replikering till Azure** | Replikering har Aktiver ATS/inledande replikering pågår | Ja     
    **VMware-replikering till Azure** | Misslyckad/misslyckad återställning | Nej      
    **Hyper-V-replikering till Azure** | Misslyckad/misslyckad återställning | Nej
...
6. Klicka på en dator om du vill gå vidare till mer information om den. Informationen omfattar:
   ...
   - Återställnings punkt (återställnings punkt mål): Aktuell återställning för den virtuella datorn och tiden då återställningen senast beräknades.
   - **Återställnings punkter**: Senaste tillgängliga återställnings punkter för datorn.
   - **Beredskap för redundans**: Anger om ett redundanstest kördes för datorn, den agent version som körs på datorn (för datorer som kör mobilitets tjänsten) och eventuella konfigurations problem.
   - **Fel**: Lista över fel i replikeringen som för närvarande observerats på datorn och möjliga orsaker/åtgärder.
