...
- Sekundär (mål) region är Azure Sydostasien-Sydostasien har en återställnings virtuella nätverk (återställnings-**VNet 1** och **återställnings-VNet 2**) som är identiska med **VNet 1** och **källans VNet 2**.
        - **återställnings-VNet 1** och **återställnings-VNet 2** har två undernät som matchar under näten i **VNet 1** och VNET- **VNet 2** – Sydostasien har ytterligare ett VNet (**Azure VNet**) med adress utrymme 10.3.0.0/16.
