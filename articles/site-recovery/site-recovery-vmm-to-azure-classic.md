<properties
    pageTitle="Replikera virtuella Hyper-V-datorer i VMM-moln till Azure | Microsoft Azure"
...
3. Kontrollera egenskaperna för de virtuella datorerna och ändra dem vid behov.

    ![Verifiera virtuella datorer](./media/site-recovery-vmm-to-azure-classic/vm-properties.png)


4. Du kan ändra följande nätverksegenskaper på fliken **Konfigurera** i egenskaperna för virtuella datorer.
...
>[AZURE.NOTE] Virtuella Linux-datorer med en statisk IP-adress stöds inte.
