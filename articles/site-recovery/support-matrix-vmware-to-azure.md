...
description: "Sammanfattar de operativsystem som stöds och komponenter för att replikera virtuella VMware-datorer till Azure med hjälp av Azure Site Recovery."
...
**Antal datadiskar** | Antalet är 64 eller mindre om du replikerar *virtuella VMware-datorer till Azure*. Antalet är 16 eller mindre om du replikerar *Hyper-V virtuella datorer till Azure*. | Kravkontroll misslyckas om stöds inte.
**VHD-storlek för datadisk** | Upp till 4,095 GB | Kravkontroll misslyckas om stöds inte.
...
**Namn på virtuell dator** | Mellan 1 och 63 tecken.<br/><br/> Begränsat till bokstäver, siffror och bindestreck.<br/><br/> Datornamnet måste börja och sluta med en bokstav eller siffra. | Uppdatera värdet i datoregenskaperna i Site Recovery.
**VM-typ** | Generation 1.<br/><br/> Generation 2 – Windows. | Generation 2 virtuella datorer med en OS-disktyp av grundläggande (som innehåller en eller två datavolymer som formaterats som VHDX) och mindre än 300 GB diskutrymme stöds.<br></br>Linux Generation 2 virtuella datorer stöds inte. Läs mer i [katastrofåterställning till Azure förbättrad](https://azure.microsoft.com/blog/2015/04/28/disaster-recovery-to-azure-enhanced-and-were-listening/).|
