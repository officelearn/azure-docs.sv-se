...
- Om du använder System Center 2012 R2 VMM 
    ...
    - Kontrol lera databas informationen på VMM: **VMM-konsolen** -> **inställningar** -> **allmän** -> **databas anslutning**
    ...
    - Anteckna databas namnet för de SCVMM-servrar som berörs. Detta kan göras genom att gå till **VMM-konsolen** -> **inställningar** -> **allmän** -> **databas anslutning**
...
3. I **Lägg till ta bort program**väljer du **VMM** > **Avinstallera**. b. Välj **ta bort funktioner**och välj sedan V**mm-hanterings Server och VMM-konsol**. c. I **databas alternativ**väljer du **Kvarhåll databas**. d. Granska sammanfattningen och klicka på **Avinstallera**.
