---
title: Skapa och hitta ankare med hjälp av sensorer för enhets sensorer i mål-C | Microsoft Docs
description: Djupgående förklaring av hur du skapar och lokaliserar ankare med hjälp av sensorer för enhets sensorer i mål-C.
author: bucurb
manager: dacoghl
...
ms.locfileid: "74093218"
---
# <a name="how-to-create-and-locate-anchors-using-on-device-sensors-in-objective-c"></a>Skapa och hitta ankare med hjälp av sensorer för enhets sensorer i mål-C
