...
- [Bevara virtuellt innehåll i verkligheten](concepts/create-locate-anchors-unity.md#creating-a-cloud-spatial-anchor). Med en app kan en användare placera en virtuell kalender på väggen i ett konferensrum, som andra kan se med hjälp av en mobilapp eller en HoloLens-enhet. I en industrimiljö kan en användare få sammanhangsbaserad information om en maskin genom att rikta en enhetskamera som stöds mot den.
