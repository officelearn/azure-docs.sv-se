...
Leta upp `case DemoStep::ConfigSession:` och Lägg till följande rad och ersätt i din konto domän från tidigare: `configuration.AccountDomain("MyAccountDomain");` .
