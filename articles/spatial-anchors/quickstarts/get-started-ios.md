...
Leta upp `startSession()` och Lägg till följande rad och ersätt i din konto domän från tidigare: `_cloudSession.configuration.accountDomain = @"MyAccountDomain";` .
