...
| `strict-host-key-checking` | Nej     | Anger om konfigurations Server instansen inte kan starta vid användning av privat `host-key` . Ska vara *Sant* (standardvärde) eller *falskt*. |
...
| `default-label` | Nej     | Standard etiketten för git-lagringsplatsen ska vara *gren namnet*, *taggnamnet*eller lagrings- *ID* för lagrings platsen. |
| `search-paths`  | Nej     | En sträng mat ris som används för att söka i under kataloger på git-lagringsplatsen. |
| `username`      | Nej     | Det användar namn som används för att få åtkomst till git-lagringsplatsen, vilket _krävs_ när git-lagringsplatsen stöder `Http Basic Authentication` . |
| `password`      | Nej     | Lösen ordet som används för att få åtkomst till git-lagringsplatsen, vilket _krävs_ när git-lagringsplatsen stöder `Http Basic Authentication` . |
...
| `repos."username"`                 | Nej             | Det användar namn som används för att få åtkomst till git-lagringsplatsen, vilket _krävs_ när git-lagringsplatsen stöder `Http Basic Authentication` . |
| `repos."password"`                 | Nej             | Lösen ordet som används för att få åtkomst till git-lagringsplatsen, vilket _krävs_ när git-lagringsplatsen stöder `Http Basic Authentication` . |
...
| `repos."strict-host-key-checking"` | Nej             | Anger om konfigurations Server instansen inte kan starta vid användning av privat `host-key` . Ska vara *Sant* (standardvärde) eller *falskt*. |
