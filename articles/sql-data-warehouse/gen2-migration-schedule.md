...
- **Automatiska uppgraderingen:** Automatiska uppgraderingar startar inte så snart tjänsten är tillgänglig i en region.  När automatiska uppgraderingar startar i en viss region, ska enskilda DW-uppgraderingar äga rum under ditt valda underhållsschema. 
- **Lokal uppgradera till Gen2:** Om du vill att reglera när du uppgraderar kan utföra du lokal uppgradera till Gen2. Om din region inte stöds ännu, kan du migrera dina DW till en region som stöds och sedan utför en lokal uppgradering till generation 2.
...
| Södra Brasilien |\* |\* |
| Centrala Kanada |Tillgängligt |Den 1 maj 2019 |
| Östra Kanada |\* |\* |
...
Startar den 16 mars 2019 börjar vi schemaläggning automatiska uppgraderingar för Gen1-instanser. För att undvika oväntade avbrott på tillgängligheten för datalagret, schemaläggs automatiserade uppgraderingar under ditt underhållsschema. Mer information om scheman finns [visa ett underhållsschema](viewing-maintenance-schedule.md)

Uppgraderingen kommer att omfatta en kort minskning i anslutningen (cirka 5 minuter) som vi starta om ditt informationslager.  När ditt informationslager har startats blir fullt tillgänglig för användning men, försämrade prestanda kan brytas medan uppgraderingen fortsätter att uppgradera datafiler i bakgrunden. Den totala tiden för försämrade prestanda varierar beroende på storleken på dina filer.
...
Du kan också om du vill uppgradera nu kan du välja att uppgradera själv genom att följa dessa steg på ett befintligt Gen1-informationslager. Om du väljer det här alternativet måste du slutföra lokal uppgradera innan den automatiska uppgraderingen påbörjas i den regionen. Detta säkerställer att du undviker att risk för automatiska uppgraderingar som orsakar en konflikt.
