...
6. Välj **Spara**. Ett meddelande visas som bekräftar att ditt nya schema nu är aktivt. 
   ...
   ![Meddelande om region tillgänglighet](media/sql-data-warehouse-maintenance-scheduling/maintenance-not-active-toast.png)

## <a name="next-steps"></a>Nästa steg
- [Lär dig mer](../monitoring-and-diagnostics/monitor-alerts-unified-usage.md) om att skapa, Visa och hantera aviseringar med hjälp av Azure Monitor.
- [Läs mer](../monitoring-and-diagnostics/monitor-alerts-unified-log-webhook.md) om webhook-åtgärder för logg aviserings regler.
- [Läs mer](../monitoring-and-diagnostics/monitoring-action-groups.md) Skapa och hantera åtgärds grupper.
