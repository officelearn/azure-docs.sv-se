---
title: "Pausa och återuppta compute i Azure SQL Data Warehouse - Azure-portalen | Microsoft Docs"
...
---
# <a name="pause-and-resume-compute-for-an-azure-sql-data-warehouse-in-the-azure-portal"></a>Pausa och återuppta beräkningen för en Azure SQL Data Warehouse i Azure-portalen
Pausa beräkning för en Azure SQL Data Warehouse att minska kostnaderna. Återuppta databearbetning när du är redo att använda datalagret.
