...
Använda PowerShell för att pausa beräkning för en Azure SQL Data Warehouse att minska kostnaderna. [Återuppta databearbetning](sql-data-warehouse-manage-compute-overview.md) när du är redo att använda datalagret.
