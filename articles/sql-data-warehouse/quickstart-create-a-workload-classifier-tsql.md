...
## <a name="create-theceo-user-in-mysampledatawarehouse"></a>Skapa TheCEO användare i mySampleDataWarehouse
...
## <a name="create-a-workload-classifier-for-theceo-with-high-importance"></a>Skapa en klassificerare för arbetsbelastningen för TheCEO med hög prioritet
