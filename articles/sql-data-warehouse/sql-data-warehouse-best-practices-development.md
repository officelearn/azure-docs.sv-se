...
Se även [förstå transaktioner][Understanding transactions], [Optimizing transactions][Optimizing transactions], [tabell partitionering][tabell partitionering], [truncate Table][TRUNCATE TABLE], [ALTER TABLE][ALTER TABLE], [Skapa tabell som Select (CTAS)][Skapa tabell som Select (CTAS)]
