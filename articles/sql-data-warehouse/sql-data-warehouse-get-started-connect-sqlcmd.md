<properties
   pageTitle="Fråga Azure SQL Data Warehouse (sqlcmd)| Microsoft Azure"
...
Den här genomgången använder kommandoradsverktyget [sqlcmd][] för att fråga en Azure SQL Data Warehouse.  

## 1. Anslut

Du kommer igång med [sqlcmd][] genom att öppna kommandotolken och ange **sqlcmd** följt av anslutningssträngen för din SQL Data Warehouse-databas. Anslutningssträngen kräver följande parametrar:
