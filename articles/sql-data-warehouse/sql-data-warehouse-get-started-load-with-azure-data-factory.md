<properties
   pageTitle="Läs in data med Azure Data Factory | Microsoft Azure"
...
1. [Hämta exempeldata][]. Den här datan lägger till ytterligare tre år med försäljningsdata till din AdventureWorksDW-exempeldata.
