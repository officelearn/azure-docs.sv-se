...
## Nästa steg
Nu när du har värmt upp med exempeldata, kan du se mer information om att [utveckla][utveckla], [läsa in][läsa in] eller [migrera][migrera]. Eller ta en titt på [Power BI-webbplatsen][Power BI-webbplatsen].
