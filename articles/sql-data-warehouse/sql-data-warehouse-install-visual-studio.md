...
För utveckling av program för SQL Data Warehouse, rekommenderar vi att du använder Visual Studio 2015 med den senaste versionen av SQL Server Data Tools (SSDT).  Visual Studio 2013, uppdatering 5 med SSDT, stöds också för bakåtkompatibilitet.  
...
1. [Hämta Visual Studio 2015][Hämta Visual Studio 2015].
2. Följ guiden [Installera Visual Studio][Installera Visual Studio] på MSDN och välj standardkonfigurationerna.
...
Om ingen uppdatering hittas, bör du ha den senaste versionen installerad.  Bekräfta SSDT har installerats genom att klicka på **Hjälp** / **Om Microsoft Visual Studio** och leta efter SQL Server Data Tools i listan.  Den senaste versionen av SSDT är 14.0.60525.0.  Om alternativet att installera inte är tillgängligt från Visual Studio så kan du besöka sida [SSDT hämta][SSDT hämta], för att manuellt hämta och installera SSDT.

## Nästa steg
Nu när du har den senaste versionen av SSDT, är du redo att [ansluta][ansluta] till ditt SQL Data Warehouse.
...
<!--Articles-->
[ansluta]: ./sql-data-warehouse-query-visual-studio.md
