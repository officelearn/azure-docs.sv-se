---
title: Läs in data från SQL Server i Azure SQL Data Warehouse (bcp) | Microsoft Docs
...
Se [Tabellöversikt][Tabellöversikt] eller [CREATE TABLE-syntax][CREATE TABLE-syntax] för ytterligare information om hur man skapar en tabell i SQL Data Warehouse.
