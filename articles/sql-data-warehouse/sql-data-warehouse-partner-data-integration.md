...
Välj en mängd olika branschledande verktyg för att skapa din lösning för slutpunkt till slutpunkt data warehouse. Den här artikeln visar Microsoft partnerföretag med lösningar för integration stöder Azure SQL Data Warehouse.

## <a name="our-data-integration-partners"></a>Våra data integration partner
| Partner | Beskrivning | Länkar | Videoklipp |
| --- | --- | --- | --- |
| ![Alteryx][1] |**Alteryx**<br> Alteryx Designer har ett repeterbara arbetsflöde för självbetjäning dataanalys som leder till djupare insikter i timmar, inte veckor typiska för traditionella metoder! Alteryx Designer ger dataanalytiker genom att kombinera förberedelse av data, blandning av data och analytics – förutsägande statistiska och spatial – med hjälp av samma intuitiva användargränssnitt. |[Marketplace][alteryx_marketplace]<br>[Webbplats][alteryx_designer_website]<br>[Vitboken][alteryx_whitepaper]<br>[Datablad][alteryx_designer_datasheet]<br>[Twitter][alteryx_designer_twitter]<br>[YouTube][alteryx_designer_youtube] |[![Alteryx video](./media/sql-data-warehouse-partner-data-integration/alteryx_designer_video.jpg)](https://www.youtube.com/watch?v=CdqSDPyNDKc) |
| ![Attunity][2] |**Attunity**<br>Attunity CloudBeam är en lösning för automatisk och optimerad för att läsa in data till SQL Data Warehouse. Med en ”klickar du på att belastningen” design förenklar och ger snabbare både batch lästes in samt inkrementell replikering från flera heterogena databaser, inklusive SQL Server, Oracle, DB2, Sybase och mySQL. |[Marketplace][attunity_marketplace]<br>[Snabbstart][attunity_quickstart]<br>[Webbplats][attunity_cloudbeam_website]<br>[Datablad][attunity_cloudbeam_datasheet]<br>[Twitter][attunity_cloudbeam_twitter]<br>[YouTube][attunity_cloudbeam_youtube] |[![Attunity video](./media/sql-data-warehouse-partner-data-integration/attunity_video.jpg)](https://www.youtube.com/watch?v=w14zuSjMlok) |
| ![Bryte system][3] |**Bryte system**<br>Bryte system automatiserar dataöverföring till SQL Data Warehouse från olika databaser och källor. Bryte system specialiserat sig på data movement och integrering tekniker. De skapar skalbara molnbaserade datalager och data sjöar att få insikter. |[Marketplace][bryte_systems_marketplace]<br>[Webbplats][bryte_systems_azure_website] | |
| ![Informatica][4] |**Informatica Cloud Services för Azure – betala per användning**<br> Optimera värdet för dina Azure-tjänster och härleda tillämplig insikter från alla dina hybrid datauppsättningar med Informatica molntjänster för Azure – betala per användning. Informatica molnet ger en bäst i klassen för dataintegrering molnet Analytics, integrera appar och Data Management. Med självbetjäning datamigrering, integrering och hantering funktioner kunder kan snabbt och tillförlitligt importera, exportera, synkronisera och schemalägga petabyte data till Azure från olika källor, till exempel SaaS-program, Hadoop-baserade data sjöar och andra lokala datakällor (Oracle, SAP).  Informatica molntjänster för Azure innehåller ursprungliga, hög volym, högpresterande anslutningen till Azure SQL Data Warehouse, Sgl Database, Blob Storage, Data Lake Store och Azure Cosmos DB. |[Marketplace][informatica_Cloud_Services_marketplace]<br>[Kostnadsfri utvärderingsversion][informatica_cloud_free_trial]<br>[Config-guiden][informatica_cloud_services_config]<br>[Webbplats][informatica_Cloud_Services_website]<br>[Datablad][informatica_cloud_datasheet]<br>[Twitter][informatica_cloud_twitter]<br>[YouTube][informatica_cloud_youtube] | |
| ![Informatica][4] |**Informatica PowerCenter**<br>Informatica är en av världens mest okänt oberoende leverantörer av programvara för integrering. PowerCenter utgör grunden för alla dina data initiativ integration. Använd PowerCenter för analytics datalagring, program-migrering, konsolidering eller datastyrning. |[Marketplace (Standard)][informatica_PowerCenter_std_marketplace]<br>[Marketplace (Avancerat)][informatica_PowerCenter_adv_marketplace]<br>[Webbplats][informatica_PowerCenter_website]<br>[Datablad][informatica_powercenter_datasheet]<br>[Twitter][informatica_powercenter_twitter]<br>[YouTube][informatica_powercenter_youtube] | |
| ![Redgate][5] |**Redgate Data Platform Studio (förhandsgranskning)**<br>Redgate's Data Platform Studio tillhandahåller ett enkelt och tillförlitligt sätt att migrera lokala SQL-databaser till Azure SQL Data Warehouse. Den har utformats för att fatta smarta beslut för en helt automatiserad migrering och kan användas för oneoff migreringar. |[Webbplats][redgate_website]<br>[Twitter][redgate_twitter]<br>[YouTube][redgate_youtube] |[![Redgate video](./media/sql-data-warehouse-partner-data-integration/redgate_video.jpg)](https://www.youtube.com/watch?v=IR9HNvnU46s) |
| ![SnapLogic][6] |**SnapLogic**<br>SnapLogic integrering plattform som en tjänst (iPaaS) ger kunder möjlighet att snabbt överföra data till och från Microsoft Azure SQL Data Warehouse.  SnapLogic ger dig möjlighet att integrera hundratals program, tjänster och IoT-scenarier i en lösning. Leverera snabba och effektiva insikter i molnet, lokal eller hybrid-läge med SnapLogic! |[Marketplace][snaplogic_marketplace]<br>[Webbplats][snaplogic_website]<br>[Datablad][snaplogic_datasheet]<br>[Twitter][snaplogic_twitter]<br>[YouTube][snaplogic_youtube] |[![Snaplogic video](./media/sql-data-warehouse-partner-data-integration/snaplogic_video.jpg)](https://www.youtube.com/watch?v=YiJCwObOh5Y) |

## <a name="next-steps"></a>Nästa steg
Läs mer om några av våra andra partners i [Business Intelligence-partners] [ bi_partners] och [datahantering partners][dm_partners].
