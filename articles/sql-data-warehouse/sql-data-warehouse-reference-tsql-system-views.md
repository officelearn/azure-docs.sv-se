...
## <a name="sql-analytics-catalog-views"></a>Vyer för SQL Analytics-kataloger
...
* [sys. pdw_materialized_view_column_distribution_properties](/sql/relational-databases/system-catalog-views/sys-pdw-materialized-view-column-distribution-properties-transact-sql?view=azure-sqldw-latest) (för hands version)
* [sys. pdw_materialized_view_distribution_properties](/sql/relational-databases/system-catalog-views/sys-pdw-materialized-view-distribution-properties-transact-sql?view=azure-sqldw-latest) (för hands version)
* [sys. pdw_materialized_view_mappings](/sql/relational-databases/system-catalog-views/sys-pdw-materialized-view-mappings-transact-sql?view=azure-sqldw-latest) (för hands version)
...
* [sys. dm_workload_management_workload_groups_stats](https://docs.microsoft.com/sql/relational-databases/system-dynamic-management-views/sys-dm-workload-management-workload-group-stats-transact-sql) (för hands version)

## <a name="sql-server-dmvs-applicable-to-sql-analytics"></a>SQL Server DMV: er som gäller för SQL Analytics
Följande DMV: er gäller för SQL Analytics, men måste köras genom att ansluta till **huvud** databasen.
...
## <a name="sql-server-dmvs-available-in-sql-analytics"></a>SQL Server DMV: er tillgängligt i SQL Analytics
SQL Analytics visar många SQL Server DMV: er (Dynamic Management views). Dessa vyer, när de efter frågas i SQL Analytics, rapporterar status för SQL-databaser som körs på distributionerna.

SQL Analytics och Parallel Data Warehouse (PDW) använder samma systemvyer. Varje DMV har en kolumn med namnet pdw_node_id, som är identifieraren för Compute-noden. 
...
## <a name="sql-server-2016-polybase-dmvs-available-in-sql-analytics"></a>SQL Server 2016 PolyBase DMV: er finns i SQL Analytics
Följande DMV: er gäller för SQL Analytics, men måste köras genom att ansluta till **huvud** databasen.
