...
| Tabell |Byte per kolumn |Beroende av kolumnens [datatyp](sql-data-warehouse-tables-data-types.md). För tecken data typer kan MAX gränsen lagra upp till 2 GB på sidan av lagrings utrymme (rad spill).  Icke-Unicode-tecken som char-eller varchar-gränser är 8000 på en data sida, Unicode-tecken som nchar eller nvarchar-gränsen är 4000 på en data sida.  Använd data sidans lagrings storlekar för att öka prestandan. |
