...
När du har konstruerat en hash-distribuerad tabell är nästa steg att läsa in data i tabellen.  Information om hur du läser in vägledning finns i [Översikt över inläsning](sql-data-warehouse-overview-load.md). 
...
I det här exemplet används [CREATE TABLE som Välj](https://docs.microsoft.com/sql/t-sql/statements/create-table-as-select-azure-sql-data-warehouse?view=aps-pdw-2016-au7) för att återskapa en tabell med en annan hash-fördelnings kolumn.
