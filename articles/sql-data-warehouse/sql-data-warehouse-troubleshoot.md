...
| Servern huvudnamn ”MittAnvändarnamn” går inte att komma åt databasen ”master” under det aktuella säkerhetssammanhanget. Det går inte att öppna användarens standarddatabas. Inloggningen misslyckades. Inloggningen misslyckades för användaren 'MittAnvändarnamn'. (Microsoft SQL Server, fel: 916) |Det här felet uppstår när en AAD-användare försöker ansluta till master-databasen, men har inte en användare i master.  Om du vill åtgärda det här problemet, ange antingen SQL Data Warehouse som du vill ansluta till vid anslutningen, eller lägga till användaren i master-databasen.  Se [Säkerhetsöversikt] [ Security overview] mer information. |
