...
Den här artikeln visar hur du importerar eller exporterar en Azure SQL-databas när *Tillåt att Azure-tjänster* är inställt på Azure SQL-servern. *OFF* Arbets flödet använder en virtuell Azure-dator för att köra SqlPackage för att utföra import-eller export åtgärden.
...
Följande SqlPackage-kommando importerar **AdventureWorks2017** -databasen från lokal lagring till en Azure SQL Database-Server. Den skapar en ny databas med namnet **myMigratedDatabase** med en **Premium** service-nivå och ett **P6** -tjänst mål. Ändra värdena efter behov för din miljö.
