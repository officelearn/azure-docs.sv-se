...
<div class="content">
    ...
    <div class="introHolder" style="justify-content: space-between;">
        <div class="intro" style="min-width: 200px">
            <p>Azure SQL Database är en relationsdatabas-som-tjänst som bygger på Microsoft SQL Server-motorn. SQL Database är en högpresterande, tillförlitlig och säker databas som du kan använda för att skapa datadrivna program och webbplatser i valfritt programmeringsspråk, utan att behöva hantera infrastrukturen. Lär dig hur du använder SQL Database med våra snabbstarter, självstudier och exempel.</p>
        </div>
        <a href="https://azure.microsoft.com/en-us/resources/videos/create-sql-database-on-azure/">
            <div class="calloutHolder" style="max-width: 250px">
                ...
                <div>
                    <p style="margin-top: 0; color: #6e6e6e">Skapa en SQL-databas på Azure. (3:12)</p>
                </div>
            </div>
        </a>
    </div>
<h2 style="margin-top: 18px; margin-bottom: 0px;">Snabbstarter på 5 minuter</h2>
<p style="margin-top: 6px; margin-bottom: 6px;">Lär dig att skapa en SQL-databas, hantera den med hjälp av SQL Management Studio och utveckla den i C#, Java, Python, Node.js och Ruby:</p>
<div class="ico48Case">
    <div class="ico48Link">
...
<p>Lär dig att skapa, hantera och migrera databaser med SQL DB</p>
<ol>
    <li><a href="/azure/sql-database/sql-database-design-first-database">Skapa och utforma schemat för en ny SQL-databas</a></li>
    <li><a href="/azure/sql-database/sql-database-migrate-your-sql-server-database">Migrera en befintlig SQL Server-databas för att använda Azure SQL Database</a></li>
</ol>
...
<h2 style="margin-top: 36px">Exempel</h2>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>SQL Server-verktyg</h3>
                        <p><a href="https://msdn.microsoft.com/library/mt238365.aspx">SQL Server-verktyg</a></p>
                        ...
                        <p><a href="https://www.nuget.org/packages/Microsoft.Azure.Management.Sql">Bibliotekspaket för SQL Database-hantering</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>SQL Server-drivrutiner</h3>
                        <p><a href="https://msdn.microsoft.com/library/mt654049.aspx">SQL Server-drivrutiner</a></p>
