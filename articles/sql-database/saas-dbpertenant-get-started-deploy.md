...
1. Använd URL: en för att öppna Events-hubben i http://events.wingtip-dpt.&ltwebbläsaren:&gt;; User. trafficmanager.net. Ersätt &lt;användare&gt; med din distributions användar värde.
