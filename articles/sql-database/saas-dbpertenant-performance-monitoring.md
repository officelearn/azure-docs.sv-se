...
**Skala upp och ned en pool enligt ett schema för att matcha användnings mönster**
...
* [Azure Monitor loggar](saas-dbpertenant-log-analytics.md) – skapa och använda Azure Monitor loggar självstudie
