...
- **SP\_Add\_Target\_Group** skapar mål grupp namnet *DemoServerGroup*och lägger till mål medlemmar i gruppen.

- **SP\_Lägg\_till\_mål\_grupp medlem** lägger till följande objekt:
...
* **SP\_Add\_Job** skapar ett nytt jobb med namnet *online Reindex\_\_PK\_\_VenueTyp 265E44FD7FD4C885*.
