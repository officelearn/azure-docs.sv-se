...
- *Definition* [SaaS-databas för flera klient organisationer][saas-concept-design-patterns-563e]
- *Självstudier* [Wingtip Ticket SaaS-program][saas-how-welcome-wingtip-app-679t]
...
Varje tids index har formatet *h:mm: SS*. Till exempel, den andra indexerade tids platsen, som ärmärkt med målenhet, startar på den ungefärliga tids platsen för **0:03:11**.
...
- [2. Mål för sessioner, 0:03:11](#anchor-image-wtip-min00311)
- [3. Agenda, 0:04:17](#anchor-image-wtip-min00417)
- [4. Webb program för flera innehavare, 0:05:05](#anchor-image-wtip-min00505)
- [5. Webb formulär för app i åtgärd, 0:05:55](#anchor-image-wtip-min00555)
...
- [8. Hybrid modell överlappar fördelarna med MT/ST, 0:13:01](#anchor-image-wtip-min01301)
...
- [12. Live app-formuläret visar dojo, 0:20:29](#anchor-image-wtip-min02029)
- [13. MYOB och inte en DBA i syn, 0:28:54](#anchor-image-wtip-min02854)
- [14. Exempel på MYOB elastisk pool, 0:29:40](#anchor-image-wtip-min02940)
...
- [18. Exempel program för Wingtip SaaS, 0:48:10](#anchor-image-wtip-min04810)
...
- [25. Demo av hanterings skript för etablering av en enskild klient, 0:59:43](#anchor-image-wtip-min05943)
...
- [28. Hantera oförutsägbara arbets belastningar för klienter, 1:04:36](#anchor-image-wtip-min10436)
- [29. Övervakning av elastisk pool, 1:06:39](#anchor-image-wtip-min10639)
- [30. Läsa in generering och prestanda övervakning, 1:09:42](#anchor-image-wtip-min10942)
...
- [33. Demo av att skapa biljetter, 1:12:32](#anchor-image-wtip-min11232)
...
- [36. Diagram över dagliga försäljnings fördelningen, 1:16:48](#anchor-image-wtip-min11648)
- [37. Bryt upp och anropa åtgärd, 1:19:52](#anchor-image-wtip-min11952)
...
- Rubrik: Lära från MYOB: Design mönster för SaaS-program på Azure SQL Database
...
#### <a name="2-session-objectives-00153"></a>2. Mål för sessioner, 0:01:53
...
#### <a name="4-multi-tenant-web-app-00500"></a>4. Webb program för flera innehavare, 0:05:00
...
#### <a name="5-app-web-form-in-action-00539"></a>5. Webb formulär för app i åtgärd, 0:05:39
...
#### <a name="8-hybrid-model-blends-benefits-of-mtst-01229"></a>8. Hybrid modell överlappar fördelarna med MT/ST, 0:12:29
...
#### <a name="12-live-app-form-showing-dojo-02010"></a>12. Live app-formuläret visar dojo, 0:20:10
...
#### <a name="14-myob-elastic-pool-usage-example-02930"></a>14. Exempel på MYOB elastisk pool, 0:29:30
...
#### <a name="18-wingtip-saas-sample-app-04801"></a>18. Exempel program för Wingtip SaaS, 0:48:01
...
#### <a name="25-demo-of-management-scripts-provisioning-a-single-tenant-05936"></a>25. Demo av hanterings skript för etablering av en enskild klient, 0:59:36
...
#### <a name="28-managing-unpredictable-tenant-workloads-10334"></a>28. Hantera oförutsägbara arbets belastningar för klienter, 1:03:34
...
#### <a name="29-elastic-pool-monitoring-10632"></a>29. Övervakning av elastisk pool, 1:06:32
...
#### <a name="30-load-generation-and-performance-monitoring-10937"></a>30. Läsa in generering och prestanda övervakning, 1:09:37
...
#### <a name="33-demo-of-ticket-generation-11228"></a>33. Demo av att skapa biljetter, 1:12:28
...
#### <a name="36-graph-of-daily-sale-distribution-11638"></a>36. Diagram över dagliga försäljnings fördelningen, 1:16:38
...
#### <a name="37-wrap-up-and-call-to-action-11743"></a>37. Bryt upp och anropa åtgärd, 1:17:43
