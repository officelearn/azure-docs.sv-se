...
| | |
|---|---|
| [az sql server](/cli/azure/sql/server#az-sql-server-create) | Serverkommandon |
| [az sql server brandvägg](/cli/azure/sql/server/firewall-rule#az-sql-server-firewall-rule-create) | Kommandon för serverbrandväggen. |
| [az sql db](/cli/azure/sql/db#az-sql-db-create) | Databaskommandon. |
