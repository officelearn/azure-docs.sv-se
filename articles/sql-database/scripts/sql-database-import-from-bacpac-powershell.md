...
---
# <a name="use-powershell-to-import-a-bacpac-file-into-an-azure-sql-database"></a>Använd PowerShell för att importera en BACPAC-fil till en Azure SQL database
