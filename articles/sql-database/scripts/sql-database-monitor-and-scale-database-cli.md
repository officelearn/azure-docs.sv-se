---
title: CLI exempel-monitor-scale-single Azure SQL-databas
...
> [!TIP]
> Använd [az sql db op-listan](/cli/azure/sql/db/op?#az-sql-db-op-list) för att få en lista över åtgärder som utförs på databasen och az sql db op [cancel](/cli/azure/sql/db/op#az-sql-db-op-cancel) för att avbryta en uppdateringsåtgärd i databasen.
