...
| [az sql db show-usage](https://docs.microsoft.com/cli/azure/sql/db) | Visar användningsinformation om storlek för en enkel eller grupperad databas. |
