---
title: CLI-exempelaktiv geo-replikeringspoolad Azure SQL-databas
description: Azure CLI exempel skript för att ställa in aktiv geo-replikering för en poolad databas i Azure SQL Database och växla över.
...
Det här Azure CLI-skriptexempeln konfigurerar aktiv geo-replikering för en poolad databas i Azure SQL Database och växlar över den till den sekundära repliken av databasen.
...
| [az sql db replika](/cli/azure/sql/db/replica) | Databasreplikeringskommandon. |
