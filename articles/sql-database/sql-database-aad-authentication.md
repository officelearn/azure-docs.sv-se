---
title: Azure Active Directory-autentisering – Azure SQL (översikt) | Microsoft Docs
...
ms.locfileid: "35968162"
---
# <a name="use-azure-active-directory-authentication-for-authentication-with-sql-database-managed-instance-or-sql-data-warehouse"></a>Använda Azure Active Directory-autentisering för autentisering med SQL Database Managed Instance eller SQL Data Warehouse
