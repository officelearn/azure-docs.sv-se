...
Skrivskyddade replik gransknings loggar lagras i samma behållare. Katalogpartitionen i behållaren har formatet `<ServerName>/<DatabaseName>/<AuditName>/<Date>/RO/`. BLOB-filnamnet delar samma format.
...
| connection_id | Gäller inte | ID för anslutningen på servern | LED | Gäller inte |
