...
1. En gång i fönstret Automation-konto klickar du på meny alternativet "**Runbooks**" på vänster sida för att skapa en ny Azure Automation Runbook med PowerShell-skriptet. Mer information om hur du skapar Automation-runbooks finns i [skapa en ny Runbook](../automation/manage-runbooks.md#creating-a-runbook).
...
> [!TIP]
> Skapa separata flöden för att skicka automatiska e-postmeddelanden till olika mottagare. I dessa ytterligare flöden ändrar du mottagarens e-postadress i fältet till och e-postmeddelandets ämnesrad i fältet ämne. Om du skapar nya Runbooks i Azure Automation med anpassade PowerShell-skript (till exempel med ändring av Azure-prenumerations-ID) möjliggörs ytterligare anpassning av automatiserade scenarier, till exempel e-postseparata mottagare av automatiska justerings rekommendationer för separata prenumerationer.
>
