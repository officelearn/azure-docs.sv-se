...
- Lär dig hur du [ansluter och frågar en Azure SQL-databas med hjälp av .NET Framework och Visual Studio](sql-database-connect-query-dotnet-visual-studio.md).  
