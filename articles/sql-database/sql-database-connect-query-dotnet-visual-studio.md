...
---
# <a name="quickstart-use-net-and-c-in-visual-studio-to-connect-to-and-query-an-azure-sql-database"></a>Snabb start: använda .NET och C# i Visual Studio för att ansluta till och fråga en Azure SQL-databas
...
1. Ersätt innehållet i **Program.cs** med följande kod i kodredigeraren. `<server>`Ersätt värdena för `<username>`,, `<password>`och. `<database>`
