...
ms.locfileid: "50913163"
---
# <a name="quickstart-azure-portal-use-the-sql-query-editor-to-connect-and-query-data"></a>Snabbstart: Azure-portalen: Använd SQL-frågeredigeraren för att ansluta och fråga efter data
