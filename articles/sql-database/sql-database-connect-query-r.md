...
> [!NOTE]
> Under den offentliga för hands versionen kommer Microsoft att publicera dig och aktivera Machine Learning för din befintliga eller nya databas, men distributions alternativet för hanterade instanser stöds inte för närvarande.
