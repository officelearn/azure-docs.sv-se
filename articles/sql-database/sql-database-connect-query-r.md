...
Machine Learning Services with R är en funktion i Azure SQL Database som används för att köra R-skript i databasen. Mer information finns i [R-projektet](https://www.r-project.org/).
