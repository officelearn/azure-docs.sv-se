...
1. Klicka på **Konfigurera serverns brandvägg** i verktygsfältet. Sidan **brand Väggs inställningar** för SQL Database servern öppnas.
...
2. I dialogrutan **Anslut till server** anger du följande information:
   ...
   | **Gäst** | Serveradministratörskontot | Kontot som du angav när du skapade servern. |
