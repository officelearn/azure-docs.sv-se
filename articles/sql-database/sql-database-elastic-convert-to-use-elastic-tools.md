...
Du måste välja vilken typ av Fragmentera kartan för att skapa. Valet är beroende av databasens arkitektur: 
...
Observera att om du vill använda den här mappningen mönster, klient-id värden måste vara sammanhängande intervall och det är acceptabelt att ha lucka i intervall genom att helt enkelt hoppa över intervallet när du skapar databaserna.
...
För varje klient kör du Add-ListMapping (alternativ 1, ovan). 
...
Hämta PowerShell-skript från [Azure SQL DB-elastiska Database tools sripts](https://gallery.technet.microsoft.com/scriptcenter/Azure-SQL-DB-Elastic-731883db).
