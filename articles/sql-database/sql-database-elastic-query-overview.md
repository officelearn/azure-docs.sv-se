---
title: Översikt över Azure SQL Database elastisk fråga | Microsoft Docs
...
Kör fjärranslutna procedur anrop eller fjärrfunktioner med hjälp av [\_SP EXECUTE \_Remote](https://msdn.microsoft.com/library/mt703714).
