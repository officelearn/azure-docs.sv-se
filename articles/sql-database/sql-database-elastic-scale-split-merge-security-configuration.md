...
1. [Konfigurera SSL-certifikatet](#to-configure-the-ssl-certificate)
...
## <a name="to-configure-the-ssl-certificate"></a>Konfigurera SSL-certifikatet

Ett SSL-certifikat krävs för att kryptera kommunikationen och autentisera servern. Välj de tre scenarierna nedan och kör alla steg:
...
3. [Överför SSL-certifikat till moln tjänsten](#upload-ssl-certificate-to-cloud-service)
4. [Uppdatera SSL-certifikatet i tjänst konfigurations filen](#update-ssl-certificate-in-service-configuration-file)
...
1. [Exportera SSL-certifikat från certifikat arkivet](#export-ssl-certificate-from-certificate-store)
2. [Överför SSL-certifikat till moln tjänsten](#upload-ssl-certificate-to-cloud-service)
3. [Uppdatera SSL-certifikatet i tjänst konfigurations filen](#update-ssl-certificate-in-service-configuration-file)

### <a name="to-use-an-existing-certificate-in-a-pfx-file"></a>Använda ett befintligt certifikat i en PFX-fil
1. [Överför SSL-certifikat till moln tjänsten](#upload-ssl-certificate-to-cloud-service)
2. [Uppdatera SSL-certifikatet i tjänst konfigurations filen](#update-ssl-certificate-in-service-configuration-file)
...
1. [Skapa ett självsignerat certifikat](#create-a-self-signed-certificate)
2. [Skapa PFX-fil för självsignerat krypterings certifikat](#create-pfx-file-for-self-signed-ssl-certificate)
...
## <a name="export-ssl-certificate-from-certificate-store"></a>Exportera SSL-certifikat från certifikat arkivet
* Hitta certifikat
...
## <a name="upload-ssl-certificate-to-cloud-service"></a>Överför SSL-certifikat till moln tjänsten
Ladda upp certifikatet med befintlig eller genererad. PFX-fil med SSL-nyckel paret:

* Ange lösen ordet för att skydda informationen om den privata nyckeln

## <a name="update-ssl-certificate-in-service-configuration-file"></a>Uppdatera SSL-certifikatet i tjänst konfigurations filen
...
Kopiera sedan samma tumavtryck som SSL-certifikatet i inställningen för certifikat utfärdarens certifikat:
...
Det här kommandot kommer att uppmanas att ange ett lösen ord som ska skapas och sedan användas en gång. Använd ett starkt lösen ord.
