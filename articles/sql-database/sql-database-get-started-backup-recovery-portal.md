---
title: "Azure Portal: Säkerhetskopiera och återställ med Azure SQL Database | Microsoft-dokument"
...
---
# <a name="tutorial-back-up-and-restore-an-azure-sql-database-using-the-azure-portal"></a>Självstudie: Säkerhetskopiera och återställa en Azure SQL-databas via Azure Portal
...
> [!TIP]
> Mer information om borttagning av säkerhetskopior i långsiktig kvarhållning av säkerhetskopior finns i [Manage long-term backup retention usihg PowerShell](sql-database-manage-long-term-backup-retention-powershell.md) (Hantera långsiktig kvarhållning av säkerhetskopior med PowerShell).
>
