...
||Databas för generell användning|En databas skapas inom eller flyttas till tjänstenivå för generell användning för den DTU-baserade inköpsmodellen|
||Storskalig databas|En databas skapas inom eller flyttas till hyperskala tjänstenivå för den DTU-baserade inköpsmodellen|
||Kritisk Business-databas|En databas skapas inom eller flyttas till företag kritiska tjänstenivå för den DTU-baserade inköpsmodellen|
...
|Database-brandväggsregler för servern|IP-brandväggsregler|[IP-brandväggsregler](sql-database-firewall-configure.md)|
...
||Brandväggsregler på servernivå|[Brandväggsregler på servernivå server-databas](sql-database-firewall-configure.md#server-level-firewall-rule-versus-a-database-level-firewall-rule)|
|| Brandväggsregler på databasnivå|[Brandväggsregler på servernivå server-databas](sql-database-firewall-configure.md#server-level-firewall-rule-versus-a-database-level-firewall-rule)|
