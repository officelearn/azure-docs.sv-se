...
1. Ange Java-versionen genom att lägga `properties` till avsnittet efter `dependencies` avsnittet:
...
1. Stöd MANIFEST filer genom att lägga `build` till avsnittet efter `properties` avsnittet:
