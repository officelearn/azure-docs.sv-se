...
Använd cmdleten [New-AzSqlDatabaseImport](/powershell/module/az.sql/new-azsqldatabaseimport) för att skicka en begäran om att importera databas till tjänsten Azure SQL Database. Importen kan ta lite tid att slutföra beroende på databasens storlek.
 ...
 Du kan använda cmdleten [Get-AzSqlDatabaseImportExportStatus](/powershell/module/az.sql/get-azsqldatabaseimportexportstatus) för att kontrol lera importens förlopp. Kör cmdleten omedelbart efter att begäran vanligtvis returnerar **Status: pågår**. Importen är klar när du ser **Status: lyckades**.
