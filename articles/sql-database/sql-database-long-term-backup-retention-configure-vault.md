...
Använd den [New AzRecoveryServicesVault](/powershell/module/az.recoveryservices/new-azrecoveryservicesvault) att skapa ett recovery services-valv.
...
Använd den [Set-AzSqlServerBackupLongTermRetentionVault](/powershell/module/az.sql/set-azsqlserverbackuplongtermretentionvault) cmdlet för att associera tidigare skapade recovery services-valvet med en specifik Azure SQL-server.
...
I en kvarhållningsprincip anger du hur länge en säkerhetskopia av databasen ska bevaras. Använd den [Get-AzRecoveryServicesBackupRetentionPolicyObject](https://docs.microsoft.com/powershell/module/azurerm.recoveryservices.backup/get-Azrecoveryservicesbackupretentionpolicyobject) cmdlet för att hämta den standardkvarhållningsprincip att använda som mall för att skapa principer. I den här mallen anges kvarhållningsperioden i 2 år. Kör den [New AzRecoveryServicesBackupProtectionPolicy](/powershell/module/azurerm.recoveryservices.backup/new-Azrecoveryservicesbackupprotectionpolicy) att slutligen skapa principen.

> [!NOTE]
> Vissa cmdlets kräver att du anger valvkontexten innan du kör ([Set-AzRecoveryServicesVaultContext](/powershell/module/az.recoveryservices/set-azrecoveryservicesvaultcontext)) så att du ser denna cmdlet i några relaterade fragment. Du anger kontexten eftersom principen är en del av valvet. Du kan skapa flera kvarhållningsprinciper för varje valv och sedan använda önskad princip för specifika databaser.
...
Använd den [Set-AzSqlDatabaseBackupLongTermRetentionPolicy](/powershell/module/az.sql/set-azsqldatabasebackuplongtermretentionpolicy) cmdlet för att tillämpa den nya principen till en viss databas.
...
Återställa från långsiktig kvarhållning av säkerhetskopior använder den [återställning AzSqlDatabase](/powershell/module/az.sql/restore-azsqldatabase) cmdlet.
