...
> [!TIP]
> Många användare vill använda systemets tids inställnings funktioner i R, till `system.time` exempel `proc.time`och, för att avbilda tiden som används av r-processer och analysera prestanda problem.
