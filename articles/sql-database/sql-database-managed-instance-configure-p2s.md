...
ms.locfileid: "47163009"
---
# <a name="configure-a-point-to-site-connection-to-connect-to-an-azure-sql-database-managed-instance-from-on-premises-computer"></a>Konfigurera en punkt-till-plats-anslutning för att ansluta till en Azure SQL Database Managed Instance från en lokal dator
...
- Används som dess startar peka de resurser som skapades i den här snabbstarten: [skapar en hanterad instans](sql-database-managed-instance-get-started.md).
...
5. Havigate till mappen WindowsAmd64 och öppna den **VpnClientSetupAmd64.exe** fil.
