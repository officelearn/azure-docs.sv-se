---
title: Hanterad instans Connect-program
...
- Om du använder VNet-peering för att ansluta ett Azure App Service värdbaserade program och den hanterade instansens VNet har ett offentligt IP-adressintervall, kontrollerar du att inställningarna för värdbaserade program tillåter att den utgående trafiken dirigeras till offentliga IP-nätverk. Följ anvisningarna i [regional VNet-integrering](../app-service/web-sites-integrate-with-vnet.md#regional-vnet-integration).
