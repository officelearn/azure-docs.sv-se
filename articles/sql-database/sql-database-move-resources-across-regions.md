---
title: Flytta resurser till en annan region
...
När **ReplicationState** är `2`det ansluter du till varje databas eller en delmängd av databaser med hjälp `<fog-name>.secondary.database.windows.net` av den sekundära slut punkten och utför en fråga mot databaserna för att säkerställa anslutning, korrekt säkerhets konfiguration och datareplikering. 
