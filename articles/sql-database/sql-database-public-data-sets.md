...
| [Uppgifter om offentligt genom](https://www.completegenomics.com/public-data/) | "En mångsidig datauppsättning av hela mänskliga genom är fritt tillgängliga för allmänheten för att förbättra alla genomiska studier..." Leverantören, Complete Genomics, är ett privat vinstdrivande företag. | Datauppsättningar, efter extrahering, är i UNIX-textformat. Analysverktyg finns också tillgängliga. |
