...
![Diagram över](./media/sql-database-saas-tutorial-performance-monitoring/app-diagram.png)
...
![diagram för databasen](./media/sql-database-saas-tutorial-performance-monitoring/pool1.png)
...
![databasen resursutnyttjande](./media/sql-database-saas-tutorial-performance-monitoring/database-utilization.png)
...
1. I den [Azure-portalen](https://portal.azure.com) bläddrar du till listan över databaser på den *tenants1* server. 
...
2. Kontrollera den **elastisk databas övervakning** visas som visar de mest populära databaserna under den senaste timmen. Den *contosoconcerthall* databasen snart ska visas som en av de fem senaste databaserna.
