...
| | Hanterade instanser av pooler | 2, 4, 8, 16, 24, 32, 40, 64, 80 virtuella kärnor | Ej tillämpligt | Ej tillämpligt |
...
| | Hanterad instans  | [24 GB per vCore](sql-database-managed-instance-resource-limits.md#service-tier-characteristics) | Ej tillämpligt | Upp till 4 TB – [begränsas av lagrings storlek](sql-database-managed-instance-resource-limits.md#service-tier-characteristics) |
...
| | Hanterad instans | [3 MB/s per vCore (högst 22 MB/s)](sql-database-managed-instance-resource-limits.md#service-tier-characteristics) | Ej tillämpligt | [4 MB/s per vCore (max 48 MB/s)](sql-database-managed-instance-resource-limits.md#service-tier-characteristics) |
...
|**Minnes intern OLTP** | | Ej tillämpligt | Ej tillämpligt | Tillgängligt |
