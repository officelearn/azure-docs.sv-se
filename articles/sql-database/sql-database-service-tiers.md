...
## <a name="service-tiers-and-database-options"></a>Tjänstnivåer och databasalternativ
...
### <a name="choosing-a-service-tier-for-a-standalone-database"></a>Välja tjänstnivå för en fristående databas
