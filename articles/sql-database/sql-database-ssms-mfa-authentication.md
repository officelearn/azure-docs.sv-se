...
description: Azure SQL Database-och Azure Synapse-support anslutningar från SQL Server Management Studio (SSMS) med Active Directory Universal Authentication.
