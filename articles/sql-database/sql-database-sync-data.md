...
-   En primär nyckel kan inte ha datatypen datetime.
...
-   Markören, tidsstämpel, Hierarchyid
...
SQL Data Sync är tillgängligt i alla regioner för offentliga moln.
...
### <a name="developer-reference"></a>Utvecklarreferens
