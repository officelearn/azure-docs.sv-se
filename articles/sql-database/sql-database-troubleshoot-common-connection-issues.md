...
3. När en databas närmar sig sin resursbegränsningar, kan det verka vara ett tillfälligt anslutningsproblem. Se [resursgränser](sql-database-resource-limits.md).
