...
## <a name="troubleshooting-sync"></a>Felsökning av synkronisering
...
## <a name="troubleshooting-the-client-agent"></a>Felsökning av klientagenten
...
-   Skapa en ny agent i samma datacenter som gruppen synkronisering. Registrera sedan databasen med agenten.
...
## <a name="troubleshooting-setup-and-maintenance"></a>Felsökning av konfiguration och underhåll
...
Om du återställer en förlorade eller skadade databasen från en säkerhetskopia kan finnas det bristande konvergens i data i sync-grupper som databasen tillhör.
