...
5. **Nya AzureRmSqlServerVirtualNetworkRule**: när ditt undernät är en slutpunkt, lägger till ditt undernät som regel virtuellt nätverk i Åtkomstkontrollistan för din Azure SQL Database-server.
