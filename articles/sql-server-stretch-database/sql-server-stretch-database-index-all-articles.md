...
description: Tabell med alla ämnen för Azure-tjänsten med namnet SQL Server Stretch Database, som finns på https://azure.microsoft.com/documentation/articles/, rubrik och beskrivning.
...
Det här avsnittet listar alla ämnen som gäller direkt till den **SQL Server Stretch Database** tjänsten i Azure. Du kan söka efter den här webbsidan efter nyckelord med hjälp av **Ctrl + F**, för att hitta de aktuella intresseområden.
...
| 4 |[Kom igång genom att köra aktivera databas för Stretch-guiden](sql-server-stretch-database-wizard.md) |Lär dig hur du konfigurerar en databas för Stretch Database genom att köra guiden aktivera databas för Stretch. |
...
| &nbsp; | Rubrik | Beskrivning |
| ---:|:--- |:--- |
| 8 |[Inaktivera Stretch Database och hämta tillbaka fjärrdata](sql-server-stretch-database-disable.md) |Lär dig hur du inaktiverar Stretch Database för en tabell och du kan också hämta tillbaka fjärrdata. |
| 9 |[Hantera och felsök Stretch Database](sql-server-stretch-database-manage.md) |Lär dig mer om att hantera och Felsök Stretch Database. |
| 10 |[Övervaka och felsöka datamigrering (Stretch Database)](sql-server-stretch-database-monitor.md) |Lär dig hur du övervakar datamigreringens status. |
| 11 |[Pausa och återuppta datamigrering (Stretch Database)](sql-server-stretch-database-pause.md) |Lär dig mer om att pausa eller återuppta datamigrering till Azure. |
