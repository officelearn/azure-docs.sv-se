...
Du kan ange behörigheter på filsystemets rotnivå. Om du vill göra det måste du vara inloggad i Azure Storage Explorer med ditt individuella konto med behörighet att göra detta (i motsats till med en anslutningssträng). Högerklicka på ditt filsystem och välj **hantera behörigheter**, att både upp den **hantera behörighet** dialogrutan.
