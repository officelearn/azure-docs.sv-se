...
När du skapar en diagnostisk inställning väljer du den typ av lagring som du vill aktivera loggar för, till exempel en BLOB, kö, tabell eller fil. För Blob Storage väljer du **BLOB**. Data Lake Storage Gen2 visas inte som lagrings typ. Det beror på att Data Lake Storage Gen2 är en uppsättning funktioner som är tillgängliga för Blob Storage. 

Om du skapar en diagnostisk inställning i Azure Portal kan du välja resursen från en lista. Om du använder PowerShell eller Azure CLI måste du använda resurs-ID: t för Blob Storage-slutpunkten. Du hittar resurs-ID: t i Azure Portal genom att öppna sidan **Egenskaper** för ditt lagrings konto.
