...
Kommandot ovan kräver version 2.2.4.1 eller senare av PowerShellGet för att kunna installeras. Ta reda på vilken version som du för närvarande har läst in:
```powershell
