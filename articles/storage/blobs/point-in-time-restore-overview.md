...
Om du vill registrera dig för för hands versionen kör du följande kommandon från Azure PowerShell:
...
Kör följande kommandon för att kontrol lera status för registreringen:
