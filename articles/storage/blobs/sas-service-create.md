...
description: Lär dig hur du skapar en signatur för delad åtkomst för en behållare (SAS) för en behållare eller BLOB med hjälp av Azure Storage-bibliotek för Blob Storage.
services: storage
author: tamram
ms.service: storage
ms.topic: how-to
