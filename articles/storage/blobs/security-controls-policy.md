---
title: Azure Policy kontroll av efterlevnad för Azure Data Lake Storage Gen2
description: Visar Azure Policy regler för regelefterlevnad som är tillgängliga för Azure Data Lake Storage Gen2. Dessa inbyggda princip definitioner tillhandahåller vanliga metoder för att hantera kompatibiliteten för dina Azure-resurser.
ms.date: 09/10/2020
ms.topic: sample
author: normesta
ms.author: normesta
