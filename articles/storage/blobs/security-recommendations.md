...
| Begränsa anonym offentlig Läs behörighet till behållare och blobbar | Anonym, offentlig Läs behörighet till en behållare och dess blobbar beviljar skrivskyddad åtkomst till dessa resurser till alla klienter. Undvik att aktivera offentlig Läs behörighet om inte ditt scenario kräver det. | - |
