...
description: Simulera ett fel vid läsning av data från den primära regionen när lagrings kontot har kon figurer ATS för Read-Access geo-Zone-redundant lagring (RA-GZRS). När felet har inträffat läser du data från den sekundära regionen.
services: storage
author: tamram
ms.service: storage
ms.subservice: blobs
