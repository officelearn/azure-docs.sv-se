...
1. I Visual Studio lägger du till URL-`https://azuresdkartifacts.blob.core.windows.net/azure-sdk-for-net/index.json` till dina NuGet-paket källor. 
...
Parsa anslutnings strängen genom att anropa metoden [CloudStorageAccount. TryParse](/dotnet/api/microsoft.windowsazure.storage.cloudstorageaccount.tryparse) . 

Skapa sedan ett objekt som representerar Blob Storage i ditt lagrings konto genom att anropa metoden [CloudStorageAccount. CreateCloudBlobClient](https://docs.microsoft.com/dotnet/api/microsoft.windowsazure.storage.cloudstorageaccount.createcloudblobclient?view=azure-dotnet) .
