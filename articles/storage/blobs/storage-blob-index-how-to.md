...
2. Leta upp paketet **Azure. Storage. blobs** i NuGet Package Manager och installera version **12.5.0-dev. 20200422.2** i projektet. Du kan också köra kommandot```Install-Package Azure.Storage.Blobs -Version12.5.0-dev.20200422.2```
