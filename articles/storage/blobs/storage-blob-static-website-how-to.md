...
Du kan aktivera statisk webbplats värd med hjälp av [Azure Command-Line Interface (CLI)](https://docs.microsoft.com/cli/azure/?view=azure-cli-latest).
