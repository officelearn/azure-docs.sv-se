...
Kom igång med [GitHub-åtgärder](https://docs.github.com/en/actions) genom att använda ett arbets flöde för att distribuera en statisk plats till en Azure Storage-blob. När du har skapat ett arbets flöde för GitHub-åtgärder kommer du att kunna distribuera din webbplats automatiskt till Azure från GitHub när du gör ändringar i din plats kod. 
...
- Ett GitHub-konto med din statiska webbplats kod. Om du inte har ett GitHub-konto kan du [Registrera dig kostnads fritt](https://github.com/join).  
- En fungerande statisk webbplats som finns i Azure Storage. Lär dig att vara [värd för en statisk webbplats i Azure Storage](storage-blob-static-website-how-to.md). Din statiska webbplats bör innehålla en [Azure CDN](static-website-content-delivery-network.md).
...
1. Klistra in hela JSON-utdata från Azure CLI-kommandot i fältet hemligt värde. Ge hemligheten namnet som `AZURE_CREDENTIALS` .
...
1. Öppna det första resultatet för att se detaljerade loggar för arbets flödets körning. 
    ...
    :::image type="content" source="../media/index/github-actions-run.png" alt-text="Meny alternativ för GitHub-åtgärder&quot;:::
...
När den statiska Azure-platsen och lagrings platsen inte längre behövs, rensar du de resurser som du har distribuerat genom att ta bort resurs gruppen och GitHub-lagringsplatsen. 
