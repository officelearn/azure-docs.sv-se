...
Innehållstypen, som även kallas MIME-typ, identifierar formatet för data i bloben. Webbläsare och andra program kan du använda innehållstypen för att avgöra hur data ska bearbetas. Följande exempel anger innehållstypen `image/png`.
