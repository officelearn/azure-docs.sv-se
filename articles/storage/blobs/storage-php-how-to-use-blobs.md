...
Den här guiden visar hur du utför vanliga scenarier med hjälp av Azure blob-tjänsten. Exemplen är skrivna i PHP och Använd den [Azure Storage Blob-klientbibliotek för PHP][download]. Scenarier som tas upp inkluderar **överför**, **lista**, **hämtar**, och **bort** blobbar. Mer information om blobbar finns i [nästa steg](#next-steps) avsnitt.
...
I följande exempel visas hur du lägger till den automatiska bandladdaren fil- och referens av **BlobRestProxy** klass.
...
Om du vill skapa en Azure Blob-tjänsten-klient, måste du använda den **BlobRestProxy** klass. Du kan:
