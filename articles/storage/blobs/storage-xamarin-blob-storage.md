...
Xamarin gör det möjligt för utvecklare att använda en delad C#-kodbas för att skapa iOS-, Android-och Windows Store-appar med sina inbyggda användar gränssnitt. Den här självstudien visar hur du använder Azure Blob Storage med ett Xamarin-program. Om du vill veta mer om Azure Storage, innan du simhopp till koden, se [Introduktion till Microsoft Azure Storage](../common/storage-introduction.md?toc=%2fazure%2fstorage%2fblobs%2ftoc.json).
...
2. Öppna Visual Studio och skapa en tom app (inbyggd portabel): **fil > nytt > projekt > plattforms oberoende > tom app (inbyggt flyttbar)**.
...
* [Kom igång med Azure Queue Storage med hjälp av .NET](../queues/storage-dotnet-how-to-use-queues.md)
