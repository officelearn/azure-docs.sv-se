...
Kontrol lera lagrings kontots **geoReplicationStats. lastSyncTime** -egenskap för att hämta den senaste synkroniseringstid för lagrings kontot med Azure CLI. Använd parametern `--expand` för att returnera värden för egenskaperna som är kapslade under **geoReplicationStats**. Kom ihåg att ersätta plats hållarnas värden med dina egna värden:
