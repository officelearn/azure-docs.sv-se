...
| **Händelse prenumerationer** | [Reagera på Blob Storage-händelser](../blobs/storage-blob-event-overview.md) |
...
Om du vill ta bort resurs gruppen och dess kopplade resurser, inklusive det nya lagrings kontot, använder du kommandot [Remove-AzStorageAccount](/powershell/module/az.resources/remove-azstorageaccount) :
