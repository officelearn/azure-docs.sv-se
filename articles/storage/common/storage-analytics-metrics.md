...
> Lagringsanalys mått är nu klassiska mått. Microsoft rekommenderar att [lagrings mått används i Azure Monitor](monitor-storage.md) i stället för Lagringsanalys mått.
