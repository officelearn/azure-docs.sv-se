...
|  |Delad nyckel (lagrings konto nyckel)  |Signatur för delad åtkomst (SAS)  |Azure Active Directory (Azure AD)  |Active Directory |Anonym offentlig Läs behörighet  |
|---------|---------|---------|---------|---------|---------|
