...
Till exempel använda **CloudBlobClient.getDefaultRequestOptions().setRequireEncryption(true)** att kräva kryptering för alla blob-åtgärder som utförs via klientobjektet.
