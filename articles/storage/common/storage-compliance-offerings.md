---
title: Azure Storage erbjudanden för regelefterlevnad | Microsoft Docs
description: Läs en sammanfattning av efterlevnaden av efterlevnad på Azure Storage för nationella, regionala och branschspecifika krav som reglerar insamling och användning av data.
services: storage
author: fhryo-msft
ms.service: storage
ms.topic: conceptual
...
* [CSA-STAR-attestering](https://www.microsoft.com/trustcenter/compliance/csa-star-attestation)
* [CSA-Star-Certificate](https://www.microsoft.com/trustcenter/compliance/csa-star-certification)
...
* [EU-modell-satser](https://www.microsoft.com/trustcenter/compliance/eu-model-clauses)
* [EU – U. S. sekretess sköld](https://privacy.microsoft.com/en-US/microsoft-eu-us-privacy-shield)
...
* [Storbritannien – G-Cloud](https://www.microsoft.com/trustcenter/compliance/uk-g-cloud)

## <a name="next-steps"></a>Nästa steg

Microsoft Azure & Azure Storage du vill ha ledande erbjudanden för regelefterlevnad kan du hitta den senaste täckningen och informationen i [Microsoft TrustCenter](https://www.microsoft.com/TrustCenter/Compliance/default.aspx).
