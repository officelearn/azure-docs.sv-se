...
1. Använd den [Add-AzureAccount](/powershell/module/azure/add-azureaccount?view=azuresmps-3.7.0) cmdlet för att lägga till ditt Azure-konto till PowerShell-fönstret:
