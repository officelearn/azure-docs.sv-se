...
|`Blob/MetadataPath`|String|Valfri. Anger den relativa sökvägen för en metadatafil. Metadata har angetts för målblobben under en import. När du exporterar lagras i blob-metadata i metadatafilen på enheten.|  
|`Blob/MetadataPath/@Hash`|Attribut, sträng|Anger Base16-kodad MD5-hash för den blob-metadatafil.|  
|`Blob/PropertiesPath`|String|Valfri. Anger den relativa sökvägen för filsegment egenskaper. Egenskaperna är inställda på målblobben under en import. När du exporterar lagras blobegenskaper i filen egenskaper på enheten.|  
