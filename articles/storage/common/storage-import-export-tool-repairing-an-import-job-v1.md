...
Du kan köra verktyget Microsoft Azure Import/Export med importjobbets kopieringsloggfiler, då verktyget laddar upp de saknade filerna (eller delar av en fil) till ditt Windows Azure-lagringskonto för att slutföra importjobbet.  
...
|**/d:**<TargetDirectories\>|**Kunna.** En eller flera semikolonavgränsade kataloger som innehåller de ursprungliga filerna som importerades. Import enheten kan även användas, men det krävs inte om alternativa platser för originalfiler är tillgängliga.|  
...
Om du vill reparera import data genom att strömma data via nätverket måste du ange de kataloger som innehåller de ursprungliga filerna som du importerade med hjälp av `/d` parametern. Du måste också ange kopierings logg filen som du laddade ned från ditt lagrings konto. En vanlig kommando rad för att reparera ett import jobb med partiella problem ser ut så här:  
