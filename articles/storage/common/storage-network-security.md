...
| Azure Event Hubs         | Microsoft.EventHub         | Arkivera data med Event Hubs Capture. [Mer information](/azure/event-hubs/event-hubs-capture-overview). |
...
| Azure Logic Apps               | Microsoft.Logic/workflows       | Gör att Logic Apps kan komma åt lagrings konton. [Läs mer](/azure/logic-apps/create-managed-service-identity#authenticate-access-with-managed-identity). |
