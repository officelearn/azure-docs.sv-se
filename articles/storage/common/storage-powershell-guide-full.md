...
* Läs hur du aktiverar och visar mätvärden i Storage-data med hjälp av PowerShell i [mätvärden i Storage analytics](storage-analytics-metrics.md).
...
* [Azure Kina 21Vianet-molnet som drivs av 21Vianet i Kina](http://www.windowsazure.cn/)
