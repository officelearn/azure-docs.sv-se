...
* Information om hur du använder PowerShell för att utföra åtgärder för Azure Cosmos DB Table API finns [utför Azure Cosmos DB Table API-åtgärder med PowerShell](../../cosmos-db/table-powershell.md).
