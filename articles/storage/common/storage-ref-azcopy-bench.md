...
---
# <a name="azcopy-bench"></a>AzCopy bänk
...
Benchmark-läget justerar sig automatiskt till antalet parallella TCP-anslutningar som ger maximalt data flöde. Den kommer att visas i slutet av den här siffran. För att förhindra automatisk justering ställer du in miljövariabeln AZCOPY_CONCURRENCY_VALUE på ett angivet antal anslutningar.
