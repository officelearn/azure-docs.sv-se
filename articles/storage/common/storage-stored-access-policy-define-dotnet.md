...
description: Använd Azure Storage och .NET för att skapa en lagrad åtkomst princip. Utöva ytterligare kontroll nivåer över signaturer för delad åtkomst på tjänst nivå på servern.
services: storage
author: tamram
ms.service: storage
ms.topic: how-to
