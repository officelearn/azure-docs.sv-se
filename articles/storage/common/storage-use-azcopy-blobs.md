...
> [!NOTE]
> AzCopy som standard överför data till block-blobar. Använd flaggan `--blob-type=[BlockBlob|PageBlob|AppendBlob]` för att ladda upp filer som bifogade BLOB-eller Page-blobar.
