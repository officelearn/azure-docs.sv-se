...
Mer information om kommandot `sync` finns i [Synkronisera filer](storage-use-azcopy-blobs.md#synchronize-files).
...
I de här exemplen förutsätts att din mapp heter `myFolder`, ditt lagrings konto namn är `mystorageaccount` och behållar namnet är `mycontainer`.
