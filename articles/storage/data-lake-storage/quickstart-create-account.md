...
description: Lär dig hur du snabbt skapar ett nytt lagringskonto med åtkomst till Data Lake Storage Gen2 (förhandsversion) med hjälp av Azure Portal, Azure PowerShell eller Azure CLI
services: storage
author: jamesbak
manager: twooley
...
|CLI        | Du kan logga in på Azure och köra Azure CLI-kommandon på något av två sätt: <ul><li>Du kan köra CLI-kommandon från Azure Portal, i Azure Cloud Shell </li><li>Du kan installera CLI och köra CLI-kommandon lokalt</li></ul>|
...
Innan du skapar ett konto ska du först skapa en resursgrupp som fungerar som en logisk behållare för lagringskonton eller någon annan Azure-resurs som du skapar. Om du vill rensa de resurser som har skapats med den här snabbstarten kan du helt enkelt ta bort resursgruppen. När du tar bort resursgruppen raderas även det kopplade lagringskontot och eventuella andra resurser som är kopplade till resursgruppen. Mer information om resursgrupper finns i [Översikt över Azure Resource Manager](../../azure-resource-manager/resource-group-overview.md).
...
![Skärmbild som visar hur du skapar en resursgrupp i Azure Portal](./media/quickstart-create-account/create-resource-group.png)
...
![Skärmbild som visar hur du skapar ett lagringskonto i Azure Portal](./media/quickstart-create-account/azure-data-lake-storage-account-create.png)
