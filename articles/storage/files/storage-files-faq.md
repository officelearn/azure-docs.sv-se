...
* <a id="why-files-useful"></a>**Hur är Azure Files användbar?**  
...
* <a id="files-versus-blobs"></a>**Varför ska jag använda en Azure-filresursen jämfört med Azure Blob storage för Mina data?**  
...
* <a id="tier-options"></a>**Vilka lagringsnivåer stöds i Azure-filer?**  
...
* <a id="give-us-feedback"></a>**Jag vill verkligen finns en specifik funktion som lagts till i Azure-filer. Kan du lägga till den?**  
...
* <a id="afs-change-detection"></a>**Jag har skapat en fil direkt i min Azure-filresursen via SMB eller i portalen. Hur lång tid tar det för filen som synkroniseras till servrar i gruppen synkronisering?**  
...
* <a id="afs-storage-redundancy"></a>**Stöds geo-redundant lagring för Azure filsynkronisering?**  
...
* <a id="afs-force-tiering"></a>**Hur jag tvinga en fil eller katalog till nivåindelas?**  
...
* <a id="afs-os-support"></a>**Kan jag använda Azure filsynkronisering med Windows Server 2008 R2, Linux eller enheten nätverksansluten lagring (NAS)?**  
...
* <a id="encryption-at-rest"></a>**Hur kan jag säkerställa att min Azure-filresursen är krypterat i vila?**  
...
* <a id="access-via-browser"></a>**Hur kan ge åtkomst till en viss fil med hjälp av en webbläsare?**  
...
* <a id="ip-restrictions"></a>**Kan jag implementera IP-begränsningar för en Azure-filresursen?**  
...
* <a id="data-compliance-policies"></a>**Vilka data efterlevnadsprinciper stöder Azure-filer?**  
...
* <a id="mount-locally"></a>**Hur kan jag montera en Azure-filresursen på min dator?**  
...
* <a id="backup-share"></a>**Hur gör jag säkerhetskopiera min Azure fil dela?**  
    Du kan använda periodiska [dela ögonblicksbilder (förhandsgranskning)](storage-how-to-use-files-snapshots.md) för skydd mot oavsiktliga borttagningar. Du kan också använda AzCopy, Robocopy eller tredje parts säkerhetskopiering som kan säkerhetskopiera en monterad filresurs. 

## <a name="share-snapshots"></a>Dela ögonblicksbilder
### <a name="share-snapshots-general"></a>Dela ögonblicksbilder: Allmänt
* <a id="what-are-snaphots"></a>**Vad är filen resursen ögonblicksbilder?**  
...
* <a id="snapshot-perf-impact"></a>**Finns det några konsekvenser för prestanda för att använda resursen ögonblicksbilder?**  
    Dela ögonblicksbilder har inte någon prestanda försämras.

* <a id="snapshot-consistency"></a>**Är resursen ögonblicksbilder programkonsekventa?**  
...
* <a id="snapshot-limits"></a>**Finns det någon gräns för antalet ögonblicksbilder för resursen kan användas?**  
...
* <a id="encypted-snapshots"></a>**Kan jag skapa resursen ögonblicksbilder av en krypterad filresurs?**  
...
* <a id="delete-share-keep-snapshots"></a>**Kan jag bort min resurs men inte ta bort min resursen ögonblicksbilder?**  
...
* <a id="need-larger-share"></a>**Jag behöver en större filresurs än Azure-filer finns för närvarande. Kan jag öka storleken på min Azure-filresursen?**  
...
* <a id="zip-slow-performance"></a>**Min går långsamt när jag packa upp filer i Azure-filer. Vad ska jag göra?**  
...
* <a id="slow-perf-windows-81-2012r2"></a>**Varför är min långsamma prestanda när jag ansluta min Azure-filresursen på Windows Server 2012 R2 eller Windows 8.1?**  
...
* <a id="cluster-witness"></a>**Kan jag använda min Azure-filresursen som en *filresursvittne* för min redundanskluster för Windows Server?**  
...
* <a id="containers"></a>**Kan jag montera en Azure-filresurs på en instans av Azure-behållare?**  
...
* <a id="nested-shares"></a>**Kan jag skapa kapslade resurser? Med andra ord en resurs under en annan resurs?**  
    Nej. Filresursen *är* den virtuella drivrutin som du kan montera, så kapslade resurser inte stöds.

* <a id="ibm-mq"></a>**Hur använder Azure-filer med IBM MQ?**  
