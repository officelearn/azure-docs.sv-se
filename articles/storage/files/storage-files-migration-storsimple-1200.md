...
När du anser att stillestånds tiden är acceptabel och du är för beredd att ta StorSimple-platsen offline gör du det nu: ta till exempel bort SMB-resursen så att ingen användare kan komma åt mappen eller vidta något annat lämpligt steg som förhindrar att innehåll ändras i detta mapp på StorSimple.
