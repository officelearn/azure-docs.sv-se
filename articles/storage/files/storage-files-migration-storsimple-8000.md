...
ms.locfileid: "78209446"
---
# <a name="storsimple-8100-and-8600-migration-to-azure-file-sync"></a>StorSimple 8100 och 8600-migrering till Azure File Sync

StorSimple 8000-serien har två olika fysiska apparater i den. Den enda skillnaden mellan dem är storleken på den lokala cachestorleken (disk utrymme). Den här installationen körs i ett lokalt Data Center och fungerar som en cache för de data som lagras i Azure.
Med den meddelade tjänste livstiden för StorSimple produkt linje i december 31 2022 kommer den moln tjänst som den här enheten är ansluten till sluta att fungera.
...
Den här artikeln innehåller de steg som krävs för att göra migreringen till en lyckad Azure File Sync.
...
### <a name="expose-the-storsimple-8020-volumes-to-the-vm"></a>Exponera StorSimple 8020-volymer på den virtuella datorn
...
1. [Hämta privat IP för moln installationen](../../storsimple/storsimple-8000-cloud-appliance-u2.md#get-private-ip-for-the-cloud-appliance)
...
Om du har en DFS-N-distribution kan du peka DFN-namnområden till de nya mapparna för Server. Om du inte har en DFS-N-distribution, och du framförde 8100 8600-installationen lokalt med en Windows-Server, kan du ta bort servern från domänen och domän ansluta till din nya Windows Server med AFS till domänen, ge den samma server namn som den gamla servern , och samma resurs namn, är den nya servern transparent för dina användare, grup principer eller skript.
