...
Mer information om säkerhets kopiering finns i [om Azure File Share-säkerhetskopiering](https://docs.microsoft.com/azure/backup/azure-file-share-backup-overview?toc=/azure/storage/files/toc.json).
