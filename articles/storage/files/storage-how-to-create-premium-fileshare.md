---
title: Skapa ett Azure filestorage storage-konto
description: I den här artikeln får du lära dig hur du skapar en filestorage (förhandsversion) och en premium-filresurs.
services: storage
author: roygara
ms.service: storage
ms.topic: conceptual
