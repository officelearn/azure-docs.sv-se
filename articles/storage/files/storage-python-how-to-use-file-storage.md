...
Om du vill visa en lista över filer och kataloger i en resurs använder du metoden **lista\_kataloger\_och\_filer** . Den här metoden returnerar en generator. Följande kod matar ut **namnet** på varje fil och katalog i en resurs till-konsolen.
...
Använd `create_file_from_path`metoderna, `create_file_from_stream`, `create_file_from_bytes` eller förattskapaenfilochöverföradata.`create_file_from_text` De är avancerade metoder som utför den nödvändiga delningen när storleken på data överskrider 64 MB.
