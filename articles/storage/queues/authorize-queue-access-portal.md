...
:::image type="content" source="media/authorize-queue-access-portal/queue-access-portal.png" alt-text="Skärm bild som visar hur du navigerar till köa data i Azure Portal":::
