...
ms.locfileid: "68721647"
---
# <a name="how-to-use-queue-storage-from-c"></a>Använda Queue Storage frånC++
...
* **Windows:** Klicka på **Verktyg > NuGet Package Manager > Package Manager Console** i Visual Studio. Skriv följande kommando i [NuGet Package Manager-konsolen](https://docs.nuget.org/docs/start-here/using-the-package-manager-console) och tryck på **RETUR**.
...
Om du vill testa programmet på den lokala Windows-datorn kan du använda Microsoft Azure [](../common/storage-use-emulator.md?toc=%2fazure%2fstorage%2fqueues%2ftoc.json) -emulatorn som är installerad med [Azure SDK](https://azure.microsoft.com/downloads/). Lagringsprovidern är ett verktyg som simulerar BLOB-, kö-och tabell tjänster som är tillgängliga i Azure på din lokala utvecklings dator. Följande exempel visar hur du kan deklarera ett statiskt fält för lagring av anslutningssträngen i den lokala lagringsemulatorn:  
...
Om du vill infoga ett meddelande i en befintlig kö måste du först skapa ett nytt **cloud_queue_message**. Anropa sedan metoden **add_message** . En **cloud_queue_message** kan skapas från antingen en sträng eller en **byte** mat ris. Här är kod som skapar en kö (om den inte finns) och som infogar meddelandet ”Hello World”:
...
Du kan hämta en uppskattning av antalet meddelanden i en kö. Metoden **download_attributes** ber kötjänst Hämta attributen för kön, inklusive antalet meddelanden. Metoden **approximate_message_count** hämtar det ungefärliga antalet meddelanden i kön.
