...
Du kan titta på meddelandet överst i en kö utan att ta bort det från kön genom att anropa metoden [peek_messages](/python/api/azure-storage-queue/azure.storage.queue.queueservice.queueservice#peek-messages-queue-name--num-messages-none--timeout-none-) . `peek_messages` tittar som standard i ett enda meddelande.
