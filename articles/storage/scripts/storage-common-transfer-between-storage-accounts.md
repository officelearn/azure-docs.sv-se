---
title: Migrera blobbar över lagrings konton med AzCopy i Windows
description: Azure PowerShell skript exempel – om du använder AzCopy kopieras BLOB-innehållet för ett Azure Storage-konto till ett annat.
services: storage
