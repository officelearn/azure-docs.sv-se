<properties
    pageTitle="Skapa, hantera eller ta bort ett lagringskonto på Azure Portal | Microsoft Azure"
...
> [AZURE.NOTE] Ett Blob Storage-konto exponerar endast blob-tjänstens slutpunkt.
...
4. Ange vilken distributionsmodell som ska användas: **Resource Manager** eller **Klassisk**. **Resource Manager** är den rekommenderade distributionsmodellen. Mer information finns i [Förstå Resource Manager-distribution och klassisk distribution](../resource-manager-deployment-model.md).
    ...
    > [AZURE.NOTE] Blob Storage-konton kan bara skapas med Resource Manager-distributionsmodellen.
...
> [AZURE.NOTE] Vissa replikeringsalternativ kanske inte är tillgängliga beroende på vilken prestandanivå du valde när du skapade lagringskontot.
