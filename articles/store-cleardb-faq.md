---
title: Frågor och svar om ClearDB MySql-databaser med Azure App Service | Microsoft Docs
...
>
> Mer information och nästa steg i [ändras till ClearDB-tjänstplaner](http://w2.cleardb.net/important-change-of-billing-notice-for-all-azure-cleardb-service-plans/).
...
ClearDB är en MySQL som värd för tjänsten och hanterar MySQL-infrastrukturen åt dig. När du kör din egen MySQL-kluster eller en databas på en Azure-dator kan behöva du konfigurera MySQL-server och hålls uppdaterad med korrigeringar.
...
## <a name="in-which-countries-are-cleardb-premium-mysql-clusters-supported"></a>Där är länder ClearDB MySQL för Premium-kluster stöds?
[ClearDB MySQL för Premium-kluster](/marketplace/partners/cleardb-clusters/cluster/) är tillgängliga i alla Azure-regioner över hela världen med undantag för Indien, Australien, Brasilien, södra och Kina.
