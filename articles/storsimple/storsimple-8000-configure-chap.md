...
3. Klicka på **Save** (Spara). Ett bekräftelse meddelande visas. Spara ändringarna genom att klicka på **OK**.
...
4. Klicka på **Save** (Spara). Ett bekräftelse meddelande visas. Spara ändringarna genom att klicka på **OK**.
