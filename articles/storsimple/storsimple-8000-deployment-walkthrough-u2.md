---
title: Distribuera din StorSimple 8000-serieenhet i Azure Portal
...
| [Förutsättningar för distribution](#deployment-prerequisites) |När de här kraven är uppfyllda är miljön klar för distribution. |
|  | |
