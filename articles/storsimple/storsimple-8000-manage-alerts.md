...
| Varningstexten | Händelse | Mer information / rekommenderade åtgärder |
|:--- |:--- |:--- |
| Enheten belastningen har överskridit <*tröskelvärdet*>. |Långsammare än förväntat svarstider. |Enheten rapporterar användning under en hög i/o-belastning. Det kan leda till enheten inte fungerar så väl som den ska. Granska arbetsbelastningar som du har kopplat till enheten och kontrollera om det finns några som kunde flyttas till en annan enhet eller som inte längre behövs.| Det gick inte att starta StorSimple-tjänst(er). |DataPath fel |Kontakta Microsoft-supporten om problemet kvarstår. |och aktuell status, gå till [använda Enhetshanteraren för StorSimple-tjänsten för att övervaka din enhet](storsimple-8000-monitor-device.md) |
...
Lär dig mer om [StorSimple fel och felsökning av problem med enheten distribution](storsimple-8000-troubleshoot-deployment.md).
