---
title: Ändra DATA 0 på StorSimple 8000-serieenhet | Microsoft Docs
...
ms.locfileid: "23927588"
---
# <a name="modify-the-data-0-network-interface-settings-on-your-storsimple-8000-series-device"></a>Ändra DATA 0-gränssnittet nätverksinställningarna på enheten StorSimple 8000-serien

## <a name="overview"></a>Översikt

Microsoft Azure StorSimple-enheten har sex nätverksgränssnitt från DATA 0 till DATA 5. DATA 0 gränssnittet är alltid konfigurerad via Windows PowerShell-gränssnittet eller seriekonsolen och är automatiskt moln-aktiverat. Observera att du kan konfigurera DATA 0-nätverksgränssnittet via Azure-portalen.
...
3. En installationsguide visas för att konfigurera DATA 0-gränssnittet på enheten. Ange nya värden för IP-adress, gateway och nätmask.

> [!NOTE]
> Fast domänkontrollanter IP-adresser måste konfigureras via den **nätverksinställningar** bladet för den virtuella StorSimple-enheten i Azure-portalen. Mer information finns på [ändra nätverksgränssnitt](storsimple-8000-modify-device-config.md#modify-network-interfaces).
...
* Du kan använda för att konfigurera nätverksgränssnitt förutom DATA 0, den [konfigurera nätverksinställningar i Azure portal](storsimple-8000-modify-device-config.md). 
