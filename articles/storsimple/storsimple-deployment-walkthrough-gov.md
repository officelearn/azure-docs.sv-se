...
Välkommen till distribution av Microsoft Azure StorSimple-enheten  Dessa självstudiekurser för distribution gäller StorSimple 8000-serien uppdatering 1 programvaran som körs i Azure Government-portalen. Denna serie självstudier beskriver hur du konfigurerar din StorSimple-enhet och innehåller en checklista för konfiguration, konfigurationskrav och detaljerade konfigurationssteg.
...
| &nbsp; |Nyckel för tjänstregistrering |Den här nyckeln skapas från Azure-portalen. | |
...
Utför följande steg i Government-portalen för att slutföra den minimala Enhetsinstallationen.
...
Utför följande steg i Government-Portal på den **StorSimple Manager-tjänsten** sidan.
