<properties
   pageTitle="Distribuera en lokal StorSimple-enhet |Microsoft Azure"
...
Informationen i dessa självstudiekurser förutsätter att du har granskat säkerhetsåtgärder, packat upp, rackmonterat och kabelanslutit din StorSimple-enhet. Om du fortfarande behöver utföra dessa uppgifter ska du börja med att granska [säkerhetsåtgärderna](storsimple-safety.md). Beroende på din enhetsmodell kan du sedan packa upp, rackmontera och kabelansluta genom att följa instruktionerna i:

- [Packa upp, rackmontera och kabelansluta din 8100](storsimple-8100-hardware-installation.md)
- [Packa upp, rackmontera och kabelansluta din 8600](storsimple-8600-hardware-installation.md)
...
> [AZURE.NOTE] Distributionsinformationen för StorSimple som publiceras på webbplatsen Microsoft Azure gäller endast StorSimple-enheter i 8000-serien. Fullständig information om enheterna i serierna 5000 och 7000 finns i: [http://onlinehelp.storsimple.com/](http://onlinehelp.storsimple.com). Distributionsinformation för 5000 och 7000-serien finns i [Snabbstartsguide för StorSimple-system](http://onlinehelp.storsimple.com/111_Appliance/).

## Distributionssteg

Genomför dessa steg för att konfigurera din StorSimple-enhet och ansluta den till din StorSimple Manager-tjänst. Förutom de nödvändiga stegen finns valfria steg och procedurer du kan behöva under distributionen. Steg för steg-instruktionerna för distribution anger när du bör utföra varje valfritt steg.
...
| Distributionskrav.                                                               | Dessa verifierar att miljön är klar för distribution.                                                                                                     |
|                                                                                        |                                                                                                                                                               |
...
| Steg 6: Skapa en volym.                                                                | Etablera lagringsvolymerna på StorSimple-enheten för dina servrar.                                                                                        |
...
|                                        | Krypteringsnyckel för tjänstdata                       | Den här nyckeln skapas när enheten är registrerad med hanteringstjänsten via Windows PowerShell för StorSimple. Kopiera den här nyckeln och spara den på en säker plats.|  |
|   |   |  |  |
| **Slutför de inställningar som krävs som minimum**          | Eget namn för din enhet                     | Det här är ett beskrivande namn för enheten. |        |
|                                        | Tidszon                                          | Enheten använder den här tidszonen för alla schemalagda åtgärder.  |        |
|                                        | Sekundär DNS-server                              | Detta är en nödvändig konfiguration.                                  |        |
|                                        | Nätverksgränssnitt: Data 0-kontrollant med statiska IP-adresser                                     | Dessa IP-adresser ska vara dirigerbara till internet.</br>Kontrollant 0, statisk IP-adress:</br>Kontrollant 1, statisk IP-adress:|
|   |   |  |  |
...
|                                        | Azure lagringskonto:                            | Lagringskontonamn och åtkomstnyckel som ska associeras med denna volymbehållare                                                                                              |        |
...
Innan du konfigurerar enheten ska du kontrollera att:

- Din enhet är helt uppackad, rackmonterad och helt kabelansluten till ström, nätverk och serieåtkomst som beskrivs i:
...
> [AZURE.IMPORTANT] Hoppa över det här steget om du har en befintlig StorSimple Manager-tjänst och du planerar att distribuera StorSimple-enheten med den tjänsten.
...
Utför följande steg i den klassiska Azure-portalen.
...
> [AZURE.IMPORTANT] Koppla från alla nätverksgränssnitt förutom DATA 0 för båda (aktiva och passiva) kontrollanterna innan du utför den här konfigurationen.
...
- Göra inställningar för den sekundära DNS-servern.
...
Utför följande steg i den klassiska Azure-portalen för att skapa en schemalagd säkerhetskopiering.
