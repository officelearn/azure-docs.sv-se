...
|:--- |:--- |:--- |:--- |
| 1 |Fel 350032: enheten har redan inaktiverats. |Det här felet visas om du kör installations guiden på en enhet som är inaktive rad. |[Kontakta Microsoft Support](storsimple-contact-microsoft-support.md) om du vill ha hjälp. En inaktive rad enhet kan inte placeras i tjänsten. Det kan krävas en fabriks återställning innan enheten kan aktive ras igen. |
