...
> 
> Kontrol lera att alla enhets komponenter är felfria innan du stänger av enheten. I Azure Portal navigerar du till **enheter** > **övervaka** > **maskin varu hälsa**och kontrollerar att status för alla komponenter är grön. Detta gäller endast för felfria system. Om systemet stängs av för att ersätta en komponent som inte fungerar visas en misslyckad (röd) eller degraderad (gul) status för respektive komponent i **maskin varu statusen**.
> 
> 
...
> [!IMPORTANT]
> Innan du stänger av den primära inne slutningen och EBOD-höljet kontrollerar du att alla enhets komponenter är felfria. I Azure Portal navigerar du till **enheter** > **övervaka** > **maskin varu hälsa**och kontrollerar att alla komponenter är felfria.
