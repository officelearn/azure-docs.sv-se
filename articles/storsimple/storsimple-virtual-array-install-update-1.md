...
5. När omstarten är klar tas du till **inloggnings** sidan. För att kontrol lera att enhetens program vara har uppdaterats går du till **underhåll** > **program uppdatering**i det lokala webb gränssnittet. Den program varu version som visas ska vara **10.0.0.0.0.10296** för uppdatering 1,0.
