# [Dokumentation om Stream Analytics](index.md)
...
## Skala
### [Skala med direktuppspelningsenheter](stream-analytics-streaming-unit-consumption.md)
### [Skala med frågeparallellisering](stream-analytics-parallelization.md)
#### [Öka dataflödet](stream-analytics-scale-jobs.md)
### [Skala med ML-funktioner](stream-analytics-scale-with-machine-learning-functions.md)

## Automatisera
### [Använda .NET SDK](stream-analytics-dotnet-management-sdk.md)
### [Använda Azure PowerShell](https://github.com/Azure/azure-stream-analytics/tree/master/Samples/ASAOneClick)
...
### [SELECT INTO-instruktion](stream-analytics-select-into.md)
### [Händelsehubbmottagare](stream-analytics-event-hub-consumer-groups.md)

## Integrera med Machine Learning
### [Attitydanalys med maskininlärningsmodeller](stream-analytics-machine-learning-integration-tutorial.md)
...
## [Videoklipp](https://azure.microsoft.com/resources/videos/index/?services=stream-analytics&sort=newest)
