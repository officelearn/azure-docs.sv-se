...
Om du vill ha mer information om `Start-AzStreamAnalyitcsJob`-cmdleten kan du Visa [Start-AzStreamAnalyticsJob-referensen](/powershell/module/az.streamanalytics/start-azstreamanalyticsjob).
