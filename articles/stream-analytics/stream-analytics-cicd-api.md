...
|------|-----------|
|FÖRAS|https://management.azure.com/subscriptions/{**prenumerations-ID**}/ResourceGroups/{**resurs-grupp-namn**}/providers/Microsoft.StreamAnalytics/streamingjobs/{**jobb-Name**}? API-version = 2017-04 01 – för hands version|
...
|Metod|URL för begäran|
|------|-----------|
|EFTER|https://management.azure.com/subscriptions/{**subscriptionId**}/resourceGroups/{**ResourceGroupName**}/providers/Microsoft.StreamAnalytics/streamingjobs/{**JobName**}/publishedgepackage? API-version = 2017-04 01 – för hands version|
