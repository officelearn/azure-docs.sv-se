---
title: 'Självstudie: Skapa och hantera ett Stream Analytics-jobb med hjälp av Azure-portalen | Microsoft Docs'
...
2. Välj **Skapa en resurs** > **Sakernas Internet** > **Event Hubs**.  
   ...
   ![Skapa en Azure-händelsehubb](media/stream-analytics-manage-job/find-eh.png)
...
4. **Spara** frågan.  
   ...
   ![Definiera Stream Analytics-fråga](media/stream-analytics-manage-job/define-query.png)
