...
## <a name="examples"></a>Exempel
Använd punktnotation (.) för att få åtkomst till kapslade fält. Till exempel väljer den här frågan koordinater för latitud och longitud under egenskapen Location i föregående JSON-data:
...
[Datatyper i Azure Stream Analytics](https://docs.microsoft.com/en-us/stream-analytics-query/data-types-azure-stream-analytics)
