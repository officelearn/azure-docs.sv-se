...
Använd funktionen [GetRecordPropertyValue](https://docs.microsoft.com/stream-analytics-query/getrecordpropertyvalue-azure-stream-analytics) om egenskaps namnet är en variabel. 
