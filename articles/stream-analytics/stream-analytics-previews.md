...
Azure Stream Analytics på IoT Edge kan utvecklare distribuera analys i nära realtid på IoT Edge-enheter. Mer information finns i den [Azure Stream Analytics på IoT Edge](stream-analytics-edge.md) dokumentation.
