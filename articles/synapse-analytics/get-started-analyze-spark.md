...
1. Kör följande kod för att utföra samma analys som vi gjorde tidigare med den dedikerade SQL-poolen **SQLDB1**. Den här koden sparar resultatet av analysen i en tabell med namnet **nyctaxi. passengercountstats** och visualiserar resultaten.
...
Tidigare kopierade data från den dedikerade SQL-adresspoolen **SQLDB1. dbo. resan** till Spark-tabellen **nyctaxi. resan**. Därefter aggregerade vi data till Spark-tabellen **nyctaxi. passengercountstats** med Spark. Nu ska vi kopiera data från **nyctaxi. passengercountstats** till en särskild SQL-pool med namnet **SQLDB1. dbo. passengercountstats**.
