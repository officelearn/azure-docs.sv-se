...
Öppna **övervakaren**och välj **Apache Spark program**. Om du vill visa information om Apache Spark program som körs väljer du sändnings Apache Spark programmet och visar informationen. Om Apache Spark programmet fortfarande körs kan du övervaka förloppet.
