...
description: Rekommendationer och prestandaoptimeringar för inläsning av data i SQL Analytics
...
Som tidigare nämnts kommer inläsning med PolyBase att ge det högsta dataflödet med SQL Data Warehouse. Om du inte kan använda PolyBase för att läsa in och måste använda SQLBulkCopy API (eller BCP) bör du överväga att öka batchstorleken för bättre dataflöde - en bra tumregel är en batchstorlek mellan 100K till 1 M rader.
