...
Använd det här kommandot [skapa extern data källa](/sql/t-sql/statements/create-external-data-source-transact-sql?toc=/azure/synapse-analytics/sql-data-warehouse/toc.json&bc=/azure/synapse-analytics/sql-data-warehouse/breadcrumb/toc.json&view=azure-sqldw-latest) för att lagra data platsen. Om du autentiserar med AAD-vidarekoppling krävs inte parametern CREDENTIAL. Om du autentiserar med hjälp av hanterad identitet för tjänst slut punkter följer du den här [dokumentationen](../../azure-sql/database/vnet-service-endpoint-rule-overview.md?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json#azure-synapse-polybase) för att konfigurera den externa data källan.
