...
Använd det här kommandot [SKAPA EXTERN DATAKÄLLA](/sql/t-sql/statements/create-external-data-source-transact-sql?toc=/azure/synapse-analytics/sql-data-warehouse/toc.json&bc=/azure/synapse-analytics/sql-data-warehouse/breadcrumb/toc.json&view=azure-sqldw-latest) för att lagra platsen för data. Om du autentiserar med AAD-genomströmning krävs inte parametern AUTENTISERINGSUPPGIFTER.
