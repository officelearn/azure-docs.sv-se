...
Om du pausar beräkning tas lagringslagret bort från beräkningsnoderna. Beräkningsresurserna frigörs från ditt konto. Du debiteras inte för beräkning medan beräkningen pausas. Återuppta beräkning återansluter lagring till beräkningsnoderna och återupptar avgifter för Beräkning.
...
För att skala SQL-poolen krävs de behörigheter som beskrivs i [ALTER DATABASE](/sql/t-sql/statements/alter-database-azure-sql-data-warehouse?toc=/azure/synapse-analytics/sql-data-warehouse/toc.json&bc=/azure/synapse-analytics/sql-data-warehouse/breadcrumb/toc.json&view=azure-sqldw-latest).  Paus och återställning kräver SQL DB Contributor-behörigheten, särskilt Microsoft.Sql/servers/databases/action. [SQL DB Contributor](../../role-based-access-control/built-in-roles.md?toc=/azure/synapse-analytics/sql-data-warehouse/toc.json&bc=/azure/synapse-analytics/sql-data-warehouse/breadcrumb/toc.json#sql-db-contributor)
