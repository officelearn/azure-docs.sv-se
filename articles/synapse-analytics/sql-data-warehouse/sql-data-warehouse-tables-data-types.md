---
title: Tabell data typer i dedikerad SQL-pool
description: Rekommendationer för att definiera tabell data typer i en dedikerad SQL-pool.
...
ms.locfileid: "93313077"
---
# <a name="table-data-types-for-dedicated-sql-pool-in-azure-synapse-analytics"></a>Tabell data typer för dedikerad SQL-pool i Azure Synapse Analytics 
...
I följande lista visas de data typer som dedikerade SQL-poolen inte stöder och ger användbara alternativ för data typer som inte stöds.
