---
title: 'Självstudier om data analys: använda SQL på begäran (för hands version) för att analysera Azure Open-datauppsättningar i Azure Synapse Studio (för hands version)'
