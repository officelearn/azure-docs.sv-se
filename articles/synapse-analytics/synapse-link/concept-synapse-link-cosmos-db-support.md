---
title: Azure Synapse-länk för Azure Cosmos DB funktioner som stöds
...
ms.locfileid: "83599951"
---
# <a name="azure-synapse-link-for-azure-cosmos-db-supported-features"></a>Azure Synapse-länk för Azure Cosmos DB funktioner som stöds
