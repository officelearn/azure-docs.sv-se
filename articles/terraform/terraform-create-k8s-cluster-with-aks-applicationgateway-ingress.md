---
title: Skapa en Application Gateway ingress-kontrollant i Azure Kubernetes service (AKS)
...
1. Redigera `helm-config.yaml` och ange lämpliga värden för `appgw`-och `armAuth`-sektioner.
