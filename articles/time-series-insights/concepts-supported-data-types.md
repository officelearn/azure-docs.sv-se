---
title: Data typer som stöds – Azure Time Series Insights | Microsoft Docs
description: Lär dig mer om de data typer som stöds i Azure Time Series Insights Preview.
author: lyrana
ms.author: lyhughes
...
ms.locfileid: "86050102"
---
# <a name="supported-data-types"></a>Data typer som stöds

I följande tabell visas de data typer som stöds av Time Series Insights
