...
2. Under den **entiteter** väljer **konsumentgrupper**.
...
4. På den **konsumentgrupper** anger du ett nytt unikt **namn**.  Använd det här namnet när du skapar en ny händelsekälla i Time Series Insights-miljö.

5. Välj **skapa** att skapa nya konsumentgruppen.
...
8. Om du har valt den **Använd Event Hub från tillgängliga prenumerationer** alternativet i följande tabell beskrivs varje obligatorisk egenskap:
...
10. Lägg till dedikerade TSI konsument gruppnamnet som du lade till din Event hub.
