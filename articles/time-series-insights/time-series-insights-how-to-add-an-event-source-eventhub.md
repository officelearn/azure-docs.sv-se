---
title: Lägg till en Event Hubs händelse källa i Azure Time Series Insights | Microsoft Docs
...
1. Under **entiteter**väljer du **konsument grupper**och väljer sedan **konsument grupp**.
   ...
   [![Event Hub – Lägg till en konsument grupp](media/time-series-insights-how-to-add-an-event-source-eventhub/2-event-hub-consumer-group.png)](media/time-series-insights-how-to-add-an-event-source-eventhub/2-event-hub-consumer-group.png#lightbox)
