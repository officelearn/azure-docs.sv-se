...
ms.locfileid: "87920729"
---
# <a name="query-data-from-the-azure-time-series-insights-gen1-environment-using-c"></a>Fråga efter data från Azure Time Series Insights gen1-miljön med hjälp av C #

Det här C#-exemplet visar hur du använder [gen1-fråge-API: er](https://docs.microsoft.com/rest/api/time-series-insights/ga-query) för att fråga efter data från Azure Time Series Insights gen1-miljöer.
