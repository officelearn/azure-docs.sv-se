...
| deviceId  | Typ | L1 | L2 | tidsstämpel | series_Flow Rate ft3/s | series_Engine olja-tryck psi |
| ---- | ---- | ---- | ---- | ---- | ---- | ---- |
...
* Eftersom det finns några mått skickas de som separata egenskaper inom samma objekt. I exemplet är **Series_Flow Rate PSI**, **series_Engine olja Press PSI**och **series_Flow Rate ft3/s** unika kolumner.
