...
Om det behövs installerar du Azure PowerShell med hjälp av den instruktion som finns i [Azure PowerShell-guiden](/powershell/azure)och `Connect-AzAccount` kör sedan för att skapa en anslutning till Azure.
