...
- För det andra använder Traffic Manager en intern karta för att göra IP-adressen till översättning av geografiskt område. Även om den här kartan verifieras och uppdateras kontinuerligt för att öka noggrannheten och kontot för internetens föränderliga natur, är det fortfarande möjligt att vår information inte är en exakt representation av den geografiska platsen för alla IP-adresser adresser.
