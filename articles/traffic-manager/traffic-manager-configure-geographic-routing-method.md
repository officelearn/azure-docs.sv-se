---
title: Konfigurera geografisk trafik routning – Azure Traffic Manager
description: Den här artikeln förklarar hur du konfigurerar metoden för geografisk trafik cirkulation med hjälp av Azure Traffic Manager
...
ms.locfileid: "74031955"
---
# <a name="configure-the-geographic-traffic-routing-method-using-traffic-manager"></a>Konfigurera routningsmetod för geografisk trafik med hjälp av Traffic Manager
