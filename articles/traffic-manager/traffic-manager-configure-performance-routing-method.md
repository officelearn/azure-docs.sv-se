...
Trafikroutningsmetod prestanda kan du dirigera trafik till slutpunkten med den lägsta fördröjningen från klientens nätverk. Datacenter med den lägsta fördröjningen är vanligtvis den närmaste i geografiska avstånd. Den här trafikroutningsmetod kan inte kontot för realtid ändringarna i nätverkskonfigurationen eller läsa in.

##  <a name="to-configure-performance-routing-method"></a>Konfigurera routningsmetoden för prestanda
...
5.  Testa ändringar i konfigurationen på följande sätt:
    ...
    3.  Den **trafikhanterarprofil** bladet visar DNS-namnet för nyskapade Traffic Manager-profilen. Detta kan användas av alla klienter (till exempel genom att navigera till den med hjälp av en webbläsare) att hämta dirigeras till rätt slutpunkten som bestäms av typen routning. I det här fallet dirigeras alla begäranden som till slutpunkten med den lägsta fördröjningen från klientens nätverk.
