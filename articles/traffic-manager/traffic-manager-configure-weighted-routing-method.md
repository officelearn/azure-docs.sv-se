...
Ett vanligt trafik routning metoden mönster är att tillhandahålla en uppsättning identiska slutpunkter, bland annat molntjänster och webbplatser, och skicka trafik till var och en i en resursallokering. Följande steg beskriver hur du konfigurerar den här typen av trafikroutningsmetod.

> [!NOTE]
> Med Azure Web Apps tillhandahåller redan belastningsutjämning för resursallokering för webbplatser inom en Azure-Region (innehåller flera datacenter). Traffic Manager kan du ange routningsmetoden för resursallokering för webbplatser på olika datacenter.
