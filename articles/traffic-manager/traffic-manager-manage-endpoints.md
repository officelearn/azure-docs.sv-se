...
>[AZURE.NOTE]  Den här artikeln beskriver hur man använder den klassiska portalen. Den klassiska Azure-portalen stöder bara skapande och tilldelning av molntjänster och webbappar som slutpunkter. Den nya [Azure-portalen](https://portal.azure.com) är det föredragna gränssnittet.
