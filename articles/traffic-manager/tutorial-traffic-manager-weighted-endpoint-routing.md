...
I det här avsnittet ska du installera IIS-servern på två virtuella datorer&mdash;myIISVMEastUS och myIISVMWEurope&mdash;, och uppdatera sedan standardwebbsidan. Den anpassade webbsidan visar namnet på den virtuella datorn som du ansluter till när du besöker webbplatsen från en webbläsare.
