---
title: Anslut med Windows Virtual Desktop förhandsversion webbklienten - Azure
description: Hur du ansluter till Windows Virtual Desktop förhandsversion HTML5-webbklienten.
...
ms.locfileid: "58403756"
---
# <a name="connect-with-the-web-client"></a>Anslut med webbklienten
...
>[!NOTE]
>Om du redan har loggat in med ett Azure AD-konto som är samma som det konto som du vill använda för virtuella Windows-skrivbordet, kan du behöva logga ut eller använda ett privat webbläsarfönster.
