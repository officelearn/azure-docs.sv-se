...
- Distribuera om mallen när autentiseringsuppgifterna har bekräftats. Se [skapa en adresspool med PowerShell](create-host-pools-powershell-2019.md).
...
**Korrigering 1:** Lägg till de saknade komponenterna manuellt i de virtuella datorerna med hjälp av [skapa en adresspool med PowerShell](create-host-pools-powershell-2019.md).
...
3. Installera stacken sida vid sida med hjälp av [skapa en värdbaserad pool med PowerShell](create-host-pools-powershell-2019.md).
