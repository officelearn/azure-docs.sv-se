...
När de virtuella dator instanserna är krypterade rapporterar EncryptionSummary *-koden ProvisioningState/lyckades* som visas i följande exempel på utdata:
