        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Läs mer om skalningsuppsättningar för virtuella datorer</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Komma igång med skalningsuppsättningar för virtuella datorer</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/virtualmachinescalesets/">REST API-referens för skalningsuppsättningar för virtuella datorer</a></p>
                    </div>
                </div>
            </div>
        </div>
