...
Skapa en virtuell dator från en specialiserad avbildnings version som lagras i ett [delat avbildnings Galleri](shared-image-galleries.md) med hjälp av Azure PowerShell. Om du vill skapa en skalnings uppsättning med en generaliserad avbildnings version, se [skapa skalnings uppsättnings instanser från en generaliserad avbildnings version](instance-generalized-image-version-powershell.md).
