...
Om du vill ange domän namnet i en Azure-mall lägger du till en **dnsSettings** -egenskap i avsnittet skalnings uppsättning **networkInterfaceConfigurations** . Till exempel:
...
För visa skaluppsättningens offentliga IP-adresser med hjälp av PowerShell använder du kommandot _Get-AzPublicIpAddress_. Till exempel:
