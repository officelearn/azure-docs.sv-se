...
---
# <a name="troubleshooting-autoscale-with-virtual-machine-scale-sets"></a>Felsöka autoskalning med Virtual Machine Scale Sets
**Problem** – du har skapat en infrastruktur för automatisk skalning i Azure Resource Manager att använda skalnings uppsättningar för virtuella datorer, t. ex. genom att distribuera en mall som den här: https://github.com/Azure/azure-quickstart-templates/tree/master/201-vmss-bottle-autoscale – du har definierat dina skalnings regler och det fungerar bra, förutom oavsett hur mycket belastning du lägger till på de virtuella datorerna, skalas den inte.
