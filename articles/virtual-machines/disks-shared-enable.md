...
Delade diskar har stöd för flera operativ system. Se avsnittet [Windows](./disks-shared.md#windows) och [Linux](./disks-shared.md#linux) i den konceptuella artikeln för de operativ system som stöds.
