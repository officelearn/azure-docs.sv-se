---
title: Eav4-serien och Easv4-serien – virtuella Azure-datorer
description: Specifikationer för Eav4 och Easv4-serien virtuella datorer.
...
ms.locfileid: "78164397"
---
# <a name="eav4-and-easv4-series"></a>Eav4- och Easv4-serien

Eav4-serien och Easv4-serien använder AMD:s 2,35 Ghz EPYC<sup>TM</sup> 7452-processor i en flertrådad konfiguration med upp till 256 MB L3-cache, vilket ökar alternativen för att köra de flesta minnesoptimerade arbetsbelastningar. Eav4-serien och Easv4-serien har samma minnes- och diskkonfigurationer som Ev3 & Esv3-serien.
...
Eav4-seriens storlekar är baserade på 2,35 GHz AMD EPYC<sup>TM</sup> 7452-processor som kan uppnå en förstärkt maximal frekvens på 3,35 GHz och använda premium SSD. Storleken i Eav4-serien är idealiska för minnesintensiva företagsprogram. Datadisklagring faktureras separat från virtuella datorer. Använd storlekarna i Easv4-serien om du vill använda premium-SSD. Pris- och faktureringsmätare för Easv4-storlekar är desamma som Eav3-serien.
...
Easv4-seriens storlekar är baserade på 2,35 GHz AMD EPYC<sup>TM</sup> 7452-processor som kan uppnå en ökad maximal frekvens på 3,35 GHz och använda premium SSD. Storlekarna i Easv4-serien är idealiska för minnesintensiva företagsprogram.
