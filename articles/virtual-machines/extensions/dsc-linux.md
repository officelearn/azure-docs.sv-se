...
DSC-Linux-tillägget har stöd för alla de [tillägget stöds operativsystem](https://azurewiki.cloudapp.netVMAgentExtension/extensionSupportedOSs) utom:

| Distribution | Version |
|---|---|
| CentOS Linux | 6,5 och högre |
