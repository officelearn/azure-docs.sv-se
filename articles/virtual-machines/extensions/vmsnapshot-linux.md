---
title: Linux för ögonblicksbild av VM-tillägget för Azure Backup | Microsoft Docs
...
ms.locfileid: "33942692"
---
# <a name="vm-snapshot-linux-extension-for-azure-backup"></a>Linux för ögonblicksbild av VM-tillägget för Azure Backup

## <a name="overview"></a>Översikt

Azure-säkerhetskopiering har stöd för säkerhetskopiering av arbetsbelastningar från lokalt till molnet och säkerhetskopiering av molnresurser till Recovery Services-valvet. Azure Backup använder ögonblicksbilden tillägg för virtuell dator för att ta ett program konsekvent säkerhetskopiering av den virtuella Azure-datorn utan att behöva avstängning den virtuella datorn. VM-ögonblicksbild Linux tillägget publiceras och stöds av Microsoft som en del av Azure Backup-tjänsten. Azure Backup installerar tillägget som en del av första schemalagda säkerhetskopiering utlösta efter att aktivera säkerhetskopiering. Det här dokumentet beskriver de plattformar som stöds, konfigurationer och distributionsalternativ för tillägg för VM-ögonblicksbild.

## <a name="prerequisites"></a>Förutsättningar

### <a name="operating-system"></a>Operativsystem
En lista över operativsystem som stöds, referera till [operativsystem som stöds av Azure Backup](../../backup/backup-azure-arm-vms-prepare.md#supported-operating-systems-for-backup)
