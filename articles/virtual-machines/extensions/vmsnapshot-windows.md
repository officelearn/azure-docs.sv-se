---
title: Vm Snapshot Windows-tillägg för Azure Backup
...
ms.locfileid: "79415128"
---
# <a name="vm-snapshot-windows-extension-for-azure-backup"></a>Vm Snapshot Windows-tillägg för Azure Backup

Azure Backup ger stöd för säkerhetskopiering av arbetsbelastningar från lokalt till moln och säkerhetskopiering av molnresurser till Recovery Services-valvet. Azure Backup använder vm-ögonblicksbildtillägg för att ta ett program konsekvent säkerhetskopiering av den virtuella Azure-datorn utan att behöva stänga av den virtuella datorn. Vm Snapshot-tillägget publiceras och stöds av Microsoft som en del av Azure Backup-tjänsten. Azure Backup installerar tillägget som en del av den första schemalagda säkerhetskopieringen som utlösts efter säkerhetskopiering. I det här dokumentet beskrivs de plattformar, konfigurationer och distributionsalternativ som stöds för tillägget Ögonblicksbild av virtuella datorer.
