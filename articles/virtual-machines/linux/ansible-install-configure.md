...
På värddatorn eller i Azure Cloud-gränssnittet, skapa ett service principal med [az ad sp skapa-för-rbac](/cli/azure/ad/sp#az-ad-sp-create-for-rbac). Autentiseringsuppgifterna som Ansible måste är utdata till skärmen:
...
Om du vill autentisera till Azure, du måste också hämta din Azure-prenumeration ID med [az konto visa](/cli/azure/account#az-account-show):
