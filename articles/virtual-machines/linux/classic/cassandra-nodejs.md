...
Du måste manuellt godkänna licensen för Oracle när du laddar ned JRE. Hämta så all nödvändig programvara för att förenkla distributionen på skrivbordet. Sedan överföra det till Ubuntu-mallavbildningen för att skapa som ett tidigare kluster-distributionen.
