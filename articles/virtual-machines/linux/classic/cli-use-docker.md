...
Om du vill använda Docker med en virtuell dator i Azure, Linux-bild som används för den virtuella datorn måste ha den [Virtuella Azure Linux-agenten](../../extensions/agent-linux.md) installerad. Det finns för närvarande bara två typer av avbildningar som innehåller detta:

* En Ubuntu-avbildning från Azure-galleriet avbildningen eller
* En anpassad avbildning i Linux som du har skapat med Azure Linux VM-agenten installeras och konfigureras. Se [Virtuella Azure Linux-agenten](../../extensions/agent-linux.md) mer information om hur du skapar en anpassad Linux VM med Azure VM-agenten.
