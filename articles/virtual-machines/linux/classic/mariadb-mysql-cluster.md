...
> [!NOTE]
> MariaDB Enterprise kluster är nu tillgänglig i Azure Marketplace. Nytt erbjudande distribuera automatiskt ett MariaDB Galera kluster på Azure Resource Manager. Du bör använda ett nytt erbjudande från [Azure Marketplace](https://azure.microsoft.com/en-us/marketplace/partners/mariadb/cluster-maxscale/).
>
>
