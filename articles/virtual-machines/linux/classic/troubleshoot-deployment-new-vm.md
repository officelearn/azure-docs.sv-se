...
Överför den ursprungliga virtuella Hårddisken tillgänglig lokalt, med samma inställning som för OS (generaliserad/specialiserade) för att lösa båda dessa fel. Om du vill överföra som generaliserad ihåg att köra - ta bort etableringen först. Se [skapa och ladda upp en virtuell hårddisk som innehåller Linux-operativsystem](create-upload-vhd.md) för mer information.
