---
title: "Skapa en virtuell Linux-dator för ett webbprogram | Microsoft Docs"
description: "Skapa en virtuell dator för ett webbprojekt med hjälp av Visual Studio- och Linux."
...
---
# <a name="creating-a-virtual-machine-for-a-web-application-with-visual-studio"></a>Skapa en virtuell dator för ett webbprogram med Visual Studio
> [!IMPORTANT] 
