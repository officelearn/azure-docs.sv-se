...
Mer detaljerad hjälp med specifika kommando rads växlar och alternativ finns i hjälp och alternativ för online-kommandot genom att skriva `az <command> <subcommand> --help`.
