...
Nu skapar du en virtuell dator med [az vm skapa](/cli/azure/vm#az_vm_create) och ange bash-skriptfil med `--custom-data simple_bash.sh` på följande sätt:
