---
title: Beräkna benchmark-poäng för virtuella Linux-datorer | Microsoft Docs
description: Jämför CoreMark compute benchmark-poäng för virtuella Azure-datorer som kör Linux.
...
ms.locfileid: "67668151"
---
# <a name="compute-benchmark-scores-for-linux-vms"></a>Beräkna benchmark-poäng för virtuella Linux-datorer
Följande CoreMark benchmark-poäng visar prestanda för databearbetning för Azures högpresterande VM utbud som kör Ubuntu. Compute benchmark-poäng kan också användas för [Windows virtuella datorer](../windows/compute-benchmark-scores.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).

## <a name="av2---general-compute"></a>Av2 - allmänna beräkning
(3/15/2019 12:06:55 AM pbi 3897709)

| Storlek på virtuell dator | Processor | virtuella processorer | NUMA-noder | Memory(GiB) | Genomsnittligt antal poäng | StdDev | StdDev % | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
...
(3/12/2019 18:52:03: 00 pbi 3897709)
...
(3/15/2019 12:53:13: 00 pbi 3897709)
...
(3/12/2019 18:53:48: 00 pbi 3897709)
...
(3/12/2019 18:52:13: 00 pbi 3897709)
...
(3/12/2019 18:57:51: 00 pbi 3897709)
...
| Storlek på virtuell dator | Processor | virtuella processorer | NUMA-noder | Memory(GiB) | Genomsnittligt antal poäng | StdDev | StdDev % | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_F2s_v2 | Intel(R) Xeon(R) CPU Platinum 8168 @ 2,70 GHz | 2 | 1 | 3.9 | 28,219 | 1,843 | 6.53% | 700 |
| Standard_F4s_v2 | Intel(R) Xeon(R) CPU Platinum 8168 @ 2,70 GHz | 4 | 1 | 7.8 | 53,911 | 1,002 | 1.86% | 707 |
| Standard_F8s_v2 | Intel(R) Xeon(R) CPU Platinum 8168 @ 2,70 GHz | 8 | 1 | 15.7 | 106,467 | 1,101 | 1.03% | 707 |
| Standard_F16s_v2 | Intel(R) Xeon(R) CPU Platinum 8168 @ 2,70 GHz | 16 | 1 | 31.4 | 211,311 | 1,724 | 0.82% | 707 |
| Standard_F32s_v2 | Intel(R) Xeon(R) CPU Platinum 8168 @ 2,70 GHz | 32 | 1 | 62.9 | 423,175 | 4,346 | 1.03% | 707 |
| Standard_F64s_v2 | Intel(R) Xeon(R) CPU Platinum 8168 @ 2,70 GHz | 64 | 2 | 125.9 | 829,537 | 21,574 | 2.60% | 707 |
| Standard_F72s_v2 | Intel(R) Xeon(R) CPU Platinum 8168 @ 2,70 GHz | 72 | 2 | 141.7 | 933,800 | 26,783 | 2.87% | 707 |
...
(3/12/2019 18:53:59: 00 pbi 3897709)
...
(3/14/2019 17:49:04: 00 pbi 3897709)

| Storlek på virtuell dator | Processor | virtuella processorer | NUMA-noder | Memory(GiB) | Genomsnittligt antal poäng | StdDev | StdDev % | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_L8s_v2 | AMD EPYC 7551 32 processorkärnor | 8 | 1 | 62.9 | 80,528 | 404 | 0.50% | 119 |
| Standard_L16s_v2 | AMD EPYC 7551 32 processorkärnor | 16 | 2 | 125.9 | 154,829 | 3,708 | 2.40% | 119 |
| Standard_L32s_v2 | AMD EPYC 7551 32 processorkärnor | 32 | 4 | 251.9 | 310,811 | 7,751 | 2.49% | 119 |
| Standard_L64s_v2 | AMD EPYC 7551 32 processorkärnor | 64 | 8 | 503.9 | 595,140 | 14,572 | 2.45% | 112 |
| Standard_L80s_v2 | AMD EPYC 7551 32 processorkärnor | 80 | 10 | 629.9 | 773,171 | 19,559 | 2.53% | 119 |
...
(3/12/2019 23:19:19: 00 pbi 3897709)
...
(3/12/2019 23:08:03: 00 pbi 3897709)
...
(3/12/2019 23:08:13: 00 pbi 3897709)
...
Linux-värdena är beräknade genom att köra [CoreMark](https://www.eembc.org/coremark/faq.php) på Ubuntu. CoreMark har konfigurerats med antalet trådar som anger att antalet virtuella processorer och samtidighet ange PThreads. Antalet iterationer justerades baserat på prestanda att tillhandahålla en körning av minst 20 sekunder (vanligtvis mycket längre). Den slutliga poängen representerar antalet iterationer har slutförts dividerat med antalet sekunder som det tog för att utföra testet. Varje test kördes minst sju gånger på varje virtuell dator. Testkörning datum som anges ovan. Tester körs på flera virtuella datorer mellan offentliga Azure-regioner den virtuella datorn hade stöd i den dag som kör. Basic A och B (anpassningsbara) serier som inte visas eftersom prestanda är variabel. N-serien som inte visas eftersom de är inriktad GPU- och Coremark mäta inte GPU-prestanda.

## <a name="next-steps"></a>Nästa steg
* Lagringskapacitet, diskinformation och ytterligare överväganden för att välja bland VM-storlekar finns i [storlekar för virtuella datorer](sizes.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
* Kör CoreMark-skript på virtuella Linux-datorer genom att ladda ned den [CoreMark skriptet pack](https://download.microsoft.com/download/3/0/5/305A3707-4D3A-4599-9670-AAEB423B4663/AzureCoreMarkScriptPack.zip).
