---
title: Beräkna benchmark resultat för virtuella Azure Linux-datorer | Microsoft Docs
description: Jämför CoreMark beräkning benchmark resultat för Azure virtuella datorer som kör Linux.
...
| Standard_A8m_v2 | Intel(R) Xeon(R) CPU E5 2673 v4 @ 2,30 GHz | 8 | 1 | 64.4 | 48,494 | 501 | 1,03 enligt följande % | 49 |
