---
title: Beräkna benchmark-poäng för virtuella Azure Linux-datorer
description: Jämför CoreMark-beräkningsriktmärken för virtuella Azure-datorer som kör Linux.
...
ms.locfileid: "78969752"
---
# <a name="compute-benchmark-scores-for-linux-vms"></a>Beräkna benchmark-poäng för virtuella Linux-datorer
Följande CoreMark-benchmarkpoäng visar beräkningsprestanda för Azures högpresterande VM-uppställning som kör Ubuntu. Beräkningsriktmärken är också tillgängliga för [virtuella Windows-datorer](../windows/compute-benchmark-scores.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).

## <a name="av2---general-compute"></a>Av2 - Allmän beräkning
(2019-03-15 12:06:55 pbi 3897709)

| Storlek på virtuell dator | Processor | Virtuella processorer | NUMA-noder | Minne(GiB) | Genomsnittlig poäng | StdDev (på samma sätt som) | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
...
(2019-03-15 12:27:08 pbi 3897709)
...
CoreMark är ett kort körtest som vanligtvis slutförs inom tillgängliga burst-krediter.  Därför representerar siffrorna ovan vanligtvis burst-prestanda för den virtuella datorn, vilket återspeglar vad den korta, bursty, arbetsbelastningar (typiska på B-serien) prestanda normalt ser.

## <a name="dsv3---general-compute--premium-storage"></a>DSv3 - Allmän beräkning + Premium-lagring
(2019-03-12 18:52:03 pbi 3897709)
...
(2019-03-12 18:54:27 pbi 3897709)
...
(2019-03-15 12:53:13 pbi 3897709)
...
(2019-03-12 18:53:48 pbi 3897709)
...
(2019-03-12 19:17:33 pbi 3897709)
...
(2019-04-11 10:07:29 pbi 3897709)
...
(2019-03-12 18:52:13 pbi 3897709)
...
(2019-03-12 18:57:51 pbi 3897709)
...
(2019-03-12 18:51:35 pbi 3897709)
...
(2019-03-15 12:12:51 pbi 3897709)
...
(2019-03-12 18:53:59 pbi 3897709)
...
(2019-03-12 10:22:33 pbi 3897709)
...
(2019-03-12 10:23:51 pbi 3897709)
...
(2019-03-12 10:50:51 pbi 3897709)
...
## <a name="lv2---storage-optimized"></a>Lv2 - Lagring optimerad
(2019-03-14 17:49:04 pbi 3897709)

| Storlek på virtuell dator | Processor | Virtuella processorer | NUMA-noder | Minne(GiB) | Genomsnittlig poäng | StdDev (på samma sätt som) | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_L8s_v2 | AMD EPYC 7551 32-kärnig processor | 8 | 1 | 62.9 | 80,528 | 404 | 0.50% | 119 |
| Standard_L16s_v2 | AMD EPYC 7551 32-kärnig processor | 16 | 2 | 125.9 | 154,829 | 3,708 | 2.40% | 119 |
| Standard_L32s_v2 | AMD EPYC 7551 32-kärnig processor | 32 | 4 | 251.9 | 310,811 | 7,751 | 2.49% | 119 |
| Standard_L64s_v2 | AMD EPYC 7551 32-kärnig processor | 64 | 8 | 503.9 | 595,140 | 14,572 | 2.45% | 112 |
| Standard_L80s_v2 | AMD EPYC 7551 32-kärnig processor | 80 | 10 | 629.9 | 773,171 | 19,559 | 2.53% | 119 |

## <a name="ls---storage-optimized"></a>Ls - Lagring Optimerad
(2019-03-12 10:22:29 pbi 3897709)
...
(2019-04-11 19:30:39 pbi 3897709)
...
(2019-03-12 11:19:19 pbi 3897709)
...
(2019-03-12 11:08:03 pbi 3897709)
...
(2019-03-12 11:19:10 pbi 3897709)
...
(2019-03-12 11:08:13 pbi 3897709)
...
Linux-nummer beräknades genom att köra [CoreMark](https://www.eembc.org/coremark/faq.php) på Ubuntu. CoreMark konfigurerades med antalet trådar inställda på antalet virtuella processorer och samtidighet inställd på PThreads. Målantalet iterationer justerades baserat på förväntade prestanda för att ge en körning på minst 20 sekunder (vanligtvis mycket längre). Slutresultatet representerar antalet slutförda iterationer dividerat med antalet sekunder som tog att köra testet. Varje test kördes minst sju gånger på varje virtuell dator. Testkörningsdatum som visas ovan. Tester körs på flera virtuella datorer i Azure offentliga regioner den virtuella datorn stöddes i på datumkörningen. Grundserien a och b (Burstable) visas inte eftersom prestanda är varierande. N-serien visas inte eftersom de är GPU-centrerade och Coremark mäter inte GPU-prestanda.

## <a name="next-steps"></a>Nästa steg
* För lagringskapacitet, diskinformation och ytterligare överväganden för att välja mellan vm-storlekar finns i [Storlekar för virtuella datorer](sizes.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
* Om du vill köra CoreMark-skripten på virtuella Linux-datorer laddar du ned [CoreMark-skriptpaketet](https://download.microsoft.com/download/3/0/5/305A3707-4D3A-4599-9670-AAEB423B4663/AzureCoreMarkScriptPack.zip).
