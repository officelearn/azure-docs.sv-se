...
Om du vill definiera anslutningsinställningar för, kan du köra kommandot föreslagna configuration (`eval $(docker-machine env myvm)`), eller att du anger miljövariabler manuellt. 
