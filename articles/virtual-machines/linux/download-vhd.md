...
Installera [Azure CLI](/cli/azure/install-az-cli2)om du inte redan gjort det.
...
2. Logga in på ditt Azure-konto med [AZ-inloggning](/cli/azure/reference-index).
