...
| Azure VM Access-tillägg |Hantera användare och autentiseringsuppgifter |[Tillägget för virtuell dator åtkomst för Linux](https://azure.microsoft.com/blog/using-vmaccess-extension-to-reset-login-credentials-for-linux-vm/) |
