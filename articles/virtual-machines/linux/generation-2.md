...
> [!IMPORTANT]
> Azure-support för virtuella datorer i generation 2 förhandsvisas just nu. Den här förhandsversionen tillhandahålls utan ett serviceavtal och det rekommenderas inte för produktionsarbetsbelastningar. Vissa funktioner kanske inte stöds eller kan vara begränsade.
