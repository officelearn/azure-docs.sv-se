...
Mer information om Azure Active Directory finns i [vad är Azure Active Directory](../../active-directory/fundamentals/active-directory-whatis.md) och [hur du kommer igång med Azure Active Directory](../../active-directory/fundamentals/get-started-azure-ad.md)
