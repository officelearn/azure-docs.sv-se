---
title: Översikt över plattformsstödd migrering av IaaS-resurser från klassisk till Azure Resource Manager
description: Den här artikeln går igenom den plattformsstödda migreringen av resurser från klassisk till Azure Resource Manager
author: tanmaygore
manager: vashan
...
ms.locfileid: "78944680"
---
# <a name="platform-supported-migration-of-iaas-resources-from-classic-to-azure-resource-manager"></a>Migrering av IaaS-resurser som stöds av plattformen från klassisk till Azure Resource Manager
