...
Microsoft Azure-resurser fördelas på flera geografiska områden runtom i världen.  En ”region” representerar flera datacenter i ett enda geografiskt område.  Det finns 34 regioner som är allmänt tillgängliga världen över, och fyra ytterligare regioner har tillkännagivits. Eftersom vi fortsätter att utöka vår globala täckning har vi en lista som hela tiden uppdateras med befintliga regioner och regioner som nyligen har tillkännagivits.

* [Azure-regioner](https://azure.microsoft.com/regions/)

## <a name="availability"></a>Tillgänglighet
Vi har tillkännagivit ett branschledande serviceavtal på 99,9 % för virtuella datorer med en instans, förutsatt att du distribuerar den virtuella datorn med premiumlagring för alla diskar.  För att distributionen ska kunna omfattas av vårt 99,95 % standardserviceavtal för virtuella datorer behöver du fortfarande distribuera två eller flera virtuella datorer som kör arbetsbelastningen i en tillgänglighetsuppsättning. Det säkerställer att dina virtuella datorer distribueras via flera feldomäner i datacentren och på värdar med olika underhållsfönster. I det fullständiga[Azure-serviceavtalet](https://azure.microsoft.com/support/legal/sla/virtual-machines/v1_0/) förklaras den garanterade tillgängligheten för Azure som helhet.

## <a name="managed-disks"></a>Managed Disks

Managed Disks hanterar skapande och hantering av Azure-lagringskontot i bakgrunden och säkerställer att du inte behöver bekymra dig om lagringskontots skalbarhetsgränser. Du anger bara diskens storlek och prestandanivå (Standard eller Premium) så skapar och hanterar Azure disken åt dig. Även om du lägger till diskar eller skalar upp eller ned den virtuella datorn behöver du inte oroa dig om lagringsutrymmet som används. Om du skapar nya virtuella datorer ska du [använda Azure CLI 2.0](quick-create-cli.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) eller Azure-portalen för att skapa virtuella datorer med hanterade OS- och datadiskar. Om du har virtuella datorer med ohanterade diskar kan du [konvertera de virtuella datorerna så att de stöds av Managed Disks](convert-unmanaged-to-managed-disks.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
...
Microsoft Azure har stöd för körning av ett antal populära Linux-distributioner som tillhandahålls och underhålls av ett antal partners.  Du hittar distributioner som Red Hat Enterprise, CentOS, SUSE Linux Enterprise, Debian, Ubuntu, CoreOS, RancherOS, FreeBSD med flera i Azure Marketplace. Vi arbetar aktivt med flera Linux-communities för att lägga till ännu fler alternativ i listan över [Azure-godkända Linux-distributioner](endorsed-distros.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).

Om den önskade Linux-distributionen inte finns i galleriet för närvarande kan du ”Bring your own Linux”-VM genom att [skapa och ladda upp en virtuell Linux-hårddisk i Azure](create-upload-generic.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).

Virtuella Azure-datorer gör det möjligt att distribuera en lång rad databehandlingslösningar på ett smidigt sätt. Du kan distribuera i princip vilken arbetsbelastning och vilket språk som helst på nästan vilket operativsystem som helst – Windows, Linux eller ett anpassat från någon av vår växande lista med partners. Hittar du fortfarande inte det du letar efter?  Oroa dig inte, du kan även hämta egna avbildningar lokalt.

## <a name="vm-sizes"></a>VM-storlekar
När du distribuerar en virtuell dator i Azure ska du välja en virtuell datorstorlek inom någon av våra storleksserier som passar din arbetsbelastning. Storleken påverkar också den virtuella datorns bearbetningskraft, minne och lagringskapacitet. Du debiteras baserat på hur länge den virtuella datorn körs och förbrukar sina tilldelade resurser. En fullständig lista över [storlekar på virtuella datorer](sizes.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).

Följande är några grundläggande riktlinjer för att välja virtuell datorstorlek från någon av våra serier (A, D, DS, G och GS).
* A-seriens virtuella datorer är ingångsprisnivån för virtuella datorer som används för lätta arbetsbelastningar och Dev/Test-scenarier. De är allmänt tillgängliga i alla regioner och kan ansluta till och använda alla standardresurser som är tillgängliga för virtuella datorer.
* A-seriens storlekar (A8–A11) är särskilt bearbetningsintensiva konfigurationer som är lämpliga för klustertillämpningar med hög bearbetningsprestanda.
...
* Dv2-serien är den senaste versionen av vår D-serie och har en kraftfullare processor. Processorn i Dv2-serien är cirka 35 % snabbare än den i D-serien. Den baseras på den senaste generationens 2,4 GHz Intel Xeon® E5-2673 v3-processor (Haskell) och kan uppnå 3,2 GHz med Intel Turbo Boost Technology 2.0. Dv2-serien har samma minnes- och diskkonfigurationer som D-serien.
...
Obs! DS-seriens och GS-seriens virtuella datorer har åtkomst till premiumlagring, vår lagring med korta svarstider som stöds av SSD för I/O-intensiva arbetsbelastningar. Premium Storage är tillgängligt i vissa regioner. Mer information finns i:

* [Premium Storage: Lagring med höga prestanda för virtuella Azure-datorarbetsbelastningar](../windows/premium-storage.md)
...
Microsoft samarbetar nära våra partners för att se till att de tillgängliga avbildningarna är uppdaterade och optimerade för Azure-körning.  Mer information om våra partners finns på deras Marketplace-sidor nedan.
...
Nu har du ett Azure-konto, Azure-webbportalen och Azure CLI.  Nästa steg är att skapa ett SSH-nyckelpar som används för SSH i Linux utan att behöva använda ett lösenord.  [Skapa SSH-nycklar på Linux och Mac](mac-create-ssh-keys.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) om du vill möjliggöra lösenordsfri inloggning och bättre säkerhet.
...
* [Skapa en virtuell Linux-dator med CLI](quick-create-cli.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
...
* [Skapa en virtuell Linux-dator med portalen](quick-create-portal.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)

### <a name="login-using-ssh-without-a-password"></a>Logga in med SSH utan ett lösenord
...
* [Lägga till en disk i en virtuell Linux-dator med azure-cli](add-disk.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
* [Lägga till en datadisk i en virtuell Linux-dator i Azure-portalen](attach-disk-portal.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
...
* [Öppna portar till en virtuell Linux-dator i Azure](nsg-quickstart.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
* [Skapa ett fullständigt domännamn i Azure-portalen](portal-create-fqdn.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
...
* [Utforska vår växande lista med exempelskript för vanliga uppgifter via AzureCLI](cli-samples.md)
