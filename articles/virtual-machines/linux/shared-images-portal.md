---
title: Skapa delade Azure VM-avbildningar för Linux med hjälp av portalen | Microsoft Docs
...
> [!IMPORTANT]
> Du kan inte använda portalen för att distribuera en virtuell dator från en avbildning i en annan azure-klient. Om du vill skapa en virtuell dator från en avbildning som delas mellan klienter, måste du använda den [Azure CLI](shared-images.md#create-a-vm) eller [Powershell](../windows/shared-images.md#create-vms-from-an-image).
...
1. Under **administratörskontot**väljer **lösenord** eller **offentlig SSH-nyckel**, ange din information.
1. Om du vill tillåta fjärråtkomst till den virtuella datorn under **offentliga inkommande portar**, Välj **valda portar** och välj sedan **SSH (22)** från listrutan. Om du inte vill tillåta fjärråtkomst till den virtuella datorn, lämnar **ingen** markerats för **offentliga inkommande portar**.
