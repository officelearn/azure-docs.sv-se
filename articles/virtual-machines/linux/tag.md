...
Om du vill börja, behöver du senast [Azure CLI 2.0 (förhandsgranskning)](/cli/azure/install-az-cli2) installerad och inloggad till en Azure-konto med hjälp av [az inloggningen](/cli/azure/#az_login).
