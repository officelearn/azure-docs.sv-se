...
---
# <a name="tutorial-monitor-a-linux-virtual-machine-in-azure"></a>Självstudier: Övervaka en virtuell Linux-dator i Azure
...
## <a name="create-vm"></a>Skapa virtuell dator
