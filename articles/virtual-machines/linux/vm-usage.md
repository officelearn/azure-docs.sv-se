...
Fältet typ av tjänst i fältet ytterligare information motsvarar den exakta VM-storlek som du har distribuerat. Virtuella datorer i Premium Storage (SSD-baserade) och icke-Premium-virtuella datorer (HDD-baserade) är i samma pris. Om du distribuerar en SSD-baserad storlek, som standard\_DS2\_v2, kan du se storleken på den icke-SSD (\_"\_standard D2 v2 VM") i kolumnen mätar under kategori och SSD-storlek (standard\_DS2\_v2) i fältet ytterligare information.
