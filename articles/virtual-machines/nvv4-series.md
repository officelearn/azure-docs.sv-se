...
Om du vill installera AMD GPU-drivrutiner manuellt, se N-seriens [installation av AMD GPU-drivrutiner för Windows](/windows/n-series-driver-setup.md) för operativ system, driv rutiner, installation och verifierings steg som stöds.
