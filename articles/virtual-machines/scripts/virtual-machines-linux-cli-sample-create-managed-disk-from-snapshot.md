...
|---|---|
| [az snapshot show](https://docs.microsoft.com/cli/azure/snapshot#az_snapshot_show) | Hämtar alla egenskaper för en ögonblicksbild med hjälp av ögonblicksbildens namn och resursgruppsegenskaper. ID-egenskapen används för att skapa en hanterad disk.  |
| [az disk create](https://docs.microsoft.com/cli/azure/disk#az_disk_create) | Skapar en hanterad disk med ett ögonblicksbilds-ID för en hanterad ögonblicksbild |
