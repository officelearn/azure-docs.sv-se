...
| [az vm extension set](/cli/azure/vm) | Lägg till tillägget för anpassat skript till den virtuella datorn, som anropar ett skript för att installera WordPress. |
