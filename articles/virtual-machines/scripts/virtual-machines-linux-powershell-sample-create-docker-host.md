...
Det här skriptet skapar en virtuell dator med Docker aktiverad och startar en NGINX-behållare. När skriptet har körts kan du komma åt webbservern NGINX via det fullständiga Domännamnet för den virtuella Azure-datorn. 
...
| [Ange AzureRmVMExtension](/powershell/module/azurerm.compute/set-azurermvmextension) | Lägg till en VM-tillägget till den virtuella datorn. I det här exemplet används Docker-tillägget för att konfigurera Docker och köra en Docker NGINX-behållare. |
