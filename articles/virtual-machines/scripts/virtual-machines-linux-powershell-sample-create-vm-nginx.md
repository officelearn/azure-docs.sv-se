...
| [Set-AzVMExtension](/powershell/module/az.compute/set-azvmextension) | Lägg till ett virtuellt datortillägg till den virtuella datorn. I det här exemplet används det anpassade skripttillägget till att installera NGINX. |
