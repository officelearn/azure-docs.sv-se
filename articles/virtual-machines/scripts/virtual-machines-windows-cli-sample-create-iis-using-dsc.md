...
Det här skriptet skapar en virtuell dator och använder tillägget för Azure Virtual Machine DSC-anpassat skript för att installera och konfigurera IIS. 
...
| [AZ vm-tillägget uppsättningen](https://docs.microsoft.com/cli/azure/vm#az_vm_create) | Lägg till tillägget för anpassat skript till den virtuella datorn som anropar ett skript för att installera IIS. |
