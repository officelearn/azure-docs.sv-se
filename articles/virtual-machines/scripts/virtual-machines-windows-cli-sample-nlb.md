---
title: Skriptexempel för Azure CLI – Skapa en virtuell Windows Server 2016-dator med NLB
...
ms.locfileid: "87500852"
---
# <a name="use-an-azure-cli-sample-script-to-load-balance-traffic-between-highly-available-virtual-machines"></a>Använd ett Azure CLI-exempel skript för att belastningsutjämna trafik mellan virtuella datorer med hög tillgänglighet
...
| [az network lb rule create](/cli/azure/network/lb/rule) | Skapar en NLB-regel. I det här exemplet skapas en regel för port 80. När HTTP-trafik kommer in till NLB dirigeras den till port 80 på någon av de virtuella datorerna i NLB-uppsättningen. |
