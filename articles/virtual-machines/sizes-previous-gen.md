...
Mer information om hur du ändrar storlek på en virtuell Windows-dator finns i [ändra storlek på en virtuell Linux-dator](linux/change-vm-size.md).  
...
> [!IMPORTANT]
>
> Virtuella datorer i DC-serien är [virtuella datorer i generation 2](./linux/generation-2.md#creating-a-generation-2-vm) och stöder bara `Gen2` avbildningar.
