...
Verktyget PerfInsights samlar in olika loggar, konfiguration och diagnostiska data, beroende på det valda scenariot. Mer information finns i den [PerfInsights dokumentation](http://aka.ms/perfinsights).
