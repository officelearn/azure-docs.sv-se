---
title: Felsök problem med RDP för Windows virtuella datorer i Azure | Microsoft Docs
description: Felsökning av RDP-problem i Azure för Windows virtuella datorer.
...
- [Felsöka fel utan licens](troubleshoot-rdp-no-license-server.md)
- [Felsökning av problem med Fjärrskrivbordstjänster](troubleshoot-remote-desktop-services-issues.md)
