...
Installera den [senaste Azure Classic CLI](/cli/azure/install-classic-cli) och logga in på ditt Azure-konto. Se till att du är i Resource Manager-läge ( `azure config mode arm` ).
