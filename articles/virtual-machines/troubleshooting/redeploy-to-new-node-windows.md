...
Om du har problem med att ansluta till din virtuella dator kan du hitta information om hur du [felsöker RDP-anslutningar](troubleshoot-rdp-connection.md) eller [detaljerade RDP](detailed-troubleshoot-rdp.md)-felsöknings steg. Om du inte kan komma åt ett program som körs på den virtuella datorn kan du också läsa [fel söknings problem i programmet](../windows/troubleshoot-app-connection.md).
