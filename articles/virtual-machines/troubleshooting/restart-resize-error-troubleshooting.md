...
## <a name="issue-error-when-starting-a-stopped-vm"></a>Ärende: Fel vid start av en stoppad virtuell dator
...
* Stoppa alla virtuella datorer i tillgänglighets uppsättningen och starta sedan om varje virtuell dator.
  ...
  1. Klicka på **resurs grupper** > *resurs gruppen* > **resurser** > dintillgänglighetsuppsättningVirtual Machinesden > virtuelladatorn > *Stoppa.*  > 
...
## <a name="issue-error-when-resizing-an-existing-vm"></a>Ärende: Fel vid ändring av storlek på en befintlig virtuell dator
