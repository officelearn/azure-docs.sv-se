...
1. Logga in på [Azure Portal](https://portal.azure.com).
2. På navmenyn väljer **alla resurser**. Gå till storage-konto under **Blobtjänsten** Välj **behållare**.

    ![Skärmbild av portalen med lagringskontobehållarna och den ”Lånestillstånd” med ”utlånad” markerat](./media/troubleshoot-vhds/utd-containers-sm.png)
