---
title: Det går inte att RDP om ingen licensserver för fjärrskrivbord är tillgängliga för att tillhandahålla en licens i Azure | Microsoft Docs
...
ms.locfileid: "49989240"
---
# <a name="rdp-fails-if-no-remote-desktop-license-server-is-available-in-azure"></a>Det går inte att RDP om ingen licensserver för fjärrskrivbord är tillgänglig i Azure
