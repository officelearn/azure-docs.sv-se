...
Det här problemet kan uppstå om RDP-lyssnaren är felkonfigurerad. Det här problemet uppstår vanligen, på en virtuell dator som använder en anpassad avbildning.
