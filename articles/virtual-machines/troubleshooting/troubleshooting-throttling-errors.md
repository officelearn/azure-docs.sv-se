...
Som första dörren till Azure är Azure Resource Manager autentisering och första sortering och begränsning av alla inkommande API-begäranden. Azure Resource Manager samtals frekvens gränser och relaterade diagnostiska svars-HTTP-huvuden beskrivs [här](../../azure-resource-manager/management/request-limits-and-throttling.md).
...
-   [Exportera – AzLogAnalyticRequestRateByInterval](/powershell/module/az.compute/export-azloganalyticrequestratebyinterval)
-   [Exportera – AzLogAnalyticThrottledRequest](/powershell/module/az.compute/export-azloganalyticthrottledrequest)
...
- När du spårar asynkrona åtgärder bör du respektera Retry-After huvud tipsen. 
...
Mer information om hur du gör nya försök för andra tjänster i Azure finns i [vägledning för att försöka igen för vissa tjänster](/azure/architecture/best-practices/retry-service-specific)
