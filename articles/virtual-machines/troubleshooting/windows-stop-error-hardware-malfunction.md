---
title: Windows-stoppfel – maskin varu fel
...
ms.locfileid: "94663951"
---
# <a name="windows-stop-error---hardware-malfunction"></a>Windows-stoppfel – maskin varu fel
...
3. Konfigurera register nyckeln NMI med följande kommando:
    ...
    ```
    [Visa ytterligare information om kommandot REG ADD](https://docs.microsoft.com/windows-server/administration/windows-commands/reg-add)
...
5. *(Valfritt)* Konfigurera åtkomst till serie konsol:
    ...
    ```
    [Visa ytterligare information om BCDEDIT-kommandot](https://docs.microsoft.com/windows-server/administration/windows-commands/bcdedit)
6. Starta om den virtuella datorn med följande kommando:

    ```
    SHUTDOWN /r /t 0 /f 
    ```
    [Visa ytterligare information om kommandot SHUTDOWN](https://docs.microsoft.com/windows-server/administration/windows-commands/shutdown)
