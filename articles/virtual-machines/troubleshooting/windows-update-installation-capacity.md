...
I den här situationen kan operativ systemet (OS) inte slutföra en Windows Update (KB)-installation eftersom det inte går att skapa en kärn fil i fil systemet. Baserat på den här felkoden kan operativ systemet inte skriva några filer till disken.
