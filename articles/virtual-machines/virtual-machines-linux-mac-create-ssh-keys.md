...
Lösenord är som standard inaktiverade för virtuella datorer som skapas med SSH-nycklar för att göra råstyrkeattacker något dyrare och därför svåra. I det här avsnittet beskrivs hur du skapar en enkel SSH-nyckel för snabb användning. Om du behöver mer hjälp för att skapa SSH-nyckelpar eller om du behöver fler certifikat, till exempel för användning med den klassiska portalen, finns [detaljerade steg för att skapa SSH-nyckelpar och certifikat](virtual-machines-linux-create-ssh-keys-detailed.md).
...
* [Skapa en säker virtuell Linux-dator med hjälp av Azure CLI 2.0)](virtual-machines-linux-quick-create-cli.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
