...
| Azure CLI 2.0 (förhandsversion) | För att ange identifierare av den offentliga IP-adress som du skapade tidigare använder du [az network nic create](https://docs.microsoft.com/cli/azure/network/nic#create) med parametern **--public-ip-address**. |
...
| Azure CLI 2.0 (förhandsversion) | Du använder [az network public-ip create](https://docs.microsoft.com/cli/azure/network/public-ip#create) med parametern **--allocation-method** som dynamisk eller statisk. |
...
| Azure CLI 2.0 (förhandsversion) | Undernät och VNet skapas på samma gång. Ange en **--subnet-name**-parameter till [az network vnet create](https://docs.microsoft.com/cli/azure/network/vnet#create) med namnet på undernätet. |
