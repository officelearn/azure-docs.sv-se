...
Skapa en virtuell dator med [az vm create](/cli/azure/vm#az-vm-create). Om du vill använda den senaste versionen av avbildningen `--image` anger du ID för avbildnings definitionen. 
