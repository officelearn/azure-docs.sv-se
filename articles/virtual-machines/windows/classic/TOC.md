...
# Kom igång
## [Skapa en virtuell dator med hjälp av Azure Portal](tutorial-classic.md)
## [Logga in på en virtuell dator](connect-logon-classic.md)
...
### [Ansluta virtuella datorer med virtuella nätverk eller molntjänster](connect-vms-classic.md)

## Distribuera
### [Skapa en anpassad virtuell dator](createportal-classic.md)
### [Avbilda en virtuell Windows-dator](capture-image-classic.md)
...
### [Konfigurera en tillgänglighetsuppsättning](configure-availability-classic.md)
### [Ändra storlek på en Windows VM som skapats i den klassiska distributionsmodellen](resize-vm-classic.md)
