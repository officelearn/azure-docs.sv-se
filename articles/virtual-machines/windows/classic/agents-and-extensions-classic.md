---
title: Fönstret VM agent och tillägg i Azure | Microsoft Docs
description: Ger en översikt över agent och tillägg och hur du installerar agenten med hjälp av den klassiska distributionsmodellen på virtuella Windows-datorer.
...
ms.locfileid: "30917640"
---
# <a name="about-the-virtual-machine-agent-and-extensions-for-windows-vms"></a>Om den virtuella datorns agent och tillägg för virtuella Windows-datorer
