...
Använd den [Add-AzureVhd](https://docs.microsoft.com/powershell/module/azure/add-azurevhd) att överföra den virtuella Hårddisken.
...
Använd den [Lägg till AzureVMImage](https://docs.microsoft.com/powershell/module/azure/add-azurevmimage) för att lägga till bilden i listan över egna, anpassade avbildningar.
