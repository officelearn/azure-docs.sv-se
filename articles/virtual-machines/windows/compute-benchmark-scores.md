...
ms.locfileid: "64866286"
---
# <a name="compute-benchmark-scores-for-windows-vms"></a>Beräkna benchmark-poäng för virtuella Windows-datorer
Följande SPECInt benchmark-poäng visar prestanda för databearbetning för specifika Azure virtuella datorer som kör Windows Server. Compute benchmark-poäng kan också användas för [virtuella Linux-datorer](../linux/compute-benchmark-scores.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).


## <a name="av2---general-compute"></a>Av2 - allmänna beräkning
| Storlek | virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig grundpris | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
## <a name="b---burstable"></a>B - med burst
| Storlek | virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig grundpris | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
## <a name="dsv3---general-compute--premium-storage"></a>DSv3 - beräkning för Allmänt + Premiumlagring
| Storlek | virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig grundpris | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
## <a name="esv3---memory-optimized--premium-storage"></a>Esv3 - Minnesoptimerade + Premiumlagring
| Storlek | virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig grundpris | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
## <a name="eisv3---memory-opt--premium-storage-isolated"></a>Eisv3 - minne Opt + Premiumlagring (isolerad)
| Storlek | virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig grundpris | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
| Standard_E64is_v3 | 64 | 2 | Intel(R) Xeon(R) CPU E5-2673 v4 @ 2,30 GHz | 28 | 1073.9 | 5.7 | 

## <a name="ev3---memory-optimized"></a>Ev3 - optimerat minne
| Storlek | virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig grundpris | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
## <a name="eiv3---memory-optimized-isolated"></a>Eiv3 - optimerat minne (isolerad)
| Storlek | virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig grundpris | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
| Storlek | virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig grundpris | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
| Standard_F2s_v2 | 2 | 1 | Intel(R) Xeon(R) CPU Platinum 8168 @ 2,70 GHz | 46 | 56.5 | 2.4 | 
| Standard_F4s_v2 | 4 | 1 | Intel(R) Xeon(R) CPU Platinum 8168 @ 2,70 GHz | 60 | 110.2 | 4.7 | 
| Standard_F8s_v2 | 8 | 1 | Intel(R) Xeon(R) CPU Platinum 8168 @ 2,70 GHz | 36 | 215.2 | 5.3 | 
| Standard_F16s_v2 | 16 | 1 | Intel(R) Xeon(R) CPU Platinum 8168 @ 2,70 GHz | 36 | 409.3 | 15.5 | 
| Standard_F32s_v2 | 32 | 1 | Intel(R) Xeon(R) CPU Platinum 8168 @ 2,70 GHz | 31 | 760.9 | 16.9 | 
| Standard_F64s_v2 | 64 | 2 | Intel(R) Xeon(R) CPU Platinum 8168 @ 2,70 GHz | 33 | 1440.9 | 26.0 | 
| Standard_F72s_v2 | 72 | 2 | Intel(R) Xeon(R) CPU Platinum 8168 @ 2,70 GHz | 29 | 1372.1 | 8.2 | 

## <a name="fs---compute-and-storage-optimized"></a>FS - beräknings- och Lagringsoptimerade
| Storlek | virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig grundpris | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
## <a name="f---compute-optimized"></a>F - beräkningsoptimerad
| Storlek | virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig grundpris | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
## <a name="gs---storage-optimized"></a>GS - optimerad lagring
| Storlek | virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig grundpris | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
## <a name="g---compute-optimized"></a>G - beräkningsoptimerad
| Storlek | virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig grundpris | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
## <a name="h---high-performance-compute-hpc"></a>H - databehandling med höga prestanda (HPC)
| Storlek | virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig grundpris | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
## <a name="ls---storage-optimized"></a>Ls - lagringsoptimerade
| Storlek | virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig grundpris | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
## <a name="ncsv3---gpu-enabled"></a>NCSv3 - Grafikprocessoraktiverad
| Storlek | virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig grundpris | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
## <a name="ncsv2---gpu-enabled"></a>NCSv2 - Grafikprocessoraktiverad
| Storlek | virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig grundpris | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
## <a name="nc---gpu-enabled"></a>NC - Grafikprocessoraktiverad
| Storlek | virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig grundpris | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
## <a name="nds--gpu-enabled"></a>NDs - Grafikprocessoraktiverade
| Storlek | virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig grundpris | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
## <a name="nv---gpu-enabled"></a>NV - Grafikprocessoraktiverad
| Storlek | virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig grundpris | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
