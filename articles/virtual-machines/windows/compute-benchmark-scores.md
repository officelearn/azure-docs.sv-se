---
title: Beräkna benchmark-resultat för virtuella Windows-datorer i Azure | Microsoft Docs
...
| Size | Virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig bas taxa | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
