---
title: Beräkna benchmark-poäng för virtuella Azure Windows-datorer
description: Jämför SPECint-beräkningsriktmärken för virtuella Azure-datorer som kör Windows Server.
author: cynthn
...
ms.locfileid: "82086240"
---
# <a name="compute-benchmark-scores-for-windows-vms"></a>Beräkna benchmark-poäng för virtuella Windows-datorer
Följande REFERENSPOÄNG för SPECInt visar beräkningsprestanda för utvalda Virtuella Azure-datorer som kör Windows Server. Beräkningsriktmärken är också tillgängliga för [virtuella Linux-datorer.](../linux/compute-benchmark-scores.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)


## <a name="av2---general-compute"></a>Av2 - Allmän beräkning
| Storlek | Virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig basränta | StdDev (på samma sätt som) | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
Obs: Av2-serien virtuella datorer kan distribueras på en mängd olika maskinvarutyper och processorer (som visas ovan). Virtuella datorer i Av2-serien har processorprestanda och minneskonfigurationer som är bäst lämpade för arbetsbelastningar på ingångsnivå som utveckling och test. Storleken begränsas för att erbjuda relativt konsekvent processorprestanda för den löpinstansen, oavsett vilken maskinvara den distribueras på. Programvara som drar nytta av specifika nyare processoroptimeringar kan dock se större variation mellan processortyper.

## <a name="b---burstable"></a>B - Sprängbar
| Storlek | Virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig basränta | StdDev (på samma sätt som) | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
Virtuella datorer i B-serien är för arbetsbelastningar med burstable prestandakrav. VM-instanser ackumulerar krediter när du använder mindre än baslinjen. När den virtuella datorn har ackumulerat kredit kan den virtuella datorn brista ovanför baslinjen med upp till 100% för att uppfylla korta CPU-burst-krav. Burst-tiden beror på tillgängliga krediter som är en funktion av VM-storlek och tid.  

SPEC Int är en ganska lång kör test som vanligtvis avgaser tillgängliga burst krediter.  Därför är talen ovan närmare den virtuella datorns baslinjeprestanda (även om de kan återspegla en viss burst-tid som ackumulerats mellan körningar).  För korta, bursty, arbetsbelastningar (typiskt på B-serien) prestanda kommer vanligtvis att vara närmare Ds v3-serien..

## <a name="dsv3---general-compute--premium-storage"></a>DSv3 - Allmän beräkning + Premium-lagring
| Storlek | Virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig basränta | StdDev (på samma sätt som) | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
## <a name="dsv2---storage-optimized"></a>DSv2 - Lagring optimerad
| Storlek | Virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig basränta | StdDev (på samma sätt som) | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
## <a name="esv3---memory-optimized--premium-storage"></a>Esv3 - Minnesoptimerad + Premium-lagring
| Storlek | Virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig basränta | StdDev (på samma sätt som) | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
## <a name="eisv3---memory-opt--premium-storage-isolated"></a>Eisv3 - Minne Opt + Premium Storage (isolerad)
| Storlek | Virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig basränta | StdDev (på samma sätt som) | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
| Standard_E64is_v3 | 64 | 2 | Intel(R) Xeon(R) CPU E5-2673 v4 @ 2,30 GHz | 28 | 1073.9 | 5.7 | 

## <a name="ev3---memory-optimized"></a>Ev3 - Minnesoptimerat
| Storlek | Virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig basränta | StdDev (på samma sätt som) | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
## <a name="eiv3---memory-optimized-isolated"></a>Eiv3 - Minnesoptimerad (isolerad)
| Storlek | Virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig basränta | StdDev (på samma sätt som) | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
| Standard_E64i_v3 | 64 | 2 | Intel(R) Xeon(R) CPU E5-2673 v4 @ 2,30 GHz | 28 | 1081.4 | 11.1 | 

## <a name="fsv2---compute--storage-optimized"></a>Fsv2 - Beräkna + lagring optimerad
| Storlek | Virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig basränta | StdDev (på samma sätt som) | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
## <a name="f---compute-optimized"></a>F - Beräkna optimerad
| Storlek | Virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig basränta | StdDev (på samma sätt som) | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
## <a name="g---compute-optimized"></a>G - Beräkna optimerad
| Storlek | Virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig basränta | StdDev (på samma sätt som) | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
## <a name="h---high-performance-compute-hpc"></a>H - Hög prestanda Beräkning (HPC)
| Storlek | Virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig basränta | StdDev (på samma sätt som) | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
## <a name="ls---storage-optimized"></a>Ls - Lagring Optimerad
| Storlek | Virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig basränta | StdDev (på samma sätt som) | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
## <a name="m---memory-optimized"></a>M - Minnesoptimerat
| Storlek | Virtuella processorer | NUMA-noder | Processor | Körningar | Genomsnittlig basränta | StdDev (på samma sätt som) | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
Windows-nummer beräknades genom att köra [SPECint 2006](https://www.spec.org/cpu2006/results/rint2006.html) på Windows Server. SPECint kördes med basräntealternativet (SPECint_rate2006), med en kopia per vCPU. SPECint består av 12 separata tester, varje körning tre gånger, med medianvärdet från varje test och viktning dem att bilda en sammansatt poäng. Dessa tester kördes sedan över flera virtuella datorer för att ge de genomsnittliga poängen som visas.

## <a name="next-steps"></a>Nästa steg
* För lagringskapacitet, diskinformation och ytterligare överväganden för att välja mellan vm-storlekar finns i [Storlekar för virtuella datorer](sizes.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
