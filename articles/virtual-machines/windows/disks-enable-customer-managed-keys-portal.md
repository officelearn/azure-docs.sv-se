---
title: Använd Azure Portal för att aktivera Kundhanterade nycklar med SSE-hanterade diskar
description: Använd Azure Portal för att aktivera kryptering på Server sidan med Kundhanterade nycklar på dina hanterade diskar.
author: roygara
ms.date: 07/10/2020
ms.topic: how-to
ms.author: rogarana
