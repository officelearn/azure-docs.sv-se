...
Den `Set-AzVMDiagnosticsExtension` kommando kan användas för att lägga till Azure-diagnostiktillägget i en befintlig virtuell dator. Se även [Använd PowerShell för att aktivera Azure Diagnostics i en virtuell dator med Windows](ps-extensions-diagnostics.md).
