...
Följ stegen i den här artikeln för att distribuera en [Microsoft HPC Pack 2016](https://technet.microsoft.com/library/cc514029) kluster i Azure-datorer. HPC Pack är Microsofts ledigt HPC-lösning baserat på Microsoft Azure och Windows Server-teknik och stöder en bred HPC-arbetsbelastning.

Använd någon av de [Azure Resource Manager-mallar](https://github.com/MsHpcPack/HPCPack2016) att distribuera HPC Pack 2016-klustret. Du har flera val av klustertopologi med olika antal head klusternoder och antingen Linux eller Windows compute-noder.
...
Innan du distribuerar HPC-kluster, överför certifikatet till en [Azure key vault](../../key-vault/index.md) som en hemlighet och registrera följande information för användning under distributionen: **valvnamnet**, **valvet resursgruppen**, **Certifikatwebbadress**, och **certifikattumavtrycket**.

En PowerShell-exempelskript för att ladda upp certifikatet följer. Mer information om hur du överför ett certifikat till ett Azure key vault finns [Kom igång med Azure Key Vault](../../key-vault/key-vault-get-started.md).
...
Välj något av de [Azure Resource Manager-mallar](https://github.com/MsHpcPack/HPCPack2016) att distribuera HPC Pack 2016-klustret. Följande är med tre topologier som stöds för klustret. Hög tillgänglighet topologier innehåller flera head klusternoder.
...
Den **prenumeration** och **plats** måste vara samma som du angav när du har överfört PFX-certifikat (se krav). Vi rekommenderar att du skapar en **resursgruppen** för distributionen.
...
Klicka på **Granska juridiska villkor** att granska villkoren. Om du godkänner villkoren klickar du på **inköp**, och klicka sedan på **skapa** att starta distributionen.
...
2. Klicka på en huvudnod (i ett kluster med hög tillgänglighet, klicka på någon av huvudnoderna). I **Essentials**, du kan hitta den offentliga IP-adress eller fullständigt DNS-namn för klustret.
