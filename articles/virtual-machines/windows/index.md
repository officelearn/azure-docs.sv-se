---
title: "Dokumentation om virtuella Windows-datorer i Azure – Självstudier, API Reference | Microsoft Docs"
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/compute">Compute REST API-referens</a></p>
                    </div>
                </div>
            </div>
        </div>
