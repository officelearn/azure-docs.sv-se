...
description: Lär dig hur du migrerar dina virtuella dator diskar från ett standard lagrings konto till ett Premium Storage-konto med hjälp av Azure Site Recovery.
author: luywang
...
2. Välj **skapa en resurs**  >  **hanterings**  >  **backup och Site Recovery (OMS)**. Alternativt kan du välja **Bläddra**  >  **Recovery Services valv**  >  **Lägg till**.
   >[!NOTE]
   >Säkerhets kopiering och Site Recovery var tidigare en del av [OMS-sviten](../../azure-monitor/terminology.md#april-2018---retirement-of-operations-management-suite-brand).
