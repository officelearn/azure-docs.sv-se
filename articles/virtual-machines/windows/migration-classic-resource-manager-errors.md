...
description: I den här artikeln katalogiseras de vanligaste felen och mildrande åtgärder under migreringen av IaaS-resurser från Azure Service Management till Azure Resource Manager-stacken.
