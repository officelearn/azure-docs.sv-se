...
| [Azure PowerShell](../../virtual-network/virtual-network-deploy-multinic-arm-ps.md) | Använd [New-AzureRmNetworkInterface](/powershell/module/azurerm.network/new-azurermnetworkinterface) med parametern **-PublicIpAddressId** för att ange identifierare av den offentliga IP-adress som du skapade tidigare. |
...
| [Azure PowerShell](../../virtual-network/virtual-network-deploy-static-pip-arm-ps.md) | Du använder [New-AzureRmPublicIpAddress](/powershell/module/azurerm.network/new-azurermpublicipaddress) med parametern **- AllocationMethod** som dynamisk eller statisk. |
