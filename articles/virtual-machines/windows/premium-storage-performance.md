---
title: 'Azure Premium Storage: Design för prestanda på virtuella Windows-datorer | Microsoft-dokument'
...
* [Metodtips för prestanda för SQL Server i virtuella Azure-datorer](sql/virtual-machines-windows-sql-performance.md)
