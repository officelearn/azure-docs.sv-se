...
Du kan använda den [Get-AzureRmVMUsage](/powershell/module/azurerm.compute/get-azurermvmusage) cmdlet för att kontrollera din för kvotanvändning.
