...
description: Det här avsnittet beskriver hur du kör skript i en Windows-dator
services: automation
...
Den [tillägget för anpassat skript](../extensions/custom-script-windows.md) används främst för efter distribution konfigurations- och installationen.
