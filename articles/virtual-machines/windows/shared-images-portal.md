---
title: Skapa delade virtuella Azure-dator avbildningar för Windows med hjälp av portalen | Microsoft Docs
...
> [!IMPORTANT]
> Du kan inte använda portalen för att distribuera en virtuell dator från en avbildning i en annan Azure-klient. Om du vill skapa en virtuell dator från en avbildning som delas mellan klienter, måste du använda [Azure CLI](../linux/shared-images.md#create-a-vm) eller [PowerShell](shared-images.md#create-vms-from-an-image).
