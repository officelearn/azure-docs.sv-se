---
title: Storlekar på windows vm i Azure
...
- Information om prissättning av de olika storlekarna finns i [Prissättning för virtuella datorer](https://azure.microsoft.com/pricing/details/virtual-machines/#Windows).
...
- Lagringskostnaderna beräknas separat baserat på använda sidor i lagringskontot. Mer information finns [i Azure Storage Pricing](https://azure.microsoft.com/pricing/details/storage/).
...
Läs mer om beräkningsprestanda för virtuella Windows-datorer med hjälp av [CoreMarks benchmarkpoäng](compute-benchmark-scores.md).
