...
8. På sidan **Välj inledande data synkronisering** väljer du **fullständig** och anger en delad nätverks plats. För platsen använder du den [säkerhets kopierings resurs som du skapade](#backupshare). I exemplet var ** \\ \\ \<det första SQL Server\>\ säkerhets kopiering\\**. Klicka på **Nästa**.
...
1. Konfigurera följande parametrar för belastningsutjämnaren.
   ...
   ![Skapa Load Balancer](./media/virtual-machines-windows-portal-sql-availability-group-tutorial/84-createloadbalancer.png)
