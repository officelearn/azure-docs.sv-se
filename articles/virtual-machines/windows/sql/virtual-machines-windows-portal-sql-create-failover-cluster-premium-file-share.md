...
1. Ta med alla tester förutom **lagring** och **Lagringsdirigering**vid **Val av test**. Se följande bild:
   ...
   :::image type="content" source="media/virtual-machines-windows-portal-sql-create-failover-cluster-premium-file-share/cluster-validation.png" alt-text="Kluster verifierings test":::
