...
> [!NOTE]
> Du kan lägga till fler begränsningar för nätverkskommunikationen till den virtuella datorn med SQL Server. Du kan lägga till fler begränsningar genom att redigera nätverkssäkerhetsgruppen när den virtuella datorn har skapats. Mer information finns i [Vad är en nätverkssäkerhetsgrupp?](../../../virtual-network/virtual-networks-nsg.md)
> 
> 
...
Aktivera [SQL Server R Services](https://msdn.microsoft.com/library/mt604845.aspx). SQL Server R-tjänsten ger dig möjlighet att använda avancerad analys med SQL Server 2016. Klicka på **Aktivera** på bladet **SQL Server-inställningar**.
