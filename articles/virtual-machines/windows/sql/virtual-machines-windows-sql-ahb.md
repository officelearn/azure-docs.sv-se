...
1. Välj den **Azure Hybrid-förmånen** alternativet och bekräfta att du har en SQL Server-licens med Software Assurance. 
...
Registrera SQL Server VM med Azure CLI med den nedan kodfragmentet: 
