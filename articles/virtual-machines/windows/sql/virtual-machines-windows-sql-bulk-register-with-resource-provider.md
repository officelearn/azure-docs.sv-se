...
Den här artikeln beskriver hur du kan registrera din SQL Server virtuella dator (VM) i Azure med den virtuella SQL-SqlVMs med PowerShell-cmdleten "register-".

Cmdleten "register-SqlVMs" kan användas för att registrera alla virtuella datorer i en specifik lista med prenumerationer, resurs grupper eller en lista med virtuella datorer. Cmdleten registrerar de virtuella datorerna i läget för _förenklad_ hantering och genererar sedan både en [rapport och en loggfil](#output-description). 
