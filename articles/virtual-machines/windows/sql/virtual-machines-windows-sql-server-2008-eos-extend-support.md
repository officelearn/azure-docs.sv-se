...
- **SQL Server-säkerhetskopieringar**: SQL Server-säkerhetskopieringar kan användas för att återställa SQL Server vid regionala eller zon fel. Eftersom hanterade säkerhetskopieringsfunktionen inte stöds för EOS SQL Server, måste kunderna att göra säkerhetskopior manuellt.
