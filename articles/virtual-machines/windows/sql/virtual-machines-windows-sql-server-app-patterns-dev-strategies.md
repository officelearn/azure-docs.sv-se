...
Läs mer om att välja mellan metoderna programming [Azure Web Apps, Cloud Services och virtuella datorer: När du ska använda som](/azure/architecture/guide/technology-choices/compute-decision-tree).
