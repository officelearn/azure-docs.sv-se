...
|-----|-----|
| **Kostnadsbesparingar** | [Azure Hybrid-förmån](https://azure.microsoft.com/pricing/hybrid-benefit/) erbjuder upp till 55% besparingar. Mer information finns i [switch Licensing Model](virtual-machines-windows-sql-ahb.md) |
