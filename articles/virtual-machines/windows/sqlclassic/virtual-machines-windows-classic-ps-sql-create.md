---
title: Skapa en SQL Server virtuell dator i Azure PowerShell (klassisk) | Microsoft Docs
...
2. [Hämta och installera de senaste Azure PowerShell](/powershell/azure/overview)-kommandona.
