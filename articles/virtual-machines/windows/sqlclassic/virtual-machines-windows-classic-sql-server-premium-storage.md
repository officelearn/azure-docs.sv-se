...
Ökad IOPS uppnås med större storlekar för diskar. Du bör överväga när du funderar på sökvägen för migreringen. Mer information [finns i tabellen för IOPS och disktyper](../../../storage/common/storage-premium-storage.md#scalability-and-performance-targets).
