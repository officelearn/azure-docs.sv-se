...
* **Microsoft.ReportViewer.WebForms.dll**: innehåller ReportViewer-koden som du behöver använda ReportViewer på din sida. Referens för den här sammansättningen har lagts till ditt projekt när du släpper en kontroll för ReportViewer på en ASP.NET-sida i projektet.
