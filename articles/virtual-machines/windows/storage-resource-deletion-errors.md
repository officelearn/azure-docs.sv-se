---
title: Felsöka lagring resurs tas bort i en Azure Resource Manager distribution på virtuella Windows-datorer | Microsoft Docs
...
Virtuella hårddiskar som används i Azure Virtual Machines är VHD-filer som lagras som sidblobbar i en standard- eller premium storage-konto i Azure. Läs mer om Azure-diskarna [om ohanterade och hanterade disklagring för virtuella datorer i Microsoft Azure Windows](about-disks-and-vhds.md). 
