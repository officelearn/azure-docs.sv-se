---
title: Tidssynkronisering för virtuella Windows-datorer i Azure | Microsoft Docs
...
## <a name="check-your-configuration"></a>Kontrol lera konfigurationen
...
- [Verktyg och inställningar för Windows tids tjänst](https://docs.microsoft.com/windows-server/networking/windows-time-service/Windows-Time-Service-Tools-and-Settings)
