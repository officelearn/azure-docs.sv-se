---
title: Felsöka Windows VM programåtkomst i Azure | Microsoft Docs
description: Följ stegen för detaljerad felsökning för att identifiera problem vid anslutning till program som körs på Windows-datorer i Azure.
