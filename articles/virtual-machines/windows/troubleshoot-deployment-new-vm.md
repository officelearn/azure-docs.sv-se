...
Andra problem med VM-distribution och frågor finns i [felsöka distribuera Windows VM-problem i Azure](troubleshoot-deploy-vm.md).
...
Lös båda de här felen genom att ta bort den nuvarande avbildningen från portalen och [avbilda från de aktuella virtuella hårddiskarna](create-vm-specialized.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json) med samma inställning som för Operativsystemet (generaliserad/specialiserade).
