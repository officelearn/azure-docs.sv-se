...
| Mätar-ID           | Identifierar den översta tjänst som denna användning tillhör.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | “Virtual Machines”                                                                                                                                                                                                                                                                                                                                               |
...
Fältet typ av tjänst i fältet ytterligare information motsvarar den exakta VM-storlek som du har distribuerat. Virtuella datorer i Premium Storage (SSD-baserade) och icke-Premium-virtuella datorer (HDD-baserade) är i samma pris. Om du distribuerar en SSD-baserad storlek, som standard\_DS2\_v2, ser du storlek (standard\_D2\_v2 VM) i kolumnen mätar under kategori och SSD-storlek (standard\_DS2\_v2) i fältet ytterligare information.
