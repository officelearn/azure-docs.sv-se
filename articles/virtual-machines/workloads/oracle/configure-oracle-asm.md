...
2. I dialog rutan **Konfigurera ASM: disk grupper** klickar du `Create` på knappen och sedan på. `Show Advanced Options`
...
4. I dialog rutan **Konfigurera ASM: disk grupper** klickar du `Create` på knappen och sedan på. `Show Advanced Options`
