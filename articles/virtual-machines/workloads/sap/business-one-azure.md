...
| Antal användare | vCPU:er | Minne | Exempel på VM-typer |
| --- | --- | --- | --- |
...
För konfigurationer med hög tillgänglighet och haveri beredskap runt SAP HANA som databas för företag en i Azure bör du läsa dokumentationen [SAP HANA hög tillgänglighet för virtuella Azure-datorer](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/sap-hana-availability-overview) och dokumentationen som pekas från dokumentet .
