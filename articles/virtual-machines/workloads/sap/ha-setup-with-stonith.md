...
Förväntat värde = antal distribuerade noder (i det här fallet 2) ![yast-Cluster-Security. png ](media/HowToHLI/HASetupWithStonith/yast-Cluster-Security.png) Klicka på **nästa** 
