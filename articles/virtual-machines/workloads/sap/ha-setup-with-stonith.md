...
crm_mon
```
![CRM-Mon. png](media/HowToHLI/HASetupWithStonith/crm-mon.png) du kan också logga in på Hawk för att kontrol lera kluster status *https://\<nod-IP >: 7630*. Standard användaren är hacluster och lösen ordet är Linux. Om det behövs kan du ändra lösen ordet med hjälp av kommandot *passwd* .
