...
| --- | --- | --- | --- | --- |
| Optimerat för OLAP: SAP BW, BW/4HANA<br /> eller SAP HANA för generisk OLAP-arbetsbelastning | SAP HANA på Azure S72<br /> – 2 x Intel® Xeon® Processor E7-8890 v3<br /> 36 processorkärnor och 72 CPU-trådar |  768 GB |  3 TB | Erbjuds inte längre |
...
| Optimerat för OLTP: SAP Business Suite<br /> på SAP HANA eller S/4HANA (OLTP)<br /> generic OLTP | SAP HANA på Azure S72m<br /> – 2 x Intel® Xeon® Processor E7-8890 v3<br /> 36 processorkärnor och 72 CPU-trådar |  1,5 TB |  6 TB | Erbjuds inte längre |
...
- **Storage**: Isolering via storage virtuella datorer som har lagringsvolymer tilldelas och isolera lagringsvolymer mellan klienter.
- **Compute**: Dedikerad tilldelningen av server-enheter till en enda klient. Inte hårt eller mjuk partitionering av server-enheter. Ingen delning av en enda enhet för servern eller värden mellan klienter. 
