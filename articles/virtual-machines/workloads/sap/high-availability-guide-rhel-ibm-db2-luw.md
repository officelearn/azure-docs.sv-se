...
>](./media/high-availability-guide-rhel-ibm-db2-luw/hadr-swpm-db2-port.png) för ![SAP SWPM-port definition
...
1. I den högra rutan väljer du nyckel `jdbc/pool/\<SAPSID>/url`.
