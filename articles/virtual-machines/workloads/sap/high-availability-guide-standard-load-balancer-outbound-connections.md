---
title: Offentlig slut punkts anslutning för Virtual Machines med Azure Standard Load Balancer i SAP-scenarier med hög tillgänglighet
...
5. Skapa väg till Azure-brandvägg  
   ...
   Brand Väggs regeln skulle se ut så här: ![utgående anslutning med Azure Firewall](./media/high-availability-guide-standard-load-balancer/high-availability-guide-standard-load-balancer-firewall-rule.png)
...
### <a name="important-considerations"></a>Viktiga överväganden
  ...
  - Se till att proxykonfigurationen tillåter utgående anslutning till Azure Management API: https://management.azure.com  
