...
På Azure bör du vara medveten om det faktum att funktionen för ögonblicks bilder av&#39;Azure-Blob gör att fil systemets konsekvens över flera diskar (se [använda BLOB-ögonblicksbilder med PowerShell](https://blogs.msdn.microsoft.com/cie/2016/05/17/using-blob-snapshots-with-powershell/)). 
...
1. Lås fil systemen för alla diskar/volymer (Använd till exempel **xfs\_frysa**)
