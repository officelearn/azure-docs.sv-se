...
Den tid som ägnats åt nätverket att skicka en sådan fråga från program nivån till databas nivån och ta emot resultat uppsättningen tillbaka har en stor inverkan på den tid det tar att köra affärs processer. Den här känsligheten för nätverks fördröjning är varför du måste uppnå optimal nätverks fördröjning i SAP-distributions projekt. Se [SAP Obs! #1100926 – vanliga frågor och svar: Nätverks prestanda @ no__t-0 för rikt linjer för hur du klassificerar nätverks fördröjningen.
...
- Den första virtuella Azure-datorn som distribuerats i data centret. Du kan tänka på den första virtuella datorn som en "virtuell dator" som har distribuerats i ett Data Center baserat på Azure Allocation-algoritmer som slutligen kombineras med användar definitioner för en speciell tillgänglighets zon.
...
- Att du behöver en VM-typ som inte kan köras i det angivna data centret där närhets placerings gruppen var fäst.
