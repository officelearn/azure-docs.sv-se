...
Innan du slutfört alla steg i den här självstudiekursen, logga in på Azure-portalen på https://portal.azure.com. Om du inte har en Azure-prenumeration kan du skapa ett [kostnadsfritt konto](https://azure.microsoft.com/free/?WT.mc_id=A261C142F) innan du börjar.
...
3. Välj **Skapa**.
4. Ange eller välj egna värden eller ange eller Välj följande exempelvärden och välj sedan **skapa**:
