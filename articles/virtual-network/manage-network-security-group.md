---
title: Skapa, ändra eller ta bort en säkerhetsgrupp i Azure-nätverk | Microsoft Docs
...
2. I den **Sök på Marketplace** anger *programsäkerhetsgruppen*. När **programsäkerhetsgruppen** visas i sökresultatet väljer den, väljer **programsäkerhetsgruppen** igen under **allt**, och välj sedan **Skapa**.
3. Välj eller ange följande information och välj **Skapa**:

    | Inställning        | Värde                                                   |
    | ---            | ---                                                     |
    | Namn           | Namnet måste vara unika inom en resursgrupp.        |
...
- PowerShell: [Get-azurermapplicationsecuritygroup har till](/powershell/module/azurerm.network/get-azurermapplicationsecuritygroup)
...
- PowerShell: [Remove-azurermapplicationsecuritygroup har till](/powershell/module/azurerm.network/remove-azurermapplicationsecuritygroup)
