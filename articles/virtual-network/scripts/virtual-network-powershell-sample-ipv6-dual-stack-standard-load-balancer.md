---
title: Exempel på Azure PowerShell-skript – Konfigurera IPv6-klientdel med standardbelastningsutjämning(förhandsgranskning)
...
ms.locfileid: "77201330"
---
# <a name="configure-ipv6-frontend-in-virtual-network-script-sample-with-standard-load-balancerpreview"></a>Konfigurera IPv6-klientdel i exempel på virtuellt nätverksskript med standardbelastningsutjämning(förhandsgranskning)
