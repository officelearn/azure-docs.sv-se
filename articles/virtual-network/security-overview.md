...
* **MicrosoftContainerRegistry** (endast Resource Manager): den här taggen anger adressprefix för Microsoft Container Registry-tjänsten. Om du anger *MicrosoftContainerRegistry* som värde så tillåts eller nekas trafik till MicrosoftContainerRegistry. Om du bara vill ge åtkomst till MicrosoftContainerRegistry i en specifik [region](https://azure.microsoft.com/regions) så kan du ange regionen i följande format: MicrosoftContainerRegistry.[regionsnamn]. 
* **AzureContainerRegistry** (endast Resource Manager): den här taggen anger adressprefix för Azure Container Registry-tjänsten. Om du anger *AzureContainerRegistry* som värde så tillåts eller nekas trafik till AzureContainerRegistry. Om du bara vill ge åtkomst till AzureContainerRegistry i en specifik [region](https://azure.microsoft.com/regions) så kan du ange regionen i följande format: AzureContainerRegistry.[regionsnamn]. 
