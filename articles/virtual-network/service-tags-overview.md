...
| **DataFactory**  | Azure Data Factory | Utgående | Nej | Nej |
| **DataFactoryManagement** | Hanterings trafik för Azure Data Factory. | Inkommande | Nej | Nej |
...
| **WindowsVirtualDesktop** | Virtuellt Windows-skrivbord. | Båda | Nej | Nej |
