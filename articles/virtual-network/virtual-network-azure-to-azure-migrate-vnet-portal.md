...
12. Du kan också ändra andra parametrar i mallen om du väljer, och de är valfria beroende på dina krav:
    ...
    * **Adress utrymme** – det virtuella nätverkets adress utrymme kan ändras i mallen innan du sparar genom att ändra avsnittet **Resources** > **addressSpace** och ändra egenskapen **addressPrefixes** i **mallen. JSON** fil:
