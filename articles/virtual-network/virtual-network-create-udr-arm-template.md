---
title: Kontrollera Routning och virtuella installationer i Azure - mall | Microsoft Docs
description: Lär dig hur du styr Routning och virtuella installationer med en Azure Resource Manager-mall.
...
> [!IMPORTANT]
> Innan du börjar arbeta med Azure-resurser är det viktigt att du vet att Azure för närvarande har två distributionsmodeller: Azure Resource Manager och klassisk. Se till att du förstår [distributionsmodeller och verktyg](../azure-resource-manager/resource-manager-deployment-model.md) innan du börjar arbeta med Azure-resurser. Du kan granska dokumentationen för olika verktyg genom att klicka på flikarna överst i den här artikeln. Den här artikeln beskriver Resource Manager-distributionsmodellen. 

[!INCLUDE [virtual-network-create-udr-scenario-include.md](../../includes/virtual-network-create-udr-scenario-include.md)]

## <a name="udr-resources-in-a-template-file"></a>UDR resurser i en mallfil
Du kan visa och ladda ned den [exempelmall](https://github.com/telmosampaio/azure-templates/tree/master/IaaS-NSG-UDR).

I följande avsnitt beskrivs definitionen av frontend UDR i den **azuredeploy-vnet-nsg-udr.json** filen för scenariot:
...
Om du vill associera UDR frontend-undernät som du behöver ändra definitionen för undernätet i mallen och använda referens-id för UDR.
...
3. Kör följande kommando för att distribuera mallen:
...
5. Kör följande kommando för att visa de resurser som skapats i den nya resursgruppen:
