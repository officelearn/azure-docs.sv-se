...
1. I [Azure Portal](https://portal.azure.com) klickar du på **Skapa en resurs** > **Compute** > **Windows Server 2016 Datacenter**.
2. Klicka på **Skapa**.
...
1. I [Azure Portal](https://portal.azure.com) klickar du på **Alla tjänster**.
2. Skriv *Resursgrupper* i rutan som innehåller ordet *Filter*. Klicka på **Resursgrupper** när du ser det i den filtrerade listan.
