...
4. I den **skapa nätverksgränssnittet** bladet som visas anger, eller Välj värden för följande inställningar och sedan klickar du på **skapa**:
    ...
    |Privata IP-adresstilldelning|Ja| I den här inställningen väljer du tilldelningsmetod för IPv4-adress. Välj bland följande tilldelning: **dynamiska:** när du väljer det här alternativet kan tilldelas en tillgänglig adress Azure automatiskt från adressutrymmet till undernätet som du har valt. Azure kan tilldela en annan adress till ett nätverksgränssnitt när den virtuella datorn den startas efter att ha varit i tillståndet Stoppad (frigjord). Adressen förblir detsamma om den virtuella datorn har startats om utan att ha varit i tillståndet Stoppad (frigjord). **Statiskt:** när du väljer det här alternativet måste du manuellt tilldelar en tillgänglig IP-adress inom adressutrymmet för det undernät som du har valt. Statiska adresser ändras inte tills du ändrar dem eller nätverksgränssnittet har tagits bort. Du kan ändra metoden tilldelning när nätverksgränssnittet har skapats. Azure DHCP-servern tilldelar den här adressen till nätverksgränssnittet i operativsystemet för den virtuella datorn.|
