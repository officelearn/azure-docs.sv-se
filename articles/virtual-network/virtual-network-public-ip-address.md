...
4. Ange eller välj värden för följande inställningar under **skapa offentlig IP-adress**och välj sedan **skapa**:
   ...
   |Location|Ja|Måste finnas på samma [plats](https://azure.microsoft.com/regions), även kallat region, som den resurs som du ska koppla den offentliga IP-adressen till.|
