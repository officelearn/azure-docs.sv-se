...
Åtkomst till resursen nekas och du får ett `New-PSDrive : Access is denied` fel. Åtkomst nekas eftersom lagrings kontots *notallowedaccount* inte finns i listan över tillåtna resurser i tjänstens slut punkts princip. 
