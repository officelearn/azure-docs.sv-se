...
Den här funktionen är tillgänglig för följande Azure-tjänster och-regioner. *Microsoft.\** -resursen finns i parentes. Aktivera den här resursen från under näts sidan när du konfigurerar tjänstens slut punkter för tjänsten:
...
- **[Azure Key Vault](../key-vault/key-vault-overview-vnet-service-endpoints.md)** (*Microsoft. nyckel valv*): allmänt tillgänglig i alla Azure-regioner.
...
- **[Azure App Service](https://docs.microsoft.com/azure/app-service/app-service-ip-restrictions)** : är allmänt tillgängliga i alla Azure-regioner där App Service är tillgängligt.
