---
title: "Skapa ett virtuellt nätverk med en ARM-mall | Microsoft Docs"
...
---
# <a name="create-a-virtual-network-by-using-an-arm-template"></a>Skapa ett virtuellt nätverk med en ARM-mall
...
Det här dokumentet går igenom hur man skapar ett VNet med hjälp av Resource Manager-distributionsmodellen. Du kan också [skapa ett virtuellt nätverk i den klassiska distributionsmodellen](virtual-networks-create-vnet-classic-pportal.md).
