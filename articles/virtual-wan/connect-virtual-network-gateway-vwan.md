---
title: Ansluta en virtuell nätverksgateway till ett virtuellt Azure-WAN | Microsoft Docs
...
## <a name="vnetgw"></a>1. skapa en virtuell Azure-nätverksgateway
...
### <a name="active-active"></a>Inställningen aktiv-aktiv läge

![aktiv-aktiv](./media/connect-virtual-network-gateway-vwan/active.png "aktiv-aktiv")

### <a name="BGP"></a>BGP-inställning
...
### <a name="pip"></a>Offentliga IP-adresser
...
## <a name="vwansite"></a>2. skapa virtuella WAN VPN-platser
...
## <a name="downloadconfig"></a>3. Hämta filerna för VPN-konfigurationen
...
## <a name="createlocalgateways"></a>4. skapa lokala nätverksgateway
...
## <a name="createlocalgateways"></a>5. skapa anslutningar
...
## <a name="test"></a>6. testa anslutningar
