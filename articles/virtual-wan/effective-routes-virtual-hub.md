...
## <a name="understand"></a>Förstå vägar
...
![Venndiagram](./media/effective-routes-virtual-hub/diagram.png)

## <a name="view"></a>Visa effektiva vägar
...
### <a name="routetable"></a>Hubb väg tabell
...
### <a name="abouthubroute"></a>Om Hub Route-tabellen
...
### <a name="aboutdefaultroute"></a>Om standard väg (0.0.0.0/0)
