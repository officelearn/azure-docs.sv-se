...
**figur: contoso befintlig nätverkstopologi**
...
## <a name="architecture"></a>Azure Virtual WAN-arkitektur
...
![Contosos virtuella WAN-arkitektur](./media/migrate-from-hub-spoke-topology/vwan-architecture.png)
...
### <a name="step-1-vdc-hub-and-spoke-single-region"></a>Steg 1: VDC Hub-och-eker-enkel region

Granska arkitekturen. Följande bild visar en topologi för en enda region för Contoso innan du inför distributionen av Azure Virtual WAN:

![topologi för en enda region](./media/migrate-from-hub-spoke-topology/figure1.png)
**figur 1: VDC Hub-och-eker-enkel region**

I och med VDC-metoden (Virtual Data Center) innehåller det virtuella kund hanterade Hubbs nätverket flera funktions block:
...
![distribuera virtuella WAN-hubbar](./media/migrate-from-hub-spoke-topology/figure2.png)
**bild 2: VDC hubb-och-eker till virtuell WAN-migrering**
...
![ansluta fjärranslutna platser till ett virtuellt WAN-](./media/migrate-from-hub-spoke-topology/figure3.png)
**bild 3: VDC Hub-och-eker till virtuell WAN-migrering**

I det här läget börjar den lokala nätverks utrustningen ta emot vägar som motsvarar IP-adressutrymmet som tilldelats det virtuella WAN-hanterade hubb-nätverket. Fjärr-VPN-anslutna grenar i det här skedet kommer att se två sökvägar till alla befintliga program i ekrarnas virtuella nätverk. De här enheterna bör konfigureras att fortsätta använda tunneln till VDC-hubben för att säkerställa symmetrisk routning under över gångs fasen.
...
![hybrid anslutning via Virtual WAN](./media/migrate-from-hub-spoke-topology/figure4.png)
**bild 4: VDC hubb-och-eker till virtuell WAN-migrering**

### <a name="step-5-transition-connectivity-to-virtual-wan-hub"></a>Steg 5: över gångs anslutning till Virtual WAN Hub

![över gångs anslutning till den virtuella WAN-hubben](./media/migrate-from-hub-spoke-topology/figure5.png)
**figur 5: VDC hubb-och-eker till virtuell WAN-migrering**
...
![gamla hubben blir delade tjänster ekrar](./media/migrate-from-hub-spoke-topology/figure6.png)
**figur 6: VDC hubb-och-eker till virtuell WAN-migrering**
...
![optimera lokal anslutning för att fullt ut utnyttja virtuella WAN **-](./media/migrate-from-hub-spoke-topology/figure7.png)
bild 7: VDC hubb-och-eker till virtuell WAN-migrering**
...
![end-State-arkitektur och trafik Sök vägar](./media/migrate-from-hub-spoke-topology/figure8.png)
**figur: dubbelt regions virtuella WAN**
...
![säkerhets-och princip kontroll via Azure brand vägg](./media/migrate-from-hub-spoke-topology/security-policy.png)
