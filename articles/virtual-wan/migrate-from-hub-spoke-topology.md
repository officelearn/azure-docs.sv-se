...
![Contoso Virtual WAN-](./media/migrate-from-hub-spoke-topology/vwan-architecture.png)
arkitektur**bild: Azure Virtual WAN-arkitektur**
...
![Topologi](./media/migrate-from-hub-spoke-topology/figure1.png)
för en enda region**bild 1: VDC Hub-och-eker, enkel region**
...
![Anslut fjärrplatser till virtuellt WAN](./media/migrate-from-hub-spoke-topology/figure3.png)
 **-bild 3: VDC hubb-och-eker till virtuell WAN-migrering**
...
![Över gångs anslutning till virtuellt](./media/migrate-from-hub-spoke-topology/figure5.png)
WAN Hub **-bild 5: VDC hubb-och-eker till virtuell WAN-migrering**
...
![Den gamla hubben blir delade](./media/migrate-from-hub-spoke-topology/figure6.png)
tjänster eker**figur 6: VDC Hub-och-eker till Virtual WAN-migrering**
 ...
 **-bild 7: VDC Hub-och-eker till virtuell WAN-migrering**
...
![Slut punkts arkitektur och trafik Sök](./media/migrate-from-hub-spoke-topology/figure8.png)
vägar**figur: dubbelt region virtuellt WAN**
