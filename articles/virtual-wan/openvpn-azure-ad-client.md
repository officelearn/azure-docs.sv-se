...
När du arbetar med en certifikatbaserad profil kontrollerar du att lämpliga certifikat är installerade på klientdatorn. Mer information om certifikat finns i [Installera klientcertifikat](certificates-point-to-site.md).
