...
Azure virtuellt WAN-nätverk innehåller många Azure-molnet anslutning tjänster som plats-till-plats-VPN, ExpressRoute och användare för punkt-till-plats VPN i ett enda gränssnitt som fungerar. Upprätta en anslutning till virtuella Azure-nätverk är med hjälp av virtuella nätverksanslutningar.

ExpressRoute och användare för punkt-till-plats-VPN för virtuellt WAN-nätverk är för närvarande i förhandsversion.
