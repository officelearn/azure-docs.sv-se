...
ms.locfileid: "74896593"
---
# <a name="create-a-site-to-site-vpn-connection-over-expressroute-private-peering-by-using-azure-virtual-wan"></a>Skapa en VPN-anslutning från plats till plats via ExpressRoute privat peering med hjälp av Azure Virtual WAN
...
## <a name="associate"></a>4. Hämta de privata IP-adresserna för hubb-VPN-gatewayen
...
1. På sidan **Översikt** representerar varje punkt på kartan ett nav. Hovra över en punkt för att Visa hubbens hälso översikt.
...
1. Gå till ditt WAN.
1. I avsnittet **support och fel sökning** väljer du **hälsa** och visar din resurs.
...
När du inte längre behöver dessa resurser kan du använda [Remove-AzResourceGroup](/powershell/module/az.resources/remove-azresourcegroup) för att ta bort resurs gruppen och alla resurser som den innehåller. Kör följande PowerShell-kommando och ersätt `myResourceGroup` med namnet på din resurs grupp:
