...
1. Anropa `CloudBlobContainer.CreateIfNotExists` metoden för att skapa behållaren om den inte redan finns. `CloudBlobContainer.CreateIfNotExists` Metoden returnerar **True** om behållaren inte finns och har skapats. Annars returnerar metoden **false**.    
...
1. Kör programmet och välj **skapa BLOB-behållare** för att se resultat som liknar följande skärm bild:
    ...
    Som tidigare nämnts returnerar `CloudBlobContainer.CreateIfNotExists` metoden **True** bara när behållaren inte finns och skapas. Om appen körs när behållaren finns returnerar metoden **falskt**.
...
1. I- `UploadBlob` metoden kan du hämta `CloudBlobContainer` ett objekt som representerar en referens till önskat BLOB container-namn. 
...
1. I- `DownloadBlob` metoden kan du hämta `CloudBlobContainer` ett objekt som representerar en referens till BLOB-behållaren.
...
1. I- `DeleteBlob` metoden kan du hämta `CloudBlobContainer` ett objekt som representerar en referens till BLOB-behållaren.
