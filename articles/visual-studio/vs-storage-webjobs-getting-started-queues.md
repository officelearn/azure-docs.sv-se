...
Den här artikeln innehåller C#-kod exempel som visar hur du använder Azure WebJobs SDK version 1. x med Azure Queue Storage-tjänsten.
...
### <a name="poco-plain-old-clr-object-queue-messages"></a>POCO [(vanligt gammalt CLR-objekt](https://en.wikipedia.org/wiki/Plain_Old_CLR_Object)) köa meddelanden
