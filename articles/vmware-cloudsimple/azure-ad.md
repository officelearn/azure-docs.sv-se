---
title: Azure VMware-lösningar (AVS) – Använd Azure AD som identitets källa i det privata AVS-molnet
description: Beskriver hur du lägger till Azure AD som en identitets leverantör i ditt moln privata moln för att autentisera användare som har åtkomst till AVS-post från Azure
author: sharaths-cs
ms.author: b-shsury
ms.date: 08/15/2019
ms.topic: article
...
ms.locfileid: "77015931"
---
# <a name="use-azure-ad-as-an-identity-provider-for-vcenter-on-avs-private-cloud"></a>Använd Azure AD som identitets leverantör för vCenter i molnets privata moln

Du kan ställa in ditt molns privata moln vCenter för att autentisera med Azure Active Directory (Azure AD) för att VMware-administratörer ska få åtkomst till vCenter. När identitets källan för enkel inloggning har kon figurer ATS kan **cloudowner** -användaren lägga till användare från identitets källan till vCenter.  
...
* Ny Active Directory domän och domänkontrollanter som körs i ditt moln privata moln
...
2. [Så här konfigurerar du en identitets källa i ditt molns vCenter vCenter](#set-up-an-identity-source-on-your-avs-private-cloud-vcenter)
...
## <a name="set-up-an-identity-source-on-your-avs-private-cloud-vcenter"></a>Konfigurera en identitets källa för ditt molns privata moln vCenter

1. [Eskalera behörigheter](escalate-private-cloud-privileges.md) för ditt molns privata moln vCenter.
2. Samla in de konfigurations parametrar som krävs för att konfigurera identitets källan.
    ...
    | **Domännamn** | FQDN för domänen, till exempel example.com. Ange ingen IP-adress i den här text rutan. |
...
3. Logga in på ditt molns privata moln vCenter när behörigheterna har eskalerats.
