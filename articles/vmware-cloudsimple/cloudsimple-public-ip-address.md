---
title: Azure VMware-lösningar (AVS) – offentlig IP-adress
description: Lär dig mer om offentliga IP-adresser och deras fördelar med Azure VMware-lösningar (AVS)
author: sharaths-cs
ms.author: dikamath
ms.date: 08/20/2019
ms.topic: article
...
---
# <a name="avs-public-ip-address-overview"></a>Översikt över AVS-offentlig IP-adress

En offentlig IP-adress gör det möjligt för Internet resurser att kommunicera inkommande till moln resurser i ett privat IP-adress. Den privata IP-adressen är en virtuell dator eller en belastningsutjämnare för program vara i ditt molns privata moln vCenter. Med den offentliga IP-adressen kan du exponera tjänster som körs på ditt molns privata moln till Internet.
