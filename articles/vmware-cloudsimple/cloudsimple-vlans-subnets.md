...
description: Lär dig om VLAN och undernät i CloudSimple privata moln och om nätverket som CloudSimple tillhandahåller var CloudSimple-tjänsten distribueras.
author: sharaths-cs
ms.author: dikamath
ms.date: 08/15/2019
ms.topic: article
