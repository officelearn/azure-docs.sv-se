...
2. Skapa en användare i ditt privata moln för vSphere-replikering och SRM-installation. Förklaras [nedan i vCenter-gränssnittet: Skapa en användare i ett privat moln för vRA & SRM](#vcenter-ui-create-a-user-in-private-cloud-for-vra-and-srm-installation)-installation.
...
5. Konfigurera brand Väggs regler för vRA. Förklaras [nedan i CloudSimple-portalen: Konfigurera brand Väggs regler](#cloudsimple-portal-configure-firewall-rules-for-vra)för vRA.
