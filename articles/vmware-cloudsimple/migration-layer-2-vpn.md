...
3. Öppna en SSH-session med hanterings-IP-adressen för den virtuella Edge-datorn. Kör ```get logical-router```-kommandot med användar namns **administratör** och lösen ord **CloudSimple 123!** .
