---
title: Azure VMware-lösningar (AVS) – Konfigurera vCenter-identitets källor i molnets privata moln
description: Beskriver hur du konfigurerar ditt molns privata moln vCenter för att autentisera med Active Directory för VMware-administratörer att komma åt vCenter
author: sharaths-cs
ms.author: b-shsury
ms.date: 08/15/2019
ms.topic: article
...
I den här guiden beskrivs aktiviteter för att konfigurera Active Directory domän-och domän kontrollers som kör antingen lokalt eller som virtuella datorer i dina prenumerationer. Om du vill använda Azure AD som identitets källa kan du läsa mer i [använda Azure AD som identitets leverantör för vCenter i molnets privata moln](azure-ad.md) för detaljerade anvisningar om hur du konfigurerar identitets källan.
...
* [Konfigurera nya Active Directory på ett privat moln moln](#set-up-new-active-directory-on-an-avs-private-cloud)
...
* [Plats-till-plats-VPN-anslutning](vpn-gateway.md#set-up-a-site-to-site-vpn-gateway) från ditt lokala data Center till ditt moln privata moln.
...
## <a name="set-up-new-active-directory-on-an-avs-private-cloud"></a>Konfigurera nya Active Directory på ett privat moln moln

Du kan konfigurera en ny Active Directory domän i ditt moln-moln och använda den som identitets källa för enkel inloggning. Active Directory domän kan ingå i en befintlig Active Directory skog eller konfigureras som en oberoende skog.
...
1. [Eskalera behörigheter](escalate-private-cloud-privileges.md) för ditt moln privata moln.

2. Logga in på vCenter för ditt AVS-privata moln.
