...
ms.locfileid: "69544479"
---
# <a name="configure-vsan-encryption-for-your-cloudsimple-private-cloud"></a>Konfigurera virtuellt San-kryptering för ditt CloudSimple privata moln
...
VMware kräver att du använder en extern KMIP 1,1-kompatibel server för nyckel hanterings Server (KMS) från tredje part när du använder virtuellt San-kryptering. Du kan använda en KMS som stöds och som har certifierats av VMware och är tillgänglig för Azure.

Så här använder du HyTrust-KMS-KMS som körs i ett virtuellt Azure-nätverk. En liknande metod kan användas för alla andra certifierade KMS-lösningar från tredje part för virtuellt San.
...
![KMS-kluster i Azure Virtual Network](media/vsan-kms-cluster.png)

## <a name="how-to-deploy-the-solution"></a>Så här distribuerar du lösningen

Distributions processen innehåller följande steg:

1. [Kontrol lera att kraven är uppfyllda](#verify-that-prerequisites-are-met)
2. [CloudSimple-Portal: Hämta information om ExpressRoute-peering](#cloudsimple-portal-obtain-expressroute-peering-information)
3. [Azure-portalen: Anslut det virtuella nätverket till det privata molnet](#azure-portal-connect-your-virtual-network-to-your-private-cloud)
4. [Azure-portalen: Distribuera ett HyTrust-i ditt virtuella nätverk](#azure-portal-deploy-a-hytrust-keycontrol-cluster-in-the-azure-resource-manager-in-your-virtual-network)
...
### <a name="verify-that-prerequisites-are-met"></a>Kontrol lera att kraven är uppfyllda
...
### <a name="azure-portal-deploy-a-hytrust-keycontrol-cluster-in-the-azure-resource-manager-in-your-virtual-network"></a>Azure-portalen: Distribuera ett HyTrust-gruppkluster i Azure Resource Manager i ditt virtuella nätverk

Om du vill distribuera ett HyTrust-i Azure Resource Manager det virtuella nätverket utför du följande uppgifter. Mer information finns i <a href="https://docs.hytrust.com/DataControl/Admin_Guide-4.0/Default.htm#OLH-Files/Azure.htm%3FTocPath%3DHyTrust%2520DataControl%2520and%2520Microsoft%2520Azure%7C_____0" target="_blank">HyTrust-dokumentationen</a> .
...
Gå till https://*Public-IP*, där *offentlig* IP-adress är den offentliga IP-adressen för den virtuella. Följ de här stegen i <a href="https://docs.hytrust.com/DataControl/Admin_Guide-4.0/Default.htm#OLH-Files/Azure.htm%3FTocPath%3DHyTrust%2520DataControl%2520and%2520Microsoft%2520Azure%7C_____0" target="_blank">HyTrust-dokumentationen</a>.

1. <a href="https://docs.hytrust.com/DataControl/4.2/Admin_Guide-4.2/index.htm#Books/VMware-vSphere-VSAN-Encryption/configuring-kmip-server.htm%3FTocPath%3DHyTrust%2520KeyControl%2520with%2520VSAN%25C2%25A0and%2520VMware%2520vSphere%2520VM%2520Encryption%7C_____2" target="_blank">Konfigurera en KMIP-Server</a>
2. <a href="https://docs.hytrust.com/DataControl/4.2/Admin_Guide-4.2/index.htm#Books/VMware-vSphere-VSAN-Encryption/creating-user-for-vmcrypt.htm%3FTocPath%3DHyTrust%2520KeyControl%2520with%2520VSAN%25C2%25A0and%2520VMware%2520vSphere%2520VM%2520Encryption%7C_____3" target="_blank">Skapa ett certifikat paket för VMware-kryptering</a>
...
Följ HyTrust-instruktionerna för att <a href="https://docs.hytrust.com/DataControl/4.2/Admin_Guide-4.2/index.htm#Books/VMware-vSphere-VSAN-Encryption/creating-KMS-Cluster.htm%3FTocPath%3DHyTrust%2520KeyControl%2520with%2520VSAN%25C2%25A0and%2520VMware%2520vSphere%2520VM%2520Encryption%7C_____4" target="_blank">skapa ett KMS-kluster i vCenter</a>.
