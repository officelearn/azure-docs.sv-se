...
# Gör så här för att
## Konfigurera en plats-till-plats-anslutning
...
### [Klassisk portal (klassisk)](vpn-gateway-point-to-site-create.md)
...
## Skapa anslutningar för samexistens mellan plats-till-plats och ExpressRoute
