...
description: Lär dig hur du skapar en Route-baserad Azure VPN-gateway med hjälp av Azure Portal. Använd en VPN-gateway för att ansluta till ditt lokala nätverk.
