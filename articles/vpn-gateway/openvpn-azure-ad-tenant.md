---
title: 'Skapa en Azure Active Directory-klient för P2S VPN-anslutningar: Azure AD-autentisering | Microsoft Docs'
...
ms.locfileid: "73517402"
---
# <a name="create-an-azure-active-directory-tenant-for-p2s-open-vpn-connections-that-use-azure-ad-authentication"></a>Skapa en Azure Active Directory-klient för P2S öppna VPN-anslutningar som använder Azure AD-autentisering
