...
description: Azure PowerShell-exempel för VPN Gateway.
...
| [Skapa vnet-to-vnet-anslutningar](./scripts/vpn-gateway-sample-vnet-vnet-powershell.md) | Skapa anslutningar mellan virtuella nätverk. |
