...
description: Lär dig hur du konfigurerar Azure VPN-gatewayer för att uppfylla krypterings kraven för lokala S2S VPN-tunnlar och VNet-till-VNet-anslutningar i Azure.
