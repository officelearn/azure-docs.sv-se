...
En VPN-enhet krävs för att kunna konfigurera en plats-till-plats-anslutning (S2S) i VPN. Plats-till-plats-anslutningar kan användas för att skapa en hybridlösning, eller när du vill skapa en säker anslutning mellan ditt lokala nätverk och ditt virtuella nätverk. I den här artikeln beskrivs kompatibla VPN-enheter och konfigurationsparametrar. Observera att när du konfigurerar en plats-till-plats-anslutning, krävs en offentlig IPv4-adress för VPN-enheten.                                                                                                                                                                                

Om enheten inte finns med i tabellen med verifierade VPN-enheter, kan du gå till avsnittet Icke-verifierade VPN-enheter i den här artikeln. Det är möjligt att enheten fungerar med Azure ändå. Kontakta enhetstillverkaren för att se vilket stöd som finns för VPN-enheter.
...
- Specifikationerna för en VPN-gateway med hög kapacitet och en routningsbaserad VPN-gateway är samma, om inget annat anges. Till exempel kommer verifierade VPN-enheter som är kompatibla med routningsbaserade VPN-gatewayer också vara kompatibla med den nya Azure VPN-gatewayen med hög kapacitet.  


## Verifierade VPN-enheter 

Vi har verifierat en uppsättning VPN-standardenheter tillsammans med våra enhetsleverantörer. Alla enheter i enhetsfamiljerna som finns i listan nedan ska fungera med Azures VPN-gatewayer. Se artikeln [VPN-gatewayer](vpn-gateway-about-vpngateways.md) för att kontrollera vilken typ av gateway som du måste skapa för den lösning som du vill konfigurera. 
...
| Citrix                          | CloudBridge MPX-installation, eller en virtuell VPX-installation       | Saknas                                                | [Integreringsanvisningar](https://www.citrix.com/welcome.html?resource=%2Fdownloads%2Fcloudbridge%2Fbetas-and-tech-previews%2Fcloudbridge-azure-integration)                                                                                                                                                                            | Inte kompatibel                                                                                                                                                                                               |
...
| Fortinet                        | FortiGate                                                | FortiOS 5.0.7                                      | [Konfigurationsanvisningar](http://docs.fortinet.com/fortigate/admin-guides)                                                                                                                                                                          | [Konfigurationsanvisningar](http://docs.fortinet.com/fortigate/admin-guides)                                                                                                                                  |
...
>[AZURE.NOTE] Även om de värden som anges nedan stöds av Azure VPN Gateway, går det för närvarande inte att ange eller välja en specifik kombination från Azure VPN Gateway. Du måste ange eventuella begränsningar från den lokala VPN-enheten.
...
Tabellen nedan visar IPsec, SA-kryptering och autentiseringserbjudanden. Erbjudandena visas i prioritetsordning efter när erbjudandet visats eller godkänts.
