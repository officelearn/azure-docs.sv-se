...
## <a name="rmvnet"></a>Avsnitt 2 – Konfigurera inställningar för VNet för Resource Manager
...
## <a name="modifylng"></a>Avsnitt 3 – ändra de klassiska VNet-inställningarna för lokal plats
...
## <a name="RMtoclassic"></a>Avsnitt 4 – Skapa Resource Manager till klassisk anslutning
...
## <a name="classictoRM"></a>Avsnitt 5 – skapa klassiskt till Resource Manager-anslutning
...
## <a name="verify"></a>Avsnitt 6 – kontrol lera dina anslutningar
