...
## <a name="enablepolicybased"></a>Aktivera principbaserad trafik väljare
...
## <a name="update"></a>Så här uppdaterar du principbaserad trafik väljare
