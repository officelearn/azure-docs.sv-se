...
## <a name="modify"></a>Steg 4: ändra nätverks konfigurations filen
...
### <a name="lnsref"></a>Referenser till lokala nätverks platser
...
### <a name="lns"></a>Lokala nätverks platser
...
### <a name="clientaddresss"></a>Klientadresspool för klient
...
## <a name="upload"></a>Steg 5: Ladda upp nätverks konfigurations filen
