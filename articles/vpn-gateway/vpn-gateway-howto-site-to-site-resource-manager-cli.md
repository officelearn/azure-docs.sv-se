---
title: 'Anslut lokala nätverk till ett virtuellt nätverk: Plats-till-plats-VPN: CLI'
...
* Du kan använda Azure Cloud Shell för att köra dina CLI-kommandon (instruktioner nedan). Om du föredrar att köra kommandona lokalt kontrollerar du dock att du har installerat den senaste versionen av CLI-kommandona (2.0 eller senare). Information om att installera CLI-kommandona finns i [Installera Azure CLI](/cli/azure/install-azure-cli) och [Kom igång med Azure CLI](/cli/azure/get-started-with-azure-cli). 
...
Om du väljer att köra CLI lokalt ansluter du till din prenumeration. Om du använder Azure Cloud Shell i webbläsaren behöver du inte ansluta till din prenumeration. Du ansluter automatiskt i Azure Cloud Shell. Du kanske vill kontrollera att du använder rätt prenumeration när du har anslutit.

[!INCLUDE [CLI login](../../includes/vpn-gateway-cli-login-include.md)]

## <a name="2-create-a-resource-group"></a><a name="rg"></a>2. Skapa en resursgrupp
...
## <a name="6-request-a-public-ip-address"></a><a name="PublicIP"></a>6. Begära en offentlig IP-adress
...
* *--vpn-typen* kan vara *RouteBased* (kallas en dynamisk gateway i viss dokumentation) eller *PolicyBased* (kallas en statisk gateway i viss dokumentation). Inställningen gäller krav på den enhet som du ansluter till. Mer information om VPN Gateway-typer finns i [Om konfigurationsinställningar för VPN Gateway](vpn-gateway-about-vpn-gateway-settings.md#vpntype).
...
## <a name="8-configure-your-vpn-device"></a><a name="VPNDevice"></a>8. Konfigurera din VPN-enhet
...
* Information om Tvångstunneler finns i [Om tvångstunneler](vpn-gateway-forced-tunneling-rm.md).
...
* Information om hur du skapar en VPN-anslutning från plats till plats med Azure Resource Manager-mall finns i [Skapa en plats-till-plats-VPN-anslutning](https://azure.microsoft.com/resources/templates/101-site-to-site-vpn-create/).
* Information om hur du skapar en vpn-anslutning mellan vnet-till-vnet med Azure Resource Manager-mall finns i [Distribuera HBase geo replication](https://azure.microsoft.com/resources/templates/101-hdinsight-hbase-replication-geo/).
