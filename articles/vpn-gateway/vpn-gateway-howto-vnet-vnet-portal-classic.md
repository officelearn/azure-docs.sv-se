...
## <a name="vnetvalues"></a>Steg 2 – skapa de virtuella nätverken
...
* **DNS-servrar** – ange DNS-serverns namn och IP-adress. Du skapar inte en DNS-server med den här inställningen. Den gör att du kan välja vilka DNS-servrar du vill använda för namnmatchning för det virtuella nätverket.
...
## <a name="updatelocal"></a>Steg 6 – uppdatera de lokala platserna
...
## <a name="getvalues"></a>Steg 7 – hämta värden från nätverks konfigurations filen
