...
## <a name="CreateVNet"></a>Skapa ditt virtuella nätverk
...
## <a name="Connectivity"></a>Sidan Plats-till-plats-anslutning
...
## <a name="Address"></a>Sidan Adressutrymmen för virtuella nätverk
...
## <a name="VNetGateway"></a>Konfigurera den virtuella nätverksgatewayen
