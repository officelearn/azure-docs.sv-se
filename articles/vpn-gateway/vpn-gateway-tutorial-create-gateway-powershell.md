...
Om du känner till namnet på den offentliga IP-adressen kan du använda [Get-AzPublicIpAddress](https://docs.microsoft.com/powershell/module/az.network/get-azpublicipaddress?view=azurermps-6.8.1) till att visa den offentliga IP-adress som är tilldelad till gatewayen.
