...
Mer hjälp med att installera Storage Explorer på Linux, finns det [felsökningsguiden för](https://docs.microsoft.com/en-us/azure/storage/common/storage-explorer-troubleshooting#linux-dependencies).
