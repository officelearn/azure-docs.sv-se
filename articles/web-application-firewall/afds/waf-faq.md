...
description: Den här artikeln innehåller svar på vanliga frågor om brand vägg för webbaserade program i Azures frontend-tjänst
...
## <a name="what-is-waf-on-azure-front-door-service"></a>Vad är WAF på Azures frontend-tjänst? 
