---
title: Självstudie – Skapa en Programgateway med en brand vägg för webbaserade program – Azure Portal
...
1. Hitta den offentliga IP-adressen för Application Gateway på sidan **Översikt** .![att registrera den offentliga IP-adressen för Application Gateway](../media/application-gateway-web-application-firewall-portal/application-gateway-record-ag-address.png) 
