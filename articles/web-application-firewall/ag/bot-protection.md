...
2. På sidan information går du till avsnittet **Hantera regler** på den nedrullningsbara menyn, markerar kryss rutan för skydds regeln för bot och väljer sedan **Spara**.

> [!div class="mx-imgBorder"]
> ![bot-skydd](../media/bot-protection/bot-protection.png)
