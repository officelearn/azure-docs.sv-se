...
Information om hur du importerar brand Väggs loggar till Log Analytics finns i [backend-hälsa, diagnostikloggar och mått för Application Gateway](../../application-gateway/application-gateway-diagnostics.md#diagnostic-logging). När du har brand Väggs loggar i Log Analytics arbets ytan kan du visa data, skriva frågor, Skapa visualiseringar och lägga till dem i portalens instrument panel.
