...
description: Lär dig hur du använder en Azure Resource Manager snabb starts mall (ARM-mall) för att skapa en brand vägg för webbaserade program v2 på Azure Application Gateway.
