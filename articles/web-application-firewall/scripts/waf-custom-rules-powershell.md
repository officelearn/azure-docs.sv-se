...
description: Exempel på Azure PowerShell-skript – skapa brandvägg för webbprogram i anpassade regler för Programgateway
author: vhorne
...
- Mer information om anpassade WAF-regler finns i [Anpassade regler för brandvägg för webbprogram](../ag/custom-waf-rules-overview.md)
