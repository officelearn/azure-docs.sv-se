...
ms.locfileid: "60459040"
---
Klicka på den **skapa en resurs** knappen. I fältet **Sök på marketplace** skriver du `Azure Active Directory B2C`.
...
Välj **Skapa en ny Azure AD B2C-klient**. De inställningar som anges i tabellen nedan kan du använda namnet på företaget Contoso som ett exempel. Du måste ange organisationens namn och ett unikt klientnamn när du skapar din klient.  
...
| **Ursprungligt domännamn** |  ContosoB2CTenant | Domännamn för B2C-klientorganisationen. Som standard det ursprungliga domännamnet innehåller. onmicrosoft.com. Om du skapar en Testklient väljer du en icke-produktionsnamn, till exempel ContosoB2CTesting. |
