...
1. I Azure-portalen väljer du **Resursgrupper** längst till vänster.
   ...
   [![Delete i Azure Portal](./media/aml-delete-resource-group/delete-resources.png)](./media/aml-delete-resource-group/delete-resources-expanded.png)
