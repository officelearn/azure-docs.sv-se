...
1. Wechseln Sie zu der [Dropbox-Entwicklerportal](https://www.dropbox.com/developers/apps), klicken Sie auf **App Console**, und klicken Sie dann auf **Create App**.

    ![Erstellen einer Dropbox-App](./media/app-service-api-create-dropbox-app/dbappcreate.png) 

2. Wählen Sie **Dropbox API app** und anderen Einstellungen konfigurieren. 
...
3. Klicken Sie auf **Erstellen app**.
