...
ms.locfileid: "67187835"
---
Först måste du registrera din app på en identitetsprovider plats och du kommer sedan att ange autentiseringsuppgifter för provider-genererade i Mobile Apps-serverdel.

1. Konfigurera din önskade identitetsprovider genom att följa anvisningarna för provider-specifik:
...
2. Upprepa föregående steg för varje leverantör som du vill använda i din app.
