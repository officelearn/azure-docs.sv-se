Hinzufügen von Authentifizierung zu Ihrer mobilen App: [iOS][ios-get-started-users], [Xamarin.iOS][xamarin-ios-get-started-users], [Xamarin.Android][xamarin-android-get-started-users], [universelle Windows-][windows-get-started-users].
