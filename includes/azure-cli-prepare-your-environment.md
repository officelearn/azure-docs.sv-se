...
- Om du vill kan du [Installera](/cli/azure/install-azure-cli) Azure CLI för att köra CLI-referens kommandon.
   - Om du använder en lokal installation loggar du in med Azure CLI med hjälp av kommandot [AZ login](/cli/azure/reference-index#az-login) .  Slutför autentiseringsprocessen genom att följa stegen som visas i terminalen.  Se [Logga in med Azure CLI](/cli/azure/authenticate-azure-cli) för ytterligare inloggnings alternativ.
  - När du uppmanas att installera Azure CLI-tillägg vid första användningen.  Mer information om tillägg finns i [använda tillägg med Azure CLI](/cli/azure/azure-cli-extensions-overview).
