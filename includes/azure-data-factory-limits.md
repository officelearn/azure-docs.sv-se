...
Der Azure-Ressourcen-Manager weist Limits für API-Aufrufe auf. Lassen Sie API-Aufrufe mit einer Rate innerhalb der [Azure-Ressourcen-Manager-API schränkt](azure-subscription-service-limits/#resource-group-limits). 
