...
ms.locfileid: "77172886"
---
|Namn |Beskrivning |Påverkan (ar) |Version |
|---|---|---|---|
|[Tillåtna SKU:er för lagringskonto](https://github.com/Azure/azure-policy/blob/masterbuilt-in-policies/policyDefinitions/Storage/AllowedStorageSkus_Deny.json) |Med den här principen kan du ange en uppsättning lagrings konto-SKU: er som din organisation kan distribuera. |Neka |1.0.0 |
...
|[Distribuera Avancerat skydd på lagrings konton](https://github.com/Azure/azure-policy/blob/masterbuilt-in-policies/policyDefinitions/Storage/StorageAdvancedThreatProtection_Deploy.json) |Den här principen aktiverar Avancerat skydd på lagrings konton. |DeployIfNotExists, inaktiverat |1.0.0 |
