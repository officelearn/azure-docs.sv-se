...
<sup>1</sup>*Eingang* bezieht sich auf alle Daten (Anforderungen) an ein Speicherkonto gesendet werden. *Ausgang* bezieht sich auf alle Daten (Antworten), die aus einem Speicherkonto empfangen werden.
