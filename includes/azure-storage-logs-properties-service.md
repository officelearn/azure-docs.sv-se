...
|**operationCount** | Antalet varje loggad åtgärd som ingår i begäran. Antalet börjar med ett index av `0` . Vissa begär Anden kräver mer än en åtgärd. De flesta förfrågningar utför bara en åtgärd. Exempel: `1`. |
