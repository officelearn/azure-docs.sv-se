...
<sup>1</sup>lagras automatiskt virtuella datorer som skapats i Service Management (i stället för Resource Manager) i en molntjänst. Du kan lägga till fler virtuella maskiner Molntjänsten för belastningsutjämning och tillgänglighet. Se [ansluta virtuella datorer med ett virtuellt nätverk eller Molntjänsten](../articles/virtual-machines/linux/classic/connect-vms.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json).
