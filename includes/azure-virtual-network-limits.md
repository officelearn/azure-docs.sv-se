...
| --- | --- | --- |
| Public IP addresses - dynamic | 1,000 for Basic. |Kontakta supporten. |
| Public IP addresses - static | 1,000 for Basic. |Kontakta supporten. |
| Public IP addresses - static | 1,000 for Standard.|Kontakta supporten. |
| Public IP prefix length | /28 | Kontakta supporten. |

#### <a name="load-balancer"></a>Load balancer limits
Följande begränsningar gäller endast för nätverksresurser som hanteras via Azure Resource Manager per region per prenumeration. Learn how to [view your current resource usage against your subscription limits](../articles/networking/check-usage-against-limits.md).
