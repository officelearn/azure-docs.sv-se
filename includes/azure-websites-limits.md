| Resurs | Gratis | Delad | Standard | Standard | Premium (v2) | Isolerad </th> |
| --- | --- | --- | --- | --- | --- | --- |
...
| Minne (1 timme) |1 024 MB per App Service-plan |1 024 MB per app |Ej tillämpligt |Saknas |Saknas |Ej tillämpligt |
