...
| source | Källportar | Mål | Måltjänsttagg | Målportar | Protocol | Åtgärd |
| --- | --- | --- | --- | --- | --- | --- |
| Alla | * | [Tjänsttagg](../articles/virtual-network/security-overview.md#service-tags) | `Storage` (i samma region som dina Batch-konto och ett virtuellt nätverk) | 443 | TCP | Tillåt |
