...
ms.locfileid: "91360707"
---
1. Logga in på [Azure-portalen](https://portal.azure.com).
 
2. Sök efter **Kostnadshantering och fakturering** .
 
   ![Skärmbild som visar en sökning i Azure-portalen efter Kostnadshantering + fakturering.](./media/billing-check-account-type/billing-search-cost-management-billing.png)    
