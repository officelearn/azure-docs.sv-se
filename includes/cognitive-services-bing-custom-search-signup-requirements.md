...
ms.locfileid: "74972716"
---
## <a name="create-an-azure-resource"></a>Skapa en Azure-resurs

Börja använda API för anpassad Bing-sökning genom att skapa en av Azure-resurserna nedan.

* [Skapa en utvärderings resurs](https://azure.microsoft.com/try/cognitive-services/?api=bing-custom-search-api):
...
* [Skapa en anpassad sökning i Bing resurs](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingCustomSearch):
