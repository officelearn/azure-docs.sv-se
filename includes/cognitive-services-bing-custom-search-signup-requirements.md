...
ms.locfileid: "85805592"
---
## <a name="create-an-azure-resource"></a>Skapa en Azure-resurs

Börja använda API för anpassad Bing-sökning genom att skapa någon av följande Azure-resurser.

### <a name="bing-custom-search-resource"></a>[Anpassad sökning i Bing resurs](https://portal.azure.com/#create/Microsoft.CognitiveServicesBingCustomSearch)
