...
ms.locfileid: "51977872"
---
## <a name="request-and-response-json"></a>Begäran- och svars-JSON

En JSON-formaterad exempelfråga för REST API:
...
Frågan innehåller en egenskap för att returnera de översta tre svaren. 

Svaret returneras i ett JSON-objekt:
