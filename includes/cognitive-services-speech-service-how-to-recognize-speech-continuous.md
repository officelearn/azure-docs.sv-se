...
ms.locfileid: "57891378"
---
## <a name="continuous-speech-recognition-from-a-file"></a>Kontinuerlig taligenkänning från en fil

Följande kodavsnitt identifierar kontinuerligt talindata från en ljudfil på standardspråket (en-US). Format är en kanal (mono) WAV / PCM med en samplingsfrekvensen 16 kHz.
