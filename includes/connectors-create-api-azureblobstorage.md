...
1. När du uppmanas att ange anslutningsinformationen Tillhandahåll följande information:
   ...
   *Krävs*
   ...
   |----------|-------|-------------| 
   | Anslutningsnamn | <*connection-name*> | Namn för att skapa för anslutningen | 
   | Lagringskonto | <*storage-account*> | Välj ditt lagringskonto i listan. | 
   ||| 
