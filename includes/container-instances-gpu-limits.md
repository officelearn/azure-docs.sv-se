...
ms.locfileid: "87387104"
---
### <a name="maximum-resources-per-sku"></a>Maximalt antal resurser per SKU

| Operativsystem | GPU-SKU | GPU-antal | Maximal CPU | Högsta mängd minne (GB) | Lagring (GB) |
| --- | --- | --- | --- | --- | --- |
| Linux | K80 | 1 | 6 | 56 | 50 |
