...
Följande skript använder kommandot [AZ Role Assignment Create][az-role-assignment-create] för att ge *pull* -behörighet till ett huvud namn för tjänsten som du `SERVICE_PRINCIPAL_ID` anger i variabeln. Justera `--role` värdet om du vill bevilja en annan åtkomst nivå.
