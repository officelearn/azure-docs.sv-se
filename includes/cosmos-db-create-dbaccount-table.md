...
3. Välj **databaser**Azure Cosmos DB på sidan **nytt**  >  **Azure Cosmos DB**.
   ...
   :::image type="content" source="./media/cosmos-db-create-dbaccount-table/create-nosql-db-databases-json-tutorial-1.png" alt-text="Skapa en resurs på Azure-portalen":::
...
5. Välj **Granska + skapa**. När verifieringen är klar väljer du **skapa** för att skapa kontot. 
   ...
   :::image type="content" source="./media/cosmos-db-create-dbaccount-table/azure-cosmos-db-create-new-account.png" alt-text="Skapa en resurs på Azure-portalen":::
...
6. Det tar några minuter att skapa kontot. Ett meddelande visas som anger att **distributionen pågår**. Vänta tills distributionen är klar och välj sedan **gå till resurs**.
    ...
    :::image type="content" source="./media/cosmos-db-create-dbaccount-table/azure-cosmos-db-account-created.png" alt-text="Skapa en resurs på Azure-portalen":::
