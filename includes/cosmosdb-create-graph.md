...
2. På bladet Datautforskaren klickar du på **Ny samling** och fyller sedan i sidan med följande information.
    ...
    ![Datautforskaren i Azure Portal](./media/cosmosdb-create-graph/azure-cosmosdb-data-explorer.png)
    ...
    Samlings-id|sample-graph|ID:t för din nya samling. Samma teckenkrav gäller för samlingsnamn som databas-id.
