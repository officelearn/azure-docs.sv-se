...
Die Spaltenzuordnung kann verwendet werden, um anzugeben, wie die in "structure" der Quelltabelle angegebenen Spalten den in "structure" der Senkentabelle angegebenen Spalten zugeordnet werden. Die **ColumnMapping** Eigenschaft steht in der **TypeProperties** Teil der kopieren-Aktivität.
...
> [AZURE.NOTE] Die Beispiele unten sind für SQL Azure und Azure-Blob, gelten jedoch auf die gleiche Weise für beliebige Datenspeicher, die rechteckige Tabellen unterstützt. Sie müssen die Definitionen von Datasets und verknüpften Diensten in den folgenden Beispielen anpassen, damit sie auf Daten in der relevanten Datenquelle verweisen.
...
Die JSON für die Aktivität ist unten dargestellt. Die Spalten der Quelle, die Spalten der Senke zugeordnet (**ColumnMappings**) mithilfe von **Translator** Eigenschaft.
