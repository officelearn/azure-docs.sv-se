...
1. På sidan lagrings konto väljer du **översikt** > **behållare**.
2. På sidan *\<konto namn >*  - **behållare** sidans verktygsfält väljer du **behållare**.
...
1. På sidan *\<konto namn >*  - **behållare** där du slutade, väljer du **adftutorial** från den uppdaterade listan över behållare.
   ...
   1. Välj ditt lagrings konto och välj sedan **behållare** > **adftutorial**.
