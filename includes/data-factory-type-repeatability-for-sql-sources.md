...
> [AZURE.NOTE] Ein Segment kann automatisch in Azure Data Factory gemäß der angegebenen wiederholungsrichtlinie erneut ausgeführt werden.

### Verfahren 1

Sie können nutzen **SqlWriterCleanupScript** Eigenschaft, um zuerst Systembereinigungsaktion auszuführen, wenn ein Slice ausgeführt wird. 
...
Einen anderen Mechanismus zum Erreichen von Wiederholbarkeit ist eine dedizierte Spalte (**SliceIdentifierColumnName**) in der Zieltabelle. Diese Spalte wird von Azure Data Factory verwendet, um sicherzustellen, dass Quell- und Zielserver synchron bleiben. Dieser Ansatz funktioniert, wenn das Schema der SQL-Zieltabelle flexibel geändert oder definiert werden kann. 
