...
-->
Du kan använda något av följande verktyg och SDK: er för att använda Kopieringsaktivitet med en pipeline. Välj en länk för stegvisa instruktioner:

- [Kopiera Data-verktyg](../articles/data-factory/quickstart-create-data-factory-copy-data-tool.md)
