...
Käll koden för att använda [snabb starts guiden](https://github.com/Azure-Samples/digital-twins-samples-csharp/blob/master/occupancy-quickstart/src/api/update.cs) innehåller fullständiga C#-exempel som demonstrerar hur du gör flerdelade förfrågningar mot Azure Digitals hanterings-API: er.