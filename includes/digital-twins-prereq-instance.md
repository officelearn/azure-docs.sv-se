...
* instansens **_värdnamn_**. Du kan hitta det här värdet i Azure Portal ([instruktioner](../articles/digital-twins/how-to-set-up-instance-portal.md#verify-success-and-collect-important-values)).
