...
Självstudien drivs av ett exempel projekt som skrivits i C#. Exemplet finns här: [Azure Digitals dubbla exempel](https://docs.microsoft.com/samples/azure-samples/digital-twins-samples/digital-twins-samples). **Hämta exempelprojektet** på datorn genom att gå till exempel länken och välja knappen *Hämta zip* under rubriken.

Då hämtas en *. ZIP* -mapp på din dator som **Azure_Digital_Twins_samples.zip**. Zippa upp mappen och extrahera filerna.
