...
Om du inte vill använda Azure Cloud Shell installerar du Azure PowerShell lokalt i stället. Se till att installera den senaste versionen av modulen Azure PowerShell AZ för att få uppdaterade funktioner. Mer information finns i [installera Azure PowerShell](/powershell/azure/overview).
