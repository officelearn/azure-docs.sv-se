...
ms.locfileid: "60713532"
---
I följande tabell visas de utlösare och bindningen attribut som är tillgängliga i en Azure Functions klassbiblioteksprojektet. Alla attribut finns i namnområdet `Microsoft.Azure.WebJobs`.
