...
|**kardinalitet** | Saknas | För Java Script. Ange till `many` för att aktivera batchbearbetning.  Om det utelämnas eller anges till `one`, skickas ett enskilt meddelande till funktionen. |
