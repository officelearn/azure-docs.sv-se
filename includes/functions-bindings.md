...
<sup>1</sup> i 2.x, alla bindningar förutom HTTP, Timer och Azure Storage måste vara registrerad. Se [registrera tillägg av bindning](../articles/azure-functions/functions-triggers-bindings.md#register-binding-extensions).
