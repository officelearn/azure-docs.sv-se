...
<sup>1</sup> i 2. x måste alla bindningar utom http och timer registreras. Se [Registrera bindnings tillägg](../articles/azure-functions/functions-bindings-register.md).
