...
2. Använd funktionen app-inställningar som anges i tabellen nedan avbildningen.
    ...
    | **Prenumeration** | Din prenumeration | Den prenumeration som har skapats för den här nya funktionen appen. | 
    ...
    | **Plats** | Västra Europa | Välj en [region](https://azure.microsoft.com/regions/) nära dig eller nära andra tjänster dina funktioner har åtkomst till. |
...
1. Klicka på **Skapa** för att etablera och distribuera den nya funktionsappen. Du kan övervaka statusen för distributionen genom att klicka på meddelandeikonen i övre högra hörnet av portalen. 

    ![Definiera nya funktionen app-inställningar](./media/functions-create-function-app-portal/function-app-create-notification.png)

    Klicka på **finns resurs** tar dig till din nya funktionsapp.
