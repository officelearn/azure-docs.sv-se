...
ms.locfileid: "66236021"
---
| Resource | [Förbrukningsplan](../articles/azure-functions/functions-scale.md#consumption-plan) | [Premium-abonnemang](../articles/azure-functions/functions-scale.md#premium-plan-public-preview) | [App Service-plan](../articles/azure-functions/functions-scale.md#app-service-plan)<sup>1</sup> |
| --- | --- | --- | --- |
...
<sup>7</sup>när funktionsappen är värd för en [förbrukningsplan](../articles/azure-functions/functions-scale.md#consumption-plan), endast alternativet CNAME stöds. För funktionsappar i en [premiumprenumerationen](../articles/azure-functions/functions-scale.md#premium-plan-public-preview) eller en [App Service-plan](../articles/azure-functions/functions-scale.md#app-service-plan), kan du mappa en anpassad domän med en CNAME-post eller en A-post. 
