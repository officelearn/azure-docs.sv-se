...
Du kan använda kommandot [`az storage queue list`](/cli/azure/storage/queue#az-storage-queue-list) för att Visa lagrings köer i ditt konto, som i följande exempel:
