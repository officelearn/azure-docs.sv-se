> [!IMPORTANT]
> Azure PowerShell-stöd för hantering av HDInsight-resurser med hjälp av Azure Service Manager (ASM) är **föråldrat** och kommer inte längre att kunna användas från och med 1 januari 2017. Stegen i det här dokumentet använder de nya HDInsight-cmdletarna som fungerar med Azure Resource Manager (ARM).
> 
