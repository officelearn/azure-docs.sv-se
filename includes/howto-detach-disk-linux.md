...
> [!NOTE]
> En virtuell dator i Azure använder olika typer av diskar – en operativsystemdisk, en lokal temporär disk och valfria datadiskar. Mer information finns i avsnittet om [diskar och virtuella hårddiskar för virtuella datorer](../articles/storage/storage-about-disks-and-vhds-linux.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json). Du kan inte koppla bort en operativsystemdisk om du inte också tar bort den virtuella datorn.
