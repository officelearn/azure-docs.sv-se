...
1. Ange ett **namn på en säkerhets profil**, en **Beskrivning av säkerhets profil**och **URL**för sekretess meddelande `https://www.contoso.com/privacy` , till exempel URL: en för sekretess meddelandet är en sida som du hanterar som ger sekretess information till användarna. Klicka sedan på **Spara**.
