...
[Abbildung 2](#fig2) zeigt die erste dieser beiden Optionen, bei Azure Active Directory erforderlich ist.
...
Nehmen wir z. B., eine Anwendung ermöglicht Benutzern möchte melden Sie sich mithilfe von mehreren ausgestellte Token *Identitätsanbietern (IdPs)*. Aktuell gibt es die verschiedensten Identitätsanbieter, darunter Facebook, Google, Microsoft und andere; Anwendungen gestatten häufig die Benutzeranmeldung mit einer dieser Identitäten. Weshalb sollte eine Anwendung sich die Mühe machen, ihre eigene Benutzer- und Kennwortliste zu pflegen, wenn sie statt dessen auf bereits existierende Identitäten zurückgreifen kann? Das Akzeptieren vorhandener Identitäten erleichtert den Benutzern das Leben, die sich eine Kombination aus Benutzername und Kennwort weniger merken müssen, und genauso den Anwendungsentwicklern, die keine eigenen Listen von Benutzernamen und Kennwörtern mehr pflegen müssen.
