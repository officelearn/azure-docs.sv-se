...
Den här artikeln förutsätter att du använder .NET-mikrotjänster. Det finns även Java-implementeringar. Om du vill hämta den senaste versionen av Java mikrotjänst implementeringar, kör du:
