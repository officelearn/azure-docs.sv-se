...
| [Automatisk identifiering och reaktion](../articles/iot-hub/iot-hub-monitoring-notifications-with-azure-logic-apps.md) | Azure Logic Apps                   |

## <a name="next-steps"></a>Nästa steg

När du har slutfört de här självstudierna kan du fortsätta att utforska funktionerna i IoT Hub i den [utvecklarguide](../articles/iot-hub/iot-hub-devguide.md). 
