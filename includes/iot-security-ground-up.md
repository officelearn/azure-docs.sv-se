...
Den här artikeln visar hur IoT Solution Accelerators tillhandahåller en säker och privat Sakernas Internet moln lösning. Lösnings acceleratorerna levererar en komplett lösning från slut punkt till slut punkt, med säkerhet som är inbyggd i varje fas från grunden. På Microsoft är att utveckla säker program vara en del av den tekniska övningen, som är rotad i Microsofts årtionde för att utveckla säkra program. För att säkerställa detta, är säkerhets utvecklings livs cykeln (SDL) grundläggande utvecklings metodik, tillsammans med en värd för säkerhets tjänster på infrastruktur nivå, till exempel drift säkerhet (OSA) och Microsoft Digital brottslighet-enhet, Microsoft Security Response Center och Microsoft Malware Protection Center.
