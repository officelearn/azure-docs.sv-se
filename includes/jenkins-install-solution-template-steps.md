...
![Låsa upp Jenkins](./media/jenkins-install-solution-template-steps/jenkins-unlock.png)
...
![Jenkins är redo!](./media/jenkins-install-solution-template-steps/jenkins-welcome.png)
...
![Skapa ett nytt jobb](./media/jenkins-install-solution-template-steps/jenkins-new-job.png) 
...
![Definiera Git-lagringsplatsen](./media/jenkins-install-solution-template-steps/jenkins-job-git-configuration.png) 
...
![Använda Gradle-omslutning för att bygga](./media/jenkins-install-solution-template-steps/jenkins-job-gradle-config.png) 

Välj **Avancerat** och ange sedan `complete` i fältet **Root Build script** (Root Build-skript). Välj **Spara**.

![Ange avancerade inställningar i steget för att bygga Gradle-omslutning](./media/jenkins-install-solution-template-steps/jenkins-job-gradle-advances.png) 
...
![Gå till arbetsytan för att hämta JAR-filen från versionen](./media/jenkins-install-solution-template-steps/jenkins-access-workspace.png) 
