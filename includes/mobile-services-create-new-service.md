...
2.  In der **Erstellen eines Mobile Service** Dialogfeld **eine freie 20 MB-SQL-Datenbank erstellen**, wählen **JavaScript** Common Language Runtime, geben Sie dann einen Unterdomänennamen für den neuen mobilen Dienst im Namen der **URL** Textbox. Klicken Sie auf den Pfeil nach rechts, um die nächste Seite aufzurufen.
