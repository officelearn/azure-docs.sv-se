...
5. In der **Mobildienst erstellen** Dialogfeld Ihre **Abonnement**, die **.NET Framework** Back-End **Common Language Runtime** und ein **Region** für Ihren mobilen Dienst, und geben Sie dann eine **Namen** für Ihren mobilen Dienst.
