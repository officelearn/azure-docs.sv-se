...
1. Klicken Sie auf **TodoItem**, klicken Sie auf **Skript** und wählen Sie **Einfügen**. 

2. Ersetzen Sie die Einfügefunktion durch den folgenden Code, und klicken Sie dann auf **Speichern**:
