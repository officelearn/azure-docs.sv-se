...
1. In **Projektmappen-Explorer** in Visual Studio mit der rechten Maustaste des Projektnamens, und wählen Sie dann **NuGet-Pakete verwalten**.

2. Wählen Sie im linken Bereich die **Online** Kategorie, suchen Sie nach `WindowsAzure.Storage`, klicken Sie auf **Installieren** auf die **Azure Storage** Paket, und stimmen Sie dem Lizenzvertrag. 
...
1. Öffnen Sie in Visual Studio die Datei "Package.appxmanifest" für das Windows-app-Projekt und in der **Funktionen** Registerkarte aktivieren die **Webcam** und **Mikrofon** Funktionen.
...
3. Klicken Sie im Windows-app-Projekt öffnen Sie die Datei "MainPage.xaml", und Ersetzen Sie die **StackPanel** -Element direkt nach dem ersten **"quickstarttask"** Element durch den folgenden Code:
...
3. Klicken Sie im Windows Phone-app-Projekt öffnen Sie die Datei "MainPage.xaml", und Ersetzen Sie die **ButtonSave** Element mit dem folgenden Code:
...
3. Öffnen Sie die freigegebene Projektdatei "MainPage.cs", und fügen Sie die folgenden **mit** Anweisungen:
...
3. Klicken oder tippen Sie auf die Vorschau, um ein Bild aufzunehmen, und klicken Sie dann **Hochladen** an das neue Element einzufügen und das Bild hochzuladen.
...
4. Das neue Element wird zusammen mit dem hochgeladenen Bild in der Listenansicht angezeigt.
    ...
    >[AZURE.NOTE]Das Bild wird automatisch vom Blob-Speicher heruntergeladen bei der *ImageUri* Eigenschaft des neuen Elements gebunden ist die **Image** Steuerelement.
...
6. Geben Sie wie zuvor Text in das Textfeld ein, und klicken Sie dann **Photo**.

    ![](./media/mobile-services-windows-universal-dotnet-upload-to-blob-storage/mobile-upload-blob-app-view-wp8.png)

3. Tippen Sie auf die Vorschau, um ein Bild aufzunehmen, und klicken Sie dann **Hochladen** an das neue Element einzufügen und das Bild hochzuladen.
