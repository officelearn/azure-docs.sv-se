...
5. Se följande **konfigurationsändringar** till ditt projekt i Android Studio. 
    ...
    3. Lägg till följande rad i slutet av den **appnivå build.gradle** filen efter avsnittet dependenices. 
...
4. Om du inte har hämtat den **google-services.json** filen till den **app** mapp på din Android Studio-projektet som du kan göra så vidare den här sidan. 
