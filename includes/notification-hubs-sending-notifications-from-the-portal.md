...
* Azure-Mobile Apps: ett exempel på hur du skickar meddelanden från en Mobile Apps Server del som är integrerad med Notification Hubs finns i [lägga till push-meddelanden till din iOS-app](../articles/app-service-mobile/app-service-mobile-ios-get-started-push.md).  
