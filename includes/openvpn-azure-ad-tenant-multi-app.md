...
## <a name="users"></a>2. skapa klient organisations användare
...
## <a name="register-client"></a>3. registrera VPN-klienten
...
6. Välj **acceptera** när du uppmanas till detta.
    ...
    ![Godkänn](./media/openvpn-azure-ad-tenant-multi-app/accept.jpg)
...
## <a name="register-apps"></a>4. registrera ytterligare program
...
## <a name="assign-users"></a>5. tilldela användare till program

Tilldela användarna till dina program.

1. Under **Azure AD-> företags program**väljer du det nyligen registrerade programmet och klickar på **Egenskaper**. Se till att **användar tilldelning krävs?** är inställt på **Ja**. Klicka på **Save** (Spara).
