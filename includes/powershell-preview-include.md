> [AZURE.NOTE] Azure PowerShell finns för nuvarande i två versioner, 1.0 och 0.9.8. Om du har befintliga skript och inte vill ändra dem just nu, kan du fortsätta använda 0.9.8-versionen. När du använder version 1.0, bör du noggrant testa skripten i testmiljöer innan du använder dem i produktion för att undvika oväntade konsekvenser.
>
