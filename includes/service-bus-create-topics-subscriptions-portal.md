...
## <a name="create-a-subscription-to-the-topic"></a>Skapa en prenumeration på ämnet
...
3. På sidan **Skapa prenumeration** anger du ett **namn** på prenumerationen och väljer sedan **Skapa**. 
