...
Du kan också skapa ett Azure-lagringskonto med hjälp av [Azure PowerShell](../articles/storage/common/storage-powershell-guide-full.md), [Azure CLI](../articles/storage/common/storage-azure-cli.md), eller [Lagringsresursprovider-klientbiblioteket för .NET](/dotnet/api/microsoft.azure.management.storage).
