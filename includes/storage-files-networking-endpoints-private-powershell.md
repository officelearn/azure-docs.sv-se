...
När du skapar en privat DNS-zon för Azure kan du använda det ursprungliga namnet på lagrings kontot, till exempel `storageaccount.file.core.windows.net` för att matcha den privata IP-adressen i det virtuella nätverket. Även om det är valfritt från perspektivet för att skapa en privat slut punkt krävs det uttryckligen för att montera Azure-filresursen direkt med hjälp av ett huvud för AD-användare eller åtkomst via REST API.  
