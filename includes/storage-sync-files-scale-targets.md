...
| Server slut punkter per Sync-grupp | 50 Server slut punkter | No |
...
| Minsta fil storlek för en fil i nivå | V9: baserat på fil systemets kluster storlek (kluster storlek för dubbla fil system). Om fil systemets kluster storlek till exempel är 4kb, kommer den minsta fil storleken att vara 8 KB.<br> V8 och äldre: 64 KiB  | Yes |
