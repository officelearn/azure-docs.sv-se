...
-   **URL-Format:** Code adressiert Tabellen in einem Konto mithilfe dieses
    Adressformats:   
...
-   **Tabelle**: eine Tabelle ist eine Auflistung von Entitäten. Tabellen erzwingen kein
...
-   **Entität**: eine Entität ist ein Satz von Eigenschaften, der in einer Datenbank
