...
1. Använd dina Microsoft-kontouppgifter för att logga in på [Microsoft Azure Government Portal](https://portal.azure.us/).
2. Klicka på och **+** klicka sedan på **Se alla**på marknadsplatsen på regeringsportalen. Sök efter _StorSimple Physical_. Markera och klicka på **StorSimple Physical Device Series** och sedan på **Skapa**. Du kan också klicka på **+** och **Storage**klicka på **StorSimple Physical Device Series**i regeringsportalen.
3. Utför följande steg på bladet för **StorSimple Device Manager**:
   ...
   4. Ange en **plats** för din tjänst. Plats refererar till det geografiska område där du vill distribuera enheten. Välj **USGov Iowa** eller **USGov Virginia**.
