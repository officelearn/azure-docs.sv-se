...
1.  Wechseln Sie im Azure-Portal auf der **StorSimple-Manager** Service.

2. Wechseln Sie zu der **Geräte** Seite. Klicken Sie auf **Virtuelles Gerät erstellen** am unteren Rand der **Geräte** Seite.

3. In der **Virtuelles Medium erstellen (Dialogfeld)**, geben Sie die folgenden Details.

     ![StorSimple – virtuelles Gerät erstellen](./media/storsimple-create-virtual-device-u2/CreatePremiumsva1.png)

    1. **Namen** – einen eindeutigen Namen für Ihr virtuelles Gerät.
