...
3. I sökrutan i Microsoft Update-katalogen ange Knowledge Base (KB) antalet den snabbkorrigering som du vill hämta, till exempel **3179904**, och klicka sedan på **Sök**.
   
    Snabbkorrigeringen listan visas till exempel **kumulativa programvara paket Update 2.2 för StorSimple 8000-serien**.
...
5. Sök efter eventuella ytterligare snabbkorrigeringar som anges i tabellen ovan (**3103616**, **3146621**), och Lägg till dem till korgen.
...
4. Skriv **Y** när du uppmanas att bekräfta installationen av snabbkorrigeringen.
   ...
   > [!IMPORTANT]
   > Om du installerar uppdateringen 2.2 bara installera den binära fil som inleds med ”alla hcsmdssoftwareudpate'. Installera inte TIS och MDS-agentuppdatering som inleds med alla cismdsagentupdatebundle. Det gick inte att göra det resulterar i ett fel. 
...
1. När programuppdateringen har slutförts kan du kontrollera systemprogramversionerna. Ange:
   ...
   * `MdsAgentVersion: 30.0.4698.16` 
     ...
     > 
     > 
2. Upprepa steg 3-5 om du vill installera snabbkorrigeringar återstående regular-läge.
   
   * ISCSI-uppdateringen KB3146621
   * WMI-uppdateringen KB3103616
3. Hoppa över det här steget om du uppdaterar från uppdatering 2. Om du uppdaterar från en tidigare version än uppdatering 2, måste du också hämta:

    - LSI drivrutinen KB3121900

    - Spaceport uppdateringen KB3090322

    - Storport uppdateringen KB3080728
