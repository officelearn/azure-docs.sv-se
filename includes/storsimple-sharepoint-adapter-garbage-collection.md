...
5. I den dekrypterade Web. config-filen under `connectionStrings` noden, Lägg till anslutnings strängen för din SQL Server-instans och innehålls databasens namn. Se följande exempel.
