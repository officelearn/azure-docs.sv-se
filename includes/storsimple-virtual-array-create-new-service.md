...
3.  Gör följande på bladet **StorSimple Enhetshanteraren** som öppnas:
    ...
    3.  För **resurs grupp**väljer du en befintlig eller skapar en ny grupp. Mer information finns i avsnittet om [Azure-resursgrupper](https://azure.microsoft.com/documentation/articles/virtual-machines-windows-infrastructure-resource-groups-guidelines/).
