...
4. Select and add the following columns:
   ...
   **Maintenance**: Shows the maintenance status for the VM. The following are the potential values:
      ...
      | Värde | Beskrivning |
      |-------|-------------|
      | Börja nu | The VM is in the self-service maintenance window that lets you initiate the maintenance yourself. See below on how to start maintenance on your VM. | 
      | Schemalagd | Den virtuella datorn är schemalagd för underhåll utan något alternativ för dig att starta underhållet. You can learn of the maintenance window by selecting the Maintenance - Scheduled window in this view or by clicking on the VM. | 
