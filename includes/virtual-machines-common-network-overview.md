...
| Metod | Beskrivning |
| ------ | ----------- |
| Azure-portalen |  Du kan [belastningsutjämna Internet trafik till virtuella datorer med hjälp av Azure Portal](../articles/load-balancer/tutorial-load-balancer-standard-manage-portal.md). |
...
| Metod | Beskrivning |
| ------ | ----------- |
| Azure-portalen | Du kan [utjämna belastningen på intern trafik med en grundläggande belastningsutjämnare i Azure Portal](../articles/load-balancer/tutorial-load-balancer-basic-internal-portal.md). |
