...
Du kan tilldela dessa typer av [IP-adresser](../articles/virtual-network/public-ip-addresses.md) till ett NIC i Azure:
...
- **[Vidarebefordran av port](../articles/load-balancer/tutorial-load-balancer-port-forwarding-portal.md)** – definierar hur inkommande trafik flödar genom klient delens IP och distribueras till backend-IP-användningen som använder inkommande NAT-regler.
...
- **[Utgående regler](../articles/load-balancer/load-balancer-outbound-rules-overview.md)** – en utgående regel konfigurerar utgående NAT (Network Address Translation) för alla virtuella datorer eller instanser som identifieras av backend-poolen för standard Load Balancer som ska översättas till klient delen.
...
| Metod | Description |
| ------ | ----------- |
| Azure Portal | Du kan [utjämna belastningen på intern trafik med en belastningsutjämnare i Azure Portal](../articles/load-balancer/tutorial-load-balancer-standard-internal-portal.md). |
