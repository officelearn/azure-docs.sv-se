...
Mer information finns i [storlekar för virtuella datorer för generell användning](../articles/virtual-machines/windows/sizes-general.md#dv2-series).
...
Mer information finns i [storlekar för virtuella datorer för den minnesoptimerade](../articles/virtual-machines/windows/sizes-memory.md#dsv2-series-11-15).
...
Mer information finns i [storlekar för virtuella datorer för den minnesoptimerade](../articles/virtual-machines/windows/sizes-memory.md#dv2-series-11-15).
...
Mer information finns i [beräkningsoptimerade virtuella datorstorlekar](../articles/virtual-machines/windows/sizes-compute.md#f-series).
