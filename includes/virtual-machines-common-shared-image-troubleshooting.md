...
## <a name="unable-to-create-a-shared-image-gallery"></a>Det gick inte att skapa ett delat avbildnings Galleri
...
## <a name="unable-to-create-an-image-definition"></a>Det gick inte att skapa en bild definition 
...
## <a name="unable-to-create-an-image-version"></a>Det gick inte att skapa en avbildnings version 
...
## <a name="unable-to-create-a-vm-or-a-scale-set"></a>Det gick inte att skapa en virtuell dator eller en skalnings uppsättning 
...
## <a name="unable-to-share-resources"></a>Det gick inte att dela resurser
