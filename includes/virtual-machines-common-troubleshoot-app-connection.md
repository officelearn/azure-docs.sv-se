...
* [Felsök fjärrskrivbordsanslutningar till en Windows-baserade Azure-dator](../articles/virtual-machines/windows/troubleshoot-rdp-connection.md)
* [Felsöka Secure Shell (SSH)-anslutningar till en Linux-baserade Azure VM](../articles/virtual-machines/linux/troubleshoot-ssh-connection.md).
...
* Distribuera om den virtuella datorn
  * [Distribuera om Windows VM](../articles/virtual-machines/windows/redeploy-to-new-node.md)
  * [Distribuera om virtuell Linux-dator](../articles/virtual-machines/linux/redeploy-to-new-node.md)
...
* För virtuella datorer som skapas med hjälp av den klassiska distributionsmodellen:
  ...
  * Mer information finns i [så konfigurera slutpunkter till en virtuell dator](../articles/virtual-machines/windows/classic/setup-endpoints.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fclassic%2ftoc.json).
