...
Om du vill skapa och konfigurera stegvisa ögonblicks bilder i den globala Azure Portal måste du använda följande länk: [https://aka.ms/incrementalsnapshots](https://aka.ms/incrementalsnapshots). Det går inte att skapa en stegvis ögonblicks bild i den globala Azure Portal.

1. Logga in på [Azure Portal](https://aka.ms/incrementalsnapshots) med den angivna länken och navigera till den disk som du vill ögonblicks bild.
