...
De två data diskarna finns på LUN 0 och LUN 1 (den första kolumnen i `lsscsi` informationen om `[host:channel:target:lun]`utdata). Båda diskarna bör vara tillgängliga från den virtuella datorn. Om du har angett att den första disken manuellt ska läggas till på LUN 1 och den andra disken vid LUN 2, kanske du inte ser diskarna på rätt sätt i den virtuella datorn.
