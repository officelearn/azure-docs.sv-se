...
Om du vill anpassa plats- eller avbildnings-urn:en så kan du se över kommandona `azure location list` och `azure vm image {list-publishers|list-offers|list-skus|list|show}`.

Detta kommando blir tillgängligt igen när skalningsuppsättningen har distribuerats. Den här skalningsuppsättningen har en belastningsutjämnare med NAT-regler som mappar port 50 000+i på belastningsutjämnaren till port 22 på VM i. Så när vi räknat ut FQDN för belastningsutjämnaren så kan vi ansluta till våra virtuella datorer via ssh:
