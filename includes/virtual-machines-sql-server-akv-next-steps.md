...
Varje exempel baseras på de två förutsättningarna: en asymmetrisk nyckel från ditt nyckel valv som kallas **CONTOSO_KEY** och en autentiseringsuppgift som skapats av AKV-integrations funktionen som kallas **Azure_EKM_TDE_cred**. Följande Transact-SQL-kommandon ställer in dessa krav för att köra exemplen.
