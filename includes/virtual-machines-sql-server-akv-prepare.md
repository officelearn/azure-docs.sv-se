...
* Du måste auktorisera den här nya klient-ID som har följande åtkomstbehörighet: **kryptera**, **dekryptera**, **wrapKey**, **unwrapKey**, **logga**, och **Kontrollera**. Detta görs med de [Set-AzureRmKeyVaultAccessPolicy](https://docs.microsoft.com/powershell/module/azurerm.keyvault/Set-AzureRmKeyVaultAccessPolicy) cmdlet. Mer information finns i [godkänna att programmet använder nyckeln eller hemligheten](../articles/key-vault/key-vault-get-started.md#authorize).
