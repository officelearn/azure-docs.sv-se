...
Bevor Sie mehrere NICs in virtuellen Computern implementieren können, müssen Sie wissen, wann Sie mehrere NICs verwenden können und wie diese verwendet werden. Lesen der [Übersicht über die Multi-NIC](virtual-networks-multiple-nics.md) Weitere Informationen zu virtuellen Maschinen mit mehreren NICs.
