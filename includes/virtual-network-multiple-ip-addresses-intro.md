...
Du kan tilldela upp till 250 privata IP-adresser till varje nätverkskort. Du kan tilldela flera offentliga IP-adresser till varje nätverkskort, men det finns gränser för hur många offentliga IP-adresser som kan användas i en Azure-prenumeration. Mer information finns i artikeln om [Azure-gränser](../articles/azure-subscription-service-limits.md?toc=%2fazure%2fvirtual-network%2ftoc.json#networking-limits).
