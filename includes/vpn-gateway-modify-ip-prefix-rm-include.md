...
### <a name="to-add-additional-prefixes"></a>Att lägga till ytterligare prefix
...
```
### <a name="to-remove-an-address-prefix"></a>Ta bort ett adressprefix
...
> [!IMPORTANT]
> Ta inte bort VPN-gatewayen. Om du gör det, måste du göra om alla stegen för att återskapa den, samt omkonfigurera din lokala router med den nya inställningarna.
> 
> 
