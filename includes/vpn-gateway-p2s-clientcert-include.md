...
- **Företagscertifikat:**
  ...
  - Om du använder en företagscertifikatlösning genererar du ett klientcertifikat med det vanliga *namnformatnamnet\@yourdomain.com*. Använd det här formatet i stället för formatet *domännamn\användarnamn*.
...
- **Självsignerat rotcertifikat:** Följ stegen i någon av följande P2S-certifikatartiklar så att de klientcertifikat du skapar är kompatibla med dina P2S-anslutningar. Med anvisningarna i de angivna artiklarna skapas ett kompatibelt klientcertifikat: 
  ...
  * [MakeCert-instruktioner](../articles/vpn-gateway/vpn-gateway-certificates-point-to-site-makecert.md): Använd MakeCert om du inte har tillgång till en Windows 10-dator för att generera certifikat. MakeCert är inaktuellt, men du kan fortfarande använda det för att generera certifikat. Du kan installera de genererade certifikaten på valfri P2S-klient som stöds.
