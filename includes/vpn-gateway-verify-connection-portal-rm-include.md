...
1. Klicka på **alla resurser** i [Azure Portal](https://portal.azure.com)och navigera till din virtuella nätverksgateway.
...
3. Klicka på namnet på den anslutning du vill verifiera för att öppna **Essentials**. I Essentials, kan du visa mer information om din anslutning. **Statusen** är Lyckades och Ansluten, när du har skapat en lyckad anslutning.
   ...
   ![Verifiera VPN Gateway-anslutningen med Azure Portal](./media/vpn-gateway-verify-connection-portal-rm-include/connection-succeeded.png)
